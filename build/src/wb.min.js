...
virtualclass.gObj.wbData[a]=virtualclass.gObj.wbData[a].concat(b)},attachWhiteboardPopupHandler(b){c.addEventListener("mouseup",a=>{var d=document.querySelector("#virtualclassCont").dataset.currapp;const c=document.querySelector("#askQuestion .moreControls .item.open");c&&(c.classList.remove("open"),c.classList.add("close"));d&&("Whiteboard"===d||"DocumentShare"===d)&&b&&roles.hasControls()&&(d=document.querySelector(".commandToolsWrapper .active"),!d||a.target.classList.contains("icon-shapes")||
a.target.classList.contains("congtooltip")||a.target.classList.contains("whiteboards")||0===a.target.classList.length||a.target.classList.contains("whiteBoardTextBox")||d.classList.remove("active"),(a=document.querySelector(".commandToolsWrapper .open"))&&virtualclass.wb[b].closeElem(a))})},setScreenShareDefualtColor(){var b=virtualclass.gObj.prvRequestScreenUser;virtualclass.gObj.prvRequestScreenUser&&(b=chatContainerEvent.elementFromShadowDom(`#ml${b} .icon-stdscreenImg`),null!==b&&(b.setAttribute("data-dcolor",
...
c.previousElementSibling,null!=c?(0===+c.dataset.status?(b=this.getActiveSlide(a,b,"prev"))?(this.getScreen(b,!0),a.docs.currNote=b.dataset.slide):virtualclass.dts.indexNav.UI.setArrowStatusDocs(document.getElementById("leftNavPage"),"disable","enable"):(this.getScreen(c,!0),a.docs.currNote=c.dataset.slide),virtualclass.dts.indexNav.movePageIndex("left")):(a=document.getElementById("leftNavPage"),virtualclass.dts.indexNav.UI.setArrowStatusDocs(a,"disable","enable")))},getActiveSlide(a,b,c){b=document.querySelector(`#documentScreen #note${b}`);
...
a.docs.currNote=b.dataset.slide):alert("There is no page"):(this.getScreen(c,!0),a.docs.currNote=c.dataset.slide)));virtualclass.dts.indexNav.movePageIndex("right")}else a=document.getElementById("rightNavPage"),virtualclass.dts.indexNav.UI.setArrowStatusDocs(a,"disable","enable")},isSlideAvailable(a,b){return a===b?!1:!0},currentSlide(a){a=document.querySelector(`#documentScreen #note${a}`);null!=a&&this.getScreen(a);a=document.querySelector("#docScreenContainer");null!=a&&(a.classList.add("noteDisplay"),
