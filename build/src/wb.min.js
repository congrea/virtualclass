...
{this.ogvPlayer&&this.ogvPlayer._codec&&this.ogvPlayer._codec.loadedAllMetadata&&(clearInterval(this.ogvPlayerLoadedMedia),virtualclass.system.mybrowser.iOS?virtualclass.popup.infoMsg(virtualclass.lang.getString("continueToLiveStream"),this.playIfReadyOGVFinal):this.ogvPlayer.play())},500)}playIfReadyOGVFinal(){this.ogvPlayer.play()}destroyOGVPlayer(){this.ogvPlayer&&(this.ogvPlayer._stopPlayback(),this.ogvPlayer.stop());delete this.ogvPlayer;delete virtualclass.liveStream.listStream;virtualclass.liveStream.listStream=
