...
"boxManager").addMsg(a.name,b)}});virtualclass.gObj.hasOwnProperty("chatEnable")&&!virtualclass.gObj.chatEnable&&(a=c.getElementById("chatrm"),null!=a&&virtualclass.user.control.makeElemDisable(a));a=c.getElementById("cc_arrow_button");a.classList.add("icon-arrow-down");a.classList.remove("icon-arrow-up")}},toogleAudioIcon(){var a=c.querySelector(".bulkUserActions #contrAudioAllImg");if(null!=a){let b=a.dataset.action;"enable"==a.dataset.action?(a.dataset.action="disable",a.className="slider round icon-all-audio-disable congtooltip",
a.dataset.title=virtualclass.lang.getString("muteAll"),a=c.querySelector(".congrea .bulkUserActions #contrAudioAll"),a.classList.add("disable"),a.classList.remove("enable")):(a.dataset.action="enable",a.className="slider round icon-all-audio-enable congtooltip",a.dataset.title=virtualclass.lang.getString("unmuteAll"),a=c.querySelector(".congrea .bulkUserActions #contrAudioAll"),a.classList.add("enable"),a.classList.remove("disable"));return b}},toggleVideoIcon(){var a=c.querySelector(".bulkUserActions #contrVideoAllImg");
if(null!=a){let b=a.dataset.action;"enable"==a.dataset.action?(a.dataset.action="disable",a.className="slider round icon-all-video-disable congtooltip",a.dataset.title=virtualclass.lang.getString("disableAllVideo"),a=c.querySelector(".congrea .bulkUserActions #contrVideoAll"),a.classList.add("disable"),a.classList.remove("enable")):(a.dataset.action="enable",a.className="slider round icon-all-video-enable congtooltip",a.dataset.title=virtualclass.lang.getString("enableAllVideo"),a=c.querySelector(".congrea .bulkUserActions #contrVideoAll"),
a.classList.add("enable"),a.classList.remove("disable"));return b}},changeRoleOnFooter(a,c){chatContainerEvent.elementFromShadowDom(`#ml${a}`).dataset.role=c},initControlHandler(a){virtualclass.vutil.userIsOrginalTeacher(a);const b=chatContainerEvent.elementFromShadowDom(`#ml${a} .contImg`,"all");let d=!1,k=localStorage.getItem(`virtualclass${a}`);null!=k&&(d=!0,k=JSON.parse(k),k.hasOwnProperty("currTeacher")&&(virtualclass.gObj[`${a}currTeacher`]={},1==k.currTeacher?(virtualclass.user.control.currTeacherAlready=
!0,virtualclass.gObj[`${a}currTeacher`].ct=!0):virtualclass.gObj[`${a}currTeacher`].ct=!1));for(let f=0;f<b.length;f++)if(-1<b[f].className.indexOf("chat")){var m=d&&k.hasOwnProperty("chat")?!!k.chat:!0;virtualclass.user.control.changeAttribute(a,b[f],m,"chat","chat")}else-1<b[f].className.indexOf("aud")?(d&&k.hasOwnProperty("aud")?m=!!k.aud:(m=c.querySelector("#contrAudioAll"),m=null!=virtualclass.jId&&m.classList.contains("disable")?!0:virtualclass.gObj.stdaudioEnable),virtualclass.user.control.changeAttribute(a,
b[f],m,"audio","aud"),roles.hasAdmin()&&"false"==b[f].dataset.audioDisable&&localStorage.getItem("allAudAction")):-1<b[f].className.indexOf("RaiseHand")?(m=d&&k.hasOwnProperty("raiseHand")?!!k.raiseHand:!1,virtualclass.user.control.changeAttribute(a,b[f],m,"RaiseHand","RaiseHand")):-1<b[f].className.indexOf("stdscreen")?virtualclass.gObj.studentSSstatus.hasOwnProperty("whoIsSharing")&&virtualclass.vutil.initssSharing(virtualclass.gObj.whoIsSharing):-1<b[f].className.indexOf("editorRich")&&"EditorRich"==
virtualclass.currApp?(c.querySelector("#alleditorRichContainerAnch"),m=d&&k.hasOwnProperty("editorRich")?!!k.editorRich:!1,virtualclass.user.control.changeAttribute(a,b[f],m,"editorRich","editorRich")):-1<b[f].className.indexOf("editorCode")&&(m=d&&k.hasOwnProperty("editorCode")?!!k.editorCode:!1,virtualclass.user.control.changeAttribute(a,b[f],m,"editorCode","editorCode"))}}}})(window,document);(function(d){d.xhr={init(){this.httpObj=d.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");this.httpObj.upload.addEventListener("progress",this.onProgress);this.onReadStateChange();this.httpObj.onerror=function(c){console.log(`Error ${c}`)};this.httpObj.withCredentials=!0;this.httpObj.onabort=function(c){console.log(`Error abort ${c}`)}},onProgress(c){virtualclass.pbar.currVal=c.loaded;""!=virtualclass.pbar.prvVal&&"undefined"!==typeof virtualclass.pbar.prvVal||virtualclass.isPlayMode||
...
b=>a!=b);d=$.grep(d,b=>a!=b)},dispatch:function(a,b){$(`#${a.userid}`).chatbox("option","boxManager").addMsg(a.name,b)}}}();let tabId;const myChatBoxOpen=!1,chatResults=[];let myDivResult="";const checkChatDisabled=!1;let tmpmyDivResult;
...
0;a<virtualclass.gObj.uploadingFiles.length;)return virtualclass.gObj.uploadingFiles[a].name},requestDocs(a){var b={filename:this.getFilenameFromUploadingfiles(a),fileuuid:a,filepath:"somewhere",filetype:"doc",key_room:`${virtualclass.gObj.sessionInfo.key}_${virtualclass.gObj.sessionInfo.room}`,status:1};this.allDocs[a]=b;b=0;if("true"==this.allDocs[a].status||1==this.allDocs[a].status)b=1;const c=`docs${a}`;"object"!==typeof this.pages[c]&&(this.pages[c]=new virtualclass.page("docScreenContainer",
...
notes_id:"all",user:virtualclass.gObj.uid},"retrieve_all_notes",c=>{c=JSON.parse(c);+c.status&&(b.allPages=c.resultdata,b.allNotes=b.convertInObjects(b.allPages),b.storeInDocs(b.allNotes),ioAdapter.mustSend({dts:{allNotes:b.allNotes,doc:a},cf:"dts"}))})},firstRequestNotes(){const a=this;virtualclass.vutil.xhrSendWithForm({live_class_id:virtualclass.gObj.congCourse,notes_id:"all",user:virtualclass.gObj.uid},"retrieve_all_notes",b=>{b=JSON.parse(b);a.allPages=b.resultdata;a.allNotes=a.convertInObjects(a.allPages);
a.storeInDocs(a.allNotes);ioAdapter.mustSend({dts:{fallNotes:a.allNotes},cf:"dts"});a.requestOrder(a.executeOrder)})},requestSlidesOld(a){a=parseInt(a,10);console.log(`${virtualclass.gObj.currWb} `+`document share : request ${a}`);const b=this.getDocs(a),c=document.querySelector(`#linkdocs${a}`).dataset.selected;ioAdapter.mustSend({dts:{dres:a,ds:1-+c},cf:"dts"});return b},requestSlides(a){console.log(`${virtualclass.gObj.currWb} `+`document share : request ${a}`);const b=this.getDocs(a),c=document.querySelector(`#linkdocs${a}`).dataset.selected;
ioAdapter.mustSend({dts:{dres:a,ds:1-+c},cf:"dts"});return b},storeInDocs(a){virtualclass.storage.dstAllStore(virtualclass.serverData.rawData.docs)},removeWhiteboardFromStorage(a){virtualclass.storage.wbDataRemove(a)},getNotesOld(a){const b=[];for(const c in this.allNotes)this.allNotes[c].lc_content_id==a&&b.push(this.allNotes[c]);return b},getNotes(a){return this.allDocs[a].notesarr},removePagesUI(a){a=this.getNotes(a);for(let b=0;b<a.length;b++)this._removePageUI(a[b].id);0>=this.order.length&&
...
"undefined"!==typeof k?this.createNoteNav(k):this.createNoteNav(),this.updateLinkNotes(this.docs.currNote),virtualclass.dts.setCurrentNav(this.docs.currNote),virtualclass.vutil.hideUploadMsg("docsuploadContainer"),virtualclass.vutil.addNoteClass()):(this.removePagesUI(a),virtualclass.dts.noteExist()||(virtualclass.vutil.showUploadMsg("docsuploadContainer"),virtualclass.dts.docs.currNote=0,virtualclass.dts.docs.currDoc=void 0,virtualclass.gObj.currWb=null),virtualclass.dts.docSelected()||(b=JSON.parse(localStorage.getItem("dtsdocs")),
null!=b&&(b.slideNumber=null,localStorage.setItem("dtsdocs",JSON.stringify(b))),roles.isStudent()&&(b=document.querySelector(`#cont${virtualclass.gObj.currWb}`),null!=b?b.style.display="block":(b=document.querySelector("#docScreenContainer"),null!=b&&b.classList.remove("noteDisplay"),virtualclass.gObj.currWb=null,document.querySelector("#virtualclassCont").classList.remove("pdfRendering"),b=document.querySelector("#virtualclassAppLeftPanel.hideZoom"),g=document.querySelector("#virtualclassAppLeftPanel"),
b||(g.classList.add("hideZoom"),g.classList.remove("showZoom"))))));null==document.querySelector("#listnotes .currentNav")&&(b=document.querySelector("#listnotes .linknotes"),null!=b&&(virtualclass.dts.currNote=b.dataset.rid,b=document.querySelector(`#mainpnotes${virtualclass.dts.currNote}`),null!=b&&(virtualclass.dts.docs.currDoc=virtualclass.dts.currNote.split("_")[0],b.click())));roles.hasAdmin()&&this.sendOrder(this.order)},selectFirstNote(){if(null==document.querySelector("#notesContainer .current")){const a=
...
JSON.stringify(virtualclass.settings.user))}return!0}return!1}for(b in c)if(virtualclass.settings.info[b]=c[b],"trimRecordings"!==b)virtualclass.settings[b](c[b]);a=virtualclass.settings.settingsToHex(c);localStorage.setItem("settings",a)},send(c,a){roles.hasControls()&&("undefined"!==typeof a?virtualclass.vutil.beforeSend({cf:"settings",Hex:c,toUser:a},a):virtualclass.vutil.beforeSend({cf:"settings",Hex:c}))},onMessage(c){"string"===typeof c?roles.isStudent()&&(c=virtualclass.settings.parseSettings(c),
this._applySettings(c)):this.recording.triggerSetting(c)},onLoadSettings(c){return virtualclass.settings.parseSettings(c)},disableAttendeeAudio(c){roles.isStudent()&&(!0===c?(virtualclass.user.control.audioWidgetEnable(!0),virtualclass.gObj.audioEnable=!0):!1===c&&(c=document.querySelector("#speakerPressOnce"),!0!==c.dataset.audioPlaying&&"true"!==c.dataset.audioPlaying||virtualclass.media.audio.clickOnceSpeaker("speakerPressOnce"),virtualclass.user.control.audioDisable(),virtualclass.gObj.audioEnable=
!1))},allowoverride(){console.log("TO DO")},disableAttendeePc(){console.log("TO DO")},disableAttendeeGc(){console.log("TO DO")},disableAttendeeVideo(c){if(roles.isStudent()){const a=document.querySelector(".videoSwitchCont #videoSwitch");a.classList.contains("off")&&!1===c?console.log("do nothing"):a.classList.contains("on")&&!0===c?console.log("do nothing"):a.classList.contains("on")&&!1===c&&virtualclass.vutil.videoHandler("off");virtualclass.videoHost.toggleVideoMsg(!1===c?"disable":"enable")}},
disableRaiseHand(){console.log("TO DO")},disableUserList(){console.log("TO DO")},x8(){console.log("TO DO")},enableRecording(){console.log("TO DO")},recAllowpresentorAVcontrol(){console.log("TO DO")},recShowPresentorRecordingStatus(){console.log("TO DO")},recDisableAttendeeAV(){console.log("TO DO")},recallowattendeeAVcontrol(){console.log("TO DO")},showAttendeeRecordingStatus(){console.log("TO DO")},x16(){console.log("TO DO")},recording:{enableRecording:!1,allowpresentorAVcontrol:!1,disableAttendeeAV:!1,
allowattendeeAVcontrol:!1,audioVideo:!0,statusOnly:!1,trimRecordings:!1,allowattendeeAVcontrolByTeacher:!1,init(){this.enableRecording=virtualclass.settings.info.enableRecording;roles.hasControls()?(this.allowpresentorAVcontrol=virtualclass.settings.info.recAllowpresentorAVcontrol,this.showPresentorRecordingStatus=virtualclass.settings.info.allowpresentorAVcontrol?!0:virtualclass.settings.info.recShowPresentorRecordingStatus):(this.disableAttendeeAV=virtualclass.settings.info.recDisableAttendeeAV,
this.allowattendeeAVcontrol=virtualclass.settings.info.recallowattendeeAVcontrol,this.showAttendeeRecordingStatus=virtualclass.settings.info.allowattendeeAVcontrol?!0:virtualclass.settings.info.showAttendeeRecordingStatus);this.trimRecordings=virtualclass.settings.info.trimRecordings;this.showStatus=this.showStatus();this.showButton();this.overrideSettingFromLocalStorage()},overrideSettingFromLocalStorage(){let c=localStorage.getItem("recsetting");if(null!==c&&void 0!==c)if(c=JSON.parse(c),roles.hasControls()||
!0!==c.statusonly)this.updateSettingAV(!1);else virtualclass.settings.onMessage({ac:!1})},showButton(){const c=document.getElementById("recording");this.showStatus?(c.classList.remove("hide"),c.classList.add("show"),virtualclassCont.dataset.recording="on",this.statusOnly?c.classList.add("statusonly"):this.attachHandler(c),this.trimRecordings&&c.classList.add("trimRecording")):(c.classList.remove("show"),c.classList.add("hide"))},attachHandler(c){c.addEventListener("click",this.recordingButtonAction.bind(this,
c))},updateSettingAV(c){const a=document.querySelector("#recording"),b=document.querySelector("#recording .recordingText");(this.audioVideo=c)?(b.innerHTML="Recording",virtualclassCont.dataset.recording="on",a.setAttribute("data-title","Recording Started"),localStorage.removeItem("recsetting"),"ScreenShare"===virtualclass.currApp&&null!=virtualclass.ss&&virtualclass.ss.initShareScreen("ss",500)):(roles.hasControls(),a.setAttribute("data-title","Recording Stopped"),virtualclassCont.dataset.recording=
"off",localStorage.setItem("recsetting",JSON.stringify({statusonly:this.statusOnly,rec:virtualclassCont.dataset.recording})));ioAdapter.setRecording()},recordingButtonAction(c){c.classList.contains("statusonly")?console.log(" Do nothing"):(c="off"===virtualclassCont.dataset.recording?!0:!1,this.updateSettingAV(c),roles.hasControls()&&ioAdapter.mustSend({ac:c,cf:"recs"}))},showStatus(){return roles.hasControls()?this.enableRecording&&this.allowpresentorAVcontrol&&this.showPresentorRecordingStatus?
!0:this.enableRecording&&!this.allowpresentorAVcontrol&&this.showPresentorRecordingStatus?this.statusOnly=!0:!1:this.enableRecording&&!this.disableAttendeeAV&&this.allowattendeeAVcontrol&&this.showAttendeeRecordingStatus?!0:this.enableRecording&&!this.disableAttendeeAV&&!this.allowpresentorAVcontrol&&this.showAttendeeRecordingStatus?this.statusOnly=!0:!1},isRecordingOn(){return roles.hasControls()?this.enableRecording&&this.allowpresentorAVcontrol&&this.audioVideo:this.disableAttendeeAV?!1:this.allowattendeeAVcontrol?
this.audioVideo:!0},sendYesOrNo(){return this.isRecordingOn()?"yes":"no"},setStatusOnElement(){const c=document.querySelector("#recording");this.allowattendeeAVcontrolByTeacher?(c.classList.add("statusonly"),this.statusOnly=!0):(c.classList.remove("statusonly"),this.statusOnly=!1)},triggerSetting(c){this.allowattendeeAVcontrolByTeacher=0==c.ac;this.setStatusOnElement();this.updateSettingAV(c.ac)}}}})(window);(d=>{function c(a){const b=new Promise((b,c)=>{const d=()=>{a.removeEventListener("success",g);a.removeEventListener("error",k)},g=()=>{b(f(a.result));d()},k=()=>{c(a.error);d()};a.addEventListener("success",g);a.addEventListener("error",k)});b.then(b=>{b instanceof IDBCursor&&q.set(b,a)});u.set(b,a);return b}function a(a){if(!r.has(a)){var b=new Promise((b,c)=>{const d=()=>{a.removeEventListener("complete",f);a.removeEventListener("error",g);a.removeEventListener("abort",g)},f=()=>{b();d()},g=()=>
