...
CommonXHR.prototype.send=function(d,c,a){console.log(`Common URL ${d}`);this.cb=c;this.httpObj.open("GET",d,!0);this.httpObj.responseType=a;this.httpObj.setRequestHeader("x-api-key",wbUser.lkey);this.httpObj.setRequestHeader("x-congrea-authuser",wbUser.auth_user);this.httpObj.setRequestHeader("x-congrea-authpass",wbUser.auth_pass);this.httpObj.setRequestHeader("x-congrea-room",wbUser.room);this.httpObj.withCredentials=!0;this.httpObj.send()};(function(d){d.settings={info:{allowoverride:null,disableAttendeeAudio:null,disableAttendeePc:null,disableAttendeeGc:null,disableAttendeeVideo:null,disableRaiseHand:null,disableUserList:null,x8:null,x16:null,enableRecording:null,recAllowpresentorAVcontrol:null,recShowPresentorRecordingStatus:null,attendeeAV:null,recallowattendeeAVcontrol:null,showAttendeeRecordingStatus:null,trimRecordings:null},user:{},init(){let c=localStorage.getItem("settings");c||(c=virtualclassSetting.settings);c=virtualclass.settings.onLoadSettings(c);
for(const a in c)virtualclass.settings.info.hasOwnProperty(a)&&(virtualclass.settings.info[a]=c[a]);this.recording.init()},settingsToHex(c){const a=[];a[0]=+c.allowoverride;a[1]=+c.disableAttendeeAudio;a[2]=+c.disableAttendeeVideo;a[3]=+c.disableAttendeePc;a[4]=+c.disableAttendeeGc;a[5]=+c.disableRaiseHand;a[6]=+c.disableUserList;a[7]=+c.enableRecording;a[8]=+c.recAllowpresentorAVcontrol;a[9]=+c.recShowPresentorRecordingStatus;a[10]=+c.attendeeAV;a[11]=+c.recallowattendeeAVcontrol;a[12]=+c.showAttendeeRecordingStatus;
a[13]=+c.trimRecordings;a[14]=+c.x8;a[15]=+c.x16;return virtualclass.settings.binaryToHex(a.join(""))},parseSettings(c){const a={};(c=virtualclass.settings.hexToBinary(c))&&(c=c.split(""));a.allowoverride=!!+c[0];a.disableAttendeeAudio=!!+c[1];a.disableAttendeeVideo=!!+c[2];a.disableAttendeePc=!!+c[3];a.disableAttendeeGc=!!+c[4];a.disableRaiseHand=!!+c[5];a.disableUserList=!!+c[6];a.enableRecording=!!+c[7];a.recAllowpresentorAVcontrol=!!+c[8];a.recShowPresentorRecordingStatus=!!+c[9];a.attendeeAV=
!!+c[10];a.recallowattendeeAVcontrol=!!+c[11];a.showAttendeeRecordingStatus=!!+c[12];a.trimRecordings=!!+c[13];a.x8=!!+c[14];a.x16=!!+c[15];return a},hexToBinary(c){let a,b="";const d={0:"0000",1:"0001",2:"0010",3:"0011",4:"0100",5:"0101",6:"0110",7:"0111",8:"1000",9:"1001",a:"1010",b:"1011",c:"1100",d:"1101",e:"1110",f:"1111",A:"1010",B:"1011",C:"1100",D:"1101",E:"1110",F:"1111"};for(a=0;a<c.length;a+=1)if(d.hasOwnProperty(c[a]))b+=d[c[a]];else return!1;return b},binaryToHex(c){let a,b,d,g,k="";
for(a=c.length-1;3<=a;a-=4){d=c.substr(a+1-4,4);for(b=g=0;4>b;b+=1){if("0"!==d[b]&&"1"!==d[b])return!1;g=2*g+parseInt(d[b],10)}k=10<=g?String.fromCharCode(g-10+65)+k:String(g)+k}if(0<=a){for(b=g=0;b<=a;b+=1){if("0"!==c[b]&&"1"!==c[b])return!1;g=2*g+parseInt(c[b],10)}k=String(g)+k}return k},applySettings(c,a,b){const d={};d[a]=c;this._applySettings(d,b)},_applySettings(c,a){if(roles.hasControls()){var b=Object.keys(c)[0];c=c[b];if((!0===c||!1===c)&&virtualclass.settings.info.hasOwnProperty(b)){if("undefined"===
typeof a){localStorage.removeItem("userSettings");virtualclass.settings.info[b]=c;var d=virtualclass.settings.settingsToHex(virtualclass.settings.info);virtualclass.settings.send(d,a);localStorage.setItem("settings",d)}else{const f={},k=virtualclass.settings.info;for(d in k)f[d]=k[d];f[b]=c;d=virtualclass.settings.settingsToHex(f);virtualclass.settings.user[a]=d;virtualclass.settings.send(d,a);localStorage.setItem("userSettings",JSON.stringify(virtualclass.settings.user))}return!0}return!1}for(b in c)if(virtualclass.settings.info[b]=
c[b],"trimRecordings"!==b)virtualclass.settings[b](c[b]);a=virtualclass.settings.settingsToHex(c);localStorage.setItem("settings",a)},send(c,a){roles.hasControls()&&("undefined"!==typeof a?virtualclass.vutil.beforeSend({cf:"settings",Hex:c,toUser:a},a):virtualclass.vutil.beforeSend({cf:"settings",Hex:c}))},onMessage(c){"string"===typeof c?roles.isStudent()&&(c=virtualclass.settings.parseSettings(c),this._applySettings(c)):this.recording.triggerSetting(c)},onLoadSettings(c){return virtualclass.settings.parseSettings(c)},
disableAttendeeAudio(c){roles.isStudent()&&(!0===c?(virtualclass.user.control.audioWidgetEnable(!0),virtualclass.gObj.audioEnable=!0):!1===c&&(c=document.querySelector("#speakerPressOnce"),!0!==c.dataset.audioPlaying&&"true"!==c.dataset.audioPlaying||virtualclass.media.audio.clickOnceSpeaker("speakerPressOnce"),virtualclass.user.control.audioDisable(),virtualclass.gObj.audioEnable=!1))},allowoverride(){console.log("TO DO")},disableAttendeePc(){console.log("TO DO")},disableAttendeeGc(){console.log("TO DO")},
disableAttendeeVideo(c){if(roles.isStudent()){const a=document.querySelector(".videoSwitchCont #videoSwitch");a.classList.contains("off")&&!1===c?console.log("do nothing"):a.classList.contains("on")&&!0===c?console.log("do nothing"):a.classList.contains("on")&&!1===c&&virtualclass.vutil.videoHandler("off");virtualclass.videoHost.toggleVideoMsg(!1===c?"disable":"enable")}},disableRaiseHand(){console.log("TO DO")},disableUserList(){console.log("TO DO")},x8(){console.log("TO DO")},enableRecording(){console.log("TO DO")},
recAllowpresentorAVcontrol(){console.log("TO DO")},recShowPresentorRecordingStatus(){console.log("TO DO")},attendeeAV(){console.log("TO DO")},recallowattendeeAVcontrol(){console.log("TO DO")},showAttendeeRecordingStatus(){console.log("TO DO")},x16(){console.log("TO DO")},recording:{enableRecording:!1,allowpresentorAVcontrol:!1,attendeeAV:!1,allowattendeeAVcontrol:!1,audioVideo:!0,statusOnly:!1,trimRecordings:!1,allowattendeeAVcontrolByTeacher:!1,init(){this.enableRecording=virtualclass.settings.info.enableRecording;
roles.hasControls()?(this.allowpresentorAVcontrol=virtualclass.settings.info.recAllowpresentorAVcontrol,this.showPresentorRecordingStatus=virtualclass.settings.info.allowpresentorAVcontrol?!0:virtualclass.settings.info.recShowPresentorRecordingStatus):(this.attendeeAV=virtualclass.settings.info.attendeeAV,this.allowattendeeAVcontrol=virtualclass.settings.info.recallowattendeeAVcontrol,this.showAttendeeRecordingStatus=virtualclass.settings.info.allowattendeeAVcontrol?!0:virtualclass.settings.info.showAttendeeRecordingStatus);
this.trimRecordings=virtualclass.settings.info.trimRecordings;this.showStatus=this.showStatus();this.showButton();this.overrideSettingFromLocalStorage()},overrideSettingFromLocalStorage(){let c=localStorage.getItem("recsetting");if(null!==c&&void 0!==c)if(c=JSON.parse(c),roles.hasControls()||!0!==c.statusonly)this.updateSettingAV(!1);else virtualclass.settings.onMessage({ac:!1})},showButton(){const c=document.getElementById("recording");this.showStatus?(c.classList.remove("hide"),c.classList.add("show"),
virtualclassCont.dataset.recording="on",this.statusOnly?c.classList.add("statusonly"):this.attachHandler(c),this.trimRecordings&&c.classList.add("trimRecording")):(c.classList.remove("show"),c.classList.add("hide"))},attachHandler(c){c.addEventListener("click",this.recordingButtonAction.bind(this,c))},updateSettingAV(c){const a=document.querySelector("#recording"),b=document.querySelector("#recording .recordingText");(this.audioVideo=c)?(b.innerHTML="Recording",virtualclassCont.dataset.recording=
"on",a.setAttribute("data-title","Recording Started"),localStorage.removeItem("recsetting"),"ScreenShare"===virtualclass.currApp&&null!=virtualclass.ss&&virtualclass.ss.initShareScreen("ss",500)):(roles.hasControls(),a.setAttribute("data-title","Recording Stopped"),virtualclassCont.dataset.recording="off",localStorage.setItem("recsetting",JSON.stringify({statusonly:this.statusOnly,rec:virtualclassCont.dataset.recording})));ioAdapter.setRecording()},recordingButtonAction(c){c.classList.contains("statusonly")?
console.log(" Do nothing"):(c="off"===virtualclassCont.dataset.recording?!0:!1,this.updateSettingAV(c),roles.hasControls()&&ioAdapter.mustSend({ac:c,cf:"recs"}))},showStatus(){return roles.hasControls()?this.enableRecording&&this.allowpresentorAVcontrol&&this.showPresentorRecordingStatus?!0:this.enableRecording&&!this.allowpresentorAVcontrol&&this.showPresentorRecordingStatus?this.statusOnly=!0:!1:this.enableRecording&&this.attendeeAV&&this.allowattendeeAVcontrol&&this.showAttendeeRecordingStatus?
!0:this.enableRecording&&this.attendeeAV&&!this.allowpresentorAVcontrol&&this.showAttendeeRecordingStatus?this.statusOnly=!0:!1},isRecordingOn(){return roles.hasControls()?this.enableRecording&&this.allowpresentorAVcontrol&&this.audioVideo:this.attendeeAV?this.allowattendeeAVcontrol?this.audioVideo:!0:!1},sendYesOrNo(){return this.isRecordingOn()?"yes":"no"},setStatusOnElement(){const c=document.querySelector("#recording");this.allowattendeeAVcontrolByTeacher?(c.classList.add("statusonly"),this.statusOnly=
