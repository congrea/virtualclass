...
g=new ImageData(a.data.cw,a.data.ch);a=4*b.length;for(let d=0;d<a;d++)g.data[4*d]=36.5*(b[d]>>5),g.data[4*d+1]=36.5*((b[d]&28)>>2),g.data[4*d+2]=85*(b[d]&3),g.data[4*d+3]=255;postMessage({globalImageData:g,dtype:"drgb",stype:"full",uid:d})}else f(a.data.data_pack)}}.toString(),")()"],{type:"application/javascript"})),sdworker=new Worker(screenDecodeBlob);const screenWorkerBlob=URL.createObjectURL(new Blob(["(",function(){function c(a,b){a=a.toString();let d;for(d=a.length;d<b;d++)a=`0${a}`;return a.match(/[\S]{1,2}/g)||[]}function b(b){0===k?d=a=0:(f=k%b.data.resB,g=Math.floor(k/b.data.resB),a=f*b.data.dw,d=g*b.data.dh);return{x:a,y:d,w:b.data.dw,h:b.data.dh}}let a,d,f,g,k,m=0,n,q,r,z,u=null,t=[],p,v,A;const D=function(a,b,d,f,g,c,k){c=new Uint8ClampedArray(d*f);let m=0;for(let n=b;n<f+b;n+=1)for(let b=a;b<d+a;b+=1){const a=n*g+b;c[m++]=k[a]}return c},
G=function(a,b,d){const f=b.length;let g;if(b.length!==a.length)return!1;for(g=0;g<f;g+=1){if(b[g]!==a[g])return!1;g+=d}for(g=0;g<f;--g)if(g+=d,b[g]!==a[g])return!1;for(g=0;g<f;g+=7)if(b[g]!==a[g])return!1;return!0};onmessage=function(a){if(Object.prototype.hasOwnProperty.call(a.data,"initPrevImg"))t=[],u=null;else if(Object.prototype.hasOwnProperty.call(a.data,"resize"))for(k=0;k<a.data.resA*a.data.resB;k++)r=b(a),t[k]=D(r.x,r.y,r.w,r.h,a.data.offsetWidth,a.data.offsetHeight,a.data.img);else{{var d=
a.data.img,f=d.length/4;let b;var g;if(null===u||u.length!==f)u=new Uint8ClampedArray(f);for(g=0;g<f;g++){var F=d[4*g];var I=d[4*g+1];b=d[4*g+2];F=(Math.round(F/36.5)<<5)+(Math.round(I/36.5)<<2)+Math.round(b/85);u[g]=F}}for(k=0;k<a.data.resA*a.data.resB;k++)if(r=b(a),z=D(r.x,r.y,r.w,r.h,a.data.offsetWidth,a.data.offsetHeight,u),"undefined"!==typeof t[k]){if(n=G(z,t[k],r.w),!n){if(t[k].length!==z.length)t[k]=z;else for(d=0;d<z.length;d++)t[k][d]=z[d];d=z;f=r;g=a.data.type;I=c(f.x,4);F=c(f.y,4);g=new Uint8ClampedArray(["ss"===
g?103:203,I[0],I[1],F[0],F[1],f.h,f.w]);f=new Uint8ClampedArray(d.length+g.length);f.set(g);f.set(d,g.length);d=f;null===q||void 0===q?q=d:(f=new Uint8ClampedArray(q.length+d.length),f.set(q),f.set(d,q.length),q=f)}}else console.log("====> screen share need full screen "),t[k]=z,m=1;q?(v=c(a.data.uid,8),p=new Uint8ClampedArray(["103","123",v[0],v[1],v[2],v[3]]),A=new Uint8ClampedArray(q.length+p.length),A.set(p),A.set(q,p.length),postMessage({sendMasterSlice:A,needFullScreen:m},[A.buffer]),A=null):
postMessage({masterSlice:null,needFullScreen:m});m=0;q=null}}}.toString(),")()"],{type:"application/javascript"})),sworker=new Worker(screenWorkerBlob);const dtConWorkerBlob=URL.createObjectURL(new Blob(["(",function(){const c=function(){function b(a,b){a=a.replace(/[^A-Za-z0-9\+\/]/g,"");const d=a.length;b=b?Math.ceil((3*d+1>>2)/b)*b:3*d+1>>2;const f=new Uint8Array(b);for(var c,n=0,q=0,r=0;r<d;r++){c=r&3;var z=a.charCodeAt(r);n|=(64<z&&91>z?z-65:96<z&&123>z?z-71:47<z&&58>z?z+4:43===z?62:47===z?63:0)<<6*(3-c);if(3===c||1===d-r){for(c=0;3>c&&q<b;c++,q++)f[q]=n>>>(16>>>c&24)&255;n=0}}return f}function a(a){return 26>a?a+65:52>a?a+71:62>a?a-4:62===
...
d={};let f=0;const g={};let k,m;const n=[];let q=0;class r extends AudioWorkletProcessor{constructor(){super();this.port.onmessage=c}process(b,g){q=n.length=0;for(k in a){b:{b=k;if(null!==a){if(288<=a[b].length){for(;96<=a[b].length;)a[b].shift();d[b]=!0;b=a[b].shift();break b}if(64<=a[b].length){d[b]=!0;b=a[b].shift();break b}if(0<a[b].length&&!0===d[b]){d[b]=!0;b=a[b].shift();break b}d[b]=!1;0===a[b].length&&delete a[b]}b=void 0}if(null!=b)if(q++,1===q)for(var c=0;128>c;c++)n[c]=b[c];else for(c=
0;128>c;c++)n[c]+=b[c]}if(1===q)b=n;else if(1<q){for(b=0;128>b;b++)n[b]/=q;b=n}else b=void 0;if(null!=b)g[0][0].set(b,0),f=b[127];else if(null!==f)for(b=0;128>b;b++)g[0][0][b]=f;return!0}}registerProcessor("worklet-audio-rec",r)}.toString(),")()"],{type:"application/javascript"}));/*
  2018 Suman Bogati  {@link http://vidyamantra.com}
 @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
!function(c,b,a){function d(a){let b=r.className;const d=n._config.classPrefix||"";if(z&&(b=b.baseVal),n._config.enableJSClass)b=b.replace(new RegExp(`(^|\\s)${d}no-js(\\s|$)`),`$1${d}js$2`);n._config.enableClasses&&(b+=` ${d}${a.join(` ${d}`)}`,z?r.className.baseVal=b:r.className=b)}function f(a,b){if("object"===typeof a)for(var g in a)q(a,g)&&f(g,a[g]);else{a=a.toLowerCase();g=a.split(".");let f=n[g[0]];if(2==g.length&&(f=f[g[1]]),"undefined"!==typeof f)return n;b="function"===typeof b?b():b;1==
g.length?n[g[0]]=b:(!n[g[0]]||n[g[0]]instanceof Boolean||(n[g[0]]=new Boolean(n[g[0]])),n[g[0]][g[1]]=b);d([(b&&0!=b?"":"no-")+g.join("-")]);n._trigger(a,b)}return n}var g=[],k=[];const m={_version:"3.5.0",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on(a,b){const d=this;setTimeout(()=>{b(d[a])},0)},addTest(a,b,d){k.push({name:a,fn:b,options:d})},addAsyncTest(a){k.push({name:null,fn:a})}};var n=function(){};n.prototype=m;n=new n;let q;var r=b.documentElement,z="svg"===
r.nodeName.toLowerCase();!function(){const a={}.hasOwnProperty;q="undefined"===typeof a||"undefined"===typeof a.call?function(a,b){return b in a&&"undefined"===typeof a.constructor.prototype[b]}:function(b,d){return a.call(b,d)}}();m._l={};m.on=function(a,b){this._l[a]||(this._l[a]=[]);this._l[a].push(b);Object.prototype.hasOwnProperty.call(n,a)&&setTimeout(()=>{n._trigger(a,n[a])},0)};m._trigger=function(a,b){if(this._l[a]){const d=this._l[a];setTimeout(()=>{let a;for(a=0;a<d.length;a++)(0,d[a])(b)},
...
2E3);this.previous=virtualclass.mvConfig.id}},attachFunction(){let a;const b=document.getElementsByClassName("appOptions");for(let d=0;d<b.length;d++){const f=b[d].getElementsByTagName("a")[0];"virtualclassEditorCodeTool"!==b[d].id&&(a=this,f.onclick=function(){a.initlizer(this)})}},initlizer(a){a=a.parentNode.id.split("virtualclass")[1];if("SessionEndTool"===a)virtualclass.popup.confirmInput(virtualclass.lang.getString("startnewsession"),a=>{a&&(virtualclass.gObj.endSession=!0,localStorage.clear(),
...
virtualclass.wb[f].objInit)},toolInit(a){let d,f,c,g,r;Object.prototype.hasOwnProperty.call(a,"cmd")&&(d=a.cmd);Object.prototype.hasOwnProperty.call(a,"repMode")&&(f=a.repMode);Object.prototype.hasOwnProperty.call(a,"multiUser")&&(c=a.multiUser);Object.prototype.hasOwnProperty.call(a,"myfunc")&&(g=a.myfunc);Object.prototype.hasOwnProperty.call(a,"wbId")&&(r=a.wbId);Object.prototype.hasOwnProperty.call(a,"myfunc")&&(g=a.myfunc);-1>=d.indexOf("_doc_")&&(d+=r);({vcan:a}=virtualclass.wb[r]);0<a.getStates("children").length?
d!==`t_clearall${r}`&&("undefined"!==typeof c&&d===`t_replay${r}`||virtualclass.wb[r].utility.deActiveFrmDragDrop(r),!0!==c&&"t_replay"!==d&&a.renderAll()):a.main.action="create";virtualclass.wb[r].utility.IsObjEmpty(virtualclass.wb[r].obj.freeDrawObj&&!1===c)||(virtualclass.wb[r].obj.freeDrawObj.freesvg=!1);a.main.currUserCommand=`${d}Init`;if(d===`t_activeall${r}`)virtualclass.wb[r].utility.t_activeallInit();else if(d===`t_replay${r}`)"undefined"===typeof c&&a.setValInMain("id",0),"undefined"!==
typeof g?virtualclass.wb[r].t_replayInit(f,r,g):virtualclass.wb[r].t_replayInit(f,r);else if(d===`t_clearall${r}`){let a;"Whiteboard"===virtualclass.currApp?a=virtualclass.lang.getString("clearAllWarnMessageW"):"DocumentShare"===virtualclass.currApp&&(a=virtualclass.lang.getString("clearAllWarnMessageD"));virtualclass.popup.confirmInput(a,a=>{if(!a)return!0;virtualclass.wb[r].utility.t_clearallInit(r);virtualclass.wb[r].utility.makeDefaultValue(d,r);virtualclass.vutil.beforeSend({repObj:[{cmd:"clearAll"}],
cf:"repObj"});delete virtualclass.gObj.wbTool[virtualclass.gObj.currWb];roles.hasControls()&&(virtualclass.wb[r].currStrkSize=virtualclass.gObj.defalutStrk,virtualclass.wb[r].textFontSize=virtualclass.gObj.defalutFont,virtualclass.wb[r].activeToolColor=virtualclass.gObj.defaultcolor,b.querySelector(`#t_color${r} .disActiveColor`).style.backgroundColor=virtualclass.wb[r].activeToolColor,a=b.querySelector(`#tool_wrapper${r}`).dataset.currtool,"triangle"!==a&&"line"!==a&&"oval"!==a&&"rectangle"!==a||
delete b.querySelector(`#tool_wrapper${r}`).dataset.currtool,a=b.querySelector(`#t_strk${r}`),null!=a&&a.classList.remove("show"),a=b.querySelector(`#t_font${r}`),null!=a&&a.classList.remove("show"),a=b.querySelector(`#colorList${virtualclass.gObj.currWb} .selected`),null!=a&&a.classList.remove("selected"),a=b.querySelector(`#t_strk${virtualclass.gObj.currWb} .selected`),null!=a&&(a.classList.remove("selected"),b.querySelector(`.strkSizeList #strk-1${r}`).classList.add("selected")),a=b.querySelector(`#t_font${virtualclass.gObj.currWb} .selected`),
null!=a&&(a.classList.remove("selected"),b.querySelector(`.fontSizeList #font-1${r}`).classList.add("selected")),b.querySelector(`#tool_wrapper${virtualclass.gObj.currWb}.shapesToolbox`).classList.remove("active"),localStorage.removeItem("activeTool"))})}d!==`t_replay${r}`&&d!==`t_clearallInit${r}`&&(virtualclass.wb[r].tool=new virtualclass.wb[r].toolObj(d,r),virtualclass.wb[r].utility.attachEventHandlers(r))},toolObj:function(a,b){-1>=a.indexOf("_doc_")&&(a+=b);this.cmd=a;a!==`t_freeDrawing${b}`&&
...
a);null!=a[0]&&a[0].parentNode.removeChild(a[0])},multiMediaMsg(a){},canvasDrawMsg(a,b){let d;document.getElementById(`vcanvas${b}`).classList.add("canvasMsgBoxParent");"Firefox"===virtualclass.system.mybrowser.name?(d=virtualclass.lang.getString("canvasDrawMsg"),this.displayMessage(d,"canvasDrawMsgContFirefox",this.msgBoxClass+a,"containerWb")):"Chrome"===virtualclass.system.mybrowser.name&&(d=virtualclass.lang.getString("canvasDrawMsg"),this.displayMessage(d,"canvasDrawMsgContChrome",this.msgBoxClass+
a,"containerWb",null,b))},drawLabel(a,b){const d=virtualclass.lang.getString("drawArea");this.displayMessage(d,"canvasDrawArea",this.msgBoxClass+a,"containerWb",!1,b)},displayMsgBox(a,b){const d=this.customCreateElement("div",a),f=this.customCreateElement("p",`${a}Para`);f.innerHTML=virtualclass.lang.getString(b);d.appendChild(f);b=this.customCreateElement("a",`${a}Anchor`);b.href="#";b.innerHTML=virtualclass.lang.getString("reload");b.onclick=function(){c.location.reload()};d.appendChild(b);a=document.getElementById("divForReloadMsg"===
a?"virtualclassCont":"virtualclassAppLeftPanel");a.insertBefore(d,a.firstChild)},displayServerError(a,b){a=this.customCreateElement("div",a);a.innerHTML=b;b=document.getElementById("vcanvas");b.parentNode.insertBefore(a,b)},removeElement(a){a=document.getElementById(a);null!=a&&a.parentNode.removeChild(a)},disableSSUI(){const a=document.getElementById("virtualclassScreenShareTool");null!=a&&(a.style.opacity="0.5",a.style.pointerEvents="none")},disableLeftAppBar(){const a=document.getElementById("virtualclassOptionsCont");
null!=a&&(a.style.opacity="0.5",a.style.pointerEvents="none")}};a=a.init();a.window.resizeFinished=function(){let a=0;return function(b,d){clearTimeout(a);a=setTimeout(b,d)}}();a.window.resize=function(b){b=virtualclass.system.measureResoultion({width:c.innerWidth,height:c.innerHeight});"DocumentShare"===virtualclass.currApp&&(b.width-=10,roles.hasControls()?b.height-=100:b.height-=40);b=virtualclass.gObj.currWb;"undefined"!==typeof b&&"undefined"!==typeof virtualclass.wb[b]&&Object.prototype.hasOwnProperty.call(virtualclass.wb[b],
...
"fitToScreenOnResize")&&clearTimeout(virtualclass.gObj.fitToScreenOnResize),virtualclass.gObj.fitToScreenOnResize=setTimeout(()=>{"ScreenShare"===virtualclass.currApp?virtualclass.ss.triggerFitToScreen():null!=document.querySelector(".zoomControler .fitScreen")&&virtualclass.zoom.zoomAction("fitToScreen")},700);virtualclass.chat.calculateViewPortForMessageBox();virtualclass.gObj.inputFocusHandler&&clearTimeout(virtualclass.gObj.inputFocusHandler);virtualclass.gObj.inputFocusHandler=setTimeout(()=>
{console.log("===> triger input focus");virtualclass.gObj.notHandleInputFocusHandler||("normal"===document.getElementById("virtualclassCont").dataset.currwindow&&(c.innerHeight>=virtualclass.gObj.initHeight?virtualclass.vutil.inputFocusOutHandler():virtualclass.vutil.inputFocusHandler()),c.innerWidth>c.innerHeight&&(virtualclass.gObj.initHeight=c.innerHeight));delete virtualclass.gObj.notHandleInputFocusHandler},1100)};c.view=a})(window);(function(c){let b={init(){this.wbRtc={};this.wbRtc.className="webrtcCont";this.mybrowser={}},isCanvasSupport(a,b,f){return"MSIE"===b?9===f:!!c.CanvasRenderingContext2D},isWebSocketSupport(){return c.WebSocket&&("function"===typeof c.WebSocket||"object"===typeof c.WebSocket)&&Object.prototype.hasOwnProperty.call(c.WebSocket,"OPEN")},isLocalStorageSupport(){return void 0!==Storage},isGetUserMediaSupport(){navigator.getUserMedia=navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||
...
b?"none":"block";document.getElementById("dataInfoHeading").style.display=b;var a=document.getElementById("packetContainer");a.style.display=b;a=document.getElementById("informationCont");a.style.display=b}}}})(window);(function(c){c.draw_object=function(b,a,d,f){const c=this;d.started=!1;let k,m,n=[];const {vcan:q}=virtualclass.wb[f];d.mousedown=function(a,b){d._mousedown(a,b)};d.mousemove=function(a,b,f){d._mousemove(a,b,f)};d.mouseup=function(a,b){d._mouseup(a,b)};d.touchstart=function(a,b){d._mousedown(a,b);a.preventDefault()};d.touchmove=function(a,b,f){d._mousemove(a,b,f);a.preventDefault()};d.touchend=function(a,b){d._mouseup(a,b);a.preventDefault()};d._mousedown=function(a,f){(new Date).getTime();Object.prototype.hasOwnProperty.call(a.detail,
...
c,y:b.mt.y-d},bl:{x:b.mt.x-c,y:b.mt.y+d},br:{x:b.mt.x+d,y:b.mt.y+c}};b.mr.corner={tl:{x:b.mr.x-d,y:b.mr.y-c},tr:{x:b.mr.x+c,y:b.mr.y-d},bl:{x:b.mr.x-c,y:b.mr.y+d},br:{x:b.mr.x+d,y:b.mr.y+c}};b.mb.corner={tl:{x:b.mb.x-d,y:b.mb.y-c},tr:{x:b.mb.x+c,y:b.mb.y-d},bl:{x:b.mb.x-c,y:b.mb.y+d},br:{x:b.mb.x+d,y:b.mb.y+c}};b.mtr.corner={tl:{x:b.mtr.x-d+f*this.rotatingPointOffset,y:b.mtr.y-c-q*this.rotatingPointOffset},tr:{x:b.mtr.x+c+f*this.rotatingPointOffset,y:b.mtr.y-d-q*this.rotatingPointOffset},bl:{x:b.mtr.x-
c+f*this.rotatingPointOffset,y:b.mtr.y+d-q*this.rotatingPointOffset},br:{x:b.mtr.x+d+f*this.rotatingPointOffset,y:b.mtr.y+c-q*this.rotatingPointOffset}}};b.getAngle=function(){return 180*this.theta/Math.PI};b.setZindex=function(){for(let d=0;d<a.main.children.length;d++)if(this.id===a.main.children[d].id){var b=a.main.children[d];a.main.children.splice(d,1);break}return b?(a.main.children.push(b),!0):!1};b.setupCurrentTransform=function(b,d){const c=a.main;let f="drag";const g=a.utility.actualPointer(b,
d);if(b=this.findTargetCorner(b,d))f="ml"===b||"mr"===b?"scaleX":"mt"===b||"mb"===b?"scaleY":"mtr"===b?"rotate":this.hasRotatingPoint?"scale":"rotate";c.currentTransform={target:this,action:f,scaleX:this.scaleX,scaleY:this.scaleY,offsetX:g.x-this.x,offsetY:g.y-this.y,ex:g.x,ey:g.y,x:this.x,y:this.y,theta:this.theta,width:this.width*this.scaleX};c.currentTransform.original={x:this.x,y:this.y}};"text"!==b.type&&b.setCoords();return a.makeDispObject(b)}}}})(window);(function(c){c.Events=function(b){const {vcan:a}=virtualclass.wb[b];a.events=function(){return{bind(a,b,c){a[`on${b}`]=c},findTarget(b,c){let d;const f=a.main.children;for(let g=f.length;g--;)if(f[g]&&a.virtual_box.containsPoint(b,f[g],c)){d=f[g];break}if(d&&d.selectable)return d}}}}})(window);(function(c){c.Virtualbox=function(b){const {vcan:a}=virtualclass.wb[b];a.virtual_box={findCrossPoints(a,b,c){let d;let f=0;for(const k in c){var g=c[k];if(!(g.o.y<b&&g.d.y<b||g.o.y>=b&&g.d.y>=b)){if(g.o.x===g.d.x&&g.o.x>=a)var q=g.o.x;else q=(g.d.y-g.o.y)/(g.d.x-g.o.x),d=b-0*a,g=g.o.y-q*g.o.x,q=-(d-g)/(0-q);q>=a&&(f+=1);if(2===f)break}}return f},getImageLines(a,b){return{topline:{o:a.tl,d:a.tr},rightline:{o:a.tr,d:a.br},bottomline:{o:a.br,d:a.bl},leftline:{o:a.bl,d:a.tl}}},containsPoint(b,c,g){var d=
a.utility.getReltivePoint(b,g),{x:f}=d;({y:d}=d);const n=a.virtual_box.getImageLines(c.oCoords);return(f=a.virtual_box.findCrossPoints(f,d,n))&&1===f%2||c.findTargetCorner(b,g)?!0:!1}}}})(window);(function(c){c.Interact=function(b){const {vcan:a}=virtualclass.wb[b];a.interact={rotateObject(b,c){const d=a.main.currentTransform,f=a.main.offset;d.target.lockRotation||a.utility.setVal(d.target,"theta",Math.atan2(c-d.y-f.y,b-d.x-f.x)-Math.atan2(d.ey-d.y-f.y,d.ex-d.x-f.x)+d.theta)},scaleObject(b,c,g){const d=a.main.currentTransform,{offset:f}=a.main,{target:n}=d;if(!n.lockScalingX||!n.lockScalingY){var q=Math.sqrt(Math.pow(d.ey-d.y-f.y,2)+Math.pow(d.ex-d.x-f.x,2));b=Math.sqrt(Math.pow(c-d.y-f.y,
2)+Math.pow(b-d.x-f.x,2));n.scaling=!0;g?"x"!==g||n.lockUniScaling?"y"!==g||n.lockUniScaling||n.lockScalingY||a.utility.setVal(n,"scaleY",d.scaleY*b/q):n.lockScalingX||a.utility.setVal(n,"scaleX",d.scaleX*b/q):(n.lockScalingX||a.utility.setVal(n,"scaleX",d.scaleX*b/q),n.lockScalingY||a.utility.setVal(n,"scaleY",d.scaleY*b/q))}},translateObject(b,c){const {target:d}=a.main.currentTransform;d.lockMovementX||a.utility.setVal(d,"x",b-a.main.currentTransform.offsetX);d.lockMovementY||a.utility.setVal(d,
...
a.moveTo(-c,d);a.lineTo(0,-d);a.lineTo(c,d);a.lineWidth=b.stroke;a.strokeStyle=b.color;a.closePath();null!=b.fillStyle&&(a.fillStyle=b.fillStyle,a.fill());a.stroke()}}}}})(window);(function(c){c.Line=function(b){({vcan:b}=virtualclass.wb[b]);b.line=function(){return{type:"line",init(a){const b=a.start.x,c=a.start.y,g=a.end.x,k=a.end.y;null==a.width&&(a.width=g-b,a.height=k-c);a.x=b+(g-b)/2;a.y=c+(k-c)/2;return a},draw(a,b,c){a.beginPath();c=1===b.width?0:b.width/2;const d=1===b.height?0:b.height/2;a.moveTo(1===b.width?0:-b.width/2,1===b.height?0:-b.height/2);a.lineTo(c,d);a.lineWidth=b.stroke;null!=b.lineColor&&(a.strokeStyle=b.lineColor);a.strokeStyle=b.color;a.closePath();
a.stroke()}}}}})(window);(function(c){c.Text=function(b){({vcan:b}=virtualclass.wb[b]);b.text=function(){return{type:"text",init(b){b.lineHeight=1.3;null==b.fontSize&&(b.fontSize=30);b.fontSize*=virtualclass.zoom.canvasScale;b.font=`${b.fontSize}px Times New Roman`;return b},draw(b,d,c){({fontSize:c}=d);b.font=`${c}px Times New Roman`;b.fillStyle=d.color;c=d.text.split(/\r?\n/);d.height=this.getTextHeight(b,c,d);d.width=this.getTextWidth(b,c);b.beginPath();for(let a=0,f=c.length;a<f;a++)b.fillText(c[a],-d.width/2,-d.height/
...
this);this.overlayFill?b.fillStyle=this.overlayFill:this.fill&&(b.fillStyle=this.fill);this.stroke&&(b.strokeStyle=this.stroke);b.beginPath();this._render(b);this.fill&&b.fill();this.stroke&&(b.strokeStyle=this.stroke,b.lineWidth=this.strokeWidth,b.lineCap=b.lineJoin="round",b.stroke());!d&&this.active&&(this.drawBorders(b),this.hideCorners||this.drawCorners(b));b.restore()},_parsePath(){const b=[];let a;for(var d=0,c,f=this.path.length;d<f;d++){const f=/\d+\s$/.exec(this.path[d]);if(null!=f){var r=
this.path[d].indexOf(f);this.path[d]=this.path[d].substring(0,r)}r=this.path[d];var z=r.slice(1).trim().replace(/(\d)-/g,"$1###-").split(/\s|,|###/);r=[r.charAt(0)];c=0;for(var u=z.length;c<u;c++)a=parseFloat(z[c]),isNaN(a)||r.push(a);z=r[0].toLowerCase();z=this.commandLengths[z];if(r.length-1>z)for(let a=1,d=r.length;a<d;a+=z)null==f?b.push([r[0]].concat(r.slice(a,a+z))):(b.push([r[0]].concat(r.slice(a,a+z))),r.push(f),b.push(r));else null!=f&&r.push(f[0]),b.push(r)}return b},_parseDimensions(){const b=
[],a=[];let d,f,q=!1,r,z;this.path.forEach(function(c,g){if(c[3])var k=c.splice(3);"H"!==c[0]&&(d=0===g?this.utility.getX(c):this.utility.getX(this.path[g-1]));"V"!==c[0]&&(f=0===g?this.utility.getY(c):this.utility.getY(this.path[g-1]));c[0]===c[0].toLowerCase()&&(q=!0);r=q?d+this.utility.getX(c):"V"===c[0]?d:this.utility.getX(c);z=q?f+this.utility.getY(c):"H"===c[0]?f:this.utility.getY(c);g=parseInt(r,10);isNaN(g)||b.push(g);g=parseInt(z,10);isNaN(g)||a.push(g);null!=k&&1<=k.length&&c.push(k[0])},
...
var m="";if("undefined"===typeof c){c=f.getElementsByTagName("textarea");for(var n=0;n<c.length;n++)if(c[n].id===`${f.id}textarea`){m=c[n].value;break}}else m=c;b.font="20px Times New Roman";b.fillStyle=this.prvCurrTransform.color;const q=m.split(/\r?\n/);var r=b.measureText(q[0]).width+20;c=15;for(n=1;n<q.length;n++){c+=15;const a=b.measureText(q[n]).width;a>r&&(r=a)}r/=2;n=(new Date).getTime();b={type:"text",text:m,x:a.measure.x+r*virtualclass.zoom.canvasScale,y:a.measure.y+c*virtualclass.zoom.canvasScale,
...
c){return-1!=={offer:{setLocalDescription:["stable","have-local-offer"],setRemoteDescription:["stable","have-remote-offer"]},answer:{setLocalDescription:["have-remote-offer","have-local-pranswer"],setRemoteDescription:["have-local-offer","have-remote-pranswer"]}}[d][a].indexOf(c)}function q(a,d){const c=a.getRemoteCandidates().find(a=>d.foundation===a.foundation&&d.ip===a.ip&&d.port===a.port&&d.priority===a.priority&&d.protocol===a.protocol&&d.type===a.type);c||a.addRemoteCandidate(d);return!c}function r(a,
...
a}),this.transceivers.forEach((a,c)=>{d._gather(a.mid,c)});else if("answer"===a.type){c=p.splitSections(d.remoteDescription.sdp);f=c.shift();const a=0<p.matchPrefix(f,"a=ice-lite").length;c.forEach((c,g)=>{const k=d.transceivers[g],{iceGatherer:n}=k,{iceTransport:q}=k,{dtlsTransport:D}=k,{localCapabilities:r}=k,{remoteCapabilities:v}=k;if(!(p.isRejected(c)&&0===p.matchPrefix(c,"a=bundle-only").length||k.isDatachannel)){const t=p.getIceParameters(c,f);c=p.getDtlsParameters(c,f);a&&(c.role="server");
d.usingBundle&&0!==g||(d._gather(k.mid,g),"new"===q.state&&q.start(n,t,a?"controlling":"controlled"),"new"===D.state&&D.start(c));g=m(r,v);d._transceive(k,0<g.codecs.length,!1)}})}this.localDescription={type:a.type,sdp:a.sdp};switch(a.type){case "offer":this._updateSignalingState("have-local-offer");break;case "answer":this._updateSignalingState("stable");break;default:throw new TypeError(`unsupported type "${a.type}"`);}return Promise.resolve()};c.prototype.setRemoteDescription=function(c){const f=
this;if(!n("setRemoteDescription",c.type,this.signalingState)||this._isClosed)return Promise.reject(t("InvalidStateError",`Can not set remote ${c.type} in state ${f.signalingState}`));const g={};this.remoteStreams.forEach(a=>{g[a.id]=a});const k=[],m=p.splitSections(c.sdp),D=m.shift(),v=0<p.matchPrefix(D,"a=ice-lite").length,G=0<p.matchPrefix(D,"a=group:BUNDLE ").length;this.usingBundle=G;const A=p.matchPrefix(D,"a=ice-options:")[0];this.canTrickleIceCandidates=A?0<=A.substr(14).split(" ").indexOf("trickle"):
!1;m.forEach((m,n)=>{var t=p.splitLines(m),u=p.getKind(m),A=p.isRejected(m)&&0===p.matchPrefix(m,"a=bundle-only").length,F=t[0].substr(2).split(" ")[2];t=p.getDirection(m,D);const C=p.parseMsid(m);var B=p.getMid(m)||p.generateIdentifier();if("application"===u&&"DTLS/SCTP"===F)f.transceivers[n]={mid:B,isDatachannel:!0};else{var H=p.parseRtpParameters(m);if(!A){var M=p.getIceParameters(m,D);var I=p.getDtlsParameters(m,D);I.role="client"}F=p.parseRtpEncodingParameters(m);var N=p.parseRtcpParameters(m),
O=0<p.matchPrefix(m,"a=end-of-candidates",D).length,L=p.matchPrefix(m,"a=candidate:").map(a=>p.parseCandidate(a)).filter(a=>1===a.component);("offer"===c.type||"answer"===c.type)&&!A&&G&&0<n&&f.transceivers[n]&&(f._disposeIceAndDtlsTransports(n),f.transceivers[n].iceGatherer=f.transceivers[0].iceGatherer,f.transceivers[n].iceTransport=f.transceivers[0].iceTransport,f.transceivers[n].dtlsTransport=f.transceivers[0].dtlsTransport,f.transceivers[n].rtpSender&&f.transceivers[n].rtpSender.setTransport(f.transceivers[0].dtlsTransport),
f.transceivers[n].rtpReceiver&&f.transceivers[n].rtpReceiver.setTransport(f.transceivers[0].dtlsTransport));if("offer"!==c.type||A)"answer"!==c.type||A||(E=f.transceivers[n],K=E.iceGatherer,u=E.iceTransport,B=E.dtlsTransport,J=E.rtpReceiver,A=E.sendEncodingParameters,m=E.localCapabilities,f.transceivers[n].recvEncodingParameters=F,f.transceivers[n].remoteCapabilities=H,f.transceivers[n].rtcpParameters=N,L.length&&"new"===u.state&&(!v&&!O||G&&0!==n?L.forEach(a=>{q(E.iceTransport,a)}):u.setRemoteCandidates(L)),
G&&0!==n||("new"===u.state&&u.start(K,M,"controlling"),"new"===B.state&&B.start(I)),f._transceive(E,"sendrecv"===t||"recvonly"===t,"sendrecv"===t||"sendonly"===t),!J||"sendrecv"!==t&&"sendonly"!==t?delete E.rtpReceiver:(t=J.track,C?(g[C.stream]||(g[C.stream]=new a.MediaStream),r(t,g[C.stream]),k.push([t,J,g[C.stream]])):(g.default||(g.default=new a.MediaStream),r(t,g.default),k.push([t,J,g.default]))));else{var E=f.transceivers[n]||f._createTransceiver(u);E.mid=B;E.iceGatherer||(E.iceGatherer=f._createIceGatherer(n,
G));L.length&&"new"===E.iceTransport.state&&(!O||G&&0!==n?L.forEach(a=>{q(E.iceTransport,a)}):E.iceTransport.setRemoteCandidates(L));m=a.RTCRtpReceiver.getCapabilities(u);15019>d&&(m.codecs=m.codecs.filter(a=>"rtx"!==a.name));A=E.sendEncodingParameters||[{ssrc:1001*(2*n+2)}];M=!1;if("sendrecv"===t||"sendonly"===t){M=!E.rtpReceiver;var J=E.rtpReceiver||new a.RTCRtpReceiver(E.dtlsTransport,u);if(M){t=J.track;if(!C||"-"!==C.stream)if(C){g[C.stream]||(g[C.stream]=new a.MediaStream,Object.defineProperty(g[C.stream],
"id",{get(){return C.stream}}));Object.defineProperty(t,"id",{get(){return C.track}});var K=g[C.stream]}else g.default||(g.default=new a.MediaStream),K=g.default;K&&(r(t,K),E.associatedRemoteMediaStreams.push(K));k.push([t,J,K])}}else E.rtpReceiver&&E.rtpReceiver.track&&(E.associatedRemoteMediaStreams.forEach(a=>{const d=a.getTracks().find(a=>a.id===E.rtpReceiver.track.id);d&&z(d,a)}),E.associatedRemoteMediaStreams=[]);E.localCapabilities=m;E.remoteCapabilities=H;E.rtpReceiver=J;E.rtcpParameters=
N;E.sendEncodingParameters=A;E.recvEncodingParameters=F;f._transceive(f.transceivers[n],!1,M)}}});void 0===this._dtlsRole&&(this._dtlsRole="offer"===c.type?"active":"passive");this.remoteDescription={type:c.type,sdp:c.sdp};switch(c.type){case "offer":this._updateSignalingState("have-remote-offer");break;case "answer":this._updateSignalingState("stable");break;default:throw new TypeError(`unsupported type "${c.type}"`);}Object.keys(g).forEach(d=>{const c=g[d];if(c.getTracks().length){if(-1===f.remoteStreams.indexOf(c)){f.remoteStreams.push(c);
...
c.webkitAudioContext)});if(!v){const a=new MessageChannel;workerIO.postMessage({cmd:"workerAudioRec"},[a.port1]);workerAudioRec.postMessage({cmd:"workerIO",sampleRate:this.Html5Audio.audioContext.sampleRate},[a.port2]);workerAudioRec.postMessage({cmd:"audioWorklet",msg:!1});workerAudioRec.onmessage=function(a){switch(a.data.cmd){case "noAudioWorklet":virtualclass.media.audio.queueWithFalback(a.data.msg.data,a.data.msg.uid),virtualclass.media.audio.playWithFallback(a.data.msg.uid)}};v=!0;virtualclass.gObj.audioRecWorkerReady=
!0}},initPlay(){Object.prototype.hasOwnProperty.call(this,"Html5Audio")||this.Html5Audio||(this.Html5Audio={audioContext:new (c.AudioContext||c.webkitAudioContext)});"object"!==typeof t&&g.audio.Html5Audio.audioContext.audioWorklet.addModule(workletAudioRecBlob).then(()=>{if("undefined"===typeof p){t=new AudioWorkletNode(g.audio.Html5Audio.audioContext,"worklet-audio-rec");g.audio.Html5Audio.MediaStreamDest=g.audio.Html5Audio.audioContext.createMediaStreamDestination();t.connect(g.audio.Html5Audio.audioContext.destination);
"Chrome"===virtualclass.system.mybrowser.name&&g.audio.bug_687574_callLocalPeers();var a=new MessageChannel;workerIO.postMessage({cmd:"workerAudioRec"},[a.port1]);workerAudioRec.postMessage({cmd:"workerIO",sampleRate:g.audio.Html5Audio.audioContext.sampleRate},[a.port2]);a=new MessageChannel;workerAudioRec.postMessage({cmd:"workletAudioRec"},[a.port1]);t.port.postMessage({cmd:"workerAudioRec"},[a.port2]);workerAudioRec.postMessage({cmd:"audioWorklet",msg:!0});p=!0;virtualclass.gObj.audioRecWorkerReady=
...
delete this.audioSuspendTime)},innerPlayWithFallback(){const a=this;if(null===virtualclass.media.audioPlayerNode||"closed"===virtualclass.media.audioPlayerNode.context.state)null!==virtualclass.media.audioPlayerNode&&virtualclass.media.audioPlayerNode.disconnect(),virtualclass.media.audioPlayerNode=this.Html5Audio.audioContext.createScriptProcessor(4096,1,1),A=0,virtualclass.media.audioPlayerNode.onaudioprocess=function(b){b=b.outputBuffer.getChannelData(0);var d=a.getMergedAudio();if(null!==d&&void 0!==
d){for(let a=0;a<d.length;a++)b[a]=d[a];A=d[4095]}else for(d=0;d<b.length;d++)b[d]=A},virtualclass.media.audioPlayerNode.connect(this.Html5Audio.audioContext.destination)},queueWithFalback(a,b){null==k[b]&&(k[b]=[]);null==n[b]&&(n[b]=[]);for(let d=0;d<a.length;d++)n[b].push(a[d]);for(;4096<=n[b].length;)a=n[b].splice(0,4096),k[b].push(new Float32Array(a))},getMergedAudio(){r=[];z=0;for(q in k){var a=this.getAudioChunks(q);if(null!=a)if(z++,1===z)for(var b=0;4096>b;b++)r[b]=a[b];else for(b=0;4096>
b;b++)r[b]+=a[b]}if(1===z)return r;if(1<z){for(a=0;4096>a;a++)r[a]/=z;return r}},getAudioChunks(a){if(null!==k){if(9<=k[a].length){for(;3<=k[a].length;)k[a].shift();m[a]=!0;return k[a].shift()}if(2<=k[a].length||0<k[a].length&&!0===m[a])return m[a]=!0,k[a].shift();m[a]=!1;0===k[a].length&&delete k[a]}},actualManiPulateStream(){this.triggermaniPulateStream=!0;const a=virtualclass.media;setTimeout(()=>{a.detectAudioWorklet()?a.audio.maniPulateStream():a.audio.maniPulateStreamWithFallback()},1E3)},maniPulateStream(){const {stream:a}=
g;"undefined"!==typeof u&&u.disconnect();"undefined"!==typeof a&&null!=a&&g.audio.Html5Audio.audioContext.audioWorklet.addModule(workletAudioSendBlob).then(()=>{var d=g.audio.Html5Audio.audioContext.createMediaStreamSource(a);const c=g.audio.Html5Audio.audioContext.createBiquadFilter();c.type="lowpass";c.frequency.value=2E3;d.connect(c);u=new AudioWorkletNode(g.audio.Html5Audio.audioContext,"worklet-audio-send");u.onprocessorerror=function(a){g.audio.notifiyMuteAudio()};c.connect(u);u.connect(g.audio.Html5Audio.audioContext.destination);
...
0,b.tempVid.width,b.tempVid.height);b.tempVidCont.drawImage(b.myVideo,0,0,b.width,b.height);roles.hasControls();virtualclass.system.webpSupport?(d=b.tempVid.toDataURL("image/webp",.6),c=1):(d=b.tempVid.toDataURL("image/jpeg",.3),c=0);d=virtualclass.videoHost.convertDataURIToBinary(d);if(!virtualclass.videoHost.gObj.stdStopSmallVid&&(!roles.hasControls()||roles.hasControls()&&virtualclass.videoHost.gObj.videoSwitch)){var m=virtualclass.gObj.uid.toString();for(var n=m.length;8>n;n++)m=`0${m}`;m=m.match(/[\S]{1,2}/g)||
[];m=new Uint8ClampedArray([11,m[0],m[1],m[2],m[3],c]);n=new Uint8ClampedArray(d.length+m.length);n.set(m);n.set(d,m.length);k.sendInBinary(n)}clearInterval(virtualclass.media.smallVid);if(Object.prototype.hasOwnProperty.call(virtualclass,"connectedUsers"))if(m=f+2500*virtualclass.connectedUsers.length,g!==virtualclass.connectedUsers.length){g=virtualclass.connectedUsers.length;n=-1;for(var q=0;q<virtualclass.connectedUsers.length;q++)virtualclass.connectedUsers[0].userid===virtualclass.gObj.uid&&
(n=q);q=m/g;0>n&&(n=0);virtualclass.media.smallVid=setInterval(a,m+n*q)}else virtualclass.media.smallVid=setInterval(a,m)}Object.prototype.hasOwnProperty.call(virtualclass.media,"smallVid")&&clearInterval(virtualclass.media.smallVid);const b=this;let d,c;f=Math.floor(5001*Math.random()+3E3);let g=-1;const k=this;virtualclass.media.smallVid=setInterval(a,f)},startToStream(){g.video.calcDimension();g.video.send()},playWithoutSlice(a,b,d){this.remoteVid=document.getElementById(`video${a}`);null!=this.remoteVid&&
...
virtualclass.system.mediaDevices.webcamErr.push("nopermission");g.video.tempStream=a;g.audio.init();g.audio.attachAudioStopHandler(a);b=chatContainerEvent.elementFromShadowDom(`#ml${virtualclass.gObj.uid}`);null!=b&&null!=b.getElementsByTagName("video")&&g.innerHandleUserMedia(virtualclass.gObj.uid);roles.hasAdmin()&&virtualclass.videoHost.isDomReady(()=>{virtualclass.videoHost.renderSelfVideo(a)});virtualclass.settings.userVideoIcon();null==localStorage.getItem("prevApp")&&(roles.hasControls()?virtualclass.vutil.videoHandler("off"===
...
6,b=>LZString._keyStrUriSafe.charAt(b))},decompressFromEncodedURIComponent(c){if(null==c)return"";if(""==c)return null;c=c.replace(/ /g,"+");return LZString._decompress(c.length,32,b=>LZString._getBaseValue(LZString._keyStrUriSafe,c.charAt(b)))},compress(c){return LZString._compress(c,16,b=>String.fromCharCode(b))},_compress(c,b,a){if(null==c)return"";let d,f;const g={},k={};let m,n,q="",r=2,z=3,u=2;const t=[];let p=0,v=0,A;for(A=0;A<c.length;A+=1)if(m=c[A],Object.prototype.hasOwnProperty.call(g,
m)||(g[m]=z++,k[m]=!0),n=q+m,Object.prototype.hasOwnProperty.call(g,n))q=n;else{if(Object.prototype.hasOwnProperty.call(k,q)){if(256>q.charCodeAt(0)){for(d=0;d<u;d++)p<<=1,v==b-1?(v=0,t.push(a(p)),p=0):v++;f=q.charCodeAt(0);for(d=0;8>d;d++)p=p<<1|f&1,v==b-1?(v=0,t.push(a(p)),p=0):v++,f>>=1}else{f=1;for(d=0;d<u;d++)p=p<<1|f,v==b-1?(v=0,t.push(a(p)),p=0):v++,f=0;f=q.charCodeAt(0);for(d=0;16>d;d++)p=p<<1|f&1,v==b-1?(v=0,t.push(a(p)),p=0):v++,f>>=1}r--;0==r&&(r=Math.pow(2,u),u++);delete k[q]}else for(f=
g[q],d=0;d<u;d++)p=p<<1|f&1,v==b-1?(v=0,t.push(a(p)),p=0):v++,f>>=1;r--;0==r&&(r=Math.pow(2,u),u++);g[n]=z++;q=String(m)}if(""!==q){if(Object.prototype.hasOwnProperty.call(k,q)){if(256>q.charCodeAt(0)){for(d=0;d<u;d++)p<<=1,v==b-1?(v=0,t.push(a(p)),p=0):v++;f=q.charCodeAt(0);for(d=0;8>d;d++)p=p<<1|f&1,v==b-1?(v=0,t.push(a(p)),p=0):v++,f>>=1}else{f=1;for(d=0;d<u;d++)p=p<<1|f,v==b-1?(v=0,t.push(a(p)),p=0):v++,f=0;f=q.charCodeAt(0);for(d=0;16>d;d++)p=p<<1|f&1,v==b-1?(v=0,t.push(a(p)),p=0):v++,f>>=1}r--;
0==r&&(r=Math.pow(2,u),u++);delete k[q]}else for(f=g[q],d=0;d<u;d++)p=p<<1|f&1,v==b-1?(v=0,t.push(a(p)),p=0):v++,f>>=1;r--;0==r&&u++}f=2;for(d=0;d<u;d++)p=p<<1|f&1,v==b-1?(v=0,t.push(a(p)),p=0):v++,f>>=1;for(;;)if(p<<=1,v==b-1){t.push(a(p));break}else v++;return t.join("")},decompress(c){return null==c?"":""==c?null:LZString._decompress(c.length,32768,b=>c.charCodeAt(b))},_decompress(c,b,a){const d=[];let f=4,g=4,k=3;const m=[];var n;let q,r,z,u;const t=LZString._f;var p=a(0),v=b,A=1;for(n=0;3>n;n+=
1)d[n]=n;q=0;z=Math.pow(2,2);for(u=1;u!=z;)r=p&v,v>>=1,0==v&&(v=b,p=a(A++)),q|=(0<r?1:0)*u,u<<=1;switch(q){case 0:q=0;z=Math.pow(2,8);for(u=1;u!=z;)r=p&v,v>>=1,0==v&&(v=b,p=a(A++)),q|=(0<r?1:0)*u,u<<=1;var D=t(q);break;case 1:q=0;z=Math.pow(2,16);for(u=1;u!=z;)r=p&v,v>>=1,0==v&&(v=b,p=a(A++)),q|=(0<r?1:0)*u,u<<=1;D=t(q);break;case 2:return""}n=d[3]=D;for(m.push(D);;){if(A>c)return"";q=0;z=Math.pow(2,k);for(u=1;u!=z;)r=p&v,v>>=1,0==v&&(v=b,p=a(A++)),q|=(0<r?1:0)*u,u<<=1;switch(D=q){case 0:q=0;z=Math.pow(2,
8);for(u=1;u!=z;)r=p&v,v>>=1,0==v&&(v=b,p=a(A++)),q|=(0<r?1:0)*u,u<<=1;d[g++]=t(q);D=g-1;f--;break;case 1:q=0;z=Math.pow(2,16);for(u=1;u!=z;)r=p&v,v>>=1,0==v&&(v=b,p=a(A++)),q|=(0<r?1:0)*u,u<<=1;d[g++]=t(q);D=g-1;f--;break;case 2:return m.join("")}0==f&&(f=Math.pow(2,k),k++);if(d[D])D=d[D];else if(D===g)D=n+n[0];else return null;m.push(D);d[g++]=n+D[0];f--;n=D;0==f&&(f=Math.pow(2,k),k++)}}};"undefined"!==typeof module&&null!=module&&(module.exports=LZString);window.addEventListener("message",c=>{if(c.origin===window.location.origin)if("gotScreen"===c.data.type){let b;if(""===c.data.sourceId){virtualclass.vutil.beforeSend({sd:!0,cf:"colorIndicator"});c=Error("NavigatorUserMediaError");c.name="PERMISSION_DENIED";if(Object.prototype.hasOwnProperty.call(virtualclass,"ss"))virtualclass.ss.onError(c);if("SharePresentation"===virtualclass.currApp||"DocumentShare"===virtualclass.currApp)c=document.querySelector("#dashboardnav button"),null!=c&&c.click();roles.hasControls()&&
...
!0,virtualclass.media.audio.receivedAudioProcess(virtualclass.gObj.audioPlayMessage))},async beforeLoad(){if(!virtualclass.isPlayMode)if(roles.hasControls()&&null!==document.querySelector("#virtualclassAppRightPanel.vidShow")&&ioAdapter.mustSend({congCtr:{videoSwitch:"off"},cf:"congController"}),virtualclass.gObj.prvRequestScreenUser&&virtualclass.config.makeWebSocketReady&&ioAdapter.mustSendUser({cancel:!0,cf:"reqscreen"},virtualclass.gObj.prvRequestScreenUser),virtualclass.userInteractivity.rendererObj.noteEvent&&
(console.log("====> send note on page load"),virtualclass.userInteractivity.handler(virtualclass.userInteractivity.rendererObj.noteEvent)),virtualclass.gObj.windowLoading=!0,Object.prototype.hasOwnProperty.call(virtualclass.recorder,"doSessionClear"))virtualclass.clearSession();else if(0===localStorage.length)virtualclass.storage.clearStorageData();else{localStorage.removeItem("otherRole");Object.prototype.hasOwnProperty.call(virtualclass.gObj,"audIntDisable")||virtualclass.media.audio.studentNotSpeak();
...
virtualclass.vutil.removeBecomeTeacherWidget();setTimeout(()=>{virtualclass.vutil.isOrginalTeacherExist(virtualclass.jId)||virtualclass.vutil.overrideRoles("t");c.location.reload()},virtualclass.gObj.mySetTime)},overrideRoles(b){virtualclass.uInfo.userobj.role=b;virtualclass.gObj.uRole=virtualclass.uInfo.userobj.role;wbUser.role=virtualclass.uInfo.userobj.role;const a=document.getElementById("virtualclassCont");virtualclass.vutil.overrideRolesFromElem(a,b)},overrideRolesFromElem(b,a){"s"===a?(b.classList.remove("teacher"),
...
a&&(b.classList.remove("student"),b.classList.remove("educator"),b.classList.remove("presenter"),b.classList.add("teacher"),b.classList.add("orginalTeacher"))},sesionEndMsgBoxIsExisting(){const b=document.getElementById("sessionEndMsgCont");return b.hasAttribute("data-displaying")&&"true"===b.dataset.displaying},removeVideoHostContainer(){const b=document.getElementById("videoHostContainer");null!=b&&b.parentNode.removeChild(b)},createDummyUser(b){let a=b;a=a?b:5E3;let d,c=0,g=31;const k=setInterval(()=>
{c>a?clearInterval(k):(g+=c,d={joinUser:{key:g},message:[{lname:" ",name:`User${g}`,role:"s",userid:g}],newuser:null,type:"member_added",user:!0},c++,virtualclass.ioEventApi.readyto_member_add(d))},1)},getVisibleHeightElem(b){var a=$(b);b=$(c).scrollTop();const d=b+$(c).height(),f=a.offset().top;a=f+a.outerHeight();return(a>d?d:a)-(f<b?b:f)},applyHeight(b){b=document.getElementById("virtualclassAppRightPanel");const a=this.getVisibleHeightElem("virtualclassCont");b.style.height=null!=a?a:c.innerHeight},
insertIntoLeftBar(b){const a=document.querySelector("#virtualclassApp #virtualclassAppLeftPanel");null!=a?a.appendChild(b):alert("Error:- There is no Element to insert it.")},getWhiteboardId(b){b=b.closest(".vcanvas");if(null!=b)return b.dataset.wbId;alert("doc element is null")},getElementOffset(b){let a=0,d=0;do a+=b.offsetTop||0,d+=b.offsetLeft||0,b=b.offsetParent;while(b);return{x:d,y:a}},updateCurrentDoc(b){virtualclass.gObj.currWb=`_doc_${b}_${b}`},getParentTag(b,a){return b.closest(a)},attachEventToUploadTab(b,
a,d){b=document.getElementById("newDocBtn");null!=b&&(b.removeEventListener("click",virtualclass.vutil._attachEventToUploadTab),b.addEventListener("click",virtualclass.vutil._attachEventToUploadTab))},_attachEventToUploadTab(){var b=document.querySelector("#DocumentShareDashboard .qq-upload-button-selector.qq-upload-button input");if(null!=b){if(b.click(),b=document.querySelector("#DocumentShareDashboard .qq-upload-list-selector.qq-upload-list"))b.style.display="block"}else alert("Element is null")},
attachEventToUpload(b,a,d){b=document.getElementById("uploadVideo");null!=b&&b.addEventListener("click",()=>{const a=document.querySelector("#VideoDashboard .qq-upload-button-selector.qq-upload-button input");null!=a?a.click():alert("Element is null")})},modalPopup(b,a){const d={};if("video"===b){const a=document.querySelector("#listvideo .playing");a&&(this.currPlaying=a.getAttribute("data-rid"));d.validation="mp4 avi wmv mov webm mkv vob mpeg".split(" ");d.cb=virtualclass.videoUl.afterUploadVideo;
d.cthis="video";d.maxSize=512E6;d.requesteEndPoint=`${c.webapi}&methodname=file_save&live_class_id=${virtualclass.gObj.congCourse}&status=1&content_type_id=2&user=${virtualclass.gObj.uid}`}else d.validation="doc docx txt html csv pdf ppt pptx xls xlsx xlt png jpg gif svg tiff rtf xpm".split(" "),d.cb=virtualclass.dts.onAjaxResponse,d.cthis="docs",d.maxSize=1E8,d.requesteEndPoint=`${c.webapi}&methodname=congrea_image_converter&live_class_id=${virtualclass.gObj.congCourse}&status=1&content_type_id=1&user=${virtualclass.gObj.uid}`;
d.multiple=!1;d.wrapper=document.getElementById(a[0]);virtualclass.fineUploader.uploaderFn(d);"video"!==b&&(b=document.querySelector("#DocumentShareDashboard #docsUploadMsz"),a=document.createElement("div"),b&&b.appendChild(a))},async xhrSendWithForm(b,a){const d=new FormData;for(const a in b)d.append(a,b[a]);return await this.vxhr.post("undefined"===typeof a?c.webapi:`${c.webapi}&methodname=${a}&user=${virtualclass.gObj.uid}`,d)},createSaveButton(){const b=document.createElement("div");b.id="tech_support_save";
...
a):virtualclass.dashboard.init(b):virtualclass.dashboard.init(b)},trimExtension(b){return b.replace(/\.[^/.]+$/,"")},hideUploadMsg(b){b=document.querySelector(`#${b} .qq-uploader-selector.qq-uploader.qq-gallery`);null!=b&&b.setAttribute("qq-drop-area-text","")},showUploadMsg(b){b=document.querySelector(`#${b} .qq-uploader-selector.qq-uploader.qq-gallery`);null!=b&&b.setAttribute("qq-drop-area-text",virtualclass.lang.getString("dropfilehere"))},audioStatus(b,a){const d=b.getElementsByClassName("congtooltip")[0];
"true"===a?(b.setAttribute("data-audio-playing","true"),d.setAttribute("data-title",virtualclass.lang.getString("audioEnable")),b.className="audioTool active"):(b.setAttribute("data-audio-playing","false"),d&&d.setAttribute("data-title",virtualclass.lang.getString("audioDisable")),b.className="audioTool deactive")},selfVideoStatus(){const b=document.querySelector(".congrea .videoSwitchCont #videoSwitch");if(b.classList.contains("off"))return"off";if(b.classList.contains("on"))return"on"},videoController(){const b=
document.querySelector(".congrea .videoSwitchCont");b&&b.addEventListener("click",()=>{virtualclass.vutil.videoHandler("off"===virtualclass.vutil.selfVideoStatus()?"on":"off")})},videoHandler(b,a){let d;var c=document.querySelector(".congrea .videoSwitchCont #videoSwitch");if("on"===b){c.classList.remove("off");c.classList.add("on");d="on";c=document.querySelector(".videoSwitchCont");c.dataset.title="Video off";roles.hasControls()?virtualclass.videoHost.gObj.videoSwitch=1:virtualclass.videoHost.gObj.stdStopSmallVid=
!1;c=chatContainerEvent.elementFromShadowDom(`#ml${virtualclass.gObj.uid} .user-details a span`);const a=chatContainerEvent.elementFromShadowDom(`#ml${virtualclass.gObj.uid} .user-details a img`);c||a?virtualclass.videoHost.removeUserIcon(virtualclass.gObj.uid):virtualclass.gObj.delayVid="hide";roles.hasControls()&&virtualclass.videoHost.UI.displayTeacherVideo();const b=document.querySelector(`#ml${virtualclass.gObj.uid} video`);null!=b&&setTimeout(()=>{b.srcObject=virtualclass.media.stream},100)}else"off"===
b&&(c.classList.remove("on"),c.classList.add("off"),d="off",c=document.querySelector(".videoSwitchCont"),c.dataset.title="Video on",virtualclass.videoHost&&(roles.hasControls()?virtualclass.videoHost.gObj.videoSwitch=0:virtualclass.videoHost.gObj.stdStopSmallVid=!0),chatContainerEvent.elementFromShadowDom(`#ml${virtualclass.gObj.uid} .user-details a .videoWrapper`)?virtualclass.videoHost.setUserIcon(virtualclass.gObj.uid):virtualclass.gObj.delayVid="display",roles.hasControls()&&virtualclass.videoHost.UI.hideTeacherVideo());
"undefined"===typeof a&&(virtualclass.gObj.meetingMode?virtualclass.multiVideo.setVideoStatus("off"!==b):virtualclass.gObj.uid===virtualclass.vutil.whoIsTeacher()&&ioAdapter.mustSend({congCtr:{videoSwitch:d},cf:"congController"}),roles.hasControls()||ioAdapter.mustSend({stdVideoCtr:{videoSwitch:virtualclass.videoHost.gObj.stdStopSmallVid},cf:"stdVideoCtrl"}))},isChromeExtension(){c.postMessage({type:"isInstalled",id:1},"*");c.addEventListener("message",b=>{"yes"===b.data.type&&(virtualclass.gObj.chromeExt=
!0)})},setWidth(b,a,d){document.querySelector(`#canvas${b}`).width=d},setHeight(b,a,d){document.querySelector(`#canvas${b}`).height=d},getWidth(b){return b.width},getHeight(b){return b.height},getValueWithoutPixel(b){return parseInt(b,10)},removeDecimal(b){return b.toFixed(2)},getElemM(b,a){let d;"Y"===a?d=document.querySelector(`#${b}`).offsetHeight:"X"===a&&(d=document.querySelector(`#${b}`).offsetWidth);return this.getValueWithoutPixel(d)},getElemM2(b,a){let d;"Y"===a?d=document.querySelector(`#${b}`).offsetHeight:
"X"===a&&(d=document.querySelector(`#${b}`).offsetWidth);return this.getValueWithoutPixel(d)},getElemHeight(b){b=document.querySelector(`#${b}`).offsetHeight;return this.getValueWithoutPixel(b)},getElemWidth(b){b=document.querySelector(`#${b}`).offsetWidth;return this.getValueWithoutPixel(b)},visibleElementHeighOldt(b,a){let d=0;for(b=document.getElementById(b);b.offsetParent&&b.offsetParent.id!==a;)d+=b.offsetTop,b=b.offsetParent;return b.offsetHeight-d},elementIsVisible2(b){const a=b.getBoundingClientRect().top;
b=b.getBoundingClientRect().bottom;return 0<=a&&b<=c.innerHeight},elementIsVisible(b){b=b.getBoundingClientRect();const a=Math.max(document.documentElement.clientHeight,c.innerHeight);return!(0>b.bottom||0<=b.top-a)},getVisibleHeight(b){var a=$(`#${b}`);b=$(c).scrollTop();const d=b+$(c).height(),f=a.offset().top;a=f+a.outerHeight();return(a>d?d:a)-(f<b?b:f)},isNumeric(b){return!isNaN(parseFloat(b))&&isFinite(b)},setContainerDimension(b,a){},setDefaultScroll(){if(roles.hasControls()&&("Whiteboard"===
virtualclass.currApp||"DocumentShare"===virtualclass.currApp)){const b=virtualclass.gObj.currWb;null!=b&&"object"===typeof virtualclass.pdfRender[b]&&null!=virtualclass.pdfRender[b].canvasWrapper&&(virtualclass.pdfRender[b].canvasWrapper.scrollTop=1)}},createWhiteBoard(b,a){virtualclass.appInitiator.Whiteboard.call(virtualclass,{app:virtualclass.currApp,cusEvent:"byclick",data:b,position:a})},createHashString(b){let a=0;const d=b.length;for(let c=0;c<d;c++)a=31*a+b.charCodeAt(c),a&=a;return a},randomString(b){let a=
...
a="#listdocs");const d=document.querySelector(`#${virtualclass.currApp}Dashboard`);null==d||d.classList.contains("uploading")?virtualclass.vutil.makeElementDeactive(b):(virtualclass.vutil.makeElementActive(b),virtualclass.vutil.makeElementDeactive(a))},isResponseAvailable(b){return null!=b&&"undefined"!==typeof b&&null!=b},navWhiteboard(b,a,d){const c=virtualclass.gObj.currWb;virtualclass.vutil.isTextWrapperExist()&&virtualclass.wb[c].obj.drawTextObj.finalizeTextIfAny(void 0,c);"undefined"!==typeof d?
a.call(b,d):a.call(b)},removeAllTextWrapper(){const b=document.querySelectorAll(".canvasWrapper .textBoxContainer");for(let a=0;a<b.length;a++)b[a].parentNode.removeChild(b[a])},isDashboardOpened(b){b=document.querySelector("#dashboardnav button");return null!=b&&b.classList.contains("clicked")},stopConnection(){io.webSocketConnected()&&io.disconnect();virtualclass.gObj.invalidlogin=!0},initDefaultApp:()=>{const b=document.querySelector(`#virtualclass${virtualclass.gObj.defaultApp}Tool a`);null!=
b&&b.click(b)},initssSharing:b=>{virtualclass.gObj.whoIsSharing=b;b=chatContainerEvent.elementFromShadowDom(`#ml${b} .icon-stdscreenImg`);null!=b&&b.setAttribute("data-dcolor","green")},removeSSsharing:()=>{const b=document.querySelector("#chat_div .controleCont.ssSharing");null!=b&&b.classList.remove("ssSharing");delete virtualclass.gObj.whoIsSharing;virtualclass.vutil.removeStudenScreenStatus()},informIamSharing:()=>{const b=virtualclass.vutil.whoIsTeacher();roles.isStudent()&&virtualclass.gObj.studentSSstatus.mesharing&&
ioAdapter.mustSendUser({cf:"sshare_user"},b)},resizeWindowIfBigger(){var {currWb:b}=virtualclass.gObj;b=document.querySelector(`#canvasWrapper${b}`);null!=b&&60<c.innerWidth-(b.offsetWidth+320)&&system.initResize()},isTextWrapperExist(){return 0<document.querySelectorAll(".canvasWrapper .textBoxContainer").length},insertAppLayout:b=>{$("#virtualclassAppContainer").append(b)},prechkScrnShare(){document.getElementById("preCheckcontainer").style.display="none";document.getElementById("virtualclassApp").style.display=
"flex";localStorage.getItem("precheck")?virtualclass.videoHost._resetPrecheck():(virtualclass.popup.waitMsg(),virtualclass.makeReadySocket(),virtualclass.videoHost.afterSessionJoin());virtualclass.gObj.precheckScrn=!1},showFinishBtn(){var b=document.querySelector(".congrea #dashboardContainer .modal-header button");b&&b.classList.add("enable");"DocumentShare"===virtualclass.currApp&&(b=document.querySelector("#virtualclassAppLeftPanel"),b.classList.add("showZoom"),b.classList.remove("hideZoom"))},
removeFinishBtn(){var b=document.querySelector(".congrea.teacher  #dashboardContainer .modal-header button.enable");b&&b.classList.remove("enable");"DocumentShare"===virtualclass.currApp&&(b=document.querySelector("#virtualclassAppLeftPanel"),b.classList.add("hideZoom"),b.classList.remove("showZoom"))},addNoteClass(){if(roles.isStudent()){const b=document.querySelector("#docScreenContainer");null!=b&&b.classList.add("noteDisplay")}},calcBrightness(b){b=chroma(b).rgb();return Math.round((299*+b[0]+
587*+b[1]+114*+b[2])/1E3)},removeStudenScreenStatus(){const b=chatContainerEvent.elementFromShadowDom(".stdscreenImg","all");for(let a=0;a<b.length;a++)b[a].dataset.dcolor=""},insertAfter(b,a){a.parentNode.insertBefore(b,a.nextSibling)},triggerMouseEvent(b,a){if(null!=b){const d=document.createEvent("MouseEvents");d.initEvent(a,!0,!0);b.dispatchEvent(d)}},getCookie(b){return(b=document.cookie.match(RegExp(`(?:^|;\\s*)${b.replace(/([.*+?\^${}()|\[\]\/\\])/g,"\\$1")}=([^;]*)`)))?b[1]:null},sendCurrAppOnUserJoin(){},
setCurrApp(b,a){b.dataset.currapp=a;b=document.getElementById("chat_div");null!=b&&(b.dataset.currapp=a)},selfJoin(b){return b===virtualclass.gObj.uid?(ioAdapter.sendSpeed(virtualclass.videoHost.gObj.MYSPEED),!0):!1},getUrlVars(b){const a=[],d=b.slice(b.indexOf("?")+1).split("&");for(let c=0;c<d.length;c++)b=d[c].split("="),a.push(b[0]),a[b[0]]=b[1];return a},clearSyncTimeInterval(){Object.prototype.hasOwnProperty.call(virtualclass.videoUl,"syncTimeInterval")&&clearInterval(virtualclass.videoUl.syncTimeInterval)},
pageVisible(){let b,a;const d={hidden:"visibilitychange",webkitHidden:"webkitvisibilitychange",mozHidden:"mozvisibilitychange",msHidden:"msvisibilitychange"};for(b in d)if(b in document){a=d[b];break}return function(d){d&&document.addEventListener(a,d);return!document[b]}},showZoom(){const b=document.querySelector("#virtualclassAppLeftPanel.hideZoom");b&&(b.classList.remove("hideZoom"),b.classList.add("showZoom"))},removeBackgroundVideoApp(){virtualclass.videoUl.videoId="";var b=document.getElementById("dispVideo_Youtube_api");
b&&b.contentWindow&&b.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*");if(b=document.querySelector(".congrea #dispVideo"))b.style.display="none",(b=document.querySelector(".congrea #dispVideo video"))&&b.setAttribute("src","");(b=document.querySelector("#listvideo .playing"))&&b.classList.remove("playing");(b=document.querySelector("#listvideo .removeCtr"))&&b.classList.remove("removeCtr");roles.hasControls()||(Object.prototype.hasOwnProperty.call(virtualclass.gObj,
"videoPauseTime")&&clearTimeout(virtualclass.gObj.videoPauseTime),"object"===typeof virtualclass.videoUl.player&&null!=virtualclass.videoUl.player.player_&&virtualclass.videoUl.player.paused()&&virtualclass.videoUl.player.pause());"object"===typeof virtualclass.videoUl.player&&delete virtualclass.videoUl.player},removeSessionEndTool(){const b=document.getElementById("virtualclassSessionEndTool");null!=b&&b.parentNode.removeChild(b)},WebPDecodeAndDraw(b,a,d){c.Worker&&webpToPng.postMessage({vdata:b,
canid:a.id});c.Worker&&(webpToPng.onmessage=function(a){var b="videoParticipate"===a.data.canid?document.querySelector(`#${a.data.canid}`):chatContainerEvent.elementFromShadowDom(`#${a.data.canid}`);const d=b.getContext("2d"),c=d.createImageData(b.width,b.height);b.height=a.data.bh;b.width=a.data.bw;c.data.set(a.data.vdata);d.putImageData(c,0,0);virtualclass.gObj.isReadyForVideo=!0})},isSessionEnded(){if(!virtualclass.isPlayMode&&virtualclass.endSession)return localStorage.clear(),!0},afterPdfPrefetch(b,
a){virtualclass.gObj.nextPdf={};virtualclass.gObj.nextPdf[b]=a},getCurrentFormattedTime(b){b=this.UTCtoLocalTimeToSeconds(b);var a=new Date(b);b=a.getHours();a=`0${a.getMinutes()}`;return`${b}:${a.substr(-2)}`},hideFullScreenButton(){console.log("=====> full screen show hide");document.querySelector("#fullScreenButton").style.display="none";document.querySelector("#fullScreenExitButton").style.display="block";virtualclass.gObj.fullScreenMode=!0;virtualclass.gObj.notHandleInputFocusHandler=!0},showFullScreenButton(){console.log("=====> full screen show show");
document.querySelector("#fullScreenButton").style.display="block";document.querySelector("#fullScreenExitButton").style.display="none";virtualclass.gObj.fullScreenMode=!1;virtualclass.gObj.notHandleInputFocusHandler=!0},showFullScreenButtonIfNeed(){console.log("====> show video full screen 1");virtualclass.gObj.fullScreenMode&&this.showFullScreenButton()},storeWhiteboardAtInlineMemory(b){const a=virtualclass.gObj.currWb;"object"!==typeof virtualclass.gObj.wbData[a]&&(virtualclass.gObj.wbData[a]=[]);
virtualclass.gObj.wbData[a]=virtualclass.gObj.wbData[a].concat(b)},attachWhiteboardPopupHandler(b){c.addEventListener("mouseup",a=>{var d=document.querySelector("#virtualclassCont").dataset.currapp;virtualclass.userInteractivity.event.moreControls(a);d&&("Whiteboard"===d||"DocumentShare"===d)&&b&&roles.hasControls()&&(d=document.querySelector(".commandToolsWrapper .active"),!d||a.target.classList.contains("icon-shapes")||a.target.classList.contains("congtooltip")||a.target.classList.contains("whiteboards")||
0===a.target.classList.length||a.target.classList.contains("whiteBoardTextBox")||d.classList.remove("active"),(a=document.querySelector(".commandToolsWrapper .open"))&&virtualclass.wb[b].closeElem(a))})},setScreenShareDefualtColor(){var b=virtualclass.gObj.prvRequestScreenUser;virtualclass.gObj.prvRequestScreenUser&&(b=chatContainerEvent.elementFromShadowDom(`#ml${b} .icon-stdscreenImg`),null!==b&&(b.setAttribute("data-dcolor","black"),b.parentNode.setAttribute("data-title",virtualclass.lang.getString("requestScreenShare"))))},
hidePageNumber(){const b=document.querySelector("#docShareNav");null!==b&&(b.classList.add("hide"),b.classList.remove("show"))},sendSpeedByMobile(b){"mobTab"===virtualclass.system.desktop&&ioAdapter.sendSpeed(b)},isRefreshMode(){return virtualclass.config.makeWebSocketReady},triggerFinalizeTextIfAny(b){b=b||virtualclass.gObj.currWb;"Whiteboard"!==virtualclass.currApp&&"DocumentShare"!==virtualclass.currApp||"object"!==typeof virtualclass.wb[b]||!virtualclass.wb[b].obj.drawTextObj||virtualclass.wb[b].obj.drawTextObj.finalizeTextIfAny(void 0,
b)},inputFocusHandler(b){console.log("====> focus input");b&&"string"!==typeof b&&virtualclass.isPlayMode&&virtualclass.userInteractivity.triggerPause();c.innerWidth>c.innerHeight&&(virtualclass.gObj.initHeight=c.innerHeight,b=document.querySelector("#tabs .ui-state-focus"),"mobTab"===virtualclass.system.device&&null==b&&"Safari"!=virtualclass.system.mybrowser.name&&document.getElementById("virtualclassCont").classList.add("focusInput"))},inputFocusOutHandler(){console.log("====> focus output");"mobTab"===
virtualclass.system.device&&document.getElementById("virtualclassCont").classList.remove("focusInput")},checkUserRole(){return virtualclass.isPlayMode?"t"===wbUser.orginalUserRole:"t"===virtualclass.gObj.uRole||"p"===virtualclass.gObj.uRole}}})(window);let globalImageData={};
(function(c){let b,a,d,f,g,k,m,n,q;const r=function(a){null==k&&(k=document.querySelector("#virtualclassScreenShareLocal"));null==m&&(m=document.createElement("canvas"),m.id="virtualclassScreenShareLocalVideoNew",k.appendChild(m),m=document.querySelector("#virtualclassScreenShareLocalVideoNew"));m.width=a.width;m.height=a.height;0>=virtualclass.studentScreen.base.width&&(virtualclass.studentScreen.base.width=m.width,virtualclass.studentScreen.base.height=m.height);null==n&&(n=document.querySelector("#virtualclassScreenShareLocalVideoNew").getContext("2d"));
n.putImageData(a,0,0);virtualclass.ss.localCont.save();virtualclass.ss.localCont.clearRect(0,0,c.innerWidth-300,c.innerHeight);virtualclass.ss.localCont.scale(virtualclass.studentScreen.scale,virtualclass.studentScreen.scale);virtualclass.ss.localCont.drawImage(m,0,0);virtualclass.ss.localCont.restore()};c.Worker&&(sdworker.onmessage=function(a){"drgb"===a.data.dtype&&(q=globalImageData=a.data.globalImageData,Object.prototype.hasOwnProperty.call(a.data,"stype")?(virtualclass.studentScreen.base.width=
0,virtualclass.studentScreen.setDimension(),r(q),virtualclass.studentScreen.triggerNormalView(a.data.stype),(a=virtualclass.vutil.getUserAllInfo(a.data.uid,virtualclass.connectedUsers))&&"t"!==a.role&&roles.isStudent()&&!virtualclass.gObj.studentSSstatus.shareToAll&&receiveFunctions.sview({message:"firstSs"})):r(q))});c.studentScreen=function(){return{scale:1,SCALE_FACTOR:1.04,szoom:!1,base:{width:0,height:0},ssProcess(a,b,d){a=new Uint8ClampedArray(a);let c,f;switch(a[0]){case 102:case 202:if(a[1]===
...
a.toString();for(let d=a.length;d<b;d+=1)a=`0${a}`;return a.match(/[\S]{1,2}/g)||[]}function g(a){switch(!0){case 300>=a||"undefined"===typeof a:H=300;break;case 3E3>=a:H=a;break;case 5E3>=a:H=3E3;break;default:H=5E3}}function k(){if(roles.hasControls()||virtualclass.gObj.studentSSstatus.mesharing){d=B.video.offsetWidth;f=B.video.offsetHeight;5<B.localtempCanvas.width&&5<B.localtempCanvas.height?(q=Math.round(B.localtempCanvas.height/12),r=Math.round(B.localtempCanvas.width/12),z=q,C=r):(q=z,r=C);
{var k=B.type;B.localtempCanvas.width=B.video.offsetWidth;B.localtempCanvas.height=B.video.offsetHeight;B.localtempCont.drawImage(B.video,0,0,B.video.offsetWidth,B.video.offsetHeight);var m=B.localtempCont.getImageData(0,0,B.localtempCanvas.width,B.localtempCanvas.height);m=B.dc.encodeRGB(m.data);const b=Math.round(B.localtempCanvas.width/r),g=Math.round(B.localtempCanvas.height/q);let n,v;const u=a(virtualclass.gObj.uid,8);var p=B.getContainerDimension();if("undefined"!==typeof d&&"undefined"!==
typeof f){var t=a(d,4);n=a(f,4)}else t=a(B.video.offsetWidth,4),n=a(B.video.offsetHeight,4);v=a(p.width,4);p=a(p.height,4);k=new Uint8ClampedArray(["ss"===k?104:204,virtualclass.gObj.screenShareVersion,u[0],u[1],u[2],u[3],t[0],t[1],n[0],n[1],v[0],v[1],p[0],p[1]]);t=new Uint8ClampedArray(m.length+k.length);t.set(k);t.set(m,k.length);c.Worker&&sworker.postMessage({img:m,resize:1,resA:q,resB:r,dw:b,dh:g,offsetWidth:B.video.offsetWidth,offsetHeight:B.video.offsetHeight},[m.buffer]);m=t}virtualclass.vutil.informIamSharing();
ioAdapter.sendBinary(m);g(m.length/128);b=0;clearInterval(virtualclass.clear);virtualclass.clear=setInterval(n,H)}}function m(){B.localtempCanvas.width=B.video.offsetWidth;B.localtempCanvas.height=B.video.offsetHeight;B.localtempCont.drawImage(B.video,0,0,B.video.offsetWidth,B.video.offsetHeight);const a=Math.round(B.localtempCanvas.width/r),b=Math.round(B.localtempCanvas.height/q),d=B.localtempCont.getImageData(0,0,B.video.offsetWidth,B.video.offsetHeight);c.Worker&&(sworker.postMessage({img:d.data,
resA:q,resB:r,dw:a,dh:b,offsetWidth:B.video.offsetWidth,offsetHeight:B.video.offsetHeight,type:B.type,uid:virtualclass.gObj.uid},[d.data.buffer]),sworker.onmessage=function(a){let b;1===a.data.needFullScreen?(a=virtualclass.getDataFullScreen(B.type),virtualclass.vutil.informIamSharing(),ioAdapter.sendBinary(a),b=a.length/128):null!=a.data.sendMasterSlice&&(ioAdapter.sendBinary(a.data.sendMasterSlice),b=a.data.sendMasterSlice.length/128);g(b);clearInterval(virtualclass.clear);virtualclass.clear=setInterval(n,
H)});clearInterval(virtualclass.clear)}function n(){clearInterval(virtualclass.clear);if("undefined"!==typeof d&&"undefined"!==typeof f){if(d!==B.video.offsetWidth||f!==B.video.offsetHeight)b=1}else d=B.video.offsetWidth,f=B.video.offsetHeight;1===b?virtualclass.ss.sendResizeWindowTime=setTimeout(k,2E3):m()}let q=Math.round(this.localtempCanvas.height/12),r=Math.round(this.localtempCanvas.width/12),z=q,C=r;const B=this;Object.prototype.hasOwnProperty.call(virtualclass,"wholeImage")&&clearInterval(virtualclass.wholeImage);
Object.prototype.hasOwnProperty.call(virtualclass,"clear")&&clearInterval(virtualclass.clear);0===q&&0===r&&virtualclass.view.createErrorMsg("screensharereload","errorContainer","virtualclassAppFooterPanel");let H=1E3;virtualclass.getDataFullScreen=function(b){B.localtempCanvas.width=B.video.offsetWidth;B.localtempCanvas.height=B.video.offsetHeight;B.localtempCont.drawImage(B.video,0,0,B.video.offsetWidth,B.video.offsetHeight);var d=B.localtempCont.getImageData(0,0,B.localtempCanvas.width,B.localtempCanvas.height);
...
virtualclass.recorder.init(virtualclass.recorder.masterRecordings);virtualclass.config.setNewSession("thisismyplaymode");virtualclass.recorder.initController();virtualclass.media.audio.initAudiocontext()},askToPlay(){const b=document.querySelector(".rv-vanilla-modal-overlay.is-shown");b.addEventListener("click",this.handleStartToPlay.bind(this));const a=document.querySelector("#loadingWindowCont .askToPlay");null!=a&&a.addEventListener("click",this.handleStartToPlay.bind(this));document.getElementById("popupContainer").classList.add("playPopup");
b.classList.add("askToPlayCont")},playProgressOutput(b){},getOffset(b){"touchend"===b.type?b=this.lastEvent:b.touches?(b.offsetX=b.touches[0].pageX-b.touches[0].target.offsetLeft,b.offsetY=b.touches[0].pageY-b.touches[0].target.offsetTop):b=0;return this.lastEvent=b},seekHandler(b){null==b.offsetX&&(b=this.getOffset(b));this.pauseBeforeSeek=this.controller.pause;if(!this.startSeek){this.startSeek=!0;var a=document.querySelector("#virtualclassCont");null!=a&&a.classList.add("recordSeeking");b=b.offsetX;
a=this.getCustomWidth();this.seekValueInPercentage=b/a*100}},getCustomWidth(){return document.getElementById("downloadProgress").clientWidth-1},async seek(b){virtualclass.videoHost.UI.hideTeacherVideo();b=this.getSeekPoint(b);(b.master<this.masterIndex||b.master===this.masterIndex&&b.sub<this.subRecordingIndex)&&await this.replayFromStart();await this._seek(b);this.triggerSynchPacket()},triggerSynchPacket(){this.triggerPlayProgress();this.binarySyncMsg&&(this.handleSyncPacket(),this.binarySyncMsg=
null);this.handleSyncStringPacket()},_seek(b){this.controller._pause();let a;for(;;){a=null!=b?this.masterIndex!==b.master?this.masterRecordings[this.masterIndex].length:b.sub:this.masterRecordings[this.masterIndex].length;for(let b=this.subRecordingIndex;b<a;b++){try{if("B"!==this.subRecordings[this.subRecordingIndex].type)this.msg=io.cleanRecJson(this.subRecordings[this.subRecordingIndex].recObjs),-1<this.msg.indexOf('"m":{"unshareScreen"')?this.binarySyncMsg=null:-1<this.msg.indexOf('},"m":{"poll":{"pollMsg":"stdPublish",')?
virtualclass.poll.recordStartTime={app:"Poll",data:{masterIndex:this.masterIndex,subIndex:this.subRecordingIndex}}:-1<this.msg.indexOf('"m":{"videoUl":{"content_path"')?virtualclass.videoUl.videoStartTime={app:"Video",data:{masterIndex:this.masterIndex,subIndex:this.subRecordingIndex}}:-1<this.msg.indexOf('"m":{"quiz":{"quizMsg":"stdPublish"')&&(virtualclass.quiz.quizStartTime={app:"Quiz",data:{masterIndex:this.masterIndex,subIndex:this.subRecordingIndex}}),io.onRecMessage(this.convertInto({data:this.msg}));
else{this.msg=this.subRecordings[this.subRecordingIndex].recObjs;if(104===this.msg[0]||204===this.msg[0]||102===this.msg[0]||202===this.msg[0])if(0===this.msg[1]||1===this.msg[1])this.binarySyncMsg={data:{masterIndex:this.masterIndex,subIndex:this.subRecordingIndex}};"ScreenShare"!==virtualclass.currApp||104!==this.msg[0]&&204!==this.msg[0]&&103!==this.msg[0]&&203!==this.msg[0]&&102!==this.msg[0]&&202!==this.msg[0]||(io.onRecMessage(this.convertInto({data:this.msg})),this.binarySyncMsg=null)}this.collectElapsedPlayTime()}catch(f){}this.subRecordingIndex++}this.elapsedRecTime=
this.elapsedTime=this.elapsedPlayTime;if(void 0!=b&&this.masterIndex===b.master&&b.sub===this.subRecordingIndex)break;else this.subRecordingIndex=0,this.masterIndex++,this.subRecordings=this.masterRecordings[this.masterIndex]}},handleSyncStringPacket(){let b;if("Poll"===virtualclass.currApp&&"object"===typeof virtualclass.poll.pollState.data&&Object.prototype.hasOwnProperty.call(virtualclass.poll,"recordStartTime")){var a=virtualclass.poll.recordStartTime.data.subIndex;b=virtualclass.poll.recordStartTime.data.masterIndex;
var d=this.getTotalTimeInMilSeconds(b,a);virtualclass.poll.dataRec.setting.timer?this.pollUpdateTime(d,virtualclass.poll.pollState):(d=this.convertIntoReadable(this.elapsedPlayTime-d),virtualclass.poll.dataRec.newTime.min=d.m,virtualclass.poll.dataRec.newTime.sec=d.s,virtualclass.poll.elapsedTimer())}else"Video"===virtualclass.currApp&&"object"===typeof virtualclass.videoUl&&Object.prototype.hasOwnProperty.call(virtualclass.videoUl,"videoStartTime")?(a=virtualclass.videoUl.videoStartTime.data.subIndex,
b=virtualclass.videoUl.videoStartTime.data.masterIndex,d=this.getTotalTimeInMilSeconds(b,a),d=(this.elapsedPlayTime-d)/1E3,"object"===typeof virtualclass.videoUl.player?virtualclass.videoUl.playVideo(d):(virtualclass.videoUl.isPaused=this.pauseBeforeSeek?!0:!1,virtualclass.videoUl.startTime=d)):"Quiz"===virtualclass.currApp&&"object"===typeof virtualclass.quiz&&(a=virtualclass.quiz.quizStartTime.data.subIndex,b=virtualclass.quiz.quizStartTime.data.masterIndex,d=document.querySelector("#qztime"),a=
this.getTotalTimeInMilSeconds(b,a),0<+virtualclass.quiz.plugin.config.quizTime?(a=1E3*virtualclass.quiz.plugin.config.quizTime-(this.elapsedPlayTime-a),virtualclass.quiz.plugin.method.startTimer(a/1E3,d,"desc","vmQuiz")):(a=(this.elapsedPlayTime-a)/1E3,virtualclass.quiz.plugin.method.startTimer(a,d,"asc","vmQuiz")))},pollUpdateTime(b,a){b=this.convertIntoReadable(1E3*a.data.setting.time.totalInSeconds-(this.elapsedPlayTime-b));virtualclass.poll.remainingTimer({min:b.m,sec:b.s})},handleSyncPacket(){if(this.binarySyncMsg){var b=
this.binarySyncMsg.data.subIndex;let a=this.binarySyncMsg.data.masterIndex;for(;a<=this.masterIndex;){const d=this.masterRecordings[a];let c;for(c=this.masterIndex!=a?this.masterRecordings[this.masterIndex].length:this.subRecordingIndex;b<=c;b++){this.msg=d[b];try{if(null!=this.msg&&"B"===this.msg.type&&(this.msg=this.msg.recObjs,104===this.msg[0]||204===this.msg[0]||103===this.msg[0]||203===this.msg[0]||102===this.msg[0]||202===this.msg[0]))io.onRecMessage(this.convertInto({data:this.msg}))}catch(g){}}if(this.masterIndex===
...
typeof a&&null!==a}if(a(b)){const d=Object.keys(b);for(;d.length;){const c=d.shift(),g=b[c];a(g)&&g.hasOwnProperty("S")?b[c]=g.S:a(g)&&g.hasOwnProperty("N")?b[c]=parseFloat(g.N):a(g)&&g.hasOwnProperty("BOOL")?b[c]=g.BOOL:a(g)&&g.hasOwnProperty("NULL")?b[c]=null:a(g)&&g.hasOwnProperty("M")?b[c]=this.mapper(g.M):a(g)&&g.hasOwnProperty("L")?b[c]=this.mapper(g.L):a(g)&&g.hasOwnProperty("SS")?b[c]=g.SS:a(g)&&g.hasOwnProperty("NN")?b[c]=g.NN:a(g)&&g.hasOwnProperty("BB")?b[c]=g.BB:a(g)&&g.hasOwnProperty("NS")?
b[c]=g.NS:a(g)&&g.hasOwnProperty("BS")&&(b[c]=g.BS)}}return b},getSeekPoint(b){b=Math.trunc(this.totalTimeInMiliSeconds*b/100);this.count=Math.floor(b/5E3);let a=0;for(let d=0;d<this.masterRecordings.length;d++)for(let c=0;c<this.masterRecordings[d].length;c++){a+=this.masterRecordings[d][c].playTime;if(a===b)return{master:d,sub:c};if(a>=b)return 0<c?c--:(d--,c=0<=d?this.masterRecordings[d].length-1:0),{master:d,sub:c}}},play(){this.controller.pause||(this.config(),this.isPlayFinished()?(this.masterRecordings[this.masterIndex]&&
...
this.count++,this.actualPlayRecordingTime=this.remainingSeconds))},recDataConvertIntoArrayForm(b){var a=this.viewPoint.data[Object.keys(this.viewPoint.data)[0]];this.recData=Array(b);if(null!==a)for(const c in this.viewPoint.data){b=c;a=this.viewPoint.data[c];for(let c=0;c<a.length;c++){var d=parseInt(Object.keys(a[c])[0]);const f=Object.values(a[c])[0];for(;d<f;d++)this.recData.splice(d,1,parseInt(b))}}},isPlayFinished(){return"undefined"===typeof this.masterRecordings[this.masterIndex]&&("undefined"===
...
virtualclass.videoUl&&virtualclass.videoUl.player&&(virtualclass.videoUl.player.play(),virtualclass.videoUl.isPaused=!1)},askAgainToPlay(){if(this.subRecordings&&0>this.subRecordings[this.subRecordingIndex].recObjs.indexOf("sEnd"))io.onRecMessage(this.convertInto({data:this.subRecordings[this.subRecordingIndex].recObjs}));virtualclass.recorder.allFileFound?virtualclass.recorder.allFileFound&&this.initReplayWindow():(virtualclass.recorder.waitServer=!0,virtualclass.recorder.waitPopup=!1,this.displayWaitPopupIfNot())},
initReplayWindow(){this.triggerPauseVideo();virtualclass.popup.replayWindow();virtualclass.popup.sendBackOtherElems();document.getElementById("replayClose").addEventListener("click",()=>{c.close()});document.getElementById("replayButton").addEventListener("click",()=>{virtualclass.recorder.controller.pause=!1;virtualclass.recorder.replayFromStart.call(virtualclass.recorder)})},getCurrentPacket(){let b=0;if(0<this.masterIndex)for(let a=0;a<this.masterIndex;a++)b+=this.masterRecordings[a].length;return b+
this.subRecordingIndex},collectElapsedPlayTime(){this.elapsedPlayTime+=this.subRecordings[this.subRecordingIndex].playTime},triggerPlayProgress(){this.collectElapsedPlayTime();0===this.masterIndex&&0===this.subRecordingIndex?this.playProgressBar(this.elapsedPlayTime):(this.playTimeNowSeconds=Math.round(this.elapsedPlayTime/1E3),this.playTimeNowSeconds>this.playTimePreviousSeconds&&(this.playProgressBar(this.elapsedPlayTime),virtualclass.popup.sendBackOtherElems(),this.playTimePreviousSeconds=this.playTimeNowSeconds))},
calcPlayTime(){"object"===typeof this.subRecordings[this.subRecordingIndex]&&(this.playTimePak=this.subRecordings[this.subRecordingIndex].playTime/this.controller.ff);this.timeNow=performance.now();this.diffTime=this.timeNow-this.startTime;this.startTime=this.timeNow;this.elapsedTime+=this.diffTime;this.playTime=Math.round(this.playTimePak-(this.elapsedTime-this.elapsedRecTime));this.elapsedRecTime+=this.playTimePak;0>this.playTime&&(this.playTime=0)},calcPlayTimeNext(){this.subRecordingIndex+1==
this.subRecordings.length?(this.masterIndex++,this.subRecordings=this.masterRecordings[this.masterIndex],this.subRecordingIndex=0):this.subRecordingIndex++},initController(){if(null!=document.getElementById("playControllerCont")){var b=this;const a=document.getElementsByClassName("ff");for(let d=0;d<a.length;d++)a[d].onclick=function(){var a=this.id.split("ff")[1];b.controller.fastForward(parseInt(a,10));a=document.querySelector("#dispVideo");virtualclass.videoUl&&virtualclass.videoUl.player&&a.classList.contains("vjs-paused")&&
virtualclass.videoUl.player.play();"replayFromStart"!==this.parentNode.id&&b.doControlActive(this)};b=this;const d=document.getElementById("recPause");d.addEventListener("click",()=>{d.parentNode.classList.contains("recordingPlay")?b.initRecPause():b.initRecPlay()})}},initRecPause(){const b=document.getElementById("recPause");this.controller._pause();this.doControlActive(b);virtualclass.recorder.triggerPauseVideo();b.parentNode.classList.remove("recordingPlay");b.dataset.title="Play"},initRecPlay(){const b=
document.getElementById("recPause");this.controller._play();this.doControlActive(b);virtualclass.videoUl&&virtualclass.videoUl.player&&virtualclass.videoUl.player.play();b.parentNode.classList.add("recordingPlay");b.dataset.title="Pause"},doControlActive(b){const a=document.getElementById("playControllerCont").getElementsByClassName("recButton");for(let b=0;b<a.length;b++)a[b].classList.remove("controlActive");b.parentNode.classList.add("controlActive")},controller:{pause:!1,ff:1,_play(){virtualclass.recorder.startTime=
performance.now();this.ff=1;this.pause=!1;virtualclass.recorder.play()},_pause(){this.pause=!0},fastForward(b){this.ff=b;this.pause=!1;virtualclass.recorder.play()}},sendData(b,a,d){this.cb=d;b=JSON.stringify(b);this.httpObj.open("POST",a);this.httpObj.setRequestHeader("x-api-key",wbUser.lkey);this.httpObj.setRequestHeader("x-congrea-authuser",wbUser.auth_user);this.httpObj.setRequestHeader("x-congrea-authpass",wbUser.auth_pass);this.httpObj.setRequestHeader("x-congrea-room",wbUser.room);this.httpObj.setRequestHeader("Content-Type",
"application/json");this.httpObj.withCredentials=!1;this.httpObj.send(b)},sortingFiles(b){return b.sort(function(a,b){return a<b?-1:a>b?1:0})},setOrginalListOfFiles(b){const a={};for(let d=0;d<b.length;d++)a[b[d]]=null!=b[d+1]?{index:d,next:b[d+1]}:{index:d,next:"end"};return a},triggerDownloader(){this.tryNumberOfTimes=1;Object.prototype.hasOwnProperty.call(this,"triggerDownloaderTime")&&clearInterval(this.triggerDownloaderTime);Object.prototype.hasOwnProperty.call(this,"startTimeCounter")&&clearInterval(this.startTimeCounter);
let b=0;this.startTimeCounter=setInterval(()=>{b++},1E3);this.triggerDownloaderTime=setInterval(()=>{3<this.tryNumberOfTimes?(virtualclass.recorder.allFileFound=!0,clearInterval(this.triggerDownloaderTime.triggerDownloaderTime),this.isPlayFinished()&&(-1<this.masterRecordings[this.masterIndex][this.subRecordingIndex].recObjs.indexOf('"cf":"sEnd"')&&this.playProgressBar(this.totalTimeInMiliSeconds),this.askAgainToPlay())):virtualclass.xhrn.vxhrn.post(virtualclass.api.recordingFiles,data).then(a=>{this.afterDownloadingList(a.data)})},
18E4)},afterDownloadingList(b){let a;if(null!=b&&Object.prototype.hasOwnProperty.call(b,"Item")){var d=+b.Item.time.N;this.sessionStartTime=(new Date).getTime()-d;d=[...new Set(b.Item.list.L.map(a=>a.S))];b=d.length;if(this.lastRecordings&&d.length===this.lastRecordings)this.tryNumberOfTimes=this.tryNumberOfTimes?++this.tryNumberOfTimes:1;else{delete this.alreadyCalcTotTime;this.totalRecordingFiles=this.sortingFiles(d);this.lastFile=this.totalRecordingFiles[this.totalRecordingFiles.length-1];this.orginalListOfFiles=
this.setOrginalListOfFiles(this.totalRecordingFiles);this.calculateTotalPlayTime();d=this.totalRecordingFiles.shift();this.firstxhr=axios.create({timeout:6E5,withCredentials:!0});this.requestDataFromServer(d,this.firstxhr);for(const b in this.totalRecordingFiles)d=virtualclass.recorder.session,a=this.totalRecordingFiles[b],virtualclass.createPrefetchLink(`https://recording.congrea.net/${wbUser.lkey}/${wbUser.room}/${d}/${a}`);9E5>this.sessionStartTime&&this.triggerDownloader()}this.lastRecordings=
b}else this.tryNumberOfTimes=this.tryNumberOfTimes?++this.tryNumberOfTimes:1,this.triggerDownloader()},requestListOfFiles(){this.fetchRecViewData();this.actualTotalPlayTime=0;this.session=wbUser.session;virtualclass.xhrn.vxhrn.post(virtualclass.api.recordingFiles,{session:virtualclass.recorder.session}).then(b=>{this.afterDownloadingList(b.data)})},calculateTotalPlayTime(){var b=virtualclass.recorder.totalRecordingFiles;const a=Math.trunc(+b[0].split("-")[0]/1E6);b=Math.trunc(+b[b.length-1].split("-")[1].split(".")[0]/
1E6);this.totalTimeInMiliSeconds=b-a;this.lastTimeInSeconds=Math.trunc(b/1E3);this.firstTimeInSeconds=Math.trunc(a/1E3)},getTimeFromFile(b){return+b.split("-")[1].split(".")[0]/1E9},totalPlayTime(){let b=0;for(let a=0;a<virtualclass.recorder.masterRecordings.length;a++)for(let d=0;d<virtualclass.recorder.masterRecordings[a].length;d++)b+=virtualclass.recorder.masterRecordings[a][d].playTime;return b/1E3},getTotalTimeInMilSeconds(b,a){let d=0,c=0;for(;d<=b;){for(let f=0;f<virtualclass.recorder.masterRecordings[d].length&&
(c+=virtualclass.recorder.masterRecordings[d][f].playTime,b!==d||a!==f);f++);d+=1}return c},getTempTotalTimeInMilSeconds(b,a){let d=0,c=0;for(;d<=b;){for(let f=0;f<this.orginalTimes[d].length&&(c+=this.orginalTimes[d][f],b!==d||a!==f);f++);d++}return c},getTotalElementLength(){let b=0;for(let a=0;a<virtualclass.recorder.masterRecordings.length;a++)b+=virtualclass.recorder.masterRecordings[a].length;return b},seekWithMouseMove(b){null==b.offsetX&&(b=this.getOffset(b));if(this.startSeek){this.controller._pause();
this.seekValueInPercentage=this.getSeekValueInPercentage(b);this.downloadInPercentage<this.seekValueInPercentage&&(this.seekValueInPercentage=Math.trunc(this.downloadInPercentage));this.setPlayProgressTime(this.seekValueInPercentage);virtualclass.pbar.renderProgressBar(this.totalTimeInMiliSeconds,6E4*this.seekTimeWithMove.m+1E3*this.seekTimeWithMove.s,"playProgressBar",void 0);const a=this.seekTimeWithMove.h,d=this.seekTimeWithMove.m,c=this.seekTimeWithMove.s;document.querySelector("#tillRepTime").innerHTML=
`${a}:${d}:${c}`;this.displayTimeInHover(b,this.seekValueInPercentage)}},getSeekValueInPercentage(b){const a=this.getCustomWidth();return b.offsetX/a*100},handlerDisplayTime(b){const a=this.getSeekValueInPercentage(b);this.displayTimeInHover(b,a)},displayTimeInHover(b,a){this.setPlayProgressTime(a);b=20>b.offsetX?3:5>c.innerWidth-b.offsetX?b.offsetX-65:30>c.innerWidth-b.offsetX?b.offsetX-60:40>c.innerWidth-b.offsetX?b.offsetX-35:b.offsetX-25;a=document.getElementById("timeInHover");a.style.display=
"block";a.style.marginLeft=`${b}px`;b=this.seekTimeWithMove.h;a=this.seekTimeWithMove.m;const d=this.seekTimeWithMove.s;document.getElementById("timeInHover").innerHTML=`${b}:${a}:${d}`;document.querySelector("#virtualclassCont").classList.add("recordSeeking")},setPlayProgressTime(b){this.seekTimeWithMove=this.convertIntoReadable(b*this.totalTimeInMiliSeconds/100)},async finalSeek(b){b.offsetX||this.getOffset(b);this.startSeek&&Object.prototype.hasOwnProperty.call(this,"seekValueInPercentage")&&(this.downloadInPercentage<
this.seekValueInPercentage&&(this.seekValueInPercentage=Math.trunc(this.downloadInPercentage)),0<this.seekValueInPercentage&&await this.seek(this.seekValueInPercentage),this.pauseBeforeSeek?(this.controller._pause(),this.triggerPauseVideo()):(this.controller._play(),this.triggerPlayVideo()),document.getElementById("timeInHover").style.display="none");document.querySelector("#virtualclassCont").classList.remove("recordSeeking");delete this.seekValueInPercentage;this.startSeek=!1;b=document.getElementById("congrealogo");
null!=b&&b.classList.remove("disbaleOnmousedown")},initRecordViewHandler(){let b=!1;c.addEventListener("unload",()=>{b||(virtualclass.recorder.recDataSend(),console.log("Send recording view data 1"),b=!0)});document.addEventListener("visibilitychange",()=>{b||"hidden"!==document.visibilityState||(virtualclass.recorder.recDataSend(),console.log("Send recording view data 2"),b=!0);"visible"===document.visibilityState&&(b=!1)});"mobTab"===virtualclass.system.device&&backDection.backDetect("#virtualclassCont",
()=>{b||(virtualclass.recorder.recDataSend(),b=!0,setTimeout(()=>{virtualclassSetting.congreaWindow.close()},500))})}}})(window);(function(c){c.storage={version:1,mycacheQueue:[],mycacheInQueue:[],mycacheOutQueue:[],async init(){this.tables=["cacheAll","cacheOut","cacheIn"];this.db=await virtualclass.virtualclassIDBOpen("congrea",this.version,{upgrade(b){virtualclass.storage.onupgradeneeded(b)}})},onupgradeneeded(b){b.objectStoreNames.contains("cacheAll")||b.createObjectStore("cacheAll");b.objectStoreNames.contains("cacheOut")||b.createObjectStore("cacheOut");b.objectStoreNames.contains("cacheIn")||b.createObjectStore("cacheIn")},
...
d,c,g){const f=this;var m=this.createControllerElement(d,"contrAssign");const n=m[0],q=m[1];m=b.getElementById(`${d}ControlContainer`);null!=m?0>=m.getElementsByClassName("controleCont").length?m.appendChild(n):m.insertBefore(n,m.firstChild):a.appendChild(n);virtualclass.user.control.changeAttribute(d,q,c,"assign","aRole");"undefined"!==typeof g&&(q.className+=" currTeacher");q.addEventListener("click",()=>{f.control.init.call(f,q)})},createControlDivs(a,b,c){const d=this;let f;let m,n,q,r,z=!1,u=
localStorage.getItem(`virtualclass${b}`);null!=u&&(z=!0,u=JSON.parse(u),Object.prototype.hasOwnProperty.call(u,"currTeacher")&&(virtualclass.gObj[`${b}currTeacher`]={},!0===u.currTeacher?(f=virtualclass.user.control.currTeacherAlready=!0,virtualclass.gObj[`${b}currTeacher`].ct=!0):virtualclass.gObj[`${b}currTeacher`].ct=!1));const t=!roles.isEducator(),p=virtualclass.vutil.userIsOrginalTeacher(b);for(let g=0;g<c.length;g++)if("assign"===c[g]&&p)"undefined"!==typeof f?this.createAssignControl(a,b,
t,f):this.createAssignControl(a,b,t);else if("audio"===c[g]){var v=this.createControllerElement(b,"contrAud");var A=v[0];m=v[1];a.appendChild(A);A=z&&Object.prototype.hasOwnProperty.call(u,"aud")?!!u.aud:!0;virtualclass.user.control.changeAttribute(b,m,A,"audio","aud");p&&m.addEventListener("click",()=>{d.control.init.call(d,m)});roles.hasAdmin()&&"false"===m.dataset.audioDisable&&(A=localStorage.getItem("allAudioAction"),null!=A&&"disable"===A&&m.click())}else"chat"===c[g]?(v=this.createControllerElement(b,
"contrChat"),A=v[0],n=v[1],a.appendChild(A),p&&n.addEventListener("click",()=>{d.control.init.call(d,n)}),q=z&&Object.prototype.hasOwnProperty.call(u,"chat")?!!u.chat:!0,virtualclass.user.control.changeAttribute(b,n,q,"chat","chat")):"editorRich"===c[g]||"editorCode"===c[g]?roles.hasAdmin()&&(r=z&&Object.prototype.hasOwnProperty.call(u,c[g])?!!u[c[g]]:!1,v=this.createControllerElement(b,`contr${c[g]}`),A=v[0],v=v[1],A.className+=` controller${c[g]}`,a.appendChild(A),virtualclass.currApp!==virtualclass.vutil.capitalizeFirstLetter(c[g])&&
(A.style.display="none"),virtualclass.user.control.changeAttribute(b,v,r,c[g],c[g]),p&&v.addEventListener("click",d.closureEditor(d,v))):"RaiseHand"===c[g]&&(rhEnable=z&&Object.prototype.hasOwnProperty.call(u,"raiseHand")?!!u.raiseHand:!0,virtualclass.user.control.changeAttribute(b,n,q,"RaiseHand","RaiseHand"))},closureEditor(a,b){return function(){a.control.init.call(a,b)}},control:{toggleDisplayWriteModeMsgBox(a,d){let c=b.getElementById(`${a}writeModeBox`);var g=virtualclass.lang.getString("readonlymode"),
...
a=b.getElementById("stickybar").getElementsByClassName("ui-chatbox");for(var d=0;d<a.length;d++)this.makeElemEnable(a[d])}else"gc"===a&&(a=b.getElementById("chatrm"),null!=a&&a.classList.remove("chat_disable"),a=b.querySelector("#virtualclassCont.congrea #ta_chrm2"))&&(a.classList.remove("disable"),a.disabled=!1);a=b.querySelector("#virtualclassCont #chatrm.enable");d=b.querySelector("#chatroom_bt2");a&&(d.classList.contains("active")||d.classList.add("active"),virtualclass.chat.chatWindow="common")},
...
if(null!=a&&virtualclass.system.mediaDevices.hasWebcam&&a.classList.contains("video")){const d=b.getElementById("rightCtlr");a.classList.contains("on")&&(virtualclass.vutil.videoHandler("off"),d.parentNode.setAttribute("data-title",virtualclass.lang.getString("videoon")))}this.mediaSliderSetting("audio");this.mediaSliderSetting("video")}roles.hasAdmin()&&(virtualclass.gObj.delayVid="display")},mediaSliderSetting(a){const d="audio"===a?"Audio":"Video";var c=virtualclass.gObj.stdaudioEnable,g=virtualclass.gObj.stdvideoEnable;
c={action:("audio"===a?c:g)?"enable":"disable",enable:"disable",disable:"enable"};if(g=b.querySelector(`.congrea #contr${d}All.${c.action}`))g.classList.remove(c.action),g.classList.add(c[c.action]),(g=b.querySelector(`.congrea #contr${d}All input`))&&g.removeAttribute("checked");if(g=b.querySelector(`.congrea .slider.icon-all-${a}-${c.action}`))g.className=`slider round congtooltip icon-all-${a}-${c[c.action]}`,g.setAttribute("data-action",c[c.action]),a=virtualclass.lang.getString(`${c[c.action]}All${d}`),
g.setAttribute("data-title",a)},makeElemEnable(a){virtualclass.vutil.elemHasAnyClass(a.id)?(a.classList.remove("disable"),a.classList.add("enable")):a.className="enable";a=a.getElementsByClassName("ui-chatbox-input-box")[0];null!=a&&(a.disabled=!1)},toggleAllEditorController(a,b){a=virtualclass.vutil.smallizeFirstLetter(a);const d=chatContainerEvent.elementFromShadowDom(".controleCont","all");if(0<d.length)for(let f=0;f<d.length;f++)if(0<d[f].id.indexOf(a)){var c=d[f].id.indexOf("Cont");0<c&&(c=d[f].id.substr(0,
c),c=chatContainerEvent.elementFromShadowDom(`${c}Img`,null,!0),this.control.init.call(this,c,b,void 0,"actnotSend"))}"enable"===b?virtualclass.vutil.beforeSend({status:!0,control:"editorRich",cf:"control"}):virtualclass.vutil.beforeSend({status:!1,control:"editorRich",cf:"control"})},toggleDisplayEditorController(a,b){a=virtualclass.vutil.smallizeFirstLetter(a);if(Object.prototype.hasOwnProperty.call(virtualclass.gObj,"testChatDiv")){a=chatContainerEvent.elementFromShadowDom(`.controller${a}`,"all");
for(let d=0;d<a.length;d++)a[d].style.display=b}},updateUser(a,b,c){const d=localStorage.getItem(`virtualclass${a}`);let f={};null==d?f.id=a:f=JSON.parse(d);f[b]=c;localStorage[`virtualclass${f.id}`]=JSON.stringify(f);return f},audioSign2(a,d){if("create"===d){if(null==b.getElementById(`${a.id}AudEnableSign`)){d=b.createElement("div");d.id=`${a.id}AudEnableSign`;const f=b.createElement("img");f.id=`${a.id+"audioenable"}Img`;f.src=`${c.whiteboardPath}images/${"audioenable"}.png`;const g=b.createElement("a");
g.id=`${a.id+"audioenable"}Anch`;g.className="audEnableSign tooltip controleCont";g.setAttribute("data-title",virtualclass.lang.getString("studentAudEnable"));g.appendChild(f);d.appendChild(g);b.getElementById(`${a.id}ControlContainer`).appendChild(d)}}else a=b.getElementById(`${a.id}AudEnableSign`),a.parentNode.removeChild(a)},audioSign(a,b){"create"===b?this.iconAttrManupulate(a.id,"icon-audioEnaGreen"):a.aud?this.iconAttrManupulate(a.id,"icon-audioImg"):this.iconAttrManupulate(a.id,"icon-audioDisImg")},
iconAttrManupulate(a,b){a=virtualclass.gObj.testChatDiv.shadowRoot.querySelector(`#ml${a} .audioImg`);if(null!=a)for(let d=0;d<a.classList.length;d++)if("icon-"===a.classList[d].substring(0,5)){a.classList.remove(a.classList[d]);a.classList.add(b);break}},shouldApply(a){let b=localStorage.getItem(`virtualclass${a}`);null!=b&&(b=JSON.parse(b),b.ad&&virtualclass.user.control.audioSign({id:a},"create"))},changeAttrToAssign(a){const d=b.getElementById("chatWidget").getElementsByClassName("assignImg");
for(let b=0;b<d.length;b++)"enable"===a?(d[b].classList.remove("block"),d[b].classList.add("enable"),d[b].parentNode.classList.add("tooltip"),d[b].parentNode.setAttribute("data-title",virtualclass.lang.getString("transferControls")),d[b].setAttribute("data-assign-disable","false")):(d[b].classList.remove("enable"),d[b].classList.add("block"),d[b].parentNode.classList.remove("tooltip"),d[b].setAttribute("data-assign-disable","true"))}},displayStudentSpeaker(a){const d=b.getElementById("alwaysPress");
null!=d&&(d.style.display=a?"block":"none")},toggleAllUserListIcon(a,b){b="audio"===b?"Aud":"Chat";const d=chatContainerEvent.elementFromShadowDom(".controleCont","all");if(0<d.length)for(let f=0;f<d.length;f++)if(0<d[f].id.indexOf(b)){var c=d[f].id.indexOf("Cont");0<c&&(c=d[f].id.substr(0,c),c=chatContainerEvent.elementFromShadowDom(`${c}Img`,null,!0),this.control.init.call(this,c,a,void 0,"actnotSend"))}},toggleAllVideo(a){ioAdapter.mustSend({action:a,cf:"toggleVideo"})},mediaSliderUI(a){const d=
virtualclass.vutil.capitalizeFirstLetter(a);let c=b.querySelector(`.bulkUserActions #contr${d}AllImg`);if("chat"===a)var g="pc";else if("groupChat"===a)g="gc";else if("audio"===a||"video"===a)g=a;var k="askQuestion"===a||"userlist"===a||"qaMarkNotes"===a?virtualclass.settings.info[a]:virtualclass.settings.info[`student${g}`];g=b.querySelector(`.bulkUserActions #contr${d}All input`);const m=b.querySelector(`.congrea #contr${d}All`),n=!0===k?"disable":"enable";null!==k?(c.setAttribute("data-action",
n),c.className=`slider round icon-all-${a}-${n} enable congtooltip cgIcon`,c.dataset.title=virtualclass.lang.getString(`${n}All${d}`),g.setAttribute("checked","true"),m.classList.add(n)):(k={action:k?"enable":"disable",enable:"disable",disable:"enable"},c=b.querySelector(`.bulkUserActions #contr${d}AllImg`),c.setAttribute("data-action",k[k.action]),c.className=`slider round icon-all-${a}-${k[k.action]} congtooltip cgIcon`,c.dataset.title=virtualclass.lang.getString(`${k[k.action]}All${d}`),g.removeAttribute("checked"),
m.classList.add(k[k.action]));if(!virtualclass.isPlayMode){const b=this;c.addEventListener("click",()=>{const d=b.toogleIcon(a),c="enable"===d;let f;"chat"===a?f="pc":"groupChat"===a?f="gc":"askQuestion"===a||"userlist"===a||"qaMarkNotes"===a?virtualclass.settings.applySettings(c,a):f=a;"raisehand"===a&&"userlist"===a||virtualclass.settings.applySettings(c,`student${f}`);"undefined"===typeof d||"audio"!==a&&"chat"!==a||b.toggleAllUserListIcon.call(virtualclass.user,d,a)})}},chatBoxesSwitch(){if(virtualclass.chat.chatroombox)toggleCommonChatBox();
else if(0===$("div#chat_room").length){var a=b.createElement("ul");a.id="chat_room";b.body.appendChild(a);virtualclass.chat.chatroombox=$("#chat_room").chatroom({id:"chat_room",user:{name:"test"},title:lang.chatroom_header,offset:"20px",messageSent(a,b){$("#chat_room").chatroom("option","boxManager").addMsg(a.name,b)}});Object.prototype.hasOwnProperty.call(virtualclass.gObj,"chatEnable")&&!virtualclass.gObj.chatEnable&&(a=b.getElementById("chatrm"),null!=a&&virtualclass.user.control.makeElemDisable(a));
a=b.getElementById("cc_arrow_button");a.classList.add("icon-arrow-down");a.classList.remove("icon-arrow-up")}},toogleIcon(a){const d=virtualclass.vutil.capitalizeFirstLetter(a),c=b.querySelector(`.bulkUserActions #contr${d}AllImg`);if(null!=c){const f=c.dataset.action;"enable"===c.dataset.action?(c.dataset.action="disable",c.className=`slider round icon-all-${a}-disable congtooltip`,c.dataset.title=virtualclass.lang.getString(`disableAll${d}`),a=b.querySelector(`.congrea .bulkUserActions #contr${d}All`),
a.classList.add("disable"),a.classList.remove("enable")):(c.dataset.action="enable",c.className=`slider round icon-all-${a}-enable congtooltip`,c.dataset.title=virtualclass.lang.getString(`enableAll${d}`),a=b.querySelector(`.congrea .bulkUserActions #contr${d}All`),a.classList.add("enable"),a.classList.remove("disable"));return f}},changeRoleOnFooter(a,b){chatContainerEvent.elementFromShadowDom(`#ml${a}`).dataset.role=b},initControlHandler(a){const d=chatContainerEvent.elementFromShadowDom(`#ml${a} .contImg`,
"all");let c=!1,g=localStorage.getItem(`virtualclass${a}`);null!=g&&(c=!0,g=JSON.parse(g),Object.prototype.hasOwnProperty.call(g,"currTeacher")&&(virtualclass.gObj[`${a}currTeacher`]={},!0===g.currTeacher?(virtualclass.user.control.currTeacherAlready=!0,virtualclass.gObj[`${a}currTeacher`].ct=!0):virtualclass.gObj[`${a}currTeacher`].ct=!1));for(let f=0;f<d.length;f++)if(-1<d[f].className.indexOf("chat")){var k=c&&Object.prototype.hasOwnProperty.call(g,"chat")?Object.prototype.hasOwnProperty.call(virtualclass.settings.user,
a)?virtualclass.settings.parseSettings(virtualclass.settings.user[a]).studentpc:virtualclass.settings.info.studentpc:virtualclass.settings.info.studentpc;virtualclass.user.control.changeAttribute(a,d[f],k,"chat","chat")}else-1<d[f].className.indexOf("aud")?(c&&Object.prototype.hasOwnProperty.call(g,"aud")?k=Object.prototype.hasOwnProperty.call(virtualclass.settings.user,a)?virtualclass.settings.parseSettings(virtualclass.settings.user[a]).studentaudio:virtualclass.settings.info.studentaudio:(k=b.querySelector("#contrAudioAll"),
null!=virtualclass.jId&&k.classList.contains("disable"),k=virtualclass.settings.info.studentaudio),virtualclass.user.control.changeAttribute(a,d[f],k,"audio","aud"),roles.hasAdmin()&&"false"===d[f].dataset.audioDisable&&localStorage.getItem("allAudioAction")):-1<d[f].className.indexOf("RaiseHand")?(k=c&&Object.prototype.hasOwnProperty.call(g,"raiseHand")?!!g.raiseHand:!1,virtualclass.user.control.changeAttribute(a,d[f],k,"RaiseHand","RaiseHand")):-1<d[f].className.indexOf("stdscreen")?Object.prototype.hasOwnProperty.call(virtualclass.gObj.studentSSstatus,
"whoIsSharing")&&virtualclass.vutil.initssSharing(virtualclass.gObj.whoIsSharing):-1<d[f].className.indexOf("editorRich")&&"EditorRich"===virtualclass.currApp?(k=c&&Object.prototype.hasOwnProperty.call(g,"editorRich")?!!g.editorRich:!1,virtualclass.user.control.changeAttribute(a,d[f],k,"editorRich","editorRich")):-1<d[f].className.indexOf("editorCode")&&(k=c&&Object.prototype.hasOwnProperty.call(g,"editorCode")?!!g.editorCode:!1,virtualclass.user.control.changeAttribute(a,d[f],k,"editorCode","editorCode"))}}}})(window,
...
null==a||virtualclass.isPlayMode||(a.style.zIndex=0);a=document.getElementById("audioWidget");null!=a&&(a.style.zIndex=0);a=document.getElementById("memlist");null!=a&&(a.style.zIndex=0)};a.prototype.openProgressBar=function(a){a=document.getElementById("about-modal");virtualclass.popup.open(a);this.hideAllPopups();document.getElementById("recordingContainer").style.display="block"};a.prototype.replayWindow=function(){const a=document.getElementById("about-modal");virtualclass.popup.open(a);this.hideAllPopups();
virtualclass.popup.replayWindowAction("block")};a.prototype.sesseionEndWindow=function(){var a=document.getElementById("about-modal");virtualclass.popup.open(a);this.hideAllPopups();a=document.getElementById("sessionEndMsgCont");a.style.display="block";a.dataset.displaying=!0;document.getElementById("sessionEndClose").addEventListener("click",()=>{virtualclass.popup.closeElem();c.close()})};a.prototype.validateurlPopup=function(a){const b=document.getElementById("about-modal");virtualclass.popup.open(b);
this.hideAllPopups();let d,c;"video"===a?(d=document.querySelector("#virtualclassCont.congrea #popupContainer #uploadvideourl"),c=document.querySelector("#virtualclassCont.congrea #popupContainer #vidPopupClose")):"presentation"===a&&(d=document.querySelector("#virtualclassCont.congrea #popupContainer #uploadppturl"),c=document.querySelector("#virtualclassCont.congrea #popupContainer #pptPopupClose"));d.style.display="block";d.dataset.displaying=!0;c.addEventListener("click",()=>{virtualclass.popup.closeElem()})};
a.prototype.replayWindowAction=function(a){document.getElementById("replayContainer").style.display=a};a.prototype.progressBarAction=function(a){document.getElementById("recordingContainer").style.display=a};a.prototype.confirmInput=function(a,b,d,c,f,r){var g=document.getElementById("about-modal");virtualclass.popup.open(g);this.hideAllPopups();g=document.getElementById("confirm");g.style.display="block";var k=g.getElementsByClassName("confirmChild");if(0<k.length)for(;1<=k.length;)k[0].parentNode.removeChild(k[0]);
k=document.createElement("div");k.id="confirmMessage";k.className="confirmChild";k.innerHTML=a;g.appendChild(k);const m=this;a=function(){m.confirmInit(this.id,b,d,c,f,r)};k=document.createElement("div");k.id="confirmOk";k.className="confirmButton confirmChild";k.addEventListener("click",a);const n=document.createElement("button");n.id="confirmOkButton";n.className="icon-check";n.innerHTML=virtualclass.lang.getString("confirmOk");k.appendChild(n);g.appendChild(k);k=document.createElement("div");k.id=
"confirmCancel";k.className="confirmButton confirmChild";k.addEventListener("click",a);a=document.createElement("button");a.id="confirmCancelButton";a.className="icon-close";a.innerHTML=virtualclass.lang.getString("confirmCancel");k.appendChild(a);g.appendChild(k)};a.prototype.pollPopUp=function(a,b){var d=document.getElementById("about-modal");virtualclass.popup.open(d);this.hideAllPopups();d=document.getElementById("editPollCont");d.style.display="block";const c=this,f=function(){c.action(this.id,
a,b)};if(null==document.getElementById("pollCancel")){const a=document.createElement("div");a.id="pollCancel";a.className="cancelBtn";a.addEventListener("click",f);const b=document.createElement("button");b.id="confirmCancelButton";b.className="icon-close";b.innerHTML=virtualclass.lang.getString("pollCancel");a.appendChild(b);d.appendChild(a)}document.getElementById("resetPoll").addEventListener("click",f);document.getElementById("addMoreOption").addEventListener("click",f);document.getElementById("etSave").addEventListener("click",
f);document.getElementById("saveNpublish").addEventListener("click",f)};a.prototype.action=function(a,b,d,c,f,r){b(a)};a.prototype.confirmInit=function(a,b,d,c,f,r){virtualclass.popup.closeElem();a="confirmOk"===a?virtualclass.popup.confirmOk():virtualclass.popup.confirmCancel();b(a,d,c,f,r)};a.prototype.confirmCancel=function(){return!1};a.prototype.confirmOk=function(){return!0};a.prototype.waitMsg=function(a){let b=0;"undefined"!==typeof a&&(b=1300);setTimeout(()=>{virtualclass.network.netWorkElementIsReady()},
b);"undefined"!==typeof virtualclass.vutil&&virtualclass.vutil.sesionEndMsgBoxIsExisting()||this.hideAllPopups()};a.prototype.chromeExtMissing=function(){const a=document.getElementById("about-modal");a.dataset.currPopup="chromeExt";virtualclass.popup.open(a);this.hideAllPopups();document.getElementById("chromeExtMiss").style.display="block";roles.isStudent()&&virtualclass.gObj.studentSSstatus.mesharing&&(virtualclass.gObj.studentSSstatus.mesharing=!1);document.getElementById("chromeExtClose").addEventListener("click",
()=>{virtualclass.popup.closeElem();a.dataset.currPopup=""})};a.prototype.generalMsg=function(a){const b=document.getElementById("about-modal");virtualclass.popup.open(b);this.hideAllPopups();document.getElementById("generalMessage").style.display="block";document.querySelector("#generalMessageMsg").innerHTML=a;document.getElementById("generalMessageClose").addEventListener("click",()=>{virtualclass.popup.closeElem()})};a.prototype.infoMsg=function(a){const b=document.getElementById("about-modal");
virtualclass.popup.open(b);this.hideAllPopups();document.getElementById("infoMessage").style.display="block";document.querySelector("#infoMessageMsg").innerHTML=a;document.getElementById("infoMessageOk").innerHTML="ok";document.getElementById("infoMessageOk").addEventListener("click",()=>{virtualclass.popup.closeElem()})};a.prototype.generalMsgButton=function(a){a=document.getElementById("about-modal");virtualclass.popup.open(a);this.hideAllPopups();a=document.querySelector("#generalMessageButton");
null!=a&&(a.style.display="block;",document.querySelector("#generalMessageButton .button").addEventListener("click",()=>{virtualclass.popup.closeElem()}))};a.prototype.hideAllPopups=function(){const a=document.getElementsByClassName("popupWindow");for(let b=0;b<a.length;b++)a[b].style.display="none"};a.prototype.closePopup=function(){virtualclass.popup.closeElem();"true"===document.getElementById("sessionEndMsgCont").dataset.displaying&&this.sesseionEndWindow()};a.prototype.loadingWindow=function(){const a=
document.getElementById("about-modal");virtualclass.popup.open(a);this.hideAllPopups();const b=document.querySelector("#loadingWindowCont");null!=b&&(b.style.display="block",a.parentNode.classList.add("loading"))};return a}(window);(function(c){c.converter=function(){function b(a){return 26>a?a+65:52>a?a+71:62>a?a-4:62===a?43:63===a?47:65}return{base64EncArrInt(a){const b=new Uint8Array(a.length);for(let d=0;d<a.length;d++)b[d]=0>a[d]?-1*a[d]+127:a[d];return this.base64EncArr(b)},base64EncArr(a){let d=2,c="";for(let f=a.length,k=0,m=0;m<f;m++)if(d=m%3,0<m&&0===4*m/3%76&&(c+="\r\n"),k|=a[m]<<(16>>>d&24),2===d||1===a.length-m)c+=String.fromCharCode(b(k>>>18&63),b(k>>>12&63),b(k>>>6&63),b(k&63)),k=0;return c.substr(0,c.length-
2+d)+(2===d?"":1===d?"=":"==")},base64DecToArrInt(a){a=base64DecToArr(a);const b=new Int8Array(a.length);for(let d=0;d<a.length;d++)b[d]=128<=a[d]?-1*(a[d]-127):a[d];return b},base64DecToArr(a,b){a=a.replace(/[^A-Za-z0-9\+\/]/g,"");const d=a.length;b=b?Math.ceil((3*d+1>>2)/b)*b:3*d+1>>2;const c=new Uint8Array(b);for(var k,m=0,n=0,q=0;q<d;q++){k=q&3;var r=a.charCodeAt(q);m|=(64<r&&91>r?r-65:96<r&&123>r?r-71:47<r&&58>r?r+4:43===r?62:47===r?63:0)<<6*(3-k);if(3===k||1===d-q){for(k=0;3>k&&n<b;k++,n++)c[n]=
...
d||[];if(a.length!==this.baseLength)throw Error("The operation's base length must be equal to the string's length.");const c=[];let f=0,g,m,n=0;const {ops:q}=this;for(let r=0,p=q.length;r<p;r++){const p=q[r];if(p.isRetain()){if(n+p.chars>a.length)throw Error("Operation can't retain more characters than are left in the string.");c[f++]=a.slice(n,n+p.chars);for(g=0;g<p.chars;g++){var A=b[n+g]||{};const a={};for(m in A)a[m]=A[m],k.assert(!1!==a[m]);for(m in p.attributes)!1===p.attributes[m]?delete a[m]:
a[m]=p.attributes[m],k.assert(!1!==a[m]);d.push(a)}n+=p.chars}else if(p.isInsert())for(c[f++]=p.text,g=0;g<p.text.length;g++){A={};for(m in p.attributes)A[m]=p.attributes[m],k.assert(!1!==A[m]);d.push(A)}else n+=p.chars}if(n!==a.length)throw Error("The operation didn't operate on the whole string.");a=c.join("");k.assert(a.length===d.length);return a};a.prototype.invert=function(b){let d=0;const c=new a,{ops:f}=this;for(let a=0,g=f.length;a<g;a++){const g=f[a];g.isRetain()?(c.retain(g.chars),d+=g.chars):
...
a.sendOperation(b);return new c(b)};g.prototype.serverAck=function(a){a.sendOperation(a.revision,this.buffer);return new c(this.buffer)};g.prototype.transformCursor=function(a){return a.transform(this.outstanding).transform(this.buffer)};return a}();c.Client=b})(window);(function(c){let b=0,a=0,d=null;"use strict";const f=function(){function f(a,b){this.cursorBefore=a;this.cursorAfter=b}function k(a,b){this.id=a;this.editorAdapter=b;this.li=document.createElement("li")}function m(a,b,d,c){q.call(this,a);this.serverAdapter=d;this.editorAdapter=c;this.undoManager=new z;this.clients={};const f=this;this.editorAdapter.registerCallbacks({change(a,b){f.onChange(a,b)},cursorActivity(){f.onCursorActivity()},blur(){f.onBlur()},focus(){f.onFocus()}});this.editorAdapter.registerUndo(()=>
{f.undo()});this.editorAdapter.registerRedo(()=>{f.redo()});this.serverAdapter.registerCallbacks({client_left(a){f.onClientLeft(a)},set_name(a,b){f.getClientObject(a).setName(b)},ack(){f.serverAck()},operation(a){f.applyServer(u.fromJSON(a))},cursor(a,b){b?f.getClientObject(a).updateCursor(f.transformCursor(r.fromJSON(b))):f.getClientObject(a).removeCursor()},clients(a){let b;for(b in f.clients)if(Object.prototype.hasOwnProperty.call(f.clients,b)&&!Object.prototype.hasOwnProperty.call(a,b))f.onClientLeft(b);
for(b in a)if(Object.prototype.hasOwnProperty.call(a,b)){var d=f.getClientObject(b);a[b].name&&d.setName(a[b].name);({selection:d}=a[b]);d?f.clients[b].updateSelection(f.transformSelection(Selection.fromJSON(d))):f.clients[b].removeSelection()}},reconnect(){f.serverReconnect()}})}function n(a){return a[a.length-1]}const {Client:q}=c,{Cursor:r}=c,{UndoManager:z}=c,{TextOperation:u}=c,{WrappedOperation:t}=c;f.prototype.invert=function(){return new f(this.cursorAfter,this.cursorBefore)};f.prototype.compose=
...
(d,c)=>{a(null!==c);const f=new k(0,n);let g=f;b.pos>d&&(g.next=new k(b.pos-d,c.annotation),g=g.next);for(;b.end()>d+c.length;)d+=c.length,c=c.next;d=d+c.length-b.end();0<d&&(g.next=new k(d,c.annotation));return f.next})};g.prototype.updateSpan=function(b,d){0!==b.length&&this.wrapOperation_(b,(c,f)=>{a(null!==f);const g=new k(0,n);let m=g;var q=c,r=b.pos-q;a(r<f.length);0<r&&(m.next=new k(r,f.annotation),m=m.next,q+=m.length);for(;null!==f&&b.end()>=c+f.length;)q=c+f.length-q,m.next=new k(q,d(f.annotation,
q)),m=m.next,c+=f.length,f=f.next,q=c;r=b.end()-q;0<r&&(a(r<f.length),m.next=new k(r,d(f.annotation,r)),m=m.next,q+=m.length,m.next=new k(c+f.length-q,f.annotation));return g.next})};g.prototype.wrapOperation_=function(a,d){if(0>a.pos)throw Error("Span start cannot be negative.");const c=[],g=[];a=this.getAffectedNodes_(a);if(null!==a.start){var m=a.end.next;a.end.next=null}else m=a.succ;var n=d(a.startPos,a.start);let q=!1;d=!1;if(n){this.mergeNodesWithSameAnnotations_(n);let b;a.pred&&a.pred.annotation.equals(n.annotation)?
(q=!0,n.length+=a.pred.length,a.beforePred.next=n,b=a.predPos):(a.beforeStart.next=n,b=a.startPos);for(;n.next;)g.push(new f(b,n)),b+=n.length,n=n.next;a.succ&&a.succ.annotation.equals(n.annotation)?(n.length+=a.succ.length,d=!0,n.next=a.succ.next):n.next=m;g.push(new f(b,n))}else a.pred&&a.succ&&a.pred.annotation.equals(a.succ.annotation)?(d=q=!0,n=new k(a.pred.length+a.succ.length,a.pred.annotation),a.beforePred.next=n,n.next=a.succ.next,g.push(new f(a.startPos-a.pred.length,n))):a.beforeStart.next=
m;q&&c.push(new b(a.predPos,a.pred));m=a.startPos;for(n=a.start;null!==n;)c.push(new b(m,n)),m+=n.length,n=n.next;d&&c.push(new b(m,a.succ));this.changeHandler_(c,g)};g.prototype.getAffectedNodes_=function(a){const b={};let d=null,c=this.head_,f=c.next,g=0;for(;null!==f&&a.pos>=g+f.length;)g+=f.length,d=c,c=f,f=f.next;if(null===f&&(0!==a.length||a.pos!==g))throw Error("Span start exceeds the bounds of the AnnotationList.");b.startPos=g;b.start=0===a.length&&a.pos===g?null:f;b.beforeStart=c;g===a.pos&&
...
function(a){return this.cloneWithNewAttribute_(b.LINE_ALIGN,a)};a.prototype.listItem=function(a){vceditor.utils.assert(!1===a||"u"===a||"o"===a||"t"===a||"tc"===a);return this.cloneWithNewAttribute_(b.LIST_TYPE,a)};a.prototype.getIndent=function(){return this.attributes[b.LINE_INDENT]||0};a.prototype.getAlign=function(){return this.attributes[b.LINE_ALIGN]||0};a.prototype.getListItem=function(){return this.attributes[b.LIST_TYPE]||!1};return a}();c.LineFormatting=b})(window);(function(c){const b=function(){function a(a){return a===k.ORDERED?"</ol>":"</ul>"}function b(a,b){return a===b||a===k.TODO&&b===k.TODOCHECKED||a===k.TODOCHECKED&&b===k.TODO}const {utils:f}=c,g=c.AttributeConstants,{LIST_TYPE:k}=c.LineFormatting;return function(d,c){let m="",n=!0;const z=[];var u=!1;let t=!0;var p=!0;let v=0,A=d.ops[v],D=!1;for(;A;){f.assert(A.isInsert());const q=A.attributes;if(n){n=!1;var G=0,F=null,C="left";g.LINE_SENTINEL in q&&(G=q[g.LINE_INDENT]||0,F=q[g.LIST_TYPE]||null,C=
q[g.LINE_ALIGN]||"left");F&&(G=G||1);u?(m+="</li>",u=!1):t||(p&&(m+="<br/>"),m+="</div>");t=!1;for(f.assert(0<=G,"Indent must not be negative.");z.length>G||G===z.length&&null!==F&&!b(F,z[z.length-1]);)m+=a(z.pop());for(;z.length<G;)p=F||k.UNORDERED,D=F==k.TODO||F==k.TODOCHECKED||D,m+=p===k.ORDERED?"<ol>":p===k.UNORDERED?"<ul>":'<ul class="vceditor-todo">',z.push(p);p="left"!==C?` style="text-align:${C}"`:"";if(F){u="";switch(F){case k.TODOCHECKED:u=' class="vceditor-checked"';break;case k.TODO:u=
' class="vceditor-unchecked"'}m+=`<li${u}${p}>`;u=!0}else m+=`<div${p}>`;p=!0}if(g.LINE_SENTINEL in q){A=d.ops[++v];continue}if(g.ENTITY_SENTINEL in q){for(F=0;F<A.text.length;F++)G=vceditor.Entity.fromAttributes(q),G=c.exportToElement(G),m+=G.outerHTML;A=d.ops[++v];continue}G=F="";for(const a in q){C=q[a];var B;if(a===g.BOLD||a===g.ITALIC||a===g.UNDERLINE||a===g.STRIKE){f.assert(!0===C);var H=B=a}else a===g.FONT_SIZE?(H=`span style="font-size: ${C}`,H+="string"!==typeof C||-1===C.indexOf("px",C.length-
2)?'px"':'"',B="span"):a===g.FONT?(H=`span style="font-family: ${C}"`,B="span"):a===g.COLOR?(H=`span style="color: ${C}"`,B="span"):a===g.BACKGROUND_COLOR?(H=`span style="background-color: ${C}"`,B="span"):f.log(!1,`Encountered unknown attribute while rendering html: ${a}`);H&&(F+=`<${H}>`);B&&(G=`</${B}>${G}`)}({text:C}=A);const r=C.indexOf("\n");0<=r?(n=!0,A=r<C.length-1?new vceditor.TextOp("insert",C.substr(r+1),q):d.ops[++v],C=C.substr(0,r)):A=d.ops[++v];C=C.replace(/  +/g,a=>Array(a.length+1).join("\u00a0")).replace(/^ /,
"\u00a0").replace(/ $/,"\u00a0");0<C.length&&(p=!1);m+=F+C.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\u00a0/g,"&nbsp;")+G}u?m+="</li>":t||(p&&(m+="&nbsp;"),m+="</div>");for(;0<z.length;)m+=a(z.pop());D&&(m='<style>ul.vceditor-todo { list-style: none; margin-left: 0; padding-left: 0; } ul.vceditor-todo > li { padding-left: 1em; text-indent: -1em; } ul.vceditor-todo > li:before { content: "\\2610"; padding-right: 5px; } ul.vceditor-todo > li.vceditor-checked:before { content: "\\2611"; padding-right: 5px; }</style>\n'+
m);return m}}();c.SerializeHtml=b})(window);(function(c){const b=function(){function a(a,b,d){this.listType=a||m.UNORDERED;this.lineFormatting=b||vceditor.LineFormatting();this.textFormatting=d||vceditor.Formatting()}function b(){this.lines=[];this.currentLine=[];this.currentLineListItemType=null}function f(a,b,d){if(a.nodeType===q.ELEMENT_NODE){var c=n.fromElement(a);if(c){d.currentLine.push(new vceditor.Text(vceditor.sentinelConstants.ENTITY_SENTINEL_CHARACTER,new vceditor.Formatting(c.toAttributes())));return}}switch(a.nodeType){case q.TEXT_NODE:a=
a.nodeValue.replace(/[ \n\t]+/g," ");d.currentLine.push(vceditor.Text(a,b.textFormatting));break;case q.ELEMENT_NODE:switch(c=a.getAttribute("style")||"",b=k(b,c),a.nodeName.toLowerCase()){case "div":case "h1":case "h2":case "h3":case "p":d.newlineIfNonEmpty(b);g(a,b,d);d.newlineIfNonEmpty(b);break;case "center":b=b.withAlign("center");d.newlineIfNonEmpty(b);g(a,b.withAlign("center"),d);d.newlineIfNonEmpty(b);break;case "b":case "strong":g(a,b.withTextFormatting(b.textFormatting.bold(!0)),d);break;
...
1;this.currentLine[0].text=this.currentLine[0].text.replace(/^ +/,"");this.currentLine[a].text=this.currentLine[a].text.replace(/ +$/g,"");for(a=0;a<this.currentLine.length;a++)this.currentLine[a].text=this.currentLine[a].text.replace(/\u00a0/g," ")}1===this.currentLine.length&&""===this.currentLine[0].text&&(this.currentLine=[])};let n;var q=q||{ELEMENT_NODE:1,TEXT_NODE:3};return function(d,c){const g=(vceditor.document||document).createElement("div");g.innerHTML=d;n=c;d=new b;c=new a;f(g,c,d);return d.lines}}();
...
b+m.chars),f=0;f<c.length;f++){var v={};for(const a in m.attributes){var A=m.attributes[a];const b=c[f].attributes[a];!1===A?b&&(v[a]=b):A!==b&&(v[a]=b||!1)}n.retain(c[f].length,v);b+=c[f].length}else if(m.isInsert())n.delete(m.text.length);else if(m.isDelete()){v=d.getRange(d.posFromIndex(b),d.posFromIndex(b+m.chars));c=this.rtcm.getAttributeSpans(b,b+m.chars);for(f=A=0;f<c.length;f++)n.insert(v.substr(A,c[f].length),c[f].attributes),A+=c[f].length;b+=m.chars}}return new m(n,a.meta.invert())};return a}();
...
{};this.dirtyLines_=[]}function d(a,b){return a.line-b.line||a.ch-b.ch}function c(a){if(0===a.length)return 0;let b=0;for(let d=0;d<a.length;d++)b+=a[d].length;return b+a.length-1}function g(a){this.attributes=a||{}}function k(a,b){const d=a[b];a[b]=function(){d.apply(a,arguments)}}const {AnnotationList:m}=b,{Span:n}=b,{utils:q}=b,r=b.AttributeConstants,z={c:"color",bc:"background-color",fs:"font-size",li(a){return`padding-left: ${40*a}px`}},u={};q.makeEventEmitter(a,["change","attributesChange",
...
b,d,c,f){const k=[];let m=a;const v=this;this.annotationList_.updateSpan(new n(a,b-a),(a,b)=>{const n={};for(var q in a.attributes)n[q]=a.attributes[q];n[r.LINE_SENTINEL]&&!f||d(n);q={};const A={};v.computeChangedAttributes_(a.attributes,n,q,A);a:{for(const b in q){a=!1;break a}a=!0}a||k.push({start:m,end:m+b,attributes:q,attributesInverse:A,origin:c});m+=b;return new g(n)});0<k.length&&this.trigger("attributesChange",this,k)};a.prototype.computeChangedAttributes_=function(a,b,d,c){const f={};let g;
...
d=d.line;let f=c.line;b=b.getLine(f);c=this.areLineSentinelCharacters_(b.substr(0,c.ch));f>d&&c&&f--;this.updateLineAttributes(d,f,a)};a.prototype.updateLineAttributes=function(a,b,d){for(;a<=b;a++){var c=this.codeMirror.getLine(a);const b=this.codeMirror.indexFromPos({line:a,ch:0});c[0]!==t?(c={},c[r.LINE_SENTINEL]=!0,d(c),this.insertText(b,t,c)):this.updateTextAttributes(b,b+1,d,null,!0)}};a.prototype.replaceText=function(a,b,d,c,f){this.changeId_++;const g="cmrt-"+this.changeId_;this.outstandingChanges_[g]=
...
b);for(var f=0;f<a.length;f++)({attributes:d}=a[f].annotation),r.LINE_SENTINEL in d&&(c[this.codeMirror.posFromIndex(a[f].pos).line]=!0),(d=a[f].getAttachedObject())&&d.clear();for(f=0;f<b.length;f++){({annotation:d}=b[f]);var g=r.LINE_SENTINEL in d.attributes;const k=r.ENTITY_SENTINEL in d.attributes;a=this.codeMirror.posFromIndex(b[f].pos);g?c[a.line]=!0:k?this.markEntity_(b[f]):(d=this.getClassNameForAttributes_(d.attributes),""!==d&&(g=this.codeMirror.posFromIndex(b[f].pos+b[f].length),d=this.codeMirror.markText(a,
...
document.getElementsByTagName("head")[0],d=document.createElement("style");d.type="text/css";d.styleSheet?d.styleSheet.cssText=a:d.appendChild(document.createTextNode(a));b.appendChild(d)};a.prototype.getClassNameForAttributes_=function(a){let d="";for(const g in a){var c=a[g];if(g===r.LINE_SENTINEL)b.utils.assert(!0===c,"LINE_SENTINEL attribute should be true if it exists.");else{let a=(this.options_.cssPrefix||"cmrt-")+g;if(!0!==c){g===r.FONT_SIZE&&"string"!==typeof c&&(c+="px");var f=c.toString().toLowerCase().replace(/[^a-z0-9-_]/g,
"-");a+=`-${f}`;z[g]&&(u[g]||(u[g]={}),u[g][f]||(u[g][f]=!0,f=z[g],c="function"===typeof f?f(c):`${f}: ${c}`,this.addStyleWithCSS_(`${g===r.LINE_INDENT?`pre.${a}`:`.${a}`} { ${c} }`)))}d=`${d} ${a}`}}return d};a.prototype.markEntity_=function(a){var {attributes:d}=a.annotation;d=b.Entity.fromAttributes(d);const c=this.codeMirror,f=this,g=[];for(let b=0;b<a.length;b++){var k=c.posFromIndex(a.pos+b);const f=c.posFromIndex(a.pos+b+1),m={collapsed:!0,atomic:!0,inclusiveLeft:!1,inclusiveRight:!1},n=this.createEntityHandle_(d,
a.pos),q=this.entityManager_.renderToElement(d,n);q&&(m.replacedWith=q);k=c.markText(k,f,m);g.push(k);n.setMarker(k)}a.attachObject({clear(){for(let a=0;a<g.length;a++)g[a].clear()},update(a){a=b.Entity.fromAttributes(a);for(let b=0;b<g.length;b++)f.entityManager_.updateElement(a,g[b].replacedWith)}});this.queueRefresh_()};a.prototype.queueRefresh_=function(){const a=this;this.refreshTimer_||(this.refreshTimer_=setTimeout(()=>{a.codeMirror.refresh();a.refreshTimer_=null},0))};a.prototype.createEntityHandle_=
...
typeof b.from){for(a=[];b;)a.push(b),b=b.next;b=a}a=this.convertCoordinateSystemForChanges_(b);const d=[];for(let b=0;b<a.length;b++){var c=a[b];const {start:f}=c,{text:k}=c,{removed:m}=c;let {origin:q}=c;if(0<m.length){const a=this.annotationList_.getAnnotatedSpansForSpan(new n(f,m.length));let b=0;for(let g=0;g<a.length;g++){const k=a[g];d.push({start:f,end:f+k.length,removedAttributes:k.annotation.attributes,removed:m.substr(b,k.length),attributes:{},text:"",origin:c.origin});b+=k.length}this.annotationList_.removeSpan(new n(f,
m.length))}0<k.length&&("+input"===c.origin||"paste"===c.origin?c=this.currentAttributes_||{}:q in this.outstandingChanges_?(c=this.outstandingChanges_[q].attributes,q=this.outstandingChanges_[q].origOrigin,delete this.outstandingChanges_[q]):c={},this.annotationList_.insertAnnotatedSpan(new n(f,k.length),new g(c)),d.push({start:f,end:f,removedAttributes:{},removed:"",text:k,attributes:c,origin:q}))}this.markLineSentinelCharactersForChanges_(b);0<d.length&&this.trigger("change",this,d)};a.prototype.convertCoordinateSystemForChanges_=
...
function(a){return q.elt("div",`${a}.`,{class:"vceditor-list-left"})};a.prototype.makeUnorderedListElement_=function(){return q.elt("div","\u2022",{class:"vceditor-list-left"})};a.prototype.toggleTodo=function(a){const b=r.LIST_TYPE,d=this.getCurrentLineAttributes_();let c;b in d&&("t"===d[b]||"tc"===d[b])?"t"===d[b]?c="tc":"tc"===d[b]&&(c=a?"t":!1):c="t";this.setLineAttribute(b,c)};a.prototype.makeTodoListElement_=function(a,b){const d={type:"checkbox",class:"vceditor-todo-left"};a&&(d.checked=!0);
a=q.elt("input",!1,d);const c=this;q.on(a,"click",q.stopEventAnd(a=>{c.codeMirror.setCursor({line:b(),ch:1});c.toggleTodo(!0)}));return a};a.prototype.lineIsListItemOrIndented_=function(a){a=this.getLineAttributes_(a);return!1!==(a[r.LIST_TYPE]||!1)||0!==(a[r.LINE_INDENT]||0)};a.prototype.onCursorActivity_=function(){const a=this;clearTimeout(a.cursorTimeout);a.cursorTimeout=setTimeout(()=>{a.updateCurrentAttributes_()},1)};a.prototype.getCurrentAttributes_=function(){this.currentAttributes_||this.updateCurrentAttributes_();
return this.currentAttributes_};a.prototype.updateCurrentAttributes_=function(){var a=this.codeMirror,d=a.indexFromPos(a.getCursor("anchor"));const c=a.indexFromPos(a.getCursor("head"));a=c;if(d>c){for(;a<this.end();){d=this.getRange(a,a+1);if("\n"!==d&&d!==t)break;a++}a<this.end()&&a++}else for(;0<a;){d=this.getRange(a-1,a);if("\n"!==d&&d!==t)break;a--}d=this.annotationList_.getAnnotatedSpansForPos(a);this.currentAttributes_={};a={};0<d.length&&!(r.LINE_SENTINEL in d[0].annotation.attributes)?a=
d[0].annotation.attributes:1<d.length&&(b.utils.assert(!(r.LINE_SENTINEL in d[1].annotation.attributes),"Cursor can't be between two line sentinel characters."),a=d[1].annotation.attributes);for(const b in a)"l"!==b&&"lt"!==b&&"li"!==b&&0!==b.indexOf(r.ENTITY_SENTINEL)&&(this.currentAttributes_[b]=a[b])};a.prototype.getCurrentLineAttributes_=function(){var a=this.codeMirror;const b=a.getCursor("anchor");a=a.getCursor("head");let {line:d}=a;0===a.ch&&b.line<a.line&&d--;return this.getLineAttributes_(d)};
...
if(this.emptySelection_()){const d=a.getCursor("head").line,c=this.getLineAttributes_(d),f=c[r.LIST_TYPE];f&&1===a.getLine(d).length?this.updateLineAttributes(d,d,a=>{delete a[r.LIST_TYPE];delete a[r.LINE_INDENT]}):(a.replaceSelection("\n","end","+input"),this.updateLineAttributes(d+1,d+1,a=>{for(const b in c)a[b]=c[b];"tc"===f&&(a[r.LIST_TYPE]="t");b.trigger("newLine",{line:d+1,attr:a})}))}else a.replaceSelection("\n","end","+input")};a.prototype.deleteLeft=function(){const a=this.codeMirror,b=a.getCursor("head");
var d=this.getLineAttributes_(b.line);const c=d[r.LIST_TYPE];d=d[r.LINE_INDENT];const f=this.emptySelection_()&&1===b.ch;f&&c?this.updateLineAttributes(b.line,b.line,a=>{delete a[r.LIST_TYPE];delete a[r.LINE_INDENT]}):f&&d&&0<d?this.updateLineAttributes(b.line,b.line,a=>{a[r.LINE_INDENT]--}):a.deleteH(-1,"char")};a.prototype.deleteRight=function(){const a=this.codeMirror,b=a.getCursor("head");var d=a.getLine(b.line);d=this.areLineSentinelCharacters_(d);const c=b.line+1<a.lineCount()?a.getLine(b.line+
1):"";this.emptySelection_()&&d&&c[0]===t?a.replaceRange("",{line:b.line,ch:0},{line:b.line+1,ch:0},"+input"):a.deleteH(1,"char")};a.prototype.indent=function(){this.updateLineAttributesForSelection(a=>{const b=a[r.LIST_TYPE];a[r.LINE_INDENT]?a[r.LINE_INDENT]++:a[r.LINE_INDENT]=b?2:1})};a.prototype.unindent=function(){this.updateLineAttributesForSelection(a=>{const b=a[r.LINE_INDENT];b&&1<b?a[r.LINE_INDENT]=b-1:(delete a[r.LIST_TYPE],delete a[r.LINE_INDENT])})};a.prototype.getText=function(){return this.codeMirror.getValue().replace(new RegExp(t,
...
d.formatting.attributes);for(let a=0;a<d.textPieces.length;a++)c(d.textPieces[a]);c("\n")}const k=[];for(let a=0;a<d.length;a++)d[a]instanceof b.Line?g(d[a]):c(d[a]);return k};b=b||{};b.Vceditor=function(a){function d(a,b,g,k){if(!(this instanceof d))return new d(a,b,g,k);if(!v&&!A)throw Error("Couldn't find CodeMirror or ACE.  Did you forget to include codemirror.js or ace.js?");if(v&&b instanceof v)this.codeMirror_=this.editor_=b,a=this.codeMirror_.getValue();else if(A&&b&&b.session instanceof A.EditSession){if(this.ace_=
...
c=document.getElementById("user_list"),c.classList.remove("active")),b&&(b.style.display="none")):c&&(c.classList.add("enable"),c.classList.remove("disable"),c=document.getElementById("user_list"),c.classList.add("active"))):null!=k&&"support"===k?(c=document.getElementById("congreaSupport"))&&c.classList.add("active"):(c&&(c.classList.add("enable"),c=document.getElementById("user_list"),c.classList.add("active"),virtualclass.chat.chatWindow="private"),a&&(a.style.display="none"));document.querySelector("#virtualclassCont.congrea  .vmchat_bar_button").classList.contains("active")?
...
title:lang.online,userSent(a){console.log("====> UserList is created 1");return b("#chat_div").memberlist("option","boxManager").addUsr(a)}})},history(){var a=null;null!=localStorage.getItem(wbUser.sid)&&(a=JSON.parse(localStorage.getItem(wbUser.sid)),displayPvtChatHistory(a),a=localStorage.getItem("chatEnable"),null!=a&&"false"===a&&virtualclass.user.control.disbaleAllChatBox(),this.vmstorage=JSON.parse(localStorage.getItem(wbUser.sid)));0<localStorage.length&&(displaycomChatHistory(),virtualclass.chat.removeChatHighLight("chatrm"),
null!=a&&"false"===a&&virtualclass.user.control.disableCommonChat())},exportCommonChat(a){const b=[],d=virtualclass.chat.commonChat;for(let c=0;c<d.length;c++)a<=d[c].time&&b.push(d[c]);return b},UI:{privateChatBox:{init(){b("#tabs").delegate("span.icon-close","click",this.close);b("#tabs").on("click","li a",this.toggle)},close(){var a=b(this).closest("li").attr("id").substring(5);b(`#${a}`).chatbox("option").boxClosed(a);b(`div#cb${a}.ui-widget`).hide();a=b(this).closest("li").remove().attr("aria-controls");
...
a.tabs("refresh")},removeCookieUserInfo(a){document.cookie="auth_user=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/";document.cookie="auth_pass=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/";document.cookie="path=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/";display_error(a.message)},makeUserListEmpty(){const a=`url(${c.whiteboardPath}images/offline.png)no-repeat top left`;b("#user_list .inner_bt #usertab_icon").css({background:a});b("#chatroom_bt .inner_bt #chatroom_text").text(`${lang.chatroom} (0)`);
...
uiChatboxLog=(b.uiChatboxLog=b.element).addClass("ui-widget-content ui-chatbox-log").appendTo(uiChatboxContent);uiChatboxInputBox=(b.uiChatboxInputBox=c("<input></input>")).addClass("ui-widget-content ui-chatbox-input-box ").prop("id","ta_chrm2").prop("placeholder","Send message...").appendTo(document.querySelector(".congrea #congchatBarInput")).keydown(function(d){if(d.keyCode&&d.keyCode===c.ui.keyCode.ENTER){msg=c.trim(c(this).val());d=(new Date).getTime();var f={receiver:"chatroom",msg,cf:"msg",
time:d};0<msg.length&&(ioAdapter.mustSend(f),c(this).val(""),b.options.messageSent({name:io.cfg.userobj.name},{msg,time:d}),null!=localStorage.getItem("chatroom")?(f=JSON.parse(localStorage.getItem("chatroom")),a={userid:io.cfg.userid,name:io.cfg.userobj.name,msg,time:d},f.push(a)):a={userid:io.cfg.userid,name:io.cfg.userobj.name,msg,time:d},virtualclass.chat.commonChat.push(a));return!1}}).focusin(()=>{uiChatboxInputBox.addClass("ui-chatbox-input-focus");virtualclass.vutil.inputFocusHandler()}).focusout(()=>
{uiChatboxInputBox.removeClass("ui-chatbox-input-focus");virtualclass.vutil.inputFocusOutHandler()});uiChatboxContent.children().click(()=>{b.uiChatboxInputBox.focus()});b._setWidth(b.options.width);b._position(b.options.offset);b.options.boxManager.init(b);roles.isStudent()&&virtualclass.settings.studentgc(virtualclass.settings.info.studentgc);b.options.hidden||(d.show(),virtualclass.vutil.isPlayMode()&&disCommonChatInput())},_setOption(b,a){if(null!=a)switch(b){case "hidden":a?this.uiChatbox.hide():
...
const chatboxManager=function(){function c(b){var c=d.indexOf(b);if(-1!==c){d.splice(c,1);a.splice(c,1);b=f.width+f.gap;for(let a=c;a<d.length;a++)c=$(`#${d[a]}`).chatbox("option","offset"),$(`#${d[a]}`).chatbox("option","offset",c-b)}else alert(`There is some error: ${b}`)}function b(a,b,d){f.messageSent(a,b,d)}let a=[],d=[];const f={width:230,gap:20,maxBoxes:5,messageSent(a,b,d){$(`#${a}`).chatbox("option","boxManager").addMsg(b,d)}};return{init:function(a){$.extend(f,a)},addBox:function(g,k,m){m=
...
name:`${d.name} ${d.lname}`}))),null==document.querySelector(`#cb${d.userid}`)&&(chatboxManager.addBox(d.userid,{dest:`dest${virtualclass.chat.counter}`,title:`box${virtualclass.chat.counter}`,first_name:d.name,last_name:d.lname}),Object.prototype.hasOwnProperty.call(virtualclass.chat.vmstorage,d.userid)&&1<virtualclass.chat.vmstorage[d.userid].length&&displayUserSinglePvtChatHistory(d.userid)),chatboxManager.init({user:d,messageSent(a,b,d){$(`#${a}`).chatbox("option","boxManager").addMsg(b.name,
d)}}),roles.isStudent()&&virtualclass.settings.studentpc(virtualclass.settings.info.studentpc),$(`#${d.userid}`).chatbox("option").messageSent(d.userid,d,b),$(`li[aria-controls='tabcb${d.userid}']`).addClass("ui-state-highlight"),k=d.userid),virtualclass.chat.vmstorage[k].push({userid:d.userid,name:d.name,msg:b,time:g})):(b={msg:b,time:c.message.time},virtualclass.chat.chatroombox||0!==$("ul#chat_room").length||(c=document.createElement("ul"),c.id="chat_room",document.body.appendChild(c),virtualclass.chat.chatroombox=
$("#chat_room").chatroom({id:"chat_room",user:d,title:lang.chatroom_header,messageSent(a,b){const d=a.userid||virtualclass.gObj.uid;$("#chat_room").chatroom("option","boxManager").addMsg(a.name,b,d)}})),$("#chat_room").chatroom("option").messageSent(d,b),c=localStorage.getItem("chatroom"),null!=c?(c=JSON.parse(c),b={userid:d.userid,name:d.name,msg:b,time:g},c.push(b)):b={userid:d.userid,name:d.name,msg:b,time:g},virtualclass.chat.commonChat.push(b),0===$("#chatroom_bt2.active").length&&virtualclass.config.makeWebSocketReady&&
($("#chatroom_bt2").addClass("ui-state-highlight"),$("#chatrm").removeClass("enable")))}function statusUpdate(c,b,a){$(`#${c.userid}`).length&&($(`#${c.userid}`).chatbox("option").messageSent(c.userid,c,b),$(`#ta${c.userid}`).prop("disabled",a))}function commonChatboxUpdate(c,b){$("ul#chat_room").length&&$("#chat_room").chatroom("option").messageSent(c,b)}
...
c,c.msg)});b=!1;a==virtualclass.chat.supportId&&(d=document.getElementById(`cb${virtualclass.chat.supportId}`))&&d.classList.add("support");"hidden"==localStorage.getItem(a)&&($(`#cb${a}`).hide(),$(`#tabcb${a}`).removeClass("ui-state-active"))})}function displayError(c){virtualclass.view.createErrorMsg(c,"errorContainer","virtualclassAppFooterPanel",{className:"Unauthenticated"})}function clearAllChatBox(){$("#chatWidget .icon-close").trigger("click")}
...
"none";document.getElementById("virtualclassApp").style.display="flex";localStorage.setItem("precheck",!0);virtualclass.videoHost.afterSessionJoin();virtualclass.precheck.afterComplete()},createVideo(){if(virtualclass.system.mediaDevices.hasWebcam&&"undefined"!==typeof virtualclass.precheck.mediaStream){const c=document.getElementById("webcamTempVideo");"mobTab"===virtualclass.system.device?(c.width=320,c.height=100):(c.width=320,c.height=240);virtualclass.adpt.attachMediaStream(c,virtualclass.precheck.mediaStream);
c.muted=!0;c.play()}}},startSession(){document.getElementById("virtualclassApp").style.display="flex";const c=document.getElementById("virtualclassPreCheck");null!=c&&c.parentNode.removeChild(c)},updateProgressBar(c){document.querySelector(`#progressbarScreen .${c}`);const b=document.querySelectorAll("#preCheckProgress .progressbar li");for(let a=0;a<b.length;a++)if(b[a].classList.add("active"),b[a].classList.contains(c)){0<a&&b[a-1].classList.remove("current");b[a].classList.add("current");break}},
...
"enable"===c?(a.setAttribute("data-action","disable"),a.className="video on",b.setAttribute("data-title","Video off")):(a.setAttribute("data-action","enable"),a.className="video off",b.setAttribute("data-title","Video on"))},setUserIcon(c){var b;(b=chatContainerEvent.elementFromShadowDom(`#ml${c} .user-details a .videoWrapper`))&&b.parentNode.removeChild(b);const a=chatContainerEvent.elementFromShadowDom(`#ml${c} .user-details a`);chatContainerEvent.elementFromShadowDom(`#ml${c} .user-details a span`)||
...
virtualclass.poll.askConfirmClose,"close",a)},saveQuestion(a,b,c){"course"===c?(this.coursePoll[b].questiontext=a.value,this.coursePoll[b].creator=wbUser.name):(this.sitePoll[b].questiontext=a.value,this.sitePoll[b].creator=wbUser.name);document.getElementById(`qnText${c}${b}`).innerHTML=a.value},saveOption(a,b){const d=[];let c=0;var k;b="course"===b?this.coursePoll[a]:this.sitePoll[a];const m=document.getElementById("optsTxCont").querySelectorAll("#virtualclassCont #optsTxCont .opt");for(a=0;a<
m.length;a++)d[a]=m[a].value;for(k in b.options)b.options[k]=d[c],c++;if(a>c)for(c,k=c;k<a;k++)b.options[`noid${c}`]=d[c],c++},hideModal(){virtualclass.modal.removeModal()},newPollSave(a,b){a=0;const d=[];if(!virtualclass.poll.isBlank())return 0;var c=document.getElementById("optsTxCont").querySelectorAll("#virtualclassCont #optsTxCont .opt");for(let a=0;a<c.length;a++)d.push(c[a].value);c=document.getElementById("q");"course"===b&&(a=virtualclass.poll.cmid);virtualclass.poll.interfaceToSave({question:c.value,
...
0):c?(alert(virtualclass.lang.getString("delblank")),0):1},saveNdPublish(a,b){if(!virtualclass.poll.isBlank())return 0;var d=`${b}Poll`,c=document.getElementById("optsTxCont").querySelectorAll("#virtualclassCont #optsTxCont .opt");if("undefined"===typeof a){({length:d}=virtualclass.poll[d]);var k=document.getElementById("q").value,m={};for(var n=0;n<c.length;n++)m[n]=c[n].value;c=m;virtualclass.poll.dataToStd.question=k;virtualclass.poll.dataToStd.options=c;virtualclass.poll.newPollSave(d,b,!0)&&
virtualclass.poll.pollSetting(b,d,!0)}else{k=virtualclass.poll[d][a];n=document.getElementById("q").value;k.question=n;n=0;for(m in k.options)k.options[m]=c[n].value,n++;virtualclass.poll[d][a].questiontext=document.getElementById("q").value;virtualclass.poll.dataToStd.question=virtualclass.poll[d][a].questiontext;virtualclass.poll.dataToStd.options=virtualclass.poll[d][a].options;virtualclass.poll.etSave(a,b,setting)&&virtualclass.poll.pollSetting(b,a,!0)}a={type:"course",qid:a,pollqnOps:virtualclass.poll.dataToStd};
...
virtualclass.poll.sitePoll[b];"undefined"!==typeof a&&(delete a.options[d],virtualclass.poll.interfaceToDelOption(d))},publishHandler(a,b,c){var d=document.getElementById("mszBoxPoll");0<d.childNodes.length&&d.childNodes[0].parentNode.removeChild(d.childNodes[0]);({isPublished:d}=a);d?virtualclass.poll.duplicatePoll(a):virtualclass.poll.publishPoll(a,b,c)},duplicatePoll(a){const b=[];for(const d in a.options)b.push(a.options[d]);virtualclass.poll.interfaceToSave({question:a.questiontext,options:b,
action:"newPollSave",category:a.category,copied:!0},a.category)},publishPoll(a,b){virtualclass.poll.dataToStd.question=a.questiontext;virtualclass.poll.dataToStd.qId=a.questionid;virtualclass.poll.dataToStd.options=a.options;document.getElementById("layoutPollBody");var d=document.getElementById("editPollModal");d&&d.remove();d={};d.questiontext=a.questiontext;d.options=a.options;const c=virtualclass.getTemplate("preview-modal","poll"),k=document.querySelector("#virtualclassApp #bootstrapCont");k&&
...
"timer")&&clearInterval(virtualclass.poll.timer);if(a=document.getElementById("timerLabel"))a.innerHTML=virtualclass.lang.getString("ETime");if(roles.hasControls())k=document.getElementById("timerCont");else if(a=document.getElementById("stdContHead"))k=document.querySelector("#timerCont"),null===k&&(k=document.createElement("div"),k.id="timerCont",a.appendChild(k));a=function(){k?(c++,60===c&&(c=0,d++,60===d&&(d=0)),k.innerHTML=`${10>d?`0${d}`:d}:${10>c?`0${c}`:c}`):clearInterval(virtualclass.poll.timer)};
...
c)});document.getElementById("cancelSetting").addEventListener("click",()=>{virtualclass.modal.removeModal("editPollModal")});virtualclass.modal.closeModalHandler("editPollModal")},saveSetting(a,b){let d;document.getElementById("radioBtn2")&&(d=document.getElementById("radioBtn2").checked,virtualclass.poll.setting.timer=d);const c=document.getElementById("timer");if(c){var k=c.options[c.selectedIndex].value;const a=document.getElementById("ut");virtualclass.poll.setting.time.totalInSeconds="minut"===
a.options[a.selectedIndex].value?60*+k:+k;virtualclass.poll.setting.time.timestamp=virtualclass.vutil.localToUTC(Date.now())}document.getElementById("pollCkbox")&&(k=document.getElementById("pollCkbox").checked,virtualclass.poll.setting.showResult=k);virtualclass.poll.UI.resultView(d,a);virtualclass.poll.currResultView="bar";if(d){const [a,b,d]=virtualclass.vutil.miliSecondsToFormatedTime(1E3*virtualclass.poll.setting.time.totalInSeconds);virtualclass.poll.remainingTimer({hour:a,min:b,sec:d})}else virtualclass.poll.elapsedTimer();
...
delete virtualclass.poll.afterReload);c&&ioAdapter.mustSend({poll:{pollMsg:"stdPublish",data:a},cf:"poll"});a.view=virtualclass.poll.currResultView;virtualclass.poll.showGraph();virtualclass.poll.updateBarGraph();virtualclass.poll.pollState.currScreen="teacherPublish";virtualclass.poll.pollState.data=a},updateResponse(a,b){"list"!==virtualclass.poll.currResultView&&virtualclass.poll.showChart();var d=document.getElementById("pollResultMsz");d&&(d.style.display="none");d=document.querySelectorAll("#chartMenuCont button");
for(let a=0;a<d.length;a++)d[a].classList.remove("disabled");d={};"undefined"===typeof virtualclass.poll.count[a]&&(virtualclass.poll.count[a]=0);virtualclass.poll.count[a]+=1;d[b.userid]=a;d.username=b.name;virtualclass.poll.list.push(d);"bar"===virtualclass.poll.currResultView?(virtualclass.poll.showGraph(),virtualclass.poll.updateBarGraph()):"pi"===virtualclass.poll.currResultView?virtualclass.poll.updatePiChart():"list"===virtualclass.poll.currResultView&&virtualclass.poll.updateListResult()},
...
a&&(a.style.display="none");virtualclass.poll.showGraph();virtualclass.poll.updateBarGraph();virtualclass.poll.pollState.data.view="bar"},showGraph(){var a=roles.hasControls()?virtualclass.poll.dataToStd:virtualclass.poll.dataRec;const b=[];for(const d in virtualclass.poll.count)b.push([a.options[d],virtualclass.poll.count[d]]);a={type:"bar"};a.columns=b;virtualclass.poll.hideChart();virtualclass.poll.chart=c3.generate({bindto:"#chart",data:a,bar:{width:{ratio:.5}},axis:{y:{tick:{format:function(a){return parseInt(a)===
...
"none";const a=document.querySelector(".congrea.student #virtualclassPoll #navigator #pollResult");a.addEventListener("click",()=>{virtualclass.poll.showStudentPollReport(virtualclass.poll.previousResult);a.classList.add("active")})}},resultView(a,b){if(roles.hasControls()&&(this.createResultLayout(),!a)){var d=document.getElementById("resultLayoutHead");a=document.getElementById("closePoll");a||(a=document.createElement("button"),a.id="closePoll",a.className="btn btn-default col-md-2",d.appendChild(a),
a.innerHTML=virtualclass.lang.getString("closeVoting"),a.addEventListener("click",()=>{virtualclass.poll.closePoll(b)}),d=document.createElement("i"),d.className="icon-close-poll",a.appendChild(d))}if(a=document.getElementById("modalClose"))a.removeAttribute("data-dismiss"),a.addEventListener("click",()=>{virtualclass.poll.pollModalClose(b)});virtualclass.poll.count={};virtualclass.poll.list=[]},createResultLayout(){var a=document.getElementById("resultLayout");a&&a.parentNode.removeChild(a);var b=
!!roles.hasControls();a={};a.control=b;if(roles.hasControls()){a.question=virtualclass.poll.dataToStd.question;a.options=virtualclass.poll.dataToStd.options;b=virtualclass.getTemplate("result-modal","poll");const d=document.querySelector("#editPollModal");d&&d.remove();document.querySelector("#bootstrapCont").insertAdjacentHTML("beforeend",b({obj:a}));a=document.querySelectorAll("#chartMenuCont button");for(b=0;b<a.length;b++)a[b].classList.add("disabled")}else a.question=virtualclass.poll.dataRec.question,
...
createOption(a,b){let d;const c=document.getElementById("optsTxCont").querySelectorAll("#optsTxCont .opt");let k=0;for(let a=0;a<c.length;a++){k++;var m=c[a].id}d=m?k:"0";m={};m.index=d;m.closeBtn=1<d;m=virtualclass.getTemplate("optioninput","poll")({close:m});document.querySelector("#addMoreCont").insertAdjacentHTML("beforebegin",m);document.getElementById(`remove${d}`).addEventListener("click",()=>{virtualclass.poll.removeOption(b,a,`remove${d}`)})},hidePrevious(a){(a=document.getElementById("optsTxCont"))&&
a.parentNode.removeChild(a);if(a=document.getElementById("reset"))a.style.display="none";a=document.getElementById("footerCtrCont");a.parentNode.removeChild(a)},editPoll(a,b){virtualclass.poll.UI.loadContent(a,b);virtualclass.poll.UI.footerBtns(a,b)},loadContent(a,d){let c;document.getElementById("qnTxCont");virtualclass.poll.UI.editQn(a,d);c=b.options;let g=0;if("object"===typeof c)for(var k in c)g++,virtualclass.poll.UI.editOptions(a,d,k,g);else for(k=0;k<c.length;k++)virtualclass.poll.UI.editOptions(a,
d,k,g)},previewFooterBtns(a,b,c){document.getElementById("footerCtrCont")&&virtualclass.poll.pollPopUp(virtualclass.poll.popupFn,c,b)},footerBtns(a,b){a&&virtualclass.poll.pollPopUp(virtualclass.poll.popupFn,b,a)},editQn(a,b){const d=document.querySelector("#qnTxCont #q");null==d&&(d.value=document.getElementById(`qnText${a}${b}`).innerHTML);null==d||d.value||(d.value="course"===a?virtualclass.poll.coursePoll[b].questiontext:virtualclass.poll.sitePoll[b].questiontext)},editOptions(a,b,c,g){document.getElementById("optsTxCont").style.display=
...
"object"===typeof c?c.options:c)},pollSettingUI(a,b){const d=virtualclass.getTemplate("setting-modal","poll"),c=document.querySelector("#editPollModal");for(;c.firstChild;)c.removeChild(c.firstChild);c.insertAdjacentHTML("beforeend",d({time:function(a,b){const d=[];for(a=b-a+1;a--;)d[a]=b--;return d}(1,60)}));this.settingUIBody(a,b)},settingUIBody(a,b){this.addSettingHandlers()},addSettingHandlers(){document.getElementById("mode").addEventListener("click",()=>{const a=document.getElementById("radioBtn1"),
...
b;this.reArrangeElements(virtualclass.orderList[virtualclass.videoUl.appName].ol.order);this.sendOrder(virtualclass.orderList[virtualclass.videoUl.appName].ol.order)},async editTitle(b,a,d){d=new FormData;const f={lc_content_id:b,action:"edit",title:a,user:virtualclass.gObj.uid};for(const a in f)d.append(a,f[a]);await this.vxhr.post(`${c.webapi}&user=${virtualclass.gObj.uid}&methodname=update_content_video`,d).then(d=>{if(d=document.getElementById(`videoTitle${b}`))d.innerHTML=a,d.style.display="inline",
...
a){if(!virtualclass.videoUl.player){virtualclass.videoUl.player="mobTab"===virtualclass.system.device&&"iOS"!==virtualclass.system.mybrowser.name&&"Safari"!==virtualclass.system.mybrowser.name?videojs("dispVideo",{html5:{nativeAudioTracks:!1,nativeVideoTracks:!1,hls:{overrideNative:!0}},controlBar:{pictureInPictureToggle:!1}}):videojs("dispVideo",{controlBar:{pictureInPictureToggle:!1}});if(roles.hasControls()){$(".vjs-autoPlay-button").length||virtualclass.videoUl.UI.appendAutoPlayButton(virtualclass.videoUl.player);
...
switchDisplay(b,a){var d=document.getElementById("dispVideo");d?d.style.display="block":virtualclass.videoUl.UI.createVideoElem(b);d=document.getElementById("messageLayoutVideo");"undefined"===typeof a?(b.style.display="none",d&&(d.style.display="block")):(b.style.display="block",d&&(d.style.display="none"))},createVideoElem(b){b.insertAdjacentHTML("beforeend",'<video id="dispVideo" class="video-js" autoplay controls  preload="auto" data-setup="{}" >');b=document.createElement("p");b.setAttribute("class",
"vjs-no-js");document.getElementById("dispVideo").appendChild(b);const a=document.createElement("a");a.setAttribute("href","https://videojs.com/html5-video-support/");a.setAttribute("target","_blank");a.innerHTML="supports HTML5 video";b.appendChild(a)},setPlayerUrl(b,a){b.poster_&&(b.poster_="");const d=document.querySelector("#dispVideo");virtualclass.videoUl.yts?(d.setAttribute("data-setup",'{ techOrder: [youtube],"preload": "auto"}'),b.src({type:"video/youtube",src:a}),(a=document.querySelector("#videoPlayerCont .vjs-error-display"))&&
a.classList.add("vjs-hidden")):virtualclass.videoUl.online?(d.setAttribute("data-setup",'{"preload": "auto" }'),b.src({type:"video/webm",src:a}),b.src({type:"video/mp4",src:a})):(d.setAttribute("data-setup",'{"preload": "auto"}'),b.src({type:"application/x-mpegURL",withCredentials:!0,src:a}));b.any("loadstart",()=>{virtualclass.videoUl.alreadySetPlayerUrl=!0;virtualclass.videoUl.isPaused?(virtualclass.videoUl.lastSeek&&virtualclass.videoUl.player.currentTime(virtualclass.videoUl.lastSeek),b.pause()):
...
{el:videojs.createEl("button",{className:"vjs-autoPlay-button vjs-control on",id:"autoPlayListBtn",role:"button",title:"Auto Play",onclick(){virtualclass.videoUl.UI.autoPlayFn(this)}})})},autoPlayFn(b){b.classList.contains("off")?(virtualclass.videoUl.autoPlayFlag=1,b.classList.remove("off"),b.classList.add("on"),b.style.color="green"):(virtualclass.videoUl.autoPlayFlag=0,b.classList.remove("on"),b.classList.add("off"),b.style.color="red")},onEndedHandler(b,a,d){b.off("ended");b.on("ended",()=>{if(roles.hasControls())virtualclass.videoUl.UI.onEnded(b,
a)})},onEnded(b,a,d){d=document.querySelectorAll("#listvideo .linkvideo");let c=0;for(let b=0;b<d.length;b++)if(d[b].getAttribute("data-rid")===a){c=b;break}virtualclass.videoUl.autoPlayFlag?(b.poster_&&(b.poster_=""),virtualclass.videoUl.findNextVideo(c+1)?virtualclass.videoUl.autoPlayList(c+1,d):virtualclass.videoUl.UI.autoVideoPause()):virtualclass.videoUl.UI.autoVideoPause()},autoVideoPause(){virtualclass.videoUl.isPaused=!0;virtualclass.videoUl.listEndPause=!0;virtualclass.videoUl.player.on("play",
...
(b=document.querySelector(" #listvideo .removeCtr"))&&b.classList.remove("removeCtr");a=virtualclass.vutil.createHashString(a.value)+virtualclass.vutil.randomString(32).slice(1,-1);virtualclass.videoUl.UI.saveYtsUrl(a)}});(b=document.querySelector(".congrea #newVideoBtn"))&&b.addEventListener("click",()=>{document.querySelector(".congrea #congreavideoContBody").style.display="block";document.querySelector(".congrea #listvideo").style.display="none"})},saveYtsUrl(b){const a=document.querySelector(".congrea #videourl"),
d={};d.uuid=b;d.URL=a.value;d.title=a.value;b=virtualclass.api.addURL;"boolean"===typeof virtualclass.videoUl.getVideoId(a.value)?d.type="video_online":d.type="video_yts";virtualclass.xhrn.vxhrn.post(b,d).then(()=>{virtualclass.orderList[virtualclass.videoUl.appName].insert(d.uuid);virtualclass.config.makeWebSocketReady&&(virtualclass.serverData.syncComplete=!1,virtualclass.serverData.syncAllData().then(()=>{virtualclass.videoUl.UI.rawVideoList();virtualclass.videoUl.sendOrder(virtualclass.orderList[virtualclass.videoUl.appName].ol.order)}))});
document.querySelector(".congrea #videourl").value=""},fetchYtsTitle(b,a){$.getJSON("https://www.googleapis.com/youtube/v3/videos",{key:"AIzaSyCt1SQWwanpucKGFlzytu-mDdr6vRKzJGA",part:"snippet,statistics",id:a},a=>{0!==a.items.length&&(a=a.items[0].snippet.title,virtualclass.videoUl.UI.setYtsTitle(b,a))}).fail((a,b,c)=>"ERROR")},validateURL(b){return null==b.match(/(http(s)?:\/\/.)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/g)?(virtualclass.popup.validateurlPopup("video"),
...
a=`link${this.type}${this.rid}`;var c={rid:this.rid,status:this.status,id:this.id,type:this.type,title:this.title,titleAction:1===this.status?"Hide":"Show"};if("video"===this.type){if(c=b.getElementById("listvideo")){c=this.UI.createPageNavLink2.call(this,c);var k=virtualclass.getTemplate("linkvideo","videoupload");d.insertAdjacentHTML("beforeend",k(c));d=b.getElementById(`${this.type}Title${this.rid}`);d.innerHTML=this.title;d.dataset.title=this.title;this.UI.controller.init(this,a)}}else if("docs"===
this.type)k=virtualclass.getTemplate("docsNav",virtualclass.dts.tempFolder),c.title=virtualclass.vutil.trimExtension(c.title),d.insertAdjacentHTML("beforeend",k(c)),this.UI.controller.init(this,a);else if("notes"===this.type){k=virtualclass.getTemplate("notesNav",virtualclass.dts.tempFolder);const b=virtualclass.dts.getNote(this.rid);c.content_path=b.thumbnail;d.insertAdjacentHTML("beforeend",k(c));this.UI.controller.init(this,a)}else"ppt"===this.type&&(d=b.getElementById("listppt"))&&(c=this.UI.createPageNavLink2.call(this,
...
{};let d;b.type=this.type;b.className=`link${this.type}`;b.id=`link${this.id}`;b.className=`link${this.type} links`;b.dataset={};b.dataset.screen=this.id;b.dataset.rid=this.rid;b.dataset.selected=0;b.dataset.status=this.status;"video"===this.type?(b.type="video",d=virtualclass.getTemplate("linkvideo","videoupload")):d=JST["templates/linkdoc.hbs"];a.insertAdjacentHTML("beforeend",d(b))},mainView(a){b.getElementById(this.parent);if(null==b.getElementById(`screen-${this.type}`)){a={hasControls:roles.hasControls(),
...
this.getDocs(a);if(null!=b){const d=document.querySelector(`#linkdocs${a}`).dataset.selected;ioAdapter.mustSend({dts:{dres:a,ds:1-+d},cf:"dts"});return b}return null},getNotes(a){return this.allDocs[a].notesarr},removePagesUI(a){a=this.getNotes(a);for(let b=0;b<a.length;b++)this.removePageUI(a[b].id);0>=virtualclass.orderList[this.appName].ol.order.length&&(b=!0);roles.hasControls()&&this.indexNav.createIndex()},removePageUI(a){var b=virtualclass.orderList[this.appName].ol.order.indexOf(a);0<=b&&
...
document.querySelector(`#linkdocs${a}`);if(null!=a){if("1"===a.dataset.selected)return a.dataset.selected=0,!1;a.dataset.selected=1;return!0}},setLinkSelected(a,b){a=document.querySelector(`#linkdocs${a}`);null!=a&&(a.dataset.selected=b)},onResponseFiles(a,d,c,g,k){if(b){if("undefined"!==typeof g)this.docs.currNote=g;else if(!virtualclass.dts.noteExist()){for(var f=0;f<d.length;f++)if(1===d[f].status){g=d[f].id;break}this.docs.currNote=g}b=!1}"undefined"!==typeof c?(f=+c,roles.hasControls()&&(1===
c?this.setLinkSelected(a,1):this.setLinkSelected(a,0))):f=roles.hasControls()?this.toggleSlideWithOrder(a,d):!0;f?(console.log("====> document share nav add "),this.addPages(d),a="string"!==typeof a?`docs${a}`:0<=a.indexOf("docs")?a:`docs${a}`,this.createNoteLayout(d,a),"undefined"!==typeof g?this.docs.displayScreen(a,g):virtualclass.dts.noteExist()||this.docs.displayScreen(a),"undefined"!==typeof k?this.createNoteNav(k):this.createNoteNav(),this.updateLinkNotes(this.docs.currNote),virtualclass.dts.setCurrentNav(this.docs.currNote),
virtualclass.vutil.hideUploadMsg("docsuploadContainer"),virtualclass.vutil.addNoteClass()):(console.log("====> document share nav remove "),this.deleteNotesFromOrder(a),this.removePagesUI(a),virtualclass.dts.noteExist()||(virtualclass.vutil.showUploadMsg("docsuploadContainer"),virtualclass.dts.docs.currNote=0,virtualclass.dts.docs.currDoc=void 0,virtualclass.gObj.currWb=null),virtualclass.dts.docSelected()||(d=JSON.parse(localStorage.getItem("dtsdocs")),null!=d&&(d.slideNumber=null),roles.isStudent()&&
!virtualclass.dts.noteExist()&&(d=document.querySelector("#docScreenContainer"),null!=d&&(d.classList.remove("noteDisplay"),console.log("====> noteDisplay removing")),virtualclass.gObj.currWb=null,document.querySelector("#virtualclassCont").classList.remove("pdfRendering"),d=document.querySelector("#virtualclassAppLeftPanel.hideZoom"),g=document.querySelector("#virtualclassAppLeftPanel"),d||(g.classList.add("hideZoom"),g.classList.remove("showZoom")))));null==document.querySelector("#listnotes .currentNav")&&
(d=document.querySelector("#listnotes .linknotes"),null!=d&&(virtualclass.dts.currNote=d.dataset.rid,d=document.querySelector(`#mainpnotes${virtualclass.dts.currNote}`),null!=d&&(virtualclass.dts.docs.currDoc=virtualclass.dts.currNote.split("_")[0],d.click())));roles.hasAdmin()&&this.sendOrder(virtualclass.orderList[this.appName].ol.order)},selectFirstNote(){if(null==document.querySelector("#notesContainer .current")){const a=document.querySelector("#notesContainer .note");null!=a&&(this.docs.currNote=
...
"documentSharing");virtualclass.vutil.insertAppLayout(b(a));null==document.querySelector("#congdashboard")&&(a=virtualclass.getTemplate("dashboard")({app:"DocumentShare"}),document.querySelector("#dashboardContainer").innerHTML=a)}null==document.querySelector("#DocumentShareDashboard")&&(a=document.createElement("div"),document.querySelector("#congdashboard .modal-body").appendChild(a),a.id="DocumentShareDashboard");null==document.querySelector("#docsDbCont")&&(a=virtualclass.vutil.getDocsDashBoard("DocumentShare"),
document.querySelector("#DocumentShareDashboard").innerHTML=a,roles.hasControls()&&(virtualclass.vutil.attachEventToUploadTab(),null==document.querySelector("#DocumentShareDashboard .qq-gallery")&&virtualclass.vutil.modalPopup("docs",["docsuploadContainer"]),virtualclass.dashboard.modalCloseHandler()))},createMainContent(a,b,c){},createSlides(a,b){let d=document.querySelector("#notesContainer");null==d&&(d=document.createElement("div"),d.className="notes",d.id="notesContainer");for(let a=0;a<b.length;a++)if(null==
document.querySelector(`#note${b[a].id}`)){const d=document.createElement("div");d.id=`note${b[a].id}`;d.className="note";d.dataset.slide=b[a].id;d.dataset.status="true"===d.dataset.statuS||!0===d.dataset.statuS?1:"false"===d.dataset.status||!1===d.dataset.status?0:b[a].status}a.appendChild(d);roles.hasControls()&&(this.createNavigation(a,"prev"),this.createNavigation(a,"next"))},createNavigation(a,b){if(null==document.querySelector(`#docs${b}`)){const d=document.createElement("span");d.className=
`${"nvgt "}${b}`;d.id=`docs${b}`;a.appendChild(d)}},createDocsNav(a,b){let d=document.getElementById("listDocs");null==d&&(d=document.createElement("div"),d.id="listDocs",a.appendChild(d));a=this.createDocsNavLink(b);this.attachDocsNav(a,b);d.appendChild(a)},createDocsNavLink(a){const b=document.createElement("div");b.id=`link${a}`;b.className="linkdoc";b.innerHTML=a;b.dataset.screen=a;return b},attachDocsNav(a,b){a.onclick=virtualclass.dts.docs.goToDocs(b)}},createNoteNav(a){let b;virtualclass.orderList[this.appName].ol.order&&
this.indexNav.init();for(let d=0;d<virtualclass.orderList[this.appName].ol.order.length;d++)"object"!==typeof this.notes[virtualclass.orderList[this.appName].ol.order[d]]&&(b="true"===this.allNotes[virtualclass.orderList[this.appName].ol.order[d]].status||1===+this.allNotes[virtualclass.orderList[this.appName].ol.order[d]].status?1:0,this.notes[virtualclass.orderList[this.appName].ol.order[d]]=new virtualclass.page("screen-docs","notes","virtualclassDocumentShare","dts",b),this.notes[virtualclass.orderList[this.appName].ol.order[d]].init(virtualclass.orderList[this.appName].ol.order[d],
`note_${this.allNotes[virtualclass.orderList[this.appName].ol.order[d]].lc_content_id}_${virtualclass.orderList[this.appName].ol.order[d]}`),"undefined"===typeof a&&this.noteStatus(virtualclass.orderList[this.appName].ol.order[d],b)),0===d&&virtualclass.vutil.hideUploadMsg("docsuploadContainer");roles.hasControls()&&(this.indexNav.shownPage(this.indexNav.width),this.indexNav.addActiveNavigation(),document.querySelector("#dcPaging").addEventListener("change",function(){virtualclass.dts.docs.goToNavs(this.value)()}));
document.querySelector(".congrea.teacher  #dashboardContainer .modal-header button.enable")||virtualclass.vutil.showFinishBtn();this.indexNav.setTotalPages(virtualclass.orderList[virtualclass.dts.appName].ol.order.length)},addNoteHidClass(a,b,c){b>c?a.classList.add("hid","right"):a.classList.add("shw")},indexHandler(a){virtualclass.dts.docs.goToNavs(a)},createNoteNavAlt(a){let b;for(let d=0;d<virtualclass.orderList[this.appName].ol.order.length;d++)b="true"===this.allNotes[virtualclass.orderList[this.appName].ol.order[d]].status||
1===+this.allNotes[virtualclass.orderList[this.appName].ol.order[d]].status?1:0,this.notes[virtualclass.orderList[this.appName].ol.order[d]]=new virtualclass.page("screen-docs","notes","virtualclassDocumentShare","dts",b),this.notes[virtualclass.orderList[this.appName].ol.order[d]].init(virtualclass.orderList[this.appName].ol.order[d],`note_${this.allNotes[virtualclass.orderList[this.appName].ol.order[d]].lc_content_id}_${virtualclass.orderList[this.appName].ol.order[d]}`),"undefined"===typeof a&&
this.noteStatus(virtualclass.orderList[this.appName].ol.order[d],b)},removeNoteNav(a){const b=document.querySelector(`#linknotes${a}`);null!=b&&b.parentNode.removeChild(b);"object"===typeof this.notes[a]&&delete this.notes[a]},docs:{num:0,currNote:0,curr(a,b){this.currDoc=a;virtualclass.dts.docs.num=a;const d=document.querySelector("#documentScreen .screen.current");null!=d&&d.classList.remove("current");document.querySelector("#screen-docs").classList.add("current");document.querySelector("#documentScreen").dataset.screen=
...
virtualclass.vutil.removeFinishBtn(),virtualclass.dts&&virtualclass.dts.docs&&virtualclass.dts.docs.currNote&&virtualclass.dts.identifyFirstAndLastNote(`note${virtualclass.dts.docs.currNote}`))}},goToNavs(a){return function(){const b=document.querySelector(`#linknotes${a}`);null!=b?1===+b.dataset.status&&(virtualclass.dts.docs.currNote=a,virtualclass.dts.docs.note.currentSlide(a)):(virtualclass.dts.docs.currNote=a,virtualclass.dts.docs.note.currentSlide(a));virtualclass.dts.indexNav.addActiveNavigation();
virtualclass.dts.indexNav.UI.setClassPrevNext()}},studentExecuteScreen(a){const b=a.dres;this.currDoc=b;const c=virtualclass.dts.getDocs(b);if(null!=c)virtualclass.dts.onResponseFiles(b,c,a.ds)},executeScreen(a,b,c,g){this.currDoc=a;-1===a.indexOf("docs")&&(this.currDoc=`docs${a}`);const d=virtualclass.dts;if(roles.hasControls()&&"undefined"===typeof b)"docs"===a.substring(0,4)&&(a=a.split("docs")[1]),b=d.requestSlides(a),null!=b&&(d.onResponseFiles(a,b),"undefined"!==typeof c&&c());else if("undefined"!==
typeof g){"string"===typeof a&&-1<a.indexOf("docs")&&(a=a.split("docs")[1]);const f=d.getDocs(a);if(null!=f){if("undefined"===typeof b)d.onResponseFiles(a,f,void 0,g);else d.onResponseFiles(a,f,void 0,g,"fromReload");"undefined"!==typeof c&&c()}}},displayScreen(a,b){"undefined"!==typeof b?this.curr(a,b):this.curr(a)},createWhiteboard(a){virtualclass.vutil.createWhiteBoard(`_doc_${a}_${a}`);virtualclass.previous=virtualclass.dtsConfig.id},slide:function(a){return{li_items:0,imageNumber:0,currSlide:"undefined"!==
typeof a?a:0,currNote:"undefined"!==typeof a?a:0,doc:1,init(){const a=virtualclass.dts;var b=document.querySelector("#screen-docs .notes");this.doc=a.docs.num;if(null!=b){if(this.li_items=b.children,this.imageNumber=this.li_items.length,roles.hasControls()){b=document.querySelector("#screen-docs .prev");const d=document.querySelector("#screen-docs .next"),c=this;b.onclick=function(){virtualclass.vutil.navWhiteboard(c,c.prevSlide,a)};d.onclick=function(){virtualclass.vutil.navWhiteboard(c,c.nextSlide,
a)}}}else alert("no element")},slideTo(a,b){console.log("hello 3");const d=a.dataset.slide;virtualclass.vutil.updateCurrentDoc(d);this.displaySlide(a);roles.hasControls()&&"undefined"===typeof b&&(!virtualclass.dts.sentStudentLayout&&virtualclass.config.makeWebSocketReady&&(ioAdapter.mustSend({dts:{init:"studentlayout"},cf:"dts"}),virtualclass.dts.sentStudentLayout=!0),ioAdapter.mustSend({dts:{slideTo:d,docn:virtualclass.dts.docs.currDoc},cf:"dts"}))},displaySlide(a){const b=document.querySelector("#screen-docs .note.current");
null!=b&&b.classList.remove("current");null!=a&&a.classList.add("current");virtualclass.vutil.addNoteClass();a=a.id.split("note")[1];roles.hasControls()?virtualclass.config.makeWebSocketReady||(a=virtualclass.orderList[virtualclass.dts.appName].ol.order.indexOf(a),virtualclass.wbCommon.indexNav.setCurrentIndex(a+1),virtualclass.dashboard.close()):virtualclass.dts.indexNav.studentDocNavigation(a)},prevSlide(a){var b=a.docs.currNote,d=document.querySelector(`#documentScreen #note${b}`);null!=d&&(d=
d.previousElementSibling,null!=d?(0===+d.dataset.status?(b=this.getActiveSlide(a,b,"prev"))?(this.getScreen(b,!0),a.docs.currNote=b.dataset.slide):virtualclass.dts.indexNav.UI.setArrowStatusDocs(document.getElementById("leftNavPage"),"disable","enable"):(this.getScreen(d,!0),a.docs.currNote=d.dataset.slide),virtualclass.dts.indexNav.movePageIndex("left")):(a=document.getElementById("leftNavPage"),virtualclass.dts.indexNav.UI.setArrowStatusDocs(a,"disable","enable")))},getActiveSlide(a,b,c){b=document.querySelector(`#documentScreen #note${b}`);
if(null!=b)return b="next"===c?b.nextElementSibling:b.previousElementSibling,null!=b?0===+b.dataset.status?this.getActiveSlide(a,b.dataset.slide,c):b:!1},nextSlide(a){var b=a.docs.currNote;if(b!==virtualclass.orderList[virtualclass.dts.appName].ol.order[virtualclass.orderList[virtualclass.dts.appName].ol.order.length-1]){var d=document.querySelector(`#documentScreen #note${b}`);null!=d&&(d=d.nextElementSibling,null!=d&&(0===+d.dataset.status?(b=this.getActiveSlide(a,b,"next"))?(this.getScreen(b,!0),
a.docs.currNote=b.dataset.slide):alert("There is no page"):(this.getScreen(d,!0),a.docs.currNote=d.dataset.slide)));virtualclass.dts.indexNav.movePageIndex("right")}else a=document.getElementById("rightNavPage"),virtualclass.dts.indexNav.UI.setArrowStatusDocs(a,"disable","enable")},isSlideAvailable(a,b){return a===b?!1:!0},currentSlide(a){a=document.querySelector(`#documentScreen #note${a}`);null!=a&&this.getScreen(a);a=document.querySelector("#docScreenContainer");null!=a&&(a.classList.add("noteDisplay"),
console.log("====> noteDisplay add"))},isPdfRendered(){const a=document.querySelector(`#canvas${virtualclass.gObj.currWb}`);return null!=a?Object.prototype.hasOwnProperty.call(a.parentNode.dataset,"pdfrender"):!1},getScreen(a){this.currNote=this.currSlide=a.dataset.slide;virtualclass.dts.currDoc=this.doc;this.slideTo(a);this.isWhiteboardExist(this.currNote)?virtualclass.zoom.normalRender():virtualclass.dts.docs.createWhiteboard(this.currNote);virtualclass.vutil.updateCurrentDoc(this.currNote);virtualclass.dts.updateLinkNotes(this.currNote);
...
cf:"dts"}),virtualclass.dts&&virtualclass.dts.docs&&virtualclass.dts.docs.currNote&&virtualclass.dts.identifyFirstAndLastNote(`note${virtualclass.dts.docs.currNote}`))},sendOrder(a){Array.isArray(a)&&virtualclass.vutil.sendOrder("docs",a)},reaArrangeThumbCount(){const a=document.querySelectorAll("#listnotes .thumbList");for(let b=0;b<a.length;b++)a[b].innerHTML=b+1},reArrangeElements(a){const b=document.getElementById("notesContainer"),c=document.createElement("div");c.id="notesContainer";c.className=
"notes";for(let b=0;b<a.length;b++)c.appendChild(document.getElementById(`note${a[b]}`));b.parentNode.replaceChild(c,b);this.reaArrangeThumbCount()},delete(a){this.deleteNotesFromOrder(a);virtualclass.xhrn.vxhrn.post(virtualclass.api.UpdateDocumentStatus,{uuid:a,action:"delete",page:0}).then(a=>{"ok"===a.data.status&&virtualclass.dts.sendOrder(virtualclass.orderList[this.appName].ol.order)});this.deleteDocElement(a)},deleteNotesFromOrder(a){const b=this.getNotes(a);virtualclass.orderList[this.appName].ol.order=
virtualclass.orderList[this.appName].ol.order.filter(a=>!b.includes(a.id))},deleteDocElement(a){const b=document.querySelector(`#linkdocs${a}`);null!=b&&b.parentNode.removeChild(b);delete this.pages[`docs${a}`];this.removePagesUI(a);this.removePagesFromStructure(a)},deleteNote(a,b){this.removePageUI(a,b);this.removePageFromStructure(a,b);roles.hasControls()&&ioAdapter.mustSend({dts:{rmsnote:a},cf:"dts"});b=a.split("_");a=b[0];b=parseInt(b[1]);const c=this;virtualclass.xhrn.vxhrn.post(virtualclass.api.UpdateDocumentStatus,
{uuid:a,action:"delete",page:b}).then(a=>{"ok"===a.data.status&&c.sendOrder(virtualclass.orderList[this.appName].ol.order)});b=!1;const d=virtualclass.dts.allDocs[a];if(null!=d)for(let a=0;a<d.notesarr.length;a++)if(!Object.prototype.hasOwnProperty.call(d.notesarr[a],"deletedn")){b=!0;break}b||this.delete(a);roles.hasControls()&&this.indexNav.createIndex()},removePagesFromStructure(a){this.allDocs[a].deleted="0";let b;for(b in this.allNotes)-1<this.allNotes[b].id.indexOf(a)&&this.removePageFromStructure(this.allNotes[b].id)},
updateInAllDocs(a){var b=a.split("_")[0];b=this.allDocs[b];if("undefined"!==typeof b.notes[a]){b.notes[a].deletedn=a;for(let c=0;c<b.notesarr.length;c++)b.notesarr[c].id===a&&(b.notesarr[c].deletedn=a)}},removePageFromStructure(a){this.allNotes[a].deletedn=a;this.updateInAllDocs(a)},disable(a){this.docStatus(a)},enable(a){this.docStatus(a)},docStatus(a,b){var c=document.querySelector(`#linkdocs${a} .controls.status`);b=null!=c?"undefined"===typeof b?1-+c.dataset.status:b:b;c=this.getDocs(a);for(let a=
0;a<c.length;a++){const d=c[a].id;this.noteStatus(d,b);this.updatePageNavStatus(d,b)}roles.hasControls()&&ioAdapter.mustSend({dts:{docSt:b,doc:a},cf:"dts"})},updatePageNavStatus(a,b){a=document.querySelector(`#linknotes${a}`);null!=a&&(a.dataset.status=b,a=a.querySelector(".controls.status"),a.dataset.status=b,a.querySelector(".statusanch").innerHTML=`status${b}`)},noteDisable(a){this.noteStatus(a);this.sendNoteStatus(a)},noteEnable(a){this.noteStatus(a);this.sendNoteStatus(a)},sendNoteStatus(a){if(roles.hasControls()){const b=
...
"attemptQzBody","modal-body");a=a.questions;let c=1;for(let d=0;d<a.length;d++){const f=virtualclass.view.customCreateElement("div","","q-area");b.appendChild(f);var k=virtualclass.view.customCreateElement("span","","q-no");k.innerHTML=c;f.appendChild(k);k=virtualclass.view.customCreateElement("div","","qscolor");k.innerHTML=a[d].q;f.appendChild(k);k=virtualclass.view.customCreateElement("div");k.innerHTML=`Users attempted : <span id='usA_${a[d].qid}'>0</span>`;f.appendChild(k);k=this.UI.createProgressBar(a[d].qid,
0);f.appendChild(k);c++}return b},tabContent(){const a=document.getElementById("resultQzLayout"),b=virtualclass.view.customCreateElement("div","","tab-content");var c=virtualclass.view.customCreateElement("div","qzOverv");c.className="tab-pane fade in active";var k=this.attemptProgressReport();c.appendChild(k);b.appendChild(c);c=virtualclass.view.customCreateElement("div","gdRpt");c.className="tab-pane fade";k=this.UI.gradeReportLayout();c.appendChild(k);b.appendChild(c);a.appendChild(b)},gradeReport(a,
b,c,k,m,n,q){const d=document.getElementById("qzReTbody");if(d){let f=document.getElementById(`user${q}`);null!==f&&(a=f.childNodes[0].innerHTML,f.parentNode.removeChild(f));f=document.createElement("tr");f.id=`user${q}`;d.appendChild(f);q=document.createElement("th");q.scope="row";q.innerHTML=a;f.appendChild(q);a=document.createElement("td");a.innerHTML=b;f.appendChild(a);b=document.createElement("td");b.innerHTML=c;f.appendChild(b);c=document.createElement("td");c.innerHTML=`${k}%`;f.appendChild(c);
k=document.createElement("td");k.innerHTML=m;f.appendChild(k);m=document.createElement("td");m.innerHTML=n;f.appendChild(m)}},quizTimer(a,b,c){function d(){g="asc"===c?a+((Date.now()-f)/1E3|0):a-((Date.now()-f)/1E3|0);q=g/3600|0;r=g%3600/60|0;z=g%60|0;q=10>q?`0${q}`:q;r=10>r?`0${r}`:r;z=10>z?`0${z}`:z;b.textContent=`${q}:${r}:${z}`;if(0>=g&&("asc"!==c&&(b.textContent="00 : 00 : 00 "),f=0,null!=virtualclass.gObj.CDTimer&&clearInterval(virtualclass.gObj.CDTimer),ioAdapter.mustSend({quiz:{quizMsg:"quizTimeEnd",
quizId:virtualclass.view.qzid},cf:"quiz"}),roles.hasControls())){let a=document.getElementById("closeQzBt");null!=a&&(a.disabled=!0)}}c="undefined"!==typeof c?c:"desc";let f=Date.now(),g,q,r,z;null!=virtualclass.gObj.CDTimer&&clearInterval(virtualclass.gObj.CDTimer);"asc"!==c&&d();virtualclass.gObj.CDTimer=setInterval(d,1E3)},quizModalClose(){const a=this,b=virtualclass.lang.getString("rusureCquiz");virtualclass.popup.confirmInput(b,b=>{b&&(a.quizSt={},b=document.getElementById("editQuizModal"),b.parentNode.removeChild(b),
a.attemptedUsers={},a.quizAttempted={},ioAdapter.mustSend({quiz:{quizMsg:"quizClosed",quizId:a.qzid},cf:"quiz"}))})},convertSecToTime(a){if(/^\d+$/.test(a)){const b=new Date(null);b.setSeconds(a);return b.toISOString().substr(11,8)}return"00:00:00"},convertTimeToSec(a){return a?(a=a.split(":"),3600*+a[0]+60*+a[1]+ +a[2]):0},isJson(a){try{JSON.parse(a)}catch(f){return!1}return!0},sendQuizData(a,b,c){if(roles.isStudent()){const d=virtualclass.vutil.whoIsTeacher();ioAdapter.mustSendUser({quiz:{quizMsg:"quizAttempt",
...
`{background-image: radial-gradient(ellipse at center, ${c.fcolor} 0%,${c.scolor} 100%) !important}`+"#virtualclassCont.congrea #virtualclassAppRightPanel li:hover .cgIcon:before"+`{color:${f.frontColor}!important}`+"#virtualclassCont.congrea #virtualclassAppRightPanel #appSettingCtrlAnchor span"+`{color:${b}!important}`+"#virtualclassCont.congrea #virtualclassAppRightPanel li:hover .cgText"+`{color:${f.frontColor}!important}`+"#virtualclassCont.congrea #virtualclassAppRightPanel .askQuestion_btn.enable #iconAskQuestion:before"+
`{color:${b}!important}`+"#virtualclassCont.congrea #virtualclassAppRightPanel .pre-check-btn"+`{background-image: linear-gradient(to bottom, ${a.fcolor} 0%,${a.scolor} 100%) !important ;color:${b}!important} `)},makeThemeReadyVideo(b,a,c,f,g){let d=a.fcolor;180<g&&(d=c.fcolor);this.addCss(`${"#virtualclassCont.congrea .ui-widget-header,#virtualclassCont.congrea #congdashboard .modal-header,#virtualclassCont #virtualclassApp #virtualclassAppLeftPanel #sidebarButton, #virtualclassCont.congrea #layoutPoll #navigator, #virtualclassCont.congrea #layoutQuiz .navbar, #virtualclassCont.congrea #virtualclassAppFooterPanel #audioWidget {background-image: linear-gradient(to bottom, "}${a.fcolor} 0%,${a.scolor} 100%) !important}`+
...
"right"),d.classList.add("shw"),d=b.querySelector(".noteIndex.shw"))d.classList.remove("shw"),d.classList.add("hid","left");"DocumentShare"===virtualclass.currApp&&(a=virtualclass.dts.docs.currNote,(a=b.querySelector(`.congrea #dcPaging #index${a}`))&&!a.classList.contains("active")&&a.classList.add("active"))}else{for((c=b.querySelector(".noteIndex.shw"))&&(m=parseInt(c.getAttribute("data-set")));m>a;m--)"DocumentShare"===virtualclass.currApp&&virtualclass.dts.indexNav.UI.setClassPrevNext(),c=b.querySelectorAll(".noteIndex.hid.left"),
...
virtualclass.videoHost.toggleVideoMsg("disable")):(virtualclass.user.control.videoEnable(),roles.isStudent()&&virtualclass.vutil.videoHandler("off")),!0===virtualclass.settings.info.studentvideo&&virtualclass.user.control.videoEnable())}}})(window);(c=>{function b(a){const b=new Promise((b,c)=>{const d=()=>{a.removeEventListener("success",g);a.removeEventListener("error",k)},g=()=>{b(f(a.result));d()},k=()=>{c(a.error);d()};a.addEventListener("success",g);a.addEventListener("error",k)});b.then(b=>{b instanceof IDBCursor&&q.set(b,a)});t.set(b,a);return b}function a(a){if(!r.has(a)){var b=new Promise((b,c)=>{const d=()=>{a.removeEventListener("complete",f);a.removeEventListener("error",g);a.removeEventListener("abort",g)},f=()=>{b();d()},g=()=>
{c(a.error);d()};a.addEventListener("complete",f);a.addEventListener("error",g);a.addEventListener("abort",g)});r.set(a,b)}}function d(a){return a!==IDBDatabase.prototype.transaction||"objectStoreNames"in IDBTransaction.prototype?(n||(n=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])).includes(a)?function(...b){a.apply(t.get(this),b);return f(q.get(this))}:function(...b){return f(a.apply(t.get(this),b))}:function(b,...c){c=a.call(t.get(this),b,...c);
...
component:"answer",componentId:c.componentId,parentId:c.parent,text:void 0,action:void 0};c.action="markAnswer";setTimeout(()=>{virtualclass.userInteractivity.event.execute(b)},1E3)}}moreControls(c){var b;(b=document.querySelector("#askQuestion .moreControls .item.open"))?(b.classList.remove("open"),b.classList.add("close")):c.target.firstChild&&null!=c.target.firstChild.dataset&&(b=c.target.firstChild.dataset.componentId,(b=document.querySelector(`#${b} .moreControls .item.close`))&&"moreControls"===
c.target.dataset.event&&(b.classList.remove("close"),b.classList.add("open")))}markAnswer(c){const b=document.querySelector(`#askQuestion #${c.parentId} .answers .answer[data-mark-answer="marked"]`),a=document.querySelector(`#askQuestion #${c.parentId} .answers .moreControls .mark`),d=virtualclass.lang.getString("markAnswerUnmark");b&&a&&"Unmark"===a.innerHTML&&a.parentNode.dataset.componentId!==c.componentId?virtualclass.view.createAskQuestionMsg(d,"msgContainer","loading"):(c=virtualclass.userInteractivity.generateData({component:c.component,
...
(g=f.parentNode.dataset.event,k=f.parentNode.parentNode):this.event.values.includes(f.parentNode.parentNode.dataset.event)&&(g=f.parentNode.parentNode.dataset.event,k=f.parentNode.parentNode.parentNode);if(g){let m,n,q=null;c=k.dataset.component;if(k.dataset.componentId&&"save"!==g)if(a=k.dataset.componentId,"reply"===g)a=null,q=k.dataset.componentId;else if("edit"===g||"markAnswer"===g||"delete"===g)q=k.dataset.parent?k.dataset.parent:null;if("save"===g){if("note"===c)m=f.value,n="create";else if("bookmark"===
...
"msgContainer","loading"))))}q=k.dataset.parent?k.dataset.parent:null}else if("clearall"===g){k=document.querySelector("#noteNavigationContainer .clearAll");if(d=k.dataset.currentContext)d=k.dataset.currentContext;if(k=document.querySelector(`#noteContainer .context[data-context~=${d}] textarea`))m=k.value="",n="create",g="save"}else"upvote"===g&&(q=k.dataset.parent);this.event.execute({event:g,component:c,componentId:a,text:m,action:n,parentId:q});if("cancel"===g||"save"===g)this.inputGenerating=
...
this.inputGenerating?this.donotChangeContext=this.readyContextActual():this.displayContext()},200)}getActiveTab(){return null!=document.querySelector("#congAskQuestion.active")?"question":null!=document.querySelector("#virtualclassnote.active")?"note":!1}readyContextActual(){let c,b;switch(virtualclass.currApp){case "Whiteboard":case "DocumentShare":c=virtualclass.gObj.currWb;break;case "EditorRich":c="editor";break;case "SharePresentation":c=null;b=virtualclass.sharePt;b.currId&&b.state&&(c=`sharePt-${b.currId}_${b.state.indexv}_${b.state.indexh}`);
break;case "Video":virtualclass.videoUl.videoId&&(c=`video-${virtualclass.videoUl.videoId}`);break;case "ScreenShare":virtualclass.gObj.screenShareId&&(c=virtualclass.gObj.screenShareId);break;default:c=null}return c}displayContext(){this.rendererObj.removeWriteContainer();const c=this.readyContextActual();c!==this.currentContext&&c&&("question"!==this.getActiveTab()&&(this.queue.question[c]&&0<this.queue.question[c].length?this.questionAnswer.addHighLightNewActual():this.questionAnswer.removeHighlight()),
this.triggerPerform(c),virtualclass.vutil.checkUserRole()&&ioAdapter.mustSend({cf:"readyContext",context:this.currentContext}))}triggerPerform(c){this.currentContext=c;this.triggerPerformActual(c)}async triggerPerformActual(c){var b=document.getElementById("askQuestion");b&&(c?b.classList.add("readyContext"):b.classList.remove("readyContext"));b=document.querySelector("#askQuestion .container .current");const a=document.querySelector(`.context[data-context~=${this.currentContext}]`);a&&!a.classList.contains("current")&&
a.classList.add("current");b&&b.classList.contains("current")&&b.classList.remove("current");c&&!this.context[c]&&(this.context[c]=new QAcontext);(b=this.getActiveTab())&&this.queue[b]&&this.queue[b][c]&&0<this.queue[b][c].length?(await this.engine.perform(c,b),this.triggerRearrangeUpvotedElem({context:c,component:"question"}),this.triggerRearrangeUpvotedElem({context:c,component:"answer"}),"note"===b&&this.note.afterChangeContext(c)):"note"===b&&(this.engine.performWithQueue({component:"note",action:"renderer",
type:"noteContainer",context:c}),this.note.afterChangeContext(c));this.bookmark.afterChangeContext(c)}async authenticate(c){firebase.initializeApp(c);this.db||(this.db=firebase.firestore());this.setDbCollection();if(c=await virtualclass.xhrn.getAskQnAccess())return firebase.auth().signInWithCustomToken(c.data);this.db.firestore().enablePersistence().catch(function(b){});return!1}setDbCollection(){virtualclass.isPlayMode?(this.collection=`${wbUser.lkey}_${wbUser.session}_${wbUser.room}`,this.collectionMark=
`${this.collection}_${virtualclass.gObj.orginalUserId}`):null!=localStorage.getItem("mySession")&&(this.collection=`${wbUser.lkey}_${localStorage.getItem("mySession")}_${wbUser.room}`,this.collectionMark=`${this.collection}_${virtualclass.gObj.orginalUserId}`)}buildAllMarksStatus(c){this.allMarks[c.context]||(this.allMarks[c.context]={});"question"===c.component?"create"===c.action?(this.allMarks[c.context].question||(this.allMarks[c.context].question=[]),this.allMarks[c.context][c.component].push(c.componentId)):
