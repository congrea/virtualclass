...
return{width:a,height:b}}}})(window);let globalImageData={};
...
a.classList.remove("connecting");document.querySelector("#virtualclassApp").classList.remove("try-to-connect");roles.hasControls()?virtualclass.userInteractivity.triggerInitFirebaseOperation():null!=localStorage.getItem("mySession")&&(document.getElementById("virtualclassCont").classList.add("readyForNote"),virtualclass.userInteractivity.triggerInitFirebaseOperation());console.log("live stream remove button ",virtualclass.gObj.currentSession);a=document.getElementById("startLiveStream");null!=a&&
a.classList.remove("disabled")}};a.prototype.waitBlock=function(){const a=document.getElementById("about-modal");virtualclass.popup.open(a);this.hideAllPopups();document.getElementById("recordPlay").style.display="block";virtualclass.popup.replayWindowAction("none")};a.prototype.waitBlockAction=function(a){document.getElementById("recordPlay").style.display=a};a.prototype.sendBackOtherElems=function(a){a=document.getElementById("virtualclassOptionsCont");null!=a&&(a.style.zIndex=0);a=document.getElementById("commandToolsWrapper");
null!=a&&(a.style.pointerEvents="none");a=document.getElementById("stickybar");null!=a&&(a.style.zIndex=0);a=document.getElementById("chatrm");null==a||virtualclass.isPlayMode||(a.style.zIndex=0);a=document.getElementById("audioWidget");null!=a&&(a.style.zIndex=0);a=document.getElementById("memlist");null!=a&&(a.style.zIndex=0)};a.prototype.openProgressBar=function(a){a=document.getElementById("about-modal");virtualclass.popup.open(a);this.hideAllPopups();document.getElementById("recordingContainer").style.display=
"block"};a.prototype.replayWindow=function(){const a=document.getElementById("about-modal");virtualclass.popup.open(a);this.hideAllPopups();virtualclass.popup.replayWindowAction("block")};a.prototype.sesseionEndWindow=function(){var a=document.getElementById("about-modal");virtualclass.popup.open(a);this.hideAllPopups();a=document.getElementById("sessionEndMsgCont");a.style.display="block";a.dataset.displaying=!0;document.getElementById("sessionEndClose").addEventListener("click",()=>{virtualclass.popup.closeElem();
c.close()})};a.prototype.validateurlPopup=function(a){const b=document.getElementById("about-modal");virtualclass.popup.open(b);this.hideAllPopups();let c,d;"video"===a?(c=document.querySelector("#virtualclassCont.congrea #popupContainer #uploadvideourl"),d=document.querySelector("#virtualclassCont.congrea #popupContainer #vidPopupClose")):"presentation"===a&&(c=document.querySelector("#virtualclassCont.congrea #popupContainer #uploadppturl"),d=document.querySelector("#virtualclassCont.congrea #popupContainer #pptPopupClose"));
c.style.display="block";c.dataset.displaying=!0;d.addEventListener("click",()=>{virtualclass.popup.closeElem()})};a.prototype.replayWindowAction=function(a){document.getElementById("replayContainer").style.display=a};a.prototype.progressBarAction=function(a){document.getElementById("recordingContainer").style.display=a};a.prototype.confirmInput=function(a,b,c,d,f,t){var g=document.getElementById("about-modal");virtualclass.popup.open(g);this.hideAllPopups();g=document.getElementById("confirm");g.style.display=
"block";var k=g.getElementsByClassName("confirmChild");if(0<k.length)for(;1<=k.length;)k[0].parentNode.removeChild(k[0]);k=document.createElement("div");k.id="confirmMessage";k.className="confirmChild";k.innerHTML=a;g.appendChild(k);const m=this;a=function(){m.confirmInit(this.id,b,c,d,f,t)};k=document.createElement("div");k.id="confirmOk";k.className="confirmButton confirmChild";k.addEventListener("click",a);const n=document.createElement("button");n.id="confirmOkButton";n.className="icon-check";
...
c=document.getElementById("editPollCont");c.style.display="block";const d=this,f=function(){d.action(this.id,a,b)};if(null==document.getElementById("pollCancel")){const a=document.createElement("div");a.id="pollCancel";a.className="cancelBtn";a.addEventListener("click",f);const b=document.createElement("button");b.id="confirmCancelButton";b.className="icon-close";b.innerHTML=virtualclass.lang.getString("pollCancel");a.appendChild(b);c.appendChild(a)}document.getElementById("resetPoll").addEventListener("click",
f);document.getElementById("addMoreOption").addEventListener("click",f);document.getElementById("etSave").addEventListener("click",f);document.getElementById("saveNpublish").addEventListener("click",f)};a.prototype.action=function(a,b,c,d,f,t){b(a)};a.prototype.confirmInit=function(a,b,c,d,f,t){virtualclass.popup.closeElem();a="confirmOk"===a?virtualclass.popup.confirmOk():virtualclass.popup.confirmCancel();b(a,c,d,f,t)};a.prototype.confirmCancel=function(){return!1};a.prototype.confirmOk=function(){return!0};
a.prototype.waitMsg=function(a){let b=0;"undefined"!==typeof a?b=1300:document.getElementById("virtualclassCont").classList.add("withoutRefresh");setTimeout(()=>{virtualclass.network.netWorkElementIsReady()},b);"undefined"!==typeof virtualclass.vutil&&virtualclass.vutil.sesionEndMsgBoxIsExisting()||this.hideAllPopups()};a.prototype.chromeExtMissing=function(){const a=document.getElementById("about-modal");a.dataset.currPopup="chromeExt";virtualclass.popup.open(a);this.hideAllPopups();document.getElementById("chromeExtMiss").style.display=
"block";roles.isStudent()&&virtualclass.gObj.studentSSstatus.mesharing&&(virtualclass.gObj.studentSSstatus.mesharing=!1);document.getElementById("chromeExtClose").addEventListener("click",()=>{virtualclass.popup.closeElem();a.dataset.currPopup=""})};a.prototype.generalMsg=function(a){const b=document.getElementById("about-modal");virtualclass.popup.open(b);this.hideAllPopups();document.getElementById("generalMessage").style.display="block";document.querySelector("#generalMessageMsg").innerHTML=a;
document.getElementById("generalMessageClose").addEventListener("click",()=>{virtualclass.popup.closeElem()})};a.prototype.infoMsg=function(a){const b=document.getElementById("about-modal");virtualclass.popup.open(b);this.hideAllPopups();document.getElementById("infoMessage").style.display="block";document.querySelector("#infoMessageMsg").innerHTML=a;document.getElementById("infoMessageOk").innerHTML="ok";document.getElementById("infoMessageOk").addEventListener("click",()=>{virtualclass.popup.closeElem()})};
a.prototype.generalMsgButton=function(a){a=document.getElementById("about-modal");virtualclass.popup.open(a);this.hideAllPopups();a=document.querySelector("#generalMessageButton");null!=a&&(a.style.display="block;",document.querySelector("#generalMessageButton .button").addEventListener("click",()=>{virtualclass.popup.closeElem()}))};a.prototype.hideAllPopups=function(){const a=document.getElementsByClassName("popupWindow");for(let b=0;b<a.length;b++)a[b].style.display="none"};a.prototype.closePopup=
...
' class="vceditor-unchecked"'}m+=`<li${v}${p}>`;v=!0}else m+=`<div${p}>`;p=!0}if(g.LINE_SENTINEL in r){A=c.ops[++q];continue}if(g.ENTITY_SENTINEL in r){for(F=0;F<A.text.length;F++)G=vceditor.Entity.fromAttributes(r),G=d.exportToElement(G),m+=G.outerHTML;A=c.ops[++q];continue}G=F="";for(const a in r){C=r[a];var B;if(a===g.BOLD||a===g.ITALIC||a===g.UNDERLINE||a===g.STRIKE){f.assert(!0===C);var H=B=a}else a===g.FONT_SIZE?(H=`span style="font-size: ${C}`,H+="string"!==typeof C||-1===C.indexOf("px",C.length-
...
"scY")&&null!=b.scY&&null!=this.canvas&&this.scroll.caclculatePosition(b.scY,a.height,"Y");Object.prototype.hasOwnProperty.call(b,"scX")&&null!=b.scX&&null!=this.canvas&&this.scroll.caclculatePosition(b.scX,a.width,"X")},customMoustPointer(b,a,c){this.scroll[a].e=c;this.scroll[a].e>this.scroll[a].c?(b=this.scroll[a].b+(this.scroll[a].d-this.scroll[a].c),b>this.scroll[a].e&&(b=this.scroll[a].e-(this.scroll[a].b+this.scroll[a].c)/2),"Y"==a?(this.canvasWrapper.scrollTop=b,console.log("====> scroll top")):
this.canvasWrapper.scrollLeft=b,this.scroll[a].b=b,this.scroll[a].c=this.scroll[a].b+this.scroll[a].studentVPm):this.scroll[a].e<this.scroll[a].b&&(b=this.scroll[a].b-this.scroll[a].a,this.scroll[a].c-b<this.scroll[a].e&&(b=(this.scroll[a].b+this.scroll[a].c)/2-this.scroll[a].e),"Y"===a?this.canvasWrapper.scrollTop-=b:this.canvasWrapper.scrollLeft-=b,this.scroll[a].b=b,this.scroll[a].c=this.scroll[a].b+this.scroll[a].studentVPm)},setCustomMoustPointer(b,a){var c=`scrollDiv${a}${virtualclass.gObj.currWb}`,
f=document.querySelector(`#${c}mousePointer`);null==f&&(f=document.createElement("div"),f.className="mousepointer",f.id=`${c}mousePointer`,c=document.querySelector(`#scrollDiv${a}${virtualclass.gObj.currWb}`),null!=c&&c.appendChild(f));"Y"===a?f.style.top=`${b.y-this.scroll[a].a}px`:"X"===a&&(f.style.left=`${b.x-this.scroll[a].a}px`)},sendScroll(){virtualclass.vutil.setDefaultScroll()},sendCurrentScroll(b){let a={};if(null!=this.currentScroll){a=Object.assign(a,this.currentScroll);const c=this;c.currentScrolltoUser=
b;setTimeout(()=>{c.currentScrolltoUser=b;a.cf="scf";a.toUser=b;virtualclass.vutil.beforeSend({toUser:b,cf:"scf",scY:a.scY,vpY:a.vpY},b)},2E3)}},setDefaultCanvasWidth(b,a){if("_doc_0_0"!==b||0!==a.parentNode.parentNode.offsetWidth&&300!==a.parentNode.parentNode.offsetWidth)a.width=a.parentNode.parentNode.offsetWidth-6;else{let b;"Whiteboard"===virtualclass.currApp?b=document.querySelector("#virtualclassWhiteboard.canvasContainer.current"):"DocumentShare"===virtualclass.currApp&&(b=document.querySelector("#screen-docs.current"));
b||(b=document.querySelector("#virtualclassAppContainer"));a.width=b.offsetWidth-6}virtualclass.wbWrapper.util.createFabricNewInstance(b,{width:a.width,height:a.height})},calculateViewPort(b,a){const c=document.getElementById("virtualclassAppContainer");b=virtualclass.vutil.canvasDimensionFromPixel(b);const f=a.getViewport(Math.min(c.clientWidth/b.width*virtualclass.zoom.canvasScale,c.clientHeight/b.height*virtualclass.zoom.canvasScale));return f.width<c.offsetWidth?f:a.getViewport(b.width/a.getViewport(1).width)},
getAppearanceCanvasWidth(b,a){Object.prototype.hasOwnProperty.call(virtualclass.zoom,"diffrentDocumentWidth")?(b=virtualclass.zoom.diffrentDocumentWidth,console.log("==== a canvas width ",a.width),delete virtualclass.zoom.diffrentDocumentWidth):Object.prototype.hasOwnProperty.call(virtualclass.gObj,"fitToScreen")?(b=300===a.parentNode.offsetWidth||0===a.parentNode.offsetWidth?document.querySelector("#virtualclassAppContainer").offsetWidth:a.parentNode.offsetWidth-6,"DocumentShare"===virtualclass.currApp&&
virtualclass.zoom.fitToElementTooltip("fitToToPage")):Object.prototype.hasOwnProperty.call(virtualclass.zoom,"performZoom")?(b=virtualclass.zoom.canvasDimension.width,console.log("==== a canvas width performZoom ",a.width),delete virtualclass.zoom.performZoom):Object.prototype.hasOwnProperty.call(virtualclass.zoom,"canvasDimension")?(b=virtualclass.zoom.canvasDimension.width,console.log("==== a canvas width  ",a.width)):0===a.offsetWidth||300===a.offsetWidth||virtualclass.isPlayMode?(this.setDefaultCanvasWidth(b,
a),b=virtualclass.vutil.canvasDimensionFromPixel(a).width):b=a.parentNode.offsetWidth-6;return b},async renderPage(b,a){virtualclass.zoom.prvPdfDimension&&virtualclass.zoom.prvPdfDimension[2]!==b.view[2]&&(virtualclass.gObj.fitToScreen=!0,this.firstTime&&(virtualclass.gObj.pdfWidthChanged=!0));if(null!=virtualclass.gObj.currWb){var c=this.pdfScale;null!=virtualclass.zoom.canvasScale&&""!=virtualclass.zoom.canvasScale&&0<virtualclass.zoom.canvasScale&&(c=virtualclass.zoom.canvasScale);let d;d="Whiteboard"===
virtualclass.currApp&&null!=this.wbId&&virtualclass.gObj.currWb!==this.wbId?-1<this.wbId.indexOf("_doc_")?this.wbId:`_doc_${this.wbId}_${this.wbId}`:b.wbId;const k=virtualclass.wb[d].canvas.lowerCanvasEl;var f=this.getAppearanceCanvasWidth(d,k);this.firstTime?(this.firstTime=!1,null==virtualclass.zoom.canvasScale||virtualclass.gObj.fitToScreen?(c=b.getViewport(f/b.getViewport(1).width),console.log("==== view port 1",c.width)):(c=b.getViewport(c),console.log("==== view port 2",c.width))):virtualclass.zoom.performFitToPage?
(c=this.calculateViewPort(k,b),console.log("==== view port 3",c.width)):(c=b.getViewport(f/b.getViewport(1).width),console.log("==== view port 4",c.width));console.log("=====> whiteboard pdf suman calc canvas scale");virtualclass.zoom.prvCanvasScale=virtualclass.zoom.canvasScale;virtualclass.zoom.canvasScale=c.scale;console.log("==== a suman SCAle change ",virtualclass.zoom.canvasScale);virtualclass.zoom.prvPdfDimension=b.view;f=document.getElementById(`${k.id}_pdf`);f.width=c.width;f.height=c.height;
virtualclass.zoom.canvasDimension={};virtualclass.zoom.canvasDimension.width=c.width;virtualclass.zoom.canvasDimension.height=c.height;virtualclass.wbWrapper.util.createFabricNewInstance(d,{width:c.width,height:c.height});if(Object.prototype.hasOwnProperty.call(virtualclass.gObj,"fitToScreen")){const a=document.querySelector(`#canvasWrapper${virtualclass.gObj.currWb}`);if(null!==a&&(a.scrollHeight<=a.clientHeight||a.scrollWidth<=a.clientWidth))virtualclass.pdfRender[virtualclass.gObj.currWb].onScroll(a,
!0)}virtualclass.wb[d].canvas.setZoom(virtualclass.zoom.canvasScale);console.log("====> canvas set zoom",virtualclass.zoom.canvasScale);delete virtualclass.gObj.fitToScreen;c={canvasContext:f.getContext("2d"),viewport:c};await b.render(c);k.parentNode.dataset.pdfrender=!0;this[d]={pdfrender:!0};virtualclass.vutil.showZoom();null!=a&&null!=virtualclass.gObj.currWb&&(await this.initWhiteboardData(b.wbId),roles.hasControls()&&(console.log("====> invoke handle active tool"),virtualclass.wbWrapper.util.handleActivateTool(b.wbId)));
"object"===typeof this.shownPdf&&(io.globallock=!1,virtualclass.vutil.removeClass("virtualclassCont","resizeWindow"));this.firstTimeScroll&&roles.isStudent()&&"object"===typeof virtualclass.pdfRender[virtualclass.gObj.currWb]&&(virtualclass.pdfRender[virtualclass.gObj.currWb].setScrollPosition({scX:0,scY:0}),this.firstTimeScroll=!1)}},async displayPage(b,a,c){a=await b.getPage(a);a.wbId=b.wbId;virtualclass.pdfRender[b.wbId].page=a;"undefined"!==typeof c?await this.renderPage(a,c):await this.renderPage(a,
null)},async initWhiteboardData(b){"object"===typeof virtualclass.gObj.wbData[b]&&virtualclass.gObj.wbData[b]&&0<virtualclass.gObj.wbData[b].length&&await virtualclass.wbWrapper.replay.replayFromLocalStroage(virtualclass.gObj.wbData[b],b)},async _zoom(b,a,c){virtualclass.vutil.setHeight(virtualclass.gObj.currWb,b,c);virtualclass.vutil.setWidth(virtualclass.gObj.currWb,b,a);b=b.parentNode;c=virtualclass.vutil.getValueWithoutPixel(b.style.width);await virtualclass.pdfRender[virtualclass.gObj.currWb].displayPage(this.shownPdf,
...
async _zoomOut(b,a,c){virtualclass.vutil.setHeight(virtualclass.gObj.currWb,b,c);virtualclass.vutil.setWidth(virtualclass.gObj.currWb,b,a);await virtualclass.pdfRender[virtualclass.gObj.currWb].displayPage(this.shownPdf,1);for(const a in virtualclass.pdfRender)this.zoomOutWhiteboardObjects(a)},async _fitToScreen(b,a){virtualclass.vutil.setHeight(virtualclass.gObj.currWb,b,b.height);virtualclass.vutil.setWidth(virtualclass.gObj.currWb,b,a);b=b.parentNode;const c=b.offsetWidth;if(" "!==this.shownPdf){await virtualclass.pdfRender[virtualclass.gObj.currWb].displayPage(this.shownPdf,
1);for(const a in virtualclass.pdfRender)this.fitToScreenWhiteboardObjects(a);a>c&&55<a-c?b.classList.add("scrollX"):b.classList.remove("scrollX")}roles.hasControls()&&(console.log("====> invoke handle active tool"),virtualclass.wbWrapper.util.handleActivateTool(this.shownPdf.wbId))},calculateScaleAtFirst(b,a){b=b.getViewport(a.width/b.getViewport(1).width);this.firstTime=!1;return b},isWhiteboardAlreadyExist(b){return null!=this.canvas},defaultScroll(){null!=virtualclass.gObj.currWb&&(this.canvasWrapper.scrollTop=
...
(-1<this.backDetectValues.frameNavigator.indexOf("MSIE ")||-1<this.backDetectValues.frameNavigator.indexOf("Trident")?this.backDetectValues.frameDetect.src=`${this.backDetectValues.frameDataSrc}'?historyLoaded`:this.backDetectValues.frameDetect.src="about:blank?historyLoaded")}};class LiveStream{constructor(){this.mimeType="video/webm;codecs=vp8,opus";this.queue=[];this.MAX_TIME=999999999999;this.startedStream=!1;this.uploadEndPoint="https://stream.congrea.net";this.fileList=new OrderedList;this.streamQueue=[];this.sendFiles=[];this.bufferLength=2;this.listStream={};this.sharing=!1;this.resoluation={qga:{width:{ideal:320},height:{ideal:240}},vga:{width:{ideal:640},height:{ideal:480}},vga2:{width:{ideal:800},height:{ideal:600}},vga3:{width:{ideal:960},height:{ideal:720}},
vga4:{width:{ideal:1024},height:{ideal:768}},hd:{width:{ideal:1280},height:{ideal:720}},fullhd:{width:{ideal:1920},height:{ideal:1080}},fourk:{width:{ideal:4096},height:{ideal:2160}},eightk:{width:{ideal:7680},height:{ideal:4320}}};this.xhr=axios.create({responseType:"arraybuffer",withCredentials:!0});this.constraints={audio:{echoCancellation:{exact:!0}},video:this.resoluation.fullhd};this.constraints.video.frameRate={ideal:20}}init(){if(!document.querySelector("#networkStatusContainer.connecting-room")){const c=
document.getElementById("startLiveStream");null!=c&&c.classList.remove("disabled")}this.alreadyInit||(virtualclass.isPlayMode?(this.prefixUrl=`${this.uploadEndPoint}/${wbUser.lkey}/${wbUser.room}/${wbUser.session}`,console.log("Prfix url recording",this.prefixUrl)):null!=localStorage.mySession?(this.prefixUrl=`${this.uploadEndPoint}/${wbUser.lkey}/${wbUser.room}/${localStorage.mySession}`,console.log("Prfix url localstorage",this.prefixUrl)):(this.prefixUrl=`${this.uploadEndPoint}/${wbUser.lkey}/${wbUser.room}/${virtualclass.gObj.currentSession}`,
console.log("Prfix url new",virtualclass.gObj.currentSession)),roles.hasControls()&&(console.log("==> attach click event "),document.getElementById("startLiveStream").addEventListener("click",this.handlLiveStream.bind(this))),this.alreadyInit=!0)}requestStream(c){c&&void 0!=c?(console.log("====> remain queue length ",this.fileList.ol.order.length),console.log("request url ",c),this.xhr.get(c).then(async b=>{this.afterReceivedStream(b)}).catch(b=>{5>=this.fileList.ol.order.length?this.lastFileRequested=
this.firstFile:setTimeout(()=>{console.log("trigger init packet with ",this.lastFileRequested);this.requestInitializePacket(this.lastFileRequested)},2E3)})):console.log("Invalid URL")}getFileName(c){const b=c.lastIndexOf("/");return c.substring(b+1).replace(".chvs","")}duringPlayFirstPacket(){var c=document.getElementById("virtualclassVideo");c&&(c.dataset.currapp="liveStream");if(c=document.getElementById("messageLayoutVideo"))c.style.display="none"}afterReceivedStream(c){console.log("play start data received");
const b=c.data.slice(4,c.data.length);c=this.getFileName(c.config.url);this.listStream[c]=b;console.log("reponse receive at very start, Play start 0 ",c);this.playIfReady(c);console.log("====> response received for file ",c)}onBuffer(c){if(this.sourceBuffer){const b=new Uint8Array(c);console.log("play start first four ",b[0],b[1],b[2],b[3]);this.sourceBuffer.appendBuffer(c)}}readyParticipateVideo(){this.remoteVideo||(this.remoteVideo=document.getElementById("liveStream"),this.remoteVideo.srcObject=
null,this.remoteVideo.currentTime=0)}initPLayerForParticipaes(){console.log("current mode LIVE STREAM");this.mediaSource=new MediaSource;this.mediaSource.addEventListener("sourceopen",this.mediaSourceOpen.bind(this));this.readyParticipateVideo();this.remoteVideo.src=URL.createObjectURL(this.mediaSource)}mediaSourceOpen(){console.log("step 1");"open"===this.mediaSource.readyState?(this.sourceBuffer=this.mediaSource.addSourceBuffer(this.mimeType),this.sourceBuffer.addEventListener("error",function(c){}),
this.sourceBuffer.addEventListener("updateend",function(){console.log("====> appended start: remove 2");const c=virtualclass.liveStream.fileList.getNextByID(virtualclass.liveStream.currentExecuted);console.log(" ===> actual PLAY START 2");c&&virtualclass.liveStream.playIfReady(c.id)})):console.log("MEDIA SOURCE IS NOT OPEN")}handlLiveStream(c){"0"===c.currentTarget.dataset.sharinglivestream?this.startToShare():(this.stop(),c=document.querySelector("#dashboardnav button"),null!=c&&c.click())}disableLiveStreamButton(){const c=
document.getElementById("startLiveStream");null!=c&&c.classList.add("disabled")}async startToShare(){this.stopTraditionalVideo();var c=c=document.getElementById("startLiveStream");c.dataset.sharinglivestream="1";c=null;try{c=await navigator.mediaDevices.getUserMedia(this.constraints)}catch(b){this.disableLiveStreamButton(),virtualclass.media.handleUserMediaError(b)}c&&this.handleSuccess(c)}handleSuccess(c){const b=c.getVideoTracks()[0].getSettings();console.log("====> camera settings ",b);console.log("getUserMedia() got stream:",
c);this.stream=c;virtualclass.dashboard.close();this.showLiveStreamHTML();document.getElementById("liveStream").srcObject=this.stream;this.startRecorder()}startRecorder(){console.log("current mode LIVE STREAM");MediaRecorder.isTypeSupported(this.mimeType)||console.error(`${this.mimeType} is not supported`);this.mediaRecorder=new MediaRecorder(this.stream,{mimeType:this.mimeType});this.mediaRecorder.addEventListener("stop",this.stopHandler.bind(this));this.mediaRecorder.addEventListener("dataavailable",
this.handleLiveStreamData.bind(this));this.mediaRecorder.start(1500)}stopHandler(){console.log("====STOP 1")}handleLiveStreamData(c){console.log("====> triggering data ");this.mediaRecorder&&"recording"===this.mediaRecorder.state&&this.saveToStreamServer(c.data)}async saveToStreamServer(c){c=await this.videoTypedArray(c);ioAdapter.sendStream(c)}async videoTypedArray(c){c=await c.arrayBuffer();c=new Uint8Array(c);let b=new c.constructor(2);b[0]=72;b[1]=78;let a=new c.constructor(c.length+b.length);
a.set(b,0);a.set(c,b.length);return a}stop(){var c=c=document.getElementById("startLiveStream");c.dataset.sharinglivestream="0";this.mediaRecorder&&"inactive"!==this.mediaRecorder.state&&this.mediaRecorder.stop();this.hideLiveStreamHTML();this.disableLiveStreamButton();roles.hasControls()&&(ioAdapter.mustSend({cf:"liveStream",stop:!0}),this.clearEveryThing());setTimeout(()=>{streamElement.classList.remove("disabled")},5E3)}stopTraditionalVideo(){Object.prototype.hasOwnProperty.call(virtualclass,"videoUl")&&
Object.prototype.hasOwnProperty.call(virtualclass.videoUl,"player")&&virtualclass.videoUl.destroyPlayer();const c=document.getElementById("videoPlayerCont");c&&(c.style.display="none");roles.hasControls()&&ioAdapter.mustSend({cf:"liveStream",stopVideo:!0})}clearEveryThing(){console.log("Removed live stream");delete virtualclass.gObj.videoMode;console.log("delete normal video");var c=document.getElementById("virtualclassVideo");null!=c&&(c.dataset.currapp="normalVideo",c=document.getElementById("messageLayoutVideo"))&&
(c.style.display="block");this.stream&&this.stream.getTracks().forEach(function(b){b.stop()});this.mediaRecorder&&delete this.mediaRecorder;if(this.sourceBuffer){if(this.sourceBuffer.updating)this.sourceBuffer.abort(),console.log("Source buffer abort");else{try{this.sourceBuffer.remove(0,300)}catch(b){this.sourceBuffer.abort()}console.log("====> appended start: remove 3");console.log("Source buffer remove")}delete this.sourceBuffer;delete this.mediaSource}this.startedStream=!1;c=document.getElementById("liveStream");
null!=c&&(c.src=null);delete this.firstFile;console.log("====> Empty the list 2a");delete this.startingPoint;delete this.startedAppending;this.fileList.emptyList();delete this.lastFileRequested;delete virtualclass.liveStream.callFromSeek;delete this.startFromPageRefresh;console.log("====> appended start: remove 1")}showLiveStreamHTML(){document.getElementById("virtualclassVideo").dataset.currapp="liveStream";document.querySelector("#startLiveStream .label").innerHTML=virtualclass.lang.getString("stopLiveSharing")}hideLiveStreamHTML(){document.getElementById("virtualclassVideo").dataset.currapp=
"normalVideo";document.querySelector("#startLiveStream .label").innerHTML=virtualclass.lang.getString("startLiveSharing")}isLiveStreamMode(){return"liveStream"===document.getElementById("virtualclassVideo").dataset.currapp}onMessage(c){c.message.fileName?(console.log("Received file from server ",c.message.fileName),setTimeout(()=>{"Video"===virtualclass.currApp&&this.mediaRecorder&&"recording"===this.mediaRecorder.state&&(console.log("====> send file ",c.message.fileName),ioAdapter.mustSend({cf:"liveStream",
url:c.message.fileName}))},3E3)):c.message.stop?this.clearEveryThing():c.message.stopVideo?this.stopTraditionalVideo():c.message.url&&"Video"===virtualclass.currApp&&!virtualclass.gObj.hasOwnProperty("videoMode")&&roles.isStudent()&&(console.log("====> Empty the list 2"),this.firstFile||(this.firstFile=c.message.url),this.lastFileRequested=c.message.url,console.log("Last file request ",this.lastFileRequested),this.fileList.insert(c.message.url,`${this.prefixUrl}/${c.message.url}.chvs`),!this.startingPoint&&
this.fileList.ol.order.length>=this.bufferLength&&this.readyStartingPoint(),this.insertTime&&(clearTimeout(this.insertTime),this.pageRefresh=!0),this.insertTime=setTimeout(()=>{this.pageRefresh?5>=this.fileList.ol.order.length?(this.triggerStart(this.fileList.ol.order[0]),console.log("live stream, start from first ",this.fileList.ol.order.length)):this.startFromPageRefresh||(this.startFromPageRefresh=!0,virtualclass.liveStream.callFromSeek||this.requestInitializePacket(),console.log("live stream, start from latest",
this.fileList.ol.order.length)):this.triggerStart(c.message.url);console.log("page refresh remove");this.insertTime=this.pageRefresh=!1;console.log("live video suman 1")},100),console.log("====> live stream receive file ",c.message.url," queue length ",this.fileList.ol.order.length))}requestInitializePacket(c){this.stopTraditionalVideo();this.initPLayerForParticipaes();this.xhrInitPacket||(this.xhrInitPacket=axios.create({responseType:"arraybuffer",headers:{"Content-Type":"application/json","x-api-key":wbUser.lkey,
"x-congrea-authuser":wbUser.auth_user,"x-congrea-authpass":wbUser.auth_pass,"x-congrea-room":wbUser.room,get:{Accept:"video/webm;codecs=vp8,opus"}}}));let b;b=virtualclass.isPlayMode?wbUser.session:null!=localStorage.mySession?localStorage.mySession:virtualclass.gObj.currentSession;c=c?`https://api.congrea.net/data/stream?session=${b}&file=${c}`:`https://api.congrea.net/data/stream?session=${b}`;console.log("request url init packet ",c);this.requestInitializePacketFinal(c)}requestInitializePacketFinal(c){this.latesRequetInitUrl=
c;console.log("request url live stream init data ",c);this.xhrInitPacket.get(c).then(async b=>{this.latesRequetInitUrl===b.config.url&&(this.currentFile=b.headers["x-congrea-seg"].split(".chvs")[0],console.log("request url live stream receive init data ",this.currentFile,b.config.url.split("?")[1]),this.startedStream=!0,this.listStream[this.currentFile]=b.data,this.firstFile=b.headers["x-congrea-seg"].split(".chvs")[0],delete this.startingPoint,console.log("calculate starting point"),this.readyStartingPoint())})}triggerStart(c){this.startedStream?
this.startedStream&&0<this.fileList.ol.order.length&&(c=this.fileList.getNextByID(this.currentFile),this.requestStream(c.data),this.currentFile=c.id):(this.initPLayerForParticipaes(),this.requestStream(this.fileList.getCurrent(c)),this.currentFile=c,this.startedStream=!0)}isMyTurn(c){const b=this.fileList.getNextByID(this.currentExecuted);console.log("is my turn curernt, next ",this.currentExecuted,b.id,c);return b.id===c}inStreamList(c){return this.listStream[c]?this.listStream[c]:!1}readyStartingPoint(){let c=
this.firstFile;if(-1>=this.fileList.getCurrentPosition(c))console.log("NOT FOUND ON LIST");else{var b;if(1<this.bufferLength){for(let a=1;a<this.bufferLength;a++)if(b=this.fileList.getNextByID(c))c=b.id;c!=this.firstFile&&(this.startingPoint=c)}}}playIfReady(c){var b=this.inStreamList(c);if(this.startingPoint&&c===this.startingPoint&&this.inStreamList(this.firstFile)){b=this.inStreamList(this.firstFile);try{this.onBuffer(b),console.log("Actual append buffer ",this.firstFile),this.currentExecuted=
this.firstFile,delete this.listStream[this.firstFile],this.startedAppending=!0,this.duringPlayFirstPacket(),this.startFromPageRefresh&&setTimeout(()=>{document.getElementById("liveStream").currentTime=this.MAX_TIME;console.log("REFRESH THE SCREEN")},1600)}catch(a){this.requestInitializePacket(c),console.log("====> Error handlling request packet")}}else if(this.startedAppending&&this.isMyTurn(c)&&b)try{this.onBuffer(b),console.log("Actual append buffer ",c),delete this.listStream[c],this.currentExecuted=
c}catch(a){this.requestInitializePacket(c),console.log("====> Error handlling request packet")}}};$.uiBackCompat=!1;
