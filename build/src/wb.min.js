...
(virtualclass.wb[virtualclass.gObj.currWb].replay.rendering=!1)),null!=virtualclass.editorRich&&virtualclass.editorRich.removeEditorData(),virtualclass.pdfRender={});virtualclass.vutil.removeClass("audioWidget","fixed");virtualclass.storage.clearStorageData();virtualclass.wbCommon.removeAllContainers();virtualclass.gObj.wbCount=0;virtualclass.gObj.currSlide=0;virtualclass.currApp=virtualclass.gObj.defaultApp;virtualclass.gObj.hasOwnProperty("disableCamByUser")?virtualclass.user.control.audioDisable():
virtualclass.user.control.audioWidgetEnable(!0);virtualclass.user.control.allChatEnable();virtualclass.user.control.resetmediaSetting();roles.isStudent()?(a=document.getElementById("videoHostContainer"),null!==a&&(a.style.display="none"),a=document.getElementById("virtualclassAppRightPanel"),null!==a&&a.classList.contains("vidShow")&&a.classList.remove("vidShow")):(a=document.getElementById("virtualclassSessionEndTool"),null!==a&&(a.className=virtualclass.vutil.removeClassFromElement("virtualclassSessionEndTool",
...
{};a=document.querySelector("#virtualclassWhiteboard");null!==a&&(a.style.display="none");a=document.querySelector("#virtualclassCont");null!==a&&a.classList.remove("loading");localStorage.clear();virtualclass.videoHost&&roles.isStudent()&&!virtualclass.isPlayMode&&(a=document.querySelector("#virtualclassAppRightPanel"),null===a||a.classList.contains("vidHide")||a.classList.add("vidHide"));console.log(`New role after clear ${virtualclass.gObj.uRole}`);virtualclass.enablePreCheck||virtualclass.popup.waitMsg();
"object"===typeof virtualclass.dts&&null!=virtualclass.dts&&virtualclass.dts.destroyDts();if("object"===typeof virtualclass.raiseHand&&null!=virtualclass.raiseHand)if(roles.hasControls()){if(virtualclass.raiseHand.rhCount=0,virtualclass.raiseHand.rhCountR=0,(a=document.querySelector(".congrea .vmchat_bar_button .hand_bt.highlight"))&&a.classList.remove("highlight"),a=document.querySelector(".congrea .vmchat_bar_button .hand_bt #notifyText"))a.innerHTML=""}else if(a=document.querySelector(".congrea .handRaise.disable"))a.classList.remove("disable"),
a.classList.add("enable"),a.setAttribute("data-title",virtualclass.lang.getString("RaiseHandStdEnabled")),document.querySelector(".congrea .handRaise #icHr").setAttribute("data-action","enable"),virtualclass.raiseHand.stdRhEnable="enabled";if(null!==document.getElementById("chat_div")){(a=chatContainerEvent.elementFromShadowDom(".vmchat_room_bt.ui-state-highlight"))&&a.classList.remove("ui-state-highlight");(a=document.querySelector("#virtualclassCont.congrea.student"))&&a.classList.contains("videoff")&&
a.classList.remove("videoff");a=document.querySelector("#virtualclassCont #memlist");b=document.querySelector("#virtualclassCont #chatrm");c=document.querySelector("#user_list");const f=document.querySelector("#chatroom_bt2");a&&!a.classList.contains("enable")&&(a.classList.add("enable"),a.classList.remove("disable"),b&&(b.classList.add("disable"),b.classList.remove("enable")));null!=f&&(c.classList.contains("active")||c.classList.add("active"),f.classList.remove("active"))}null!=virtualclass.serverData&&
