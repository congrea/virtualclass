...
typeof virtualclass.gObj.wbData[a]&&(virtualclass.gObj.wbData[a]=[]);virtualclass.gObj.wbData[a]=virtualclass.gObj.wbData[a].concat(b)},attachWhiteboardPopupHandler(b){c.addEventListener("mouseup",a=>{roles.hasControls()&&WhiteboardUtility.closeTray();virtualclass.userInteractivity.event.moreControlsCloseTray()})},setScreenShareDefualtColor(){var b=virtualclass.gObj.prvRequestScreenUser;virtualclass.gObj.prvRequestScreenUser&&(b=chatContainerEvent.elementFromShadowDom(`#ml${b} .icon-stdscreenImg`),
null!==b&&(b.setAttribute("data-dcolor","black"),b.parentNode.setAttribute("data-title",virtualclass.lang.getString("requestScreenShare"))))},hidePageNumber(){const b=document.querySelector("#docShareNav");null!==b&&(b.classList.add("hide"),b.classList.remove("show"))},sendSpeedByMobile(b){"mobTab"===virtualclass.system.desktop&&ioAdapter.sendSpeed(b)},isRefreshMode(){return virtualclass.config.makeWebSocketReady},triggerFinalizeTextIfAny(b){},inputFocusHandler(b){console.log("====> focus input");
b&&"string"!==typeof b&&virtualclass.isPlayMode&&virtualclass.userInteractivity.triggerPause();c.innerWidth>c.innerHeight&&(virtualclass.gObj.initHeight=c.innerHeight,b=document.querySelector("#tabs .ui-state-focus"),"mobTab"===virtualclass.system.device&&null==b&&"Safari"!=virtualclass.system.mybrowser.name&&document.getElementById("virtualclassCont").classList.add("focusInput"))},inputFocusOutHandler(){console.log("====> focus output");"mobTab"===virtualclass.system.device&&document.getElementById("virtualclassCont").classList.remove("focusInput")},
checkUserRole(){return virtualclass.isPlayMode?"t"===wbUser.orginalUserRole:"t"===virtualclass.gObj.uRole||"p"===virtualclass.gObj.uRole},closeElement(b){b.classList.contains("open")&&(b.classList.remove("open"),b.classList.add("close"))},canvasDimensionFromPixel(b){const a=parseFloat(c.getComputedStyle(b).width);b=parseFloat(c.getComputedStyle(b).height);return{width:a,height:b}}}})(window);let globalImageData={};
