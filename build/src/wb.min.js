...
"dec"===vType&&virtualclass.gObj.meetingMode&&WebPDecDemo(c.id);virtualclass.vutil.WebPDecodeAndDraw(b,c,a)}};http.send(null)}else"enc"===vType&&ImageToCanvas(`/images-enc/${filename}`)};function WebPDecDemo(d){document.getElementById(d).getContext("2d");document.createElement("img")};const BASE64_MARKER=";base64,";
