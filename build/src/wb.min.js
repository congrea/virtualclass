...
!1;virtualclass.gObj.meetingMode||virtualclass.videoHost.init(320,240);virtualclass.vutil.videoController();a=document.getElementById("precheckBtn");a.addEventListener("click",()=>{virtualclass.gObj.precheckScrn=!0;virtualclass.precheck.init(virtualclass.precheck)});this.raiseHand=d.raiseHand;this.raiseHand.init();this.appSetting=d.appSetting;this.appSetting.init();virtualclass.colorSelector=d.colorSelector;virtualclassSetting.theme.selectedColor&&this.colorSelector.makeThemeReady();a=document.getElementById("virtualclassCont");
null!=a&&a.classList.add(virtualclass.system.mybrowser.name);a=document.getElementById("fullScreenButton");null!=a&&a.addEventListener("click",virtualclass.vutil.Fullscreen);a=document.getElementById("fullScreenExitButton");null!=a&&a.addEventListener("click",virtualclass.vutil.closeFullscreen);document.onfullscreenchange=function(b){virtualclass.gObj.fullScreenMode?(document.querySelector("#fullScreenButton").style.display="block",document.querySelector("#fullScreenExitButton").style.display="none",
virtualclass.gObj.fullScreenMode=!1):(document.querySelector("#fullScreenButton").style.display="none",document.querySelector("#fullScreenExitButton").style.display="block",virtualclass.gObj.fullScreenMode=!0)}},makeReadySocket(){virtualclass.vutil.isPlayMode()||this.initSocketConn()},initSocketConn(){this.system.webSocket&&(io.init(virtualclass.uInfo),d.userdata=virtualclass.uInfo)},html:{id:"virtualclassCont",optionsClass:"appOptions",init(b){this.virtualclass=b},leftAppBar(){if(!(0<document.getElementsByClassName("appOptions").length)){document.querySelector("#virtualclassApp #virtualclassAppLeftPanel");
...
a!=`t_assign${g}`&&a!=`t_reclaim${g}`&&(virtualclass.wb[g].tool=new virtualclass.wb[g].tool_obj(a),virtualclass.wb[g].utility.attachEventHandlers(g))},tool_obj:function(b){if(-1<b.indexOf("_doc_")){var a=c.querySelector(`#${b}`);a=null==a?virtualclass.gObj.currWb:virtualclass.vutil.getWhiteboardId(a)}else a=virtualclass.gObj.currWb,b+=a;this.cmd=b;b!=`t_freeDrawing${a}`&&(virtualclass.wb[a].obj.freeDrawObj="");b==`t_text${a}`||virtualclass.vutil.exitTextWrapper()||(virtualclass.wb[a].obj.drawTextObj=
...
"undefined"!==typeof b&&b(c)}a=await a.continue()}}else"undefined"!==typeof b&&b()},createNewSession(){virtualclass.makeAppReady(virtualclass.gObj.defaultApp);var a=(new Date).getTime();a=JSON.stringify({createdDate:a});localStorage.setItem("myConfig",a)},endSession:async function(a){console.log("==== End the session here");delete virtualclass.connectedUsers;virtualclass.gObj.hasOwnProperty("memberUpdateDelayTimer")&&(clearTimeout(virtualclass.gObj.memberUpdateDelayTimer),virtualclass.gObj.memberlistpending.length=
...
null!=virtualclass.gObj.CDTimer&&clearInterval(virtualclass.gObj.CDTimer);b=document.querySelector(`#virtualclass${virtualclass.currApp}`);null!=b&&(b.style.display="none");virtualclass.hasOwnProperty("media")&&virtualclass.media.audio.muteButtonToogle();b=chatContainerEvent.elementFromShadowDom(".ui-memblist-usr","all");if(null!=b&&0<b.length)for(var c=0;c<b.length;c++)null!=b[c]&&b[c].parentNode.removeChild(b[c]);virtualclass.gObj.precheckScrn&&virtualclass.vutil.prechkScrnShare();virtualclass.gObj.audioEnable=
roles.hasControls()?!0:virtualclass.gObj.stdaudioEnable;virtualclass.storage.config.sessionEndFlag=!0;b=localStorage.getItem("precheck");null!=virtualclass.chat&&(delete virtualclass.chat.vmstorage,virtualclass.chat.vmstorage={},virtualclass.chat.removeChatHighLight("chatrm"));virtualclass.recorder.items=[];virtualclass.recorder.totalSent=0;virtualclass.gObj.tempReplayObjs.length=0;virtualclass.wb="";delete virtualclass.gObj.currWb;virtualclass.gObj.studentSSstatus.mesharing=!1;virtualclass.removeSharingClass();
...
(alert("Clear all whiteboard"),virtualclass.wb[virtualclass.gObj.currWb].utility.t_clearallInit(),virtualclass.wb[virtualclass.gObj.currWb].utility.makeDefaultValue(),"object"===typeof virtualclass.wb[virtualclass.gObj.currWb].replay&&(virtualclass.wb[virtualclass.gObj.currWb].replay.rendering=!1)),null!=virtualclass.editorRich&&virtualclass.editorRich.removeEditorData(),virtualclass.pdfRender={});virtualclass.vutil.removeClass("audioWidget","fixed");virtualclass.storage.clearStorageData();virtualclass.wbCommon.removeAllContainers();
virtualclass.gObj.wbCount=0;virtualclass.gObj.currSlide=0;virtualclass.currApp=virtualclass.gObj.defaultApp;virtualclass.gObj.hasOwnProperty("disableCamByUser")?virtualclass.user.control.audioDisable():virtualclass.user.control.audioWidgetEnable(!0);virtualclass.user.control.allChatEnable();virtualclass.user.control.resetmediaSetting();roles.isStudent()?(a=document.getElementById("videoHostContainer"),null!==a&&(a.style.display="none"),a=document.getElementById("virtualclassAppRightPanel"),null!==
a&&a.classList.contains("vidShow")&&a.classList.remove("vidShow")):(a=document.getElementById("virtualclassSessionEndTool"),null!==a&&(a.className=virtualclass.vutil.removeClassFromElement("virtualclassSessionEndTool","active")));"object"===typeof virtualclass.yts&&clearInterval(virtualclass.yts.tsc);"object"===typeof virtualclass.sharePt&&virtualclass.sharePt.UI.removeIframe();console.log("Session End.");virtualclass.previous=`virtualclass${virtualclass.currApp}`;virtualclass.getContent=!1;virtualclass.recorder.storeDone=
0;workerIO.postMessage({cmd:"sessionEndClose"});null!=b&&localStorage.setItem("precheck",JSON.parse(b));console.log(`New role before clear ${virtualclass.gObj.uRole}`);virtualclass.settings.user={};a=document.querySelector("#virtualclassWhiteboard");null!==a&&(a.style.display="none");a=document.querySelector("#virtualclassCont");null!==a&&a.classList.remove("loading");localStorage.clear();virtualclass.videoHost&&roles.isStudent()&&!virtualclass.isPlayMode&&(a=document.querySelector("#virtualclassAppRightPanel"),
null===a||a.classList.contains("vidHide")||a.classList.add("vidHide"));console.log(`New role after clear ${virtualclass.gObj.uRole}`);virtualclass.enablePreCheck||virtualclass.popup.waitMsg();"object"===typeof virtualclass.dts&&null!=virtualclass.dts&&virtualclass.dts.destroyDts();if("object"===typeof virtualclass.raiseHand&&null!=virtualclass.raiseHand)if(roles.hasControls()){if(virtualclass.raiseHand.rhCount=0,virtualclass.raiseHand.rhCountR=0,(a=document.querySelector(".congrea .vmchat_bar_button .hand_bt.highlight"))&&
a.classList.remove("highlight"),a=document.querySelector(".congrea .vmchat_bar_button .hand_bt #notifyText"))a.innerHTML=""}else if(a=document.querySelector(".congrea .handRaise.disable"))a.classList.remove("disable"),a.classList.add("enable"),a.setAttribute("data-title",virtualclass.lang.getString("RaiseHandStdEnabled")),document.querySelector(".congrea .handRaise #icHr").setAttribute("data-action","enable"),virtualclass.raiseHand.stdRhEnable="enabled";if(null!==document.getElementById("chat_div")){(a=
chatContainerEvent.elementFromShadowDom(".vmchat_room_bt.ui-state-highlight"))&&a.classList.remove("ui-state-highlight");(a=document.querySelector("#virtualclassCont.congrea.student"))&&a.classList.contains("videoff")&&a.classList.remove("videoff");a=document.querySelector("#virtualclassCont #memlist");b=document.querySelector("#virtualclassCont #chatrm");c=document.querySelector("#user_list");const f=document.querySelector("#chatroom_bt2");a&&!a.classList.contains("enable")&&(a.classList.add("enable"),
a.classList.remove("disable"),b&&(b.classList.add("disable"),b.classList.remove("enable")));null!=f&&(c.classList.contains("active")||c.classList.add("active"),f.classList.remove("active"))}null!=virtualclass.serverData&&(virtualclass.serverData.rawData={video:[],ppt:[],docs:[]},roles.hasAdmin()&&virtualclass.serverData.fetchAllData());virtualclass.gObj.wIds=[0];virtualclass.wbCommon.order=[0];virtualclass.gObj.wbCount=0;virtualclass.wbCommon.clearNavigation();"object"===typeof virtualclass.wb&&delete virtualclass.wb[virtualclass.gObj.currWb].activeToolColor;
virtualclass.gObj.currIndex=1}},dstdata:{async handleResult(b){for(;b;)b.value.hasOwnProperty("alldocs")&&(console.log("document share store"),a=!0,virtualclass.gObj.docs=JSON.parse(b.value.alldocs)),b=await b.continue();a||(virtualclass.gObj.docs="init",console.log("==== Docs init "))}},dstAllStore(a){const b=this.db.transaction("dstall","readwrite");b.store.clear();const c=JSON.stringify(virtualclass.dts.allNotes);b.store.add({dstalldocs:JSON.stringify(a),allNotes:c,timeStamp:(new Date).getTime(),
id:10});b.done.then(()=>{console.log("success")},()=>{console.log("failure")})},dstall:{async handleResult(a){for(;a;)a.value.hasOwnProperty("dstalldocs")&&(console.log("document share store"),b=!0,virtualclass.gObj.dstAll=JSON.parse(a.value.dstalldocs),virtualclass.gObj.dstAllNotes=JSON.parse(a.value.allNotes)),a=await a.continue();b||(console.log("document share store init"),virtualclass.gObj.dstAll="init")}},clearSingleTable(a,b){this.db.transaction(a,"readwrite").store.clear();"undefined"!==typeof b&&
b();"dstdata"==a&&(virtualclass.gObj.docs="init",console.log("==== Docs init "));"dstall"==a&&(virtualclass.gObj.dstall="init")},clearStorageData(){ioAdapter.adapterMustData=[];ioAdapter.serial=-1;ioAdapter.userSerial=[];ioAdapter.userAdapterMustData=[];ioMissingPackets.executedStore=[];ioMissingPackets.executedSerial={};ioMissingPackets.missRequest=[];ioMissingPackets.aheadPackets=[];ioMissingPackets.missRequestFlag=0;ioMissingPackets.executedUserStore=[];ioMissingPackets.executedUserSerial={};ioMissingPackets.missUserRequest=
[];ioMissingPackets.aheadUserPackets=[];ioMissingPackets.missUserRequestFlag=0;for(let a=0;a<this.tables.length;a++)a+1==this.tables.length?this.clearSingleTable(this.tables[a],this.clearLastTable):this.clearSingleTable(this.tables[a])},clearLastTable(){virtualclass.gObj.hasOwnProperty("sessionEndResolve")&&virtualclass.gObj.sessionEndResolve()},async getQuizData(a){const b=[];let c=await this.db.transaction("quizData").store.openCursor();for(;c;)b[c.value.quizkey]=c.value.qzData,c=await c.continue();
a(b)},clearTableData(a){this.db.transaction(a,"readwrite").store.clear()},async getWbData(a){const b=await (await this.db.transaction("wbData","readwrite")).objectStore("wbData").get(a);"undefined"!==typeof b?(console.log(`Whiteboard start store from local storage ${a}`),virtualclass.gObj.tempReplayObjs[a]=[],virtualclass.gObj.tempReplayObjs[a]=JSON.parse(b.repObjs)):virtualclass.gObj.tempReplayObjs[a]="nodata"}}})(window);(function(d,c){d.user=function(a){return{assignRole(a,c,g){roles.hasControls()&&(roles.isEducator()||virtualclass.html.leftAppBar(),virtualclass.attachFunction(),"Whiteboard"==c&&d.virtualclass.wb[virtualclass.gObj.currWb].attachToolFunction(virtualclass.gObj.commandToolsWrapperId[virtualclass.gObj.currWb],!0,virtualclass.gObj.currWb),virtualclass.hasOwnProperty("previrtualclass")?virtualclass.vutil.makeActiveApp(`virtualclass${c}`,virtualclass.previrtualclass):virtualclass.vutil.makeActiveApp(`virtualclass${c}`),
...
"true"));(d=g[f].querySelector(".icon-audioDisImg"))&&d.classList.contains("block")&&(d.parentNode.setAttribute("data-title",virtualclass.lang.getString("audioEnable")),d.setAttribute("data-audio-disable","false"))}f=c.querySelector("#virtualclassCont #memlist.enable");g=c.querySelector("#virtualclassCont #chatrm.enable");d=c.querySelector("#user_list");const b=c.querySelector("#chatroom_bt2");f&&!d.classList.contains("active")&&(d.classList.contains("active")||d.classList.add("active"),b.classList.remove("active"),
virtualclass.chat.chatWindow="private");g&&(b.classList.contains("active")||b.classList.add("active"),d.classList.remove("active"),virtualclass.chat.chatWindow="common");c.getElementsByClassName("ui-memblist-usr");for(f=0;f<a.length;f++)this.makeElemEnable(a[f])}},resetmediaSetting(){if(roles.isStudent()){if(virtualclass.gObj.stdaudioEnable||virtualclass.user.control.audioDisable(),virtualclass.system.mediaDevices.hasWebcam)if(virtualclass.gObj.stdvideoEnable)virtualclass.vutil.videoHandler("off"),
...
null!=b&&(b.style.display=a?"block":"none")},toggleAllAudio(a){const b=chatContainerEvent.elementFromShadowDom(".controleCont","all");if(0<b.length)for(let f=0;f<b.length;f++)if(0<b[f].id.indexOf("Aud")){var c=b[f].id.indexOf("Cont");0<c&&(c=b[f].id.substr(0,c),c=chatContainerEvent.elementFromShadowDom(`${c}Img`,null,!0),this.control.init.call(this,c,a,void 0,"actnotSend"))}},toggleAllVideo(a){ioAdapter.mustSend({action:a,cf:"toggleVideo"})},mediaSliderUI(a){const b="audio"===a?"Audio":"Video";let g=
c.querySelector(`.bulkUserActions #contr${b}AllImg`);var d=virtualclass.user.defaultSettings(a,virtualclass.settings.info);const m=c.querySelector(`.bulkUserActions #contr${b}All input`),n=c.querySelector(`.congrea #contr${b}All`),q="enable"===d?"disable":"enable";null!=d?(g.setAttribute("data-action",q),g.className=`slider round icon-all-${a}-${q} enable congtooltip cgIcon`,g.dataset.title=virtualclass.lang.getString(`${q}All${b}`),m.setAttribute("checked","true"),n.classList.add(q)):(d={action:d?
"enable":"disable",enable:"disable",disable:"enable"},g=c.querySelector(`.bulkUserActions #contr${b}AllImg`),g.setAttribute("data-action",d[d.action]),g.className=`slider round icon-all-${a}-${d[d.action]} congtooltip cgIcon`,g.dataset.title=virtualclass.lang.getString(`${d[d.action]}All${b}`),m.removeAttribute("checked"),n.classList.add(d[d.action]));if(virtualclass.isPlayMode)anchorTag.pointerEvents="none",anchorTag.style.cursor="default";else{const b=this;g.addEventListener("click",()=>{let c;
"audio"===a?(c=b.toogleAudioIcon(),virtualclass.settings.applySettings("enable"===c,"studentaudio"),"undefined"!==typeof c&&(localStorage.setItem("allAudAction",c),b.toggleAllAudio.call(virtualclass.user,c))):(c=b.toggleVideoIcon(),virtualclass.settings.applySettings("enable"===c,"studentvideo"),"undefined"!==typeof c&&(localStorage.setItem("allVideoAction",c),b.toggleAllVideo(c)))})}},defaultSettings(a,c){let b,f;for(const g in c)if(f=c[g],"audio"===a&&"studentaudio"===g||"video"===a&&"studentvideo"===
g)b=!0===f?"enable":"disable";return b},chatBoxesSwitch(){if(virtualclass.chat.chatroombox)toggleCommonChatBox();else if(0==$("div#chat_room").length){var a=c.createElement("ul");a.id="chat_room";c.body.appendChild(a);virtualclass.chat.chatroombox=$("#chat_room").chatroom({id:"chat_room",user:{name:"test"},title:lang.chatroom_header,offset:"20px",messageSent(a,b){$("#chat_room").chatroom("option","boxManager").addMsg(a.name,b)}});virtualclass.gObj.hasOwnProperty("chatEnable")&&!virtualclass.gObj.chatEnable&&
(a=c.getElementById("chatrm"),null!=a&&virtualclass.user.control.makeElemDisable(a));a=c.getElementById("cc_arrow_button");a.classList.add("icon-arrow-down");a.classList.remove("icon-arrow-up")}},toogleAudioIcon(){var a=c.querySelector(".bulkUserActions #contrAudioAllImg");if(null!=a){let b=a.dataset.action;"enable"==a.dataset.action?(a.dataset.action="disable",a.className="slider round icon-all-audio-disable congtooltip",a.dataset.title=virtualclass.lang.getString("muteAll"),a=c.querySelector(".congrea .bulkUserActions #contrAudioAll"),
...
"slider round icon-all-video-disable congtooltip",a.dataset.title=virtualclass.lang.getString("disableAllVideo"),a=c.querySelector(".congrea .bulkUserActions #contrVideoAll"),a.classList.add("disable"),a.classList.remove("enable")):(a.dataset.action="enable",a.className="slider round icon-all-video-enable congtooltip",a.dataset.title=virtualclass.lang.getString("enableAllVideo"),a=c.querySelector(".congrea .bulkUserActions #contrVideoAll"),a.classList.add("enable"),a.classList.remove("disable"));
return b}},changeRoleOnFooter(a,c){chatContainerEvent.elementFromShadowDom(`#ml${a}`).dataset.role=c},initControlHandler(a){virtualclass.vutil.userIsOrginalTeacher(a);const b=chatContainerEvent.elementFromShadowDom(`#ml${a} .contImg`,"all");let g=!1,d=localStorage.getItem(`virtualclass${a}`);null!=d&&(g=!0,d=JSON.parse(d),d.hasOwnProperty("currTeacher")&&(virtualclass.gObj[`${a}currTeacher`]={},1==d.currTeacher?(virtualclass.user.control.currTeacherAlready=!0,virtualclass.gObj[`${a}currTeacher`].ct=
!0):virtualclass.gObj[`${a}currTeacher`].ct=!1));for(let f=0;f<b.length;f++)if(-1<b[f].className.indexOf("chat")){var m=g&&d.hasOwnProperty("chat")?virtualclass.settings.user.hasOwnProperty(a)?virtualclass.settings.parseSettings(virtualclass.settings.user[a]).studentpc:virtualclass.settings.info.studentpc:virtualclass.settings.info.studentpc;virtualclass.user.control.changeAttribute(a,b[f],m,"chat","chat")}else-1<b[f].className.indexOf("aud")?(g&&d.hasOwnProperty("aud")?m=virtualclass.settings.user.hasOwnProperty(a)?
virtualclass.settings.parseSettings(virtualclass.settings.user[a]).studentaudio:virtualclass.settings.info.studentaudio:(m=c.querySelector("#contrAudioAll"),null!=virtualclass.jId&&m.classList.contains("disable"),m=virtualclass.settings.info.studentaudio),virtualclass.user.control.changeAttribute(a,b[f],m,"audio","aud"),roles.hasAdmin()&&"false"==b[f].dataset.audioDisable&&localStorage.getItem("allAudAction")):-1<b[f].className.indexOf("RaiseHand")?(m=g&&d.hasOwnProperty("raiseHand")?!!d.raiseHand:
!1,virtualclass.user.control.changeAttribute(a,b[f],m,"RaiseHand","RaiseHand")):-1<b[f].className.indexOf("stdscreen")?virtualclass.gObj.studentSSstatus.hasOwnProperty("whoIsSharing")&&virtualclass.vutil.initssSharing(virtualclass.gObj.whoIsSharing):-1<b[f].className.indexOf("editorRich")&&"EditorRich"==virtualclass.currApp?(c.querySelector("#alleditorRichContainerAnch"),m=g&&d.hasOwnProperty("editorRich")?!!d.editorRich:!1,virtualclass.user.control.changeAttribute(a,b[f],m,"editorRich","editorRich")):
-1<b[f].className.indexOf("editorCode")&&(m=g&&d.hasOwnProperty("editorCode")?!!d.editorCode:!1,virtualclass.user.control.changeAttribute(a,b[f],m,"editorCode","editorCode"))}}}})(window,document);(function(d){d.xhr={init(){this.httpObj=d.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");this.httpObj.upload.addEventListener("progress",this.onProgress);this.onReadStateChange();this.httpObj.onerror=function(c){console.log(`Error ${c}`)};this.httpObj.withCredentials=!0;this.httpObj.onabort=function(c){console.log(`Error abort ${c}`)}},onProgress(c){virtualclass.pbar.currVal=c.loaded;""!=virtualclass.pbar.prvVal&&"undefined"!==typeof virtualclass.pbar.prvVal||virtualclass.isPlayMode||
...
b.classList.add("lastNote"):b.classList.remove("lastNote")},removeAllContainers(){const a=document.querySelectorAll("#virtualclassWhiteboard .whiteboardContainer .canvasContainer");let b;for(let c=0;c<a.length;c++)b=a[c],b.parentNode.removeChild(b)},clearNavigation(){const a=document.getElementById("dcPaging");if(null!==a){for(;a.firstChild;)a.removeChild(a.firstChild);if(roles.hasControls())virtualclass.wbCommon.indexNav.createWbNavigationNumber(0,0),document.querySelector("#virtualclassWhiteboard").classList.add("lastNote");
...
this.userMsg=function(d){virtualclass.gObj.chat.display(d.message.userMsg)};this.requestPacketBy=function(d){roles.hasControls()&&virtualclass.gObj.chat.sendPackets(d.message.requestPacketBy,d.message.sp)};this.chatPackResponsed=function(d){d.message.byRequest===virtualclass.gObj.uid&&virtualclass.gObj.chat.displayMissedChats(d.message.chatPackResponsed)};this.reclaimRole=function(d){console.log("Role reclaim");roles.hasControls()&&virtualclass.vutil.vcResponseAReclaimRole(d.fromUser.userid,wbUser.id)};
this.rpr=function(d){this.reclaimRole(d);console.log("reclaim role")};this.assignRole=function(d){d.message.toUser===virtualclass.gObj.uid&&(console.log("Role assign"),"object"===typeof virtualclass.wb&&virtualclass.wb[virtualclass.gObj.currWb].utility.removeWhiteboardMessage(),virtualclass.vutil.vcResponseAssignRole(d.fromUser.userid,wbUser.id))};this.clearAll=function(d){"object"!==typeof virtualclass.wb&&virtualclass.makeAppReady(virtualclass.apps.wb);virtualclass.wb[virtualclass.gObj.currWb].response.clearAll(d.fromUser.userid,
wbUser.id,d.message,virtualclass.wb[virtualclass.gObj.currWb].oTeacher)};this.getMsPckt=function(d){virtualclass.wb[virtualclass.gObj.currWb].gObj.chunk=[];d=virtualclass.wb[virtualclass.gObj.currWb].bridge.sendPackets(d,virtualclass.wb[virtualclass.gObj.currWb].gObj.chunk);virtualclass.vutil.beforeSend({repObj:d,chunk:!0,cf:"repObj"})};this.createArrow=function(d){"object"===typeof virtualclass.wb&&(roles.hasControls()||virtualclass.wb[virtualclass.gObj.currWb].response.createArrow(d.message))};
this.repObj=function(d){"object"!==typeof virtualclass.wb&&"DocumentShare"!=virtualclass.currApp&&virtualclass.makeAppReady(virtualclass.apps.wb);"undefined"!==typeof virtualclass.gObj.currWb&&(virtualclass.wb[virtualclass.gObj.currWb].utility.removeWhiteboardMessage(),"t"==d.fromUser.role?virtualclass.wb[virtualclass.gObj.currWb].utility.replayObjsByFilter(d.message.repObj):console.log("whiteboard -------------------------- We just lost a packet"))};this.replayAll=function(d){virtualclass.wb[virtualclass.gObj.currWb].response.replayAll()};
this.dts=function(d){console.log(`Document share :- message received ${d.message.serial}`);console.dir(d.message.dts);if(d.message.dts.hasOwnProperty("init"))virtualclass.gObj.screenRh=100,virtualclass.makeAppReady("DocumentShare",void 0,d.message.dts),virtualclass.gObj.screenRh=60;else if("object"===typeof virtualclass.dts)virtualclass.dts.onmessage(d)};this.poll=function(d){console.log(d.message.poll.pollMsg);"init"==d.message.poll.pollMsg?virtualclass.makeAppReady("Poll"):("object"!==typeof virtualclass.poll&&
(virtualclass.makeAppReady("Poll"),virtualclass.poll.onmessage({pollMsg:d.message.poll.init,cf:"poll",user:"all"})),virtualclass.poll.onmessage(d.message,d.fromUser))};this.quiz=function(d){console.log(d.message.quiz.quizMsg);"init"==d.message.quiz.quizMsg?virtualclass.makeAppReady("Quiz"):("object"!==typeof virtualclass.quiz&&(virtualclass.makeAppReady("Quiz"),virtualclass.quiz.onmessage({quizMsg:d.message.quiz.init,cf:"quiz",user:"all"})),virtualclass.quiz.onmessage(d.message,d.fromUser))};this.videoUl=
function(d){if(d.fromUser.userid!=virtualclass.gObj.uid)virtualclass.videoUl.onmessage(d.message)};this.congController=function(d){if(d.fromUser.userid!=virtualclass.gObj.uid)virtualclass.videoHost.onmessage(d.message);"off"==d.message.congCtr.videoSwitch?(virtualclass.vutil.addClass("virtualclassCont","videoff"),virtualclass.vutil.addClass("virtualclassAppRightPanel","hide"),virtualclass.vutil.removeClass("virtualclassAppRightPanel","show"),virtualclass.videoHost.setUserIcon(d.fromUser.userid)):
...
newJoinUser:d.message.user,cmadd:!0})};this.mvid=function(d){console.log("multivideo, message received");virtualclass.multiVideo.onmessage(d.message,d.fromUser.userid)};this.sc=function(d){console.log("Recevied scroll");virtualclass.pdfRender[virtualclass.gObj.currWb].setScrollPosition(d.message)};this.scf=function(d){console.log("Recevied scroll first");console.dir(d.message);null!=virtualclass.gObj.currWb&&virtualclass.pdfRender[virtualclass.gObj.currWb].setScrollPosition(d.message)};this.cwb=function(d){if(d.message.hasOwnProperty("diswb")){const {wid:c}=
d.message;virtualclass.gObj.currWb=c;virtualclass.wbCommon.whiteboardExist(virtualclass.gObj.currWb)||virtualclass.vutil.createWhiteBoard(virtualclass.gObj.currWb);const a=c.split("_");0<a.length&&(virtualclass.gObj.currSlide=a[a.length-1]);virtualclass.gObj.currIndex=d.message.currIndex;virtualclass.wbCommon.displaySlide(c);localStorage.setItem("currIndex",virtualclass.gObj.currIndex)}else d.message.hasOwnProperty("wbCount")&&(virtualclass.gObj.wbCount=d.message.wbCount,-1==virtualclass.gObj.wIds.indexOf(Number(virtualclass.gObj.wbCount))&&
(virtualclass.gObj.wIds.push(virtualclass.gObj.wbCount),virtualclass.gObj.currIndex=d.message.currIndex,virtualclass.wbCommon.indexNav.studentWBPagination(virtualclass.gObj.currIndex)),localStorage.setItem("currIndex",virtualclass.gObj.currIndex))};this.reqscreen=function(d){"mobTab"==virtualclass.system.device||"Chrome"!=virtualclass.system.mybrowser.name&&"Firefox"!=virtualclass.system.mybrowser.name&&"Edge"!=virtualclass.system.mybrowser.name?virtualclass.vutil.beforeSend({ext:!0,cf:"colorIndicator",
nosupport:!0}):(d=virtualclass.lang.getString("stdscreenshare"),virtualclass.gObj.precheckScrn&&virtualclass.vutil.prechkScrnShare(),virtualclass.popup.confirmInput(d,c=>{c?(roles.isStudent()&&(virtualclass.gObj.studentSSstatus.mesharing=!0),virtualclass.makeAppReady("ScreenShare","byclick")):virtualclass.vutil.beforeSend({sd:!0,cf:"colorIndicator"})}))};this.sshare_user=d=>{virtualclass.vutil.removeSSsharing();virtualclass.gObj.whoIsSharing=d.fromUser.userid;virtualclass.vutil.initssSharing(d.fromUser.userid)};
this.sview=function(d){const c=document.getElementById("virtualclassScreenShareLocal");roles.isStudent()&&!virtualclass.gObj.studentSSstatus.mesharing&&null!=c&&(c.style.display="none");d.message.hasOwnProperty("firstSs")&&(virtualclass.gObj.studentSSstatus.sharing=!0);virtualclass.gObj.studentSSstatus.shareToAll=!1;console.log("Share, self view")};this.sToAll=function(){const d=document.getElementById("virtualclassScreenShareLocal");null!=d&&(d.style.display="block");virtualclass.gObj.studentSSstatus.shareToAll=
!0;virtualclass.gObj.studentSSstatus.sharing=!0;console.log("Share, to all")};this.rmStdScreen=function(d){virtualclass.vutil.initDefaultApp();virtualclass.vutil.beforeSend({unshareScreen:!0,st:"ss",cf:"unshareScreen"});"object"===typeof virtualclass.ss?virtualclass.ss.clearScreenShare():virtualclass.vutil.removeSSsharing()};this.raiseHand=function(d){virtualclass.raiseHand.onMsgRec(d)};this.colorIndicator=function(d){var c=d.message;d=d.fromUser.userid;c.sd?(d=chatContainerEvent.elementFromShadowDom(`#ml${d} .icon-stdscreenImg`),
null!=d&&d.setAttribute("data-dcolor","red")):c.ext&&(c=c.hasOwnProperty("nosupport")?"nosupport":"orange",d=chatContainerEvent.elementFromShadowDom(`#ml${d} .icon-stdscreenImg`),null!=d&&d.setAttribute("data-dcolor",c))};this.stdVideoCtrl=function(d){d.fromUser.userid!=virtualclass.gObj.uid&&virtualclass.videoHost.stdVideoCtrlMsg(d)};this.toggleVideo=function(d){};this.destroyPlayer=function(d){if("Video"==virtualclass.currApp&&virtualclass.hasOwnProperty("videoUl")&&virtualclass.videoUl.videoUrl){virtualclass.videoUl.videoUrl=
"";virtualclass.videoUl.videoId="";(d=document.getElementById("dispVideo_Youtube_api"))&&d.contentWindow&&d.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*");if(d=document.querySelector(".congrea #dispVideo"))d.style.display="none",(d=document.querySelector(".congrea #dispVideo video"))&&d.setAttribute("src","");(d=document.querySelector("#listvideo .playing"))&&d.classList.remove("playing");(d=document.querySelector("#listvideo .removeCtr"))&&d.classList.remove("removeCtr");
"object"===typeof virtualclass.videoUl.player&&delete virtualclass.videoUl.player}};this.sync=function(){};this.recs=function(d){if(!virtualclass.isPlayMode)virtualclass.settings.onMessage(d.message)}};(function(d){function c(){}c.prototype.setBasicData=async function(a){a.earlierWidth=a.innerWidth;a.earlierHeight=a.innerHeight;a.wbUser=wbUser;a.pageEnter=(new Date).getTime();const b=new a.virtualclass;b.config.data={};b.virtualclassIDBOpen=a.virtualclassOpenDB;a.virtualclass=b;b.gObj.displayError=1;b.lang={};b.lang.getString=a.getString;b.lang.message=a.message;b.gObj.mobileVchOffset=vhCheck();b.settings=a.settings;b.ioEventApi=ioEventApi;b.user=new a.user;b.storage=a.storage;b.wbCommon=a.wbCommon;
b.recorder=a.recorder;b.vutil=a.vutil;b.system=a.system;wbUser.virtualclassPlay=+wbUser.virtualclassPlay;wbUser.virtualclassPlay&&(b.gObj.role="s",localStorage.removeItem("teacherId"),wbUser.id=99955551230,b.gObj.uid=wbUser.id);b.popup=new PopUp({showOverlay:!0});b.gObj.fromPageRefresh=!0;b.isMiniFileIncluded("wb.min")&&(b.gObj.displayError=0);2<a.virtualclass.error.length?a.virtualclass.error=[]:(b.gObj.memberlistpending=[],b.gObj.veryFirstJoin=!0,await b.storage.init())};c.prototype.validDateSession=
function(){var a=localStorage.getItem("prvUser");const b=localStorage.getItem("thisismyplaymode");virtualclass.gObj.myConfig=localStorage.getItem("myConfig");virtualclass.isPlayMode||null!==b&&"thisismyplaymode"===b?virtualclass.storage.config.endSession():null!==a?(a=JSON.parse(a),a.id===wbUser.id&&a.room===wbUser.room&&wbUser.role===a.role&&a.settings===virtualclassSetting.settings||virtualclass.storage.config.endSession()):null!==virtualclass.gObj.myConfig&&(a=JSON.parse(virtualclass.gObj.myConfig),
a=a.createdDate,108E5<(new Date).getTime()-a&&virtualclass.storage.config.endSession())};c.prototype.loadData=function(){roles.hasControls()&&localStorage.setItem("uRole",virtualclass.gObj.uRole);null===localStorage.getItem("prvUser")&&virtualclass.setPrvUser();virtualclass.createMainContainer();var a=localStorage.getItem("wIds");null!=a&&(a=JSON.parse(a),virtualclass.gObj.wIds=a,virtualclass.gObj.wbCount=a.length-1);const b=JSON.parse(localStorage.getItem("prevApp"));virtualclass.gObj.prevApp=b;
if(null!=b){virtualclass.previousApp=b;var c=b.name;c=c.charAt(0).toUpperCase()+c.slice(1);if("Yts"==b.name||"DocumentShare"==b.name)if(null==b.metaData)var d=null;else d=b.metaData,d.fromReload=!0;else"Video"==b.name?null==b.metaData||null==b.metaData.init?d=null:(d=b.metaData,d.fromReload=!0):"Whiteboard"==b.name&&(null==a&&(virtualclass.gObj.wbCount=b.wbn),a=localStorage.getItem("currSlide"),null!=a&&(virtualclass.gObj.currSlide=a,console.log("==== current slide ",virtualclass.gObj.currSlide)))}else c=
...
virtualclass.isPrecheck?(virtualclass.makePreCheckAvailable=!1,virtualclass.popup.waitMsg("refresh")):virtualclass.makePreCheckAvailable=!0;virtualclass.config.data.appIs=c;virtualclass.config.data.videoObj=d};c.prototype.appInit=async function(){virtualclass.settings.init();await virtualclass.init(wbUser.role,virtualclass.config.data.appIs,virtualclass.config.data.videoObj);if("Edge"===virtualclass.system.mybrowser.name){const a=document.getElementById("virtualclassCont");null!=a&&a.classList.add("edge")}wbUser.virtualclassPlay||
virtualclass.editorRich.veryInit();virtualclass.gObj.testChatDiv=document.querySelector("#chat_div");virtualclass.gObj.testChatDiv.attachShadow({mode:"open"})};c.prototype.setUpMedia=function(){if(roles.isStudent()){const a=localStorage.getItem("audEnable");null!==a&&"false"===a.ac&&(virtualclass.user.control.mediaWidgetDisable(),virtualclass.gObj.audioEnable=!1)}virtualclass.gObj.hasOwnProperty("audIntDisable")||virtualclass.gObj.hasOwnProperty("vidIntDisable")||setTimeout(()=>{virtualclass.media.init()},
