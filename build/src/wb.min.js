...
await this.clearSingleTable("dataUserAdapterAll");await this.clearSingleTable("executedStoreAll");await this.clearSingleTable("executedUserStoreAll");await this.clearSingleTable("dstdata");await this.clearSingleTable("pollStorage");await this.clearSingleTable("quizData");await this.clearSingleTable("dstall")},clearLastTable(){virtualclass.gObj.hasOwnProperty("sessionEndResolve")&&virtualclass.gObj.sessionEndResolve()},async getQuizData(a){const b=[];let c=await this.db.transaction("quizData").store.openCursor();
