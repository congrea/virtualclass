...
1)};a.prototype.newWbpage=function(a){virtualclass.vutil.navWhiteboard(virtualclass.wbCommon,virtualclass.wbCommon.newPage);virtualclass.wbCommon.hasOwnProperty("setNextWhiteboardTime")&&clearTimeout(virtualclass.wbCommon.setNextWhiteboardTime);"Whiteboard"==virtualclass.currApp&&(virtualclass.wbCommon.setNextWhiteboardTime=setTimeout(()=>{virtualclass.zoom.normalRender()},500))};a.prototype.studentDocNavigation=function(a){if(virtualclass.dts.order){a=virtualclass.dts.order.indexOf(a);var b=c.querySelector("#docShareNav");
-1==a?(b.classList.add("hide"),b.classList.remove("show")):(b.classList.add("show"),b.classList.remove("hide"));if(b=c.getElementById("stdPageNo"))b.innerHTML=a+1;const d=this;setTimeout(()=>{d.setTotalPages(virtualclass.dts.order.length)},100)}};a.prototype.studentWBPagination=function(a){const b=c.getElementById("stdPageNo");if(b){b.innerHTML=parseInt(a)+1;const c=this;setTimeout(()=>{c.setTotalPages(virtualclass.gObj.wbCount+1)},100)}};a.prototype.UI={container(){for(var a=c.getElementById("docShareNav");a.firstChild;)a.removeChild(a.firstChild);
var d=virtualclass.getTemplate("navMain","navigation")({app:virtualclass.currApp,control:roles.hasControls()});a.innerHTML=d;if(roles.hasControls()){a=c.querySelector(".congrea #docShareNav");c.querySelector("#currIndex").addEventListener("click",function(){var a=c.querySelector("#dcPaging");a&&(a.classList.toggle("close"),a.classList.toggle("open"))});if("Whiteboard"==virtualclass.currApp){d=c.createElement("span");d.id="addNewPage";d.className="newPage";a.appendChild(d);var g=c.createElement("span");
d.appendChild(g);g.className="icon-newPage congtooltip";g.setAttribute("data-title",virtualclass.lang.getString("newPage"));g.addEventListener("click",function(){virtualclass.wbCommon.indexNav.newWbpage(this.type)})}var k=c.querySelector("#dcPaging");a.addEventListener("mouseover",function(){k.classList.add("open");k.classList.remove("close")});a.addEventListener("mouseout",function(){k.classList.add("close");k.classList.remove("open")});var m=this;c.querySelector("#leftNavPage").addEventListener("click",
function(){"Whiteboard"==virtualclass.currApp?m.isNodeAvailable(".noteIndex.shw.active","prev")?c.querySelector("#virtualclassWhiteboard .prev").click():m.setArrowStatus("leftNavPage","disable"):(c.getElementById("docsprev").click(),m.setArrowStatus("leftNavPage","disable"))});c.querySelector("#rightNavPage").addEventListener("click",function(){"Whiteboard"==virtualclass.currApp?m.isNodeAvailable(".noteIndex.shw.active","next")?(c.querySelector("#virtualclassWhiteboard .next").click(),virtualclass.gObj.currWb.split("_doc_0")[1]>
this.shownPages&&(c.querySelector(".noteIndex.shw").className="noteIndex hid left")):m.setArrowStatus("rightNavPage","disable"):(c.getElementById("docsnext").click(),m.setArrowStatus("rightNavPage","disable"))})}},setClassPrevNext(){const a=c.querySelector(`#documentScreen #note${virtualclass.dts.docs.currNote}`);if(null!=a)var d=a.previousElementSibling,g=a.nextElementSibling;c.querySelector("#leftNavPage")&&(d?this.setArrowStatus("leftNavPage","enable"):this.setArrowStatus("leftNavPage","disable"));
c.querySelector("#rightNavPage")&&(g?this.setArrowStatus("rightNavPage","enable"):this.setArrowStatus("rightNavPage","disable"))},pageNavHandler(a,d){if("right"==a){if(a=c.querySelector(".noteIndex.hid.right.active")){a.classList.remove("hid");a.classList.remove("right");a.classList.add("shw");var b=c.querySelector(".noteIndex.shw");b&&(b.classList.remove("shw"),b.classList.add("hid","left"))}}else if(a=c.querySelector(".noteIndex.hid.left.active"))a.classList.remove("hid"),a.classList.remove("left"),
a.classList.add("shw"),a=c.querySelectorAll(".noteIndex.shw"),a.length&&(b=a[a.length-1]),b&&(b.classList.remove("shw"),b.classList.add("hid"),b.classList.add("right"))},setArrowStatus(a,d){const b="disable"==d?"enable":"disable";a=c.getElementById(a);"Whiteboard"==virtualclass.currApp?(a.classList.add(d),a.classList.remove(b)):virtualclass.dts.docs.currNote==virtualclass.dts.order[virtualclass.dts.order.length-1]&&this._setArrowStatusDocs(a,d,b)},_setArrowStatusDocs(a,c,d){a.classList.add(c);a.classList.remove(d)},
