...
console.log("====> Error handlling request packet")}}else if(this.startedAppending&&this.isMyTurn(c)&&b)try{this.onBuffer(b),console.log("Actual append buffer ",c),delete this.listStream[c],this.currentExecuted=c}catch(a){this.requestInitializePacket(c),console.log("====> Error handlling request packet")}}playIfReadyOGV(c){!this.ogvPlayerReady&&this.inStreamList(this.firstFile)&&1<Object.keys(this.listStream).length&&1<virtualclass.liveStream.fileList.ol.order.length&&this._playIfReadyOGV(c)}_playIfReadyOGV(c){this.readyOGVInstance();
this.ogvPlayerReady=!0;c=this.inStreamList(this.firstFile);this.ogvPlayer._loadCodec(c,function(b){virtualclass.liveStream.currentExecuted=virtualclass.liveStream.firstFile;virtualclass.liveStream.ogvPlayer._startProcessingVideo(b);console.log("Current executed file input ",virtualclass.liveStream.currentExecuted);delete virtualclass.liveStream.listStream[virtualclass.liveStream.firstFile];virtualclass.liveStream.startedAppending=!0;virtualclass.liveStream.duringPlayFirstPacket();virtualclass.liveStream.ogvPlayerLoadedMedia&&
