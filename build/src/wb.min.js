...
m:d};this.sendUser(d,c);ioStorage.dataUserAdapterMustData({type:"broadcastToAll",user:wbUser.id,m:d},`${c}_${d.userSerial}`)},sendUser(d,c){io.send(d,"broadcastToAll",c)},sendPing(d){io.send(d,"ping")},sendSpeed(d){ioAdapter.sendWithDelayAndDrop(d,null,"realSendSpeed","sendSpeed",1E3)},realSendSpeed(d){io.send(d,"speed")},sendBinary(d){io.sendBinary(d)},setRecording(){if(!virtualclass.isPlayMode&&virtualclass.settings.info.enableRecording&&(roles.hasControls()||virtualclass.settings.info.recallowattendeeAVcontrol)){var d=
...
virtualclass.hasOwnProperty("prevScreen")&&virtualclass.prevScreen.hasOwnProperty("currentStream")&&virtualclass.prevScreen.unShareScreen();virtualclass.previrtualclass=`virtualclass${virtualclass.gObj.defaultApp}`},async init(b,a,c){b=document.getElementById("virtualclassCont");b.classList.add("loading");const {wbUser:f}=d;virtualclass.uInfo={userid:f.id,sid:f.sid,rid:f.path,authuser:f.auth_user,authpass:f.auth_pass,userobj:{userid:f.id,name:f.name,lname:f.lname,img:f.imageurl,role:null!=localStorage.getItem("uRole")?
localStorage.getItem("uRole"):f.role},room:f.room};this.gObj.congCourse=typeof("undefiend"!=d.congCourse)?d.congCourse:0;this.wbConfig={id:`virtualclass${virtualclass.apps.wb}`,classes:"appOptions"};this.ssConfig={id:`virtualclass${virtualclass.apps.ss}`,classes:"appOptions"};this.edConfig={id:`virtualclass${virtualclass.apps.er}`,classes:"appOptions"};this.edCodeConfig={id:`virtualclass${virtualclass.apps.ec}`,classes:"appOptions"};this.ptConfig={id:`virtualclass${virtualclass.apps.sp}`,classes:"appOptions"};
this.plConfig={id:`virtualclass${virtualclass.apps.poll}`,classes:"appOptions"};this.viConfig={id:`virtualclass${virtualclass.apps.vid}`,classes:"appOptions"};this.dtsConfig={id:`virtualclass${virtualclass.apps.ds}`,classes:"appOptions"};this.qzConfig={id:`virtualclass${this.apps.quiz}`,classes:"appOptions"};this.mvConfig={id:`virtualclass${this.apps.mv}`,classes:"appOptions"};this.user=new d.user;this.vutil=d.vutil;this.sharePt=d.sharePt;this.fineUploader=d.fineUploader;this.system=d.system;this.recorder=
d.recorder;this.converter=converter;this.clear="";this.currApp=this.vutil.capitalizeFirstLetter(a);this.storage=d.storage;this.dashBoard=dashBoard;this.multiVideo=d.MultiVideo;this.vutil.isChromeExtension();this.wbCommon=d.wbCommon;this.pageNavigation=d.pageIndexNav;this.modal=d.modal;this.zoom=d.zoomWhiteboard();virtualclass.pageIndexNav=d.pageIndexNav;this.system.isIndexedDbSupport()?await this.storage.init():console.log("Indexeddb does not support");"Quiz"!=this.currApp&&null!=virtualclass.gObj.CDTimer&&
clearInterval(null!=virtualclass.gObj.CDTimer);virtualclass.modernizr=Modernizr;this.system.webpInit();this.dirtyCorner=d.dirtyCorner;this.html.init(this);this.adapter=d.adapter;virtualclass.system.mybrowser.hasOwnProperty("name")||this.system.setBrowserDetails();virtualclass.api=api;virtualclass.vutil.initOnBeforeUnload(virtualclass.system.mybrowser.name);virtualclass.xhr=d.xhr;virtualclass.xhr.init();virtualclass.xhrn=d.xhrn;virtualclass.xhrn.init();virtualclass.vutil.getCookie("readyToCommunicate")&&
(virtualclass.gObj.readyToCommunicate=!0);this.xhrn.getAcess(b=>{if("ERROR"!=b||"Error"!=b)virtualclass.gObj.readyToCommunicate=!0,console.log("get access"),virtualclass.vutil.isPlayMode()&&virtualclass.recorder.requestListOfFiles()});virtualclass.chat=new Chat;virtualclass.chat.init();virtualclass.dtCon=virtualclass.converter();virtualclass.pbar=progressBar;virtualclass.editorRich=d.editor("editorRich","virtualclassEditorRich","virtualclassEditorRichBody");virtualclass.editorCode=d.editor("editorCode",
"virtualclassEditorCode","virtualclassEditorCodeBody");virtualclass.poll=d.poll();virtualclass.quiz=d.quiz();virtualclass.videoUl=d.videoUl();virtualclass.videoHost=d.videoHost;virtualclass.precheck=preCheck;virtualclass.page=page;if(virtualclass.vutil.isSessionEnded())return!0;console.log("==== session clear zoom object ready ");virtualclass.network=new Network;virtualclass.gesture=gesture;this.serverData=serverData;roles.hasControls()&&this.serverData.fetchAllData();null!=localStorage.uRole&&(virtualclass.gObj.uRole=
localStorage.uRole,b.classList.add(virtualclass.vutil.getClassName(virtualclass.gObj.uRole)));"undefined"===typeof c||null==c?this.makeAppReady(a,"byclick"):this.makeAppReady(a,"byclick",c);this.system.check();this.vutil.isSystemCompatible();this.system.mediaDevices.getMediaDeviceInfo();this.pageVisible=virtualclass.vutil.pageVisible();a==virtualclass.apps.ss&&this.system.setAppDimension();virtualclass.vutil.createReclaimButtonIfNeed();virtualclass.user.assignRole(virtualclass.gObj.uRole,a);this.media=
new d.media;a=localStorage.getItem("precheck");null!=a&&(a=JSON.parse(a));virtualclass.makePreCheckAvailable?virtualclass.precheck.init():(virtualclass.makeReadySocket(),virtualclass.isPlayMode||virtualclass.gesture.initClassJoin());b.classList.remove("loading");virtualclass.gObj.precheckScrn=!1;virtualclass.gObj.meetingMode||virtualclass.videoHost.init(320,240);virtualclass.vutil.videoController();a=document.getElementById("precheckSetting");a.addEventListener("click",()=>{virtualclass.gObj.precheckScrn=
!0;virtualclass.precheck.init(virtualclass.precheck)});this.raiseHand=d.raiseHand;this.raiseHand.init();this.appSetting=d.appSetting;this.appSetting.init();virtualclass.colorSelector=d.colorSelector;virtualclassSetting.theme.selectedColor&&this.colorSelector.makeThemeReady();a=document.getElementById("virtualclassCont");null!=a&&a.classList.add(virtualclass.system.mybrowser.name);a=document.getElementById("fullScreenButton");null!=a&&a.addEventListener("click",virtualclass.vutil.Fullscreen);a=document.getElementById("fullScreenExitButton");
null!=a&&a.addEventListener("click",virtualclass.vutil.closeFullscreen);document.onfullscreenchange=function(b){virtualclass.gObj.fullScreenMode?(document.querySelector("#fullScreenButton").style.display="block",document.querySelector("#fullScreenExitButton").style.display="none",virtualclass.gObj.fullScreenMode=!1):(document.querySelector("#fullScreenButton").style.display="none",document.querySelector("#fullScreenExitButton").style.display="block",virtualclass.gObj.fullScreenMode=!0)}},makeReadySocket(){if(!virtualclass.vutil.isPlayMode()){const a=
this;var b=setInterval(()=>{2<=a.gObj.editorInitDone&&(a.initSocketConn(),clearInterval(b))},100)}},initSocketConn(){this.system.webSocket&&(io.init(virtualclass.uInfo),d.userdata=virtualclass.uInfo)},html:{id:"virtualclassCont",optionsClass:"appOptions",init(b){this.virtualclass=b},leftAppBar(){if(!(0<document.getElementsByClassName("appOptions").length)){document.querySelector("#virtualclassApp #virtualclassAppLeftPanel");var b=virtualclass.getTemplate("appTools")();virtualclass.vutil.insertAppLayout(b);
virtualclass.gObj.hasOwnProperty("errNotScreenShare")&&virtualclass.view.disableSSUI();virtualclass.gObj.hasOwnProperty("errAppBar")&&virtualclass.view.disableLeftAppBar()}},createDiv(b,a,c,k,d){const f=document.createElement("a");f.href="#";const g=document.createElement("div");g.id=b;"undefined "!==typeof k&&(g.className=k);k=document.createElement("span");k.className=`icon-${a}`;f.appendChild(k);f.dataset.title=virtualclass.lang.getString(a);f.className="tooltip";"virtualclassWhiteboardTool"==
b&&(f.dataset.doc=`${"_doc_0_"}${virtualclass.gObj.wbCount}`);g.appendChild(f);"undefined"!==typeof d?(d=document.getElementById("virtualclassScreenShareTool"),c.replaceChild(g,d)):c.appendChild(g)},createElement(b,a,c){b=document.createElement(b);"undefined"!==typeof a&&(b.id=a);if("undefined"!==typeof c&&1<c.length)for(a=0;a<c.length;a++)b.className+=`${c[a]} `;return b}},dispvirtualclassLayout(b){if("undefined"!==typeof this.previous)if(this.previous.toUpperCase()!=`virtualclass${this.currApp}`.toUpperCase()){var a=
document.getElementById(virtualclass.previous);null!=a&&(a.style.display="none");"undefined"!==typeof b?("EDITORRICH"==b.toUpperCase()?(a=document.getElementById("virtualclassEditorCode"),null!=a&&(a.style.display="none")):console.log(`EditorRich can not be display:none ${b}`),"EDITORCODE"==b.toUpperCase()?(a=document.getElementById("virtualclassEditorRich"),null!=a&&(a.style.display="none")):console.log(`EditorCode can not be display:none ${b}`)):console.log(`appId ${b} undefined`)}else{a=document.getElementById("virtualclassCont").getElementsByClassName("virtualclass");
for(let b=0;b<a.length;b++)a[b].style.display="none"}"undefined"!==typeof b&&(b=`virtualclass${b.charAt(0).toUpperCase()+b.slice(1)}`);a=document.getElementById(b);null!=a&&(a.style.display="block",console.log(`App ${b} block`))},async makeAppReady(b,a,c){virtualclass.dashBoard.close();console.log(`Application is ready${b}`);this.view=d.view;var f=virtualclass.vutil.capitalizeFirstLetter(b);"ScreenShare"!=f&&(this.currApp=f);"DocumentShare"!=b&&(virtualclass.gObj.docPdfFirstTime=!1);console.log(`Current App init ${this.currApp}`);
roles.hasControls()&&virtualclass.hasOwnProperty("previrtualclass")&&(b!=virtualclass.apps.ss||virtualclass.gObj.studentSSstatus.mesharing&&"ScreenShare"==virtualclass.apps.ss)&&virtualclass.vutil.makeActiveApp(`virtualclass${b}`,virtualclass.previrtualclass);"undefined"===typeof this.previous||"virtualclassEditorRich"!=this.previous&&"virtualclassEditorCode"!=this.previous||(f=this.previous.split("virtualclass")[1],this.user.control.toggleDisplayEditorController(f,"none"));if(b!=virtualclass.apps.ss){this.dispvirtualclassLayout(b);
f=document.getElementById("virtualclassCont");virtualclass.vutil.setCurrApp(f,this.currApp);var g=document.querySelector("#virtualclassApp");null!=g&&("DocumentShare"==this.currApp||"SharePresentation"==this.currApp||"Video"==this.currApp?virtualclass.vutil.setCurrApp(g,f.dataset.currapp):g.dataset.currapp="")}"undefined"!==typeof this.prevScreen&&this.prevScreen.hasOwnProperty("currentStream")&&this.prevScreen.unShareScreen();if("SharePresentation"==b)`virtualclass${b}`!=virtualclass.previous&&this.appInitiator[b].apply(virtualclass,
Array.prototype.slice.call(arguments));else if("DocumentShare"==b)this.appInitiator[b].apply(virtualclass,Array.prototype.slice.call(arguments)),roles.hasControls()&&(virtualclass.dts.firstRequest?virtualclass.vutil.triggerDashboard(b,"hidepopup"):virtualclass.vutil.triggerDashboard(b));else if(f=localStorage.getItem("prevApp"),null!=f&&(g=JSON.parse(f),"SharePresentation"==g.name&&(g.name="",localStorage.setItem("prevApp",JSON.stringify(g)))),"Whiteboard"===b){var n=[];for(g=0;g<arguments.length;g++)n.push(arguments[g]);
"undefined"===typeof a&&(n[1]=a);n[2]="undefined"!==typeof c?`_doc_${c}`:`_doc_0_${virtualclass.gObj.currSlide}`;n.push("virtualclassWhiteboard");this.appInitiator[b].apply(virtualclass,Array.prototype.slice.call(n));f=JSON.parse(f);virtualclass.gObj.wbRearrang||null==f||null==localStorage.getItem("currSlide")||(n=localStorage.getItem("wIds"),null!==n&&(n=JSON.parse(n),0<n.length&&(virtualclass.wbCommon.readyElements(n),virtualclass.gObj.hasOwnProperty("currSlide")&&-1===n.indexOf(+virtualclass.gObj.currSlide)&&
(console.log("wids, From virtualclass "),n.push(virtualclass.gObj.currSlide)),virtualclass.gObj.wbRearrang=!0,virtualclass.gObj.wIds=n)));virtualclass.wbCommon.initNav(virtualclass.gObj.wIds);virtualclass.gObj.wbRearrang&&roles.hasControls()&&(virtualclass.wbCommon.rearrange(virtualclass.wbCommon.order),virtualclass.wbCommon.indexNav.addActiveNavigation(virtualclass.gObj.currWb));virtualclass.wbCommon.identifyFirstNote(virtualclass.gObj.currWb);virtualclass.wbCommon.identifyLastNote(virtualclass.gObj.currWb)}else f=
Array.prototype.slice.call(arguments)[2],this.appInitiator[b].apply(virtualclass,Array.prototype.slice.call(arguments)),f&&f.init&&f.init.videoUrl&&f.fromReload&&(n=!0),roles.hasControls()&&"Video"==b&&(`virtualclass${b}`!=virtualclass.previous&&(f=document.querySelector("#dashboardnav button"),null!=f&&(f.setAttribute("data-currapp","Video"),f.classList.contains("clicked")&&f.classList.remove("clicked"))),virtualclass.vutil.triggerDashboard(b,n));this.previrtualclass=this.previous;b!=virtualclass.apps.wb&&
b!=virtualclass.apps.ss&&virtualclass.system.setAppDimension();if("Video"!=b&&virtualclass.hasOwnProperty("videoUl")){virtualclass.videoUl.videoId="";(n=document.getElementById("dispVideo_Youtube_api"))&&n.contentWindow&&n.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*");if(n=document.querySelector(".congrea #dispVideo"))n.style.display="none",(n=document.querySelector(".congrea #dispVideo video"))&&n.setAttribute("src","");(n=document.querySelector("#listvideo .playing"))&&
...
(f=Array.prototype.slice.call(arguments)[2],"ScreenShare"==b||"SharePresentation"!=virtualclass.currApp&&"Video"!=virtualclass.currApp?"DocumentShare"!=virtualclass.currApp&&"SharePresentation"!=virtualclass.currApp&&virtualclass.vutil.removeDashboardNav():(virtualclass.vutil.initDashboardNav(f),"Video"==virtualclass.currApp?console.log(`currApp ${virtualclass.currApp}`):virtualclass.sharePt.localStoragFlag||(f=document.querySelector("#dashboardnav button"),null!=f&&f.click())),"SharePresentation"!=
virtualclass.currApp&&(n=document.querySelector("#listppt .playing"))&&n.classList.remove("playing"))},appInitiator:{async Whiteboard(b,a,c,k){"object"===typeof this.ss&&(this.ss.prevStream=!1);"undefined"!==typeof this.previous&&"undefined"!==typeof a&&"byclick"==a&&roles.hasControls()&&"Whiteboard"==virtualclass.currApp&&(a=c.split("_doc_")[1],virtualclass.vutil.beforeSend({dispWhiteboard:!0,cf:"dispWhiteboard",d:a}));virtualclass.gObj.currWb=c;"object"!==typeof this.pdfRender[c]?this.pdfRender[c]=
...
c),null!=this.gObj.tempQueue[c]&&(this.wb[c].gObj.queue=this.gObj.tempQueue[c].slice(),this.gObj.tempQueue[c]=null),"Whiteboard"==virtualclass.currApp?(a=document.querySelector("#virtualclassWhiteboard .whiteboardContainer"),virtualclass.gObj.wbInitHandle||(virtualclass.wbCommon.initNavHandler(),virtualclass.gObj.wbInitHandle=!0)):a=document.getElementById(`cont${c}`),null!=a){if(null==document.querySelector(`vcanvas${c}`)){k=virtualclass.getTemplate("main","whiteboard");if("Whiteboard"==virtualclass.currApp){virtualclass.wbCommon.hideElement();
const b=`note${c}`;var f=document.querySelector(`#${b}`);null!=f?(f.classList.add("canvasContainer","current"),k=k({cn:c,hasControl:roles.hasControls()}),f.innerHTML=k):(k=`<div id='${b}' data-wb-id='${c}' class='canvasContainer current'>${k({cn:c,hasControl:roles.hasControls()})}</div>`,"_doc_0_0"!=c?a.insertAdjacentHTML("beforeend",k):(a.innerHTML=k,f=document.querySelector("#note_doc_0_0"),null!=f&&f.classList.add("current")))}else k=k({cn:c,hasControl:roles.hasControls()}),a.innerHTML=k;f=document.querySelector(`#canvas${c}`)}this.wb[c].utility=
new d.utility;this.wb[c].alreadyReplay=!1;this.wb[c].packContainer=new d.packContainer;this.wb[c].draw_object=d.draw_object;this.wb[c].makeobj=d.makeobj;this.wb[c].readyFreeHandObj=d.readyFreeHandObj;this.wb[c]._replay=_replay;this.wb[c].readyTextObj=d.readyTextObj;this.wb[c].bridge=d.bridge;this.wb[c].response=d.response;virtualclass.wb[c].utility.displayCanvas(c);({vcan:a}=virtualclass.wb[c]);roles.hasControls()&&(virtualclass.wb[c].utility.setOrginalTeacherContent(b),virtualclass.wb[c].attachToolFunction(virtualclass.gObj.commandToolsWrapperId[c],
!0,c),b=a.utility.canvasCalcOffset(a.main.canid),console.log(`whietboard offset x=${b.x} `+` y=${b.y}`));"DocumentShare"==virtualclass.currApp?({currNote:b}=virtualclass.dts.docs.note,virtualclass.pdfRender[c].init(f,b)):virtualclass.pdfRender[c].init(f);await virtualclass.storage.getWbData(c)}else alert("whiteboard container is null");else b=`commandToolsWrapper${c}`,null==document.getElementById(`commandToolsWrapper${c}`)&&roles.hasControls()&&virtualclass.wb[c].attachToolFunction(b,!0,c);({vcan:a}=
virtualclass.wb[c]);null!=document.getElementById(`canvas${c}`)&&(a.utility.canvasCalcOffset(a.main.canid),0!==this.gObj.tempReplayObjs[c].length&&"nodata"!==this.gObj.tempReplayObjs[c]||virtualclass.wb[c].utility.makeCanvasEnable());console.log(`==== previous set ${this.wbConfig.id}`);this.previous=this.wbConfig.id}else alert("id is undefined");console.log("==== SESSION CLEAR");virtualclass.zoom.init();b=localStorage.getItem("activeTool");null!=b&&(f=document.querySelector(`#${b}`),null!=f&&(f.classList.add("active"),
virtualclass.wb[c].prvTool=b));roles.hasControls()&&d.addEventListener("mouseup",b=>{var a=document.querySelector("#virtualclassCont").dataset.currapp;if(null!=a&&("Whiteboard"==a||"DocumentShare"==a))if(b.target.dataset.hasOwnProperty("stroke")||b.target.dataset.hasOwnProperty("font"))b=b.target.dataset.hasOwnProperty("stroke")?document.querySelector(`#t_strk${virtualclass.gObj.currWb} .strkSizeList`):document.querySelector(`#t_font${virtualclass.gObj.currWb} .fontSizeList`),virtualclass.wb[virtualclass.gObj.currWb].closeElem(b);
...
b)},SharePresentation(b,a){"object"===typeof this.ss&&(this.ss.prevStream=!1);this.sharePt=new d.sharePt;console.log(virtualclass.sharePt.pptUrl);this.sharePt.init(b,a);console.log(virtualclass.sharePt.pptUrl);this.previous=virtualclass.ptConfig.id;virtualclass.sharePt.attachMessageEvent("message",virtualclass.sharePt.pptMessageEventHandler)},Poll(b){virtualclass.poll.init()},Quiz(b){virtualclass.quiz.init()},Video(b,a,c){"undefined"!==typeof c&&null!=c?"undefined"===typeof c.type?virtualclass.videoUl.init(c,
c.startFrom):virtualclass.videoUl.init():virtualclass.videoUl.init()},editor(b){this.user.control.toggleDisplayEditorController(b.substring(b.indexOf("virtualclass"),b.length),"block");var a=[];b==virtualclass.apps.er?(virtualclass.editorRich.init(0,a,"",""),this.previous=virtualclass.edConfig.id):(virtualclass.editorCode.init(0,a,"",""),this.previous=virtualclass.edCodeConfig.id);a=JSON.parse(localStorage.getItem(virtualclass.vutil.smallizeFirstLetter(b)));const c=virtualclass.vutil.smallizeFirstLetter(b);
roles.hasAdmin()||(null==a?(this[c].cm.setOption("readOnly","nocursor"),this.user.control.toggleDisplayWriteModeMsgBox(b,!1),console.log(`message box is created ${b}`)):(this.user.control.toggleDisplayWriteModeMsgBox(b,a),a?this[c].cm.setOption("readOnly",!1):this[c].cm.setOption("readOnly","nocursor")),virtualclass.vutil.setReadModeWhenTeacherIsDisConn(c))},makeReadyDsShare(b,a,c){virtualclass.dts.docs.hasOwnProperty("currDoc")?(roles.hasControls()&&(ioAdapter.mustSend({dts:{init:"studentlayout"},
cf:"dts"}),console.log("doc share current"),virtualclass.dts.sendCurrentDoc(),virtualclass.dts.sendCurrentSlide()),b=virtualclass.dts.docs.currNote,"undefined"!==typeof b&&virtualclass.vutil.updateCurrentDoc(b)):"undefined"!==typeof c?setTimeout(()=>{virtualclass.dts.init(c)},1E3):virtualclass.dts.init();virtualclass.previous=virtualclass.dtsConfig.id;console.log(`==== previous ${virtualclass.previous}`)},DocumentShare(b,a,c){virtualclass.hasOwnProperty("dts")&&null!=virtualclass.dts?(virtualclass.dts.firstRequest=
!1,virtualclass.dts.indexNav.init()):virtualclass.dts=d.documentShare();const f=[];"undefined"!==typeof b&&f.push(b);"undefined"!==typeof a&&f.push(a);"undefined"!==typeof c&&f.push(c);"undefined"===typeof virtualclass.dts.indexNav&&(virtualclass.dts.indexNav=new virtualclass.pageIndexNav("documentShare"));virtualclass.gObj.hasOwnProperty("docs")&&(virtualclass.appInitiator.makeReadyDsShare.apply(virtualclass.appInitiator,f),virtualclass.vutil.initDashboardNav(),virtualclass.dts.firstRequest||virtualclass.dts.noteExist()?
(console.log("===== DOCUMENT EXIST"),virtualclass.zoom.adjustScreenOnDifferentPdfWidth()):(b=document.querySelector("#dashboardnav button"),null!=b&&b.click()),null!=virtualclass.gObj.currWb&&"undefined"!==typeof virtualclass.pdfRender[virtualclass.gObj.currWb]&&"DocumentShare"==virtualclass.currApp&&virtualclass.pdfRender[virtualclass.gObj.currWb].hasOwnProperty("page")&&null!=virtualclass.pdfRender[virtualclass.gObj.currWb].page&&virtualclass.dts.order&&("undefined"===typeof virtualclass.dts.indexNav&&
(virtualclass.dts.indexNav=new virtualclass.pageIndexNav("documentShare")),roles.hasControls()?virtualclass.dts.indexNav.createIndex():virtualclass.dts.indexNav.studentDocNavigation(virtualclass.dts.docs.currNote)));(b=document.querySelector("#virtualclassAppLeftPanel .zoomControler .reloadNote span"))&&b.setAttribute("data-title",virtualclass.lang.getString("reloadDoc"))},MultiVideo(){const b=this;b.multiVideo.hasOwnProperty("initDone")?b.multiVideo._init():setTimeout(()=>{b.appInitiator.MultiVideo.apply(virtualclass)},
2E3);this.previous=virtualclass.mvConfig.id}},attachFunction(){const b=document.getElementsByClassName("appOptions");for(let c=0;c<b.length;c++){const f=b[c].getElementsByTagName("a")[0];if("virtualclassEditorCodeTool"!=b[c].id){var a=this;f.onclick=function(){a.initlizer(this)}}}},initlizer(b){b=b.parentNode.id.split("virtualclass")[1];"SessionEndTool"==b?virtualclass.popup.confirmInput(virtualclass.lang.getString("startnewsession"),b=>{b?(virtualclass.gObj.endSession=!0,virtualclass.gObj.hasOwnProperty("beTeacher")&&
roles.isTeacher()&&localStorage.setItem("uRole","t"),localStorage.clear(),(new Promise((b,a)=>{virtualclass.gObj.sessionEndResolve=b;virtualclass.clearSession()})).then(()=>{delete virtualclass.gObj.sessionEndResolve},b=>{console.log(`ERRROR ${b}`)})):console.log("Not start new session")}):(b=b.substring(0,b.indexOf("Tool")),this.PrvAndCurrIsWss(this.previous,b)?alert(virtualclass.lang.getString("screensharealready")):("DocumentShare"==virtualclass.currApp&&(virtualclass.gObj.screenRh=160),this.makeAppReady(b,
"byclick"),setTimeout(()=>{virtualclass.gObj.screenRh=60},1500)));"ScreenShare"!=b&&virtualclass.vutil.removeClass("audioWidget","fixed")},PrvAndCurrIsWss(b,a){return!("virtualclassWholeScreenShare"!=b||a!=virtualclass.apps.yt)},handleCurrentUserWithPrevious(){let b=localStorage.getItem("prvUser");if(null==b)virtualclass.setPrvUser();else if(b=JSON.parse(b),b.id!=wbUser.id||b.room!=wbUser.room||wbUser.role!=b.role||b.recording!=virtualclassSetting.settings.enableRecording)virtualclass.gObj.sessionClear=
!0,virtualclass.setPrvUser(),roles.hasControls()&&localStorage.setItem("uRole",this.gObj.uRole)},setPrvUser(){localStorage.clear();const b={id:wbUser.id,room:wbUser.room,role:wbUser.role,recording:virtualclassSetting.settings.enableRecording};console.log("previosu user");localStorage.setItem("prvUser",JSON.stringify(b))},registerPartial(){const b={whiteboardPath},a="precheck teacherVideo audioWidget appTools popupCont appToolsMeeting appSettingDetail joinclass".split(" "),c={hasControl:roles.hasControls()};
let k;for(let f=0;f<a.length;f++){k=null;if("precheck"==a[f]||"popupCont"==a[f])k=b;else if("audioWidget"==a[f])k=virtualclassSetting,k.isControl=roles.hasControls(),k.isMettingMode=virtualclass.gObj.meetingMode&&roles.isStudent();else if("teacherVideo"==a[f]||"appTools"==a[f]||"appSettingDetail"==a[f])k=c;this.makeReadyTemplate(a[f],k)}Handlebars.registerPartial({docNotesMain:this.getTemplate("notesMain","documentSharing"),whiteboardToolbar:this.getTemplate("toolbar","whiteboard"),rightBar:this.getTemplate("rightBar"),
recordingControl:this.getTemplate("recordingControl"),leftBar:this.getTemplate("leftBar"),main:this.getTemplate("main"),whiteboard:this.getTemplate("main","whiteboard"),dashboardCont:this.getTemplate("dashboardCont"),multiVideo:this.getTemplate("multiVideo")})},registerHelper(){Handlebars.registerHelper("getString",b=>virtualclass.lang.getString(b));Handlebars.registerHelper("debug",function(b){console.log("Current Context");console.log("====================");console.log(this);b&&(console.log("Value"),
console.log("===================="),console.log(b))});Handlebars.registerHelper("getVideoType",b=>virtualclass.gObj.meetingMode?"multiVideo":"teacherVideo")},createMainContainer(){const b=document.querySelector(`#${virtualclass.html.id}`);this.registerHelper();this.registerPartial();var a=this.getTemplate("main");const c={isPlay:virtualclass.isPlayMode,hasControls:roles.hasControls(),meetingMode:virtualclass.gObj.meetingMode};a=a(c);b.insertAdjacentHTML("afterbegin",a)},makeReadyTemplate(b,a){Handlebars.registerPartial(b,
(0,JST[`${virtualclass.gObj.tempPrefix}/${b}.hbs`])(a))},getTemplate(b,a){return"undefined"===typeof a?JST[`${virtualclass.gObj.tempPrefix}/${b}.hbs`]:JST[`${virtualclass.gObj.tempPrefix}/${a}/${b}.hbs`]}}}})(window);(function(d,c){d.Vcan=function(){var a={create(b){if("#"==b.charAt(0)){const c=b.substring(1,b.length);a.utility.canvasCalcOffset(c);return new a.main(b)}console.log("there is a problem with canvas id");console.log("there is a problem with canvas id")},main:function(b){a.main.children=[];a.main.id=0;a.main.uid=0;a.main.canvas=c.querySelector(b);a.main.canid=b.substring(1,b.length);a.main.currentTransform="";a.main.replayObjs=[];a.main.dragMode=!1;a.main.scaleMode=!1;a.main.usrCurrAction="";a.main.currObj=
...
a=>a.id==b.id&&(a.mt==b.mt||1==b.multiuser));0<=g&&a.main.children.splice(g,1);({height:g}=c);const {width:k}=c;c=c.getContext("2d");c.beginPath();c.clearRect(0,0,k,g);c.closePath();a.renderAll()},render:function(b,c,g,k){b.beginPath();b.save();b.lineWidth=void 0!==b.lineWidth?c.lineWidth:2;g||a.transform(b,c,k);b.strokeStyle=void 0!=c.borderColor?c.borderColor:"#000000";"rectangle"==c.type?a.objRect.draw(b,c,g):"line"==c.type?a.objLine.draw(b,c,g):"oval"==c.type?a.objOval.draw(b,c,g):"triangle"==
...
a}),this.transceivers.forEach((a,f)=>{b._gather(a.mid,f)});else if("answer"===a.type){f=p.splitSections(b.remoteDescription.sdp);g=f.shift();const a=0<p.matchPrefix(g,"a=ice-lite").length;f.forEach((f,d)=>{const k=b.transceivers[d],{iceGatherer:n}=k,{iceTransport:q}=k,{dtlsTransport:C}=k,{localCapabilities:u}=k,{remoteCapabilities:v}=k;if(!(p.isRejected(f)&&0===p.matchPrefix(f,"a=bundle-only").length||k.isDatachannel)){const r=p.getIceParameters(f,g);f=p.getDtlsParameters(f,g);a&&(f.role="server");
b.usingBundle&&0!==d||(b._gather(k.mid,d),"new"===q.state&&q.start(n,r,a?"controlling":"controlled"),"new"===C.state&&C.start(f));d=m(u,v);b._transceive(k,0<d.codecs.length,!1)}})}this.localDescription={type:a.type,sdp:a.sdp};switch(a.type){case "offer":this._updateSignalingState("have-local-offer");break;case "answer":this._updateSignalingState("stable");break;default:throw new TypeError(`unsupported type "${a.type}"`);}return Promise.resolve()};f.prototype.setRemoteDescription=function(f){const g=
...
0<Object.keys(virtualclass.dts.pages).length&&(c.metaData.docs=virtualclass.dts.pages)):"Quiz"===virtualclass.currApp?(virtualclass.quiz.saveInLocalStorage(),console.log("quiz data saved")):"Whiteboard"===virtualclass.currApp&&(c={name:"Whiteboard",wbn:virtualclass.gObj.wbCount});0<virtualclass.gObj.wIds.length&&localStorage.setItem("wIds",JSON.stringify(virtualclass.gObj.wIds));roles.hasControls()&&localStorage.setItem("wbOrder",JSON.stringify(virtualclass.wbCommon.order));null!=virtualclass.zoom.canvasScale&&
(a=+virtualclass.zoom.canvasScale,console.log(`Canvas pdf scale ${a}`),virtualclass.vutil.isNumeric(a),virtualclass.zoom.hasOwnProperty("canvasDimension")&&localStorage.setItem("canvasDimension",JSON.stringify(virtualclass.zoom.canvasDimension)));roles.hasView()&&"Yts"==virtualclass.currApp&&(c={name:"Yts",metaData:null});virtualclass.hasOwnProperty("dts")&&null!=virtualclass.dts&&virtualclass.dts.upateInStorage();localStorage.setItem("currSlide",virtualclass.gObj.currSlide);localStorage.setItem("currIndex",
virtualclass.gObj.currIndex);roles.hasControls()||(a=document.querySelector("#virtualclassCont.congrea #congHr.disable"))&&a.click();console.dir(`Previous object ${c}`);localStorage.setItem("prevApp",JSON.stringify(c));roles.hasControls()?localStorage.setItem("videoSwitch",virtualclass.videoHost.gObj.videoSwitch):(localStorage.setItem("stdVideoSwitch",virtualclass.videoHost.gObj.stdStopSmallVid),localStorage.setItem("allStdVideoOff",virtualclass.videoHost.gObj.allStdVideoOff));localStorage.setItem("chatWindow",
virtualclass.chat.chatWindow);this.saveWbOrder();virtualclass.isPlayMode&&localStorage.clear();"DocumentShare"!=virtualclass.currApp&&io.disconnect()}},initOnBeforeUnload(c){"iOS"==c?document.body.onunload=function(){virtualclass.vutil.beforeLoad()}:d.onbeforeunload=function(){const a=virtualclass.vutil.smallizeFirstLetter(virtualclass.currApp);virtualclass.vutil.beforeLoad();if(("editorRich"==a||"editorCode"==a)&&"Synchronized"!=virtualclass[a].cmClient.state.constructor.name)return virtualclass.lang.getString("editorinsync")}},
...
c.slice(1)},initDefaultInfo(c,a){"t"==c&&"Whiteboard"==a?roles.hasAdmin()||(virtualclass.wb[virtualclass.gObj.currWb].utility.setOrginalTeacherContent(),virtualclass.wb[virtualclass.gObj.currWb].attachToolFunction(commandToolsWrapper+virtualclass.gObj.currWb,!0)):"s"==c&&(virtualclass.gObj.studentId=wbUser.id,roles.hasControls()||(a=localStorage.getItem("uRole"),null!=a&&"e"==a&&(c="e"),localStorage.setItem("uRole",c)),virtualclass.vutil.removeSessionTool());virtualclass.gObj.hasOwnProperty("audIntDisable")||
virtualclass.gObj.hasOwnProperty("vidIntDisable")||setTimeout(()=>{virtualclass.media.init();virtualclass.media.isInitiator=!0},500);virtualclass.gObj.oneExecuted=!1},removeClassFromElement(c,a){if("t_reclaim"!=c){c=document.getElementById(c);if(0<c.classList.length)return c.classList.remove(a),c.className;console.log(`Whiteboard Tool class:- could not remove ${a}`)}},beforeSend(c,a,b){const f=virtualclass.gObj.currWb;if(c.hasOwnProperty("createArrow"))c=JSON.stringify(c),virtualclass.wb[f].vcan.optimize.sendPacketWithOptimization(c,
300);else{if(c.hasOwnProperty("repObj")){if("undefined"===typeof c.repObj[c.repObj.length-1])return;virtualclass.wb[f].gObj.rcvdPackId=c.repObj[c.repObj.length-1].uid;virtualclass.wb[f].gObj.displayedObjId=virtualclass.wb[f].gObj.rcvdPackId}JSON.stringify(c);"undefined"!==typeof b&&!0===b?"undefined"===typeof a||!1===a||null===a?ioAdapter.send(c):ioAdapter.sendUser(c,a):"undefined"===typeof a||!1===a||null===a?ioAdapter.mustSend(c):ioAdapter.mustSendUser(c,a)}},breakintobytes(c,a){c=c.toString();
for(let b=c.length;b<a;b++)c=`0${c}`;return c.match(/[\S]{1,2}/g)||[]},createReclaimButton(c){this.createDiv("t_reclaim","educator",c);const a=this;document.getElementById("t_reclaim").getElementsByTagName("a")[0].addEventListener("click",()=>{a._reclaimRole()})},createDiv(c,a,b,f){const g=a;a=virtualclass.lang.getString(a);const d=document.createElement("a");d.href="#";const m=document.createElement("div");m.id=c;"undefined"!==typeof f&&(m.className=f);m.dataset.tool=g;f=document.createElement("span");
f.className=`icon-${g}`;d.appendChild(f);d.dataset.title=a;d.className="tooltip";m.appendChild(d);"t_reclaim"==c?(c=document.getElementById("virtualclassAppLeftPanel"),b.appendChild(m),c.insertBefore(b,c.firstChild)):b.appendChild(m)},assignRole(c){if("object"===typeof virtualclass.wb){var {vcan:a}=virtualclass.wb[virtualclass.gObj.currWb];virtualclass.wb[virtualclass.gObj.currWb].tool="";"move"==a.main.action&&virtualclass.wb[virtualclass.gObj.currWb].utility.deActiveFrmDragDrop()}if("undefined"!==
typeof c){if(roles.isEducator()){var b=document.getElementById("commandToolsWrapper_doc_0_0");b.parentNode.removeChild(b);virtualclass.vutil.removeClass("virtualclassCont","educator")}else virtualclass.vutil.addClass("virtualclassCont","presenter");virtualclass.gObj.uRole=roles.hasAdmin()?"t":"p";localStorage.setItem("uRole",virtualclass.gObj.uRole);virtualclass.user.assignRole(virtualclass.gObj.uRole,virtualclass.vutil.capitalizeFirstLetter(virtualclass.currApp),c);"object"===typeof virtualclass.wb&&
a.utility.canvasCalcOffset(a.main.canid);"Yts"==virtualclass.currApp?(c=document.getElementById("virtualclassYts"),null!=c?null==document.getElementById("player")&&virtualclass.yts.UI.createPlayerTag(c):virtualclass.yts.UI.container(),virtualclass.yts.UI.inputURL(),"object"===typeof virtualclass.yts.player?virtualclass.yts.seekChangeInterval():console.log("Player object is not ready")):"SharePresentation"==virtualclass.currApp&&(null!=document.getElementById("virtualclassSharePresentation")?null==
document.getElementById("iframecontainer")&&virtualclass.sharePt.UI.createIframe():virtualclass.sharePt.UI.container(),roles.hasControls()&&virtualclass.sharePt.initTeacherLayout(),roles.hasView()&&(virtualclass.sharePt.eventsObj=[]),virtualclass.sharePt.attachEvent("submitpurl","click",virtualclass.sharePt.initNewPpt),virtualclass.sharePt.attachMessageEvent("message",virtualclass.sharePt.pptMessageEventHandler))}else{"Yts"==virtualclass.currApp&&(virtualclass.yts.UI.removeinputURL(),virtualclass.yts.hasOwnProperty("tsc")&&
clearInterval(virtualclass.yts.tsc));"SharePresentation"==virtualclass.currApp&&(roles.hasControls()&&virtualclass.sharePt.initStudentLayout(),roles.hasView()&&(virtualclass.sharePt.eventsObj=[],virtualclass.sharePt.hideElement("pptMessageLayout"),virtualclass.sharePt.UI.createUrlContainer(),virtualclass.sharePt.displayElement("urlcontainer")),virtualclass.sharePt.attachEvent("submitpurl","click",virtualclass.sharePt.initNewPpt),virtualclass.sharePt.attachMessageEvent("message",virtualclass.sharePt.pptMessageEventHandler));
virtualclass.gObj.uRole=roles.hasAdmin()?"e":"s";b=document.getElementById("commandToolsWrapper_doc_0_0");if(null!=b)for(;b.hasChildNodes();)b.removeChild(b.lastChild);else b=virtualclass.vutil.createRoleWrapper();"object"===typeof virtualclass.wb&&virtualclass.wb[virtualclass.gObj.currWb].utility.makeCanvasDisable();roles.hasAdmin()?(document.getElementById("virtualclassCont"),virtualclass.vutil.createReclaimButton(b),virtualclass.vutil.addClass("virtualclassCont","educator")):(virtualclass.vutil.removeClass("virtualclassCont",
"presenter"),b=document.querySelector("#commandToolsWrapper_doc_0_0"),null!=b&&b.parentNode.removeChild(b));localStorage.setItem("uRole",virtualclass.gObj.uRole);"object"===typeof virtualclass.wb&&virtualclass.wb[virtualclass.gObj.currWb].utility.uniqueArrOfObjsToStudent()}virtualclass.system.setAppDimension();virtualclass.vutil.renderWhiteboardObjectsIfAny();roles.hasAdmin()?virtualclass.uInfo.userobj.role=virtualclass.gObj.uRole:(io.disconnect(),setTimeout(()=>{virtualclass.uInfo.userobj.role=virtualclass.gObj.uRole;
io.init(virtualclass.uInfo)},500))},renderWhiteboardObjectsIfAny(){"object"===typeof virtualclass.wb&&0<virtualclass.wb[virtualclass.gObj.currWb].vcan.main.children.length&&virtualclass.wb[virtualclass.gObj.currWb].vcan.renderAll()},createCommandWrapper(c){var {vcan:a}=virtualclass.wb[c];const b=document.createElement("div");b.id=virtualclass.gObj.commandToolsWrapperId[c];b.className="commandToolsWrapper";a=document.getElementById(a.canvasWrapperId);null!=a?document.getElementById(`containerWb${c}`).insertBefore(b,
a):document.getElementById(`containerWb${c}`).appendChild(b);return b},createRoleWrapper(){const c=document.createElement("div");c.id="commandToolsWrapper_doc_0_0";c.className="commandToolsWrapper";return c},_reclaimRole(){virtualclass.vutil.beforeSend({reclaimRole:!0,cf:"reclaimRole"});const c=document.getElementById("t_reclaim");c.style.pointerEvents="none";c.style.opacity="0.5";const a=this;setTimeout(()=>{a.reclaimRole();virtualclass.user.control.changeAttrToAssign("enable")},2E3)},reclaimRole(){virtualclass.gObj.controlAssign=
!1;this.vcResponseAssignRole(virtualclass.gObj.uid,virtualclass.gObj.uid,!0)},vcResponseAssignRole(c,a,b){if(c!=a||"undefined"!==typeof b)if(virtualclass.vutil.assignRole(a),"object"===typeof virtualclass.wb&&virtualclass.wb[virtualclass.gObj.currWb].utility.uniqueArrOfObjsToTeacher(),roles.hasAdmin())c=document.getElementById("chat_div").getElementsByClassName("currTeacher")[0],null!=c&&virtualclass.user.control.removeCurrTeacherFromControl(c.id),virtualclass.user.control.changeAttrToAssign("enable");
...
"errorContainer","chatWidget"))},vcResponseAReclaimRole(c,a){console.log("Reclaim role :- Init");if(c!=a){if("object"===typeof virtualclass.wb){var b=virtualclass.wb[virtualclass.gObj.currWb].vcan.main.replayObjs[virtualclass.wb[virtualclass.gObj.currWb].vcan.main.replayObjs.length-1];if("object"===typeof b&&"del"==b.ac)console.log("Delete command:- Transferring the delete command"),virtualclass.vutil.beforeSend({repObj:[b],cf:"repObj"});else if("t_text"==virtualclass.wb[virtualclass.gObj.currWb].tool.cmd&&
"create"==virtualclass.wb[virtualclass.gObj.currWb].vcan.main.action)virtualclass.wb[virtualclass.gObj.currWb].obj.drawTextObj.finalizeTextIfAny(!0),console.log("Text command:- Transferring text command");else if(virtualclass.wb[virtualclass.gObj.currWb].tool.hasOwnProperty("started")&&1==virtualclass.wb[virtualclass.gObj.currWb].tool.started||"move"==virtualclass.wb[virtualclass.gObj.currWb].vcan.main.action)b=vcan.extend({},virtualclass.wb[virtualclass.gObj.currWb].vcan.main.replayObjs[virtualclass.wb[virtualclass.gObj.currWb].vcan.main.replayObjs.length-
1]),b.ac="u",b=b.hasOwnProperty("mtext")?{detail:{cevent:{x:b.x,y:b.y,mtext:b.mtext}}}:{detail:{cevent:{x:b.x,y:b.y}}},b.detail.broadCast=!0,b=new CustomEvent("mouseup",b),vcan.main.canvas.dispatchEvent(b),console.log("Whiteboard:- Transfering the assign role to Teacher");console.log("Role assign with reclaim")}virtualclass.user.control._assign(a,"notsent",c);console.log("Reclaim role :- peforme");virtualclass.user.displayStudentSpeaker(!0);null!=localStorage.getItem("aId")&&localStorage.removeItem("aId");
virtualclass.user.control.removeAudioFromParticipate(c);"mobTab"==virtualclass.system.device&&((virtualclass.system.mybrowser.name=8<=virtualclass.system.mybrowser.version)&&/(iPad)/g.test(navigator.userAgent)&&virtualclass.vutil.enableVirtualClass(),virtualclass.view.removeErrorMsg("errorContainer",!0))}},createReclaimButtonIfNeed(){if(roles.isEducator()){const c=virtualclass.vutil.createRoleWrapper();virtualclass.vutil.createReclaimButton(c);return!0}return!1},whoIsTeacher(){if(virtualclass.hasOwnProperty("connectedUsers"))for(let c=
0;c<virtualclass.connectedUsers.length;c++)if("t"==virtualclass.connectedUsers[c].role||"e"==virtualclass.connectedUsers[c].role)return virtualclass.connectedUsers[c].userid;return 0},getMySelf(){if(virtualclass.hasOwnProperty("connectedUsers"))for(let c=0;c<virtualclass.connectedUsers.length;c++)if(virtualclass.connectedUsers[c].userid==virtualclass.gObj.uid)return virtualclass.connectedUsers[c]},enablePresentatorEditors(c){c={toUser:c,status:!0};virtualclass.user.control.received_editorRich(c);
virtualclass.user.control.received_editorCode(c)},getClassName(c){let a;"t"==c?a="teacher":"e"==c?a="educator":"s"==c?a="student":"p"==c&&(a="presenter");return a},isPresenterExist(){for(let c=0;c<virtualclass.connectedUsers.length;c++)if("p"==virtualclass.connectedUsers[c].role)return!0;return!1},setReadModeWhenTeacherIsDisConn(c){if(!roles.hasAdmin()){let a=localStorage.getItem("oTDisconn");null!=a&&((a=JSON.parse(a))?virtualclass.hasOwnProperty(c)?"object"===typeof virtualclass[c].cm?virtualclass[c].cm.setOption("readOnly",
"nocursor"):console.log(`Editor CM is notvutil defined for editor ${c}`):console.log(`Editor type ${c} is not ready.`):console.log("Teacher is connected."))}},setReadModeWhenTeacherIsConn(c){localStorage.removeItem("oTDisconn");const a=document.getElementById(`${virtualclass.vutil.capitalizeFirstLetter(c)}writeModeBox`);null!=a?"true"==a.getAttribute("data-write-mode")?virtualclass[c].cm.setOption("readOnly",!1):virtualclass[c].cm.setOption("readOnly","nocursor"):console.log(`Editor:- writemode element is not found for ${c}`)},
isTeacherAlreadyExist(c){if(virtualclass.hasOwnProperty("connectedUsers"))for(let a=0;a<virtualclass.connectedUsers.length;a++)if(("t"==virtualclass.connectedUsers[a].role||"e"==virtualclass.connectedUsers[a].role)&&virtualclass.connectedUsers[a].userid!=c)return console.log(`joni Id ${c}`),!0;return!1},getPresenterId(){if(virtualclass.hasOwnProperty("connectedUsers"))for(let c=0;c<virtualclass.connectedUsers.length;c++)if("p"==virtualclass.connectedUsers[c].role)return virtualclass.connectedUsers[c].userid;
return!1},isEducatorAlreadyExist(c){if(virtualclass.hasOwnProperty("connectedUsers"))for(let a=0;a<virtualclass.connectedUsers.length;a++)if("e"==virtualclass.connectedUsers[a].role&&virtualclass.connectedUsers[a].userid!=c)return console.log(`joniId ${c}`),!0;return!1},isOrginalTeacherExist(c){if(virtualclass.hasOwnProperty("connectedUsers"))for(let a=0;a<virtualclass.connectedUsers.length;a++)if("t"==virtualclass.connectedUsers[a].role&&virtualclass.connectedUsers[a].userid!=c)return console.log(`joniId ${c}`),
!0;return!1},createBecomeTeacherWidget(){if(null==document.getElementById("beTeacher")){const a=document.createElement("div");a.id="beTeacher";var c=document.createElement("a");c.id=`${a.id}Anchor`;c.innerHTML=virtualclass.lang.getString("becomeTeacher");a.appendChild(c);c=document.getElementById("virtualclassCont");c.insertBefore(a,c.firstChild);a.addEventListener("click",virtualclass.vutil.initTeacherRole);a.style.pointerEvents="none";a.style.opacity="0.5";setTimeout(()=>{a.style.pointerEvents=
"visible";a.style.opacity="1"},6E4)}},removeBecomeTeacherWidget(){const c=document.getElementById("beTeacher");null!=c&&c.parentNode.removeChild(c)},initTeacherRole(){ioAdapter.send({cf:"bt"});virtualclass.vutil.removeBecomeTeacherWidget();setTimeout(()=>{virtualclass.vutil.isOrginalTeacherExist(virtualclass.jId)?console.log("Already connected teacher"):(virtualclass.vutil.overrideRoles("t"),localStorage.setItem("beTeacher",!0),console.log("connected teacher"));d.location.reload()},virtualclass.gObj.mySetTime)},
overrideRoles(c){virtualclass.uInfo.userobj.role=c;virtualclass.gObj.uRole=virtualclass.uInfo.userobj.role;wbUser.role=virtualclass.uInfo.userobj.role;const a=document.getElementById("virtualclassCont");virtualclass.vutil.overrideRolesFromElem(a,c)},overrideRolesFromElem(c,a){"s"==a?(c.classList.remove("teacher"),c.classList.remove("orginalTeacher"),c.classList.remove("presenter"),c.classList.remove("educator"),virtualclassCont.classList.add("student")):"p"==a?(c.classList.remove("teacher"),c.classList.remove("orginalTeacher"),
c.classList.remove("educator"),virtualclassCont.classList.add("student"),virtualclassCont.classList.add("presenter")):"e"==a?(c.classList.add("teacher"),c.classList.remove("student"),c.classList.remove("presenter"),c.classList.add("educator"),c.classList.add("orginalTeacher")):"t"==a&&(c.classList.remove("student"),c.classList.remove("educator"),c.classList.remove("presenter"),c.classList.add("teacher"),c.classList.add("orginalTeacher"),console.log("add Teacher"))},sesionEndMsgBoxIsExisting(){const c=
document.getElementById("sessionEndMsgCont");return c.hasAttribute("data-displaying")&&"true"==c.dataset.displaying},removeVideoHostContainer(){const c=document.getElementById("videoHostContainer");null!=c&&c.parentNode.removeChild(c)},createDummyUser(c){c||(c=5E3);let a,b=0,f=31;var g=setInterval(()=>{b>c?clearInterval(g):(f+=b,a={joinUser:{key:f},message:[{lname:" ",name:`User${f}`,role:"s",userid:f}],newuser:null,type:"member_added",user:!0},b++,virtualclass.ioEventApi.readyto_member_add(a))},
1)},getVisibleHeightElem(c){var a=$(c);c=$(d).scrollTop();const b=c+$(d).height(),f=a.offset().top;a=f+a.outerHeight();return(a>b?b:a)-(f<c?c:f)},applyHeight(c){c=document.getElementById("virtualclassAppRightPanel");const a=this.getVisibleHeightElem("virtualclassCont");c.style.height=a!=nul1?a:d.innerHeight},insertIntoLeftBar(c){const a=document.querySelector("#virtualclassApp #virtualclassAppLeftPanel");null!=a?a.appendChild(c):alert("Error:- There is no Element to insert it.")},getWhiteboardId(c){c=
c.closest(".vcanvas");if(null!=c)return c.dataset.wbId;alert("doc element is null")},getElementOffset(c){let a=0,b=0;do a+=c.offsetTop||0,b+=c.offsetLeft||0,c=c.offsetParent;while(c);return{x:b,y:a}},updateCurrentDoc(c){virtualclass.gObj.currWb=`_doc_${c}_${c}`},getParentTag(c,a){return c.closest(a)},attachEventToUploadTab(c,a,b){c=document.getElementById("newDocBtn");null!=c&&(c.removeEventListener("click",virtualclass.vutil._attachEventToUploadTab),c.addEventListener("click",virtualclass.vutil._attachEventToUploadTab))},
_attachEventToUploadTab(){var c=document.querySelector("#DocumentShareDashboard .qq-upload-button-selector.qq-upload-button input");if(null!=c){if(c.click(),c=document.querySelector("#DocumentShareDashboard .qq-upload-list-selector.qq-upload-list"))c.style.display="block"}else alert("Element is null")},attachEventToUpload(c,a,b){c=document.getElementById("uploadVideo");null!=c&&c.addEventListener("click",()=>{const a=document.querySelector("#VideoDashboard .qq-upload-button-selector.qq-upload-button input");
null!=a?a.click():alert("Element is null")})},modalPopup(c,a){const b={};if("video"==c){const a=document.querySelector("#listvideo .playing");a&&(this.currPlaying=a.getAttribute("data-rid"));b.validation="mp4 avi wmv mov webm mkv vob mpeg".split(" ");b.cb=virtualclass.videoUl.afterUploadVideo;b.cthis="video";b.maxSize=512E6;b.requesteEndPoint=`${d.webapi}&methodname=file_save&live_class_id=${virtualclass.gObj.congCourse}&status=1&content_type_id=2&user=${virtualclass.gObj.uid}`}else b.validation=
...
virtualclass.videoUl.hasOwnProperty("player")&&"object"===typeof virtualclass.videoUl.player&&null!=virtualclass.videoUl.player.player_&&virtualclass.videoUl.destroyPlayer();null!=virtualclass.gObj.CDTimer&&clearInterval(virtualclass.gObj.CDTimer);b=document.querySelector(`#virtualclass${virtualclass.currApp}`);null!=b&&(b.style.display="none");virtualclass.hasOwnProperty("media")&&virtualclass.media.audio.muteButtonToogle();b=chatContainerEvent.elementFromShadowDom(".ui-memblist-usr","all");if(null!=
b&&0<b.length)for(var f=0;f<b.length;f++)null!=b[f]&&b[f].parentNode.removeChild(b[f]);virtualclass.gObj.precheckScrn&&virtualclass.vutil.prechkScrnShare();virtualclass.gObj.audioEnable=roles.hasControls()?!0:virtualclass.gObj.stdaudioEnable;virtualclass.storage.config.sessionEndFlag=!0;b=localStorage.getItem("nEd");localStorage.getItem("precheck");null!=virtualclass.chat&&(delete virtualclass.chat.vmstorage,virtualclass.chat.vmstorage={},virtualclass.chat.removeChatHighLight("chatrm"));virtualclass.recorder.items=
...
typeof virtualclass.yts&&clearInterval(virtualclass.yts.tsc);"object"===typeof virtualclass.sharePt&&virtualclass.sharePt.UI.removeIframe();console.log("Session End.");virtualclass.previous=`virtualclass${virtualclass.currApp}`;virtualclass.getContent=!1;virtualclass.recorder.storeDone=0;workerIO.postMessage({cmd:"sessionEndClose"});null!=b?(console.log("Editor mode enable"),localStorage.setItem("editorRich",!0),localStorage.setItem("editorCode",!0),localStorage.removeItem("nEd")):console.log("Editor mode disable");
console.log(`New role before clear ${virtualclass.gObj.uRole}`);virtualclass.settings.user={};document.querySelector("#virtualclassWhiteboard").style.display="none";a=document.querySelector("#virtualclassCont");null!=a&&a.classList.remove("loading");localStorage.clear();if(virtualclass.isPlayMode){c.config.createNewSession();virtualclass.videoHost&&roles.isStudent()&&!virtualclass.isPlayMode&&(virtualclass.settings.init(),virtualclass.settings.userAudioIcon(),virtualclass.settings.userVideoIcon(),
a=document.querySelector("#virtualclassAppRightPanel"),a.classList.contains("vidHide")||a.classList.add("vidHide"));console.log(`New role after clear ${virtualclass.gObj.uRole}`);virtualclass.popup.waitMsg();"object"===typeof virtualclass.dts&&null!=virtualclass.dts&&virtualclass.dts.destroyDts();if("object"===typeof virtualclass.raiseHand&&null!=virtualclass.raiseHand)if(roles.hasControls())virtualclass.raiseHand.rhCount=0,virtualclass.raiseHand.rhCountR=0,(a=document.querySelector(".congrea .vmchat_bar_button .hand_bt.highlight"))&&
...
b.length)for(let f=0;f<b.length;f++)if(0<b[f].id.indexOf("Aud")){var c=b[f].id.indexOf("Cont");0<c&&(c=b[f].id.substr(0,c),c=chatContainerEvent.elementFromShadowDom(`${c}Img`,null,!0),this.control.init.call(this,c,a,void 0,"actnotSend"))}},toggleAllVideo(a){ioAdapter.mustSend({action:a,cf:"toggleVideo"})},mediaSliderUI(a){const b="audio"===a?"Audio":"Video";let g=c.querySelector(`.bulkUserActions #contr${b}AllImg`);var d=virtualclass.user.defaultSettings(a,virtualclass.settings.info);const m=c.querySelector(`.bulkUserActions #contr${b}All input`),
n=c.querySelector(`.congrea #contr${b}All`),q="enable"===d?"disable":"enable";null!=d?(g.setAttribute("data-action",q),g.className=`slider round icon-all-${a}-${q} enable congtooltip cgIcon`,g.dataset.title=virtualclass.lang.getString(`${q}All${b}`),m.setAttribute("checked","true"),n.classList.add(q)):(d={action:d?"enable":"disable",enable:"disable",disable:"enable"},g=c.querySelector(`.bulkUserActions #contr${b}AllImg`),g.setAttribute("data-action",d[d.action]),g.className=`slider round icon-all-${a}-${d[d.action]} congtooltip cgIcon`,
g.dataset.title=virtualclass.lang.getString(`${d[d.action]}All${b}`),m.removeAttribute("checked"),n.classList.add(d[d.action]));if(virtualclass.isPlayMode)anchorTag.pointerEvents="none",anchorTag.style.cursor="default";else{const b=this;g.addEventListener("click",()=>{let c;"audio"===a?(c=b.toogleAudioIcon(),virtualclass.settings.applySettings("enable"===c,"studentaudio"),"undefined"!==typeof c&&(localStorage.setItem("allAudAction",c),b.toggleAllAudio.call(virtualclass.user,c))):(c=b.toggleVideoIcon(),
virtualclass.settings.applySettings("enable"===c,"studentvideo"),"undefined"!==typeof c&&(localStorage.setItem("allVideoAction",c),b.toggleAllVideo(c)))})}},defaultSettings(a,c){let b,f;for(const g in c)if(f=c[g],"audio"===a&&"studentaudio"===g||"video"===a&&"studentvideo"===g)b=!0===f?"enable":"disable";return b},chatBoxesSwitch(){if(virtualclass.chat.chatroombox)toggleCommonChatBox();else if(0==$("div#chat_room").length){var a=c.createElement("ul");a.id="chat_room";c.body.appendChild(a);virtualclass.chat.chatroombox=
$("#chat_room").chatroom({id:"chat_room",user:{name:"test"},title:lang.chatroom_header,offset:"20px",messageSent(a,b){$("#chat_room").chatroom("option","boxManager").addMsg(a.name,b)}});virtualclass.gObj.hasOwnProperty("chatEnable")&&!virtualclass.gObj.chatEnable&&(a=c.getElementById("chatrm"),null!=a&&virtualclass.user.control.makeElemDisable(a));a=c.getElementById("cc_arrow_button");a.classList.add("icon-arrow-down");a.classList.remove("icon-arrow-up")}},toogleAudioIcon(){var a=c.querySelector(".bulkUserActions #contrAudioAllImg");
...
a.className="slider round icon-all-video-enable congtooltip",a.dataset.title=virtualclass.lang.getString("enableAllVideo"),a=c.querySelector(".congrea .bulkUserActions #contrVideoAll"),a.classList.add("enable"),a.classList.remove("disable"));return b}},changeRoleOnFooter(a,c){chatContainerEvent.elementFromShadowDom(`#ml${a}`).dataset.role=c},initControlHandler(a){virtualclass.vutil.userIsOrginalTeacher(a);const b=chatContainerEvent.elementFromShadowDom(`#ml${a} .contImg`,"all");let g=!1,d=localStorage.getItem(`virtualclass${a}`);
null!=d&&(g=!0,d=JSON.parse(d),d.hasOwnProperty("currTeacher")&&(virtualclass.gObj[`${a}currTeacher`]={},1==d.currTeacher?(virtualclass.user.control.currTeacherAlready=!0,virtualclass.gObj[`${a}currTeacher`].ct=!0):virtualclass.gObj[`${a}currTeacher`].ct=!1));for(let f=0;f<b.length;f++)if(-1<b[f].className.indexOf("chat")){var m=g&&d.hasOwnProperty("chat")?virtualclass.settings.user.hasOwnProperty(a)?virtualclass.settings.parseSettings(virtualclass.settings.user[a]).studentpc:virtualclass.settings.info.studentpc:
virtualclass.settings.info.studentpc;virtualclass.user.control.changeAttribute(a,b[f],m,"chat","chat")}else-1<b[f].className.indexOf("aud")?(g&&d.hasOwnProperty("aud")?m=virtualclass.settings.user.hasOwnProperty(a)?virtualclass.settings.parseSettings(virtualclass.settings.user[a]).studentaudio:virtualclass.settings.info.studentaudio:(m=c.querySelector("#contrAudioAll"),null!=virtualclass.jId&&m.classList.contains("disable"),m=virtualclass.settings.info.studentaudio),virtualclass.user.control.changeAttribute(a,
b[f],m,"audio","aud"),roles.hasAdmin()&&"false"==b[f].dataset.audioDisable&&localStorage.getItem("allAudAction")):-1<b[f].className.indexOf("RaiseHand")?(m=g&&d.hasOwnProperty("raiseHand")?!!d.raiseHand:!1,virtualclass.user.control.changeAttribute(a,b[f],m,"RaiseHand","RaiseHand")):-1<b[f].className.indexOf("stdscreen")?virtualclass.gObj.studentSSstatus.hasOwnProperty("whoIsSharing")&&virtualclass.vutil.initssSharing(virtualclass.gObj.whoIsSharing):-1<b[f].className.indexOf("editorRich")&&"EditorRich"==
virtualclass.currApp?(c.querySelector("#alleditorRichContainerAnch"),m=g&&d.hasOwnProperty("editorRich")?!!d.editorRich:!1,virtualclass.user.control.changeAttribute(a,b[f],m,"editorRich","editorRich")):-1<b[f].className.indexOf("editorCode")&&(m=g&&d.hasOwnProperty("editorCode")?!!d.editorCode:!1,virtualclass.user.control.changeAttribute(a,b[f],m,"editorCode","editorCode"))}}}})(window,document);(function(d){d.xhr={init(){this.httpObj=d.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");this.httpObj.upload.addEventListener("progress",this.onProgress);this.onReadStateChange();this.httpObj.onerror=function(c){console.log(`Error ${c}`)};this.httpObj.withCredentials=!0;this.httpObj.onabort=function(c){console.log(`Error abort ${c}`)}},onProgress(c){virtualclass.pbar.currVal=c.loaded;""!=virtualclass.pbar.prvVal&&"undefined"!==typeof virtualclass.pbar.prvVal||virtualclass.isPlayMode||
...
c&&virtualclass.vutil.WebPDecodeAndDraw(a)}},http.send(null)):"enc"===c&&ImageToCanvas(`/images-enc/${d}`)}
...
"dec"===type&&virtualclass.gObj.meetingMode&&WebPDecDemo(c.id);virtualclass.vutil.WebPDecodeAndDraw(b,c,a)}};http.send(null)}else"enc"===type&&ImageToCanvas(`/images-enc/${filename}`)};function WebPDecDemo(d){document.getElementById(d).getContext("2d");document.createElement("img")};const BASE64_MARKER=";base64,";
...
stdResponse(a,b){this.updateResponse(a,b)},newPollHandler(a){const b=document.querySelector("#createPollCont");var c=document.querySelector("#editPollModal");c&&c.remove();c=virtualclass.getTemplate("modal","poll");b.insertAdjacentHTML("beforeend",c());virtualclass.modal.closeModalHandler("editPollModal");virtualclass.poll.pollPopUp(virtualclass.poll.popupFn,void 0,a)},popupFn(a,b,c){virtualclass.poll[a].call(virtualclass.poll,b,c,a)},next(a,b){virtualclass.poll.pollSetting(b,a)},goBack(a,b){console.log("modal dismiss")},
...
1,a.style.pointerEvents="auto",virtualclass.videoUl.videos&&virtualclass.videoUl.videos.length&&virtualclass.videoUl.videos.forEach((a,f)=>{a.fileuuid==c&&(delete a.disabled,a.status=1)}))},_delete(c){const a=this;virtualclass.xhrn.sendData({uuid:c,action:"delete",page:0},virtualclass.api.UpdateDocumentStatus,b=>{a.afterDeleteCallback(b,c)})},afterDeleteCallback(c,a){if("ERROR"!=c&&(c=document.getElementById(`linkvideo${a}`))){c.parentNode.removeChild(c);if(virtualclass.videoUl.videoId==a&&(c=document.querySelector("#videoPlayerCont"))){c.style.display=
...
{control:!!roles.hasAdmin()};virtualclass.vutil.insertAppLayout((0,JST[`${virtualclass.gObj.tempPrefix}/videoupload/videoupload.hbs`])(c));document.getElementById(this.id)}!roles.hasControls()&&(c=document.getElementById("messageLayoutVideo"))&&(c.style.display="block")},createYoutubeUrlCont(c){const a=document.createElement("div");a.id="listvideo";c.appendChild(a)},displayVideo(c,a,b){const f=this;virtualclass.videoUl.hasOwnProperty("displayVideoTime")&&clearTimeout(virtualclass.videoUl.displayVideoTime);
virtualclass.videoUl.displayVideoTime=setTimeout(()=>{"Video"==virtualclass.currApp&&f._displayVideo(c,a,b)},300)},_displayVideo(c,a,b){"object"===typeof virtualclass.videoUl.player&&virtualclass.videoUl.player.hasOwnProperty("dispose")&&virtualclass.videoUl.player.dispose();virtualclass.videoUl.videoUrl=a;virtualclass.videoUl.videoId=c;var f=document.getElementById("videoPlayerCont");f?f.style.display="block":(virtualclass.videoUl.UI.container(),f=document.getElementById("videoPlayerCont"));const d=
document.querySelector("iframe#player");d&&d.remove();virtualclass.videoUl.UI.switchDisplay(f,a);virtualclass.videoUl.UI.videojsPlayer(a,c,b);virtualclass.modal.hideModal()},videojsPlayer(c,a,b){if(!virtualclass.videoUl.player){const b=videojs("dispVideo");if(roles.hasControls()){$(".vjs-autoPlay-button").length||virtualclass.videoUl.UI.appendAutoPlayButton(b);const a=document.getElementById("autoPlayListBtn");a&&(a.className=virtualclass.videoUl.autoPlayClass)}virtualclass.videoUl.player=b;virtualclass.videoUl.UI.attachPlayerHandler(virtualclass.videoUl.player,
...
(b=virtualclass.videoUl.startTime);c.poster_&&(c.poster_="");const f=document.querySelector("#dispVideo");virtualclass.videoUl.yts?(f.setAttribute("data-setup",'{ techOrder: [youtube],"preload": "auto"}'),c.src({type:"video/youtube",src:a})):virtualclass.videoUl.online?(f.setAttribute("data-setup",'{"preload": "auto" }'),c.src({type:"video/webm",src:a}),c.src({type:"video/mp4",src:a})):(f.setAttribute("data-setup",'{"preload": "auto"}'),c.src({type:"application/x-mpegURL",withCredentials:!0,src:a}));
...
dispList(){document.getElementById("mszBoxQuiz");const a=document.getElementById("listQzCont");a?a.style.display="block":(console.log("quiz layout 2"),this.UI.layout2("layoutQuizBody"))},interfaceToFetchList(a){a=new FormData;a.append("cmid",this.cmid);a.append("user",this.uid);const b=this;virtualclass.xhr.send(a,`${d.webapi}&methodname=congrea_quiz`,a=>{a=JSON.parse(a);if(0==a.status)document.getElementById("bootstrapQzCont").innerHTML=virtualclass.lang.getString("noQuiz");else{for(let b=0;b<=a.length-
1;b++){const {options:c}=a[b];for(const d in c)a[b].options[d]=c[d].options}b.coursequiz=a;b.displayQuizList()}})},displayQuizes(a,c){this.UI.qzCont(c);this.UI.qzCtrCont(c);this.UI.qzTextCont(a,c);this.attachQZEvent(`publishQz${c}`,"click",this.publishHandler,a,c)},attachQZEvent(a,c,d,k,m){a=document.getElementById(a);null!=a&&a.addEventListener(c,()=>{"undefined"!==typeof k?(console.log("attach time handler"),d(k,m)):console.log("quiz is missing no need of time")})},publishHandler(a,c){const b=document.getElementById("mszBoxQuiz");
0<b.childNodes.length&&b.childNodes[0].parentNode.removeChild(b.childNodes[0]);virtualclass.quiz.publishQuiz(a,c)},publishQuiz(a,c){this.openQuizPopup(a,c);this.quizPreview(a);a=document.querySelector("#editQuizModal");a.className="modal in";a.style.display="block"},openQuizPopup(a,c){this.qzid=c;a=document.getElementById("layoutQuizBody");c=document.createElement("div");c.className="container";a.appendChild(c);(a=document.getElementById("editQuizModal"))&&a.remove();a=document.getElementById("bootstrapQzCont");
virtualclass.quiz.UI.generateModal("editQuizModal",a)},showQn(a){roles.hasControls()?a.innerHTML="quiz question":a.innerHTML="quiz question for student"},action(a,c,d){c(a,d)},getQuizData(a){const b=this.coursequiz[a.id],g=new FormData;g.append("cmid",this.cmid);g.append("user",this.uid);g.append("qid",a.id);c=this;virtualclass.xhr.send(g,`${d.webapi}&methodname=congrea_get_quizdata`,a=>{if(c.isJson(a))c.quizJSON=a,$("#slickQuiz").slickQuiz({json:c.quizJSON,questionPerPage:b.questionsperpage,questionMode:b.preferredbehaviour,
quizTime:b.timelimit,displayDetailResult:!1});else{const b=document.getElementById("publishQzBt");b.parentNode.removeChild(b);document.getElementById("contQzBody").innerHTML=a}})},quizPopUp(a,c){console.log("quiz pop up");const b=function(){console.log(this.id);virtualclass.quiz.action(this.id,a,c)},d=(document.getElementById("editQuizModal")?document.getElementById("editQuizModal"):document.getElementById("qzPopup")).querySelectorAll(":scope .controls");for(let a=0;a<d.length;a++)d[a].addEventListener("click",
b)},quizPreview(a){console.log("quiz preview function");this.UI.modalContentUI();var b=document.getElementById("contQzHead"),c=document.createElement("div");c.id="QstnName";c.innerHTML=a.name;b.appendChild(c);c=document.getElementById("contQzBody");b=document.createElement("button");b.id="publishQzBt";b.classList.add("btn","btn-default","controls");b.innerHTML=virtualclass.lang.getString("PQuiz");c.appendChild(b);c=document.createElement("i");c.className="icon-publish";b.appendChild(c);this.getQuizData(a);
this.quizPopUp(this.popupFn,1)},popupFn(a,c){virtualclass.quiz[a].call(virtualclass.quiz,c)},publishQzBt(){const a=virtualclass.quiz;var c=a.quizJSON,g=JSON.parse(c).questions.length;a.coursequiz[a.qzid].noOfQus=g;g=a.coursequiz[a.qzid];const k={json:c,questionPerPage:g.questionsperpage,questionMode:g.preferredbehaviour,quizTime:g.timelimit,displayDetailResult:!1,ptm:(new Date).getTime()};ioAdapter.mustSend({quiz:{quizMsg:"stdPublish",quizId:a.qzid,data:k},cf:"quiz"});a.UI.resultView(g);a.tabContent();
a.quizSt.screen="tchResultView";virtualclass.storage.quizStorage("qDetail",JSON.stringify(g));virtualclass.storage.quizStorage("qData",c);c=new FormData;c.append("cmid",a.cmid);c.append("qzid",a.qzid);c.append("user",a.uid);virtualclass.xhr.send(c,`${d.webapi}&methodname=congrea_add_quiz`,a=>{"ture"!==a&&console.log("Quiz data not saved in congrea")})},closeQzBt(){console.log("-------CLOSE QUIZ--------");var {qzid:a}=virtualclass.quiz;ioAdapter.mustSend({quiz:{quizMsg:"stdShowResult",data:{qzid:a}},
cf:"quiz"});null!=virtualclass.gObj.CDTimer&&(clearInterval(virtualclass.gObj.CDTimer),console.log("Clear quiz interval"));document.getElementById("closeQzBt").disabled=!0;a=document.createElement("div");a.className="alert alert-info";a.innerHTML=virtualclass.lang.getString("QClosed");resultQzLayout.insertBefore(a,resultQzLayout.firstChild)},quizDisplay(a){var b=document.getElementById("mszBoxQuiz");b&&b.parentNode.removeChild(b);(b=document.getElementById("contQzBody"))&&b.parentNode.removeChild(b);
b=document.getElementById("bootstrapQzCont");const c=virtualclass.view.customCreateElement("div","contQzBody","modal-body");b.appendChild(c);this.UI.modalContentUI();$("#slickQuiz").slickQuiz(a)},saveInLocalStorage(){const a=virtualclass.quiz;null!=document.querySelector("#qztime")&&(a.quizSt.qtime=document.querySelector("#qztime").textContent,console.log(`quiz=${a.quizSt.qtime}`));null!=document.querySelector("#elsTime")&&(a.quizSt.qtime=document.querySelector("#elsTime").textContent,console.log(`quiz=${a.quizSt.qtime}`));
console.log(`quiz=${a.quizSt.screen}`);null!=document.getElementById("closeQzBt")&&1==document.getElementById("closeQzBt").disabled&&(a.quizSt.qClosed="true");a.quizSt&&localStorage.setItem("quizSt",JSON.stringify(a.quizSt));a.quizAttempted&&(console.log(`attempt data =${a.quizAttempted}`),virtualclass.storage.quizStorage("qAttempt",JSON.stringify(a.quizAttempted)))},onmessage(a,c){const b=virtualclass.quiz;"stdPublish"==a.quiz.quizMsg&&(b.dataRec=a.quiz.data,virtualclass.storage.quizStorage("qData",
JSON.stringify(b.dataRec)),b.quizSt.screen="stdPublish",this.quizDisplay(a.quiz.data));if("stdShowResult"==a.quiz.quizMsg||"quizTimeEnd"==a.quiz.quizMsg){null!=document.querySelector("#timeText")&&(document.querySelector("#timeText").textContent="Quiz has been closed");var d=document.querySelector("#slickQuiz .quizResults");d&&"block"!=d.style.display&&(d=document.querySelectorAll("#slickQuiz .nextQuestion"),d[d.length-1].click())}"quizClosed"==a.quiz.quizMsg&&(localStorage.removeItem("quizSt"),this.quizSt=
...
a.quiz.correctans))},saveGradeInDb(a,c,g,k,m){const b=virtualclass.quiz;c=this.convertTimeToSec(c);const f=new FormData;f.append("cmid",b.cmid);f.append("qzid",b.qzid);f.append("user",a);f.append("grade",g);f.append("timetaken",c);f.append("qusattempted",k);f.append("currectans",m);virtualclass.xhr.send(f,`${d.webapi}&methodname=congrea_quiz_result`,a=>{"ture"!==a&&console.log("Quiz data not saved in congrea")})},displayAttemptOverview(){const a=virtualclass.quiz;for(const b in a.quizAttempted)if(document.getElementById(`usA_${b}`).innerHTML=
a.quizAttempted[b].uA,0<a.quizAttempted[b].cA){const c=(a.quizAttempted[b].cA/a.quizAttempted[b].uA*100).toFixed(2),d=document.getElementById(`qPb_${b}`);d.innerHTML=`${c}% correct`;d.style.width=`${c}%`}},displayGradeReport(){const a=virtualclass.quiz;for(let b=0;b<a.qGrade.length;b++)a.gradeReport(b+1,a.qGrade[b].nm,a.qGrade[b].tt,a.qGrade[b].sc,a.qGrade[b].qAt,a.qGrade[b].ca)},attemptProgressReport(){var a=JSON.parse(virtualclass.quiz.quizJSON);const c=virtualclass.view.customCreateElement("div",
"attemptQzBody","modal-body");a=a.questions;let d=1;for(let b=0;b<a.length;b++){const f=virtualclass.view.customCreateElement("div","","q-area");c.appendChild(f);var k=virtualclass.view.customCreateElement("span","","q-no");k.innerHTML=d;f.appendChild(k);k=virtualclass.view.customCreateElement("div","","qscolor");k.innerHTML=a[b].q;f.appendChild(k);k=virtualclass.view.customCreateElement("div");k.innerHTML=`Users attempted : <span id='usA_${a[b].qid}'>0</span>`;f.appendChild(k);k=this.UI.createProgressBar(a[b].qid,
0);f.appendChild(k);d++}return c},tabContent(){const a=document.getElementById("resultQzLayout"),c=virtualclass.view.customCreateElement("div","","tab-content");var d=virtualclass.view.customCreateElement("div","qzOverv");d.className="tab-pane fade in active";var k=this.attemptProgressReport();d.appendChild(k);c.appendChild(d);d=virtualclass.view.customCreateElement("div","gdRpt");d.className="tab-pane fade";k=this.UI.gradeReportLayout();d.appendChild(k);c.appendChild(d);a.appendChild(c)},gradeReport(a,
c,d,k,m,n){var b=document.getElementById("qzReTbody");if(b){const f=document.createElement("tr");b.appendChild(f);b=document.createElement("th");b.scope="row";b.innerHTML=a;f.appendChild(b);a=document.createElement("td");a.innerHTML=c;f.appendChild(a);c=document.createElement("td");c.innerHTML=d;f.appendChild(c);d=document.createElement("td");d.innerHTML=`${k}%`;f.appendChild(d);k=document.createElement("td");k.innerHTML=m;f.appendChild(k);m=document.createElement("td");m.innerHTML=n;f.appendChild(m)}},
quizTimer(a,c,d){function b(){g="asc"==d?a+((Date.now()-f)/1E3|0):a-((Date.now()-f)/1E3|0);q=g/3600|0;r=g%3600/60|0;z=g%60|0;q=10>q?`0${q}`:q;r=10>r?`0${r}`:r;z=10>z?`0${z}`:z;c.textContent=`${q}:${r}:${z}`;0>=g&&("asc"!=d&&(c.textContent="00 : 00 : 00 "),f=0,null!=virtualclass.gObj.CDTimer&&(clearInterval(virtualclass.gObj.CDTimer),console.log("Clear quiz interval")),ioAdapter.mustSend({quiz:{quizMsg:"quizTimeEnd",quizId:virtualclass.view.qzid},cf:"quiz"}),roles.hasControls()&&(document.getElementById("closeQzBt").disabled=
!0))}d="undefined"!==typeof d?d:"desc";let f=Date.now(),g,q,r,z;"asc"!==d&&b();virtualclass.gObj.CDTimer=setInterval(b,1E3)},quizModalClose(){const a=this,c=virtualclass.lang.getString("rusureCquiz");virtualclass.popup.confirmInput(c,b=>{b&&(localStorage.removeItem("quizSt"),a.quizSt={},virtualclass.storage.clearTableData("quizData"),localStorage.removeItem("qRep"),b=document.getElementById("editQuizModal"),b.parentNode.removeChild(b),a.attemptedUsers={},a.quizAttempted={},ioAdapter.mustSend({quiz:{quizMsg:"quizClosed",
quizId:a.qzid},cf:"quiz"}))})},convertSecToTime(a){if(/^\d+$/.test(a)){const b=new Date(null);b.setSeconds(a);return b.toISOString().substr(11,8)}return"00:00:00"},convertTimeToSec(a){return a?(a=a.split(":"),3600*+a[0]+60*+a[1]+ +a[2]):0},isJson(a){try{JSON.parse(a)}catch(f){return!1}return!0},UI:{id:"virtualclassQuiz",class:"virtualclass",container(){console.log("quiz layout check");var a=document.getElementById(this.id);null!=a&&a.parentNode.removeChild(a);a=virtualclass.view.customCreateElement("div",
...
this.createMszBox(a);this.createModalCont(a)},createModalCont(a){const b=virtualclass.view.customCreateElement("div","bootstrapQzCont","modalCont");a.appendChild(b)},layout2(a){a=document.getElementById(a);var b=document.getElementById("listQzCont");if(null==b){const c=document.createElement("div");c.className="table-responsive";a.appendChild(c);b=virtualclass.view.customCreateElement("table","listQzCont","table table-bordered table-striped quizList");c.appendChild(b)}},listHeader(){var a=document.getElementById("listQzCont");
...
c=document.querySelector("#QstnName");null==c&&(c=document.createElement("div"),c.id="QstnName",c.innerHTML=a.name,null!=b&&b.appendChild(c));let f=parseInt(a.timelimit);if(0<f){c="desc";var d="Time remaining"}else c="asc",d="Elapsed time";b=localStorage.getItem("quizSt");null!=b&&(b=JSON.parse(b),0<Object.keys(b).length&&(b=b.qtime.split(":"),f=parseInt(b[2])+60*parseInt(b[1])+3600*parseInt(b[0])));b=document.getElementById("resultQzLayout");const g=virtualclass.view.customCreateElement("div","rsQzHead",
"row col-md-12");b.appendChild(g);var m=virtualclass.view.customCreateElement("div","","col-md-3");m.innerHTML=`Time limit : <span> ${virtualclass.quiz.convertSecToTime(a.timelimit)}</span>`;g.appendChild(m);m=virtualclass.view.customCreateElement("div","","col-md-3");m.innerHTML=`No of questions : <span> ${a.noOfQus}</span>`;g.appendChild(m);a=virtualclass.view.customCreateElement("div","","col-md-4");a.innerHTML=`${d} : <span id="elsTime">00:00:00</span>`;g.appendChild(a);a=virtualclass.view.customCreateElement("button",
"closeQzBt","");a.classList.add("btn","btn-default","controls");a.innerHTML=virtualclass.lang.getString("Cquiz");g.appendChild(a);a.addEventListener("click",virtualclass.quiz.closeQzBt);a=JSON.parse(localStorage.getItem("quizSt"));null==a||"true"!=a.qClosed&&!a.qClosed?virtualclass.quiz.quizTimer(f,document.getElementById("elsTime"),c):(console.log("Don't run timer when quiz is closed"),c=document.querySelector("#elsTime"),localStorage.setItem("quizSt",JSON.stringify(a)),null!=c&&(c.innerHTML=a.qtime));
c=this.createTab();b.appendChild(c)}},createResultLayout(){var b=document.getElementById("resultQzLayout");b&&b.parentNode.removeChild(b);if(roles.hasControls()){b=document.getElementById("contQzHead");(a=document.getElementById("publishQzBt"))&&a.parentNode.removeChild(a);var c=document.querySelector("#contQzHead .close");c&&(c.parentNode.removeChild(c),c=virtualclass.view.customCreateElement("div","modalQzClose","close"),c.type="button",c.innerHTML="&times",b.appendChild(c));if(b=document.getElementById("quizModalBody"))for(;1<
b.childElementCount;)b.removeChild(b.lastChild);c=document.createElement("div");c.id="resultQzLayout";b.appendChild(c);document.getElementById("modalQzClose").addEventListener("click",()=>{virtualclass.quiz.usersFinishedQz=[];virtualclass.quiz.qGrade=[];virtualclass.quiz.quizModalClose()})}},createProgressBar(a,c){const b=virtualclass.view.customCreateElement("div","","progress");a=virtualclass.view.customCreateElement("div",`qPb_${a}`,"progress-bar");a.role="progressbar";a.setAttribute("setaria-valuenow",
c);a.setAttribute("aria-valuemin","0");a.setAttribute("aria-valuemax","100");a.style=`width:${c}%`;a.innerHTML=`${c}% Correct`;b.appendChild(a);return b},gradeReportLayout(){const a=virtualclass.view.customCreateElement("div","gradeRpBody","modal-body"),c=virtualclass.view.customCreateElement("table","","table");var d=virtualclass.view.customCreateElement("thead","","thead-inverse");const k=document.createElement("tr");var m=document.createElement("th");m.innerHTML="#";k.appendChild(m);m=document.createElement("th");
...
CommonXHR.prototype.send=function(d,c,a){console.log(`Common URL ${d}`);this.cb=c;this.httpObj.open("GET",d,!0);this.httpObj.responseType=a;this.httpObj.setRequestHeader("x-api-key",wbUser.lkey);this.httpObj.setRequestHeader("x-congrea-authuser",wbUser.auth_user);this.httpObj.setRequestHeader("x-congrea-authpass",wbUser.auth_pass);this.httpObj.setRequestHeader("x-congrea-room",wbUser.room);this.httpObj.withCredentials=!0;this.httpObj.send()};(function(d){d.settings={info:{},user:{},init(){var c=localStorage.getItem("settings");null===c&&(c=virtualclassSetting.settings,localStorage.setItem("settings",c));virtualclass.settings.info=virtualclass.settings.parseSettings(c);if(c=localStorage.getItem("userSettings"))virtualclass.settings.user=JSON.parse(c);this.recording.init()},settingsToHex(c){const a=[];a[0]=+c.allowoverride;a[1]=+c.studentaudio;a[2]=+c.studentvideo;a[3]=+c.studentpc;a[4]=+c.studentgc;a[5]=+c.raisehand;a[6]=+c.userlist;a[7]=
+c.enableRecording;a[8]=+c.recAllowpresentorAVcontrol;a[9]=+c.recShowPresentorRecordingStatus;a[10]=+c.attendeeAV;a[11]=+c.recallowattendeeAVcontrol;a[12]=+c.showAttendeeRecordingStatus;a[13]=+c.trimRecordings;a[14]=+c.x5;a[15]=+c.x6;return virtualclass.settings.binaryToHex(a.join(""))},parseSettings(c){const a={};c=virtualclass.settings.hexToBinary(c);c=c.split("");a.allowoverride=!!+c[0];a.studentaudio=!!+c[1];a.studentvideo=!!+c[2];a.studentpc=!!+c[3];a.studentgc=!!+c[4];a.raisehand=!!+c[5];a.userlist=
!!+c[6];a.enableRecording=!!+c[7];a.recAllowpresentorAVcontrol=!!+c[8];a.recShowPresentorRecordingStatus=!!+c[9];a.attendeeAV=!!+c[10];a.recallowattendeeAVcontrol=!!+c[11];a.showAttendeeRecordingStatus=!!+c[12];a.trimRecordings=!!+c[13];a.x5=!!+c[14];a.x6=!!+c[15];return a},hexToBinary(c){let a,b="";const d={0:"0000",1:"0001",2:"0010",3:"0011",4:"0100",5:"0101",6:"0110",7:"0111",8:"1000",9:"1001",a:"1010",b:"1011",c:"1100",d:"1101",e:"1110",f:"1111",A:"1010",B:"1011",C:"1100",D:"1101",E:"1110",F:"1111"};
for(a=0;a<c.length;a+=1)if(d.hasOwnProperty(c[a]))b+=d[c[a]];else return!1;return b},binaryToHex(c){let a,b,d,g,k="";for(a=c.length-1;3<=a;a-=4){d=c.substr(a+1-4,4);for(b=g=0;4>b;b+=1){if("0"!==d[b]&&"1"!==d[b])return!1;g=2*g+parseInt(d[b],10)}k=10<=g?String.fromCharCode(g-10+65)+k:String(g)+k}if(0<=a){for(b=g=0;b<=a;b+=1){if("0"!==c[b]&&"1"!==c[b])return!1;g=2*g+parseInt(c[b],10)}k=String(g)+k}return k},applySettings(c,a,b){const d={};d[a]=c;this._applySettings(d,b)},_applySettings(c,a){if(roles.hasControls()){var b=
Object.keys(c)[0];c=c[b];if((!0===c||!1===c)&&virtualclass.settings.info.hasOwnProperty(b)){if("undefined"===typeof a){var d=virtualclass.connectedUsers;for(let a=0;a<d.length;a++)"s"===d[a].role&&(virtualclass.user.control.changeAttribute(d[a].userid,virtualclass.gObj.testChatDiv.shadowRoot.getElementById(d[a].userid+"contrAudImg"),virtualclass.settings.info.studentaudio,"audio","aud"),virtualclass.user.control.changeAttribute(d[a].userid,virtualclass.gObj.testChatDiv.shadowRoot.getElementById(d[a].userid+
"contrChatImg"),!0,"chat","chat"));localStorage.removeItem("userSettings");virtualclass.settings.user={};virtualclass.settings.info[b]=c;b=virtualclass.settings.settingsToHex(virtualclass.settings.info);virtualclass.settings.send(b,a);localStorage.setItem("settings",b)}else virtualclass.settings.user.hasOwnProperty(a)?(d=virtualclass.settings.parseSettings(virtualclass.settings.user[a]),d[b]=c,b=virtualclass.settings.settingsToHex(d)):(d=virtualclass.settings.info,d[b]=c,b=virtualclass.settings.settingsToHex(d)),
virtualclass.settings.send(b,a),virtualclass.settings.user[a]=b,localStorage.setItem("userSettings",JSON.stringify(virtualclass.settings.user));return!0}return!1}for(b in c)if(virtualclass.settings.info[b]=c[b],"trimRecordings"!==b)virtualclass.settings[b](c[b]);a=virtualclass.settings.settingsToHex(c);localStorage.setItem("settings",a)},send(c,a){roles.hasControls()&&("undefined"!==typeof a?virtualclass.vutil.beforeSend({cf:"settings",Hex:c,toUser:a},a):virtualclass.vutil.beforeSend({cf:"settings",
Hex:c}))},onMessage(c){"string"===typeof c?roles.isStudent()&&(c=virtualclass.settings.parseSettings(c),this._applySettings(c)):this.recording.triggerSetting(c)},studentaudio(c){roles.isStudent()&&(!0===c?(virtualclass.user.control.audioWidgetEnable(!0),virtualclass.gObj.audioEnable=!0):!1===c&&(c=document.querySelector("#speakerPressOnce"),!0!==c.dataset.audioPlaying&&"true"!==c.dataset.audioPlaying||virtualclass.media.audio.clickOnceSpeaker("speakerPressOnce"),virtualclass.user.control.audioDisable(),
virtualclass.gObj.audioEnable=!1))},allowoverride(){console.log("TO DO")},studentpc(c){console.log("TO DO");!0===c?(virtualclass.user.control.allChatEnable(),virtualclass.gObj.chatEnable=!0,document.querySelector("#chatWidget").classList.remove("chat_disabled"),document.querySelector("#chat_div").classList.remove("chat_disabled")):!1===c&&(virtualclass.user.control.allChatDisable(),virtualclass.gObj.chatEnable=!1)},studentgc(){console.log("TO DO")},studentvideo(c){if(roles.isStudent()){const a=document.querySelector(".videoSwitchCont #videoSwitch");
...
attendeeAV(){console.log("TO DO")},recallowattendeeAVcontrol(){console.log("TO DO")},showAttendeeRecordingStatus(){console.log("TO DO")},x16(){console.log("TO DO")},recording:{recordingButton:0,attendeeButtonAction:!0,init(){var c=JSON.parse(localStorage.getItem("recordingButton"));null===c?(this.recordingButton=this.recordingStatus(),localStorage.setItem("recordingButton",this.recordingButton)):this.recordingButton=c;c=JSON.parse(localStorage.getItem("attendeeButtonAction"));null!==c&&(this.attendeeButtonAction=
c);this.showRecordingButton()},toggleRecordingButton(){21===this.recordingButton?this.recordingButton=11:11===this.recordingButton&&(this.recordingButton=21);ioAdapter.setRecording();localStorage.setItem("recordingButton",this.recordingButton);this.showRecordingButton();roles.hasControls()?virtualclass.settings.info.attendeeAV&&ioAdapter.mustSend({ac:this.recordingButton,cf:"recs"}):21===this.recordingButton?(this.attendeeButtonAction=!0,localStorage.setItem("attendeeButtonAction",!0)):(this.attendeeButtonAction=
!1,localStorage.setItem("attendeeButtonAction",!1))},showRecordingButton(){var c=virtualclass.getTemplate("recordingButton");switch(this.recordingButton){case 10:var a={ten:"ten"};break;case 11:a={eleven:"eleven"};break;case 20:a={twenty:"twenty"};break;case 21:a={twentyone:"twentyone"};break;default:return}c=c(a);a=document.querySelector("#docShareNav");let b=document.getElementById("recording");null!==b&&b.remove();a.insertAdjacentHTML("afterend",c);b=document.getElementById("recording");21!==this.recordingButton&&
11!==this.recordingButton||this.attachHandler(b)},attachHandler(c){c.addEventListener("click",this.recordingButtonAction.bind(this,c))},recordingButtonAction(){21!==this.recordingButton&&11!==this.recordingButton||this.toggleRecordingButton()},recordingStatus(){if(virtualclass.settings.info.enableRecording)return roles.hasControls()?virtualclass.settings.info.recShowPresentorRecordingStatus?virtualclass.settings.info.recAllowpresentorAVcontrol?21:20:22:virtualclass.settings.info.attendeeAV?virtualclass.settings.info.showAttendeeRecordingStatus?
virtualclass.settings.info.recallowattendeeAVcontrol?21:20:22:virtualclass.settings.info.showAttendeeRecordingStatus?10:0;if(roles.hasControls()){if(virtualclass.settings.info.recShowPresentorRecordingStatus)return 10}else if(virtualclass.settings.info.showAttendeeRecordingStatus)return 10;return 0},sendYesOrNo(){return 20===this.recordingButton||21===this.recordingButton||22===this.recordingButton?"yes":"no"},triggerSetting(c){if(virtualclass.settings.info.attendeeAV){switch(c.ac){case 11:this.recordingButton=
