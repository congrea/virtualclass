...
null!==b&&-1<b.indexOf(c)?(this.makeActiveTool(b,c),b=b.split("_")[1],virtualclass.wb[c].selectedTool=b,"activeAll"!==virtualclass.wb[c].selectedTool&&virtualclass.wb[c].activeAllObj.disable(c)):virtualclass.wb[c].selectedTool&&(b=`t_${virtualclass.wb[c].selectedTool}${c}`,this.makeActiveTool(b,c));virtualclass.wb[c].selectedTool&&"text"===virtualclass.wb[c].selectedTool?WhiteboardUtility.fontSizeSelector(c):-1<virtualclass.wbWrapper.shapes.indexOf(virtualclass.wb[c].selectedTool)&&WhiteboardUtility.strokeSizeSelector(c);
virtualclass.wb[c].toolColor&&(console.log("====> apply color background"),document.querySelector(`#t_color${c} .disActiveColor`).style.backgroundColor=virtualclass.wb[c].toolColor)}static updateToolStyle(c,b,a){a||(a=virtualclass.gObj.currWb);"color"===c?virtualclass.wb[a].toolColor=b:"strk"===c?virtualclass.wb[a].strokeSize=b:"font"===c&&(virtualclass.wb[a].fontSize=b)}static strokeSizeSelector(c){c=c||virtualclass.gObj.currWb;var b=document.querySelector(`#t_font${c}`);null!=b&&(b.classList.remove("show"),
b.classList.add("hide"));b=document.querySelector(`#t_strk${c}`);null!=b&&(b.classList.remove("hide"),b.classList.add("show"));WhiteboardUtility.fontAndStrokeSizeUi("strk",c,"stroke","li",virtualclass.wb[c].strokeSize)}static fontAndStrokeSizeUi(c,b,a,d,f){const g=document.querySelector(`#t_${c}${b} ${d}.selected`);null!=g&&g.classList.remove("selected");c=document.querySelector(`#t_${c}${b} ${d}[data-${a}='${f}']`);null!=c&&c.classList.add("selected")}static fontSizeSelector(c){c=c||virtualclass.gObj.currWb;
var b=document.querySelector(`#t_strk${c}`);null!=b&&(b.classList.remove("show"),b.classList.add("hide"));b=document.querySelector(`#t_font${c}`);null!=b&&(b.classList.remove("hide"),b.classList.add("show"));WhiteboardUtility.fontAndStrokeSizeUi("font",c,"font","span",virtualclass.wb[c].fontSize)}static themeColorShapes(c,b){c=c.split(/_doc_*/)[0];b=document.querySelector(`#tool_wrapper${b}.shapesToolbox`);"t_line"===c||"t_circle"===c||"t_rectangle"===c||"t_triangle"===c?b.classList.add("active"):
...
WhiteboardUtility.strokeSizeSelector())}innerToolbarHandler(c,b){WhiteboardUtility.closeTray();this.selectTool(c);if("rectangle"!==c&&"line"!==c&&"circle"!==c&&"triangle"!==c&&"text"!==c)this[c](b);else"text"===c?(this.activeAllObj.enable(b,"i-text"),this.activeAllObj.disableBut(b,"i-text"),delete virtualclass.wbWrapper.gObj.textSelected,this.textObj.textEditing=!1):this.activeAllObj.disable(b);"activeAll"===c?this.activeAllObj.makeTextUnEditable(b):this.activeAllObj.makeTextEditable(b)}shapes(){const c=
...
m.id=b;"undefined"!==typeof c&&(m.className=c);m.dataset.tool=a;c=document.createElement("span");c.className=`icon-${a}`;k.appendChild(c);k.dataset.title=f;k.className="tooltip";m.appendChild(k);"t_reclaim"===b?(b=document.getElementById("virtualclassAppLeftPanel"),d.appendChild(m),b.insertBefore(d,b.firstChild)):d.appendChild(m)},renderWhiteboardObjectsIfAny(){"object"===typeof virtualclass.wb&&0<virtualclass.wb[virtualclass.gObj.currWb].vcan.main.children.length&&virtualclass.wb[virtualclass.gObj.currWb].vcan.renderAll()},
createCommandWrapper(b){var {vcan:a}=virtualclass.wb[b];const d=document.createElement("div");d.id=virtualclass.gObj.commandToolsWrapperId[b];d.className="commandToolsWrapper";a=document.getElementById(a.canvasWrapperId);null!=a?document.getElementById(`containerWb${b}`).insertBefore(d,a):document.getElementById(`containerWb${b}`).appendChild(d);return d},createRoleWrapper(){const b=document.createElement("div");b.id="commandToolsWrapper_doc_0_0";b.className="commandToolsWrapper";return b},whoIsTeacher(){if(Object.prototype.hasOwnProperty.call(virtualclass,
"connectedUsers"))for(let b=0;b<virtualclass.connectedUsers.length;b++)if("t"===virtualclass.connectedUsers[b].role)return virtualclass.connectedUsers[b].userid},getTeacherInstance(){if(Object.prototype.hasOwnProperty.call(virtualclass,"connectedUsers"))for(let b=0;b<virtualclass.connectedUsers.length;b++)if("t"===virtualclass.connectedUsers[b].role)return virtualclass.connectedUsers[b];return 0},getMySelf(){if(Object.prototype.hasOwnProperty.call(virtualclass,"connectedUsers"))for(let b=0;b<virtualclass.connectedUsers.length;b++)if(virtualclass.connectedUsers[b].userid===
virtualclass.gObj.uid)return virtualclass.connectedUsers[b]},enablePresentatorEditors(b){b={toUser:b,status:!0};virtualclass.user.control.receivedEditorRich(b);virtualclass.user.control.receivedEditorCode(b)},getClassName(b){let a;"t"===b?a="teacher":"e"===b?a="educator":"s"===b?a="student":"p"===b&&(a="presenter");return a},isPresenterExist(){for(let b=0;b<virtualclass.connectedUsers.length;b++)if("p"===virtualclass.connectedUsers[b].role)return!0;return!1},setReadModeWhenTeacherIsDisConn(b){if(!roles.hasAdmin()){let a=
localStorage.getItem("oTDisconn");null!=a&&(a=JSON.parse(a))&&Object.prototype.hasOwnProperty.call(virtualclass,b)&&"object"===typeof virtualclass[b].cm&&virtualclass[b].cm.setOption("readOnly","nocursor")}},setReadModeWhenTeacherIsConn(b){localStorage.removeItem("oTDisconn");const a=document.getElementById(`${virtualclass.vutil.capitalizeFirstLetter(b)}writeModeBox`);null!=a&&("true"===a.getAttribute("data-write-mode")?virtualclass[b].cm.setOption("readOnly",!1):virtualclass[b].cm.setOption("readOnly",
"nocursor"))},isTeacherAlreadyExist(b){if(Object.prototype.hasOwnProperty.call(virtualclass,"connectedUsers"))for(let a=0;a<virtualclass.connectedUsers.length;a++)if(("t"===virtualclass.connectedUsers[a].role||"e"===virtualclass.connectedUsers[a].role)&&virtualclass.connectedUsers[a].userid!==b)return!0;return!1},getPresenterId(){if(Object.prototype.hasOwnProperty.call(virtualclass,"connectedUsers"))for(let b=0;b<virtualclass.connectedUsers.length;b++)if("p"===virtualclass.connectedUsers[b].role)return virtualclass.connectedUsers[b].userid;
return!1},isEducatorAlreadyExist(b){if(Object.prototype.hasOwnProperty.call(virtualclass,"connectedUsers"))for(let a=0;a<virtualclass.connectedUsers.length;a++)if("e"===virtualclass.connectedUsers[a].role&&virtualclass.connectedUsers[a].userid!==b)return!0;return!1},isOrginalTeacherExist(b){if(Object.prototype.hasOwnProperty.call(virtualclass,"connectedUsers"))for(let a=0;a<virtualclass.connectedUsers.length;a++)if("t"===virtualclass.connectedUsers[a].role&&virtualclass.connectedUsers[a].userid!==
b)return!0;return!1},createBecomeTeacherWidget(){if(null==document.getElementById("beTeacher")){const a=document.createElement("div");a.id="beTeacher";var b=document.createElement("a");b.id=`${a.id}Anchor`;b.innerHTML=virtualclass.lang.getString("becomeTeacher");a.appendChild(b);b=document.getElementById("virtualclassCont");b.insertBefore(a,b.firstChild);a.addEventListener("click",virtualclass.vutil.initTeacherRole);a.style.pointerEvents="none";a.style.opacity="0.5";setTimeout(()=>{a.style.pointerEvents=
"visible";a.style.opacity="1"},6E4)}},removeBecomeTeacherWidget(){const b=document.getElementById("beTeacher");null!=b&&b.parentNode.removeChild(b)},initTeacherRole(){ioAdapter.send({cf:"bt"});virtualclass.vutil.removeBecomeTeacherWidget();setTimeout(()=>{virtualclass.vutil.isOrginalTeacherExist(virtualclass.jId)||virtualclass.vutil.overrideRoles("t");c.location.reload()},virtualclass.gObj.mySetTime)},overrideRoles(b){virtualclass.uInfo.userobj.role=b;virtualclass.gObj.uRole=virtualclass.uInfo.userobj.role;
wbUser.role=virtualclass.uInfo.userobj.role;const a=document.getElementById("virtualclassCont");virtualclass.vutil.overrideRolesFromElem(a,b)},overrideRolesFromElem(b,a){"s"===a?(b.classList.remove("teacher"),b.classList.remove("orginalTeacher"),b.classList.remove("presenter"),b.classList.remove("educator"),virtualclassCont.classList.add("student")):"p"===a?(b.classList.remove("teacher"),b.classList.remove("orginalTeacher"),b.classList.remove("educator"),virtualclassCont.classList.add("student"),
virtualclassCont.classList.add("presenter")):"e"===a?(b.classList.add("teacher"),b.classList.remove("student"),b.classList.remove("presenter"),b.classList.add("educator"),b.classList.add("orginalTeacher")):"t"===a&&(b.classList.remove("student"),b.classList.remove("educator"),b.classList.remove("presenter"),b.classList.add("teacher"),b.classList.add("orginalTeacher"))},sesionEndMsgBoxIsExisting(){const b=document.getElementById("sessionEndMsgCont");return b.hasAttribute("data-displaying")&&"true"===
b.dataset.displaying},removeVideoHostContainer(){const b=document.getElementById("videoHostContainer");null!=b&&b.parentNode.removeChild(b)},createDummyUser(b){let a=b;a=a?b:5E3;let d,c=0,g=31;const k=setInterval(()=>{c>a?clearInterval(k):(g+=c,d={joinUser:{key:g},message:[{lname:" ",name:`User${g}`,role:"s",userid:g}],newuser:null,type:"member_added",user:!0},c++,virtualclass.ioEventApi.readyto_member_add(d))},1)},getVisibleHeightElem(b){var a=$(b);b=$(c).scrollTop();const d=b+$(c).height(),f=a.offset().top;
a=f+a.outerHeight();return(a>d?d:a)-(f<b?b:f)},applyHeight(b){b=document.getElementById("virtualclassAppRightPanel");const a=this.getVisibleHeightElem("virtualclassCont");b.style.height=null!=a?a:c.innerHeight},insertIntoLeftBar(b){const a=document.querySelector("#virtualclassApp #virtualclassAppLeftPanel");null!=a?a.appendChild(b):alert("Error:- There is no Element to insert it.")},getWhiteboardId(b){b=b.closest(".vcanvas");if(null!=b)return b.dataset.wbId;alert("doc element is null")},getElementOffset(b){let a=
0,d=0;do a+=b.offsetTop||0,d+=b.offsetLeft||0,b=b.offsetParent;while(b);return{x:d,y:a}},updateCurrentDoc(b){virtualclass.gObj.currWb=`_doc_${b}_${b}`},getParentTag(b,a){return b.closest(a)},attachEventToUploadTab(b,a,d){b=document.getElementById("newDocBtn");null!=b&&(b.removeEventListener("click",virtualclass.vutil._attachEventToUploadTab),b.addEventListener("click",virtualclass.vutil._attachEventToUploadTab))},_attachEventToUploadTab(){var b=document.querySelector("#DocumentShareDashboard .qq-upload-button-selector.qq-upload-button input");
if(null!=b){if(b.click(),b=document.querySelector("#DocumentShareDashboard .qq-upload-list-selector.qq-upload-list"))b.style.display="block"}else alert("Element is null")},attachEventToUpload(b,a,d){b=document.getElementById("uploadVideo");null!=b&&b.addEventListener("click",()=>{const a=document.querySelector("#VideoDashboard .qq-upload-button-selector.qq-upload-button input");null!=a?a.click():alert("Element is null")})},modalPopup(b,a){const d={};if("video"===b){const a=document.querySelector("#listvideo .playing");
a&&(this.currPlaying=a.getAttribute("data-rid"));d.validation="mp4 avi wmv mov webm mkv vob mpeg".split(" ");d.cb=virtualclass.videoUl.afterUploadVideo;d.cthis="video";d.maxSize=512E6;d.requesteEndPoint=`${c.webapi}&methodname=file_save&live_class_id=${virtualclass.gObj.congCourse}&status=1&content_type_id=2&user=${virtualclass.gObj.uid}`}else d.validation="doc docx txt html csv pdf ppt pptx xls xlsx xlt png jpg gif svg tiff rtf xpm".split(" "),d.cb=virtualclass.dts.onAjaxResponse,d.cthis="docs",
d.maxSize=1E8,d.requesteEndPoint=`${c.webapi}&methodname=congrea_image_converter&live_class_id=${virtualclass.gObj.congCourse}&status=1&content_type_id=1&user=${virtualclass.gObj.uid}`;d.multiple=!1;d.wrapper=document.getElementById(a[0]);virtualclass.fineUploader.uploaderFn(d);"video"!==b&&(b=document.querySelector("#DocumentShareDashboard #docsUploadMsz"),a=document.createElement("div"),b&&b.appendChild(a))},async xhrSendWithForm(b,a){const d=new FormData;for(const a in b)d.append(a,b[a]);return await this.vxhr.post("undefined"===
typeof a?c.webapi:`${c.webapi}&methodname=${a}&user=${virtualclass.gObj.uid}`,d)},createSaveButton(){const b=document.createElement("div");b.id="tech_support_save";const a=document.createElement("span");a.innerHTML="Save Session";b.appendChild(a);return b},setChatContHeight(b){},setChatHeight(b){},alreadyConnected(b){return 0<virtualclass.connectedUsers.length?0<virtualclass.connectedUsers.filter(a=>a.userid==b).length:!1},miliSecondsToFormatedTime(b){return[Math.floor(b/36E5%24),Math.floor(b/6E4%
60),Math.floor(b/1E3%60)]},localToUTC(){var b=new Date;b=Date.UTC(b.getUTCFullYear(),b.getUTCMonth(),b.getUTCDate(),b.getUTCHours(),b.getUTCMinutes(),b.getUTCSeconds());return new Date(b)},UTCtoLocalTimeToSeconds(b){return(new Date(b)).getTime()},appIsForEducator(b){for(const a in virtualclass.apps)if(virtualclass.apps[a]===b)return!1;return!0},getDocsDashBoard(b){const a=virtualclass.getTemplate("dashboard","documentSharing");b={app:b,hasControls:roles.hasControls()};return a(b)},getPptDashBoard(b){const a=
virtualclass.getTemplate("dashboard","ppt");b={app:b,hasControls:roles.hasControls()};return a(b)},removeDashboardNav(){const b=document.querySelector("#dashboardnav");null!=b&&b.parentNode.removeChild(b)},makeElementDeactive(b){b=document.querySelector(b);null!=b&&(b.style.pointerEvents="none")},makeElementActive(b){b=document.querySelector(b);null!=b&&(b.style.pointerEvents="visible")},initCommonSortingChat(){setTimeout(()=>{sortCommonChat()},800)},triggerDashboard(b,a){"DocumentShare"===b?null==
document.querySelector("#screen-docs .note.current")&&(a?virtualclass.dashboard.init(b,a):virtualclass.dashboard.init(b)):"Video"===b?a?virtualclass.dashboard.init(b,a):virtualclass.dashboard.init(b):virtualclass.dashboard.init(b)},trimExtension(b){return b.replace(/\.[^/.]+$/,"")},hideUploadMsg(b){b=document.querySelector(`#${b} .qq-uploader-selector.qq-uploader.qq-gallery`);null!=b&&b.setAttribute("qq-drop-area-text","")},showUploadMsg(b){b=document.querySelector(`#${b} .qq-uploader-selector.qq-uploader.qq-gallery`);
null!=b&&b.setAttribute("qq-drop-area-text",virtualclass.lang.getString("dropfilehere"))},audioStatus(b,a){const d=b.getElementsByClassName("congtooltip")[0];"true"===a?(b.setAttribute("data-audio-playing","true"),d.setAttribute("data-title",virtualclass.lang.getString("audioEnable")),b.className="audioTool active"):(b.setAttribute("data-audio-playing","false"),d&&d.setAttribute("data-title",virtualclass.lang.getString("audioDisable")),b.className="audioTool deactive")},selfVideoStatus(){const b=
document.querySelector(".congrea .videoSwitchCont #videoSwitch");if(b.classList.contains("off"))return"off";if(b.classList.contains("on"))return"on"},videoController(){const b=document.querySelector(".congrea .videoSwitchCont");b&&b.addEventListener("click",()=>{virtualclass.vutil.videoHandler("off"===virtualclass.vutil.selfVideoStatus()?"on":"off")})},videoHandler(b,a){let d;var c=document.querySelector(".congrea .videoSwitchCont #videoSwitch");if("on"===b){c.classList.remove("off");c.classList.add("on");
d="on";c=document.querySelector(".videoSwitchCont");c.dataset.title="Video off";roles.hasControls()?virtualclass.videoHost.gObj.videoSwitch=1:virtualclass.videoHost.gObj.stdStopSmallVid=!1;c=chatContainerEvent.elementFromShadowDom(`#ml${virtualclass.gObj.uid} .user-details a span`);const a=chatContainerEvent.elementFromShadowDom(`#ml${virtualclass.gObj.uid} .user-details a img`);c||a?virtualclass.videoHost.removeUserIcon(virtualclass.gObj.uid):virtualclass.gObj.delayVid="hide";roles.hasControls()&&
virtualclass.videoHost.UI.displayTeacherVideo();const b=document.querySelector(`#ml${virtualclass.gObj.uid} video`);null!=b&&setTimeout(()=>{b.srcObject=virtualclass.media.stream},100)}else"off"===b&&(c.classList.remove("on"),c.classList.add("off"),d="off",c=document.querySelector(".videoSwitchCont"),c.dataset.title="Video on",virtualclass.videoHost&&(roles.hasControls()?virtualclass.videoHost.gObj.videoSwitch=0:virtualclass.videoHost.gObj.stdStopSmallVid=!0),chatContainerEvent.elementFromShadowDom(`#ml${virtualclass.gObj.uid} .user-details a .videoWrapper`)?
virtualclass.videoHost.setUserIcon(virtualclass.gObj.uid):virtualclass.gObj.delayVid="display",roles.hasControls()&&virtualclass.videoHost.UI.hideTeacherVideo());"undefined"===typeof a&&(virtualclass.gObj.meetingMode?virtualclass.multiVideo.setVideoStatus("off"!==b):virtualclass.gObj.uid===virtualclass.vutil.whoIsTeacher()&&ioAdapter.mustSend({congCtr:{videoSwitch:d},cf:"congController"}),roles.hasControls()||ioAdapter.mustSend({stdVideoCtr:{videoSwitch:virtualclass.videoHost.gObj.stdStopSmallVid},
cf:"stdVideoCtrl"}))},isChromeExtension(){c.postMessage({type:"isInstalled",id:1},"*");c.addEventListener("message",b=>{"yes"===b.data.type&&(virtualclass.gObj.chromeExt=!0)})},setWidth(b,a,d){document.querySelector(`#canvas${b}`).width=d},setHeight(b,a,d){document.querySelector(`#canvas${b}`).height=d},getWidth(b){return b.width},getHeight(b){return b.height},getValueWithoutPixel(b){return parseInt(b,10)},removeDecimal(b){return b.toFixed(2)},getElemM(b,a){let d;"Y"===a?d=document.querySelector(`#${b}`).offsetHeight:
"X"===a&&(d=document.querySelector(`#${b}`).offsetWidth);return this.getValueWithoutPixel(d)},getElemM2(b,a){let d;"Y"===a?d=document.querySelector(`#${b}`).offsetHeight:"X"===a&&(d=document.querySelector(`#${b}`).offsetWidth);return this.getValueWithoutPixel(d)},getElemHeight(b){b=document.querySelector(`#${b}`).offsetHeight;return this.getValueWithoutPixel(b)},getElemWidth(b){b=document.querySelector(`#${b}`).offsetWidth;return this.getValueWithoutPixel(b)},visibleElementHeighOldt(b,a){let d=0;
for(b=document.getElementById(b);b.offsetParent&&b.offsetParent.id!==a;)d+=b.offsetTop,b=b.offsetParent;return b.offsetHeight-d},elementIsVisible2(b){const a=b.getBoundingClientRect().top;b=b.getBoundingClientRect().bottom;return 0<=a&&b<=c.innerHeight},elementIsVisible(b){b=b.getBoundingClientRect();const a=Math.max(document.documentElement.clientHeight,c.innerHeight);return!(0>b.bottom||0<=b.top-a)},getVisibleHeight(b){var a=$(`#${b}`);b=$(c).scrollTop();const d=b+$(c).height(),f=a.offset().top;
a=f+a.outerHeight();return(a>d?d:a)-(f<b?b:f)},isNumeric(b){return!isNaN(parseFloat(b))&&isFinite(b)},setContainerDimension(b,a){},setDefaultScroll(){if(roles.hasControls()&&("Whiteboard"===virtualclass.currApp||"DocumentShare"===virtualclass.currApp)){const b=virtualclass.gObj.currWb;null!=b&&"object"===typeof virtualclass.pdfRender[b]&&null!=virtualclass.pdfRender[b].canvasWrapper&&(virtualclass.pdfRender[b].canvasWrapper.scrollTop=1)}},createWhiteBoard(b,a){virtualclass.appInitiator.Whiteboard.call(virtualclass,
{app:virtualclass.currApp,cusEvent:"byclick",data:b,position:a})},createHashString(b){let a=0;const d=b.length;for(let c=0;c<d;c++)a=31*a+b.charCodeAt(c),a&=a;return a},randomString(b){let a="";for(;0<b;--b)a+="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"[Math.round(61*Math.random())];return a},isBulkDataFetched(){return 0<virtualclass.serverData.rawData.video.length||0<virtualclass.serverData.rawData.docs.length||0<virtualclass.serverData.rawData.ppt.length},sendOrder(b,a){virtualclass.orderList["vid"===
b?"Video":"docs"===b?"DocumentShare":"presentation"===b?"SharePresentation":virtualclass.currApp].ol.order=a;virtualclass.config.makeWebSocketReady&&(b={order:JSON.stringify(virtualclass.orderList)},virtualclass.xhrn.vxhrn.post(virtualclass.api.UpdateRoomMetaData,b).then(a=>{console.log(a)}))},saveWbOrder(b){},requestOrder(b){virtualclass.config.makeWebSocketReady&&virtualclass.xhrn.vxhrn.post(virtualclass.api.GetRoomMetaData,{noting:!0}).then(a=>{if(null!=a.data.Item&&a.data.Item.order.S&&virtualclass.vutil.IsJsonString(a.data.Item.order.S)){a=
JSON.parse(a.data.Item.order.S);for(const b in a)if("SharePresentation"===b||"DocumentShare"===b||"Video"===b)"object"!==typeof virtualclass.orderList[b]&&(virtualclass.orderList[b]=new OrderedList),virtualclass.orderList[b].ol=a[b].ol;b("ok")}})},IsJsonString(b){try{JSON.parse(b)}catch(a){return!1}return!0},removeChildrens(b){b=document.querySelectorAll(b);for(let a=0;a<b.length;a++)b[a].parentNode.removeChild(b[a])},initAcitveElement(){let b,a;"Video"===virtualclass.currApp?(b="#VideoDashboard .qq-uploader-selector.qq-uploader.qq-gallery",
a="#listvideo"):"DocumentShare"===virtualclass.currApp&&(b="#DocumentShareDashboard .qq-uploader-selector.qq-uploader.qq-gallery",a="#listdocs");const d=document.querySelector(`#${virtualclass.currApp}Dashboard`);null==d||d.classList.contains("uploading")?virtualclass.vutil.makeElementDeactive(b):(virtualclass.vutil.makeElementActive(b),virtualclass.vutil.makeElementDeactive(a))},isResponseAvailable(b){return null!=b&&"undefined"!==typeof b&&null!=b},navWhiteboard(b,a,d){const c=virtualclass.gObj.currWb;
virtualclass.vutil.isTextWrapperExist()&&virtualclass.wb[c].obj.drawTextObj.finalizeTextIfAny(void 0,c);"undefined"!==typeof d?a.call(b,d):a.call(b)},removeAllTextWrapper(){const b=document.querySelectorAll(".canvasWrapper .textBoxContainer");for(let a=0;a<b.length;a++)b[a].parentNode.removeChild(b[a])},isDashboardOpened(b){b=document.querySelector("#dashboardnav button");return null!=b&&b.classList.contains("clicked")},stopConnection(){io.webSocketConnected()&&io.disconnect();virtualclass.gObj.invalidlogin=
...
a,d){c.Worker&&webpToPng.postMessage({vdata:b,canid:a.id});c.Worker&&(webpToPng.onmessage=function(a){var b="videoParticipate"===a.data.canid?document.querySelector(`#${a.data.canid}`):chatContainerEvent.elementFromShadowDom(`#${a.data.canid}`);const d=b.getContext("2d"),c=d.createImageData(b.width,b.height);b.height=a.data.bh;b.width=a.data.bw;c.data.set(a.data.vdata);d.putImageData(c,0,0);virtualclass.gObj.isReadyForVideo=!0})},isSessionEnded(){if(!virtualclass.isPlayMode&&virtualclass.endSession)return localStorage.clear(),
!0},afterPdfPrefetch(b,a){virtualclass.gObj.nextPdf={};virtualclass.gObj.nextPdf[b]=a},getCurrentFormattedTime(b){b=this.UTCtoLocalTimeToSeconds(b);var a=new Date(b);b=a.getHours();a=`0${a.getMinutes()}`;return`${b}:${a.substr(-2)}`},hideFullScreenButton(){console.log("=====> full screen show hide");document.querySelector("#fullScreenButton").style.display="none";document.querySelector("#fullScreenExitButton").style.display="block";virtualclass.gObj.fullScreenMode=!0;virtualclass.gObj.notHandleInputFocusHandler=
!0},showFullScreenButton(){console.log("=====> full screen show show");document.querySelector("#fullScreenButton").style.display="block";document.querySelector("#fullScreenExitButton").style.display="none";virtualclass.gObj.fullScreenMode=!1;virtualclass.gObj.notHandleInputFocusHandler=!0},showFullScreenButtonIfNeed(){console.log("====> show video full screen 1");virtualclass.gObj.fullScreenMode&&this.showFullScreenButton()},storeWhiteboardAtInlineMemory(b){const a=virtualclass.gObj.currWb;"object"!==
...
virtualclass.lang.getString("requestScreenShare"))))},hidePageNumber(){const b=document.querySelector("#docShareNav");null!==b&&(b.classList.add("hide"),b.classList.remove("show"))},sendSpeedByMobile(b){"mobTab"===virtualclass.system.desktop&&ioAdapter.sendSpeed(b)},isRefreshMode(){return virtualclass.config.makeWebSocketReady},triggerFinalizeTextIfAny(b){},inputFocusHandler(b){console.log("====> focus input");b&&"string"!==typeof b&&virtualclass.isPlayMode&&virtualclass.userInteractivity.triggerPause();
c.innerWidth>c.innerHeight&&(virtualclass.gObj.initHeight=c.innerHeight,b=document.querySelector("#tabs .ui-state-focus"),"mobTab"===virtualclass.system.device&&null==b&&"Safari"!=virtualclass.system.mybrowser.name&&document.getElementById("virtualclassCont").classList.add("focusInput"))},inputFocusOutHandler(){console.log("====> focus output");"mobTab"===virtualclass.system.device&&document.getElementById("virtualclassCont").classList.remove("focusInput")},checkUserRole(){return virtualclass.isPlayMode?
"t"===wbUser.orginalUserRole:"t"===virtualclass.gObj.uRole||"p"===virtualclass.gObj.uRole},closeElement(b){b.classList.contains("open")&&(b.classList.remove("open"),b.classList.add("close"))},canvasDimensionFromPixel(b){const a=parseFloat(c.getComputedStyle(b).width);b=parseFloat(c.getComputedStyle(b).height);return{width:a,height:b}}}})(window);let globalImageData={};
