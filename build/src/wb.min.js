...
console.log("=====> full screen show ask hide exit"),virtualclass.gObj.rightbarFullScreenMode=!1,virtualclass.gObj.ignoreFullScreen||document.querySelector("html").classList.contains("pwa")||virtualclass.vutil.showFullScreenButton()):(virtualclass.gObj.rightbarFullScreenMode=!0,console.log("=====> full screen show ask show exit ")):virtualclass.gObj.fullScreenMode?virtualclass.vutil.showFullScreenButton():virtualclass.vutil.hideFullScreenButton();delete virtualclass.gObj.ignoreFullScreen},makeReadySocket(){virtualclass.vutil.isPlayMode()||
...
triggerFinalizeTextIfAny(b){},checkUserRole(){return virtualclass.isPlayMode?"t"===wbUser.orginalUserRole:"t"===virtualclass.gObj.uRole||"p"===virtualclass.gObj.uRole},closeElement(b){b.classList.contains("open")&&(b.classList.remove("open"),b.classList.add("close"))},canvasDimensionFromPixel(b){const a=parseFloat(c.getComputedStyle(b).width);b=parseFloat(c.getComputedStyle(b).height);return{width:a,height:b}}}})(window);let globalImageData={};
