...
n._q.push(()=>{m.addTest=f});n.addAsyncTest(()=>{function a(a,b,c){function g(b){const g=b&&"load"===b.type?1==k.width:!1;f(a,"webp"===a&&g?new Boolean(g):g);c&&c(b)}var k=new Image;k.onerror=g;k.onload=g;k.src=b}const b=[{uri:"data:image/webp;base64,UklGRiQAAABXRUJQVlA4IBgAAAAwAQCdASoBAAEAAwA0JaQAA3AA/vuUAAA=",name:"webp"},{uri:"data:image/webp;base64,UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAwAAAABBxAR/Q9ERP8DAABWUDggGAAAADABAJ0BKgEAAQADADQlpAADcAD++/1QAA==",name:"webp.alpha"},{uri:"data:image/webp;base64,UklGRlIAAABXRUJQVlA4WAoAAAASAAAAAAAAAAAAQU5JTQYAAAD/////AABBTk1GJgAAAAAAAAAAAAAAAAAAAGQAAABWUDhMDQAAAC8AAAAQBxAREYiI/gcA",
...
makeElemEnable(a){virtualclass.vutil.elemHasAnyClass(a.id)?(a.classList.remove("disable"),a.classList.add("enable")):a.className="enable";a=a.getElementsByClassName("ui-chatbox-input-box")[0];null!=a&&(a.disabled=!1)},toggleAllEditorController(a,c){a=virtualclass.vutil.smallizeFirstLetter(a);const b=chatContainerEvent.elementFromShadowDom(".controleCont","all");if(0<b.length)for(let g=0;g<b.length;g++)if(0<b[g].id.indexOf(a)){var f=b[g].id.indexOf("Cont");0<f&&(f=b[g].id.substr(0,f),f=chatContainerEvent.elementFromShadowDom(`${f}Img`,
...
function(){virtualclass.vutil.navWhiteboard(a,a.prev);"object"===typeof virtualclass.wb[virtualclass.gObj.currWb]&&setTimeout(()=>{console.log("whiteboard zoom normal render");virtualclass.zoom.normalRender()},500)})},initNav(a){"undefined"===typeof this.indexNav&&(this.indexNav=new pageIndexNav("WB"));this.indexNav.init();if(roles.hasControls()){virtualclass.wbCommon.indexNav.createWbNavigationNumber(a.length);virtualclass.wbCommon.indexNav.addActiveNavigation(virtualclass.gObj.currWb);var b=localStorage.getItem("wbOrder");
null!=b&&(b=JSON.parse(b),virtualclass.wbCommon.order=b);1<this.order.length&&(virtualclass.wbCommon.rearrangeNav(this.order),this.rearrange(this.order),b=localStorage.getItem("currIndex"),null!==b&&this.indexNav.createWbNavigationNumber(b))}else virtualclass.wbCommon.indexNav.studentWBPagination(virtualclass.gObj.currIndex||virtualclass.gObj.currSlide);virtualclass.wbCommon.indexNav.setTotalPages(a.length)},displaySlide(a){this.hideElement();const b=document.querySelector(`#note${a}`);null!=b&&(b.classList.add("current"),
virtualclass.gObj.currWb=a);this.identifyFirstNote(a);this.identifyLastNote(a);roles.hasControls()||"undefined"!==typeof virtualclass.wbCommon.indexNav&&virtualclass.wbCommon.indexNav.studentWBPagination(virtualclass.gObj.currIndex||virtualclass.gObj.currSlide)},hideElement(){const a=document.querySelector("#virtualclassWhiteboard.whiteboard .current");null!=a&&(console.log("Whiteboard slide remove"),a.classList.remove("current"))},currentWhiteboard(a){null==document.querySelector(`#canvas${a}`)&&
...
virtualclass.vutil.beforeSend({cf:"cwb",diswb:!0,wid:a,currIndex:virtualclass.gObj.currIndex})}console.log("==== current slide ",virtualclass.gObj.currSlide)},prev(){this.hideElement();const a=this.whiteboardWrapperExist("prev"),b=+a.split("_doc_0_")[1];this.readyCurrentWhiteboard(a);this.setCurrSlideNumber(a);virtualclass.wbCommon.indexNav.addActiveNavigation(a);virtualclass.wbCommon.indexNav.UI.pageNavHandler("left");const c=document.querySelector(`#${virtualclass.wb[a].prvTool}`);null==c||c.classList.contains("active")||
c.classList.add("active");virtualclass.gObj.currIndex=this.order.indexOf(b)+1;virtualclass.wbCommon.indexNav.setCurrentIndex(virtualclass.gObj.currIndex);console.log("==== current slide ",virtualclass.gObj.currSlide);virtualclass.vutil.beforeSend({cf:"cwb",diswb:!0,wid:a,currIndex:virtualclass.gObj.currIndex})},newPage:async function(){this.hideElement();virtualclass.gObj.wbCount++;-1>=virtualclass.gObj.wIds.indexOf(virtualclass.gObj.wbCount)&&virtualclass.gObj.wIds.push(virtualclass.gObj.wbCount);
const a=`${"_doc_0_"}${virtualclass.gObj.wbCount}`;var b=virtualclass.gObj.currWb.slice(7);const c=this.order.indexOf(b),d=this.whiteboardWrapperExist("next");virtualclass.vutil.createWhiteBoard(a,c);this.displaySlide(a);null==d?(this.order.push(virtualclass.gObj.wbCount),b=this.order.length,virtualclass.wbCommon.indexNav.createWbNavigationNumber(b)):(b=this.order.indexOf(b),this.order.splice(b+1,0,virtualclass.gObj.wbCount),this.rearrange(this.order),this.rearrangeNav(this.order),b+=2,virtualclass.wbCommon.indexNav.createWbNavigationNumber(b));
virtualclass.vutil.beforeSend({cf:"cwb",wbCount:virtualclass.gObj.wbCount,currIndex:b});this.setCurrSlideNumber(a);virtualclass.gObj.currIndex=b;console.log("==== current slide ",virtualclass.gObj.currSlide)},rearrange(a){const b=document.getElementsByClassName("whiteboardContainer")[0],c=document.createElement("div");c.className="whiteboardContainer";for(let b=0;b<a.length;b++){const d=document.getElementById(`note_doc_0_${a[b]}`);d&&c.appendChild(d)}b.parentNode.replaceChild(c,b)},rearrangeNav(a){document.querySelector("#dcPaging").innerHTML=
"";virtualclass.wbCommon.indexNav.createWbNavigationNumber(virtualclass.gObj.wbCount);if("Whiteboard"==virtualclass.currApp)var b=virtualclass.gObj.currWb.split("doc_0_")[1];a=this.order.indexOf(b);var c=document.querySelector(".congrea #dcPaging .noteIndex.active");c&&c.classList.remove("active");if(c=document.querySelector(`#index${b}`))c.classList.add("active"),c.selected="selected";b=document.querySelector("#dcPaging .hid.right.active");const d=document.querySelector("#dcPaging .hid.left.active");
if(b||d)var k=b?b.title:d.title;"Whiteboard"==virtualclass.currApp?this.index=+a+1:(this.index=null!=k?k:null!=c&&"undefined"!==typeof c?c.title:1,virtualclass.dts.order.length||(this.index=0),k=document.querySelector("#docShareNav"),this.index?(k.classList.add("show"),k.classList.remove("hide")):(k.classList.add("hide"),k.classList.remove("show")))},setCurrSlideNumber(a){a=a.split("_");0<a.length&&(virtualclass.gObj.currSlide=a[a.length-1],roles.hasControls()||"undefined"!==typeof virtualclass.wbCommon.indexNav&&
virtualclass.wbCommon.indexNav.studentWBPagination(virtualclass.gObj.currIndex||virtualclass.gObj.currSlide))},readyCurrentWhiteboard(a){null!=a?(this.whiteboardExist(a)||virtualclass.vutil.createWhiteBoard(a),this.displaySlide(a),virtualclass.gObj.currWb=a,console.log(`whiteboard slide send=${virtualclass.gObj.currWb}`)):alert("Elemennt is NULL")},whiteboardExist(a){return null!=document.querySelector(`#canvas${a}`)},whiteboardWrapperExist(a){var b=virtualclass.gObj.currWb;if(null!=b){b=document.querySelector(`#note${b}`);
...
this.UI.isNodeAvailable(".noteIndex.shw.active","prev")?null!=a&&("Whiteboard"==virtualclass.currApp?this.UI.setArrowStatus("leftNavPage","enable"):virtualclass.dts.indexNav.UI._setArrowStatusDocs(c.getElementById("leftNavPage"),"enable","disable")):"Whiteboard"==virtualclass.currApp?this.UI.setArrowStatus("leftNavPage","disable"):virtualclass.dts.indexNav.UI._setArrowStatusDocs(c.getElementById("leftNavPage"),"disable","enable")};a.prototype.addActiveClass=function(a){if("Whiteboard"==virtualclass.currApp){var b=
a.split("doc_0_")[1];var d=virtualclass.gObj.wbCount+1}else d=virtualclass.dts.order.length;(a=c.querySelector(".congrea #dcPaging .noteIndex.active"))&&a.classList.remove("active");b="DocumentShare"==virtualclass.currApp?virtualclass.dts.docs.currNote:b;if(a=c.querySelector(`#index${b}`)){a.classList.add("active");a.selected="selected";var k=c.querySelector("#totalPages");k&&k.parentNode.removeChild(k);k=c.createElement("span");k.id="totalPages";c.querySelector("#pageAnc").appendChild(k);this.setTotalPages(d)}d=
c.querySelector("#dcPaging .hid.right.active");k=c.querySelector("#dcPaging .hid.left.active");if(d||k){if(d){var m=d.value;d="right"}else m=k.value,d="left";this.adjustPageNavigation(parseInt(m),d)}"Whiteboard"==virtualclass.currApp?this.index=+b+1:(this.index=null!=m?m:null!=a&&"undefined"!==typeof a?a.getAttribute("data-set"):1,virtualclass.dts.order.length||(this.index=0),m=c.querySelector("#docShareNav"),virtualclass.dts.order.length?(m.classList.add("show"),m.classList.remove("hide")):(m.classList.add("hide"),
m.classList.remove("show")));m=c.getElementById("teacherCurrPage");null!=m&&(m.innerHTML=this.index)};a.prototype.rearrangePageNavigation=function(a){const b=c.getElementById("dcPaging");if(b){const f=c.createElement("div");f.id="dcPaging";if(null!=f){const g=[];if(this.oldOrder)for(var d=0;d<this.oldOrder.length;d++){var k=this.oldOrder[d];g[k]=c.getElementById(`index${this.oldOrder[d]}`).className}for(d=0;d<a.length;d++){const b=c.getElementById(`index${a[d]}`);this.oldOrder&&(k=this.oldOrder[d],
b.className=g[k]);f.appendChild(b);b.innerHTML=d+1;b.value=d+1}b.parentNode.replaceChild(f,b)}}this.UI.setClassPrevNext();this.addActiveNavigation()};a.prototype.shownPage=function(a){const b=c.querySelectorAll(".noteIndex");a=this.countNumberOfNavigation(a);for(let c=0;c<b.length;c++)b[c].className=c>a?"noteIndex hid right":"noteIndex shw"};a.prototype.countNumberOfNavigation=function(a){return 1200<=a?8:700<=a?5:500<=a?4:2};a.prototype.movePageIndex=function(a){virtualclass.dts.indexNav.addActiveNavigation();
virtualclass.dts.indexNav.UI.setClassPrevNext();virtualclass.dts.indexNav.UI.pageNavHandler(a)};a.prototype.createDocNavigationNumber=function(a,d){var b=virtualclass.getTemplate("docIndex","navigation")({app:virtualclass.currApp,id:a,page:d+1});this.subCont.insertAdjacentHTML("beforeend",b);b=c.querySelector("#index"+a);virtualclass.dts.docs.currNote==a&&(b.classList.add("active"),c.querySelector("#currIndex").innerHTML=d+1);this.index=d+1;b.onclick=virtualclass.dts.docs.goToNavs(a)};a.prototype.createWbNavigationNumber=
function(a){const b="_doc_0_"+a,c=virtualclass.getTemplate("wbIndex","navigation")({app:virtualclass.currApp,id:a,order:a+1,wid:b});this.subCont.insertAdjacentHTML("beforeend",c);virtualclass.wbCommon.indexNav.addActiveNavigation(b);this.setCurrentIndex(a)};a.prototype.newWbpage=function(a){virtualclass.vutil.navWhiteboard(virtualclass.wbCommon,virtualclass.wbCommon.newPage);virtualclass.wbCommon.hasOwnProperty("setNextWhiteboardTime")&&clearTimeout(virtualclass.wbCommon.setNextWhiteboardTime);"Whiteboard"===
...
virtualclass.pdfRender[virtualclass.gObj.currWb].setScrollPosition(d.message)};this.cwb=function(d){if(d.message.hasOwnProperty("diswb")){const {wid:c}=d.message;virtualclass.gObj.currWb=c;virtualclass.wbCommon.whiteboardExist(virtualclass.gObj.currWb)||virtualclass.vutil.createWhiteBoard(virtualclass.gObj.currWb);const a=c.split("_");0<a.length&&(virtualclass.gObj.currSlide=a[a.length-1]);virtualclass.gObj.currIndex=d.message.currIndex;virtualclass.wbCommon.displaySlide(c)}else d.message.hasOwnProperty("wbCount")&&
(virtualclass.gObj.wbCount=d.message.wbCount,-1==virtualclass.gObj.wIds.indexOf(Number(virtualclass.gObj.wbCount))&&(virtualclass.gObj.wIds.push(virtualclass.gObj.wbCount),virtualclass.gObj.currIndex=d.message.currIndex,virtualclass.wbCommon.indexNav.studentWBPagination(virtualclass.gObj.currIndex)))};this.reqscreen=function(d){"mobTab"==virtualclass.system.device||"Chrome"!=virtualclass.system.mybrowser.name&&"Firefox"!=virtualclass.system.mybrowser.name&&"Edge"!=virtualclass.system.mybrowser.name?
...
d.fromUser.userid;virtualclass.vutil.initssSharing(d.fromUser.userid)};this.sview=function(d){const c=document.getElementById("virtualclassScreenShareLocal");roles.isStudent()&&!virtualclass.gObj.studentSSstatus.mesharing&&null!=c&&(c.style.display="none");d.message.hasOwnProperty("firstSs")&&(virtualclass.gObj.studentSSstatus.sharing=!0);virtualclass.gObj.studentSSstatus.shareToAll=!1;console.log("Share, self view")};this.sToAll=function(){const d=document.getElementById("virtualclassScreenShareLocal");
