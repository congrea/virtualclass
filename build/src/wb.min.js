...
c.y);a.e.isTrusted&&this.activeDown&&this.down&&(this.down=!1,WhiteboardMessage.send(virtualclass.wbWrapper.gObj.previousData),b=this.generateData(a,b,"u"),WhiteboardMessage.send(b))}};class WhiteboardReplay{init(c){this.objs=virtualclass.wb[c].vcanMainReplayObjs;this.objNo=0}renderObj(c){const b=virtualclass.wbWrapper.protocol.decode(this.objs[this.objNo],c);switch(b.action){case "sp":virtualclass.wb[c].selectedTool=b.tool;console.log("====> selected id suman for  ",c,virtualclass.wb[c].selectedTool);var a=b.event;var d=`${b.shape}Obj`;virtualclass.wb[c][d][a](b.actual,virtualclass.wb[c]);break;case "ac":a=virtualclass.wb[c].canvas;virtualclass.wb[c].selectedTool=b.tool;b.event&&
"mousedown"===b.event&&virtualclass.wb[c].innerToolbarHandler(virtualclass.wbWrapper.keyMap[b.action],c);d=WhiteboardUtility.readyMouseEvent(b.event,b.actual);d.wId=c;a.upperCanvasEl.dispatchEvent(d);b.event&&"mousedown"===b.event&&(c=a._getEventPrefix(),fabric.util.removeListener(fabric.document,`${c}move`,a._onMouseMove,{passive:!1}),fabric.util.removeListener(fabric.document,`${c}up`,a._onMouseUp,{passive:!1}),fabric.util.addListener(a.upperCanvasEl,`${c}move`,a._onMouseMove,{passive:!1}),fabric.util.addListener(a.upperCanvasEl,
`${c}up`,a._onMouseUp,{passive:!1}));break;case "cr":virtualclass.wb[b.actual].clear();break;case "ds":virtualclass.wb[b.actual].canvas.discardActiveObject();virtualclass.wb[b.actual].canvas.renderAll();break;case "da":WhiteboardUtility.deleteActiveObject(!1,c);break;case "ot":WhiteboardUtility.updateToolStyle(b.tool,b.actual.value,c);break;case "tx":virtualclass.wb[c].selectedTool=b.tool;virtualclass.wb[c].textObj.renderText(b.actual,virtualclass.wb[c]);break;default:console.log("====> do nothing")}}replayInit(c){this.init(c);
this.renderObj(c)}replayData(c,b){virtualclass.wb[b].vcanMainReplayObjs=[];0<c.length&&(virtualclass.wb[b].vcanMainReplayObjs=c,this.replayInit(b))}replayFromLocalStroage(c,b){"undefined"!==typeof Storage&&(virtualclass.wb[b].clear(b),virtualclass.wb[b].replayObjs=[],delete virtualclass.wb[b].strokeSize,delete virtualclass.wb[b].toolColor,virtualclass.wb[b].gObj.tempRepObjs=c,0<c.length&&this.triggerReplay(c,b))}triggerReplay(c,b){for(let a=0;a<c.length;a+=1)WhiteboardUtility.storeAtMemory([c[a]],
...
"object"===typeof a?virtualclass.view.createErrorMsg(b,"errorContainer","virtualclassAppFooterPanel",{className:a.name}):virtualclass.view.createErrorMsg(b,"errorContainer","virtualclassAppFooterPanel");virtualclass.user.control.mediaWidgetDisable("vd");virtualclass.view.disappearBox("WebRtc");switch(a.name){case "NotFoundError":case "DevicesNotFoundError":a="nowebcam";break;case "SourceUnavailableError":a="webcambusy";break;case "PermissionDeniedError":case "SecurityError":a="nopermission";virtualclass.gObj.disableCamByUser=
!0;break;case "NotAllowedError":a="nopermission";virtualclass.gObj.disableCamByUser=!0;break;default:a="rejected"}virtualclass.system.mediaDevices.webcamErr.push(a)},detectAudioWorklet:()=>{if("undefined"===typeof OfflineAudioContext)return!1;const a=new OfflineAudioContext(1,1,44100);return!(!a.audioWorklet||"function"!==typeof a.audioWorklet.addModule)}}}})(window);(function(c){c.sharePt=function(){return{pptUrl:"",state:{},urlValue:"",localStoragFlag:!1,eventsObj:[],autoSlideTime:0,viewFlag:0,controlFlag:0,autoSlideFlag:0,autoSlideResumed:0,studentPpt:0,startFromFlag:0,startFrom:0,currId:"",order:[],init(b,a){virtualclass.orderList[virtualclass.currApp]||(virtualclass.orderList[virtualclass.currApp]=new OrderedList);this.pages={};this.order=[];this.autoSlideResumed=this.autoSlideTime=this.autoSlideFlag=0;"undefined"!==typeof virtualclass.previous&&"undefined"!==
