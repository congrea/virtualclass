...
Presult:"Poll result",preWllBshortly:"Presentation will be shared shortly",Prev:"Prev",proposedspeed:"Proposed speed",PSetting:"Poll setting",Publish:"Publish",QClosed:"Quiz closed",Question:"Question",QTquestions:"Total no of questions",QMaximumMark:"Maximum mark",QCorrectAnswers:"Correct answers",QQuestionsAttempted:"Questions attempted",QYouScored:"You Scored",Quiz:"Quiz","Quiz/page":"Quiz / page",Quizes:"Quizzes",quizmayshow:"Get ready for a quiz",quizreviewpublish:"Review & publish quiz",RaiseHandStdDisabled:"Undo raise hand",
RaiseHandEnable:"Hand raised",raiseHandNotify:"Student(s) raised hand",RaiseHandStdEnabled:"Raise hand",readonlymode:"Read only",receivedVotes:"Received votes",reclaim:"Reclaim",Rectangle:"Rectangle",rejected:"Another application on your computer might be using your webcam. Kindly close all other applications",reload:"Reload",reloadDoc:"Reload document",removeContext:"Remove Bookmark",replay:"Re-play",Replay:"Replay from start.",replay_message:"Thanks for watching.",requestScreenShare:"Request screen share",
requestedScreenShare:"Screen share is requested",Reset:"Reset",Rtime:"Remaining time",rusureCquiz:"<span>Are you sure to close this quiz? </span>",rvtu:"Votes received/ total users",reply:"Reply",safariBrowserIssue:"Your browser Safari {virtualclass1} is not supported, We fully support Chrome  and Firefox",Save:"Save",savesession:"Do you want to save current session?",savesessionTechSupport:"Do you want to save current session? <br /> Once you download the session, Updates won't be available on re-downloading of same session.",
...
QCorrectAnswers:"Respostas corretas",QQuestionsAttempted:"Perguntas tentadas",QYouScored:"Voc\u00ea pontuou",Quiz:"Question\u00e1rio","Quiz/page":"Question\u00e1rio / p\u00e1gina",Quizes:"Quizzes",quizmayshow:"Prepare-se para um quiz",quizreviewpublish:"Revisar e publicar quiz",RaiseHandStdDisabled:"Abaixar m\u00e3o",RaiseHandEnable:"M\u00e3o levantada",raiseHandNotify:"Estudante(s) com m\u00e3o levantada",RaiseHandStdEnabled:"Levantar m\u00e3o",readonlymode:"Apenas leitura",receivedVotes:"Votos recebidos",
...
Quizes:"Ex\u00e1menes",quizmayshow:"Prep\u00e1rate para una prueba",quizreviewpublish:"Revisar y publicar examen",RaiseHandStdDisabled:"Bajar la mano",RaiseHandEnable:"Levantar la mano",raiseHandNotify:"Alumno(s) levant\u00f3 la mano",RaiseHandStdEnabled:"Mano levantada",readonlymode:"Solo lectura",receivedVotes:"Votos recibidos",reclaim:"Reclamar",Rectangle:"Rect\u00e1ngulo",rejected:"Otra aplicaci\u00f3n en su computadora podr\u00eda estar usando su c\u00e1mara web. Debe cerrar las dem\u00e1s aplicaciones",
