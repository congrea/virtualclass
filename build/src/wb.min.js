'use strict';const screenDecodeBlob=URL.createObjectURL(new Blob(["(",function(){function d(a){myLoop=4*a.length;k=new Uint8ClampedArray(myLoop);for(let b=0;b<myLoop;b++)k[4*b]=36.5*(a[b]>>5),k[4*b+1]=36.5*((a[b]&28)>>2),k[4*b+2]=85*(a[b]&3),k[4*b+3]=255}function c(a,b,c,f,d){const k=g.width;let m=0;for(let n=b;n<f+b;n++)for(let b=a;b<c+a;b++){const a=4*(n*k+b);g.data[a]=d[m++];g.data[a+1]=d[m++];g.data[a+2]=d[m++];g.data[a+3]=d[m++]}}function a(a,c){a=b(a);c=b(c);return parseInt(a+c)}function b(a){a=
a.toString();if(1==a.length)return`0${a}`;if(2==a.length)return a}function f(b){let f=7;for(let g=0;g+7<=b.length;g=l+1)x=a(b[g+1],b[g+2]),y=a(b[g+3],b[g+4]),h=parseInt(b[g+5]),w=parseInt(b[g+6]),l=f+h*w-1,recmsg=b.subarray(f,l+1),d(recmsg),c(x,y,w,h,k),f=l+7+1;m&&clearTimeout(m);m=setTimeout(()=>{postMessage({globalImageData:g,dtype:"drgb"})},100)}let g={},k,m;onmessage=function(a){if(a.data.hasOwnProperty("dtype"))if("drgb"==a.data.dtype){var b=a.data.encodeArr;g=new ImageData(a.data.cw,a.data.ch);
a=4*b.length;for(let c=0;c<a;c++)g.data[4*c]=36.5*(b[c]>>5),g.data[4*c+1]=36.5*((b[c]&28)>>2),g.data[4*c+2]=85*(b[c]&3),g.data[4*c+3]=255;postMessage({globalImageData:g,dtype:"drgb",stype:"full"})}else f(a.data.data_pack)}}.toString(),")()"],{type:"application/javascript"})),sdworker=new Worker(screenDecodeBlob);const screenWorkerBlob=URL.createObjectURL(new Blob(["(",function(){function d(a,b){a=a.toString();let c;for(c=a.length;c<b;c++)a=`0${a}`;return a.match(/[\S]{1,2}/g)||[]}function c(c){0===k?b=a=0:(f=k%c.data.resB,g=Math.floor(k/c.data.resB),a=f*c.data.dw,b=g*c.data.dh);return{x:a,y:b,w:c.data.dw,h:c.data.dh}}let a,b,f,g,k,m=0,n,q,r,z,t=null,v=[];const p=function(a,b,c,f,g,d,k){d=new Uint8ClampedArray(c*f);let m=0;for(let n=b;n<f+b;n+=1)for(let b=a;b<c+a;b+=1){const a=n*g+b;d[m++]=k[a]}return d},
u=function(a,b,c){const f=b.length;let g;if(b.length!==a.length)return!1;for(g=0;g<f;g+=1){if(b[g]!==a[g])return!1;g+=c}for(g=0;g<f;--g)if(g+=c,b[g]!==a[g])return!1;for(g=0;g<f;g+=7)if(b[g]!==a[g])return!1;return!0};onmessage=function(a){if(a.data.hasOwnProperty("initPrevImg"))v=[],t=null;else if(a.data.hasOwnProperty("resize"))for(k=0;k<a.data.resA*a.data.resB;k++)r=c(a),v[k]=p(r.x,r.y,r.w,r.h,a.data.offsetWidth,a.data.offsetHeight,a.data.img);else{{var b=a.data.img,f=b.length/4;let c;var g;if(null===
t||t.length!==f)t=new Uint8ClampedArray(f);for(g=0;g<f;g++){var B=b[4*g];var H=b[4*g+1];c=b[4*g+2];B=(Math.round(B/36.5)<<5)+(Math.round(H/36.5)<<2)+Math.round(c/85);t[g]=B}}for(k=0;k<a.data.resA*a.data.resB;k++)if(r=c(a),z=p(r.x,r.y,r.w,r.h,a.data.offsetWidth,a.data.offsetHeight,t),"undefined"!==typeof v[k]){if(n=u(z,v[k],r.w),!n){if(v[k].length!==z.length)v[k]=z;else for(b=0;b<z.length;b++)v[k][b]=z[b];b=z;f=r;g=a.data.type;H=d(f.x,4);B=d(f.y,4);g=new Uint8ClampedArray(["ss"===g?103:203,H[0],H[1],
B[0],B[1],f.h,f.w]);f=new Uint8ClampedArray(b.length+g.length);f.set(g);f.set(b,g.length);b=f;null===q||void 0===q?q=b:(f=new Uint8ClampedArray(q.length+b.length),f.set(q),f.set(b,q.length),q=f)}}else v[k]=z,m=1;q?postMessage({masterSlice:q,needFullScreen:m},[q.buffer]):postMessage({masterSlice:null,needFullScreen:m});m=0;q=null}}}.toString(),")()"],{type:"application/javascript"})),sworker=new Worker(screenWorkerBlob);const dtConWorkerBlob=URL.createObjectURL(new Blob(["(",function(){const d=function(){function c(a,c){a=a.replace(/[^A-Za-z0-9\+\/]/g,"");const b=a.length;c=c?Math.ceil((3*b+1>>2)/c)*c:3*b+1>>2;const f=new Uint8Array(c);for(var d,n=0,q=0,r=0;r<b;r++){d=r&3;var z=a.charCodeAt(r);n|=(64<z&&91>z?z-65:96<z&&123>z?z-71:47<z&&58>z?z+4:43===z?62:47===z?63:0)<<6*(3-d);if(3===d||1===b-r){for(d=0;3>d&&q<c;d++,q++)f[q]=n>>>(16>>>d&24)&255;n=0}}return f}function a(a){return 26>a?a+65:52>a?a+71:62>a?a-4:62===
a?43:63===a?47:65}return{base64EncArrInt(a){const b=new Uint8Array(a.length);for(let c=0;c<a.length;c++)b[c]=0>a[c]?-1*a[c]+127:a[c];return this.base64EncArr(b)},base64EncArr(b){let c=2,g="";for(let f=b.length,d=0,n=0;n<f;n++)if(c=n%3,0<n&&0===4*n/3%76&&(g+="\r\n"),d|=b[n]<<(16>>>c&24),2===c||1===b.length-n)g+=String.fromCharCode(a(d>>>18&63),a(d>>>12&63),a(d>>>6&63),a(d&63)),d=0;return g.substr(0,g.length-2+c)+(2===c?"":1===c?"=":"==")},base64DecToArrInt(a){a=c(a);const b=new Int8Array(a.length);
for(let c=0;c<a.length;c++)b[c]=128<=a[c]?-1*(a[c]-127):a[c];return b},base64DecToArrclm(a){a=c(a);return new Uint8ClampedArray(a.buffer)}}}();onmessage=function(c){if(c.data.hasOwnProperty("dt")){if("a"==c.data.dt)var a=d.base64EncArrInt(c.data.msg);else"c"==c.data.dt&&(a=d.base64EncArr(c.data.msg));postMessage({dt:c.data.dt,msg:a})}}}.toString(),")()"],{type:"application/javascript"})),dtConWorker=new Worker(dtConWorkerBlob);/*
  2018 Suman Bogati  {@link http://vidyamantra.com}
 @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 This file sends/receives packet to/from  Server through websocket
*/
const workerIOBlob=URL.createObjectURL(new Blob(["(",function(){const d={workerAudioRec:!1,workerAudioSend:!1,binMsgQueue:[],recBinMsgQueue:[],init(c){this.cfg=c;this.wsconnect()},userauthenticate(){const c=`F-AH-${JSON.stringify({authuser:this.cfg.authuser,authpass:this.cfg.authpass})}`;this.finallySend(c)},addclient(){const c=`F-JR-${JSON.stringify({client:this.cfg.userid,roomname:this.cfg.room,user:this.cfg.userobj})}`;this.finallySend(c)},wsconnect(){console.log("member_added init for socket connect");
d.wsuri=this.cfg.rid;"undefined"!==typeof WebSocket?(console.log(`rid ${d.wsuri}`),this.sock=new WebSocket(d.wsuri)):(console.log("Browser does not support WebSocket!"),this.error=lang.wserror);const c=this;this.sock.onopen=function(){this.readyToSend=!1;console.log(`member_added Connected to ${c.cfg.rid}`);c.userauthenticate();c.addclient();postMessage({cmd:"connectionopen",msg:{type:"connectionopen"}})};this.sock.binaryType="arraybuffer";this.sock.onmessage=function(a){if(a.data instanceof ArrayBuffer)d.onRecBinary(a);
...
else if(3==a[1]&&0<this.recBinMsgQueue.length){this.recBinMsgQueue.push(a.subarray(2));for(c=b=0;c<this.recBinMsgQueue.length;c++)b+=this.recBinMsgQueue[c].length;b=101==a[0]?new Int8Array(b):new Uint8ClampedArray(b);for(a=c=0;c<this.recBinMsgQueue.length;c++)b.set(this.recBinMsgQueue[c],a),a+=this.recBinMsgQueue[c].length;postMessage({cmd:"endBinary",msg:b})}}},webSocketConnected(){return 1==this.sock.readyState&&this.readyToSend},finallySend(c){this.sock.send(c)},sendBinary(c){if(this.webSocketConnected()&&
c.length)if(6E5>=c.length){if(c.constructor===Int8Array)var a=new Int8Array(c.length+2);else c.constructor===Uint8ClampedArray&&(a=new Uint8ClampedArray(c.length+2));a.set([c[0],0]);a.set(c,2);this.finallySend(a.buffer);postMessage({cmd:"stBinary",msg:a})}else{this.binMsgQueue=[];for(let b=0,f=0;b<c.length;f++)a=c.slice(b,b+55E4),c.constructor===Int8Array?this.binMsgQueue[f]=new Int8Array(a.length+2):c.constructor===Uint8ClampedArray&&(this.binMsgQueue[f]=new Uint8ClampedArray(a.length+2)),this.binMsgQueue[f].set([c[0],
2]),this.binMsgQueue[f].set(a,2),a.length&&(b+=a.length);this.binMsgQueue[0][1]=1;this.binMsgQueue[this.binMsgQueue.length-1][1]=3;for(c=0;c<this.binMsgQueue.length;c++)this.finallySend(this.binMsgQueue[c].buffer),postMessage({cmd:"stBinary",msg:this.binMsgQueue[c]});this.binMsgQueue=[]}},onMessage(c){switch(c.data.cmd){case "init":this.init(c.data.msg);break;case "wsconnect":this.wsconnect();break;case "disconnect":this.disconnect();break;case "sessionEndClose":this.sock&&this.sock.close();break;
case "workerAudioRec":this.workerAudioRec=c.ports[0];this.workerAudioRec.onmessage=function(a){a.data.hasOwnProperty("dest")&&"mainthread"==a.data.dest&&postMessage(a.data)};break;case "send":this.webSocketConnected()&&"undefined"!==typeof c.data.msg&&this.finallySend(c.data.msg);break;case "sendBinary":this.sendBinary(c.data.msg);break;case "workerAudioSend":this.workerAudioSend=c.ports[0];this.workerAudioSend.onmessage=this.fromWorkerAudioSend.bind(this);break;case "readyToSend":this.readyToSend=
!0;break;case "onRecBinary":this.onRecBinary({data:c.data.msg});break;default:this.finallySend(c.data.msg)}},fromWorkerAudioSend(c){c.data.hasOwnProperty("cmd")&&this.sendBinary(c.data.msg)}};onmessage=function(c){d.onMessage(c)}}.toString(),")()"],{type:"application/javascript"})),workerIO=new Worker(workerIOBlob);/*
  2018 Suman Bogati  {@link http://vidyamantra.com}
 @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
a){c=c.toString();for(let b=c.length;b<a;b++)c=`0${c}`;return c.match(/[\S]{1,2}/g)||[]},sendBinary(c){null!=this.workerIO&&this.workerIO.postMessage({cmd:"sendBinary",msg:c})},audioSend(c,a){if(this.audMouseDown&&!this.precheck){var b=this.breakintobytes(this.gObjUid,8);b=new Int8Array([101,b[0],b[1],b[2],b[3]]);const f=new Int8Array(c.length+b.length);f.set(b);f.set(c,b.length);this.sendBinary(f);postMessage({cmd:"adStatus",msg:a})}else postMessage({cmd:"adStatus",msg:"stop"})},silenceDetection(c,
a){let b,f=sum=rate=0;for(i=0;i<a.length;i++)b=Math.abs(a[i]),f<b&&(f=b),sum+=b;this.curAvg=sum/a.length;rate=Math.abs(this.curAvg^2-this.preAvg^2);this.preAvg=this.curAvg;5>rate&&(this.minthreshold=f);this.minthreshold>f&&(this.minthreshold=f);this.maxthreshold<f&&(this.maxthreshold=f);20*this.minthreshold<this.maxthreshold&&(this.minthreshold*=5);this.maxthreshold/20>this.minthreshold&&(this.maxthreshold/=5);10<g&&(this.maxthreshold*=.8);var g=this.maxthreshold/this.minthreshold;a=f/this.minthreshold;
0!==f&&postMessage({cmd:"unMuteAudio"});isFinite(g)&&20<=g||2<a||rate>this.minthreshold||25<rate||f>2*this.minthreshold||4>=g?(this.audioSend(c,"sending"),this.audioWasSent=6):0<this.audioWasSent?(this.audioSend(c,"sending"),this.audioWasSent--):2>g?this.audioSend(c,"sending"):(postMessage({cmd:"adStatus",msg:"notSending"}),postMessage({cmd:"ioAdapterSend",msg:{cf:"na"}}),0===f&&postMessage({cmd:"muteAudio"}));return c},recorderProcess(c){if(!this.repMode&&this.audMouseDown&&!this.precheck){c=this.resampler.resampler(c);
c=this.convertFloat32ToInt16(c);const a=this.encodeAudio(c);this.silenceDetection(a,c)}},onMessage(c){switch(c.data.cmd){case "workerIO":this.workerIO=c.ports[0];this.resampler=new Resampler(c.data.sampleRate,8E3,1,4096);this.workerIO.onmessage=function(a){console.log("From io lib")};this.gObjUid=c.data.uid;break;case "audioWorkletSend":this.audioWorkletSend=c.ports[0];this.repMode=c.data.msg.repMode;this.audioWorkletSend.onmessage=this.formAudioWorkletSend.bind(this);break;case "audioMouseDown":this.audMouseDown=
c.data.msg.adMouseDown;break;case "precheck":this.precheck=c.data.msg.precheck;break;case "rawAudio":this.recorderProcess(c.data.msg);break;default:console.log("Do nothing")}},formAudioWorkletSend(c){c.data.hasOwnProperty("cmd")&&"rawAudio"==c.data.cmd&&this.recorderProcess(c.data.msg)}};onmessage=function(c){d.onMessage(c)}}.toString(),")()"],{type:"application/javascript"})),workerAudioSend=new Worker(workerAudioSendBlob);/*
  2018 Suman Bogati  {@link http://vidyamantra.com}
 @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 This file(Audio worklet) plays the received Audio from received audio worker(worker-audio-rec.js)
*/
const workletAudioRecBlob=URL.createObjectURL(new Blob(["(",function(){function d(a){a.data.hasOwnProperty("cmd")&&"workerAudioRec"===a.data.cmd&&(m=a.ports[0],m.onmessage=c)}function c(b){if(b.data.hasOwnProperty("cmd")&&"audio"===b.data.cmd){var c=b.data.msg.data;b=b.data.msg.uid;null==a[b]&&(a[b]=[]);null==g[b]&&(g[b]=[]);for(let a=0;a<c.length;a++)g[b].push(c[a]);for(;128<=g[b].length;)c=g[b].splice(0,128),a[b].push(new Float32Array(c))}}const a={},b={};let f=0;const g={};let k,m;const n=[];let q=
...
webpToPng=new Worker(webpToPngBlob);/*
 ...
 @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
*/
var io={cfg:{},sock:null,wsuri:null,error:null,uniquesids:null,serial:null,globallock:!1,readyToSend:!1,globalmsgjson:[],packetQueue:[],binMsgQueue:[],jsnMsgQueue:[],recBinMsgQueue:[],recjsnMsgQueue:null,stockReadyState:!1,workerIOOnmessage:!1,sessionSet:!1,init(d){this.cfg=d;"use strict";console.log("==== io init ");ioInit.sendToWorker({cmd:"init",msg:d})},send(d,c,a){d.hasOwnProperty("m")&&"all"==d.m.user&&alert("som packet are sending");d={cfun:c,arg:{msg:d}};a&&(d.arg.touser=a);if(this.webSocketConnected()&&
io.sessionSet){if(0<io.packetQueue.length){for(a=0;a<io.packetQueue.length;a++)c=JSON.parse(io.packetQueue[a]),this.realSend(c);io.packetQueue.length=0}this.realSend(d)}else console.log("SOCKET is not ready."),a=JSON.stringify(d),io.packetQueue.push(a)},realSend(d){if("undefined"!==typeof d.arg.touser)if(null==io.uniquesids)console.log("uniqueid is null");else if(d.arg.touser=io.uniquesids[d.arg.touser],"undefined"===typeof d.arg.touser){console.log(`User is not connected.${d.arg.touser}`);return}var c=
{userid:wbUser.id};switch(d.cfun){case "broadcastToAll":if("undefined"===typeof d.arg.touser)c={user:c,m:d.arg.msg},d=`F-BR-{"0${JSON.stringify(c)}`;else{c={user:c,m:d.arg.msg,userto:d.arg.touser};for({touser:d}=d.arg;12>d.length;)d=`0${d}`;d=`F-BRU-{"${d}{"0${JSON.stringify(c)}`}break;case "ping":c={type:"PONG",m:d.arg.msg};d=`F-PI-${JSON.stringify(c)}`;break;case "speed":d=`F-SPE-{"${d.arg.msg}`;break;case "session":d=`F-SS-{"${d.arg.msg}`;break;case "recording":d=`F-SR-{"${d.arg.msg}`;break;default:d=
JSON.stringify(d)}if(6E5>=d.length)workerIO.postMessage({cmd:"send",msg:d});else{if(this.jsnMsgQueue=this.chunkSubstr(d,55E4))for(d=0;d<this.jsnMsgQueue.length;d++)workerIO.postMessage({cmd:"send",msg:this.jsnMsgQueue[d]});this.jsnMsgQueue=[]}},chunkSubstr(d,c){if(d.startsWith('F-BR-{"0')){var a='F-BR-{"';d=d.replace('F-BR-{"0',"")}else if(d.startsWith('F-BRU-{"'))a=d.substring(0,22),d=d.substring(23,d.length);else return!1;const b=Math.ceil(d.length/c),f=Array(b);for(let g=0,k=0;g<b;++g,k+=c)f[g]=
d.substr(k,c),f[g]=0==g?`${a}1${f[g]}`:g<b-1?`${a}2${f[g]}`:`${a}3${f[g]}`;return f},cleanRecJson(d){if(!(d.startsWith('{"0{"')||d.startsWith('{"1{"')||d.startsWith('{"2')||d.startsWith('{"3')))return d;if(d.startsWith('{"0{"'))return d=d.replace('{"0{"','{"');if(d.startsWith('{"1{"'))this.recjsnMsgQueue=d.replace('{"1{"','{"');else if(d.startsWith('{"2'))0<this.recjsnMsgQueue.length&&(this.recjsnMsgQueue+=d.replace('{"2',""));else if(d.startsWith('{"3')){if(0<this.recjsnMsgQueue.length)return this.recjsnMsgQueue+=
d.replace('{"3',"")}else this.recjsnMsgQueue="";return!1},sendBinary(d){workerIO.postMessage({cmd:"sendBinary",msg:d})},onRecMessage(d){if(d.data instanceof ArrayBuffer)workerIO.postMessage({cmd:"onRecBinary",msg:d.data});else ioInit.onmessage({data:{cmd:"receivedJson",msg:d.data}})},webSocketConnected(){return 1==io.stockReadyState&&1==this.readyToSend},onRecJson(d){if(!1===io.globallock)if(0<io.globalmsgjson.length)for(;0<io.globalmsgjson.length&&!1===io.globallock;)d=io.globalmsgjson.shift(),io.onRecJsonIndividual(d);
else if(null!=d&&!1===io.globallock&&0==io.globalmsgjson.length)io.onRecJsonIndividual(d);else null!=d&&io.globalmsgjson.push(d);else null!=d&&io.globalmsgjson.push(d)},onRecJsonIndividual(d){var c="";switch(d.type){case "joinroom":d.hasOwnProperty("users")?(ioAdapter.setRecording(),roles.hasControls()||ioAdapter.makeSessionReady(),console.log("==== Member add, join room")):console.log("No users");this.readyToSend=!0;workerIO.postMessage({cmd:"readyToSend"});c=null;if(null!=io.uniquesids)for(var a in d.clientids)void 0==
...
var ioInit={sendToWorker(d){workerIO.postMessage(d)},onmessage(d){switch(d.data.cmd){case "connectionopen":io.stockReadyState=1;virtualclass.ioEventApi.connectionopen(d.data.msg);break;case "receivedJson":var c=io.cleanRecJson(d.data.msg);if(c)if(d=JSON.parse(c),!d.hasOwnProperty("type")&&d.hasOwnProperty("user")&&(d.type="broadcastToAll","undefined"===typeof virtualclass.gObj.allUserObj[d.user.userid]&&(virtualclass.gObj.allUserObj[d.user.userid]={},virtualclass.gObj.allUserObj[d.user.userid].userid=
...
m:d};this.sendUser(d,c);ioStorage.dataUserAdapterMustData({type:"broadcastToAll",user:wbUser.id,m:d},`${c}_${d.userSerial}`)},sendUser(d,c){io.send(d,"broadcastToAll",c)},sendPing(d){io.send(d,"ping")},sendSpeed(d){ioAdapter.sendWithDelayAndDrop(d,null,"realSendSpeed","sendSpeed",1E3)},realSendSpeed(d){io.send(d,"speed")},sendBinary(d){io.sendBinary(d)},makeSessionReady(){io.sessionSet=!0},setRecording(){if(!virtualclass.isPlayMode&&virtualclass.settings.recording.enableRecording){const d=virtualclass.settings.recording.sendYesOrNo();
io.realSend({cfun:"recording",arg:{msg:d}});console.log(`==== Send Recording a/v ${d}`)}},setSession(d){io.realSend({cfun:"session",arg:{msg:d}});console.log(`==== Send Session serverSession ${d}`)},initSetSession(d){const c=localStorage.getItem("serverSession");null==c?localStorage.setItem("serverSession",d):virtualclass.isPlayMode||c==d||this.setSession(c);this.makeSessionReady()},sync(d){io.send(d,"broadcastToAll",null)}};const ioPingPong={ping(d){"member_added"==d.type?roles.hasAdmin()&&(d={ping:"ping",cf:"pong",session:this.sessionName()},ioAdapter.sendWithDelayAndDrop(d,null,"mustSend","pingAll",3E3),console.log("PING BROADCAST")):"member_added"==d.type&&d.hasOwnProperty("users")&&(io.sessionSet=!0)},pong(d){d.toUser?(console.log(`PONG TO ${d.toUser.userid} from ${d.fromUser.userid}`),ioAdapter.mustSendUser({ping:"pong",cf:"pongAck"},d.fromUser.userid),console.log(`PONG ACK TO ${d.fromUser.userid}`)):(console.log(`PONG BROADCAST from ${d.fromUser.userid}`),
this.verifySession(d))},pongAck(d){console.log(`PONG ACK FROM ${d.fromUser.userid}`)},sessionName(){let d=localStorage.getItem("mySession");null===d&&(virtualclass.gObj.hasOwnProperty("doEndSession")&&(virtualclass.storage.config.endSession(),console.log("==== session, end session")),d=this.setSession());return d},setSession(){const d=virtualclass.vutil.randomString(32);console.log("==== session, My session is created by setSession");localStorage.setItem("mySession",d);return d},verifySession(d){const {session:c}=
d.message,a=localStorage.getItem("mySession");null!=a?a!==c&&"t"==d.fromUser.role&&this.sessionDestroy(c,d):(console.log("==== session, start session"),console.log("My session is created"),localStorage.setItem("mySession",c))},sessionDestroy(d,c){virtualclass.isPlayMode?(console.log("==== session, end session"),console.log("My session is created"),localStorage.setItem("mySession","thisismyplaymode")):(console.log("==== session, start session"),c=c.fromUser.userid,localStorage.removeItem("mySession"),
virtualclass.storage.config.endSession(),localStorage.setItem("mySession",d),ioMissingPackets.validateAllVariables(c),console.log("REFRESH SESSION"))}};(function(d){d.virtualclass=function(){const c=""!=wbUser.virtualclassPlay?parseInt(wbUser.virtualclassPlay,10):0;let a=localStorage.getItem("studentSSstatus");a=null!=a?JSON.parse(localStorage.getItem("studentSSstatus")):{sharing:!1,mesharing:!1,shareToAll:!1};return{isPlayMode:c,apps:{wb:"Whiteboard",ss:"ScreenShare",yt:"Yts",er:"EditorRich",ec:"EditorCode",sp:"SharePresentation",poll:"Poll",vid:"Video",ds:"DocumentShare",quiz:"Quiz",mv:"MultiVideo"},appSessionEnd:"virtualclassSessionEnd",appAudioTest:"virtualclassAudioTest",
rWidgetConfig:{id:"virtualclassAppRightPanel"},wb:"",ss:"",wss:"",rw:"",poll:"",quiz:"",raiseHand:"",error:[],pdfRender:{},clearGlobalLock:"",gObj:{SCALE_FACTOR:1.02,next:{},uid:d.wbUser.id,uRole:d.wbUser.role,uName:d.wbUser.name,tempReplayObjs:{},commandToolsWrapperId:{},editorInitDone:0,resize:!1,has_ts_capability:!(1!=wbUser.ts&&1!=wbUser.ts),meetingMode:0,chromeExt:!1,pdfdebugg:!0,wbInitHandle:!1,wbCount:0,prvWindowSize:!1,wIds:[0],wbRearrang:!1,currSlide:null!=localStorage.getItem("currSlide")?
...
audioRecWorkerReady:!1,wbTool:{},fullScreenMode:!1,lastmousemovetime:null},enablePreCheck:!0,clearSession(){d.pageEnter=(new Date).getTime();"undefined"===typeof notSend&&virtualclass.vutil.beforeSend({sEnd:!0,cf:"sEnd"},null,!0);"object"===typeof virtualclass.videoUl&&"object"===typeof virtualclass.videoUl.player&&"undefined"!==typeof virtualclass.videoUl.player.dispose&&virtualclass.videoUl.player.dispose();virtualclass.storage.config.endSession();virtualclass.hasOwnProperty("prevScreen")&&virtualclass.prevScreen.hasOwnProperty("currentStream")&&
virtualclass.prevScreen.unShareScreen();virtualclass.previrtualclass=`virtualclass${virtualclass.gObj.defaultApp}`},async init(a,c,g){a=document.getElementById("virtualclassCont");a.classList.add("loading");const {wbUser:b}=d;virtualclass.uInfo={userid:b.id,sid:b.sid,rid:b.path,authuser:b.auth_user,authpass:b.auth_pass,userobj:{userid:b.id,name:b.name,lname:b.lname,img:b.imageurl,role:null!=localStorage.getItem("uRole")?localStorage.getItem("uRole"):b.role},room:b.room};this.gObj.congCourse=typeof("undefiend"!=
d.congCourse)?d.congCourse:0;this.wbConfig={id:`virtualclass${virtualclass.apps.wb}`,classes:"appOptions"};this.ssConfig={id:`virtualclass${virtualclass.apps.ss}`,classes:"appOptions"};this.edConfig={id:`virtualclass${virtualclass.apps.er}`,classes:"appOptions"};this.edCodeConfig={id:`virtualclass${virtualclass.apps.ec}`,classes:"appOptions"};this.ptConfig={id:`virtualclass${virtualclass.apps.sp}`,classes:"appOptions"};this.plConfig={id:`virtualclass${virtualclass.apps.poll}`,classes:"appOptions"};
this.viConfig={id:`virtualclass${virtualclass.apps.vid}`,classes:"appOptions"};this.dtsConfig={id:`virtualclass${virtualclass.apps.ds}`,classes:"appOptions"};this.qzConfig={id:`virtualclass${this.apps.quiz}`,classes:"appOptions"};this.mvConfig={id:`virtualclass${this.apps.mv}`,classes:"appOptions"};this.user=new d.user;this.vutil=d.vutil;this.sharePt=d.sharePt;this.fineUploader=d.fineUploader;this.system=d.system;this.recorder=d.recorder;this.converter=converter;this.clear="";this.currApp=this.vutil.capitalizeFirstLetter(c);
this.storage=d.storage;this.dashBoard=dashBoard;this.multiVideo=d.MultiVideo;this.vutil.isChromeExtension();this.wbCommon=d.wbCommon;this.pageNavigation=d.pageIndexNav;this.modal=d.modal;this.zoom=d.zoomWhiteboard();virtualclass.pageIndexNav=d.pageIndexNav;this.system.isIndexedDbSupport()?await this.storage.init():console.log("Indexeddb does not support");"Quiz"!=this.currApp&&"undefined"!==typeof CDTimer&&clearInterval(CDTimer);virtualclass.modernizr=Modernizr;this.system.webpInit();this.dirtyCorner=
d.dirtyCorner;this.html.init(this);this.adapter=d.adapter;virtualclass.system.mybrowser.hasOwnProperty("name")||this.system.setBrowserDetails();virtualclass.api=api;virtualclass.vutil.initOnBeforeUnload(virtualclass.system.mybrowser.name);virtualclass.xhr=d.xhr;virtualclass.xhr.init();virtualclass.xhrn=d.xhrn;virtualclass.xhrn.init();virtualclass.vutil.getCookie("readyToCommunicate")&&(virtualclass.gObj.readyToCommunicate=!0);this.xhrn.getAcess(a=>{if("ERROR"!=a||"Error"!=a)virtualclass.gObj.readyToCommunicate=
!0,console.log("get access"),virtualclass.vutil.isPlayMode()&&virtualclass.recorder.requestListOfFiles()});virtualclass.chat=new Chat;virtualclass.chat.init();virtualclass.dtCon=virtualclass.converter();virtualclass.pbar=progressBar;virtualclass.editorRich=d.editor("editorRich","virtualclassEditorRich","virtualclassEditorRichBody");virtualclass.editorCode=d.editor("editorCode","virtualclassEditorCode","virtualclassEditorCodeBody");virtualclass.poll=d.poll();virtualclass.quiz=d.quiz();virtualclass.videoUl=
d.videoUl();virtualclass.videoHost=d.videoHost;virtualclass.precheck=preCheck;virtualclass.page=page;console.log("==== session clear zoom object ready ");virtualclass.network=new Network;virtualclass.gesture=gesture;this.serverData=serverData;roles.hasControls()&&this.serverData.fetchAllData();null!=localStorage.uRole&&(virtualclass.gObj.uRole=localStorage.uRole,a.classList.add(virtualclass.vutil.getClassName(virtualclass.gObj.uRole)));"undefined"===typeof g||null==g?this.makeAppReady(c,"byclick"):
this.makeAppReady(c,"byclick",g);this.system.check();this.vutil.isSystemCompatible();this.system.mediaDevices.getMediaDeviceInfo();this.pageVisible=virtualclass.vutil.pageVisible();c==virtualclass.apps.ss&&this.system.setAppDimension();virtualclass.vutil.createReclaimButtonIfNeed();virtualclass.user.assignRole(virtualclass.gObj.uRole,c);this.media=new d.media;c=localStorage.getItem("precheck");null!=c&&(c=JSON.parse(c));virtualclass.makePreCheckAvailable?virtualclass.precheck.init():(virtualclass.makeReadySocket(),
virtualclass.isPlayMode||virtualclass.gesture.initClassJoin());a.classList.remove("loading");virtualclass.gObj.precheckScrn=!1;virtualclass.gObj.meetingMode||virtualclass.videoHost.init(320,240);virtualclass.vutil.videoController();c=document.getElementById("precheckSetting");c.addEventListener("click",()=>{virtualclass.gObj.precheckScrn=!0;virtualclass.precheck.init(virtualclass.precheck)});this.raiseHand=d.raiseHand;this.raiseHand.init();this.appSetting=d.appSetting;this.appSetting.init();virtualclass.colorSelector=
d.colorSelector;virtualclassSetting.theme.selectedColor&&this.colorSelector.makeThemeReady();c=document.getElementById("virtualclassCont");null!=c&&c.classList.add(virtualclass.system.mybrowser.name);c=document.getElementById("fullScreenButton");null!=c&&c.addEventListener("click",virtualclass.vutil.Fullscreen);c=document.getElementById("fullScreenExitButton");null!=c&&c.addEventListener("click",virtualclass.vutil.closeFullscreen);document.onfullscreenchange=function(a){virtualclass.gObj.fullScreenMode?
(document.querySelector("#fullScreenButton").style.display="block",document.querySelector("#fullScreenExitButton").style.display="none",virtualclass.gObj.fullScreenMode=!1):(document.querySelector("#fullScreenButton").style.display="none",document.querySelector("#fullScreenExitButton").style.display="block",virtualclass.gObj.fullScreenMode=!0)}},makeReadySocket(){if(!virtualclass.vutil.isPlayMode()){const b=this;var a=setInterval(()=>{2<=b.gObj.editorInitDone&&(b.initSocketConn(),clearInterval(a))},
100)}},initSocketConn(){this.system.webSocket&&(io.init(virtualclass.uInfo),d.userdata=virtualclass.uInfo)},html:{id:"virtualclassCont",optionsClass:"appOptions",init(a){this.virtualclass=a},leftAppBar(){if(!(0<document.getElementsByClassName("appOptions").length)){document.querySelector("#virtualclassApp #virtualclassAppLeftPanel");var a=virtualclass.getTemplate("appTools")();virtualclass.vutil.insertAppLayout(a);virtualclass.gObj.hasOwnProperty("errNotScreenShare")&&virtualclass.view.disableSSUI();
virtualclass.gObj.hasOwnProperty("errAppBar")&&virtualclass.view.disableLeftAppBar()}},createDiv(a,c,g,d,m){const b=document.createElement("a");b.href="#";const f=document.createElement("div");f.id=a;"undefined "!==typeof d&&(f.className=d);d=document.createElement("span");d.className=`icon-${c}`;b.appendChild(d);b.dataset.title=virtualclass.lang.getString(c);b.className="tooltip";"virtualclassWhiteboardTool"==a&&(b.dataset.doc=`${"_doc_0_"}${virtualclass.gObj.wbCount}`);f.appendChild(b);"undefined"!==
typeof m?(m=document.getElementById("virtualclassScreenShareTool"),g.replaceChild(f,m)):g.appendChild(f)},createElement(a,c,g){a=document.createElement(a);"undefined"!==typeof c&&(a.id=c);if("undefined"!==typeof g&&1<g.length)for(c=0;c<g.length;c++)a.className+=`${g[c]} `;return a}},dispvirtualclassLayout(a){if("undefined"!==typeof this.previous)if(this.previous.toUpperCase()!=`virtualclass${this.currApp}`.toUpperCase()){var b=document.getElementById(virtualclass.previous);null!=b&&(b.style.display=
...
for(let a=0;a<b.length;a++)b[a].style.display="none"}"undefined"!==typeof a&&(a=`virtualclass${a.charAt(0).toUpperCase()+a.slice(1)}`);b=document.getElementById(a);null!=b&&(b.style.display="block",console.log(`App ${a} block`))},async makeAppReady(a,c,g){virtualclass.dashBoard.close();console.log(`Application is ready${a}`);this.view=d.view;var b=virtualclass.vutil.capitalizeFirstLetter(a);"ScreenShare"!=b&&(this.currApp=b);"DocumentShare"!=a&&(virtualclass.gObj.docPdfFirstTime=!1);console.log(`Current App init ${this.currApp}`);
roles.hasControls()&&virtualclass.hasOwnProperty("previrtualclass")&&(a!=virtualclass.apps.ss||virtualclass.gObj.studentSSstatus.mesharing&&"ScreenShare"==virtualclass.apps.ss)&&virtualclass.vutil.makeActiveApp(`virtualclass${a}`,virtualclass.previrtualclass);"undefined"===typeof this.previous||"virtualclassEditorRich"!=this.previous&&"virtualclassEditorCode"!=this.previous||(b=this.previous.split("virtualclass")[1],this.user.control.toggleDisplayEditorController(b,"none"));if(a!=virtualclass.apps.ss){this.dispvirtualclassLayout(a);
b=document.getElementById("virtualclassCont");virtualclass.vutil.setCurrApp(b,this.currApp);var f=document.querySelector("#virtualclassApp");null!=f&&("DocumentShare"==this.currApp||"SharePresentation"==this.currApp||"Video"==this.currApp?virtualclass.vutil.setCurrApp(f,b.dataset.currapp):f.dataset.currapp="")}"undefined"!==typeof this.prevScreen&&this.prevScreen.hasOwnProperty("currentStream")&&this.prevScreen.unShareScreen();if("SharePresentation"==a)`virtualclass${a}`!=virtualclass.previous&&this.appInitiator[a].apply(virtualclass,
Array.prototype.slice.call(arguments));else if("DocumentShare"==a)this.appInitiator[a].apply(virtualclass,Array.prototype.slice.call(arguments)),roles.hasControls()&&(virtualclass.dts.firstRequest?virtualclass.vutil.triggerDashboard(a,"hidepopup"):virtualclass.vutil.triggerDashboard(a));else if(b=localStorage.getItem("prevApp"),null!=b&&(f=JSON.parse(b),"SharePresentation"==f.name&&(f.name="",localStorage.setItem("prevApp",JSON.stringify(f)))),"Whiteboard"==a){var n=[];for(f=0;f<arguments.length;f++)n.push(arguments[f]);
"undefined"===typeof c&&(n[1]=c);n[2]="undefined"!==typeof g?`_doc_${g}`:`_doc_0_${virtualclass.gObj.currSlide}`;n.push("virtualclassWhiteboard");this.appInitiator[a].apply(virtualclass,Array.prototype.slice.call(n));b=JSON.parse(b);virtualclass.wbCommon.initNav(virtualclass.gObj.wIds);virtualclass.gObj.wbRearrang||null==b||null==localStorage.getItem("currSlide")||(n=localStorage.getItem("wIds"),n=JSON.parse(n),null!=n&&0<n.length&&(virtualclass.wbCommon.readyElements(n),virtualclass.wbCommon.initNav(n),
virtualclass.gObj.hasOwnProperty("currSlide")&&-1==n.indexOf(Number(virtualclass.gObj.currSlide))&&(console.log("wids, From virtualclass "),n.push(virtualclass.gObj.currSlide)),virtualclass.wbCommon.reArrangeElements(n),virtualclass.gObj.wbRearrang=!0,virtualclass.gObj.wIds=n,roles.hasControls()&&(virtualclass.wbCommon.rearrange(virtualclass.wbCommon.order),virtualclass.wbCommon.indexNav.addActiveNavigation(virtualclass.gObj.currWb))));virtualclass.wbCommon.identifyFirstNote(virtualclass.gObj.currWb);
virtualclass.wbCommon.identifyLastNote(virtualclass.gObj.currWb)}else b=Array.prototype.slice.call(arguments)[2],this.appInitiator[a].apply(virtualclass,Array.prototype.slice.call(arguments)),b&&b.init&&b.init.videoUrl&&b.fromReload&&(n=!0),roles.hasControls()&&"Video"==a&&(`virtualclass${a}`!=virtualclass.previous&&(b=document.querySelector("#dashboardnav button"),null!=b&&(b.setAttribute("data-currapp","Video"),b.classList.contains("clicked")&&b.classList.remove("clicked"))),virtualclass.vutil.triggerDashboard(a,
n));this.previrtualclass=this.previous;a!=virtualclass.apps.wb&&a!=virtualclass.apps.ss&&virtualclass.system.setAppDimension();if("Video"!=a&&virtualclass.hasOwnProperty("videoUl")){virtualclass.videoUl.videoId="";(n=document.getElementById("dispVideo_Youtube_api"))&&n.contentWindow&&n.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*");if(n=document.querySelector(".congrea #dispVideo"))n.style.display="none",(n=document.querySelector(".congrea #dispVideo video"))&&
n.setAttribute("src","");(n=document.querySelector("#listvideo .playing"))&&n.classList.remove("playing");(n=document.querySelector("#listvideo .removeCtr"))&&n.classList.remove("removeCtr");roles.hasControls()||(virtualclass.gObj.hasOwnProperty("videoPauseTime")&&clearTimeout(virtualclass.gObj.videoPauseTime),"object"===typeof virtualclass.videoUl.player&&null!=virtualclass.videoUl.player.player_&&virtualclass.videoUl.player.paused()&&(console.log("==== Video is paused"),virtualclass.videoUl.player.pause()));
"object"===typeof virtualclass.videoUl.player&&delete virtualclass.videoUl.player}roles.hasControls()&&(b=Array.prototype.slice.call(arguments)[2],"ScreenShare"==a||"SharePresentation"!=virtualclass.currApp&&"Video"!=virtualclass.currApp?"DocumentShare"!=virtualclass.currApp&&"SharePresentation"!=virtualclass.currApp&&virtualclass.vutil.removeDashboardNav():(virtualclass.vutil.initDashboardNav(b),"Video"==virtualclass.currApp?console.log(`currApp ${virtualclass.currApp}`):virtualclass.sharePt.localStoragFlag||
(b=document.querySelector("#dashboardnav button"),null!=b&&b.click())),"SharePresentation"!=virtualclass.currApp&&(n=document.querySelector("#listppt .playing"))&&n.classList.remove("playing"))},appInitiator:{async Whiteboard(a,c,g,k){"object"===typeof this.ss&&(this.ss.prevStream=!1);"undefined"!==typeof this.previous&&"undefined"!==typeof c&&"byclick"==c&&roles.hasControls()&&"Whiteboard"==virtualclass.currApp&&(c=g.split("_doc_")[1],virtualclass.vutil.beforeSend({dispWhiteboard:!0,cf:"dispWhiteboard",
d:c}));virtualclass.gObj.currWb=g;"object"!==typeof this.pdfRender[g]?this.pdfRender[g]=d.pdfRender():("Whiteboard"==virtualclass.currApp||"DocumentShare"==virtualclass.currApp)&&virtualclass.zoom.adjustScreenOnDifferentPdfWidth();roles.isStudent()&&"Whiteboard"==virtualclass.currApp&&virtualclass.wbCommon.setCurrSlideNumber(g);if("undefined"!==typeof g){if("object"!==typeof this.wb[g])if("object"!==typeof this.wb&&(this.wb={}),virtualclass.gObj.commandToolsWrapperId[g]=`commandToolsWrapper${g}`,
this.wb[g]={},virtualclass.gObj.tempReplayObjs[g]=[],this.wb[g]=new d.whiteboard(this.wbConfig,g),null!=this.gObj.tempQueue[g]&&(this.wb[g].gObj.queue=this.gObj.tempQueue[g].slice(),this.gObj.tempQueue[g]=null),"Whiteboard"==virtualclass.currApp?(c=document.querySelector("#virtualclassWhiteboard .whiteboardContainer"),virtualclass.gObj.wbInitHandle||(virtualclass.wbCommon.initNavHandler(),virtualclass.gObj.wbInitHandle=!0)):c=document.getElementById(`cont${g}`),null!=c){if(null==document.querySelector(`vcanvas${g}`)){k=
virtualclass.getTemplate("main","whiteboard");if("Whiteboard"==virtualclass.currApp){virtualclass.wbCommon.hideElement();const a=`note${g}`;var b=document.querySelector(`#${a}`);null!=b?(b.classList.add("canvasContainer","current"),k=k({cn:g,hasControl:roles.hasControls()}),b.innerHTML=k):(k=`<div id='${a}' data-wb-id='${g}' class='canvasContainer current'>${k({cn:g,hasControl:roles.hasControls()})}</div>`,"_doc_0_0"!=g?c.insertAdjacentHTML("beforeend",k):(c.innerHTML=k,b=document.querySelector("#note_doc_0_0"),
null!=b&&b.classList.add("current")))}else k=k({cn:g,hasControl:roles.hasControls()}),c.innerHTML=k;b=document.querySelector(`#canvas${g}`)}this.wb[g].utility=new d.utility;this.wb[g].alreadyReplay=!1;this.wb[g].packContainer=new d.packContainer;this.wb[g].draw_object=d.draw_object;this.wb[g].makeobj=d.makeobj;this.wb[g].readyFreeHandObj=d.readyFreeHandObj;this.wb[g]._replay=_replay;this.wb[g].readyTextObj=d.readyTextObj;this.wb[g].bridge=d.bridge;this.wb[g].response=d.response;virtualclass.wb[g].utility.displayCanvas(g);
({vcan:c}=virtualclass.wb[g]);roles.hasControls()&&(virtualclass.wb[g].utility.setOrginalTeacherContent(a),virtualclass.wb[g].attachToolFunction(virtualclass.gObj.commandToolsWrapperId[g],!0,g),a=c.utility.canvasCalcOffset(c.main.canid),console.log(`whietboard offset x=${a.x} `+` y=${a.y}`));"DocumentShare"==virtualclass.currApp?({currNote:a}=virtualclass.dts.docs.note,virtualclass.pdfRender[g].init(b,a)):virtualclass.pdfRender[g].init(b);await virtualclass.storage.getWbData(g)}else alert("whiteboard container is null");
else a=`commandToolsWrapper${g}`,null==document.getElementById(`commandToolsWrapper${g}`)&&roles.hasControls()&&virtualclass.wb[g].attachToolFunction(a,!0,g);({vcan:c}=virtualclass.wb[g]);null!=document.getElementById(`canvas${g}`)&&(c.utility.canvasCalcOffset(c.main.canid),0!==this.gObj.tempReplayObjs[g].length&&"nodata"!==this.gObj.tempReplayObjs[g]||virtualclass.wb[g].utility.makeCanvasEnable());console.log(`==== previous set ${this.wbConfig.id}`);this.previous=this.wbConfig.id}else alert("id is undefined");
console.log("==== SESSION CLEAR");virtualclass.zoom.init();a=localStorage.getItem("activeTool");null!=a&&(b=document.querySelector(`#${a}`),null!=b&&(b.classList.add("active"),virtualclass.wb[g].prvTool=a));roles.hasControls()&&d.addEventListener("mouseup",a=>{var b=document.querySelector("#virtualclassCont").dataset.currapp;if(null!=b&&("Whiteboard"==b||"DocumentShare"==b))if(a.target.dataset.hasOwnProperty("stroke")||a.target.dataset.hasOwnProperty("font"))a=a.target.dataset.hasOwnProperty("stroke")?
...
document.querySelector("#virtualclassApp").classList.contains("dashboard")||(a=document.querySelector(`#shapes${virtualclass.gObj.currWb}`),null!=a&&a.classList.contains("open")&&virtualclass.wb[virtualclass.gObj.currWb].closeElem(a))}});"undefined"===typeof virtualclass.wb.indexNav&&(virtualclass.wb.indexNav=new virtualclass.pageIndexNav("WB"))},ScreenShare(a){"object"!==typeof this.ss&&(this.ss=new d.screenShare(virtualclass.ssConfig));this.ss.init({type:"ss",app:a})},Yts(a,c,g){"undefined"!==typeof g&&
null!=g?virtualclass.yts.init(g,g.startFrom):null==document.querySelector("iframe#player")&&virtualclass.yts.init();this.previous=virtualclass.ytsConfig.id},EditorRich(a){this.appInitiator.editor.call(virtualclass,a)},EditorCode(a){this.appInitiator.editor.call(virtualclass,a)},SharePresentation(a,c){"object"===typeof this.ss&&(this.ss.prevStream=!1);this.sharePt=new d.sharePt;console.log(virtualclass.sharePt.pptUrl);this.sharePt.init(a,c);console.log(virtualclass.sharePt.pptUrl);this.previous=virtualclass.ptConfig.id;
virtualclass.sharePt.attachMessageEvent("message",virtualclass.sharePt.pptMessageEventHandler)},Poll(a){virtualclass.poll.init()},Quiz(a){virtualclass.quiz.init()},Video(a,c,g){"undefined"!==typeof g&&null!=g?"undefined"===typeof g.type?virtualclass.videoUl.init(g,g.startFrom):virtualclass.videoUl.init():virtualclass.videoUl.init()},editor(a){this.user.control.toggleDisplayEditorController(a.substring(a.indexOf("virtualclass"),a.length),"block");var b=[];a==virtualclass.apps.er?(virtualclass.editorRich.init(0,
b,"",""),this.previous=virtualclass.edConfig.id):(virtualclass.editorCode.init(0,b,"",""),this.previous=virtualclass.edCodeConfig.id);b=JSON.parse(localStorage.getItem(virtualclass.vutil.smallizeFirstLetter(a)));const c=virtualclass.vutil.smallizeFirstLetter(a);roles.hasAdmin()||(null==b?(this[c].cm.setOption("readOnly","nocursor"),this.user.control.toggleDisplayWriteModeMsgBox(a,!1),console.log(`message box is created ${a}`)):(this.user.control.toggleDisplayWriteModeMsgBox(a,b),b?this[c].cm.setOption("readOnly",
!1):this[c].cm.setOption("readOnly","nocursor")),virtualclass.vutil.setReadModeWhenTeacherIsDisConn(c))},makeReadyDsShare(a,c,g){virtualclass.dts.docs.hasOwnProperty("currDoc")?(roles.hasControls()&&(ioAdapter.mustSend({dts:{init:"studentlayout"},cf:"dts"}),console.log("doc share current"),virtualclass.dts.sendCurrentDoc(),virtualclass.dts.sendCurrentSlide()),a=virtualclass.dts.docs.currNote,"undefined"!==typeof a&&virtualclass.vutil.updateCurrentDoc(a)):"undefined"!==typeof g?setTimeout(()=>{virtualclass.dts.init(g)},
1E3):virtualclass.dts.init();virtualclass.previous=virtualclass.dtsConfig.id;console.log(`==== previous ${virtualclass.previous}`)},DocumentShare(a,c,g){virtualclass.hasOwnProperty("dts")&&null!=virtualclass.dts?(virtualclass.dts.firstRequest=!1,virtualclass.dts.indexNav.init()):virtualclass.dts=d.documentShare();const b=[];"undefined"!==typeof a&&b.push(a);"undefined"!==typeof c&&b.push(c);"undefined"!==typeof g&&b.push(g);"undefined"===typeof virtualclass.dts.indexNav&&(virtualclass.dts.indexNav=
new virtualclass.pageIndexNav("documentShare"));virtualclass.gObj.hasOwnProperty("docs")&&(virtualclass.appInitiator.makeReadyDsShare.apply(virtualclass.appInitiator,b),virtualclass.vutil.initDashboardNav(),virtualclass.dts.firstRequest||virtualclass.dts.noteExist()?(console.log("===== DOCUMENT EXIST"),virtualclass.zoom.adjustScreenOnDifferentPdfWidth()):(a=document.querySelector("#dashboardnav button"),null!=a&&a.click()),null!=virtualclass.gObj.currWb&&"undefined"!==typeof virtualclass.pdfRender[virtualclass.gObj.currWb]&&
...
a.setAttribute("data-title",virtualclass.lang.getString("reloadDoc"))},MultiVideo(){const a=this;a.multiVideo.hasOwnProperty("initDone")?a.multiVideo._init():setTimeout(()=>{a.appInitiator.MultiVideo.apply(virtualclass)},2E3);this.previous=virtualclass.mvConfig.id}},attachFunction(){const a=document.getElementsByClassName("appOptions");for(let b=0;b<a.length;b++){const f=a[b].getElementsByTagName("a")[0];if("virtualclassEditorCodeTool"!=a[b].id){var c=this;f.onclick=function(){c.initlizer(this)}}}},
initlizer(a){a=a.parentNode.id.split("virtualclass")[1];"SessionEndTool"==a?virtualclass.popup.confirmInput(virtualclass.lang.getString("startnewsession"),a=>{a?(virtualclass.gObj.endSession=!0,virtualclass.gObj.hasOwnProperty("beTeacher")&&roles.isTeacher()&&localStorage.setItem("uRole","t"),localStorage.clear(),(new Promise((a,b)=>{virtualclass.gObj.sessionEndResolve=a;virtualclass.clearSession()})).then(()=>{delete virtualclass.gObj.sessionEndResolve;virtualclass.popup.sesseionEndWindow()},a=>
{console.log(`ERRROR ${a}`)})):console.log("Not start new session")}):(a=a.substring(0,a.indexOf("Tool")),this.PrvAndCurrIsWss(this.previous,a)?alert(virtualclass.lang.getString("screensharealready")):("DocumentShare"==virtualclass.currApp&&(virtualclass.gObj.screenRh=160),this.makeAppReady(a,"byclick"),setTimeout(()=>{virtualclass.gObj.screenRh=60},1500)));"ScreenShare"!=a&&virtualclass.vutil.removeClass("audioWidget","fixed")},PrvAndCurrIsWss(a,c){return!("virtualclassWholeScreenShare"!=a||c!=virtualclass.apps.yt)},
handleCurrentUserWithPrevious(){let a=localStorage.getItem("prvUser");if(null==a)virtualclass.setPrvUser();else if(a=JSON.parse(a),a.id!=wbUser.id||a.room!=wbUser.room||wbUser.role!=a.role||a.recording!=virtualclass.settings.recording.enableRecording)virtualclass.gObj.sessionClear=!0,virtualclass.setPrvUser(),roles.hasControls()&&localStorage.setItem("uRole",this.gObj.uRole)},setPrvUser(){localStorage.clear();const a={id:wbUser.id,room:wbUser.room,role:wbUser.role,recording:virtualclass.settings.recording.enableRecording};
console.log("previosu user");localStorage.setItem("prvUser",JSON.stringify(a))},registerPartial(){const a={whiteboardPath},c="precheck teacherVideo audioWidget appTools popupCont appToolsMeeting appSettingDetail joinclass".split(" "),g={hasControl:roles.hasControls()};let d;for(let b=0;b<c.length;b++){d=null;if("precheck"==c[b]||"popupCont"==c[b])d=a;else if("audioWidget"==c[b])d=virtualclassSetting,d.isControl=roles.hasControls(),d.isMettingMode=virtualclass.gObj.meetingMode&&roles.isStudent();else if("teacherVideo"==
c[b]||"appTools"==c[b]||"appSettingDetail"==c[b])d=g;this.makeReadyTemplate(c[b],d)}Handlebars.registerPartial({docNotesMain:this.getTemplate("notesMain","documentSharing"),whiteboardToolbar:this.getTemplate("toolbar","whiteboard"),rightBar:this.getTemplate("rightBar"),recordingControl:this.getTemplate("recordingControl"),leftBar:this.getTemplate("leftBar"),main:this.getTemplate("main"),whiteboard:this.getTemplate("main","whiteboard"),dashboardCont:this.getTemplate("dashboardCont"),multiVideo:this.getTemplate("multiVideo")})},
...
this.registerPartial();var c=this.getTemplate("main");const g={isPlay:virtualclass.isPlayMode,hasControls:roles.hasControls(),meetingMode:virtualclass.gObj.meetingMode};c=c(g);a.insertAdjacentHTML("afterbegin",c)},makeReadyTemplate(a,c){Handlebars.registerPartial(a,(0,JST[`${virtualclass.gObj.tempPrefix}/${a}.hbs`])(c))},getTemplate(a,c){return"undefined"===typeof c?JST[`${virtualclass.gObj.tempPrefix}/${a}.hbs`]:JST[`${virtualclass.gObj.tempPrefix}/${c}/${a}.hbs`]}}}})(window);(function(d,c){d.Vcan=function(){var a={create(b){if("#"==b.charAt(0)){const c=b.substring(1,b.length);a.utility.canvasCalcOffset(c);return a.main(b)}console.log("there is a problem with canvas id")},main(b){a.main.children=[];a.main.id=0;a.main.uid=0;a.main.canvas=c.querySelector(b);a.main.canid=b.substring(1,b.length);a.main.currentTransform="";a.main.replayObjs=[];a.main.dragMode=!1;a.main.scaleMode=!1;a.main.usrCurrAction="";a.main.currObj="";a.main.textObj=!1;a.main.action="create";a.wb={};a.wb.sentPack=
!1;a.activMouse=new a.mouse;a.activMouse.init()},extend(a,c){if("object"===typeof a&&"object"===typeof c){for(const b in c)a[b]=c[b];return a}console.log("it seems that the arguments you passed are not object")},transform(a,c,g){a.translate(c.x,c.y);a.rotate(c.theta);g||a.scale(c.scaleX*(c.flipX?-1:1),c.scaleY*(c.flipY?-1:1))},getStates(b){return a.main[b]},setValInMain(b,c){return a.main[b]=c},ArrayIndexOf(a,c){if(!c||"function"!==typeof c||!a||!a.length||1>a.length)return-1;for(let b=0;b<a.length;b++)if(c(a[b]))return b;
return-1},renderAll(b){"object"!==typeof b&&(b=a.main.canvas.getContext("2d"));a.clearContext(b);this.displayPdfWhiteboard()},normalDisplay(b){console.log(`Whiteboard index ${b}`);"freeDrawing"==a.main.children[b].type?a.fhdRender(ctx,a.main.children[b]):a.render(ctx,a.main.children[b])},displayPdfWhiteboard(){const {length:b}=a.main.children;if(b){const c=a.main.canvas.getContext("2d");for(let f=0;f<b;++f)"pdf"==a.main.children[f].type?console.log("Pdf, Render the data, that should not be a"):"freeDrawing"==
a.main.children[f].type?a.fhdRender(c,a.main.children[f]):a.render(c,a.main.children[f])}},clearContext(b){const c=a.main.canvas;b.clearRect(0,0,c.width,c.height);return c},deactivateAll(){const b=a.main.children;let c=0;const g=b.length;for(;c<g;c++)b[c].setActive(!1)},makeDispObject:function(a){return{coreObj:a,bind(a,b){this.addEventListener(`on${a}`,b)}}},remove:function(b){var c=a.main.canvas,g=a.ArrayIndexOf(a.main.children,a=>a.id==b.id&&(a.mt==b.mt||1==b.multiuser));0<=g&&a.main.children.splice(g,
1);({height:g}=c);const {width:d}=c;c=c.getContext("2d");c.beginPath();c.clearRect(0,0,d,g);c.closePath();a.renderAll()},render:function(b,c,g,d){b.beginPath();b.save();b.lineWidth=void 0!==b.lineWidth?c.lineWidth:2;g||a.transform(b,c,d);b.strokeStyle=void 0!=c.borderColor?c.borderColor:"#000000";"rectangle"==c.type?a.objRect.draw(b,c,g):"line"==c.type?a.objLine.draw(b,c,g):"oval"==c.type?a.objOval.draw(b,c,g):"triangle"==c.type?a.objTri.draw(b,c,g):"text"==c.type&&a.objTxt.draw(b,c,g);c.active&&
!g&&(c.drawBorders(b),c.hideCorners||c.drawCorners(b));b.closePath();b.restore()},fhdRender:function(b,c,g){b.save();var f=c.transformMatrix;f&&b.transform(f[0],f[1],f[2],f[3],f[4],f[5]);g||a.transform(b,c);c.overlayFill?b.fillStyle=c.overlayFill:c.fill&&(b.fillStyle=c.fill);c.stroke&&(b.strokeStyle=c.stroke);b.beginPath();{const a=-(c.width/2),g=-(c.height/2);for(let k=0,m=c.path.length;k<m;++k){var d=c.path[k];switch(d[0]){case "L":f=d[1];d=d[2];b.lineTo(f+a,d+g);break;case "M":f=d[1],d=d[2],b.moveTo(f+
a,d+g)}}}c.fill&&b.fill();c.stroke&&(b.strokeStyle=c.stroke,b.lineWidth=c.strokeWidth,b.lineCap=b.lineJoin="round",b.stroke());!g&&c.active&&(c.drawBorders(b),c.hideCorners||c.drawCorners(b));b.restore()},makeStackObj:function(a,c,g,d){return{mt:a,ac:c,x:g,y:d}}};return a}})(window,document);(function(d,c){d.whiteboard=function(a,b){console.log("Whiteboard new one");const f=a.hasOwnProperty("id")?a.id:"appWhitebaordCont";a=a.hasOwnProperty("class");"object"!==typeof virtualclass.wb[b].vcan&&(virtualclass.wb[b].vcan=new d.Vcan,d.vcanUtility(b),d.vcanMain(b),d.Events(b),d.Virtualbox(b),d.Interact(b),d.Rectangle(b),d.Oval(b),d.Triangle(b),d.Text(b),d.Line(b),d.FreeHandDrawing(b),d.Path(b),d.Mouse(b),d.Optimize(b));return{id:f,classes:a,tool:"",obj:{},prvObj:"",replayTime:0,uid:0,lt:"",view:{},
lang:{},system:{},user:{},gObj:{myrepObj:[],replayObjs:[],myArr:[],displayedObjId:0,packQueue:[],queue:[],virtualWindow:!1},vcan:virtualclass.wb[b].vcan,init(a){var {vcan:b}=virtualclass.wb[a];virtualclass.wb[a].canvas=b.create(`#canvas${a}`);b=b.main.canvas;b.className+=" whiteboards";b.setAttribute("tabindex","0");const f=c.createElement("canvas");f.id=`canvas${a}_pdf`;f.className="pdfs";f.width=b.width;f.height=b.height;virtualclass.vutil.insertAfter(f,b);d.onkeydown=virtualclass.wb[a].utility.keyOperation;
virtualclass.system.setAppDimension(a);"undefined"!==typeof Storage&&(d.virtualclass.wb[a]=virtualclass.wb[a]);this.arrowInit();this._init(a)},_init(a){virtualclass.wb[a].oTeacher=roles.hasAdmin();virtualclass.vutil.chkValueInLocalStorage("rcvdPackId")?virtualclass.wb[a].gObj.rcvdPackId=parseInt(localStorage.rcvdPackId):virtualclass.wb[a].gObj.rcvdPackId=0;d.addEventListener("click",()=>{virtualclass.view.disappearBox("WebRtc");virtualclass.view.disappearBox("Canvas");virtualclass.view.disappearBox("drawArea")});
virtualclass.wb[a].utility.crateCanvasDrawMesssage(a)},UI:{mainContainer(a,b){a=c.querySelector(`#${a}`);if(null!=a){const f=c.createElement("div");f.id=`vcanvas${b}`;f.className="vcanvas";f.dataset.wbId=b;const g=c.createElement("div");g.id=`containerWb${b}`;g.className="containerWb";f.appendChild(g);a.appendChild(f)}else alert("container is null")}},arrowInit(){this.arrImg=new Image;this.arrImg.src="https://cdn.congrea.net/resources/images/arrow.png";this.arrImgDraw=!1;const a=this;this.arrImg.onload=
function(){a.arrImgDraw=!0}},createCommand(a,b){if((a=virtualclass.wb[b].utility.alreadyExistToolBar(b))||null!=localStorage.getItem("educator")&&localStorage.reclaim)return!0;a=virtualclass.getTemplate("toolbar","whiteboard")({cn:b});b=c.getElementById(`containerWb${b}`);null!=b&&b.insertAdjacentHTML("afterbegin",a)},createCommandWrapper(){const a=c.createElement("div");a.id=virtualclass.gObj.commandToolsWrapperId;const b=c.getElementById(vcan.canvasWrapperId);null!=b?c.getElementById("containerWb").insertBefore(a,
b):c.getElementById("containerWb").appendChild(a);return a},createCanvas(a){({vcan:a}=virtualclass.wb[a]);a.canvasWrapperId=cmdToolsWrapper.id},initActiveElement(a,b){a=c.querySelector(a);"undefined"===typeof virtualclass.gObj.wbTool[virtualclass.gObj.currWb]&&(virtualclass.gObj.wbTool[virtualclass.gObj.currWb]={});"undefined"===typeof virtualclass.gObj.wbTool[virtualclass.gObj.currWb][b.type]&&(a.addEventListener("click",this.activeElementHandler.bind(this,b)),virtualclass.gObj.wbTool[virtualclass.gObj.currWb][b.type]=
!0)},activeElementHandler(a,b){this.activeElement(b,a)},activeElement(a,b){var f=c.querySelector(`#t_${b.type}${virtualclass.gObj.currWb} .selected`);null!=f&&f.classList.remove("selected");f=a.target.dataset[b.prop];null!=f&&(a.target.classList.add("selected"),virtualclass.wb[virtualclass.gObj.currWb].changeToolProperty(b.type,f))},objInit(a){const b=virtualclass.vutil.getWhiteboardId(this.parentNode);if(a.target.classList.contains("icon-shapes")||a.target.parentNode.classList.contains("shapes_icon")){var f=
c.querySelector(`#shapes${b}`);f.classList.contains("open")?(f.classList.remove("open"),f.classList.add("close")):(f.classList.contains("close")&&f.classList.remove("close"),f.classList.add("open"),virtualclass.wb[b].closeElem(c.querySelector(`#t_strk${b} .strkSizeList`)),virtualclass.wb[b].closeElem(c.querySelector(`#t_font${b} .fontSizeList`)))}else if(this.parentNode.id==`t_color${b}`)virtualclass.wb[b].closeElem(c.querySelector(`#shapes${virtualclass.gObj.currWb}`)),virtualclass.wb[b].closeElem(c.querySelector(`#t_strk${b} .strkSizeList`)),
virtualclass.wb[b].closeElem(c.querySelector(`#t_font${b} .fontSizeList`)),virtualclass.wb[b].toggleDisplay(this.parentNode.id,b),virtualclass.wb[b].initActiveElement(`#colorList${b}`,{type:"color",prop:"color"});else if(this.parentNode.id==`t_strk${b}`)virtualclass.wb[b].closeElem(c.querySelector(`#shapes${virtualclass.gObj.currWb}`)),virtualclass.wb[b].toggleDisplay(this.parentNode.id,b),virtualclass.wb[b].initActiveElement(`#t_strk${b} ul`,{type:"strk",prop:"stroke"});else if(this.parentNode.id==
...
virtualclass.wb[virtualclass.gObj.currWb].obj.drawTextObj.finalizeTextIfAny();({vcan:a}=virtualclass.wb[b]);roles.hasControls()&&this.parentNode.id!=`t_clearall${b}`&&virtualclass.wb[b].utility.makeActiveTool(this.parentNode.id);this.parentNode.id==`t_replay${b}`?(virtualclass.wb[b].utility.clearAll(!1),virtualclass.vutil.beforeSend({replayAll:!0,cf:replayAll})):virtualclass.wb[b].toolInit(this.parentNode.id,b);if(this.parentNode.id==`t_rectangle${b}`||this.parentNode.id==`t_line${b}`||this.parentNode.id==
`t_oval${b}`||this.parentNode.id==`t_triangle${b}`){const a=this.parentNode.id.slice(2,this.parentNode.id.split(/_doc_*/)[0].length);c.querySelector(`#tool_wrapper${b}`).dataset.currtool=this.parentNode.dataset.tool;c.querySelector(`#shapeIcon${b} a`).dataset.title=a.charAt(0).toUpperCase()+a.slice(1)}else c.querySelector(`#tool_wrapper${b}`).dataset.currtool="shapes",c.querySelector(`#shapeIcon${b} a`).dataset.title="Shapes",virtualclass.wb[b].closeElem(c.querySelector(`#shapes${virtualclass.gObj.currWb}`)),
virtualclass.wb[b].closeElem(c.querySelector(`#t_strk${virtualclass.gObj.currWb} .strkSizeList`)),virtualclass.wb[b].closeElem(c.querySelector(`#t_font${virtualclass.gObj.currWb} .fontSizeList`)),virtualclass.wb[b].closeElem(c.querySelector(`#colorList${virtualclass.gObj.currWb}`));this.parentNode.id!=`t_replay${b}`&&this.parentNode.id!=`t_clearall${b}`&&this.parentNode.id!=`t_reclaim${b}`&&this.parentNode.id!=`t_assign${b}`&&(f=(new Date).getTime(),virtualclass.wb[b].lt=this.parentNode.id,f={cmd:this.parentNode.id.split(/_doc_*/)[0],
mt:f},virtualclass.wb[b].uid++,f.uid=virtualclass.wb[b].uid,a.main.replayObjs.push(f),virtualclass.storage.store(JSON.stringify(a.main.replayObjs)),virtualclass.vutil.beforeSend({repObj:[f],cf:"repObj"}));this.parentNode.id!=`t_clearall${b}`&&(virtualclass.wb[b].prvTool=this.parentNode.id,virtualclass.wb[b].prvToolInfo=f);f=c.querySelector(`#t_font${b}`);a=c.querySelector(`#t_strk${b}`);this.parentNode.id==`t_text${b}`?(f.classList.contains("hide")&&(f.classList.remove("hide"),f.classList.add("show")),
a.classList.add("hide")):(a.classList.contains("hide")&&(a.classList.remove("hide"),a.classList.add("show")),f.classList.add("hide"))}},toggleDisplay(a,b){const f=c.querySelector(`#colorList${b}`);if(a==`t_color${b}`)f.classList.contains("open")?(f.classList.remove("open"),f.classList.add("close")):(f.classList.contains("close")&&f.classList.remove("close"),f.classList.add("open"));else if(a==`t_strk${b}`||a==`t_font${b}`)virtualclass.wb[b].closeElem(f),a=a==`t_strk${b}`?c.querySelector(`#${a} .strkSizeList`):
c.querySelector(`#${a} .fontSizeList`),a.classList.contains("open")?(a.classList.remove("open"),a.classList.add("close")):(a.classList.contains("close")&&a.classList.remove("close"),a.classList.add("open"))},changeToolProperty(a,b){const f=(new Date).getTime();if("color"==a){var g=c.querySelector(`#colorList${virtualclass.gObj.currWb} .selected`).id;virtualclass.wb[virtualclass.gObj.currWb].activeToolColor=b;c.querySelector(`#t_color${virtualclass.gObj.currWb} .disActiveColor`).style.backgroundColor=
virtualclass.wb[virtualclass.gObj.currWb].activeToolColor;g={color:b,elem:g,mt:f}}else"strk"==a?(g=c.querySelector(`#t_strk${virtualclass.gObj.currWb} .selected`).id,virtualclass.wb[virtualclass.gObj.currWb].currStrkSize=b,g={strkSize:b,elem:g,mt:f}):"font"==a&&(g=c.querySelector(`#t_font${virtualclass.gObj.currWb} .selected`).id,virtualclass.wb[virtualclass.gObj.currWb].textFontSize=b,g={fontSize:b,elem:g,mt:f});({vcan:b}=virtualclass.wb[virtualclass.gObj.currWb]);virtualclass.wb[virtualclass.gObj.currWb].uid++;
g.uid=virtualclass.wb[virtualclass.gObj.currWb].uid;b.main.replayObjs.push(g);virtualclass.storage.store(JSON.stringify(b.main.replayObjs));virtualclass.vutil.beforeSend({repObj:[g],cf:"repObj"})},closeElem(a){a.classList.contains("open")&&(a.classList.remove("open"),a.classList.add("close"))},attachToolFunction(a,b,f){virtualclass.wb[f].createCommand(b,f);a=c.getElementById(a).getElementsByTagName("div");for(b=0;b<a.length;b++)a[b].getElementsByTagName("a")[0].addEventListener("click",virtualclass.wb[f].objInit)},
toolInit(a,b,f,d){const g=virtualclass.gObj.currWb;-1>=a.indexOf("_doc_")&&(a+=g);const {vcan:k}=virtualclass.wb[g];"object"===typeof virtualclass.wb[g].obj.drawTextObj&&1==virtualclass.wb[g].obj.drawTextObj.wmode&&k.main.canvas.getContext("2d");0<k.getStates("children").length?a!=`t_clearall${g}`&&("undefined"!==typeof f&&a==`t_replay${g}`||virtualclass.wb[g].utility.deActiveFrmDragDrop(),1!=f&&"t_replay"!=a&&k.renderAll()):k.main.action="create";virtualclass.wb[g].utility.IsObjEmpty(virtualclass.wb[g].obj.freeDrawObj&&
0==f)||(virtualclass.wb[g].obj.freeDrawObj.freesvg=!1);k.main.currUserCommand=`${a}Init`;if(a==`t_activeall${g}`)console.log("command active"),virtualclass.wb[g].utility.t_activeallInit();else if(a==`t_replay${g}`)"undefined"===typeof f&&k.setValInMain("id",0),"undefined"!==typeof d?virtualclass.wb[g].t_replayInit(b,d):virtualclass.wb[g].t_replayInit(b);else if(a==`t_clearall${g}`){if("Whiteboard"==virtualclass.currApp)var m=virtualclass.lang.getString("clearAllWarnMessageW");else"DocumentShare"==
virtualclass.currApp&&(m=virtualclass.lang.getString("clearAllWarnMessageD"));virtualclass.popup.confirmInput(m,b=>{if(!b)return!0;console.log(`Whiteboard clear init ${g}`);virtualclass.wb[g].utility.t_clearallInit();virtualclass.wb[g].utility.makeDefaultValue(a);virtualclass.storage.wbDataRemove(g);virtualclass.vutil.beforeSend({clearAll:!0,cf:"clearAll"});delete virtualclass.gObj.wbTool[virtualclass.gObj.currWb];roles.hasControls()&&(virtualclass.wb[g].currStrkSize=virtualclass.gObj.defalutStrk,
virtualclass.wb[g].textFontSize=virtualclass.gObj.defalutFont,virtualclass.wb[g].activeToolColor=virtualclass.gObj.defaultcolor,c.querySelector(`#t_color${g} .disActiveColor`).style.backgroundColor=virtualclass.wb[g].activeToolColor,b=c.querySelector(`#tool_wrapper${g}`).dataset.currtool,"triangle"!=b&&"line"!=b&&"oval"!=b&&"rectangle"!=b||delete c.querySelector(`#tool_wrapper${g}`).dataset.currtool,c.querySelector(`#shapeIcon${g} a`),b=c.querySelector(`#t_strk${g}`),null!=b&&b.classList.remove("show"),
b=c.querySelector(`#t_font${g}`),null!=b&&b.classList.remove("show"),b=c.querySelector(`#colorList${virtualclass.gObj.currWb} .selected`),null!=b&&b.classList.remove("selected"),b=c.querySelector(`#t_strk${virtualclass.gObj.currWb} .selected`),null!=b&&(b.classList.remove("selected"),c.querySelector(`.strkSizeList #strk-1${g}`).classList.add("selected")),b=c.querySelector(`#t_font${virtualclass.gObj.currWb} .selected`),null!=b&&(b.classList.remove("selected"),c.querySelector(`.fontSizeList #font-1${g}`).classList.add("selected")),
c.querySelector(`#tool_wrapper${virtualclass.gObj.currWb}.shapesToolbox`).classList.remove("active"),localStorage.removeItem("activeTool"))})}else a==`t_assign${g}`?(b=localStorage.getItem("toolHeight"),null!=b?virtualclass.vutil.beforeSend({assignRole:!0,toolHeight:b,socket:virtualclass.wb[g].socketOn}):virtualclass.vutil.beforeSend({assignRole:!0,socket:virtualclass.wb[g].socketOn,cf:"assignRole"})):"t_reclaim"==a&&virtualclass.wb[g].utility._reclaimRole();a!=`t_replay${g}`&&a!=`t_clearallInit${g}`&&
a!=`t_assign${g}`&&a!=`t_reclaim${g}`&&(virtualclass.wb[g].tool=virtualclass.wb[g].tool_obj(a),virtualclass.wb[g].utility.attachEventHandlers(g))},tool_obj(a){if(-1<a.indexOf("_doc_")){var b=c.querySelector(`#${a}`);b=null==b?virtualclass.gObj.currWb:virtualclass.vutil.getWhiteboardId(b)}else b=virtualclass.gObj.currWb,a+=b;this.cmd=a;a!=`t_freeDrawing${b}`&&(virtualclass.wb[b].obj.freeDrawObj="");a==`t_text${b}`||virtualclass.vutil.exitTextWrapper()||(virtualclass.wb[b].obj.drawTextObj="");a==`t_freeDrawing${b}`?
(virtualclass.wb[b].obj.freeDrawObj=new virtualclass.wb[b].readyFreeHandObj("#424240","3"),virtualclass.wb[b].obj.freeDrawObj.init()):a==`t_text${b}`&&(virtualclass.wb[b].obj.drawTextObj=new virtualclass.wb[b].readyTextObj,virtualclass.wb[b].obj.drawTextObj.init(`canvasWrapper${b}`));a=a.slice(2,a.length);-1<a.indexOf("_doc_")&&(a=a.substring(0,a.indexOf("_")));virtualclass.wb[b].draw_object(a,virtualclass.wb[b].canvas,this)},t_replayInit(a,b){const c=virtualclass.gObj.currWb;"fromFile"==a?(virtualclass.gObj.chat.removeAllChat(),
virtualclass.wb[c].recordAudio=!0,virtualclass.recorder.init()):(virtualclass.wb[c].replay=virtualclass.wb[c]._replay(),"undefined"!==typeof b?(virtualclass.wb[c].replay.init(a,b),virtualclass.wb[c].replay.renderObj(b)):(virtualclass.wb[c].replay.init(a),virtualclass.wb[c].replay.renderObj()))}}}})(window,document);(function(d){d.utility=function(){return{userIds:[],isObjExistRE(c){var a=virtualclass.gObj.currWb;if(0<=virtualclass.wb[a].replay.removeElements.length&&(a=virtualclass.wb[a].vcan.ArrayIndexOf(virtualclass.wb[a].replay.removeElements,a=>a.id==c.id),0<=a))return a},IsObjEmpty(c){for(const a in c)if(c.hasOwnProperty(a))return!1;return!0},stringToNumber(c){" "==c[c.length-1]&&(c=c.substring(0,c.length-1));return c=Number(c)},clickOutSidebox(c){return 1!=c%2},keyOperation(c){var a=virtualclass.gObj.currWb;
...
replayFromLocalStroage(c){console.log("PDF, Whiteboard is intializing");const a=virtualclass.gObj.currWb;"undefined"!==typeof Storage&&(!1===virtualclass.storage.reclaim&&virtualclass.vutil.disableAppsBar(),virtualclass.wb[a].utility.clearAll(!1,"dontClear"),virtualclass.wb[a].gObj.tempRepObjs=c,0<c.length&&(virtualclass.wb[a].utility.makeCanvasDisable(),virtualclass.wb[a].utility.toolWrapperDisable(),virtualclass.wb[a].gObj.displayedObjId=0,virtualclass.wb[a].utility.replayObjsByFilter(c,"fromBrowser")))},
setUserStatus(c,a){const b=virtualclass.gObj.currWb;c||a?virtualclass.wb[b].utility.setClass("vcanvas","teacher"):(virtualclass.wb[b].utility.removeToolBox(b),virtualclass.wb[b].utility.setClass("vcanvas","student"))},crateCanvasDrawMesssage(c){roles.hasControls()&&null==localStorage.getItem("canvasDrwMsg")&&(localStorage.canvasDrwMsg=!0)},arrayContainsSameValue(c,a){for(let b=0;b<a.length;b++)if(a[b]!==c)return!1;return!0},actionAfterRemovedUser(){const c=virtualclass.gObj.currWb;virtualclass.wb[c].utility.makeCanvasDisable();
virtualclass.wb[c].utility.setStyleUserConnetion("con","coff");virtualclass.wb[c].utility.removeVirtualWindow("virtualWindow");virtualclass.wb[c].user.connected=!1;wb[c];localStorage.removeItem("otherRole");"undefined"!==typeof cthis&&(tempIsInitiaor=!0,cthis.isStarted&&cthis.handleRemoteHangup())},sendRequest(){virtualclass.vutil.beforeSend({reclaimRole:!0,cf:"reclaimRole"})},updateSentInformation(c,a){if(roles.hasAdmin()){c=JSON.parse(c);a="undefined"!==typeof a?c:c.repObj[0];c="";for(const b in a)c+=
`${b} : ${a[b]} <br />`;null!=document.getElementById("sentMsgInfo")&&(document.getElementById("sentMsgInfo").innerHTML=c)}},beforeSend(c,a){const b=virtualclass.gObj.currWb;if(c.hasOwnProperty("createArrow")){var f=JSON.stringify(c);virtualclass.wb[b].vcan.optimize.sendPacketWithOptimization(f,300)}else{if(c.hasOwnProperty("repObj")){if("undefined"===typeof c.repObj[c.repObj.length-1])return;virtualclass.wb[b].gObj.rcvdPackId=c.repObj[c.repObj.length-1].uid;virtualclass.wb[b].gObj.displayedObjId=
virtualclass.wb[b].gObj.rcvdPackId}f=JSON.stringify(c);io.webSocketConnected()&&("undefined"===typeof a?ioAdapter.mustSend(c):ioAdapter.mustSendUser(c,a));JSON.parse(f).hasOwnProperty("repObj")&&virtualclass.wb[b].utility.updateSentInformation(f)}},checkCanvasHasParents(){let c=document.getElementById("vcanvas");for(;"BODY"!=c.parentNode.tagName;)"vcanvas"!=c.id&&(c.style.margin="0",c.style.padding="0"),c=c.parentNode;"vcanvas"!=c.id&&(c.style.margin="0",c.style.padding="0")},lockvirtualclass(){var c=
virtualclass.gObj.currWb;d.earlierWidth!=d.innerWidth&&(virtualclass.wb[c].canvasDisable=!0,virtualclass.wb[c].utility.makeCanvasDisable(),virtualclass.wb[c].utility.toolWrapperDisable(),virtualclass.vutil.disableAppsBar(),null==document.getElementById("divForReloadMsg")&&(c=roles.hasControls()?"msgForReload":"msgStudentForReload",d.virtualclass.view.displayMsgBox("divForReloadMsg",c),d.earlierWidth=d.innerWidth))},getElementRightOffSet(c){var a=20;null!=c.parentNode&&(c=c.parentNode,a=vcan.utility.getElementOffset(c),
a=d.innerWidth-(c.clientWidth+(a.x-0)));return a},objPutInContainer(c){vcan.main.replayObjs.push(c);virtualclass.storage.store(JSON.stringify(vcan.main.replayObjs))},makeActiveTool(c){const a=virtualclass.gObj.currWb,b=document.getElementById(c);let f;virtualclass.wb[a].hasOwnProperty("prvTool")&&virtualclass.wb[a].prvTool!=`t_reclaim${a}`?(f=virtualclass.vutil.removeClassFromElement(virtualclass.wb[a].prvTool,"active"),document.getElementById(virtualclass.wb[a].prvTool).className=f):f=b.className;
virtualclass.wb[a].utility.themeColorShapes(c);b.className=`${f} active`;localStorage.activeTool=b.id},themeColorShapes(c){c=c.split(/_doc_*/)[0];const a=document.querySelector(`#tool_wrapper${virtualclass.gObj.currWb}.shapesToolbox`);"t_line"==c||"t_oval"==c||"t_rectangle"==c||"t_triangle"==c?a.classList.add("active"):a.classList.remove("active")},makeDeActiveTool(){virtualclass.wb[virtualclass.gObj.currWb].tool="";document.getElementById("commandToolsWrapper");const c=document.getElementsByClassName("tool active");
0<c.length&&c[0].classList.remove("active")},createAudioTransmitIcon(c){const a=document.cteateElement("div");a.id=`audioTransmit${uuserId}`;a.className="audioTransmit";document.getElementById(`${c}ControlContainer`)},_reclaimRole(){const c=virtualclass.gObj.currWb;virtualclass.wb[c].utility.reclaimRole();virtualclass.wb[c].utility.sendRequest();virtualclass.user.control.changeAttrToAssign("enable")},enableAppsBar(){const c=document.getElementById("virtualclassOptionsCont");null!=c&&(c.style.pointerEvents=
"visible")},replayObjsByFilter(c,a){const b=virtualclass.gObj.currWb;for(let f=0;f<c.length;f++){virtualclass.wb[b].bridge.makeQueue(c[f]);if(c[f].hasOwnProperty("cmd")){if(roles.hasControls()){const a=c[f].cmd.slice(2,c[f].cmd.length),d=document.querySelector(`${"#tool_wrapper"}${b}`),m=document.querySelector(`#tool_wrapper${virtualclass.gObj.currWb}.shapesToolbox`);"triangle"==a||"line"==a||"oval"==a||"rectangle"==a?(document.querySelector(`#shapeIcon${b} a`).dataset.title=a.charAt(0).toUpperCase()+
a.slice(1),d.dataset.currtool=a,m.classList.add("active")):(document.querySelector(`#shapeIcon${b} a`).dataset.title="Shapes",d.dataset.currtool="shapes",m.classList.remove("active"))}}else c[f].hasOwnProperty("color")?(virtualclass.wb[b].activeToolColor=c[f].color,roles.hasControls()&&(document.querySelector(`#t_color${b} .disActiveColor`).style.backgroundColor=virtualclass.wb[b].activeToolColor,virtualclass.wb[b].utility.selectElem(`#colorList${b}`,c[f].elem))):c[f].hasOwnProperty("strkSize")?(virtualclass.wb[b].currStrkSize=
c[f].strkSize,roles.hasControls()&&(document.querySelector(`#t_strk${b} ul`).dataset.stroke=virtualclass.wb[b].currStrkSize,virtualclass.wb[b].utility.selectElem(`#t_strk${b}`,c[f].elem))):c[f].hasOwnProperty("fontSize")&&(virtualclass.wb[b].textFontSize=c[f].fontSize,roles.hasControls()&&(document.querySelector(`#t_font${b} ul`).dataset.font=virtualclass.wb[b].textFontSize,virtualclass.wb[b].utility.selectElem(`#t_font${b}`,c[f].elem)));c[f].uid==virtualclass.wb[b].gObj.displayedObjId+1&&(virtualclass.wb[b].uid=
c[f].uid,this.executeWhiteboardData(c[f]),"undefined"!==typeof a&&(virtualclass.wb[b].gObj.rcvdPackId=virtualclass.wb[b].uid))}0<virtualclass.wb[b].gObj.replayObjs.length&&virtualclass.storage.store(JSON.stringify(virtualclass.wb[b].gObj.replayObjs));roles.hasControls()&&(c=document.querySelector(`#t_font${b}`),a=document.querySelector(`#t_strk${b}`),virtualclass.wb[b].tool.cmd==`t_text${b}`?(c.classList.contains("hide")&&(c.classList.remove("hide"),c.classList.add("show")),a.classList.add("hide")):
c.classList.contains("hide")||c.classList.add("hide"))},selectElem(c,a){const b=document.querySelector(`${c} .selected`);null!=b&&b.classList.remove("selected");c=document.querySelector(`${c} #${a}`);null!=c&&c.classList.add("selected")},executeWhiteboardData(c){const a=virtualclass.gObj.currWb;virtualclass.wb[a].gObj.replayObjs.push(c);virtualclass.wb[a].response.replayObj([c]);this.checkNextQueue(c)},checkNextQueue(c){(c=this.findPacketInQueue(c))&&this.executeWhiteboardData(c)},findPacketInQueue(c){const a=
virtualclass.gObj.currWb;c.hasOwnProperty("color")?virtualclass.wb[a].activeToolColor=c.color:c.hasOwnProperty("strkSize")?virtualclass.wb[a].currStrkSize=c.strkSize:c.hasOwnProperty("fontSize")&&(virtualclass.wb[a].textFontSize=c.fontSize);return virtualclass.wb[a].gObj.queue.hasOwnProperty(c.uid+1)?virtualclass.wb[a].gObj.queue[c.uid+1]:!1},putScrollWithCevent(c){return c=this.scaleCordinate(c)},scaleCordinate(c){c.detail.cevent.x*=virtualclass.zoom.canvasScale;c.detail.cevent.y*=virtualclass.zoom.canvasScale;
return c},scaleMoveCordinate(c){c.x=ev.detail.cevent.x/virtualclass.zoom.canvasScale;c.y=ev.detail.cevent.y/virtualclass.zoom.canvasScale;return c}}}})(window);(function(d){d.message={ActiveAll:"Active all",Addoption:"Add option",addnew:"Add new",adminusr:"Admin user",appPrerequites:"Validate app prerequisites",assign:"Assign",assignDisable:"Reclaim controls",askplayMessage:'<span id="askplaymsg"> Should we start playing the session?</span><br /><span id="remaingmsg">Remaining data will be downloaded in the background.</span>',askplaymsg:'<span id="askplaymsg"> "Downloading in progress, click Play to begin </span>"',audioInput:"Audio input",audiolatency:"Audio latency",
...
setTimeout(()=>{const a=document.querySelector(".zoomControler .fitScreen");null!=a&&a.click()},700))};a.virtualWindow.manupulation=function(a){const b=a.message.virtualWindow;if(b.hasOwnProperty("removeVirtualWindow"))a.fromUser.userid!=wbUser.id&&virtualclass.wb[virtualclass.gObj.currWb].utility.removeVirtualWindow("virtualWindow");else if(b.hasOwnProperty("createVirtualWindow"))b.hasOwnProperty("toolHeight")&&localStorage.setItem("toolHeight",b.toolHeight),a.fromUser.userid!=wbUser.id&&virtualclass.wb[virtualclass.gObj.currWb].utility.createVirtualWindow(b.createVirtualWindow);
else if(b.hasOwnProperty("shareBrowserWidth")){b.hasOwnProperty("toolHeight")&&localStorage.setItem("toolHeight",b.toolHeight);if(roles.hasControls()){var c=virtualclass.wb[virtualclass.gObj.currWb].utility.getWideValueAppliedByCss("commandToolsWrapper");localStorage.setItem("toolHeight",c)}a.fromUser.userid!=wbUser.id?(roles.hasControls()&&virtualclass.wb[virtualclass.gObj.currWb].utility.makeCanvasEnable(),otherBrowser=b.browserRes):myBrowser=virtualclass.system.measureResoultion({width:d.outerWidth,
height:d.innerHeight});"object"===typeof myBrowser&&"object"===typeof otherBrowser&&(myBrowser.width>otherBrowser.width?virtualclass.wb[virtualclass.gObj.currWb].gObj.virtualWindow||(virtualclass.wb[virtualclass.gObj.currWb].utility.createVirtualWindow(otherBrowser),virtualclass.wb[virtualclass.gObj.currWb].gObj.virtualWindow=!0):myBrowser.width<otherBrowser.width&&!virtualclass.wb[virtualclass.gObj.currWb].gObj.virtualWindow&&(a=document.getElementById("vcanvas"),a=virtualclass.wb[virtualclass.gObj.currWb].utility.getElementRightOffSet(a),
roles.hasControls()?virtualclass.vutil.beforeSend({virtualWindow:{createVirtualWindow:myBrowser-a,toolHeight:c}}):virtualclass.vutil.beforeSend({virtualWindow:{createVirtualWindow:myBrowser-a}})))}};d.view=a})(window);(function(d){var c={init(){this.wbRtc={};this.wbRtc.className="webrtcCont";this.mybrowser={};return this},isCanvasSupport(a,b,c){console.log("is canvas support");console.log(a);console.log(b);return"MSIE"==b?9==c:!!d.CanvasRenderingContext2D},isWebSocketSupport(a,b,c){return"undefined"===typeof d.WebSocket||"function"!==typeof d.WebSocket&&"object"!==typeof d.WebSocket||!d.WebSocket.hasOwnProperty("OPEN")?!1:!0},isLocalStorageSupport(){return void 0!==Storage},isGetUserMediaSupport(a,b){navigator.getUserMedia=
...
c?(b.setAttribute("device","mobile"),b.classList.add("ios"),this.isIPad()&&roles.isStudent()&&(8<=a?console.log("do nothing"):(virtualclass.vutil.initDisableVirtualClass(),virtualclass.error.push(virtualclass.lang.getString("ios7support"))))):this.mybrowser.detectIE()&&(virtualclass.gObj.errIE=!0,virtualclass.error.push(virtualclass.lang.getString("ieBrowserIssue")),virtualclass.vutil.initDisableVirtualClass())},mediaDevices:{webcamErr:[],getMediaDeviceInfo(){navigator.mediaDevices&&navigator.mediaDevices.enumerateDevices&&
(navigator.enumerateDevices=function(a){navigator.mediaDevices.enumerateDevices().then(a)});let a=[];const b="https:"===location.protocol;let c=!1;"undefined"!==typeof MediaStreamTrack&&"getSources"in MediaStreamTrack?c=!0:navigator.mediaDevices&&navigator.mediaDevices.enumerateDevices&&(c=!0);let g=this.hasWebcam=this.hasSpeakers=this.hasMicrophone=!1,k=!1;const m=this;(function(f){c&&(!navigator.enumerateDevices&&d.MediaStreamTrack&&d.MediaStreamTrack.getSources&&(navigator.enumerateDevices=d.MediaStreamTrack.getSources.bind(d.MediaStreamTrack)),
!navigator.enumerateDevices&&navigator.enumerateDevices&&(navigator.enumerateDevices=navigator.enumerateDevices.bind(navigator)),navigator.enumerateDevices?(a=[],navigator.enumerateDevices(c=>{c.forEach(c=>{const f={};for(const a in c)f[a]=c[a];"audio"===f.kind&&(f.kind="audioinput");"video"===f.kind&&(f.kind="videoinput");let d;a.forEach(a=>{a.id===f.id&&a.kind===f.kind&&(d=!0)});d||(f.deviceId||(f.deviceId=f.id),f.id||(f.id=f.deviceId),f.label?("videoinput"!==f.kind||k||(k=!0),"audioinput"!==f.kind||
g||(g=!0)):(f.label="Please invoke getUserMedia once.",b||(f.label=`HTTPs is required to get label of this ${f.kind} device.`)),"audioinput"===f.kind&&(m.hasMicrophone=!0),"audiooutput"===f.kind&&(m.hasSpeakers=!0),"videoinput"===f.kind&&(m.hasWebcam=!0),a.push(f))});f&&f()})):f&&f())})()}},webpInit(){virtualclass.modernizr.on("webp",a=>{virtualclass.system.webpSupport=!!a})},initResize(){virtualclass.gObj.hasOwnProperty("measureDimension")&&delete virtualclass.gObj.measureDimension;virtualclass.gObj.hasOwnProperty("initResize")&&
clearTimeout(virtualclass.gObj.initResize);virtualclass.gObj.initResize=setTimeout(()=>{virtualclass.vutil.addClass("virtualclassCont","resizeWindow");c.setAppDimension(null,"resize");virtualclass.view.window.resize()},50)},_initResize(){virtualclass.vutil.addClass("virtualclassCont","resizeWindow");c.setAppDimension(null,"resize");virtualclass.view.window.resize()}};c=c.init();d.addEventListener("resize",()=>{c.initResize()});c.mybrowser.detectIE=function(){const a=d.navigator.userAgent;var b=a.indexOf("MSIE ");
if(0<b)return parseInt(a.substring(b+5,a.indexOf(".",b)),10);if(0<a.indexOf("Trident/"))return b=a.indexOf("rv:"),parseInt(a.substring(b+3,a.indexOf(".",b)),10);b=a.indexOf("Edge/");return 17<=b?!1:parseInt(a.substring(b+5,a.indexOf(".",b)),10)};c.mybrowser.detection=function(){let a;const b=navigator.userAgent;let c,g=b.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];/trident/i.test(g[1])&&(c=/\brv[ :]+(\d+)/g.exec(b)||[],a={name:"IE",version:c[1]||""});"Chrome"===g[1]&&
(c=b.match(/\b(OPR|Edge)\/(\d+)/),null!=c&&(a={name:c[1].replace("OPR","Opera"),version:c[2]}));g=g[2]?[g[1],g[2]]:[navigator.appName,navigator.appVersion,"-?"];null!=(c=b.match(/version\/(\d+)/i))&&(g.splice(1,1,c[1]),a={name:g[0],version:g[1]});return"undefined"!==typeof a?[a.name,a.version]:g};d.system=c})(window);(function(d){d.packContainer=function(){return{createPacketContDiv(c,a){const b=document.createElement("div");"undefined"!==typeof c&&(b.id=c);"undefined"!==typeof a&&(b.clasName=a);return b},togglePacketCont(c){const a=this.className.split(" ");for(let b=0;b<a.length;b++)if("display"==a[b]){this.className="hide";this.innerHTML="+";c._togglePacketCont(a[b]);break}else if("hide"==a[b]){this.className="display";this.innerHTML="-";c._togglePacketCont(a[b]);break}},_togglePacketCont(c){c="display"==c?
...
c=(f+c-b)/this.scaleY;({height:f}=this);a.save();a.fillStyle=this.cornerColor;a.fillRect(g-p,d-v,z,t);b=g+this.width-p;a.fillRect(b,d-v,z,t);a.fillRect(g-p,d+f+c,z,t);b=g+this.width+u;a.fillRect(b,d+f+c,z,t);b=g+this.width/2-p;a.fillRect(b,d-v,z,t);b=g+this.width/2-p;a.fillRect(b,d+f+c,z,t);b=g+this.width+u;a.fillRect(b,d+f/2-v,z,t);a.fillRect(g-p,d+f/2-v,z,t);this.hasRotatingPoint&&(b=g+this.width/2-p,g=this.flipY?d+f+this.rotatingPointOffset/this.scaleY-t/2:d-this.rotatingPointOffset/this.scaleY-
...
a.utility.getReltivePoint(b),{x:d}=f;({y:f}=f);const m=a.virtual_box.getImageLines(c.oCoords);return(d=a.virtual_box.findCrossPoints(d,f,m))&&1===d%2||c.findTargetCorner(b)?!0:!1}}}})(window);(function(d){d.Interact=function(c){const {vcan:a}=virtualclass.wb[c];a.interact={rotateObject(b,c){const f=a.main.currentTransform,d=a.main.offset;f.target.lockRotation||a.utility.setVal(f.target,"theta",Math.atan2(c-f.y-d.y,b-f.x-d.x)-Math.atan2(f.ey-f.y-d.y,f.ex-f.x-d.x)+f.theta)},scaleObject(b,c,g){const f=a.main.currentTransform,{offset:d}=a.main;target=f.target;if(!target.lockScalingX||!target.lockScalingY){var n=Math.sqrt(Math.pow(f.ey-f.y-d.y,2)+Math.pow(f.ex-f.x-d.x,2));b=Math.sqrt(Math.pow(c-
f.y-d.y,2)+Math.pow(b-f.x-d.x,2));target.scaling=!0;g?"x"!==g||target.lockUniScaling?"y"!==g||target.lockUniScaling||target.lockScalingY||a.utility.setVal(target,"scaleY",f.scaleY*b/n):target.lockScalingX||a.utility.setVal(target,"scaleX",f.scaleX*b/n):(target.lockScalingX||a.utility.setVal(target,"scaleX",f.scaleX*b/n),target.lockScalingY||a.utility.setVal(target,"scaleY",f.scaleY*b/n))}},translateObject(b,c){const {target:f}=a.main.currentTransform;f.lockMovementX||a.utility.setVal(f,"x",b-a.main.currentTransform.offsetX);
f.lockMovementY||a.utility.setVal(f,"y",c-a.main.currentTransform.offsetY);return f}}}})(window);(function(d){d.Rectangle=function(c){({vcan:c}=virtualclass.wb[c]);c.rectangle=function(){return{type:"rectangle",init(a){void 0==a.x&&(a.x=a.ex-a.width/2);void 0==a.y&&(a.y=a.ey-a.height/2);return a},draw(a,b,c){c=-b.width/2;const f=-b.height/2,d=b.width,m=b.height;a.beginPath();a.strokeStyle=void 0!=b.borderColor?`"${b.strokeColor}"`:"#000";a.moveTo(c,f);a.stroke();a.strokeStyle=b.color;a.stroke();a.lineWidth=b.stroke;a.stroke();a.lineTo(c+d,f);a.stroke();a.lineTo(c+d,f+m);a.stroke();a.lineTo(c,
...
this.freeDrawingYPoints.push(a.y);this.contextTop.lineTo(a.x,a.y);this.contextTop.stroke();this.mdTime.push(b)},finalizeDrawingPath(c,g,d){(new Date).getTime();this.contextTop.closePath();this.isCurrentlyDrawing=!1;const f=this.utility.min(this.freeDrawingXPoints);g=this.utility.min(this.freeDrawingYPoints);const k=this.utility.max(this.freeDrawingXPoints);d=this.utility.max(this.freeDrawingYPoints);let q=[];var r,z,t;const v=this.freeDrawingXPoints,p=this.freeDrawingYPoints,u=this.mdTime;q.push("M ",
v[0]-f," ",p[0]-g," ",u[0]," ");for(let a=1;r=v[a],z=p[a],t=u[a];a++)q.push("L ",r-f," ",z-g," ",t," ");q=q.join("");if("M 0 0 L 0 0 "!==q)return r=this.freeDrawingXPoints[this.freeDrawingXPoints.length-1],z=this.freeDrawingYPoints[this.freeDrawingYPoints.length-1],t=new a.Path(q,this),t.mp={},t.mp.x=r,t.mp.y=z,t.init(q),t=c.readyObject(t),t.coreObj.type="freeDrawing",t=t.coreObj,t.fill=null,t.stroke=this.freeDrawingColor,t.strokeWidth=this.freeDrawingLineWidth,t.minX=f,t.minY=g,this.utility.objAdd(t),
...
return a};f.prototype.addTrack=function(b,f){if(this.transceivers.find(a=>a.track===b))throw v("InvalidAccessError","Track already exists.");if("closed"===this.signalingState)throw v("InvalidStateError","Attempted to call addTrack on a closed peerconnection.");let g;for(let a=0;a<this.transceivers.length;a++)this.transceivers[a].track||this.transceivers[a].kind!==b.kind||(g=this.transceivers[a]);g||(g=this._createTransceiver(b.kind));this._maybeFireNegotiationNeeded();-1===this.localStreams.indexOf(f)&&
...
const f=this.transceivers.find(a=>a.rtpSender===b);if(!f)throw v("InvalidAccessError","Sender was not created by this connection.");const {stream:g}=f;f.rtpSender.stop();f.rtpSender=null;f.track=null;f.stream=null;-1===this.transceivers.map(a=>a.stream).indexOf(g)&&-1<this.localStreams.indexOf(g)&&this.localStreams.splice(this.localStreams.indexOf(g),1);this._maybeFireNegotiationNeeded()};f.prototype.removeStream=function(a){const b=this;a.getTracks().forEach(a=>{const f=b.getSenders().find(b=>b.track===
...
(d.rtcp.cname=a.rtcpParameters.cname),a.sendEncodingParameters.length&&(d.rtcp.ssrc=a.sendEncodingParameters[0].ssrc),a.rtpReceiver.receive(d))};f.prototype.setLocalDescription=function(a){const b=this;if(!n("setLocalDescription",a.type,this.signalingState)||this._isClosed)return Promise.reject(v("InvalidStateError",`Can not set local ${a.type} in state ${b.signalingState}`));let f,g;if("offer"===a.type)f=p.splitSections(a.sdp),g=f.shift(),f.forEach((a,f)=>{a=p.parseRtpParameters(a);b.transceivers[f].localCapabilities=
a}),this.transceivers.forEach((a,f)=>{b._gather(a.mid,f)});else if("answer"===a.type){f=p.splitSections(b.remoteDescription.sdp);g=f.shift();const a=0<p.matchPrefix(g,"a=ice-lite").length;f.forEach((f,d)=>{const k=b.transceivers[d],{iceGatherer:n}=k,{iceTransport:u}=k,{dtlsTransport:q}=k,{localCapabilities:B}=k,{remoteCapabilities:v}=k;if(!(p.isRejected(f)&&0===p.matchPrefix(f,"a=bundle-only").length||k.isDatachannel)){const r=p.getIceParameters(f,g);f=p.getDtlsParameters(f,g);a&&(f.role="server");
b.usingBundle&&0!==d||(b._gather(k.mid,d),"new"===u.state&&u.start(n,r,a?"controlling":"controlled"),"new"===q.state&&q.start(f));d=m(B,v);b._transceive(k,0<d.codecs.length,!1)}})}this.localDescription={type:a.type,sdp:a.sdp};switch(a.type){case "offer":this._updateSignalingState("have-local-offer");break;case "answer":this._updateSignalingState("stable");break;default:throw new TypeError(`unsupported type "${a.type}"`);}return Promise.resolve()};f.prototype.setRemoteDescription=function(f){const g=
this;if(!n("setRemoteDescription",f.type,this.signalingState)||this._isClosed)return Promise.reject(v("InvalidStateError",`Can not set remote ${f.type} in state ${g.signalingState}`));const d={};this.remoteStreams.forEach(a=>{d[a.id]=a});const k=[],m=p.splitSections(f.sdp),u=m.shift(),B=0<p.matchPrefix(u,"a=ice-lite").length,C=0<p.matchPrefix(u,"a=group:BUNDLE ").length;this.usingBundle=C;const F=p.matchPrefix(u,"a=ice-options:")[0];this.canTrickleIceCandidates=F?0<=F.substr(14).split(" ").indexOf("trickle"):
!1;m.forEach((m,n)=>{var v=p.splitLines(m),t=p.getKind(m),F=p.isRejected(m)&&0===p.matchPrefix(m,"a=bundle-only").length,G=v[0].substr(2).split(" ")[2];v=p.getDirection(m,u);const D=p.parseMsid(m);var H=p.getMid(m)||p.generateIdentifier();if("application"===t&&"DTLS/SCTP"===G)g.transceivers[n]={mid:H,isDatachannel:!0};else{var A=p.parseRtpParameters(m);if(!F){var I=p.getIceParameters(m,u);var M=p.getDtlsParameters(m,u);M.role="client"}G=p.parseRtpEncodingParameters(m);var N=p.parseRtcpParameters(m),
O=0<p.matchPrefix(m,"a=end-of-candidates",u).length,L=p.matchPrefix(m,"a=candidate:").map(a=>p.parseCandidate(a)).filter(a=>1===a.component);("offer"===f.type||"answer"===f.type)&&!F&&C&&0<n&&g.transceivers[n]&&(g._disposeIceAndDtlsTransports(n),g.transceivers[n].iceGatherer=g.transceivers[0].iceGatherer,g.transceivers[n].iceTransport=g.transceivers[0].iceTransport,g.transceivers[n].dtlsTransport=g.transceivers[0].dtlsTransport,g.transceivers[n].rtpSender&&g.transceivers[n].rtpSender.setTransport(g.transceivers[0].dtlsTransport),
g.transceivers[n].rtpReceiver&&g.transceivers[n].rtpReceiver.setTransport(g.transceivers[0].dtlsTransport));if("offer"!==f.type||F)"answer"!==f.type||F||(E=g.transceivers[n],K=E.iceGatherer,t=E.iceTransport,H=E.dtlsTransport,J=E.rtpReceiver,F=E.sendEncodingParameters,m=E.localCapabilities,g.transceivers[n].recvEncodingParameters=G,g.transceivers[n].remoteCapabilities=A,g.transceivers[n].rtcpParameters=N,L.length&&"new"===t.state&&(!B&&!O||C&&0!==n?L.forEach(a=>{q(E.iceTransport,a)}):t.setRemoteCandidates(L)),
C&&0!==n||("new"===t.state&&t.start(K,I,"controlling"),"new"===H.state&&H.start(M)),g._transceive(E,"sendrecv"===v||"recvonly"===v,"sendrecv"===v||"sendonly"===v),!J||"sendrecv"!==v&&"sendonly"!==v?delete E.rtpReceiver:(v=J.track,D?(d[D.stream]||(d[D.stream]=new a.MediaStream),r(v,d[D.stream]),k.push([v,J,d[D.stream]])):(d.default||(d.default=new a.MediaStream),r(v,d.default),k.push([v,J,d.default]))));else{var E=g.transceivers[n]||g._createTransceiver(t);E.mid=H;E.iceGatherer||(E.iceGatherer=g._createIceGatherer(n,
C));L.length&&"new"===E.iceTransport.state&&(!O||C&&0!==n?L.forEach(a=>{q(E.iceTransport,a)}):E.iceTransport.setRemoteCandidates(L));m=a.RTCRtpReceiver.getCapabilities(t);15019>b&&(m.codecs=m.codecs.filter(a=>"rtx"!==a.name));F=E.sendEncodingParameters||[{ssrc:1001*(2*n+2)}];I=!1;if("sendrecv"===v||"sendonly"===v){I=!E.rtpReceiver;var J=E.rtpReceiver||new a.RTCRtpReceiver(E.dtlsTransport,t);if(I){v=J.track;if(!D||"-"!==D.stream)if(D){d[D.stream]||(d[D.stream]=new a.MediaStream,Object.defineProperty(d[D.stream],
"id",{get(){return D.stream}}));Object.defineProperty(v,"id",{get(){return D.track}});var K=d[D.stream]}else d.default||(d.default=new a.MediaStream),K=d.default;K&&(r(v,K),E.associatedRemoteMediaStreams.push(K));k.push([v,J,K])}}else E.rtpReceiver&&E.rtpReceiver.track&&(E.associatedRemoteMediaStreams.forEach(a=>{const b=a.getTracks().find(a=>a.id===E.rtpReceiver.track.id);b&&z(b,a)}),E.associatedRemoteMediaStreams=[]);E.localCapabilities=m;E.remoteCapabilities=A;E.rtpReceiver=J;E.rtcpParameters=
N;E.sendEncodingParameters=F;E.recvEncodingParameters=G;g._transceive(g.transceivers[n],!1,I)}}});void 0===this._dtlsRole&&(this._dtlsRole="offer"===f.type?"active":"passive");this.remoteDescription={type:f.type,sdp:f.sdp};switch(f.type){case "offer":this._updateSignalingState("have-remote-offer");break;case "answer":this._updateSignalingState("stable");break;default:throw new TypeError(`unsupported type "${f.type}"`);}Object.keys(d).forEach(b=>{const f=d[b];if(f.getTracks().length){if(-1===g.remoteStreams.indexOf(f)){g.remoteStreams.push(f);
...
f.component)return Promise.resolve();if((0===b||0<b&&g.iceTransport!==this.transceivers[0].iceTransport)&&!q(g.iceTransport,f))return Promise.reject(v("OperationError","Can not add ICE candidate"));g=a.candidate.trim();0===g.indexOf("a=")&&(g=g.substr(2));a=p.splitSections(this.remoteDescription.sdp);a[b+1]+=`a=${f.type?g:"end-of-candidates"}\r\n`;this.remoteDescription.sdp=a.join("")}else return Promise.reject(v("OperationError","Can not add ICE candidate"))}else return Promise.reject(v("InvalidStateError",
...
d=-1!==f.fecMechanisms.indexOf("RED"),k=-1!==f.fecMechanisms.indexOf("ULPFEC");var z=g.matchPrefix(a,"a=ssrc:").map(a=>g.parseSsrcMedia(a)).filter(a=>"cname"===a.attribute);const t=0<z.length&&z[0].ssrc;let v;z=g.matchPrefix(a,"a=ssrc-group:FID").map(a=>{a=a.split(" ");a.shift();return a.map(a=>parseInt(a,10))});0<z.length&&1<z[0].length&&z[0][0]===t&&(v=z[0][1]);f.codecs.forEach(a=>{"RTX"===a.name.toUpperCase()&&a.parameters.apt&&(a={ssrc:t,codecPayloadType:parseInt(a.parameters.apt,10),rtx:{ssrc:v}},
b.push(a),d&&(a=JSON.parse(JSON.stringify(a)),a.fec={ssrc:v,mechanism:k?"red+ulpfec":"red"},b.push(a)))});0===b.length&&t&&b.push({ssrc:t});let p=g.matchPrefix(a,"b=");p.length&&(p=0===p[0].indexOf("b=TIAS:")?parseInt(p[0].substr(7),10):0===p[0].indexOf("b=AS:")?950*parseInt(p[0].substr(5),10)-16E3:void 0,b.forEach(a=>{a.maxBitrate=p}));return b};g.parseRtcpParameters=function(a){const b={};var f=g.matchPrefix(a,"a=ssrc:").map(a=>g.parseSsrcMedia(a)).filter(a=>"cname"===a.attribute)[0];f&&(b.cname=
...
f=g.log;k=g.detectBrowser(b);const m=a("./chrome/chrome_shim")||null,z=a("./edge/edge_shim")||null,t=a("./firefox/firefox_shim")||null,v=a("./safari/safari_shim")||null,p=a("./common_shim")||null,u={browserDetails:k,commonShim:p,extractVersion:g.extractVersion,disableLog:g.disableLog,disableWarnings:g.disableWarnings};switch(k.browser){case "chrome":if(!m||!m.shimPeerConnection||!d.shimChrome){f("Chrome shim is not included in this adapter release.");break}f("adapter.js shimming chrome.");u.browserShim=
m;p.shimCreateObjectURL(b);m.shimGetUserMedia(b);m.shimMediaStream(b);m.shimSourceObject(b);m.shimPeerConnection(b);m.shimOnTrack(b);m.shimAddTrackRemoveTrack(b);m.shimGetSendersWithDtmf(b);p.shimRTCIceCandidate(b);p.shimMaxMessageSize(b);p.shimSendThrowTypeError(b);break;case "firefox":if(!t||!t.shimPeerConnection||!d.shimFirefox){f("Firefox shim is not included in this adapter release.");break}f("adapter.js shimming firefox.");u.browserShim=t;p.shimCreateObjectURL(b);t.shimGetUserMedia(b);t.shimSourceObject(b);
t.shimPeerConnection(b);t.shimOnTrack(b);t.shimRemoveStream(b);p.shimRTCIceCandidate(b);p.shimMaxMessageSize(b);p.shimSendThrowTypeError(b);break;case "edge":if(!z||!z.shimPeerConnection||!d.shimEdge){f("MS edge shim is not included in this adapter release.");break}f("adapter.js shimming edge.");u.browserShim=z;p.shimCreateObjectURL(b);z.shimGetUserMedia(b);z.shimPeerConnection(b);z.shimReplaceTrack(b);p.shimMaxMessageSize(b);p.shimSendThrowTypeError(b);break;case "safari":if(!v||!d.shimSafari){f("Safari shim is not included in this adapter release.");
break}f("adapter.js shimming safari.");u.browserShim=v;p.shimCreateObjectURL(b);v.shimRTCIceServerUrls(b);v.shimCallbacksAPI(b);v.shimLocalStreamsAPI(b);v.shimRemoteStreamsAPI(b);v.shimTrackEventTransceiver(b);v.shimGetUserMedia(b);v.shimCreateOfferLegacy(b);p.shimRTCIceCandidate(b);p.shimMaxMessageSize(b);p.shimSendThrowTypeError(b);break;default:f("Unsupported browser!")}return u}},{"./chrome/chrome_shim":5,"./common_shim":7,"./edge/edge_shim":8,"./firefox/firefox_shim":10,"./safari/safari_shim":12,
...
a.audio=k(a.audio)}if(a&&"object"===typeof a.video){let u=a.video.facingMode;u=u&&("object"===typeof u?u:{ideal:u});m=66>b.version;if(!(!u||"user"!==u.exact&&"environment"!==u.exact&&"user"!==u.ideal&&"environment"!==u.ideal||f.mediaDevices.getSupportedConstraints&&f.mediaDevices.getSupportedConstraints().facingMode&&!m)){delete a.video.facingMode;let b;if("environment"===u.exact||"environment"===u.ideal)b=["back","rear"];else if("user"===u.exact||"user"===u.ideal)b=["front"];if(b)return f.mediaDevices.enumerateDevices().then(f=>
{f=f.filter(a=>"videoinput"===a.kind);let m=f.find(a=>b.some(b=>-1!==a.label.toLowerCase().indexOf(b)));!m&&f.length&&-1!==b.indexOf("back")&&(m=f[f.length-1]);m&&(a.video.deviceId=u.exact?{exact:m.deviceId}:{ideal:m.deviceId});a.video=k(a.video);d(`chrome: ${JSON.stringify(a)}`);return g(a)})}a.video=k(a.video)}d(`chrome: ${JSON.stringify(a)}`);return g(a)},t=function(a){return{name:{PermissionDeniedError:"NotAllowedError",InvalidStateError:"NotReadableError",DevicesNotFoundError:"NotFoundError",
ConstraintNotSatisfiedError:"OverconstrainedError",TrackStartError:"NotReadableError",MediaDeviceFailedDueToShutdown:"NotReadableError",MediaDeviceKillSwitchOn:"NotReadableError"}[a.name]||a.name,message:a.message,constraint:a.constraintName,toString(){return this.name+(this.message&&": ")+this.message}}};f.getUserMedia=function(a,b,g){m(a,a=>{f.webkitGetUserMedia(a,b,a=>{g&&g(t(a))})})};const v=function(a){return new Promise((b,g)=>{f.getUserMedia(a,b,g)})};f.mediaDevices||(f.mediaDevices={getUserMedia:v,
...
function(a){if("getTracks"in a){const b=`polyblob:${++m}`;k.set(b,a);d.deprecated("URL.createObjectURL(stream)","elem.srcObject = stream");return b}return f(a)};b.revokeObjectURL=function(a){g(a);k.delete(a)};var v=Object.getOwnPropertyDescriptor(a.HTMLMediaElement.prototype,"src");Object.defineProperty(a.HTMLMediaElement.prototype,"src",{get(){return v.get.apply(this)},set(a){this.srcObject=k.get(a)||null;return v.set.apply(this,[a])}});var p=a.HTMLMediaElement.prototype.setAttribute;a.HTMLMediaElement.prototype.setAttribute=
...
this.gainNode.connect(this.audioCtx.destination)}},workerAudioSendOnmessage(){workerAudioSend.onmessage=function(a){a.data.hasOwnProperty("cmd")&&("adStatus"===a.data.cmd?(virtualclass.media.audio.setAudioStatus(a.data.msg),virtualclass.gObj.sendAudioStatus||"sending"!=a.data.msg||(ioAdapter.send({cf:"ya"}),virtualclass.gObj.sendAudioStatus=!0)):"ioAdapterSend"===a.data.cmd?(virtualclass.gObj.sendAudioStatus="na"===a.data.msg.cf?!1:!0,ioAdapter.send(a.data.msg)):"muteAudio"===a.data.cmd?g.audio.notifiyMuteAudio():
"unMuteAudio"===a.data.cmd&&g.audio.notifiyUnmuteAudio())}},audio:{audioStreamArr:[],tempAudioStreamArr:[],recordingLength:0,bufferSize:0,encMode:"alaw",recordAudio:!1,rec:"",otherSound:!1,audioNodes:[],sdElem:"silenceDetect",snode:[],workletAudioRec:!1,aChunksPlay:!1,audioContextReady:!1,init(){const a=document.getElementById("speakerPressOnce").dataset.audioPlaying;virtualclass.gObj.audMouseDown="true"==a;this.graph={height:56,width:4,average:0,display(){const a=g.video;roles.hasControls()&&this._display(a.tempVidCont,
this.height-this.height*this.average/100)},_display(a,b){a.beginPath();a.moveTo(this.width,this.height);a.lineTo(this.width,b);a.lineWidth=this.width;a.strokeStyle="rgba(32, 37, 247, 0.8)";a.closePath();a.stroke()}};this.attachFunctionsToAudioWidget()},initAudiocontext(){this.hasOwnProperty("Html5Audio")||virtualclass.gObj.meetingMode||(this.Html5Audio={audioContext:new (d.AudioContext||d.webkitAudioContext)},null==virtualclass.media.audio.Html5Audio.audioContext&&alert("audio context is null"),this.resampler=
new Resampler(virtualclass.media.audio.Html5Audio.audioContext.sampleRate,8E3,1,4096),this.audioContextReady=virtualclass.gObj.isAudioContextReady=!0,virtualclass.system.mediaDevices.hasMicrophone&&!virtualclass.isPlayMode&&null!=g.video.tempStream&&(virtualclass.media.stream=g.video.tempStream,virtualclass.media.audio._maniPulateStream()))},initScriptNode(){for(let a=0;a<this.snode.length;a++)this._playWithFallback(this.snode[a]);this.snode=[]},attachAudioStopHandler(a){a=a.getAudioTracks()[0];null!=
a&&(a.onended=this.notifiyMuteAudio,a.onmute=this.notifiyMuteAudio,a.onunmute=this.notifiyUnmuteAudio)},notifiyMuteAudio(){this.notifyAudioMute=!0;virtualclass.gObj.audMouseDown&&(virtualclass.gObj.mutedomop?virtualclass.gObj.hasOwnProperty("mutedomopto")&&null!==virtualclass.gObj.mutedomopto||(virtualclass.gObj.mutedomopto=setTimeout(()=>{g.audio.notifiyMuteAudioDom()},2E3)):g.audio.notifiyMuteAudioDom())},notifiyUnmuteAudio(){this.notifyAudioMute=!1;virtualclass.gObj.mutedomop=!0;virtualclass.gObj.hasOwnProperty("mutedomopto")&&
(clearTimeout(virtualclass.gObj.mutedomopto),virtualclass.gObj.mutedomopto=null);g.audio.notifiyUnmuteAudioDom()},notifiyUnmuteAudioDom(){this.hasOwnProperty("speakerPressOnce")&&null!=this.speakerPressOnce&&this.speakerPressOnce.classList.contains("audioMute")&&this.speakerPressOnce.classList.remove("audioMute")},notifiyMuteAudioDom(){this.hasOwnProperty("speakerPressOnce")||(this.speakerPressOnce=document.querySelector("#speakerPressOnce"));null==this.speakerPressOnce||this.speakerPressOnce.classList.contains("audioMute")||
this.speakerPressOnce.classList.add("audioMute")},muteButtonToogle(){const a=document.querySelector("#speakerPressOnce");null!=a&&a.dataset.audioPlaying&&"true"==a.dataset.audioPlaying&&a.click()},audioSend(a,b){if(virtualclass.gObj.audMouseDown&&io.webSocketConnected()){var c=virtualclass.vutil.breakintobytes(virtualclass.gObj.uid,8);c=new Int8Array([101,c[0],c[1],c[2],c[3]]);const f=new Int8Array(a.length+c.length);f.set(c);f.set(a,c.length);ioAdapter.sendBinary(f);virtualclass.media.audio.setAudioStatus(b)}else virtualclass.media.audio.setAudioStatus("stop")},
setAudioStatus(a){if("undefined"===typeof b)var b=document.getElementById("audioWidget").getElementsByClassName(this.sdElem)[0];b.setAttribute("data-silence-detect",a)},makeIconNotDraggable(a,b){const c=document.getElementById(a,b).getContext("2d"),f=new Image;f.onload=function(){c.drawImage(f,0,0)};f.src=`${d.whiteboardPath}images/${b}`},attachFunctionsToAudioWidget(){const a=document.getElementById("audioWidget").getElementsByClassName("audioTool");for(let b=0;b<a.length;b++)"speakerPressOnce"!==
a[b].id&&"speakerPressing"===a[b].id&&this.attachSpeakToStudent(a[b].id),"speakerPressing"!==a[b].id&&a[b].addEventListener("click",this.audioToolInit)},audioToolInit(){if(virtualclass.gObj.meetingMode){var a=document.getElementById(this.id);"false"==a.getAttribute("data-audio-playing")&&"undefined"===typeof alwaysDisable?(virtualclass.vutil.audioStatus(a,"true"),a=!0):(virtualclass.vutil.audioStatus(a,"false"),a=!1);virtualclass.multiVideo.setAudioStatus(a)}else a=virtualclass.media.audio,"speakerPressOnce"===
this.id?a.clickOnceSpeaker(this.id):"silenceDetect"===this.id&&(this.getElementsByTagName("a"),a.sd?(a.sd=!1,this.className=`${this.className} sdDisable`):(a.sd=!0,this.className=`${this.className} sdEnable`))},attachSpeakToStudent(a){const b=this,c=document.getElementById(a);let f=!1;c.addEventListener("mousedown",()=>{if(!virtualclass.gObj.audMouseDown){b.studentSpeak(c);f=!0;var a=document.getElementById("speakerPressonceLabel");null!=a&&virtualclass.vutil.elemHasAnyClass("speakerPressonceLabel")&&
a.classList.contains("silenceDetect")&&(a.removeAttribute("data-silence-detect"),a.classList.remove("silenceDetect"),0>=a.classList.length&&a.removeAttribute("class"),a=a.getElementsByTagName("i")[0],null!=a&&(a.setAttribute("data-silence-detect","stop"),a.className+=" silenceDetect"))}});c.addEventListener("mouseup",()=>{if(f){b.studentNotSpeak(c);f=!1;const a=document.getElementById("speakerPressonceLabel"),g=a.getElementsByTagName("i")[0];"undefined"!==typeof g.classList&&g.classList.contains("silenceDetect")&&
(g.classList.remove("silenceDetect"),0>=g.classList.length&&g.removeAttribute("class"),a.removeAttribute("data-silence-detect"));null!==a&&(a.setAttribute("data-silence-detect","stop"),a.className=`${g.className} silenceDetect`)}})},attachAudioPressOnce(){const a=document.getElementById("speakerPressOnce");a.setAttribute("data-audio-playing","false");const b=this;a.addEventListener("click",()=>{b.clickOnceSpeaker.call(b,a.id)})},clickOnceSpeaker(a,b){a=document.getElementById(a);document.getElementById("speakerPressing");
const c=a.getElementsByClassName("congtooltip")[0];"false"===a.getAttribute("data-audio-playing")&&"undefined"===typeof b?(this.studentSpeak(),a.setAttribute("data-audio-playing","true"),c.setAttribute("data-title",virtualclass.lang.getString("audioEnable")),a.className="audioTool active"):(this.studentNotSpeak(),a.setAttribute("data-audio-playing","false"),c&&c.setAttribute("data-title",virtualclass.lang.getString("audioDisable")),a.className="audioTool deactive")},initProcessorEvent(){virtualclass.gObj.hasOwnProperty("initProcessorTime")&&
clearInterval(virtualclass.gObj.initProcessorTime);virtualclass.gObj.initProcessorTime=setInterval(()=>{g.audio.notifyAudioMute&&g.audio.notifiyMuteAudio()},2E3)},studentSpeak(a){this.notifyAudioMute=!0;this.initProcessorEvent();"undefined"!==typeof a&&(document.getElementById(`${a.id}Button`),a.classList.remove("deactive"),a.classList.add("active"));virtualclass.gObj.audMouseDown=!0;workerAudioSend.postMessage({cmd:"audioMouseDown",msg:{adMouseDown:virtualclass.gObj.audMouseDown}});virtualclass.vutil.beforeSend({sad:!0,
cf:"sad"})},studentNotSpeak(a){virtualclass.gObj.hasOwnProperty("audMouseDown")&&virtualclass.gObj.audMouseDown&&("undefined"!==typeof a&&(document.getElementById(`${a.id}Button`),a.classList.remove("active"),a.classList.add("deactive")),a=document.getElementById("speakerPressOnce"),a.setAttribute("data-audio-playing","false"),a.className="audioTool deactive",virtualclass.gObj.audMouseDown=!1,workerAudioSend.postMessage({cmd:"audioMouseDown",msg:{audMouseDown:virtualclass.gObj.audMouseDown}}),virtualclass.media.audio.setAudioStatus("stop"),
virtualclass.vutil.beforeSend({sad:!1,cf:"sad"},null,!0))},ab2str(a){return String.fromCharCode.apply(null,new Int8Array(a))},str2ab(a){var b=new ArrayBuffer(a.length);b=new Int8Array(b);for(let c=0,f=a.length;c<f;c++)b[c]=a.charCodeAt(c);return b},recorderProcess(b){(new Date).getTime();if(!c&&(this.recordAudio||(this.recordingLength+=this.bufferSize),virtualclass.gObj.audMouseDown&&io.webSocketConnected())){b=this.resampler.resampler(b);l=b.length;for(a=new Int16Array(l);l--;)a[l]=32767*Math.min(1,
b[l]);b=a;const c=this.encodeAudio(b);this.silenceDetection(c,b)}},recorderProcessFallback(a){workerAudioSend.postMessage({cmd:"rawAudio",msg:a.inputBuffer.getChannelData(0)})},encodeAudio(a){return G711.encode(a,{alaw:"alaw"===this.encMode})},audioForTesting(a){a=G711.encode(a,{alaw:"alaw"===this.encMode});virtualclass.gObj.audioForTest.push(a);virtualclass.gObj[virtualclass.gObj.uid]=!1},initPlayWithFallback(){this.hasOwnProperty("Html5Audio")||this.Html5Audio||(this.Html5Audio={audioContext:new (d.AudioContext||
d.webkitAudioContext)});if(!v){const a=new MessageChannel;workerIO.postMessage({cmd:"workerAudioRec"},[a.port1]);workerAudioRec.postMessage({cmd:"workerIO",sampleRate:this.Html5Audio.audioContext.sampleRate},[a.port2]);workerAudioRec.postMessage({cmd:"audioWorklet",msg:!1});workerAudioRec.onmessage=function(a){switch(a.data.cmd){case "noAudioWorklet":virtualclass.media.audio.queueWithFalback(a.data.msg.data,a.data.msg.uid);virtualclass.media.audio.playWithFallback(a.data.msg.uid);break;default:console.log("do nothing")}};
v=!0;virtualclass.gObj.audioRecWorkerReady=!0}},initPlay(){this.hasOwnProperty("Html5Audio")||this.Html5Audio||(this.Html5Audio={audioContext:new (d.AudioContext||d.webkitAudioContext)});"object"!==typeof workletAudioRec&&g.audio.Html5Audio.audioContext.audioWorklet.addModule(workletAudioRecBlob).then(()=>{if("undefined"===typeof initchannel){workletAudioRec=new AudioWorkletNode(g.audio.Html5Audio.audioContext,"worklet-audio-rec");g.audio.Html5Audio.MediaStreamDest=g.audio.Html5Audio.audioContext.createMediaStreamDestination();
workletAudioRec.connect(g.audio.Html5Audio.audioContext.destination);"Chrome"===virtualclass.system.mybrowser.name&&(console.log("==== Chrome after change"),g.audio.bug_687574_callLocalPeers());var a=new MessageChannel;workerIO.postMessage({cmd:"workerAudioRec"},[a.port1]);workerAudioRec.postMessage({cmd:"workerIO",sampleRate:g.audio.Html5Audio.audioContext.sampleRate},[a.port2]);a=new MessageChannel;workerAudioRec.postMessage({cmd:"workletAudioRec"},[a.port1]);workletAudioRec.port.postMessage({cmd:"workerAudioRec"},
[a.port2]);workerAudioRec.postMessage({cmd:"audioWorklet",msg:!0});initchannel=!0;virtualclass.gObj.audioRecWorkerReady=!0}})},playWithFallback(a){"suspended"===this.Html5Audio.audioContext.state?(this.hasOwnProperty("audioSuspendTime")&&clearTimeout(this.audioSuspendTime),this.audioSuspendTime=setTimeout(()=>{"suspended"===this.Html5Audio.audioContext.state&&(this.snode.push(a),null===virtualclass.gObj.requestToScriptNode&&(this.Html5Audio.audioContext.resume(),virtualclass.gesture.initAudioResume(a),
virtualclass.gObj.requestToScriptNode=!0))},2E3)):this._playWithFallback()},_playWithFallback(){const a=this;if(null===virtualclass.media.audioPlayerNode||"closed"===virtualclass.media.audioPlayerNode.context.state)console.log("script processor node is created"),null!==virtualclass.media.audioPlayerNode&&virtualclass.media.audioPlayerNode.disconnect(),virtualclass.media.audioPlayerNode=this.Html5Audio.audioContext.createScriptProcessor(4096,1,1),p=0,virtualclass.media.audioPlayerNode.onaudioprocess=
function(b){b=b.outputBuffer.getChannelData(0);const c=a.getMergedAudio();if(null!==c&&void 0!==c){for(var f=0;f<c.length;f++)b[f]=c[f];p=c[4095]}else for(f=0;f<b.length;f++)b[f]=p},virtualclass.media.audioPlayerNode.connect(this.Html5Audio.audioContext.destination)},queueWithFalback(a,b){null==k[b]&&(k[b]=[]);null==n[b]&&(n[b]=[]);for(let c=0;c<a.length;c++)n[b].push(a[c]);for(;4096<=n[b].length;)a=n[b].splice(0,4096),k[b].push(new Float32Array(a))},getMergedAudio(){r=[];z=0;for(q in k){var a=this.getAudioChunks(q);
if(null!=a)if(z++,1===z)for(var b=0;4096>b;b++)r[b]=a[b];else for(b=0;4096>b;b++)r[b]+=a[b]}if(1===z)return r;if(1<z){for(a=0;4096>a;a++)r[a]/=z;return r}},getAudioChunks(a){if(null!==k){if(9<=k[a].length){for(;3<=k[a].length;)k[a].shift();m[a]=!0;return k[a].shift()}if(2<=k[a].length||0<k[a].length&&!0===m[a])return m[a]=!0,k[a].shift();m[a]=!1;0===k[a].length&&delete k[a]}},_maniPulateStream(){console.log("Manipulate stream");this.triggermaniPulateStream=!0;const a=virtualclass.media;setTimeout(()=>
{a.detectAudioWorklet()?a.audio.maniPulateStream():a.audio.maniPulateStreamWithFallback()},1E3)},maniPulateStream(){const {stream:a}=g;"undefined"!==typeof t&&t.disconnect();"undefined"!==typeof a&&null!=a&&(console.log("Audio worklet init add module"),g.audio.Html5Audio.audioContext.audioWorklet.addModule(workletAudioSendBlob).then(()=>{console.log("== init audio worklet 3");var b=g.audio.Html5Audio.audioContext.createMediaStreamSource(a);const f=g.audio.Html5Audio.audioContext.createBiquadFilter();
f.type="lowpass";f.frequency.value=2E3;b.connect(f);t=new AudioWorkletNode(g.audio.Html5Audio.audioContext,"worklet-audio-send");t.onprocessorerror=function(a){g.audio.notifiyMuteAudio()};f.connect(t);t.connect(g.audio.Html5Audio.audioContext.destination);b=new MessageChannel;workerAudioSend.postMessage({cmd:"workerIO",sampleRate:this.Html5Audio.audioContext.sampleRate,uid:virtualclass.gObj.uid},[b.port1]);workerIO.postMessage({cmd:"workerAudioSend"},[b.port2]);b=new MessageChannel;workerAudioSend.postMessage({cmd:"audioWorkletSend",
msg:{repMode:c}},[b.port1]);t.port.postMessage({cmd:"workerAudioSend"},[b.port2]);g.workerAudioSendOnmessage();console.log("Audio worklet ready audio worklet module")}).catch(a=>{g.audio.notifiyMuteAudio()}))},maniPulateStreamWithFallback(){if("undefined"!==typeof g.stream&&null!=g.stream){var {stream:a}=g;a=g.audio.Html5Audio.audioContext.createMediaStreamSource(a);g.audio.bufferSize=4096;virtualclass.media.audioCreatorNode=g.audio.Html5Audio.audioContext.createScriptProcessor(g.audio.bufferSize,
1,1);virtualclass.media.audioCreatorNode.onaudioprocess=g.audio.recorderProcessFallback.bind(g.audio);const b=g.audio.Html5Audio.audioContext.createBiquadFilter();b.type="lowpass";b.frequency.value=2E3;a.connect(b);b.connect(virtualclass.media.audioCreatorNode);virtualclass.media.audioCreatorNode.connect(g.audio.Html5Audio.audioContext.destination);a=new MessageChannel;workerAudioSend.postMessage({cmd:"workerIO",uid:virtualclass.gObj.uid,sampleRate:g.audio.Html5Audio.audioContext.sampleRate},[a.port1]);
workerIO.postMessage({cmd:"workerAudioSend"},[a.port2]);g.workerAudioSendOnmessage()}else console.log("No stream is found")},updateInfo(){this.audioStreamArr=[];c=this.recordAudio=!1},extractData(a){a=new Int8Array(a);return[virtualclass.vutil.numValidateFour(a[1],a[2],a[3],a[4]),a.subarray(5,a.length)]},removeAudioFromLocalStorage(){console.log("Remove audio from local storage");localStorage.removeItem("audEnable")},async bug_687574_callLocalPeers(){function a(a,b){if("connected"===b.currentTarget.connectionState)try{console.log("PEER connected webrtc"),
workletAudioRec.disconnect(g.audio.Html5Audio.audioContext.destination),workletAudioRec.connect(g.audio.Html5Audio.MediaStreamDest)}catch(M){}else if("disconnected"===b.currentTarget.connectionState){console.log("PEER disconnected");k.close();m.close();m=k=null;try{workletAudioRec.disconnect(g.audio.Html5Audio.MediaStreamDest),workletAudioRec.connect(g.audio.Html5Audio.audioContext.destination),console.log("PEER connected normal audio api")}catch(M){}g.audio.bug_687574_callLocalPeers()}}async function b(a){try{await k.setLocalDescription(a),
await m.setRemoteDescription(a)}catch(I){d()}try{const a=await m.createAnswer();await c(a)}catch(I){d()}}async function c(a){try{await m.setLocalDescription(a),await k.setRemoteDescription(a)}catch(I){d()}}async function f(a,b){if(b.candidate&&"host"===b.candidate.type)try{await (a===k?m:k).addIceCandidate(b.candidate)}catch(M){d()}}function d(){console.log("PEER fallback");try{workletAudioRec.connect(g.audio.Html5Audio.audioContext.destination),k.close(),m.close(),m=k=null}catch(A){m=k=null}}let k,
m;k=new RTCPeerConnection;k.count=0;k.addEventListener("icecandidate",a=>f(k,a));k.addEventListener("connectionstatechange",b=>a(k,b));m=new RTCPeerConnection;m.count=0;m.addEventListener("icecandidate",a=>f(m,a));m.addEventListener("connectionstatechange",b=>a(m,b));m.addEventListener("track",function(a){const b=document.createElement("audio");b.srcObject=a.streams[0];b.autoplay=!0});g.audio.Html5Audio.MediaStreamDest.stream.getTracks().forEach(a=>k.addTrack(a,g.audio.Html5Audio.MediaStreamDest.stream));
try{const a=await k.createOffer();await b(a)}catch(A){d()}}},video:{width:75,height:56,tempVid:"",tempVidCont:"",myVideo:"",remoteVid:"",remoteVidCont:"",maxHeight:250,init(){this.videoCont=document.getElementById("allVideosCont");null!=this.videoCont&&(this.videoCont.style.maxHeight=`${this.maxHeight}px`)},calcDimension(){this.myVideo.width=this.width;this.myVideo.height=this.height},removeUser(a){a=document.getElementById(`user${a}`);null!=a&&a.parentNode.removeChild(a)},createElement(a){const c=
document.createElement("div");c.className="videoWrapper";const f=document.createElement("div");f.className="videoSubWrapper";f.id=`user${a.id}`;c.appendChild(f);b=a.id;const g=document.createElement("canvas");g.id=`video${b}`;g.className="userVideos";g.width=this.width;g.height=this.height;g.muted="muted";f.appendChild(g);virtualclass.media.util.imageReplaceWithVideo(a.id,c)},updateHightInSideBar(a){const b=document.getElementById("widgetRightSide").offsetHeight;document.getElementById("chatContainer").style.height=
`${b-a}px`},sendInBinary(a){const b={name:virtualclass.gObj.uName,id:virtualclass.gObj.uid};io.webSocketConnected()&&(virtualclass.vutil.beforeSend({videoByImage:b,cf:"videoByImage"},null,!0),ioAdapter.sendBinary(a))},send(){function a(){b.tempVidCont.clearRect(0,0,b.tempVid.width,b.tempVid.height);b.tempVidCont.drawImage(b.myVideo,0,0,b.width,b.height);roles.hasControls();if(virtualclass.system.webpSupport){var d=b.tempVid.toDataURL("image/webp",.6);var k=1}else d=b.tempVid.toDataURL("image/jpeg",
.3),k=0;d=virtualclass.videoHost.convertDataURIToBinary(d);if(!virtualclass.videoHost.gObj.stdStopSmallVid&&!roles.hasControls()||roles.hasControls()&&virtualclass.videoHost.gObj.videoSwitch){var m=virtualclass.gObj.uid.toString();for(let a=m.length;8>a;a++)m=`0${m}`;m=m.match(/[\S]{1,2}/g)||[];k=new Uint8ClampedArray([11,m[0],m[1],m[2],m[3],k]);m=new Uint8ClampedArray(d.length+k.length);m.set(k);m.set(d,k.length);g.sendInBinary(m)}clearInterval(virtualclass.media.smallVid);if(virtualclass.hasOwnProperty("connectedUsers"))if(d=
f+2500*virtualclass.connectedUsers.length,c!=virtualclass.connectedUsers.length){c=virtualclass.connectedUsers.length;k=-1;for(m=0;m<virtualclass.connectedUsers.length;m++)virtualclass.connectedUsers[0].userid==virtualclass.gObj.uid&&(k=m);m=d/c;0>k&&(k=0);virtualclass.media.smallVid=setInterval(a,d+k*m)}else virtualclass.media.smallVid=setInterval(a,d)}virtualclass.media.hasOwnProperty("smallVid")&&clearInterval(virtualclass.media.smallVid);const b=this;f=Math.floor(5001*Math.random()+3E3);let c=
-1;const g=this;virtualclass.media.smallVid=setInterval(a,f)},startToStream(){g.video.calcDimension();g.video.send()},playWithoutSlice(a,b,c){this.remoteVid=document.getElementById(`video${a}`);null!=this.remoteVid&&(this.remoteVidCont=this.remoteVid.getContext("2d"),this.remoteVidCont.putImageData(imgData,0,0))},drawReceivedImage(a,b,c,f){this.remoteVid=chatContainerEvent.elementFromShadowDom(`#video${f}`);if(null!=this.remoteVid)if(this.remoteVidCont=this.remoteVid.getContext("2d"),virtualclass.system.webpSupport||
...
document.createElement("video");g.className="userVideo";g.muted="muted";g.src="http://html5demos.com/assets/dizzy.mp4";f.appendChild(g);b.appendChild(c);250<=b.offsetHeight&&"undefined"!=b.style.overflowY&&"scroll"!=b.style.overflowY&&(b.style.overflowY="scroll",document.getElementById(virtualclass.gObj.chat.mainChatBoxId).style.borderTop="3px solid #bbb")}},200)},createVideoElement(){const a=document.createElement("div");a.className="videoWrapper";const b=document.createElement("div");b.className=
"videoSubWrapper";a.appendChild(b);const c=document.createElement("video");c.id=`video${virtualclass.gObj.uid}`;c.autoplay=!0;b.appendChild(c);return a},insertTempVideo(a){const b=document.createElement("canvas");b.id="tempVideo";a.parentNode.insertBefore(b,a)},tempVideoInit(){g.video.tempVid=chatContainerEvent.elementFromShadowDom("#tempVideo");g.video.tempVid.width=g.video.width;g.video.tempVid.height=g.video.height;g.video.tempVidCont=g.video.tempVid.getContext("2d")},process(a){var b=new Uint8ClampedArray(a);
a=virtualclass.vutil.numValidateFour(b[1],b[2],b[3],b[4]);var c=b.subarray(6,b.length);1===b[5]?(b=`data:image/webp;base64,${btoa(virtualclass.videoHost.Uint8ToString(c))}`,c="webp"):(b=`data:image/jpeg;base64,${btoa(virtualclass.videoHost.Uint8ToString(c))}`,c="jpeg");virtualclass.media.video.drawReceivedImage(b,c,{x:0,y:0},a)}},sessionConstraints(){var a=!!virtualclass.system.mediaDevices.hasWebcam;virtualclass.gObj.meetingMode&&a&&(a="mobTab"===virtualclass.system.device&&"iOS"===virtualclass.system.mybrowser.name||
"Firefox"===virtualclass.system.mybrowser.name||"Safari"===virtualclass.system.mybrowser.name?!0:{width:{max:268},height:{max:142},frameRate:{max:6}});return[a,{video:a,audio:virtualclass.system.mediaDevices.hasMicrophone?{echoCancellation:!0,autoGainControl:!0,channelCount:1,noiseSuppression:!0}:!1}]},init(a){console.log("Video second, normal video");g=this;virtualclass.gObj.oneExecuted=!0;virtualclass.gesture.classJoin&&(virtualclass.gesture.attachHandler(),delete virtualclass.gesture.classJoin);
let b,c;[b,c]=this.sessionConstraints();g.video.init();const f=this;virtualclass.user.control.audioDisable();virtualclass.user.control.videoDisable();if(!virtualclass.vutil.isPlayMode()){null==virtualclass.adpt&&(virtualclass.adpt=new virtualclass.adapter);if(null!=virtualclass.media.video.tempStream){const a=virtualclass.media.video.tempStream.getTracks();for(let b=0;b<a.length;b++)a[b].stop()}virtualclass.adpt.init(navigator).mediaDevices.getUserMedia(c).then(b=>{f.handleUserMedia(b);virtualclass.gObj.meetingMode&&
virtualclass.multiVideo.init();"undefined"!==typeof a&&a("success")}).catch(a=>{f.handleUserMediaError(a)})}virtualclass.system.wbRtc.peerCon&&"undefined"===typeof localStorage.wbrtcMsg&&(virtualclass.view.multiMediaMsg("WebRtc"),localStorage.wbrtcMsg=!0);0==b&&(virtualclass.user.control.videoDisable(),virtualclass.vutil.addClass("virtualclassCont","nowebcam"))},handleUserMedia(a){localStorage.removeItem("dvid");document.getElementById("audioWidget");var b=localStorage.getItem("audEnable");if(roles.isStudent()&&
virtualclass.system.mediaDevices.hasMicrophone)!1===virtualclass.settings.info.disableAttendeeAudio?(virtualclass.gObj.audioEnable=!1,virtualclass.user.control.audioDisable(!0)):!0===virtualclass.settings.info.disableAttendeeAudio?(virtualclass.gObj.audioEnable=!0,virtualclass.user.control.audioWidgetEnable(!0)):!0!==virtualclass.settings.info.disableAttendeeAudio&&virtualclass.user.control.audioDisable();else if(virtualclass.system.mediaDevices.hasMicrophone)if(null!=b)if(b=JSON.parse(b),"false"===
b.ac||!1===b.ac)virtualclass.gObj.audioEnable=!1,virtualclass.user.control.audioDisable(!0);else{if("true"===b.ac||!0===b.ac)virtualclass.gObj.audioEnable=!0,virtualclass.user.control.audioWidgetEnable(!0)}else"undefined"!==typeof a&&virtualclass.user.control.audioWidgetEnable(!0);else virtualclass.user.control.audioDisable();b=a.getVideoTracks()[0];"undefined"!==typeof b?b.onended=function(){virtualclass.system.mediaDevices.webcamErr.push("webcambusy")}:virtualclass.system.mediaDevices.webcamErr.push("nopermission");
g.video.tempStream=a;g.audio.init();g.audio.attachAudioStopHandler(a);b=chatContainerEvent.elementFromShadowDom(`#ml${virtualclass.gObj.uid}`);null!=b&&null!=b.getElementsByTagName("video")&&g._handleUserMedia(virtualclass.gObj.uid);roles.hasAdmin()&&virtualclass.videoHost.isDomReady(()=>{virtualclass.videoHost.renderSelfVideo(a)});!1===virtualclass.settings.info.disableAttendeeVideo&&roles.isStudent()?virtualclass.user.control.videoDisable():(roles.isStudent()&&!0!==virtualclass.settings.info.disableAttendeeVideo?
(virtualclass.vutil.videoHandler("off"),virtualclass.videoHost.toggleVideoMsg("disable")):(virtualclass.user.control.videoEnable(),roles.isStudent()&&virtualclass.vutil.videoHandler("off")),!0===virtualclass.settings.info.disableAttendeeVideo&&virtualclass.user.control.videoEnable());null==localStorage.getItem("prevApp")&&(roles.hasControls()?virtualclass.vutil.videoHandler("off"===virtualclass.vutil.selfVideoStatus()?"on":"off"):virtualclass.gObj.meetingMode&&virtualclass.vutil.videoHandler("off"));
g.audio.audioContextReady&&!g.audio.hasOwnProperty("triggermaniPulateStream")&&(g.stream=g.video.tempStream,g.audio._maniPulateStream())},addUserRole(a,b){a.dataset.role=b;if("undefined"!==typeof b){var c="s"===b?"student":"teacher";a.classList.add(c)}else a.classList.add("student");"t"===virtualclass.gObj.uRole&&"student"===c&&document.getElementById("virtualclassCont").classList.remove("student")},_handleUserMedia(a){if("undefined"!==typeof g){if(a=g.video.tempStream,"undefined"!==typeof a&&virtualclass.system.mediaDevices.hasWebcam){const b=
g.video.createVideoElement();virtualclass.media.util.imageReplaceWithVideo(virtualclass.gObj.uid,b);g.video.insertTempVideo(b);g.video.tempVideoInit();g.video.myVideo=chatContainerEvent.elementFromShadowDom(`#video${virtualclass.gObj.uid}`);virtualclass.adpt.attachMediaStream(g.video.myVideo,a);g.video.myVideo.muted=!0;g.stream=g.video.tempStream;g.video.myVideo.onloadedmetadata=function(){g.video.startToStream()}}}else console.log("Media: it seems media is not ready")},updateVideoContHeight(){console.log("Updating User");
var a=document.getElementById("virtualclassCont");virtualclass.vutil.getElementOffset(a);a=virtualclass.chat.boxHeight;const b=document.getElementById("chat_div");b.scrollHeight>=a+1&&(b.style.overflowY="scroll");b.style.maxHeight=`${a}px`;console.log(`Chat height ${b.offsetHeight}`);console.log(`Max height ${b.style.maxHeight}`);virtualclass.isPlayMode&&(b.style.maxHeight=`${a+64}px`)},close(){virtualclass.media.hasOwnProperty("smallVid")&&clearInterval(virtualclass.media.smallVid)},dispAllVideo(a){setTimeout(()=>
...
a.style.display="none");a=document.getElementById(this.UI.id);a.classList.contains("pptSharing")||a.classList.add("pptSharing")},_rearrange(a){this.order=a;this.reArrangeElements(a);virtualclass.vutil.sendOrder("presentation",a)},sendOrder(a){virtualclass.vutil.xhrSendWithForm({content_order:a.toString(),content_order_type:"3",live_class_id:virtualclass.gObj.congCourse},"congrea_page_order",a=>{})},reArrangeElements(a){const b=document.getElementById("listppt"),c=document.createElement("div");c.id=
"listppt";c.className="ppts";let g=!1;for(var d=0;d<virtualclass.sharePt.activeppts.length;d++)-1>=a.indexOf(virtualclass.sharePt.activeppts[d].fileuuid)&&(a.push(virtualclass.sharePt.activeppts[d].fileuuid),g=!0);for(d=0;d<a.length;d++){const b=document.getElementById(`linkppt${a[d]}`);b&&c.appendChild(b)}b.parentNode.replaceChild(c,b);g&&(virtualclass.sharePt.order=a,virtualclass.vutil.sendOrder("presentation",virtualclass.sharePt.order))},_delete(a){const b=this;virtualclass.xhrn.sendData({uuid:a,
action:"delete",page:0},virtualclass.api.UpdateDocumentStatus,c=>{b.afterDeletePtCallback(c,a)})},afterDeletePtCallback(a,b){"ERROR"!=a&&(a=document.getElementById(`linkppt${b}`))&&(a.parentNode.removeChild(a),virtualclass.sharePt.ppts.length&&(virtualclass.sharePt.ppts.forEach((a,c)=>{a.fileuuid==b&&(c=virtualclass.sharePt.ppts.indexOf(a),0<=c&&(virtualclass.sharePt.ppts.splice(c,1),console.log(virtualclass.sharePt.ppts)))}),a=virtualclass.sharePt.order.indexOf(b),0<=a&&(virtualclass.sharePt.order.splice(a,
1),console.log(virtualclass.sharePt.order),virtualclass.vutil.sendOrder("presentation",virtualclass.sharePt.order)),(a=document.querySelector(".congrea #pptiframe"))&&a.getAttribute("src")?virtualclass.vutil.showFinishBtn():virtualclass.vutil.removeFinishBtn()),virtualclass.sharePt.currId==b&&(a=document.querySelector("#pptiframe")))&&(a.removeAttribute("src"),ioAdapter.mustSend({pptMsg:"deletePrt",cf:"ppt",currId:virtualclass.sharePt.currId}),virtualclass.sharePt.currId=null,virtualclass.sharePt.pptUrl=
null,virtualclass.vutil.removeFinishBtn())},_delete1(a){const b=this;virtualclass.xhrn.sendData({uuid:a,action:"delete",page:0},virtualclass.api.UpdateDocumentStatus,c=>{b.afterDeleteCallback(c,a)})},pptMessageEventHandler(a){if("SharePresentation"==virtualclass.currApp){var b=document.getElementById("pptiframe"),c=a.data;c="string"===typeof c?JSON.parse(a.data):a.data;"undefined"!==typeof c&&(c.hasOwnProperty("namespace")&&"reveal"==c.namespace&&(virtualclass.sharePt.state=c.state),"ready"==c.eventName&&
(virtualclass.sharePt.localStoragFlag&&!virtualclass.sharePt.startFromFlag?(a=virtualclass.sharePt.stateLocalStorage,b.contentWindow.postMessage(JSON.stringify({method:"slide",args:[a.indexh,a.indexv,a.indexf]}),"*"),virtualclass.sharePt.localStoragFlag=0):virtualclass.sharePt.startFromFlag&&b.contentWindow.postMessage(JSON.stringify({method:"slide",args:virtualclass.sharePt.startFrom}),"*"),setTimeout(()=>{null!=b&&null!=b.contentWindow&&b.contentWindow.postMessage(JSON.stringify({method:"toggleAutoSlide"}),
"*")},1500)),roles.hasView()?"ready"==c.eventName&&(setTimeout(()=>{virtualclass.sharePt.removeControls()},100),virtualclass.sharePt.studentPpt&&(virtualclass.sharePt.setSlideState(virtualclass.sharePt.studentPpt),virtualclass.sharePt.studentPpt=0)):roles.hasControls()&&(console.log(c.eventName),"undefined"!==typeof c.eventName&&(virtualclass.sharePt[c.eventName].call(virtualclass.sharePt,c),virtualclass.sharePt.state=c.state)))}else null!=b&&b.removeAttribute("src")},setAutoSlideConfig(){localStorage.getItem("autoSlideTime")&&
...
virtualclass.sharePt.urlValue=virtualclass.sharePt.toProtocolRelativeUrl();const a=virtualclass.sharePt.validUrl();a?(virtualclass.sharePt.savePptUrl(a),document.getElementById("presentationurl").value=""):virtualclass.popup.validateurlPopup("presentation")},savePptUrl(a){const b=virtualclass.vutil.createHashString(a)+virtualclass.vutil.randomString(32).slice(1,-1),c={};c.uuid=b;c.URL=a;c.title=a;a=virtualclass.api.addURL;c.type="presentation";const g=this;virtualclass.xhrn.sendData(c,a,a=>{virtualclass.sharePt.hasOwnProperty("activeppts")&&
(a=virtualclass.sharePt.activeppts.map(a=>a.fileuuid),a.length!=virtualclass.sharePt.order.length&&(virtualclass.sharePt.order=a));virtualclass.sharePt.order.push(c.uuid);virtualclass.vutil.sendOrder("presentation",virtualclass.sharePt.order);virtualclass.sharePt.getPptList();g.fetchAllData()})},fetchAllData(){virtualclass.serverData.fetchAllData(()=>{virtualclass.sharePt.awsPresentationList(virtualclass.serverData.rawData.ppt)})},awsPresentationList(a){virtualclass.sharePt.ppts=[];virtualclass.sharePt.ppts=
a;document.querySelector("#SharePresentationDashboard .dbContainer")&&(virtualclass.sharePt.createPageModule(),virtualclass.sharePt.showPpts(),virtualclass.vutil.requestOrder("presentation",a=>{virtualclass.vutil.isResponseAvailable(a)?(virtualclass.sharePt.order=a,virtualclass.sharePt.order&&0<virtualclass.sharePt.order.length&&virtualclass.sharePt.reArrangeElements(virtualclass.sharePt.order)):console.log("Order response is not available")}))},afterPptSaved(a){var b=a.fileuuid;a.hasOwnProperty("disabled")?
a.status=0:a.status=1;this.pages[b]=new virtualclass.page("pptListContainer","ppt","virtualclassSharePresentation","sharePt",a.status);this.pages[b].init(b,a.URL);this.pptClickHandler(a);b=document.getElementById(`linkppt${a.fileuuid}`);const c=document.getElementById(`pptTitle${a.fileuuid}`);var g=this.extractTitle(a.URL);c&&(g?c.innerHTML=g:(g=a.URL,g=`https:${g}`,g=g.match(/^(?:https?:\/\/)?(?:w{3}\.)?([a-z\d\.-]+)\.(?:[a-z\.]{2,10})(?:[/\w\.-]*)*/)[1],c.innerHTML=g));c.setAttribute("data-toogle",
"tooltip");c.setAttribute("data-placement","bottom");c.setAttribute("title",a.URL);a.hasOwnProperty("disabled")?(this._disable(a.fileuuid),b&&b.classList.add("disable")):(this._enable(a.fileuuid),b&&b.classList.add("enable"));virtualclass.sharePt.currId==a.fileuuid&&b.classList.add("playing")},extractTitle(a){return-1<a.indexOf("//")?a.split("/")[4]:a.split("/")[2]},pptClickHandler(a){const b=document.getElementById(`mainpppt${a.fileuuid}`);b&&b.addEventListener("click",()=>{virtualclass.sharePt.playPptUrl(a.URL,
a.fileuuid);virtualclass.dashBoard.close();virtualclass.sharePt.currId=a.fileuuid;virtualclass.sharePt.activePrs(a.fileuuid)})},activePrs(a){const b=document.querySelectorAll("#virtualclassCont.congrea .linkppt");for(let a=0;a<b.length;a++)b[a].classList.contains("playing")&&b[a].classList.remove("playing");(a=document.querySelector(`#virtualclassCont.congrea #linkppt${a}`))&&!a.classList.contains("playing")&&a.classList.add("playing")},_disable(a){var b=document.getElementById(`mainpppt${a}`);b.style.opacity=
...
[];0<c.length&&(d.virtualclass.wb[virtualclass.gObj.currWb].vcan.main.replayObjs=c,virtualclass.wb[virtualclass.gObj.currWb].toolInit("t_replay","fromBrowser",!0,virtualclass.wb[virtualclass.gObj.currWb].utility.dispQueuePacket))},chunk(c,a,b){virtualclass.wb[virtualclass.gObj.currWb].bridge.handleMissedPackets(c,a,b)},repObjForMissedPkts(c){(0!==virtualclass.wb[virtualclass.gObj.currWb].gObj.rcvdPackId||0<virtualclass.wb[virtualclass.gObj.currWb].uid&&0===virtualclass.wb[virtualclass.gObj.currWb].gObj.rcvdPackId)&&
...
6,c=>LZString._keyStrUriSafe.charAt(c))},decompressFromEncodedURIComponent(d){if(null==d)return"";if(""==d)return null;d=d.replace(/ /g,"+");return LZString._decompress(d.length,32,c=>LZString._getBaseValue(LZString._keyStrUriSafe,d.charAt(c)))},compress(d){return LZString._compress(d,16,c=>String.fromCharCode(c))},_compress(d,c,a){if(null==d)return"";let b,f;const g={},k={};let m,n,q="",r=2,z=3,t=2;const v=[];let p=0,u=0,B;for(B=0;B<d.length;B+=1)if(m=d[B],Object.prototype.hasOwnProperty.call(g,
m)||(g[m]=z++,k[m]=!0),n=q+m,Object.prototype.hasOwnProperty.call(g,n))q=n;else{if(Object.prototype.hasOwnProperty.call(k,q)){if(256>q.charCodeAt(0)){for(b=0;b<t;b++)p<<=1,u==c-1?(u=0,v.push(a(p)),p=0):u++;f=q.charCodeAt(0);for(b=0;8>b;b++)p=p<<1|f&1,u==c-1?(u=0,v.push(a(p)),p=0):u++,f>>=1}else{f=1;for(b=0;b<t;b++)p=p<<1|f,u==c-1?(u=0,v.push(a(p)),p=0):u++,f=0;f=q.charCodeAt(0);for(b=0;16>b;b++)p=p<<1|f&1,u==c-1?(u=0,v.push(a(p)),p=0):u++,f>>=1}r--;0==r&&(r=Math.pow(2,t),t++);delete k[q]}else for(f=
g[q],b=0;b<t;b++)p=p<<1|f&1,u==c-1?(u=0,v.push(a(p)),p=0):u++,f>>=1;r--;0==r&&(r=Math.pow(2,t),t++);g[n]=z++;q=String(m)}if(""!==q){if(Object.prototype.hasOwnProperty.call(k,q)){if(256>q.charCodeAt(0)){for(b=0;b<t;b++)p<<=1,u==c-1?(u=0,v.push(a(p)),p=0):u++;f=q.charCodeAt(0);for(b=0;8>b;b++)p=p<<1|f&1,u==c-1?(u=0,v.push(a(p)),p=0):u++,f>>=1}else{f=1;for(b=0;b<t;b++)p=p<<1|f,u==c-1?(u=0,v.push(a(p)),p=0):u++,f=0;f=q.charCodeAt(0);for(b=0;16>b;b++)p=p<<1|f&1,u==c-1?(u=0,v.push(a(p)),p=0):u++,f>>=1}r--;
0==r&&(r=Math.pow(2,t),t++);delete k[q]}else for(f=g[q],b=0;b<t;b++)p=p<<1|f&1,u==c-1?(u=0,v.push(a(p)),p=0):u++,f>>=1;r--;0==r&&t++}f=2;for(b=0;b<t;b++)p=p<<1|f&1,u==c-1?(u=0,v.push(a(p)),p=0):u++,f>>=1;for(;;)if(p<<=1,u==c-1){v.push(a(p));break}else u++;return v.join("")},decompress(d){return null==d?"":""==d?null:LZString._decompress(d.length,32768,c=>d.charCodeAt(c))},_decompress(d,c,a){const b=[];let f=4,g=4,k=3;const m=[];var n;let q,r,z,t;const v=LZString._f;var p=a(0),u=c,B=1;for(n=0;3>n;n+=
1)b[n]=n;q=0;z=Math.pow(2,2);for(t=1;t!=z;)r=p&u,u>>=1,0==u&&(u=c,p=a(B++)),q|=(0<r?1:0)*t,t<<=1;switch(q){case 0:q=0;z=Math.pow(2,8);for(t=1;t!=z;)r=p&u,u>>=1,0==u&&(u=c,p=a(B++)),q|=(0<r?1:0)*t,t<<=1;var C=v(q);break;case 1:q=0;z=Math.pow(2,16);for(t=1;t!=z;)r=p&u,u>>=1,0==u&&(u=c,p=a(B++)),q|=(0<r?1:0)*t,t<<=1;C=v(q);break;case 2:return""}n=b[3]=C;for(m.push(C);;){if(B>d)return"";q=0;z=Math.pow(2,k);for(t=1;t!=z;)r=p&u,u>>=1,0==u&&(u=c,p=a(B++)),q|=(0<r?1:0)*t,t<<=1;switch(C=q){case 0:q=0;z=Math.pow(2,
8);for(t=1;t!=z;)r=p&u,u>>=1,0==u&&(u=c,p=a(B++)),q|=(0<r?1:0)*t,t<<=1;b[g++]=v(q);C=g-1;f--;break;case 1:q=0;z=Math.pow(2,16);for(t=1;t!=z;)r=p&u,u>>=1,0==u&&(u=c,p=a(B++)),q|=(0<r?1:0)*t,t<<=1;b[g++]=v(q);C=g-1;f--;break;case 2:return m.join("")}0==f&&(f=Math.pow(2,k),k++);if(b[C])C=b[C];else if(C===g)C=n+n[0];else return null;m.push(C);b[g++]=n+C[0];f--;n=C;0==f&&(f=Math.pow(2,k),k++)}}};"undefined"!==typeof module&&null!=module&&(module.exports=LZString);/*
 g711
...
a=document.getElementById(a);return null!=a?a.offsetWidth+b==c:!1},disableAppsBar(){const c=document.getElementById("virtualclassOptionsCont");null!=c&&(c.style.pointerEvents="none")},isMiniFileIncluded(c){c=new RegExp(`${c}.js?=\*([0-9]*)`);const a=document.getElementsByTagName("script");for(let b=0;b<a.length;b++)if(c.test(a[b].src))return!0;return!1},clearAllChat(){localStorage.removeItem(virtualclass.gObj.uid);localStorage.clear("chatroom");null!=virtualclass.chat&&(virtualclass.chat.idList.length=
0);clearAllChatBox();const c=document.getElementById("chatWidget").getElementsByClassName("ui-chatbox-msg");if(0<c.length)for(;null!=c[0];)c[0].parentNode.removeChild(c[0])},isObjectEmpty(c){for(const a in c)if(c.hasOwnProperty(a))return!1;return!0},removeSessionTool(){if(!roles.hasAdmin()){const c=document.getElementById("virtualclassSessionEndTool");null!=c&&c.parentNode.removeChild(c)}},Fullscreen(){const c=document.getElementById("virtualclassCont");c.requestFullscreen?c.requestFullscreen():c.mozRequestFullScreen?
c.mozRequestFullScreen():c.webkitRequestFullscreen?c.webkitRequestFullscreen():c.msRequestFullscreen&&c.msRequestFullscreen();c.classList.add("fullScreenMode")},closeFullscreen(){const c=document.getElementById("virtualclassCont");document.exitFullscreen?document.exitFullscreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitExitFullscreen?document.webkitExitFullscreen():document.msExitFullscreen&&document.msExitFullscreen();c.classList.remove("fullScreenMode")},addClass(c,
a){const b=document.getElementById(c);virtualclass.vutil.elemHasAnyClass(c)?b.classList.add(a):b.className=a},removeClass(c,a){const b=document.getElementById(c);virtualclass.vutil.elemHasAnyClass(c)&&b.classList.contains(a)&&b.classList.remove(a)},breakIntoBytes(c,a){c=c.toString();for(let b=c.length;b<a;b++)c=`0${c}`;return c.match(/[\S]{1,2}/g)||[]},numValidateFour(c,a,b,f){c=this.preNumValidateTwo(c);a=this.preNumValidateTwo(a);b=this.preNumValidateTwo(b);f=this.preNumValidateTwo(f);return parseInt(c+
a+b+f)},numValidateTwo(c,a){c=this.preNumValidateTwo(c);a=this.preNumValidateTwo(a);return parseInt(c+a)},preNumValidateTwo(c){c=c.toString();if(1==c.length)return`0${c}`;if(2==c.length)return c},elemHasAnyClass(c){c=document.getElementById(c);return null!=c?"undefined"!==typeof c.classList:!1},userIsOrginalTeacher(c){return roles.hasAdmin()},isUserTeacher(c){return roles.hasControls()},initDisableAudVid(){virtualclass.gObj.audIntDisable=!0;virtualclass.gObj.vidIntDisable=!0},initDisableVirtualClass(){this.initDisableAudVid();
...
beforeLoad(){if("DocumentShare"==virtualclass.currApp){if(!roles.hasControls()){var c=document.querySelector("#virtualclassCont.congrea #icHr").getAttribute("data-action");if("disable"==c){const a=virtualclass.vutil.whoIsTeacher();ioAdapter.sendUser({data:{user:wbUser.id,action:c},cf:"raiseHand"},a)}}io.disconnect()}virtualclass.gObj.windowLoading=!0;if(virtualclass.recorder.hasOwnProperty("doSessionClear"))virtualclass.clearSession();else if(0==localStorage.length)virtualclass.storage.clearStorageData();
...
console.log(`start From${virtualclass.sharePt.state}`),virtualclass.sharePt.saveIntoLocalStorage(c)):c.metaData=null:"Poll"==virtualclass.currApp?(virtualclass.poll.saveInLocalStorage(),console.log("currAppPoll")):"Video"==virtualclass.currApp?(virtualclass.videoUl.player&&(a=virtualclass.videoUl.player.currentTime()),c.metaData={init:{videoId:virtualclass.videoUl.videoId,videoUrl:virtualclass.videoUl.videoUrl,yts:virtualclass.videoUl.yts,online:virtualclass.videoUl.online,isPaused:virtualclass.videoUl.isPaused},
startFrom:a,isAutoplay:virtualclass.videoUl.autoPlayFlag},console.log(c)):"DocumentShare"==virtualclass.currApp?(console.log(`previous app success ${virtualclass.currApp}`),virtualclass.dts.docs.hasOwnProperty("currDoc")?({currDoc:a}=virtualclass.dts.docs,console.log(`currentDocument ${a}`),c.metaData=0<virtualclass.dts.order.length?{init:a,slideNumber:virtualclass.dts.docs.note.currNote,order:JSON.stringify(virtualclass.dts.order)}:{init:"layout",slideNumber:null}):c.metaData={init:"layout",slideNumber:null},
0<Object.keys(virtualclass.dts.pages).length&&(c.metaData.docs=virtualclass.dts.pages)):"Quiz"==virtualclass.currApp?(virtualclass.quiz.saveInLocalStorage(),console.log("quiz data saved")):"Whiteboard"==virtualclass.currApp&&(c={name:"Whiteboard",wbn:virtualclass.gObj.wbCount});localStorage.setItem("wIds",JSON.stringify(virtualclass.gObj.wIds));localStorage.setItem("wbOrder",JSON.stringify(virtualclass.wbCommon.order));null!=virtualclass.zoom.canvasScale&&(a=+virtualclass.zoom.canvasScale,console.log(`Canvas pdf scale ${a}`),
virtualclass.vutil.isNumeric(a),virtualclass.zoom.hasOwnProperty("canvasDimension")&&localStorage.setItem("canvasDimension",JSON.stringify(virtualclass.zoom.canvasDimension)));roles.hasView()&&"Yts"==virtualclass.currApp&&(c={name:"Yts",metaData:null});virtualclass.hasOwnProperty("dts")&&null!=virtualclass.dts&&virtualclass.dts.upateInStorage();localStorage.setItem("currSlide",virtualclass.gObj.currSlide);localStorage.setItem("currIndex",virtualclass.gObj.currIndex);roles.hasControls()||(a=document.querySelector("#virtualclassCont.congrea #congHr.disable"))&&
a.click();console.dir(`Previous object ${c}`);localStorage.setItem("prevApp",JSON.stringify(c));roles.hasControls()?localStorage.setItem("videoSwitch",virtualclass.videoHost.gObj.videoSwitch):(localStorage.setItem("stdVideoSwitch",virtualclass.videoHost.gObj.stdStopSmallVid),localStorage.setItem("allStdVideoOff",virtualclass.videoHost.gObj.allStdVideoOff));localStorage.setItem("chatWindow",virtualclass.chat.chatWindow);this.saveWbOrder();"DocumentShare"!=virtualclass.currApp&&io.disconnect()}},initOnBeforeUnload(c){"iOS"==
...
a.getAttribute("data-write-mode")?virtualclass[c].cm.setOption("readOnly",!1):virtualclass[c].cm.setOption("readOnly","nocursor"):console.log(`Editor:- writemode element is not found for ${c}`)},isTeacherAlreadyExist(c){if(virtualclass.hasOwnProperty("connectedUsers"))for(let a=0;a<virtualclass.connectedUsers.length;a++)if(("t"==virtualclass.connectedUsers[a].role||"e"==virtualclass.connectedUsers[a].role)&&virtualclass.connectedUsers[a].userid!=c)return console.log(`joni Id ${c}`),!0;return!1},isPresenterAlreadyExist(c){if(virtualclass.hasOwnProperty("connectedUsers"))for(let a=
0;a<virtualclass.connectedUsers.length;a++)if("p"==virtualclass.connectedUsers[a].role&&virtualclass.connectedUsers[a].userid!=c)return console.log(`joniId ${c}`),!0;return!1},getPresenterId(){if(virtualclass.hasOwnProperty("connectedUsers"))for(let c=0;c<virtualclass.connectedUsers.length;c++)if("p"==virtualclass.connectedUsers[c].role)return virtualclass.connectedUsers[c].userid;return!1},isEducatorAlreadyExist(c){if(virtualclass.hasOwnProperty("connectedUsers"))for(let a=0;a<virtualclass.connectedUsers.length;a++)if("e"==
virtualclass.connectedUsers[a].role&&virtualclass.connectedUsers[a].userid!=c)return console.log(`joniId ${c}`),!0;return!1},isOrginalTeacherExist(c){if(virtualclass.hasOwnProperty("connectedUsers"))for(let a=0;a<virtualclass.connectedUsers.length;a++)if("t"==virtualclass.connectedUsers[a].role&&virtualclass.connectedUsers[a].userid!=c)return console.log(`joniId ${c}`),!0;return!1},createBecomeTeacherWidget(){if(null==document.getElementById("beTeacher")){const a=document.createElement("div");a.id=
"beTeacher";var c=document.createElement("a");c.id=`${a.id}Anchor`;c.innerHTML=virtualclass.lang.getString("becomeTeacher");a.appendChild(c);c=document.getElementById("virtualclassCont");c.insertBefore(a,c.firstChild);a.addEventListener("click",virtualclass.vutil.initTeacherRole);a.style.pointerEvents="none";a.style.opacity="0.5";setTimeout(()=>{a.style.pointerEvents="visible";a.style.opacity="1"},6E4)}},removeBecomeTeacherWidget(){const c=document.getElementById("beTeacher");null!=c&&c.parentNode.removeChild(c)},
initTeacherRole(){ioAdapter.send({cf:"bt"});virtualclass.vutil.removeBecomeTeacherWidget();setTimeout(()=>{virtualclass.vutil.isOrginalTeacherExist(virtualclass.jId)?console.log("Already connected teacher"):(virtualclass.vutil.overrideRoles("t"),localStorage.setItem("beTeacher",!0),console.log("connected teacher"));d.location.reload()},virtualclass.gObj.mySetTime)},overrideRoles(c){virtualclass.uInfo.userobj.role=c;virtualclass.gObj.uRole=virtualclass.uInfo.userobj.role;wbUser.role=virtualclass.uInfo.userobj.role;
const a=document.getElementById("virtualclassCont");virtualclass.vutil.overrideRolesFromElem(a,c)},overrideRolesFromElem(c,a){"s"==a?(c.classList.remove("teacher"),c.classList.remove("orginalTeacher"),c.classList.remove("presenter"),c.classList.remove("educator"),virtualclassCont.classList.add("student")):"p"==a?(c.classList.remove("teacher"),c.classList.remove("orginalTeacher"),c.classList.remove("educator"),virtualclassCont.classList.add("student"),virtualclassCont.classList.add("presenter")):"e"==
a?(c.classList.add("teacher"),c.classList.remove("student"),c.classList.remove("presenter"),c.classList.add("educator"),c.classList.add("orginalTeacher")):"t"==a&&(c.classList.remove("student"),c.classList.remove("educator"),c.classList.remove("presenter"),c.classList.add("teacher"),c.classList.add("orginalTeacher"),console.log("add Teacher"))},sesionEndMsgBoxIsExisting(){const c=document.getElementById("sessionEndMsgCont");return c.hasAttribute("data-displaying")&&"true"==c.dataset.displaying},removeVideoHostContainer(){const c=
document.getElementById("videoHostContainer");null!=c&&c.parentNode.removeChild(c)},createDummyUser(c){c||(c=5E3);let a,b=0,f=31;var g=setInterval(()=>{b>c?clearInterval(g):(f+=b,a={joinUser:{key:f},message:[{lname:" ",name:`User${f}`,role:"s",userid:f}],newuser:null,type:"member_added",user:!0},b++,virtualclass.ioEventApi.readyto_member_add(a))},1)},getVisibleHeightElem(c){var a=$(c);c=$(d).scrollTop();const b=c+$(d).height(),f=a.offset().top;a=f+a.outerHeight();return(a>b?b:a)-(f<c?c:f)},applyHeight(c){c=
document.getElementById("virtualclassAppRightPanel");const a=this.getVisibleHeightElem("virtualclassCont");c.style.height=a!=nul1?a:d.innerHeight},insertIntoLeftBar(c){const a=document.querySelector("#virtualclassApp #virtualclassAppLeftPanel");null!=a?a.appendChild(c):alert("Error:- There is no Element to insert it.")},getWhiteboardId(c){c=c.closest(".vcanvas");if(null!=c)return c.dataset.wbId;alert("doc element is null")},getElementOffset(c){let a=0,b=0;do a+=c.offsetTop||0,b+=c.offsetLeft||0,c=
c.offsetParent;while(c);return{x:b,y:a}},updateCurrentDoc(c){virtualclass.gObj.currWb=`_doc_${c}_${c}`},getParentTag(c,a){return c.closest(a)},attachEventToUploadTab(c,a,b){c=document.getElementById("newDocBtn");null!=c&&(c.removeEventListener("click",virtualclass.vutil._attachEventToUploadTab),c.addEventListener("click",virtualclass.vutil._attachEventToUploadTab))},_attachEventToUploadTab(){var c=document.querySelector("#DocumentShareDashboard .qq-upload-button-selector.qq-upload-button input");
if(null!=c){if(c.click(),c=document.querySelector("#DocumentShareDashboard .qq-upload-list-selector.qq-upload-list"))c.style.display="block"}else alert("Element is null")},attachEventToUpload(c,a,b){c=document.getElementById("uploadVideo");null!=c&&c.addEventListener("click",()=>{const a=document.querySelector("#VideoDashboard .qq-upload-button-selector.qq-upload-button input");null!=a?a.click():alert("Element is null")})},modalPopup(c,a){const b={};if("video"==c){const a=document.querySelector("#listvideo .playing");
a&&(this.currPlaying=a.getAttribute("data-rid"));b.validation="mp4 avi wmv mov webm mkv vob mpeg".split(" ");b.cb=virtualclass.videoUl.afterUploadVideo;b.cthis="video";b.maxSize=512E6;b.requesteEndPoint=`${d.webapi}&methodname=file_save&live_class_id=${virtualclass.gObj.congCourse}&status=1&content_type_id=2&user=${virtualclass.gObj.uid}`}else b.validation="doc docx txt html csv pdf ppt pptx xls xlsx xlt png jpg gif svg tiff rtf xpm".split(" "),b.cb=virtualclass.dts.onAjaxResponse,b.cthis="docs",
b.maxSize=24E6,b.requesteEndPoint=`${d.webapi}&methodname=congrea_image_converter&live_class_id=${virtualclass.gObj.congCourse}&status=1&content_type_id=1&user=${virtualclass.gObj.uid}`;b.multiple=!1;b.wrapper=document.getElementById(a[0]);virtualclass.fineUploader.uploaderFn(b);"video"!=c&&(c=document.querySelector("#DocumentShareDashboard #docsUploadMsz"),a=document.createElement("div"),c&&c.appendChild(a))},xhrSendWithForm(c,a,b){const f=new FormData;for(const a in c)f.append(a,c[a]);c="undefined"===
typeof a?d.webapi:`${d.webapi}&methodname=${a}&user=${virtualclass.gObj.uid}`;"undefined"!==typeof b?virtualclass.xhr.sendFormData(f,c,b):virtualclass.xhr.sendFormData(f,c)},createSaveButton(){const c=document.createElement("div");c.id="tech_support_save";const a=document.createElement("span");a.innerHTML="Save Session";c.appendChild(a);return c},setChatContHeight(c){},setChatHeight(c){},alreadyConnected(c){return 0<virtualclass.connectedUsers.length?0<virtualclass.connectedUsers.filter(a=>a.userid==
c).length:!1},UTCtoLocalTime(c){var a=new Date(c);c=a.getHours();a=`0${a.getMinutes()}`;return`${c}:${a.substr(-2)}`},UTCtoLocalTimeToSeconds(c){return c=(new Date(c)).getTime()},appIsForEducator(c){for(const a in virtualclass.apps)if(virtualclass.apps[a]==c)return!1;return!0},initDashboardNav(c){if(roles.hasControls()){var a=document.querySelector("#dashboardnav button");null==a&&(a=virtualclass.getTemplate("dashboardNav")({app:virtualclass.currApp}),document.querySelector("#virtualclassAppOptionsCont").insertAdjacentHTML("beforeend",
...
f.dataset.title="Video on",roles.hasControls()?virtualclass.videoHost.gObj.videoSwitch=0:virtualclass.videoHost.gObj.stdStopSmallVid=!0,chatContainerEvent.elementFromShadowDom(`#ml${virtualclass.gObj.uid} .user-details a .videoWrapper`)?virtualclass.videoHost.setUserIcon(virtualclass.gObj.uid):virtualclass.gObj.delayVid="display",roles.hasControls()&&virtualclass.videoHost.UI.hideTeacherVideo());"undefined"===typeof a&&(virtualclass.gObj.meetingMode?virtualclass.multiVideo.setVideoStatus("off"!=c):
virtualclass.gObj.uid==virtualclass.vutil.whoIsTeacher()&&ioAdapter.mustSend({congCtr:{videoSwitch:b},cf:"congController"}),roles.hasControls()||ioAdapter.mustSend({stdVideoCtr:{videoSwitch:virtualclass.videoHost.gObj.stdStopSmallVid},cf:"stdVideoCtrl"}))},isChromeExtension(){d.postMessage({type:"isInstalled",id:1},"*");console.log("Chrome Extension:- Check");d.addEventListener("message",c=>{"yes"==c.data.type&&(virtualclass.gObj.chromeExt=!0)})},setWidth(c,a,b){a=document.querySelector(`#canvas${c}`);
...
a&=a;return a},randomString(c){let a="";for(;0<c;--c)a+="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"[Math.round(61*Math.random())];return a},isBulkDataFetched(){return 0<virtualclass.serverData.rawData.video.length||0<virtualclass.serverData.rawData.docs.length||0<virtualclass.serverData.rawData.ppt.length},sendOrder(c,a,b){virtualclass.gObj.docOrder[c]=a;c={order:JSON.stringify(virtualclass.gObj.docOrder)};virtualclass.xhrn.sendData(c,virtualclass.api.UpdateRoomMetaData,b)},saveWbOrder(c){c&&
(console.log(`nirmala${c}`),localStorage.setItem("wbOrder",JSON.stringify(virtualclass.wbCommon.order)))},requestOrder(c,a){virtualclass.xhrn.sendData({noting:!0},virtualclass.api.GetRoomMetaData,b=>{"Error"==b?console.log("page order retrieve failed"):(b=JSON.parse(b).Item,null!=b&&"undefined"!==typeof b&&void 0!=b&&b.order.S&&virtualclass.vutil.IsJsonString(b.order.S)&&(b=JSON.parse(b.order.S),virtualclass.gObj.docOrder=b,a(b[c])))})},IsJsonString(c){try{JSON.parse(c)}catch(a){return!1}return!0},
removeChildrens(c){console.log(`children selector ${c}`);c=document.querySelectorAll(c);for(let a=0;a<c.length;a++)c[a].parentNode.removeChild(c[a])},initAcitveElement(){if("Video"==virtualclass.currApp)var c="#VideoDashboard .qq-uploader-selector.qq-uploader.qq-gallery",a="#listvideo";else"DocumentShare"==virtualclass.currApp&&(c="#DocumentShareDashboard .qq-uploader-selector.qq-uploader.qq-gallery",a="#listdocs");const b=document.querySelector(`#${virtualclass.currApp}Dashboard`);null==b||b.classList.contains("uploading")?
virtualclass.vutil.makeElementDeactive(c):(virtualclass.vutil.makeElementActive(c),virtualclass.vutil.makeElementDeactive(a))},isResponseAvailable(c){return void 0!=c&&"undefined"!=c&&null!=c},navWhiteboard(c,a,b){virtualclass.vutil.isTextWrapperExist()&&virtualclass.wb[virtualclass.gObj.currWb].obj.drawTextObj.finalizeTextIfAny();"undefined"!==typeof b?a.call(c,b):a.call(c);console.log(`whiteboard nav time${virtualclass.gObj.wbNavtime}`)},removeAllTextWrapper(){const c=document.querySelectorAll(".canvasWrapper .textBoxContainer");
for(let a=0;a<c.length;a++)c[a].parentNode.removeChild(c[a])},isDashboardOpened(c){c=document.querySelector("#dashboardnav button");return null!=c&&c.classList.contains("clicked")},stopConnection(){io.webSocketConnected()&&io.disconnect();virtualclass.gObj.invalidlogin=!0},initDefaultApp:()=>{const c=document.querySelector(`#virtualclass${virtualclass.gObj.defaultApp}Tool a`);null!=c&&c.click(c)},initssSharing:c=>{virtualclass.gObj.whoIsSharing=c;c=chatContainerEvent.elementFromShadowDom(`#ml${c} .icon-stdscreenImg`);
null!=c&&c.setAttribute("data-dcolor","green")},removeSSsharing:()=>{const c=document.querySelector("#chat_div .controleCont.ssSharing");null!=c&&c.classList.remove("ssSharing");delete virtualclass.gObj.whoIsSharing},informIamSharing:()=>{const c=virtualclass.vutil.whoIsTeacher();roles.isStudent()&&virtualclass.gObj.studentSSstatus.mesharing&&ioAdapter.mustSendUser({cf:"sshare_user"},c)},resizeWindowIfBigger(){var {currWb:c}=virtualclass.gObj;c=document.querySelector(`#canvasWrapper${c}`);null!=c&&
60<d.innerWidth-(c.offsetWidth+320)&&(console.log("Resize event is triggered"),system.initResize())},isTextWrapperExist(){return 0<document.querySelectorAll(".canvasWrapper .textBoxContainer").length},insertAppLayout:c=>{document.querySelector("#virtualclassAppContainer");$("#virtualclassAppContainer").append(c)},prechkScrnShare(){if(localStorage.getItem("precheck")){var c=document.getElementById("preCheckcontainer");c.style.display="none";c=document.getElementById("virtualclassApp");c.style.display=
"block";virtualclass.videoHost._resetPrecheck()}else virtualclass.popup.waitMsg(),virtualclass.makeReadySocket(),c=document.getElementById("preCheckcontainer"),c.style.display="none",c=document.getElementById("virtualclassApp"),c.style.display="block",localStorage.setItem("precheck",!0),virtualclass.videoHost.afterSessionJoin();virtualclass.gObj.precheckScrn=!1},showFinishBtn(){var c=document.querySelector(".congrea #dashboardContainer .modal-header button");c&&c.classList.add("enable");"DocumentShare"==
virtualclass.currApp&&(c=document.querySelector("#virtualclassAppLeftPanel"),c.classList.add("showZoom"),c.classList.remove("hideZoom"))},removeFinishBtn(){var c=document.querySelector(".congrea.teacher  #dashboardContainer .modal-header button.enable");c&&c.classList.remove("enable");"DocumentShare"==virtualclass.currApp&&(c=document.querySelector("#virtualclassAppLeftPanel"),c.classList.add("hideZoom"),c.classList.remove("showZoom"))},removeSharingClass(){const c=document.querySelector("#virtualclassCont");
""!=c&&(c.classList.remove("studentScreenSharing"),document.querySelector("#chat_div").classList.remove("studentScreenSharing"))},addNoteClass(){if(roles.isStudent()){const c=document.querySelector("#docScreenContainer");null!=c&&(c.classList.add("noteDisplay"),console.log("add note display"))}},calcBrightness(c){c=chroma(c).rgb();c=Math.round((299*parseInt(c[0])+587*parseInt(c[1])+114*parseInt(c[2]))/1E3);console.log(`brightne${c}`);return c},removeStudenScreenStatus(){const c=chatContainerEvent.elementFromShadowDom(".stdscreenImg",
"all");for(let a=0;a<c.length;a++)c[a].dataset.dcolor=""},insertAfter(c,a){a.parentNode.insertBefore(c,a.nextSibling)},triggerMouseEvent(c,a){if(null!=c){const b=document.createEvent("MouseEvents");b.initEvent(a,!0,!0);c.dispatchEvent(b)}},getCookie(c){return(c=document.cookie.match(RegExp(`(?:^|;\\s*)${c.replace(/([.*+?\^${}()|\[\]\/\\])/g,"\\$1")}=([^;]*)`)))?c[1]:null},sendCurrAppOnUserJoin(){if("object"===typeof virtualclass.wb&&"Whiteboard"==virtualclass.currApp){const c=virtualclass.wb[virtualclass.gObj.currWb].vcan.main.replayObjs;
0<c.length?ioAdapter.sendWithDelayAndDrop({repObj:c,cf:"repObj"},null,"mustSend","repObj",1500):console.log("Could not send the whiteboard data")}},setCurrApp(c,a){c.dataset.currapp=a;console.log(`Data set curr app ${a}`);c=document.getElementById("chat_div");null!=c&&(c.dataset.currapp=a)},selfJoin(c){return c==virtualclass.gObj.uid?(ioAdapter.sendSpeed(virtualclass.videoHost.gObj.MYSPEED),!0):!1},getUrlVars(c){const a=[],b=c.slice(c.indexOf("?")+1).split("&");for(let f=0;f<b.length;f++)c=b[f].split("="),
a.push(c[0]),a[c[0]]=c[1];return a},clearSyncTimeInterval(){virtualclass.videoUl.hasOwnProperty("syncTimeInterval")&&clearInterval(virtualclass.videoUl.syncTimeInterval)},pageVisible(){let c,a;const b={hidden:"visibilitychange",webkitHidden:"webkitvisibilitychange",mozHidden:"mozvisibilitychange",msHidden:"msvisibilitychange"};for(c in b)if(c in document){a=b[c];break}return function(b){b&&document.addEventListener(a,b);return!document[c]}},showZoom(){const c=document.querySelector("#virtualclassAppLeftPanel.hideZoom");
...
(c=document.querySelector("#listvideo .removeCtr"))&&c.classList.remove("removeCtr");roles.hasControls()||(virtualclass.gObj.hasOwnProperty("videoPauseTime")&&clearTimeout(virtualclass.gObj.videoPauseTime),"object"===typeof virtualclass.videoUl.player&&null!=virtualclass.videoUl.player.player_&&virtualclass.videoUl.player.paused()&&(console.log("==== Video is paused"),virtualclass.videoUl.player.pause()));"object"===typeof virtualclass.videoUl.player&&delete virtualclass.videoUl.player}}})(window);let globalImageData={},newCanvas;
...
!1;virtualclass.gObj.studentSSstatus.sharing=!1;localStorage.setItem("studentSSstatus",JSON.stringify(virtualclass.gObj.studentSSstatus));const a=document.querySelector("#virtualclassScreenShare");null!=a&&a.parentNode.removeChild(a);virtualclass.vutil.removeSSsharing();delete virtualclass.ss;virtualclass.hasOwnProperty("studentScreen")&&delete virtualclass.studentScreen;virtualclass.zoom.removeZoomController();virtualclass.ss=""},removeStream(){virtualclass.vutil.removeClass("audioWidget","fixed");
this.localCont.clearRect(0,0,this.localCanvas.width,this.localCanvas.height);this.clearScreenShare()},initializeRecorder(a){c=1;this.prevStream&&(this.ssByClick=!1);"undefined"!==typeof virtualclass.prevScreen&&virtualclass.prevScreen.hasOwnProperty("currentStream")&&virtualclass.prevScreen.unShareScreen();this.video=document.getElementById(`${this.local}Video`);this.videoSmall=document.getElementById(`${this.local}Videosmall`);if("VIDEO"!=this.video.tagName){var b=document.getElementById(`${this.local}video`);
this.video.parentNode.replaceChild(b,this.video);this.video=document.getElementById(`${this.local}Video`);this.video.autoplay=!0;virtualclass.vutil.initLocCanvasCont(`${this.local}Temp`+"Video")}this.currentStream=a;var f=this;virtualclass.adpt.attachMediaStream(this.video,a);virtualclass.adpt.attachMediaStream(this.videoSmall,a);this.prevStream=!0;this.currentStream.getVideoTracks()[0].onended=function(a){if(f.ssByClick){if(a=document.querySelector("#virtualclassScreenShareLocalSmall"))a.style.display=
...
setInterval(g,I)},getContainerDimension(){const a=document.getElementById(`${this.id}Local`);return{width:a.offsetWidth,height:a.offsetHeight}},drawImages(a){sdworker.postMessage({encodeArr:a,cw:virtualclass.ss.localCanvas.width,ch:virtualclass.ss.localCanvas.height,dtype:"drgb"},[a.buffer])},dimensionStudentScreen(a,b){this.localCanvas=document.getElementById(`${virtualclass[g].local}Video`);this.localCont=virtualclass[g].localCanvas.getContext("2d");this.localCanvas.width=a;this.localCanvas.height=
b;console.log(`normal width ${this.localCanvas.width}`)},dimensionStudentScreenResize(a,b){this.hasOwnProperty("vac")||(this.vac=!0,this.localCanvas=document.getElementById(`${virtualclass[g].local}Video`),this.localCont=virtualclass[g].localCanvas.getContext("2d"));a.hasOwnProperty("d")&&(this.localCont.clearRect(0,0,this.localCanvas.width,this.localCanvas.height),this.localCanvas.width=a.d.w,this.localCanvas.height=a.d.h);a.hasOwnProperty("vc")&&(b=document.getElementById(virtualclass[g].local),
b.style.width=`${a.vc.w}px`,b.style.height=`${a.vc.h}px`);"virtualclassScreenShare"==virtualclass.previous&&virtualclass.vutil.setScreenInnerTagsWidth(virtualclass.previous)},isAbleToScreenShare(){return roles.isStudent()&&virtualclass.gObj.studentSSstatus.mesharing||roles.hasControls()&&!virtualclass.gObj.studentSSstatus.mesharing?!0:!1},html:{UI(a){a=virtualclass.ss.isAbleToScreenShare();var b=roles.hasControls(),{recImgPlay:c}=virtualclass.recorder;c=virtualclass.getTemplate("ssmainDiv")({control:a,
recImg:c,scrctrl:b});virtualclass.vutil.insertAppLayout(c);roles.hasControls()&&!virtualclass.gObj.studentSSstatus.mesharing&&(c=document.querySelector("#virtualclassCont  #stopScreenShare"))&&c.addEventListener("click",()=>{virtualclass.vutil.initDefaultApp()});b&&this.html.initScreenController();b=document.querySelector(".congrea #virtualclassApp");a?b.classList.remove("zoomCtrAdd"):b.classList.contains("zoomCtr")||b.classList.add("zoomCtrAdd");if(roles.hasControls()&&virtualclass.gObj.studentSSstatus.mesharing){const a=
this;setTimeout(()=>{var b=document.querySelector("#screenController .share");virtualclass.gObj.studentSSstatus.shareToAll?(a.html.changeSsInfoSelf(b),b="sToAll"):(a.html.changeSsInfoShareToAll(b),b="sview");ioAdapter.mustSend({cf:b,firstSs:!0})},2E3);(c=document.querySelector("#virtualclassCont  #stopScreenShare"))&&c.addEventListener("click",()=>{virtualclass.vutil.initDefaultApp();const a=document.querySelector("#virtualclassCont.studentScreenSharing");a&&(a.classList.remove("studentScreenSharing"),
...
c));virtualclass.pageVisible(this.handlPageActiveness.bind(this))}this.hasOwnProperty("prvNum")||(this.masterIndex=this.subRecordingIndex=0,this.subRecordings=this.masterRecordings[this.masterIndex],this.play(),this.prvNum=this.masterIndex)},handlPageActiveness(){virtualclass.pageVisible()?this.earlierPause||(this.controller._play(),delete this.earlierPause):(this.earlierPause=this.controller.pause,this.controller._pause())},removeHandler(a){a.removeEventListener("mousedown",this.seekHandler.bind(this));
document.getElementById("timeInHover").style.display="none";document.querySelector("#virtualclassCont").classList.remove("recordSeeking")},replayFromStart(){console.log("Replay from start");this.tempPlayTime=this.playTime=150;const a=this.masterRecordings;virtualclass.storage.config.endSession();virtualclass.popup.closeElem();disCommonChatInput();this.playTimeout="";this.playStart=this.waitPopup=this.waitServer=!1;this.elapsedPlayTime=this.error=0;this.controller.ff=1;this.masterRecordings=a;this.playTimePreviousSeconds=
0;this.playProgressBar(this.playTime);delete this.prvNum;this.init()},convertInto(a){if("string"===typeof a.data)return a;a.data=a.data.buffer;return a},playProgressBar(a){0<a?(virtualclass.pbar.renderProgressBar(this.totalTimeInMiliSeconds,a,"playProgressBar",void 0),a=this.convertIntoReadable(a),document.getElementById("tillRepTime").innerHTML=`${a.h}:${a.m}:${a.s}`,this.alreadyCalcTotTime||(this.updateTotalTime(),this.alreadyCalcTotTime=!0)):virtualclass.pbar.renderProgressBar(1E3*this.lastTimeInSeconds,
0,"playProgressBar",void 0)},updateTotalTime(){const a=this.convertIntoReadable(this.totalTimeInMiliSeconds);document.getElementById("totalRepTime").innerHTML=`${a.h}:${a.m}:${a.s}`},convertIntoReadable(a){a/=1E3;let b=0,c=Math.floor(a%60);a=Math.floor(a/60);60<=a&&(b=Math.floor(a/60),a%=60);10>b&&(b=`0${b}`);10>a&&(a=`0${a}`);10>c&&(c=`0${c}`);return{h:b,m:a,s:c}},displayWaitPopupIfNot(){0==this.waitPopup&&(virtualclass.popup.sendBackOtherElems(),document.getElementById("recordingContainer").style.display=
"none",virtualclass.popup.waitBlockAction("block"),virtualclass.pbar.renderProgressBar(0,0,"downloadProgressBar","downloadProgressValue"),virtualclass.popup.waitBlock(),this.waitPopup=!0)},requestDataFromServer(a){if(this.isFileVcp(a))if(this.alreadyRequested[a])console.log(`Already requested file ${a}`),0<virtualclass.recorder.totalRecordingFiles.length&&(a=virtualclass.recorder.totalRecordingFiles.shift(),virtualclass.recorder.requestDataFromServer(a));else{console.log(`requested file ${a}`);const b=
`https://recording.congrea.net/${wbUser.lkey}/${wbUser.room}/${virtualclass.recorder.session}/${a}`;virtualclass.recorder.xhr[a]=new c;virtualclass.recorder.xhr[a].init();virtualclass.recorder.xhr[a].loadData(b,this.afterDownloading.bind(this,a))}},afterDownloading(a,b){if("ERROR"==b)setTimeout(()=>{virtualclass.recorder.requestDataFromServer(a)},500);else{if(0<virtualclass.recorder.totalRecordingFiles.length){const a=virtualclass.recorder.totalRecordingFiles.shift();virtualclass.recorder.requestDataFromServer(a)}virtualclass.recorder.rawDataQueue[a]=
{file:a,data:b};this.formatRecording(a);this.alreadyRequested[a]=!0}},isFirstPacket(a){a=virtualclass.recorder.orginalListOfFiles[a];return null!=a&&0==a.index},isPacketInSerial(a){if(null!=this.prevFile)return this.orginalListOfFiles[this.prevFile].next===a||"end"===this.orginalListOfFiles[this.prevFile].next},formatRecording(a){if(this.isFirstPacket(a)||this.isPacketInSerial(a)&&0<Object.keys(this.rawDataQueue).length)a=this.rawDataQueue[a],null!=a&&(this.makeRecordingQueue(a.file,a.data),delete this.rawDataQueue[a.file],
this.prevFile=a.file,a=this.orginalListOfFiles[a.file].next,"end"!==a&&this.formatRecording(a))},isFileVcp(a){return null!=a&&null!=a.match(/^.*\.(vcp)$/)},calculateNextTime(a,b){const c=b.substring(0,21);b.substring(22,b.length);[b]=c.split(" ");b=Math.trunc(b/1E6);return b-a},insertPacketInto(a,b){b=Math.trunc(b/1E3);let c=0;if(!isNaN(b)&&1<=b){this.isTrimRecordingNow||(c=1E3);const f={playTime:c,recObjs:'{"0{"user":{"userid":"2"},"m":{"app":"nothing","cf":"sync"}} ',type:"J"};for(let g=0;g<b;g++)this.totalTimeInMiliSeconds+=
c,a.push(f)}return a},makeRecordingQueue(a,b){console.log(`File formatting ${a}`);let c=[];var g=null;const d=[];b=b.trim().split(/(?:\r\n|\r|\n)/g);for(let a=0;a<b.length;a++)if(null!=b[a]&&""!=b[a]){this.totalElements++;var m=b[a].substring(0,21);var n=b[a].substring(22,b[a].length);let [f,k]=m.split(" ");this.tempTime=f;f=Math.trunc(f/1E6);null!=this.refrenceTime&&(g?(this.tempPlayTime=f-this.refrenceTime-g,g=null):this.tempPlayTime=f-this.refrenceTime);this.hasOwnProperty("tempRefrenceTime")?
d.push(Math.trunc((this.tempTime-this.tempRefrenceTime)/1E6)):d.push(150);null!=n&&""!=n&&(!this.joinRoomRecevied&&-1<n.indexOf('"type":"joinroom"')&&(this.joinRoomRecevied=!0,n=JSON.parse(n),n.clientids=n.action,n=JSON.stringify(n)),this.lastFileTime&&0===a&&(m=Math.trunc(f-this.lastFileTime),c=this.insertPacketInto(c,m),this.tempPlayTime=1E3<m?m%1E3:m),a===b.length-1&&(this.lastFileTime=f),this.isTrimRecordingNow?(c.push({playTime:0,recObjs:n,type:k}),console.log("==== TRIM ")):virtualclass.settings.recording.trimRecordings&&
-1<n.indexOf('{"ac":false,"cf":"recs"')?(this.isTrimRecordingNow=!0,c.push({playTime:0,recObjs:n,type:k}),console.log("==== TRIM ")):c.push({playTime:this.tempPlayTime,recObjs:n,type:k}),this.totalTimeInMiliSeconds+=c[c.length-1].playTime,virtualclass.settings.recording.trimRecordings&&-1<n.indexOf('{"ac":true,"cf":"recs"')&&(this.isTrimRecordingNow=!1),"undefined"!==typeof b[a+1]&&(n=this.calculateNextTime(f,b[a+1]),c=this.insertPacketInto(c,n,!0),1E3<=n&&(g=1E3*Math.trunc(n/1E3))),this.refrenceTime=
f,this.tempRefrenceTime=this.tempTime)}console.log(`totalTime in seconds ${this.totalTimeInMiliSeconds/1E3}`);for(b=0;b<c.length;b++)"B"==c[b].type&&(g=virtualclass.dtCon.base64DecToArr(c[b].recObjs),c[b].recObjs=g);this.masterRecordings.push(c);this.orginalTimes.push(d);this.UIdownloadProgress(a);(3<this.currentMin||this.lastFile==a)&&0<this.masterRecordings.length&&(this.playStart?(this.startToPlay(),this.updateTotalTime()):this.alreadyAskForPlay||(this.alreadyAskForPlay=!0,this.askToPlay()))},
handleStartToPlay(a){const b=document.querySelector(".rv-vanilla-modal-overlay.is-shown");null!=b&&b.removeEventListener("click",this.handleStartToPlay.bind(this));virtualclass.gesture.clickToContinue();console.log("===== Start to play");this.startToPlay();a.currentTarget.classList.remove("askToPlayCont")},startToPlay(){this.playStart?this.hasOwnProperty("isPausedByNotPresent")&&(delete this.isPausedByNotPresent,this.subRecordingIndex=0,this.subRecordings=this.masterRecordings[this.masterIndex],this.controller._play(),
virtualclass.popup.closeElem()):(this.playStart=!0,this.playInt(),virtualclass.popup.closeElem())},isDownloadedAllRecordings(a){return 9E5<this.sessionStartTime?a>=virtualclass.recorder.lastTimeInSeconds:!1},finishRequestDataFromServer(a){this.isDownloadedAllRecordings(a)&&(virtualclass.recorder.allFileFound=!0,virtualclass.recorder.alreadyAskForPlay&&(a=document.getElementById("askplayMessage"),null!=a&&(a.innerHTML=virtualclass.lang.getString("playsessionmsg"))))},UIdownloadProgress(a){a=virtualclass.recorder.getTimeFromFile(a);
var b=(a-this.firstTimeInSeconds)/60;b>this.currentMin&&(this.currentMin=b);b=virtualclass.recorder.totalTimeInMiliSeconds/1E3/60;this.downloadInPercentage=100*this.currentMin/b;virtualclass.pbar.renderProgressBar(b,this.currentMin,"downloadProgressBar","downloadProgressValue");this.finishRequestDataFromServer(a);virtualclass.recorder.playStart&&!virtualclass.recorder.waitServer&&virtualclass.recorder.init()},playInt(){console.log("=====Play init recording=====");virtualclass.popup.closeElem();virtualclass.recorder.init(virtualclass.recorder.masterRecordings);
localStorage.setItem("mySession","thisismyplaymode");virtualclass.recorder.initController();virtualclass.media.audio.initAudiocontext()},askToPlay(){document.querySelector("#loadingWindowCont .loading");document.querySelector("#loadingWindowCont .askToPlay");document.querySelector("#loadingWindowCont");const a=document.querySelector(".rv-vanilla-modal-overlay.is-shown");a.addEventListener("click",this.handleStartToPlay.bind(this));const b=document.querySelector("#loadingWindowCont .askToPlay");null!=
b&&b.addEventListener("click",this.handleStartToPlay.bind(this));document.getElementById("popupContainer").classList.add("playPopup");a.classList.add("askToPlayCont")},playProgressOutput(a){console.log("Offset ",a.offsetX)},getOffset(a){"touchend"==a.type?a=this.lastEvent:(a.offsetX=a.touches[0].pageX-a.touches[0].target.offsetLeft,a.offsetY=a.touches[0].pageY-a.touches[0].target.offsetTop);return this.lastEvent=a},seekHandler(a){void 0==a.offsetX&&(a=this.getOffset(a));this.pauseBeforeSeek=this.controller.pause;
if(this.startSeek)console.log("Earlier seek start is not end yet.");else{this.startSeek=!0;var b=document.querySelector("#virtualclassCont");null!=b&&b.classList.add("recordSeeking");b=a.offsetX;const c=this.getCustomWidth();this.seekValueInPercentage=b/c*100;console.log(`====Seek start ${this.seekValueInPercentage} ev current target=${a.currentTarget.id}`)}},getCustomWidth(){return document.getElementById("downloadProgress").clientWidth-1},seek(a){a=this.getSeekPoint(a);(a.master<this.masterIndex||
a.master==this.masterIndex&&a.sub<this.subRecordingIndex)&&this.replayFromStart();this._seek(a);console.log("seek is finished");this.triggerSynchPacket()},selfSeek(){console.log("Start self seek");this.selfStartSeek=!0;this._seek();this.triggerSynchPacket();this.controller._play()},triggerSynchPacket(){this.triggerPlayProgress();this.binarySyncMsg&&(this.handleSyncPacket(),this.binarySyncMsg=null);this.handleSyncStringPacket()},seekFinished(a){if(void 0==a&&void 0!=this.masterRecordings[this.masterIndex][this.subRecordingIndex])return-1<
this.masterRecordings[this.masterIndex][this.subRecordingIndex].recObjs.indexOf('{"ac":true,"cf":"recs"')},_seek(a){this.controller._pause();let b;for(;;){b=null!=a?this.masterIndex!=a.master?this.masterRecordings[this.masterIndex].length:a.sub:this.masterRecordings[this.masterIndex].length;for(let a=this.subRecordingIndex;a<b;a++){try{if("B"!=this.subRecordings[this.subRecordingIndex].type)this.msg=io.cleanRecJson(this.subRecordings[this.subRecordingIndex].recObjs),-1<this.msg.indexOf('"m":{"unshareScreen"')?
...
this.binarySyncMsg=null)}this.collectElapsedPlayTime()}catch(g){}if(virtualclass.settings.recording.trimRecordings&&this.selfStartSeek&&this.seekFinished()){this.selfSeekFinished=!0;break}this.subRecordingIndex++}this.elapsedRecTime=this.elapsedTime=this.elapsedPlayTime;if(void 0!=a&&this.masterIndex===a.master&&a.sub===this.subRecordingIndex||this.selfSeekFinished)break;else this.subRecordingIndex=0,this.masterIndex++,this.subRecordings=this.masterRecordings[this.masterIndex]}},handleSyncStringPacket(){if("Poll"==
virtualclass.currApp&&"object"===typeof virtualclass.poll.pollState.data&&virtualclass.poll.hasOwnProperty("recordStartTime")){var a=this.getTotalTimeInMilSeconds(virtualclass.poll.recordStartTime.data.masterIndex,virtualclass.poll.recordStartTime.data.subIndex);virtualclass.poll.dataRec.setting.timer?this.pollUpdateTime(a,virtualclass.poll.pollState):(a=this.convertIntoReadable(this.elapsedPlayTime-a),virtualclass.poll.dataRec.newTime.min=a.m,virtualclass.poll.dataRec.newTime.sec=a.s,virtualclass.poll.elapsedTimer())}else if("Video"==
virtualclass.currApp&&"object"===typeof virtualclass.videoUl&&virtualclass.videoUl.hasOwnProperty("videoStartTime"))a=this.getTotalTimeInMilSeconds(virtualclass.videoUl.videoStartTime.data.masterIndex,virtualclass.videoUl.videoStartTime.data.subIndex),a=(this.elapsedPlayTime-a)/1E3,"object"===typeof virtualclass.videoUl.player?virtualclass.videoUl.playVideo(a):(console.log("====Video init to play start"),virtualclass.videoUl.isPaused=this.pauseBeforeSeek?!0:!1,virtualclass.videoUl.startTime=a);else if("Quiz"==
virtualclass.currApp&&"object"===typeof virtualclass.quiz){a=document.querySelector("#qztime");var b=this.getTotalTimeInMilSeconds(virtualclass.quiz.quizStartTime.data.masterIndex,virtualclass.quiz.quizStartTime.data.subIndex);0<+virtualclass.quiz.plugin.config.quizTime?(b=1E3*virtualclass.quiz.plugin.config.quizTime-(this.elapsedPlayTime-b),virtualclass.quiz.plugin.method.startTimer(b/1E3,a,"desc","vmQuiz")):(b=(this.elapsedPlayTime-b)/1E3,virtualclass.quiz.plugin.method.startTimer(b,a,"asc","vmQuiz"))}},
pollUpdateTime(a,b){a=this.convertIntoReadable(6E4*b.data.stdPoll.newTime.min+1E3*b.data.stdPoll.newTime.sec-(this.elapsedPlayTime-a));virtualclass.poll.newTimer.sec=a.s;virtualclass.poll.newTimer.min=a.m;virtualclass.poll.showTimer(virtualclass.poll.newTimer)},handleSyncPacket(){if(this.binarySyncMsg){console.log("Get full screen share");var a=this.binarySyncMsg.data.subIndex;let b=this.binarySyncMsg.data.masterIndex;for(;b<=this.masterIndex;){console.log(`Start from master index ${b} from Subindex ${a}`);
const c=this.masterRecordings[b];let g;for(g=this.masterIndex!=b?this.masterRecordings[this.masterIndex].length:this.subRecordingIndex;a<=g;a++){this.msg=c[a];try{if(null!=this.msg&&"B"==this.msg.type){if(this.msg=this.msg.recObjs,104==this.msg[0]||204==this.msg[0]||103==this.msg[0]||203==this.msg[0]||102==this.msg[0]||202==this.msg[0])io.onRecMessage(this.convertInto({data:this.msg}))}else console.log("Either this.msg is null or string")}catch(k){console.log(`PLAY ERROR ${k.errorCode}`)}}if(this.masterIndex==
b&&a==this.subRecordingIndex)break;else b++,a=0}console.log(`===== Elapsed time 2 ==== ${this.elapsedPlayTime}`);this.playProgressBar(this.elapsedPlayTime)}},getSeekPoint(a){a=Math.trunc(this.totalTimeInMiliSeconds*a/100);console.log(`Seek index ${a}`);let b=0;for(let c=0;c<this.masterRecordings.length;c++)for(let f=0;f<this.masterRecordings[c].length;f++){b+=this.masterRecordings[c][f].playTime;if(b==a)return{master:c,sub:f};if(b>=a)return 0<f?f--:(c--,f=0<=c?this.masterRecordings[c].length-1:0),
console.log(`Seek index i = ${c} j=${f} totalTime=${b}`),{master:c,sub:f}}},play(){this.controller.pause||(this.config(),this.isPlayFinished()?this.allFileFound?this.askAgainToPlay():(this.controller._pause(),this.initReplayWindow(),document.querySelector("#loadingWindowCont .loading").style.display="block",document.querySelector("#loadingWindowCont .askToPlay").style.display="none",this.isPausedByNotPresent=!0):this.executePacketToPlay())},config(){0==this.masterIndex&&0==this.subRecordingIndex&&
...
-1<this.subRecordings[this.subRecordingIndex].recObjs.indexOf('"m":{"videoUl":{"content_path"')?(virtualclass.videoUl.videoStartTime={app:"Video",data:{masterIndex:this.masterIndex,subIndex:this.subRecordingIndex}},console.log("Capture video")):"Quiz"==virtualclass.currApp&&-1<this.subRecordings[this.subRecordingIndex].recObjs.indexOf('"m":{"quiz":{"quizMsg":"stdPublish",')?virtualclass.quiz.quizStartTime={app:"Quiz",data:{masterIndex:this.masterIndex,subIndex:this.subRecordingIndex}}:virtualclass.settings.recording.trimRecordings&&
-1<this.masterRecordings[this.masterIndex][this.subRecordingIndex].recObjs.indexOf('{"ac":false,"cf":"recs"')&&virtualclass.recorder.selfSeek())}catch(a){console.log(`PLAY ERROR ${a.errorCode}`)}this.calcPlayTimeNext();this.play()},this.playTime)},isPlayFinished(){return"undefined"===typeof this.masterRecordings[this.masterIndex]&&("undefined"===typeof this.subRecordings||"undefined"===typeof this.subRecordings[this.subRecordingIndex])||"undefined"!==typeof this.subRecordings&&"undefined"!==typeof this.subRecordings[this.subRecordingIndex]&&
"J"==this.subRecordings[this.subRecordingIndex].type&&-1<this.subRecordings[this.subRecordingIndex].recObjs.indexOf('{"sEnd"')},triggerPauseVideo(){document.querySelector("#dispVideo");virtualclass.videoUl&&virtualclass.videoUl.player&&(console.log("VIDEO IS PAUSED"),virtualclass.videoUl.player.pause(),virtualclass.videoUl.isPaused=!0)},triggerPlayVideo(){"Video"==virtualclass.currApp&&virtualclass.videoUl&&virtualclass.videoUl.player&&(console.log("VIDEO IS Played"),virtualclass.videoUl.player.play(),
virtualclass.videoUl.isPaused=!1)},askAgainToPlay(){if(this.subRecordings&&0>this.subRecordings[this.subRecordingIndex].recObjs.indexOf("sEnd"))io.onRecMessage(this.convertInto({data:this.subRecordings[this.subRecordingIndex].recObjs}));virtualclass.recorder.allFileFound?virtualclass.recorder.allFileFound&&this.initReplayWindow():(virtualclass.recorder.waitServer=!0,virtualclass.recorder.waitPopup=!1,this.displayWaitPopupIfNot())},initReplayWindow(){this.triggerPauseVideo();virtualclass.popup.replayWindow();
virtualclass.popup.sendBackOtherElems();document.getElementById("replayClose").addEventListener("click",()=>{d.close()});document.getElementById("replayButton").addEventListener("click",()=>{virtualclass.recorder.controller.pause=!1;virtualclass.recorder.replayFromStart.call(virtualclass.recorder)})},getCurrentPacket(){let a=0;if(0<this.masterIndex)for(let b=0;b<this.masterIndex;b++)a+=this.masterRecordings[b].length;return a+this.subRecordingIndex},collectElapsedPlayTime(){this.elapsedPlayTime+=
...
this.subRecordingIndex=0):this.subRecordingIndex++},initController(){if(null!=document.getElementById("playControllerCont")){var a=this;const b=document.getElementsByClassName("ff");for(let c=0;c<b.length;c++)b[c].onclick=function(){var b=this.id.split("ff")[1];a.controller.fastForward(parseInt(b,10));b=document.querySelector("#dispVideo");virtualclass.videoUl&&virtualclass.videoUl.player&&b.classList.contains("vjs-paused")&&virtualclass.videoUl.player.play();"replayFromStart"!=this.parentNode.id&&
a.doControlActive(this)};a=this;const c=document.getElementById("recPause");c.addEventListener("click",()=>{c.parentNode.classList.contains("recordingPlay")?a.initRecPause():a.initRecPlay()})}},initRecPause(){const a=document.getElementById("recPause");this.controller._pause();this.doControlActive(a);virtualclass.recorder.triggerPauseVideo();a.parentNode.classList.remove("recordingPlay");a.dataset.title="Play"},initRecPlay(){const a=document.getElementById("recPause");this.controller._play();this.doControlActive(a);
virtualclass.videoUl&&virtualclass.videoUl.player&&virtualclass.videoUl.player.play();a.parentNode.classList.add("recordingPlay");a.dataset.title="Pause"},doControlActive(a){const b=document.getElementById("playControllerCont").getElementsByClassName("recButton");for(let a=0;a<b.length;a++)b[a].classList.remove("controlActive");a.parentNode.classList.add("controlActive")},controller:{pause:!1,ff:1,_play(){virtualclass.recorder.startTime=performance.now();this.ff=1;this.pause=!1;virtualclass.recorder.play();
console.log("====== Recording play")},_pause(){this.pause=!0;console.log("====== Recording pause")},fastForward(a){this.ff=a;this.pause=!1;virtualclass.recorder.play()}},sendData(a,b,c){this.cb=c;a=JSON.stringify(a);this.httpObj.open("POST",b);this.httpObj.setRequestHeader("x-api-key",wbUser.lkey);this.httpObj.setRequestHeader("x-congrea-authuser",wbUser.auth_user);this.httpObj.setRequestHeader("x-congrea-authpass",wbUser.auth_pass);this.httpObj.setRequestHeader("x-congrea-room",wbUser.room);this.httpObj.setRequestHeader("Content-Type",
"application/json");this.httpObj.withCredentials=!1;this.httpObj.send(a)},sortingFiles(a){return a.sort(function(a,c){return a<c?-1:a>c?1:0})},setOrginalListOfFiles(a){const b={};for(let c=0;c<a.length;c++)b[a[c]]=null!=a[c+1]?{index:c,next:a[c+1]}:{index:c,next:"end"};return b},triggerDownloader(){console.log("Init trigger time to request 1");this.tryNumberOfTimes=1;this.hasOwnProperty("triggerDownloaderTime")&&clearInterval(this.triggerDownloaderTime);this.hasOwnProperty("startTimeCounter")&&clearInterval(this.startTimeCounter);
let a=0;this.startTimeCounter=setInterval(()=>{a++;console.log(`=====Timer ===${a}`)},1E3);this.triggerDownloaderTime=setInterval(()=>{console.log("Init trigger time to request 2");3<this.tryNumberOfTimes?(virtualclass.recorder.allFileFound=!0,clearInterval(this.triggerDownloaderTime.triggerDownloaderTime),this.isPlayFinished()&&this.askAgainToPlay()):virtualclass.xhrn.sendData({session:this.session},virtualclass.api.recordingFiles,this.afterDownloadingList.bind(this));console.log("Time to request 180000")},
18E4)},afterDownloadingList(a){a=JSON.parse(a);if(null!=a&&a.hasOwnProperty("Item")){var b=+a.Item.time.N;this.sessionStartTime=(new Date).getTime()-b;b=[...new Set(a.Item.list.L.map(a=>a.S))];a=b.length;this.lastRecordings&&b.length==this.lastRecordings?this.tryNumberOfTimes=this.tryNumberOfTimes?++this.tryNumberOfTimes:1:(delete this.alreadyCalcTotTime,this.totalRecordingFiles=this.sortingFiles(b),this.lastFile=this.totalRecordingFiles[this.totalRecordingFiles.length-1],this.orginalListOfFiles=
this.setOrginalListOfFiles(this.totalRecordingFiles),this.calculateTotalPlayTime(),b=this.totalRecordingFiles.shift(),this.requestDataFromServer(b),0<this.totalRecordingFiles.length&&(b=this.totalRecordingFiles.shift(),this.requestDataFromServer(b)),9E5>this.sessionStartTime&&this.triggerDownloader());this.lastRecordings=a}else this.tryNumberOfTimes=this.tryNumberOfTimes?++this.tryNumberOfTimes:1,this.triggerDownloader()},requestListOfFiles(){this.session=wbUser.session;virtualclass.popup.loadingWindow();
virtualclass.xhrn.sendData({session:virtualclass.recorder.session},virtualclass.api.recordingFiles,this.afterDownloadingList.bind(this))},calculateTotalPlayTime(){const a=Math.trunc(+virtualclass.recorder.totalRecordingFiles[0].split("-")[0]/1E6),b=Math.trunc(+virtualclass.recorder.totalRecordingFiles[virtualclass.recorder.totalRecordingFiles.length-1].split("-")[1].split(".")[0]/1E6);this.lastTimeInSeconds=Math.trunc(b/1E3);this.firstTimeInSeconds=Math.trunc(a/1E3)},getTimeFromFile(a){return+a.split("-")[1].split(".")[0]/
1E9},totalPlayTime(){let a=0;for(let b=0;b<virtualclass.recorder.masterRecordings.length;b++)for(let c=0;c<virtualclass.recorder.masterRecordings[b].length;c++)a+=virtualclass.recorder.masterRecordings[b][c].playTime;return a/1E3},getTotalTimeInMilSeconds(a,b){let c=0,g=0;for(;c<=a;){for(let f=0;f<virtualclass.recorder.masterRecordings[c].length&&(g+=virtualclass.recorder.masterRecordings[c][f].playTime,a!=c||b!=f);f++);c++}return g},getTempTotalTimeInMilSeconds(a,b){let c=0,g=0;for(;c<=a;){for(let f=
0;f<this.orginalTimes[c].length&&(g+=this.orginalTimes[c][f],a!=c||b!=f);f++);c++}return g},getTotalElementLength(){let a=0;for(let b=0;b<virtualclass.recorder.masterRecordings.length;b++)a+=virtualclass.recorder.masterRecordings[b].length;return a},seekWithMouseMove(a){void 0==a.offsetX&&(a=this.getOffset(a));this.startSeek&&(this.controller._pause(),this.seekValueInPercentage=this.getSeekValueInPercentage(a),this.downloadInPercentage<this.seekValueInPercentage&&(this.seekValueInPercentage=Math.trunc(this.downloadInPercentage)),
this.setPlayProgressTime(this.seekValueInPercentage),virtualclass.pbar.renderProgressBar(this.totalTimeInMiliSeconds,6E4*this.seekTimeWithMove.m+1E3*this.seekTimeWithMove.s,"playProgressBar",void 0),document.querySelector("#tillRepTime").innerHTML=`${this.seekTimeWithMove.h}:${this.seekTimeWithMove.m}:${this.seekTimeWithMove.s}`,this.displayTimeInHover(a,this.seekValueInPercentage))},getSeekValueInPercentage(a){const b=this.getCustomWidth();return a.offsetX/b*100},handlerDisplayTime(a){const b=this.getSeekValueInPercentage(a);
this.displayTimeInHover(a,b)},displayTimeInHover(a,b){this.setPlayProgressTime(b);a=20>a.offsetX?3:5>d.innerWidth-a.offsetX?a.offsetX-65:30>d.innerWidth-a.offsetX?a.offsetX-60:40>d.innerWidth-a.offsetX?a.offsetX-35:a.offsetX-25;b=document.getElementById("timeInHover");b.style.display="block";b.style.marginLeft=`${a}px`;document.getElementById("timeInHover").innerHTML=`${this.seekTimeWithMove.h}:${this.seekTimeWithMove.m}:${this.seekTimeWithMove.s}`;document.querySelector("#virtualclassCont").classList.add("recordSeeking")},
setPlayProgressTime(a){this.seekTimeWithMove=this.convertIntoReadable(a*this.totalTimeInMiliSeconds/100)},finalSeek(a){a.offsetX||(a=this.getOffset(a));this.startSeek&&this.hasOwnProperty("seekValueInPercentage")&&(console.log(`====Seek up ${this.seekValueInPercentage}`),this.downloadInPercentage<this.seekValueInPercentage&&(this.seekValueInPercentage=Math.trunc(this.downloadInPercentage)),0<this.seekValueInPercentage&&this.seek(this.seekValueInPercentage),this.pauseBeforeSeek?(console.log("=== Video pause "),
this.controller._pause(),this.triggerPauseVideo()):(console.log("=== Video play "),this.controller._play(),this.triggerPlayVideo()),document.getElementById("timeInHover").style.display="none");document.querySelector("#virtualclassCont").classList.remove("recordSeeking");console.log(a.offsetX);delete this.seekValueInPercentage;this.startSeek=!1;a=document.getElementById("congrealogo");null!=a&&a.classList.remove("disbaleOnmousedown")}}})(window);(function(d){let c,a=!1,b=!1,f=!1;d.storage={version:7,sessionEndFlag:!1,async init(){this.reclaim=roles.isEducator();c=this;this.tables="wbData chunkData config dataAdapterAll dataUserAdapterAll executedStoreAll executedUserStoreAll dstdata pollStorage quizData dstall".split(" ");this.db=await virtualclass.virtualclassIDBOpen("vidya_apps",c.dbVersion,{upgrade(a,b,f,d){c.onupgradeneeded(a)}});"object"===typeof this.db.objectStoreNames&&null!=this.db.objectStoreNames?await this.onsuccess():this.init()},
onupgradeneeded(a){a.objectStoreNames.contains("wbData")||a.createObjectStore("wbData",{keyPath:"did"});a.objectStoreNames.contains("config")||a.createObjectStore("config",{keyPath:"timeStamp",autoIncrement:!0});a.objectStoreNames.contains("chunkData")||a.createObjectStore("chunkData",{autoIncrement:!0});a.objectStoreNames.contains("dataAdapterAll")||a.createObjectStore("dataAdapterAll",{keyPath:"serialKey"});a.objectStoreNames.contains("dataUserAdapterAll")||a.createObjectStore("dataUserAdapterAll",
...
a.createObjectStore("quizData",{keyPath:"quizkey"});a.objectStoreNames.contains("dstall")||a.createObjectStore("dstall",{keyPath:"timeStamp",autoIncrement:!0})},async onsuccess(){if(virtualclass.gObj.sessionClear)console.log("==== session clear endsession after room change"),this.config.endSession(!0);else{var a=this.tables.indexOf("wbData");-1<a?a=this.tables.slice(a+1):{tables:a}=this;await this.getAllObjs(a,a=>{if("undefined"===typeof a)c.config.createNewSession();else{const b=a.createdDate;if(108E5<
(new Date).getTime()-b||a.room!=wbUser.room)console.log("==== session clear endsession after date expire"),c.config.endSession()}})}console.log("==== Member add, config is ready")},store(a){const b=c.db.transaction("wbData","readwrite");b.store.put({repObjs:a,did:virtualclass.gObj.currWb,id:1});b.done.then(()=>{},()=>{console.log("failure")})},pollStore(a){const b=c.db.transaction("pollStorage","readwrite");b.store.add({pollResult:a,currTime:(new Date).getTime(),id:1});b.done.then(()=>{console.log("success")},
()=>{console.log("failure")})},wbDataRemove(a){console.log("Whiteboard data remove");c.db.transaction(["wbData"],"readwrite").store.delete(a)},async dataExecutedStoreAll(a,b){const f=c.db.transaction("executedStoreAll","readwrite");f.store.put({executedData:a,id:6,serialKey:b});f.done.then(()=>{console.log("success")},()=>{console.log("failure")})},dataAdapterAllStore(a,b){const f=c.db.transaction("dataAdapterAll","readwrite");f.store.put({adaptData:a,id:5,serialKey:b});f.done.then(()=>{},()=>{console.log("failure")})},
dataUserAdapterAllStore(a,b){const f=c.db.transaction("dataUserAdapterAll","readwrite");f.store.put({adaptUserData:a,id:7,serialKey:b});f.done.then(()=>{console.log("success")},()=>{console.log("failure")})},dataExecutedUserStoreAll(a,b){const f=c.db.transaction("executedUserStoreAll","readwrite");f.store.put({executedUserData:a,id:8,serialKey:b});f.done.then(()=>{console.log("success")},()=>{console.log("failure")})},quizStorage(a,b){const f=c.db.transaction("quizData","readwrite");f.store.put({qzData:b,
quizkey:a});f.done.then(()=>{console.log("success")},()=>{console.log("failure")})},async getAllObjs(a,b){b="undefined"!==typeof b?b:"";for(let c=0;c<a.length;c++){const f=await this.db.transaction(a[c]).store.openCursor();"function"===typeof b?"chunkData"!==a[c]&&"quizData"!==a[c]&&"pollStorage"!==a[c]&&await this[a[c]].handleResult(f,b):await this[a[c]].handleResult(f)}},async getAllDataOfPoll(a,b){a=[];let f=await c.db.transaction("pollStorage").store.openCursor();for(;f;)console.log(f.key,f.value),
a.push(f.value),f=await f.continue();0<a.length?b(a):console.log("No data fetched from indexedDb")},wbData:{async handleResult(a){for(;a;)a.value.hasOwnProperty("repObjs")&&("object"===typeof virtualclass.wb?(console.log(`Total Whiteboard Length ${JSON.parse(a.value.repObjs).length} From indexeddb`),virtualclass.wb[virtualclass.gObj.currWb].utility.replayFromLocalStroage(JSON.parse(a.value.repObjs))):virtualclass.gObj.tempReplayObjs._doc_0_0=JSON.parse(a.value.repObjs),f=!0),a=await a.continue();
...
JSON.parse(a.value.adaptUserData);var b=a.value.serialKey.split("_");const f=parseInt(b[0]);b=parseInt(b[1]);ioAdapter.validateAllVariables(f);b>ioAdapter.userSerial[f]&&(ioAdapter.userSerial[f]=b);ioAdapter.userAdapterMustData[f][b]=c}a=await a.continue()}}},executedStoreAll:{async handleResult(a){for(;a;){if(a.value.hasOwnProperty("executedData")){const c=JSON.parse(a.value.executedData);var b=a.value.serialKey.split("_");const f=parseInt(b[0]);b=parseInt(b[1]);ioMissingPackets.validateAllVariables(f);
ioMissingPackets.executedStore[f][b]=c}a=await a.continue()}}},executedUserStoreAll:{async handleResult(a){for(;a;){if(a.value.hasOwnProperty("executedUserData")){const c=JSON.parse(a.value.executedUserData);var b=a.value.serialKey.split("_");const f=parseInt(b[0]);b=parseInt(b[1]);ioMissingPackets.validateAllUserVariables(f);ioMissingPackets.executedUserStore[f][b]=c}a=await a.continue()}}},config:{async handleResult(a,b){if(null!=a)for(;a;){if(a){if(a.value.hasOwnProperty("myconfig")){const c=JSON.parse(a.value.myconfig);
"undefined"!==typeof b&&b(c)}a=await a.continue()}}else"undefined"!==typeof b&&b()},createNewSession(){virtualclass.makeAppReady(virtualclass.gObj.defaultApp);var a=(new Date).getTime();if("undefined"!==typeof c.db){const b=c.db.transaction(["config"],"readwrite").objectStore("config");a=JSON.stringify({createdDate:a,room:wbUser.room});b.add({myconfig:a,timeStamp:(new Date).getTime()})}else console.log("The Datbase is not created for Applicatoin.")},endSession(a){delete virtualclass.connectedUsers;
...
virtualclass.videoUl.hasOwnProperty("player")&&"object"===typeof virtualclass.videoUl.player&&null!=virtualclass.videoUl.player.player_&&virtualclass.videoUl.destroyPlayer();"undefined"!==typeof CDTimer&&clearInterval(CDTimer);b=document.querySelector(`#virtualclass${virtualclass.currApp}`);null!=b&&(b.style.display="none");virtualclass.hasOwnProperty("media")&&virtualclass.media.audio.muteButtonToogle();b=chatContainerEvent.elementFromShadowDom(".ui-memblist-usr","all");if(null!=b&&0<b.length)for(var f=
0;f<b.length;f++)null!=b[f]&&b[f].parentNode.removeChild(b[f]);virtualclass.gObj.precheckScrn&&virtualclass.vutil.prechkScrnShare();virtualclass.gObj.audioEnable=roles.hasControls()?!0:virtualclass.gObj.stdaudioEnable;virtualclass.storage.config.sessionEndFlag=!0;b=localStorage.getItem("nEd");f=localStorage.getItem("precheck");localStorage.clear();null!=virtualclass.chat&&(delete virtualclass.chat.vmstorage,virtualclass.chat.vmstorage={},virtualclass.chat.removeChatHighLight("chatrm"));virtualclass.recorder.items=
[];virtualclass.recorder.totalSent=0;virtualclass.gObj.tempReplayObjs.length=0;virtualclass.wb="";delete virtualclass.gObj.currWb;virtualclass.gObj.studentSSstatus.mesharing=!1;virtualclass.vutil.removeSharingClass();virtualclass.gObj.studentSSstatus.shareToAll=!1;virtualclass.gObj.studentSSstatus.sharing=!1;delete virtualclass.gObj.whoIsSharing;null!=virtualclass.videoHost&&(virtualclass.videoHost.gObj.stdStopSmallVid=!1,virtualclass.videoHost.gObj.allStdVideoOff=!1);virtualclass.gObj.wbTool={};
...
!1)),virtualclass.vutil.clearAllChat(),null!=virtualclass.editorRich&&virtualclass.editorRich.removeEditorData(),virtualclass.pdfRender={});virtualclass.vutil.removeClass("audioWidget","fixed");virtualclass.storage.clearStorageData();virtualclass.wbCommon.removeAllContainers();virtualclass.gObj.wbCount=0;virtualclass.gObj.currSlide=0;virtualclass.currApp=virtualclass.gObj.defaultApp;virtualclass.gObj.hasOwnProperty("disableCamByUser")?virtualclass.user.control.audioDisable():virtualclass.user.control.audioWidgetEnable(!0);
virtualclass.user.control.allChatEnable();virtualclass.user.control.resetmediaSetting();!virtualclass.gObj.meetingMode&&roles.isStudent()&&(document.getElementById("videoHostContainer").style.display="none",a=document.getElementById("virtualclassAppRightPanel"),a.classList.contains("vidShow")&&a.classList.remove("vidShow"));roles.hasAdmin()&&(document.getElementById("virtualclassSessionEndTool").className=virtualclass.vutil.removeClassFromElement("virtualclassSessionEndTool","active"));"object"===
...
!roles.isEducator(),z=virtualclass.vutil.userIsOrginalTeacher(c);virtualclass.vutil.isUserTeacher(c);for(let k=0;k<g.length;k++)if("assign"==g[k]&&z)"undefined"!==typeof q?this.createAssignControl(a,c,r,q):this.createAssignControl(a,c,r);else if("audio"==g[k]){var t=this.createControllerElement(c,"contrAud"),v=t[0],p=t[1];a.appendChild(v);v=f&&d.hasOwnProperty("aud")?!!d.aud:!0;virtualclass.user.control.changeAttribute(c,p,v,"audio","aud");z&&p.addEventListener("click",()=>{b.control.init.call(b,
p)});roles.hasAdmin()&&"false"==p.dataset.audioDisable&&(v=localStorage.getItem("allAudAction"),null!=v&&"disable"==v&&p.click())}else if("chat"==g[k]){t=this.createControllerElement(c,"contrChat");v=t[0];var u=t[1];a.appendChild(v);z&&u.addEventListener("click",()=>{b.control.init.call(b,u)});var B=f&&d.hasOwnProperty("chat")?!!d.chat:!0;virtualclass.user.control.changeAttribute(c,u,B,"chat","chat")}else if("editorRich"==g[k]||"editorCode"==g[k]){if(roles.hasAdmin()){var C=f&&d.hasOwnProperty(g[k])?
!!d[g[k]]:!1;t=this.createControllerElement(c,`contr${g[k]}`);v=t[0];t=t[1];v.className+=` controller${g[k]}`;a.appendChild(v);virtualclass.currApp!=virtualclass.vutil.capitalizeFirstLetter(g[k])&&(v.style.display="none");virtualclass.user.control.changeAttribute(c,t,C,g[k],g[k]);z&&t.addEventListener("click",b.closureEditor(b,t))}}else"RaiseHand"==g[k]&&(f&&d.hasOwnProperty("raiseHand"),virtualclass.user.control.changeAttribute(c,u,B,"RaiseHand","RaiseHand"))},closureEditor(a,c){return function(){a.control.init.call(a,
...
null!=a&&a.parentNode.removeChild(a)},disable(a,c,g,d){g=virtualclass.gObj.testChatDiv.shadowRoot.querySelector(`.${c}Control${a} `+" .contImg");null!=g&&virtualclass.user.control._disable(g,c,a,d)},_disable(a,c,d,k){a.parentNode.setAttribute("data-title",virtualclass.lang.getString(`${c}Disable`));a.setAttribute(`data-${c}-disable`,"true");a.className=`icon-${c}Img block`+` ${c}Img`;"assign"==c?(a.parentNode.classList.remove("tooltip"),this.addCurrTeacherToControl(a.id),a=localStorage.getItem(`virtualclass${d}`),
a=JSON.parse(a),virtualclass.gObj.hasOwnProperty(`${d}currTeacher`)?(virtualclass.gObj[`${d}currTeacher`].ct||virtualclass.gObj.hasOwnProperty("controlAssign")&&virtualclass.gObj.controlAssign&&a.currTeacher)&&virtualclass.user.control.updateUser(d,"currTeacher",!0):virtualclass.gObj.hasOwnProperty("controlAssign")&&virtualclass.gObj.controlAssignId==d&&virtualclass.user.control.updateUser(d,"currTeacher",!0)):"audio"==c&&(a.className=`icon-${c}DisImg block`+` ${c}DisImg`);virtualclass.user.control.updateUser(d,
k,!1)},enable(a,c,d,k){d=virtualclass.gObj.testChatDiv.shadowRoot.querySelector(`.${c}Control${a} .contImg`);null==d?console.log("Element is Null"):virtualclass.user.control._enable(d,c,a,k)},_enable(a,c,d,k){a.parentNode.setAttribute("data-title",virtualclass.lang.getString(`${c}Enable`));a.setAttribute(`data-${c}-disable`,"false");a.className=`icon-${c}Img enable`+` ${c}Img`;"RaiseHand"==c&&virtualclass.raiseHand._raiseHand(d);virtualclass.user.control.updateUser(d,k,!0)},changeAttribute(a,c,d,
k,m){d?virtualclass.user.control._enable(c,k,a,m):virtualclass.user.control._disable(c,k,a,m)},init(a,c,d,k){"undefined"===typeof d&&(d="Img");var b=a.id,f=b.indexOf("contr");f=b.substring(0,f);b=b.split("contr")[1];d=b.indexOf(d);d=b.substring(0,d);if("Assign"==d)virtualclass.vutil.appIsForEducator(virtualclass.currApp)&&(virtualclass.gObj.controlAssign=!0,virtualclass.gObj.controlAssignId=f,k="true"==a.getAttribute("data-assign-disable"),k||(this.control.changeAttribute(f,a,k,"assign","aRole"),
virtualclass.user.control._assign(f),virtualclass.user.control.changeAttrToAssign("block")),roles.hasAdmin()||virtualclass.user.control.removeAudioFromParticipate(f));else{let g;"stdscreen"==d?(roles.hasControls()&&"virtualclassScreenShare"==virtualclass.previous&&virtualclass.vutil.initDefaultApp(),this.control._stdscreen.call(this.control,f),"Video"==virtualclass.currApp&&virtualclass.videoUl.player&&(ioAdapter.mustSend({videoUl:{init:"destroyPlayer"},cf:"destroyPlayer"}),ioAdapter.mustSend({videoUl:{init:"studentlayout"},
cf:"videoUl"}),virtualclass.vutil.initDashboard(),virtualclass.vutil.removeBackgroundVideoApp())):("Chat"==d?(a.className="contrChatBlock",b="chat"):b="Aud"==d?"audio":d,"undefined"!==typeof c?c=(g="enable"==c)?"enable":"block":"true"==a.getAttribute(`data-${b}-disable`)?(c="enable",g=!0):(c="block",g=!1),this.control.changeAttribute(f,a,g,b,virtualclass.vutil.smallizeFirstLetter(d)),void 0==k&&this.control[`_${b}`].call(this.control,f,c))}},init_old(a){var b=a.id,c=b.indexOf("contr");c=b.substring(0,
...
virtualclass.vutil.beforeSend({assignRole:!0,toUser:a,cf:"assignRole"},a),roles.hasAdmin()&&(f=c.getElementById(`${a}contreditorRichImg`),"true"==f.dataset.editorrichDisable&&virtualclass.user.control.init.call(virtualclass.user,f),f=c.getElementById(`${a}contreditorCodeImg`),"true"==f.dataset.editorcodeDisable&&virtualclass.user.control.init.call(virtualclass.user,f)));roles.hasAdmin()||("undefined"===typeof d&&(d=a),a=c.getElementById(`${d}ControlContainer`).getElementsByClassName("controleCont")[0],
a.removeChild(a.firstChild),localStorage.removeItem("aId"))},_chat(a,c){"enable"==c?virtualclass.vutil.beforeSend({enc:!0,toUser:a,cf:"enc"},a):(virtualclass.user.control.updateUser(a,"chat",!1),virtualclass.vutil.beforeSend({dic:!0,toUser:a,cf:"dic"},a))},_audioAll(a,c){"enable"==c?virtualclass.vutil.beforeSend({ena:!0,toUser:a,cf:"ena"},a):virtualclass.vutil.beforeSend({dia:!0,toUser:a,cf:"dia"},a)},_editorRich(a,c){"enable"==c?virtualclass.vutil.beforeSend({status:!0,control:"editorRich",toUser:a,
cf:"control"},a):virtualclass.vutil.beforeSend({status:!1,control:"editorRich",toUser:a,cf:"control"},a)},_editorCode(a,c){"enable"==c?virtualclass.vutil.beforeSend({status:!0,control:"editorCode",toUser:a,cf:"control"},a):virtualclass.vutil.beforeSend({status:!1,control:"editorCode",toUser:a,cf:"control"},a)},_audio(a,c){"enable"==c?virtualclass.settings.applySettings(!0,"disableAttendeeAudio",a):virtualclass.settings.applySettings(!1,"disableAttendeeAudio",a)},_RaiseHand(a,c){virtualclass.raiseHand.disableRaiseHand(a)},
_stdscreen(a){virtualclass.vutil.beforeSend({reqscreen:!0,toUser:a,cf:"reqscreen"},a)},audioWidgetEnable(a){console.log("Audio enable true");localStorage.setItem("audEnable",JSON.stringify({ac:"true"}));if(null==localStorage.getItem("dvid")){const b=c.getElementById("speakerPressOnce");"undefined"===typeof a&&(b.className="active");b.style.opacity="1";b.style.pointerEvents="visible"}},mediaWidgetDisable(a){virtualclass.system.mediaDevices.hasWebcam=!1;const b={ac:"false"};let d=localStorage.getItem("audEnable");
null!=d?(d=JSON.parse(d),"false"!=d.ac&&"undefined"!==typeof a&&(b.r=a)):"unefined"!==typeof a&&(b.r=a);console.log(`audEnable ${b}`);a=c.getElementById("audioWidget");a.style.opacity="1";a.style.pointerEvents="visible";a.className="deactive";this.audioDisable();this.videoDisable();virtualclass.gObj.hasOwnProperty("video")&&(virtualclass.media.audio.studentNotSpeak(),virtualclass.media.audio.clickOnceSpeaker("speakerPressOnce","alwaysDisable"));virtualclass.vutil.addClass("virtualclassCont","nowebcam")},
audioDisable(){const a=c.getElementById("speakerPressOnce");null!=a&&(a.style.opacity="0.5",a.style.pointerEvents="none")},videoDisable(){const a=c.getElementById("congCtrBar");null!=a&&(a.style.opacity="0.5",a.style.pointerEvents="none")},videoEnable(){const a=c.getElementById("congCtrBar");null!=a&&(a.style.opacity="1",a.style.pointerEvents="visible")},allChatDisable(){this.disableCommonChat();this.disbaleAllChatBox();this.disableOnLineUser()},disableCommonChat(){var a=c.getElementById("chatrm");
null!=a&&this.makeElemDisable(a);if(a=c.querySelector("#virtualclassCont.congrea #ta_chrm2"))a.classList.add("disable"),a.disabled=!0},disbaleAllChatBox(){localStorage.setItem("chatEnable","false");var a=c.querySelector("#virtualclassAppRightPanel");a.classList.add("chat_disabled");c.querySelector("#chat_div").classList.add("chat_disabled");a.classList.remove("chat_enabled");a=c.getElementById("stickybar").getElementsByClassName("ui-chatbox");for(let b=0;b<a.length;b++)this.makeElemDisable(a[b])},
disableOnLineUser(){const a=c.getElementsByClassName("ui-memblist-usr");for(let b=0;b<a.length;b++)a[b].style.pointerEvents="none"},makeElemDisable(a){"chatrm"!=a.id&&(virtualclass.vutil.elemHasAnyClass(a.id)?(a.classList.remove("enable"),a.classList.add("disable")):a.className="disable");a=a.getElementsByClassName("ui-chatbox-input-box")[0];null!=a&&(a.disabled=!0)},allChatEnable(){localStorage.setItem("chatEnable","true");var a=c.querySelector("#virtualclassAppRightPanel");a.classList.remove("chat_disabled");
c.querySelector("#chat_div").classList.remove("chat_disabled");a.classList.add("chat_enabled");if(a=c.querySelector("#virtualclassCont.congrea #ta_chrm2"))a.classList.remove("disable"),a.disabled=!1;a=c.getElementById("stickycontainer").getElementsByClassName("ui-chatbox");for(var f=0;f<a.length;f++)this.makeElemEnable(a[f]);var d=c.getElementsByClassName("ui-memblist-usr");for(f=0;f<d.length;f++){d[f].classList.contains("mySelf")||(d[f].style.pointerEvents="visible");var k=d[f].querySelector(".icon-chatImg");
k&&!k.classList.contains("enable")&&(k.classList.add("enable"),k.setAttribute("data-chat-disable","false"));(k=d[f].querySelector(".icon-editorRichImg"))&&k.classList.contains("enable")&&(k.classList.remove("enable"),k.classList.add("block"),k.parentNode.setAttribute("data-title",virtualclass.lang.getString("writemode")),k.setAttribute("data-editorrich-disable","true"));(k=d[f].querySelector(".icon-editorCodeImg"))&&k.classList.contains("enable")&&(k.classList.remove("enable"),k.classList.add("block"),
k.parentNode.setAttribute("data-title",virtualclass.lang.getString("editorCodeDisable")),k.setAttribute("data-editorcode-disable","true"));(k=d[f].querySelector(".icon-audioDisImg"))&&k.classList.contains("block")&&(k.parentNode.setAttribute("data-title",virtualclass.lang.getString("audioEnable")),k.setAttribute("data-audio-disable","false"))}f=c.querySelector("#virtualclassCont #memlist.enable");d=c.querySelector("#virtualclassCont #chatrm.enable");k=c.querySelector("#user_list");const m=c.querySelector("#chatroom_bt2");
f&&!k.classList.contains("active")&&(k.classList.contains("active")||k.classList.add("active"),m.classList.remove("active"),virtualclass.chat.chatWindow="private");d&&(m.classList.contains("active")||m.classList.add("active"),k.classList.remove("active"),virtualclass.chat.chatWindow="common");c.getElementsByClassName("ui-memblist-usr");for(f=0;f<a.length;f++)this.makeElemEnable(a[f])},resetmediaSetting(){if(roles.isStudent()){if(virtualclass.gObj.stdaudioEnable||virtualclass.user.control.audioDisable(),
virtualclass.system.mediaDevices.hasWebcam)if(virtualclass.gObj.stdvideoEnable)virtualclass.vutil.videoHandler("off"),virtualclass.videoHost.toggleVideoMsg("enable");else{virtualclass.videoHost.toggleVideoMsg("disable");var a=c.querySelector("#videoSwitch");null!=a&&a.classList.contains("on")&&(a.classList.remove("on"),a.classList.add("off"))}}else{(a=c.getElementById("contrAudioAllImg"))&&a.classList.contains("icon-all-audio-enable")&&(a.classList.remove("icon-all-audio-enable"),a.classList.add("icon-all-audio-disable"),
a.setAttribute("data-title",virtualclass.lang.getString("muteAll")),"enable"==a.dataset.action&&(a.dataset.action="disable"));a=c.getElementById("videoSwitch");if(virtualclass.system.mediaDevices.hasWebcam&&a.classList.contains("video")){const b=c.getElementById("rightCtlr");a.classList.contains("on")&&(virtualclass.vutil.videoHandler("off"),b.parentNode.setAttribute("data-title",virtualclass.lang.getString("videoon")))}this.mediaSliderSetting("audio");this.mediaSliderSetting("video")}roles.hasAdmin()&&
(virtualclass.gObj.delayVid="display")},mediaSliderSetting(a){const b="audio"==a?"Audio":"Video",d={action:("audio"==a?virtualclass.gObj.stdaudioEnable:virtualclass.gObj.stdvideoEnable)?"enable":"disable",enable:"disable",disable:"enable"};var k=c.querySelector(`.congrea #contr${b}All.${d.action}`);k&&(k.classList.remove(d.action),k.classList.add(d[d.action]),(k=c.querySelector(`.congrea #contr${b}All input`))&&k.removeAttribute("checked"));if(k=c.querySelector(`.congrea .slider.icon-all-${a}-${d.action}`))k.className=
`slider round congtooltip icon-all-${a}-${d[d.action]}`,k.setAttribute("data-action",d[d.action]),k.setAttribute("data-title",virtualclass.lang.getString(`${d[d.action]}All${b}`))},makeElemEnable(a){virtualclass.vutil.elemHasAnyClass(a.id)?(a.classList.remove("disable"),a.classList.add("enable")):a.className="enable";a=a.getElementsByClassName("ui-chatbox-input-box")[0];null!=a&&(a.disabled=!1)},toggleAllEditorController(a,c){a=virtualclass.vutil.smallizeFirstLetter(a);const b=chatContainerEvent.elementFromShadowDom(".controleCont",
"all");if(0<b.length)for(let d=0;d<b.length;d++)if(0<b[d].id.indexOf(a)){var f=b[d].id.indexOf("Cont");0<f&&(f=b[d].id.substr(0,f),f=chatContainerEvent.elementFromShadowDom(`${f}Img`,null,!0),this.control.init.call(this,f,c,void 0,"actnotSend"))}"enable"==c?virtualclass.vutil.beforeSend({status:!0,control:"editorRich",cf:"control"}):virtualclass.vutil.beforeSend({status:!1,control:"editorRich",cf:"control"})},toggleDisplayEditorController(a,c){a=virtualclass.vutil.smallizeFirstLetter(a);if(virtualclass.gObj.hasOwnProperty("testChatDiv")){a=
chatContainerEvent.elementFromShadowDom(`.controller${a}`,"all");for(let b=0;b<a.length;b++)a[b].style.display=c}},updateUser(a,c,d){const b=localStorage.getItem(`virtualclass${a}`);let f={};null==b?f.id=a:f=JSON.parse(b);f[c]=d;localStorage[`virtualclass${f.id}`]=JSON.stringify(f);return f},audioSign2(a,f){if("create"==f){if(null==c.getElementById(`${a.id}AudEnableSign`)){f=c.createElement("div");f.id=`${a.id}AudEnableSign`;const b=c.createElement("img");imgName="audioenable";b.id=`${a.id+imgName}Img`;
b.src=`${d.whiteboardPath}images/${imgName}.png`;const k=c.createElement("a");k.id=`${a.id+imgName}Anch`;k.className="audEnableSign tooltip controleCont";k.setAttribute("data-title",virtualclass.lang.getString("studentAudEnable"));k.appendChild(b);f.appendChild(k);c.getElementById(`${a.id}ControlContainer`).appendChild(f)}}else a=c.getElementById(`${a.id}AudEnableSign`),a.parentNode.removeChild(a)},audioSign(a,c){"create"==c?this.iconAttrManupulate(a.id,"icon-audioEnaGreen"):a.aud?this.iconAttrManupulate(a.id,
"icon-audioImg"):this.iconAttrManupulate(a.id,"icon-audioDisImg")},iconAttrManupulate(a,c){a=virtualclass.gObj.testChatDiv.shadowRoot.querySelector(`#ml${a} .audioImg`);if(null!=a)for(let b=0;b<a.classList.length;b++)if("icon-"==a.classList[b].substring(0,5)){a.classList.remove(a.classList[b]);a.classList.add(c);break}},shouldApply(a){let b=localStorage.getItem(`virtualclass${a}`);null!=b&&(b=JSON.parse(b),b.ad&&virtualclass.user.control.audioSign({id:a},"create"))},changeAttrToAssign(a){const b=
c.getElementById("chatWidget").getElementsByClassName("assignImg");for(let c=0;c<b.length;c++)"enable"==a?(b[c].classList.remove("block"),b[c].classList.add("enable"),b[c].parentNode.classList.add("tooltip"),b[c].parentNode.setAttribute("data-title",virtualclass.lang.getString("transferControls")),b[c].setAttribute("data-assign-disable","false")):(b[c].classList.remove("enable"),b[c].classList.add("block"),b[c].parentNode.classList.remove("tooltip"),b[c].setAttribute("data-assign-disable","true"))}},
displayStudentSpeaker(a){const b=c.getElementById("alwaysPress");null!=b&&(b.style.display=a?"block":"none")},toggleAllAudio(a){const b=chatContainerEvent.elementFromShadowDom(".controleCont","all");if(0<b.length)for(let f=0;f<b.length;f++)if(0<b[f].id.indexOf("Aud")){var c=b[f].id.indexOf("Cont");0<c&&(c=b[f].id.substr(0,c),c=chatContainerEvent.elementFromShadowDom(`${c}Img`,null,!0),this.control.init.call(this,c,a,void 0,"actnotSend"))}},toggleAllVideo(a){ioAdapter.mustSend({action:a,cf:"toggleVideo"})},
mediaSliderUI(a){var b="audio"==a?"Audio":"Video",d=c.querySelector(`.bulkUserActions #contr${b}AllImg`),k=virtualclass.user.defaultSettings(a,virtualclass.settings.info),m="enable"==k?"disable":"enable";null!=k?(d.setAttribute("data-action",m),d.className=`slider round icon-all-${a}-${m} enable congtooltip cgIcon`,d.dataset.title=virtualclass.lang.getString(`${m}All${b}`),k=c.querySelector(`.bulkUserActions #contr${b}All input`),k.setAttribute("checked","true"),b=c.querySelector(`.congrea #contr${b}All`),
b.classList.add(m)):(m={action:k?"enable":"disable",enable:"disable",disable:"enable"},d=c.querySelector(`.bulkUserActions #contr${b}AllImg`),d.setAttribute("data-action",m[m.action]),d.className=`slider round icon-all-${a}-${m[m.action]} congtooltip cgIcon`,d.dataset.title=virtualclass.lang.getString(`${m[m.action]}All${b}`),k=c.querySelector(`.bulkUserActions #contr${b}All input`),k.removeAttribute("checked"),b=c.querySelector(`.congrea #contr${b}All`),b.classList.add(m[m.action]));if(virtualclass.isPlayMode)anchorTag.pointerEvents=
"none",anchorTag.style.cursor="default";else{const b=this;d.addEventListener("click",()=>{if("audio"==a){var c=b.toogleAudioIcon();virtualclass.settings.applySettings("enable"==c,"disableAttendeeAudio");"undefined"!==typeof c&&(localStorage.setItem("allAudAction",c),b.toggleAllAudio.call(virtualclass.user,c))}else c=b.toggleVideoIcon(),virtualclass.settings.applySettings("enable"==c,"disableAttendeeVideo"),"undefined"!==typeof c&&(localStorage.setItem("allVideoAction",c),b.toggleAllVideo(c))})}},
defaultSettings(a,c){let b,f;for(const d in c)if(f=c[d],"audio"===a&&"disableAttendeeAudio"===d||"video"===a&&"disableAttendeeVideo"===d)b=!0===f?"enable":"disable";return b},chatBoxesSwitch(){if(virtualclass.chat.chatroombox)toggleCommonChatBox();else if(0==$("div#chat_room").length){var a=c.createElement("ul");a.id="chat_room";c.body.appendChild(a);virtualclass.chat.chatroombox=$("#chat_room").chatroom({id:"chat_room",user:{name:"test"},title:lang.chatroom_header,offset:"20px",messageSent(a,b){$("#chat_room").chatroom("option",
"boxManager").addMsg(a.name,b)}});virtualclass.gObj.hasOwnProperty("chatEnable")&&!virtualclass.gObj.chatEnable&&(a=c.getElementById("chatrm"),null!=a&&virtualclass.user.control.makeElemDisable(a));a=c.getElementById("cc_arrow_button");a.classList.add("icon-arrow-down");a.classList.remove("icon-arrow-up")}},toogleAudioIcon(){var a=c.querySelector(".bulkUserActions #contrAudioAllImg");if(null!=a)return actionToPerform=a.dataset.action,"enable"==a.dataset.action?(a.dataset.action="disable",a.className=
"slider round icon-all-audio-disable congtooltip",a.dataset.title=virtualclass.lang.getString("muteAll"),a=c.querySelector(".congrea .bulkUserActions #contrAudioAll"),a.classList.add("disable"),a.classList.remove("enable")):(a.dataset.action="enable",a.className="slider round icon-all-audio-enable congtooltip",a.dataset.title=virtualclass.lang.getString("unmuteAll"),a=c.querySelector(".congrea .bulkUserActions #contrAudioAll"),a.classList.add("enable"),a.classList.remove("disable")),actionToPerform},
toggleVideoIcon(){var a=c.querySelector(".bulkUserActions #contrVideoAllImg");if(null!=a)return actionToPerform=a.dataset.action,"enable"==a.dataset.action?(a.dataset.action="disable",a.className="slider round icon-all-video-disable congtooltip",a.dataset.title=virtualclass.lang.getString("disableAllVideo"),a=c.querySelector(".congrea .bulkUserActions #contrVideoAll"),a.classList.add("disable"),a.classList.remove("enable")):(a.dataset.action="enable",a.className="slider round icon-all-video-enable congtooltip",
a.dataset.title=virtualclass.lang.getString("enableAllVideo"),a=c.querySelector(".congrea .bulkUserActions #contrVideoAll"),a.classList.add("enable"),a.classList.remove("disable")),actionToPerform},changeRoleOnFooter(a,c){chatContainerEvent.elementFromShadowDom(`#ml${a}`).dataset.role=c},initControlHandler(a){virtualclass.vutil.userIsOrginalTeacher(a);const b=chatContainerEvent.elementFromShadowDom(`#ml${a} .contImg`,"all");let d=!1,k=localStorage.getItem(`virtualclass${a}`);null!=k&&(d=!0,k=JSON.parse(k),
k.hasOwnProperty("currTeacher")&&(virtualclass.gObj[`${a}currTeacher`]={},1==k.currTeacher?(virtualclass.user.control.currTeacherAlready=!0,virtualclass.gObj[`${a}currTeacher`].ct=!0):virtualclass.gObj[`${a}currTeacher`].ct=!1));for(let f=0;f<b.length;f++)if(-1<b[f].className.indexOf("chat")){var m=d&&k.hasOwnProperty("chat")?!!k.chat:!0;virtualclass.user.control.changeAttribute(a,b[f],m,"chat","chat")}else-1<b[f].className.indexOf("aud")?(d&&k.hasOwnProperty("aud")?m=!!k.aud:(m=c.querySelector("#contrAudioAll"),
m=null!=virtualclass.jId&&m.classList.contains("disable")?!0:virtualclass.gObj.stdaudioEnable),virtualclass.user.control.changeAttribute(a,b[f],m,"audio","aud"),roles.hasAdmin()&&"false"==b[f].dataset.audioDisable&&localStorage.getItem("allAudAction")):-1<b[f].className.indexOf("RaiseHand")?(m=d&&k.hasOwnProperty("raiseHand")?!!k.raiseHand:!1,virtualclass.user.control.changeAttribute(a,b[f],m,"RaiseHand","RaiseHand")):-1<b[f].className.indexOf("stdscreen")?virtualclass.gObj.studentSSstatus.hasOwnProperty("whoIsSharing")&&
virtualclass.vutil.initssSharing(virtualclass.gObj.whoIsSharing):-1<b[f].className.indexOf("editorRich")&&"EditorRich"==virtualclass.currApp?(c.querySelector("#alleditorRichContainerAnch"),m=d&&k.hasOwnProperty("editorRich")?!!k.editorRich:!1,virtualclass.user.control.changeAttribute(a,b[f],m,"editorRich","editorRich")):-1<b[f].className.indexOf("editorCode")&&(m=d&&k.hasOwnProperty("editorCode")?!!k.editorCode:!1,virtualclass.user.control.changeAttribute(a,b[f],m,"editorCode","editorCode"))}}}})(window,
document);(function(d){d.xhr={init(){this.httpObj=d.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");this.httpObj.upload.addEventListener("progress",this.onProgress);this.onReadStateChange();this.httpObj.onerror=function(c){console.log(`Error ${c}`)};this.httpObj.withCredentials=!0;this.httpObj.onabort=function(c){console.log(`Error abort ${c}`)}},onProgress(c){virtualclass.pbar.currVal=c.loaded;""!=virtualclass.pbar.prvVal&&"undefined"!==typeof virtualclass.pbar.prvVal||virtualclass.isPlayMode||
virtualclass.pbar.progressInit();virtualclass.pbar.renderProgressBar(c.total,c.loaded,"indProgressBar","indProgressValue")},onReadStateChange(){const c=this;this.httpObj.onreadystatechange=function(){4==c.httpObj.readyState&&"undefined"!==typeof c.cb&&(200==c.httpObj.status?c.cb(c.httpObj.responseText):c.cb("ERROR"))}},send(c,a,b){this.cb=b;this.httpObj.open("POST",a,!0);this.httpObj.send(c)},sendFormData(c,a,b){this.cb=b;this.httpObj.open("POST",a,!0);this.httpObj.send(c)},loadData(c,a){this.cb=
a;this.httpObj.open("GET",c,!0);this.httpObj.send()}}})(window);(function(d){d.xhrn={init(){this.httpObj=d.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");this.httpObj.upload.addEventListener("progress",this.onProgress);this.onReadStateChange();this.httpObj.onerror=function(c){console.log(`Error ${c}`)};this.httpObj.onabort=function(c){console.log(`Error abort ${c}`)}},onReadStateChange(){const c=this;this.httpObj.onreadystatechange=function(){4==c.httpObj.readyState&&"undefined"!==typeof c.cb&&(200==c.httpObj.status?c.cb(c.httpObj.responseText):
c.cb("ERROR"))}},sendData(c,a,b){this.cb=b;c=JSON.stringify(c);this.httpObj.open("POST",a);this.httpObj.setRequestHeader("x-api-key",wbUser.lkey);this.httpObj.setRequestHeader("x-congrea-authuser",wbUser.auth_user);this.httpObj.setRequestHeader("x-congrea-authpass",wbUser.auth_pass);this.httpObj.setRequestHeader("x-congrea-room",wbUser.room);this.httpObj.setRequestHeader("Content-Type","application/json");this.httpObj.withCredentials=!1;this.httpObj.send(c)},getAcess(c){this.cb=c;this.httpObj.open("GET",
virtualclass.api.access);this.httpObj.setRequestHeader("x-api-key",wbUser.lkey);this.httpObj.setRequestHeader("x-congrea-authuser",wbUser.auth_user);this.httpObj.setRequestHeader("x-congrea-authpass",wbUser.auth_pass);this.httpObj.setRequestHeader("x-congrea-room",wbUser.room);this.httpObj.setRequestHeader("Content-Type","application/json");this.httpObj.withCredentials=!0;this.httpObj.send()}}})(window);const PopUp=function(d,c){function a(a){this.init(a);return this}function b(a,b){const c={};let f;for(f in a)Object.prototype.hasOwnProperty.call(a,f)&&(c[f]=a[f]);for(f in b)Object.prototype.hasOwnProperty.call(b,f)&&(c[f]=b[f]);return c}function f(a){const b=document.createElement("div");b.classList.add("rv-vanilla-modal-overlay");document.querySelector("body").appendChild(b);"function"===typeof a&&a()}"use strict";a.prototype.init=function(a){const c=this;this.settings=b({selector:"[data-rv-vanilla-modal]",
...
0;f<a.length;f++){const d=c.elt("div");d.className="vceditor-color-dropdown-item";d.setAttribute("style",`background-color:${a[f]}`);b.push({content:d,value:a[f]})}return this.makeDropdown_("Color","color",b)};b.prototype.makeDropdown_=function(a,b,f,d){function g(){v&&(n.style.display="",c.off(document,"click",g,!0),v=!1);p=!0;setTimeout(()=>{p=!1},0)}function k(a,f){"object"!==typeof a&&(a=document.createTextNode(String(a)));a=c.elt("a",[a]);c.on(a,"click",c.stopEventAnd(()=>{g();m.trigger(b,f+
d)}));n.appendChild(a)}d=d||"";const m=this;a=c.elt("a",`${a} \u25be`,{class:"vceditor-btn vceditor-dropdown"});const n=c.elt("ul",[],{class:"vceditor-dropdown-menu"});a.appendChild(n);let v=!1,p=!1;for(let a=0;a<f.length;a++){const {content:b}=f[a],{value:c}=f[a];k(b,c)}c.on(a,"click",c.stopEventAnd(()=>{p||v||(n.style.display="block",c.on(document,"click",g,!0),v=!0)}));return a};return b}();d.RichTextToolbar=c})(window);(function(d){const c=function(){function a(a,c,d){this.type=a;this.attributes=this.text=this.chars=null;"insert"===a?(this.text=c,b.assert("string"===typeof this.text),this.attributes=d||{},b.assert("object"===typeof this.attributes)):"delete"===a?(this.chars=c,b.assert("number"===typeof this.chars)):"retain"===a&&(this.chars=c,b.assert("number"===typeof this.chars),this.attributes=d||{},b.assert("object"===typeof this.attributes))}const {utils:b}=d;a.prototype.isInsert=function(){return"insert"===
...
c||[];if(a.length!==this.baseLength)throw Error("The operation's base length must be equal to the string's length.");const f=[];let d=0,g,m,n=0;const {ops:q}=this;for(let p=0,r=q.length;p<r;p++){const r=q[p];if(r.isRetain()){if(n+r.chars>a.length)throw Error("Operation can't retain more characters than are left in the string.");f[d++]=a.slice(n,n+r.chars);for(g=0;g<r.chars;g++){var B=b[n+g]||{};const a={};for(m in B)a[m]=B[m],k.assert(!1!==a[m]);for(m in r.attributes)!1===r.attributes[m]?delete a[m]:
a[m]=r.attributes[m],k.assert(!1!==a[m]);c.push(a)}n+=r.chars}else if(r.isInsert())for(f[d++]=r.text,g=0;g<r.text.length;g++){B={};for(m in r.attributes)B[m]=r.attributes[m],k.assert(!1!==B[m]);c.push(B)}else n+=r.chars}if(n!==a.length)throw Error("The operation didn't operate on the whole string.");a=f.join("");k.assert(a.length===c.length);return a};a.prototype.invert=function(b){let c=0;const f=new a,{ops:d}=this;for(let a=0,g=d.length;a<g;a++){const g=d[a];g.isRetain()?(f.retain(g.chars),c+=g.chars):
g.isInsert()?f.delete(g.text.length):(f.insert(b.slice(c,c+g.chars)),c+=g.chars)}return f};a.prototype.compose=function(b){function c(a,b,c){const f={};let d;for(d in a)f[d]=a[d];for(d in b)c&&!1===b[d]?delete f[d]:f[d]=b[d];return f}if(this.targetLength!==b.baseLength)throw Error("The base length of the second operation has to be the target length of the first operation");const f=new a,d=this.clone().ops;b=b.clone().ops;let g=0,k=0,m=d[g++],p=b[k++],u;for(;"undefined"!==typeof m||"undefined"!==typeof p;)if(m&&
m.isDelete())f.delete(m.chars),m=d[g++];else if(p&&p.isInsert())f.insert(p.text,p.attributes),p=b[k++];else{if("undefined"===typeof m)throw Error("Cannot compose operations: first operation is too short.");if("undefined"===typeof p)throw Error("Cannot compose operations: first operation is too long.");if(m.isRetain()&&p.isRetain())u=c(m.attributes,p.attributes),m.chars>p.chars?(f.retain(p.chars,u),m.chars-=p.chars,p=b[k++]):m.chars===p.chars?(f.retain(m.chars,u),m=d[g++],p=b[k++]):(f.retain(m.chars,
u),p.chars-=m.chars,m=d[g++]);else if(m.isInsert()&&p.isDelete())m.text.length>p.chars?(m.text=m.text.slice(p.chars),p=b[k++]):m.text.length===p.chars?(m=d[g++],p=b[k++]):(p.chars-=m.text.length,m=d[g++]);else if(m.isInsert()&&p.isRetain())u=c(m.attributes,p.attributes,!0),m.text.length>p.chars?(f.insert(m.text.slice(0,p.chars),u),m.text=m.text.slice(p.chars),p=b[k++]):m.text.length===p.chars?(f.insert(m.text,u),m=d[g++],p=b[k++]):(f.insert(m.text,u),p.chars-=m.text.length,m=d[g++]);else if(m.isRetain()&&
...
if("undefined"===typeof n)throw Error("Cannot transform operations: first operation is too long.");if(m.isRetain()&&n.isRetain()){const q=a.transformAttributes(m.attributes,n.attributes);if(m.chars>n.chars){var u=n.chars;m.chars-=n.chars;n=c[k++]}else m.chars===n.chars?(u=n.chars,m=b[g++],n=c[k++]):(u=m.chars,n.chars-=m.chars,m=b[g++]);f.retain(u,q[0]);d.retain(u,q[1])}else if(m.isDelete()&&n.isDelete())m.chars>n.chars?(m.chars-=n.chars,n=c[k++]):m.chars===n.chars?(m=b[g++],n=c[k++]):(n.chars-=m.chars,
m=b[g++]);else if(m.isDelete()&&n.isRetain())m.chars>n.chars?(u=n.chars,m.chars-=n.chars,n=c[k++]):m.chars===n.chars?(u=n.chars,m=b[g++],n=c[k++]):(u=m.chars,n.chars-=m.chars,m=b[g++]),f.delete(u);else if(m.isRetain()&&n.isDelete())m.chars>n.chars?(u=n.chars,m.chars-=n.chars,n=c[k++]):m.chars===n.chars?(u=m.chars,m=b[g++],n=c[k++]):(u=m.chars,n.chars-=m.chars,m=b[g++]),d.delete(u);else throw Error("The two operations aren't compatible");}return[f,d]};return a}();d.TextOperation=c})(window);(function(d){const c=function(a){function b(a,b){this.wrapped=a;this.meta=b}function c(a,b){for(const c in a)a.hasOwnProperty(c)&&(b[c]=a[c])}function d(a,b){return a&&"object"===typeof a&&"function"===typeof a.transform?a.transform(b):a}b.prototype.apply=function(){return this.wrapped.apply.apply(this.wrapped,arguments)};b.prototype.invert=function(){const {meta:a}=this;return new b(this.wrapped.invert.apply(this.wrapped,arguments),a&&"object"===typeof a&&"function"===typeof a.invert?a.invert.apply(a,
...
this.undoManager.transform(new v(a,null))};m.prototype.emitStatus=function(){const a=this;setTimeout(()=>{a.trigger("synced",a.state instanceof q.Synchronized)},0)};return m}();d.EditorClient=f})(window);(function(d){const c=function(){function a(a,c){this.pos=a;this.length=c}a.prototype.end=function(){return this.pos+this.length};return a}();d.Span=c})(window);(function(d){const c=function(){function a(a,b){if(!a)throw Error(`AnnotationList assertion failed${b?`: ${b}`:""}`);}function b(a,b){this.pos=a;this.length=b.length;this.annotation=b.annotation;this.attachedObject_=b.attachedObject}function c(a,b){this.pos=a;this.length=b.length;this.annotation=b.annotation;this.node_=b}function g(a){this.head_=new k(0,n);this.changeHandler_=a}function k(a,b){this.length=a;this.annotation=b;this.next=this.attachedObject=null}const {Span:m}=d;b.prototype.getAttachedObject=
...
function(a){return this.cloneWithNewAttribute_(b.LINE_ALIGN,a)};a.prototype.listItem=function(a){vceditor.utils.assert(!1===a||"u"===a||"o"===a||"t"===a||"tc"===a);return this.cloneWithNewAttribute_(b.LIST_TYPE,a)};a.prototype.getIndent=function(){return this.attributes[b.LINE_INDENT]||0};a.prototype.getAlign=function(){return this.attributes[b.LINE_ALIGN]||0};a.prototype.getListItem=function(){return this.attributes[b.LIST_TYPE]||!1};return a}();d.LineFormatting=c})(window);(function(d){const c=function(){function a(a){return a===k.ORDERED?"</ol>":"</ul>"}function b(a,b){return a===b||a===k.TODO&&b===k.TODOCHECKED||a===k.TODOCHECKED&&b===k.TODO}const {utils:c}=d,g=d.AttributeConstants,{LIST_TYPE:k}=d.LineFormatting;return function(f,d){let m="",n=!0;const z=[];var t=!1;let v=!0;var p=!0;let u=0,B=f.ops[u],C=!1;for(;B;){c.assert(B.isInsert());const q=B.attributes;if(n){n=!1;var F=0,G=null,D="left";g.LINE_SENTINEL in q&&(F=q[g.LINE_INDENT]||0,G=q[g.LIST_TYPE]||null,D=
q[g.LINE_ALIGN]||"left");G&&(F=F||1);t?(m+="</li>",t=!1):v||(p&&(m+="<br/>"),m+="</div>");v=!1;for(c.assert(0<=F,"Indent must not be negative.");z.length>F||F===z.length&&null!==G&&!b(G,z[z.length-1]);)m+=a(z.pop());for(;z.length<F;)p=G||k.UNORDERED,C=G==k.TODO||G==k.TODOCHECKED||C,m+=p===k.ORDERED?"<ol>":p===k.UNORDERED?"<ul>":'<ul class="vceditor-todo">',z.push(p);p="left"!==D?` style="text-align:${D}"`:"";if(G){t="";switch(G){case k.TODOCHECKED:t=' class="vceditor-checked"';break;case k.TODO:t=
' class="vceditor-unchecked"'}m+=`<li${t}${p}>`;t=!0}else m+=`<div${p}>`;p=!0}if(g.LINE_SENTINEL in q){B=f.ops[++u];continue}if(g.ENTITY_SENTINEL in q){for(G=0;G<B.text.length;G++)F=vceditor.Entity.fromAttributes(q),F=d.exportToElement(F),m+=F.outerHTML;B=f.ops[++u];continue}F=G="";for(const a in q){D=q[a];var H;if(a===g.BOLD||a===g.ITALIC||a===g.UNDERLINE||a===g.STRIKE){c.assert(!0===D);var A=H=a}else a===g.FONT_SIZE?(A=`span style="font-size: ${D}`,A+="string"!==typeof D||-1===D.indexOf("px",D.length-
2)?'px"':'"',H="span"):a===g.FONT?(A=`span style="font-family: ${D}"`,H="span"):a===g.COLOR?(A=`span style="color: ${D}"`,H="span"):a===g.BACKGROUND_COLOR?(A=`span style="background-color: ${D}"`,H="span"):c.log(!1,`Encountered unknown attribute while rendering html: ${a}`);A&&(G+=`<${A}>`);H&&(F=`</${H}>${F}`)}({text:D}=B);const r=D.indexOf("\n");0<=r?(n=!0,B=r<D.length-1?new vceditor.TextOp("insert",D.substr(r+1),q):f.ops[++u],D=D.substr(0,r)):B=f.ops[++u];D=D.replace(/  +/g,a=>Array(a.length+1).join("\u00a0")).replace(/^ /,
"\u00a0").replace(/ $/,"\u00a0");0<D.length&&(p=!1);m+=G+D.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\u00a0/g,"&nbsp;")+F}t?m+="</li>":v||(p&&(m+="&nbsp;"),m+="</div>");for(;0<z.length;)m+=a(z.pop());C&&(m='<style>ul.vceditor-todo { list-style: none; margin-left: 0; padding-left: 0; } ul.vceditor-todo > li { padding-left: 1em; text-indent: -1em; } ul.vceditor-todo > li:before { content: "\\2610"; padding-right: 5px; } ul.vceditor-todo > li.vceditor-checked:before { content: "\\2611"; padding-right: 5px; }</style>\n'+
...
case "u":g(a,b.withTextFormatting(b.textFormatting.underline(!0)),c);break;case "i":case "em":g(a,b.withTextFormatting(b.textFormatting.italic(!0)),c);break;case "s":g(a,b.withTextFormatting(b.textFormatting.strike(!0)),c);break;case "font":f=a.getAttribute("face");var d=a.getAttribute("color"),u=parseInt(a.getAttribute("size"));f&&(b=b.withTextFormatting(b.textFormatting.font(f)));d&&(b=b.withTextFormatting(b.textFormatting.color(d)));u&&(b=b.withTextFormatting(b.textFormatting.fontSize(u)));g(a,
...
c.apply(this,b)};a.prototype.applyOperation=function(b){a.applyOperationToCodeMirror(b,this.rtcm)};a.prototype.registerUndo=function(a){this.cm.undo=a};a.prototype.registerRedo=function(a){this.cm.redo=a};a.prototype.invertOperation=function(a){let b=0;const c=this.rtcm.codeMirror;let f,d;const n=new k;for(let k=0;k<a.wrapped.ops.length;k++){const m=a.wrapped.ops[k];if(m.isRetain())if(g(m.attributes))n.retain(m.chars),b+=m.chars;else for(f=this.rtcm.getAttributeSpans(b,b+m.chars),d=0;d<f.length;d++){var u=
{};for(const a in m.attributes){var B=m.attributes[a];const b=f[d].attributes[a];!1===B?b&&(u[a]=b):B!==b&&(u[a]=b||!1)}n.retain(f[d].length,u);b+=f[d].length}else if(m.isInsert())n.delete(m.text.length);else if(m.isDelete()){u=c.getRange(c.posFromIndex(b),c.posFromIndex(b+m.chars));f=this.rtcm.getAttributeSpans(b,b+m.chars);for(d=B=0;d<f.length;d++)n.insert(u.substr(B,f[d].length),f[d].attributes),B+=f[d].length;b+=m.chars}}return new m(n,a.meta.invert())};return a}();d.Client=c})(window);const otAdapter=function(){function d(c,a){a=a.charAt(0).toLowerCase()+a.slice(1);const b=Vceditor.getvcEditor();c.operations&&c.revision>c.operations.length?(a=[],a[c.revision-c.operations.length-1]=null,this.operations=a.concat(c.operations)):this.operations=c.operations?c.operations:[];this.server=new b.Server(c.doc,this.operations);this.trigger=function(a){this.callbacks[a].apply(this,Array.prototype.slice.call(arguments,1))};this.teacherOT=function(a){a=this.doOT(a);"undefined"!==typeof a&&this.preSend(a,
...
b,c,f,g){const k=[];let m=a;const u=this;this.annotationList_.updateSpan(new n(a,b-a),(a,b)=>{const n={};for(var C in a.attributes)n[C]=a.attributes[C];n[r.LINE_SENTINEL]&&!g||c(n);C={};const q={};u.computeChangedAttributes_(a.attributes,n,C,q);a:{for(const b in C){a=!1;break a}a=!0}a||k.push({start:m,end:m+b,attributes:C,attributesInverse:q,origin:f});m+=b;return new d(n)});0<k.length&&this.trigger("attributesChange",this,k)};a.prototype.computeChangedAttributes_=function(a,b,c,f){const d={};let g;
...
c=c.line;let d=f.line;b=b.getLine(d);f=this.areLineSentinelCharacters_(b.substr(0,f.ch));d>c&&f&&d--;this.updateLineAttributes(c,d,a)};a.prototype.updateLineAttributes=function(a,b,c){for(;a<=b;a++){var f=this.codeMirror.getLine(a);const b=this.codeMirror.indexFromPos({line:a,ch:0});f[0]!==v?(f={},f[r.LINE_SENTINEL]=!0,c(f),this.insertText(b,v,f)):this.updateTextAttributes(b,b+1,c,null,!0)}};a.prototype.replaceText=function(a,b,c,f,d){this.changeId_++;const g="cmrt-"+this.changeId_;this.outstandingChanges_[g]=
...
const k=[];for(let b=a.length-1;0<=b;b--){const f=a[b];g=c(g,f);const d=g(f.from),m=f.removed.join("\n"),n=f.text.join("\n");k.unshift({start:d,end:d+m.length,removed:m,text:n,origin:f.origin})}return k};a.prototype.markLineSentinelCharactersForChanges_=function(a){let b=Number.MAX_VALUE,c=-1;for(let f=0;f<a.length;f++){const d=a[f],{line:g}=d.from;if(1<d.removed.length||0<=d.removed[0].indexOf(v))b=Math.min(b,g),c=Math.max(c,g);1<d.text.length?(b=Math.min(b,g),c=Math.max(c,g+d.text.length-1)):0<=
d.text[0].indexOf(v)&&(b=Math.min(b,g),c=Math.max(c,g))}c=Math.min(c,this.codeMirror.lineCount()-1);this.markLineSentinelCharactersForChangedLines_(b,c)};a.prototype.markLineSentinelCharactersForChangedLines_=function(a,b){if(a<Number.MAX_VALUE)for(;0<a&&this.lineIsListItemOrIndented_(a-1);)a--;if(-1<b)for(var c=this.codeMirror.lineCount();b+1<c&&this.lineIsListItemOrIndented_(b+1);)b++;c=[];const f=this.codeMirror;for(;a<=b;a++){const b=f.getLine(a);var d=f.getLineHandle(a);f.removeLineClass(d,"text",
".*");if(0<b.length)for(d=b.indexOf(v);0<=d;){const g=d;for(;d<b.length&&b[d]===v;){const b=f.findMarksAt({line:a,ch:d});for(let a=0;a<b.length;a++)b[a].isForLineSentinel&&b[a].clear();d++}this.markLineSentinelCharacters_(a,g,d,c);d=b.indexOf(v,d)}else c=[]}return b};a.prototype.markLineSentinelCharacters_=function(a,b,c,f){const d=this.codeMirror;let g=null;var k=null,m=function(){const a=k.find();return a?a.from.line:null};if(0===b){const b=this.getLineAttributes_(a),c=b[r.LIST_TYPE];let d=b[r.LINE_INDENT]||
...
a.prototype.getLineAttributes_=function(a){const b={},f=this.codeMirror.getLine(a);if(0<f.length&&f[0]===v){a=this.codeMirror.indexFromPos({line:a,ch:0});a=this.annotationList_.getAnnotatedSpansForSpan(new n(a,1));c.utils.assert(1===a.length);for(const c in a[0].annotation.attributes)b[c]=a[0].annotation.attributes[c]}return b};a.prototype.clearAnnotations_=function(){this.annotationList_.updateSpan(new n(0,this.end()),(a,b)=>new d({}))};a.prototype.newline=function(){const a=this.codeMirror,b=this;
...
b.formatting.attributes);for(let a=0;a<b.textPieces.length;a++)f(b.textPieces[a]);f("\n")}const k=[];for(let a=0;a<b.length;a++)b[a]instanceof c.Line?d(b[a]):f(b[a]);return k};c=c||{};c.Vceditor=function(a){function b(a,c,g,k){if(!(this instanceof b))return new b(a,c,g,k);if(!u&&!B)throw Error("Couldn't find CodeMirror or ACE.  Did you forget to include codemirror.js or ace.js?");if(u&&c instanceof u)this.codeMirror_=this.editor_=c,a=this.codeMirror_.getValue(),""!==a&&console.log("Can't initialize Vceditor with a CodeMirror instance that already contains text.");
else if(B&&c&&c.session instanceof B.EditSession){if(this.ace_=this.editor_=c,a=this.ace_.getValue(),""!==a)throw Error("Can't initialize Vceditor with an ACE instance that already contains text.");}else this.codeMirror_=this.editor_=new u(c);a=this.codeMirror_?this.codeMirror_.getWrapperElement():this.ace_.container;this.vcEditorWrapper_=p.elt("div",null,{class:"vceditor"});a.parentNode.replaceChild(this.vcEditorWrapper_,a);this.vcEditorWrapper_.appendChild(a);p.on(a,"dragstart",p.stopEvent);this.editor_.vceditor=
this;this.options_=g||{};this.getOption("richTextShortcuts",!1)&&(u.keyMap.richtext||this.initializeKeyMap_(),this.codeMirror_.setOption("keyMap","richtext"),this.vcEditorWrapper_.className+=" vceditor-richtext");this.imageInsertionUI=this.getOption("imageInsertionUI",!0);this.getOption("richTextToolbar",!1)&&(this.addToolbar_(),this.vcEditorWrapper_.className+=" vceditor-richtext vceditor-with-toolbar");this.addPoweredByLogo_();this.codeMirror_&&this.codeMirror_.refresh();this.getOption("userColor",
...
this.getWrappedOperations();localStorage.removeItem(`${this.etype}_allEditorOperations`);localStorage.setItem(`${this.etype}_allEditorOperations`,JSON.stringify(a));localStorage.setItem(`${this.etype}_edOperationRev`,this.cmClient.revision)}},undoManager(a){setTimeout(()=>{90==a?document.querySelector(".vceditor-tb-undo").parentNode.click():89==a&&document.querySelector(".vceditor-tb-redo").parentNode.click()},0)}}}})(window);(function(d,c){d.Chat=function(){let a;return{userList:[],init(){this.chatroombox=null;this.chatWindow="private";this.counter=0;this.idList=[];this.commonChat=[];c.htab=[];c.htabIndex=[];this.vmstorage={};c("body").footerbar();"false"==localStorage.getItem("init")&&(c("#stickybar").removeClass("maximize").addClass("minimize"),c("#hide_bar input").removeClass("close").addClass("expand"));a=c("#tabs").tabs({cache:!0,activeOnAdd:!0});if(0==browserSupportsLocalStorage())alert(lang.sterror);else{this.history();
this.UI.privateChatBox.init();c("ul.tabs").on("click, focus","li",function(){c(`li[aria-controls='${c(this).attr("id")}']`).removeClass("ui-state-highlight")});console.log("chat local storage start ");var b=localStorage.getItem("chatEnable");null!=b&&"false"==b&&(document.querySelector("#chatWidget").classList.add("chat_disabled"),document.querySelector("#chat_div").classList.add("chat_disabled"),document.querySelector("#chatWidget").classList.remove("chat_enabled"))}},fetchChatUsers(){console.log("FetchUser congrea_get_enrolled_users");
const a=new FormData;a.append("action","fetchUser");virtualclass.xhr.send(a,`${d.webapi}&user=${virtualclass.gObj.uid}&methodname=congrea_get_enrolled_users`,a=>{virtualclass.chat.userList=JSON.parse(a);updateOnlineUserText()})},setChatDisplay(){const a=document.querySelector("#virtualclassCont.congrea  #ta_chrm2");var c=document.querySelector("#virtualclassCont.congrea #congreaUserSearch"),d=localStorage.getItem("chatWindow");if(null!=d&&"common"==d)if(virtualclass.chat.chatWindow="common",d=document.getElementById("chatrm")){d.classList.add("enable");
...
d.classList.add("active")}else if(null!=d&&"support"==d)(d=document.getElementById("congreaSupport"))&&d.classList.add("active");else{if(d=document.getElementById("memlist"))d.classList.add("enable"),d=document.getElementById("user_list"),d.classList.add("active"),virtualclass.chat.chatWindow="private";a&&(a.style.display="none")}document.querySelector("#virtualclassCont.congrea  .vmchat_bar_button").classList.contains("active")?(a&&(a.style.display="none"),c&&(c.style.display="block")):(a&&(a.style.display=
"block"),c&&(c.style.display="none"))},showChatListUsers(){const a=virtualclass.chat.userList;0<a.length&&(this._showChatUserList(a),displayChatOfflineUserList(a),document.querySelector("div#memlist").classList.add("enable"))},_showChatUserList(a){if(!document.getElementById("chat_div")){const a=document.createElement("div");a.id="chat_div";document.body.appendChild(a)}c("#chat_div").memberlist({id:"chat_div",user:a,offset:"-1px",title:lang.online,userSent(a){return c("#chat_div").memberlist("option",
"boxManager").addUsr(a)}})},history(){var a=null;null!=localStorage.getItem(wbUser.sid)&&(a=JSON.parse(localStorage.getItem(wbUser.sid)),displayPvtChatHistory(a),a=localStorage.getItem("chatEnable"),null!=a&&"false"==a&&virtualclass.user.control.disbaleAllChatBox(),this.vmstorage=JSON.parse(localStorage.getItem(wbUser.sid)));0<localStorage.length&&(displaycomChatHistory(),virtualclass.chat.removeChatHighLight("chatrm"),null!=a&&"false"==a&&virtualclass.user.control.disableCommonChat())},exportCommonChat(a){const b=
[],c=virtualclass.chat.commonChat;for(let f=0;f<c.length;f++)a<=c[f].time&&b.push(c[f]);return b},UI:{privateChatBox:{init(){c("#tabs").delegate("span.icon-close","click",this.close);c("#tabs").on("click","li a",this.toggle)},close(){var a=c(this).closest("li").attr("id").substring(5);c(`#${a}`).chatbox("option").boxClosed(a);c(`div#cb${a}.ui-widget`).hide();a=c(this).closest("li").remove().attr("aria-controls");c(`#${a}`).remove()},toggle(){const a=c(this).closest("li").attr("id").substring(5);c(`#${a}`).chatbox("toggleContentbox");
"hidden"==localStorage.getItem(a)?localStorage.removeItem(a):localStorage.setItem(a,"hidden")}}},removedPrvLoggedInDetail(){c(".ui-memblist").remove();c(".ui-chatbox").remove();c("div#chatrm").remove();virtualclass.chat.chatroombox=null;console.log("Chat box is  null");for(const a in io.uniquesids)a!=io.cfg.userid&&(chatboxManager.delBox(a),c(`li#tabcb${a}`).remove());this.idList=0;c("#stickybar").removeClass("maximize").addClass("minimize");a.tabs("refresh")},removeCookieUserInfo(a){document.cookie=
"auth_user=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/";document.cookie="auth_pass=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/";document.cookie="path=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/";display_error(a.message)},makeUserListEmpty(){c("#user_list .inner_bt #usertab_icon").css({background:`url(${d.whiteboardPath}images/offline.png)no-repeat top left`});c("#chatroom_bt .inner_bt #chatroom_text").text(`${lang.chatroom} (0)`);c("div#memlist").removeClass("enable")},removeChatHighLight(a){if(virtualclass.gObj.hasOwnProperty("testChatDiv")){a=
...
this.elem.uiChatboxLog;c.scrollTop(c.get(0).scrollHeight)}}},toggleContent(c){this.uiChatboxContent.toggle();this.uiChatboxContent.is(":visible")&&this.uiChatboxInputBox.focus()},widget(){return this.uiChatbox},_create(){var c=null!=localStorage.getItem("chatEnable")?"true"==localStorage.chatEnable?"enable":"disable":"disable";const a=this;c=(a.uiChatbox=d("<div></div>")).appendTo(document.getElementById("congreaChatCont")).addClass(`${"ui-widget ui-corner-top ui-chatroom "}${c}`).prop("id","chatrm");
uiChatboxContent=(a.uiChatboxContent=d("<div></div>")).addClass("ui-widget-content ui-chatbox-content ").appendTo(c);uiChatboxLog=(a.uiChatboxLog=a.element).addClass("ui-widget-content ui-chatbox-log").appendTo(uiChatboxContent);uiChatboxInputBox=(a.uiChatboxInputBox=d("<input></input>")).addClass("ui-widget-content ui-chatbox-input-box ").prop("id","ta_chrm2").prop("placeholder","Send message...").appendTo(document.querySelector(".congrea #congchatBarInput")).keydown(function(b){if(b.keyCode&&b.keyCode==
d.ui.keyCode.ENTER){msg=d.trim(d(this).val());b=(new Date).getTime();var c={receiver:"chatroom",msg,cf:"msg",time:b};0<msg.length&&(ioAdapter.mustSend(c),d(this).val(""),a.options.messageSent({name:io.cfg.userobj.name},{msg,time:b}),null!=localStorage.getItem("chatroom")?(c=JSON.parse(localStorage.getItem("chatroom")),b={userid:io.cfg.userid,name:io.cfg.userobj.name,msg,time:b},c.push(b),localStorage.setItem("chatroom",JSON.stringify(c))):(b={userid:io.cfg.userid,name:io.cfg.userobj.name,msg,time:b},
localStorage.setItem("chatroom",JSON.stringify([b]))),virtualclass.chat.commonChat.push(b));return!1}}).focusin(()=>{uiChatboxInputBox.addClass("ui-chatbox-input-focus")}).focusout(()=>{uiChatboxInputBox.removeClass("ui-chatbox-input-focus")});uiChatboxContent.children().click(()=>{a.uiChatboxInputBox.focus()});a._setWidth(a.options.width);a._position(a.options.offset);a.options.boxManager.init(a);a.options.hidden||(c.show(),virtualclass.vutil.isPlayMode()&&disCommonChatInput())},_setOption(c,a){if(null!=
...
const chatboxManager=function(){let d=[],c=[];const a={width:230,gap:20,maxBoxes:5,messageSent(a,b,c){$(`#${a}`).chatbox("option","boxManager").addMsg(b,c)}},b=function(b){const f=c.indexOf(b);if(-1!=f)for(c.splice(f,1),d.splice(f,1),diff=a.width+a.gap,b=f;b<c.length;b++)offset=$(`#${c[b]}`).chatbox("option","offset"),$(`#${c[b]}`).chatbox("option","offset",offset-diff);else alert(`should not happen: ${b}`)};var f=function(b,c,f){d.indexOf(c.userid);a.messageSent(b,c,f)};return{init:function(b){$.extend(a,
b)},addBox:function(g,k,m){m=c.indexOf(g);const n=d.indexOf(g);-1!=m?console.log("Do nothing"):-1!=n?($(`#${g}`).chatbox("option","offset",285+(a.width+a.gap)*c.length),$(`#${g}`).chatbox("option","boxManager").toggleBox(),c.push(g),m=$("#tabs li").index($(`#tabcb${g}`)),$($(".tabs li")[m]).css("display","list-item"),$("#tabs").tabs("option","active",m),$("#tabs").tabs("show")):(void 0==k.last_name&&(k.last_name=""),m=document.createElement("div"),m.setAttribute("id",g),$(m).chatbox({id:g,user:k,
title:`${k.first_name} ${k.last_name}`,hidden:!1,width:a.width,offset:285+(a.width+a.gap)*c.length,messageSent:f,boxClosed:b}),d.push(g),c.push(g));"support"==k.class?0==$(`#cb${g}.support`).length&&$(`#cb${g}`).addClass("support").removeClass("privateChat"):"privateChat"==k.class&&0==$(`#cb${g}.privateChat`).length&&$(`#cb${g}`).addClass("privateChat").removeClass("support");virtualclass.chat.vmstorage.hasOwnProperty(g)&&(virtualclass.chat.vmstorage[g][0].box="opened")},delBox:function(a){c=$.grep(c,
b=>a!=b);d=$.grep(d,b=>a!=b)},dispatch:function(a,b){$(`#${a.userid}`).chatbox("option","boxManager").addMsg(a.name,b)}}}();const myChatBoxOpen=!1,chatResults=[];let myDivResult="";const checkChatDisabled=!1;let tmpmyDivResult;
...
title:`box${virtualclass.chat.counter}`,first_name:b.name,last_name:b.lname}),virtualclass.chat.vmstorage.hasOwnProperty(b.userid)&&1<virtualclass.chat.vmstorage[b.userid].length&&displayUserSinglePvtChatHistory(b.userid));chatboxManager.init({user:b,messageSent(a,b,c){$(`#${a}`).chatbox("option","boxManager").addMsg(b.name,c)}});d=localStorage.getItem("chatEnable");null!=d&&"false"==d&&virtualclass.user.control.allChatDisable();$(`#${b.userid}`).chatbox("option").messageSent(b.userid,b,c);$(`li[aria-controls='tabcb${b.userid}']`).addClass("ui-state-highlight");
...
d(b)};c.onerror=function(a,c){ShowProgressMessage("Invalid image, or error downloading")};this.startTime=(new Date).getTime();c.src=this.imageAddr+`?nnn=${this.startTime}`},calculateSpeed(){const d=((8*this.downloadSize/((this.endTime-this.startTime)/1E3)).toFixed(2)/1024).toFixed(2);return Math.round(d)}},speaker:{prev:"bandwidth",curr:"speaker",next:"mic",perform(){const d=document.createElement("div");d.innerHTML=virtualclass.lang.getString("speakerTest");document.querySelector(`${`#preCheckcontainer .precheck.${this.curr}`} .result`).appendChild(d);
...
function loadfile2(d,c){"undefined"===typeof c&&(c="dec");"dec"===c?(http.open("get","http://localhost/google-webp/1.webp"),http.overrideMimeType?http.overrideMimeType("text/plain; charset=x-user-defined"):http.setRequestHeader("Accept-Charset","x-user-defined"),http.onreadystatechange=function(){if(4==http.readyState){var a="undefined"===typeof http.responseBody?http.responseText.split("").map(a=>String.fromCharCode(a.charCodeAt(0)&255)).join(""):convertResponseBodyToText(http.responseBody);"dec"===
c&&WebPDecodeAndDraw(a)}},http.send(null)):"enc"===c&&ImageToCanvas(`/images-enc/${d}`)}
function loadfile(d,c,a){"undefined"===typeof type&&(type="dec");if("dec"===type){const b=new Image;b.src=d;http.open("get",b.src);http.overrideMimeType?http.overrideMimeType("text/plain; charset=x-user-defined"):http.setRequestHeader("Accept-Charset","x-user-defined");http.onreadystatechange=function(){if(4==http.readyState){var b="undefined"===typeof http.responseBody?http.responseText.split("").map(a=>String.fromCharCode(a.charCodeAt(0)&255)).join(""):convertResponseBodyToText(http.responseBody);
"dec"===type&&virtualclass.gObj.meetingMode&&WebPDecDemo(c.id);WebPDecodeAndDraw(b,c,a)}};http.send(null)}else"enc"===type&&ImageToCanvas(`/images-enc/${filename}`)};function WebPDecDemo(d){document.getElementById(d).getContext("2d");document.createElement("img")};const BASE64_MARKER=";base64,";
...
(null!=this.domreadyCheck&&clearTimeout(this.domreadyCheck),d()):this.domreadyCheck=setTimeout(()=>{c.isDomReady(d)},1E3)},_init(){this.setCanvasAttr("vidHost","videoHost");this.setCanvasAttr("vidHostSlice","videoHostSlice");this.vidHostSlice.globalAlpha=.5;this.vidHostSlice.globalCompositeOperation="multiply"},onmessage(d){console.log(d);"on"==d.congCtr.videoSwitch?(virtualclass.videoHost.gObj.videoSwitch=1,console.log("videoSwitch 1"),this.UI.displayTeacherVideo(),localStorage.tvideo="show"):"off"==
d.congCtr.videoSwitch&&(virtualclass.videoHost.gObj.videoSwitch=0,this.UI.hideTeacherVideo(),localStorage.tvideo="hide")},stdVideoCtrlMsg(d){const {userid:c}=d.fromUser;d.message.stdVideoCtr.videoSwitch?this.setUserIcon(c):this.removeUserIcon(c)},toggleVideoMsg(d){const c=document.querySelector("#congCtrBar");"enable"==d?(c.style.pointerEvents="visible",c.style.opacity="1",virtualclass.videoHost.gObj.allStdVideoOff=!1):(c.style.pointerEvents="none",c.style.opacity="0.5",virtualclass.videoHost.gObj.allStdVideoOff=
!0)},toggleStdVideoIcon(d){const c=document.querySelector(".congrea .videoSwitchCont"),a=document.querySelector(".congrea #rightCtlr #videoSwitch");"enable"==d?(a.setAttribute("data-action","disable"),a.className="video on",c.setAttribute("data-title","Video off")):(a.setAttribute("data-action","enable"),a.className="video off",c.setAttribute("data-title","Video on"))},setUserIcon(d){var c=chatContainerEvent.elementFromShadowDom(`#ml${d} .user-details a .videoWrapper`);c&&c.parentNode.removeChild(c);
c=chatContainerEvent.elementFromShadowDom(`#ml${d} .user-details a`);if(chatContainerEvent.elementFromShadowDom(`#ml${d} .user-details a span`)||chatContainerEvent.elementFromShadowDom(`#ml${d} .user-details a img`)||null==c)console.log("Image container is null");else{if(virtualclass.gObj.chatIconColors[d]&&!virtualclass.gObj.chatIconColors[d].savedImg){var a=document.createElement("span");a.innerHTML=virtualclass.gObj.chatIconColors[d].initial;a.style.backgroundColor=virtualclass.gObj.chatIconColors[d].bgColor;
a.style.color=virtualclass.gObj.chatIconColors[d].textColor;a.dataset.event="ub";a.classList.add("chat-img","media-object");c.appendChild(a)}else virtualclass.gObj.chatIconColors[d]&&virtualclass.gObj.chatIconColors[d].savedImg&&(a=document.createElement("img"),a.setAttribute("src",virtualclass.gObj.chatIconColors[d].savedImg),a.classList.add("chat-img","media-object"),c.appendChild(a));console.log("set User icon")}},removeUserIcon(d){let c=virtualclass.media;console.log("Remove User icon");virtualclass.gObj.uid==
d&&(d=c.video.createVideoElement(),virtualclass.media.util.imageReplaceWithVideo(virtualclass.gObj.uid,d),chatContainerEvent.elementFromShadowDom(`#ml${virtualclass.gObj.uid} #tempVideo`)||(c.video.insertTempVideo(d),c.video.tempVideoInit()),c.video.myVideo=chatContainerEvent.elementFromShadowDom(`#video${virtualclass.gObj.uid}`),c.video.myVideo.muted=!0,virtualclass.adpt.attachMediaStream(c.video.myVideo,c.video.tempStream))},fromLocalStorage(){let d="";if(roles.hasControls())d=localStorage.getItem("videoSwitch"),
localStorage.removeItem("videoSwitch");else{var c=localStorage.getItem("stdVideoSwitch");c=null!=c&&"undefined"!=c?JSON.parse(c):!1;localStorage.removeItem("stdVideoSwitch");var a=localStorage.getItem("allStdVideoOff");a=null!=a&&"undefined"!=a?JSON.parse(a):!1;virtualclass.videoHost.gObj.allStdVideoOff=a;localStorage.removeItem("stdVideoSwitch")}if("undefined"!==typeof d&&d)if(virtualclass.videoHost.gObj.videoSwitch=+d,roles.hasControls()){if(a=document.getElementById("videoSwitch"))+d?a.classList.contains("off")&&
(a.classList.add("on"),a.classList.remove("off"),console.log("Video controller on")):a.classList.contains("on")&&(console.log("Video controller off"),a.classList.add("off"),a.classList.remove("on"),virtualclass.gObj.meetingMode&&virtualclass.multiVideo.setVideoStatus(!1))}else virtualclass.gObj.meetingMode||(+d?virtualclass.videoHost.UI.displayTeacherVideo():virtualclass.videoHost.UI.hideTeacherVideo());roles.hasControls()||("undefined"!==typeof c&&c&&((virtualclass.videoHost.gObj.stdStopSmallVid=
c)?(virtualclass.videoHost.toggleStdVideoIcon("disable"),virtualclass.multiVideo.setVideoStatus(!1)):virtualclass.videoHost.toggleStdVideoIcon("enable")),virtualclass.videoHost.gObj.allStdVideoOff||!virtualclass.system.mediaDevices.hasWebcam?virtualclass.videoHost.toggleVideoMsg("disable"):virtualclass.gObj.videoEnable?virtualclass.videoHost.toggleVideoMsg("enable"):virtualclass.videoHost.toggleStdVideoIcon("disable"))},setCanvasAttr(d,c){this[d]=document.getElementById(c);this[d].width=this.width;
this[d].height=this.height;this[`${d}Con`]=this[d].getContext("2d")},getMediaStream(d){this.videoHostSrc=document.getElementById("videoHostSource");this.videoHostSrc.width=this.width;this.videoHostSrc.height=this.height;virtualclass.adpt.attachMediaStream(this.videoHostSrc,d);const c=this;setTimeout(()=>{c.shareVideo()},2E3)},shareVideo(){this.imageSlices=this.getImageSlices(1,1);const d=this;videoHost.gObj.hasOwnProperty("shareVideoInterval")&&clearInterval(videoHost.gObj.shareVideoInterval);videoHost.gObj.shareVideoInterval=
setInterval(()=>{d.gObj.videoSwitch&&io.webSocketConnected()&&virtualclass.system.mediaDevices.hasWebcam&&d._shareVideo(d,1,1)},120)},_shareVideo(d,c,a){for(d.sl=0;d.sl<c*a;d.sl++){d.vidHostCon.drawImage(d.videoHostSrc,0,0,d.width,d.height);var b=d.imageSlices[d.sl];const a=d.vidHostCon.getImageData(b.x,b.y,b.w,b.h);d.vidHostSliceCon.putImageData(a,b.x,b.y)}d.sl==c*a&&(virtualclass.system.webpSupport?(c=d.vidHostSlice.toDataURL("image/webp",.6),a=1):(c=d.vidHostSlice.toDataURL("image/jpeg",.3),a=
0),d.vidHostSliceCon.clearRect(0,0,d.width,d.height),d.sendInBinary(c,a))},sendInBinary(d,c){d=this.convertDataURIToBinary(d);c=new Int8Array([21,c]);const a=new Int8Array(d.length+c.length);a.set(c);a.set(d,c.length);ioAdapter.sendBinary(a)},convertDataURIToBinary(d){var c=d.indexOf(BASE64_MARKER)+BASE64_MARKER.length;d=d.substring(c);d=window.atob(d);c=d.length;const a=new Uint8Array(new ArrayBuffer(c));for(let b=0;b<c;b++)a[b]=d.charCodeAt(b);return a},drawReceivedImage(d,c,a){"undefined"===typeof vid0eoPartCont&&
...
virtualclass.videoHost.UI.displayTeacherVideo();setTimeout(()=>{if(virtualclass.isPlayMode||3>virtualclass.videoHost.gObj.MYSPEED)if(virtualclass.system.webpSupport||"jpeg"==c){const c=new Image;c.onload=function(){b.videoPartCont.drawImage(c,a.x,a.y)};c.src=d}else virtualclass.gObj.isReadyForVideo&&(virtualclass.gObj.isReadyForVideo=!1,loadfile(d,b.videoPartCan,b.videoPartCont))},260)},onError(d){console.log(`MediaStream Error ${d}`)},getImageSlices(d,c){const a=[],b=d*c,f=Math.floor(this.vidHost.width/
c),g=Math.floor(this.vidHost.height/d);for(let k=0;k<b;k++){const b=this._getSingleSliceImg(k,f,g,d,c);a.push(b)}return a},_getSingleSliceImg(d,c,a,b,f){0==d?f=d=0:(b=Math.floor(d/f),d=d%f*c,f=b*a);return{x:d,y:f,w:c,h:a}},Uint8ToString(d){const c=[];for(let a=0;a<d.length;a+=32768)c.push(String.fromCharCode.apply(null,d.subarray(a,a+32768)));return c.join("")},getTeacherVideoQuality(){virtualclass.videoHost.gObj.teacherVideoQuality=16;const d=document.querySelector("#virtualclassCont.teacher #videoHostSource");
null!=d&&""==d.src&&(virtualclass.videoHost.gObj.teacherVideoQuality=0);return virtualclass.videoHost.gObj.teacherVideoQuality},afterSessionJoin(){const d=roles.hasAdmin()?1:virtualclass.videoHost.gObj.MYSPEED;this.setDefaultValue(d);virtualclass.network.initToPing(1E4);this.fromLocalStorage();this.resetPrecheck()},resetPrecheck(){this._resetPrecheck();var d=document.querySelector("#joinSession .next");if(null!=d){const c=document.createElement("button");d.parentNode.appendChild(c);d.parentNode.removeChild(d);
c.classList.add("precheckComplete","btn","btn-default");c.innerHTML=virtualclass.lang.getString("prechkcmplt")}(d=document.querySelector("#preCheckcontainer .skip"))&&d.addEventListener("click",()=>{micTesting.makeAudioEmpty();document.getElementById("preCheckcontainer").style.display="none";document.getElementById("virtualclassApp").style.display="block";virtualclass.videoHost._resetPrecheck()})},_resetPrecheck(){var d=document.querySelectorAll("#congProgressbar .active");for(let c=0;c<d.length;c++)0<
c&&d[c].classList.remove("active");0<d.length&&(d=document.querySelectorAll("#myModal .precheck"),[].slice.call(d,0).forEach(c=>{c.style.display="none"}),(d=document.querySelector("#vcBrowserCheck .information"))&&d.parentNode.removeChild(d),virtualclass.precheck.totalTest&&virtualclass.precheck.totalTest.forEach(c=>{"undefined"!==typeof virtualclass.precheck[c]&&virtualclass.precheck[c].hasOwnProperty("alreadyDone")&&"mic"==c&&delete virtualclass.precheck[c].alreadyDone}))},UI:{displayTeacherVideo(){if(!virtualclass.gObj.meetingMode){var d=
document.querySelector(".congrea #videoHostContainer");d.classList.add("show");d.classList.remove("hide");d=document.querySelector(".congrea #virtualclassAppRightPanel");d.classList.add("vidShow");d.classList.remove("vidHide")}},hideTeacherVideo(){if(!virtualclass.gObj.meetingMode){var d=document.querySelector(".congrea #videoHostContainer");d.classList.remove("show");d.classList.add("hide");d=document.querySelector(".congrea #virtualclassAppRightPanel");d.classList.add("vidHide");d.classList.remove("vidShow")}}}};(function(d){var c=function(){return{coursePoll:[],sitePoll:[],setting:{showResult:!0,timer:!0,time:{digit:"2",unit:"minut"}},uid:0,currQid:0,currOption:{},dataToStd:{},count:{},save:0,newUserTime:{},list:[],listPoll:{},currResultView:"bar",tStamp:[],pollState:{},exportfilepath:d.exportfilepath,uniqueUsers:[],init(){this.pollState={};virtualclass.previrtualclass="virtualclassPoll";virtualclass.previous="virtualclassPoll";this.cmid=virtualclass.vutil.getUrlVars(exportfilepath).cmid;this.timer&&clearInterval(this.timer);
!roles.hasAdmin()||roles.isEducator()?roles.isStudent()?this.UI.defaultLayoutForStudent():(this.UI.container(),roles.hasControls()?ioAdapter.mustSend({poll:{pollMsg:"init"},cf:"poll"}):this.UI.defaultLayoutForStudent()):(this.UI.container(),ioAdapter.mustSend({poll:{pollMsg:"init"},cf:"poll"}));const a=JSON.parse(localStorage.getItem("pollState"));var b;if(b=a){a:{for(const c in a)if(a.hasOwnProperty(c)){b=!1;break a}b=!0}b=!b}b?(console.log("storeddata if block"),this.storedDataHandle(a)):roles.hasControls()&&
(console.log("fetchlist"),this.interfaceToFetchList(this.cmid));localStorage.removeItem("pollState")},interfaceToSave(a,b){const c=this;b=new FormData;b.append("dataToSave",JSON.stringify(a));b.append("user",virtualclass.gObj.uid);virtualclass.xhr.send(b,`${d.webapi}&methodname=poll_save`,a=>{a=JSON.parse(a);const {options:b}=a,f={},d={};b.forEach(a=>{d[a.optid]=a.options});a.copied?(a.options=d,f.questionid=a.qid,f.category=a.category,f.createdby=a.createdby,f.questiontext=a.question,f.creatorname=
a.creatorname,f.options=a.options,c.publishPoll(f),c.interfaceToFetchList(f.category)):c.updatePollList(a);c.currQid=a.qid;c.currOption=d})},interfaceToEdit(a){const b=this,c=new FormData;c.append("editdata",JSON.stringify(a));c.append("user",virtualclass.gObj.uid);virtualclass.xhr.send(c,`${d.webapi}&methodname=poll_update`,a=>{a=JSON.parse(a);console.log(a);b.updatePollList(a)})},updatePollList(a){const {options:b}=a,c={},d={};b.forEach(a=>{d[a.id]=a.options});c.questionid=a.qid;c.category=a.category;
c.createdby=a.createdby;c.questiontext=a.question;c.creatorname=a.creatorname;c.options=d;this.currQid=a.qid;this.currOption=d;(c.category?this.coursePoll:this.sitePoll).push(c);this.interfaceToFetchList(c.category)},interfaceToFetchList(a){const b=this,c=new FormData;c.append("category",JSON.stringify(a));c.append("user",virtualclass.gObj.uid);virtualclass.recorder.items=[];virtualclass.xhr.send(c,`${d.webapi}&methodname=poll_data_retrieve`,c=>{c=JSON.parse(c);for(let a=0;a<=c.length-1;a++){const {options:b}=
c[a];for(var f in b)c[a].options[f]=b[f].options,console.log(`getContent ${c[a]}`)}console.log(c);f=c.pop();JSON.parse(a)?(b.coursePoll=c,b.displaycoursePollList()):(b.sitePoll=c,b.displaysitePollList(f))})},interfaceToDelete(a){const b=this,c=new FormData;c.append("qid",JSON.stringify(a));c.append("user",virtualclass.gObj.uid);virtualclass.xhr.send(c,`${d.webapi}&methodname=poll_delete`,a=>{a=JSON.parse(a);b.interfaceToFetchList(a)})},interfaceToDelOption(a){const b=new FormData;b.append("id",JSON.stringify(a));
b.append("user",virtualclass.gObj.uid);virtualclass.xhr.send(b,`${d.webapi}&methodname=poll_option_drop`,a=>{})},interfaceToSaveResult(a){const b=this,c=new FormData;c.append("saveResult",JSON.stringify(a));c.append("user",virtualclass.gObj.uid);virtualclass.xhr.send(c,`${d.webapi}&methodname=poll_result`,a=>{a&&(a=JSON.parse(a),b.interfaceToFetchList(a))})},storedDataHandle(a){"displaycoursePollList"==a.currScreen?this.reloadPollList(a,"course"):"displaysitePollList"==a.currScreen?this.reloadPollList(a,
...
let k=0;"course"==b?(d.classList.remove("active"),c.classList.add("active"),k=this.cmid):(c.classList.remove("active"),d.classList.add("active"));this.interfaceToFetchList(k);a.currScreen==`display${b}PollList`},reloadStdPublish(a){this.dataRec=a.data.stdPoll;this.dataRec.newTime=a.data.timer;this.stdPublish();a={stdPoll:this.dataRec,timer:this.newUserTime};this.pollState.currScreen="stdPublish";this.pollState.data=a},reloadVotedScrn(a){this.dataRec=a.data.stdPoll;this.dataRec.newTime=a.data.timer;
(a=document.getElementById("stdPollMszLayout"))&&a.parentNode.removeChild(a);a=this.dataRec.setting.showResult?virtualclass.lang.getString("votesuccess"):virtualclass.lang.getString("votesuccessPbt");this.showMsg("mszBoxPoll",a,"alert-success");a={stdPoll:this.dataRec,timer:this.newUserTime};this.pollState.currScreen="voted";this.pollState.data=a},reloadStdResult(a){const b=document.getElementById("mszBoxPoll");b&&(b.style.display="none");if(this.dataRec=a.data.stdPoll)this.dataRec.newTime=a.data.timer;
this.count=a.data.count;this.currResultView=a.data.view;this.stdPublishResult(this.count);"bar"==this.currResultView?this.updateBarGraph():"pi"==this.currResultView&&(this.createPiChart(),this.updatePiChart());a={stdPoll:this.dataRec,timer:this.newUserTime,count:this.count,view:this.currResultView};this.pollState.currScreen="stdPublishResult";this.pollState.data=a},loadTeacherScrn(a){console.log("currentscreenpublish");this.dataToStd.question=a.data.question;this.dataToStd.options=a.data.options;
this.dataToStd.qId=a.data.qId;this.setting=a.data.setting;this.nTimer=this.newTime=this.newUserTime=a.data.newTime;this.count=a.data.count;this.currResultView=a.data.view;this.uniqueUsers=a.data.users;var {pollType:b}=a.data;const c=document.getElementById("coursePollTab"),d=document.getElementById("sitePollTab");let k=0;"course"==b?(d.classList.remove("active"),c.classList.add("active"),k=this.cmid):(c.classList.remove("active"),d.classList.add("active"));this.interfaceToFetchList(k);this.list=a.data.list;
b={question:this.dataToStd.question,options:this.dataToStd.options,setting:this.setting,newTime:this.nTimer,count:this.count,view:this.currResultView,list:this.list,totalUsers:a.data.totalUsers,users:this.uniqueUsers,pollType:b,qId:a.data.qId};"yes"!=a.pollClosed&&this.reloadTeacherPublish(a);"undefined"!==typeof a.data.pollClosed&&"yes"!=a.pollClosed&&(this.UI.pollClosedUI(),a=virtualclass.lang.getString("Pclosed"),this.showMsg("resultLayoutHead",a,"alert-success"),this.timer&&clearInterval(this.timer),
this.testNoneVoted(),(a=document.getElementById("pollResultMsz"))&&a.parentNode.removeChild(a),b.pollClosed="yes",this.pollState.pollClosed="yes");this.pollState.data=b;this.pollState.currScreen="teacherPublish";localStorage.removeItem("pollState")},reloadTeacherPublish(a){const {pollType:b}=a.data;virtualclass.modal.closeModalHandler("editPollModal");var c=this.setting.timer;this.UI.resultView(c,b);this.list=a.data.list;this.count=a.data.count;this.currResultView=a.data.view;var {totalUsers:d}=a.data;
this.reloadGraph();this.noOfVotes(d);if(c)if({min:c}=this.nTimer,{sec:d}=this.nTimer,c||1<d){var k=document.getElementById("timerWrapper");if(k){var m=document.createElement("div");m.id="timerCont";k.appendChild(m)}this.showTimer(virtualclass.poll.nTimer,0)}else{if(c||1>=d){if(k=document.getElementById("timerWrapper"))m=document.createElement("div"),m.id="timerCont",k.appendChild(m);m.innerHTML=`${10>c?`0${c}`:c}:${10>d?"00":d}`;this.testNoneVoted();(m=document.getElementById("pollResultMsz"))&&m.parentNode.removeChild(m)}}else({min:c}=
a.data.newTime),{sec:d}=a.data.newTime,this.elapsedTimer(c,d);if(m=document.getElementById("modalClose"))m.removeAttribute("data-dismiss"),m.addEventListener("click",()=>{virtualclass.poll.pollModalClose(b)});this.count=a.data.count;this.pollState.currScreen="teacherPublish"},pollModalClose(a){roles.hasControls()&&virtualclass.poll.pollState.currScreen&&"teacherPublish"==virtualclass.poll.pollState.currScreen&&(virtualclass.poll.pollState.currScreen="course"==a?"displaycoursePollList":"displaysitePollList");
const b=virtualclass.lang.getString("pclosetag");virtualclass.popup.confirmInput(b,this.resultCloseConfirm,a)},resultCloseConfirm(a){if(a){(a=document.querySelector("#editPollModal"))&&a.remove();if(virtualclass.poll.timer){ioAdapter.mustSend({poll:{pollMsg:"stdPublishResult",data:virtualclass.poll.count},cf:"poll"});virtualclass.poll.resultToStorage();var b={qid:virtualclass.poll.dataToStd.qId,list:virtualclass.poll.list}}virtualclass.poll.timer&&(virtualclass.poll.interfaceToSaveResult(b),clearInterval(virtualclass.poll.timer),
virtualclass.poll.timer=0);if(b=document.getElementById("congreaPollVoters"))b.innerHTML=virtualclass.lang.getString("receivedVotes");virtualclass.poll.count={}}},resultToStorage(){var a=roles.hasControls()?this.dataToStd:this.dataRec;a&&(a={result:this.count,qid:a.qId,pollData:a},this.uid++,a.uid=this.uid,roles.hasControls()||virtualclass.storage.pollStore(JSON.stringify(a)))},reloadGraph(){"bar"==this.currResultView?(this.showGraph(),this.updateBarGraph()):"pi"==this.currResultView?(this.createPiChart(),
this.updatePiChart()):"list"==this.currResultView&&this.listView();var a=document.getElementsByClassName("emptyList"),b=document.getElementById("chart");if(0<this.list.length)for(b=0;b<a.length;b++)a[b].style.display="none";else b.style.display="none";if(a=document.querySelectorAll("#chartMenuCont button"))for(b=0;b<a.length;b++)a[b].classList.remove("disabled")},saveInLocalStorage(){console.log(`pollinlocalstorage${this.pollState}`);console.log(this.pollState.data);console.log(this.pollState);localStorage.setItem("pollState",
JSON.stringify(this.pollState))},onmessage(a,b){"stdPublish"==a.poll.pollMsg&&(this.dataRec=a.poll.data);console.log(`student side ${a.poll.pollMsg}`);virtualclass.poll[a.poll.pollMsg].call(this,a.poll.data,b);"stdPublishResult"==a.poll.pollMsg&&this.resultToStorage()},pollPopUp(a,b,c){const f=function(){console.log(this.id);virtualclass.poll.action(this.id,a,b,c);"goBack"!=this.id&&"cacelSetting"!=this.id||virtualclass.modal.removeModal()},d=(document.getElementById("editPollModal")?document.getElementById("editPollModal"):
document.getElementById("qnPopup")).querySelectorAll("#pollModalBody .controls");for(let a=0;a<d.length;a++)d[a].addEventListener("click",f)},attachConfirmInit(a,b,c,d){this.action(a,b,c,d)},action(a,b,c,d){b(a,c,d)},displaycoursePollList(){const a=this;this.dispList("course");var b=document.querySelector("#listQnContcourse tbody");if(b)for(;b.childNodes.length;)b.removeChild(b.lastChild);b=document.querySelector("#listQnContcourse");if(this.coursePoll.length){b&&(b.style.display="block");var c=document.querySelector("#mszBoxPoll");
c.style.display="none";this.coursePoll.forEach((b,c)=>{a.forEachPoll(b,c,"course")})}else{c=document.querySelector("#mszBoxPoll");const a=virtualclass.lang.getString("noPoll");c.style.display="block";c.innerHTML=a;b&&(b.style.display="none")}(b=document.getElementById("emptyListsite"))&&b.parentNode.removeChild(b);this.dispNewPollBtn("course");"teacherPublish"!=this.pollState.currScreen&&(this.pollState.currScreen="displaycoursePollList")},displaysitePollList(a){const b=this;this.dispList("site");
var c=document.querySelector("#listQnContsite tbody");if(c)for(;c.childNodes.length;)c.removeChild(c.lastChild);c=document.querySelector("#listQnContsite");if(this.sitePoll.length){this.sitePoll.forEach((c,f)=>{b.forEachPoll(c,f,"site",a)});c&&(c.style.display="block");var d=document.querySelector("#mszBoxPoll");d.style.display="none"}else{d=document.querySelector("#mszBoxPoll");let b=virtualclass.lang.getString("noPoll");"false"==a&&(b=virtualclass.lang.getString("noPollNoAdmin"));d.style.display=
"block";d.innerHTML=b;c&&(c.style.display="none")}(c=document.getElementById("emptyListcourse"))&&c.parentNode.removeChild(c);this.dispNewPollBtn("site",a);"teacherPublish"!=this.pollState.currScreen&&(this.pollState.currScreen="displaysitePollList")},dispList(a){var b=document.getElementById("mszBoxPoll");0<b.childNodes.length&&b.childNodes[0].parentNode.removeChild(b.childNodes[0]);b="course"==a?"site":"course";this.hidePollList(b);var c=document.getElementById(`listQnCont${a}`);c?(c.style.display=
"table",(c=document.getElementById(`newPollBtn${a}`))&&c.classList.contains(b)&&(c.classList.remove(b),c.classList.add(a))):this.UI.layout2("layoutPollBody",a)},dispNewPollBtn(a,b){this.attachEvent(`newPollBtn${a}`,"click",this.newPollHandler,a);var c=document.getElementById(`newPollBtn${a}`);"site"==a?("undefined"!==typeof b&&"true"==b?c.style.display="table":(c.style.display="none",roles.hasControls&&(a=document.getElementById("listQnContsite"),a.classList.add("teacherTableHeader"))),c=document.getElementById("newPollBtncourse")):
...
g({pollQn:f}));if("course"==c&&a.createdby==wbUser.id||"site"==c&&"true"==d){if(a.isPublished){if(d=document.querySelector(`#editQn${c}${b} span`))d.setAttribute("title",virtualclass.lang.getString("etDisabledA")),d.style.cursor="default",d.classList.add("disabled")}else this.attachEvent(`editQn${c}${b}`,"click",this.editHandler,a,c,b,a.createdby,a.questionid);this.attachEvent(`deleteQn${c}${b}`,"click",this.deleteHandler,a,c,b)}else{if(d=document.querySelector(`#editQn${c}${b} span`))d.setAttribute("title",
virtualclass.lang.getString("etDisabledCr")),d.style.cursor="default",d.classList.add("disabled");d=document.querySelector(`#deleteQn${c}${b} span`);d.setAttribute("title",virtualclass.lang.getString("dltDisabled"));d.style.cursor="default";d.classList.add("disabled")}d="course"==c?virtualclass.poll.coursePoll:virtualclass.poll.sitePoll;if(b==d.length-1||b==d.length-2||b==d.length-3)d=document.querySelector(`#contQn${c}${b}`),d.classList.add("lastNode");this.attachEvent(`publishQn${c}${b}`,"click",
this.publishHandler,a,c,b);this.previewOnHover(a,c,b)},previewOnHover(a,b,c){const f={};document.querySelector(`#qnText${b}${c} .popover-content`)||(f.questiontext=a.questiontext,f.options=a.options,a=virtualclass.getTemplate("previewPopup","poll")({data:f}),virtualclass.modal.attachpopupHandler(b,c,a))},attachEvent(a,b,c,d,k,m,n,q,r){q=document.getElementById(a);null!=q&&q.addEventListener(b,()=>{"undefined"!==typeof d?c(d,k,m,a,n,r):c(k,m,a,n,r)})},hidePollList(a){if(a=document.getElementById(`listQnCont${a}`))a.style.display=
"none"},editHandler(a,b,f){a=document.getElementById("mszBoxPoll");0<a.childNodes.length&&a.childNodes[0].parentNode.removeChild(a.childNodes[0]);a={};c="course"==b?virtualclass.poll.coursePoll[f]:virtualclass.poll.sitePoll[f];a.options=c.options;a.questiontext=c.questiontext;const d=virtualclass.getTemplate("edit-modal","poll");document.querySelector("#bootstrapCont").insertAdjacentHTML("beforeend",d({data:a}));virtualclass.poll.UI.editPoll(b,f);virtualclass.modal.closeModalHandler("editPollModal")},
stdResponse(a,b){this.updateResponse(a,b)},newPollHandler(a){const b=document.querySelector("#createPollCont");var c=document.querySelector("#editPollModal");c&&c.remove();c=virtualclass.getTemplate("modal","poll");b.insertAdjacentHTML("beforeend",c());virtualclass.modal.closeModalHandler("editPollModal");virtualclass.poll.pollPopUp(virtualclass.poll.popupFn,void 0,a)},popupFn(a,b,c){virtualclass.poll[a].call(this.poll,b,c,a)},next(a,b){virtualclass.poll.pollSetting(b,a)},goBack(a,b){console.log("modal dismiss")},
etSave(a,b,c){var f=virtualclass.poll.isBlank();if(!f)return 0;f="course"==b?virtualclass.poll.coursePoll[a]:virtualclass.poll.sitePoll[a];const d="course"==b?virtualclass.poll.cmid:0,m=document.getElementById("q");document.getElementById("etSave").setAttribute("data-dismiss","modal");if("undefined"!==typeof a)virtualclass.poll.saveQuestion(m,a,b),virtualclass.poll.saveOption(a,b),virtualclass.poll.interfaceToEdit({questionid:f.questionid,question:f.questiontext,options:f.options,createdby:f.createdby},
d);else if(f=virtualclass.poll.newPollSave("undefined",b),!f)return 0;"etSave"==c&&virtualclass.modal.removeModal();return 1},closePoll(a){const b=virtualclass.lang.getString("pclose");virtualclass.popup.confirmInput(b,virtualclass.poll.askConfirmClose,"close",a)},saveQuestion(a,b,c){"course"==c?(this.coursePoll[b].questiontext=a.value,this.coursePoll[b].creator=wbUser.name):(this.sitePoll[b].questiontext=a.value,this.sitePoll[b].creator=wbUser.name);console.log(this.coursePoll);document.getElementById(`qnText${c}${b}`).innerHTML=
a.value},saveOption(a,b){const c=[];let d=0;var k;a="course"==b?this.coursePoll[a]:this.sitePoll[a];const m=document.getElementById("optsTxCont").querySelectorAll("#virtualclassCont #optsTxCont .opt");for(b=0;b<m.length;b++)c[b]=m[b].value;for(k in a.options)a.options[k]=c[d],d++;if(b>d)for(d,k=d;k<b;k++)a.options[`noid${d}`]=c[d],d++},hideModal(){virtualclass.modal.removeModal()},newPollSave(a,b){a=0;const c=[];if(!virtualclass.poll.isBlank())return 0;var d=document.getElementById("optsTxCont").querySelectorAll("#virtualclassCont #optsTxCont .opt");
for(let a=0;a<d.length;a++)c.push(d[a].value);d=document.getElementById("q");"course"==b&&(a=virtualclass.poll.cmid);virtualclass.poll.interfaceToSave({question:d.value,options:c,action:"newPollSave",category:a,copied:!1},a);return 1},isBlank(){document.getElementById("q");var a=document.getElementById("optsTxCont").querySelectorAll("#virtualclassCont #optsTxCont .opt");let b=0,c=0;for(let f=0;f<a.length;f++)null==a[f].value||""===a[f].value.trim()?c++:b++;a=document.getElementById("q");return null==
...
reset(){const a=document.querySelectorAll("#editPollModal textArea");for(let b=0;b<a.length;b++)a[b].value=""},addMoreOption(a,b){virtualclass.poll.UI.createOption(a,b)},removeOption(a,b,c){const f=c.replace("remove","");c=document.getElementById(c);c.parentNode.parentNode.removeChild(c.parentNode);a="course"==a?virtualclass.poll.coursePoll[b]:virtualclass.poll.sitePoll[b];"undefined"!==typeof a&&(delete a.options[f],virtualclass.poll.interfaceToDelOption(f))},publishHandler(a,b,c){var f=document.getElementById("mszBoxPoll");
0<f.childNodes.length&&f.childNodes[0].parentNode.removeChild(f.childNodes[0]);({isPublished:f}=a);f?virtualclass.poll.duplicatePoll(a):virtualclass.poll.publishPoll(a,b,c)},duplicatePoll(a){const b=[];for(const c in a.options)b.push(a.options[c]);virtualclass.poll.interfaceToSave({question:a.questiontext,options:b,action:"newPollSave",category:a.category,copied:!0},a.category)},publishPoll(a,b){virtualclass.poll.dataToStd.question=a.questiontext;virtualclass.poll.dataToStd.qId=a.questionid;virtualclass.poll.dataToStd.options=
a.options;var c=document.getElementById("layoutPollBody"),d=document.createElement("div");d.className="container";c.appendChild(d);(c=document.getElementById("editPollModal"))&&c.remove();c={};c.questiontext=a.questiontext;c.options=a.options;d=virtualclass.getTemplate("preview-modal","poll");const k=document.querySelector("#virtualclassApp #bootstrapCont");k&&k.insertAdjacentHTML("beforeend",d({poll:c}));b||(b="0"==a.category?"site":"course");virtualclass.poll.pollPreview(b);virtualclass.modal.closeModalHandler("editPollModal")},
pollPreview(a){const b=document.getElementById("contFooter");virtualclass.poll.UI.previewFooterBtns(b,a)},publishHandler2(){virtualclass.poll.showMsg("mszBoxPoll","poll published","alert-success")},deleteHandler(a,b,c){a=document.getElementById("mszBoxPoll").querySelectorAll("#mszBoxPoll .alert");0<a.length&&a[0].parentNode.removeChild(a[0]);a=virtualclass.lang.getString("pollDel");virtualclass.popup.confirmInput(a,virtualclass.poll.askConfirm,b,c)},showMsg(a,b,c){let f=document.getElementById(a);
if(!f){const b=document.getElementById("layoutPollBody");f=document.createElement("div");f.id=a;b.appendChild(f)}const d=document.createElement("div");d.className="alert  alert-dismissable";d.classList.add(c);d.innerHTML=b;f.insertBefore(d,f.firstChild);a=document.createElement("button");a.className="close";a.setAttribute("data-dismiss","alert");a.innerHTML="&times";d.appendChild(a);a.addEventListener("click",()=>{d.parentNode.removeChild(d)})},askConfirm(a,b,c){if(a){a=document.getElementById(`contQn${b}${c}`);
a.parentNode.removeChild(a);a=virtualclass.lang.getString("Pdsuccess");virtualclass.poll.showMsg("mszBoxPoll",a,"alert-success");a="course"==b?virtualclass.poll.coursePoll[c]:virtualclass.poll.sitePoll[c];const f=a.questionid;a="course"==b?virtualclass.poll.coursePoll:virtualclass.poll.sitePoll;a.splice(c,1);virtualclass.poll.interfaceToDelete(f)}},askConfirmClose(a,b,c){if(a){(virtualclass.poll.setting.showResult&&roles.hasControls()||!roles.hasControls())&&ioAdapter.mustSend({poll:{pollMsg:"stdPublishResult",
...
a},voted(){virtualclass.poll.pollState.currScreen="voted";if(!document.querySelector("#virtualclassCont.congrea #stdPollContainer #btnVote").classList.contains("disabled"))if(virtualclass.poll.saveSelected()){virtualclass.poll.timer&&clearInterval(virtualclass.poll.timer);var a=document.getElementById("stdPollMszLayout");a&&a.parentNode.removeChild(a);a=document.getElementById("stdPollContainer");a.parentNode.removeChild(a);a=virtualclass.poll.dataRec.setting.showResult?virtualclass.lang.getString("votesuccess"):
virtualclass.lang.getString("votesuccessPbt");document.querySelector(".congrea.student #mszBoxPoll").style.display="block";virtualclass.poll.showMsg("mszBoxPoll",a,"alert-success");virtualclass.poll.sendResponse()}else alert("Select an option");a={stdPoll:virtualclass.poll.dataRec,timer:virtualclass.poll.newUserTime};virtualclass.poll.pollState.currScreen="voted";virtualclass.poll.pollState.data=a},sendResponse(){const a=virtualclass.vutil.whoIsTeacher();ioAdapter.mustSendUser({poll:{pollMsg:"stdResponse",
data:virtualclass.poll.responseId},cf:"poll"},a)},timeStamp(a){virtualclass.poll.newTimer=a},saveSelected(){const a=document.getElementById("stdOptionCont").querySelectorAll("#stdOptionCont .opt");for(var b=0;b<a.length;b++)if(a[b].checked)return virtualclass.poll.responseId=a[b].id,1;if(b==a.length)return 0},elapsedTimer(a,b){virtualclass.poll.hasOwnProperty("timer")&&clearInterval(virtualclass.poll.timer);const c=document.getElementById("timerLabel");c&&(c.innerHTML=virtualclass.lang.getString("ETime"));
if(a||b)var d=a,k=b;else d=k=0;if(roles.hasControls())var m=document.getElementById("timerCont");else{if(a=document.getElementById("stdContHead"))m=document.querySelector("#timerCont"),null==m&&(m=document.createElement("div"),m.id="timerCont",a.appendChild(m));d=virtualclass.poll.dataRec.newTime.min;k=virtualclass.poll.dataRec.newTime.sec}a=function(){m?(k++,60==k&&(k=0,d++,60==d&&(d=0)),virtualclass.poll.newUserTime.min=d,virtualclass.poll.newUserTime.sec=k,m.innerHTML=`${10>d?`0${d}`:d}:${10>k?
`0${k}`:k}`):clearInterval(virtualclass.poll.timer)};a();virtualclass.poll.timer=setInterval(a,1E3)},showTimer(a,b){virtualclass.poll.timer&&clearInterval(virtualclass.poll.timer);const c=document.getElementById("timerCont");roles.hasControls()&&virtualclass.poll.pollState.data&&(virtualclass.poll.pollState.data.newTime=virtualclass.poll.newUserTime,console.log(`test${virtualclass.poll.pollState.data.newTime}`));var d=0,k=0;roles.hasControls()&&("undefined"!==typeof a.digit?(b=a.digit,{unit:a}=a,
k=b,d=0,"minut"==a&&(d=b,k=0)):"undefined"!==typeof a.min&&(d=a.min,k=a.sec));roles.hasControls()||!virtualclass.poll.newTimer.min&&!virtualclass.poll.newTimer.sec||(d=virtualclass.poll.newTimer.min,k=virtualclass.poll.newTimer.sec,virtualclass.poll.newTimer={});a=function(){c?(virtualclass.poll.newUserTime.min=d,virtualclass.poll.newUserTime.sec=k,c.innerHTML=`${10>d?`0${d}`:d}:${10>k?`0${k}`:k}`,console.log(`testtimer${virtualclass.poll.timer}`),k--,0>=k&&(k=59,d--,0>d&&(k=d=0,c.innerHTML=`${10>
d?`0${d}`:d}:${10>k?`0${k}`:k}`,clearInterval(virtualclass.poll.timer),virtualclass.poll.timerExpired()))):clearInterval(virtualclass.poll.timer)};if(d||k)a(),virtualclass.poll.timer=setInterval(a,1E3)},timerExpired(){var a=document.getElementById("btnVote");a&&a.classList.add("disabled");roles.hasControls()&&(virtualclass.poll.setting.showResult&&ioAdapter.mustSend({poll:{pollMsg:"stdPublishResult",data:virtualclass.poll.count},cf:"poll"}),virtualclass.poll.timer&&virtualclass.poll.interfaceToSaveResult({qid:virtualclass.poll.dataToStd.qId,
...
"poll");document.querySelector("#resultLayoutBody #optnNonVotd").insertAdjacentHTML("beforeend",b({poll:a}))},showQn(a){roles.hasControls()?a.innerHTML=virtualclass.poll.dataToStd.question:a.innerHTML=virtualclass.poll.dataRec.question},showOption(a){const b=roles.hasControls()?virtualclass.poll.dataToStd:virtualclass.poll.dataRec;var {options:c}=b;for(const f in c){c=document.createElement("div");a.appendChild(c);var d=document.createElement("input");d.className="opt";d.setAttribute("name","option");
d.setAttribute("value",f);d.setAttribute("type","radio");d.id=f;c.appendChild(d);d=document.createElement("span");d.className="stdoptn";c.appendChild(d);d.innerHTML=b.options[f]}},pollSetting(a,b,c){virtualclass.poll.UI.hidePrevious(b);null==document.getElementById(`settingTx${b}`)&&virtualclass.poll.UI.pollSettingUI(b,a);"undefined"!==typeof c&&document.getElementById("publish").setAttribute("disable",!0);document.getElementById("publish").addEventListener("click",()=>{virtualclass.poll.saveSetting(a,
c)});document.getElementById("cancelSetting").addEventListener("click",()=>{virtualclass.modal.removeModal("editPollModal")});virtualclass.modal.closeModalHandler("editPollModal")},saveSetting(a,b){if(document.getElementById("radioBtn2")){var c=document.getElementById("radioBtn2").checked;virtualclass.poll.setting.timer=c}const d=document.getElementById("timer");if(d){virtualclass.poll.setting.time.digit=d.options[d.selectedIndex].value;var k=document.getElementById("ut");virtualclass.poll.setting.time.unit=
k.options[k.selectedIndex].value;k=Date.now();console.log(`sender TimeStamp${Date.now()}`);virtualclass.poll.setting.time.timestamp=k}document.getElementById("pollCkbox")&&(k=document.getElementById("pollCkbox").checked,virtualclass.poll.setting.showResult=k);virtualclass.poll.UI.resultView(c,a);virtualclass.poll.currResultView="bar";c?virtualclass.poll.showTimer(virtualclass.poll.setting.time,0):virtualclass.poll.elapsedTimer();"undefined"!==typeof b&&(virtualclass.poll.dataToStd.qId=virtualclass.poll.currQid,
virtualclass.poll.dataToStd.options=virtualclass.poll.currOption);a={question:virtualclass.poll.dataToStd.question,options:virtualclass.poll.dataToStd.options,qId:virtualclass.poll.dataToStd.qId,setting:virtualclass.poll.setting,newTime:virtualclass.poll.newUserTime,count:virtualclass.poll.count,list:virtualclass.poll.list,users:virtualclass.poll.uniqueUsers,pollType:a};"undefined"!==typeof virtualclass.poll.afterReload&&(a.newTime=virtualclass.poll.afterReload,delete virtualclass.poll.afterReload);
d&&(ioAdapter.mustSend({poll:{pollMsg:"stdPublish",data:a},cf:"poll"}),console.log(`to send${a}`));a.view=virtualclass.poll.currResultView;virtualclass.poll.showGraph();virtualclass.poll.updateBarGraph();virtualclass.poll.pollState.currScreen="teacherPublish";virtualclass.poll.pollState.data=a},updateResponse(a,b){var c=document.getElementById("chart");c&&"list"!=virtualclass.poll.currResultView&&(c.style.display="block");if(c=document.getElementById("pollResultMsz"))c.style.display="none";c=document.querySelectorAll("#chartMenuCont button");
for(let a=0;a<c.length;a++)c[a].classList.remove("disabled");c={};"undefined"===typeof virtualclass.poll.count[a]&&(virtualclass.poll.count[a]=0);virtualclass.poll.count[a]+=1;c[b.userid]=a;c.username=b.name;virtualclass.poll.list.push(c);"bar"==virtualclass.poll.currResultView?(virtualclass.poll.showGraph(),virtualclass.poll.updateBarGraph()):"pi"==virtualclass.poll.currResultView?virtualclass.poll.updatePiChart():"list"==virtualclass.poll.currResultView&&virtualclass.poll.updateListResult()},noOfVotes(a){var b=
virtualclass.hasOwnProperty("connectedUsers")?virtualclass.connectedUsers.length:0;let c=0;for(const a in virtualclass.poll.count)c+=virtualclass.poll.count[a];b=b?b-1:0;virtualclass.poll.pollState.data&&(virtualclass.poll.pollState.data.totalUsers=a||b);(a=virtualclass.poll.uniqueUsers.length?virtualclass.poll.uniqueUsers.length:0)&&(b=a);a=document.getElementById("receivedVotes");null!=a&&(a.innerHTML=`${c}\/${b}`)},updateBarGraph(){const a=document.getElementById("chart"),b=document.getElementById("pollResultMsz"),
c=[],d=roles.hasControls()?virtualclass.poll.dataToStd:virtualclass.poll.dataRec;for(var k in virtualclass.poll.count)c.push([d.options[k],virtualclass.poll.count[k]]),virtualclass.poll.count[k]&&(a&&(a.style.display="block"),b&&(b.style.display="none"));for(k in d.options)virtualclass.poll.count.hasOwnProperty(k)||(c.push([d.options[k],"0"]),virtualclass.poll.count[k]=0);virtualclass.poll.chart&&virtualclass.poll.chart.load({columns:c});roles.hasControls()&&this.noOfVotes()},updatePiChart(){const a=
document.getElementById("chart"),b=document.getElementById("pollResultMsz");this.noOfVotes();const c=roles.hasControls()?virtualclass.poll.dataToStd:virtualclass.poll.dataRec,d=[];for(var k in virtualclass.poll.count)d.push([c.options[k],virtualclass.poll.count[k]]),virtualclass.poll.count[k]&&(a&&(a.style.display="block"),b&&(b.style.display="none"));for(k in c.options)virtualclass.poll.count.hasOwnProperty(k)||(d.push([c.options[k],"0"]),virtualclass.poll.count[k]=0);virtualclass.poll.piChart&&
virtualclass.poll.piChart.load({columns:d})},updateListResult(){this.noOfVotes();const a=virtualclass.poll.list.pop();virtualclass.poll.addResultListItem(a);virtualclass.poll.list.push(a);virtualclass.poll.pollState.data.list=virtualclass.poll.list},createPiChart(){const a=roles.hasControls()?virtualclass.poll.dataToStd:virtualclass.poll.dataRec;virtualclass.poll.currResultView="pi";const b=document.getElementById("chart");b.style.display="none";var c=document.getElementById("listCont");c&&(c.style.display=
"none");c=[];let d=!1;for(const b in virtualclass.poll.count)c.push([a.options[b],virtualclass.poll.count[b]]),virtualclass.poll.count[b]&&(d=!0);d&&(b.style.display="block");virtualclass.poll.piChart=c3.generate({data:{columns:c,transition:{duration:null},type:"pie",onclick(a,b){console.log("onclick",a,b)},onmouseover(a,b){console.log("onmouseover",a,b)},onmouseout(a,b){console.log("onmouseout",a,b)}}});virtualclass.poll.currResultView="pi";"undefined"!==typeof virtualclass.poll.pollState.data&&
...
createResponseTable(a){a=virtualclass.getTemplate("pollresultlist","poll");document.querySelector("#virtualclassApp #listCont").insertAdjacentHTML("beforeend",a({}));virtualclass.poll.list.forEach((a,c)=>{virtualclass.poll.addResultListItem(a,c)});virtualclass.poll.currResultView="list";"undefined"!==typeof virtualclass.poll.pollState.data&&(virtualclass.poll.pollState.data.view="list",virtualclass.poll.pollState.data.list=virtualclass.poll.list)},addResultListItem(a){const b=virtualclass.poll.dataToStd.options;
var c=document.getElementById("resultList");for(var d in a)if("username"!=d)var k=a[d];d=document.createElement("tr");c.appendChild(d);c=document.createElement("td");c.innerHTML=a.username;d.appendChild(c);c=document.createElement("td");c.innerHTML=b[k];d.appendChild(c)},barGraph(){var a=document.getElementById("chart");a&&(a.style.display="block");virtualclass.poll.currResultView="bar";if(a=document.getElementById("listCont"))a.style.display="none";virtualclass.poll.showGraph();virtualclass.poll.updateBarGraph();
virtualclass.poll.pollState.data.view="bar"},showGraph(){var a=roles.hasControls()?virtualclass.poll.dataToStd:virtualclass.poll.dataRec,b=[];for(const c in virtualclass.poll.count)b.push([a.options[c],virtualclass.poll.count[c]]);a={type:"bar"};a.columns=b;if(b=document.getElementById("chart"))b.style.display="none";virtualclass.poll.chart=c3.generate({bindto:"#chart",data:a,bar:{width:100}})},UI:{id:"virtualclassPoll",class:"virtualclass",container(){var a=document.getElementById(this.id);null!=
a&&a.parentNode.removeChild(a);a=virtualclass.getTemplate("pollmain","poll");const b=!!roles.hasAdmin();virtualclass.vutil.insertAppLayout(a({control:b}));if(roles.hasAdmin()){const a=document.querySelector("#coursePollTab"),b=document.querySelector("#sitePollTab");b.addEventListener("click",()=>{a.classList.remove("active");b.classList.add("active");b.style.pointerEvents="none";a.style.pointerEvents="visible";virtualclass.poll.interfaceToFetchList(0)});a.addEventListener("click",()=>{b.classList.remove("active");
a.classList.add("active");a.style.pointerEvents="none";b.style.pointerEvents="visible";virtualclass.poll.interfaceToFetchList(virtualclass.poll.cmid)})}else{document.querySelector("#virtualclassCont.congrea.student #navigator #pollResult").style.display="none";virtualclass.storage.getAllDataOfPoll(["pollStorage"],a=>{if(a&&(a=JSON.parse(a.pop().pollResult),a.pollData.setting.showResult)){virtualclass.poll.previousResult=a;if(a=document.querySelector("#virtualclassCont.congrea.student #navigator #pollResult"))a.style.display=
...
a.parentNode.removeChild(a);if(a=document.getElementById("reset"))a.style.display="none";a=document.getElementById("footerCtrCont");a.parentNode.removeChild(a)},editPoll(a,b){virtualclass.poll.UI.loadContent(a,b);virtualclass.poll.UI.footerBtns(a,b)},loadContent(a,b){let d;document.getElementById("qnTxCont");virtualclass.poll.UI.editQn(a,b);d=c.options;let g=0;if("object"===typeof d)for(var k in d)console.log(k),g++,virtualclass.poll.UI.editOptions(a,b,k,g);else for(k=0;k<d.length;k++)virtualclass.poll.UI.editOptions(a,
b,k,g)},previewFooterBtns(a,b,c){document.getElementById("footerCtrCont")&&virtualclass.poll.pollPopUp(virtualclass.poll.popupFn,c,b)},footerBtns(a,b){a&&virtualclass.poll.pollPopUp(virtualclass.poll.popupFn,b,a)},editQn(a,b){const c=document.querySelector("#qnTxCont #q");null==c&&(c.value=document.getElementById(`qnText${a}${b}`).innerHTML);null==c||c.value||(c.value="course"==a?virtualclass.poll.coursePoll[b].questiontext:virtualclass.poll.sitePoll[b].questiontext)},editOptions(a,b,c,d){document.getElementById("optsTxCont").style.display=
"block";document.getElementById(`opt${b}${c}`);if(2<d){const d=document.createElement("a");d.id=`remove${c}`;d.className="close";d.innerHTML="&times";document.querySelector(`#optsTxCont .inputWrapper #option${c}`).parentNode.appendChild(d);d.addEventListener("click",()=>{virtualclass.poll.removeOption(a,b,d.id)})}d=document.getElementById(`option${c}`);"course"==a?(c=virtualclass.poll.coursePoll[b].options[c],d.value="object"===typeof c?c.options:c):(c=virtualclass.poll.sitePoll[b].options[c],d.value=
...
"video","virtualclassVideo","videoUl",c.status)})},reArrangeElements(c){const a=document.getElementById("listvideo"),b=document.createElement("div");b.id="listvideo";b.className="videos";var d=this.getActiveVideos(),g=!1;for(let a=0;a<d.length;a++)-1>=c.indexOf(d[a].fileuuid)&&(c.push(d[a].fileuuid),g=!0);g&&(virtualclass.videoUl.order=c,virtualclass.videoUl.sendOrder(virtualclass.videoUl.order));for(d=0;d<c.length;d++)(g=document.getElementById(`linkvideo${c[d]}`))&&b.appendChild(g);a.parentNode.replaceChild(b,
...
if(c=document.querySelector("#videoPopup .qq-upload-list-selector.qq-upload-list"))c.style.display="none"},showUploadMsz(c,a){const b=document.querySelector("#VideoDashboard #uploadMsz"),d=document.querySelector("#VideoDashboard #uploadMsz .alert");d&&d.parentNode.removeChild(d);const g=document.createElement("div");g.className="alert  alert-dismissable";g.classList.add(a);g.innerHTML=c;b.appendChild(g);c=document.createElement("button");c.className="close";c.setAttribute("data-dismiss","alert");
c.innerHTML="&times";c.addEventListener("click",()=>{var a=document.querySelector("#uploadMsz");a&&(a.style.display="none");(a=document.querySelector(".congrea #VideoDashboard #videoPopup"))&&a.classList.remove("uploadSuccess");g.parentNode.removeChild(g)});g.appendChild(c)},retrieveOrder(){this.requestOrder()},afterUploadFile(c){var a=c.fileuuid;this.pages[a]=new virtualclass.page("videoList","video","virtualclassVideo","videoUl",c.status,c.filetype);if("video_yts"==c.filetype){var b=virtualclass.videoUl.getVideoId(c.URL);
...
_rearrange(c){this.order=c;this.reArrangeElements(c);this.sendOrder(this.order)},_editTitle(c,a,b){b=new FormData;const f={lc_content_id:c,action:"edit",title:a,user:virtualclass.gObj.uid};b=new FormData;for(const a in f)b.append(a,f[a]),console.log(f[a]);virtualclass.xhr.sendFormData(b,`${d.webapi}&user=${virtualclass.gObj.uid}&methodname=update_content_video`,b=>{"ERROR"!=b&&(b=document.getElementById(`videoTitle${c}`))&&(b.innerHTML=a,b.style.display="inline",virtualclass.videoUl.videos&&virtualclass.videoUl.videos.length&&
virtualclass.videoUl.videos.forEach((b,d)=>{b.id==c&&(console.log(b),b.title=a)}))})},sendOrder(c,a){virtualclass.vutil.sendOrder("vid",c)},onmessage(c){if("string"===typeof c.videoUl)if("play"==c.videoUl)this.playVideo(c),virtualclass.videoUl.isPaused=!1;else if("pause"==c.videoUl)this.pauseVideo(),virtualclass.videoUl.isPaused=!0;else if("destroyPlayer"==c.videoUl)virtualclass.videoUl.destroyPlayer();else if("enterFullScreen"==c.videoUl)virtualclass.videoUl.enterFullScreen();else if("exitFullScreen"==
c.videoUl)virtualclass.videoUl.exitFullScreen();else{if("videoDelete"==c.videoUl&&(c=document.querySelector("#videoPlayerCont"))){c.style.display="none";if(c=document.querySelector("#messageLayoutVideo"))c.style.display="block";virtualclass.videoUl.videoId=null;virtualclass.videoUl.videoUrl=null;c=document.querySelector(".congrea #dispVideo video");const a=document.querySelector(".congrea #dispVideo iframe");(c=c||a)&&c.setAttribute("src","")}}else this.onmessageObj(c)},onmessageObj(c){c.videoUl.type&&
("video_yts"==c.videoUl.type?(virtualclass.videoUl.yts=!0,virtualclass.videoUl.online=!1):"video_online"==c.videoUl.type?(virtualclass.videoUl.online=!0,virtualclass.videoUl.yts=!1):(virtualclass.videoUl.yts=!1,virtualclass.videoUl.online=!1));if(c.videoUl.hasOwnProperty("init"))if(virtualclass.videoUl.rec=c.videoUl,console.log(virtualclass.videoUl.rec),"studentlayout"==c.videoUl.init){if(virtualclass.makeAppReady("Video",void 0,c.videoUl),c=document.getElementById("messageLayoutVideo"))c.style.display=
...
this.activeVideoClass(c.fileuuid)))},findNextObj(c){const a=this.findNextVideoId(c),b=this.getActiveVideos();for(let d=0;d<b.length;d++)if(b[d].fileuuid==a)return"1"==document.getElementById(`linkvideo${b[d].fileuuid}`).getAttribute("data-status")?c=b[d]:c+1},findNextVideoId(c){const a=document.querySelectorAll("#listvideo .linkvideo");return c<a.length?a[c].getAttribute("data-rid"):!1},findVideoIndex(c){const a=document.querySelectorAll("#listvideo .linkvideo");for(let b=0;b<a.length;b++)if(a[b].getAttribute("data-rid")==
c)return c=b},_disable(c){document.querySelector(`#linkvideo${c}`).classList.add("playDisable");const a=document.getElementById(`mainpvideo${c}`);a.style.opacity=.3;a.style.pointerEvents="none";virtualclass.videoUl.videos&&virtualclass.videoUl.videos.length&&virtualclass.videoUl.videos.forEach((a,d)=>{a.fileuuid==c&&(a.disabled=0,a.status=0)})},_enable(c){document.querySelector(`#linkvideo${c}`).classList.remove("playDisable");const a=document.getElementById(`mainpvideo${c}`);a&&(a.style.opacity=
1,a.style.pointerEvents="auto",virtualclass.videoUl.videos&&virtualclass.videoUl.videos.length&&virtualclass.videoUl.videos.forEach((a,d)=>{a.fileuuid==c&&(delete a.disabled,a.status=1)}))},_delete(c){const a=this;virtualclass.xhrn.sendData({uuid:c,action:"delete",page:0},virtualclass.api.UpdateDocumentStatus,b=>{a.afterDeleteCallback(b,c)})},afterDeleteCallback(c,a){if("ERROR"!=c&&(c=document.getElementById(`linkvideo${a}`))){c.parentNode.removeChild(c);if(virtualclass.videoUl.videoId==a&&(c=document.querySelector("#videoPlayerCont"))){c.style.display=
"none";ioAdapter.mustSend({videoUl:"videoDelete",cf:"videoUl"});virtualclass.videoUl.videoId=null;virtualclass.videoUl.videoUrl=null;c=document.querySelector(".congrea #dispVideo video");const a=document.querySelector(".congrea #dispVideo iframe");(c=c||a)&&c.setAttribute("src","");virtualclass.vutil.removeFinishBtn()}virtualclass.videoUl.videos&&virtualclass.videoUl.videos.length&&virtualclass.videoUl.videos.forEach((b,c)=>{b.fileuuid==a&&(c=virtualclass.videoUl.videos.indexOf(b),0<=c&&(virtualclass.videoUl.videos.splice(c,
1),console.log(virtualclass.videoUl.videos)))});c=virtualclass.videoUl.order.indexOf(a);0<=c&&(virtualclass.videoUl.order.splice(c,1),console.log(virtualclass.videoUl.order),virtualclass.videoUl.sendOrder(virtualclass.videoUl.order));virtualclass.videoUl.videos.length?1==virtualclass.videoUl.videos.length&&(c=document.querySelector(".congrea #listvideo .linkvideo"))&&c.classList.add("singleVideo"):virtualclass.vutil.removeFinishBtn()}},xhrOrderSend(c){virtualclass.xhrn.sendData({order:c.toString()},
virtualclass.api.UpdateRoomMetaData,()=>{virtualclass.serverData.fetchAllData(virtualclass.videoUl.UI.awsVideoList)})},videoToStudent(c){ioAdapter.mustSend({videoUl:c,cf:"videoUl"})},getVideoId(c){c=c.match(/^.*(?:(?:youtu\.be\/|v\/|vi\/|u\/\w\/|embed\/)|(?:(?:watch)?\?v(?:i)?=|&v(?:i)?=))([^#&\?]*).*/);return null!=c&&1<c.length&&(c=c[1].substring(0,11),11==c.length)?c:!1},UI:{id:"virtualclassVideo",class:"bootstrap virtualclass",container(){if(!document.getElementById("virtualclassVideo")){var c=
{control:!!roles.hasAdmin()};virtualclass.vutil.insertAppLayout((0,JST[`${virtualclass.gObj.tempPrefix}/videoupload/videoupload.hbs`])(c));document.getElementById(this.id)}!roles.hasControls()&&(c=document.getElementById("messageLayoutVideo"))&&(c.style.display="block")},createYoutubeUrlCont(c){const a=document.createElement("div");a.id="listvideo";c.appendChild(a)},displayVideo(c,a,b){const d=this;virtualclass.videoUl.hasOwnProperty("displayVideoTime")&&clearTimeout(virtualclass.videoUl.displayVideoTime);
virtualclass.videoUl.displayVideoTime=setTimeout(()=>{"Video"==virtualclass.currApp&&d._displayVideo(c,a,b)},300)},_displayVideo(c,a,b){"object"===typeof virtualclass.videoUl.player&&virtualclass.videoUl.player.hasOwnProperty("dispose")&&virtualclass.videoUl.player.dispose();virtualclass.videoUl.videoUrl=a;virtualclass.videoUl.videoId=c;var d=document.getElementById("videoPlayerCont");d?d.style.display="block":(virtualclass.videoUl.UI.container(),d=document.getElementById("videoPlayerCont"));const g=
document.querySelector("iframe#player");g&&g.remove();virtualclass.videoUl.UI.switchDisplay(d,a);virtualclass.videoUl.UI.videojsPlayer(a,c,b);virtualclass.modal.hideModal()},videojsPlayer(c,a,b){if(!virtualclass.videoUl.player){const b=videojs("dispVideo");if(roles.hasControls()){$(".vjs-autoPlay-button").length||virtualclass.videoUl.UI.appendAutoPlayButton(b);const a=document.getElementById("autoPlayListBtn");a&&(a.className=virtualclass.videoUl.autoPlayClass)}virtualclass.videoUl.player=b;virtualclass.videoUl.UI.attachPlayerHandler(virtualclass.videoUl.player,
a,c)}virtualclass.videoUl.UI.onEndedHandler(virtualclass.videoUl.player,a,c);virtualclass.videoUl.UI.setPlayerUrl(virtualclass.videoUl.player,c,b)},attachPlayerHandler(c,a,b){this.attachPlayer||(this.attachPlayer=!0,console.log("Attach video player"),c.on("pause",a=>{console.log("paused");roles.hasControls()&&ioAdapter.mustSend({videoUl:"pause",cf:"videoUl"});virtualclass.videoUl.isPaused=!0}),c.on("play",a=>{console.log("play");roles.hasControls()&&ioAdapter.mustSend({videoUl:{play:c.currentTime()},
cf:"videoUl"});virtualclass.videoUl.isPaused=!1}))},switchDisplay(c,a){var b=document.getElementById("dispVideo");b?b.style.display="block":virtualclass.videoUl.UI.createVideoElem(c);b=document.getElementById("videoPlayerCont");c=document.getElementById("messageLayoutVideo");"undefined"===typeof a?(b.style.display="none",c?c.style.display="block":(b=document.createElement("div"),b.id="messageLayoutVideo")):(b.style.display="block",c&&(c.style.display="none"))},createVideoElem(c,a){c.insertAdjacentHTML("beforeend",
'<video id="dispVideo" class="video-js" autoplay controls  preload="auto" data-setup="{}" >');c=document.createElement("p");c.setAttribute("class","vjs-no-js");document.getElementById("dispVideo").appendChild(c);a=document.createElement("a");a.setAttribute("href","https://videojs.com/html5-video-support/");a.setAttribute("target","_blank");a.innerHTML="supports HTML5 video";c.appendChild(a)},setPlayerUrl(c,a,b){console.log("====Video init to play start");void 0==b&&virtualclass.videoUl.startTime&&
(b=virtualclass.videoUl.startTime);c.poster_&&(c.poster_="");const d=document.querySelector("#dispVideo");virtualclass.videoUl.yts?(d.setAttribute("data-setup",'{ techOrder: [youtube],"preload": "auto"}'),c.src({type:"video/youtube",src:a})):virtualclass.videoUl.online?(d.setAttribute("data-setup",'{"preload": "auto" }'),c.src({type:"video/webm",src:a}),c.src({type:"video/mp4",src:a})):(d.setAttribute("data-setup",'{"preload": "auto"}'),c.src({type:"application/x-mpegURL",withCredentials:!0,src:a}));
c.ready(function(){const a=this;a.on("loadedmetadata",()=>{virtualclass.videoUl.isPaused?a.pause():"desktop"==virtualclass.system.device&&a.play();b&&(a.currentTime(b),virtualclass.videoUl.yts&&!virtualclass.videoUl.isPaused&&"desktop"==virtualclass.system.device&&a.play())})});console.log(b)},appendAutoPlayButton(c){virtualclass.videoUl.autoPlayClass=virtualclass.videoUl.autoPlayFlag?"vjs-autoPlay-button vjs-control on":"vjs-autoPlay-button vjs-control off";c.controlBar.addChild("button",{el:videojs.createEl("button",
{className:"vjs-autoPlay-button vjs-control on",id:"autoPlayListBtn",role:"button",title:"Auto Play",onclick(){virtualclass.videoUl.UI.autoPlayFn(this)}})})},autoPlayFn(c){c.classList.contains("off")?(virtualclass.videoUl.autoPlayFlag=1,c.classList.remove("off"),c.classList.add("on"),c.style.color="green"):(virtualclass.videoUl.autoPlayFlag=0,c.classList.remove("on"),c.classList.add("off"),c.style.color="red")},onEndedHandler(c,a,b){c.off("ended");c.on("ended",d=>{virtualclass.videoUl.UI.onEnded(c,
a,b)})},onEnded(c,a,b){var d=document.querySelector("#dispVideo");virtualclass.videoUl.yts?(d.setAttribute("data-setup","{ techOrder: [youtube],controls: true,}"),c.src({type:"video/youtube",src:b})):virtualclass.videoUl.online?(d.setAttribute("data-setup",'{"preload": "auto", "controls": true, }'),c.src({type:"video/webm",src:b}),c.src({type:"video/mp4",src:b})):(d.setAttribute("data-setup",'{"preload": "auto", "controls": true, }'),c.src({type:"application/x-mpegURL",withCredentials:!0,src:b}));
console.log(`ended${a}`);b=document.querySelectorAll("#listvideo .linkvideo");d=0;for(let c=0;c<b.length;c++)if(b[c].getAttribute("data-rid")==a){d=c;break}virtualclass.videoUl.autoPlayFlag?(c.poster_&&(c.poster_=""),virtualclass.videoUl.findNextVideoId(d+1)?virtualclass.videoUl.autoPlayList(d+1,b):virtualclass.videoUl.UI.autoVideoPause()):virtualclass.videoUl.UI.autoVideoPause()},autoVideoPause(){virtualclass.videoUl.isPaused=!0;virtualclass.videoUl.listEndPause=!0;virtualclass.videoUl.player.on("play",
...
(a.onclick=virtualclass.dts.docs.goToNavs(this.rid))};a.prototype.displayContent=function(a,d){c.getElementById(a);a.appendChild(d)};a.prototype.sendUpdate=function(b){b.type=this.type;b.id=this.rid;a.prototype.xhrSend(b)};a.prototype.xhrSend=function(a){const b=new FormData;for(const c in a)b.append(c,a[c]);virtualclass.xhr.sendFormData(b,`${d.webapi}&user=${virtualclass.gObj.uid}${"SharePresentation"!=virtualclass.currApp?"&methodname=update_content":"&methodname=update_content_video"}`,this.onServerResponse)};
a.prototype.sendStatus2=function(a){"notes"==this.type?a.page_id=this.rid:a.lc_content_id=this.rid;this.xhrSend(a)};a.prototype.sendStatus=function(a){if("notes"==this.type){const b=this.rid.split("_");a.uuid=b[0];a.page=parseInt(b[1])}else a.uuid=this.rid,a.page=0;virtualclass.xhrn.sendData(a,virtualclass.api.UpdateDocumentStatus,a=>{console.log(`Msg ${a}`)})};a.prototype.rearrange=function(){const a=c.querySelectorAll(`#list${this.type} .link${this.type}`),d=[];if(null!=a)for(let b=0;b<a.length;b++)d.push(a[b].dataset.rid);
0<d.length?"notes"==this.type?virtualclass.dts.reArrangeNotes(d):virtualclass[this.module]._rearrange(d):console.log("Document share:- Element is missing")};a.prototype.disable=function(a){"notes"==this.type?virtualclass.dts._noteDisable(this.rid):virtualclass[this.module]._disable(this.rid)};a.prototype.enable=function(){"notes"==this.type?virtualclass.dts._noteEnable(this.rid):virtualclass[this.module]._enable(this.rid)};a.prototype.UI={mainPDiv(){const a=c.createElement("div");a.className=`mainp${this.type}`;
a.id=`mainp${this.id}`;a.className="mainpreview";if("notes"==this.type){a.innerHTML="";const b=c.createElement("img");b.className="thumbnail";b.id=`thumbnail${this.rid}`;var d=virtualclass.dts.getNote(this.rid);b.src=d.content_path;b.style.border="1px solid gray";b.style.width="70px";b.style.height="40px";b.style.padding="5px";a.appendChild(b);d=c.querySelectorAll(`#list${this.type} .link${this.type}`);d=null!=d?d.length:1;const f=c.createElement("span");f.className="thumbList tooltip2";f.innerHTML=
d;f.dataset.title=this.title;a.appendChild(b);a.appendChild(f)}else"docs"==this.type&&(a.innerHTML=this.title,a.dataset.title=this.title,a.className+=" tooltip2");a.dataset.screen=this.id;a.dataset.rid=this.rid;return a},createPageNavLink2(){const a=c.createElement("div");a.className=`link${this.type}`;a.id=`link${this.id}`;a.className=`link${this.type} links`;a.dataset.screen=this.id;a.dataset.rid=this.rid;a.type=this.type;a.dataset.selected=0;a.dataset.status=this.status;"video"==this.type&&a.classList.add(this.videoClass);
return a},createPageNavLink(a){const b={};b.type=this.type;b.className=`link${this.type}`;b.id=`link${this.id}`;b.className=`link${this.type} links`;b.dataset={};b.dataset.screen=this.id;b.dataset.rid=this.rid;b.dataset.selected=0;b.dataset.status=this.status;if("video"==this.type){b.type="video";var c=virtualclass.getTemplate("linkvideo","videoupload")}else c=JST["templates/linkdoc.hbs"];a.insertAdjacentHTML("beforeend",c(b))},mainView(a){c.getElementById(this.parent);if(null==c.getElementById(`screen-${this.type}`)){a=
{hasControls:roles.hasControls(),cd:virtualclass.dts.docs.currDoc};const b=JST["templates/docMain.hbs"];c.querySelector("#documentScreen").insertAdjacentHTML("beforeend",b(a))}return c.querySelector(`#screen${this.id}   .pageContainer`)},controller:{cthis:null,init(a,c){this.cthis=a;this.element(a,"status",this.cthis.status);this.element(a,"delete");"video"==a.type&&this.element(a,"edit");"docs"!=a.type&&this.dragDrop.init(this.cthis)},dragDrop:{cthis:null,source:null,init(a){const b=this;this.cthis=
a;const d=c.querySelector(`#${`link${this.cthis.type}${this.cthis.rid}`}`);d.setAttribute("draggable","true");d.addEventListener("dragstart",c=>{b.handleDragStart(c,a)},!1);d.addEventListener("dragenter",c=>{b.handleDragEnter(c,a)},!1);d.addEventListener("dragend",c=>{b.handleDragEnd(c,a)},!1)},isBefore(a,c){if(a&&c){if(a.parentNode==c.parentNode)for(;a;a=a.previousSibling)if(a===c)return!0;return!1}},handleDragStart(a,c){a.dataTransfer.setData("text/plain","nirmala");"video"===c.type?(virtualclass.vutil.makeElementDeactive("#VideoDashboard .qq-uploader-selector.qq-uploader.qq-gallery"),
virtualclass.vutil.makeElementActive("#listvideo")):"notes"===this.cthis.type&&(virtualclass.vutil.makeElementDeactive("#DocumentShareDashboard .qq-uploader-selector.qq-uploader.qq-gallery"),virtualclass.vutil.makeElementActive("#listnotes"));a.target.classList.contains(`link${c.type}`)?this.source=a.target:this.source=a.target.closest(`.link${c.type}`);a.dataTransfer.effectAllowed="move";this.source&&this.source.classList.add("dragElem")},handleDragEnter(a,d){"video"==d.type?virtualclass.vutil.makeElementActive("#listvideo"):
"notes"==d.type&&virtualclass.vutil.makeElementActive("#listnotes");if(this.source){this.source.classList.add("dragElem");console.log("add dragelem");if("video"==d.type||"notes"==d.type||"ppt"==d.type){var b=c.querySelectorAll(`#virtualclassCont.congrea .link${d.type}.htn`);for(var f=0;f<b.length;f++)b[f].classList.remove("htn")}b=a.target.closest(`.link${d.type}`);b.classList.add("htn");this.isBefore(this.source,b)?b.parentNode.insertBefore(this.source,b):(a=a.target.closest(`.link${d.type}`),a.parentNode.insertBefore(this.source,
a.nextSibling));if("video"==d.type||"notes"==d.type||"ppt"==d.type)for(b=c.querySelectorAll(`#virtualclassCont.congrea .link${d.type}:not(.dragElem)`),f=0;f<b.length;f++)b[f].classList.add("opaq")}},handleDragEnd(a,d){"DocumentShare"==virtualclass.currApp&&(virtualclass.dts.indexNav.oldOrder=virtualclass.dts.order);d.rearrange();a.preventDefault();this.source.classList.remove("dragElem");console.log("remove dragelem");if("video"==d.type||"notes"==d.type||"ppt"==d.type){"video"==d.type?virtualclass.vutil.makeElementActive("#VideoDashboard .qq-uploader-selector.qq-uploader.qq-gallery"):
"notes"==d.type&&virtualclass.vutil.makeElementActive("#DocumentShareDashboard .qq-uploader-selector.qq-uploader.qq-gallery");virtualclass.vutil.makeElementActive(`#list${d.type}`);const b=c.querySelectorAll(` #virtualclassCont.congrea .link${d.type}.opaq`);for(a=0;a<b.length;a++)b[a].classList.remove("opaq");d=c.querySelectorAll(` #virtualclassCont.congrea .link${d.type}.htn`);for(a=0;a<d.length;a++)d[a].classList.remove("htn")}}},events:{status2(a,c){0==+a.dataset.status?(a.title="video"==c.type||
"ppt"==c.type?"Disable":"Hide",c.status=1,c.enable()):(a.title="video"==c.type||"ppt"==c.type?"Enable":"Show",c.status=0,c.disable());a.dataset.status=c.status;a.closest(`.link${c.type}`).dataset.status=c.status;a.querySelector(".statusanch").innerHTML=`status${a.dataset.status}`;c.sendStatus({action:"status",status:a.dataset.status})},status(a,c){0==+a.dataset.status?(a.title="video"==c.type||"ppt"==c.type?"Disable":"Hide",c.status=1,c.enable()):(a.title="video"==c.type||"ppt"==c.type?"Enable":"Show",
c.status=0,c.disable());a.dataset.status=c.status;a.closest(`.link${c.type}`).dataset.status=c.status;a.querySelector(".statusanch").innerHTML=`status${a.dataset.status}`;c.sendStatus(0==c.status?{action:"disable"}:{action:"enable"})},delete(a,c,g){virtualclass.dashBoard.userConfirmation(virtualclass.lang.getString("deletepopup"),a=>{a&&("notes"==c.type?virtualclass[c.module]._deleteNote(c.rid,c.type):virtualclass[c.module]._delete(c.rid))});"DocumentShare"==virtualclass.currApp&&(a=g||d.event,a.stopPropagation&&
a.stopPropagation(),null!=a.cancelBubble&&(a.cancelBubble=!0))},edit(a,d){if(!c.querySelector(`#titleCont${d.rid}`)&&"video"==d.type){var b=function(){var a=c.querySelector(`#virtualclassCont.congrea #temp${d.rid}`);a&&(a.value||(a.value=d.title),a.value&&(virtualclass.videoUl._editTitle(d.rid,a.value,d.videoClass),a=c.querySelector(`#virtualclassCont.congrea #titleCont${d.rid}`),a.parentNode.removeChild(a)))},f=c.querySelector(`#virtualclassCont.congrea #videoTitle${d.rid}`);a=f.innerHTML;f.style.display=
"none";const g=c.querySelector(`#virtualclassCont.congrea #videoTitleCont${d.rid} .controls.edit`),k=c.createElement("div");k.setAttribute("class","titleCont");k.setAttribute("id",`titleCont${d.rid}`);f.parentNode.insertBefore(k,g);f=c.createElement("input");f.setAttribute("type","text");f.setAttribute("class","textInput");f.setAttribute("id",`temp${d.rid}`);f.setAttribute("placeholder",a);k.appendChild(f);$(c).on("click",a=>{a.target.id!=`temp${d.rid}`&&a.target.id!=`editVideoTitle${d.rid}`&&b()})}}},
element2(a,d,g){("video"==a.type?"status"==d?c.querySelector(`#controlCont${a.type}${a.rid} .status`):c.querySelector(`#controlCont${a.type}${a.rid} .delete`):"status"==d?c.querySelector(".controls.status"):c.querySelector(".controls.delete")).onclick=this.goToEvent(this.cthis,d)},element(a,d,g){g=`.${d}`;"status"==d||"delete"==d?(g=c.querySelector(`#controlCont${a.type}${a.rid} ${g}`),g.onclick=this.goToEvent(this.cthis,d)):"edit"==d&&(g=c.querySelector(`#${a.type}TitleCont${a.rid} ${g}`),g.onclick=
this.goToEvent(this.cthis,d),"video_yts"!=a.videoClass&&(g.style.pointerEvents="none",g.classList.add("editDisable")));const b=this;if(g=c.querySelector(`#link${a.type}${a.rid}`))b.hoverHandler(a),g.classList.add("showCtr"),g.addEventListener("mouseover",()=>{b.hoverHandler(a)}),g.addEventListener("mouseout",()=>{b.hoverHandler1(a)})},hoverHandler(a){(a="video"==a.type?c.querySelector(`#VideoDashboard #link${a.type}${a.rid} .controlCont`):"ppt"==a.type?c.querySelector(`#SharePresentationDashboard #link${a.type}${a.rid} .controlCont`):
c.querySelector(`#DocumentShareDashboard #link${a.type}${a.rid} .controlCont`))&&a.classList.add("showCtr")},hoverHandler1(a){"video"==a.type?(a=c.querySelector(`#VideoDashboard #link${a.type}${a.rid} .controlCont`),a.classList.remove("showCtr")):"ppt"==a.type&&(a=c.querySelector(`#SharePresentationDashboard #link${a.type}${a.rid} .controlCont`),a.classList.remove("showCtr"))},goToEvent(a,c){const b=this;return function(d){b.events[c](this,a,d)}}}};d.page=a})(window,document);(function(d){let c=!0;d.documentShare=function(){return{allPages:null,allNotes:null,allDocs:null,notes:null,order:[],tempFolder:"documentSharing",init(a){this.firstRequest=!1;c=!0;this.indexNav=new virtualclass.pageIndexNav("documentShare");virtualclass.gObj.hasOwnProperty("dstAll")&&"string"===typeof virtualclass.gObj.dstAll?this.storageRawData=null:(null==virtualclass.gObj.dstAll||"undefined"!==typeof virtualclass.gObj.dstAll&&0==Object.keys(virtualclass.gObj.dstAll).length?(a=void 0,localStorage.removeItem("dtsdocs"),
...
a=document.querySelector("#screen-docs #notesContainer")),c=virtualclass.getTemplate(c,"documentSharing"),b=c(b),null!=a?a.insertAdjacentHTML("beforeend",b):console.log("there is no such element"),roles.hasControls()||virtualclass.vutil.showZoom())},afterUploadFile(a,b,c){c="undefined"!==typeof c?c.docs["docs"+a].status:1;"undefined"===typeof b&&roles.hasControls()?this.requestDocs(a):(b=`docs${a}`,"object"!==typeof this.pages[b]&&(this.pages[b]=new virtualclass.page("docScreenContainer","docs","virtualclassDocumentShare",
"dts",c),this.pages[b].init(a,title)))},initDocs(a){if("object"!==typeof this.pages[a]){let b=0;if("true"==this.allDocs[a].status||1==this.allDocs[a].status)b=1;const c=`docs${a}`;this.pages[c]=new virtualclass.page("docScreenContainer","docs","virtualclassDocumentShare","dts",b);this.pages[c].init(a,this.allDocs[a].filename);this.upateInStorage()}},firstRequestDocs(){const a=this;virtualclass.vutil.isBulkDataFetched()?(ioAdapter.mustSend({dts:{fallDocs:virtualclass.serverData.rawData.docs},cf:"dts"}),
a.afterFirstRequestDocs(virtualclass.serverData.rawData.docs)):virtualclass.serverData.fetchAllData(()=>{ioAdapter.mustSend({dts:{fallDocs:virtualclass.serverData.rawData.docs},cf:"dts"});a.afterFirstRequestDocs(virtualclass.serverData.rawData.docs);a.firstRequest=!0})},fetchAllNotes(){const a={};for(const b in virtualclass.dts.allDocs)for(let c=0;c<virtualclass.dts.allDocs[b].notesarr.length;c++)a[virtualclass.dts.allDocs[b].notesarr[c].id]=virtualclass.dts.allDocs[b].notesarr[c];return a},fetchAllNotesAsArr(){const a=
[];for(const b in virtualclass.dts.allDocs)for(let c=0;c<virtualclass.dts.allDocs[b].notesarr.length;c++)a.push(virtualclass.dts.allDocs[b].notesarr[c]);return a},afterFirstRequestDocs(a,b){this.rawToProperData(a);virtualclass.storage.dstAllStore(a);for(const a in this.allDocs)this.allDocs[a].hasOwnProperty("deleted")||this.initDocs(this.allDocs[a].fileuuid);roles.hasAdmin()&&this.requestOrder(this.executeOrder)},rawToProperData(a,b){"undefined"===typeof notconvert&&(this.allDocsTemp=a,this.allDocs=
this.convertInObjects(this.allDocsTemp));this.allNotes="undefined"!==typeof b?virtualclass.gObj.dstAllNotes:this.fetchAllNotes()},afterRequestOrder(a){this.order.length=0;this.order=a;a=this.getDocId(this.order[0]);virtualclass.dts.allDocs.hasOwnProperty(a)&&(a=`docs${a}`,console.log(`From database doc share order ${this.order.join(",")}`),this.setScreenByOrder(a),this.docs.currNote=this.order[0],this.docs.displayScreen(a,this.order[0]))},requestOrder(a){virtualclass.vutil.requestOrder("docs",a)},
executeOrder(a){if(void 0!=a&&"undefined"!==typeof a){const b=virtualclass.dts;0<a.length&&("Failed"==a||"Error"==a?(console.log("page order retrieve failed"),$("#congdashboard").modal(),console.log(`dashboard length ${$("#congdashboard").length}`),virtualclass.dashBoard.clickCloseButton()):a&&roles.hasAdmin()&&(ioAdapter.mustSend({dts:{order_recived:a},cf:"dts"}),b.afterRequestOrder(a),b.createNoteNav()))}},getFilenameFromUploadingfiles(a){for(a=0;a<virtualclass.gObj.uploadingFiles.length;)return virtualclass.gObj.uploadingFiles[a].name},
requestDocs(a){var b={filename:this.getFilenameFromUploadingfiles(a),fileuuid:a,filepath:"somewhere",filetype:"doc",key_room:`${virtualclass.gObj.sessionInfo.key}_${virtualclass.gObj.sessionInfo.room}`,status:1};this.allDocs[a]=b;b=0;if("true"==this.allDocs[a].status||1==this.allDocs[a].status)b=1;const c=`docs${a}`;"object"!==typeof this.pages[c]&&(this.pages[c]=new virtualclass.page("docScreenContainer","docs","virtualclassDocumentShare","dts",b),this.pages[c].init(a,this.allDocs[a].filename),this.allDocs[a].hasOwnProperty("notes")||
document.querySelector(`#linkdocs${a}`).classList.add("noDocs"));ioAdapter.mustSend({dts:{allDocs:this.allDocs,doc:a},cf:"dts"});virtualclass.serverData.pollingStatus(virtualclass.dts.afterRequestNotes)},afterRequestNotes(){const a=virtualclass.dts;virtualclass.dts.afterFirstRequestDocs(virtualclass.serverData.rawData.docs);ioAdapter.mustSend({dts:{fallDocs:virtualclass.serverData.rawData.docs},cf:"dts"});a.removeNoDocsElem();a.allPages=virtualclass.dts.fetchAllNotesAsArr();a.allNotes=virtualclass.dts.fetchAllNotes();
a.storeInDocs(a.allNotes);virtualclass.storage.dstAllStore(virtualclass.serverData.rawData.docs);ioAdapter.mustSend({dts:{allNotes:a.allNotes},cf:"dts"})},removeNoDocsElem(){const a=document.querySelectorAll(".noDocs");for(let b=0;b<a.length;b++)a[b].classList.remove("noDocs")},requestNotes(a){const b=this;virtualclass.vutil.xhrSendWithForm({live_class_id:virtualclass.gObj.congCourse,notes_id:"all",user:virtualclass.gObj.uid},"retrieve_all_notes",c=>{c=JSON.parse(c);+c.status&&(b.allPages=c.resultdata,
b.allNotes=b.convertInObjects(b.allPages),b.storeInDocs(b.allNotes),ioAdapter.mustSend({dts:{allNotes:b.allNotes,doc:a},cf:"dts"}))})},firstRequestNotes(){const a=this;virtualclass.vutil.xhrSendWithForm({live_class_id:virtualclass.gObj.congCourse,notes_id:"all",user:virtualclass.gObj.uid},"retrieve_all_notes",b=>{b=JSON.parse(b);a.allPages=b.resultdata;a.allNotes=a.convertInObjects(a.allPages);a.storeInDocs(a.allNotes);ioAdapter.mustSend({dts:{fallNotes:a.allNotes},cf:"dts"});a.requestOrder(a.executeOrder)})},
requestSlidesOld(a){a=parseInt(a,10);console.log(`${virtualclass.gObj.currWb} `+`document share : request ${a}`);const b=this.getDocs(a),c=document.querySelector(`#linkdocs${a}`).dataset.selected;ioAdapter.mustSend({dts:{dres:a,ds:1-+c},cf:"dts"});return b},requestSlides(a){console.log(`${virtualclass.gObj.currWb} `+`document share : request ${a}`);const b=this.getDocs(a),c=document.querySelector(`#linkdocs${a}`).dataset.selected;ioAdapter.mustSend({dts:{dres:a,ds:1-+c},cf:"dts"});return b},storeInDocs(a){virtualclass.storage.dstAllStore(virtualclass.serverData.rawData.docs)},
removeWhiteboardFromStorage(a){virtualclass.storage.wbDataRemove(a)},getNotesOld(a){const b=[];for(const c in this.allNotes)this.allNotes[c].lc_content_id==a&&b.push(this.allNotes[c]);return b},getNotes(a){return this.allDocs[a].notesarr},removePagesUI(a){a=this.getNotes(a);for(let b=0;b<a.length;b++)this._removePageUI(a[b].id);0>=this.order.length&&(c=!0);roles.hasControls()&&this.indexNav.createIndex()},_removePageUI(a,b){b=this.order.indexOf(a);0<=b&&this.order.splice(b,1);b=document.querySelector(`#notesContainer #note${a}`);
null!=b&&b.parentNode.removeChild(b);"object"===typeof virtualclass.wb[`_doc_${a}_${a}`]&&delete virtualclass.wb[`_doc_${a}_${a}`];this.removeNoteNav(a);this.reaArrangeThumbCount();if(!roles.hasControls())if(a=document.querySelector("#notesContainer .note.current"))a=a.id.split("note")[1],virtualclass.dts.indexNav.studentDocNavigation(a);else{if(a=document.getElementById("stdPageNo"))a.innerHTML=0;virtualclass.dts.indexNav.setTotalPages(virtualclass.dts.order.length)}},addPages(a){let b=0;for(;b<
a.length;)a[b].hasOwnProperty("deletedn")||null!=this.order&&-1>=this.order.indexOf(a[b].id)&&this.order.push(a[b].id),b++},toggleSlideWithOrder(a,b){a=document.querySelector(`#linkdocs${a}`);if(null!=a){if(1==a.dataset.selected)return a.dataset.selected=0,!1;a.dataset.selected=1;return!0}console.log("Document sharing There is no Element")},setLinkSelected(a,b){a=document.querySelector(`#linkdocs${a}`);null!=a&&(a.dataset.selected=b)},onResponseFiles(a,b,d,g,k){c&&(this.docs.currNote="undefined"!==
...
virtualclass.vutil.insertAppLayout(b(a));null==document.querySelector("#congdashboard")&&(a=virtualclass.getTemplate("dashboard")({app:"DocumentShare"}),document.querySelector("#dashboardContainer").innerHTML=a)}null==document.querySelector("#DocumentShareDashboard")&&(a=document.createElement("div"),document.querySelector("#congdashboard .modal-body").appendChild(a),a.id="DocumentShareDashboard");null==document.querySelector("#docsDbCont")&&(document.querySelector("#DocumentShareDashboard").innerHTML=
virtualclass.vutil.getDocsDashBoard("DocumentShare"),roles.hasControls()&&(virtualclass.vutil.attachEventToUploadTab(),null==document.querySelector("#DocumentShareDashboard .qq-gallery")&&virtualclass.vutil.modalPopup("docs",["docsuploadContainer"]),virtualclass.vutil.modalCloseHandler()))},createMainContent(a,b,c){},createSlides(a,b){let c=document.querySelector("#notesContainer");null==c&&(c=document.createElement("div"),c.className="notes",c.id="notesContainer");for(let a=0;a<b.length;a++)if(null==
...
c)virtualclass.dts.onResponseFiles(b,c,a.ds)},executeScreen(a,b,c,d){this.currDoc=a;-1==a.indexOf("docs")&&(this.currDoc=`docs${a}`);const f=virtualclass.dts;if(roles.hasControls()&&"undefined"===typeof b)b=f.requestSlides(a),null!=b?(f.onResponseFiles(a,b),"undefined"!==typeof c&&c()):console.log("There is no data");else{{"string"===typeof a&&-1<a.indexOf("docs")&&(a=a.split("docs")[1]);const g=f.getDocs(a);if(null!=g){if("undefined"===typeof b)f.onResponseFiles(a,g,void 0,d);else f.onResponseFiles(a,
g,void 0,d,"fromReload");"undefined"!==typeof c&&c()}}}},displayScreen(a,b){console.log("==== prev display screen");"undefined"!==typeof b?this.curr(a,b):this.curr(a)},async createWhiteboard(a){const b=`_doc_${a}_${a}`;console.log(`${virtualclass.gObj.currWb} `+"document share Create Whiteboard ");const c=document.createElement("div");c.id="cont";c.className="whiteboard";c.dataset.wid=b;c.id=`cont${c.dataset.wid}`;a=document.querySelector(`.note[data-slide='${a}']`);null!=a?(a.insertBefore(c,a.firstChild),
await virtualclass.vutil.createWhiteBoard(c.dataset.wid)):console.log("Element is null");console.log("==== previous set ",virtualclass.dtsConfig.id);virtualclass.previous=virtualclass.dtsConfig.id},slide(a){return{li_items:0,imageNumber:0,currSlide:"undefined"!==typeof a?a:0,currNote:"undefined"!==typeof a?a:0,doc:1,init(a){const b=virtualclass.dts;a="#screen-docs";var c=document.querySelector(`${a} .notes`);this.doc=b.docs.num;if(null!=c){if(this.li_items=c.children,this.imageNumber=this.li_items.length,
roles.hasControls()){c=document.querySelector(`${a} .prev`);a=document.querySelector(`${a} .next`);const d=this;c.onclick=function(){virtualclass.vutil.navWhiteboard(d,d.prevSlide,b)};a.onclick=function(){virtualclass.vutil.navWhiteboard(d,d.nextSlide,b)}}}else alert("no element")},slideTo(a,c){const b=a.dataset.slide;virtualclass.vutil.updateCurrentDoc(b);this.displaySlide(a);roles.hasControls()&&"undefined"===typeof c&&(ioAdapter.mustSend({dts:{slideTo:b,docn:virtualclass.dts.docs.currDoc},cf:"dts"}),
console.log(`Slide to document sharing ${b}`))},displaySlide(a){const b=document.querySelector("#screen-docs .note.current");null!=b&&b.classList.remove("current");null!=a&&a.classList.add("current");virtualclass.vutil.addNoteClass();roles.hasControls()||(a=a.id.split("note")[1],virtualclass.dts.indexNav.studentDocNavigation(a))},prevSlide(a){var b=a.docs.currNote,c=document.querySelector(`#documentScreen #note${b}`);null!=c&&(c=c.previousElementSibling,null!=c?(0==+c.dataset.status?(b=this.getActiveSlide(a,
b,"prev"))?(this.getScreen(b,!0),a.docs.currNote=b.dataset.slide,console.log(`Current note ${virtualclass.dts.docs.currNote}`)):virtualclass.dts.indexNav.UI._setArrowStatusDocs(document.getElementById("leftNavPage"),"disable","enable"):(this.getScreen(c,!0),a.docs.currNote=c.dataset.slide,console.log(`Current note ${virtualclass.dts.docs.currNote}`)),"object"===typeof virtualclass.wb[`_doc_${a.docs.currNote}_${a.docs.currNote}`]&&system.setAppDimension(null,"resize"),virtualclass.dts.indexNav.movePageIndex("left")):
virtualclass.dts.indexNav.UI._setArrowStatusDocs(document.getElementById("leftNavPage"),"disable","enable"))},getActiveSlide(a,c,d){c=document.querySelector(`#documentScreen #note${c}`);if(null!=c)return c="next"==d?c.nextElementSibling:c.previousElementSibling,null!=c?0==+c.dataset.status?this.getActiveSlide(a,c.dataset.slide,d):c:!1},nextSlide(a){var b=a.docs.currNote;if(b!=a.order[a.order.length-1]){var c=document.querySelector(`#documentScreen #note${b}`);null!=c&&(c=c.nextElementSibling,null!=
c&&(0==+c.dataset.status?(b=this.getActiveSlide(a,b,"next"))?(this.getScreen(b,!0),a.docs.currNote=b.dataset.slide,console.log(`Current note ${virtualclass.dts.docs.currNote}`)):alert("There is no page"):(this.getScreen(c,!0),a.docs.currNote=c.dataset.slide)));virtualclass.dts.indexNav.movePageIndex("right")}else virtualclass.dts.indexNav.UI._setArrowStatusDocs(document.getElementById("rightNavPage"),"disable","enable"),virtualclass.zoom.adjustScreenOnDifferentPdfWidth()},isSlideAvailable(a,c){return a==
c?!1:!0},currentSlide(a){const b=document.querySelector(`#documentScreen #note${a}`);null!=b?this.getScreen(b):console.log(`Document-Sharing:-${a} is not found `);a=document.querySelector("#docScreenContainer");null!=a&&a.classList.add("noteDisplay")},isPdfRendered(){const a=document.querySelector(`#canvas${virtualclass.gObj.currWb}`);return null!=a?a.parentNode.dataset.hasOwnProperty("pdfrender"):!1},getScreen(a,c){this.currNote=this.currSlide=a.dataset.slide;virtualclass.dts.currDoc=this.doc;this.slideTo(a);
null!=virtualclass.wb[virtualclass.gObj.currWb]&&console.log(`whiteboard ============ ${virtualclass.wb[virtualclass.gObj.currWb].gObj.queue.length}`);null!=virtualclass.wb[virtualclass.gObj.currWb]&&0<virtualclass.wb[virtualclass.gObj.currWb].gObj.queue.length&&(virtualclass.gObj.tempQueue[virtualclass.gObj.currWb]=virtualclass.wb[virtualclass.gObj.currWb].gObj.queue);this.isWhiteboardExist(this.currNote)?this.isWhiteboardExist(this.currNote)&&!this.isPdfRendered(this.currNote)?(delete virtualclass.wb[virtualclass.gObj.currWb],
virtualclass.dts.docs.createWhiteboard(this.currNote)):virtualclass.zoom.adjustScreenOnDifferentPdfWidth():virtualclass.dts.docs.createWhiteboard(this.currNote);virtualclass.vutil.updateCurrentDoc(this.currNote);virtualclass.dts.updateLinkNotes(this.currNote);c=virtualclass.dts.isFirstNote(a.id);a=virtualclass.dts.isLastNote(a.id);const b=document.querySelector("#screen-docs .pageContainer");c&&a?(b.classList.add("firstNote"),b.classList.add("lastNote")):c?(b.classList.remove("lastNote"),b.classList.add("firstNote")):
a?(b.classList.remove("firstNote"),b.classList.add("lastNote")):(b.classList.remove("firstNote"),b.classList.remove("lastNote"))},isWhiteboardExist(a){return null!=document.querySelector(`#${`containerWb_doc_${a}_${a}`}`)}}}},destroyDts(){const a=document.getElementById(virtualclass.dts.UI.id);null!=a?a.parentNode.removeChild(a):console.log("Element is null");virtualclass.dts=null},screenIsCreated(a){return null!=document.getElementById(`screen${a}`)},convertInObjects(a){const b={};for(let c=0;c<
a.length;c++)b[a[c].fileuuid]=a[c];return b},onmessage(a){"object"!==typeof virtualclass.dts&&virtualclass.makeAppReady("DocumentShare",void 0,{init:"studentlayout"});const {dts:b}=a.message;b.hasOwnProperty("docn")&&-1==b.docn.indexOf("docs")&&(b.docn=`docs${b.docn}`);if(b.hasOwnProperty("allNotes"))this.allNotes=b.allNotes,this.storeInDocs(this.allNotes);else if(b.hasOwnProperty("fallNotes"))this.allNotes=b.fallNotes,this.storeInDocs(this.allNotes),virtualclass.storage.dstAllStore(virtualclass.serverData.rawData.docs);
else if(b.hasOwnProperty("allDocs"))this.allDocs=b.allDocs,this.afterUploadFile(b.doc);else if(b.hasOwnProperty("fallDocs")){var c=this;c.afterFirstRequestDocs(b.fallDocs);virtualclass.serverData.rawData.docs=b.fallDocs}else b.hasOwnProperty("dres")?(this.docs.studentExecuteScreen(b),console.log(`${virtualclass.gObj.currWb} `+"document share :- Layout initialized")):b.hasOwnProperty("slideTo")?"object"!==typeof this.docs.note?(c=this,this.docs.executeScreen(b.docn,void 0,()=>{console.log("document share :- doc is not created");
c.docs.note.currNote=b.slideTo;const a=document.querySelector(`#note${b.slideTo}`);c.docs.note.slideTo(a)},b.slideTo)):"object"===typeof this.docs.note&&b.docn!=this.docs.num?(this.docs.currNote=b.slideTo,console.log(`Current note ${this.docs.currNote}`),this.docs.executeScreen(b.docn,void 0),this.docs.note.currentSlide(b.slideTo)):(a=document.querySelector(`#note${b.slideTo}`),null!=a?(this.docs.currNote=b.slideTo,console.log(`Current note ${this.docs.currNote}`),this.docs.note.getScreen(a),console.log(`${virtualclass.gObj.currWb} `+
"document share :- Normal Case")):alert(`Note is not found ${b.slideTo}`)):b.hasOwnProperty("dispScreen")?(a=b.dispScreen.sc,virtualclass.vutil.updateCurrentDoc(a,b.dispScreen.sn),virtualclass.dts.screenIsCreated(a)?(console.log(`${virtualclass.gObj.currWb} `+"document share :- Only display screen"),this.docs.displayScreen(a)):(console.log(`${virtualclass.gObj.currWb} `+"document share :- With screen Created"),this.docs.executeScreen(a,void 0,void 0,b.dispScreen.sn),"object"===typeof this.docs.note&&
this.docs.note.getScreen(b.dispScreen.sn))):b.hasOwnProperty("rmnote")?this._delete(b.rmnote):b.hasOwnProperty("rmsnote")?(this._removePageUI(b.rmsnote),this._removePageFromStructure(b.rmsnote)):b.hasOwnProperty("noteSt")?(this.noteStatus(b.note,b.noteSt),this.storeInDocs(this.allNotes)):b.hasOwnProperty("docSt")?this.docStatus(b.doc,b.docSt):b.hasOwnProperty("order_recived")?this.afterRequestOrder(b.order_recived):b.hasOwnProperty("norder")&&(this.order=b.norder,virtualclass.dts.indexNav.studentDocNavigation(this.docs.currNote))},
sendCurrentSlide(){if(virtualclass.dts.docs.hasOwnProperty("currDoc")){const a=virtualclass.dts.docs.currDoc;void 0!=a?null!=document.querySelector("#listnotes .note")&&(ioAdapter.mustSend({dts:{slideTo:virtualclass.dts.docs.note.currNote,docn:a},cf:"dts"}),console.log(`${virtualclass.gObj.currWb} `+"Document share send current slide")):console.log("Document sharing : doc number is undefined")}},sendCurrentDoc(){if(virtualclass.dts.docs.hasOwnProperty("currDoc"))if(void 0!=a){var a;ioAdapter.mustSend({dts:{doc:virtualclass.dts.docs.currDoc},
cf:"dts"});console.log(`${virtualclass.gObj.currWb} `+"Document share send current doc only")}else console.log("Document sharing : doc number is undefined")},consoleMessage(a){console.log(`${virtualclass.gObj.currWb} ${a}`)},_rearrange(a){alert(a.toString())},reArrangeNotes(a){this.order=a;this.reArrangeElements(a);roles.hasAdmin()&&(this.sendOrder(this.order),ioAdapter.mustSend({dts:{norder:this.order},cf:"dts"}))},sendOrder(a){virtualclass.vutil.sendOrder("docs",a)},reaArrangeThumbCount(){const a=
document.querySelectorAll("#listnotes .thumbList");for(let b=0;b<a.length;b++)a[b].innerHTML=b+1},reArrangeElements(a){const b=document.getElementById("notesContainer"),c=document.createElement("div");c.id="notesContainer";c.className="notes";for(let b=0;b<a.length;b++)c.appendChild(document.getElementById(`note${a[b]}`));b.parentNode.replaceChild(c,b);this.reaArrangeThumbCount();0<document.querySelectorAll("#dcPaging .noteIndex").length&&this.indexNav.rearrangePageNavigation(a);document.querySelector("#dcPaging").addEventListener("change",
function(){virtualclass.dts.docs.goToNavs(this.value)()})},_delete(a){const b=document.querySelector(`#linkdocs${a}`);null!=b&&b.parentNode.removeChild(b);const c=this;virtualclass.xhrn.sendData({uuid:a,action:"delete",page:0},virtualclass.api.UpdateDocumentStatus,a=>{"ok"==JSON.parse(a).status&&c.sendOrder(c.order)});delete this.pages[`docs${a}`];this.removePagesUI(a);this.removePagesFromStructure(a);this.upateInStorage()},_deleteNote(a,b){this._removePageUI(a,b);this._removePageFromStructure(a,
b);roles.hasControls()&&ioAdapter.mustSend({dts:{rmsnote:a},cf:"dts"});b=a.split("_");a=b[0];b=parseInt(b[1]);const c=this;virtualclass.xhrn.sendData({uuid:a,action:"delete",page:b},virtualclass.api.UpdateDocumentStatus,a=>{"ok"==JSON.parse(a).status&&c.sendOrder(c.order)});b=!1;const d=virtualclass.dts.allDocs[a];if(null!=d)for(let a=0;a<d.notesarr.length;a++)if(!d.notesarr[a].hasOwnProperty("deletedn")){b=!0;break}b||this._delete(a);roles.hasControls()&&this.indexNav.createIndex()},removePagesFromStructure(a){this.allDocs[a].deleted=
"0";let b;for(b in this.allNotes)-1<this.allNotes[b].id.indexOf(a)&&this._removePageFromStructure(this.allNotes[b].id)},updateInAllDocs(a){var b=a.split("_")[0];doc=this.allDocs[b];if("undefined"!==typeof doc.notes[a])for(doc.notes[a].deletedn=a,b=0;b<doc.notesarr.length;b++)doc.notesarr[b].id==a&&(doc.notesarr[b].deletedn=a);else console.log(`The note with the id ${a} is not available`)},_removePageFromStructure(a){this.removeWhiteboardFromStorage(`_doc_${a}_${a}`);this.allNotes[a].deletedn=a;this.storeInDocs(this.allNotes);
this.updateInAllDocs(a)},_disable(a){this.docStatus(a)},_enable(a){this.docStatus(a)},docStatus(a,b){var c=document.querySelector(`#linkdocs${a} .controls.status`);null!=c?"undefined"===typeof b&&(b=1-+c.dataset.status):console.log(`document share:- there is no element ${a}`);c=this.getDocs(a);for(let a=0;a<c.length;a++){const d=c[a].id;this.noteStatus(d,b);this.updatePageNavStatus(d,b)}this.storeInDocs(this.allNotes);roles.hasControls()&&ioAdapter.mustSend({dts:{docSt:b,doc:a},cf:"dts"})},updatePageNavStatus(a,
b){const c=document.querySelector(`#linknotes${a}`);null!=c?(c.dataset.status=b,a=c.querySelector(".controls.status"),a.dataset.status=b,a.querySelector(".statusanch").innerHTML=`status${b}`):console.log(`${"Document share : there is no element #linknotes"}${a}`)},_noteDisable(a){this.noteStatus(a);this.storeInDocs(this.allNotes);this.sendNoteStatus(a)},_noteEnable(a){this.noteStatus(a);this.storeInDocs(this.allNotes);this.sendNoteStatus(a)},sendNoteStatus(a){if(roles.hasControls()){const b=document.querySelector(`#note${a}`);
null!=b?ioAdapter.mustSend({dts:{noteSt:b.dataset.status,note:a},cf:"dts"}):console.log("Element is null")}},noteStatus(a,b){const c=document.querySelector(`#note${a}`);null!=c?(b="undefined"===typeof b?1-+c.dataset.status:1==b||"true"==b?1:0,c.dataset.status=b,b=this.allNotes[a],b.status=c.dataset.status,this.allNotes[a]=b):console.log(`there is no element #note${a}`)},getDocsOld(a){const b=[];for(const c in this.allNotes)a==this.allNotes[c].lc_content_id&&b.push(this.allNotes[c]);return b},getDocs(a){console.log("--------------");
if(null!=this.allDocs&&"object"===typeof this.allDocs[a])return this.allDocs[a].notesarr;console.log(`There is no document with the id ${a}`)},getDocId(a){return a.split("_")[0]},getAllNotes(a){const b=[];for(let c=0;c<a.length;c++)b.push(this.allNotes[a[c]]);return b},getNote(a){return this.allNotes[a]},updateLinkNotes(a){const b=document.querySelector("#listnotes .currentNav");null!=b&&b.classList.remove("currentNav");this.setCurrentNav(a)},setCurrentNav(a){a=document.querySelector(`#linknotes${a}`);
null!=a&&a.classList.add("currentNav")},onAjaxResponse(a,b,c){if(c.hasOwnProperty("success")&&c.success){for(a=0;a<virtualclass.gObj.uploadingFiles.length;a++)this.afterUploadFile(virtualclass.gObj.uploadingFiles[a].uuid);virtualclass.gObj.uploadingFiles=[];this.showUploadMsz(virtualclass.lang.getString("docUploadSuccess"),"alert-success")}else"duplicate"==c.message?this.showUploadMsz(virtualclass.lang.getString("duplicateUploadMsg"),"alert-error"):c.hasOwnProperty("error")?this.showUploadMsz(c.error,
"alert-error"):this.showUploadMsz(virtualclass.lang.getString("someproblem"),"alert-error");if(a=document.querySelector("#DocumentShareDashboard .qq-upload-list-selector.qq-upload-list"))a.style.display="none";null!=document.querySelector("#listnotes")?(virtualclass.vutil.makeElementDeactive("#DocumentShareDashboard .qq-uploader-selector.qq-uploader.qq-gallery"),virtualclass.vutil.makeElementActive("#listnotes")):console.log("List note is null")},showUploadMsz(a,b){const c=document.querySelector("#DocumentShareDashboard #docsUploadMsz");
...
document.querySelector("#notesContainer .note")},docSelected(){return document.querySelector('#listdocs .linkdocs[data-selected="1"]')},isUploaderExist(){return null!=document.querySelector("#docsuploadContainer .qq-uploader-selector")},upateInStorage(){if(virtualclass.hasOwnProperty("dts")&&typeof virtualclass.dts.hasOwnProperty("pages")&&"object"===typeof virtualclass.dts.pages){const a={};a.docs=virtualclass.dts.pages;a.order=JSON.stringify(virtualclass.dts.order);a.slideNumber=0<virtualclass.dts.order.length?
virtualclass.dts.docs.note.currNote:null;localStorage.setItem("dtsdocs",JSON.stringify(a))}}}}})(window);(function(d){d.quiz=function(){return{coursequiz:[],uid:virtualclass.gObj.uid,qzid:0,newUserTime:{},list:[],listQuiz:{},uniqueUsers:[],usersFinishedQz:[],quizJSON:{},attemptedUsers:{},cmid:2,exportfilepath:d.exportfilepath,quizSt:{},quizAttempted:{},qGrade:[],init(){virtualclass.previrtualclass="virtualclassQuiz";virtualclass.previous="virtualclassQuiz";this.cmid=virtualclass.vutil.getUrlVars(exportfilepath).cmid;!roles.hasAdmin()||roles.isEducator()?roles.isStudent()?this.UI.defaultLayoutForStudent():
(this.UI.container(),roles.hasControls()?ioAdapter.mustSend({quiz:{quizMsg:"init"},cf:"quiz"}):this.UI.defaultLayoutForStudent()):(this.UI.container(),ioAdapter.mustSend({quiz:{quizMsg:"init"},cf:"quiz"}));roles.hasControls()&&(console.log("fetchquizes"),this.interfaceToFetchList(this.cmid));const c=JSON.parse(localStorage.getItem("quizSt"));c&&(this.storedDataHandle(c),virtualclass.quiz.quizSt=c)},storedDataHandle(c){if("stdPublish"==c.screen){var a=this;virtualclass.storage.getQuizData(b=>{b.hasOwnProperty("qData")?
(b=JSON.parse(b.qData),a.quizDisplay(b)):console.log("Quiz data is not available")})}else if("quizsubmitted"==c.screen){const a=JSON.parse(localStorage.getItem("qRep"));this.UI.displayStudentResultScreen(a)}else"tchResultView"==c.screen&&(a=this,virtualclass.storage.getQuizData(b=>{if("undefined"!==typeof b&&b.hasOwnProperty("qData")&&b.hasOwnProperty("qDetail")){const d=JSON.parse(b.qDetail);a.quizJSON=b.qData;a.openQuizPopup(a.quizJSON,d.id);a.UI.resultView(d);a.tabContent();b.hasOwnProperty("qAttempt")&&
(a.quizAttempted=JSON.parse(b.qAttempt),a.displayAttemptOverview());b.hasOwnProperty("qGrade")&&(a.qGrade=JSON.parse(b.qGrade),a.displayGradeReport());"true"==c.qClosed&&(document.getElementById("closeQzBt").disabled=!0)}}),virtualclass.quiz.quizSt.screen=c.screen)},displayQuizList(){var c=!1;virtualclass.quiz.dispList("course");document.getElementById("listquizcourse");if(0<Object.keys(this.coursequiz).length){for(const a in this.coursequiz)this.coursequiz.hasOwnProperty(a)&&!+this.coursequiz[a].quizstatus&&
...
dispList(){document.getElementById("mszBoxQuiz");const c=document.getElementById("listQzCont");c?c.style.display="block":(console.log("quiz layout 2"),this.UI.layout2("layoutQuizBody"))},interfaceToFetchList(c){c=new FormData;c.append("cmid",this.cmid);c.append("user",this.uid);const a=this;virtualclass.xhr.send(c,`${d.webapi}&methodname=congrea_quiz`,b=>{b=JSON.parse(b);if(0==b.status)document.getElementById("bootstrapQzCont").innerHTML=virtualclass.lang.getString("noQuiz");else{for(let a=0;a<=b.length-
1;a++){const {options:c}=b[a];for(const d in c)b[a].options[d]=c[d].options}a.coursequiz=b;a.displayQuizList()}})},displayQuizes(c,a){this.UI.qzCont(a);this.UI.qzCtrCont(a);this.UI.qzTextCont(c,a);this.attachQZEvent(`publishQz${a}`,"click",this.publishHandler,c,a)},attachQZEvent(c,a,b,d,g){c=document.getElementById(c);null!=c&&c.addEventListener(a,()=>{"undefined"!==typeof d?(console.log("attach time handler"),b(d,g)):console.log("quiz is missing no need of time")})},publishHandler(c,a){const b=document.getElementById("mszBoxQuiz");
0<b.childNodes.length&&b.childNodes[0].parentNode.removeChild(b.childNodes[0]);virtualclass.quiz.publishQuiz(c,a)},publishQuiz(c,a){this.openQuizPopup(c,a);this.quizPreview(c);c=document.querySelector("#editQuizModal");c.className="modal in";c.style.display="block"},openQuizPopup(c,a){this.qzid=a;c=document.getElementById("layoutQuizBody");a=document.createElement("div");a.className="container";c.appendChild(a);(c=document.getElementById("editQuizModal"))&&c.remove();c=document.getElementById("bootstrapQzCont");
virtualclass.quiz.UI.generateModal("editQuizModal",c)},showQn(c){roles.hasControls()?c.innerHTML="quiz question":c.innerHTML="quiz question for student"},action(c,a,b){a(c,b)},getQuizData(c){const a=this.coursequiz[c.id],b=new FormData;b.append("cmid",this.cmid);b.append("user",this.uid);b.append("qid",c.id);scope=this;virtualclass.xhr.send(b,`${d.webapi}&methodname=congrea_get_quizdata`,b=>{if(scope.isJson(b))scope.quizJSON=b,$("#slickQuiz").slickQuiz({json:scope.quizJSON,questionPerPage:a.questionsperpage,
questionMode:a.preferredbehaviour,quizTime:a.timelimit,displayDetailResult:!1});else{const a=document.getElementById("publishQzBt");a.parentNode.removeChild(a);document.getElementById("contQzBody").innerHTML=b}})},quizPopUp(c,a){console.log("quiz pop up");const b=function(){console.log(this.id);virtualclass.quiz.action(this.id,c,a)},d=(document.getElementById("editQuizModal")?document.getElementById("editQuizModal"):document.getElementById("qzPopup")).querySelectorAll(":scope .controls");for(let a=
0;a<d.length;a++)d[a].addEventListener("click",b)},quizPreview(c){console.log("quiz preview function");this.UI.modalContentUI();var a=document.getElementById("contQzHead"),b=document.createElement("div");b.id="QstnName";b.innerHTML=c.name;a.appendChild(b);b=document.getElementById("contQzBody");a=document.createElement("button");a.id="publishQzBt";a.classList.add("btn","btn-default","controls");a.innerHTML=virtualclass.lang.getString("PQuiz");b.appendChild(a);b=document.createElement("i");b.className=
"icon-publish";a.appendChild(b);this.getQuizData(c);this.quizPopUp(this.popupFn,1)},popupFn(c,a){virtualclass.quiz[c].call(this.quiz,a)},publishQzBt(){const c=virtualclass.quiz;var a=c.quizJSON,b=JSON.parse(a).questions.length;c.coursequiz[c.qzid].noOfQus=b;b=c.coursequiz[c.qzid];const f={json:a,questionPerPage:b.questionsperpage,questionMode:b.preferredbehaviour,quizTime:b.timelimit,displayDetailResult:!1,ptm:(new Date).getTime()};ioAdapter.mustSend({quiz:{quizMsg:"stdPublish",quizId:c.qzid,data:f},
cf:"quiz"});c.UI.resultView(b);c.tabContent();c.quizSt.screen="tchResultView";virtualclass.storage.quizStorage("qDetail",JSON.stringify(b));virtualclass.storage.quizStorage("qData",a);a=new FormData;a.append("cmid",c.cmid);a.append("qzid",c.qzid);a.append("user",c.uid);virtualclass.xhr.send(a,`${d.webapi}&methodname=congrea_add_quiz`,a=>{"ture"!==a&&console.log("Quiz data not saved in congrea")})},closeQzBt(){console.log("-------CLOSE QUIZ--------");var {qzid:c}=virtualclass.quiz;ioAdapter.mustSend({quiz:{quizMsg:"stdShowResult",
data:{qzid:c}},cf:"quiz"});"undefined"!==typeof CDTimer&&(clearInterval(CDTimer),console.log("Clear quiz interval"));document.getElementById("closeQzBt").disabled=!0;c=document.createElement("div");c.className="alert alert-info";c.innerHTML=virtualclass.lang.getString("QClosed");resultQzLayout.insertBefore(c,resultQzLayout.firstChild)},quizDisplay(c){var a=document.getElementById("mszBoxQuiz");a&&a.parentNode.removeChild(a);(a=document.getElementById("contQzBody"))&&a.parentNode.removeChild(a);a=
document.getElementById("bootstrapQzCont");const b=virtualclass.view.customCreateElement("div","contQzBody","modal-body");a.appendChild(b);this.UI.modalContentUI();$("#slickQuiz").slickQuiz(c)},saveInLocalStorage(){const c=virtualclass.quiz;null!=document.querySelector("#qztime")&&(c.quizSt.qtime=document.querySelector("#qztime").textContent,console.log(`quiz=${c.quizSt.qtime}`));null!=document.querySelector("#elsTime")&&(c.quizSt.qtime=document.querySelector("#elsTime").textContent,console.log(`quiz=${c.quizSt.qtime}`));
console.log(`quiz=${c.quizSt.screen}`);null!=document.getElementById("closeQzBt")&&1==document.getElementById("closeQzBt").disabled&&(c.quizSt.qClosed="true");c.quizSt&&localStorage.setItem("quizSt",JSON.stringify(c.quizSt));c.quizAttempted&&(console.log(`attempt data =${c.quizAttempted}`),virtualclass.storage.quizStorage("qAttempt",JSON.stringify(c.quizAttempted)))},onmessage(c,a){const b=virtualclass.quiz;"stdPublish"==c.quiz.quizMsg&&(b.dataRec=c.quiz.data,virtualclass.storage.quizStorage("qData",
JSON.stringify(b.dataRec)),b.quizSt.screen="stdPublish",this.quizDisplay(c.quiz.data));if("stdShowResult"==c.quiz.quizMsg||"quizTimeEnd"==c.quiz.quizMsg){null!=document.querySelector("#timeText")&&(document.querySelector("#timeText").textContent="Quiz has been closed");var d=document.querySelector("#slickQuiz .quizResults");d&&"block"!=d.style.display&&(d=document.querySelectorAll("#slickQuiz .nextQuestion"),d[d.length-1].click())}"quizClosed"==c.quiz.quizMsg&&(localStorage.removeItem("quizSt"),this.quizSt=
{},localStorage.removeItem("qRep"),virtualclass.storage.clearTableData("quizData"),this.UI.defaultLayoutForStudent());if("quizAttempt"==c.quiz.quizMsg&&roles.hasControls()){"undefined"===typeof this.attemptedUsers[c.quiz.questionId]&&(this.attemptedUsers[c.quiz.questionId]={});d=c.quiz.user;"undefined"===typeof this.attemptedUsers[c.quiz.questionId][d]&&(this.attemptedUsers[c.quiz.questionId][d]={});this.attemptedUsers[c.quiz.questionId][d]=c.quiz.ans;d=Object.keys(this.attemptedUsers[c.quiz.questionId]).length;
let a=0;for(var g in this.attemptedUsers[c.quiz.questionId])1==this.attemptedUsers[c.quiz.questionId][g]&&a++;document.getElementById(`usA_${c.quiz.questionId}`).innerHTML=d;g=0;0<a&&(g=a/d*100);const b=document.getElementById(`qPb_${c.quiz.questionId}`);b.innerHTML=`${g}% correct`;b.style.width=`${g}%`;"undefined"===typeof this.quizAttempted[c.quiz.questionId]&&(this.quizAttempted[c.quiz.questionId]={});this.quizAttempted[c.quiz.questionId].uA=d;this.quizAttempted[c.quiz.questionId].cA=a}"quizsubmitted"==
c.quiz.quizMsg&&roles.hasControls()&&(this.usersFinishedQz.push(c.quiz.user),a="undefined"==!typeof a.lname?`${a.name} ${a.lname}`:a.name,this.gradeReport(this.usersFinishedQz.length,a,c.quiz.timetaken,c.quiz.score,c.quiz.quesattemptd,c.quiz.correctans),this.qGrade.push({nm:a,tt:c.quiz.timetaken,sc:c.quiz.score,qAt:c.quiz.quesattemptd,ca:c.quiz.correctans}),virtualclass.storage.quizStorage("qGrade",JSON.stringify(b.qGrade)),this.saveGradeInDb(c.quiz.user,c.quiz.timetaken,c.quiz.score,c.quiz.quesattemptd,
c.quiz.correctans))},saveGradeInDb(c,a,b,f,g){const k=virtualclass.quiz;a=this.convertTimeToSec(a);const m=new FormData;m.append("cmid",k.cmid);m.append("qzid",k.qzid);m.append("user",c);m.append("grade",b);m.append("timetaken",a);m.append("qusattempted",f);m.append("currectans",g);virtualclass.xhr.send(m,`${d.webapi}&methodname=congrea_quiz_result`,a=>{"ture"!==a&&console.log("Quiz data not saved in congrea")})},displayAttemptOverview(){const c=virtualclass.quiz;for(const a in c.quizAttempted)if(document.getElementById(`usA_${a}`).innerHTML=
c.quizAttempted[a].uA,0<c.quizAttempted[a].cA){const b=(c.quizAttempted[a].cA/c.quizAttempted[a].uA*100).toFixed(2),d=document.getElementById(`qPb_${a}`);d.innerHTML=`${b}% correct`;d.style.width=`${b}%`}},displayGradeReport(){const c=virtualclass.quiz;for(let a=0;a<c.qGrade.length;a++)c.gradeReport(a+1,c.qGrade[a].nm,c.qGrade[a].tt,c.qGrade[a].sc,c.qGrade[a].qAt,c.qGrade[a].ca)},attemptProgressReport(){var c=JSON.parse(virtualclass.quiz.quizJSON);const a=virtualclass.view.customCreateElement("div",
"attemptQzBody","modal-body");c=c.questions;let b=1;for(i=0;i<c.length;i++){const f=virtualclass.view.customCreateElement("div","","q-area");a.appendChild(f);var d=virtualclass.view.customCreateElement("span","","q-no");d.innerHTML=b;f.appendChild(d);d=virtualclass.view.customCreateElement("div","","qscolor");d.innerHTML=c[i].q;f.appendChild(d);d=virtualclass.view.customCreateElement("div");d.innerHTML=`Users attempted : <span id='usA_${c[i].qid}'>0</span>`;f.appendChild(d);d=this.UI.createProgressBar(c[i].qid,
0);f.appendChild(d);b++}return a},tabContent(){const c=document.getElementById("resultQzLayout"),a=virtualclass.view.customCreateElement("div","","tab-content");var b=virtualclass.view.customCreateElement("div","qzOverv");b.className="tab-pane fade in active";var d=this.attemptProgressReport();b.appendChild(d);a.appendChild(b);b=virtualclass.view.customCreateElement("div","gdRpt");b.className="tab-pane fade";d=this.UI.gradeReportLayout();b.appendChild(d);a.appendChild(b);c.appendChild(a)},gradeReport(c,
a,b,d,g,k){var f=document.getElementById("qzReTbody");if(f){const m=document.createElement("tr");f.appendChild(m);f=document.createElement("th");f.scope="row";f.innerHTML=c;m.appendChild(f);c=document.createElement("td");c.innerHTML=a;m.appendChild(c);a=document.createElement("td");a.innerHTML=b;m.appendChild(a);b=document.createElement("td");b.innerHTML=`${d}%`;m.appendChild(b);d=document.createElement("td");d.innerHTML=g;m.appendChild(d);g=document.createElement("td");g.innerHTML=k;m.appendChild(g)}},
quizTimer(c,a,b){function d(){k="asc"==b?c+((Date.now()-g)/1E3|0):c-((Date.now()-g)/1E3|0);m=k/3600|0;n=k%3600/60|0;q=k%60|0;m=10>m?`0${m}`:m;n=10>n?`0${n}`:n;q=10>q?`0${q}`:q;a.textContent=`${m}:${n}:${q}`;timeTakenQuiz=`${m}:${n}:${q}`;0>=k&&("asc"!=b&&(a.textContent="00 : 00 : 00 "),g=0,"undefined"!==typeof CDTimer&&(clearInterval(CDTimer),console.log("Clear quiz interval")),ioAdapter.mustSend({quiz:{quizMsg:"quizTimeEnd",quizId:virtualclass.view.qzid},cf:"quiz"}),roles.hasControls()&&(document.getElementById("closeQzBt").disabled=
!0))}b="undefined"!==typeof b?b:"desc";let g=Date.now(),k,m,n,q;"asc"!==b&&d();CDTimer=setInterval(d,1E3)},quizModalClose(){const c=this,a=virtualclass.lang.getString("rusureCquiz");virtualclass.popup.confirmInput(a,a=>{a&&(localStorage.removeItem("quizSt"),c.quizSt={},virtualclass.storage.clearTableData("quizData"),localStorage.removeItem("qRep"),a=document.getElementById("editQuizModal"),a.parentNode.removeChild(a),c.attemptedUsers={},c.quizAttempted={},ioAdapter.mustSend({quiz:{quizMsg:"quizClosed",
quizId:c.qzid},cf:"quiz"}))})},convertSecToTime(c){if(/^\d+$/.test(c)){const a=new Date(null);a.setSeconds(c);return a.toISOString().substr(11,8)}return"00:00:00"},convertTimeToSec(c){return c?(c=c.split(":"),3600*+c[0]+60*+c[1]+ +c[2]):0},isJson(c){try{JSON.parse(c)}catch(a){return!1}return!0},UI:{id:"virtualclassQuiz",class:"virtualclass",container(){console.log("quiz layout check");var c=document.getElementById(this.id);null!=c&&c.parentNode.removeChild(c);c=virtualclass.view.customCreateElement("div",
this.id,this.class);virtualclass.vutil.insertAppLayout(c);this.layout(c)},layout(c){const a=virtualclass.view.customCreateElement("div","layoutQuiz","bootstrap container-fluid quizLayout");c.appendChild(a);c=document.createElement("nav");c.className="nav navbar ";a.appendChild(c);const b=virtualclass.view.customCreateElement("div","","vchead");b.innerHTML=virtualclass.lang.getString("Quiz");c.appendChild(b);c=virtualclass.view.customCreateElement("div","layoutQuizBody","quizMainCont");a.appendChild(c);
this.createMszBox(c);this.createModalCont(c)},createModalCont(c){const a=virtualclass.view.customCreateElement("div","bootstrapQzCont","modalCont");c.appendChild(a)},layout2(c){c=document.getElementById(c);var a=document.getElementById("listQzCont");if(null==a){const b=document.createElement("div");b.className="table-responsive";c.appendChild(b);a=virtualclass.view.customCreateElement("table","listQzCont","table table-bordered table-striped quizList");b.appendChild(a)}},listHeader(){var c=document.getElementById("listQzCont");
const a=document.createElement("tr");a.classList.add("headerContainer");a.id="headerContainer";c.insertBefore(a,c.firstChild);c=document.createElement("th");c.classList.add("controlsHeader");c.innerHTML=virtualclass.lang.getString("Controls");a.appendChild(c);var b=document.createElement("i");b.className="icon-setting";c.appendChild(b);c=document.createElement("th");c.classList.add("qnTextHeader");c.innerHTML=virtualclass.lang.getString("Quizes");a.appendChild(c);b=document.createElement("i");b.className=
"icon-help";c.appendChild(b);c=document.createElement("th");c.classList.add("timeHeader");c.innerHTML=virtualclass.lang.getString("Time");a.appendChild(c);b=document.createElement("i");b.className="icon-creator";c.appendChild(b);c=document.createElement("th");c.classList.add("qperpageHeader");c.innerHTML=virtualclass.lang.getString("Quiz/page");a.appendChild(c)},createTab(){const c=document.createElement("ul");c.classList.add("nav","nav-tabs");const a=document.createElement("li");a.className="active";
var b=document.createElement("a");b.setAttribute("data-toggle","tab");b.href="#qzOverv";b.innerHTML="Questions overview";a.appendChild(b);c.appendChild(a);const d=document.createElement("li");b=document.createElement("a");b.setAttribute("data-toggle","tab");b.href="#gdRpt";b.innerHTML=virtualclass.lang.getString("Greport");d.appendChild(b);c.appendChild(d);d.addEventListener("click",()=>{d.classList.toggle("active");a.classList.toggle("active");d.classList.contains("active")&&(document.querySelector("#gdRpt").className=
"tab-pane fade in active",document.querySelector("#qzOverv").className="tab-pane fade")});a.addEventListener("click",()=>{a.classList.toggle("active");d.classList.toggle("active");a.classList.contains("active")&&(document.querySelector("#qzOverv").className="tab-pane fade in active",document.querySelector("#gdRpt").className="tab-pane fade")});return c},resultView(c){document.getElementById("layoutQuiz");if(roles.hasControls()){this.createResultLayout();var a=document.querySelector("#contQzHead"),
b=document.querySelector("#QstnName");null==b&&(b=document.createElement("div"),b.id="QstnName",b.innerHTML=c.name,null!=a&&a.appendChild(b));let f=parseInt(c.timelimit);if(0<f){b="desc";var d="Time remaining"}else b="asc",d="Elapsed time";a=localStorage.getItem("quizSt");null!=a&&(a=JSON.parse(a),0<Object.keys(a).length&&(a=a.qtime.split(":"),f=parseInt(a[2])+60*parseInt(a[1])+3600*parseInt(a[0])));a=document.getElementById("resultQzLayout");const m=virtualclass.view.customCreateElement("div","rsQzHead",
"row col-md-12");a.appendChild(m);var g=virtualclass.view.customCreateElement("div","","col-md-3");g.innerHTML=`Time limit : <span> ${virtualclass.quiz.convertSecToTime(c.timelimit)}</span>`;m.appendChild(g);g=virtualclass.view.customCreateElement("div","","col-md-3");g.innerHTML=`No of questions : <span> ${c.noOfQus}</span>`;m.appendChild(g);c=virtualclass.view.customCreateElement("div","","col-md-4");c.innerHTML=`${d} : <span id="elsTime">00:00:00</span>`;m.appendChild(c);c=virtualclass.view.customCreateElement("button",
"closeQzBt","");c.classList.add("btn","btn-default","controls");c.innerHTML=virtualclass.lang.getString("Cquiz");m.appendChild(c);c.addEventListener("click",virtualclass.quiz.closeQzBt);c=JSON.parse(localStorage.getItem("quizSt"));null==c||"true"!=c.qClosed&&!c.qClosed?virtualclass.quiz.quizTimer(f,document.getElementById("elsTime"),b):(console.log("Don't run timer when quiz is closed"),b=document.querySelector("#elsTime"),localStorage.setItem("quizSt",JSON.stringify(c)),null!=b&&(b.innerHTML=c.qtime));
b=this.createTab();a.appendChild(b)}},createResultLayout(){var c=document.getElementById("resultQzLayout");c&&c.parentNode.removeChild(c);if(roles.hasControls()){c=document.getElementById("contQzHead");(pubbtn=document.getElementById("publishQzBt"))&&pubbtn.parentNode.removeChild(pubbtn);var a=document.querySelector("#contQzHead .close");a&&(a.parentNode.removeChild(a),a=virtualclass.view.customCreateElement("div","modalQzClose","close"),a.type="button",a.innerHTML="&times",c.appendChild(a));if(c=
document.getElementById("quizModalBody"))for(;1<c.childElementCount;)c.removeChild(c.lastChild);a=document.createElement("div");a.id="resultQzLayout";c.appendChild(a);document.getElementById("modalQzClose").addEventListener("click",()=>{virtualclass.quiz.usersFinishedQz=[];virtualclass.quiz.qGrade=[];virtualclass.quiz.quizModalClose()})}},createProgressBar(c,a){const b=virtualclass.view.customCreateElement("div","","progress");c=virtualclass.view.customCreateElement("div",`qPb_${c}`,"progress-bar");
c.role="progressbar";c.setAttribute("setaria-valuenow",a);c.setAttribute("aria-valuemin","0");c.setAttribute("aria-valuemax","100");c.style=`width:${a}%`;c.innerHTML=`${a}% Correct`;b.appendChild(c);return b},gradeReportLayout(){const c=virtualclass.view.customCreateElement("div","gradeRpBody","modal-body"),a=virtualclass.view.customCreateElement("table","","table");var b=virtualclass.view.customCreateElement("thead","","thead-inverse");const d=document.createElement("tr");var g=document.createElement("th");
g.innerHTML="#";d.appendChild(g);g=document.createElement("th");g.innerHTML="Name";d.appendChild(g);g=document.createElement("th");g.innerHTML="Time taken";d.appendChild(g);g=document.createElement("th");g.innerHTML="Grade";d.appendChild(g);g=document.createElement("th");g.innerHTML="Q. attempted";d.appendChild(g);g=document.createElement("th");g.innerHTML="Correct";d.appendChild(g);b.appendChild(d);a.appendChild(b);b=virtualclass.view.customCreateElement("tbody","qzReTbody");a.appendChild(b);c.appendChild(a);
return c},displayStudentResultScreen(c){var a=document.getElementById("mszBoxQuiz");if(a){var b=document.getElementById("stdQuizMszLayout");b&&a.removeChild(b);b=virtualclass.view.customCreateElement("div","resultDiv");a.appendChild(b);a=document.createElement("h4");a.innerHTML=`<span class='col-md-4'> Total no of questions </span>  <span class='nfqh'>: &nbsp;  ${c.grade.noofqus}</span>`;b.appendChild(a);a=document.createElement("h4");a.innerHTML=` <span class='col-md-4'> Time taken </span><span class='tth'> : &nbsp;   ${c.grade.timetaken}</span>`;
b.appendChild(a);a=document.createElement("h4");a.innerHTML=` <span class='col-md-4'> Maximum mark </span><span class='mmh'>: &nbsp;  ${c.grade.maxmarks}</span>`;b.appendChild(a);a=document.createElement("h4");a.innerHTML=`<span class='col-md-4'> Correct answers </span><span class='cah'>: &nbsp;  ${c.grade.correctans}</span>`;b.appendChild(a);a=document.createElement("h4");a.innerHTML=` <span class='col-md-4'> Questions attempted</span> <span class='qah'>: &nbsp;  ${c.grade.quesattemptd}</span>`;
b.appendChild(a);a=document.createElement("h4");a.innerHTML=` <span class='col-md-4'> You Scored </span> <span class='sch'>: &nbsp;  ${c.grade.score}</span>`;b.appendChild(a);b.style.display="block"}},createMszBox(c){const a=virtualclass.view.customCreateElement("div","mszBoxQuiz","row");c.appendChild(a)},generateModal(c,a){const b=virtualclass.view.customCreateElement("div",c,"modal");b.role="dialog";b.style.display="none";b.setAttribute("tab-index","-1");b.setAttribute("area-hidden","true");a.appendChild(b);
a=document.createElement("div");a.className="modal-dialog";b.appendChild(a);c=virtualclass.view.customCreateElement("div","quizModalBody","modal-content");a.appendChild(c);a=virtualclass.view.customCreateElement("div","contQzHead","modal-header");c.appendChild(a);const d=virtualclass.view.customCreateElement("div","","close");d.type="button";d.setAttribute("data-dismiss","modal");d.innerHTML="&times";a.appendChild(d);a=virtualclass.view.customCreateElement("div","contQzBody","modal-body");c.appendChild(a);
document.querySelector("#editQuizModal #contQzHead .close ").addEventListener("click",()=>{b.style.display="none";b.className="modal fade"})},modalContentUI(){const c=document.getElementById("contQzBody"),a=virtualclass.view.customCreateElement("div","slickQuiz","path-mod-congrea-quiz");var b=virtualclass.view.customCreateElement("h3","","quizName");a.appendChild(b);b=virtualclass.view.customCreateElement("P","timeText");a.appendChild(b);var d=virtualclass.view.customCreateElement("div","exam_navblock",
"navblock");a.appendChild(d);b=virtualclass.view.customCreateElement("div","","content");d.appendChild(b);d=virtualclass.view.customCreateElement("div","","qn_buttons multipages");b.appendChild(d);b=virtualclass.view.customCreateElement("div","","quizArea");a.appendChild(b);d=virtualclass.view.customCreateElement("div","","quizHeader");b.appendChild(d);b=virtualclass.view.customCreateElement("a","","button startQuiz");b.href="#";b.innerHTML="Get Started!";d.appendChild(b);d=virtualclass.view.customCreateElement("div",
"","quizResults");a.appendChild(d);var g=virtualclass.view.customCreateElement("h3","","quizScore");g.innerHTML="You Scored: <span></span>";d.appendChild(g);g=virtualclass.view.customCreateElement("h3","","quizLevel");b.innerHTML="<strong>Ranking:</strong> <span></span>";d.appendChild(g);b=virtualclass.view.customCreateElement("div","","quizResultsCopy");d.appendChild(b);c.appendChild(a)},qzCont(c){const a=document.getElementById("listQzCont");c=virtualclass.view.customCreateElement("tr",`contQz${c}`,
"vcQuizCont");null!=a&&a.insertBefore(c,a.firstChild)},qzCtrCont(c){var a=document.getElementById(`contQz${c}`);const b=virtualclass.view.customCreateElement("td",`ctrQz${c}`,"quizCtrCont");a.appendChild(b);a=document.createElement("a");a.href="#";a.id=`publishQz${c}`;b.appendChild(a);c=document.createElement("span");c.className="icon-publish2";c.setAttribute("data-toggle","tooltip");c.setAttribute("title",virtualclass.lang.getString("quizreviewpublish"));a.appendChild(c)},qzTextCont(c,a){a=document.getElementById(`contQz${a}`);
var b=document.createElement("td");b.classList.add("qnText");b.innerHTML=c.name;a.appendChild(b);b=document.createElement("td");b.classList.add("creator");var d=0<c.timelimit?virtualclass.quiz.convertSecToTime(c.timelimit):c.timelimit;b.innerHTML=d;a.appendChild(b);b=document.createElement("td");b.classList.add("qperpage");b.innerHTML=c.questionsperpage;a.appendChild(b)},defaultLayoutForStudent(){this.container();const c=document.getElementById("mszBoxQuiz");if(null==document.getElementById("stdQuizMszLayout")){const a=
virtualclass.view.customCreateElement("div","stdQuizMszLayout");a.innerHTML=virtualclass.lang.getString("quizmayshow");c.appendChild(a)}}}}}})(window);!function(){const d=Handlebars.template;(Handlebars.templates=Handlebars.templates||{})["docNotesMain.hbs"]=d({compiler:[7,">= 4.0.0"],main(c,a,b,d,g){let f;return`<div id="notesContainer" class="notes ddd">\n  ${c.escapeExpression((f=null!=(f=b.name||(null!=a?a.name:a))?f:b.helperMissing,"function"===typeof f?f.call(null!=a?a:c.nullContext||{},{name:"name",hash:{},data:g}):f))}\n</div>`},useData:!0})}();(function(d){function c(a){console.log(`multivideo, ${a}`)}function a(){console.log("multivideo, success setRemoteDescriptionSuccess")}function b(a){console.log(`multivideo, error setRemoteDescriptionError${a}`)}function f(a){console.log(`multivideo, error handleCreateAnswerError${a}`)}function g(){console.log("multivideo, success addIceCandidateSuccess")}function k(a){console.log(`multivideo, error addIceCandidateError${a}`)}function m(c,d){t[d]=new RTCPeerConnection(pc_config);t[d].onicecandidate=
...
b.click(function(){u.UI.displayMainVideo(this)});"undefined"!==typeof updateActiveTime&&clearTimeout(updateActiveTime);updateActiveTime=setTimeout(()=>{var a=0;for(var b in p){var c=p[b].getVideoTracks()[0];const d=document.querySelector(`#vid${b}`);null!=c?(a++,null!=d?(d.classList.add("vshow"),d.classList.remove("vhide")):console.log("Meeting mode is null")):null!=d?(d.classList.add("vhide"),d.classList.remove("vshow")):console.log("Meeting mode is null")}c="one";4<a?c="morethanfour":2<a?c="four":
1<a&&(c="two");a=document.querySelector("#virtualclassCont");b=document.querySelector("#videoConfrence");a.setAttribute("data-totalUser",c);b.setAttribute("data-totalUser",c)},3E3)}function r(a){return function(b){q(b.stream,a)}}function z(a){v[a]=new RTCPeerConnection(pc_config);v[a].onicecandidate=n(a,"apc");v[a].onaddstream=r(a);"undefined"!==typeof _localStream?(v[a].addStream(_localStream),console.log(`multivideo, Set addStream for ${a}`)):console.log(`No _localStream  for ${a}`);console.log(`multivideo, Create offer for ${a}`);
v[a].createOffer(b=>{v[a].setLocalDescription(b);console.log("multivideo, setLocalDescription with offer");ioAdapter.sendUser({cf:"mvid",sdp:b,offer:!0},a)},c)}let t,v;const p={},u={init(){this.UI.container();this.start();var a=document.querySelector("#videosWrapper .videoCont.selfVideo");a.id=`vid${virtualclass.gObj.uid}`;a.setAttribute("data-userid",virtualclass.gObj.uid);const b=this;p[virtualclass.gObj.uid]=virtualclass.multiVideo.localStream;a.addEventListener("click",function(){b.UI.displayMainVideo(this)});
...
b=document.querySelectorAll("#videosWrapper .videoCont.vshow");null!=a&&(a.dataset.activeuser=`vid_${b.length}`)}}}else console.log("localStream is undefined")},1E3)},addClass(){}};t={};v={};u.onmessage=function(c,d){if(c.hasOwnProperty("_init"))virtualclass.makeAppReady(virtualclass.apps.mv);else if(c.hasOwnProperty("offer"))m(c,d);else if(c.hasOwnProperty("candidate")){const a=new RTCIceCandidate(c.candidate);"apc"==c.pt?t[d].addIceCandidate(a,g,k):v[d].addIceCandidate(a,g,k);console.log("multivideo addIcecandidate")}else c.hasOwnProperty("answer")&&
(console.log(`multivideo setRemoteDescription for${d}`),v[d].setRemoteDescription(new RTCSessionDescription(c.sdp),a,b))};u.onUserJoin=function(a){setTimeout(()=>{z(a)},2E3)};d.MultiVideo=u})(window);(function(d){d.zoomWhiteboard=function(){return{init(){if(null==document.querySelector(".zoomControler")){var c=document.querySelector("#virtualclassAppLeftPanel");if(null!=c){const a=virtualclass.getTemplate("zoomControl")({hasControls:roles.hasControls()});c.insertAdjacentHTML("beforeend",a);this._initScaleController();c=localStorage.getItem("canvasDimension");null!=c&&(virtualclass.zoom.canvasDimension=JSON.parse(c))}}},_initScaleController(){const c=document.querySelector(".zoomControler");var a=
...
virtualclass.gObj.SCALE_FACTOR,virtualclass.zoom.canvasDimension.height/=virtualclass.gObj.SCALE_FACTOR,console.log(`Canvas pdf scale ${this.canvasScale}`),virtualclass.zoom.zoomIn("normalRender")):console.log("canvasScale is not defined yet."))},removeZoomController(){const c=document.querySelector("#virtualclassApp .zoomControler");null!=c&&virtualclass.gObj.studentSSstatus.mesharing&&c.parentNode.removeChild(c)}}}})(window);(function(d){let c=null;d.pdfRender=function(){return{firstTime:!0,shownPdf:"",canvasWrapper:null,canvasId:null,canvas:null,pdfScale:1,url:"",xhr:new CommonXHR,xhrNext:new CommonXHR,init(a,b){document.querySelector("#virtualclassCont");io.globallock=!1;virtualclass.gObj.firstNormalRender=!1;this.url="undefined"!==typeof b?virtualclass.dts.getNote(b).pdf:`${whiteboardPath}resources/sample.pdf`;this.loadPdf(this.url,a,b)},prefechPdf(a){const b=virtualclass.dts.getNote(a);this.xhrNext.send(b.pdf,this.afterPdfPrefetch.bind(this,
a),"arraybuffer")},afterPdfPrefetch(a,b){virtualclass.gObj.next={};virtualclass.gObj.next[a]=b},async loadPdf(a,b,c){virtualclass.gObj.hasOwnProperty("getDocumentTimeout")&&clearTimeout(virtualclass.gObj.getDocumentTimeout);null==virtualclass.gObj.getDocumentTimer||0==virtualclass.gObj.getDocumentTimer?(this._loadPdf(a,b,c),virtualclass.gObj.getDocumentTimer=!0,virtualclass.gObj.getDocumentTimeout=setTimeout(()=>{virtualclass.gObj.getDocumentTimer=!1},1E3)):virtualclass.gObj.getDocumentTimeout=setTimeout(()=>
{this._loadPdf(a,b,c);virtualclass.gObj.getDocumentTimer=!1},1E3)},_loadPdf(a,b,c){virtualclass.gObj.next.hasOwnProperty(c)?this.afterPdfLoad(b,c,virtualclass.gObj.next[c]):this.xhr.send(a,this.afterPdfLoad.bind(this,b,c),"arraybuffer")},async afterPdfLoad(a,b,c){this.canvasWrapper=document.querySelector(`#canvasWrapper${virtualclass.gObj.currWb}`);this.canvas=a;a={};a.data=c;null!=virtualclass.gObj.myworker&&(a.worker=virtualclass.gObj.myworker);const d=this;c=virtualclass.gObj.currWb;virtualclass.currApp==
virtualclass.currApp?(d.wbId="undefined"===typeof b?virtualclass.gObj.currWb:b,console.log(`-----------START ${virtualclass.currApp}----------`),console.log("PDF render request to pdf.js 1"),PDFJS.workerSrc=`${whiteboardPath}build/src/pdf.worker.min.js`,PDFJS.getDocument(a).then(a=>{null==virtualclass.gObj.myworker&&(virtualclass.gObj.myworker=a.loadingTask._worker);d.displayPage(a,1,()=>{},!0);d.shownPdf=a;roles.hasControls()||(d.topPosY=0,d.leftPosX=0);d.scrollEvent()})):"DocumentShare"==virtualclass.currApp&&
virtualclass.wbCommon.deleteWhiteboard(c);"undefined"!==typeof virtualclass.gObj.currWb&&null!=virtualclass.gObj.currWb&&(b=document.querySelector(`#note${b}`),null!=b&&null!=b.nextElementSibling&&virtualclass.pdfRender[virtualclass.gObj.currWb].prefechPdf(b.nextElementSibling.dataset.slide))},updateScrollPosition(a,b){"object"===typeof this.scroll[b]&&this.scroll[b].hasOwnProperty("b")?(this.scroll[b].b=a,this.scroll[b].c=this.scroll[b].b+this.scroll[b].studentVPm):console.log("Scroll b is undefined")},
scrollEvent(){const a=this.canvasWrapper,b=a.scrollTop,c=a.scrollLeft;virtualclass.topPosY=b;virtualclass.leftPosX=c;this.topPosY=b;this.leftPosX=c;const d=this;a.onscroll=function(){d.onScroll(a)}},onScroll(a,b){var c=a.scrollTop;var d=a.scrollLeft;(0<c||"undefined"!==typeof b)&&this._scroll(d,c,a,"Y");(0<d||"undefined"!==typeof b)&&this._scroll(d,c,a,"X");roles.hasControls()||virtualclass.pdfRender[virtualclass.gObj.currWb].setScrollPosition({scX:d,scY:c})},_scroll(a,b,c,d){if(roles.hasControls())return this.topPosY=
b,this.leftPosX=a,this.scrollPosition(c,d);if("Y"==d)var f=b;else"X"==d&&(f=a);this.updateScrollPosition(f,d);return null},scrollPosition(a,b){const {canvas:c}=this;if("Y"==b)var d=a.scrollTop,k=c.height;else"X"==b&&(d=a.scrollLeft,k=c.width);this[`scrollPos${b}`]=d/k*100;a=virtualclass.vutil.getElemM(`canvasWrapper${virtualclass.gObj.currWb}`,b);this[`actualVp${b}`]=a;this[`viewPort${b}`]=a/k*100;k={};k[`vp${b}`]=this[`viewPort${b}`];k[`sc${b}`]=this[`scrollPos${b}`];return k},scroll:{caclculatePosition(a,
b,c){a=this.type=c;null==this[a]&&(this[a]={});this[a].a=0;this[a].d=b;b=`canvasWrapper${virtualclass.gObj.currWb}`;c=document.querySelector(`#${b}`);null!=c&&("X"==this.type?this[a].b=c.scrollLeft:"Y"==this.type&&(this[a].b=c.scrollTop),this[a].studentVPm=virtualclass.vutil.getElemM(b,a),this[a].c=this[a].b+this[a].studentVPm)}},setScrollPosition(a){a.hasOwnProperty("scY")&&null!=a.scY&&this.scroll.caclculatePosition(a.scY,this.canvas.height,"Y");a.hasOwnProperty("scX")&&null!=a.scX&&this.scroll.caclculatePosition(a.scX,
this.canvas.width,"X")},customMoustPointer(a,b,c){this.scroll[b].e=c;this.scroll[b].e>this.scroll[b].c?(a=this.scroll[b].b+(this.scroll[b].d-this.scroll[b].c),a>this.scroll[b].e&&(a=this.scroll[b].e-(this.scroll[b].b+this.scroll[b].c)/2),console.log(`custom mouse down pointer ay=${this.scroll[b].a} by=${this.scroll[b].b} cy=${this.scroll[b].c} dy=${this.scroll[b].d} ey${this.scroll[b].e} scrollPos=${a}`),"Y"==b?this.canvasWrapper.scrollTop=a:(this.canvasWrapper.scrollLeft=a,console.log(`Scroll left ${this.canvasWrapper.scrollLeft}`)),
this.scroll[b].b=a,this.scroll[b].c=this.scroll[b].b+this.scroll[b].studentVPm):this.scroll[b].e<this.scroll[b].b&&(a=this.scroll[b].b-this.scroll[b].a,this.scroll[b].c-a<this.scroll[b].e&&(a=(this.scroll[b].b+this.scroll[b].c)/2-this.scroll[b].e),"Y"==b?this.canvasWrapper.scrollTop-=a:this.canvasWrapper.scrollLeft-=a,this.scroll[b].b=a,this.scroll[b].c=this.scroll[b].b+this.scroll[b].studentVPm)},setCustomMoustPointer(a,b){var c=`scrollDiv${b}${virtualclass.gObj.currWb}`,d=document.querySelector(`#${c}mousePointer`);
null==d&&(d=document.createElement("div"),d.className="mousepointer",d.id=`${c}mousePointer`,c=document.querySelector(`#scrollDiv${b}${virtualclass.gObj.currWb}`),null!=c&&c.appendChild(d));"Y"==b?d.style.top=`${a.y-this.scroll[b].a}px`:"X"==b&&(d.style.left=`${a.x-this.scroll[b].a}px`)},sendScroll(){virtualclass.vutil.setDefaultScroll()},sendCurrentScroll(a){let b={};if(null!=this.currentScroll){b=Object.assign(b,this.currentScroll);console.log(`Send scroll first time ${this.currentScroll}`);const c=
this;c.currentScrolltoUser=a;setTimeout(()=>{c.currentScrolltoUser=a;b.cf="scf";b.toUser=a;virtualclass.vutil.beforeSend({toUser:a,cf:"scf",scY:b.scY,vpY:b.vpY},a);console.log(`Send scroll ${b}to user ${a}`);console.log(`Send scroll ${b}`)},2E3)}},async renderPage(a,b){console.log("#### render page");if(null!=virtualclass.gObj.currWb){var f=this.pdfScale;null!=virtualclass.zoom.canvasScale&&""!=virtualclass.zoom.canvasScale&&(0<virtualclass.zoom.canvasScale?f=virtualclass.zoom.canvasScale:console.log("Why negative value"));
var g="Whiteboard"==virtualclass.currApp&&null!=this.wbId&&virtualclass.gObj.currWb!=this.wbId?-1<this.wbId.indexOf("_doc_")?this.wbId:`_doc_${this.wbId}_${this.wbId}`:virtualclass.gObj.currWb;const {canvas:k}=virtualclass.wb[g].vcan.main;virtualclass.gObj.hasOwnProperty("fitToScreen")?(k.width=d.innerWidth-virtualclass.zoom.getReduceValueForCanvas(),console.log("==== a canvas width fit to screen"),roles.hasControls()||(k.width+=50)):virtualclass.zoom.hasOwnProperty("performZoom")?(k.width=virtualclass.zoom.canvasDimension.width,
delete virtualclass.zoom.performZoom):virtualclass.zoom.hasOwnProperty("canvasDimension")?(console.log(`==== a canvas width dimension ${virtualclass.zoom.canvasDimension.width} scale=${virtualclass.zoom.canvasScale}`),k.width=virtualclass.zoom.canvasDimension.width):0===k.offsetWidth?(k.width=d.innerWidth-382,console.log("==== a canvas width click to continue")):virtualclass.isPlayMode&&(k.width=d.innerWidth-382,console.log("==== a canvas width"));this.firstTime?(this.firstTime=!1,console.log("## WHITEBOARD Canvas = ",
virtualclass.zoom.prvCanvasScale," ID ",virtualclass.gObj.currWb),f=null==virtualclass.zoom.canvasScale?a.getViewport(k.width/a.getViewport(1).width):a.getViewport(f)):f=a.getViewport(k.width/a.getViewport(1).width);virtualclass.zoom.prvCanvasScale=virtualclass.zoom.canvasScale;virtualclass.zoom.canvasScale=f.scale;k.height=f.height;const m=k.nextSibling;m.width=k.width;m.height=k.height;virtualclass.zoom.canvasDimension={};virtualclass.zoom.canvasDimension.width=k.width;virtualclass.zoom.canvasDimension.height=
k.height;console.log("==== canvas dimension ",virtualclass.zoom.canvasDimension.width);if(virtualclass.gObj.hasOwnProperty("fitToScreen")){const a=document.querySelector(`#canvasWrapper${virtualclass.gObj.currWb}`);if(null!=a&&(a.scrollHeight<=a.clientHeight||a.scrollWidth<=a.clientWidth))virtualclass.pdfRender[virtualclass.gObj.currWb].onScroll(a,!0)}delete virtualclass.gObj.fitToScreen;f={canvasContext:m.getContext("2d"),viewport:f};const n=this;console.log("PDF render initiate to display pdf on canvas 3");
a.render(f).then(()=>{console.log("PDF render DONE 4");console.log("-----------END----------");k.parentNode.dataset.pdfrender=!0;n[g]={pdfrender:!0};virtualclass.vutil.showZoom();void 0!=b&&null!=virtualclass.gObj.currWb&&n.initWhiteboardData(virtualclass.gObj.currWb);c();"object"===typeof n.shownPdf?(io.globallock=!1,io.onRecJson(null),virtualclass.gObj.hasOwnProperty("pdfNormalTimeout")&&clearTimeout(virtualclass.gObj.pdfNormalTimeout),virtualclass.gObj.firstNormalRender||null==virtualclass.gObj.currWb||
null==document.querySelector(`#canvas${virtualclass.gObj.currWb}_pdf`)||(virtualclass.zoom.adjustScreenOnDifferentPdfWidth(a),virtualclass.gObj.firstNormalRender=!0),virtualclass.vutil.removeClass("virtualclassCont","resizeWindow")):console.log("We should have a PDF here")})}},displayPage(a,b,d,g){c=d;this._displayPage(a,b,d,g)},async _displayPage(a,b,c,d){a=await a.getPage(b);virtualclass.pdfRender[virtualclass.gObj.currWb].page=a;console.log("==== to be display ",virtualclass.pdfRender[virtualclass.gObj.currWb].page,
virtualclass.gObj.currWb);"undefined"!==typeof d?await this.renderPage(a,d):await this.renderPage(a,null)},fitToScreenIfNeed(){"DocumentShare"!=virtualclass.currApp||virtualclass.gObj.docPdfFirstTime||(virtualclass.gObj.docPdfFirstTime=!0,virtualclass.zoom.zoomAction("fitToScreen"))},async initWhiteboardData(a){await virtualclass.storage.getWbData(a);"object"===typeof virtualclass.gObj.tempReplayObjs[a]&&0<virtualclass.gObj.tempReplayObjs[a].length&&(console.log("Start whiteboard replay from local storage"),
virtualclass.wb[a].utility.replayFromLocalStroage(virtualclass.gObj.tempReplayObjs[a]))},_zoom(a,b,c,d){virtualclass.vutil.setHeight(virtualclass.gObj.currWb,a,c);virtualclass.vutil.setWidth(virtualclass.gObj.currWb,a,b);const f=a.parentNode,g=virtualclass.vutil.getValueWithoutPixel(f.style.width),n=this;this.displayPage(this.shownPdf,1,()=>{if("undefined"===typeof d){console.log("Zooming whiteboard");for(var a in virtualclass.pdfRender)n.zoomwhiteboardObjects(a)}else null!=virtualclass.gObj.currWb&&
({vcan:a}=virtualclass.wb[virtualclass.gObj.currWb],a.renderAll());b>g&&f.classList.add("scrollX")})},fitWhiteboardAtScale(a){if("object"===typeof virtualclass.wb[a]){({vcan:a}=virtualclass.wb[a]);const d=a.main.children;if(0<d.length)for(const a in d){var {scaleX:b}=d[a],{scaleY:c}=d[a];b=b/virtualclass.zoom.prvCanvasScale*virtualclass.zoom.canvasScale;c=c/virtualclass.zoom.prvCanvasScale*virtualclass.zoom.canvasScale;const f=d[a].x/d[a].scaleX*b,g=d[a].y/d[a].scaleY*c;d[a].scaleX=b;d[a].scaleY=
c;d[a].x=f;d[a].y=g;d[a].setCoords()}a.renderAll()}},zoomwhiteboardObjects(a){this.fitWhiteboardAtScale(a)},zoomOutWhiteboardObjects(a){this.fitWhiteboardAtScale(a)},fitToScreenWhiteboardObjects(a){this.fitWhiteboardAtScale(a)},_zoomOut(a,b,c,d){virtualclass.vutil.setHeight(virtualclass.gObj.currWb,a,c);virtualclass.vutil.setWidth(virtualclass.gObj.currWb,a,b);const f=this;this.displayPage(this.shownPdf,1,()=>{for(const a in virtualclass.pdfRender)f.zoomOutWhiteboardObjects(a)})},_fitToScreen(a,b,
c){console.log(`==== Current whiteboard id ${virtualclass.gObj.currWb}`);virtualclass.vutil.setHeight(virtualclass.gObj.currWb,a,c);virtualclass.vutil.setWidth(virtualclass.gObj.currWb,a,b);const d=a.parentNode,f=d.offsetWidth,m=this;" "!==this.shownPdf?this.displayPage(this.shownPdf,1,()=>{for(const a in virtualclass.pdfRender)m.fitToScreenWhiteboardObjects(a);b>f&&55<b-f?d.classList.add("scrollX"):d.classList.remove("scrollX")}):console.log("ERROR : shown pdf is not available")},isBiggerCanvasHeight(a){},
isBiggerCanvasWidth(a){},calculateScaleAtFirst(a,b){a=a.getViewport(b.width/a.getViewport(1).width);this.firstTime=!1;return a},isWhiteboardAlreadyExist(a){return null!=this.canvas},defaultScroll(){null!=virtualclass.gObj.currWb&&(this.canvasWrapper.scrollTop=1)}}}})(window);(function(d){var c={order:[0],wbInd:0,initNavHandler(){const a=this;var b=document.querySelector("#virtualclassWhiteboard.whiteboard .next");null!=b&&(b.onclick=function(){virtualclass.vutil.navWhiteboard(a,a.next);c.hasOwnProperty("setNextWhiteboardTime")&&clearTimeout(c.setNextWhiteboardTime);"Whiteboard"==virtualclass.currApp&&(c.setNextWhiteboardTime=setTimeout(()=>{virtualclass.zoom.normalRender()},500))});b=document.querySelector("#virtualclassWhiteboard.whiteboard .prev");null!=b&&(b.onclick=
function(){virtualclass.vutil.navWhiteboard(a,a.prev);"object"===typeof virtualclass.wb[virtualclass.gObj.currWb]&&setTimeout(()=>{console.log("whiteboard zoom normal render");virtualclass.zoom.normalRender()},500)})},initNav(a){"undefined"===typeof this.indexNav&&(this.indexNav=new pageIndexNav("WB"));this.indexNav.init();if(roles.hasControls()){for(var b=0;b<a.length;b++)virtualclass.wbCommon.indexNav.createWbNavigationNumber(a[b],a[b]);virtualclass.wbCommon.indexNav.addActiveNavigation(virtualclass.gObj.currWb);
b=localStorage.getItem("wbOrder");null!=b&&(b=JSON.parse(b),virtualclass.wbCommon.order=b);1<this.order.length&&(virtualclass.wbCommon.rearrangeNav(this.order),this.rearrange(this.order))}else virtualclass.wbCommon.indexNav.studentWBPagination(virtualclass.gObj.currIndex-1||virtualclass.gObj.currSlide);document.querySelector("#dcPaging").onchange=function(){virtualclass.wbCommon.setCurrSlideNumber(this.value);virtualclass.wbCommon.indexNav.addActiveNavigation(this.value);virtualclass.wbCommon.readyCurrentWhiteboard(this.value);
virtualclass.gObj.currWb=this.value};virtualclass.wbCommon.indexNav.setTotalPages(a.length)},displaySlide(a){this.hideElement();const b=document.querySelector(`#note${a}`);null!=b&&(b.classList.add("current"),virtualclass.gObj.currWb=a);this.identifyFirstNote(a);this.identifyLastNote(a);roles.hasControls()||"undefined"!==typeof virtualclass.wbCommon.indexNav&&virtualclass.wbCommon.indexNav.studentWBPagination(virtualclass.gObj.currIndex-1||virtualclass.gObj.currSlide)},hideElement(){const a=document.querySelector("#virtualclassWhiteboard.whiteboard .current");
null!=a&&(console.log("Whiteboard slide remove"),a.classList.remove("current"))},currentWhiteboard(a){null==document.querySelector(`#canvas${a}`)&&(this.hideElement(),virtualclass.vutil.createWhiteBoard(a),this.displaySlide(a),virtualclass.gObj.currWb=a)},next(){this.hideElement();const a=this.whiteboardWrapperExist("next");virtualclass.wbCommon.indexNav.createWbNavigationNumber(virtualclass.gObj.wbCount);virtualclass.vutil.beforeSend({cf:"cwb",wbCount:virtualclass.gObj.wbCount,currIndex:b});b=a.slice(7);
var b=this.order.indexOf(b);this.whiteboardExist(a)||virtualclass.vutil.createWhiteBoard(a,b);virtualclass.vutil.beforeSend({cf:"cwb",diswb:!0,wid:a,currIndex:b});this.setCurrSlideNumber(a);virtualclass.wbCommon.indexNav.addActiveNavigation(a);virtualclass.wbCommon.indexNav.UI.pageNavHandler("right");this.displaySlide(a);virtualclass.gObj.currWb=a},newPage(){this.hideElement();const a=virtualclass.gObj.currWb.slice(7);virtualclass.gObj.wbCount++;const b=this.whiteboardWrapperExist("next");virtualclass.gObj.hasOwnProperty("currSlide")&&
-1==virtualclass.gObj.wIds.indexOf(Number(virtualclass.gObj.wbCount))&&(console.log("wids, From virtualclass "),virtualclass.gObj.wIds.push(virtualclass.gObj.wbCount));const c=`${"_doc_0_"}${virtualclass.gObj.wbCount}`;var d=this.order.indexOf(a);this.whiteboardExist(c)||virtualclass.vutil.createWhiteBoard(c,d);this.setCurrSlideNumber(c);virtualclass.wbCommon.indexNav.UI.pageNavHandler("right");this.displaySlide(c);d=0;null==b?(this.order.push(virtualclass.gObj.wbCount),virtualclass.wbCommon.indexNav.createWbNavigationNumber(virtualclass.gObj.wbCount,
virtualclass.gObj.wbCount),d=this.order.length,virtualclass.wbCommon.identifyLastNote(virtualclass.gObj.currWb)):(d=this.order.indexOf(a),this.order.splice(d+1,0,virtualclass.gObj.wbCount),this.rearrange(this.order),this.indexNav.index=d+1,this.rearrangeNav(this.order));this.wbInd=d+1;virtualclass.vutil.beforeSend({cf:"cwb",wbCount:virtualclass.gObj.wbCount,currIndex:d+1});virtualclass.gObj.currWb=c;this.indexNav.setTotalPages(virtualclass.gObj.wIds.length);virtualclass.wbCommon.indexNav.addActiveNavigation(virtualclass.gObj.currWb);
document.querySelector("#dcPaging").onchange=function(){virtualclass.wbCommon.setCurrSlideNumber(this.value);virtualclass.wbCommon.indexNav.addActiveNavigation(this.value);virtualclass.wbCommon.readyCurrentWhiteboard(this.value);virtualclass.gObj.currWb=this.value}},rearrange(a){const b=document.getElementsByClassName("whiteboardContainer")[0],c=document.createElement("div");c.className="whiteboardContainer";for(let b=0;b<a.length;b++){const d=document.getElementById(`note_doc_0_${a[b]}`);d&&c.appendChild(d)}b.parentNode.replaceChild(c,
b)},rearrangeNav(a){document.querySelector("#dcPaging").innerHTML="";for(var b=0;b<=virtualclass.gObj.wbCount;b++)virtualclass.wbCommon.indexNav.createWbNavigationNumber(a[b],b);if("Whiteboard"==virtualclass.currApp)var c=virtualclass.gObj.currWb.split("doc_0_")[1];a=this.order.indexOf(c);(b=document.querySelector(".congrea #dcPaging .noteIndex.active"))&&b.classList.remove("active");if(b=document.querySelector(`#index${c}`))b.classList.add("active"),b.selected="selected";c=document.querySelector("#dcPaging .hid.right.active");
const d=document.querySelector("#dcPaging .hid.left.active");if(c||d)var k=c?c.title:d.title;"Whiteboard"==virtualclass.currApp?this.index=+a+1:(this.index=null!=k?k:null!=b&&"undefined"!==typeof b?b.title:1,virtualclass.dts.order.length||(this.index=0),k=document.querySelector("#docShareNav"),this.index?(k.classList.add("show"),k.classList.remove("hide")):(k.classList.add("hide"),k.classList.remove("show")))},setCurrSlideNumber(a){a=a.split("_");0<a.length&&(virtualclass.gObj.currSlide=a[a.length-
1],roles.hasControls()||"undefined"!==typeof virtualclass.wbCommon.indexNav&&virtualclass.wbCommon.indexNav.studentWBPagination(virtualclass.gObj.currIndex-1||virtualclass.gObj.currSlide))},prev(){this.hideElement();var a=this.whiteboardWrapperExist("prev");this.readyCurrentWhiteboard(a);this.setCurrSlideNumber(a);virtualclass.wbCommon.indexNav.addActiveNavigation(a);virtualclass.wbCommon.indexNav.UI.pageNavHandler("left");a=document.querySelector(`#${virtualclass.wb[a].prvTool}`);null==a||a.classList.contains("active")||
a.classList.add("active")},readyCurrentWhiteboard(a){null!=a?(this.whiteboardExist(a)||virtualclass.vutil.createWhiteBoard(a),this.displaySlide(a),virtualclass.gObj.currWb=a,virtualclass.vutil.beforeSend({cf:"cwb",diswb:!0,wid:virtualclass.gObj.currWb}),console.log(`whiteboard slide send=${virtualclass.gObj.currWb}`)):alert("Elemennt is NULL")},whiteboardExist(a){return null!=document.querySelector(`#canvas${a}`)},whiteboardWrapperExist(a){var b=virtualclass.gObj.currWb;if(null!=b){b=document.querySelector(`#note${b}`);
if("prev"==a)var c=b.previousElementSibling;else"next"==a&&(c=b.nextElementSibling);return null!=c?c.dataset.wbId:null}},readyElements(a){const b=document.querySelector("#virtualclassWhiteboard .whiteboardContainer");for(let d=0;d<a.length;d++){const f=`_doc_0_${a[d]}`;var c=document.querySelector(`#note${f}`);null==c&&(c=document.createElement("div"),c.id=`note${f}`,c.dataset.wbId=f,c.className="canvasContainer",b.appendChild(c))}},reArrangeElements(a){const b=document.querySelector("#virtualclassWhiteboard .whiteboardContainer"),
c=document.createElement("div");c.className="whiteboardContainer";for(let b=0;b<a.length;b++){var d=`note_doc_0_${a[b]}`;d=document.getElementById(d);null!=c&&null!=d?c.appendChild(d):console.log(`Error temp div is null ${c}`)}b.parentNode.replaceChild(c,b)},identifyFirstNote(a){const b=document.querySelector("#virtualclassWhiteboard");"_doc_0_0"==a?b.classList.add("firstNote"):b.classList.remove("firstNote")},identifyLastNote(a){const b=document.querySelector("#virtualclassWhiteboard");this.order.indexOf(a.slice(7))+
1==this.order.length?b.classList.add("lastNote"):b.classList.remove("lastNote")},removeAllContainers(){const a=document.querySelectorAll("#virtualclassWhiteboard .whiteboardContainer .canvasContainer");let b;for(let c=0;c<a.length;c++)b=a[c],b.parentNode.removeChild(b)},clearNavigation(){const a=document.getElementById("dcPaging");for(;a.firstChild;)a.removeChild(a.firstChild);if(roles.hasControls())virtualclass.wbCommon.indexNav.createWbNavigationNumber(0,0);else{const b=document.createElement("span");
b.id="stdPageNo";a.appendChild(b);virtualclass.wbCommon.indexNav.studentWBPagination(0)}},deleteWhiteboard(a){delete virtualclass.wb[a];delete virtualclass.pdfRender[a];"Whiteboard"==virtualclass.currApp&&(a=document.querySelector(`#containerWb${a}`),null!=a&&a.parentNode.removeChild(a))}};d.wbCommon=c})(window);const serverData={rawData:{video:[],ppt:[],docs:[]},fetchAllData(d){console.log("Fetch all data");this.cb=d;console.log("Request get document url");this.requestData(virtualclass.api.GetDocumentURLs)},requestData(d){this.rawData={video:[],ppt:[],docs:[]};const c=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");c.open("POST",d);const a=this;c.onreadystatechange=function(){3<c.readyState&&200==c.status&&a.afterResponse(c.responseText)};c.setRequestHeader("x-api-key",wbUser.lkey);
c.setRequestHeader("x-congrea-authuser",wbUser.auth_user);c.setRequestHeader("x-congrea-authpass",wbUser.auth_pass);c.setRequestHeader("x-congrea-room",wbUser.room);c.setRequestHeader("Content-Type","application/json");c.send(null)},afterResponse(d){"ERROR"!=d&&(virtualclass.serverData.formatRawData(d),virtualclass.gObj.fetchedData=!0,"undefined"!==typeof virtualclass.serverData.cb&&virtualclass.serverData.cb())},formatRawData(d){d=JSON.parse(d);this.awsUrlArr(d)},awsUrlArr(d){this.rawData={video:[],
ppt:[],docs:[]};const c=[];d=d.Items;for(let q=0;q<d.length;q++)if(d[q].hasOwnProperty("filetype"))switch(d[q].filetype.S){case "doc":var a=this.processObj(d[q]);var b=d[q].processed_data.M.commonpath.S;var f=parseInt(d[q].processed_data.M.count.N);if(null!=b&&null!=f){b=`${"https://media.congrea.net"}/${d[q].processed_data.M.commonpath.S}`;a.notes={};a.notesarr=[];let r=[],z=[];a.hasOwnProperty("deletednes")&&(r=a.deletednes);a.hasOwnProperty("disablednes")&&(z=a.disablednes);for(let c=1;c<=f;c++){var g=
c;var k=3-`${g}`.length;var m=(0<k?Array(++k).join("0"):"")+g;g=`${b}/image/${m}.${d[q].processed_data.M.image.M.type.S}`;k=`${b}/pdf/${m}.pdf`;m=`${b}/thumbnail/${m}.${d[q].processed_data.M.thumbnail.M.type.S}`;var n=99<c?`${a.fileuuid}_${c}`:9<c?`${a.fileuuid}_0${c}`:`${a.fileuuid}_00${c}`;const f={};0<r.length&&-1<r.indexOf(c)&&(f.deletedn=n);f.id=n;f.pdf=k;f.image=g;f.thumbnail=m;0<z.length?-1<z.indexOf(c)?f.status=0:f.status=1:f.status=1;a.notes[n]=f;a.notesarr.push(f)}c.push(a);this.rawData.docs.push(a)}break;
...
disableRaiseHand(a){chatContainerEvent.elementFromShadowDom(`#ml${a} .controllerRaiseH`);var b=chatContainerEvent.elementFromShadowDom(`#ml${a} .controllerRaiseH`);const d=b.querySelector("a.congtooltip"),k=d.querySelector(".RaiseHandImg");ioAdapter.mustSendUser({data:{action:"disable"},cf:"raiseHand"},a);b.classList.remove("enabled");b.classList.add("disabled");k.setAttribute("data-raisehand-disable",!0);d.setAttribute("data-title","disabled");b.style.pointerEvents="none";virtualclass.user.control.updateUser(a,
...
`{border-left: 1px solid ${a.fcolor}!important}`+"#virtualclassCont.congrea #screenController .share button,#virtualclassCont.congrea #stopScreenShare button"+`{border-right:1px solid ${b.fcolor}!important}`+"#virtualclassCont.congrea #screenController .share button:hover,#virtualclassCont.congrea #stopScreenShare button:hover "+`{background-image: linear-gradient(to bottom, ${d.fcolor} 0%,${d.scolor} 100%) !important;color:${c}!important}`+"#virtualclassCont.congrea  #playController button"+`{background-image:none !important;color:${c}!important; border-right: 1px solid ${a.fcolor}!important}`+
"#virtualclassCont.congrea #virtualclassAppLeftPanel .containerWb .commandToolsWrapper .shapesToolbox.active"+`{background-image: radial-gradient(ellipse at center, ${b.fcolor} 0%,${b.scolor} 100%);} `)},makeThemeReadyEditor(c,a,b,d){this.addCss(`${"#virtualclassCont.congrea a.vceditor-btn#virtualclassCont.congrea .containerWb .commandToolsWrapper .tool ul.fontSizeList span.selected,{background-color: "}${b.fcolor}} `+"#virtualclassCont.congrea a.vceditor-btn"+`{color: ${b.frontColor}} `+"#virtualclassCont.congrea #alleditorRichContainer"+
`{background-color: ${b.frontColor}} `+"#virtualclassCont.congrea .vceditor-toolbar"+`{background-image: linear-gradient(to bottom, ${a.fcolor} 0%,${a.scolor} 100%) !important} `+"#virtualclassCont.congrea a.vceditor-btn:hover"+`{color:${d.frontColor}!important}`+"#virtualclassCont.congrea a.vceditor-btn:hover"+`{background-image: radial-gradient(ellipse at center, ${d.fcolor} 0%,${d.scolor} 100%) !important}`+"#virtualclassCont.congrea .commandToolsWrapper .tool.active a"+`{background-image: radial-gradient(ellipse at center, ${b.fcolor} 0%,${b.scolor} 100% !important)} `+
"#virtualclassCont .vceditor-dropdown-menu a:hover"+`{background-color:${a.fcolor}!important}`)},makeThemeReadyRightPanel(c,a,b,d){this.addCss(`${"#virtualclassCont.congrea #recordPlay .rv-vanilla-modal-body #downloadPcCont #downloadSessionText,#virtualclassCont.congrea #virtualclassAppRightPanel #audioWidget{background-image: linear-gradient(to bottom, "}${a.fcolor} 0%,${a.scolor} 100%) !important}`+"#virtualclassCont.congrea #chatWidget .chatBarTab"+`{background: linear-gradient(to bottom, ${a.fcolor} 0%,${a.scolor} 100%) !important}`+
"#virtualclassCont.congrea #stickycontainer .inner_bt:hover, #virtualclassCont.congrea #stickycontainer .stdRaiseHand:hover, #virtualclassCont.congrea #stickycontainer #contrAudioAll:hover, #virtualclassCont.congrea #virtualclassAppRightPanel #mainAudioPanel li:hover, #virtualclassCont.congrea #virtualclassAppRightPanel #mainAudioPanel li a:hover,#virtualclassCont.congrea #audioWidget #speakerPressOnce:hover,#virtualclassCont.congrea #audioTest-box:hover,#virtualclassCont.congrea #playButton:hover, #virtualclassCont.congrea #alwaysPress:hover"+
...
c.querySelector("#dcPaging").addEventListener("change",function(){virtualclass.dts.docs.goToNavs(this.value)()});this.shownPage(this.width);this.addActiveNavigation();this.setTotalPages(virtualclass.dts.order.length)};a.prototype.setTotalPages=function(a){var b=c.querySelector("#docShareNav #totalPages");b&&(roles.hasControls(),b.innerHTML=` of ${a}`,b=c.querySelector("#docShareNav"),a?(b.classList.add("show"),b.classList.remove("hide")):(b.classList.add("hide"),b.classList.remove("show")))};a.prototype.adjustPageNavigation=
function(a,d){if("right"==d){d=c.querySelectorAll(".noteIndex.shw");if(d.length)var b=d[d.length-1],f=parseInt(b.getAttribute("title"));for(;f<a;f++){"DocumentShare"==virtualclass.currApp&&virtualclass.dts.indexNav.UI.setClassPrevNext();var m=c.querySelector(".noteIndex.hid.right");m&&(m.classList.remove("hid","right"),m.classList.add("shw"),b=c.querySelector(".noteIndex.shw"))&&(b.classList.remove("shw"),b.classList.add("hid","left"))}"DocumentShare"==virtualclass.currApp&&(a=virtualclass.dts.docs.currNote,
(a=c.querySelector(`.congrea #dcPaging #index${a}`))&&!a.classList.contains("active")&&a.classList.add("active"))}else{for((d=c.querySelector(".noteIndex.shw"))&&(f=parseInt(d.getAttribute("title")));f>a;f--)"DocumentShare"==virtualclass.currApp&&virtualclass.dts.indexNav.UI.setClassPrevNext(),d=c.querySelectorAll(".noteIndex.hid.left"),d.length&&(m=d[d.length-1]),m&&(m.classList.remove("hid","left"),m.classList.add("shw"),d=c.querySelectorAll(".noteIndex.shw"),d.length&&(b=d[d.length-1]),b&&(b.classList.remove("shw"),
b.classList.add("hid","right")));"DocumentShare"==virtualclass.currApp&&(a=virtualclass.dts.docs.currNote,(a=c.querySelector(`.congrea #dcPaging #index${a}`))&&!a.classList.contains("active")&&(a.classList.add("active"),a.setAttribute("selected","selected")))}};a.prototype.removeNav=function(){const a=c.getElementById("docShareNav");for(;a.firstChild;)a.removeChild(a.firstChild)};a.prototype.addActiveNavigation=function(a){this.addActiveClass(a);a=c.querySelector("#rightNavPage.disable");this.UI.isNodeAvailable(".noteIndex.shw.active",
"next")?null!=a&&("Whiteboard"==virtualclass.currApp?this.UI.setArrowStatus("rightNavPage","enable"):virtualclass.dts.indexNav.UI._setArrowStatusDocs(c.getElementById("rightNavPage"),"enable","disable")):"Whiteboard"==virtualclass.currApp?this.UI.setArrowStatus("rightNavPage","disable"):virtualclass.dts.indexNav.UI._setArrowStatusDocs(c.getElementById("rightNavPage"),"disable","enable");a=c.querySelector("#leftNavPage.disable");this.UI.isNodeAvailable(".noteIndex.shw.active","prev")?null!=a&&("Whiteboard"==
virtualclass.currApp?this.UI.setArrowStatus("leftNavPage","enable"):virtualclass.dts.indexNav.UI._setArrowStatusDocs(c.getElementById("leftNavPage"),"enable","disable")):"Whiteboard"==virtualclass.currApp?this.UI.setArrowStatus("leftNavPage","disable"):virtualclass.dts.indexNav.UI._setArrowStatusDocs(c.getElementById("leftNavPage"),"disable","enable")};a.prototype.addActiveClass=function(a){if("Whiteboard"==virtualclass.currApp){var b=a.split("doc_0_")[1];var d=virtualclass.gObj.wbCount+1}else d=
virtualclass.dts.order.length;(a=c.querySelector(".congrea #dcPaging .noteIndex.active"))&&a.classList.remove("active");b="DocumentShare"==virtualclass.currApp?virtualclass.dts.docs.currNote:b;if(a=c.querySelector(`#index${b}`)){a.classList.add("active");a.selected="selected";var k=c.querySelector("#totalPages");k&&k.parentNode.removeChild(k);const b=c.createElement("span");b.id="totalPages";k=c.querySelector("#pageAnc");k.appendChild(b);this.setTotalPages(d)}d=c.querySelector("#dcPaging .hid.right.active");
k=c.querySelector("#dcPaging .hid.left.active");if(d||k){if(d){var m=d.title;d="right"}else m=k.title,d="left";this.adjustPageNavigation(parseInt(m),d)}if("Whiteboard"==virtualclass.currApp){if(this.index=+b+1,m=c.querySelector(".noteIndex.active"))k=c.querySelector("#currIndex"),k.innerHTML=m.innerHTML,ioAdapter.mustSend({wbData:"wbIndex",wbIndex:m.innerHTML,cf:"wbData"})}else this.index=null!=m?m:null!=a&&"undefined"!==typeof a?a.title:1,virtualclass.dts.order.length||(this.index=0),m=c.querySelector("#docShareNav"),
this.index?(m.classList.add("show"),m.classList.remove("hide")):(m.classList.add("hide"),m.classList.remove("show")),c.querySelector("#currIndex").innerHTML=this.index;m=c.getElementById("teacherCurrPage");null!=m&&(m.innerHTML=this.index)};a.prototype.rearrangePageNavigation=function(a){const b=c.getElementById("dcPaging");if(b){const f=c.createElement("div");f.id="dcPaging";if(null!=f){const g=[];if(this.oldOrder)for(var d=0;d<this.oldOrder.length;d++){var k=this.oldOrder[d];g[k]=c.getElementById(`index${this.oldOrder[d]}`).className}for(d=
0;d<a.length;d++){const b=c.getElementById(`index${a[d]}`);this.oldOrder&&(k=this.oldOrder[d],b.className=g[k]);f.appendChild(b);b.innerHTML=d+1;b.title=d+1}b.parentNode.replaceChild(f,b)}}this.UI.setClassPrevNext();this.addActiveNavigation()};a.prototype.shownPage=function(a){const b=c.querySelectorAll(".noteIndex");a=this.countNumberOfNavigation(a);for(let c=0;c<b.length;c++)b[c].className=c>a?"noteIndex hid right":"noteIndex shw"};a.prototype.countNumberOfNavigation=function(a){return 1200<=a?
8:700<=a?5:500<=a?4:2};a.prototype.movePageIndex=function(a){virtualclass.dts.indexNav.addActiveNavigation();virtualclass.dts.indexNav.UI.setClassPrevNext();virtualclass.dts.indexNav.UI.pageNavHandler(a)};a.prototype.createDocNavigationNumber=function(a,d){const b=c.createElement("span");b.id=`index${a}`;b.value=a;b.className="noteIndex";const f=d+1;b.setAttribute("title",f);b.innerHTML=f;this.subCont.appendChild(b);virtualclass.dts.docs.currNote==a&&(b.classList.add("active"),c.querySelector("#currIndex").innerHTML=
d+1);this.index=f;b.onclick=virtualclass.dts.docs.goToNavs(a)};a.prototype.createWbNavigationNumber=function(a,d){const b=`_doc_0_${a}`,f=c.createElement("span");f.id=`index${a}`;f.className="noteIndex";f.setAttribute("title",a+1);f.innerHTML=d+1;f.setAttribute("value",b);this.subCont.appendChild(f);f.className=a>this.shownPages?"noteIndex hid right":"noteIndex shw";virtualclass.gObj.currWb==b&&(virtualclass.wbCommon.indexNav.addActiveNavigation(b),c.querySelector("#currIndex").innerHTML=d+1);f.onclick=
function(){virtualclass.wbCommon.setCurrSlideNumber(b);virtualclass.wbCommon.indexNav.addActiveNavigation(b);virtualclass.wbCommon.readyCurrentWhiteboard(b);virtualclass.gObj.currWb=b}};a.prototype.newWbpage=function(a){virtualclass.vutil.navWhiteboard(virtualclass.wbCommon,virtualclass.wbCommon.newPage);virtualclass.wbCommon.hasOwnProperty("setNextWhiteboardTime")&&clearTimeout(virtualclass.wbCommon.setNextWhiteboardTime);"Whiteboard"==virtualclass.currApp&&(virtualclass.wbCommon.setNextWhiteboardTime=
setTimeout(()=>{virtualclass.zoom.normalRender()},500))};a.prototype.studentDocNavigation=function(a){if(virtualclass.dts.order){a=virtualclass.dts.order.indexOf(a);var b=c.querySelector("#docShareNav");-1==a?(b.classList.add("hide"),b.classList.remove("show")):(b.classList.add("show"),b.classList.remove("hide"));if(b=c.getElementById("stdPageNo"))b.innerHTML=a+1;const d=this;setTimeout(()=>{d.setTotalPages(virtualclass.dts.order.length)},100)}};a.prototype.studentWBPagination=function(a){const b=
c.getElementById("stdPageNo");if(b){b.innerHTML=parseInt(a)+1;const c=this;setTimeout(()=>{c.setTotalPages(virtualclass.gObj.wbCount+1)},100)}};a.prototype.UI={container(){var a=c.getElementById("docShareNav");if(roles.hasControls()){for(;a.firstChild;)a.removeChild(a.firstChild);a=c.querySelector(".congrea #docShareNav");const b=c.createElement("span");b.id="leftNavPage";b.className="pageNav";a.appendChild(b);var d=c.createElement("span");d.classList.add("navArrow");d.innerHTML="";a.appendChild(d);
d=c.createElement("span");d.classList.add("pageHead");d.innerHTML="Page";a.appendChild(d);d=c.createElement("div");d.id="ancCont";d.classList.add("noCont");a.appendChild(d);var g=c.createElement("div");g.id="pageAnc";d.appendChild(g);d=c.createElement("span");d.id="currIndex";g.appendChild(d);g.addEventListener("click",()=>{const a=c.querySelector("#dcPaging");a&&(a.classList.toggle("close"),a.classList.toggle("open"))});"Whiteboard"==virtualclass.currApp&&(d=c.createElement("span"),d.id="addNewPage",
d.className="newPage",a.appendChild(d),g=c.createElement("span"),d.appendChild(g),g.className="icon-newPage congtooltip",g.setAttribute("data-title",virtualclass.lang.getString("newPage")),g.addEventListener("click",function(){virtualclass.wbCommon.indexNav.newWbpage(this.type)}));var k=c.createElement("div");k.id="dcPaging";k.classList.add("close");a.appendChild(k);d=c.createElement("span");d.id="rightNavPage";d.className="pageNav";a.appendChild(d);const f=this;a.addEventListener("mouseover",()=>
{k.classList.add("open");k.classList.remove("close")});a.addEventListener("mouseout",()=>{k.classList.add("close");k.classList.remove("open")});b.addEventListener("click",()=>{"Whiteboard"==virtualclass.currApp?f.isNodeAvailable(".noteIndex.shw.active","prev")?c.querySelector("#virtualclassWhiteboard .prev").click():f.setArrowStatus("leftNavPage","disable"):(c.getElementById("docsprev").click(),f.setArrowStatus("leftNavPage","disable"))});d.addEventListener("click",function(){"Whiteboard"==virtualclass.currApp?
f.isNodeAvailable(".noteIndex.shw.active","next")?(c.querySelector("#virtualclassWhiteboard .next").click(),virtualclass.gObj.currWb.split("_doc_0")[1]>this.shownPages&&(c.querySelector(".noteIndex.shw").className="noteIndex hid left")):f.setArrowStatus("rightNavPage","disable"):(c.getElementById("docsnext").click(),f.setArrowStatus("rightNavPage","disable"))})}else a=c.querySelector(".congrea #docShareNav"),c.querySelector(".congrea #stdPageNo")||(d=c.createElement("span"),d.classList.add("pageHead"),
d.innerHTML="Page",a.appendChild(d),k=c.createElement("div"),k.id="dcPaging",a.appendChild(k),a=c.createElement("span"),a.id="stdPageNo",k.appendChild(a));roles.hasControls()||(a=c.querySelector("#totalPages"),a||(a=c.createElement("span"),a.id="totalPages",a.className="pages",null!=k&&k.appendChild(a)))},setClassPrevNext(){const a=c.querySelector(`#documentScreen #note${virtualclass.dts.docs.currNote}`);if(null!=a)var d=a.previousElementSibling,g=a.nextElementSibling;c.querySelector("#leftNavPage")&&
(d?this.setArrowStatus("leftNavPage","enable"):this.setArrowStatus("leftNavPage","disable"));c.querySelector("#rightNavPage")&&(g?this.setArrowStatus("rightNavPage","enable"):this.setArrowStatus("rightNavPage","disable"))},pageNavHandler(a,d){if("right"==a){if(a=c.querySelector(".noteIndex.hid.right.active")){a.classList.remove("hid");a.classList.remove("right");a.classList.add("shw");var b=c.querySelector(".noteIndex.shw");b&&(b.classList.remove("shw"),b.classList.add("hid","left"))}}else if(a=c.querySelector(".noteIndex.hid.left.active"))a.classList.remove("hid"),
a.classList.remove("left"),a.classList.add("shw"),a=c.querySelectorAll(".noteIndex.shw"),a.length&&(b=a[a.length-1]),b&&(b.classList.remove("shw"),b.classList.add("hid"),b.classList.add("right"))},setArrowStatus(a,d){const b="disable"==d?"enable":"disable";a=c.getElementById(a);"Whiteboard"==virtualclass.currApp?(a.classList.add(d),a.classList.remove(b)):virtualclass.dts.docs.currNote==virtualclass.dts.order[virtualclass.dts.order.length-1]&&this._setArrowStatusDocs(a,d,b)},_setArrowStatusDocs(a,
c,d){a.classList.add(c);a.classList.remove(d)},isNodeAvailable(a,d){d="next"==d?"nextSibling":"previousSibling";return(a=c.querySelector(a))&&null!=a[d]}};d.pageIndexNav=a})(window,document);const chatContainerEvent={ub:"init_chatBox",ac:"footerControler",ch:"footerControler",er:"footerControler",rs:"footerControler",rh:"footerControler",getEvent(d){({event:d}=d.dataset);return this[d]},init_chatBox(d,c){var a=$(d);let b;"videoSubWrapper"==d.className||"userVideos"==d.classList?(b=a[0].id,d=b.replace("user","")):(b=a.attr("href"),d=b.replace("#",""));"undefined"!==typeof b&&(a=0<a.parent(".usern").length?a.html():chat_div.shadowRoot.querySelector(`#ml${d} .usern a`).title,-1==$.inArray(d,
...
function(c){if(micTesting.playAudio){c=c.outputBuffer.getChannelData(0);const a=d.getAudioChunks();if(null!=a)for(i=0;i<a.length;i++)c[i]=a[i]}else for(c=c.outputBuffer.getChannelData(0),i=0;i<c.length;i++)c[i]=0},this.audioPlayerNode.connect(virtualclass.media.audioVisual.audioCtx.destination))},getAudioChunks(){if(5<=this.audioToBePlay.length){for(;2<=this.audioToBePlay.length;)this.audioToBePlay.shift();this.aChunksPlay=!0;return this.audioToBePlay.shift()}if(2<=this.audioToBePlay.length||0<this.audioToBePlay.length&&
!0===this.aChunksPlay)return this.aChunksPlay=!0,this.audioToBePlay.shift();this.aChunksPlay=!1},makeAudioEmpty(){this.playAudio=!1;this.audioToBePlay=[]},destroyAudioNode(){this.makeAudioEmpty();if(virtualclass.gObj.meetingMode){const d=virtualclass.multiVideo.localStream.getTracks();for(let c=0;c<d.length;c++)d[c].stop()}else this.audioPlayerNode&&(this.audioPlayerNode.disconnect(virtualclass.media.audioVisual.audioCtx.destination),delete this.audioPlayerNode,this.audioPlayerNode=!1),this.audioCreatorNode&&
(this.audioCreatorNode.disconnect(virtualclass.media.audioVisual.audioCtx.destination),delete this.audioCreatorNode,"Firefox"!=virtualclass.system.mybrowser.name&&"iOS"!=virtualclass.system.mybrowser.name&&"Safari"!=virtualclass.system.mybrowser.name||virtualclass.media.audioVisual.audioCtx.close(),virtualclass.precheck.mic.hasOwnProperty("graphProcessor")&&null!=virtualclass.precheck.mic.graphProcessor&&virtualclass.precheck.mic.graphProcessor.disconnect(virtualclass.precheck.mic.graphContext.destination),
"Firefox"!=virtualclass.system.mybrowser.name&&"iOS"!=virtualclass.system.mybrowser.name&&"Safari"!=virtualclass.system.mybrowser.name||null==virtualclass.precheck.mic.graphContext||virtualclass.precheck.mic.graphContext.close(),delete virtualclass.media.audioVisual.audioCtx)}};function CommonXHR(){this.init()}CommonXHR.prototype.init=function(){this.httpObj=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");this.onReadStateChange()};CommonXHR.prototype.onReadStateChange=function(){const d=this;this.httpObj.onreadystatechange=function(){4==d.httpObj.readyState&&"undefined"!==typeof d.cb&&(200==d.httpObj.status?d.cb(d.httpObj.response):d.cb("ERROR"))}};
CommonXHR.prototype.send=function(d,c,a){console.log(`Common URL ${d}`);this.cb=c;this.httpObj.open("GET",d,!0);this.httpObj.responseType=a;this.httpObj.setRequestHeader("x-api-key",wbUser.lkey);this.httpObj.setRequestHeader("x-congrea-authuser",wbUser.auth_user);this.httpObj.setRequestHeader("x-congrea-authpass",wbUser.auth_pass);this.httpObj.setRequestHeader("x-congrea-room",wbUser.room);this.httpObj.withCredentials=!0;this.httpObj.send()};(function(d){d.settings={info:{allowoverride:null,disableAttendeeAudio:null,disableAttendeePc:null,disableAttendeeGc:null,disableAttendeeVideo:null,disableRaiseHand:null,disableUserList:null,x8:null,x16:null,enableRecording:null,recAllowpresentorAVcontrol:null,recShowPresentorRecordingStatus:null,recDisableAttendeeAV:null,recallowattendeeAVcontrol:null,showAttendeeRecordingStatus:null,trimRecordings:null},user:{},init(){let c=localStorage.getItem("settings");c||(c=virtualclassSetting.settings);c=
virtualclass.settings.onLoadSettings(c);for(const a in c)virtualclass.settings.info.hasOwnProperty(a)&&(virtualclass.settings.info[a]=c[a]);this.recording.init()},settingsToHex(c){const a=[];a[0]=+c.allowoverride;a[1]=+c.disableAttendeeAudio;a[2]=+c.disableAttendeeVideo;a[3]=+c.disableAttendeePc;a[4]=+c.disableAttendeeGc;a[5]=+c.disableRaiseHand;a[6]=+c.disableUserList;a[7]=+c.enableRecording;a[8]=+c.recAllowpresentorAVcontrol;a[9]=+c.recShowPresentorRecordingStatus;a[10]=+c.recDisableAttendeeAV;
a[11]=+c.recallowattendeeAVcontrol;a[12]=+c.showAttendeeRecordingStatus;a[13]=+c.trimRecordings;a[14]=+c.x8;a[15]=+c.x16;return virtualclass.settings.binaryToHex(a.join(""))},parseSettings(c){const a={};(c=virtualclass.settings.hexToBinary(c))&&(c=c.split(""));a.allowoverride=!!+c[0];a.disableAttendeeAudio=!!+c[1];a.disableAttendeeVideo=!!+c[2];a.disableAttendeePc=!!+c[3];a.disableAttendeeGc=!!+c[4];a.disableRaiseHand=!!+c[5];a.disableUserList=!!+c[6];a.enableRecording=!!+c[7];a.recAllowpresentorAVcontrol=
!!+c[8];a.recShowPresentorRecordingStatus=!!+c[9];a.recDisableAttendeeAV=!!+c[10];a.recallowattendeeAVcontrol=!!+c[11];a.showAttendeeRecordingStatus=!!+c[12];a.trimRecordings=!!+c[13];a.x8=!!+c[14];a.x16=!!+c[15];return a},hexToBinary(c){let a,b="";const d={0:"0000",1:"0001",2:"0010",3:"0011",4:"0100",5:"0101",6:"0110",7:"0111",8:"1000",9:"1001",a:"1010",b:"1011",c:"1100",d:"1101",e:"1110",f:"1111",A:"1010",B:"1011",C:"1100",D:"1101",E:"1110",F:"1111"};for(a=0;a<c.length;a+=1)if(d.hasOwnProperty(c[a]))b+=
d[c[a]];else return!1;return b},binaryToHex(c){let a,b,d,g,k="";for(a=c.length-1;3<=a;a-=4){d=c.substr(a+1-4,4);for(b=g=0;4>b;b+=1){if("0"!==d[b]&&"1"!==d[b])return!1;g=2*g+parseInt(d[b],10)}k=10<=g?String.fromCharCode(g-10+65)+k:String(g)+k}if(0<=a){for(b=g=0;b<=a;b+=1){if("0"!==c[b]&&"1"!==c[b])return!1;g=2*g+parseInt(c[b],10)}k=String(g)+k}return k},applySettings(c,a,b){const d={};d[a]=c;this._applySettings(d,b)},_applySettings(c,a){if(roles.hasControls()){var b=Object.keys(c)[0];c=c[b];if((!0===
c||!1===c)&&virtualclass.settings.info.hasOwnProperty(b)){if("undefined"===typeof a){localStorage.removeItem("userSettings");virtualclass.settings.info[b]=c;var d=virtualclass.settings.settingsToHex(virtualclass.settings.info);virtualclass.settings.send(d,a);localStorage.setItem("settings",d)}else{const f={},k=virtualclass.settings.info;for(d in k)f[d]=k[d];f[b]=c;d=virtualclass.settings.settingsToHex(f);virtualclass.settings.user[a]=d;virtualclass.settings.send(d,a);localStorage.setItem("userSettings",
JSON.stringify(virtualclass.settings.user))}return!0}return!1}for(b in c)virtualclass.settings.info[b]=c[b],virtualclass.settings[b](c[b]);a=virtualclass.settings.settingsToHex(c);localStorage.setItem("settings",a)},send(c,a){roles.hasControls()&&("undefined"!==typeof a?virtualclass.vutil.beforeSend({cf:"settings",Hex:c,toUser:a},a):virtualclass.vutil.beforeSend({cf:"settings",Hex:c}))},onMessage(c){"string"===typeof c?roles.isStudent()&&(c=virtualclass.settings.parseSettings(c),this._applySettings(c)):
this.recording.triggerSetting(c)},onLoadSettings(c){return virtualclass.settings.parseSettings(c)},disableAttendeeAudio(c){roles.isStudent()&&(!0===c?(virtualclass.user.control.audioWidgetEnable(!0),virtualclass.gObj.audioEnable=!0):!1===c&&(c=document.querySelector("#speakerPressOnce"),!0!==c.dataset.audioPlaying&&"true"!==c.dataset.audioPlaying||virtualclass.media.audio.clickOnceSpeaker("speakerPressOnce"),virtualclass.user.control.audioDisable(),virtualclass.gObj.audioEnable=!1))},allowoverride(){console.log("TO DO")},
disableAttendeePc(){console.log("TO DO")},disableAttendeeGc(){console.log("TO DO")},disableAttendeeVideo(c){if(roles.isStudent()){const a=document.querySelector(".videoSwitchCont #videoSwitch");a.classList.contains("off")&&!1===c?console.log("do nothing"):a.classList.contains("on")&&!0===c?console.log("do nothing"):a.classList.contains("on")&&!1===c&&virtualclass.vutil.videoHandler("off");virtualclass.videoHost.toggleVideoMsg(!1===c?"disable":"enable")}},disableRaiseHand(){console.log("TO DO")},disableUserList(){console.log("TO DO")},
x8(){console.log("TO DO")},enableRecording(){console.log("TO DO")},recAllowpresentorAVcontrol(){console.log("TO DO")},recShowPresentorRecordingStatus(){console.log("TO DO")},recDisableAttendeeAV(){console.log("TO DO")},recallowattendeeAVcontrol(){console.log("TO DO")},showAttendeeRecordingStatus(){console.log("TO DO")},x16(){console.log("TO DO")},recording:{enableRecording:!1,allowpresentorAVcontrol:!1,disableAttendeeAV:!1,allowattendeeAVcontrol:!1,audioVideo:!0,statusOnly:!1,trimRecordings:!1,allowattendeeAVcontrolByTeacher:!1,
init(){this.enableRecording=virtualclass.settings.info.enableRecording;roles.hasControls()?(this.allowpresentorAVcontrol=virtualclass.settings.info.recAllowpresentorAVcontrol,this.showPresentorRecordingStatus=virtualclass.settings.info.allowpresentorAVcontrol?!0:virtualclass.settings.info.recShowPresentorRecordingStatus):(this.disableAttendeeAV=virtualclass.settings.info.recDisableAttendeeAV,this.allowattendeeAVcontrol=virtualclass.settings.info.recallowattendeeAVcontrol,this.showAttendeeRecordingStatus=
virtualclass.settings.info.allowattendeeAVcontrol?!0:virtualclass.settings.info.showAttendeeRecordingStatus);this.trimRecordings=virtualclass.settings.info.trimRecordings;this.showStatus=this.showStatus();this.showButton();this.overrideSettingFromLocalStorage()},overrideSettingFromLocalStorage(){let c=localStorage.getItem("recsetting");if(null!==c&&void 0!==c)if(c=JSON.parse(c),roles.hasControls()||!0!==c.statusonly)this.updateSettingAV(!1);else virtualclass.settings.onMessage({ac:!1})},showButton(){const c=
document.getElementById("recording");this.showStatus?(c.classList.remove("hide"),c.classList.add("show"),virtualclassCont.dataset.recording="on",this.statusOnly?c.classList.add("statusonly"):this.attachHandler(c),this.trimRecordings&&c.classList.add("trimRecording")):(c.classList.remove("show"),c.classList.add("hide"))},attachHandler(c){c.addEventListener("click",this.recordingButtonAction.bind(this,c))},updateSettingAV(c){const a=document.querySelector("#recording"),b=document.querySelector("#recording .recordingText");
(this.audioVideo=c)?(b.innerHTML="Recording",virtualclassCont.dataset.recording="on",a.setAttribute("data-title","Recording Started"),localStorage.removeItem("recsetting"),"ScreenShare"===virtualclass.currApp&&null!=virtualclass.ss&&virtualclass.ss.initShareScreen("ss",500)):(roles.hasControls(),a.setAttribute("data-title","Recording Stopped"),virtualclassCont.dataset.recording="off",localStorage.setItem("recsetting",JSON.stringify({statusonly:this.statusOnly,rec:virtualclassCont.dataset.recording})));
ioAdapter.setRecording()},recordingButtonAction(c){c.classList.contains("statusonly")?console.log(" Do nothing"):(c="off"===virtualclassCont.dataset.recording?!0:!1,this.updateSettingAV(c),roles.hasControls()&&ioAdapter.mustSend({ac:c,cf:"recs"}))},showStatus(){return roles.hasControls()?this.enableRecording&&this.allowpresentorAVcontrol&&this.showPresentorRecordingStatus?!0:this.enableRecording&&!this.allowpresentorAVcontrol&&this.showPresentorRecordingStatus?this.statusOnly=!0:!1:this.enableRecording&&
!this.disableAttendeeAV&&this.allowattendeeAVcontrol&&this.showAttendeeRecordingStatus?!0:this.enableRecording&&!this.disableAttendeeAV&&!this.allowpresentorAVcontrol&&this.showAttendeeRecordingStatus?this.statusOnly=!0:!1},isRecordingOn(){return roles.hasControls()?this.enableRecording&&this.allowpresentorAVcontrol&&this.audioVideo:this.disableAttendeeAV?!1:this.allowattendeeAVcontrol?this.audioVideo:!0},sendYesOrNo(){return this.isRecordingOn()?"yes":"no"},setStatusOnElement(){const c=document.querySelector("#recording");
this.allowattendeeAVcontrolByTeacher?(c.classList.add("statusonly"),this.statusOnly=!0):(c.classList.remove("statusonly"),this.statusOnly=!1)},triggerSetting(c){this.allowattendeeAVcontrolByTeacher=0==c.ac;this.setStatusOnElement();this.updateSettingAV(c.ac)}}}})(window);(d=>{function c(a){const b=new Promise((b,c)=>{const d=()=>{a.removeEventListener("success",g);a.removeEventListener("error",k)},g=()=>{b(f(a.result));d()},k=()=>{c(a.error);d()};a.addEventListener("success",g);a.addEventListener("error",k)});b.then(b=>{b instanceof IDBCursor&&q.set(b,a)});v.set(b,a);return b}function a(a){if(!r.has(a)){var b=new Promise((b,c)=>{const d=()=>{a.removeEventListener("complete",f);a.removeEventListener("error",g);a.removeEventListener("abort",g)},f=()=>{b();d()},g=()=>
{c(a.error);d()};a.addEventListener("complete",f);a.addEventListener("error",g);a.addEventListener("abort",g)});r.set(a,b)}}function b(a){return a!==IDBDatabase.prototype.transaction||"objectStoreNames"in IDBTransaction.prototype?(n||(n=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])).includes(a)?function(...b){a.apply(v.get(this),b);return f(q.get(this))}:function(...b){return f(a.apply(v.get(this),b))}:function(b,...c){c=a.call(v.get(this),b,...c);
z.set(c,b.sort?b.sort():[b]);return f(c)}}function f(d){if(d instanceof IDBRequest)return c(d);if(t.has(d))return t.get(d);if("function"===typeof d)var f=b(d);else d instanceof IDBTransaction&&a(d),f=k(d,m||(m=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction]))?new Proxy(d,p):d;f!==d&&(t.set(d,f),v.set(f,d));return f}function g(a,b){if(a instanceof IDBDatabase&&!(b in a)&&"string"===typeof b){if(C.get(b))return C.get(b);var c=b.replace(/FromIndex$/,""),d=b!==c,f=B.includes(c);if(c in
(d?IDBIndex:IDBObjectStore).prototype&&(f||u.includes(c)))return a=async function(a,...b){a=this.transaction(a,f?"readwrite":"readonly");let g=a.store;d&&(g=g.index(b.shift()));b=g[c](...b);f&&await a.done;return b},C.set(b,a),a}}const k=(a,b)=>b.some(b=>a instanceof b);let m,n;const q=new WeakMap,r=new WeakMap,z=new WeakMap,t=new WeakMap,v=new WeakMap;let p={get(a,b,c){if(a instanceof IDBTransaction){if("done"===b)return r.get(a);if("objectStoreNames"===b)return a.objectStoreNames||z.get(a);if("store"===
b)return c.objectStoreNames[1]?void 0:c.objectStore(c.objectStoreNames[0])}return f(a[b])},has(a,b){return a instanceof IDBTransaction&&("done"===b||"store"===b)?!0:b in a}};const u=["get","getKey","getAll","getAllKeys","count"],B=["put","add","delete","clear"],C=new Map;p=(a=>({get:(b,c,d)=>g(b,c)||a.get(b,c,d),has:(b,c)=>!!g(b,c)||a.has(b,c)}))(p);d.virtualclassOpenDB=function(a,b,{blocked:c,upgrade:d,blocking:g}={}){const k=indexedDB.open(a,b);a=f(k);d&&k.addEventListener("upgradeneeded",a=>{d(f(k.result),
a.oldVersion,a.newVersion,f(k.transaction))});c&&k.addEventListener("blocked",()=>c());g&&a.then(a=>a.addEventListener("versionchange",g));return a};d.virtualclassDeleteDB=function(a,{blocked:b}={}){a=indexedDB.deleteDatabase(a);b&&a.addEventListener("blocked",()=>b());return f(a).then(()=>{})}})(window);(function(d){d.modal=(()=>({show(c){c=document.querySelector(c);null!=c&&c.classList.add("in")},hide(){var c=document.querySelector(c);null!=c&&c.classList.add("fade")},removeModal(){const c=document.querySelector("#editPollModal");c&&c.parentNode.removeChild(c)},closeModalHandler(c){const a=this;(c=document.querySelector(`#${c} .close`))&&c.addEventListener("click",()=>{a.removeModal()})},hideModal(){const c=document.querySelector("#congdashboard");c&&(c.className="modal fade")},showModal(){const c=
document.querySelector("#congdashboard");c&&(c.className="modal in")},attachpopupHandler(c,a,b){const d=document.querySelector(`#qnText${c}${a}`);d.insertAdjacentHTML("beforeend",b);document.querySelector(`#qnText${c}${a} .popover-content`).classList.add("hide");const g=document.querySelector(`#qnText${c}${a} .popover-content`);d.addEventListener("mouseover",()=>{g.classList.add("show");g.classList.remove("hide")});d.addEventListener("mouseleave",()=>{g.classList.remove("show");g.classList.add("hide")})}}))()})(window);const removeAppsDom=function(){var d=document.getElementById("commandToolsWrapper");null!=d&&d.parentNode.removeChild(d);d=document.getElementById("virtualclassOptionsCont");null!=d&&d.parentNode.removeChild(d)};
...
const defaultOperation=function(d,c){virtualclass.jId==virtualclass.gObj.uid?("t"!=virtualclass.joinUser.role&&(virtualclass.vutil.overrideRoles(virtualclass.joinUser.role),"s"==virtualclass.joinUser.role?removeAppsDom():"e"!=virtualclass.joinUser.role&&removeSessionEndTool()),virtualclass.gObj.hasOwnProperty("doEndSession")&&"t"==virtualclass.joinUser.role?(overrideRoleTeacher(),console.log("From localStorage, perform the override role action")):console.log("From localStorage, cannot perform the override role action")):console.log("Does not need to say hello to new user");
ioPingPong.ping(d);Array.isArray(d.message)||(d.message=[d.message]);memberUpdateWithDelay(d,"added");roles.hasAdmin()&&(virtualclass.gObj.uid==virtualclass.jId&&(virtualclass.gObj.studentSSstatus.mesharing||("EDITORRICH"!=virtualclass.currApp.toUpperCase()&&"EDITORCODE"!=virtualclass.currApp.toUpperCase()||ioAdapter.mustSend({eddata:"currAppEditor",et:virtualclass.currApp}),virtualclass.editorRich.isVcAdapterIsReady("editorRich")?virtualclass.editorRich.responseToRequest():console.log("Editor Rich vcAdapter is not ready"),
virtualclass.editorCode.isVcAdapterIsReady("editorCode")?virtualclass.editorCode.responseToRequest():console.log("Editor Code vcAdapter is not ready")),"SharePresentation"===virtualclass.currApp?"object"===typeof virtualclass.sharePt&&ioAdapter.mustSendUser({ppt:{init:virtualclass.sharePt.pptUrl,startFrom:virtualclass.sharePt.state},cf:"ppt"},virtualclass.jId):"Video"===virtualclass.currApp&&"object"===typeof virtualclass.videoUl.player&&ioAdapter.mustSendUser({videoUl:{init:{videoId:virtualclass.videoUl.videoId,
videoUrl:virtualclass.videoUl.videoUrl},startFrom:virtualclass.videoUl.player.currentTime()},cf:"videoUl"},virtualclass.jId)),ioAdapter.sendWithDelayAndDrop({cf:"tConn"},null,"send","tConn",1E3));roles.hasControls()&&virtualclass.gObj.uid!=virtualclass.jId?(virtualclass.vutil.sendCurrAppOnUserJoin(),"ScreenShare"===virtualclass.currApp?c="ss":"SharePresentation"===virtualclass.currApp?(console.log("sharePPt"),"object"===typeof virtualclass.sharePt?ioAdapter.mustSendUser({ppt:{init:virtualclass.sharePt.pptUrl,
startFrom:virtualclass.sharePt.state},cf:"ppt"},virtualclass.jId):ioAdapter.mustSendUser({ppt:{init:"studentlayout"},cf:"ppt"},virtualclass.jId)):"DocumentShare"===virtualclass.currApp?roles.hasControls()&&virtualclass.dts.docs.hasOwnProperty("currDoc")?null!=virtualclass.gObj.currWb&&(ioAdapter.mustSendUser({dts:{slideTo:virtualclass.dts.docs.note.currNote,docn:virtualclass.dts.docs.currDoc},cf:"dts"},virtualclass.jId),console.log("Document share send :- Complete slide")):(ioAdapter.mustSendUser({dts:{init:"studentlayout"},
cf:"dts"},virtualclass.jId),console.log("Document share send :- Layout")):"Video"===virtualclass.currApp&&("object"===typeof virtualclass.videoUl.player?virtualclass.videoUl.videoUrl&&ioAdapter.mustSendUser({videoUl:{init:{id:virtualclass.videoUl.videoId,videoUrl:virtualclass.videoUl.videoUrl},startFrom:virtualclass.videoUl.player.currentTime(),isPaused:virtualclass.videoUl.player.paused()},cf:"videoUl"},virtualclass.jId):ioAdapter.mustSendUser({videoUl:{init:"studentlayout"},cf:"videoUl"},virtualclass.jId)),
"undefined"!==typeof c&&null!==c&&triggerInitShareScreen(c,6E3)):roles.isStudent()&&virtualclass.gObj.uid!=virtualclass.jId&&virtualclass.gObj.studentSSstatus.mesharing&&triggerInitShareScreen("ss",6E3)};function processImage(d,c){d=new Uint8ClampedArray(d);d=d.subarray(2,d.length);1==c?(c=`data:image/webp;base64,${btoa(virtualclass.videoHost.Uint8ToString(d))}`,d="webp"):(c=`data:image/jpeg;base64,${btoa(virtualclass.videoHost.Uint8ToString(d))}`,d="jpeg");virtualclass.videoHost.drawReceivedImage(c,d,{x:0,y:0})}function isAnyOnePresenter(){return 1==parseInt(wbUser.anyonepresenter,10)}
function joinAsTeacher(d){virtualclass.gObj.veryFirstJoin=!1;virtualclass.vutil.isOrginalTeacherExist(d)||(overrideOperation("t"),console.log("Member add :- join as teacher"));virtualclass.gObj.hasOwnProperty("doEndSession")&&roles.isTeacher()&&overrideRoleTeacher()}
var overrideOperation=function(d){"s"==d?(virtualclass.view.disappearBox("drawArea"),removeAppsDom(),"object"===typeof virtualclass.wb&&virtualclass.wb[virtualclass.gObj.currWb].utility.makeCanvasDisable()):"e"==d?(getUserId(virtualclass.jId)&&document.getElementById("virtualclassCont").classList.add("orginalTeacher"),console.log("Member add :- join as educator")):console.log(`Member add :- join as ${d}`);io.disconnect();virtualclass.vutil.overrideRoles(d);io.init(virtualclass.uInfo)};
function initOverrideRoleTeacher(d){virtualclass.gObj.hasOwnProperty("doEndSession")&&selfJoin(d)&&"t"==virtualclass.joinUser.role&&overrideRoleTeacher()}function getPosition(d,c){return d.findIndex(a=>a.userid==c)}
const ioEventApi={readyto_member_add(d){if("object"===typeof d.joinUser){const c={};let a=0;for(const b in d.joinUser)wbUser.id!=b&&(console.log("Don t join"),c.joinUser={key:b},c.message=d.message[a],c.newuser=d.newuser,c.type=d.type,c.user=d.user,a++,this.member_added(c))}else this.member_added(d)},member_added(d){"undefined"===typeof virtualclass.connectedUsers&&(virtualclass.connectedUsers=[]);if(d.hasOwnProperty("user")){var c=d.message;virtualclass.jId=c.userid;console.log(`===== JOIN users ${virtualclass.jId}`);
const a=getPosition(virtualclass.connectedUsers,virtualclass.jId);-1!=a&&virtualclass.connectedUsers.splice(a,1);virtualclass.gObj.allUserObj[virtualclass.jId]=c;virtualclass.connectedUsers.push(c);virtualclass.joinUser=c}else if(d.hasOwnProperty("users")){virtualclass.jId=d.joinUser;console.log(`===== JOIN users ${virtualclass.jId}`);virtualclass.connectedUsers=d.message;for(var a=0;a<virtualclass.connectedUsers.length;a++)virtualclass.gObj.allUserObj[virtualclass.connectedUsers[a].userid]=virtualclass.connectedUsers[a];
virtualclass.joinUser=this.getJoinUser(virtualclass.connectedUsers,virtualclass.jId)}else console.log("User packet is not receving");virtualclass.jId==virtualclass.gObj.uid&&(virtualclass.videoHost.setDefaultValue("undefined"===typeof virtualclass.videoHost.gObj.MYSPEED?1:virtualclass.videoHost.gObj.MYSPEED),virtualclass.vutil.setDefaultScroll());virtualclass.gObj.mySetTime=2E3;virtualclass.vutil.selfJoin(virtualclass.jId)&&virtualclass.gObj.veryFirstJoin&&"t"==virtualclass.joinUser.role?virtualclass.vutil.isTeacherAlreadyExist(virtualclass.jId)?
(virtualclass.gObj.veryFirstJoin=!1,overrideOperation("s"),console.log("Member add :- Join As Student")):virtualclass.gObj.veryFirstJoin&&virtualclass.vutil.isPresenterAlreadyExist(virtualclass.jId)?(c=virtualclass.vutil.getPresenterId())?(ioAdapter.sendUser({cf:"rpr"},c),overrideRoleTeacher()):console.log("There some problem on joining as"):function(a){setTimeout(()=>{joinAsTeacher(a);const b=virtualclass.gObj.currWb;null!=virtualclass.pdfRender[b]&&virtualclass.pdfRender[b].sendScroll()},virtualclass.gObj.mySetTime)}(virtualclass.jId):
virtualclass.vutil.selfJoin(virtualclass.jId)&&virtualclass.gObj.veryFirstJoin&&("p"==virtualclass.joinUser.role&&virtualclass.vutil.isPresenterAlreadyExist(virtualclass.jId)||"e"==virtualclass.joinUser.role&&(virtualclass.vutil.isEducatorAlreadyExist(virtualclass.jId)||virtualclass.vutil.isOrginalTeacherExist(virtualclass.jId)))?(virtualclass.gObj.veryFirstJoin=!1,overrideOperation("s"),console.log("Member add :- join as student. Earlier was educator OR teacher")):(defaultOperation(d,void 0),!isAnyOnePresenter()||
!virtualclass.vutil.selfJoin(virtualclass.jId)||virtualclass.vutil.isTeacherAlreadyExist(virtualclass.jId)||"s"!=virtualclass.joinUser.role&&"p"!=virtualclass.joinUser.role||virtualclass.vutil.createBecomeTeacherWidget());(function(a){setTimeout(()=>{initOverrideRoleTeacher(a)},virtualclass.gObj.mySetTime+200)})(virtualclass.jId);!isAnyOnePresenter()||"t"!=virtualclass.joinUser.role&&"e"!=virtualclass.joinUser.role||virtualclass.jId==virtualclass.gObj.uid||virtualclass.vutil.removeBecomeTeacherWidget();
roles.hasControls()&&virtualclass.poll.updateUsersOnPoll();if("undefined"!==typeof virtualclass.quiz&&0>virtualclass.quiz.uniqueUsers.indexOf(virtualclass.jId))for(a in virtualclass.quiz.uniqueUsers.push(virtualclass.jId),io.uniquesids)0>virtualclass.quiz.uniqueUsers.indexOf(a)&&virtualclass.quiz.uniqueUsers.push(a);"s"==virtualclass.joinUser.role&&virtualclass.gObj.has_ts_capability&&ioAdapter.mustSend({uid:virtualclass.gObj.uid,ac:!0,cf:"tsr"});if(virtualclass.gObj.uid!=virtualclass.jId&&virtualclass.gObj.meetingMode)virtualclass.multiVideo.onUserJoin(virtualclass.jId);
!roles.hasControls()&&("t"==d.message[0].role||virtualclass.gObj.uid==virtualclass.jId&&virtualclass.vutil.whoIsTeacher())&&(d=document.querySelector("#virtualclassCont.congrea"),d.classList.contains("tr_available")||d.classList.add("tr_available"))},newmessage(d){const c=d.message;if(c.hasOwnProperty("cf"))if("function"===typeof receiveFunctions[c.cf])receiveFunctions[c.cf](d);else console.log(`CF ${c.cf} is not a function of receiveFunctions`)},readyto_user_logout(d){for(const c in d.action)d={type:"user_logout",
fromUser:c,message:"offline"},virtualclass.ioEventApi.user_logout(d)},user_logout(d){console.log("user_logout");isAnyOnePresenter()&&!isTeacherExistWhenRemoveUser(virtualclass.connectedUsers)&&"t"!=virtualclass.gObj.uRole&&"e"!=virtualclass.gObj.uRole&&virtualclass.vutil.createBecomeTeacherWidget();if(!roles.hasControls()&&(virtualclass.gObj.hasOwnProperty("whoIsTeacher")||(virtualclass.gObj.whoIsTeacher=virtualclass.vutil.whoIsTeacher()),virtualclass.gObj.whoIsTeacher==d.fromUser)){var c=document.querySelector("#virtualclassCont.congrea");
c&&c.classList.contains("tr_available")&&c.classList.remove("tr_available")}virtualclass.media.video.removeUser(d.fromUser);virtualclass.chat.isTechSupportExist(d.fromUser)&&virtualclass.chat.disableTechSupport(d.fromUser);"t"!=d.fromUser.role&&"e"!=d.fromUser.role||!roles.isStudent()&&!roles.isPresenter()||(localStorage.setItem("oTDisconn",!0),disableEditor("editorRich"),disableEditor("editorCode"));c=d.fromUser;delete virtualclass.gObj.allUserObj[c];d=getPosition(virtualclass.connectedUsers,c);
-1!==d&&virtualclass.connectedUsers.splice(d,1);d={removeUser:c};memberUpdateWithDelay(d,"removed");if(virtualclass.gObj.meetingMode)virtualclass.multiVideo.onUserRemove(c);virtualclass.connectedUsers.length<virtualclass.gObj.userToBeDisplay&&(virtualclass.gObj.insertUser=!0)},error(d){virtualclass.gObj.displayError?(virtualclass.view.removeElement("serverErrorCont"),"undefined"!==typeof d.message.stack?virtualclass.view.displayServerError("serverErrorCont",d.message.stack):console.log(`Error message ${d.message.stack} could not display`),
"object"!==typeof d.message&&display_error(d.message.stack)):"object"!==typeof d.message&&console.log(d.message.stack)},Text_Limit_Exeed(d){virtualclass.view.createErrorMsg(virtualclass.lang.getString("Text_Limit_Exeed"),"errorContainer","chatWidget",{className:"Text_Limit_Exeed"})},Binary_Limit_Exeed(d){virtualclass.view.createErrorMsg(virtualclass.lang.getString("Binary_Limit_Exeed"),"errorContainer","chatWidget",{className:"Binary_Limit_Exeed"})},Unauthenticated(d){virtualclass.view.createErrorMsg(virtualclass.lang.getString("Unauthenticated"),
...
"errorContainer","chatWidget",{className:"Max_users"})},PONG(d){virtualclass.network.latency=d.timeStamp-d.message;virtualclass.network.initToPing(1E3)},authentication_failed(d){virtualclass.chat.removeCookieUserInfo(d)},connectionclose(d){virtualclass.hasOwnProperty("recorder")&&virtualclass.recorder.startUpload?console.log("During the upload process there would not any other popup box."):virtualclass.recorder.smallData&&virtualclass.recorder.hasOwnProperty("rdlength")&&1E5>virtualclass.recorder.rdlength?
console.log("Do not show the waiting popupbox if there small chunks of data"):virtualclass.popup.waitMsg();virtualclass.chat.makeUserListEmpty()},connectionopen(d){virtualclass.gObj.invalidlogin=!1;d=6E3;virtualclass.gObj.hasOwnProperty("doEndSession")&&(console.log("From Become Teacher"),d=1E4);setTimeout(()=>{if(virtualclass.vutil.sesionEndMsgBoxIsExisting()||virtualclass.gObj.hasOwnProperty("downloadProgress")||virtualclass.recorder.startUpload)console.log("Popup box Could not close");else{virtualclass.popup.closePopup();
virtualclass.vutil.setDefaultScroll();const c=document.getElementById("popupContainer");null!=c&&(c.style.display="none");console.log("Popup box Close All")}},d)},binrec(d){const c=new Uint8Array(d.message);switch(c[0]){case 102:case 103:case 104:case 202:case 203:case 204:if(roles.hasControls()){virtualclass.gObj.studentSSstatus.mesharing=!0;const a=document.querySelector("#virtualclassCont");""!=a&&(a.classList.add("studentScreenSharing"),document.querySelector("#chat_div").classList.add("studentScreenSharing"))}virtualclass.hasOwnProperty("studentScreen")||
(virtualclass.studentScreen=new studentScreen);virtualclass.gObj.precheckScrn&&virtualclass.vutil.prechkScrnShare();roles.hasControls()&&!virtualclass.gObj.studentSSstatus.mesharing||virtualclass.studentScreen.ssProcess(c,d.message,"ss","ScreenShare");virtualclass.gObj.studentSSstatus.sharing&&roles.isStudent()&&(d=document.getElementById("virtualclassScreenShareLocal"),virtualclass.gObj.studentSSstatus.shareToAll?null!=d&&(d.style.display="block"):null!=d&&(d.style.display="none"));break;case 11:virtualclass.media.video.process(d.message);
break;case 21:processImage(d.message,c[1])}},getJoinUser(d,c){for(let a=0;a<d.length;a++)if(d[a].userid==c)return d[a]}};const receiveFunctions=new function(){this.pong=function(d){ioPingPong.pong(d)};this.pongAck=function(d){ioPingPong.pongAck(d)};this.control=function(d){virtualclass.user.control.onmessage(d)};this.eddata=function(d){if(d.message.hasOwnProperty("et"))if("editorRich"==d.message.et)virtualclass.editorRich.onmessage(d,"EditorRich");else virtualclass.editorCode.onmessage(d,"EditorCode")};this.nEd=function(d){localStorage.setItem("nEd",!0);const c=document.getElementById("EditorRichwriteModeBox");null!=
...
this.settings=function(d){if(d.message.hasOwnProperty("Hex"))virtualclass.settings.onMessage(d.message.Hex)};this.enc=function(d){d.message.hasOwnProperty("ouser")?virtualclass.user.control.enable(d.message.ouser,"chat","Chat","chat"):(virtualclass.user.control.allChatEnable(),virtualclass.gObj.chatEnable=!0);document.querySelector("#chatWidget").classList.remove("chat_disabled");document.querySelector("#chat_div").classList.remove("chat_disabled")};this.dic=function(d){d.message.hasOwnProperty("ouser")?
virtualclass.user.control.disable(d.message.ouser,"chat","Chat","chat"):(virtualclass.user.control.allChatDisable(),virtualclass.gObj.chatEnable=!1)};this.ena=function(d){};this.dia=function(d){};this.aEna=function(d){};this.aDia=function(d){};this.msg=function(d){messageUpdate(d)};this.sEnd=function(d){document.querySelector("#joinClassModal").style.display="none";d=document.querySelector("#virtualclassCont #virtualclassApp");null!=d&&(d.style.display="block");virtualclass.storage.config.endSession();
virtualclass.popup.sesseionEndWindow();virtualclass.gObj.endSession=!0};this.dispWhiteboard=function(d){virtualclass.makeAppReady(virtualclass.apps.wb,void 0,d.message.d,d.message.ci)};this.ppt=function(d){d.fromUser.userid!=virtualclass.gObj.uid&&(d.message.hasOwnProperty("init")?virtualclass.makeAppReady(virtualclass.apps.sp):("object"!==typeof virtualclass.sharePt&&(virtualclass.makeAppReady(virtualclass.apps.sp),virtualclass.sharePt.onmessage({pptMsg:d.message.ppt.init,cf:"ppt",user:"all",cfpt:"setUrl"})),
virtualclass.sharePt.onmessage(d.message)))};this.unshareScreen=function(d){d=d.message.st;"object"===typeof virtualclass[d]&&(console.log("Unshare the screen at student"),virtualclass[d].prevImageSlices=[],virtualclass[d].removeStream(),virtualclass.currApp=virtualclass.gObj.defaultApp)};this.videoSlice=function(d){virtualclass.media.playVideo(d.message.videoSlice)};this.videoByImage=function(d){virtualclass.media.existVideoContainer(d.message.videoByImage)||virtualclass.media.video.createElement(d.message.videoByImage)};
this.userMsg=function(d){virtualclass.gObj.chat.display(d.message.userMsg)};this.requestPacketBy=function(d){roles.hasControls()&&virtualclass.gObj.chat.sendPackets(d.message.requestPacketBy,d.message.sp)};this.chatPackResponsed=function(d){d.message.byRequest===virtualclass.gObj.uid&&virtualclass.gObj.chat.displayMissedChats(d.message.chatPackResponsed)};this.checkUser=function(d){virtualclass.wb[virtualclass.gObj.currWb].response.checkUser(d,wbUser.id,virtualclass.wb[virtualclass.gObj.currWb].stHasTeacher)};
this.reclaimRole=function(d){console.log("Role reclaim");roles.hasControls()&&virtualclass.vutil.vcResponseAReclaimRole(d.fromUser.userid,wbUser.id)};this.rpr=function(d){this.reclaimRole(d);console.log("reclaim role")};this.assignRole=function(d){d.message.toUser===virtualclass.gObj.uid&&(console.log("Role assign"),"object"===typeof virtualclass.wb&&virtualclass.wb[virtualclass.gObj.currWb].utility.removeWhiteboardMessage(),virtualclass.vutil.vcResponseAssignRole(d.fromUser.userid,wbUser.id))};this.clearAll=
function(d){"object"!==typeof virtualclass.wb&&virtualclass.makeAppReady(virtualclass.apps.wb);virtualclass.wb[virtualclass.gObj.currWb].response.clearAll(d.fromUser.userid,wbUser.id,d.message,virtualclass.wb[virtualclass.gObj.currWb].oTeacher)};this.getMsPckt=function(d){virtualclass.wb[virtualclass.gObj.currWb].gObj.chunk=[];d=virtualclass.wb[virtualclass.gObj.currWb].bridge.sendPackets(d,virtualclass.wb[virtualclass.gObj.currWb].gObj.chunk);virtualclass.vutil.beforeSend({repObj:d,chunk:!0,cf:"repObj"})};
this.createArrow=function(d){"object"===typeof virtualclass.wb&&(roles.hasControls()||virtualclass.wb[virtualclass.gObj.currWb].response.createArrow(d.message))};this.repObj=function(d){"object"!==typeof virtualclass.wb&&"DocumentShare"!=virtualclass.currApp&&virtualclass.makeAppReady(virtualclass.apps.wb);"undefined"!==typeof virtualclass.gObj.currWb&&(virtualclass.wb[virtualclass.gObj.currWb].utility.removeWhiteboardMessage(),"p"!=d.fromUser.role&&("t"!=d.fromUser.role&&"e"!=d.fromUser.role||virtualclass.vutil.isPresenterExist())?
console.log("whiteboard -------------------------- We just lost a packet"):virtualclass.wb[virtualclass.gObj.currWb].utility.replayObjsByFilter(d.message.repObj))};this.replayAll=function(d){virtualclass.wb[virtualclass.gObj.currWb].response.replayAll()};this.dts=function(d){console.log(`Document share :- message received ${d.message.serial}`);console.dir(d.message.dts);if(d.message.dts.hasOwnProperty("init"))virtualclass.gObj.screenRh=100,virtualclass.makeAppReady("DocumentShare",void 0,d.message.dts),
virtualclass.gObj.screenRh=60;else if("object"===typeof virtualclass.dts)virtualclass.dts.onmessage(d)};this.poll=function(d){console.log(d.message.poll.pollMsg);"init"==d.message.poll.pollMsg?virtualclass.makeAppReady("Poll"):("object"!==typeof virtualclass.poll&&(virtualclass.makeAppReady("Poll"),virtualclass.poll.onmessage({pollMsg:d.message.poll.init,cf:"poll",user:"all"})),virtualclass.poll.onmessage(d.message,d.fromUser))};this.quiz=function(d){console.log(d.message.quiz.quizMsg);"init"==d.message.quiz.quizMsg?
virtualclass.makeAppReady("Quiz"):("object"!==typeof virtualclass.quiz&&(virtualclass.makeAppReady("Quiz"),virtualclass.quiz.onmessage({quizMsg:d.message.quiz.init,cf:"quiz",user:"all"})),virtualclass.quiz.onmessage(d.message,d.fromUser))};this.videoUl=function(d){if(d.fromUser.userid!=virtualclass.gObj.uid)virtualclass.videoUl.onmessage(d.message)};this.congController=function(d){if(d.fromUser.userid!=virtualclass.gObj.uid)virtualclass.videoHost.onmessage(d.message);"off"==d.message.congCtr.videoSwitch?
(virtualclass.vutil.addClass("virtualclassCont","videoff"),virtualclass.vutil.addClass("virtualclassAppRightPanel","hide"),virtualclass.vutil.removeClass("virtualclassAppRightPanel","show"),virtualclass.videoHost.setUserIcon(d.fromUser.userid)):(document.querySelector("#virtualclassCont").classList.remove("videoff"),virtualclass.vutil.addClass("virtualclassAppRightPanel","show"),virtualclass.vutil.removeClass("virtualclassAppRightPanel","hide"))};this.tsr=function(d){};this.na=function(d){virtualclass.user.control.iconAttrManupulate(d.fromUser.userid,
"icon-audioEnaOrange")};this.ya=function(d){virtualclass.user.control.iconAttrManupulate(d.fromUser.userid,"icon-audioEnaGreen")};this.mem_add=function(d){virtualclass.ioEventApi.member_added({type:"member_added",newJoinUser:d.message.user,cmadd:!0})};this.mvid=function(d){console.log("multivideo, message received");virtualclass.multiVideo.onmessage(d.message,d.fromUser.userid)};this.sc=function(d){console.log("Recevied scroll");virtualclass.pdfRender[virtualclass.gObj.currWb].setScrollPosition(d.message)};
this.scf=function(d){console.log("Recevied scroll first");console.dir(d.message);null!=virtualclass.gObj.currWb&&virtualclass.pdfRender[virtualclass.gObj.currWb].setScrollPosition(d.message)};this.cwb=function(d){if(d.message.hasOwnProperty("diswb")){({wid:d}=d.message);virtualclass.gObj.currWb=d;virtualclass.wbCommon.whiteboardExist(virtualclass.gObj.currWb)||virtualclass.vutil.createWhiteBoard(virtualclass.gObj.currWb);const c=d.split("_");0<c.length&&(virtualclass.gObj.currSlide=c[c.length-1]);
virtualclass.wbCommon.displaySlide(d);console.log(`whiteboard slide received=${d}`);virtualclass.vutil.resizeWindowIfBigger()}else d.message.hasOwnProperty("wbCount")&&(virtualclass.gObj.wbCount=d.message.wbCount,-1==virtualclass.gObj.wIds.indexOf(Number(virtualclass.gObj.wbCount))&&virtualclass.gObj.wIds.push(virtualclass.gObj.wbCount))};this.reqscreen=function(d){"mobTab"==virtualclass.system.device||"Chrome"!=virtualclass.system.mybrowser.name&&"Firefox"!=virtualclass.system.mybrowser.name&&"Edge"!=
virtualclass.system.mybrowser.name?virtualclass.vutil.beforeSend({ext:!0,cf:"colorIndicator",nosupport:!0}):(d=virtualclass.lang.getString("stdscreenshare"),virtualclass.gObj.precheckScrn&&virtualclass.vutil.prechkScrnShare(),virtualclass.popup.confirmInput(d,c=>{c?(roles.isStudent()&&(virtualclass.gObj.studentSSstatus.mesharing=!0),virtualclass.makeAppReady("ScreenShare","byclick")):virtualclass.vutil.beforeSend({sd:!0,cf:"colorIndicator"})}))};this.sshare_user=d=>{virtualclass.vutil.removeSSsharing();
virtualclass.gObj.whoIsSharing=d.fromUser.userid;virtualclass.vutil.initssSharing(d.fromUser.userid)};this.sview=function(d){const c=document.getElementById("virtualclassScreenShareLocal");roles.isStudent()&&!virtualclass.gObj.studentSSstatus.mesharing&&null!=c&&(c.style.display="none");d.message.hasOwnProperty("firstSs")&&(virtualclass.gObj.studentSSstatus.sharing=!0);virtualclass.gObj.studentSSstatus.shareToAll=!1;console.log("Share, self view")};this.sToAll=function(){const d=document.getElementById("virtualclassScreenShareLocal");
null!=d&&(d.style.display="block");virtualclass.gObj.studentSSstatus.shareToAll=!0;virtualclass.gObj.studentSSstatus.sharing=!0;console.log("Share, to all")};this.rmStdScreen=function(d){virtualclass.vutil.initDefaultApp();virtualclass.vutil.beforeSend({unshareScreen:!0,st:"ss",cf:"unshareScreen"});"object"===typeof virtualclass.ss?virtualclass.ss.clearScreenShare():virtualclass.vutil.removeSSsharing()};this.raiseHand=function(d){virtualclass.raiseHand.onMsgRec(d)};this.colorIndicator=function(d){var c=
d.message;d=d.fromUser.userid;c.sd?(d=chatContainerEvent.elementFromShadowDom(`#ml${d} .icon-stdscreenImg`),null!=d&&d.setAttribute("data-dcolor","red")):c.ext&&(c=c.hasOwnProperty("nosupport")?"nosupport":"orange",d=chatContainerEvent.elementFromShadowDom(`#ml${d} .icon-stdscreenImg`),null!=d&&d.setAttribute("data-dcolor",c))};this.stdVideoCtrl=function(d){d.fromUser.userid!=virtualclass.gObj.uid&&virtualclass.videoHost.stdVideoCtrlMsg(d)};this.toggleVideo=function(d){};this.destroyPlayer=function(d){if("Video"==
virtualclass.currApp&&virtualclass.hasOwnProperty("videoUl")&&virtualclass.videoUl.videoUrl){virtualclass.videoUl.videoUrl="";virtualclass.videoUl.videoId="";(d=document.getElementById("dispVideo_Youtube_api"))&&d.contentWindow&&d.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*");if(d=document.querySelector(".congrea #dispVideo"))d.style.display="none",(d=document.querySelector(".congrea #dispVideo video"))&&d.setAttribute("src","");(d=document.querySelector("#listvideo .playing"))&&
d.classList.remove("playing");(d=document.querySelector("#listvideo .removeCtr"))&&d.classList.remove("removeCtr");"object"===typeof virtualclass.videoUl.player&&delete virtualclass.videoUl.player}};this.sync=function(){};this.wbData=function(d){console.log(d);d.message.wbIndex&&(virtualclass.gObj.currIndex=parseInt(d.message.wbIndex),virtualclass.wbCommon.indexNav.studentWBPagination(d.message.wbIndex-1))};this.recs=function(d){if(!virtualclass.isPlayMode)virtualclass.settings.onMessage(d.message)}};$.uiBackCompat=!1;
$(document).ready(()=>{window.onload=async function(){console.log("Whiteboard init very start");window.earlierWidth=window.innerWidth;window.earlierHeight=window.innerHeight;window.wbUser=wbUser;window.pageEnter=(new Date).getTime();const d=new window.virtualclass;d.virtualclassIDBOpen=window.virtualclassOpenDB;window.virtualclass=d;d.gObj.displayError=1;d.lang={};d.lang.getString=window.getString;d.lang.message=window.message;d.createMainContainer();d.gObj.sessionClear=!1;d.settings=window.settings;
d.settings.init();d.handleCurrentUserWithPrevious();d.ioEventApi=ioEventApi;d.gObj.mobileVchOffset=vhCheck();var c=localStorage.getItem("wIds");null!=c&&(c=JSON.parse(c),d.gObj.wids=c,d.gObj.wbCount=c.length-1);var a=localStorage.getItem("anyp");null==a?localStorage.setItem("anyp",wbUser.anyonepresenter):a!=wbUser.anyonepresenter&&(localStorage.removeItem("uRole"),localStorage.setItem("anyp",wbUser.anyonepresenter));wbUser.virtualclassPlay=parseInt(wbUser.virtualclassPlay,10);wbUser.virtualclassPlay&&
(d.gObj.sessionClear=!0,d.gObj.role="s",localStorage.removeItem("teacherId"),wbUser.id=99955551230,d.gObj.uid=wbUser.id);a=function(a){return a.charAt(0).toUpperCase()+a.slice(1)};const b=JSON.parse(localStorage.getItem("prevApp"));d.gObj.prevApp=b;if(null!=b)if(d.previousApp=b,a=a(b.name),"Yts"==b.name||"DocumentShare"==b.name)if(null==b.metaData)var f=null;else f=b.metaData,f.fromReload=!0;else"Video"==b.name?null==b.metaData||null==b.metaData.init?f=null:(f=b.metaData,f.fromReload=!0):"Whiteboard"==
b.name&&(null==c&&(d.gObj.wbCount=b.wbn),c=localStorage.getItem("currSlide"),null!=c&&(d.gObj.currSlide=c));else a=d.gObj.defaultApp;"undefined"===typeof f&&(f=null);d.popup=new PopUp({showOverlay:!0});d.precheck=localStorage.getItem("precheck");c=localStorage.getItem("precheck");null!=c&&(d.isPrecheck=JSON.parse(c));wbUser.virtualclassPlay?(d.isPrecheck=!1,d.enablePreCheck=!1):(d.precheck=localStorage.getItem("precheck"),d.enablePreCheck=!0,c=localStorage.getItem("precheck"),null!=c&&(d.isPrecheck=
JSON.parse(c)));!d.enablePreCheck||null!=d.isPrecheck&&d.isPrecheck?(d.makePreCheckAvailable=!1,d.popup.waitMsg("refresh")):d.makePreCheckAvailable=!0;null!=localStorage.getItem("beTeacher")?(d.gObj.doEndSession=!0,d.gObj.beTeacher=!0,wbUser.role="t",d.gObj.uRole="t",localStorage.setItem("uRole","t"),localStorage.removeItem("beTeacher"),console.log("From locastorage:- beteacher found")):console.log("From locastorage:- beteacher not found");d.gObj.fromPageRefresh=!0;d.isPlayMode||"thisismyplaymode"!==
localStorage.getItem("mySession")?await d.init(wbUser.role,a,f):(console.log("DELETE PlayMode Data"),localStorage.clear(),await d.init(wbUser.role,a,f),d.storage.config.endSession());"Edge"==d.system.mybrowser.name&&(f=document.getElementById("virtualclassCont"),null!=f&&f.classList.add("edge"));wbUser.virtualclassPlay||(d.editorRich.veryInit(),d.editorCode.veryInit());d.vutil.isMiniFileIncluded("wb.min")&&(d.gObj.displayError=0);if(2<window.virtualclass.error.length)window.virtualclass.error=[];
else{d.vutil.initDefaultInfo(wbUser.role,a);roles.isStudent()&&(f=localStorage.getItem("audEnable"),null!==f&&"false"===f.ac&&(d.user.control.mediaWidgetDisable(),d.gObj.audioEnable=!1));setTimeout(()=>{window.postMessage({type:"isInstalled",id:1},"*")},500);d.vutil.attachClickOutSideCanvas();var g=function(){d.gObj.readyToCommunicate||setTimeout(()=>{g()},700)};d.vutil.isPlayMode()&&setTimeout(()=>{localStorage.removeItem("editorRich");localStorage.removeItem("editorCode");d.notPLayed=!0;d.storage.config.endSession();
d.chat.chatroombox=!1;var a=document.getElementById("chatrm");null!==a&&a.parentNode.removeChild(a);a=document.getElementById("canvas");null!==a&&(a.style.pointerEvents="none");g()},500);null!=d.isPrecheck&&("undefined"===typeof d.videoHost.gObj.MYSPEED&&(d.videoHost.gObj.MYSPEED=1),d.videoHost.afterSessionJoin());d.gObj.memberlistpending=[];d.gObj.veryFirstJoin=!0;d.gObj.testChatDiv=document.querySelector("#chat_div");d.gObj.testChatDiv.attachShadow({mode:"open"})}}});
