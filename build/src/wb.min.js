...
-1<n.indexOf('{"ac":11,"cf":"recs"')?(this.isTrimRecordingNow=!0,c.push({playTime:0,recObjs:n,type:k}),console.log("==== TRIM ")):c.push({playTime:this.tempPlayTime,recObjs:n,type:k}),this.totalTimeInMiliSeconds+=c[c.length-1].playTime,virtualclass.settings.info.trimRecordings&&-1<n.indexOf('{"ac":21,"cf":"recs"')&&(this.isTrimRecordingNow=!1),"undefined"!==typeof b[a+1]&&(n=this.calculateNextTime(f,b[a+1]),c=this.insertPacketInto(c,n,!0),1E3<=n&&(g=1E3*Math.trunc(n/1E3))),this.refrenceTime=f,this.tempRefrenceTime=
this.tempTime)}console.log(`totalTime in seconds ${this.totalTimeInMiliSeconds/1E3}`);for(b=0;b<c.length;b++)"B"==c[b].type&&(g=virtualclass.dtCon.base64DecToArr(c[b].recObjs),c[b].recObjs=g);this.masterRecordings.push(c);this.orginalTimes.push(d);this.UIdownloadProgress(a);(3<this.currentMin||this.lastFile==a)&&0<this.masterRecordings.length&&(this.playStart?(this.startToPlay(),this.updateTotalTime()):this.alreadyAskForPlay||(this.alreadyAskForPlay=!0,this.askToPlay()))},handleStartToPlay(a){const b=
document.querySelector(".rv-vanilla-modal-overlay.is-shown");null!=b&&b.removeEventListener("click",this.handleStartToPlay.bind(this));virtualclass.gesture.clickToContinue();console.log("===== Start to play");this.startToPlay();a.currentTarget.classList.remove("askToPlayCont")},startToPlay(){this.playStart?this.hasOwnProperty("isPausedByNotPresent")&&(delete this.isPausedByNotPresent,this.subRecordingIndex=0,this.subRecordings=this.masterRecordings[this.masterIndex],this.controller._play(),virtualclass.popup.closeElem()):
