...
d.innerHTML="&times";b.appendChild(d);b=virtualclass.view.customCreateElement("div","contQzBody","modal-body");a.appendChild(b);document.querySelector("#editQuizModal #contQzHead .close ").addEventListener("click",()=>{c.style.display="none";c.className="modal fade"})},modalContentUI(){const a=document.getElementById("contQzBody"),b=virtualclass.view.customCreateElement("div","slickQuiz","path-mod-congrea-quiz");var c=virtualclass.view.customCreateElement("h3","","quizName");b.appendChild(c);c=virtualclass.view.customCreateElement("P",
"timeText");b.appendChild(c);var k=virtualclass.view.customCreateElement("div","exam_navblock","navblock");b.appendChild(k);c=virtualclass.view.customCreateElement("div","","content");k.appendChild(c);k=virtualclass.view.customCreateElement("div","","qn_buttons multipages");c.appendChild(k);c=virtualclass.view.customCreateElement("div","","quizArea");b.appendChild(c);k=virtualclass.view.customCreateElement("div","","quizHeader");c.appendChild(k);c=virtualclass.view.customCreateElement("a","","button startQuiz");
c.href="#";c.innerHTML="Get Started!";k.appendChild(c);k=virtualclass.view.customCreateElement("div","","quizResults");b.appendChild(k);var m=virtualclass.view.customCreateElement("h3","","quizScore");m.innerHTML="You Scored: <span></span>";k.appendChild(m);m=virtualclass.view.customCreateElement("h3","","quizLevel");c.innerHTML="<strong>Ranking:</strong> <span></span>";k.appendChild(m);c=virtualclass.view.customCreateElement("div","","quizResultsCopy");k.appendChild(c);a.appendChild(b)},qzCont(a){const b=
