...
minute:"Minute",ModeclosingPoll:"Mode of closing Poll :",msgForDownloadStart:"Unable to save data. <br /> Preparing data for download",msgForReload:"Please reload this page to continue editing.",msgForWhiteboard:"Empty whiteboard.",msgStudentForReload:"Please reload this page.",Multiple_login:"Error: Access denied, multiple logins",muteAll:"Mute all",muteAllAudio:"Mute all audio",mybsharedoc:"Document will shared shortly",NAME:"NAME",Next:"Next",note:"Add note",notePlaceholder:"Write your note here",
page:"Page",of:"of",typeQuestion:"Type question",typeOption:"Type option",dropVideosHere:"Drop videos here",nomdlroot:"There is no url for momodle root.",normalView:"Normal view",noResultStd:"You are not permitted to see the result",NotAllowedError:"Webcam is disabled",NotFoundError:"Webcam is not available, or not connected properly.",NotReadableError:"Please ensure that same webcam is not being used <br /> in multiple browsers or multiple applications.",notsupportbrowser:"{virtualclass1} is not fully compatible. For the best experience, use Google Chrome.",
...
confirmCancel:"No",confirmOk:"Si",connectionClose:"La conexi\u00f3n est\u00e1 cerrada ({virtualclass1}).",connectionClosec310:"El plan gratuito no admite la funcionalidad de grabaci\u00f3n, por favor, actualice su plan o desactive la grabaci\u00f3n.",Controls:"Controles",coursePoll:"Encuesta de nivel de curso",Cpoll:"Encuesta del curso",Cquiz:"Cerrar cuestionario",createnewpoll:"Crear nueva encuesta",Creator:"Creador",comment:"Comentarios",dap:"Falso",delete:"Eliminar",delblank:"Eliminar la opci\u00f3n en blanco",
Delete:"Eliminar",DevicesNotFoundError:"La webcam no se encuentra disponible, o no est\u00e1 conectada correctamente.",deletepopup:"\u00bfEst\u00e1s seguro de eliminar? ?",disable:"Desactivar",disabled:"Desactivar",disableAllVideo:"Desactivar todo el video",dltDisabled:"Puede ser eliminado por el creador de la encuesta.",documentShare:"Compartir documento",DocumentSharing:"Compartiendo documentos",DocumentSharedbHeading:"Panel de documentos",docUploadSuccess:"Documento cargado exitosamente",download:"Descargar",
downloadFile:"Descargar archivo",downloadsession:"Por favor espere mientras se descarga la grabaci\u00f3n",drawArea:"\u00c1rea de dibujo",dropfilehere:"Suelta los archivos aqu\u00ed",duplicateUploadMsg:"Este archivo ya existe, cargue un archivo nuevo.",edit:"Editar",editorCode:"Editor de c\u00f3digo",edittitle:"Editar t\u00edtulo",editorRichDisable:"Modo de escritura",editorRichEnable:"Solo lectura",educator:"Educador",EHTMLPresentUrl:"Ingrese la URL de presentaci\u00f3n HTML5",enable:"Activar",enablehistory:'"Historial del navegador" debe habilitarse durante la sesi\u00f3n.',
enableAllVideo:"Activar todo el video",enteryouryoutubeurl:"Ingrese la URL de Youtube",etDisabledA:"No se puede editar, intento de encuesta",etDisabledCr:"Puede ser editado por el creador de la encuesta.",ETime:"Tiempo transcurrido",TimeRemaining:"Tiempo restante",QuestionsOverview:"Resumen de preguntas",UsersAttempted:"Los usuarios intentaron",gRname:"Nombre",gRtimeTaken:"Tiempo tomado",gRgrade:"Grado",gRQAttempted:"Q. intento",gRCorrect:"Correcto",FF2:"Avance r\u00e1pido 2",FF8:"Avance r\u00e1pido 8",
filenotsave:"Su archivo no se pudo guardar.",filetsaveTS:"La sesi\u00f3n est\u00e1 lista para guardarse.",Finish:"Finalizado",fitToPage:"Ajustar a la p\u00e1gina",fitToScreen:"Ajustar la pantalla",Freehand:"A mano",general:"General",Greport:"Informe de calificaciones",highBandWidthSpeed:"Su ancho de banda es lo suficientemente bueno.",httpsmissing:"Solo se permiten or\u00edgenes seguros (https) para compartir la pantalla.",ieBrowserIssue:"Internet Explorer no es compatible, Congrea es totalmente compatible con Chrome y Firefox.",
ios7support:"Para Apple, Virtual Class es compatible con iOS 8 y versiones superiores.",iosAudEnable:"Toque aqu\u00ed para habilitar el audio.",InternalError:"Aseg\u00farese de que no se est\u00e9 utilizando la misma c\u00e1mara web <br /> en varios navegadores o varias aplicaciones. ",invalidcmid:"ID del m\u00f3dulo del curso no v\u00e1lido",invalidurl:"URL inv\u00e1lida",indvprogress:"Tarea actual",InsertimageURL:"Insertar URL de la imagen",JoinClassMsg:"\u00danete al aula",JoinSession:"\u00danete a la session",
keymissing:"Su software(LMS/CMS)'s falta la Key",Line:"L\u00ednea",livestream:"Transmisi\u00f3n en vivo",lowBandWidthSpeed:"Su ancho de banda es demasiado bajo, estamos deteniendo la reproducci\u00f3n de video. A\u00fan podr\u00e1 escuchar el audio y ver la pantalla.",maxCommonChat:"Mostrar ventana de chat",Max_rooms:"Error: L\u00edmite m\u00e1ximo de salas alcanzado",Max_users:"Error: L\u00edmite m\u00e1ximo de usuarios alcanzado",media:"Media",mediumBandWidthSpeed:"Su ancho de banda es limitado, estamos reduciendo la calidad de video en funci\u00f3n de su ancho de banda disponible.",
minCommonChat:"Ocultar ventana de chat",minoption:"Ingrese al menos dos opciones",microphoneNotConnected:"El micr\u00f3fono no est\u00e1 disponible o no est\u00e1 conectado correctamente",mictesting:"El micr\u00f3fono funciona, si la barra de audio anterior fluct\u00faa <br />y puedes escuchar tu propia voz mientras hablas",minute:"Minuto",ModeclosingPoll:"Modo de cerrar la encuesta :",msgForDownloadStart:"No se pueden guardar los datos. <br /> Preparando datos para descargar",msgForReload:"Vuelva a cargar esta p\u00e1gina para continuar editando.",
msgForWhiteboard:"Pizarra vac\u00eda.",msgStudentForReload:"Por favor, vuelva a cargar esta p\u00e1gina.",Multiple_login:"Error: Acceso denegado, m\u00faltiples inicios de sesi\u00f3n",muteAll:"Silenciar todo",muteAllAudio:"Silenciar todo el audio",mybsharedoc:"El documento se compartir\u00e1 en breve.",NAME:"NOMBRE",Next:"Siguiente",note:"A\u00f1adir nota",notePlaceholder:"Escribe tu nota aqu\u00ed",page:"P\u00e1gina",of:"de",typeQuestion:"Escriba pregunta",typeOption:"Opci\u00f3n de tipo",dropVideosHere:"Suelta videos aqu\u00ed",
nomdlroot:"No hay URL para Moodle.",normalView:"Vista normal",noResultStd:"No tiene permiso para ver el resultado.",NotAllowedError:"Webcam desactivada",NotFoundError:"La Webcam no est\u00e1 disponible o no est\u00e1 conectada correctamente.",NotReadableError:"Aseg\u00farese de que no se est\u00e9 utilizando la misma webcam <br /> en varios navegadores o varias aplicaciones.",notsupportbrowser:"{virtualclass1} no es totalmente compatible. Para la mejor experiencia, use Google Chrome.",NotSupportedError:"Solo se permiten or\u00edgenes seguros (https) para audio y video",
notSupportIphone:"Lo siento. La clase virtual no es compatible con tel\u00e9fonos m\u00f3viles.",noPoll:'No hay preguntas disponibles para la encuesta. Vaya a "Agregar nuevo" para crear una pregunta.',noPollNoAdmin:"No hay preguntas disponibles para la encuesta del sitio. Solo el administrador puede crear una encuesta a nivel del sitio.",noQuiz:"No hay cuestionario disponible. Agregue un cuestionario en su Moodle. Congrea solo admite preguntas de opci\u00f3n m\u00faltiple.",Novote:"No se recibi\u00f3 voto para esta encuesta.",
nowebcam:"Webcam no disponible o no est\u00e1 conectada correctamente.",nowebcamconnectedyet:"Congrea a\u00fan no recibi\u00f3 ninguna acceso de usuario.",notcompatiblecpu:"La potencia del procesador en este sistema es baja. <br /> Es aconsejable trabajar con un procesador m\u00e1s potente",notcompatibleram:"Su sistema no dispone de suficiente memoria ram. <br /> Es recomendable disponer al menos de 4GB.",offcollaboration:"Colaboraci\u00f3n descactivada",oncollaboration:"Colaboraci\u00f3n activada",
opendsDbheading:"Panel de documento",openSharePresentationdbHeading:"Panel de Presentaci\u00f3n",openvideoDashboard:"Panel de V\u00eddeo",operaBrowserIssue:"Su navegador {virtualclass1} {virtualclass2} no es totalmente compatible. No podr\u00e1 compartir su pantalla, Congrea es totalmente compatible con Chrome y Firefox",Options:"Opciones",optselectd:"SELECCIONAR OPCI\u00d3N",Oval:"\u00d3valo",overallprogress:"Progreso general",Pause:"Pausar",pclosetag:"<span>\u00bfEst\u00e1s seguro de cerrar esta encuesta?  </span>",
...
this.prefixUrl?(roles.hasControls()&&(console.log("==> attach click event "),document.getElementById("startLiveStream").addEventListener("click",this.handlLiveStream.bind(this))),this.alreadyInit=!0):setTimeout(()=>{console.log("Prefix was not found",this.prefixUrl);this.init()},1500))}requestStream(c){c&&this.xhr.get(c).then(async b=>{this.afterReceivedStream(b)}).catch(b=>{5>=this.fileList.ol.order.length?this.lastFileRequested=this.firstFile:setTimeout(()=>{console.log("trigger init packet with ",
this.lastFileRequested);this.requestInitializePacket(this.lastFileRequested)},2E3)})}getFileName(c){const b=c.lastIndexOf("/");return c.substring(b+1).replace(".chvs","")}duringPlayFirstPacket(){var c=document.getElementById("virtualclassVideo");c&&(c.dataset.currapp="liveStream");if(c=document.getElementById("messageLayoutVideo"))c.style.display="none"}afterReceivedStream(c){console.log("play start data received");const b=c.data.slice(4,c.data.length);c=this.getFileName(c.config.url);this.listStream[c]=
b;console.log("reponse receive at very start, Play start 0 ",c);this.playIfReady(c);console.log("====> response received for file ",c)}onBuffer(c){this.sourceBuffer&&this.sourceBuffer.appendBuffer(c)}readyParticipateVideo(){this.remoteVideo||(this.remoteVideo=document.getElementById("liveStream"),this.remoteVideo.srcObject=null,this.remoteVideo.currentTime=0)}initPLayerForParticipaes(){console.log("current mode LIVE STREAM");this.mediaSource=new MediaSource;this.mediaSource.addEventListener("sourceopen",
this.mediaSourceOpen.bind(this));this.readyParticipateVideo();this.remoteVideo.src=URL.createObjectURL(this.mediaSource)}mediaSourceOpen(){console.log("step 1");"open"===this.mediaSource.readyState&&(this.sourceBuffer=this.mediaSource.addSourceBuffer(this.mimeType),this.sourceBuffer.addEventListener("error",c=>{console.log(c)}),this.sourceBuffer.addEventListener("updateend",()=>{console.log("====> appended start: remove 2");const c=this.fileList.getNextByID(virtualclass.liveStream.currentExecuted);
console.log(" ===> actual PLAY START 2");c&&this.playIfReady(c.id)}))}handlLiveStream(c){"0"===c.currentTarget.dataset.sharinglivestream?this.startToShare():(this.stop(),c=document.querySelector("#dashboardnav button"),null!=c&&c.click())}disableLiveStreamButton(){const c=document.getElementById("startLiveStream");null!=c&&c.classList.add("disabled")}async startToShare(){this.stopTraditionalVideo();document.getElementById("startLiveStream").dataset.sharinglivestream="1";let c=null;try{c=await navigator.mediaDevices.getUserMedia(this.constraints)}catch(b){this.disableLiveStreamButton(),
virtualclass.media.handleUserMediaError(b)}c&&this.handleSuccess(c)}handleSuccess(c){const b=c.getVideoTracks()[0].getSettings();console.log("====> camera settings ",b);console.log("getUserMedia() got stream:",c);this.stream=c;virtualclass.dashboard.close();this.showLiveStreamHTML();document.getElementById("liveStream").srcObject=this.stream;this.startRecorder(b.width)}startRecorder(c){let b=3E5;640<c&&1920>=c?b=5E5:1920<c&&(b=1E6);console.log("current mode LIVE STREAM");console.log("video bit per second ",
b);MediaRecorder.isTypeSupported(this.mimeType)||console.error(`${this.mimeType} is not supported`);this.mediaRecorder=new MediaRecorder(this.stream,{mimeType:this.mimeType,videoBitsPerSecond:b});this.mediaRecorder.addEventListener("stop",this.stopHandler.bind(this));this.mediaRecorder.addEventListener("dataavailable",this.handleLiveStreamData.bind(this));this.mediaRecorder.start(2E3)}stopHandler(){console.log("====STOP 1")}handleLiveStreamData(c){console.log("====> triggering data ");this.mediaRecorder&&
"recording"===this.mediaRecorder.state&&this.saveToStreamServer(c.data)}async saveToStreamServer(c){c=await this.videoTypedArray(c);ioAdapter.sendStream(c)}async videoTypedArray(c){c=await c.arrayBuffer();c=new Uint8Array(c);let b=new c.constructor(2);b[0]=72;b[1]=78;let a=new c.constructor(c.length+b.length);a.set(b,0);a.set(c,b.length);return a}stop(){document.getElementById("startLiveStream").dataset.sharinglivestream="0";this.mediaRecorder&&"inactive"!==this.mediaRecorder.state&&this.mediaRecorder.stop();
this.hideLiveStreamHTML();this.disableLiveStreamButton();roles.hasControls()&&(ioAdapter.mustSend({cf:"liveStream",stop:!0}),this.clearEveryThing());setTimeout(()=>{const c=document.getElementById("startLiveStream");null!=c&&c.classList.remove("disabled")},5E3)}stopTraditionalVideo(){Object.prototype.hasOwnProperty.call(virtualclass,"videoUl")&&Object.prototype.hasOwnProperty.call(virtualclass.videoUl,"player")&&virtualclass.videoUl.destroyPlayer();const c=document.getElementById("videoPlayerCont");
c&&(c.style.display="none");roles.hasControls()&&ioAdapter.mustSend({cf:"liveStream",stopVideo:!0})}clearEveryThing(){console.log("Removed live stream");delete virtualclass.gObj.videoMode;console.log("delete normal video");var c=document.getElementById("virtualclassVideo");null!=c&&(c.dataset.currapp="normalVideo",c=document.getElementById("messageLayoutVideo"))&&(c.style.display="block");this.stream&&this.stream.getTracks().forEach(b=>{b.stop()});this.mediaRecorder&&delete this.mediaRecorder;if(this.sourceBuffer){if(this.sourceBuffer.updating)this.sourceBuffer.abort(),
console.log("Source buffer abort");else{try{this.sourceBuffer.remove(0,300)}catch(b){this.sourceBuffer.abort()}console.log("====> appended start: remove 3");console.log("Source buffer remove")}delete this.sourceBuffer;delete this.mediaSource}this.startedStream=!1;c=document.getElementById("liveStream");null!=c&&(c.src=null);delete this.firstFile;console.log("====> Empty the list 2a");delete this.startingPoint;delete this.startedAppending;this.fileList.emptyList();delete this.lastFileRequested;delete virtualclass.liveStream.callFromSeek;
delete this.startFromPageRefresh;console.log("====> appended start: remove 1")}showLiveStreamHTML(){document.getElementById("virtualclassVideo").dataset.currapp="liveStream"}hideLiveStreamHTML(){document.getElementById("virtualclassVideo").dataset.currapp="normalVideo"}isLiveStreamMode(){return"liveStream"===document.getElementById("virtualclassVideo").dataset.currapp}onMessage(c){c.message.fileName?(console.log("Received file from server ",c.message.fileName),setTimeout(()=>{"Video"===virtualclass.currApp&&
this.mediaRecorder&&"recording"===this.mediaRecorder.state&&(console.log("====> send file ",c.message.fileName),ioAdapter.mustSend({cf:"liveStream",url:c.message.fileName}))},3E3)):c.message.stop?this.clearEveryThing():c.message.stopVideo?this.stopTraditionalVideo():c.message.url&&"Video"===virtualclass.currApp&&!Object.prototype.hasOwnProperty.call(virtualclass.gObj,"videoMode")&&roles.isStudent()&&(console.log("====> Empty the list 2"),this.firstFile||(this.firstFile=c.message.url),this.lastFileRequested=
c.message.url,console.log("Last file request ",this.lastFileRequested),this.fileList.insert(c.message.url,`${this.prefixUrl}/${c.message.url}.chvs`),!this.startingPoint&&this.fileList.ol.order.length>=this.bufferLength&&this.readyStartingPoint(),this.insertTime&&(clearTimeout(this.insertTime),this.pageRefresh=!0),this.insertTime=setTimeout(()=>{this.pageRefresh?5>=this.fileList.ol.order.length?(this.triggerStart(this.fileList.ol.order[0]),console.log("live stream, start from first ",this.fileList.ol.order.length)):
this.startFromPageRefresh||(this.startFromPageRefresh=!0,virtualclass.liveStream.callFromSeek||this.requestInitializePacket(),console.log("live stream, start from latest",this.fileList.ol.order.length)):this.triggerStart(c.message.url);console.log("page refresh remove");this.insertTime=this.pageRefresh=!1;console.log("live video suman 1")},100))}requestInitializePacket(c){this.stopTraditionalVideo();this.initPLayerForParticipaes();this.xhrInitPacket||(this.xhrInitPacket=axios.create({responseType:"arraybuffer",
headers:{"Content-Type":"application/json","x-api-key":wbUser.lkey,"x-congrea-authuser":wbUser.auth_user,"x-congrea-authpass":wbUser.auth_pass,"x-congrea-room":wbUser.room,get:{Accept:"video/webm;codecs=vp8,opus"}}}));let b;b=virtualclass.isPlayMode?wbUser.session:null!=localStorage.mySession?localStorage.mySession:virtualclass.gObj.currentSession;c=c?`https://api.congrea.net/data/stream?session=${b}&file=${c}`:`https://api.congrea.net/data/stream?session=${b}`;console.log("request url init packet ",
c);this.requestInitializePacketFinal(c)}requestInitializePacketFinal(c){this.latesRequetInitUrl=c;console.log("request url live stream init data ",c);this.xhrInitPacket.get(c).then(async b=>{this.latesRequetInitUrl===b.config.url&&(this.currentFile=b.headers["x-congrea-seg"].split(".chvs")[0],console.log("request url, stream receive init data ",this.currentFile,b.config.url.split("?")[1]),this.startedStream=!0,this.listStream[this.currentFile]=b.data,this.firstFile=b.headers["x-congrea-seg"].split(".chvs")[0],
delete this.startingPoint,console.log("calculate starting point"),this.readyStartingPoint())})}triggerStart(c){this.startedStream?this.startedStream&&0<this.fileList.ol.order.length&&(c=this.fileList.getNextByID(this.currentFile),this.requestStream(c.data),this.currentFile=c.id):(this.initPLayerForParticipaes(),this.requestStream(this.fileList.getCurrent(c)),this.currentFile=c,this.startedStream=!0)}isMyTurn(c){const b=this.fileList.getNextByID(this.currentExecuted);console.log("is my turn curernt, next ",
this.currentExecuted,b.id,c);return b.id===c}inStreamList(c){return this.listStream[c]?this.listStream[c]:!1}readyStartingPoint(){let c=this.firstFile;if(-1>=this.fileList.getCurrentPosition(c))console.log("NOT FOUND ON LIST");else{var b;if(1<this.bufferLength){for(let a=1;a<this.bufferLength;a++)if(b=this.fileList.getNextByID(c))c=b.id;c!=this.firstFile&&(this.startingPoint=c)}}}playIfReady(c){var b=this.inStreamList(c);if(this.startingPoint&&c===this.startingPoint&&this.inStreamList(this.firstFile)){b=
this.inStreamList(this.firstFile);try{this.onBuffer(b),console.log("Actual append buffer ",this.firstFile),this.currentExecuted=this.firstFile,delete this.listStream[this.firstFile],this.startedAppending=!0,this.duringPlayFirstPacket(),this.startFromPageRefresh&&setTimeout(()=>{document.getElementById("liveStream").currentTime=this.MAX_TIME;console.log("REFRESH THE SCREEN")},virtualclass.isPlayMode?700:1600)}catch(a){this.requestInitializePacket(c),console.log("====> Error handlling request packet")}}else if(this.startedAppending&&
this.isMyTurn(c)&&b)try{this.onBuffer(b),console.log("Actual append buffer ",c),delete this.listStream[c],this.currentExecuted=c}catch(a){this.requestInitializePacket(c),console.log("====> Error handlling request packet")}}};$.uiBackCompat=!1;
