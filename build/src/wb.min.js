...
this.binarySyncMsg=null)}this.collectElapsedPlayTime()}catch(g){}if(virtualclass.settings.info.trimRecordings&&this.selfStartSeek&&this.seekFinished()){this.selfSeekFinished=!0;break}this.subRecordingIndex++}this.elapsedRecTime=this.elapsedTime=this.elapsedPlayTime;if(void 0!=a&&this.masterIndex===a.master&&a.sub===this.subRecordingIndex||this.selfSeekFinished)break;else this.subRecordingIndex=0,this.masterIndex++,this.subRecordings=this.masterRecordings[this.masterIndex]}},handleSyncStringPacket(){if("Poll"==
