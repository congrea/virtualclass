...
c.y);a.e.isTrusted&&this.activeDown&&this.down&&(this.down=!1,WhiteboardMessage.send(virtualclass.wbWrapper.gObj.previousData),b=this.generateData(a,b,"u"),WhiteboardMessage.send(b))}};class WhiteboardReplay{init(c){this.objs=virtualclass.wb[c].vcanMainReplayObjs;this.objNo=0}renderObj(c){var b=virtualclass.wbWrapper.protocol.decode(this.objs[this.objNo],c);let a;switch(b.action){case "sp":virtualclass.wb[c].selectedTool=b.tool;console.log("====> selected id suman for  ",c,virtualclass.wb[c].selectedTool);var d=b.event;a=`${b.shape}Obj`;virtualclass.wb[c][a][d](b.actual,virtualclass.wb[c]);break;case "ac":virtualclass.wb[c].selectedTool=b.tool;b.event&&"mousedown"===b.event&&virtualclass.wb[c].innerToolbarHandler(virtualclass.wbWrapper.keyMap[b.action],
c);d=WhiteboardUtility.readyMouseEvent(b.event,b.actual);d.wId=c;virtualclass.wb[c].canvas.upperCanvasEl.dispatchEvent(d);b.event&&"mousedown"===b.event&&(b=virtualclass.wb[c].canvas._getEventPrefix(),fabric.util.removeListener(fabric.document,b+"move",virtualclass.wb[c].canvas._onMouseMove,{passive:!1}),fabric.util.removeListener(fabric.document,b+"up",virtualclass.wb[c].canvas._onMouseUp,{passive:!1}),fabric.util.addListener(virtualclass.wb[c].canvas.upperCanvasEl,b+"move",virtualclass.wb[c].canvas._onMouseMove,
{passive:!1}),fabric.util.addListener(virtualclass.wb[c].canvas.upperCanvasEl,b+"up",virtualclass.wb[c].canvas._onMouseUp,{passive:!1}));break;case "cr":virtualclass.wb[b.actual].clear();break;case "ds":virtualclass.wb[b.actual].canvas.discardActiveObject();virtualclass.wb[b.actual].canvas.renderAll();break;case "da":WhiteboardUtility.deleteActiveObject(!1,c);break;case "ot":WhiteboardUtility.updateToolStyle(b.tool,b.actual.value,c);break;case "tx":virtualclass.wb[c].selectedTool=b.tool;virtualclass.wb[c].textObj.renderText(b.actual,
