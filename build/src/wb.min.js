...
b,a){this.mousedown=!0;"freeDrawing"===this.name?(b.myPencil||(b.myPencil=new fabric.PencilBrush(b.canvas),b.myPencil.width=this.default.strokeWidth,b.strokeSize&&(b.myPencil.width=+b.strokeSize),b.myPencil.color=this.default.stroke,b.toolColor&&(b.myPencil.color=b.toolColor,console.log("====> stroke color ",b.myPencil.color))),a||(a={e:{isPrimary:!0}}),b.myPencil.onMouseDown(c,a)):(this.startLeft=c.x,this.startTop=c.y,this.coreObj.left=this.startLeft,this.coreObj.top=this.startTop,
...
this.default.cornerSize*virtualclass.zoom.canvasScale,this.coreObj.fontSize=this.default.fontSize,b.fontSize&&(this.coreObj.fontSize=+b.fontSize),this.coreObj.fill=this.default.fill,b.toolColor&&(this.coreObj.fill=b.toolColor),this[this.name]=new fabric.IText(c,this.coreObj),b.canvas.add(this[this.name]))}finalizeText(c){const b=virtualclass.wb[virtualclass.gObj.currWb];this.textEditing=!1;if(!this.isDefault(c.target)){virtualclass.wbWrapper.gObj.lastSentDataTime=(new Date).getTime();
