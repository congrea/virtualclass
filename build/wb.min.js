...
d.tempVid.height);c.navigator.userAgent.match("Firefox")?g():d.tempVidCont.drawImage(d.myVideo,0,0,d.width,d.height);roles.hasControls()&&cthis.audio.graph.display();h={name:virtualclass.gObj.uName,id:virtualclass.gObj.uid};roles.hasControls()&&(h.role=virtualclass.gObj.uRole);virtualclass.vutil.beforeSend({videoByImage:h,cf:"videoByImage"},null,!0);var h=d.tempVidCont.getImageData(0,0,d.tempVid.width,d.tempVid.height),h=virtualclass.dirtyCorner.encodeRGB(h.data),w=b(virtualclass.gObj.uid,8),w=new Uint8ClampedArray([11,
w[0],w[1],w[2],w[3]]),q=new Uint8ClampedArray(h.length+w.length);q.set(w);q.set(h,w.length);ioAdapter.sendBinary(q);clearInterval(virtualclass.gObj.video.smallVid);h=2E3+2500*virtualclass.gObj.totalUser.length;f!=virtualclass.gObj.totalUser?(f=virtualclass.gObj.totalUser.length,w=virtualclass.gObj.totalUser.indexOf(virtualclass.gObj.uId),virtualclass.gObj.video.smallVid=setInterval(a,h+h/f*w)):virtualclass.gObj.video.smallVid=setInterval(a,h)}function b(a,d){for(var c=a.toString(),f=c.length;f<d;f++)c=
...
r.video.offsetHeight;r.localtempCont.drawImage(r.video,0,0,r.video.offsetWidth,r.video.offsetHeight);var x=r.localtempCont.getImageData(0,0,r.localtempCanvas.width,r.localtempCanvas.height),x=r.dc.encodeRGB(x.data),G=Math.round(r.localtempCanvas.width/q),S=Math.round(r.localtempCanvas.height/w),D,O,N,X;X=r.getContainerDimension();"undefined"!=typeof d&&"undefined"!=typeof f?(D=b(d,4),O=b(f,4)):(D=b(r.video.offsetWidth,4),O=b(r.video.offsetHeight,4));N=b(X.width,4);X=b(X.height,4);t=new Uint8ClampedArray(["ss"==
t?104:204,D[0],D[1],O[0],O[1],N[0],N[1],X[0],X[1]]);D=new Uint8ClampedArray(x.length+t.length);D.set(t);D.set(x,t.length);c.Worker&&sworker.postMessage({img:x,resize:1,resA:w,resB:q,dw:G,dh:S,offsetWidth:r.video.offsetWidth,offsetHeight:r.video.offsetHeight},[x.buffer]);ioAdapter.sendBinary(D);m(D.length/128);a=0;clearInterval(virtualclass.clear);virtualclass.clear=setInterval(g,u)}}function t(a){r.localtempCanvas.width=r.video.offsetWidth;r.localtempCanvas.height=r.video.offsetHeight;r.localtempCont.drawImage(r.video,
0,0,r.video.offsetWidth,r.video.offsetHeight);a=Math.round(r.localtempCanvas.width/q);var b=Math.round(r.localtempCanvas.height/w),d=r.localtempCont.getImageData(0,0,r.video.offsetWidth,r.video.offsetHeight);c.Worker&&(sworker.postMessage({img:d.data,resA:w,resB:q,dw:a,dh:b,offsetWidth:r.video.offsetWidth,offsetHeight:r.video.offsetHeight,type:r.type},[d.data.buffer]),sworker.onmessage=function(a){if(1==a.data.needFullScreen){a=virtualclass.getDataFullScreen(r.type);ioAdapter.sendBinary(a);var b=
a.length/128}else null!=a.data.masterSlice&&(ioAdapter.sendBinary(a.data.masterSlice),b=a.data.masterSlice.length/128);m(b);clearInterval(virtualclass.clear);virtualclass.clear=setInterval(g,u)});clearInterval(virtualclass.clear)}var w=Math.round(this.localtempCanvas.height/12),q=Math.round(this.localtempCanvas.width/12),r=this;virtualclass.hasOwnProperty("wholeImage")&&clearInterval(virtualclass.wholeImage);virtualclass.hasOwnProperty("clear")&&clearInterval(virtualclass.clear);var u=1E3;virtualclass.getDataFullScreen=
...
var m=a.createElement("div");m.id=b+c+"Cont";m.className="controleCont";m.appendChild(h);return[m,g]},createAssignControl:function(b,c,g,h){var m=this,p=this.createControllerElement(c,"contrAssign"),s=p[0],v=p[1],p=a.getElementById(c+"ControlContainer");null!=p?0>=p.getElementsByClassName("controleCont").length?p.appendChild(s):p.insertBefore(s,p.firstChild):b.appendChild(s);virtualclass.user.control.changeAttribute(c,v,g,"assign","aRole");"undefined"!=typeof h&&(v.className+=" currTeacher");v.addEventListener("click",
...
w,A,c[t],c[t]);x&&w.addEventListener("click",h.closureEditor(h,w))}},closureEditor:function(a,b){return function(){a.control.init.call(a,b)}},control:{toggleDisplayWriteModeMsgBox:function(b,c){var g=a.getElementById(b+"writeModeBox"),h=c?virtualclass.lang.getString("writemode"):virtualclass.lang.getString("readonlymode"),m=a.getElementById("virtualclass"+b+"Body");null==g&&null!=m&&(g=a.createElement("div"),g.id=b+"writeModeBox",m.appendChild(g));null!=g&&(g.className="writeModeBox",g.dataset.writeMode=
...
setInterval(function(){virtualclass.yts.triggerOnSeekChange()},2E3)}}};c.onYouTubeIframeAPIReady=function(){b.ytApiReady=!0;console.log("onYouTubeIframeAPIReady is ready now")};c.yts=b})(window,document);var CodeMirror=function(){function c(H,b){if(!(this instanceof c))return new c(H,b);this.options=b=b?oa(b):{};oa(of,b,!1);t(b);var T=b.value;"string"==typeof T&&(T=new ha(T,b.mode,null,b.lineSeparator));this.doc=T;var d=new c.inputStyles[b.inputStyle](this),d=this.display=new a(H,T,d);d.wrapper.CodeMirror=this;p(this);h(this);b.lineWrapping&&(this.display.wrapper.className+=" CodeMirror-wrap");b.autofocus&&!tb&&d.input.focus();u(this);this.state={keyMaps:[],overlays:[],modeGen:0,overwrite:!1,delayingBlurEvent:!1,
focused:!1,suppressEdits:!1,pasteIncoming:!1,cutIncoming:!1,draggingText:!1,highlight:new ub,keySeq:null,specialChars:null};var n=this;M&&11>V&&setTimeout(function(){n.display.input.reset(!0)},20);pf(this);Dd||(qf(),Dd=!0);ab(this);this.curOp.forceUpdate=!0;Ed(this,T);b.autofocus&&!tb||n.hasFocus()?setTimeout(vb(Nc,this),20):wb(this);for(var f in bb)if(bb.hasOwnProperty(f))bb[f](this,b[f],Fd);D(this);b.finishInit&&b.finishInit(this);for(T=0;T<Oc.length;++T)Oc[T](this);cb(this);Z&&b.lineWrapping&&
"optimizelegibility"==getComputedStyle(d.lineDiv).textRendering&&(d.lineDiv.style.textRendering="auto")}function a(a,b,c){this.input=c;this.scrollbarFiller=C("div",null,"CodeMirror-scrollbar-filler");this.scrollbarFiller.setAttribute("cm-not-content","true");this.gutterFiller=C("div",null,"CodeMirror-gutter-filler");this.gutterFiller.setAttribute("cm-not-content","true");this.lineDiv=C("div",null,"CodeMirror-code");this.selectionDiv=C("div",null,null,"position: relative; z-index: 1");this.cursorDiv=
C("div",null,"CodeMirror-cursors");this.measure=C("div",null,"CodeMirror-measure");this.lineMeasure=C("div",null,"CodeMirror-measure");this.lineSpace=C("div",[this.measure,this.lineMeasure,this.selectionDiv,this.cursorDiv,this.lineDiv],null,"position: relative; outline: none");this.mover=C("div",[C("div",[this.lineSpace],"CodeMirror-lines")],null,"position: relative");this.sizer=C("div",[this.mover],"CodeMirror-sizer");this.sizerWidth=null;this.heightForcer=C("div",null,null,"position: absolute; height: "+
Gd+"px; width: 1px;");this.gutters=C("div",null,"CodeMirror-gutters");this.lineGutter=null;this.scroller=C("div",[this.sizer,this.heightForcer,this.gutters],"CodeMirror-scroll");this.scroller.setAttribute("tabIndex","-1");this.wrapper=C("div",[this.scrollbarFiller,this.gutterFiller,this.scroller],"CodeMirror");M&&8>V&&(this.gutters.style.zIndex=-1,this.scroller.style.paddingRight=0);Z||Na&&tb||(this.scroller.draggable=!0);a&&(a.appendChild?a.appendChild(this.wrapper):a(this.wrapper));this.reportedViewFrom=
...
this.wheelStartX=this.wheelStartY=null;this.shift=!1;this.activeTouch=this.selForContextMenu=null;c.init(this)}function b(a){a.doc.mode=c.getMode(a.options,a.doc.modeOption);d(a)}function d(a){a.doc.iter(function(a){a.stateAfter&&(a.stateAfter=null);a.styles&&(a.styles=null)});a.doc.frontier=a.doc.first;xb(a,100);a.state.modeGen++;a.curOp&&ia(a)}function f(a){var b=Oa(a.display),c=a.options.lineWrapping,d=c&&Math.max(5,a.display.scroller.clientWidth/yb(a.display)-3);return function(n){if(Pa(a.doc,
n))return 0;var f=0;if(n.widgets)for(var g=0;g<n.widgets.length;g++)n.widgets[g].height&&(f+=n.widgets[g].height);return c?f+(Math.ceil(n.text.length/d)||1)*b:f+b}}function g(a){var b=a.doc,c=f(a);b.iter(function(a){var H=c(a);H!=a.height&&ua(a,H)})}function h(a){a.display.wrapper.className=a.display.wrapper.className.replace(/\s*cm-s-\S+/g,"")+a.options.theme.replace(/(^|\s)\s*/g," cm-s-");zb(a)}function m(a){p(a);ia(a);setTimeout(function(){S(a)},20)}function p(a){var b=a.display.gutters,c=a.options.gutters;
Qa(b);for(var d=0;d<c.length;++d){var n=c[d],f=b.appendChild(C("div",null,"CodeMirror-gutter "+n));"CodeMirror-linenumbers"==n&&(a.display.lineGutter=f,f.style.width=(a.display.lineNumWidth||1)+"px")}b.style.display=d?"":"none";s(a)}function s(a){a.display.sizer.style.marginLeft=a.display.gutters.offsetWidth+"px"}function v(a){if(0==a.height)return 0;for(var b=a.text.length,c,d=a;c=Ra(d,!0);)c=c.find(0,!0),d=c.from.line,b+=c.from.ch-c.to.ch;for(d=a;c=Ra(d,!1);)c=c.find(0,!0),b-=d.text.length-c.from.ch,
d=c.to.line,b+=d.text.length-c.to.ch;return b}function x(a){var b=a.display;a=a.doc;b.maxLine=B(a,a.first);b.maxLineLength=v(b.maxLine);b.maxLineChanged=!0;a.iter(function(a){var H=v(a);H>b.maxLineLength&&(b.maxLineLength=H,b.maxLine=a)})}function t(a){var b=ca(a.gutters,"CodeMirror-linenumbers");-1==b&&a.lineNumbers?a.gutters=a.gutters.concat(["CodeMirror-linenumbers"]):-1<b&&!a.lineNumbers&&(a.gutters=a.gutters.slice(0),a.gutters.splice(b,1))}function w(a){var b=a.display,c=b.gutters.offsetWidth,
d=Math.round(a.doc.height+Pc(a.display));return{clientHeight:b.scroller.clientHeight,viewHeight:b.wrapper.clientHeight,scrollWidth:b.scroller.scrollWidth,clientWidth:b.scroller.clientWidth,viewWidth:b.wrapper.clientWidth,barLeft:a.options.fixedGutter?c:0,docHeight:d,scrollHeight:d+va(a)+b.barHeight,nativeBarWidth:b.nativeBarWidth,gutterWidth:c}}function q(a,b,c){this.cm=c;var d=this.vert=C("div",[C("div",null,null,"min-width: 1px")],"CodeMirror-vscrollbar"),n=this.horiz=C("div",[C("div",null,null,
"height: 100%; min-height: 1px")],"CodeMirror-hscrollbar");a(d);a(n);E(d,"scroll",function(){d.clientHeight&&b(d.scrollTop,"vertical")});E(n,"scroll",function(){n.clientWidth&&b(n.scrollLeft,"horizontal")});this.checkedOverlay=!1;M&&8>V&&(this.horiz.style.minHeight=this.vert.style.minWidth="18px")}function r(){}function u(a){a.display.scrollbars&&(a.display.scrollbars.clear(),a.display.scrollbars.addClass&&Ab(a.display.wrapper,a.display.scrollbars.addClass));a.display.scrollbars=new c.scrollbarModel[a.options.scrollbarStyle](function(b){a.display.wrapper.insertBefore(b,
a.display.scrollbarFiller);E(b,"mousedown",function(){a.state.focused&&setTimeout(function(){a.display.input.focus()},0)});b.setAttribute("cm-not-content","true")},function(b,c){"horizontal"==c?db(a,b):Bb(a,b)},a);a.display.scrollbars.addClass&&Cb(a.display.wrapper,a.display.scrollbars.addClass)}function A(a,b){b||(b=w(a));var c=a.display.barWidth,d=a.display.barHeight;K(a,b);for(var n=0;4>n&&c!=a.display.barWidth||d!=a.display.barHeight;n++)c!=a.display.barWidth&&a.options.lineWrapping&&ac(a),K(a,
...
c.gutterFiller.style.height=d.bottom+"px",c.gutterFiller.style.width=b.gutterWidth+"px"):c.gutterFiller.style.display=""}function G(a,b,c){var d=c&&null!=c.top?Math.max(0,c.top):a.scroller.scrollTop,d=Math.floor(d-a.lineSpace.offsetTop),n=c&&null!=c.bottom?c.bottom:d+a.wrapper.clientHeight,d=Sa(b,d),n=Sa(b,n);if(c&&c.ensure){var f=c.ensure.from.line;c=c.ensure.to.line;f<d?(d=f,n=Sa(b,wa(B(b,f))+a.wrapper.clientHeight)):Math.min(c,b.lastLine())>=n&&(d=Sa(b,wa(B(b,c))-a.wrapper.clientHeight),n=c)}return{from:d,
to:Math.max(n,d+1)}}function S(a){var b=a.display,c=b.view;if(b.alignWidgets||b.gutters.firstChild&&a.options.fixedGutter){for(var d=N(b)-b.scroller.scrollLeft+a.doc.scrollLeft,n=b.gutters.offsetWidth,f=d+"px",g=0;g<c.length;g++)if(!c[g].hidden){a.options.fixedGutter&&c[g].gutter&&(c[g].gutter.style.left=f);var h=c[g].alignable;if(h)for(var m=0;m<h.length;m++)h[m].style.left=f}a.options.fixedGutter&&(b.gutters.style.left=d+n+"px")}}function D(a){if(!a.options.lineNumbers)return!1;var b=a.doc,b=O(a.options,
...
function N(a){return a.scroller.getBoundingClientRect().left-a.sizer.getBoundingClientRect().left}function X(a,b,c){var d=a.display;this.viewport=b;this.visible=G(d,a.doc,b);this.editorIsHidden=!d.wrapper.offsetWidth;this.wrapperHeight=d.wrapper.clientHeight;this.wrapperWidth=d.wrapper.clientWidth;this.oldDisplayWidth=Ha(a);this.force=c;this.dims=Qc(a);this.events=[]}function Q(a,b){var c=a.display,d=a.doc;if(b.editorIsHidden)return Ia(a),!1;if(!b.force&&b.visible.from>=c.viewFrom&&b.visible.to<=
c.viewTo&&(null==c.updateLineNumbers||c.updateLineNumbers>=c.viewTo)&&c.renderedView==c.view&&0==Hd(a))return!1;D(a)&&(Ia(a),b.dims=Qc(a));var n=d.first+d.size,f=Math.max(b.visible.from-a.options.viewportMargin,d.first),g=Math.min(n,b.visible.to+a.options.viewportMargin);c.viewFrom<f&&20>f-c.viewFrom&&(f=Math.max(d.first,c.viewFrom));c.viewTo>g&&20>c.viewTo-g&&(g=Math.min(n,c.viewTo));Ja&&(f=Rc(a.doc,f),g=Id(a.doc,g));d=f!=c.viewFrom||g!=c.viewTo||c.lastWrapHeight!=b.wrapperHeight||c.lastWrapWidth!=
b.wrapperWidth;n=a.display;0==n.view.length||f>=n.viewTo||g<=n.viewFrom?(n.view=bc(a,f,g),n.viewFrom=f):(n.viewFrom>f?n.view=bc(a,f,n.viewFrom).concat(n.view):n.viewFrom<f&&(n.view=n.view.slice(Ta(a,f))),n.viewFrom=f,n.viewTo<g?n.view=n.view.concat(bc(a,n.viewTo,g)):n.viewTo>g&&(n.view=n.view.slice(0,Ta(a,g))));n.viewTo=g;c.viewOffset=wa(B(a.doc,c.viewFrom));a.display.mover.style.top=c.viewOffset+"px";g=Hd(a);if(!d&&0==g&&!b.force&&c.renderedView==c.view&&(null==c.updateLineNumbers||c.updateLineNumbers>=
c.viewTo))return!1;f=xa();4<g&&(c.lineDiv.style.display="none");rf(a,c.updateLineNumbers,b.dims);4<g&&(c.lineDiv.style.display="");c.renderedView=c.view;f&&xa()!=f&&f.offsetHeight&&f.focus();Qa(c.cursorDiv);Qa(c.selectionDiv);c.gutters.style.height=c.sizer.style.minHeight=0;d&&(c.lastWrapHeight=b.wrapperHeight,c.lastWrapWidth=b.wrapperWidth,xb(a,400));c.updateLineNumbers=null;return!0}function eb(a,b){for(var c=b.viewport,d=!0;;d=!1){if(!d||!a.options.lineWrapping||b.oldDisplayWidth==Ha(a))if(c&&
null!=c.top&&(c={top:Math.min(a.doc.height+Pc(a.display)-Sc(a),c.top)}),b.visible=G(a.display,a.doc,c),b.visible.from>=a.display.viewFrom&&b.visible.to<=a.display.viewTo)break;if(!Q(a,b))break;ac(a);d=w(a);Db(a);Tc(a,d);A(a,d)}b.signal(a,"update",a);if(a.display.viewFrom!=a.display.reportedViewFrom||a.display.viewTo!=a.display.reportedViewTo)b.signal(a,"viewportChange",a,a.display.viewFrom,a.display.viewTo),a.display.reportedViewFrom=a.display.viewFrom,a.display.reportedViewTo=a.display.viewTo}function Ka(a,
b){var c=new X(a,b);if(Q(a,c)){ac(a);eb(a,c);var d=w(a);Db(a);Tc(a,d);A(a,d);c.finish()}}function Tc(a,b){a.display.sizer.style.minHeight=b.docHeight+"px";var c=b.docHeight+a.display.barHeight;a.display.heightForcer.style.top=c+"px";a.display.gutters.style.height=Math.max(c+va(a),b.clientHeight)+"px"}function ac(a){a=a.display;for(var b=a.lineDiv.offsetTop,c=0;c<a.view.length;c++){var d=a.view[c],n;if(!d.hidden){if(M&&8>V){var f=d.node.offsetTop+d.node.offsetHeight;n=f-b;b=f}else n=d.node.getBoundingClientRect(),
n=n.bottom-n.top;f=d.line.height-n;2>n&&(n=Oa(a));if(.001<f||-.001>f)if(ua(d.line,n),Jd(d.line),d.rest)for(n=0;n<d.rest.length;n++)Jd(d.rest[n])}}}function Jd(a){if(a.widgets)for(var b=0;b<a.widgets.length;++b)a.widgets[b].height=a.widgets[b].node.offsetHeight}function Qc(a){for(var b=a.display,c={},d={},n=b.gutters.clientLeft,f=b.gutters.firstChild,g=0;f;f=f.nextSibling,++g)c[a.options.gutters[g]]=f.offsetLeft+f.clientLeft+n,d[a.options.gutters[g]]=f.clientWidth;return{fixedPos:N(b),gutterTotalWidth:b.gutters.offsetWidth,
gutterLeft:c,gutterWidth:d,wrapperWidth:b.wrapper.clientWidth}}function rf(a,b,c){function d(b){var c=b.nextSibling;Z&&pa&&a.display.currentWheelTarget==b?b.style.display="none":b.parentNode.removeChild(b);return c}for(var n=a.display,f=a.options.lineNumbers,g=n.lineDiv,h=g.firstChild,m=n.view,n=n.viewFrom,p=0;p<m.length;p++){var q=m[p];if(!q.hidden)if(q.node&&q.node.parentNode==g){for(;h!=q.node;)h=d(h);h=f&&null!=b&&b<=n&&q.lineNumber;q.changes&&(-1<ca(q.changes,"gutter")&&(h=!1),Kd(a,q,n,c));h&&
...
g)}else if("gutter"==f)Md(a,b,c,d);else if("class"==f)Uc(b);else if("widget"==f){f=a;g=b;h=d;g.alignable&&(g.alignable=null);for(var m=g.node.firstChild,p=void 0;m;m=p)p=m.nextSibling,"CodeMirror-linewidget"==m.className&&g.node.removeChild(m);Nd(f,g,h)}}b.changes=null}function Eb(a){a.node==a.text&&(a.node=C("div",null,null,"position: relative"),a.text.parentNode&&a.text.parentNode.replaceChild(a.node,a.text),a.node.appendChild(a.text),M&&8>V&&(a.node.style.zIndex=2));return a.node}function Ld(a,
b){var c=a.display.externalMeasured;return c&&c.line==b.line?(a.display.externalMeasured=null,b.measure=c.measure,c.built):Od(a,b)}function Uc(a){var b=a.bgClass?a.bgClass+" "+(a.line.bgClass||""):a.line.bgClass;b&&(b+=" CodeMirror-linebackground");if(a.background)b?a.background.className=b:(a.background.parentNode.removeChild(a.background),a.background=null);else if(b){var c=Eb(a);a.background=c.insertBefore(C("div",null,b),c.firstChild)}a.line.wrapClass?Eb(a).className=a.line.wrapClass:a.node!=
a.text&&(a.node.className="");a.text.className=(a.textClass?a.textClass+" "+(a.line.textClass||""):a.line.textClass)||""}function Md(a,b,c,d){b.gutter&&(b.node.removeChild(b.gutter),b.gutter=null);b.gutterBackground&&(b.node.removeChild(b.gutterBackground),b.gutterBackground=null);if(b.line.gutterClass){var n=Eb(b);b.gutterBackground=C("div",null,"CodeMirror-gutter-background "+b.line.gutterClass,"left: "+(a.options.fixedGutter?d.fixedPos:-d.gutterTotalWidth)+"px; width: "+d.gutterTotalWidth+"px");
n.insertBefore(b.gutterBackground,b.text)}var f=b.line.gutterMarkers;if(a.options.lineNumbers||f){var n=Eb(b),g=b.gutter=C("div",null,"CodeMirror-gutter-wrapper","left: "+(a.options.fixedGutter?d.fixedPos:-d.gutterTotalWidth)+"px");a.display.input.setUneditable(g);n.insertBefore(g,b.text);b.line.gutterClass&&(g.className+=" "+b.line.gutterClass);!a.options.lineNumbers||f&&f["CodeMirror-linenumbers"]||(b.lineNumber=g.appendChild(C("div",O(a.options,c),"CodeMirror-linenumber CodeMirror-gutter-elt",
...
q=a.curOp.updateInput;r={from:r,to:s,text:m?m[p%m.length]:h,origin:n||(g?"paste":a.state.cutIncoming?"cut":"+input")};fb(a.doc,r);da(a,"inputRead",a,r)}b&&!g&&Rd(a,b);gb(a);a.curOp.updateInput=q;a.curOp.typing=!0;a.state.pasteIncoming=a.state.cutIncoming=!1}function Sd(a,b){var c=a.clipboardData&&a.clipboardData.getData("text/plain");if(c)return a.preventDefault(),ja(b,function(){fc(b,c,0,null,"paste")}),!0}function Rd(a,b){if(a.options.electricChars&&a.options.smartIndent)for(var c=a.doc.sel,d=c.ranges.length-
1;0<=d;d--){var n=c.ranges[d];if(!(100<n.head.ch||d&&c.ranges[d-1].head.line==n.head.line)){var f=a.getModeAt(n.head),g=!1;if(f.electricChars)for(var h=0;h<f.electricChars.length;h++){if(-1<b.indexOf(f.electricChars.charAt(h))){g=Fb(a,n.head.line,"smart");break}}else f.electricInput&&f.electricInput.test(B(a.doc,n.head.line).text.slice(0,n.head.ch))&&(g=Fb(a,n.head.line,"smart"));g&&da(a,"electricInput",a,n.head.line)}}}function Td(a){for(var b=[],c=[],d=0;d<a.doc.sel.ranges.length;d++){var n=a.doc.sel.ranges[d].head.line,
n={anchor:z(n,0),head:z(n+1,0)};c.push(n);b.push(a.getRange(n.anchor,n.head))}return{text:b,ranges:c}}function Ud(a){a.setAttribute("autocorrect","off");a.setAttribute("autocapitalize","off");a.setAttribute("spellcheck","false")}function Wc(a){this.cm=a;this.prevInput="";this.pollingFast=!1;this.polling=new ub;this.hasSelection=this.inaccurateSelection=!1;this.composing=null}function Vd(){var a=C("textarea",null,null,"position: absolute; padding: 0; width: 1px; height: 1em; outline: none"),b=C("div",
[a],null,"overflow: hidden; position: relative; width: 3px; height: 0px;");Z?a.style.width="1000px":a.setAttribute("wrap","off");hb&&(a.style.border="1px solid black");Ud(a);return b}function Xc(a){this.cm=a;this.lastAnchorNode=this.lastAnchorOffset=this.lastFocusNode=this.lastFocusOffset=null;this.polling=new ub;this.gracePeriod=!1}function Wd(a,b){var c=Yc(a,b.line);if(!c||c.hidden)return null;var d=B(a.doc,b.line),c=Xd(c,d,b.line),d=qa(d),n="left";d&&(n=hc(d,b.ch)%2?"right":"left");c=Yd(c.map,
b.ch,n);c.offset="right"==c.collapse?c.end:c.start;return c}function ib(a,b){b&&(a.bad=!0);return a}function ic(a,b,c){var d;if(b==a.display.lineDiv){d=a.display.lineDiv.childNodes[c];if(!d)return ib(a.clipPos(z(a.display.viewTo-1)),!0);b=null;c=0}else for(d=b;;d=d.parentNode){if(!d||d==a.display.lineDiv)return null;if(d.parentNode&&d.parentNode==a.display.lineDiv)break}for(var n=0;n<a.display.view.length;n++){var f=a.display.view[n];if(f.node==d)return tf(f,b,c)}}function tf(a,b,c){function d(b,
c,L){for(var T=-1;T<(p?p.length:0);T++)for(var Zb=0>T?m.map:p[T],n=0;n<Zb.length;n+=3){var f=Zb[n+2];if(f==b||f==c){c=R(0>T?a.line:a.rest[T]);T=Zb[n]+L;if(0>L||f!=b)T=Zb[n+(L?1:0)];return z(c,T)}}}var n=a.text.firstChild,f=!1;if(!b||!Zc(n,b))return ib(z(R(a.line),0),!0);if(b==n&&(f=!0,b=n.childNodes[c],c=0,!b))return c=a.rest?P(a.rest):a.line,ib(z(R(c),c.text.length),f);var g=3==b.nodeType?b:null,h=b;g||1!=b.childNodes.length||3!=b.firstChild.nodeType||(g=b.firstChild,c&&(c=g.nodeValue.length));for(;h.parentNode!=
n;)h=h.parentNode;var m=a.measure,p=m.maps;if(b=d(g,h,c))return ib(b,f);n=h.nextSibling;for(g=g?g.nodeValue.length-c:0;n;n=n.nextSibling){if(b=d(n,n.firstChild,0))return ib(z(b.line,b.ch-g),f);g+=n.textContent.length}h=h.previousSibling;for(g=c;h;h=h.previousSibling){if(b=d(h,h.firstChild,-1))return ib(z(b.line,b.ch+g),f);g+=n.textContent.length}}function uf(a,b,c,d,n){function f(a){return function(b){return b.id==a}}function g(b){if(1==b.nodeType){var c=b.getAttribute("cm-text");if(null!=c)""==c&&
(c=b.textContent.replace(/\u200b/g,"")),h+=c;else{var c=b.getAttribute("cm-marker"),L;if(c)b=a.findMarks(z(d,0),z(n+1,0),f(+c)),b.length&&(L=b[0].find())&&(h+=Ua(a.doc,L.from,L.to).join(p));else if("false"!=b.getAttribute("contenteditable")){for(L=0;L<b.childNodes.length;L++)g(b.childNodes[L]);/^(pre|div|p)$/i.test(b.nodeName)&&(m=!0)}}}else 3==b.nodeType&&(b=b.nodeValue)&&(m&&(h+=p,m=!1),h+=b)}for(var h="",m=!1,p=a.doc.lineSeparator();;){g(b);if(b==c)break;b=b.nextSibling}return h}function Da(a,
b){this.ranges=a;this.primIndex=b}function U(a,b){this.anchor=a;this.head=b}function ra(a,b){var c=a[b];a.sort(function(a,b){return J(a.from(),b.from())});b=ca(a,c);for(c=1;c<a.length;c++){var d=a[c],n=a[c-1];if(0<=J(n.to(),d.from())){var f=dc(n.from(),d.from()),g=cc(n.to(),d.to()),d=n.empty()?d.from()==d.head:n.from()==n.head;c<=b&&--b;a.splice(--c,2,new U(d?g:f,d?f:g))}}return new Da(a,b)}function ya(a,b){return new Da([new U(a,b||a)],0)}function I(a,b){if(b.line<a.first)return z(a.first,0);var c=
a.first+a.size-1;if(b.line>c)return z(c,B(a,c).text.length);var c=B(a,b.line).text.length,d=b.ch,c=null==d||d>c?z(b.line,c):0>d?z(b.line,0):b;return c}function Gb(a,b){return b>=a.first&&b<a.first+a.size}function Hb(a,b,c,d){return a.cm&&a.cm.display.shift||a.extend?(a=b.anchor,d&&(b=0>J(c,a),b!=0>J(d,a)?(a=c,c=d):b!=0>J(c,d)&&(c=d)),new U(a,c)):new U(d||c,c)}function jc(a,b,c,d){aa(a,new Da([Hb(a,a.sel.primary(),b,c)],0),d)}function Zd(a,b,c){for(var d=[],n=0;n<a.sel.ranges.length;n++)d[n]=Hb(a,
a.sel.ranges[n],b[n],null);b=ra(d,a.sel.primIndex);aa(a,b,c)}function $c(a,b,c,d){var n=a.sel.ranges.slice(0);n[b]=c;aa(a,ra(n,a.sel.primIndex),d)}function vf(a,b){var c={ranges:b.ranges,update:function(b){this.ranges=[];for(var c=0;c<b.length;c++)this.ranges[c]=new U(I(a,b[c].anchor),I(a,b[c].head))}};Y(a,"beforeSelectionChange",a,c);a.cm&&Y(a.cm,"beforeSelectionChange",a.cm,c);return c.ranges!=b.ranges?ra(c.ranges,c.ranges.length-1):b}function $d(a,b,c){var d=a.history.done,n=P(d);n&&n.ranges?(d[d.length-
1]=b,kc(a,b,c)):aa(a,b,c)}function aa(a,b,c){kc(a,b,c);b=a.sel;var d=a.cm?a.cm.curOp.id:NaN,n=a.history,f=c&&c.origin,g;if(!(g=d==n.lastSelOp)&&(g=f&&n.lastSelOrigin==f)&&!(g=n.lastModTime==n.lastSelTime&&n.lastOrigin==f)){g=P(n.done);var h=f.charAt(0);g="*"==h||"+"==h&&g.ranges.length==b.ranges.length&&g.somethingSelected()==b.somethingSelected()&&new Date-a.history.lastSelTime<=(a.cm?a.cm.options.historyEventDelay:500)}g?n.done[n.done.length-1]=b:lc(b,n.done);n.lastSelTime=+new Date;n.lastSelOrigin=
f;n.lastSelOp=d;c&&!1!==c.clearRedo&&ae(n.undone)}function kc(a,b,c){if(ma(a,"beforeSelectionChange")||a.cm&&ma(a.cm,"beforeSelectionChange"))b=vf(a,b);var d=c&&c.bias||(0>J(b.primary().head,a.sel.primary().head)?-1:1);be(a,ce(a,b,d,!0));c&&!1===c.scroll||!a.cm||gb(a.cm)}function be(a,b){b.equals(a.sel)||(a.sel=b,a.cm&&(a.cm.curOp.updateInput=a.cm.curOp.selectionChanged=!0,de(a.cm)),da(a,"cursorActivity",a))}function ee(a){be(a,ce(a,a.sel,null,!1),za)}function ce(a,b,c,d){for(var n,f=0;f<b.ranges.length;f++){var g=
b.ranges[f],h=nc(a,g.anchor,c,d),m=nc(a,g.head,c,d);if(n||h!=g.anchor||m!=g.head)n||(n=b.ranges.slice(0,f)),n[f]=new U(h,m)}return n?ra(n,b.primIndex):b}function nc(a,b,c,d){var n=!1,f=b,g=c||1;a.cantEdit=!1;a:for(;;){var h=B(a,f.line);if(h.markedSpans)for(var m=0;m<h.markedSpans.length;++m){var p=h.markedSpans[m],q=p.marker;if((null==p.from||(q.inclusiveLeft?p.from<=f.ch:p.from<f.ch))&&(null==p.to||(q.inclusiveRight?p.to>=f.ch:p.to>f.ch))){if(d&&(Y(q,"beforeCursorEnter"),q.explicitlyCleared))if(h.markedSpans){--m;
continue}else break;if(q.atomic){m=q.find(0>g?-1:1);if(0==J(m,f)&&(m.ch+=g,0>m.ch?m=m.line>a.first?I(a,z(m.line-1)):null:m.ch>h.text.length&&(m=m.line<a.first+a.size-1?z(m.line+1,0):null),!m)){if(n){if(!d)return nc(a,b,c,!0);a.cantEdit=!0;return z(a.first,0)}n=!0;m=b;g=-g}f=m;continue a}}}return f}}function Db(a){a.display.input.showSelection(a.display.input.prepareSelection())}function fe(a,b){for(var c=a.doc,d={},n=d.cursors=document.createDocumentFragment(),f=d.selection=document.createDocumentFragment(),
g=0;g<c.sel.ranges.length;g++)if(!1!==b||g!=c.sel.primIndex){var h=c.sel.ranges[g],m=h.empty();if(m||a.options.showCursorWhenSelecting){var p=a,q=n,r=Ea(p,h.head,"div",null,null,!p.options.singleCursorHeightPerLine),s=q.appendChild(C("div","\u00a0","CodeMirror-cursor"));s.style.left=r.left+"px";s.style.top=r.top+"px";s.style.height=Math.max(0,r.bottom-r.top)*p.options.cursorHeight+"px";r.other&&(p=q.appendChild(C("div","\u00a0","CodeMirror-cursor CodeMirror-secondarycursor")),p.style.display="",p.style.left=
r.other.left+"px",p.style.top=r.other.top+"px",p.style.height=.85*(r.other.bottom-r.other.top)+"px")}m||wf(a,h,f)}return d}function wf(a,b,c){function d(a,b,H,c){0>b&&(b=0);b=Math.round(b);c=Math.round(c);h.appendChild(C("div",null,"CodeMirror-selected","position: absolute; left: "+a+"px; top: "+b+"px; width: "+(null==H?q-a:H)+"px; height: "+(c-b)+"px"))}function n(b,c,L){var T=B(g,b),n=T.text.length,f,h;xf(qa(T),c||0,null==L?n:L,function(g,m,ga){var r=oc(a,z(b,g),"div",T,"left"),s,$b;g==m?(s=r,ga=
$b=r.left):(s=oc(a,z(b,m-1),"div",T,"right"),"rtl"==ga&&(ga=r,r=s,s=ga),ga=r.left,$b=s.right);null==c&&0==g&&(ga=p);3<s.top-r.top&&(d(ga,r.top,null,r.bottom),ga=p,r.bottom<s.top&&d(ga,r.bottom,null,s.top));null==L&&m==n&&($b=q);if(!f||r.top<f.top||r.top==f.top&&r.left<f.left)f=r;if(!h||s.bottom>h.bottom||s.bottom==h.bottom&&s.right>h.right)h=s;ga<p+1&&(ga=p);d(ga,s.top,$b-ga,s.bottom)});return{start:f,end:h}}var f=a.display,g=a.doc,h=document.createDocumentFragment(),m=ge(a.display),p=m.left,q=Math.max(f.sizerWidth,
Ha(a)-f.sizer.offsetLeft)-m.right,f=b.from();b=b.to();if(f.line==b.line)n(f.line,f.ch,b.ch);else{var r=B(g,f.line),m=B(g,b.line),m=Aa(r)==Aa(m),f=n(f.line,f.ch,m?r.text.length+1:null).end;b=n(b.line,m?0:null,b.ch).start;m&&(f.top<b.top-2?(d(f.right,f.top,null,f.bottom),d(p,b.top,b.left,b.bottom)):d(f.right,f.top,b.left-f.right,f.bottom));f.bottom<b.top&&d(p,f.bottom,null,b.top)}c.appendChild(h)}function ad(a){if(a.state.focused){var b=a.display;clearInterval(b.blinker);var c=!0;b.cursorDiv.style.visibility=
"";0<a.options.cursorBlinkRate?b.blinker=setInterval(function(){b.cursorDiv.style.visibility=(c=!c)?"":"hidden"},a.options.cursorBlinkRate):0>a.options.cursorBlinkRate&&(b.cursorDiv.style.visibility="hidden")}}function xb(a,b){a.doc.mode.startState&&a.doc.frontier<a.display.viewTo&&a.state.highlight.set(b,vb(yf,a))}function yf(a){var b=a.doc;b.frontier<b.first&&(b.frontier=b.first);if(!(b.frontier>=a.display.viewTo)){var c=+new Date+a.options.workTime,d=jb(b.mode,Ib(a,b.frontier)),n=[];b.iter(b.frontier,
Math.min(b.first+b.size,a.display.viewTo+500),function(f){if(b.frontier>=a.display.viewFrom){var g=f.styles,h=he(a,f,d,!0);f.styles=h.styles;var m=f.styleClasses;(h=h.classes)?f.styleClasses=h:m&&(f.styleClasses=null);m=!g||g.length!=f.styles.length||m!=h&&(!m||!h||m.bgClass!=h.bgClass||m.textClass!=h.textClass);for(h=0;!m&&h<g.length;++h)m=g[h]!=f.styles[h];m&&n.push(b.frontier);f.stateAfter=jb(b.mode,d)}else bd(a,f.text,d),f.stateAfter=0==b.frontier%5?jb(b.mode,d):null;++b.frontier;if(+new Date>
c)return xb(a,a.options.workDelay),!0});n.length&&ja(a,function(){for(var b=0;b<n.length;b++)Fa(a,n[b],"text")})}}function zf(a,b,c){for(var d,n,f=a.doc,g=c?-1:b-(a.doc.mode.innerMode?1E3:100);b>g;--b){if(b<=f.first)return f.first;var h=B(f,b-1);if(h.stateAfter&&(!c||b<=f.frontier))return b;h=sa(h.text,null,a.options.tabSize);if(null==n||d>h)n=b-1,d=h}return n}function Ib(a,b,c){var d=a.doc,n=a.display;if(!d.mode.startState)return!0;var f=zf(a,b,c),g=f>d.first&&B(d,f-1).stateAfter,g=g?jb(d.mode,g):
Af(d.mode);d.iter(f,b,function(c){bd(a,c.text,g);c.stateAfter=f==b-1||0==f%5||f>=n.viewFrom&&f<n.viewTo?jb(d.mode,g):null;++f});c&&(d.frontier=f);return g}function Pc(a){return a.mover.offsetHeight-a.lineSpace.offsetHeight}function ge(a){if(a.cachedPaddingH)return a.cachedPaddingH;var b=na(a.measure,C("pre","x")),b=window.getComputedStyle?window.getComputedStyle(b):b.currentStyle,b={left:parseInt(b.paddingLeft),right:parseInt(b.paddingRight)};isNaN(b.left)||isNaN(b.right)||(a.cachedPaddingH=b);return b}
function va(a){return Gd-a.display.nativeBarWidth}function Ha(a){return a.display.scroller.clientWidth-va(a)-a.display.barWidth}function Sc(a){return a.display.scroller.clientHeight-va(a)-a.display.barHeight}function Xd(a,b,c){if(a.line==b)return{map:a.measure.map,cache:a.measure.cache};for(var d=0;d<a.rest.length;d++)if(a.rest[d]==b)return{map:a.measure.maps[d],cache:a.measure.caches[d]};for(d=0;d<a.rest.length;d++)if(R(a.rest[d])>c)return{map:a.measure.maps[d],cache:a.measure.caches[d],before:!0}}
function Yc(a,b){if(b>=a.display.viewFrom&&b<a.display.viewTo)return a.display.view[Ta(a,b)];var c=a.display.externalMeasured;if(c&&b>=c.lineN&&b<c.lineN+c.size)return c}function pc(a,b){var c=R(b),d=Yc(a,c);d&&!d.text?d=null:d&&d.changes&&(Kd(a,d,c,Qc(a)),a.curOp.forceUpdate=!0);if(!d){var n;n=Aa(b);d=R(n);n=a.display.externalMeasured=new ie(a.doc,n,d);n.lineN=d;d=n.built=Od(a,n);n.text=d.pre;na(a.display.lineMeasure,d.pre);d=n}c=Xd(d,b,c);return{line:b,view:d,rect:null,map:c.map,cache:c.cache,before:c.before,
hasHeights:!1}}function cd(a,b,c,d,n){b.before&&(c=-1);var f=c+(d||"");if(b.cache.hasOwnProperty(f))a=b.cache[f];else{b.rect||(b.rect=b.view.text.getBoundingClientRect());if(!b.hasHeights){var g=b.view,h=b.rect,m=a.options.lineWrapping,p=m&&Ha(a);if(!g.measure.heights||m&&g.measure.width!=p){var q=g.measure.heights=[];if(m)for(g.measure.width=p,g=g.text.firstChild.getClientRects(),m=0;m<g.length-1;m++){var p=g[m],r=g[m+1];2<Math.abs(p.bottom-r.bottom)&&q.push((p.bottom+r.top)/2-h.top)}q.push(h.bottom-
h.top)}b.hasHeights=!0}g=d;m=Yd(b.map,c,g);d=m.node;h=m.start;p=m.end;c=m.collapse;var s;if(3==d.nodeType){for(q=0;4>q;q++){for(;h&&Jb(b.line.text.charAt(m.coverStart+h));)--h;for(;m.coverStart+p<m.coverEnd&&Jb(b.line.text.charAt(m.coverStart+p));)++p;if(M&&9>V&&0==h&&p==m.coverEnd-m.coverStart)s=d.parentNode.getBoundingClientRect();else if(M&&a.options.lineWrapping){var u=Va(d,h,p).getClientRects();s=u.length?u["right"==g?u.length-1:0]:dd}else s=Va(d,h,p).getBoundingClientRect()||dd;if(s.left||s.right||
0==h)break;p=h;h-=1;c="right"}if(M&&11>V){if(u=window.screen&&null!=screen.logicalXDPI&&screen.logicalXDPI!=screen.deviceXDPI)null!=ed?u=ed:(q=na(a.display.measure,C("span","x")),u=q.getBoundingClientRect(),q=Va(q,0,1).getBoundingClientRect(),u=ed=1<Math.abs(u.left-q.left));u&&(u=screen.logicalXDPI/screen.deviceXDPI,q=screen.logicalYDPI/screen.deviceYDPI,s={left:s.left*u,right:s.right*u,top:s.top*q,bottom:s.bottom*q})}}else 0<h&&(c=g="right"),s=a.options.lineWrapping&&1<(u=d.getClientRects()).length?
u["right"==g?u.length-1:0]:d.getBoundingClientRect();!(M&&9>V)||h||s&&(s.left||s.right)||(s=(s=d.parentNode.getClientRects()[0])?{left:s.left,right:s.left+yb(a.display),top:s.top,bottom:s.bottom}:dd);u=s.top-b.rect.top;d=s.bottom-b.rect.top;h=(u+d)/2;g=b.view.measure.heights;for(q=0;q<g.length-1&&!(h<g[q]);q++);c={left:("right"==c?s.right:s.left)-b.rect.left,right:("left"==c?s.left:s.right)-b.rect.left,top:q?g[q-1]:0,bottom:g[q]};s.left||s.right||(c.bogus=!0);a.options.singleCursorHeightPerLine||
...
a.length-3&&a[h+3]==a[h+4]&&!a[h+5].insertLeft;)d=a[(h+=3)+2],g="right";break}}return{node:d,start:n,end:f,collapse:g,coverStart:m,coverEnd:p}}function je(a){if(a.measure&&(a.measure.cache={},a.measure.heights=null,a.rest))for(var b=0;b<a.rest.length;b++)a.measure.caches[b]={}}function ke(a){a.display.externalMeasure=null;Qa(a.display.lineMeasure);for(var b=0;b<a.display.view.length;b++)je(a.display.view[b])}function zb(a){ke(a);a.display.cachedCharWidth=a.display.cachedTextHeight=a.display.cachedPaddingH=
null;a.options.lineWrapping||(a.display.maxLineChanged=!0);a.display.lineNumChars=null}function fd(a,b,c,d){if(b.widgets)for(var n=0;n<b.widgets.length;++n)if(b.widgets[n].above){var f=Kb(b.widgets[n]);c.top+=f;c.bottom+=f}if("line"==d)return c;d||(d="local");b=wa(b);b="local"==d?b+a.display.lineSpace.offsetTop:b-a.display.viewOffset;if("page"==d||"window"==d)a=a.display.lineSpace.getBoundingClientRect(),b+=a.top+("window"==d?0:window.pageYOffset||(document.documentElement||document.body).scrollTop),
...
a.left,top:b-a.top}}function oc(a,b,c,d,n){d||(d=B(a.doc,b.line));var f=d;b=b.ch;d=cd(a,pc(a,d),b,n);return fd(a,f,d,c)}function Ea(a,b,c,d,n,f){function g(b,L){var h=cd(a,n,b,L?"right":"left",f);L?h.left=h.right:h.right=h.left;return fd(a,d,h,c)}function h(a,b){var H=m[b],c=H.level%2;a==gd(H)&&b&&H.level<m[b-1].level?(H=m[--b],a=hd(H)-(H.level%2?0:1),c=!0):a==hd(H)&&b<m.length-1&&H.level<m[b+1].level&&(H=m[++b],a=gd(H)-H.level%2,c=!1);return c&&a==H.to&&a>H.from?g(a-1):g(a,c)}d=d||B(a.doc,b.line);
n||(n=pc(a,d));var m=qa(d);b=b.ch;if(!m)return g(b);var p=hc(m,b),p=h(b,p);null!=Lb&&(p.other=h(b,Lb));return p}function me(a,b){var c=0;b=I(a.doc,b);a.options.lineWrapping||(c=yb(a.display)*b.ch);var d=B(a.doc,b.line),n=wa(d)+a.display.lineSpace.offsetTop;return{left:c,right:c,top:n,bottom:n+d.height}}function qc(a,b,c,d){a=z(a,b);a.xRel=d;c&&(a.outside=!0);return a}function id(a,b,c){var d=a.doc;c+=a.display.viewOffset;if(0>c)return qc(d.first,0,!0,-1);var n=Sa(d,c),f=d.first+d.size-1;if(n>f)return qc(d.first+
d.size-1,B(d,f).text.length,!0,1);0>b&&(b=0);for(d=B(d,n);;)if(n=Bf(a,d,n,b,c),f=(d=Ra(d,!1))&&d.find(0,!0),d&&(n.ch>f.from.ch||n.ch==f.from.ch&&0<n.xRel))n=R(d=f.to.line);else return n}function Bf(a,b,c,d,n){function f(d){d=Ea(a,z(c,d),"line",b,p);h=!0;if(g>d.bottom)return d.left-m;if(g<d.top)return d.left+m;h=!1;return d.left}var g=n-wa(b),h=!1,m=2*a.display.wrapper.clientWidth,p=pc(a,b),q=qa(b),r=b.text.length;n=rc(b);var s=sc(b),u=f(n),t=h,v=f(s),x=h;if(d>v)return qc(c,s,x,1);for(;;){if(q?s==
n||s==jd(b,n,1):1>=s-n){q=d<u||d-u<=v-d?n:s;for(d-=q==n?u:v;Jb(b.text.charAt(q));)++q;return qc(c,q,q==n?t:x,-1>d?-1:1<d?1:0)}var w=Math.ceil(r/2),A=n+w;if(q)for(var A=n,G=0;G<w;++G)A=jd(b,A,1);G=f(A);if(G>d){s=A;v=G;if(x=h)v+=1E3;r=w}else n=A,u=G,t=h,r-=w}}function Oa(a){if(null!=a.cachedTextHeight)return a.cachedTextHeight;if(null==Wa){Wa=C("pre");for(var b=0;49>b;++b)Wa.appendChild(document.createTextNode("x")),Wa.appendChild(C("br"));Wa.appendChild(document.createTextNode("x"))}na(a.measure,Wa);
b=Wa.offsetHeight/50;3<b&&(a.cachedTextHeight=b);Qa(a.measure);return b||1}function yb(a){if(null!=a.cachedCharWidth)return a.cachedCharWidth;var b=C("span","xxxxxxxxxx"),c=C("pre",[b]);na(a.measure,c);b=b.getBoundingClientRect();b=(b.right-b.left)/10;2<b&&(a.cachedCharWidth=b);return b||10}function ab(a){a.curOp={cm:a,viewChanged:!1,startHeight:a.doc.height,forceUpdate:!1,updateInput:null,typing:!1,changeObjs:null,cursorActivityHandlers:null,cursorActivityCalled:0,selectionChanged:!1,updateMaxLine:!1,
scrollLeft:null,scrollTop:null,scrollToPos:null,focus:!1,id:++Cf};kb?kb.ops.push(a.curOp):a.curOp.ownsGroup=kb={ops:[a.curOp],delayedCallbacks:[]}}function cb(a){if(a=a.curOp.ownsGroup)try{var b=a.delayedCallbacks,c=0;do{for(;c<b.length;c++)b[c].call(null);for(var d=0;d<a.ops.length;d++){var n=a.ops[d];if(n.cursorActivityHandlers)for(;n.cursorActivityCalled<n.cursorActivityHandlers.length;)n.cursorActivityHandlers[n.cursorActivityCalled++].call(null,n.cm)}}while(c<b.length)}finally{kb=null;for(b=
0;b<a.ops.length;b++)a.ops[b].cm.curOp=null;a=a.ops;for(b=0;b<a.length;b++){var n=a[b],c=n.cm,d=c.display,f=c,g=f.display;!g.scrollbarsClipped&&g.scroller.offsetWidth&&(g.nativeBarWidth=g.scroller.offsetWidth-g.scroller.clientWidth,g.heightForcer.style.height=va(f)+"px",g.sizer.style.marginBottom=-g.nativeBarWidth+"px",g.sizer.style.borderRightWidth=va(f)+"px",g.scrollbarsClipped=!0);n.updateMaxLine&&x(c);n.mustUpdate=n.viewChanged||n.forceUpdate||null!=n.scrollTop||n.scrollToPos&&(n.scrollToPos.from.line<
d.viewFrom||n.scrollToPos.to.line>=d.viewTo)||d.maxLineChanged&&c.options.lineWrapping;n.update=n.mustUpdate&&new X(c,n.mustUpdate&&{top:n.scrollTop,ensure:n.scrollToPos},n.forceUpdate)}for(b=0;b<a.length;b++)n=a[b],n.updatedDisplay=n.mustUpdate&&Q(n.cm,n.update);for(b=0;b<a.length;b++)if(n=a[b],c=n.cm,d=c.display,n.updatedDisplay&&ac(c),n.barMeasure=w(c),d.maxLineChanged&&!c.options.lineWrapping&&(f=n,g=d.maxLine.text.length,g=cd(c,pc(c,d.maxLine),g,void 0),f.adjustWidthTo=g.left+3,c.display.sizerWidth=
n.adjustWidthTo,n.barMeasure.scrollWidth=Math.max(d.scroller.clientWidth,d.sizer.offsetLeft+n.adjustWidthTo+va(c)+c.display.barWidth),n.maxScrollLeft=Math.max(0,d.sizer.offsetLeft+n.adjustWidthTo-Ha(c))),n.updatedDisplay||n.selectionChanged)n.preparedSelection=d.input.prepareSelection();for(b=0;b<a.length;b++)n=a[b],c=n.cm,null!=n.adjustWidthTo&&(c.display.sizer.style.minWidth=n.adjustWidthTo+"px",n.maxScrollLeft<c.doc.scrollLeft&&db(c,Math.min(c.display.scroller.scrollLeft,n.maxScrollLeft),!0),c.display.maxLineChanged=
!1),n.preparedSelection&&c.display.input.showSelection(n.preparedSelection),n.updatedDisplay&&Tc(c,n.barMeasure),(n.updatedDisplay||n.startHeight!=c.doc.height)&&A(c,n.barMeasure),n.selectionChanged&&ad(c),c.state.focused&&n.updateInput&&c.display.input.reset(n.typing),n.focus&&n.focus==xa()&&Qd(n.cm);for(b=0;b<a.length;b++){n=a[b];c=n.cm;d=c.display;f=c.doc;n.updatedDisplay&&eb(c,n.update);null==d.wheelStartX||null==n.scrollTop&&null==n.scrollLeft&&!n.scrollToPos||(d.wheelStartX=d.wheelStartY=null);
null==n.scrollTop||d.scroller.scrollTop==n.scrollTop&&!n.forceScroll||(f.scrollTop=Math.max(0,Math.min(d.scroller.scrollHeight-d.scroller.clientHeight,n.scrollTop)),d.scrollbars.setScrollTop(f.scrollTop),d.scroller.scrollTop=f.scrollTop);null==n.scrollLeft||d.scroller.scrollLeft==n.scrollLeft&&!n.forceScroll||(f.scrollLeft=Math.max(0,Math.min(d.scroller.scrollWidth-Ha(c),n.scrollLeft)),d.scrollbars.setScrollLeft(f.scrollLeft),d.scroller.scrollLeft=f.scrollLeft,S(c));if(n.scrollToPos){var h=void 0,
g=I(f,n.scrollToPos.from),h=I(f,n.scrollToPos.to),m=n.scrollToPos.margin;null==m&&(m=0);for(var p=0;5>p;p++){var q=!1,r=Ea(c,g),s=h&&h!=g?Ea(c,h):r,s=tc(c,Math.min(r.left,s.left),Math.min(r.top,s.top)-m,Math.max(r.left,s.left),Math.max(r.bottom,s.bottom)+m),u=c.doc.scrollTop,t=c.doc.scrollLeft;null!=s.scrollTop&&(Bb(c,s.scrollTop),1<Math.abs(c.doc.scrollTop-u)&&(q=!0));null!=s.scrollLeft&&(db(c,s.scrollLeft),1<Math.abs(c.doc.scrollLeft-t)&&(q=!0));if(!q)break}h=r;n.scrollToPos.isCursor&&c.state.focused&&
(Ba(c,"scrollCursorIntoView")||(m=c.display,p=m.sizer.getBoundingClientRect(),g=null,0>h.top+p.top?g=!0:h.bottom+p.top>(window.innerHeight||document.documentElement.clientHeight)&&(g=!1),null==g||Df||(h=C("div","\u200b",null,"position: absolute; top: "+(h.top-m.viewOffset-c.display.lineSpace.offsetTop)+"px; height: "+(h.bottom-h.top+va(c)+m.barHeight)+"px; left: "+h.left+"px; width: 2px;"),c.display.lineSpace.appendChild(h),h.scrollIntoView(g),c.display.lineSpace.removeChild(h))))}g=n.maybeHiddenMarkers;
h=n.maybeUnhiddenMarkers;if(g)for(m=0;m<g.length;++m)g[m].lines.length||Y(g[m],"hide");if(h)for(m=0;m<h.length;++m)h[m].lines.length&&Y(h[m],"unhide");d.wrapper.offsetHeight&&(f.scrollTop=c.display.scroller.scrollTop);n.changeObjs&&Y(c,"changes",c,n.changeObjs);n.update&&n.update.finish()}}}function ja(a,b){if(a.curOp)return b();ab(a);try{return b()}finally{cb(a)}}function W(a,b){return function(){if(a.curOp)return b.apply(a,arguments);ab(a);try{return b.apply(a,arguments)}finally{cb(a)}}}function ba(a){return function(){if(this.curOp)return a.apply(this,
arguments);ab(this);try{return a.apply(this,arguments)}finally{cb(this)}}}function ea(a){return function(){var b=this.cm;if(!b||b.curOp)return a.apply(this,arguments);ab(b);try{return a.apply(this,arguments)}finally{cb(b)}}}function ie(a,b,c){for(var d=this.line=b,n;d=Ra(d,!1);)d=d.find(1,!0).line,(n||(n=[])).push(d);this.size=(this.rest=n)?R(P(this.rest))-c+1:1;this.node=this.text=null;this.hidden=Pa(a,b)}function bc(a,b,c){var d=[],n;for(n=b;n<c;)b=new ie(a.doc,B(a.doc,n),n),n+=b.size,d.push(b);
return d}function ia(a,b,c,d){null==b&&(b=a.doc.first);null==c&&(c=a.doc.first+a.doc.size);d||(d=0);var n=a.display;d&&c<n.viewTo&&(null==n.updateLineNumbers||n.updateLineNumbers>b)&&(n.updateLineNumbers=b);a.curOp.viewChanged=!0;if(b>=n.viewTo)Ja&&Rc(a.doc,b)<n.viewTo&&Ia(a);else if(c<=n.viewFrom)Ja&&Id(a.doc,c+d)>n.viewFrom?Ia(a):(n.viewFrom+=d,n.viewTo+=d);else if(b<=n.viewFrom&&c>=n.viewTo)Ia(a);else if(b<=n.viewFrom){var f=uc(a,c,c+d,1);f?(n.view=n.view.slice(f.index),n.viewFrom=f.lineN,n.viewTo+=
d):Ia(a)}else if(c>=n.viewTo)(f=uc(a,b,b,-1))?(n.view=n.view.slice(0,f.index),n.viewTo=f.lineN):Ia(a);else{var f=uc(a,b,b,-1),g=uc(a,c,c+d,1);f&&g?(n.view=n.view.slice(0,f.index).concat(bc(a,f.lineN,g.lineN)).concat(n.view.slice(g.index)),n.viewTo+=d):Ia(a)}if(a=n.externalMeasured)c<a.lineN?a.lineN+=d:b<a.lineN+a.size&&(n.externalMeasured=null)}function Fa(a,b,c){a.curOp.viewChanged=!0;var d=a.display,n=a.display.externalMeasured;n&&b>=n.lineN&&b<n.lineN+n.size&&(d.externalMeasured=null);b<d.viewFrom||
b>=d.viewTo||(a=d.view[Ta(a,b)],null!=a.node&&(a=a.changes||(a.changes=[]),-1==ca(a,c)&&a.push(c)))}function Ia(a){a.display.viewFrom=a.display.viewTo=a.doc.first;a.display.view=[];a.display.viewOffset=0}function Ta(a,b){if(b>=a.display.viewTo)return null;b-=a.display.viewFrom;if(0>b)return null;for(var c=a.display.view,d=0;d<c.length;d++)if(b-=c[d].size,0>b)return d}function uc(a,b,c,d){var n=Ta(a,b),f=a.display.view;if(!Ja||c==a.doc.first+a.doc.size)return{index:n,lineN:c};for(var g=0,h=a.display.viewFrom;g<
...
b.left-a.left,d=b.top-a.top;return 400<H*H+d*d}var d=a.display;E(d.scroller,"mousedown",W(a,ne));M&&11>V?E(d.scroller,"dblclick",W(a,function(b){if(!Ba(a,b)){var c=lb(a,b);!c||kd(a,b,"gutterClick",!0,da)||Ga(a.display,b)||(fa(b),b=a.findWordAt(c),jc(a.doc,b.anchor,b.head))}})):E(d.scroller,"dblclick",function(b){Ba(a,b)||fa(b)});ld||E(d.scroller,"contextmenu",function(b){oe(a,b)});var n,f={end:0};E(d.scroller,"touchstart",function(a){var b;1!=a.touches.length?b=!1:(b=a.touches[0],b=1>=b.radiusX&&
1>=b.radiusY);b||(clearTimeout(n),b=+new Date,d.activeTouch={start:b,moved:!1,prev:300>=b-f.end?f:null},1==a.touches.length&&(d.activeTouch.left=a.touches[0].pageX,d.activeTouch.top=a.touches[0].pageY))});E(d.scroller,"touchmove",function(){d.activeTouch&&(d.activeTouch.moved=!0)});E(d.scroller,"touchend",function(n){var f=d.activeTouch;if(f&&!Ga(d,n)&&null!=f.left&&!f.moved&&300>new Date-f.start){var g=a.coordsChar(d.activeTouch,"page"),f=!f.prev||c(f,f.prev)?new U(g,g):!f.prev.prev||c(f,f.prev.prev)?
a.findWordAt(g):new U(z(g.line,0),I(a.doc,z(g.line+1,0)));a.setSelection(f.anchor,f.head);a.focus();fa(n)}b()});E(d.scroller,"touchcancel",b);E(d.scroller,"scroll",function(){d.scroller.clientHeight&&(Bb(a,d.scroller.scrollTop),db(a,d.scroller.scrollLeft,!0),Y(a,"scroll",a))});E(d.scroller,"mousewheel",function(b){pe(a,b)});E(d.scroller,"DOMMouseScroll",function(b){pe(a,b)});E(d.wrapper,"scroll",function(){d.wrapper.scrollTop=d.wrapper.scrollLeft=0});d.dragFunctions={simple:function(b){Ba(a,b)||md(b)},
start:function(b){if(M&&(!a.state.draggingText||100>+new Date-qe))md(b);else if(!Ba(a,b)&&!Ga(a.display,b)&&(b.dataTransfer.setData("Text",a.getSelection()),b.dataTransfer.setDragImage&&!re)){var c=C("img",null,null,"position: fixed; left: 0; top: 0;");c.src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";ta&&(c.width=c.height=1,a.display.wrapper.appendChild(c),c._top=c.offsetTop);b.dataTransfer.setDragImage(c,0,0);ta&&c.parentNode.removeChild(c)}},drop:W(a,Ef)};var g=
d.input.getField();E(g,"keyup",function(b){se.call(a,b)});E(g,"keydown",W(a,te));E(g,"keypress",W(a,ue));E(g,"focus",vb(Nc,a));E(g,"blur",vb(wb,a))}function Ff(a){var b=a.display;if(b.lastWrapHeight!=b.wrapper.clientHeight||b.lastWrapWidth!=b.wrapper.clientWidth)b.cachedCharWidth=b.cachedTextHeight=b.cachedPaddingH=null,b.scrollbarsClipped=!1,a.setSize()}function Ga(a,b){for(var c=b.target||b.srcElement;c!=a.wrapper;c=c.parentNode)if(!c||1==c.nodeType&&"true"==c.getAttribute("cm-ignore-events")||
c.parentNode==a.sizer&&c!=a.mover)return!0}function lb(a,b,c,d){var n=a.display;if(!c&&"true"==(b.target||b.srcElement).getAttribute("cm-not-content"))return null;var f,g;c=n.lineSpace.getBoundingClientRect();try{f=b.clientX-c.left,g=b.clientY-c.top}catch(h){return null}b=id(a,f,g);var m;d&&1==b.xRel&&(m=B(a.doc,b.line).text).length==b.ch&&(d=sa(m,m.length,a.options.tabSize)-m.length,b=z(b.line,Math.max(0,Math.round((f-ge(a.display).left)/yb(a.display))-d)));return b}function ne(a){var b=this.display;
if(!(b.activeTouch&&b.input.supportsTouch()||Ba(this,a)))if(b.shift=a.shiftKey,Ga(b,a))Z||(b.scroller.draggable=!1,setTimeout(function(){b.scroller.draggable=!0},100));else if(!kd(this,a,"gutterClick",!0,da)){var c=lb(this,a);window.focus();switch(ve(a)){case 1:c?Gf(this,a,c):(a.target||a.srcElement)==b.scroller&&fa(a);break;case 2:Z&&(this.state.lastMiddleDown=+new Date);c&&jc(this.doc,c);setTimeout(function(){b.input.focus()},20);fa(a);break;case 3:ld?oe(this,a):Hf(this)}}}function Gf(a,b,c){M?
setTimeout(vb(Qd,a),0):a.curOp.focus=xa();var d=+new Date,n;vc&&vc.time>d-400&&0==J(vc.pos,c)?n="triple":wc&&wc.time>d-400&&0==J(wc.pos,c)?(n="double",vc={time:d,pos:c}):(n="single",wc={time:d,pos:c});var d=a.doc.sel,f=pa?b.metaKey:b.ctrlKey,g;a.options.dragDrop&&If&&!ec(a)&&"single"==n&&-1<(g=d.contains(c))&&(0>J((g=d.ranges[g]).from(),c)||0<c.xRel)&&(0<J(g.to(),c)||0>c.xRel)?Jf(a,b,c,f):Kf(a,b,c,n,f)}function Jf(a,b,c,d){var n=a.display,f=+new Date,g=W(a,function(h){Z&&(n.scroller.draggable=!1);
a.state.draggingText=!1;Ca(document,"mouseup",g);Ca(n.scroller,"drop",g);10>Math.abs(b.clientX-h.clientX)+Math.abs(b.clientY-h.clientY)&&(fa(h),!d&&+new Date-200<f&&jc(a.doc,c),Z||M&&9==V?setTimeout(function(){document.body.focus();n.input.focus()},20):n.input.focus())});Z&&(n.scroller.draggable=!0);a.state.draggingText=g;n.scroller.dragDrop&&n.scroller.dragDrop();E(document,"mouseup",g);E(n.scroller,"drop",g)}function Kf(a,b,c,d,n){function f(b){if(0!=J(v,b))if(v=b,"rect"==d){for(var L=[],n=a.options.tabSize,
g=sa(B(p,c.line).text,c.ch,n),h=sa(B(p,b.line).text,b.ch,n),m=Math.min(g,h),g=Math.max(g,h),h=Math.min(c.line,b.line),ga=Math.min(a.lastLine(),Math.max(c.line,b.line));h<=ga;h++){var u=B(p,h).text,t=we(u,m,n);m==g?L.push(new U(z(h,t),z(h,t))):u.length>t&&L.push(new U(z(h,t),z(h,we(u,g,n))))}L.length||L.push(new U(c,c));aa(p,ra(s.ranges.slice(0,r).concat(L),r),{origin:"*mouse",scroll:!1});a.scrollIntoView(b)}else L=q,n=L.anchor,m=b,"single"!=d&&(b="double"==d?a.findWordAt(b):new U(z(b.line,0),I(p,
z(b.line+1,0))),0<J(b.anchor,n)?(m=b.head,n=dc(L.from(),b.anchor)):(m=b.anchor,n=cc(L.to(),b.head))),L=s.ranges.slice(0),L[r]=new U(I(p,n),m),aa(p,ra(L,r),nd)}function g(b){var c=++w,L=lb(a,b,!0,"rect"==d);if(L)if(0!=J(L,v)){a.curOp.focus=xa();f(L);var n=G(m,p);(L.line>=n.to||L.line<n.from)&&setTimeout(W(a,function(){w==c&&g(b)}),150)}else{var T=b.clientY<x.top?-20:b.clientY>x.bottom?20:0;T&&setTimeout(W(a,function(){w==c&&(m.scroller.scrollTop+=T,g(b))}),50)}}function h(a){w=Infinity;fa(a);m.input.focus();
Ca(document,"mousemove",A);Ca(document,"mouseup",K);p.history.lastSelOrigin=null}var m=a.display,p=a.doc;fa(b);var q,r,s=p.sel,u=s.ranges;n&&!b.shiftKey?(r=p.sel.contains(c),q=-1<r?u[r]:new U(c,c)):(q=p.sel.primary(),r=p.sel.primIndex);if(b.altKey)d="rect",n||(q=new U(c,c)),c=lb(a,b,!0,!0),r=-1;else if("double"==d){var t=a.findWordAt(c);q=a.display.shift||p.extend?Hb(p,q,t.anchor,t.head):t}else"triple"==d?(t=new U(z(c.line,0),I(p,z(c.line+1,0))),q=a.display.shift||p.extend?Hb(p,q,t.anchor,t.head):
t):q=Hb(p,q,c);n?-1==r?(r=u.length,aa(p,ra(u.concat([q]),r),{scroll:!1,origin:"*mouse"})):1<u.length&&u[r].empty()&&"single"==d&&!b.shiftKey?(aa(p,ra(u.slice(0,r).concat(u.slice(r+1)),0)),s=p.sel):$c(p,r,q,nd):(r=0,aa(p,new Da([q],0),nd),s=p.sel);var v=c,x=m.wrapper.getBoundingClientRect(),w=0,A=W(a,function(a){ve(a)?g(a):h(a)}),K=W(a,h);E(document,"mousemove",A);E(document,"mouseup",K)}function kd(a,b,c,d,n){try{var f=b.clientX,g=b.clientY}catch(h){return!1}if(f>=Math.floor(a.display.gutters.getBoundingClientRect().right))return!1;
d&&fa(b);d=a.display;var m=d.lineDiv.getBoundingClientRect();if(g>m.bottom||!ma(a,c))return od(b);g-=m.top-d.viewOffset;for(m=0;m<a.options.gutters.length;++m){var p=d.gutters.childNodes[m];if(p&&p.getBoundingClientRect().right>=f)return f=Sa(a.doc,g),n(a,c,a,f,a.options.gutters[m],b),od(b)}}function Ef(a){var b=this;if(!Ba(b,a)&&!Ga(b.display,a)){fa(a);M&&(qe=+new Date);var c=lb(b,a,!0),d=a.dataTransfer.files;if(c&&!ec(b))if(d&&d.length&&window.FileReader&&window.File){var n=d.length,f=Array(n),
g=0;a=function(a,H){var d=new FileReader;d.onload=W(b,function(){f[H]=d.result;if(++g==n){c=I(b.doc,c);var a={from:c,to:c,text:b.doc.splitLines(f.join(b.doc.lineSeparator())),origin:"paste"};fb(b.doc,a);$d(b.doc,ya(c,Xa(a)))}});d.readAsText(a)};for(var h=0;h<n;++h)a(d[h],h)}else if(b.state.draggingText&&-1<b.doc.sel.contains(c))b.state.draggingText(a),setTimeout(function(){b.display.input.focus()},20);else try{if(f=a.dataTransfer.getData("Text")){if(b.state.draggingText&&(pa?!a.altKey:!a.ctrlKey))var m=
b.listSelections();kc(b.doc,ya(c,c));if(m)for(h=0;h<m.length;++h)mb(b.doc,"",m[h].anchor,m[h].head,"drag");b.replaceSelection(f,"around","paste");b.display.input.focus()}}catch(p){}}}function Bb(a,b){2>Math.abs(a.doc.scrollTop-b)||(a.doc.scrollTop=b,Na||Ka(a,{top:b}),a.display.scroller.scrollTop!=b&&(a.display.scroller.scrollTop=b),a.display.scrollbars.setScrollTop(b),Na&&Ka(a),xb(a,100))}function db(a,b,c){(c?b==a.doc.scrollLeft:2>Math.abs(a.doc.scrollLeft-b))||(b=Math.min(b,a.display.scroller.scrollWidth-
a.display.scroller.clientWidth),a.doc.scrollLeft=b,S(a),a.display.scroller.scrollLeft!=b&&(a.display.scroller.scrollLeft=b),a.display.scrollbars.setScrollLeft(b))}function pe(a,b){var c=xe(b),d=c.x,c=c.y,n=a.display,f=n.scroller;if(d&&f.scrollWidth>f.clientWidth||c&&f.scrollHeight>f.clientHeight){if(c&&pa&&Z){var g=b.target,h=n.view;a:for(;g!=f;g=g.parentNode)for(var m=0;m<h.length;m++)if(h[m].node==g){a.display.currentWheelTarget=g;break a}}!d||Na||ta||null==ka?(c&&null!=ka&&(g=c*ka,h=a.doc.scrollTop,
m=h+n.wrapper.clientHeight,0>g?h=Math.max(0,h+g-50):m=Math.min(a.doc.height,m+g+50),Ka(a,{top:h,bottom:m})),20>xc&&(null==n.wheelStartX?(n.wheelStartX=f.scrollLeft,n.wheelStartY=f.scrollTop,n.wheelDX=d,n.wheelDY=c,setTimeout(function(){if(null!=n.wheelStartX){var a=f.scrollLeft-n.wheelStartX,b=f.scrollTop-n.wheelStartY,a=b&&n.wheelDY&&b/n.wheelDY||a&&n.wheelDX&&a/n.wheelDX;n.wheelStartX=n.wheelStartY=null;a&&(ka=(ka*xc+a)/(xc+1),++xc)}},200)):(n.wheelDX+=d,n.wheelDY+=c))):(c&&Bb(a,Math.max(0,Math.min(f.scrollTop+
c*ka,f.scrollHeight-f.clientHeight))),db(a,Math.max(0,Math.min(f.scrollLeft+d*ka,f.scrollWidth-f.clientWidth))),fa(b),n.wheelStartX=null)}}function yc(a,b,c){if("string"==typeof b&&(b=zc[b],!b))return!1;a.display.input.ensurePolled();var d=a.display.shift,n=!1;try{ec(a)&&(a.state.suppressEdits=!0),c&&(a.display.shift=!1),n=b(a)!=ye}finally{a.display.shift=d,a.state.suppressEdits=!1}return n}function Lf(a,b,c){for(var d=0;d<a.state.keyMaps.length;d++){var n=Mb(b,a.state.keyMaps[d],c,a);if(n)return n}return a.options.extraKeys&&
Mb(b,a.options.extraKeys,c,a)||Mb(b,a.options.keyMap,c,a)}function Ac(a,b,c,d){var n=a.state.keySeq;if(n){if(Mf(b))return"handled";Nf.set(50,function(){a.state.keySeq==n&&(a.state.keySeq=null,a.display.input.reset())});b=n+" "+b}d=Lf(a,b,d);"multi"==d&&(a.state.keySeq=b);"handled"==d&&da(a,"keyHandled",a,b,c);if("handled"==d||"multi"==d)fa(c),ad(a);return n&&!d&&/\'$/.test(b)?(fa(c),!0):!!d}function ze(a,b){var c=Of(b,!0);return c?b.shiftKey&&!a.state.keySeq?Ac(a,"Shift-"+c,b,function(b){return yc(a,
b,!0)})||Ac(a,c,b,function(b){if("string"==typeof b?/^go[A-Z]/.test(b):b.motion)return yc(a,b)}):Ac(a,c,b,function(b){return yc(a,b)}):!1}function Pf(a,b,c){return Ac(a,"'"+c+"'",b,function(b){return yc(a,b,!0)})}function te(a){this.curOp.focus=xa();if(!Ba(this,a)){M&&11>V&&27==a.keyCode&&(a.returnValue=!1);var b=a.keyCode;this.display.shift=16==b||a.shiftKey;var c=ze(this,a);ta&&(pd=c?b:null,!c&&88==b&&!Ae&&(pa?a.metaKey:a.ctrlKey)&&this.replaceSelection("",null,"cut"));18!=b||/\bCodeMirror-crosshair\b/.test(this.display.lineDiv.className)||
Qf(this)}}function Qf(a){function b(a){18!=a.keyCode&&a.altKey||(Ab(c,"CodeMirror-crosshair"),Ca(document,"keyup",b),Ca(document,"mouseover",b))}var c=a.display.lineDiv;Cb(c,"CodeMirror-crosshair");E(document,"keyup",b);E(document,"mouseover",b)}function se(a){16==a.keyCode&&(this.doc.sel.shift=!1);Ba(this,a)}function ue(a){if(!(Ga(this.display,a)||Ba(this,a)||a.ctrlKey&&!a.altKey||pa&&a.metaKey)){var b=a.keyCode,c=a.charCode;if(ta&&b==pd)pd=null,fa(a);else if(!ta||a.which&&!(10>a.which)||!ze(this,
a))if(b=String.fromCharCode(null==c?b:c),!Pf(this,a,b))this.display.input.onKeyPress(a)}}function Hf(a){a.state.delayingBlurEvent=!0;setTimeout(function(){a.state.delayingBlurEvent&&(a.state.delayingBlurEvent=!1,wb(a))},100)}function Nc(a){a.state.delayingBlurEvent&&(a.state.delayingBlurEvent=!1);"nocursor"!=a.options.readOnly&&(a.state.focused||(Y(a,"focus",a),a.state.focused=!0,Cb(a.display.wrapper,"CodeMirror-focused"),a.curOp||a.display.selForContextMenu==a.doc.sel||(a.display.input.reset(),Z&&
setTimeout(function(){a.display.input.reset(!0)},20)),a.display.input.receivedFocus()),ad(a))}function wb(a){a.state.delayingBlurEvent||(a.state.focused&&(Y(a,"blur",a),a.state.focused=!1,Ab(a.display.wrapper,"CodeMirror-focused")),clearInterval(a.display.blinker),setTimeout(function(){a.state.focused||(a.display.shift=!1)},150))}function oe(a,b){var c;(c=Ga(a.display,b))||(c=ma(a,"gutterContextMenu")?kd(a,b,"gutterContextMenu",!1,Y):!1);if(!c)a.display.input.onContextMenu(b)}function Be(a,b){if(0>
J(a,b.from))return a;if(0>=J(a,b.to))return Xa(b);var c=a.line+b.text.length-(b.to.line-b.from.line)-1,d=a.ch;a.line==b.to.line&&(d+=Xa(b).ch-b.to.ch);return z(c,d)}function qd(a,b){for(var c=[],d=0;d<a.sel.ranges.length;d++){var n=a.sel.ranges[d];c.push(new U(Be(n.anchor,b),Be(n.head,b)))}return ra(c,a.sel.primIndex)}function Ce(a,b,c){return a.line==b.line?z(c.line,a.ch-b.ch+c.ch):z(c.line+(a.line-b.line),a.ch)}function De(a,b,c){b={canceled:!1,from:b.from,to:b.to,text:b.text,origin:b.origin,cancel:function(){this.canceled=
!0}};c&&(b.update=function(b,c,d,L){b&&(this.from=I(a,b));c&&(this.to=I(a,c));d&&(this.text=d);void 0!==L&&(this.origin=L)});Y(a,"beforeChange",a,b);a.cm&&Y(a.cm,"beforeChange",a.cm,b);return b.canceled?null:{from:b.from,to:b.to,text:b.text,origin:b.origin}}function fb(a,b,c){if(a.cm){if(!a.cm.curOp)return W(a.cm,fb)(a,b,c);if(a.cm.state.suppressEdits)return}if(ma(a,"beforeChange")||a.cm&&ma(a.cm,"beforeChange"))if(b=De(a,b,!0),!b)return;if(c=Ee&&!c&&Rf(a,b.from,b.to))for(var d=c.length-1;0<=d;--d)Fe(a,
{from:c[d].from,to:c[d].to,text:d?[""]:b.text});else Fe(a,b)}function Fe(a,b){if(1!=b.text.length||""!=b.text[0]||0!=J(b.from,b.to)){var c=qd(a,b);Ge(a,b,c,a.cm?a.cm.curOp.id:NaN);Nb(a,b,c,rd(a,b));var d=[];Ya(a,function(a,c){c||-1!=ca(d,a.history)||(He(a.history,b),d.push(a.history));Nb(a,b,null,rd(a,b))})}}function Bc(a,b,c){if(!a.cm||!a.cm.state.suppressEdits){for(var d=a.history,n,f=a.sel,g="undo"==b?d.done:d.undone,h="undo"==b?d.undone:d.done,m=0;m<g.length&&(n=g[m],c?!n.ranges||n.equals(a.sel):
n.ranges);m++);if(m!=g.length){for(d.lastOrigin=d.lastSelOrigin=null;;)if(n=g.pop(),n.ranges){lc(n,h);if(c&&!n.equals(a.sel)){aa(a,n,{clearRedo:!1});return}f=n}else break;c=[];lc(f,h);h.push({changes:c,generation:d.generation});d.generation=n.generation||++d.maxGeneration;d=ma(a,"beforeChange")||a.cm&&ma(a.cm,"beforeChange");for(m=n.changes.length-1;0<=m;--m){var p=n.changes[m];p.origin=b;if(d&&!De(a,p,!1)){g.length=0;break}c.push(sd(a,p));f=m?qd(a,p):P(g);Nb(a,p,f,Ie(a,p));!m&&a.cm&&a.cm.scrollIntoView({from:p.from,
to:Xa(p)});var q=[];Ya(a,function(a,b){b||-1!=ca(q,a.history)||(He(a.history,p),q.push(a.history));Nb(a,p,null,Ie(a,p))})}}}}function Je(a,b){if(0!=b&&(a.first+=b,a.sel=new Da(gc(a.sel.ranges,function(a){return new U(z(a.anchor.line+b,a.anchor.ch),z(a.head.line+b,a.head.ch))}),a.sel.primIndex),a.cm)){ia(a.cm,a.first,a.first-b,b);for(var c=a.cm.display,d=c.viewFrom;d<c.viewTo;d++)Fa(a.cm,d,"gutter")}}function Nb(a,b,c,d){if(a.cm&&!a.cm.curOp)return W(a.cm,Nb)(a,b,c,d);if(b.to.line<a.first)Je(a,b.text.length-
1-(b.to.line-b.from.line));else if(!(b.from.line>a.lastLine())){if(b.from.line<a.first){var n=b.text.length-1-(a.first-b.from.line);Je(a,n);b={from:z(a.first,0),to:z(b.to.line+n,b.to.ch),text:[P(b.text)],origin:b.origin}}n=a.lastLine();b.to.line>n&&(b={from:b.from,to:z(n,B(a,n).text.length),text:[b.text[0]],origin:b.origin});b.removed=Ua(a,b.from,b.to);c||(c=qd(a,b));a.cm?Sf(a.cm,b,d):td(a,b,d);kc(a,c,za)}}function Sf(a,b,c){var d=a.doc,n=a.display,g=b.from,h=b.to,m=!1,p=g.line;a.options.lineWrapping||
(p=R(Aa(B(d,g.line))),d.iter(p,h.line+1,function(a){if(a==n.maxLine)return m=!0}));-1<d.sel.contains(b.from,b.to)&&de(a);td(d,b,c,f(a));a.options.lineWrapping||(d.iter(p,g.line+b.text.length,function(a){var b=v(a);b>n.maxLineLength&&(n.maxLine=a,n.maxLineLength=b,n.maxLineChanged=!0,m=!1)}),m&&(a.curOp.updateMaxLine=!0));d.frontier=Math.min(d.frontier,g.line);xb(a,400);c=b.text.length-(h.line-g.line)-1;b.full?ia(a):g.line!=h.line||1!=b.text.length||Ke(a.doc,b)?ia(a,g.line,h.line+1,c):Fa(a,g.line,
"text");c=ma(a,"changes");if((d=ma(a,"change"))||c)b={from:g,to:h,text:b.text,removed:b.removed,origin:b.origin},d&&da(a,"change",a,b),c&&(a.curOp.changeObjs||(a.curOp.changeObjs=[])).push(b);a.display.selForContextMenu=null}function mb(a,b,c,d,n){d||(d=c);if(0>J(d,c)){var f=d;d=c;c=f}"string"==typeof b&&(b=a.splitLines(b));fb(a,{from:c,to:d,text:b,origin:n})}function tc(a,b,c,d,n){var f=a.display,g=Oa(a.display);0>c&&(c=0);var h=a.curOp&&null!=a.curOp.scrollTop?a.curOp.scrollTop:f.scroller.scrollTop,
m=Sc(a),p={};n-c>m&&(n=c+m);var q=a.doc.height+Pc(f),r=c<g,g=n>q-g;c<h?p.scrollTop=r?0:c:n>h+m&&(c=Math.min(c,(g?q:n)-m),c!=h&&(p.scrollTop=c));h=a.curOp&&null!=a.curOp.scrollLeft?a.curOp.scrollLeft:f.scroller.scrollLeft;a=Ha(a)-(a.options.fixedGutter?f.gutters.offsetWidth:0);(f=d-b>a)&&(d=b+a);10>b?p.scrollLeft=0:b<h?p.scrollLeft=Math.max(0,b-(f?0:10)):d>a+h-3&&(p.scrollLeft=d+(f?0:10)-a);return p}function Cc(a,b,c){null==b&&null==c||Dc(a);null!=b&&(a.curOp.scrollLeft=(null==a.curOp.scrollLeft?a.doc.scrollLeft:
a.curOp.scrollLeft)+b);null!=c&&(a.curOp.scrollTop=(null==a.curOp.scrollTop?a.doc.scrollTop:a.curOp.scrollTop)+c)}function gb(a){Dc(a);var b=a.getCursor(),c=b,d=b;a.options.lineWrapping||(c=b.ch?z(b.line,b.ch-1):b,d=z(b.line,b.ch+1));a.curOp.scrollToPos={from:c,to:d,margin:a.options.cursorScrollMargin,isCursor:!0}}function Dc(a){var b=a.curOp.scrollToPos;if(b){a.curOp.scrollToPos=null;var c=me(a,b.from),d=me(a,b.to),b=tc(a,Math.min(c.left,d.left),Math.min(c.top,d.top)-b.margin,Math.max(c.right,d.right),
Math.max(c.bottom,d.bottom)+b.margin);a.scrollTo(b.scrollLeft,b.scrollTop)}}function Fb(a,b,c,d){var n=a.doc,f;null==c&&(c="add");"smart"==c&&(n.mode.indent?f=Ib(a,b):c="prev");var g=a.options.tabSize,h=B(n,b),m=sa(h.text,null,g);h.stateAfter&&(h.stateAfter=null);var p=h.text.match(/^\s*/)[0],q;if(!d&&!/\S/.test(h.text))q=0,c="not";else if("smart"==c&&(q=n.mode.indent(f,h.text.slice(p.length),h.text),q==ye||150<q)){if(!d)return;c="prev"}"prev"==c?q=b>n.first?sa(B(n,b-1).text,null,g):0:"add"==c?q=
m+a.options.indentUnit:"subtract"==c?q=m-a.options.indentUnit:"number"==typeof c&&(q=m+c);q=Math.max(0,q);c="";d=0;if(a.options.indentWithTabs)for(a=Math.floor(q/g);a;--a)d+=g,c+="\t";d<q&&(c+=Le(q-d));if(c!=p)return mb(n,c,z(b,0),z(b,p.length),"+input"),h.stateAfter=null,!0;for(a=0;a<n.sel.ranges.length;a++)if(g=n.sel.ranges[a],g.head.line==b&&g.head.ch<p.length){d=z(b,p.length);$c(n,a,new U(d,d));break}}function Ec(a,b,c,d){var n=b,f=b;"number"==typeof b?f=B(a,Math.max(a.first,Math.min(b,a.first+
a.size-1))):n=R(b);if(null==n)return null;d(f,n)&&a.cm&&Fa(a.cm,n,c);return f}function nb(a,b){for(var c=a.doc.sel.ranges,d=[],n=0;n<c.length;n++){for(var f=b(c[n]);d.length&&0>=J(f.from,P(d).to);){var g=d.pop();if(0>J(g.from,f.from)){f.from=g.from;break}}d.push(f)}ja(a,function(){for(var b=d.length-1;0<=b;b--)mb(a.doc,"",d[b].from,d[b].to,"+delete");gb(a)})}function ud(a,b,c,d,n){function f(b){var d=(n?jd:Me)(p,h,c,!0);if(null==d){if(b=!b)b=g+c,b<a.first||b>=a.first+a.size?b=q=!1:(g=b,b=p=B(a,b));
...
b,c,d){var n=a.doc,f=b.left,g;"page"==d?(d=Math.min(a.display.wrapper.clientHeight,window.innerHeight||document.documentElement.clientHeight),g=b.top+c*(d-(0>c?1.5:.5)*Oa(a.display))):"line"==d&&(g=0<c?b.bottom+3:b.top-3);for(;;){var h=id(a,f,g);if(!h.outside)break;if(0>c?0>=g:g>=n.height){h.hitSide=!0;break}g+=5*c}return h}function F(a,b,d,f){c.defaults[a]=b;d&&(bb[a]=f?function(a,b,c){c!=Fd&&d(a,b,c)}:d)}function Tf(a){var b=a.split(/-(?!$)/);a=b[b.length-1];for(var c,d,n,f,g=0;g<b.length-1;g++){var h=
b[g];if(/^(cmd|meta|m)$/i.test(h))f=!0;else if(/^a(lt)?$/i.test(h))c=!0;else if(/^(c|ctrl|control)$/i.test(h))d=!0;else if(/^s(hift)$/i.test(h))n=!0;else throw Error("Unrecognized modifier name: "+h);}c&&(a="Alt-"+a);d&&(a="Ctrl-"+a);f&&(a="Cmd-"+a);n&&(a="Shift-"+a);return a}function Gc(a){return"string"==typeof a?La[a]:a}function ob(a,b,c,d,n){if(d&&d.shared)return Uf(a,b,c,d,n);if(a.cm&&!a.cm.curOp)return W(a.cm,ob)(a,b,c,d,n);var f=new Za(a,n);n=J(b,c);d&&oa(d,f,!1);if(0<n||0==n&&!1!==f.clearWhenEmpty)return f;
f.replacedWith&&(f.collapsed=!0,f.widgetNode=C("span",[f.replacedWith],"CodeMirror-widget"),d.handleMouseEvents||f.widgetNode.setAttribute("cm-ignore-events","true"),d.insertLeft&&(f.widgetNode.insertLeft=!0));if(f.collapsed){if(Oe(a,b.line,b,c,f)||b.line!=c.line&&Oe(a,c.line,b,c,f))throw Error("Inserting collapsed marker partially overlapping an existing one");Ja=!0}f.addToHistory&&Ge(a,{from:b,to:c,origin:"markText"},a.sel,NaN);var g=b.line,h=a.cm,m;a.iter(g,c.line+1,function(a){h&&f.collapsed&&
!h.options.lineWrapping&&Aa(a)==h.display.maxLine&&(m=!0);f.collapsed&&g!=b.line&&ua(a,0);var d=new Hc(f,g==b.line?b.ch:null,g==c.line?c.ch:null);a.markedSpans=a.markedSpans?a.markedSpans.concat([d]):[d];d.marker.attachLine(a);++g});f.collapsed&&a.iter(b.line,c.line+1,function(b){Pa(a,b)&&ua(b,0)});f.clearOnEnter&&E(f,"beforeCursorEnter",function(){f.clear()});f.readOnly&&(Ee=!0,(a.history.done.length||a.history.undone.length)&&a.clearHistory());f.collapsed&&(f.id=++vd,f.atomic=!0);if(h){m&&(h.curOp.updateMaxLine=
!0);if(f.collapsed)ia(h,b.line,c.line+1);else if(f.className||f.title||f.startStyle||f.endStyle||f.css)for(d=b.line;d<=c.line;d++)Fa(h,d,"text");f.atomic&&ee(h.doc);da(h,"markerAdded",h,f)}return f}function Uf(a,b,c,d,f){d=oa(d);d.shared=!1;var g=[ob(a,b,c,d,f)],h=g[0],m=d.widgetNode;Ya(a,function(a){m&&(d.widgetNode=m.cloneNode(!0));g.push(ob(a,I(a,b),I(a,c),d,f));for(var H=0;H<a.linked.length;++H)if(a.linked[H].isParent)return;h=P(g)});return new Ic(g,h)}function Pe(a){return a.findMarks(z(a.first,
0),a.clipPos(z(a.lastLine())),function(a){return a.parent})}function Vf(a){for(var b=0;b<a.length;b++){var c=a[b],d=[c.primary.doc];Ya(c.primary.doc,function(a){d.push(a)});for(var f=0;f<c.markers.length;f++){var g=c.markers[f];-1==ca(d,g.doc)&&(g.parent=null,c.markers.splice(f--,1))}}}function Hc(a,b,c){this.marker=a;this.from=b;this.to=c}function Ob(a,b){if(a)for(var c=0;c<a.length;++c){var d=a[c];if(d.marker==b)return d}}function rd(a,b){if(b.full)return null;var c=Gb(a,b.from.line)&&B(a,b.from.line).markedSpans,
d=Gb(a,b.to.line)&&B(a,b.to.line).markedSpans;if(!c&&!d)return null;var f=b.from.ch,g=b.to.ch,h=0==J(b.from,b.to);if(c)for(var m=0,p;m<c.length;++m){var q=c[m],r=q.marker;if(null==q.from||(r.inclusiveLeft?q.from<=f:q.from<f)||!(q.from!=f||"bookmark"!=r.type||h&&q.marker.insertLeft)){var s=null==q.to||(r.inclusiveRight?q.to>=f:q.to>f);(p||(p=[])).push(new Hc(r,q.from,s?null:q.to))}}c=p;if(d)for(var m=0,u;m<d.length;++m)if(p=d[m],q=p.marker,null==p.to||(q.inclusiveRight?p.to>=g:p.to>g)||p.from==g&&
"bookmark"==q.type&&(!h||p.marker.insertLeft))r=null==p.from||(q.inclusiveLeft?p.from<=g:p.from<g),(u||(u=[])).push(new Hc(q,r?null:p.from-g,null==p.to?null:p.to-g));d=u;h=1==b.text.length;u=P(b.text).length+(h?f:0);if(c)for(g=0;g<c.length;++g)if(m=c[g],null==m.to)(p=Ob(d,m.marker),p)?h&&(m.to=null==p.to?null:p.to+u):m.to=f;if(d)for(g=0;g<d.length;++g)m=d[g],null!=m.to&&(m.to+=u),null==m.from?(p=Ob(c,m.marker),p||(m.from=u,h&&(c||(c=[])).push(m))):(m.from+=u,h&&(c||(c=[])).push(m));c&&(c=Qe(c));d&&
...
end:r.pos,string:r.current(),type:m||null,state:a?jb(g.mode,q):q}}var g=a.doc,h=g.mode,m;b=I(g,b);var p=B(g,b.line),q=Ib(a,b.line,c),r=new Kc(p.text,a.options.tabSize),s;for(d&&(s=[]);(d||r.pos<b.ch)&&!r.eol();)r.start=r.pos,m=xd(h,r,q),d&&s.push(f(!0));return d?s:f()}function Xe(a,b,c,d,f,g,h){var m=c.flattenSpans;null==m&&(m=a.options.flattenSpans);var p=0,q=null,r=new Kc(b,a.options.tabSize),s,u=a.options.addModeClass&&[null];for(""==b&&Ue(Ve(c,d),g);!r.eol();){r.pos>a.options.maxHighlightLength?
...
1,a,f[m+1],d);m+=2;p=Math.min(a,d)}if(b)if(h.opaque)f.splice(c,m-c,a,"cm-overlay "+b),m=c+2;else for(;c<m;c+=2)d=f[c+1],f[c+1]=(d?d+" ":"")+"cm-overlay "+b},g)}return{styles:f,classes:g.bgClass||g.textClass?g:null}}function Ye(a,b,c){if(!b.styles||b.styles[0]!=a.state.modeGen){var d=he(a,b,b.stateAfter=Ib(a,R(b)));b.styles=d.styles;d.classes?b.styleClasses=d.classes:b.styleClasses&&(b.styleClasses=null);c===a.doc.frontier&&a.doc.frontier++}return b.styles}function bd(a,b,c,d){var f=a.doc.mode,g=new Kc(b,
a.options.tabSize);g.start=g.pos=d||0;for(""==b&&Ve(f,c);!g.eol()&&g.pos<=a.options.maxHighlightLength;)xd(f,g,c),g.start=g.pos}function Ze(a,b){if(!a||/^\s*$/.test(a))return null;var c=b.addModeClass?Yf:Zf;return c[a]||(c[a]=a.replace(/\S+/g,"cm-$&"))}function Od(a,b){var c=C("span",null,null,Z?"padding-right: .1px":null),c={pre:C("pre",[c],"CodeMirror-line"),content:c,col:0,pos:0,cm:a,splitSpaces:(M||Z)&&a.getOption("lineWrapping")};b.measure={};for(var d=0;d<=(b.rest?b.rest.length:0);d++){var f=
d?b.rest[d-1]:b.line,g;c.pos=0;c.addToken=$f;var h;if(null!=yd)h=yd;else{h=na(a.display.measure,document.createTextNode("A\u062eA"));var m=Va(h,0,1).getBoundingClientRect();h=m&&m.left!=m.right?yd=3>Va(h,1,2).getBoundingClientRect().right-m.right:!1}h&&(g=qa(f))&&(c.addToken=ag(c.addToken,g));c.map=[];m=b!=a.display.externalMeasured&&R(f);a:{h=c;var m=Ye(a,f,m),p=f.markedSpans,q=f.text,r=0;if(p)for(var s=q.length,u=0,t=1,v="",x=void 0,w=void 0,A=0,G=void 0,K=void 0,S=void 0,z=void 0,D=void 0;;){if(A==
u){for(var G=K=S=z=w="",D=null,A=Infinity,O=[],B=0;B<p.length;++B){var Q=p[B],N=Q.marker;"bookmark"==N.type&&Q.from==u&&N.widgetNode?O.push(N):Q.from<=u&&(null==Q.to||Q.to>u||N.collapsed&&Q.to==u&&Q.from==u)?(null!=Q.to&&Q.to!=u&&A>Q.to&&(A=Q.to,K=""),N.className&&(G+=" "+N.className),N.css&&(w=N.css),N.startStyle&&Q.from==u&&(S+=" "+N.startStyle),N.endStyle&&Q.to==A&&(K+=" "+N.endStyle),N.title&&!z&&(z=N.title),N.collapsed&&(!D||0>Te(D.marker,N))&&(D=Q)):Q.from>u&&A>Q.from&&(A=Q.from)}if(D&&(D.from||
0)==u){$e(h,(null==D.to?s+1:D.to)-u,D.marker,null==D.from);if(null==D.to)break a;D.to==u&&(D=!1)}if(!D&&O.length)for(B=0;B<O.length;++B)$e(h,0,O[B])}if(u>=s)break;for(O=Math.min(s,A);;){if(v){B=u+v.length;D||(Q=B>O?v.slice(0,O-u):v,h.addToken(h,Q,x?x+G:G,S,u+Q.length==A?K:"",z,w));if(B>=O){v=v.slice(O-u);u=O;break}u=B;S=""}v=q.slice(r,r=m[t++]);x=Ze(m[t++],h.cm.options)}}else for(var t=1;t<m.length;t+=2)h.addToken(h,q.slice(r,r=m[t]),Ze(m[t+1],h.cm.options))}f.styleClasses&&(f.styleClasses.bgClass&&
(c.bgClass=zd(f.styleClasses.bgClass,c.bgClass||"")),f.styleClasses.textClass&&(c.textClass=zd(f.styleClasses.textClass,c.textClass||"")));0==c.map.length&&c.map.push(0,0,c.content.appendChild(bg(a.display.measure)));0==d?(b.measure.map=c.map,b.measure.cache={}):((b.measure.maps||(b.measure.maps=[])).push(c.map),(b.measure.caches||(b.measure.caches=[])).push({}))}Z&&/\bcm-tab\b/.test(c.content.lastChild.className)&&(c.content.className="cm-tab-wrap-hack");Y(a,"renderLine",a,b.line,c.pre);c.pre.className&&
(c.textClass=zd(c.pre.className,c.textClass||""));return c}function $f(a,b,c,d,f,g,h){if(b){var m=a.splitSpaces?b.replace(/ {3,}/g,cg):b,p=a.cm.state.specialChars,q=!1;if(p.test(b))for(var r=document.createDocumentFragment(),s=0;;){p.lastIndex=s;var u=p.exec(b),t=u?u.index-s:b.length-s;if(t){var v=document.createTextNode(m.slice(s,s+t));M&&9>V?r.appendChild(C("span",[v])):r.appendChild(v);a.map.push(a.pos,a.pos+t,v);a.col+=t;a.pos+=t}if(!u)break;s+=t+1;"\t"==u[0]?(v=a.cm.options.tabSize,u=v-a.col%
v,v=r.appendChild(C("span",Le(u),"cm-tab")),v.setAttribute("role","presentation"),v.setAttribute("cm-text","\t"),a.col+=u):("\r"==u[0]||"\n"==u[0]?(v=r.appendChild(C("span","\r"==u[0]?"\u240d":"\u2424","cm-invalidchar")),v.setAttribute("cm-text",u[0])):(v=a.cm.options.specialCharPlaceholder(u[0]),v.setAttribute("cm-text",u[0]),M&&9>V?r.appendChild(C("span",[v])):r.appendChild(v)),a.col+=1);a.map.push(a.pos,a.pos+1,v);a.pos++}else{a.col+=b.length;var r=document.createTextNode(m);a.map.push(a.pos,a.pos+
b.length,r);M&&9>V&&(q=!0);a.pos+=b.length}if(c||d||f||q||h)return b=c||"",d&&(b+=d),f&&(b+=f),d=C("span",[r],b,h),g&&(d.title=g),a.content.appendChild(d);a.content.appendChild(r)}}function cg(a){for(var b=" ",c=0;c<a.length-2;++c)b+=c%2?" ":"\u00a0";return b+" "}function ag(a,b){return function(c,d,f,g,h,m,p){f=f?f+" cm-force-border":"cm-force-border";for(var q=c.pos,r=q+d.length;;){for(var s=0;s<b.length;s++){var u=b[s];if(u.to>q&&u.from<=q)break}if(u.to>=r)return a(c,d,f,g,h,m,p);a(c,d.slice(0,
u.to-q),f,g,null,m,p);g=null;d=d.slice(u.to-q);q=u.to}}}function $e(a,b,c,d){var f=!d&&c.widgetNode;f&&a.map.push(a.pos,a.pos+b,f);!d&&a.cm.display.input.needsContentAttribute&&(f||(f=a.content.appendChild(document.createElement("span"))),f.setAttribute("cm-marker",c.id));f&&(a.cm.display.input.setUneditable(f),a.content.appendChild(f));a.pos+=b}function Ke(a,b){return 0==b.from.ch&&0==b.to.ch&&""==P(b.text)&&(!a.cm||a.cm.options.wholeLineUpdateBefore)}function td(a,b,c,d){function f(a,c,H){a.text=
c;a.stateAfter&&(a.stateAfter=null);a.styles&&(a.styles=null);null!=a.order&&(a.order=null);Re(a);Se(a,H);c=d?d(a):1;c!=a.height&&ua(a,c);da(a,"change",a,b)}function g(a,b){for(var H=a,f=[];H<b;++H)f.push(new Pb(p[H],c?c[H]:null,d));return f}var h=b.from,m=b.to,p=b.text,q=B(a,h.line),r=B(a,m.line),s=P(p),u=c?c[p.length-1]:null,t=m.line-h.line;if(b.full)a.insert(0,g(0,p.length)),a.remove(p.length,a.size-p.length);else if(Ke(a,b)){var v=g(0,p.length-1);f(r,r.text,u);t&&a.remove(h.line,t);v.length&&
a.insert(h.line,v)}else q==r?1==p.length?f(q,q.text.slice(0,h.ch)+s+q.text.slice(m.ch),u):(v=g(1,p.length-1),v.push(new Pb(s+q.text.slice(m.ch),u,d)),f(q,q.text.slice(0,h.ch)+p[0],c?c[0]:null),a.insert(h.line+1,v)):1==p.length?(f(q,q.text.slice(0,h.ch)+p[0]+r.text.slice(m.ch),c?c[0]:null),a.remove(h.line+1,t)):(f(q,q.text.slice(0,h.ch)+p[0],c?c[0]:null),f(r,s+r.text.slice(m.ch),u),v=g(1,p.length-1),1<t&&a.remove(h.line+1,t-1),a.insert(h.line+1,v));da(a,"change",a,b)}function Qb(a){this.lines=a;this.parent=
null;for(var b=0,c=0;b<a.length;++b)a[b].parent=this,c+=a[b].height;this.height=c}function Rb(a){this.children=a;for(var b=0,c=0,d=0;d<a.length;++d){var f=a[d],b=b+f.chunkSize(),c=c+f.height;f.parent=this}this.size=b;this.height=c;this.parent=null}function Ya(a,b,c){function d(a,H,f){if(a.linked)for(var g=0;g<a.linked.length;++g){var h=a.linked[g];if(h.doc!=H){var m=f&&h.sharedHist;if(!c||m)b(h.doc,m),d(h.doc,a,m)}}}d(a,null,!0)}function Ed(a,c){if(c.cm)throw Error("This document is already in use.");
a.doc=c;c.cm=a;g(a);b(a);a.options.lineWrapping||x(a);a.options.mode=c.modeOption;ia(a)}function B(a,b){b-=a.first;if(0>b||b>=a.size)throw Error("There is no line "+(b+a.first)+" in the document.");for(var c=a;!c.lines;)for(var d=0;;++d){var f=c.children[d],g=f.chunkSize();if(b<g){c=f;break}b-=g}return c.lines[b]}function Ua(a,b,c){var d=[],f=b.line;a.iter(b.line,c.line+1,function(a){a=a.text;f==c.line&&(a=a.slice(0,c.ch));f==b.line&&(a=a.slice(b.ch));d.push(a);++f});return d}function Ad(a,b,c){var d=
[];a.iter(b,c,function(a){d.push(a.text)});return d}function ua(a,b){var c=b-a.height;if(c)for(var d=a;d;d=d.parent)d.height+=c}function R(a){if(null==a.parent)return null;var b=a.parent;a=ca(b.lines,a);for(var c=b.parent;c;b=c,c=c.parent)for(var d=0;c.children[d]!=b;++d)a+=c.children[d].chunkSize();return a+b.first}function Sa(a,b){var c=a.first;a:do{for(var d=0;d<a.children.length;++d){var f=a.children[d],g=f.height;if(b<g){a=f;continue a}b-=g;c+=f.chunkSize()}return c}while(!a.lines);for(d=0;d<
a.lines.length;++d){f=a.lines[d].height;if(b<f)break;b-=f}return c+d}function wa(a){a=Aa(a);for(var b=0,c=a.parent,d=0;d<c.lines.length;++d){var f=c.lines[d];if(f==a)break;else b+=f.height}for(a=c.parent;a;c=a,a=c.parent)for(d=0;d<a.children.length&&(f=a.children[d],f!=c);++d)b+=f.height;return b}function qa(a){var b=a.order;null==b&&(b=a.order=dg(a.text));return b}function Lc(a){this.done=[];this.undone=[];this.undoDepth=Infinity;this.lastModTime=this.lastSelTime=0;this.lastOrigin=this.lastSelOrigin=
this.lastOp=this.lastSelOp=null;this.generation=this.maxGeneration=a||1}function sd(a,b){var c={from:Vc(b.from),to:Xa(b),text:Ua(a,b.from,b.to)};af(a,c,b.from.line,b.to.line+1);Ya(a,function(a){af(a,c,b.from.line,b.to.line+1)},!0);return c}function ae(a){for(;a.length;)if(P(a).ranges)a.pop();else break}function Ge(a,b,c,d){var f=a.history;f.undone.length=0;var g=+new Date,h,m;if(m=f.lastOp==d||f.lastOrigin==b.origin&&b.origin&&("+"==b.origin.charAt(0)&&a.cm&&f.lastModTime>g-a.cm.options.historyEventDelay||
"*"==b.origin.charAt(0)))f.lastOp==d?(ae(f.done),h=P(f.done)):f.done.length&&!P(f.done).ranges?h=P(f.done):1<f.done.length&&!f.done[f.done.length-2].ranges?(f.done.pop(),h=P(f.done)):h=void 0,m=h;if(m){var p=P(h.changes);0==J(b.from,b.to)&&0==J(b.from,p.to)?p.to=Xa(b):h.changes.push(sd(a,b))}else for((h=P(f.done))&&h.ranges||lc(a.sel,f.done),h={changes:[sd(a,b)],generation:f.generation},f.done.push(h);f.done.length>f.undoDepth;)f.done.shift(),f.done[0].ranges||f.done.shift();f.done.push(c);f.generation=
++f.maxGeneration;f.lastModTime=f.lastSelTime=g;f.lastOp=f.lastSelOp=d;f.lastOrigin=f.lastSelOrigin=b.origin;p||Y(a,"historyAdded")}function lc(a,b){var c=P(b);c&&c.ranges&&c.equals(a)||b.push(a)}function af(a,b,c,d){var f=b["spans_"+a.id],g=0;a.iter(Math.max(a.first,c),Math.min(a.first+a.size,d),function(c){c.markedSpans&&((f||(f=b["spans_"+a.id]={}))[g]=c.markedSpans);++g})}function Wf(a){if(!a)return null;for(var b=0,c;b<a.length;++b)a[b].marker.explicitlyCleared?c||(c=a.slice(0,b)):c&&c.push(a[b]);
return c?c.length?c:null:a}function pb(a,b,c){for(var d=0,f=[];d<a.length;++d){var g=a[d];if(g.ranges)f.push(c?Da.prototype.deepCopy.call(g):g);else{var g=g.changes,h=[];f.push({changes:h});for(var m=0;m<g.length;++m){var p=g[m],q;h.push({from:p.from,to:p.to,text:p.text});if(b)for(var r in p)(q=r.match(/^spans_(\d+)$/))&&-1<ca(b,Number(q[1]))&&(P(h)[r]=p[r],delete p[r])}}}return f}function bf(a,b,c,d){c<a.line?a.line+=d:b<a.line&&(a.line=b,a.ch=0)}function cf(a,b,c,d){for(var f=0;f<a.length;++f){var g=
...
a.defaultPrevented:!1==a.returnValue}function ve(a){var b=a.which;null==b&&(a.button&1?b=1:a.button&2?b=3:a.button&4&&(b=2));pa&&a.ctrlKey&&1==b&&(b=3);return b}function da(a,b){function c(a){return function(){a.apply(null,f)}}var d=a._handlers&&a._handlers[b];if(d){var f=Array.prototype.slice.call(arguments,2),g;kb?g=kb.delayedCallbacks:Sb?g=Sb:(g=Sb=[],setTimeout(eg,0));for(var h=0;h<d.length;++h)g.push(c(d[h]))}}function eg(){var a=Sb;Sb=null;for(var b=0;b<a.length;++b)a[b]()}function Ba(a,b,c){"string"==
typeof b&&(b={type:b,preventDefault:function(){this.defaultPrevented=!0}});Y(a,c||b.type,a,b);return od(b)||b.codemirrorIgnore}function de(a){var b=a._handlers&&a._handlers.cursorActivity;if(b){a=a.curOp.cursorActivityHandlers||(a.curOp.cursorActivityHandlers=[]);for(var c=0;c<b.length;++c)-1==ca(a,b[c])&&a.push(b[c])}}function ma(a,b){var c=a._handlers&&a._handlers[b];return c&&0<c.length}function qb(a){a.prototype.on=function(a,b){E(this,a,b)};a.prototype.off=function(a,b){Ca(this,a,b)}}function ub(){this.id=
null}function we(a,b,c){for(var d=0,f=0;;){var g=a.indexOf("\t",d);-1==g&&(g=a.length);var h=g-d;if(g==a.length||f+h>=b)return d+Math.min(h,b-f);f+=g-d;f+=c-f%c;d=g+1;if(f>=b)return d}}function Le(a){for(;Mc.length<=a;)Mc.push(P(Mc)+" ");return Mc[a]}function P(a){return a[a.length-1]}function ca(a,b){for(var c=0;c<a.length;++c)if(a[c]==b)return c;return-1}function gc(a,b){for(var c=[],d=0;d<a.length;d++)c[d]=b(a[d],d);return c}function Tb(){}function df(a,b){var c;Object.create?c=Object.create(a):
(Tb.prototype=a,c=new Tb);b&&oa(b,c);return c}function oa(a,b,c){b||(b={});for(var d in a)!a.hasOwnProperty(d)||!1===c&&b.hasOwnProperty(d)||(b[d]=a[d]);return b}function vb(a){var b=Array.prototype.slice.call(arguments,1);return function(){return a.apply(null,b)}}function Fc(a,b){return b?-1<b.source.indexOf("\\w")&&ef(a)?!0:b.test(a):ef(a)}function ff(a){for(var b in a)if(a.hasOwnProperty(b)&&a[b])return!1;return!0}function Jb(a){return 768<=a.charCodeAt(0)&&fg.test(a)}function C(a,b,c,d){a=document.createElement(a);
c&&(a.className=c);d&&(a.style.cssText=d);if("string"==typeof b)a.appendChild(document.createTextNode(b));else if(b)for(c=0;c<b.length;++c)a.appendChild(b[c]);return a}function Qa(a){for(var b=a.childNodes.length;0<b;--b)a.removeChild(a.firstChild);return a}function na(a,b){return Qa(a).appendChild(b)}function xa(){for(var a=document.activeElement;a&&a.root&&a.root.activeElement;)a=a.root.activeElement;return a}function Ub(a){return new RegExp("(^|\\s)"+a+"(?:$|\\s)\\s*")}function zd(a,b){for(var c=
a.split(" "),d=0;d<c.length;d++)c[d]&&!Ub(c[d]).test(b)&&(b+=" "+c[d]);return b}function gf(a){if(document.body.getElementsByClassName)for(var b=document.body.getElementsByClassName("CodeMirror"),c=0;c<b.length;c++){var d=b[c].CodeMirror;d&&a(d)}}function qf(){var a;E(window,"resize",function(){null==a&&(a=setTimeout(function(){a=null;gf(Ff)},100))});E(window,"blur",function(){gf(wb)})}function bg(a){if(null==Bd){var b=C("span","\u200b");na(a,C("span",[b,document.createTextNode("x")]));0!=a.firstChild.offsetHeight&&
(Bd=1>=b.offsetWidth&&2<b.offsetHeight&&!(M&&8>V))}a=Bd?C("span","\u200b"):C("span","\u00a0",null,"display: inline-block; width: 1px; margin-right: -1px");a.setAttribute("cm-text","");return a}function xf(a,b,c,d){if(!a)return d(b,c,"ltr");for(var f=!1,g=0;g<a.length;++g){var h=a[g];if(h.from<c&&h.to>b||b==c&&h.to==b)d(Math.max(h.from,b),Math.min(h.to,c),1==h.level?"rtl":"ltr"),f=!0}f||d(b,c,"ltr")}function gd(a){return a.level%2?a.to:a.from}function hd(a){return a.level%2?a.from:a.to}function rc(a){return(a=
qa(a))?gd(a[0]):0}function sc(a){var b=qa(a);return b?hd(P(b)):a.text.length}function hf(a,b){var c=B(a.doc,b),d=Aa(c);d!=c&&(b=R(d));d=(c=qa(d))?c[0].level%2?sc(d):rc(d):0;return z(b,d)}function jf(a,b){var c=hf(a,b.line),d=B(a.doc,c.line),f=qa(d);return f&&0!=f[0].level?c:(d=Math.max(0,d.text.search(/\S/)),z(c.line,b.line==c.line&&b.ch<=d&&b.ch?0:d))}function hc(a,b){Lb=null;for(var c=0,d;c<a.length;++c){var f=a[c];if(f.from<b&&f.to>b)return c;if(f.from==b||f.to==b)if(null==d)d=c;else{var g;g=f.level;
var h=a[d].level,m=a[0].level;g=g==m?!0:h==m?!1:g<h;if(g)return f.from!=f.to&&(Lb=d),c;f.from!=f.to&&(Lb=c);break}}return d}function Cd(a,b,c,d){if(!d)return b+c;do b+=c;while(0<b&&Jb(a.text.charAt(b)));return b}function jd(a,b,c,d){var f=qa(a);if(!f)return Me(a,b,c,d);var g=hc(f,b),h=f[g];for(b=Cd(a,b,h.level%2?-c:c,d);;){if(b>h.from&&b<h.to)return b;if(b==h.from||b==h.to){if(hc(f,b)==g)return b;h=f[g+c];return 0<c==h.level%2?h.to:h.from}h=f[g+=c];if(!h)return null;b=0<c==h.level%2?Cd(a,h.to,-1,
d):Cd(a,h.from,1,d)}}function Me(a,b,c,d){b+=c;if(d)for(;0<b&&Jb(a.text.charAt(b));)b+=c;return 0>b||b>a.text.length?null:b}var Na=/gecko\/\d/i.test(navigator.userAgent),kf=/MSIE \d/.test(navigator.userAgent),lf=/Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent),M=kf||lf,V=M&&(kf?document.documentMode||6:lf[1]),Z=/WebKit\//.test(navigator.userAgent),gg=Z&&/Qt\/\d+\.\d+/.test(navigator.userAgent),hg=/Chrome\//.test(navigator.userAgent),ta=/Opera\//.test(navigator.userAgent),re=/Apple Computer/.test(navigator.vendor),
ig=/Mac OS X 1\d\D([8-9]|\d\d)\D/.test(navigator.userAgent),Df=/PhantomJS/.test(navigator.userAgent),hb=/AppleWebKit/.test(navigator.userAgent)&&/Mobile\/\w+/.test(navigator.userAgent),tb=hb||/Android|webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(navigator.userAgent),pa=hb||/Mac/.test(navigator.platform),jg=/win/i.test(navigator.platform),$a=ta&&navigator.userAgent.match(/Version\/(\d*\.\d*)/);$a&&($a=Number($a[1]));$a&&15<=$a&&(ta=!1,Z=!0);var mf=pa&&(gg||ta&&(null==$a||12.11>$a)),ld=Na||
M&&9<=V,Ee=!1,Ja=!1;q.prototype=oa({update:function(a){var b=a.scrollWidth>a.clientWidth+1,c=a.scrollHeight>a.clientHeight+1,d=a.nativeBarWidth;c?(this.vert.style.display="block",this.vert.style.bottom=b?d+"px":"0",this.vert.firstChild.style.height=Math.max(0,a.scrollHeight-a.clientHeight+(a.viewHeight-(b?d:0)))+"px"):(this.vert.style.display="",this.vert.firstChild.style.height="0");b?(this.horiz.style.display="block",this.horiz.style.right=c?d+"px":"0",this.horiz.style.left=a.barLeft+"px",this.horiz.firstChild.style.width=
a.scrollWidth-a.clientWidth+(a.viewWidth-a.barLeft-(c?d:0))+"px"):(this.horiz.style.display="",this.horiz.firstChild.style.width="0");!this.checkedOverlay&&0<a.clientHeight&&(0==d&&this.overlayHack(),this.checkedOverlay=!0);return{right:c?d:0,bottom:b?d:0}},setScrollLeft:function(a){this.horiz.scrollLeft!=a&&(this.horiz.scrollLeft=a)},setScrollTop:function(a){this.vert.scrollTop!=a&&(this.vert.scrollTop=a)},overlayHack:function(){this.horiz.style.minHeight=this.vert.style.minWidth=pa&&!ig?"12px":
"18px";var a=this,b=function(b){(b.target||b.srcElement)!=a.vert&&(b.target||b.srcElement)!=a.horiz&&W(a.cm,ne)(b)};E(this.vert,"mousedown",b);E(this.horiz,"mousedown",b)},clear:function(){var a=this.horiz.parentNode;a.removeChild(this.horiz);a.removeChild(this.vert)}},q.prototype);r.prototype=oa({update:function(){return{bottom:0,right:0}},setScrollLeft:function(){},setScrollTop:function(){},clear:function(){}},r.prototype);c.scrollbarModel={"native":q,"null":r};X.prototype.signal=function(a,b){ma(a,
b)&&this.events.push(arguments)};X.prototype.finish=function(){for(var a=0;a<this.events.length;a++)Y.apply(null,this.events[a])};var z=c.Pos=function(a,b){if(!(this instanceof z))return new z(a,b);this.line=a;this.ch=b},J=c.cmpPos=function(a,b){return a.line-b.line||a.ch-b.ch},la=null;Wc.prototype=oa({init:function(a){function b(a){if(d.somethingSelected())la=d.getSelections(),c.inaccurateSelection&&(c.prevInput="",c.inaccurateSelection=!1,g.value=la.join("\n"),rb(g));else if(d.options.lineWiseCopyCut){var f=
Td(d);la=f.text;"cut"==a.type?d.setSelections(f.ranges,null,za):(c.prevInput="",g.value=f.text.join("\n"),rb(g))}else return;"cut"==a.type&&(d.state.cutIncoming=!0)}var c=this,d=this.cm,f=this.wrapper=Vd(),g=this.textarea=f.firstChild;a.wrapper.insertBefore(f,a.wrapper.firstChild);hb&&(g.style.width="0px");E(g,"input",function(){M&&9<=V&&c.hasSelection&&(c.hasSelection=null);c.poll()});E(g,"paste",function(a){if(Sd(a,d))return!0;d.state.pasteIncoming=!0;c.fastPoll()});E(g,"cut",b);E(g,"copy",b);E(a.scroller,
"paste",function(b){Ga(a,b)||(d.state.pasteIncoming=!0,c.focus())});E(a.lineSpace,"selectstart",function(b){Ga(a,b)||fa(b)});E(g,"compositionstart",function(){var a=d.getCursor("from");c.composing={start:a,range:d.markText(a,d.getCursor("to"),{className:"CodeMirror-composing"})}});E(g,"compositionend",function(){c.composing&&(c.poll(),c.composing.range.clear(),c.composing=null)})},prepareSelection:function(){var a=this.cm,b=a.display,c=a.doc,d=fe(a);if(a.options.moveInputWithCursor){var a=Ea(a,c.sel.primary().head,
...
f=d.doc;d.somethingSelected()?(this.prevInput="",b=f.sel.primary(),c=(b=Ae&&(100<b.to().line-b.from().line||1E3<(c=d.getSelection()).length))?"-":c||d.getSelection(),this.textarea.value=c,d.state.focused&&rb(this.textarea),M&&9<=V&&(this.hasSelection=c)):a||(this.prevInput=this.textarea.value="",M&&9<=V&&(this.hasSelection=null));this.inaccurateSelection=b}},getField:function(){return this.textarea},supportsTouch:function(){return!1},focus:function(){if("nocursor"!=this.cm.options.readOnly&&(!tb||
xa()!=this.textarea))try{this.textarea.focus()}catch(a){}},blur:function(){this.textarea.blur()},resetPosition:function(){this.wrapper.style.top=this.wrapper.style.left=0},receivedFocus:function(){this.slowPoll()},slowPoll:function(){var a=this;a.pollingFast||a.polling.set(this.cm.options.pollInterval,function(){a.poll();a.cm.state.focused&&a.slowPoll()})},fastPoll:function(){function a(){c.poll()||b?(c.pollingFast=!1,c.slowPoll()):(b=!0,c.polling.set(60,a))}var b=!1,c=this;c.pollingFast=!0;c.polling.set(20,
a)},poll:function(){var a=this.cm,b=this.textarea,c=this.prevInput;if(this.contextMenuPending||!a.state.focused||kg(b)&&!c&&!this.composing||ec(a)||a.options.disableInput||a.state.keySeq)return!1;var d=b.value;if(d==c&&!a.somethingSelected())return!1;if(M&&9<=V&&this.hasSelection===d||pa&&/[\uf700-\uf7ff]/.test(d))return a.display.input.reset(),!1;if(a.doc.sel==a.display.selForContextMenu){var f=d.charCodeAt(0);8203!=f||c||(c="\u200b");if(8666==f)return this.reset(),this.cm.execCommand("undo")}for(var g=
0,f=Math.min(c.length,d.length);g<f&&c.charCodeAt(g)==d.charCodeAt(g);)++g;var h=this;ja(a,function(){fc(a,d.slice(g),c.length-g,null,h.composing?"*compose":null);1E3<d.length||-1<d.indexOf("\n")?b.value=h.prevInput="":h.prevInput=d;h.composing&&(h.composing.range.clear(),h.composing.range=a.markText(h.composing.start,a.getCursor("to"),{className:"CodeMirror-composing"}))});return!0},ensurePolled:function(){this.pollingFast&&this.poll()&&(this.pollingFast=!1)},onKeyPress:function(){M&&9<=V&&(this.hasSelection=
null);this.fastPoll()},onContextMenu:function(a){function b(){if(null!=h.selectionStart){var a=f.somethingSelected(),c="\u200b"+(a?h.value:"");h.value="\u21da";h.value=c;d.prevInput=a?"":"\u200b";h.selectionStart=1;h.selectionEnd=c.length;g.selForContextMenu=f.doc.sel}}function c(){d.contextMenuPending=!1;d.wrapper.style.position="relative";h.style.cssText=q;M&&9>V&&g.scrollbars.setScrollTop(g.scroller.scrollTop=p);if(null!=h.selectionStart){(!M||M&&9>V)&&b();var a=0,H=function(){g.selForContextMenu==
f.doc.sel&&0==h.selectionStart&&0<h.selectionEnd&&"\u200b"==d.prevInput?W(f,zc.selectAll)(f):10>a++?g.detectingSelectAll=setTimeout(H,500):g.input.reset()};g.detectingSelectAll=setTimeout(H,200)}}var d=this,f=d.cm,g=f.display,h=d.textarea,m=lb(f,a),p=g.scroller.scrollTop;if(m&&!ta){f.options.resetSelectionOnContextMenu&&-1==f.doc.sel.contains(m)&&W(f,aa)(f.doc,ya(m),za);var q=h.style.cssText;d.wrapper.style.position="absolute";h.style.cssText="position: fixed; width: 30px; height: 30px; top: "+(a.clientY-
5)+"px; left: "+(a.clientX-5)+"px; z-index: 1000; background: "+(M?"rgba(255, 255, 255, .05)":"transparent")+"; outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);";if(Z)var r=window.scrollY;g.input.focus();Z&&window.scrollTo(null,r);g.input.reset();f.somethingSelected()||(h.value=d.prevInput=" ");d.contextMenuPending=!0;g.selForContextMenu=f.doc.sel;clearTimeout(g.detectingSelectAll);M&&9<=V&&b();if(ld){md(a);var s=function(){Ca(window,"mouseup",
s);setTimeout(c,20)};E(window,"mouseup",s)}else setTimeout(c,50)}},setUneditable:Tb,needsContentAttribute:!1},Wc.prototype);Xc.prototype=oa({init:function(a){function b(a){if(d.somethingSelected())la=d.getSelections(),"cut"==a.type&&d.replaceSelection("",null,"cut");else if(d.options.lineWiseCopyCut){var c=Td(d);la=c.text;"cut"==a.type&&d.operation(function(){d.setSelections(c.ranges,0,za);d.replaceSelection("",null,"cut")})}else return;if(a.clipboardData&&!hb)a.preventDefault(),a.clipboardData.clearData(),
a.clipboardData.setData("text/plain",la.join("\n"));else{var f=Vd();a=f.firstChild;d.display.lineSpace.insertBefore(f,d.display.lineSpace.firstChild);a.value=la.join("\n");var g=document.activeElement;rb(a);setTimeout(function(){d.display.lineSpace.removeChild(f);g.focus()},50)}}var c=this,d=c.cm;a=c.div=a.lineDiv;a.contentEditable="true";Ud(a);E(a,"paste",function(a){Sd(a,d)});E(a,"compositionstart",function(a){a=a.data;c.composing={sel:d.doc.sel,data:a,startData:a};if(a){var b=d.doc.sel.primary(),
f=d.getLine(b.head.line).indexOf(a,Math.max(0,b.head.ch-a.length));-1<f&&f<=b.head.ch&&(c.composing.sel=ya(z(b.head.line,f),z(b.head.line,f+a.length)))}});E(a,"compositionupdate",function(a){c.composing.data=a.data});E(a,"compositionend",function(a){var b=c.composing;b&&(a.data==b.startData||/\u200b/.test(a.data)||(b.data=a.data),setTimeout(function(){b.handled||c.applyComposition(b);c.composing==b&&(c.composing=null)},50))});E(a,"touchstart",function(){c.forceCompositionEnd()});E(a,"input",function(){c.composing||
c.pollContent()||ja(c.cm,function(){ia(d)})});E(a,"copy",b);E(a,"cut",b)},prepareSelection:function(){var a=fe(this.cm,!1);a.focus=this.cm.state.focused;return a},showSelection:function(a){a&&this.cm.display.view.length&&(a.focus&&this.showPrimarySelection(),this.showMultipleSelections(a))},showPrimarySelection:function(){var a=window.getSelection(),b=this.cm.doc.sel.primary(),c=ic(this.cm,a.anchorNode,a.anchorOffset),d=ic(this.cm,a.focusNode,a.focusOffset);if(!c||c.bad||!d||d.bad||0!=J(dc(c,d),b.from())||
0!=J(cc(c,d),b.to()))if(c=Wd(this.cm,b.from()),d=Wd(this.cm,b.to()),c||d){var f=this.cm.display.view,b=a.rangeCount&&a.getRangeAt(0);c?d||(d=f[f.length-1].measure,d=d.maps?d.maps[d.maps.length-1]:d.map,d={node:d[d.length-1],offset:d[d.length-2]-d[d.length-3]}):c={node:f[0].measure.map[2],offset:0};try{var g=Va(c.node,c.offset,d.offset,d.node)}catch(h){}g&&(a.removeAllRanges(),a.addRange(g),b&&null==a.anchorNode?a.addRange(b):Na&&this.startGracePeriod());this.rememberSelection()}},startGracePeriod:function(){var a=
...
!0});this.polling.set(this.cm.options.pollInterval,a)},selectionChanged:function(){var a=window.getSelection();return a.anchorNode!=this.lastAnchorNode||a.anchorOffset!=this.lastAnchorOffset||a.focusNode!=this.lastFocusNode||a.focusOffset!=this.lastFocusOffset},pollSelection:function(){if(!this.composing&&!this.gracePeriod&&this.selectionChanged()){var a=window.getSelection(),b=this.cm;this.rememberSelection();var c=ic(b,a.anchorNode,a.anchorOffset),d=ic(b,a.focusNode,a.focusOffset);c&&d&&ja(b,function(){aa(b.doc,
ya(c,d),za);if(c.bad||d.bad)b.curOp.selectionChanged=!0})}},pollContent:function(){var a=this.cm,b=a.display,c=a.doc.sel.primary(),d=c.from(),c=c.to();if(d.line<b.viewFrom||c.line>b.viewTo-1)return!1;var f;d.line==b.viewFrom||0==(f=Ta(a,d.line))?(d=R(b.view[0].line),f=b.view[0].node):(d=R(b.view[f].line),f=b.view[f-1].node.nextSibling);var g=Ta(a,c.line);g==b.view.length-1?(c=b.viewTo-1,b=b.lineDiv.lastChild):(c=R(b.view[g+1].line)-1,b=b.view[g+1].node.previousSibling);b=a.doc.splitLines(uf(a,f,b,
d,c));for(f=Ua(a.doc,z(d,0),z(c,B(a.doc,c).text.length));1<b.length&&1<f.length;)if(P(b)==P(f))b.pop(),f.pop(),c--;else if(b[0]==f[0])b.shift(),f.shift(),d++;else break;for(var h=0,g=0,m=b[0],p=f[0],q=Math.min(m.length,p.length);h<q&&m.charCodeAt(h)==p.charCodeAt(h);)++h;m=P(b);p=P(f);for(q=Math.min(m.length-(1==b.length?h:0),p.length-(1==f.length?h:0));g<q&&m.charCodeAt(m.length-g-1)==p.charCodeAt(p.length-g-1);)++g;b[b.length-1]=m.slice(0,m.length-g);b[0]=b[0].slice(h);d=z(d,h);c=z(c,f.length?P(f).length-
g:0);if(1<b.length||b[0]||J(d,c))return mb(a.doc,b,d,c,"+input"),!0},ensurePolled:function(){this.forceCompositionEnd()},reset:function(){this.forceCompositionEnd()},forceCompositionEnd:function(){this.composing&&!this.composing.handled&&(this.applyComposition(this.composing),this.composing.handled=!0,this.div.blur(),this.div.focus())},applyComposition:function(a){a.data&&a.data!=a.startData&&W(this.cm,fc)(this.cm,a.data,0,a.sel)},setUneditable:function(a){a.setAttribute("contenteditable","false")},
onKeyPress:function(a){a.preventDefault();W(this.cm,fc)(this.cm,String.fromCharCode(null==a.charCode?a.keyCode:a.charCode),0)},onContextMenu:Tb,resetPosition:Tb,needsContentAttribute:!0},Xc.prototype);c.inputStyles={textarea:Wc,contenteditable:Xc};Da.prototype={primary:function(){return this.ranges[this.primIndex]},equals:function(a){if(a==this)return!0;if(a.primIndex!=this.primIndex||a.ranges.length!=this.ranges.length)return!1;for(var b=0;b<this.ranges.length;b++){var c=this.ranges[b],d=a.ranges[b];
if(0!=J(c.anchor,d.anchor)||0!=J(c.head,d.head))return!1}return!0},deepCopy:function(){for(var a=[],b=0;b<this.ranges.length;b++)a[b]=new U(Vc(this.ranges[b].anchor),Vc(this.ranges[b].head));return new Da(a,this.primIndex)},somethingSelected:function(){for(var a=0;a<this.ranges.length;a++)if(!this.ranges[a].empty())return!0;return!1},contains:function(a,b){b||(b=a);for(var c=0;c<this.ranges.length;c++){var d=this.ranges[c];if(0<=J(b,d.from())&&0>=J(a,d.to()))return c}return-1}};U.prototype={from:function(){return dc(this.anchor,
this.head)},to:function(){return cc(this.anchor,this.head)},empty:function(){return this.head.line==this.anchor.line&&this.head.ch==this.anchor.ch}};var dd={left:0,right:0,top:0,bottom:0},Wa,kb=null,Cf=0,wc,vc,qe=0,xc=0,ka=null;M?ka=-.53:Na?ka=15:hg?ka=-.7:re&&(ka=-1/3);var xe=function(a){var b=a.wheelDeltaX,c=a.wheelDeltaY;null==b&&a.detail&&a.axis==a.HORIZONTAL_AXIS&&(b=a.detail);null==c&&a.detail&&a.axis==a.VERTICAL_AXIS?c=a.detail:null==c&&(c=a.wheelDelta);return{x:b,y:c}};c.wheelEventPixels=
function(a){a=xe(a);a.x*=ka;a.y*=ka;return a};var Nf=new ub,pd=null,Xa=c.changeEnd=function(a){return a.text?z(a.from.line+a.text.length-1,P(a.text).length+(1==a.text.length?a.from.ch:0)):a.to};c.prototype={constructor:c,focus:function(){window.focus();this.display.input.focus()},setOption:function(a,b){var c=this.options,d=c[a];if(c[a]!=b||"mode"==a)c[a]=b,bb.hasOwnProperty(a)&&W(this,bb[a])(this,b,d)},getOption:function(a){return this.options[a]},getDoc:function(){return this.doc},addKeyMap:function(a,
...
a||"string"==typeof a&&d.name==a){b.splice(c,1);this.state.modeGen++;ia(this);break}}}),indentLine:ba(function(a,b,c){"string"!=typeof b&&"number"!=typeof b&&(b=null==b?this.options.smartIndent?"smart":"prev":b?"add":"subtract");Gb(this.doc,a)&&Fb(this,a,b,c)}),indentSelection:ba(function(a){for(var b=this.doc.sel.ranges,c=-1,d=0;d<b.length;d++){var f=b[d];if(f.empty())f.head.line>c&&(Fb(this,f.head.line,a,!0),c=f.head.line,d==this.doc.sel.primIndex&&gb(this));else{for(var g=f.from(),f=f.to(),h=Math.max(c,
g.line),c=Math.min(this.lastLine(),f.line-(f.ch?0:1))+1,f=h;f<c;++f)Fb(this,f,a);f=this.doc.sel.ranges;0==g.ch&&b.length==f.length&&0<f[d].from().ch&&$c(this.doc,d,new U(g,f[d].to()),za)}}}),getTokenAt:function(a,b){return We(this,a,b)},getLineTokens:function(a,b){return We(this,z(a),b,!0)},getTokenTypeAt:function(a){a=I(this.doc,a);var b=Ye(this,B(this.doc,a.line)),c=0,d=(b.length-1)/2;a=a.ch;var f;if(0==a)f=b[2];else for(;;){var g=c+d>>1;if((g?b[2*g-1]:0)>=a)d=g;else if(b[2*g+1]<a)c=g+1;else{f=
b[2*g+2];break}}b=f?f.indexOf("cm-overlay "):-1;return 0>b?f:0==b?null:f.slice(0,b-1)},getModeAt:function(a){var b=this.doc.mode;return b.innerMode?c.innerMode(b,this.getTokenAt(a).state).mode:b},getHelper:function(a,b){return this.getHelpers(a,b)[0]},getHelpers:function(a,b){var c=[];if(!sb.hasOwnProperty(b))return c;var d=sb[b],f=this.getModeAt(a);if("string"==typeof f[b])d[f[b]]&&c.push(d[f[b]]);else if(f[b])for(var g=0;g<f[b].length;g++){var h=d[f[b][g]];h&&c.push(h)}else f.helperType&&d[f.helperType]?
c.push(d[f.helperType]):d[f.name]&&c.push(d[f.name]);for(g=0;g<d._global.length;g++)h=d._global[g],h.pred(f,this)&&-1==ca(c,h.val)&&c.push(h.val);return c},getStateAfter:function(a,b){var c=this.doc;a=Math.max(c.first,Math.min(null==a?c.first+c.size-1:a,c.first+c.size-1));return Ib(this,a+1,b)},cursorCoords:function(a,b){var c;c=this.doc.sel.primary();c=null==a?c.head:"object"==typeof a?I(this.doc,a):a?c.from():c.to();return Ea(this,c,b||"page")},charCoords:function(a,b){return oc(this,I(this.doc,
a),b||"page")},coordsChar:function(a,b){a=le(this,a,b||"page");return id(this,a.left,a.top)},lineAtHeight:function(a,b){a=le(this,{top:a,left:0},b||"page").top;return Sa(this.doc,a+this.display.viewOffset)},heightAtLine:function(a,b){var c=!1,d;"number"==typeof a?(d=this.doc.first+this.doc.size-1,a<this.doc.first?a=this.doc.first:a>d&&(a=d,c=!0),d=B(this.doc,a)):d=a;return fd(this,d,{top:0,left:0},b||"page").top+(c?this.doc.height-wa(d):0)},defaultTextHeight:function(){return Oa(this.display)},defaultCharWidth:function(){return yb(this.display)},
setGutterMarker:ba(function(a,b,c){return Ec(this.doc,a,"gutter",function(a){var d=a.gutterMarkers||(a.gutterMarkers={});d[b]=c;!c&&ff(d)&&(a.gutterMarkers=null);return!0})}),clearGutter:ba(function(a){var b=this,c=b.doc,d=c.first;c.iter(function(c){c.gutterMarkers&&c.gutterMarkers[a]&&(c.gutterMarkers[a]=null,Fa(b,d,"gutter"),ff(c.gutterMarkers)&&(c.gutterMarkers=null));++d})}),lineInfo:function(a){if("number"==typeof a){if(!Gb(this.doc,a))return null;var b=a;a=B(this.doc,a);if(!a)return null}else if(b=
R(a),null==b)return null;return{line:b,handle:a,text:a.text,gutterMarkers:a.gutterMarkers,textClass:a.textClass,bgClass:a.bgClass,wrapClass:a.wrapClass,widgets:a.widgets}},getViewport:function(){return{from:this.display.viewFrom,to:this.display.viewTo}},addWidget:function(a,b,c,d,f){var g=this.display;a=Ea(this,I(this.doc,a));var h=a.bottom,m=a.left;b.style.position="absolute";b.setAttribute("cm-ignore-events","true");this.display.input.setUneditable(b);g.sizer.appendChild(b);if("over"==d)h=a.top;
...
m+"px");c&&(a=tc(this,m,h,m+b.offsetWidth,h+b.offsetHeight),null!=a.scrollTop&&Bb(this,a.scrollTop),null!=a.scrollLeft&&db(this,a.scrollLeft))},triggerOnKeyDown:ba(te),triggerOnKeyPress:ba(ue),triggerOnKeyUp:se,execCommand:function(a){if(zc.hasOwnProperty(a))return zc[a].call(null,this)},triggerElectric:ba(function(a){Rd(this,a)}),findPosH:function(a,b,c,d){var f=1;0>b&&(f=-1,b=-b);var g=0;for(a=I(this.doc,a);g<b&&(a=ud(this.doc,a,f,c,d),!a.hitSide);++g);return a},moveH:ba(function(a,b){var c=this;
c.extendSelectionsBy(function(d){return c.display.shift||c.doc.extend||d.empty()?ud(c.doc,d.head,a,b,c.options.rtlMoveVisually):0>a?d.from():d.to()},Vb)}),deleteH:ba(function(a,b){var c=this.doc;this.doc.sel.somethingSelected()?c.replaceSelection("",null,"+delete"):nb(this,function(d){var f=ud(c,d.head,a,b,!1);return 0>a?{from:f,to:d.head}:{from:d.head,to:f}})}),findPosV:function(a,b,c,d){var f=1;0>b&&(f=-1,b=-b);var g=0;for(a=I(this.doc,a);g<b&&(a=Ea(this,a,"div"),null==d?d=a.left:a.left=d,a=Ne(this,
a,f,c),!a.hitSide);++g);return a},moveV:ba(function(a,b){var c=this,d=this.doc,f=[],g=!c.display.shift&&!d.extend&&d.sel.somethingSelected();d.extendSelectionsBy(function(h){if(g)return 0>a?h.from():h.to();var m=Ea(c,h.head,"div");null!=h.goalColumn&&(m.left=h.goalColumn);f.push(m.left);var p=Ne(c,m,a,b);"page"==b&&h==d.sel.primary()&&Cc(c,null,oc(c,p,"div").top-m.top);return p},Vb);if(f.length)for(var h=0;h<d.sel.ranges.length;h++)d.sel.ranges[h].goalColumn=f[h]}),findWordAt:function(a){var b=B(this.doc,
a.line).text,c=a.ch,d=a.ch;if(b){var f=this.getHelper(a,"wordChars");(0>a.xRel||d==b.length)&&c?--c:++d;for(var g=b.charAt(c),g=Fc(g,f)?function(a){return Fc(a,f)}:/\s/.test(g)?function(a){return/\s/.test(a)}:function(a){return!/\s/.test(a)&&!Fc(a)};0<c&&g(b.charAt(c-1));)--c;for(;d<b.length&&g(b.charAt(d));)++d}return new U(z(a.line,c),z(a.line,d))},toggleOverwrite:function(a){if(null==a||a!=this.state.overwrite)(this.state.overwrite=!this.state.overwrite)?Cb(this.display.cursorDiv,"CodeMirror-overwrite"):
Ab(this.display.cursorDiv,"CodeMirror-overwrite"),Y(this,"overwriteToggle",this,this.state.overwrite)},hasFocus:function(){return this.display.input.getField()==xa()},scrollTo:ba(function(a,b){null==a&&null==b||Dc(this);null!=a&&(this.curOp.scrollLeft=a);null!=b&&(this.curOp.scrollTop=b)}),getScrollInfo:function(){var a=this.display.scroller;return{left:a.scrollLeft,top:a.scrollTop,height:a.scrollHeight-va(this)-this.display.barHeight,width:a.scrollWidth-va(this)-this.display.barWidth,clientHeight:Sc(this),
clientWidth:Ha(this)}},scrollIntoView:ba(function(a,b){null==a?(a={from:this.doc.sel.primary().head,to:null},null==b&&(b=this.options.cursorScrollMargin)):"number"==typeof a?a={from:z(a,0),to:null}:null==a.from&&(a={from:a,to:null});a.to||(a.to=a.from);a.margin=b||0;if(null!=a.from.line)Dc(this),this.curOp.scrollToPos=a;else{var c=tc(this,Math.min(a.from.left,a.to.left),Math.min(a.from.top,a.to.top)-a.margin,Math.max(a.from.right,a.to.right),Math.max(a.from.bottom,a.to.bottom)+a.margin);this.scrollTo(c.scrollLeft,
c.scrollTop)}}),setSize:ba(function(a,b){function c(a){return"number"==typeof a||/^\d+$/.test(String(a))?a+"px":a}var d=this;null!=a&&(d.display.wrapper.style.width=c(a));null!=b&&(d.display.wrapper.style.height=c(b));d.options.lineWrapping&&ke(this);var f=d.display.viewFrom;d.doc.iter(f,d.display.viewTo,function(a){if(a.widgets)for(var b=0;b<a.widgets.length;b++)if(a.widgets[b].noHScroll){Fa(d,f,"widget");break}++f});d.curOp.forceUpdate=!0;Y(d,"refresh",this)}),operation:function(a){return ja(this,
a)},refresh:ba(function(){var a=this.display.cachedTextHeight;ia(this);this.curOp.forceUpdate=!0;zb(this);this.scrollTo(this.doc.scrollLeft,this.doc.scrollTop);s(this);(null==a||.5<Math.abs(a-Oa(this.display)))&&g(this);Y(this,"refresh",this)}),swapDoc:ba(function(a){var b=this.doc;b.cm=null;Ed(this,a);zb(this);this.display.input.reset();this.scrollTo(a.scrollLeft,a.scrollTop);this.curOp.forceScroll=!0;da(this,"swapDoc",this,b);return b}),getInputField:function(){return this.display.input.getField()},
getWrapperElement:function(){return this.display.wrapper},getScrollerElement:function(){return this.display.scroller},getGutterElement:function(){return this.display.gutters}};qb(c);var of=c.defaults={},bb=c.optionHandlers={},Fd=c.Init={toString:function(){return"CodeMirror.Init"}};F("value","",function(a,b){a.setValue(b)},!0);F("mode",null,function(a,c){a.doc.modeOption=c;b(a)},!0);F("indentUnit",2,b,!0);F("indentWithTabs",!1);F("smartIndent",!0);F("tabSize",4,function(a){d(a);zb(a);ia(a)},!0);F("lineSeparator",
null,function(a,b){if(a.doc.lineSep=b){var c=[],d=a.doc.first;a.doc.iter(function(a){for(var f=0;;){var g=a.text.indexOf(b,f);if(-1==g)break;f=g+b.length;c.push(z(d,g))}d++});for(var f=c.length-1;0<=f;f--)mb(a.doc,b,c[f],z(c[f].line,c[f].ch+b.length))}});F("specialChars",/[\t\u0000-\u0019\u00ad\u200b-\u200f\u2028\u2029\ufeff]/g,function(a,b,d){a.state.specialChars=new RegExp(b.source+(b.test("\t")?"":"|\t"),"g");d!=c.Init&&a.refresh()});F("specialCharPlaceholder",function(a){var b=C("span","\u2022",
"cm-invalidchar");b.title="\\u"+a.charCodeAt(0).toString(16);b.setAttribute("aria-label",b.title);return b},function(a){a.refresh()},!0);F("electricChars",!0);F("inputStyle",tb?"contenteditable":"textarea",function(){throw Error("inputStyle can not (yet) be changed in a running editor");},!0);F("rtlMoveVisually",!jg);F("wholeLineUpdateBefore",!0);F("theme","default",function(a){h(a);m(a)},!0);F("keyMap","default",function(a,b,d){b=Gc(b);(d=d!=c.Init&&Gc(d))&&d.detach&&d.detach(a,b);b.attach&&b.attach(a,
d||null)});F("extraKeys",null);F("lineWrapping",!1,function(a){a.options.lineWrapping?(Cb(a.display.wrapper,"CodeMirror-wrap"),a.display.sizer.style.minWidth="",a.display.sizerWidth=null):(Ab(a.display.wrapper,"CodeMirror-wrap"),x(a));g(a);ia(a);zb(a);setTimeout(function(){A(a)},100)},!0);F("gutters",[],function(a){t(a.options);m(a)},!0);F("fixedGutter",!0,function(a,b){a.display.gutters.style.left=b?N(a.display)+"px":"0";a.refresh()},!0);F("coverGutterNextToScrollbar",!1,function(a){A(a)},!0);F("scrollbarStyle",
"native",function(a){u(a);A(a);a.display.scrollbars.setScrollTop(a.doc.scrollTop);a.display.scrollbars.setScrollLeft(a.doc.scrollLeft)},!0);F("lineNumbers",!1,function(a){t(a.options);m(a)},!0);F("firstLineNumber",1,m,!0);F("lineNumberFormatter",function(a){return a},m,!0);F("showCursorWhenSelecting",!1,Db,!0);F("resetSelectionOnContextMenu",!0);F("lineWiseCopyCut",!0);F("readOnly",!1,function(a,b){"nocursor"==b?(wb(a),a.display.input.blur(),a.display.disabled=!0):(a.display.disabled=!1,b||a.display.input.reset())});
F("disableInput",!1,function(a,b){b||a.display.input.reset()},!0);F("dragDrop",!0,function(a,b,d){!b!=!(d&&d!=c.Init)&&(d=a.display.dragFunctions,b=b?E:Ca,b(a.display.scroller,"dragstart",d.start),b(a.display.scroller,"dragenter",d.simple),b(a.display.scroller,"dragover",d.simple),b(a.display.scroller,"drop",d.drop))});F("cursorBlinkRate",530);F("cursorScrollMargin",0);F("cursorHeight",1,Db,!0);F("singleCursorHeightPerLine",!0,Db,!0);F("workTime",100);F("workDelay",100);F("flattenSpans",!0,d,!0);
F("addModeClass",!1,d,!0);F("pollInterval",100);F("undoDepth",200,function(a,b){a.doc.history.undoDepth=b});F("historyEventDelay",1250);F("viewportMargin",10,function(a){a.refresh()},!0);F("maxHighlightLength",1E4,d,!0);F("moveInputWithCursor",!0,function(a,b){b||a.display.input.resetPosition()});F("tabindex",null,function(a,b){a.display.input.getField().tabIndex=b||""});F("autofocus",null);var nf=c.modes={},Wb=c.mimeModes={};c.defineMode=function(a,b){c.defaults.mode||"null"==a||(c.defaults.mode=
a);2<arguments.length&&(b.dependencies=Array.prototype.slice.call(arguments,2));nf[a]=b};c.defineMIME=function(a,b){Wb[a]=b};c.resolveMode=function(a){if("string"==typeof a&&Wb.hasOwnProperty(a))a=Wb[a];else if(a&&"string"==typeof a.name&&Wb.hasOwnProperty(a.name)){var b=Wb[a.name];"string"==typeof b&&(b={name:b});a=df(b,a);a.name=b.name}else if("string"==typeof a&&/^[\w\-]+\/[\w\-]+\+xml$/.test(a))return c.resolveMode("application/xml");return"string"==typeof a?{name:a}:a||{name:"null"}};c.getMode=
function(a,b){b=c.resolveMode(b);var d=nf[b.name];if(!d)return c.getMode(a,"text/plain");d=d(a,b);if(Xb.hasOwnProperty(b.name)){var f=Xb[b.name],g;for(g in f)f.hasOwnProperty(g)&&(d.hasOwnProperty(g)&&(d["_"+g]=d[g]),d[g]=f[g])}d.name=b.name;b.helperType&&(d.helperType=b.helperType);if(b.modeProps)for(g in b.modeProps)d[g]=b.modeProps[g];return d};c.defineMode("null",function(){return{token:function(a){a.skipToEnd()}}});c.defineMIME("text/plain","null");var Xb=c.modeExtensions={};c.extendMode=function(a,
b){var c=Xb.hasOwnProperty(a)?Xb[a]:Xb[a]={};oa(b,c)};c.defineExtension=function(a,b){c.prototype[a]=b};c.defineDocExtension=function(a,b){ha.prototype[a]=b};c.defineOption=F;var Oc=[];c.defineInitHook=function(a){Oc.push(a)};var sb=c.helpers={};c.registerHelper=function(a,b,d){sb.hasOwnProperty(a)||(sb[a]=c[a]={_global:[]});sb[a][b]=d};c.registerGlobalHelper=function(a,b,d,f){c.registerHelper(a,b,f);sb[a]._global.push({pred:d,val:f})};var jb=c.copyState=function(a,b){if(!0===b)return b;if(a.copyState)return a.copyState(b);
var c={},d;for(d in b){var f=b[d];f instanceof Array&&(f=f.concat([]));c[d]=f}return c},Af=c.startState=function(a,b,c){return a.startState?a.startState(b,c):!0};c.innerMode=function(a,b){for(;a.innerMode;){var c=a.innerMode(b);if(!c||c.mode==a)break;b=c.state;a=c.mode}return c||{mode:a,state:b}};var zc=c.commands={selectAll:function(a){a.setSelection(z(a.firstLine(),0),z(a.lastLine()),za)},singleSelection:function(a){a.setSelection(a.getCursor("anchor"),a.getCursor("head"),za)},killLine:function(a){nb(a,
function(b){if(b.empty()){var c=B(a.doc,b.head.line).text.length;return b.head.ch==c&&b.head.line<a.lastLine()?{from:b.head,to:z(b.head.line+1,0)}:{from:b.head,to:z(b.head.line,c)}}return{from:b.from(),to:b.to()}})},deleteLine:function(a){nb(a,function(b){return{from:z(b.from().line,0),to:I(a.doc,z(b.to().line+1,0))}})},delLineLeft:function(a){nb(a,function(a){return{from:z(a.from().line,0),to:a.from()}})},delWrappedLineLeft:function(a){nb(a,function(b){var c=a.charCoords(b.head,"div").top+5;return{from:a.coordsChar({left:0,
top:c},"div"),to:b.from()}})},delWrappedLineRight:function(a){nb(a,function(b){var c=a.charCoords(b.head,"div").top+5,c=a.coordsChar({left:a.display.lineDiv.offsetWidth+100,top:c},"div");return{from:b.from(),to:c}})},undo:function(a){a.undo()},redo:function(a){a.redo()},undoSelection:function(a){a.undoSelection()},redoSelection:function(a){a.redoSelection()},goDocStart:function(a){a.extendSelection(z(a.firstLine(),0))},goDocEnd:function(a){a.extendSelection(z(a.lastLine()))},goLineStart:function(a){a.extendSelectionsBy(function(b){return hf(a,
b.head.line)},{origin:"+move",bias:1})},goLineStartSmart:function(a){a.extendSelectionsBy(function(b){return jf(a,b.head)},{origin:"+move",bias:1})},goLineEnd:function(a){a.extendSelectionsBy(function(b){b=b.head.line;for(var c,d=B(a.doc,b);c=Ra(d,!1);)d=c.find(1,!0).line,b=null;c=(c=qa(d))?c[0].level%2?rc(d):sc(d):d.text.length;return z(null==b?R(d):b,c)},{origin:"+move",bias:-1})},goLineRight:function(a){a.extendSelectionsBy(function(b){b=a.charCoords(b.head,"div").top+5;return a.coordsChar({left:a.display.lineDiv.offsetWidth+
100,top:b},"div")},Vb)},goLineLeft:function(a){a.extendSelectionsBy(function(b){b=a.charCoords(b.head,"div").top+5;return a.coordsChar({left:0,top:b},"div")},Vb)},goLineLeftSmart:function(a){a.extendSelectionsBy(function(b){var c=a.charCoords(b.head,"div").top+5,c=a.coordsChar({left:0,top:c},"div");return c.ch<a.getLine(c.line).search(/\S/)?jf(a,b.head):c},Vb)},goLineUp:function(a){a.moveV(-1,"line")},goLineDown:function(a){a.moveV(1,"line")},goPageUp:function(a){a.moveV(-1,"page")},goPageDown:function(a){a.moveV(1,
"page")},goCharLeft:function(a){a.moveH(-1,"char")},goCharRight:function(a){a.moveH(1,"char")},goColumnLeft:function(a){a.moveH(-1,"column")},goColumnRight:function(a){a.moveH(1,"column")},goWordLeft:function(a){a.moveH(-1,"word")},goGroupRight:function(a){a.moveH(1,"group")},goGroupLeft:function(a){a.moveH(-1,"group")},goWordRight:function(a){a.moveH(1,"word")},delCharBefore:function(a){a.deleteH(-1,"char")},delCharAfter:function(a){a.deleteH(1,"char")},delWordBefore:function(a){a.deleteH(-1,"word")},
delWordAfter:function(a){a.deleteH(1,"word")},delGroupBefore:function(a){a.deleteH(-1,"group")},delGroupAfter:function(a){a.deleteH(1,"group")},indentAuto:function(a){a.indentSelection("smart")},indentMore:function(a){a.indentSelection("add")},indentLess:function(a){a.indentSelection("subtract")},insertTab:function(a){a.replaceSelection("\t")},insertSoftTab:function(a){for(var b=[],c=a.listSelections(),d=a.options.tabSize,f=0;f<c.length;f++){var g=c[f].from(),g=sa(a.getLine(g.line),g.ch,d);b.push(Array(d-
...
"Ctrl-Right":"goGroupRight","Alt-Left":"goLineStart","Alt-Right":"goLineEnd","Ctrl-Backspace":"delGroupBefore","Ctrl-Delete":"delGroupAfter","Ctrl-S":"save","Ctrl-F":"find","Ctrl-G":"findNext","Shift-Ctrl-G":"findPrev","Shift-Ctrl-F":"replace","Shift-Ctrl-R":"replaceAll","Ctrl-[":"indentLess","Ctrl-]":"indentMore","Ctrl-U":"undoSelection","Shift-Ctrl-U":"redoSelection","Alt-U":"redoSelection",fallthrough:"basic"};La.emacsy={"Ctrl-F":"goCharRight","Ctrl-B":"goCharLeft","Ctrl-P":"goLineUp","Ctrl-N":"goLineDown",
"Alt-F":"goWordRight","Alt-B":"goWordLeft","Ctrl-A":"goLineStart","Ctrl-E":"goLineEnd","Ctrl-V":"goPageDown","Shift-Ctrl-V":"goPageUp","Ctrl-D":"delCharAfter","Ctrl-H":"delCharBefore","Alt-D":"delWordAfter","Alt-Backspace":"delWordBefore","Ctrl-K":"killLine","Ctrl-T":"transposeChars"};La.macDefault={"Cmd-A":"selectAll","Cmd-D":"deleteLine","Cmd-Z":"undo","Shift-Cmd-Z":"redo","Cmd-Y":"redo","Cmd-Home":"goDocStart","Cmd-Up":"goDocStart","Cmd-End":"goDocEnd","Cmd-Down":"goDocEnd","Alt-Left":"goGroupLeft",
...
fallthrough:["basic","emacsy"]};La["default"]=pa?La.macDefault:La.pcDefault;c.normalizeKeyMap=function(a){var b={},c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];if(!/^(name|fallthrough|(de|at)tach)$/.test(c)){if("..."!=d)for(var f=gc(c.split(" "),Tf),g=0;g<f.length;g++){var h,m;g==f.length-1?(m=f.join(" "),h=d):(m=f.slice(0,g+1).join(" "),h="...");var p=b[m];if(!p)b[m]=h;else if(p!=h)throw Error("Inconsistent bindings for "+m);}delete a[c]}}for(var q in b)a[q]=b[q];return a};var Mb=c.lookupKey=
function(a,b,c,d){b=Gc(b);var f=b.call?b.call(a,d):b[a];if(!1===f)return"nothing";if("..."===f)return"multi";if(null!=f&&c(f))return"handled";if(b.fallthrough){if("[object Array]"!=Object.prototype.toString.call(b.fallthrough))return Mb(a,b.fallthrough,c,d);for(f=0;f<b.fallthrough.length;f++){var g=Mb(a,b.fallthrough[f],c,d);if(g)return g}}},Mf=c.isModifierKey=function(a){a="string"==typeof a?a:Ma[a.keyCode];return"Ctrl"==a||"Alt"==a||"Shift"==a||"Mod"==a},Of=c.keyName=function(a,b){if(ta&&34==a.keyCode&&
a["char"])return!1;var c=Ma[a.keyCode],d=c;if(null==d||a.altGraphKey)return!1;a.altKey&&"Alt"!=c&&(d="Alt-"+d);(mf?a.metaKey:a.ctrlKey)&&"Ctrl"!=c&&(d="Ctrl-"+d);(mf?a.ctrlKey:a.metaKey)&&"Cmd"!=c&&(d="Cmd-"+d);!b&&a.shiftKey&&"Shift"!=c&&(d="Shift-"+d);return d};c.fromTextArea=function(a,b){function d(){a.value=q.getValue()}b=b?oa(b):{};b.value=a.value;!b.tabindex&&a.tabIndex&&(b.tabindex=a.tabIndex);!b.placeholder&&a.placeholder&&(b.placeholder=a.placeholder);if(null==b.autofocus){var f=xa();b.autofocus=
f==a||null!=a.getAttribute("autofocus")&&f==document.body}if(a.form&&(E(a.form,"submit",d),!b.leaveSubmitMethodAlone)){var g=a.form,h=g.submit;try{var m=g.submit=function(){d();g.submit=h;g.submit();g.submit=m}}catch(p){}}b.finishInit=function(b){b.save=d;b.getTextArea=function(){return a};b.toTextArea=function(){b.toTextArea=isNaN;d();a.parentNode.removeChild(b.getWrapperElement());a.style.display="";a.form&&(Ca(a.form,"submit",d),"function"==typeof a.form.submit&&(a.form.submit=h))}};a.style.display=
...
(this.lastColumnValue=sa(this.string,this.start,this.tabSize,this.lastColumnPos,this.lastColumnValue),this.lastColumnPos=this.start);return this.lastColumnValue-(this.lineStart?sa(this.string,this.lineStart,this.tabSize):0)},indentation:function(){return sa(this.string,null,this.tabSize)-(this.lineStart?sa(this.string,this.lineStart,this.tabSize):0)},match:function(a,b,c){if("string"==typeof a){var d=function(a){return c?a.toLowerCase():a},f=this.string.substr(this.pos,a.length);if(d(f)==d(a))return!1!==
b&&(this.pos+=a.length),!0}else{if((a=this.string.slice(this.pos).match(a))&&0<a.index)return null;a&&!1!==b&&(this.pos+=a[0].length);return a}},current:function(){return this.string.slice(this.start,this.pos)},hideFirstChars:function(a,b){this.lineStart+=a;try{return b()}finally{this.lineStart-=a}}};var vd=0,Za=c.TextMarker=function(a,b){this.lines=[];this.type=b;this.doc=a;this.id=++vd};qb(Za);Za.prototype.clear=function(){if(!this.explicitlyCleared){var a=this.doc.cm,b=a&&!a.curOp;b&&ab(a);if(ma(this,
"clear")){var c=this.find();c&&da(this,"clear",c.from,c.to)}for(var d=c=null,f=0;f<this.lines.length;++f){var g=this.lines[f],h=Ob(g.markedSpans,this);a&&!this.collapsed?Fa(a,R(g),"text"):a&&(null!=h.to&&(d=R(g)),null!=h.from&&(c=R(g)));for(var m=g,p=g.markedSpans,q=h,r=void 0,s=0;s<p.length;++s)p[s]!=q&&(r||(r=[])).push(p[s]);m.markedSpans=r;null==h.from&&this.collapsed&&!Pa(this.doc,g)&&a&&ua(g,Oa(a.display))}if(a&&this.collapsed&&!a.options.lineWrapping)for(f=0;f<this.lines.length;++f)g=Aa(this.lines[f]),
h=v(g),h>a.display.maxLineLength&&(a.display.maxLine=g,a.display.maxLineLength=h,a.display.maxLineChanged=!0);null!=c&&a&&this.collapsed&&ia(a,c,d+1);this.lines.length=0;this.explicitlyCleared=!0;this.atomic&&this.doc.cantEdit&&(this.doc.cantEdit=!1,a&&ee(a.doc));a&&da(a,"markerCleared",a,this);b&&cb(a);this.parent&&this.parent.clear()}};Za.prototype.find=function(a,b){null==a&&"bookmark"==this.type&&(a=1);for(var c,d,f=0;f<this.lines.length;++f){var g=this.lines[f],h=Ob(g.markedSpans,this);if(null!=
h.from&&(c=z(b?g:R(g),h.from),-1==a))return c;if(null!=h.to&&(d=z(b?g:R(g),h.to),1==a))return d}return c&&{from:c,to:d}};Za.prototype.changed=function(){var a=this.find(-1,!0),b=this,c=this.doc.cm;a&&c&&ja(c,function(){var d=a.line,f=R(a.line);if(f=Yc(c,f))je(f),c.curOp.selectionChanged=c.curOp.forceUpdate=!0;c.curOp.updateMaxLine=!0;Pa(b.doc,d)||null==b.height||(f=b.height,b.height=null,(f=Kb(b)-f)&&ua(d,d.height+f))})};Za.prototype.attachLine=function(a){if(!this.lines.length&&this.doc.cm){var b=
this.doc.cm.curOp;b.maybeHiddenMarkers&&-1!=ca(b.maybeHiddenMarkers,this)||(b.maybeUnhiddenMarkers||(b.maybeUnhiddenMarkers=[])).push(this)}this.lines.push(a)};Za.prototype.detachLine=function(a){this.lines.splice(ca(this.lines,a),1);!this.lines.length&&this.doc.cm&&(a=this.doc.cm.curOp,(a.maybeHiddenMarkers||(a.maybeHiddenMarkers=[])).push(this))};var vd=0,Ic=c.SharedTextMarker=function(a,b){this.markers=a;this.primary=b;for(var c=0;c<a.length;++c)a[c].parent=this};qb(Ic);Ic.prototype.clear=function(){if(!this.explicitlyCleared){this.explicitlyCleared=
!0;for(var a=0;a<this.markers.length;++a)this.markers[a].clear();da(this,"clear")}};Ic.prototype.find=function(a,b){return this.primary.find(a,b)};var Jc=c.LineWidget=function(a,b,c){if(c)for(var d in c)c.hasOwnProperty(d)&&(this[d]=c[d]);this.doc=a;this.node=b};qb(Jc);Jc.prototype.clear=function(){var a=this.doc.cm,b=this.line.widgets,c=this.line,d=R(c);if(null!=d&&b){for(var f=0;f<b.length;++f)b[f]==this&&b.splice(f--,1);b.length||(c.widgets=null);var g=Kb(this);ua(c,Math.max(0,c.height-g));a&&
ja(a,function(){var b=-g;wa(c)<(a.curOp&&a.curOp.scrollTop||a.doc.scrollTop)&&Cc(a,null,b);Fa(a,d,"widget")})}};Jc.prototype.changed=function(){var a=this.height,b=this.doc.cm,c=this.line;this.height=null;var d=Kb(this)-a;d&&(ua(c,c.height+d),b&&ja(b,function(){b.curOp.forceUpdate=!0;wa(c)<(b.curOp&&b.curOp.scrollTop||b.doc.scrollTop)&&Cc(b,null,d)}))};var Pb=c.Line=function(a,b,c){this.text=a;Se(this,b);this.height=c?c(this):1};qb(Pb);Pb.prototype.lineNo=function(){return R(this)};var Zf={},Yf={};
...
{chunkSize:function(){return this.size},removeInner:function(a,b){this.size-=b;for(var c=0;c<this.children.length;++c){var d=this.children[c],f=d.chunkSize();if(a<f){var g=Math.min(b,f-a),h=d.height;d.removeInner(a,g);this.height-=h-d.height;f==g&&(this.children.splice(c--,1),d.parent=null);if(0==(b-=g))break;a=0}else a-=f}25>this.size-b&&(1<this.children.length||!(this.children[0]instanceof Qb))&&(c=[],this.collapse(c),this.children=[new Qb(c)],this.children[0].parent=this)},collapse:function(a){for(var b=
0;b<this.children.length;++b)this.children[b].collapse(a)},insertInner:function(a,b,c){this.size+=b.length;this.height+=c;for(var d=0;d<this.children.length;++d){var f=this.children[d],g=f.chunkSize();if(a<=g){f.insertInner(a,b,c);if(f.lines&&50<f.lines.length){for(;50<f.lines.length;)a=f.lines.splice(f.lines.length-25,25),a=new Qb(a),f.height-=a.height,this.children.splice(d+1,0,a),a.parent=this;this.maybeSpill()}break}a-=g}},maybeSpill:function(){if(!(10>=this.children.length)){var a=this;do{var b=
a.children.splice(a.children.length-5,5),b=new Rb(b);if(a.parent){a.size-=b.size;a.height-=b.height;var c=ca(a.parent.children,a);a.parent.children.splice(c+1,0,b)}else c=new Rb(a.children),c.parent=a,a.children=[c,b],a=c;b.parent=a.parent}while(10<a.children.length);a.parent.maybeSpill()}},iterN:function(a,b,c){for(var d=0;d<this.children.length;++d){var f=this.children[d],g=f.chunkSize();if(a<g){g=Math.min(b,g-a);if(f.iterN(a,g,c))return!0;if(0==(b-=g))break;a=0}else a-=g}}};var lg=0,ha=c.Doc=function(a,
b,c,d){if(!(this instanceof ha))return new ha(a,b,c,d);null==c&&(c=0);Rb.call(this,[new Qb([new Pb("",null)])]);this.first=c;this.scrollTop=this.scrollLeft=0;this.cantEdit=!1;this.cleanGeneration=1;this.frontier=c;c=z(c,0);this.sel=ya(c);this.history=new Lc(null);this.id=++lg;this.modeOption=b;this.lineSep=d;"string"==typeof a&&(a=this.splitLines(a));td(this,{from:c,to:c,text:a});aa(this,ya(c),za)};ha.prototype=df(Rb.prototype,{constructor:ha,iter:function(a,b,c){c?this.iterN(a-this.first,b-a,c):
this.iterN(this.first,this.first+this.size,a)},insert:function(a,b){for(var c=0,d=0;d<b.length;++d)c+=b[d].height;this.insertInner(a-this.first,b,c)},remove:function(a,b){this.removeInner(a-this.first,b)},getValue:function(a){var b=Ad(this,this.first,this.first+this.size);return!1===a?b:b.join(a||this.lineSeparator())},setValue:ea(function(a){var b=z(this.first,0),c=this.first+this.size-1;fb(this,{from:b,to:z(c,B(this,c).text.length),text:this.splitLines(a),origin:"setValue",full:!0},!0);aa(this,
ya(b))}),replaceRange:function(a,b,c,d){b=I(this,b);c=c?I(this,c):b;mb(this,a,b,c,d)},getRange:function(a,b,c){a=Ua(this,I(this,a),I(this,b));return!1===c?a:a.join(c||this.lineSeparator())},getLine:function(a){return(a=this.getLineHandle(a))&&a.text},getLineHandle:function(a){if(Gb(this,a))return B(this,a)},getLineNumber:function(a){return R(a)},getLineHandleVisualStart:function(a){"number"==typeof a&&(a=B(this,a));return Aa(a)},lineCount:function(){return this.size},firstLine:function(){return this.first},
lastLine:function(){return this.first+this.size-1},clipPos:function(a){return I(this,a)},getCursor:function(a){var b=this.sel.primary();return null==a||"head"==a?b.head:"anchor"==a?b.anchor:"end"==a||"to"==a||!1===a?b.to():b.from()},listSelections:function(){return this.sel.ranges},somethingSelected:function(){return this.sel.somethingSelected()},setCursor:ea(function(a,b,c){a=I(this,"number"==typeof a?z(a,b||0):a);aa(this,ya(a,null),c)}),setSelection:ea(function(a,b,c){var d=I(this,a);a=I(this,b||
a);aa(this,ya(d,a),c)}),extendSelection:ea(function(a,b,c){jc(this,I(this,a),b&&I(this,b),c)}),extendSelections:ea(function(a,b){for(var c=[],d=0;d<a.length;d++)c[d]=I(this,a[d]);Zd(this,c)}),extendSelectionsBy:ea(function(a,b){Zd(this,gc(this.sel.ranges,a),b)}),setSelections:ea(function(a,b,c){if(a.length){for(var d=0,f=[];d<a.length;d++)f[d]=new U(I(this,a[d].anchor),I(this,a[d].head));null==b&&(b=Math.min(a.length-1,this.sel.primIndex));aa(this,ra(f,b),c)}}),addSelection:ea(function(a,b,c){var d=
this.sel.ranges.slice(0);d.push(new U(I(this,a),I(this,b||a)));aa(this,ra(d,d.length-1),c)}),getSelection:function(a){for(var b=this.sel.ranges,c,d=0;d<b.length;d++){var f=Ua(this,b[d].from(),b[d].to());c=c?c.concat(f):f}return!1===a?c:c.join(a||this.lineSeparator())},getSelections:function(a){for(var b=[],c=this.sel.ranges,d=0;d<c.length;d++){var f=Ua(this,c[d].from(),c[d].to());!1!==a&&(f=f.join(a||this.lineSeparator()));b[d]=f}return b},replaceSelection:function(a,b,c){for(var d=[],f=0;f<this.sel.ranges.length;f++)d[f]=
a;this.replaceSelections(d,b,c||"+input")},replaceSelections:ea(function(a,b,c){for(var d=[],f=this.sel,g=0;g<f.ranges.length;g++){var h=f.ranges[g];d[g]={from:h.from(),to:h.to(),text:this.splitLines(a[g]),origin:c}}if(g=b&&"end"!=b){g=[];c=a=z(this.first,0);for(f=0;f<d.length;f++){var m=d[f],h=Ce(m.from,a,c),p=Ce(Xa(m),a,c);a=m.to;c=p;"around"==b?(m=this.sel.ranges[f],m=0>J(m.head,m.anchor),g[f]=new U(m?p:h,m?h:p)):g[f]=new U(h,h)}g=new Da(g,this.sel.primIndex)}b=g;for(g=d.length-1;0<=g;g--)fb(this,
d[g]);b?$d(this,b):this.cm&&gb(this.cm)}),undo:ea(function(){Bc(this,"undo")}),redo:ea(function(){Bc(this,"redo")}),undoSelection:ea(function(){Bc(this,"undo",!0)}),redoSelection:ea(function(){Bc(this,"redo",!0)}),setExtending:function(a){this.extend=a},getExtending:function(){return this.extend},historySize:function(){for(var a=this.history,b=0,c=0,d=0;d<a.done.length;d++)a.done[d].ranges||++b;for(d=0;d<a.undone.length;d++)a.undone[d].ranges||++c;return{undo:b,redo:c}},clearHistory:function(){this.history=
new Lc(this.history.maxGeneration)},markClean:function(){this.cleanGeneration=this.changeGeneration(!0)},changeGeneration:function(a){a&&(this.history.lastOp=this.history.lastSelOp=this.history.lastOrigin=null);return this.history.generation},isClean:function(a){return this.history.generation==(a||this.cleanGeneration)},getHistory:function(){return{done:pb(this.history.done),undone:pb(this.history.undone)}},setHistory:function(a){var b=this.history=new Lc(this.history.maxGeneration);b.done=pb(a.done.slice(0),
null,!0);b.undone=pb(a.undone.slice(0),null,!0)},addLineClass:ea(function(a,b,c){return Ec(this,a,"gutter"==b?"gutter":"class",function(a){var d="text"==b?"textClass":"background"==b?"bgClass":"gutter"==b?"gutterClass":"wrapClass";if(a[d]){if(Ub(c).test(a[d]))return!1;a[d]+=" "+c}else a[d]=c;return!0})}),removeLineClass:ea(function(a,b,c){return Ec(this,a,"gutter"==b?"gutter":"class",function(a){var d="text"==b?"textClass":"background"==b?"bgClass":"gutter"==b?"gutterClass":"wrapClass",f=a[d];if(f)if(null==
c)a[d]=null;else{var g=f.match(Ub(c));if(!g)return!1;var h=g.index+g[0].length;a[d]=f.slice(0,g.index)+(g.index&&h!=f.length?" ":"")+f.slice(h)||null}else return!1;return!0})}),addLineWidget:ea(function(a,b,c){return Xf(this,a,b,c)}),removeLineWidget:function(a){a.clear()},markText:function(a,b,c){return ob(this,I(this,a),I(this,b),c,"range")},setBookmark:function(a,b){var c={replacedWith:b&&(null==b.nodeType?b.widget:b),insertLeft:b&&b.insertLeft,clearWhenEmpty:!1,shared:b&&b.shared,handleMouseEvents:b&&
b.handleMouseEvents};a=I(this,a);return ob(this,a,a,c,"bookmark")},findMarksAt:function(a){a=I(this,a);var b=[],c=B(this,a.line).markedSpans;if(c)for(var d=0;d<c.length;++d){var f=c[d];(null==f.from||f.from<=a.ch)&&(null==f.to||f.to>=a.ch)&&b.push(f.marker.parent||f.marker)}return b},findMarks:function(a,b,c){a=I(this,a);b=I(this,b);var d=[],f=a.line;this.iter(a.line,b.line+1,function(g){if(g=g.markedSpans)for(var h=0;h<g.length;h++){var m=g[h];f==a.line&&a.ch>m.to||null==m.from&&f!=a.line||f==b.line&&
...
1});return b},copy:function(a){var b=new ha(Ad(this,this.first,this.first+this.size),this.modeOption,this.first,this.lineSep);b.scrollTop=this.scrollTop;b.scrollLeft=this.scrollLeft;b.sel=this.sel;b.extend=!1;a&&(b.history.undoDepth=this.history.undoDepth,b.setHistory(this.getHistory()));return b},linkedDoc:function(a){a||(a={});var b=this.first,c=this.first+this.size;null!=a.from&&a.from>b&&(b=a.from);null!=a.to&&a.to<c&&(c=a.to);b=new ha(Ad(this,b,c),a.mode||this.modeOption,b,this.lineSep);a.sharedHist&&
(b.history=this.history);(this.linked||(this.linked=[])).push({doc:b,sharedHist:a.sharedHist});b.linked=[{doc:this,isParent:!0,sharedHist:a.sharedHist}];a=Pe(this);for(c=0;c<a.length;c++){var d=a[c],f=d.find(),g=b.clipPos(f.from),f=b.clipPos(f.to);J(g,f)&&(g=ob(b,g,f,d.primary,d.primary.type),d.markers.push(g),g.parent=d)}return b},unlinkDoc:function(a){a instanceof c&&(a=a.doc);if(this.linked)for(var b=0;b<this.linked.length;++b)if(this.linked[b].doc==a){this.linked.splice(b,1);a.unlinkDoc(this);
Vf(Pe(this));break}if(a.history==this.history){var d=[a.id];Ya(a,function(a){d.push(a.id)},!0);a.history=new Lc(null);a.history.done=pb(this.history.done,d);a.history.undone=pb(this.history.undone,d)}},iterLinkedDocs:function(a){Ya(this,a)},getMode:function(){return this.mode},getEditor:function(){return this.cm},splitLines:function(a){return this.lineSep?a.split(this.lineSep):mg(a)},lineSeparator:function(){return this.lineSep||"\n"}});ha.prototype.eachLine=ha.prototype.iter;var ng="iter insert remove copy getEditor constructor".split(" "),
Yb;for(Yb in ha.prototype)ha.prototype.hasOwnProperty(Yb)&&0>ca(ng,Yb)&&(c.prototype[Yb]=function(a){return function(){return a.apply(this.doc,arguments)}}(ha.prototype[Yb]));qb(ha);var fa=c.e_preventDefault=function(a){a.preventDefault?a.preventDefault():a.returnValue=!1},og=c.e_stopPropagation=function(a){a.stopPropagation?a.stopPropagation():a.cancelBubble=!0},md=c.e_stop=function(a){fa(a);og(a)},E=c.on=function(a,b,c){a.addEventListener?a.addEventListener(b,c,!1):a.attachEvent?a.attachEvent("on"+
b,c):(a=a._handlers||(a._handlers={}),(a[b]||(a[b]=[])).push(c))},Ca=c.off=function(a,b,c){if(a.removeEventListener)a.removeEventListener(b,c,!1);else if(a.detachEvent)a.detachEvent("on"+b,c);else if(a=a._handlers&&a._handlers[b])for(b=0;b<a.length;++b)if(a[b]==c){a.splice(b,1);break}},Y=c.signal=function(a,b){var c=a._handlers&&a._handlers[b];if(c)for(var d=Array.prototype.slice.call(arguments,2),f=0;f<c.length;++f)c[f].apply(null,d)},Sb=null,Gd=30,ye=c.Pass={toString:function(){return"CodeMirror.Pass"}},
za={scroll:!1},nd={origin:"*mouse"},Vb={origin:"+move"};ub.prototype.set=function(a,b){clearTimeout(this.id);this.id=setTimeout(b,a)};var sa=c.countColumn=function(a,b,c,d,f){null==b&&(b=a.search(/[^\s\u00a0]/),-1==b&&(b=a.length));d=d||0;for(f=f||0;;){var g=a.indexOf("\t",d);if(0>g||g>=b)return f+(b-d);f+=g-d;f+=c-f%c;d=g+1}},Mc=[""],rb=function(a){a.select()};hb?rb=function(a){a.selectionStart=0;a.selectionEnd=a.value.length}:M&&(rb=function(a){try{a.select()}catch(b){}});var pg=/[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/,
...
a)};a.prototype.listItem=function(a){vceditor.utils.assert(!1===a||"u"===a||"o"===a||"t"===a||"tc"===a);return this.cloneWithNewAttribute_(d.LIST_TYPE,a)};a.prototype.getIndent=function(){return this.attributes[d.LINE_INDENT]||0};a.prototype.getAlign=function(){return this.attributes[d.LINE_ALIGN]||0};a.prototype.getListItem=function(){return this.attributes[d.LIST_TYPE]||!1};return a}();c.LineFormatting=a})(window);(function(c){var a=function(){function a(b){return b===h.ORDERED?"</ol>":"</ul>"}function d(a,b){return a===b||a===h.TODO&&b===h.TODOCHECKED||a===h.TODOCHECKED&&b===h.TODO}var f=c.utils,g=c.AttributeConstants,h=c.LineFormatting.LIST_TYPE;return function(c,p){for(var s="",v=!0,x=[],t=!1,w=!0,q=!0,r=0,u=c.ops[r],A=!1;u;){f.assert(u.isInsert());var K=u.attributes;if(v){var v=!1,G=0,S=null,D="left";g.LINE_SENTINEL in K&&(G=K[g.LINE_INDENT]||0,S=K[g.LIST_TYPE]||null,D=K[g.LINE_ALIGN]||"left");S&&(G=G||
1);t?(s+="</li>",t=!1):w||(q&&(s+="<br/>"),s+="</div>");w=!1;for(f.assert(0<=G,"Indent must not be negative.");x.length>G||G===x.length&&null!==S&&!d(S,x[x.length-1]);)s+=a(x.pop());for(;x.length<G;)q=S||h.UNORDERED,A=S==h.TODO||S==h.TODOCHECKED||A,s+=q===h.ORDERED?"<ol>":q===h.UNORDERED?"<ul>":'<ul class="vceditor-todo">',x.push(q);q="left"!==D?' style="text-align:'+D+'"':"";if(S){t="";switch(S){case h.TODOCHECKED:t=' class="vceditor-checked"';break;case h.TODO:t=' class="vceditor-unchecked"'}s+=
"<li"+t+q+">";t=!0}else s+="<div"+q+">";q=!0}if(g.LINE_SENTINEL in K)u=c.ops[++r];else if(g.ENTITY_SENTINEL in K){for(S=0;S<u.text.length;S++)G=vceditor.Entity.fromAttributes(K),G=p.exportToElement(G),s+=G.outerHTML;u=c.ops[++r]}else{var G=S="",O;for(O in K){var D=K[O],N,X;O===g.BOLD||O===g.ITALIC||O===g.UNDERLINE||O===g.STRIKE?(f.assert(!0===D),N=X=O):O===g.FONT_SIZE?(N='span style="font-size: '+D,N+="string"!==typeof D||-1===D.indexOf("px",D.length-2)?'px"':'"',X="span"):O===g.FONT?(N='span style="font-family: '+
D+'"',X="span"):O===g.COLOR?(N='span style="color: '+D+'"',X="span"):O===g.BACKGROUND_COLOR?(N='span style="background-color: '+D+'"',X="span"):f.log(!1,"Encountered unknown attribute while rendering html: "+O);N&&(S+="<"+N+">");X&&(G="</"+X+">"+G)}var D=u.text,Q=D.indexOf("\n");0<=Q?(v=!0,u=Q<D.length-1?new vceditor.TextOp("insert",D.substr(Q+1),K):c.ops[++r],D=D.substr(0,Q)):u=c.ops[++r];D=D.replace(/  +/g,function(a){return Array(a.length+1).join("\u00a0")}).replace(/^ /,"\u00a0").replace(/ $/,
"\u00a0");0<D.length&&(q=!1);s+=S+D.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\u00a0/g,"&nbsp;")+G}}t?s+="</li>":w||(q&&(s+="&nbsp;"),s+="</div>");for(;0<x.length;)s+=a(x.pop());A&&(s='<style>ul.vceditor-todo { list-style: none; margin-left: 0; padding-left: 0; } ul.vceditor-todo > li { padding-left: 1em; text-indent: -1em; } ul.vceditor-todo > li:before { content: "\\2610"; padding-right: 5px; } ul.vceditor-todo > li.vceditor-checked:before { content: "\\2611"; padding-right: 5px; }</style>\n'+
...
function(b){a.applyOperationToCodeMirror(b,this.rtcm)};a.prototype.registerUndo=function(a){this.cm.undo=a};a.prototype.registerRedo=function(a){this.cm.redo=a};a.prototype.invertOperation=function(a){for(var b=0,c=this.rtcm.codeMirror,d,m,w=new g,q=0;q<a.wrapped.ops.length;q++){var r=a.wrapped.ops[q];if(r.isRetain())if(f(r.attributes))w.retain(r.chars),b+=r.chars;else for(d=this.rtcm.getAttributeSpans(b,b+r.chars),m=0;m<d.length;m++){var u={},A;for(A in r.attributes){var K=r.attributes[A],G=d[m].attributes[A];
!1===K?G&&(u[A]=G):K!==G&&(u[A]=G||!1)}w.retain(d[m].length,u);b+=d[m].length}else if(r.isInsert())w["delete"](r.text.length);else if(r.isDelete()){u=c.getRange(c.posFromIndex(b),c.posFromIndex(b+r.chars));d=this.rtcm.getAttributeSpans(b,b+r.chars);for(m=K=0;m<d.length;m++)w.insert(u.substr(K,d[m].length),d[m].attributes),K+=d[m].length;b+=r.chars}}return new h(w,a.meta.invert())};return a}();c.Client=RichTextCodeMirrorAdapter})(window);otAdapter=function(){function c(a,b){b=b.charAt(0).toLowerCase()+b.slice(1);var c=Vceditor.getvcEditor();if(a.operations&&a.revision>a.operations.length){var f=[];f[a.revision-a.operations.length-1]=null;this.operations=f.concat(a.operations)}else this.operations=a.operations?a.operations:[];this.server=new c.Server(a.doc,this.operations);this.trigger=function(a){this.callbacks[a].apply(this,Array.prototype.slice.call(arguments,1))};this.teacherOT=function(a){a=this.doOT(a);"undefined"!=typeof a&&
...
t+w+"]","g"),"");c.push(f)}b.update(b.from,b.to,c)}};a.prototype.onCodeMirrorChange_=function(a,b){if("object"===typeof b.from){for(var c=[];b;)c.push(b),b=b.next;b=c}for(var c=this.convertCoordinateSystemForChanges_(b),d=[],g=0;g<c.length;g++){var h=c[g],p=h.start,s=h.text,t=h.removed,v=h.origin;if(0<t.length){for(var w=this.annotationList_.getAnnotatedSpansForSpan(new m(p,t.length)),x=0,eb=0;eb<w.length;eb++){var Ka=w[eb];d.push({start:p,end:p+Ka.length,removedAttributes:Ka.annotation.attributes,
removed:t.substr(x,Ka.length),attributes:{},text:"",origin:h.origin});x+=Ka.length}this.annotationList_.removeSpan(new m(p,t.length))}0<s.length&&("+input"===h.origin||"paste"===h.origin?h=this.currentAttributes_||{}:v in this.outstandingChanges_?(h=this.outstandingChanges_[v].attributes,v=this.outstandingChanges_[v].origOrigin,delete this.outstandingChanges_[v]):h={},this.annotationList_.insertAnnotatedSpan(new m(p,s.length),new f(h)),d.push({start:p,end:p,removedAttributes:{},removed:"",text:s,
