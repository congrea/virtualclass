...
b.className+=" youTubeSharing"}},triggerOnSeekChange:function(){console.log("there should happend something after each 2 second");if(0==d||-2==f||-1==g)d=this.player.getCurrentTime(),f=this.player.getPlayerState(),g=this.player.isMuted();else{var a=Math.abs(this.player.getCurrentTime()-d);d=this.player.getCurrentTime();console.log(d);console.log(this.player.getCurrentTime());4<a&&this.ytOnSeek(this.player.getCurrentTime());this.player.getPlayerState()!=f&&3!=this.player.getPlayerState()&&(this.ytOnChange(this.player.getPlayerState()),
