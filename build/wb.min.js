...
4<a&&this.ytOnSeek(this.player.getCurrentTime());this.player.getPlayerState()!=g&&3!=this.player.getPlayerState()&&(this.ytOnSeek(this.player.getCurrentTime()),this.ytOnChange(this.player.getPlayerState()),g=this.player.getPlayerState());this.player.isMuted()!=h&&(this.ytOnMuted(this.player.isMuted()),h=this.player.isMuted())}},ytOnMuted:function(a){a?ioAdapter.mustSend({yts:"mute",cf:"yts"}):ioAdapter.mustSend({yts:"unmute",cf:"yts"});console.log("MUTED "+a)},ytOnSeek:function(a){ioAdapter.mustSend({yts:{seekto:a},
