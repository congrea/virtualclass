...
h=a.virtual_box.getImageLines(d.oCoords);return(c=a.virtual_box.findCrossPoints(c,f,h))&&1===c%2||d.findTargetCorner(b)?!0:!1}}})(window);(function(c){var a=c.vcan;a.interact={rotateObject:function(b,d){var f=a.main.currentTransform,c=a.main.offset;if(!f.target.lockRotation){var h=Math.atan2(f.ey-f.y-c.y,f.ex-f.x-c.x),c=Math.atan2(d-f.y-c.y,b-f.x-c.x);a.utility.setVal(f.target,"theta",c-h+f.theta)}},scaleObject:function(b,d,c){var g=a.main.currentTransform,h=a.main.offset;target=g.target;if(!target.lockScalingX||!target.lockScalingY){var m=Math.sqrt(Math.pow(g.ey-g.y-h.y,2)+Math.pow(g.ex-g.x-h.x,2));b=Math.sqrt(Math.pow(d-g.y-h.y,2)+
Math.pow(b-g.x-h.x,2));target.scaling=!0;c?"x"!==c||target.lockUniScaling?"y"!==c||target.lockUniScaling||target.lockScalingY||a.utility.setVal(target,"scaleY",g.scaleY*b/m):target.lockScalingX||a.utility.setVal(target,"scaleX",g.scaleX*b/m):(target.lockScalingX||a.utility.setVal(target,"scaleX",g.scaleX*b/m),target.lockScalingY||a.utility.setVal(target,"scaleY",g.scaleY*b/m))}},translateObject:function(b,d){var c=a.main.currentTransform.target;c.lockMovementX||a.utility.setVal(c,"x",b-a.main.currentTransform.offsetX);
c.lockMovementY||a.utility.setVal(c,"y",d-a.main.currentTransform.offsetY);return c}}})(window);(function(c){c.vcan.rectangle=function(){return{type:"rectangle",init:function(a){void 0==a.x&&(a.x=a.ex-a.width/2);void 0==a.y&&(a.y=a.ey-a.height/2);return a},draw:function(a,b,d){d=-b.width/2;var c=-b.height/2,g=b.width,h=b.height;a.beginPath();a.strokeStyle=void 0!=b.borderColor?'"'+b.strokeColor+'"':"#000";a.moveTo(d,c);a.stroke();a.lineTo(d+g,c);a.stroke();a.lineTo(d+g,c+h);a.stroke();a.lineTo(d,c+h);a.stroke();a.lineTo(d,c);a.fillStyle=void 0!=b.fillColor?b.fillColor:" ";a.closePath();a.stroke();
...
d.appendChild(g);document.getElementById("recordingHeader").innerHTML=virtualclass.lang.getString("downloadFile");var h=new Blob([b],{type:"application/virtualclass"});g.addEventListener("click",function(){null!=c.webkitURL?m.href=c.webkitURL.createObjectURL(h):(m.href=c.URL.createObjectURL(h),m.onclick=a,document.body.appendChild(m));m.click();virtualclass.storage.config.endSession();io.init(virtualclass.uInfo)})})},sendDataToServer:function(){virtualclass.storage.db.transaction(["chunkData"],"readwrite").objectStore("chunkData").clear();
...
h=b.ch,m=c,p=E(a,g),q=!0;if("char"==d)f();else if("column"==d)f(!0);else if("word"==d||"group"==d){var r=null;d="group"==d;b=a.cm&&a.cm.getHelper(b,"wordChars");for(var s=!0;!(0>c)||f(!s);s=!1){var v=p.text.charAt(h)||"\n",v=Lc(v,b)?"w":d&&"\n"==v?"n":!d||/\s/.test(v)?null:"p";!d||s||v||(v="s");if(r&&r!=v){0>c&&(c=1,f());break}v&&(r=v);if(0<c&&!f(!s))break}}m=tc(a,z(g,h),m,!0);q||(m.hitSide=!0);return m}function Oe(a,b,c,d){var n=a.doc,f=b.left,g;"page"==d?(d=Math.min(a.display.wrapper.clientHeight,
window.innerHeight||document.documentElement.clientHeight),g=b.top+c*(d-(0>c?1.5:.5)*Sa(a.display))):"line"==d&&(g=0<c?b.bottom+3:b.top-3);for(;;){var h=md(a,f,g);if(!h.outside)break;if(0>c?0>=g:g>=n.height){h.hitSide=!0;break}g+=5*c}return h}function H(a,b,d,f){c.defaults[a]=b;d&&(fb[a]=f?function(a,b,c){c!=Jd&&d(a,b,c)}:d)}function Tf(a){var b=a.split(/-(?!$)/);a=b[b.length-1];for(var c,d,n,f,g=0;g<b.length-1;g++){var h=b[g];if(/^(cmd|meta|m)$/i.test(h))f=!0;else if(/^a(lt)?$/i.test(h))c=!0;else if(/^(c|ctrl|control)$/i.test(h))d=
!0;else if(/^s(hift)$/i.test(h))n=!0;else throw Error("Unrecognized modifier name: "+h);}c&&(a="Alt-"+a);d&&(a="Ctrl-"+a);f&&(a="Cmd-"+a);n&&(a="Shift-"+a);return a}function Mc(a){return"string"==typeof a?Pa[a]:a}function ub(a,b,c,d,n){if(d&&d.shared)return Uf(a,b,c,d,n);if(a.cm&&!a.cm.curOp)return Y(a.cm,ub)(a,b,c,d,n);var f=new cb(a,n);n=J(b,c);d&&ra(d,f,!1);if(0<n||0==n&&!1!==f.clearWhenEmpty)return f;f.replacedWith&&(f.collapsed=!0,f.widgetNode=D("span",[f.replacedWith],"CodeMirror-widget"),d.handleMouseEvents||
f.widgetNode.setAttribute("cm-ignore-events","true"),d.insertLeft&&(f.widgetNode.insertLeft=!0));if(f.collapsed){if(Pe(a,b.line,b,c,f)||b.line!=c.line&&Pe(a,c.line,b,c,f))throw Error("Inserting collapsed marker partially overlapping an existing one");Ma=!0}f.addToHistory&&He(a,{from:b,to:c,origin:"markText"},a.sel,NaN);var g=b.line,h=a.cm,m;a.iter(g,c.line+1,function(a){h&&f.collapsed&&!h.options.lineWrapping&&Da(a)==h.display.maxLine&&(m=!0);f.collapsed&&g!=b.line&&xa(a,0);var d=new Nc(f,g==b.line?
b.ch:null,g==c.line?c.ch:null);a.markedSpans=a.markedSpans?a.markedSpans.concat([d]):[d];d.marker.attachLine(a);++g});f.collapsed&&a.iter(b.line,c.line+1,function(b){Ta(a,b)&&xa(b,0)});f.clearOnEnter&&F(f,"beforeCursorEnter",function(){f.clear()});f.readOnly&&(Fe=!0,(a.history.done.length||a.history.undone.length)&&a.clearHistory());f.collapsed&&(f.id=++zd,f.atomic=!0);if(h){m&&(h.curOp.updateMaxLine=!0);if(f.collapsed)la(h,b.line,c.line+1);else if(f.className||f.title||f.startStyle||f.endStyle||
f.css)for(d=b.line;d<=c.line;d++)Ia(h,d,"text");f.atomic&&fe(h.doc);ga(h,"markerAdded",h,f)}return f}function Uf(a,b,c,d,f){d=ra(d);d.shared=!1;var g=[ub(a,b,c,d,f)],h=g[0],m=d.widgetNode;bb(a,function(a){m&&(d.widgetNode=m.cloneNode(!0));g.push(ub(a,I(a,b),I(a,c),d,f));for(var G=0;G<a.linked.length;++G)if(a.linked[G].isParent)return;h=P(g)});return new Oc(g,h)}function Qe(a){return a.findMarks(z(a.first,0),a.clipPos(z(a.lastLine())),function(a){return a.parent})}function Vf(a){for(var b=0;b<a.length;b++){var c=
...
c)}return"meta"}}function p(a,b,c){this.prev=a.context;this.tagName=b;this.indent=a.indented;this.startOfLine=c;if(A.doNotIndent.hasOwnProperty(b)||a.context&&a.context.noIndent)this.noIndent=!0}function r(a){a.context&&(a.context=a.context.prev)}function u(a,b){for(var c;a.context;){c=a.context.tagName;if(!A.contextGrabbers.hasOwnProperty(c)||!A.contextGrabbers[c].hasOwnProperty(b))break;r(a)}}function w(a,b,c){return"openTag"==a?(c.tagStart=b.column(),t):"closeTag"==a?x:w}function t(a,b,c){if("word"==
a)return c.tagName=b.current(),X="tag",v;X="error";return t}function x(a,b,c){if("word"==a){a=b.current();c.context&&c.context.tagName!=a&&A.implicitlyClosed.hasOwnProperty(c.context.tagName)&&r(c);if(c.context&&c.context.tagName==a)return X="tag",q;X="tag error";return s}X="error";return s}function q(a,b,c){if("endTag"!=a)return X="error",q;r(c);return w}function s(a,b,c){X="error";return q(a,b,c)}function v(a,b,c){if("word"==a)return X="attribute",B;if("endTag"==a||"selfcloseTag"==a){b=c.tagName;
var d=c.tagStart;c.tagName=c.tagStart=null;"selfcloseTag"==a||A.autoSelfClosers.hasOwnProperty(b)?u(c,b):(u(c,b),c.context=new p(c,b,d==c.indented));return w}X="error";return v}function B(a,b,c){if("equals"==a)return L;A.allowMissing||(X="error");return v(a,b,c)}function L(a,b,c){if("string"==a)return K;if("word"==a&&A.allowUnquoted)return X="string",v;X="error";return v(a,b,c)}function K(a,b,c){return"string"==a?K:v(a,b,c)}var M=a.indentUnit,C=b.multilineTagIndentFactor||1,R=b.multilineTagIndentPastTag;
...
footer:!0,form:!0,h1:!0,h2:!0,h3:!0,h4:!0,h5:!0,h6:!0,header:!0,hgroup:!0,hr:!0,menu:!0,nav:!0,ol:!0,p:!0,pre:!0,section:!0,table:!0,ul:!0},rp:{rp:!0,rt:!0},rt:{rp:!0,rt:!0},tbody:{tbody:!0,tfoot:!0},td:{td:!0,th:!0},tfoot:{tbody:!0},th:{td:!0,th:!0},thead:{tbody:!0,tfoot:!0},tr:{tr:!0}},doNotIndent:{pre:!0},allowUnquoted:!0,allowMissing:!0,caseFold:!0}:{autoSelfClosers:{},implicitlyClosed:{},contextGrabbers:{},doNotIndent:{},allowUnquoted:!1,allowMissing:!1,caseFold:!1},U=b.alignCDATA,da,X;d.isInText=
!0;return{startState:function(){return{tokenize:d,state:w,indented:0,tagName:null,tagStart:null,context:null}},token:function(a,b){!b.tagName&&a.sol()&&(b.indented=a.indentation());if(a.eatSpace())return null;da=null;var c=b.tokenize(a,b);(c||da)&&"comment"!=c&&(X=null,b.state=b.state(da||c,a,b),X&&(c="error"==X?c+" error":X));return c},indent:function(a,b,g){var h=a.context;if(a.tokenize.isInAttribute)return a.tagStart==a.indented?a.stringStartCol+1:a.indented+M;if(h&&h.noIndent)return c.Pass;if(a.tokenize!=
f&&a.tokenize!=d)return g?g.match(/^(\s*)/)[0].length:0;if(a.tagName)return R?a.tagStart+a.tagName.length+2:a.tagStart+M*C;if(U&&/<!\[CDATA\[/.test(b))return 0;if((a=b&&/^<(\/)?([\w_:\.-]*)/.exec(b))&&a[1])for(;h;)if(h.tagName==a[2]){h=h.prev;break}else if(A.implicitlyClosed.hasOwnProperty(h.tagName))h=h.prev;else break;else if(a)for(;h;)if((b=A.contextGrabbers[h.tagName])&&b.hasOwnProperty(a[2]))h=h.prev;else break;for(;h&&!h.startOfLine;)h=h.prev;return h?h.indent+M:0},electricInput:/<\/[\s\w:]+>$/,
...
(h.indentation-=h.indentationDiff),h.list=null):0<h.indentation?(h.list=null,h.listDepth=Math.floor(h.indentation/4)):(h.list=!1,h.listDepth=0));var s=null;if(4<=h.indentationDiff)return g.skipToEnd(),r||f(h.prevLine)?(h.indentation-=4,h.indentedCode=!0,A.code):null;if(g.eatSpace())return null;if((s=g.match(ib))&&6>=s[1].length)return h.header=s[1].length,b.highlightFormatting&&(h.formatting="header"),h.f=h.inline,u(h);if(f(h.prevLine)||h.quote||q||r||!(s=g.match(hc))){if(g.eat(">"))return h.quote=
m?1:h.quote+1,b.highlightFormatting&&(h.formatting="quote"),g.eatSpace(),u(h);if("["===g.peek())return d(g,h,v);if(g.match(da,!0))return h.hr=!0,A.hr;if((f(h.prevLine)||q)&&(g.match(X,!1)||g.match(V,!1)))return m=null,g.match(X,!0)?m="ul":(g.match(V,!0),m="ol"),h.indentation=g.column()+g.current().length,h.list=!0,h.listDepth++,b.taskLists&&g.match(jb,!1)&&(h.taskList=!0),h.f=h.inline,b.highlightFormatting&&(h.formatting=["list","list-"+m]),u(h);if(b.fencedCodeBlocks&&(s=g.match(Xc,!0)))return h.fencedChars=
s[1],m=s[2],c.findModeByName&&(q=c.findModeByName(m))&&(m=q.mime||q.mimes[0]),m=c.getMode(a,m),h.localMode="null"==m.name?null:m,h.localMode&&(h.localState=h.localMode.startState()),h.f=h.block=p,b.highlightFormatting&&(h.formatting="code-block"),h.code=!0,u(h)}else return h.header="="==s[0].charAt(0)?1:2,b.highlightFormatting&&(h.formatting="header"),h.f=h.inline,u(h);return d(g,h,h.inline)}function m(a,b){var c=C.token(a,b.htmlState);if(M&&null===b.htmlState.tagStart&&!b.htmlState.context&&b.htmlState.tokenize.isInText||
b.md_inside&&-1<a.current().indexOf(">"))b.f=t,b.block=h,b.htmlState=null;return c}function p(a,b){if(a.sol()&&b.fencedChars&&a.match(b.fencedChars,!1))return b.localMode=b.localState=null,b.f=b.block=r,null;if(b.localMode)return b.localMode.token(a,b.localState);a.skipToEnd();return A.code}function r(a,c){a.match(c.fencedChars);c.block=h;c.f=t;c.fencedChars=null;b.highlightFormatting&&(c.formatting="code-block");c.code=!0;var d=u(c);c.code=!1;return d}function u(a){var c=[];if(a.formatting){c.push(A.formatting);
...
U;for(U in A)A.hasOwnProperty(U)&&b.tokenTypeOverrides[U]&&(A[U]=b.tokenTypeOverrides[U]);var da=/^([*\-_])(?:\s*\1){2,}\s*$/,X=/^[*\-+]\s+/,V=/^[0-9]+([.)])\s+/,jb=/^\[(x| )\](?=\s)/,ib=b.allowAtxHeaderWithoutSpace?/^(#+)/:/^(#+)(?: |$)/,hc=/^ *(?:\={1,}|-{1,})\s*$/,Jb=/^[^#!\[\]*_\\<>` "'(~]+/,Xc=new RegExp("^("+(!0===b.fencedCodeBlocks?"~~~+|```+":b.fencedCodeBlocks)+")[ \\t]*([\\w+#]*)"),kb=[],Oa={startState:function(){return{f:h,prevLine:null,thisLine:null,block:h,htmlState:null,indentation:0,
