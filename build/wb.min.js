...
document.getElementById(a+"LocalVideo")},makeActiveApp:function(a,b){a!=b&&"undefined"!=typeof b&&(b+="Tool",document.getElementById(b).className=virtualclass.vutil.removeClassFromElement(b,"active"));document.getElementById(a+"Tool").className+=" active"},initInstallChromeExt:function(a){"EXTENSION_UNAVAILABLE"==a.name&&(console.log("ask for inline installation"),chrome.webstore.install("https://chrome.google.com/webstore/detail/ijhofagnokdeoghaohcekchijfeffbjl",function(a){c.location.reload()},
function(a){alert(a)}))},removeAppPanel:function(){var a=document.getElementById("virtualclassOptionsCont");null!=a&&a.parentNode.removeChild(a)},removeTempVideo:function(a){a=document.getElementById(a);a.parentNode.removeChild(a)},createLocalTempVideo:function(a,b){if("string"==typeof a||"String"==typeof a)a=document.getElementById(a);var d=virtualclass.vutil.createDOM("div",b),c=virtualclass.vutil.createDOM("canvas",b+"Video");d.appendChild(c);a.appendChild(d)},initLocCanvasCont:function(a){var b;
...
virtualclass.prevScreen.unShareScreen();this.video=document.getElementById(this.local+"Video");if("VIDEO"!=this.video.tagName){var b=this.video,f=document.createElement("video");f.id=b.id;this.video.parentNode.replaceChild(f,this.video);this.video=document.getElementById(this.local+"Video");this.video.autoplay=!0;virtualclass.vutil.createLocalTempVideo("virtualclassScreenShare",this.local+"Temp");virtualclass.vutil.initLocCanvasCont(this.local+"TempVideo")}this.currentStream=d;var g=this;virtualclass.adpt.attachMediaStream(this.video,
d);this.prevStream=!0;this.currentStream.onended=function(a){g.ssByClick?(g.video.src="",g.localtempCont.clearRect(0,0,g.localtempCanvas.width,g.localtempCanvas.height),clearInterval(virtualclass.clear),g.initPrevImage(),virtualclass.vutil.beforeSend({unshareScreen:!0,st:g.type,cf:"unshareScreen"}),g.prevStream=!1,g.prevScreen="",virtualclass.prevScreen=""):g.ssByClick=!0};d={};d.width=c.innerWidth;d.height=c.innerHeight-140;var b=document.getElementById(this.local),m=this.html.getDimension(d);b.style.width=
Math.round(m.width)+"px";b.style.height=Math.round(m.height)+"px";g=this;this.video.onloadedmetadata=function(){g.width=m.width;g.height=m.height;g.localtempCanvas.width=g.video.offsetWidth;g.localtempCanvas.height=g.video.offsetHeight;virtualclass.prevScreen=g;var a=virtualclass.system.measureResoultion({width:c.innerWidth,height:c.innerHeight});g.sharing();virtualclass.vutil.setContainerWidth(a,virtualclass.currApp);roles.hasControls()&&(virtualclass.vutil.makeActiveApp(g.id,virtualclass.previrtualclass),
"virtualclassYts"==virtualclass.previrtualclass&&virtualclass.yts.destroyYT());virtualclass.previrtualclass=g.id}},sharing:function(){function b(a,d){for(var c=a.toString(),f=c.length;f<d;f++)c="0"+c;return c.match(/[\S]{1,2}/g)||[]}function g(){clearInterval(virtualclass.clear);if("undefined"!=typeof d&&"undefined"!=typeof f){if(d!=r.video.offsetWidth||f!=r.video.offsetHeight)a=1}else d=r.video.offsetWidth,f=r.video.offsetHeight;1==a?setTimeout(h,2E3):t(r.type)}function m(a){switch(!0){case 300>=
a||"undefined"==typeof a:u=300;break;case 3E3>=a:u=a;break;case 5E3>=a:u=3E3;break;default:u=5E3}}function h(){console.log("RESIZE");if(roles.hasControls()){d=r.video.offsetWidth;f=r.video.offsetHeight;w=Math.round(r.localtempCanvas.height/12);q=Math.round(r.localtempCanvas.width/12);var t=r.type;r.localtempCanvas.width=r.video.offsetWidth;r.localtempCanvas.height=r.video.offsetHeight;r.localtempCont.drawImage(r.video,0,0,r.video.offsetWidth,r.video.offsetHeight);var x=r.localtempCont.getImageData(0,
0,r.localtempCanvas.width,r.localtempCanvas.height),x=r.dc.encodeRGB(x.data),H=Math.round(r.localtempCanvas.width/q),S=Math.round(r.localtempCanvas.height/w),E,O,N,W;W=r.getContainerDimension();"undefined"!=typeof d&&"undefined"!=typeof f?(E=b(d,4),O=b(f,4)):(E=b(r.video.offsetWidth,4),O=b(r.video.offsetHeight,4));N=b(W.width,4);W=b(W.height,4);t=new Uint8ClampedArray(["ss"==t?104:204,E[0],E[1],O[0],O[1],N[0],N[1],W[0],W[1]]);E=new Uint8ClampedArray(x.length+t.length);E.set(t);E.set(x,t.length);c.Worker&&
sworker.postMessage({img:x,resize:1,resA:w,resB:q,dw:H,dh:S,offsetWidth:r.video.offsetWidth,offsetHeight:r.video.offsetHeight},[x.buffer]);ioAdapter.sendBinary(E);m(E.length/128);a=0;clearInterval(virtualclass.clear);virtualclass.clear=setInterval(g,u)}}function t(a){r.localtempCanvas.width=r.video.offsetWidth;r.localtempCanvas.height=r.video.offsetHeight;r.localtempCont.drawImage(r.video,0,0,r.video.offsetWidth,r.video.offsetHeight);a=Math.round(r.localtempCanvas.width/q);var d=Math.round(r.localtempCanvas.height/
w),b=r.localtempCont.getImageData(0,0,r.video.offsetWidth,r.video.offsetHeight);c.Worker&&(sworker.postMessage({img:b.data,resA:w,resB:q,dw:a,dh:d,offsetWidth:r.video.offsetWidth,offsetHeight:r.video.offsetHeight,type:r.type},[b.data.buffer]),sworker.onmessage=function(a){if(1==a.data.needFullScreen){a=virtualclass.getDataFullScreen(r.type);ioAdapter.sendBinary(a);var d=a.length/128}else null!=a.data.masterSlice&&(ioAdapter.sendBinary(a.data.masterSlice),d=a.data.masterSlice.length/128);m(d);clearInterval(virtualclass.clear);
virtualclass.clear=setInterval(g,u)});clearInterval(virtualclass.clear)}var w=Math.round(this.localtempCanvas.height/12),q=Math.round(this.localtempCanvas.width/12),r=this;virtualclass.hasOwnProperty("wholeImage")&&clearInterval(virtualclass.wholeImage);virtualclass.hasOwnProperty("clear")&&clearInterval(virtualclass.clear);var u=1E3;virtualclass.getDataFullScreen=function(a){r.localtempCanvas.width=r.video.offsetWidth;r.localtempCanvas.height=r.video.offsetHeight;r.localtempCont.drawImage(r.video,
0,0,r.video.offsetWidth,r.video.offsetHeight);var d=r.localtempCont.getImageData(0,0,r.localtempCanvas.width,r.localtempCanvas.height),d=r.dc.encodeRGB(d.data),c=b(r.localtempCanvas.height,4),f=b(r.localtempCanvas.width,4);a=new Uint8ClampedArray(["ss"==a?102:202,f[0],f[1],c[0],c[1]]);c=new Uint8ClampedArray(d.length+a.length);c.set(a);c.set(d,a.length);return c};clearInterval(virtualclass.clear);virtualclass.clear=setInterval(g,u)},getContainerDimension:function(){var a=document.getElementById(this.id+
"Local");return{width:a.offsetWidth,height:a.offsetHeight}},drawImages:function(a,d){if("undefined"!=typeof d){var b=this.dc.decodeRGBSlice(a,this.localCont,d);this.localCont.putImageData(b,d.x,d.y)}else b=this.dc.decodeRGB(a,this.localCont,this.localCanvas),this.localCont.putImageData(b,0,0)},drawSingleImage:function(a){a=this.dc.decodeRGB(a,this.localCont,this.localCanvas);this.localCont.putImageData(a,0,0)},dimensionStudentScreen:function(a,d){this.localCanvas=document.getElementById(virtualclass[g].local+
...
a.d.w,this.localCanvas.height=a.d.h);if(a.hasOwnProperty("vc")){var b=document.getElementById(virtualclass[g].local);b.style.width=a.vc.w+"px";b.style.height=a.vc.h+"px"}"virtualclassScreenShare"==virtualclass.previous&&virtualclass.vutil.setScreenInnerTagsWidth(virtualclass.previous)},html:{UI:function(a){a=virtualclass.vutil.createDOM("div",this.id,[this.className]);var d=virtualclass.vutil.createDOM("div",this.local,[this.label]);if(roles.hasControls()){if(virtualclass.recorder.recImgPlay)var b=
virtualclass.vutil.createDOM("canvas",this.local+"Video");else b=virtualclass.vutil.createDOM("video",this.local+"Video"),b.setAttribute("autoplay",!0);d.style.cssText+=";position:relative"}else b=virtualclass.vutil.createDOM("canvas",this.local+"Video");d.appendChild(b);a.appendChild(d);roles.hasControls()&&!virtualclass.recorder.recImgPlay&&virtualclass.vutil.createLocalTempVideo(a,this.localTemp);return a},getDimension:function(a,d){return{height:a.height,width:a.width}}},initPrevImage:function(){sworker.postMessage({initPrevImg:!0})},
setCurrentApp:function(){virtualclass.hasOwnProperty("previousApp")&&"object"==typeof virtualclass.previousApp&&(virtualclass.currApp=virtualclass.previousApp.name,document.getElementById("virtualclassCont").dataset.currapp=virtualclass.currApp)}}}})(window);(function(c){function a(a){document.body.removeChild(a.target)}var b,d={},f=1,g=1,h={items:[],recImgPlay:!1,objn:0,playTimeout:"",totalSent:0,fileQueue:[],rnum:1,storeDone:0,emn:0,allFileFound:!1,waitServer:!1,waitPopup:!1,tempRecData:[],alreadyAskForPlay:!1,playStart:!1,error:0,mkDownloadLink:"",tillPlayTime:0,getPlayTotTime:!1,importfilepath:c.importfilepath,exportfilepath:c.exportfilepath,sessionKey:randomString(11),alreadyDownload:!1,init:function(a){var d=virtualclass.wb.vcan;if("undefined"!=
...
this.setReadMode();var d=virtualclass.vutil.capitalizeFirstLetter(virtualclass.currApp);"EditorRich"==d||"EditorCode"==d?(virtualclass.previous="virtualclass"+virtualclass.currApp,virtualclass.system.setAppDimension(virtualclass.currApp)):(d=document.getElementById("virtualclassEditorRich"),null!=d&&(d.style.display="none"),d=document.getElementById("virtualclassEditorCode"),null!=d&&(d.style.display="none"));d=document.getElementById("virtualclassEditorTool");null!=d&&(d.style.pointerEvents="visible");
otAdapter.myrequestData=0},removeEditorData:function(){"object"==typeof this.cm&&("object"==typeof this.vcAdapter&&(this.vcAdapter.operations.length=0),this.removeCodeMirror(),localStorage.removeItem(this.etype+"_allEditorOperations"),localStorage.removeItem(this.etype+"_edOperationRev"))},saveIntoLocalStorage:function(){if("object"==typeof this.vcAdapter&&0<this.vcAdapter.operations.length){var a=this.getWrappedOperations();localStorage.removeItem(this.etype+"_allEditorOperations");localStorage.setItem(this.etype+
"_allEditorOperations",JSON.stringify(a));localStorage.setItem(this.etype+"_edOperationRev",this.cmClient.revision)}}}}})(window);(function(c,a){c.Chat=function(){return{init:function(){this.chatroombox=null;this.counter=0;this.idList=[];a.htab=[];a.htabIndex=[];this.vmstorage={};a("body").footerbar();"false"==localStorage.getItem("init")&&(a("#stickybar").removeClass("maximize").addClass("minimize"),a("#hide_bar input").removeClass("close").addClass("expand"));tabs=a("#tabs").tabs({cache:!0,activeOnAdd:!0});!1==browserSupportsLocalStorage()?alert(lang.sterror):(this.history(),this.UI.privateChatBox.init(),a("ul.tabs").on("click, focus",
