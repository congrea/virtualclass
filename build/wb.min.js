...
0;virtualclass.chat.removeChatHighLight("chatrm");virtualclass.setPrvUser();io.sock&&io.sock.close();b.config.createNewSession()}},shapesData:{handleResult:function(){virtualclass.recorder.items.push(JSON.parse(cursor.value.recObjs))}},clearSingleTable:function(a){var b=this.db.transaction(a,"readwrite");"undefined"!=typeof b?(b.objectStore(a).clear(),console.log("Cleared IDDB Table "+a)):console.log("There is no table "+a+" at IDDB.")},clearStorageData:function(){ioAdapter.adapterMustData=[];ioAdapter.serial=
