...
this.contextTop.closePath();this.isCurrentlyDrawing=!1;var h=this.utility.min(this.freeDrawingXPoints);f=this.utility.min(this.freeDrawingYPoints);var k=this.utility.max(this.freeDrawingXPoints);d=this.utility.max(this.freeDrawingYPoints);var m=[],n,p,q,r=this.freeDrawingXPoints,u=this.freeDrawingYPoints,s=this.mdTime;m.push("M ",r[0]-h," ",u[0]-f," ",s[0]," ");for(var v=1;n=r[v],p=u[v],q=s[v];v++)m.push("L ",n-h," ",p-f," ",q," ");m=m.join("");if("M 0 0 L 0 0 "!==m)return n=this.freeDrawingXPoints[this.freeDrawingXPoints.length-
...
n,p;this.path.forEach(function(c,q){if(" "!=c[3])var s=c.splice(3);"H"!==c[0]&&(d=0===q?this.utility.getX(c):this.utility.getX(this.path[q-1]));"V"!==c[0]&&(k=0===q?this.utility.getY(c):this.utility.getY(this.path[q-1]));c[0]===c[0].toLowerCase()&&(m=!0);n=m?d+this.utility.getX(c):"V"===c[0]?d:this.utility.getX(c);p=m?k+this.utility.getY(c):"H"===c[0]?k:this.utility.getY(c);var v=parseInt(n,10);isNaN(v)||a.push(v);v=parseInt(p,10);isNaN(v)||b.push(v);void 0!=s&&1<=s.length&&c.push(s[0])},this);var q=
...
g.buffer=d;g.buffer=d;a=this.Html5Audio.audioContext.createGain();a.gain.value=.9;g.connect(a);a.connect(this.Html5Audio.audioContext.destination);f.ad&&f.aud&&vApp.user.control.iconAttrManupulate(b,"icon-audioEnaGreen");g.onended=function(){f=JSON.parse(localStorage.getItem("vApp"+b));"undefined"==typeof c&&(console.log("Stack length "+vApp.gObj.video.audio.audioToBePlay[b].length+"; UID "+b+" video Start  Duration :"+g.buffer.duration),clearTimeout(vApp.gObj[b].out),vApp.gObj[b].isplaying=!1,0<
vApp.gObj.video.audio.audioToBePlay[b].length?vApp.gObj.video.audio.getChunks(b):f.ad&&f.aud&&vApp.user.control.iconAttrManupulate(b,"icon-audioEnaOrange"))};g.start();console.log("stack length "+this.audioToBePlay[b].length+" UID "+b+" video Start  Duration :"+g.buffer.duration);vApp.gObj[b].isplaying=!0;"undefined"==typeof c&&(vApp.gObj[b].out=setTimeout(function(){console.log("Stack length "+vApp.gObj.video.audio.audioToBePlay[b].length+"; UID "+b+" video ended OUT :"+g.buffer.duration);vApp.gObj[b].isplaying=
!1;0<vApp.gObj.video.audio.audioToBePlay[b].length&&vApp.gObj.video.audio.getChunks(b)},1E3*g.buffer.duration+10))},calcAverage:function(){var a=new Uint8Array(analyser.frequencyBinCount);analyser.getByteFrequencyData(a);for(var b=0,c=a.length,f=0;f<c;f++)b+=a[f];this.graph.average=b/c},audioInGraph:function(){var a=cthis.video;if("t"==vApp.gObj.uRole){var b=this.graph.height-this.graph.height*this.graph.average/100;a.tempVidCont.beginPath();a.tempVidCont.moveTo(a.tempVid.width-this.graph.width,this.graph.height);
a.tempVidCont.lineTo(a.tempVid.width-this.graph.width,b);a.tempVidCont.lineWidth=this.graph.width;a.tempVidCont.strokeStyle="rgba(247, 25, 77, 1)";a.tempVidCont.closePath();a.tempVidCont.stroke()}},queue:function(a,b){this.hasOwnProperty("audioToBePlay")||(this.audioToBePlay={});this.audioToBePlay.hasOwnProperty(b)||(this.audioToBePlay[b]=[]);this.audioToBePlay[b].push(a)},getChunks:function(a,b){8<this.audioToBePlay[a].length?(this.audioToBePlay[a].length=0,vApp.gObj[a].isplaying=!1):0<this.audioToBePlay[a].length?
(this.playRecordedAudio(this.audioToBePlay[a],a),this.audioToBePlay[a].length=0):vApp.gObj[a].isplaying=!1},replayInit:function(){vApp.storage.getAllObjs(["audioData"],function(){vApp.gObj.video.audio.replay(0,0)})},replay:function(a,b){repMode=!0;var c,f,d;0<this.audioNodes.length&&(c=this.mergeBuffers(this.audioNodes),f=this.Html5Audio.audioContext.currentTime+a,d=this.Html5Audio.audioContext.createBuffer(1,c.length,7800),d.getChannelData(0).set(c),c=this.Html5Audio.audioContext.createBufferSource(),
...
f.tempVid.height),h=vApp.dirtyCorner.encodeRGB(h.data),s=c(vApp.gObj.uid,8),s=new Uint8ClampedArray([11,s[0],s[1],s[2],s[3]]),v=new Uint8ClampedArray(h.length+s.length);v.set(s);v.set(h,s.length);a.sendBinary(v);clearInterval(vApp.gObj.video.smallVid);h=2E3+2500*vApp.gObj.totalUser.length;g!=vApp.gObj.totalUser?(g=vApp.gObj.totalUser.length,s=vApp.gObj.totalUser.indexOf(vApp.gObj.uId),vApp.gObj.video.smallVid=setInterval(b,h+h/g*s)):vApp.gObj.video.smallVid=setInterval(b,h)}function c(a,b){for(var f=
...
k=Math.round(n.localtempCanvas.height/12);m=Math.round(n.localtempCanvas.width/12);var g=n.type;n.localtempCanvas.width=n.video.offsetWidth;n.localtempCanvas.height=n.video.offsetHeight;n.localtempCont.drawImage(n.video,0,0,n.video.offsetWidth,n.video.offsetHeight);var h=n.localtempCont.getImageData(0,0,n.localtempCanvas.width,n.localtempCanvas.height),h=n.dc.encodeRGB(h.data),q=Math.round(n.localtempCanvas.width/m),v=Math.round(n.localtempCanvas.height/k),x=n.getContainerDimension();if("undefined"!=
typeof prvVWidth&&"undefined"!=typeof prvVHeight)var w=a(prvVWidth,4),z=a(prvVHeight,4),A=a(x.width,4);else w=a(n.video.offsetWidth,4),z=a(n.video.offsetHeight,4),A=a(x.width,4);x=a(x.height,4);g=new Uint8ClampedArray(["ss"==g?104:204,w[0],w[1],z[0],z[1],A[0],A[1],x[0],x[1]]);w=new Uint8ClampedArray(h.length+g.length);w.set(g);w.set(h,g.length);d.Worker&&sworker.postMessage({img:h,resize:1,resA:k,resB:m,dw:q,dh:v,offsetWidth:n.video.offsetWidth,offsetHeight:n.video.offsetHeight},[h.buffer]);io.sendBinary(w);
f(w.length/128);changeonresize=0;clearInterval(vApp.clear);vApp.clear=setInterval(c,p)}function h(a){n.localtempCanvas.width=n.video.offsetWidth;n.localtempCanvas.height=n.video.offsetHeight;n.localtempCont.drawImage(n.video,0,0,n.video.offsetWidth,n.video.offsetHeight);a=Math.round(n.localtempCanvas.width/m);var b=Math.round(n.localtempCanvas.height/k),g=n.localtempCont.getImageData(0,0,n.video.offsetWidth,n.video.offsetHeight);d.Worker&&(sworker.postMessage({img:g.data,resA:k,resB:m,dw:a,dh:b,offsetWidth:n.video.offsetWidth,
...
f,d=0;d<b.length;d++)if(f=b[d].getAttribute("data-role"),"t"==f)return!0;return!1},createControl:function(b,f){var d=a.createElement("div");d.id=b+"ControlContainer";d.className="controls";this.createControlDivs(d,b,f);return d},createAssignControl:function(b,d,g){var h=this,k=a.createElement("span");k.id=d+"contrAssignImg";k.innerHTML="&nbsp;";var m=a.createElement("a");m.id=d+"contrAssignAnch";m.className="tooltip";m.appendChild(k);var n=a.createElement("div");n.id=d+"contrAssignCont";n.className=
"controleCont";n.appendChild(m);m=a.getElementById(d+"ControlContainer");null!=m?0>=m.getElementsByClassName("controleCont").length?m.appendChild(n):m.insertBefore(n,m.firstChild):b.appendChild(n);vApp.user.control.changeAttribute(d,k,g,"assign","aRole");k.addEventListener("click",function(){h.control.init.call(h,k)})},createControlDivs:function(b,d,g){var h=this,k=!1,m=localStorage.getItem("vApp"+d);null!=m&&(k=!0,m=JSON.parse(m));var n=localStorage.getItem("reclaim"),n=null!=n&&n?!1:!0,p=vApp.vutil.userIsOrginalTeacher(d);
vApp.vutil.isUserTeacher(d);for(var q=0;q<g.length;q++)if("assign"==g[q]&&p)this.createAssignControl(b,d,n);else if("audio"==g[q]){var r=a.createElement("span");imgName="contrAud";r.id=d+imgName+"Img";r.innerHTML="&nbsp;";var u=a.createElement("a");u.id=d+imgName+"Anch";u.className="tooltip";u.appendChild(r);var s=a.createElement("div");s.id=d+imgName+"Cont";s.className="controleCont";s.appendChild(u);b.appendChild(s);s=k&&m.hasOwnProperty("aud")?m.aud?!0:!1:!0;vApp.user.control.changeAttribute(d,
r,s,"audio","aud");p&&r.addEventListener("click",function(){h.control.init.call(h,r)})}else if("chat"==g[q]){var v=a.createElement("span");imgName="contrChat";v.id=d+imgName+"Img";v.innerHTML="&nbsp;";u=a.createElement("a");u.id=d+imgName+"Anch";u.className="tooltip";u.appendChild(v);s=a.createElement("div");s.id=d+imgName+"Cont";s.className="controleCont";s.appendChild(u);b.appendChild(s);p&&v.addEventListener("click",function(){h.control.init.call(h,v)});s=k&&m.hasOwnProperty("ch")?m.ch?!0:!1:!0;
vApp.user.control.changeAttribute(d,v,s,"chat","ch")}},control:{changeAttribute:function(a,b,d,h,k){d?(b.parentNode.setAttribute("data-title",vApp.lang.getString(h+"Disable")),b.setAttribute("data-"+h+"-disable","false"),b.className="icon-"+h+"Img enable "+h+"Img",vApp.user.control.updateUser(a,k,!0)):("assign"==h&&b.parentNode.classList.remove("tooltip"),b.parentNode.setAttribute("data-title",vApp.lang.getString(h+"Enable")),b.setAttribute("data-"+h+"-disable","true"),b.className="audio"==h?"icon-"+
h+"DisImg block "+h+"DisImg":"icon-"+h+"Img block "+h+"Img",vApp.user.control.updateUser(a,k,!1))},init:function(a){var b=a.id,d=b.indexOf("contr"),d=b.substring(0,d),b=b.split("contr")[1],h=b.indexOf("Img"),b=b.substring(0,h);"Assign"==b?(b="true"==a.getAttribute("data-assign-disable")?!0:!1,b||(this.control.changeAttribute(d,a,b,"assign","aRole"),vApp.user.control._assign(d),vApp.user.control.changeAttrToAssign("block"))):"Chat"==b?("true"==a.getAttribute("data-chat-disable")?(a.className="contrChatBlock",
b="enable",this.control.changeAttribute(d,a,!0,"chat","ch")):(b="block",this.control.changeAttribute(d,a,!1,"chat","ch")),this.control._chat(d,b)):"Aud"==b&&("true"==a.getAttribute("data-audio-disable")?(b="enable",this.control.changeAttribute(d,a,!0,"audio","aud")):(b="block",this.control.changeAttribute(d,a,!1,"audio","aud")),this.control._audio(d,b))},_assign:function(b,d,g){vApp.wb.utility.assignRole();vApp.vutil.removeAppPanel();if(!vApp.vutil.chkValueInLocalStorage("orginalTeacherId")){var h=
a.getElementById("vcanvas");h.className=h.className.replace(/\bteacher\b/," ");h.className="student"}localStorage.setItem("canvasDrwMsg",!0);h=a.getElementById("vAppScreenShareLocalVideo");null!=h&&"VIDEO"==h.tagName&&vApp.vutil.videoTeacher2Student("ScreenShare",!0);var k;"ScreenShare"==vApp.currApp&&(k="ss");"Whiteboard"!=vApp.currApp&&(vApp[k].hasOwnProperty("currentStream")&&vApp[k].currentStream.stop(),vApp[k]="");"undefined"==typeof d&&vApp.wb.utility.beforeSend({assignRole:!0,toUser:b});null==
localStorage.getItem("orginalTeacherId")&&("undefined"==typeof g&&(g=b),b=a.getElementById(g+"ControlContainer").getElementsByClassName("controleCont")[0],b.removeChild(b.firstChild))},_chat:function(a,b){"enable"==b?vApp.wb.utility.beforeSend({enc:!0,toUser:a}):(vApp.user.control.updateUser(a,"ch",!1),vApp.wb.utility.beforeSend({dic:!0,toUser:a}))},_audio:function(a,b){"enable"==b?vApp.wb.utility.beforeSend({ena:!0,toUser:a}):vApp.wb.utility.beforeSend({dia:!0,toUser:a})},audioWidgetEnable:function(){localStorage.setItem("audEnable",
...
"visible"},makeElemEnable:function(a){vApp.vutil.elemHasAnyClass(a.id)?(a.classList.remove("disable"),a.classList.add("enable")):a.className="enable";a=a.getElementsByClassName("ui-chatbox-input-box")[0];null!=a&&(a.disabled=!1)},updateUser:function(a,b,d){var h=localStorage.getItem("vApp"+a),k={};null==h?k.id=a:k=JSON.parse(h);k[b]=d;localStorage["vApp"+k.id]=JSON.stringify(k);return k},audioSign2:function(b,f){if("create"==f){if(null==a.getElementById(b.id+"AudEnableSign")){var g=a.createElement("div");
