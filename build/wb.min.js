...
safariBrowserIssue:"Your browser Safari {vapp1} is not supported, We fully support Chrome  and Firefox"}})(window);(function(d){d.getString=function(a,b){var c=d.vApp.lang.message[a];if("undefined"!=typeof b&&0<b.length)for(var f=0;f<b.length;f++)c=c.replace(new RegExp("{vapp"+(f+1)+"}"),b[f]);return c}})(window);(function(d){var a={init:function(){this.msgBoxClass="msgBox";this.window={};this.virtualWindow={};return this},displayMessage:function(a,c,f,g,d){a="undefined"==typeof d?this.createMsgBox(a,c,f):this.createMsgBox(a,c,f,d);c=document.getElementById("vcanvas");"undefined"!=typeof g?document.getElementById(g).appendChild(a):c.insertBefore(a,c.childNodes[0])},createErrorContainerToBeDeleted:function(){var a=document.getElementById("errorContainer");if(null==a){a=document.createElement("div");a.id="errorContainer";
var c=document.createElement("span");c.className="icon-clearAll";c.id="errorCloseButton";a.appendChild(c);c=document.getElementById("vcanvas");if(null!=c){c.insertBefore(a,c.childNodes[0]);var f=this;a.addEventListener("cllick",function(){f.removeErrorContainer("errorContainer")})}}return a.id},createErrorMsg:function(a,c,f){var g=document.getElementById(c);null==g?(g=document.createElement("div"),g.id=c,g.innerHTML=a):g.innerHTML=a+"<br /> "+g.innerHTML;a=document.getElementById(f);a.parentNode.insertBefore(g,
a);return g.id},removeErrorMsg:function(a,c){var f=document.getElementById(a);if("undefined"!=typeof c){var g=f.innerHTML.split(/<br>|<br\\>/);1<g.length&&(g.shift(),f.innerHTML=g.join())}else f.parentNode.removeChild(f)},removeErrorContainer:function(a){a=document.getElementById(a);a.parentNode.removeChild(a)},customCreateElement:function(a,c,f){a=document.createElement(a);"undefined"!=typeof c&&(a.id=c);"undefined"!=typeof f&&(a.className=f);return a},createMsgBox:function(a,c,f,g){var d=this.customCreateElement("div",
c,f);"undefined"==typeof g&&(f=this.customCreateElement("div",c+"img",f+"img"),d.appendChild(f));c=this.customCreateElement("p",c+"Para");c.innerHTML=a;d.appendChild(c);return d},disappearBox:function(a){a=document.getElementsByClassName(this.msgBoxClass+a);null!=a[0]&&a[0].parentNode.removeChild(a[0])},multiMediaMsg:function(a){if("Firefox"==vApp.system.mybrowser.name){var c=vApp.lang.getString("wbrtcMsgFireFox");this.displayMessage(c,"fireFoxWebrtcCont",this.msgBoxClass+a)}else"Chrome"==vApp.system.mybrowser.name&&
(c=vApp.lang.getString("wbrtcMsgChrome"),this.displayMessage(c,"chormeWebrtcCont",this.msgBoxClass+a))},canvasDrawMsg:function(a){document.getElementById("vcanvas").className="canvasMsgBoxParent";if("Firefox"==vApp.system.mybrowser.name){var c=vApp.lang.getString("canvasDrawMsg");this.displayMessage(c,"canvasDrawMsgContFirefox",this.msgBoxClass+a,"containerWb")}else"Chrome"==vApp.system.mybrowser.name&&(c=vApp.lang.getString("canvasDrawMsg"),this.displayMessage(c,"canvasDrawMsgContChrome",this.msgBoxClass+
a,"containerWb"))},drawLabel:function(a){var c=vApp.lang.getString("drawArea");this.displayMessage(c,"canvasDrawArea",this.msgBoxClass+a,"containerWb",!1)},displayMsgBox:function(a,c){var f=this.customCreateElement("div",a),g=this.customCreateElement("p",a+"Para");g.innerHTML=vApp.lang.getString(c);f.appendChild(g);g=this.customCreateElement("a",a+"Anchor");g.href=d.location;g.innerHTML=vApp.lang.getString("reload");g.onclick=function(){d.location.reload()};f.appendChild(g);g=document.getElementById("vAppCont");
g.insertBefore(f,g.firstChild)},displayServerError:function(a,c){var f=this.customCreateElement("div",a);f.innerHTML=c;var g=document.getElementById("vcanvas");g.parentNode.insertBefore(f,g)},removeElement:function(a){a=document.getElementById(a);null!=a&&a.parentNode.removeChild(a)},disableSSUI:function(){var a=document.getElementById("vAppScreenShareTool");null!=a&&(a.style.opacity="0.5",a.style.pointerEvents="none")},disableLeftAppBar:function(){var a=document.getElementById("vAppOptionsCont");
null!=a&&(a.style.opacity="0.5",a.style.pointerEvents="none")}},a=a.init();count=0;a.window.resizeFinished=function(){var a=0;return function(c,f){clearTimeout(a);a=setTimeout(c,f)}}();a.window.resize=function(){var a=vApp.system.measureResoultion({width:d.innerWidth,height:d.innerHeight});vApp.vutil.setContainerWidth(a);vcan.renderAll()};a.virtualWindow.manupulation=function(a){var c=a.message.virtualWindow;if(c.hasOwnProperty("removeVirtualWindow"))a.fromUser.userid!=wbUser.id&&vApp.wb.utility.removeVirtualWindow("virtualWindow");
else if(c.hasOwnProperty("createVirtualWindow"))c.hasOwnProperty("toolHeight")&&localStorage.setItem("toolHeight",c.toolHeight),a.fromUser.userid!=wbUser.id&&vApp.wb.utility.createVirtualWindow(c.createVirtualWindow);else if(c.hasOwnProperty("shareBrowserWidth")){c.hasOwnProperty("toolHeight")&&localStorage.setItem("toolHeight",c.toolHeight);if(null!=localStorage.getItem("teacherId")){var f=vApp.wb.utility.getWideValueAppliedByCss("commandToolsWrapper");localStorage.setItem("toolHeight",f)}a.fromUser.userid!=
wbUser.id?(null!=localStorage.getItem("teacherId")&&vApp.wb.utility.makeCanvasEnable(),otherBrowser=c.browserRes):myBrowser=vApp.system.measureResoultion({width:d.outerWidth,height:d.innerHeight});"object"==typeof myBrowser&&"object"==typeof otherBrowser&&(myBrowser.width>otherBrowser.width?vApp.wb.gObj.virtualWindow||(vApp.wb.utility.createVirtualWindow(otherBrowser),vApp.wb.gObj.virtualWindow=!0):myBrowser.width<otherBrowser.width&&!vApp.wb.gObj.virtualWindow&&(a=document.getElementById("vcanvas"),
a=vApp.wb.utility.getElementRightOffSet(a),null!=localStorage.getItem("teacherId")?vApp.wb.utility.beforeSend({virtualWindow:{createVirtualWindow:myBrowser-a,toolHeight:f}}):vApp.wb.utility.beforeSend({virtualWindow:{createVirtualWindow:myBrowser-a}})))}};d.view=a})(window);(function(d){var a={init:function(){this.wbRtc={};this.wbRtc.className="webrtcCont";this.mybrowser={};return this},isCanvasSupport:function(a,c,f){return"MSIE"==c?9!=f?!1:!0:d.CanvasRenderingContext2D?!0:!1},isWebSocketSupport:function(a,c,f){return"undefined"==typeof d.WebSocket||"function"!=typeof d.WebSocket&&"object"!=typeof d.WebSocket||!d.WebSocket.hasOwnProperty("OPEN")?!1:!0},isLocalStorageSupport:function(){return void 0!==Storage?!0:!1},isGetUserMediaSupport:function(a,c){navigator.getUserMedia=
...
vApp.gObj.audMouseDown&&("undefined"!=typeof a&&(document.getElementById(a.id+"Button"),a.classList.remove("active"),a.classList.add("deactive")),a=document.getElementById("speakerPressOnce"),a.setAttribute("data-audio-playing","false"),a.className="audioTool deactive",vApp.gObj.audMouseDown=!1,vApp.gObj.video.audio.setAudioStatus("stop"),vApp.wb.utility.beforeSend({sad:!1}))},ab2str:function(a){return String.fromCharCode.apply(null,new Int8Array(a))},str2ab:function(a){for(var b=new ArrayBuffer(a.length),
...
clearInterval(vApp.gObj.video.smallVid)},dispAllVideo:function(a){setTimeout(function(){var b=document.getElementById(a);if(null!=b)for(var b=b.getElementsByTagName("video"),c=0;c<b.length;c++)b[c].play()},1040)},existVideoContainer:function(a){for(var b=document.getElementsByClassName("userVideos"),c=0;c<b.length;c++)if(b[c].id=="video"+a.id)return!0;return!1},handleUserMediaError:function(a){a="object"==typeof a?vApp.lang.getString(a.name):vApp.lang.getString(a);vApp.wb.view.createErrorMsg(a,"errorContainer",
"chatWidget");vApp.user.control.audioWidgetDisable();vApp.wb.view.disappearBox("WebRtc");console.log("navigator.getUserMedia error: ",a)}}}})(window);(function(d){var a={requestPackets:function(a){1<a.length&&(vApp.wb.gObj.myArr=a);vApp.wb.sentReq=!0;return[vApp.wb.gObj.rcvdPackId,a[0].uid]},makeQueue:function(a){vApp.wb.gObj.rcvdPackId!=vApp.wb.gObj.displayedObjId&&(vApp.wb.gObj.packQueue=vApp.wb.gObj.packQueue.concat(a.message.repObj))},sendPackets:function(a,c){if(0==a.message.getMsPckt[0])var f=-1;else for(f=0;f<vApp.wb.gObj.myrepObj.length&&a.message.getMsPckt[0]!=vApp.wb.gObj.myrepObj[f].uid;f++);for(f+=1;f<a.message.getMsPckt[1];f++)c.push(vApp.wb.gObj.myrepObj[f]);
...
"";this.localtempCont.clearRect(0,0,this.localtempCanvas.width,this.localtempCanvas.height);clearInterval(vApp.clear);this.initPrevImage();this.hasOwnProperty("currentStream")&&this.currentStream.stop();vApp.wb.utility.beforeSend({unshareScreen:!0,st:this.type})},removeStream:function(){vApp.vutil.removeClass("audioWidget","fixed");this.localCont.clearRect(0,0,this.localCanvas.width,this.localCanvas.height)},initializeRecorder:function(a){vApp.vutil.addClass("audioWidget","fixed");changeonresize=
...
this.control._audio(d,b))},_assign:function(b,f,d){vApp.wb.utility.assignRole();vApp.vutil.removeAppPanel();if(!vApp.vutil.chkValueInLocalStorage("orginalTeacherId")){var k=a.getElementById("vcanvas");k.className=k.className.replace(/\bteacher\b/," ");k.className="student"}localStorage.setItem("canvasDrwMsg",!0);k=a.getElementById("vAppScreenShareLocalVideo");null!=k&&"VIDEO"==k.tagName&&vApp.vutil.videoTeacher2Student("ScreenShare",!0);var h;"ScreenShare"==vApp.currApp&&(h="ss");"Whiteboard"!=vApp.currApp&&
(vApp[h].hasOwnProperty("currentStream")&&vApp[h].currentStream.stop(),vApp[h]="");"undefined"==typeof f&&vApp.wb.utility.beforeSend({assignRole:!0,toUser:b});null==localStorage.getItem("orginalTeacherId")&&("undefined"==typeof d&&(d=b),b=a.getElementById(d+"ControlContainer").getElementsByClassName("controleCont")[0],b.removeChild(b.firstChild))},_chat:function(a,b){"enable"==b?vApp.wb.utility.beforeSend({enc:!0,toUser:a}):(vApp.user.control.updateUser(a,"ch",!1),vApp.wb.utility.beforeSend({dic:!0,
