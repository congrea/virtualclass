...
virtualclass.vutil.renderWhiteboardObjectsIfAny();io.disconnect();setTimeout(function(){virtualclass.uInfo.userobj.role=virtualclass.gObj.uRole;io.init(virtualclass.uInfo)},500)},renderWhiteboardObjectsIfAny:function(){"object"==typeof virtualclass.wb&&0<virtualclass.wb.vcan.main.children.length&&virtualclass.wb.vcan.renderAll()},createCommandWrapper:function(){var a=document.createElement("div");a.id=virtualclass.gObj.commandToolsWrapperId;var b=document.getElementById(vcan.canvasWrapperId);null!=
b?document.getElementById("containerWb").insertBefore(a,b):document.getElementById("containerWb").appendChild(a);return a},_reclaimRole:function(){virtualclass.vutil.beforeSend({reclaimRole:!0,cf:"reclaimRole"});var a=this;setTimeout(function(){a.reclaimRole();virtualclass.user.control.changeAttrToAssign("enable")},2E3)},reclaimRole:function(){virtualclass.gObj.controlAssign=!1;this.vcResponseAssignRole(virtualclass.gObj.uid,virtualclass.gObj.uid,!0)},vcResponseAssignRole:function(a,b,d){if(a!=b||
...
null!=c?virtualclass.user.createAssignControl(c,a,!0):(d=virtualclass.user.createControl(a,d),b.appendChild(d));localStorage.setItem("aId",a)}virtualclass.vutil.attachClickOutSideCanvas();"mobTab"==virtualclass.system.device&&(virtualclass.vutil.disableVirtualClass(),virtualclass.view.createErrorMsg(virtualclass.lang.getString("supportDesktop"),"errorContainer","chatWidget"))},vcResponseAReclaimRole:function(a,b){if(a!=b){var d=virtualclass.wb.vcan.main.replayObjs[virtualclass.wb.vcan.main.replayObjs.length-
1];d.ac="u";d=d.hasOwnProperty("mtext")?{detail:{cevent:{x:d.x,y:d.y,mtext:d.mtext}}}:{detail:{cevent:{x:d.x,y:d.y}}};d.detail.broadCast=!0;d=new CustomEvent("mouseup",d);vcan.main.canvas.dispatchEvent(d);virtualclass.user.control._assign(b,"notsent",a);virtualclass.user.displayStudentSpeaker(!0);null!=localStorage.getItem("aId")&&localStorage.removeItem("aId");virtualclass.user.control.removeAudioFromParticipate(a);"mobTab"==virtualclass.system.device&&((virtualclass.system.mybrowser.name=8<=virtualclass.system.mybrowser.version)&&
/(iPad)/g.test(navigator.userAgent)&&virtualclass.vutil.enableVirtualClass(),virtualclass.view.removeErrorMsg("errorContainer",!0))}},createReclaimButtonIfNeed:function(){if(roles.isEducator()){var a=virtualclass.vutil.createCommandWrapper();virtualclass.vutil.createReclaimButton(a);return!0}return!1},whoIsTeacher:function(){if(virtualclass.hasOwnProperty("connectedUsers"))for(var a=0;a<virtualclass.connectedUsers.length;a++)if("t"==virtualclass.connectedUsers[a].role||"e"==virtualclass.connectedUsers[a].role)return virtualclass.connectedUsers[a].userid;
