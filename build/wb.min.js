...
0;a<c.length;a++)virtualclass[this.etype].vcAdapter.server.receiveOperation(a,c[a]),this.vcAdapter.trigger("operation",c[a].wrapped.toJSON())},initialiseDataWithEditor:function(a,c,d){b(a.operations);"undefined"!=typeof c&&(virtualclass.currAppEditor?virtualclass.currAppEditorType==d&&(virtualclass.currApp=virtualclass.vutil.capitalizeFirstLetter(d)):virtualclass.currApp=virtualclass.vutil.capitalizeFirstLetter(d));this.removeCodeMirror();this.codemirrorWithLayout(h);virtualclass.dispvirtualclassLayout(virtualclass.currApp);
this.writeBulkDocs(a);this.cm.refresh();this.setReadMode();a=virtualclass.vutil.capitalizeFirstLetter(virtualclass.currApp);if("EditorRich"==a||"EditorCode"==a)virtualclass.previous="virtualclass"+virtualclass.currApp,virtualclass.system.setAppDimension(virtualclass.currApp);a=document.getElementById("virtualclassEditorTool");null!=a&&(a.style.pointerEvents="visible");otAdapter.myrequestData=0},removeEditorData:function(){"object"==typeof this.cm&&("object"==typeof this.vcAdapter&&(this.vcAdapter.operations.length=
0),this.removeCodeMirror(),localStorage.removeItem(this.etype+"_allEditorOperations"),localStorage.removeItem(this.etype+"_edOperationRev"))},saveIntoLocalStorage:function(){if("object"==typeof this.vcAdapter&&0<this.vcAdapter.operations.length){var a=this.getWrappedOperations();localStorage.removeItem(this.etype+"_allEditorOperations");localStorage.setItem(this.etype+"_allEditorOperations",JSON.stringify(a));localStorage.setItem(this.etype+"_edOperationRev",this.cmClient.revision)}}}}})(window);(function(c,a){c.Chat=function(){return{init:function(){this.chatroombox=null;this.counter=0;this.idList=[];a.htab=[];a.htabIndex=[];this.vmstorage={};a("body").footerbar();"false"==localStorage.getItem("init")&&(a("#stickybar").removeClass("maximize").addClass("minimize"),a("#hide_bar input").removeClass("close").addClass("expand"));tabs=a("#tabs").tabs({cache:!0,activeOnAdd:!0});!1==browserSupportsLocalStorage()?alert(lang.sterror):(this.history(),this.UI.privateChatBox.init(),a("ul.tabs").on("click, focus",
