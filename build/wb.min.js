...
a.strokeRect(~~(-(c/2)-b)+.5,~~(-(p/2)-b)+.5,~~(c+d),~~(p+d));!this.hasRotatingPoint||this.hideCorners||this.lockRotation||(b=(this.flipY?p:-p)/2,a.beginPath(),a.moveTo(0,b),a.lineTo(0,b+(this.flipY?this.rotatingPointOffset:-this.rotatingPointOffset)),a.closePath(),a.stroke());a.restore();return this}};b.drawCorners=function(a){if(this.hasControls){var b=this.cornersize,d=b/2,c=this.padding,p=-(this.width/2),s=-(this.height/2),u=b/this.scaleX,w=b/this.scaleY,t=(c+d)/this.scaleY,x=(c+d)/this.scaleX,
q=(c+d-b)/this.scaleX,d=(c+d-b)/this.scaleY,c=this.height;a.save();a.fillStyle=this.cornerColor;a.fillRect(p-x,s-t,u,w);b=p+this.width-x;a.fillRect(b,s-t,u,w);a.fillRect(p-x,s+c+d,u,w);b=p+this.width+q;a.fillRect(b,s+c+d,u,w);b=p+this.width/2-x;a.fillRect(b,s-t,u,w);b=p+this.width/2-x;a.fillRect(b,s+c+d,u,w);b=p+this.width+q;a.fillRect(b,s+c/2-t,u,w);a.fillRect(p-x,s+c/2-t,u,w);this.hasRotatingPoint&&(b=p+this.width/2-x,p=this.flipY?s+c+this.rotatingPointOffset/this.scaleY-w/2:s-this.rotatingPointOffset/
...
this.contextTop.closePath();this.isCurrentlyDrawing=!1;var h=this.utility.min(this.freeDrawingXPoints);c=this.utility.min(this.freeDrawingYPoints);var m=this.utility.max(this.freeDrawingXPoints);g=this.utility.max(this.freeDrawingYPoints);var p=[],s,u,w,t=this.freeDrawingXPoints,x=this.freeDrawingYPoints,q=this.mdTime;p.push("M ",t[0]-h," ",x[0]-c," ",q[0]," ");for(var r=1;s=t[r],u=x[r],w=q[r];r++)p.push("L ",s-h," ",u-c," ",w," ");p=p.join("");if("M 0 0 L 0 0 "!==p)return s=this.freeDrawingXPoints[this.freeDrawingXPoints.length-
1],u=this.freeDrawingYPoints[this.freeDrawingYPoints.length-1],w=new a.Path(p,this),w.mp={},w.mp.x=s,w.mp.y=u,w.init(p),w=d.readyObject(w),w.coreObj.type="freeDrawing",w=w.coreObj,w.fill=null,w.stroke=this.freeDrawingColor,w.strokeWidth=this.freeDrawingLineWidth,w.minX=h,w.minY=c,this.utility.objAdd(w),d=a.utility.setVal(w,"x",h+(m-h)/2),d=a.utility.setVal(d,"y",c+(g-c)/2),d.setCoords(),"object"==typeof b&&this.contextTop.restore(),a.renderAll(this.contextTop),d},utility:{max:function(a,b){if(a&&
...
_render:function(a){var b,d=0;b=0;for(var c=-(this.width/2),p=-(this.height/2),s=0,u=this.path.length;s<u;++s)switch(b=this.path[s],b[0]){case "L":d=b[1];b=b[2];a.lineTo(d+c,b+p);break;case "M":d=b[1],b=b[2],a.moveTo(d+c,b+p)}},replay_render:function(a,b,d,c){var p=y=0;switch(b[0]){case "L":p+=b[1];y+=b[2];a.lineTo(p+d,y+c);a.stroke();break;case "M":p+=b[1],y+=b[2],a.moveTo(p+d,y+c)}},render:function(b,d){b.save();var c=this.transformMatrix;c&&b.transform(c[0],c[1],c[2],c[3],c[4],c[5]);d||a.transform(b,
this);this.overlayFill?b.fillStyle=this.overlayFill:this.fill&&(b.fillStyle=this.fill);this.stroke&&(b.strokeStyle=this.stroke);b.beginPath();this._render(b);this.fill&&b.fill();this.stroke&&(b.strokeStyle=this.stroke,b.lineWidth=this.strokeWidth,b.lineCap=b.lineJoin="round",b.stroke());!d&&this.active&&(this.drawBorders(b),this.hideCorners||this.drawCorners(b));b.restore()},_parsePath:function(){for(var a=[],b,d,c,p=0,s,u=this.path.length;p<u;p++){var w=/\d+\s$/.exec(this.path[p]);null!=w&&(b=this.path[p].indexOf(w),
this.path[p]=this.path[p].substring(0,b));b=this.path[p];d=b.slice(1).trim().replace(/(\d)-/g,"$1###-").split(/\s|,|###/);b=[b.charAt(0)];s=0;for(var t=d.length;s<t;s++)c=parseFloat(d[s]),isNaN(c)||b.push(c);d=b[0].toLowerCase();d=this.commandLengths[d];if(b.length-1>d)for(c=1,s=b.length;c<s;c+=d)null==w?a.push([b[0]].concat(b.slice(c,c+d))):(a.push([b[0]].concat(b.slice(c,c+d))),b.push(w),a.push(b));else null!=w&&b.push(w[0]),a.push(b)}return a},_parseDimensions:function(){var a=[],b=[],c,m,p=!1,
s,u;this.path.forEach(function(d,w){if(" "!=d[3])var q=d.splice(3);"H"!==d[0]&&(c=0===w?this.utility.getX(d):this.utility.getX(this.path[w-1]));"V"!==d[0]&&(m=0===w?this.utility.getY(d):this.utility.getY(this.path[w-1]));d[0]===d[0].toLowerCase()&&(p=!0);s=p?c+this.utility.getX(d):"V"===d[0]?c:this.utility.getX(d);u=p?m+this.utility.getY(d):"H"===d[0]?m:this.utility.getY(d);var r=parseInt(s,10);isNaN(r)||a.push(r);r=parseInt(u,10);isNaN(r)||b.push(r);void 0!=q&&1<=q.length&&d.push(q[0])},this);var w=
...
h="";if("undefined"==typeof c){c=g.getElementsByTagName("textarea");for(var m=0;m<c.length;m++)if(c[m].id==g.id+"textarea"){h=c[m].value;break}}else h=c;a.font="20px Times New Roman";var p=0,s=h.split(/\r?\n/),p=a.measureText(s[0]).width;c=13;for(m=1;m<s.length;m++){c+=13;var u=a.measureText(s[m]).width;u>p&&(p=u)}p/=2;m=(new Date).getTime();a={type:"text",text:h,x:b.measure.x+p,y:b.measure.y+c,fontSize:20,fontWidth:a.measureText(h).width,mp:{x:b.measure.x,y:b.measure.y}};!1==virtualclass.wb.obj.drawTextObj.muser&&
...
_compress:function(c,a,b){if(null==c)return"";var d,f,g={},h={},m="",p="",s="",u=2,w=3,t=2,x=[],q=0,r=0,v;for(v=0;v<c.length;v+=1)if(m=c[v],Object.prototype.hasOwnProperty.call(g,m)||(g[m]=w++,h[m]=!0),p=s+m,Object.prototype.hasOwnProperty.call(g,p))s=p;else{if(Object.prototype.hasOwnProperty.call(h,s)){if(256>s.charCodeAt(0)){for(d=0;d<t;d++)q<<=1,r==a-1?(r=0,x.push(b(q)),q=0):r++;f=s.charCodeAt(0);for(d=0;8>d;d++)q=q<<1|f&1,r==a-1?(r=0,x.push(b(q)),q=0):r++,f>>=1}else{f=1;for(d=0;d<t;d++)q=q<<1|
f,r==a-1?(r=0,x.push(b(q)),q=0):r++,f=0;f=s.charCodeAt(0);for(d=0;16>d;d++)q=q<<1|f&1,r==a-1?(r=0,x.push(b(q)),q=0):r++,f>>=1}u--;0==u&&(u=Math.pow(2,t),t++);delete h[s]}else for(f=g[s],d=0;d<t;d++)q=q<<1|f&1,r==a-1?(r=0,x.push(b(q)),q=0):r++,f>>=1;u--;0==u&&(u=Math.pow(2,t),t++);g[p]=w++;s=String(m)}if(""!==s){if(Object.prototype.hasOwnProperty.call(h,s)){if(256>s.charCodeAt(0)){for(d=0;d<t;d++)q<<=1,r==a-1?(r=0,x.push(b(q)),q=0):r++;f=s.charCodeAt(0);for(d=0;8>d;d++)q=q<<1|f&1,r==a-1?(r=0,x.push(b(q)),
q=0):r++,f>>=1}else{f=1;for(d=0;d<t;d++)q=q<<1|f,r==a-1?(r=0,x.push(b(q)),q=0):r++,f=0;f=s.charCodeAt(0);for(d=0;16>d;d++)q=q<<1|f&1,r==a-1?(r=0,x.push(b(q)),q=0):r++,f>>=1}u--;0==u&&(u=Math.pow(2,t),t++);delete h[s]}else for(f=g[s],d=0;d<t;d++)q=q<<1|f&1,r==a-1?(r=0,x.push(b(q)),q=0):r++,f>>=1;u--;0==u&&(Math.pow(2,t),t++)}f=2;for(d=0;d<t;d++)q=q<<1|f&1,r==a-1?(r=0,x.push(b(q)),q=0):r++,f>>=1;for(;;)if(q<<=1,r==a-1){x.push(b(q));break}else r++;return x.join("")},decompress:function(c){return null==
c?"":""==c?null:LZString._decompress(c.length,32768,function(a){return c.charCodeAt(a)})},_decompress:function(c,a,b){var d=[],f=4,g=4,h=3,m="",p=[],s,u,w,t,x,q=LZString._f,r=b(0),v=a,B=1;for(s=0;3>s;s+=1)d[s]=s;m=0;w=Math.pow(2,2);for(t=1;t!=w;)u=r&v,v>>=1,0==v&&(v=a,r=b(B++)),m|=(0<u?1:0)*t,t<<=1;switch(m){case 0:m=0;w=Math.pow(2,8);for(t=1;t!=w;)u=r&v,v>>=1,0==v&&(v=a,r=b(B++)),m|=(0<u?1:0)*t,t<<=1;x=q(m);break;case 1:m=0;w=Math.pow(2,16);for(t=1;t!=w;)u=r&v,v>>=1,0==v&&(v=a,r=b(B++)),m|=(0<u?
1:0)*t,t<<=1;x=q(m);break;case 2:return""}s=d[3]=x;for(p.push(x);;){if(B>c)return"";m=0;w=Math.pow(2,h);for(t=1;t!=w;)u=r&v,v>>=1,0==v&&(v=a,r=b(B++)),m|=(0<u?1:0)*t,t<<=1;switch(x=m){case 0:m=0;w=Math.pow(2,8);for(t=1;t!=w;)u=r&v,v>>=1,0==v&&(v=a,r=b(B++)),m|=(0<u?1:0)*t,t<<=1;d[g++]=q(m);x=g-1;f--;break;case 1:m=0;w=Math.pow(2,16);for(t=1;t!=w;)u=r&v,v>>=1,0==v&&(v=a,r=b(B++)),m|=(0<u?1:0)*t,t<<=1;d[g++]=q(m);x=g-1;f--;break;case 2:return p.join("")}0==f&&(f=Math.pow(2,h),h++);if(d[x])m=d[x];else if(x===
...
f!=r.video.offsetHeight)a=1}else d=r.video.offsetWidth,f=r.video.offsetHeight;1==a?setTimeout(h,2E3):t(r.type)}function m(a){switch(!0){case 300>=a||"undefined"==typeof a:v=300;break;case 3E3>=a:v=a;break;case 5E3>=a:v=3E3;break;default:v=5E3}}function h(){console.log("RESIZE");if(roles.hasControls()){d=r.video.offsetWidth;f=r.video.offsetHeight;x=Math.round(r.localtempCanvas.height/12);q=Math.round(r.localtempCanvas.width/12);var t=r.type;r.localtempCanvas.width=r.video.offsetWidth;r.localtempCanvas.height=
r.video.offsetHeight;r.localtempCont.drawImage(r.video,0,0,r.video.offsetWidth,r.video.offsetHeight);var w=r.localtempCont.getImageData(0,0,r.localtempCanvas.width,r.localtempCanvas.height),w=r.dc.encodeRGB(w.data),K=Math.round(r.localtempCanvas.width/q),M=Math.round(r.localtempCanvas.height/x),C,R,A,U;U=r.getContainerDimension();"undefined"!=typeof d&&"undefined"!=typeof f?(C=b(d,4),R=b(f,4)):(C=b(r.video.offsetWidth,4),R=b(r.video.offsetHeight,4));A=b(U.width,4);U=b(U.height,4);t=new Uint8ClampedArray(["ss"==
t?104:204,C[0],C[1],R[0],R[1],A[0],A[1],U[0],U[1]]);C=new Uint8ClampedArray(w.length+t.length);C.set(t);C.set(w,t.length);c.Worker&&sworker.postMessage({img:w,resize:1,resA:x,resB:q,dw:K,dh:M,offsetWidth:r.video.offsetWidth,offsetHeight:r.video.offsetHeight},[w.buffer]);ioAdapter.sendBinary(C);m(C.length/128);a=0;clearInterval(virtualclass.clear);virtualclass.clear=setInterval(g,v)}}function t(a){r.localtempCanvas.width=r.video.offsetWidth;r.localtempCanvas.height=r.video.offsetHeight;r.localtempCont.drawImage(r.video,
0,0,r.video.offsetWidth,r.video.offsetHeight);a=Math.round(r.localtempCanvas.width/q);var b=Math.round(r.localtempCanvas.height/x),d=r.localtempCont.getImageData(0,0,r.video.offsetWidth,r.video.offsetHeight);c.Worker&&(sworker.postMessage({img:d.data,resA:x,resB:q,dw:a,dh:b,offsetWidth:r.video.offsetWidth,offsetHeight:r.video.offsetHeight,type:r.type},[d.data.buffer]),sworker.onmessage=function(a){if(1==a.data.needFullScreen){a=virtualclass.getDataFullScreen(r.type);ioAdapter.sendBinary(a);var b=
a.length/128}else null!=a.data.masterSlice&&(ioAdapter.sendBinary(a.data.masterSlice),b=a.data.masterSlice.length/128);m(b);clearInterval(virtualclass.clear);virtualclass.clear=setInterval(g,v)});clearInterval(virtualclass.clear)}var x=Math.round(this.localtempCanvas.height/12),q=Math.round(this.localtempCanvas.width/12),r=this;virtualclass.hasOwnProperty("wholeImage")&&clearInterval(virtualclass.wholeImage);virtualclass.hasOwnProperty("clear")&&clearInterval(virtualclass.clear);var v=1E3;virtualclass.getDataFullScreen=
...
var m=a.createElement("div");m.id=b+c+"Cont";m.className="controleCont";m.appendChild(h);return[m,g]},createAssignControl:function(b,c,g,h){var m=this,p=this.createControllerElement(c,"contrAssign"),s=p[0],u=p[1],p=a.getElementById(c+"ControlContainer");null!=p?0>=p.getElementsByClassName("controleCont").length?p.appendChild(s):p.insertBefore(s,p.firstChild):b.appendChild(s);virtualclass.user.control.changeAttribute(c,u,g,"assign","aRole");"undefined"!=typeof h&&(u.className+=" currTeacher");u.addEventListener("click",
function(){m.control.init.call(m,u)})},createControlDivs:function(a,b,c){var h=this,m=!1,p=localStorage.getItem("virtualclass"+b);if(null!=p&&(m=!0,p=JSON.parse(p),p.hasOwnProperty("currTeacher")))if(virtualclass.gObj[b+"currTeacher"]={},!0==p.currTeacher){var s=virtualclass.user.control.currTeacherAlready=!0;virtualclass.gObj[b+"currTeacher"].ct=!0}else virtualclass.gObj[b+"currTeacher"].ct=!1;var u=roles.isEducator()?!1:!0,w=virtualclass.vutil.userIsOrginalTeacher(b);virtualclass.vutil.isUserTeacher(b);
for(var t=0;t<c.length;t++)if("assign"==c[t]&&w)"undefined"!=typeof s?this.createAssignControl(a,b,u,s):this.createAssignControl(a,b,u);else if("audio"==c[t]){var x=this.createControllerElement(b,"contrAud"),q=x[0],r=x[1];a.appendChild(q);q=m&&p.hasOwnProperty("aud")?p.aud?!0:!1:!0;virtualclass.user.control.changeAttribute(b,r,q,"audio","aud");w&&r.addEventListener("click",function(){h.control.init.call(h,r)})}else if("chat"==c[t]){var x=this.createControllerElement(b,"contrChat"),q=x[0],v=x[1];a.appendChild(q);
...
b.prototype.confirmOk=function(){return!0};b.prototype.waitMsg=function(){var a=document.getElementById("about-modal");virtualclass.popup.open(a);this.hideAllPopups();document.getElementById("waitMsgCont").style.display="block"};b.prototype.hideAllPopups=function(){for(var a=document.getElementsByClassName("popupWindow"),b=0;b<a.length;b++)a[b].style.display="none"};b.prototype.closePopup=function(){virtualclass.popup.closeElem();"true"==document.getElementById("sessionEndMsgCont").dataset.displaying&&
this.sesseionEndWindow()};return b}(window);(function(c){c.converter=function(){function a(a,b){for(var c=a.replace(/[^A-Za-z0-9\+\/]/g,""),h=c.length,m=b?Math.ceil((3*h+1>>2)/b)*b:3*h+1>>2,p=new Uint8Array(m),s,u=0,w=0,t=0;t<h;t++){s=t&3;var x=c.charCodeAt(t),u=u|(64<x&&91>x?x-65:96<x&&123>x?x-71:47<x&&58>x?x+4:43===x?62:47===x?63:0)<<6*(3-s);if(3===s||1===h-t){for(s=0;3>s&&w<m;s++,w++)p[w]=u>>>(16>>>s&24)&255;u=0}}return p}function b(a){return 26>a?a+65:52>a?a+71:62>a?a-4:62===a?43:63===a?47:65}return{base64EncArrInt:function(a){for(var b=
...
"height: 100%; min-height: 1px")],"CodeMirror-hscrollbar");a(d);a(n);F(d,"scroll",function(){d.clientHeight&&b(d.scrollTop,"vertical")});F(n,"scroll",function(){n.clientWidth&&b(n.scrollLeft,"horizontal")});this.checkedOverlay=!1;O&&8>W&&(this.horiz.style.minHeight=this.vert.style.minWidth="18px")}function r(){}function v(a){a.display.scrollbars&&(a.display.scrollbars.clear(),a.display.scrollbars.addClass&&Gb(a.display.wrapper,a.display.scrollbars.addClass));a.display.scrollbars=new c.scrollbarModel[a.options.scrollbarStyle](function(b){a.display.wrapper.insertBefore(b,
...
b.first+b.size-1),c=a.display;if(b.length!=c.lineNumChars){var d=c.measure.appendChild(D("div",[D("div",b)],"CodeMirror-linenumber CodeMirror-gutter-elt")),n=d.firstChild.offsetWidth,d=d.offsetWidth-n;c.lineGutter.style.width="";c.lineNumInnerWidth=Math.max(n,c.lineGutter.offsetWidth-d)+1;c.lineNumWidth=c.lineNumInnerWidth+d;c.lineNumChars=c.lineNumInnerWidth?b.length:-1;c.lineGutter.style.width=c.lineNumWidth+"px";s(a);return!0}return!1}function R(a,b){return String(a.lineNumberFormatter(b+a.firstLineNumber))}
...
b.rest[d],b,c,!1)}function Qd(a,b,c,d,n){if(b.widgets){var f=Oa(c),g=0;for(b=b.widgets;g<b.length;++g){var h=b[g],m=D("div",[h.node],"CodeMirror-linewidget");h.handleMouseEvents||m.setAttribute("cm-ignore-events","true");var p=h,q=m,r=d;if(p.noHScroll){(c.alignable||(c.alignable=[])).push(q);var s=r.wrapperWidth;q.style.left=r.fixedPos+"px";p.coverGutter||(s-=r.gutterTotalWidth,q.style.paddingLeft=r.gutterTotalWidth+"px");q.style.width=s+"px"}p.coverGutter&&(q.style.zIndex=5,q.style.position="relative",
...
"paste"==n,h=f.splitLines(b),m=null;if(g&&1<d.ranges.length)if(oa&&oa.join("\n")==b){if(0==d.ranges.length%oa.length)for(var m=[],p=0;p<oa.length;p++)m.push(f.splitLines(oa[p]))}else h.length==d.ranges.length&&(m=nc(h,function(a){return[a]}));for(p=d.ranges.length-1;0<=p;p--){var q=d.ranges[p],r=q.from(),s=q.to();q.empty()&&(c&&0<c?r=z(r.line,r.ch-c):a.state.overwrite&&!g&&(s=z(s.line,Math.min(E(f,s.line).text.length,s.ch+P(h).length))));q=a.curOp.updateInput;r={from:r,to:s,text:m?m[p%m.length]:h,
origin:n||(g?"paste":a.state.cutIncoming?"cut":"+input")};lb(a.doc,r);ga(a,"inputRead",a,r)}b&&!g&&Sd(a,b);mb(a);a.curOp.updateInput=q;a.curOp.typing=!0;a.state.pasteIncoming=a.state.cutIncoming=!1}function Td(a,b){var c=a.clipboardData&&a.clipboardData.getData("text/plain");if(c)return a.preventDefault(),ma(b,function(){lc(b,c,0,null,"paste")}),!0}function Sd(a,b){if(a.options.electricChars&&a.options.smartIndent)for(var c=a.doc.sel,d=c.ranges.length-1;0<=d;d--){var n=c.ranges[d];if(!(100<n.head.ch||
...
c.sel.ranges[g],m=h.empty();if(m||a.options.showCursorWhenSelecting){var p=a,q=n,r=Ha(p,h.head,"div",null,null,!p.options.singleCursorHeightPerLine),s=q.appendChild(D("div","\u00a0","CodeMirror-cursor"));s.style.left=r.left+"px";s.style.top=r.top+"px";s.style.height=Math.max(0,r.bottom-r.top)*p.options.cursorHeight+"px";r.other&&(p=q.appendChild(D("div","\u00a0","CodeMirror-cursor CodeMirror-secondarycursor")),p.style.display="",p.style.left=r.other.left+"px",p.style.top=r.other.top+"px",p.style.height=
.85*(r.other.bottom-r.other.top)+"px")}m||wf(a,h,f)}return d}function wf(a,b,c){function d(a,b,G,c){0>b&&(b=0);b=Math.round(b);c=Math.round(c);h.appendChild(D("div",null,"CodeMirror-selected","position: absolute; left: "+a+"px; top: "+b+"px; width: "+(null==G?q-a:G)+"px; height: "+(c-b)+"px"))}function n(b,c,N){var S=E(g,b),n=S.text.length,f,h;xf(ta(S),c||0,null==N?n:N,function(g,m,ja){var r=uc(a,z(b,g),"div",S,"left"),s,fc;g==m?(s=r,ja=fc=r.left):(s=uc(a,z(b,m-1),"div",S,"right"),"rtl"==ja&&(ja=
r,r=s,s=ja),ja=r.left,fc=s.right);null==c&&0==g&&(ja=p);3<s.top-r.top&&(d(ja,r.top,null,r.bottom),ja=p,r.bottom<s.top&&d(ja,r.bottom,null,s.top));null==N&&m==n&&(fc=q);if(!f||r.top<f.top||r.top==f.top&&r.left<f.left)f=r;if(!h||s.bottom>h.bottom||s.bottom==h.bottom&&s.right>h.right)h=s;ja<p+1&&(ja=p);d(ja,s.top,fc-ja,s.bottom)});return{start:f,end:h}}var f=a.display,g=a.doc,h=document.createDocumentFragment(),m=he(a.display),p=m.left,q=Math.max(f.sizerWidth,Ka(a)-f.sizer.offsetLeft)-m.right,f=b.from();
b=b.to();if(f.line==b.line)n(f.line,f.ch,b.ch);else{var r=E(g,f.line),m=E(g,b.line),m=Da(r)==Da(m),f=n(f.line,f.ch,m?r.text.length+1:null).end;b=n(b.line,m?0:null,b.ch).start;m&&(f.top<b.top-2?(d(f.right,f.top,null,f.bottom),d(p,b.top,b.left,b.bottom)):d(f.right,f.top,b.left-f.right,f.bottom));f.bottom<b.top&&d(p,f.bottom,null,b.top)}c.appendChild(h)}function ed(a){if(a.state.focused){var b=a.display;clearInterval(b.blinker);var c=!0;b.cursorDiv.style.visibility="";0<a.options.cursorBlinkRate?b.blinker=
...
b.cache[f];else{b.rect||(b.rect=b.view.text.getBoundingClientRect());if(!b.hasHeights){var g=b.view,h=b.rect,m=a.options.lineWrapping,p=m&&Ka(a);if(!g.measure.heights||m&&g.measure.width!=p){var q=g.measure.heights=[];if(m)for(g.measure.width=p,g=g.text.firstChild.getClientRects(),m=0;m<g.length-1;m++){var p=g[m],r=g[m+1];2<Math.abs(p.bottom-r.bottom)&&q.push((p.bottom+r.top)/2-h.top)}q.push(h.bottom-h.top)}b.hasHeights=!0}g=d;m=Zd(b.map,c,g);d=m.node;h=m.start;p=m.end;c=m.collapse;var s;if(3==d.nodeType){for(q=
0;4>q;q++){for(;h&&Pb(b.line.text.charAt(m.coverStart+h));)--h;for(;m.coverStart+p<m.coverEnd&&Pb(b.line.text.charAt(m.coverStart+p));)++p;if(O&&9>W&&0==h&&p==m.coverEnd-m.coverStart)s=d.parentNode.getBoundingClientRect();else if(O&&a.options.lineWrapping){var v=Za(d,h,p).getClientRects();s=v.length?v["right"==g?v.length-1:0]:hd}else s=Za(d,h,p).getBoundingClientRect()||hd;if(s.left||s.right||0==h)break;p=h;h-=1;c="right"}if(O&&11>W){if(v=window.screen&&null!=screen.logicalXDPI&&screen.logicalXDPI!=
screen.deviceXDPI)null!=id?v=id:(q=qa(a.display.measure,D("span","x")),v=q.getBoundingClientRect(),q=Za(q,0,1).getBoundingClientRect(),v=id=1<Math.abs(v.left-q.left));v&&(v=screen.logicalXDPI/screen.deviceXDPI,q=screen.logicalYDPI/screen.deviceYDPI,s={left:s.left*v,right:s.right*v,top:s.top*q,bottom:s.bottom*q})}}else 0<h&&(c=g="right"),s=a.options.lineWrapping&&1<(v=d.getClientRects()).length?v["right"==g?v.length-1:0]:d.getBoundingClientRect();!(O&&9>W)||h||s&&(s.left||s.right)||(s=(s=d.parentNode.getClientRects()[0])?
{left:s.left,right:s.left+Eb(a.display),top:s.top,bottom:s.bottom}:hd);v=s.top-b.rect.top;d=s.bottom-b.rect.top;h=(v+d)/2;g=b.view.measure.heights;for(q=0;q<g.length-1&&!(h<g[q]);q++);c={left:("right"==c?s.right:s.left)-b.rect.left,right:("left"==c?s.left:s.right)-b.rect.left,top:q?g[q-1]:0,bottom:g[q]};s.left||s.right||(c.bogus=!0);a.options.singleCursorHeightPerLine||(c.rtop=v,c.rbottom=d);a=c;a.bogus||(b.cache[f]=a)}return{left:a.left,right:a.right,top:n?a.rtop:a.top,bottom:n?a.rbottom:a.bottom}}
...
(n.ch>f.from.ch||n.ch==f.from.ch&&0<n.xRel))n=Q(d=f.to.line);else return n}function Bf(a,b,c,d,n){function f(d){d=Ha(a,z(c,d),"line",b,p);h=!0;if(g>d.bottom)return d.left-m;if(g<d.top)return d.left+m;h=!1;return d.left}var g=n-za(b),h=!1,m=2*a.display.wrapper.clientWidth,p=vc(a,b),q=ta(b),s=b.text.length;n=xc(b);var r=yc(b),v=f(n),u=h,t=f(r),w=h;if(d>t)return wc(c,r,w,1);for(;;){if(q?r==n||r==nd(b,n,1):1>=r-n){q=d<v||d-v<=t-d?n:r;for(d-=q==n?v:t;Pb(b.text.charAt(q));)++q;return wc(c,q,q==n?u:w,-1>
d?-1:1<d?1:0)}var x=Math.ceil(s/2),B=n+x;if(q)for(var B=n,Z=0;Z<x;++Z)B=nd(b,B,1);Z=f(B);if(Z>d){r=B;t=Z;if(w=h)t+=1E3;s=x}else n=B,v=Z,u=h,s-=x}}function Sa(a){if(null!=a.cachedTextHeight)return a.cachedTextHeight;if(null==$a){$a=D("pre");for(var b=0;49>b;++b)$a.appendChild(document.createTextNode("x")),$a.appendChild(D("br"));$a.appendChild(document.createTextNode("x"))}qa(a.measure,$a);b=$a.offsetHeight/50;3<b&&(a.cachedTextHeight=b);Ua(a.measure);return b||1}function Eb(a){if(null!=a.cachedCharWidth)return a.cachedCharWidth;
...
b);F(this.horiz,"mousedown",b)},clear:function(){var a=this.horiz.parentNode;a.removeChild(this.horiz);a.removeChild(this.vert)}},q.prototype);r.prototype=ra({update:function(){return{bottom:0,right:0}},setScrollLeft:function(){},setScrollTop:function(){},clear:function(){}},r.prototype);c.scrollbarModel={"native":q,"null":r};U.prototype.signal=function(a,b){pa(a,b)&&this.events.push(arguments)};U.prototype.finish=function(){for(var a=0;a<this.events.length;a++)aa.apply(null,this.events[a])};var z=
...
(P(v).to-=t[0].length,v.push(new b(0,d-t[0].length,d)));2==v[0].level&&v.unshift(new b(1,v[0].to,v[0].to));v[0].level!=P(v).level&&v.push(new b(v[0].level,d,d));return v}}();c.version="5.5.1";return c}();(function(c){c(CodeMirror)})(function(c){var a=/^(\s*)(>[> ]*|[*+-]\s|(\d+)([.)]))(\s*)/,b=/^(\s*)(>[> ]*|[*+-]|(\d+)[.)])(\s*)$/,d=/[*+-]\s/;c.commands.newlineAndIndentContinueMarkdownList=function(f){if(f.getOption("disableInput"))return c.Pass;for(var g=f.listSelections(),h=[],m=0;m<g.length;m++){var p=g[m].head,s=f.getStateAfter(p.line),u=!1!==s.list,w=0!==s.quote,t=f.getLine(p.line),s=a.exec(t);if(!g[m].empty()||!u&&!w||!s){f.execCommand("newlineAndIndent");return}b.test(t)?(f.replaceRange("",
{line:p.line,ch:0},{line:p.line,ch:p.ch+1}),h[m]="\n"):(p=s[1],u=s[5],s=d.test(s[2])||0<=s[2].indexOf(">")?s[2]:parseInt(s[3],10)+1+s[4],h[m]="\n"+p+s+u)}f.replaceSelections(h)}});(function(c){c(CodeMirror)})(function(c){c.defineMode("xml",function(a,b){function d(a,b){function c(d){b.tokenize=d;return d(a,b)}var d=a.next();if("<"==d){if(a.eat("!"))return a.eat("[")?a.match("CDATA[")?c(h("atom","]]\x3e")):null:a.match("--")?c(h("comment","--\x3e")):a.match("DOCTYPE",!0,!0)?(a.eatWhile(/[\w\._\-]/),c(m(1))):null;if(a.eat("?"))return a.eatWhile(/[\w\._\-]/),b.tokenize=h("meta","?>"),"meta";da=a.eat("/")?"closeTag":"openTag";b.tokenize=f;return"tag bracket"}if("&"==d)return(a.eat("#")?
...
c)}return"meta"}}function p(a,b,c){this.prev=a.context;this.tagName=b;this.indent=a.indented;this.startOfLine=c;if(A.doNotIndent.hasOwnProperty(b)||a.context&&a.context.noIndent)this.noIndent=!0}function s(a){a.context&&(a.context=a.context.prev)}function u(a,b){for(var c;a.context;){c=a.context.tagName;if(!A.contextGrabbers.hasOwnProperty(c)||!A.contextGrabbers[c].hasOwnProperty(b))break;s(a)}}function w(a,b,c){return"openTag"==a?(c.tagStart=b.column(),t):"closeTag"==a?x:w}function t(a,b,c){if("word"==
a)return c.tagName=b.current(),X="tag",v;X="error";return t}function x(a,b,c){if("word"==a){a=b.current();c.context&&c.context.tagName!=a&&A.implicitlyClosed.hasOwnProperty(c.context.tagName)&&s(c);if(c.context&&c.context.tagName==a)return X="tag",q;X="tag error";return r}X="error";return r}function q(a,b,c){if("endTag"!=a)return X="error",q;s(c);return w}function r(a,b,c){X="error";return q(a,b,c)}function v(a,b,c){if("word"==a)return X="attribute",B;if("endTag"==a||"selfcloseTag"==a){b=c.tagName;
...
b||[];c=c||[];if(a.length!==this.baseLength)throw Error("The operation's base length must be equal to the string's length.");for(var d=[],f=0,w,t,x=0,q=this.ops,r=0,v=q.length;r<v;r++){var B=q[r];if(B.isRetain()){if(x+B.chars>a.length)throw Error("Operation can't retain more characters than are left in the string.");d[f++]=a.slice(x,x+B.chars);for(w=0;w<B.chars;w++){var L=b[x+w]||{},K={};for(t in L)K[t]=L[t],g.assert(!1!==K[t]);for(t in B.attributes)!1===B.attributes[t]?delete K[t]:K[t]=B.attributes[t],
...
c.baseLength)throw Error("Both operations have to have the same base length");for(var d=new a,f=new a,g=b.clone().ops,w=c.clone().ops,t=0,x=0,q=g[t++],r=w[x++];"undefined"!==typeof q||"undefined"!==typeof r;)if(q&&q.isInsert())d.insert(q.text,q.attributes),f.retain(q.text.length),q=g[t++];else if(r&&r.isInsert())d.retain(r.text.length),f.insert(r.text,r.attributes),r=w[x++];else{if("undefined"===typeof q)throw Error("Cannot transform operations: first operation is too short.");if("undefined"===typeof r)throw Error("Cannot transform operations: first operation is too long.");
var v;if(q.isRetain()&&r.isRetain()){var B=a.transformAttributes(q.attributes,r.attributes);q.chars>r.chars?(v=r.chars,q.chars-=r.chars,r=w[x++]):q.chars===r.chars?(v=r.chars,q=g[t++],r=w[x++]):(v=q.chars,r.chars-=q.chars,q=g[t++]);d.retain(v,B[0]);f.retain(v,B[1])}else if(q.isDelete()&&r.isDelete())q.chars>r.chars?(q.chars-=r.chars,r=w[x++]):q.chars===r.chars?(q=g[t++],r=w[x++]):(r.chars-=q.chars,q=g[t++]);else if(q.isDelete()&&r.isRetain())q.chars>r.chars?(v=r.chars,q.chars-=r.chars,r=w[x++]):q.chars===
r.chars?(v=r.chars,q=g[t++],r=w[x++]):(v=q.chars,r.chars-=q.chars,q=g[t++]),d["delete"](v);else if(q.isRetain()&&r.isDelete())q.chars>r.chars?(v=r.chars,q.chars-=r.chars,r=w[x++]):q.chars===r.chars?(v=q.chars,q=g[t++],r=w[x++]):(v=q.chars,r.chars-=q.chars,q=g[t++]),f["delete"](v);else throw Error("The two operations aren't compatible");}return[d,f]};return a}();c.TextOperation=TextOperation})(window);(function(c){var a=function(a){function c(a,b){this.wrapped=a;this.meta=b}function f(a,b){for(var c in a)a.hasOwnProperty(c)&&(b[c]=a[c])}function g(a,b){return a&&"object"===typeof a&&"function"===typeof a.transform?a.transform(b):a}c.prototype.apply=function(){return this.wrapped.apply.apply(this.wrapped,arguments)};c.prototype.invert=function(){var a=this.meta;return new c(this.wrapped.invert.apply(this.wrapped,arguments),a&&"object"===typeof a&&"function"===typeof a.invert?a.invert.apply(a,arguments):
...
for(b in a)if(a.hasOwnProperty(b)){var c=f.getClientObject(b);a[b].name&&c.setName(a[b].name);(c=a[b].selection)?f.clients[b].updateSelection(f.transformSelection(Selection.fromJSON(c))):f.clients[b].removeSelection()}},reconnect:function(){f.serverReconnect()}})}function g(a){return a[a.length-1]}var h=c.Client,m=c.Cursor,p=c.UndoManager,s=c.TextOperation,u=c.WrappedOperation;a.prototype.invert=function(){return new a(this.cursorAfter,this.cursorBefore)};a.prototype.compose=function(c){return new a(this.cursorBefore,
...
a)};a.prototype.listItem=function(a){vceditor.utils.assert(!1===a||"u"===a||"o"===a||"t"===a||"tc"===a);return this.cloneWithNewAttribute_(d.LIST_TYPE,a)};a.prototype.getIndent=function(){return this.attributes[d.LINE_INDENT]||0};a.prototype.getAlign=function(){return this.attributes[d.LINE_ALIGN]||0};a.prototype.getListItem=function(){return this.attributes[d.LIST_TYPE]||!1};return a}();c.LineFormatting=a})(window);(function(c){var a=function(){function a(b){return b===h.ORDERED?"</ol>":"</ul>"}function d(a,b){return a===b||a===h.TODO&&b===h.TODOCHECKED||a===h.TODOCHECKED&&b===h.TODO}var f=c.utils,g=c.AttributeConstants,h=c.LineFormatting.LIST_TYPE;return function(c,p){for(var s="",u=!0,w=[],t=!1,x=!0,q=!0,r=0,v=c.ops[r],B=!1;v;){f.assert(v.isInsert());var L=v.attributes;if(u){var u=!1,K=0,M=null,C="left";g.LINE_SENTINEL in L&&(K=L[g.LINE_INDENT]||0,M=L[g.LIST_TYPE]||null,C=L[g.LINE_ALIGN]||"left");M&&(K=K||
1);t?(s+="</li>",t=!1):x||(q&&(s+="<br/>"),s+="</div>");x=!1;for(f.assert(0<=K,"Indent must not be negative.");w.length>K||K===w.length&&null!==M&&!d(M,w[w.length-1]);)s+=a(w.pop());for(;w.length<K;)q=M||h.UNORDERED,B=M==h.TODO||M==h.TODOCHECKED||B,s+=q===h.ORDERED?"<ol>":q===h.UNORDERED?"<ul>":'<ul class="vceditor-todo">',w.push(q);q="left"!==C?' style="text-align:'+C+'"':"";if(M){t="";switch(M){case h.TODOCHECKED:t=' class="vceditor-checked"';break;case h.TODO:t=' class="vceditor-unchecked"'}s+=
"<li"+t+q+">";t=!0}else s+="<div"+q+">";q=!0}if(g.LINE_SENTINEL in L)v=c.ops[++r];else if(g.ENTITY_SENTINEL in L){for(M=0;M<v.text.length;M++)K=vceditor.Entity.fromAttributes(L),K=p.exportToElement(K),s+=K.outerHTML;v=c.ops[++r]}else{var K=M="",R;for(R in L){var C=L[R],A,U;R===g.BOLD||R===g.ITALIC||R===g.UNDERLINE||R===g.STRIKE?(f.assert(!0===C),A=U=R):R===g.FONT_SIZE?(A='span style="font-size: '+C,A+="string"!==typeof C||-1===C.indexOf("px",C.length-2)?'px"':'"',U="span"):R===g.FONT?(A='span style="font-family: '+
C+'"',U="span"):R===g.COLOR?(A='span style="color: '+C+'"',U="span"):R===g.BACKGROUND_COLOR?(A='span style="background-color: '+C+'"',U="span"):f.log(!1,"Encountered unknown attribute while rendering html: "+R);A&&(M+="<"+A+">");U&&(K="</"+U+">"+K)}var C=v.text,da=C.indexOf("\n");0<=da?(u=!0,v=da<C.length-1?new vceditor.TextOp("insert",C.substr(da+1),L):c.ops[++r],C=C.substr(0,da)):v=c.ops[++r];C=C.replace(/  +/g,function(a){return Array(a.length+1).join("\u00a0")}).replace(/^ /,"\u00a0").replace(/ $/,
"\u00a0");0<C.length&&(q=!1);s+=M+C.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\u00a0/g,"&nbsp;")+K}}t?s+="</li>":x||(q&&(s+="&nbsp;"),s+="</div>");for(;0<w.length;)s+=a(w.pop());B&&(s='<style>ul.vceditor-todo { list-style: none; margin-left: 0; padding-left: 0; } ul.vceditor-todo > li { padding-left: 1em; text-indent: -1em; } ul.vceditor-todo > li:before { content: "\\2610"; padding-right: 5px; } ul.vceditor-todo > li.vceditor-checked:before { content: "\\2611"; padding-right: 5px; }</style>\n'+
...
function(b){a.applyOperationToCodeMirror(b,this.rtcm)};a.prototype.registerUndo=function(a){this.cm.undo=a};a.prototype.registerRedo=function(a){this.cm.redo=a};a.prototype.invertOperation=function(a){for(var b=0,c=this.rtcm.codeMirror,d,m,x=new g,q=0;q<a.wrapped.ops.length;q++){var r=a.wrapped.ops[q];if(r.isRetain())if(f(r.attributes))x.retain(r.chars),b+=r.chars;else for(d=this.rtcm.getAttributeSpans(b,b+r.chars),m=0;m<d.length;m++){var v={},B;for(B in r.attributes){var L=r.attributes[B],K=d[m].attributes[B];
!1===L?K&&(v[B]=K):L!==K&&(v[B]=K||!1)}x.retain(d[m].length,v);b+=d[m].length}else if(r.isInsert())x["delete"](r.text.length);else if(r.isDelete()){v=c.getRange(c.posFromIndex(b),c.posFromIndex(b+r.chars));d=this.rtcm.getAttributeSpans(b,b+r.chars);for(m=L=0;m<d.length;m++)x.insert(v.substr(L,d[m].length),d[m].attributes),L+=d[m].length;b+=r.chars}}return new h(x,a.meta.invert())};return a}();c.Client=RichTextCodeMirrorAdapter})(window);otAdapter=function(){function c(a,b){b=b.charAt(0).toLowerCase()+b.slice(1);var c=Vceditor.getvcEditor();if(a.operations&&a.revision>a.operations.length){var f=[];f[a.revision-a.operations.length-1]=null;this.operations=f.concat(a.operations)}else this.operations=a.operations?a.operations:[];this.server=new c.Server(a.doc,this.operations);this.trigger=function(a){this.callbacks[a].apply(this,Array.prototype.slice.call(arguments,1))};this.teacherOT=function(a){a=this.doOT(a);"undefined"!=typeof a&&
...
this.onCursorActivity_);this.changeId_=0;this.outstandingChanges_={};this.dirtyLines_=[]}function b(a,b){return a.line-b.line||a.ch-b.ch}function d(a){if(0===a.length)return 0;for(var b=0,c=0;c<a.length;c++)b+=a[c].length;return b+a.length-1}function f(a){this.attributes=a||{}}function g(a,b){var c=a[b];a[b]=function(){c.apply(a,arguments)}}var h=c.AnnotationList,m=c.Span,p=c.utils,s=c.AttributeConstants,u={c:"color",bc:"background-color",fs:"font-size",li:function(a){return"padding-left: "+40*a+
...
c[a]=b}),this.updateCurrentAttributes_())};a.prototype.updateTextAttributes=function(a,b,c,d,g){var h=[],p=a,t=this;this.annotationList_.updateSpan(new m(a,b-a),function(a,b){var m={},q;for(q in a.attributes)m[q]=a.attributes[q];m[s.LINE_SENTINEL]&&!g||c(m);q={};var r={};t.computeChangedAttributes_(a.attributes,m,q,r);var u;a:{for(u in q){u=!1;break a}u=!0}u||h.push({start:p,end:p+b,attributes:q,attributesInverse:r,origin:d});p+=b;return new f(m)});0<h.length&&this.trigger("attributesChange",this,
...
"string"!==typeof f&&(f+="px");var h=f.toString().toLowerCase().replace(/[^a-z0-9-_]/g,"-"),g=g+("-"+h);u[d]&&(w[d]||(w[d]={}),w[d][h]||(w[d][h]=!0,h=u[d],f="function"===typeof h?h(f):h+": "+f,this.addStyleWithCSS_((d==s.LINE_INDENT?"pre."+g:"."+g)+" { "+f+" }")))}b=b+" "+g}}return b};a.prototype.markEntity_=function(a){for(var b=c.Entity.fromAttributes(a.annotation.attributes),d=this.codeMirror,f=this,g=[],h=0;h<a.length;h++){var m=d.posFromIndex(a.pos+h),p=d.posFromIndex(a.pos+h+1),s={collapsed:!0,
atomic:!0,inclusiveLeft:!1,inclusiveRight:!1},t=this.createEntityHandle_(b,a.pos),u=this.entityManager_.renderToElement(b,t);u&&(s.replacedWith=u);m=d.markText(m,p,s);g.push(m);t.setMarker(m)}a.attachObject({clear:function(){for(var a=0;a<g.length;a++)g[a].clear()},update:function(a){a=c.Entity.fromAttributes(a);for(var b=0;b<g.length;b++)f.entityManager_.updateElement(a,g[b].replacedWith)}});this.queueRefresh_()};a.prototype.queueRefresh_=function(){var a=this;this.refreshTimer_||(this.refreshTimer_=
...
t+x+"]","g"),"");c.push(f)}b.update(b.from,b.to,c)}};a.prototype.onCodeMirrorChange_=function(a,b){if("object"===typeof b.from){for(var c=[];b;)c.push(b),b=b.next;b=c}for(var c=this.convertCoordinateSystemForChanges_(b),d=[],g=0;g<c.length;g++){var h=c[g],p=h.start,s=h.text,t=h.removed,u=h.origin;if(0<t.length){for(var w=this.annotationList_.getAnnotatedSpansForSpan(new m(p,t.length)),x=0,X=0;X<w.length;X++){var V=w[X];d.push({start:p,end:p+V.length,removedAttributes:V.annotation.attributes,removed:t.substr(x,
V.length),attributes:{},text:"",origin:h.origin});x+=V.length}this.annotationList_.removeSpan(new m(p,t.length))}0<s.length&&("+input"===h.origin||"paste"===h.origin?h=this.currentAttributes_||{}:u in this.outstandingChanges_?(h=this.outstandingChanges_[u].attributes,u=this.outstandingChanges_[u].origOrigin,delete this.outstandingChanges_[u]):h={},this.annotationList_.insertAnnotatedSpan(new m(p,s.length),new f(h)),d.push({start:p,end:p,removedAttributes:{},removed:"",text:s,attributes:h,origin:u}))}this.markLineSentinelCharactersForChanges_(b);
...
c.line-f.from.line))+1+c.ch}}for(var f=this,g=function(a){return f.codeMirror.indexFromPos(a)},h=[],m=a.length-1;0<=m;m--){var p=a[m],g=c(g,p),s=g(p.from),t=p.removed.join("\n"),u=p.text.join("\n");h.unshift({start:s,end:s+t.length,removed:t,text:u,origin:p.origin})}return h};a.prototype.markLineSentinelCharactersForChanges_=function(a){for(var b=Number.MAX_VALUE,c=-1,d=0;d<a.length;d++){var f=a[d],g=f.from.line;if(1<f.removed.length||0<=f.removed[0].indexOf(t))b=Math.min(b,g),c=Math.max(c,g);1<f.text.length?
...
p[s.LIST_TYPE],u=p[s.LINE_INDENT]||0;for(t&&0===u&&(u=1);u>=d.length;)d.push(1);"o"===t?(g=this.makeOrderedListElement_(d[u]),d[u]++):"u"===t?(g=this.makeUnorderedListElement_(),d[u]=1):"t"===t?(g=this.makeTodoListElement_(!1,m),d[u]=1):"tc"===t&&(g=this.makeTodoListElement_(!0,m),d[u]=1);m=this.getClassNameForAttributes_(p);""!==m&&this.codeMirror.addLineClass(a,"text",m);d=d.slice(0,u+1)}d={inclusiveLeft:!0,collapsed:!0};g&&(d.replacedWith=g);h=f.markText({line:a,ch:b},{line:a,ch:c},d);h.isForLineSentinel=
!0};a.prototype.makeOrderedListElement_=function(a){return p.elt("div",a+".",{"class":"vceditor-list-left"})};a.prototype.makeUnorderedListElement_=function(){return p.elt("div","\u2022",{"class":"vceditor-list-left"})};a.prototype.toggleTodo=function(a){var b=s.LIST_TYPE,c=this.getCurrentLineAttributes_(),d;b in c&&("t"===c[b]||"tc"===c[b])?"t"===c[b]?d="tc":"tc"===c[b]&&(d=a?"t":!1):d="t";this.setLineAttribute(b,d)};a.prototype.makeTodoListElement_=function(a,b){var c={type:"checkbox","class":"vceditor-todo-left"};
...
this.updateCurrentAttributes_();return this.currentAttributes_};a.prototype.updateCurrentAttributes_=function(){var a=this.codeMirror,b=a.indexFromPos(a.getCursor("anchor")),d=a.indexFromPos(a.getCursor("head")),a=d;if(b>d){for(;a<this.end();){b=this.getRange(a,a+1);if("\n"!==b&&b!==t)break;a++}a<this.end()&&a++}else for(;0<a;){b=this.getRange(a-1,a);if("\n"!==b&&b!==t)break;a--}b=this.annotationList_.getAnnotatedSpansForPos(a);this.currentAttributes_={};a={};0<b.length&&!(s.LINE_SENTINEL in b[0].annotation.attributes)?
a=b[0].annotation.attributes:1<b.length&&(c.utils.assert(!(s.LINE_SENTINEL in b[1].annotation.attributes),"Cursor can't be between two line sentinel characters."),a=b[1].annotation.attributes);for(var f in a)"l"!==f&&"lt"!==f&&"li"!==f&&0!==f.indexOf(s.ENTITY_SENTINEL)&&(this.currentAttributes_[f]=a[f])};a.prototype.getCurrentLineAttributes_=function(){var a=this.codeMirror,b=a.getCursor("anchor"),a=a.getCursor("head"),c=a.line;0===a.ch&&b.line<a.line&&c--;return this.getLineAttributes_(c)};a.prototype.getLineAttributes_=
...
d(c.sentinelConstants.LINE_SENTINEL_CHARACTER,b.formatting.attributes);for(var f=0;f<b.textPieces.length;f++)d(b.textPieces[f]);d("\n")}for(var g=[],h=0;h<b.length;h++)b[h]instanceof c.Line?f(b[h]):d(b[h]);return g};c=c||{};c.Vceditor=function(a){function b(a,c,f,g){if(!(this instanceof b))return new b(a,c,f,g);if(!q&&!r)throw Error("Couldn't find CodeMirror or ACE.  Did you forget to include codemirror.js or ace.js?");if(q&&c instanceof q)this.codeMirror_=this.editor_=c,a=this.codeMirror_.getValue(),
...
this.addPoweredByLogo_();this.codeMirror_&&this.codeMirror_.refresh();this.getOption("userColor",d("JqrwCaZm29-CLg-Pfz2"));this.entityManager_=new w;a=g.revision;c=[];this.codeMirror_?(this.richTextCodeMirror_=new m(this.codeMirror_,this.entityManager_,{cssPrefix:"vceditor-"}),this.editorAdapter_=new h(this.richTextCodeMirror_)):this.editorAdapter_=new s(this.ace_);f.hasOwnProperty("richTextToolbar")?(virtualclass.editorRich.vcAdapter=new otAdapter(g,"EditorRich"),virtualclass.editorRich.cmClient=
