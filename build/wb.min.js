...
time:Date.now()});ioAdapter.mustSend({pptMsg:a,cf:"ppt",cfpt:"setPEvent"})},fragmentshown:function(a){ioAdapter.mustSend({pptMsg:a,cf:"ppt",cfpt:"setPEvent"})},fragmenthidden:function(a){ioAdapter.mustSend({pptMsg:a,cf:"ppt",cfpt:"setPEvent"})},overviewshown:function(a){ioAdapter.mustSend({pptMsg:a,cf:"ppt",cfpt:"setPEvent"})},overviewhidden:function(a){ioAdapter.mustSend({pptMsg:a,cf:"ppt",cfpt:"setPEvent"})},removeControls:function(){setTimeout(function(){document.getElementById("pptiframe").contentWindow.postMessage(JSON.stringify({method:"configure",
...
args:[a.pptMsg.state]}),"*")}},setPEvent:function(a){null!=document.getElementById("pptiframe")&&virtualclass.sharePt.setSlideState(a.pptMsg);this.state=a.pptMsg.state}},onPptMsgReceive:function(a){if("undefined"!=typeof a.ppt&&"undefined"!=typeof a.ppt.startFrom){virtualclass.sharePt.startFromFlag=1;var b=document.getElementById("pptiframe");null!=b&&(0>a.ppt.init.search("postMessage")?b.setAttribute("src",a.ppt.init+"?postMessage=true&postMessageEvents=true"):b.setAttribute("src",a.ppt.init),virtualclass.sharePt.startFrom=
[a.ppt.startFrom.indexh,a.ppt.startFrom.indexv,a.ppt.startFrom.indexf])}if("undefined"!=typeof a.pptMsg){var b=document.getElementById("pptiframe"),d=document.getElementById("pptMessageLayout");null!=b&&(b.onload=function(){roles.hasView()&&null!=b.contentWindow&&"undefined"!=typeof a.pptMsg.state&&b.contentWindow.postMessage(JSON.stringify({method:"setState",args:[a.pptMsg.state]}),"*")});null!=d&&(d.style.display="none");a.hasOwnProperty("cfpt")&&"undefined"!=typeof a.cfpt&&"undefined"!=typeof virtualclass.sharePt.cfpt[a.cfpt]&&
virtualclass.sharePt.cfpt[a.cfpt].call(virtualclass.sharePt,a)}},displayFrame:function(){virtualclass.system.setAppDimension(virtualclass.currApp);var a=document.getElementById(virtualclass.sharePt.UI.id);a.classList.contains("pptSharing")||a.classList.add("pptSharing")},setSlideUrl:function(a){virtualclass.sharePt.studentPpt=0;console.log("PPT:- invoke setSlideUrl");this.autoSlideTime=this.autoSlideFlag=this.viewFlag=0;var b=document.getElementById("pptiframe");null!=b&&b.parentNode.removeChild(b);
console.log("create iframe from setslide url");this.UI.createIframe();document.getElementById("iframecontainer").style.display="block";b=document.getElementById("pptiframe");b.setAttribute("src",0>a.pptMsg.search("postMessage")?a.pptMsg+"?postMessage=true&postMessageEvents=true":a.pptMsg);console.log("test url is set");this.pptUrl=a.pptMsg},setSlideState:function(a){var b=document.getElementById("pptiframe").contentWindow,d=[a.state.indexh,a.state.indexv,a.state.indexf],c=[a.state];switch(a.eventName){case "ready":b.postMessage(JSON.stringify({method:"setState",
args:c}),"*");break;case "slidechanged":virtualclass.sharePt.studentPpt=a;console.log("test PPt:-  changed");b.postMessage(JSON.stringify({method:"slide",args:d}),"*");break;case "autoslidepaused":this.autoSlideFlag=1;b.postMessage(JSON.stringify({method:"toggleAutoSlide"}),"*");break;case "autoslideresumed":this.autoSlideFlag=1;b.postMessage(JSON.stringify({method:"toggleAutoSlide"}),"*");break;case "fragmentshown":b.postMessage(JSON.stringify({method:"slide",args:d}),"*");break;case "fragmenthidden":b.postMessage(JSON.stringify({method:"slide",
args:d}),"*");break;case "overviewshown":b.postMessage(JSON.stringify({method:"setState",args:c}),"*");break;case "overviewhidden":b.postMessage(JSON.stringify({method:"setState",args:c}),"*"),b.postMessage(JSON.stringify({method:"slide",args:d}),"*");default:console.log("There is no event is occured")}},toProtocolRelativeUrl:function(){var a=virtualclass.sharePt.urlValue;return 0<=a.indexOf("http")?a.replace(/http:\/\/|https:\/\//,"//"):"//"+a},initNewPpt:function(){virtualclass.sharePt.autoSlideTime=
0;virtualclass.sharePt.autoSlideFlag=0;virtualclass.sharePt.localStoragFlag=0;virtualclass.sharePt.startFromFlag=0;virtualclass.sharePt.eventsObj=[];virtualclass.sharePt.state={indexh:0,indexv:0,indexf:0};virtualclass.sharePt.stateLocalStorage={};localStorage.removeItem("autoSlideTime");localStorage.removeItem("autoSlideFlag");null==document.getElementById("iframecontainer")&&(console.log("call of iframe creater from onclick event handler"),virtualclass.sharePt.UI.createIframe());var a=document.getElementById(virtualclass.sharePt.UI.id);
a.classList.contains("pptSharing")||a.classList.add("pptSharing");virtualclass.sharePt.urlValue=document.getElementById("presentationurl").value;virtualclass.sharePt.urlValue=virtualclass.sharePt.toProtocolRelativeUrl();virtualclass.sharePt.isUrlip(virtualclass.sharePt.urlValue)?virtualclass.sharePt.setPptUrl(virtualclass.sharePt.urlValue):0<virtualclass.sharePt.urlValue.search("<iframe")?(a=virtualclass.sharePt.extractUrl(virtualclass.sharePt.urlValue),virtualclass.sharePt.setPptUrl(a)):virtualclass.sharePt.validURLWithDomain(virtualclass.sharePt.urlValue)?
(a=virtualclass.sharePt.cleanupUrl(virtualclass.sharePt.urlValue),virtualclass.sharePt.setPptUrl(virtualclass.sharePt.completeUrl(a))):(console.log("Invalid Url"),alert("Invalid URL"));virtualclass.system.setAppDimension()},cleanupUrl:function(a){var b=a.search("#");0<b&&(a=a.slice(0,b));return a},setPptUrl:function(a){console.log("test+set ppt url function");document.getElementById("iframecontainer").style.display="block";var b=document.getElementById("pptiframe");console.log("completeurl"+a);virtualclass.sharePt.pptUrl=
a+"?postMessage=true&postMessageEvents=true";b.setAttribute("src",virtualclass.sharePt.pptUrl);ioAdapter.mustSend({pptMsg:"displayframe",cf:"ppt",user:"all",cfpt:"displayframe"});ioAdapter.mustSend({pptMsg:a,cf:"ppt",user:"all",cfpt:"setUrl"});b.style.display="visible"},validURLWithDomain:function(a){return/^\/\/(\w+:{0,1}\w*)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%!\-\/]))?/.test(a)},completeUrl:function(a){0<a.search("slides.com")&&0>a.search("embed")&&(a+="/embed");return a},extractUrl:function(a){if(0<
a.search("src")){var b=a.match(/"(.*?)"/);if(0<b.length)return JSON.parse(b[0])}return a},isUrlip:function(a){a.slice(0,2);return/(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)/.test(a)},saveIntoLocalStorage:function(a){if(this.validURLWithDomain(a.metaData.init)||this.isUrlip(a.metaData.init))localStorage.setItem("prevApp",JSON.stringify(a)),console.log("ppt_state",a.metaData.startFrom),
localStorage.setItem("ppt_state",JSON.stringify(a.metaData.startFrom)),console.log("savinlocal"),localStorage.setItem("pptUrl",JSON.stringify(a.metaData.init)),localStorage.setItem("autoSlideTime",JSON.stringify(virtualclass.sharePt.autoSlideTime)),localStorage.setItem("autoSlideFlag",JSON.stringify(virtualclass.sharePt.autoSlideFlag))},initTeacherLayout:function(){var a=document.getElementById("pptiframe");if(null!=document.getElementById("pptiframe")){var b={controls:!0,keyboard:!0,progress:!0,
touch:!0},d;virtualclass.sharePt.autoSlideTime&&virtualclass.sharePt.autoSlideFlag?d=virtualclass.sharePt.autoSlideTime:virtualclass.sharePt.autoSlideFlag&&(d=6E3);"undefined"!=typeof d&&1E3<d&&(b.autoSlide=d);a.contentWindow.postMessage(JSON.stringify({method:"configure",args:[b]}),"*");a.contentWindow.postMessage(JSON.stringify({method:"toggleAutoSlide"}),"*")}a=document.getElementById("pptMessageLayout");null!=a&&(a.style.display="none");virtualclass.sharePt.UI.createUrlContainer();document.getElementById("urlcontainer").style.display=
"block";virtualclass.sharePt.eventsObj=[]},initStudentLayout:function(){var a=document.getElementById("pptiframe");virtualclass.sharePt.eventsObj=[];virtualclass.sharePt.UI.messageDisplay();null!=document.getElementById("pptiframe")?(""!=a.src&&virtualclass.sharePt.hideElement("pptMessageLayout"),a.contentWindow.postMessage(JSON.stringify({method:"configure",args:[{controls:!1,autoSlide:0,autoSlideStoppable:!0,keyboard:!1,progress:!1,touch:!1}]}),"*")):virtualclass.sharePt.displayElement("pptMessageLayout");
virtualclass.sharePt.hideElement("urlcontainer")},hideElement:function(a){a=document.getElementById(a);null!=a&&(a.style.display="none")},displayElement:function(a){a=document.getElementById(a);null!=a&&(a.style.display="block")},attachEvent:function(a,b,d){a=document.getElementById(a);null!=a&&a.addEventListener(b,d)},UI:{id:"virtualclassSharePresentation","class":"virtualclass",container:function(){console.log("test create main  container with id virtualclassSharePresentation");var a=document.getElementById(this.id);
null!=a&&a.parentNode.removeChild(a);a=document.createElement("div");a.id=this.id;a.className=this["class"];var b=document.getElementById(virtualclass.rWidgetConfig.id);console.log(b.parentNode);b.parentNode.insertBefore(a,b)},createIframe:function(){var a=document.getElementById("iframecontainer");null!=a&&a.parentNode.removeChild(a);console.log("test create ppt  iframe");a=document.getElementById("virtualclassSharePresentation");if(null!=a){var b=document.createElement("div");a.appendChild(b);b.style.display=
"none"}b=document.createElement("div");b.setAttribute("id","iframecontainer");b.style.height="100%";b.style.width="100%";a.insertBefore(b,a.firstChild);b.style.display="none";a=document.getElementById("iframecontainer");b=document.createElement("iframe");a.appendChild(b);b.setAttribute("id","pptiframe");b.style.height="100%";b.style.width="100%"},createUrlContainer:function(){var a=document.getElementById("virtualclassSharePresentation");if(null==document.getElementById("urlcontainer")){var b=document.createElement("div");
b.setAttribute("id","urlcontainer");a.appendChild(b);a=document.createElement("input");a.setAttribute("id","presentationurl");a.setAttribute("placeholder",virtualclass.lang.getString("ppturl"));b.appendChild(a);a=document.createElement("input");a.setAttribute("type","submit");a.setAttribute("id","submitpurl");a.setAttribute("value","submit");b.appendChild(a)}},messageDisplay:function(){if(null==document.getElementById("pptMessageLayout")){var a=document.getElementById("virtualclassSharePresentation"),
