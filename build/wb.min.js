...
b=this.createElement("div","vAppOptionsCont");a.insertBefore(b,a.firstChild);this.createDiv(vApp.wbConfig.id+"Tool","whiteboard",b,vApp.wbConfig.classes);this.createDiv(vApp.ssConfig.id+"Tool","screenshare",b,vApp.ssConfig.classes);vApp.gObj.hasOwnProperty("errNotScreenShare")&&vApp.wb.view.disableSSUI();"t"==vApp.gObj.uRole&&this.createDiv(vApp.appSessionEnd+"Tool","sessionend",b,"appOptions")},createDiv:function(a,b,c,f,g){var d=document.createElement("a");d.href="#";var h=document.createElement("div");
...
errwebworker:"Web worker",errwebaudio:"Web audio",errtypedarray:"Typed array",errscreenshare:"Screen share",operaBrowserIssue:"is Partially Supported, you will not be able to share your screen with Learners, We Fully Support Chrome and Firefox",commonBrowserIssue:"is not supported, We support Chrome and Firefox.",chFireBrowsersIssue:" needs to updated, We support Chrome 40 and Firefox 35.",studentSafariBrowserIssue:"does not able to share your Cam with other Users, We Fully Support Chrome  and Firefox."}})(window);(function(d){d.getString=function(a){return d.vApp.lang.message[a]}})(window);(function(d){var a={init:function(){this.msgBoxClass="msgBox";this.window={};this.virtualWindow={};return this},displayMessage:function(a,c,f,g,d){a="undefined"==typeof d?this.createMsgBox(a,c,f):this.createMsgBox(a,c,f,d);c=document.getElementById("vcanvas");"undefined"!=typeof g?document.getElementById(g).appendChild(a):c.insertBefore(a,c.childNodes[0])},createErrorContainerToBeDeleted:function(){var a=document.getElementById("errorContainer");if(null==a){a=document.createElement("div");a.id="errorContainer";
...
g)},removeElement:function(a){a=document.getElementById(a);null!=a&&a.parentNode.removeChild(a)},disableSSUI:function(){var a=document.getElementById("vAppScreenShareTool");null!=a&&(a.style.opacity="0.5",a.style.pointerEvents="none")}},a=a.init();count=0;a.window.resizeFinished=function(){var a=0;return function(c,f){clearTimeout(a);a=setTimeout(c,f)}}();a.window.resize=function(){var a=vApp.system.measureResoultion({width:d.innerWidth,height:d.innerHeight});vApp.vutil.setContainerWidth(a);vcan.renderAll()};
a.virtualWindow.manupulation=function(a){var c=a.message.virtualWindow;if(c.hasOwnProperty("removeVirtualWindow"))a.fromUser.userid!=wbUser.id&&vApp.wb.utility.removeVirtualWindow("virtualWindow");else if(c.hasOwnProperty("createVirtualWindow"))c.hasOwnProperty("toolHeight")&&localStorage.setItem("toolHeight",c.toolHeight),a.fromUser.userid!=wbUser.id&&vApp.wb.utility.createVirtualWindow(c.createVirtualWindow);else if(c.hasOwnProperty("shareBrowserWidth")){c.hasOwnProperty("toolHeight")&&localStorage.setItem("toolHeight",
c.toolHeight);if(null!=localStorage.getItem("teacherId")){var f=vApp.wb.utility.getWideValueAppliedByCss("commandToolsWrapper");localStorage.setItem("toolHeight",f)}a.fromUser.userid!=wbUser.id?(null!=localStorage.getItem("teacherId")&&vApp.wb.utility.makeCanvasEnable(),otherBrowser=c.browserRes):myBrowser=vApp.system.measureResoultion({width:d.outerWidth,height:d.innerHeight});"object"==typeof myBrowser&&"object"==typeof otherBrowser&&(myBrowser.width>otherBrowser.width?vApp.wb.gObj.virtualWindow||
...
d.innerHeight+"px"},isSystemCompatible:function(){if(0<vApp.error.length){var a=1<vApp.error.length?vApp.error.join("<br />"):vApp.error[0];vApp.wb.view.createErrorMsg(a,"errorContainer","chatWidget");vApp.gObj.hasOwnProperty("audIntDisable")&&vApp.user.control.audioWidgetDisable();vApp.gObj.hasOwnProperty("errNotDesktop")&&(vApp.user.control.audioWidgetDisable(),vApp.vutil.disableVirtualClass())}},chkValueInLocalStorage:function(a){return null===localStorage.getItem(a)?!1:localStorage[a]},setContainerWidth:function(a){var b=
"vAppWhiteboard";"undefined"!=typeof vApp.previous&&(b=vApp.previous);var c=document.getElementById(b);if("ScreenShare"==vApp.currApp){var f=document.getElementById("vAppOptionsCont");if(null!=f){var d=vcan.utility.getElementOffset(f);leftSideBarWidth=f.offsetWidth+d.x}else leftSideBarWidth=0}else leftSideBarWidth=0;a.width-=5+leftSideBarWidth+0;c.style.width=a.width+"px";"vAppWhiteboard"!=b&&(f=document.getElementById(b+"Local"),a.width-=10,c.style.width=a.width,f.style.width=a.width+"px",vApp.vutil.setScreenInnerTagsWidth(b))},
setScreenInnerTagsWidth:function(a){document.getElementById(a);document.getElementById(a+"Local");document.getElementById(a+"LocalVideo")},makeActiveApp:function(a,b){if("undefined"!=typeof b){b+="Tool";var c=vApp.wb.utility.removeClassFromElement(b,"active");document.getElementById(b).className=c}document.getElementById(a+"Tool").className+=" active"},initInstallChromeExt:function(a){"EXTENSION_UNAVAILABLE"==a.name&&(console.log("ask for inline installation"),chrome.webstore.install("https://chrome.google.com/webstore/detail/ijhofagnokdeoghaohcekchijfeffbjl",
function(a){d.location.reload()},function(a){alert(a)}))},removeAppPanel:function(){var a=document.getElementById("vAppOptionsCont");null!=a&&a.parentNode.removeChild(a)},removeTempVideo:function(a){a=document.getElementById(a);a.parentNode.removeChild(a)},createLocalTempVideo:function(a,b){if("string"==typeof a||"String"==typeof a)a=document.getElementById(a);var c=vApp.vutil.createDOM("div",b),f=vApp.vutil.createDOM("canvas",b+"Video");c.appendChild(f);a.appendChild(c)},initLocCanvasCont:function(a){var b=
"ScreenShare"==vApp.currApp?"ss":"wss";vApp[b].localtempCanvas=document.getElementById(a);vApp[b].localtempCont=vApp[b].localtempCanvas.getContext("2d")},videoTeacher2Student:function(a,b){var c=a,f=document.getElementById("vApp"+a+"LocalVideo");if(null!=f&&"VIDEO"==f.tagName){var d=document.createElement("canvas");d.id=f.id;d.width=f.offsetWidth;d.height=f.offsetHeight;f.parentNode.replaceChild(d,f);"ScreenShare"==c&&(c="ss");"undefined"!=typeof b||"undefined"==typeof c||"ss"!=c&&"wss"!=c||(vApp[c].localCanvas=
...
b=this.preNumValidateTwo(b);return parseInt(a+b)},preNumValidateTwo:function(a){a=a.toString();if(1==a.length)return"0"+a;if(2==a.length)return a},elemHasAnyClass:function(a){a=document.getElementById(a);return null!=a?"undefined"!=typeof a.classList?!0:!1:!1},userIsOrginalTeacher:function(a){return null!=localStorage.getItem("orginalTeacherId")?!0:!1},isUserTeacher:function(a){return null!=localStorage.getItem("teacherId")?!0:!1},initDisableAudVid:function(){vApp.gObj.audIntDisable=!0;vApp.gObj.vidIntDisable=
!0},initDisableVirtualClass:function(){this.initDisableAudVid();vApp.gObj.errNotDesktop=!0},disableVirtualClass:function(){var a=document.getElementById("vAppCont");a.style.opacity=.6;a.style.pointerEvents="none"}};d.onbeforeunload=function(){if("undefined"!=typeof vApp.storage.wholeStoreData){var a=JSON.parse(vApp.storage.wholeStoreData);a.beforeRefresh=!0;vApp.storage.wholeStore(a,"put")}localStorage.removeItem("otherRole");vApp.wb.utility.userIds=[];vApp.gObj.hasOwnProperty("audIntDisable")||vApp.gObj.video.audio.studentNotSpeak();
