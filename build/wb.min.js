...
a.className="icon-arrow-up");vApp.chat.chatroombox.chatroom("option","boxManager").toggleBox()}else alert("sss"),0==d("div#chat_room").length&&(a=document.createElement("div"),a.id="chat_room",document.body.appendChild(a),vApp.chat.chatroombox=d("#chat_room").chatroom({id:"chat_room",user:{name:"test"},title:lang.chatroom_header,offset:"20px",messageSent:function(a,b){d("#chat_room").chatroom("option","boxManager").addMsg(a.name,b)}}),vApp.gObj.hasOwnProperty("chatEnable")&&!vApp.gObj.chatEnable&&
(a=document.getElementById("chatrm"),null!=a&&vApp.user.control.makeElemDisable(a)))});uiFooterbarUserlisttab=(this.uiFooterbarUserlisttab=d("<div></div>")).addClass("vmchat_bar_button").prop("id","user_list").appendTo(a);uiFooterbarUserlistContent=(this.uiFooterbarUserlistContent=d('<div class="inner_bt"></div>')).appendTo(uiFooterbarUserlisttab);uiFooterbarUserlistIcon=(this.uiFooterbarUserlistIcon=d('<div id="usertab_icon"></div>')).appendTo(uiFooterbarUserlistContent);uiFooterbarUserlistText=
(this.uiFooterbarUserlistText=d('<div id="usertab_text" class="tooltip close " data-title="'+vApp.lang.getString("maxUserList")+'"></div>')).appendTo(uiFooterbarUserlistContent).text("Private Chat").click(function(){vApp.gObj.video.dispAllVideo("chat_div");0<Object.keys(io.uniquesids).length&&(d(this).hasClass("close")?(d(this).addClass("open"),d(this).removeClass("close"),d("#usertab_toogle_icon").addClass("icon-arrow-down"),d("#usertab_toogle_icon").removeClass("close icon-arrow-up"),d(this).attr("data-title",
vApp.lang.getString("miniUserList"))):(d(this).addClass("close"),d(this).removeClass("open"),d("#usertab_toogle_icon").addClass("icon-arrow-up"),d("#usertab_toogle_icon").removeClass("icon-arrow-down"),d(this).attr("data-title",vApp.lang.getString("maxUserList"))),d("#chat_div").memberlist("option","boxManager").toggleBox())});uiFooterbartabCont=(this.uiFooterbartabCont=d("<div></div>")).attr("id","tabs").addClass("tabs-bottom").appendTo(a);uiFooterbartabs=(this.uiFooterbartabs=d('<ul class="tabs"></ul>')).appendTo(uiFooterbartabCont);
