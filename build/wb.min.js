...
a.keyCode||46==a.keyCode?(a=virtualclass.wb.vcan,""!=a.main.currObj&&(console.log("Delete whiteboard obj:- Invoke the command"),a=virtualclass.wb.utility.removeSelectedItem(a.main.currObj),virtualclass.vutil.beforeSend({repObj:[a],cf:"repObj"}))):27==a.keyCode&&"object"==typeof virtualclass.wb&&virtualclass.wb.obj.drawTextObj.finalizeTextIfAny()},removeSelectedItem:function(a,b){virtualclass.wb.canvas.removeObject(vcan.main.currObj);a={mt:(new Date).getTime(),ac:"del"};"undefined"==typeof b&&virtualclass.wb.uid++;
a.uid=virtualclass.wb.uid;roles.hasControls()?(console.log("Delete:- Saving the delete command"),vcan.main.replayObjs.push(a),virtualclass.storage.store(JSON.stringify(vcan.main.replayObjs))):virtualclass.storage.store(JSON.stringify(virtualclass.wb.gObj.replayObjs));vcan.main.currObj="";console.log("Delete:- Removing the whitboard object");return a},attachEventHandlers:function(){virtualclass.wb.canvas.bind("mousedown",virtualclass.wb.utility.ev_canvas);virtualclass.wb.canvas.bind("mousemove",virtualclass.wb.utility.ev_canvas);
virtualclass.wb.canvas.bind("mouseup",virtualclass.wb.utility.ev_canvas)},t_clearallInit:function(){virtualclass.wb.utility.clearAll(!0)},clearAll:function(a,b){virtualclass.wb.uid=0;virtualclass.wb.lt="";for(var d=virtualclass.wb.vcan;0<d.main.children.length;)virtualclass.wb.canvas.removeObject(d.main.children[0]);!0==a&&d.main.replayObjs.splice(0,d.main.replayObjs.length);void 0!=virtualclass.wb.replay&&(virtualclass.wb.replay.objNo=0);"move"==d.getStates("action")&&d.setValInMain("action","create");
d=document.getElementById("sendPackCont");if(null!=d&&(d=d.getElementsByClassName("numbers"),0<d.length))for(var f=0;f<d.length;f++)d[f].innerHTML=0;d=document.getElementById("serverErrorCont");null!=d&&(d.parentNode.removeChild(d),console.log("Some ERROR removed."))},deActiveFrmDragDrop:function(){var a=virtualclass.wb.vcan,b=a.main.children;if("move"==a.getStates("action")){a.setValInMain("action","create");for(a=0;a<b.length;a++)b[a].dragDrop(!1),b[a].setActive(!1);return!0}return!1},getOffset:function(a){for(var b=
a.target,d=y=0;b&&!isNaN(b.offsetLeft)&&!isNaN(b.offsetTop);)d+=b.offsetLeft-b.scrollLeft,y+=b.offsetTop-b.scrollTop,b=b.offsetParent;d=a.clientX-d;y=a.clientY-y;return{x:d,y:y}},ev_canvas:function(a){var b=virtualclass.wb.vcan.utility.getReltivePoint(a);a.currX=b.x;a.currY=b.y;if(b=virtualclass.wb.tool[a.type])return b(a),this.ev_canvas},t_activeallInit:function(){var a=virtualclass.wb.vcan,b=a.getStates("children");if(1<=b.length)for(a.setValInMain("action","move"),a=0;a<b.length;a++)b[a].dragDrop(!0)},
...
(virtualclass.wb.utility.toolWrapperEnable(),null!=vcan.main.canvas&&virtualclass.wb.utility.makeCanvasEnable())},displayCanvas:function(){vcan.canvasWrapperId="canvasWrapper";null==document.getElementById("canvas")&&virtualclass.wb.createCanvas();c.virtualclass.wb.init();virtualclass.wb.utility.makeCanvasDisable();virtualclass.wb.utility.toolWrapperDisable();roles.hasControls()||0==vcan.main.children&&virtualclass.wb.utility.createWhiteboardMessage()},removeWhiteboardMessage:function(){var a=document.getElementById("whiteBoardMsg");
null!=a&&a.parentNode.removeChild(a)},createWhiteboardMessage:function(){if(null==document.getElementById("whiteBoardMsg")){var a=document.createElement("div");a.id="whiteBoardMsg";a.innerHTML=virtualclass.lang.getString("msgForWhiteboard");var b=document.getElementById("canvasWrapper");null!=b&&b.appendChild(a)}},initAll:function(a){roles.hasControls()&&virtualclass.wb.utility.makeCanvasDisable();virtualclass.system.measureResoultion({width:c.outerWidth,height:c.innerHeight})},alreadyExistToolBar:function(){var a=
