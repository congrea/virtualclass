...
c.appendChild(f);cthis.video.imageReplaceWithVideo(a.id,b)},updateHightInSideBar:function(a){var b=document.getElementById("widgetRightSide").offsetHeight;document.getElementById("chatContainer").style.height=b-a+"px"},send:function(){function b(){function h(){try{f.tempVidCont.drawImage(f.myVideo,0,0,f.width,f.height)}catch(a){if("NS_ERROR_NOT_AVAILABLE"==a.name)setTimeout(h,100);else throw a;}}if("t"==vApp.gObj.uRole){if("undefined"==typeof k){var k=document.getElementById("graphCanvas");null!=
k&&(cthis.audio.graph.cvCont=k.getContext("2d"))}null!=k&&cthis.audio.graph.cvCont.clearRect(0,0,k.width,k.height)}f.tempVidCont.clearRect(0,0,f.tempVid.width,f.tempVid.height);d.navigator.userAgent.match("Firefox")?h():f.tempVidCont.drawImage(f.myVideo,0,0,f.width,f.height);"t"==vApp.gObj.uRole&&cthis.audio.graph.display();k={name:vApp.gObj.uName,id:vApp.gObj.uid};"t"==vApp.gObj.uRole&&(k.role=vApp.gObj.uRole);vApp.wb.utility.beforeSend({videoByImage:k});var k=f.tempVidCont.getImageData(0,0,f.tempVid.width,
f.tempVid.height),k=vApp.dirtyCorner.encodeRGB(k.data),s=c(vApp.gObj.uid,8),s=new Uint8ClampedArray([11,s[0],s[1],s[2],s[3]]),v=new Uint8ClampedArray(k.length+s.length);v.set(s);v.set(k,s.length);a.sendBinary(v);clearInterval(vApp.gObj.video.smallVid);k=2E3+2500*vApp.gObj.totalUser.length;g!=vApp.gObj.totalUser?(g=vApp.gObj.totalUser.length,s=vApp.gObj.totalUser.indexOf(vApp.gObj.uId),vApp.gObj.video.smallVid=setInterval(b,k+k/g*s)):vApp.gObj.video.smallVid=setInterval(b,k)}function c(a,b){for(var f=
...
h=Math.round(n.localtempCanvas.height/12);m=Math.round(n.localtempCanvas.width/12);var g=n.type;n.localtempCanvas.width=n.video.offsetWidth;n.localtempCanvas.height=n.video.offsetHeight;n.localtempCont.drawImage(n.video,0,0,n.video.offsetWidth,n.video.offsetHeight);var k=n.localtempCont.getImageData(0,0,n.localtempCanvas.width,n.localtempCanvas.height),k=n.dc.encodeRGB(k.data),q=Math.round(n.localtempCanvas.width/m),v=Math.round(n.localtempCanvas.height/h),x=n.getContainerDimension();if("undefined"!=
typeof prvVWidth&&"undefined"!=typeof prvVHeight)var w=a(prvVWidth,4),z=a(prvVHeight,4),A=a(x.width,4);else w=a(n.video.offsetWidth,4),z=a(n.video.offsetHeight,4),A=a(x.width,4);x=a(x.height,4);g=new Uint8ClampedArray(["ss"==g?104:204,w[0],w[1],z[0],z[1],A[0],A[1],x[0],x[1]]);w=new Uint8ClampedArray(k.length+g.length);w.set(g);w.set(k,g.length);d.Worker&&sworker.postMessage({img:k,resize:1,resA:h,resB:m,dw:q,dh:v,offsetWidth:n.video.offsetWidth,offsetHeight:n.video.offsetHeight},[k.buffer]);io.sendBinary(w);
f(w.length/128);changeonresize=0;clearInterval(vApp.clear);vApp.clear=setInterval(c,p)}function k(a){n.localtempCanvas.width=n.video.offsetWidth;n.localtempCanvas.height=n.video.offsetHeight;n.localtempCont.drawImage(n.video,0,0,n.video.offsetWidth,n.video.offsetHeight);a=Math.round(n.localtempCanvas.width/m);var b=Math.round(n.localtempCanvas.height/h),g=n.localtempCont.getImageData(0,0,n.video.offsetWidth,n.video.offsetHeight);d.Worker&&(sworker.postMessage({img:g.data,resA:h,resB:m,dw:a,dh:b,offsetWidth:n.video.offsetWidth,
...
f,d=0;d<b.length;d++)if(f=b[d].getAttribute("data-role"),"t"==f)return!0;return!1},createControl:function(b,f){var d=a.createElement("div");d.id=b+"ControlContainer";d.className="controls";this.createControlDivs(d,b,f);return d},createAssignControl:function(b,f,d){var k=this,h=a.createElement("span");h.id=f+"contrAssignImg";h.innerHTML="&nbsp;";var m=a.createElement("a");m.id=f+"contrAssignAnch";m.className="tooltip";m.appendChild(h);var n=a.createElement("div");n.id=f+"contrAssignCont";n.className=
"controleCont";n.appendChild(m);m=a.getElementById(f+"ControlContainer");null!=m?0>=m.getElementsByClassName("controleCont").length?m.appendChild(n):m.insertBefore(n,m.firstChild):b.appendChild(n);vApp.user.control.changeAttribute(f,h,d,"assign","aRole");h.addEventListener("click",function(){k.control.init.call(k,h)})},createControlDivs:function(b,f,d){var k=this,h=!1,m=localStorage.getItem("vApp"+f);null!=m&&(h=!0,m=JSON.parse(m));var n=localStorage.getItem("reclaim"),n=null!=n&&n?!1:!0,p=vApp.vutil.userIsOrginalTeacher(f);
vApp.vutil.isUserTeacher(f);for(var q=0;q<d.length;q++)if("assign"==d[q]&&p)this.createAssignControl(b,f,n);else if("audio"==d[q]){var r=a.createElement("span");imgName="contrAud";r.id=f+imgName+"Img";r.innerHTML="&nbsp;";var u=a.createElement("a");u.id=f+imgName+"Anch";u.className="tooltip";u.appendChild(r);var s=a.createElement("div");s.id=f+imgName+"Cont";s.className="controleCont";s.appendChild(u);b.appendChild(s);s=h&&m.hasOwnProperty("aud")?m.aud?!0:!1:!0;vApp.user.control.changeAttribute(f,
r,s,"audio","aud");p&&r.addEventListener("click",function(){k.control.init.call(k,r)})}else if("chat"==d[q]){var v=a.createElement("span");imgName="contrChat";v.id=f+imgName+"Img";v.innerHTML="&nbsp;";u=a.createElement("a");u.id=f+imgName+"Anch";u.className="tooltip";u.appendChild(v);s=a.createElement("div");s.id=f+imgName+"Cont";s.className="controleCont";s.appendChild(u);b.appendChild(s);p&&v.addEventListener("click",function(){k.control.init.call(k,v)});s=h&&m.hasOwnProperty("ch")?m.ch?!0:!1:!0;
vApp.user.control.changeAttribute(f,v,s,"chat","ch")}},control:{disable:function(b,f,d,k){d=a.getElementById(b+"contr"+d+"Img");vApp.user.control._disable(d,f,b,k)},_disable:function(a,b,d,k){"assign"==b&&a.parentNode.classList.remove("tooltip");a.parentNode.setAttribute("data-title",vApp.lang.getString(b+"Enable"));a.setAttribute("data-"+b+"-disable","true");a.className="audio"==b?"icon-"+b+"DisImg block "+b+"DisImg":"icon-"+b+"Img block "+b+"Img";vApp.user.control.updateUser(d,k,!1)},enable:function(b,
f,d,k){d=a.getElementById(b+"contr"+d+"Img");vApp.user.control._enable(d,f,b,k)},_enable:function(a,b,d,k){a.parentNode.setAttribute("data-title",vApp.lang.getString(b+"Disable"));a.setAttribute("data-"+b+"-disable","false");a.className="icon-"+b+"Img enable "+b+"Img";vApp.user.control.updateUser(d,k,!0)},changeAttribute:function(a,b,d,k,h){d?vApp.user.control._enable(b,k,a,h):vApp.user.control._disable(b,k,a,h)},init:function(a){var b=a.id,d=b.indexOf("contr"),d=b.substring(0,d),b=b.split("contr")[1],
k=b.indexOf("Img"),b=b.substring(0,k);"Assign"==b?(b="true"==a.getAttribute("data-assign-disable")?!0:!1,b||(this.control.changeAttribute(d,a,b,"assign","aRole"),vApp.user.control._assign(d),vApp.user.control.changeAttrToAssign("block"))):"Chat"==b?("true"==a.getAttribute("data-chat-disable")?(a.className="contrChatBlock",b="enable",this.control.changeAttribute(d,a,!0,"chat","ch")):(b="block",this.control.changeAttribute(d,a,!1,"chat","ch")),this.control._chat(d,b)):"Aud"==b&&("true"==a.getAttribute("data-audio-disable")?
(b="enable",this.control.changeAttribute(d,a,!0,"audio","aud")):(b="block",this.control.changeAttribute(d,a,!1,"audio","aud")),this.control._audio(d,b))},_assign:function(b,d,g){vApp.wb.utility.assignRole();vApp.vutil.removeAppPanel();if(!vApp.vutil.chkValueInLocalStorage("orginalTeacherId")){var k=a.getElementById("vcanvas");k.className=k.className.replace(/\bteacher\b/," ");k.className="student"}localStorage.setItem("canvasDrwMsg",!0);k=a.getElementById("vAppScreenShareLocalVideo");null!=k&&"VIDEO"==
k.tagName&&vApp.vutil.videoTeacher2Student("ScreenShare",!0);var h;"ScreenShare"==vApp.currApp&&(h="ss");"Whiteboard"!=vApp.currApp&&(vApp[h].hasOwnProperty("currentStream")&&vApp[h].currentStream.stop(),vApp[h]="");"undefined"==typeof d&&vApp.wb.utility.beforeSend({assignRole:!0,toUser:b});null==localStorage.getItem("orginalTeacherId")&&("undefined"==typeof g&&(g=b),b=a.getElementById(g+"ControlContainer").getElementsByClassName("controleCont")[0],b.removeChild(b.firstChild))},_chat:function(a,b){"enable"==
b?vApp.wb.utility.beforeSend({enc:!0,toUser:a}):(vApp.user.control.updateUser(a,"ch",!1),vApp.wb.utility.beforeSend({dic:!0,toUser:a}))},_audio:function(a,b){"enable"==b?vApp.wb.utility.beforeSend({ena:!0,toUser:a}):vApp.wb.utility.beforeSend({dia:!0,toUser:a})},audioWidgetEnable:function(){localStorage.setItem("audEnable","true");var b=a.getElementById("audioWidget");b.className="active";b.style.opacity="1";b.style.pointerEvents="visible"},audioWidgetDisable:function(){localStorage.setItem("audEnable",
