...
f[a]&&(virtualclass.gObj.errNotScreenShare=!0),d.push(virtualclass.lang.getString("err"+f[a])));return d},isiOSDevice:function(){return parseFloat((""+(/CPU.*OS ([0-9_]{1,5})|(CPU like).*AppleWebKit.*Mobile/i.exec(navigator.userAgent)||[0,""])[1]).replace("undefined","3_2").replace("_",".").replace("_",""))||!1},isAndroid:function(){return-1<navigator.userAgent.toLowerCase().indexOf("android")},isIPad:function(){return/(iPad)/g.test(navigator.userAgent)},check:function(){var a=this.isiOSDevice();
this.device="desktop";if(a){var d="iOS";this.device="mobTab"}else var f=this.isAndroid(),a=this.mybrowser.detection(),d=a[0],a=parseFloat(a[1]);this.mybrowser.name=d;this.mybrowser.version=a;this.checkBrowserFunctions(d,a);"undefined"!=typeof f&&f?(this.device="mobTab",roles.hasControls()?(virtualclass.vutil.initDisableVirtualClass(),virtualclass.error.push(virtualclass.lang.getString("supportDesktopOnly"))):f&&("Chrome"==d?40<=a?virtualclass.vutil.initDisableAudVid():(virtualclass.error.push(virtualclass.error.push(virtualclass.lang.getString("chFireBrowsersIssue",
...
if("undefined"!=typeof d&&"undefined"!=typeof f){if(d!=r.video.offsetWidth||f!=r.video.offsetHeight)a=1}else d=r.video.offsetWidth,f=r.video.offsetHeight;1==a?setTimeout(h,2E3):t(r.type)}function m(a){switch(!0){case 300>=a||"undefined"==typeof a:v=300;break;case 3E3>=a:v=a;break;case 5E3>=a:v=3E3;break;default:v=5E3}}function h(){console.log("RESIZE");if(roles.hasControls()){d=r.video.offsetWidth;f=r.video.offsetHeight;x=Math.round(r.localtempCanvas.height/12);q=Math.round(r.localtempCanvas.width/
12);var t=r.type;r.localtempCanvas.width=r.video.offsetWidth;r.localtempCanvas.height=r.video.offsetHeight;r.localtempCont.drawImage(r.video,0,0,r.video.offsetWidth,r.video.offsetHeight);var w=r.localtempCont.getImageData(0,0,r.localtempCanvas.width,r.localtempCanvas.height),w=r.dc.encodeRGB(w.data),J=Math.round(r.localtempCanvas.width/q),L=Math.round(r.localtempCanvas.height/x),C,R,A,U;U=r.getContainerDimension();"undefined"!=typeof d&&"undefined"!=typeof f?(C=b(d,4),R=b(f,4)):(C=b(r.video.offsetWidth,
4),R=b(r.video.offsetHeight,4));A=b(U.width,4);U=b(U.height,4);t=new Uint8ClampedArray(["ss"==t?104:204,C[0],C[1],R[0],R[1],A[0],A[1],U[0],U[1]]);C=new Uint8ClampedArray(w.length+t.length);C.set(t);C.set(w,t.length);c.Worker&&sworker.postMessage({img:w,resize:1,resA:x,resB:q,dw:J,dh:L,offsetWidth:r.video.offsetWidth,offsetHeight:r.video.offsetHeight},[w.buffer]);ioAdapter.sendBinary(C);m(C.length/128);a=0;clearInterval(virtualclass.clear);virtualclass.clear=setInterval(g,v)}}function t(a){r.localtempCanvas.width=
r.video.offsetWidth;r.localtempCanvas.height=r.video.offsetHeight;r.localtempCont.drawImage(r.video,0,0,r.video.offsetWidth,r.video.offsetHeight);a=Math.round(r.localtempCanvas.width/q);var b=Math.round(r.localtempCanvas.height/x),d=r.localtempCont.getImageData(0,0,r.video.offsetWidth,r.video.offsetHeight);c.Worker&&(sworker.postMessage({img:d.data,resA:x,resB:q,dw:a,dh:b,offsetWidth:r.video.offsetWidth,offsetHeight:r.video.offsetHeight,type:r.type},[d.data.buffer]),sworker.onmessage=function(a){if(1==
a.data.needFullScreen){a=virtualclass.getDataFullScreen(r.type);ioAdapter.sendBinary(a);var b=a.length/128}else null!=a.data.masterSlice&&(ioAdapter.sendBinary(a.data.masterSlice),b=a.data.masterSlice.length/128);m(b);clearInterval(virtualclass.clear);virtualclass.clear=setInterval(g,v)});clearInterval(virtualclass.clear)}var x=Math.round(this.localtempCanvas.height/12),q=Math.round(this.localtempCanvas.width/12),r=this;virtualclass.hasOwnProperty("wholeImage")&&clearInterval(virtualclass.wholeImage);
virtualclass.hasOwnProperty("clear")&&clearInterval(virtualclass.clear);var v=1E3;virtualclass.getDataFullScreen=function(a){r.localtempCanvas.width=r.video.offsetWidth;r.localtempCanvas.height=r.video.offsetHeight;r.localtempCont.drawImage(r.video,0,0,r.video.offsetWidth,r.video.offsetHeight);var d=r.localtempCont.getImageData(0,0,r.localtempCanvas.width,r.localtempCanvas.height),d=r.dc.encodeRGB(d.data),c=b(r.localtempCanvas.height,4),f=b(r.localtempCanvas.width,4);a=new Uint8ClampedArray(["ss"==
...
var b=document.getElementById("recordingContainer"),d=c.getComputedStyle(b).display;"none"!=d&&"block"==d||setTimeout(function(){virtualclass.popup.openProgressBar();io.disconnect()},3E3);var f=document.getElementById("downloadFileCont");null==f&&(f=document.createElement("div"),f.id="downloadFileCont");var g=document.createElement("div");g.id="errormsessage";g.innerHTML=virtualclass.lang.getString("msgForDownloadStart");var h=document.getElementById("progressContainer");h.style.display="none";f.appendChild(g);
b.appendChild(f);this.alreadyDownload=!0;virtualclass.storage.getAllDataForDownload(["chunkData"],function(b){virtualclass.gObj.saveSession=!0;var d=document.createElement("button");d.id="downloadButton";d.innerHTML=virtualclass.lang.getString("downloadFile");var m=document.createElement("a");m.id="dlink";m.href="";m.download="session.vcp";m.innerHTML=virtualclass.lang.getString("download");g.innerHTML=virtualclass.lang.getString("filenotsave");f.appendChild(d);var p=document.getElementById("recordingHeader");
p.innerHTML=virtualclass.lang.getString("downloadFile");var v=new Blob([b],{type:"application/virtualclass"});virtualclass.hasOwnProperty("prevScreen")&&virtualclass.prevScreen.hasOwnProperty("currentStream")&&virtualclass.prevScreen.unShareScreen();d.addEventListener("click",function(){null!=c.webkitURL?m.href=c.webkitURL.createObjectURL(v):(m.href=c.URL.createObjectURL(v),m.onclick=a,document.body.appendChild(m));m.click();p=document.getElementById("recordingHeader");p.innerHTML=virtualclass.lang.getString("uploadsession");
f.parentNode.removeChild(f);h.style.display="block";virtualclass.recorder.hasOwnProperty("dataCame")&&clearTimeout(virtualclass.recorder.dataCame);virtualclass.clearSession();delete virtualclass.gObj.saveSession;io.disconnect();io.init(virtualclass.uInfo)})})},sendDataToServer:function(){virtualclass.storage.db.transaction(["chunkData"],"readwrite").objectStore("chunkData").clear();virtualclass.popup.waitBlockAction("none");c.Worker&&(mvDataWorker.postMessage({rdata:virtualclass.recorder.items,makeChunk:!0}),
mvDataWorker.onmessage=function(a){a.data.hasOwnProperty("done_problem")?console.log("done problem"):a.data.hasOwnProperty("status")&&"done"==a.data.status&&(console.log("Recorder:- done"),delete virtualclass.recorder.startUpload,virtualclass.recorder.recordDone=!0);virtualclass.storage.chunkStorage(a.data)})},displayWaitPopupIfNot:function(){!1==this.waitPopup&&(virtualclass.popup.sendBackOtherElems(),document.getElementById("recordingContainer").style.display="none",virtualclass.popup.waitBlockAction("block"),
virtualclass.pbar.renderProgressBar(0,0,"downloadProgressBar","downloadProgressValue"),virtualclass.popup.waitBlock(),this.waitPopup=!0)},requestDataFromServer:function(a,b){this.displayWaitPopupIfNot(virtualclass.lang.getString("plswaitwhile"));var d=new FormData;d.append("prvfile",b);d.append("fileBundelId",a);var c=getUrlVars(exportfilepath);c.hasOwnProperty("cmid")&&d.append("id",c.cmid);virtualclass.xhr.send(d,exportfilepath,function(b){virtualclass.recorder.sendToWorker(b,a)})},sendToWorker:function(a,
b){c.Worker&&(mvDataWorker.postMessage({rdata:a,getData:!0}),mvDataWorker.onmessage=function(a){f++;var d=virtualclass.recorder.isUptoBaseValue(a.data.alldata.totalSent,a.data.alldata.totalStore,30);virtualclass.recorder.ctotalStore=a.data.alldata.totalStore;virtualclass.recorder.ctotalSent=a.data.alldata.totalSent;virtualclass.pbar.renderProgressBar(a.data.alldata.totalStore,a.data.alldata.totalSent,"downloadProgressBar","downloadProgressValue");d&&!virtualclass.recorder.alreadyAskForPlay?(a.data.alldata.totalSent>
...
"contrAudioAllImg";var m=localStorage.getItem("allAudAction");null!=m&&"disable"==m?(h.setAttribute("data-action","enable"),h.className="icon-all-audio-enable tooltip",h.dataset.title=virtualclass.lang.getString("unmuteAll")):(h.setAttribute("data-action","disable"),h.className="icon-all-audio-disable tooltip",h.dataset.title=virtualclass.lang.getString("muteAll"));if(virtualclass.isPlayMode)g.pointerEvents="none",g.style.cursor="default";else{var p=this;h.addEventListener("click",function(){a.getElementById("contrAudioAllImg");
var b=p.toogleAudioIcon();"undefined"!=typeof b&&(localStorage.setItem("allAudAction",b),p.toggleAllAudio.call(virtualclass.user,b))})}g.appendChild(h);a.getElementById(b).getElementsByClassName(c)[0].appendChild(g)},toogleAudioIcon:function(){var b=a.getElementById("contrAudioAllImg");if(null!=b)return actionToPerform=b.dataset.action,"enable"==b.dataset.action?(b.dataset.action="disable",b.className="icon-all-audio-disable tooltip",b.dataset.title=virtualclass.lang.getString("muteAll")):(b.dataset.action=
...
n))return 0;var f=0;if(n.widgets)for(var g=0;g<n.widgets.length;g++)n.widgets[g].height&&(f+=n.widgets[g].height);return c?f+(Math.ceil(n.text.length/d)||1)*b:f+b}}function g(a){var b=a.doc,c=f(a);b.iter(function(a){var N=c(a);N!=a.height&&xa(a,N)})}function h(a){a.display.wrapper.className=a.display.wrapper.className.replace(/\s*cm-s-\S+/g,"")+a.options.theme.replace(/(^|\s)\s*/g," cm-s-");Fb(a)}function m(a){p(a);la(a);setTimeout(function(){L(a)},20)}function p(a){var b=a.display.gutters,c=a.options.gutters;
...
a.display.scrollbarFiller);F(b,"mousedown",function(){a.state.focused&&setTimeout(function(){a.display.input.focus()},0)});b.setAttribute("cm-not-content","true")},function(b,c){"horizontal"==c?hb(a,b):Hb(a,b)},a);a.display.scrollbars.addClass&&Ib(a.display.wrapper,a.display.scrollbars.addClass)}function B(a,b){b||(b=x(a));var c=a.display.barWidth,d=a.display.barHeight;K(a,b);for(var n=0;4>n&&c!=a.display.barWidth||d!=a.display.barHeight;n++)c!=a.display.barWidth&&a.options.lineWrapping&&ib(a),K(a,
...
n[b]=c;ca(a,ua(n,a.sel.primIndex),d)}function vf(a,b){var c={ranges:b.ranges,update:function(b){this.ranges=[];for(var c=0;c<b.length;c++)this.ranges[c]=new T(H(a,b[c].anchor),H(a,b[c].head))}};aa(a,"beforeSelectionChange",a,c);a.cm&&aa(a.cm,"beforeSelectionChange",a.cm,c);return c.ranges!=b.ranges?ua(c.ranges,c.ranges.length-1):b}function ae(a,b,c){var d=a.history.done,n=P(d);n&&n.ranges?(d[d.length-1]=b,rc(a,b,c)):ca(a,b,c)}function ca(a,b,c){rc(a,b,c);b=a.sel;var d=a.cm?a.cm.curOp.id:NaN,n=a.history,
...
.85*(r.other.bottom-r.other.top)+"px")}m||wf(a,h,f)}return d}function wf(a,b,c){function d(a,b,N,c){0>b&&(b=0);b=Math.round(b);c=Math.round(c);h.appendChild(D("div",null,"CodeMirror-selected","position: absolute; left: "+a+"px; top: "+b+"px; width: "+(null==N?q-a:N)+"px; height: "+(c-b)+"px"))}function n(b,c,M){var S=E(g,b),n=S.text.length,f,h;xf(ta(S),c||0,null==M?n:M,function(g,m,ja){var r=uc(a,z(b,g),"div",S,"left"),s,fc;g==m?(s=r,ja=fc=r.left):(s=uc(a,z(b,m-1),"div",S,"right"),"rtl"==ja&&(ja=
r,r=s,s=ja),ja=r.left,fc=s.right);null==c&&0==g&&(ja=p);3<s.top-r.top&&(d(ja,r.top,null,r.bottom),ja=p,r.bottom<s.top&&d(ja,r.bottom,null,s.top));null==M&&m==n&&(fc=q);if(!f||r.top<f.top||r.top==f.top&&r.left<f.left)f=r;if(!h||s.bottom>h.bottom||s.bottom==h.bottom&&s.right>h.right)h=s;ja<p+1&&(ja=p);d(ja,s.top,fc-ja,s.bottom)});return{start:f,end:h}}var f=a.display,g=a.doc,h=document.createDocumentFragment(),m=he(a.display),p=m.left,q=Math.max(f.sizerWidth,Ka(a)-f.sizer.offsetLeft)-m.right,f=b.from();
...
d.scrollbars.setScrollTop(f.scrollTop),d.scroller.scrollTop=f.scrollTop);null==n.scrollLeft||d.scroller.scrollLeft==n.scrollLeft&&!n.forceScroll||(f.scrollLeft=Math.max(0,Math.min(d.scroller.scrollWidth-Ka(c),n.scrollLeft)),d.scrollbars.setScrollLeft(f.scrollLeft),d.scroller.scrollLeft=f.scrollLeft,L(c));if(n.scrollToPos){var h=void 0,g=H(f,n.scrollToPos.from),h=H(f,n.scrollToPos.to),m=n.scrollToPos.margin;null==m&&(m=0);for(var p=0;5>p;p++){var q=!1,s=Ha(c,g),r=h&&h!=g?Ha(c,h):s,r=zc(c,Math.min(s.left,
...
!0},100));else if(!od(this,a,"gutterClick",!0,ga)){var c=rb(this,a);window.focus();switch(we(a)){case 1:c?Gf(this,a,c):(a.target||a.srcElement)==b.scroller&&ia(a);break;case 2:ba&&(this.state.lastMiddleDown=+new Date);c&&qc(this.doc,c);setTimeout(function(){b.input.focus()},20);ia(a);break;case 3:pd?pe(this,a):Hf(this)}}}function Gf(a,b,c){O?setTimeout(Bb(Rd,a),0):a.curOp.focus=Aa();var d=+new Date,n;Bc&&Bc.time>d-400&&0==I(Bc.pos,c)?n="triple":Cc&&Cc.time>d-400&&0==I(Cc.pos,c)?(n="double",Bc={time:d,
pos:c}):(n="single",Cc={time:d,pos:c});var d=a.doc.sel,f=sa?b.metaKey:b.ctrlKey,g;a.options.dragDrop&&If&&!kc(a)&&"single"==n&&-1<(g=d.contains(c))&&(0>I((g=d.ranges[g]).from(),c)||0<c.xRel)&&(0<I(g.to(),c)||0>c.xRel)?Jf(a,b,c,f):Kf(a,b,c,n,f)}function Jf(a,b,c,d){var n=a.display,f=+new Date,g=Y(a,function(h){ba&&(n.scroller.draggable=!1);a.state.draggingText=!1;Fa(document,"mouseup",g);Fa(n.scroller,"drop",g);10>Math.abs(b.clientX-h.clientX)+Math.abs(b.clientY-h.clientY)&&(ia(h),!d&&+new Date-200<
f&&qc(a.doc,c),ba||O&&9==W?setTimeout(function(){document.body.focus();n.input.focus()},20):n.input.focus())});ba&&(n.scroller.draggable=!0);a.state.draggingText=g;n.scroller.dragDrop&&n.scroller.dragDrop();F(document,"mouseup",g);F(n.scroller,"drop",g)}function Kf(a,b,c,d,n){function f(b){if(0!=I(t,b))if(t=b,"rect"==d){for(var M=[],n=a.options.tabSize,g=va(E(p,c.line).text,c.ch,n),h=va(E(p,b.line).text,b.ch,n),m=Math.min(g,h),g=Math.max(g,h),h=Math.min(c.line,b.line),ja=Math.min(a.lastLine(),Math.max(c.line,
b.line));h<=ja;h++){var v=E(p,h).text,u=xe(v,m,n);m==g?M.push(new T(z(h,u),z(h,u))):v.length>u&&M.push(new T(z(h,u),z(h,xe(v,g,n))))}M.length||M.push(new T(c,c));ca(p,ua(s.ranges.slice(0,r).concat(M),r),{origin:"*mouse",scroll:!1});a.scrollIntoView(b)}else M=q,n=M.anchor,m=b,"single"!=d&&(b="double"==d?a.findWordAt(b):new T(z(b.line,0),H(p,z(b.line+1,0))),0<I(b.anchor,n)?(m=b.head,n=jc(M.from(),b.anchor)):(m=b.anchor,n=ic(M.to(),b.head))),M=s.ranges.slice(0),M[r]=new T(H(p,n),m),ca(p,ua(M,r),rd)}
function g(b){var c=++x,M=rb(a,b,!0,"rect"==d);if(M)if(0!=I(M,t)){a.curOp.focus=Aa();f(M);var n=J(m,p);(M.line>=n.to||M.line<n.from)&&setTimeout(Y(a,function(){x==c&&g(b)}),150)}else{var S=b.clientY<w.top?-20:b.clientY>w.bottom?20:0;S&&setTimeout(Y(a,function(){x==c&&(m.scroller.scrollTop+=S,g(b))}),50)}}function h(a){x=Infinity;ia(a);m.input.focus();Fa(document,"mousemove",B);Fa(document,"mouseup",Z);p.history.lastSelOrigin=null}var m=a.display,p=a.doc;ia(b);var q,r,s=p.sel,v=s.ranges;n&&!b.shiftKey?
...
b){for(var c=a.doc.sel.ranges,d=[],n=0;n<c.length;n++){for(var f=b(c[n]);d.length&&0>=I(f.from,P(d).to);){var g=d.pop();if(0>I(g.from,f.from)){f.from=g.from;break}}d.push(f)}ma(a,function(){for(var b=d.length-1;0<=b;b--)sb(a.doc,"",d[b].from,d[b].to,"+delete");mb(a)})}function yd(a,b,c,d,n){function f(b){var d=(n?nd:Ne)(p,h,c,!0);if(null==d){if(b=!b)b=g+c,b<a.first||b>=a.first+a.size?b=q=!1:(g=b,b=p=E(a,b));if(b)h=n?(0>c?yc:xc)(p):0>c?p.text.length:0;else return q=!1}else h=d;return!0}var g=b.line,
...
var m=Za(h,0,1).getBoundingClientRect();h=m&&m.left!=m.right?Cd=3>Za(h,1,2).getBoundingClientRect().right-m.right:!1}h&&(g=ta(f))&&(c.addToken=ag(c.addToken,g));c.map=[];m=b!=a.display.externalMeasured&&Q(f);a:{h=c;var m=Ze(a,f,m),p=f.markedSpans,q=f.text,r=0;if(p)for(var s=q.length,v=0,u=1,t="",w=void 0,x=void 0,B=0,Z=void 0,J=void 0,Na=void 0,K=void 0,V=void 0;;){if(B==v){for(var Z=J=Na=K=x="",V=null,B=Infinity,L=[],A=0;A<p.length;++A){var z=p[A],C=z.marker;"bookmark"==C.type&&z.from==v&&C.widgetNode?
L.push(C):z.from<=v&&(null==z.to||z.to>v||C.collapsed&&z.to==v&&z.from==v)?(null!=z.to&&z.to!=v&&B>z.to&&(B=z.to,J=""),C.className&&(Z+=" "+C.className),C.css&&(x=C.css),C.startStyle&&z.from==v&&(Na+=" "+C.startStyle),C.endStyle&&z.to==B&&(J+=" "+C.endStyle),C.title&&!K&&(K=C.title),C.collapsed&&(!V||0>Ue(V.marker,C))&&(V=z)):z.from>v&&B>z.from&&(B=z.from)}if(V&&(V.from||0)==v){af(h,(null==V.to?s+1:V.to)-v,V.marker,null==V.from);if(null==V.to)break a;V.to==v&&(V=!1)}if(!V&&L.length)for(A=0;A<L.length;++A)af(h,
0,L[A])}if(v>=s)break;for(L=Math.min(s,B);;){if(t){A=v+t.length;V||(z=A>L?t.slice(0,L-v):t,h.addToken(h,z,w?w+Z:Z,Na,v+z.length==B?J:"",K,x));if(A>=L){t=t.slice(L-v);v=L;break}v=A;Na=""}t=q.slice(r,r=m[u++]);w=$e(m[u++],h.cm.options)}}else for(var u=1;u<m.length;u+=2)h.addToken(h,q.slice(r,r=m[u]),$e(m[u+1],h.cm.options))}f.styleClasses&&(f.styleClasses.bgClass&&(c.bgClass=Dd(f.styleClasses.bgClass,c.bgClass||"")),f.styleClasses.textClass&&(c.textClass=Dd(f.styleClasses.textClass,c.textClass||"")));
...
a.length;++d){var f=a[d],b=b+f.chunkSize(),c=c+f.height;f.parent=this}this.size=b;this.height=c;this.parent=null}function bb(a,b,c){function d(a,N,f){if(a.linked)for(var g=0;g<a.linked.length;++g){var h=a.linked[g];if(h.doc!=N){var m=f&&h.sharedHist;if(!c||m)b(h.doc,m),d(h.doc,a,m)}}}d(a,null,!0)}function Id(a,c){if(c.cm)throw Error("This document is already in use.");a.doc=c;c.cm=a;g(a);b(a);a.options.lineWrapping||w(a);a.options.mode=c.modeOption;la(a)}function E(a,b){b-=a.first;if(0>b||b>=a.size)throw Error("There is no line "+
...
h=P(f.done)):h=void 0,m=h;if(m){var p=P(h.changes);0==I(b.from,b.to)&&0==I(b.from,p.to)?p.to=ab(b):h.changes.push(wd(a,b))}else for((h=P(f.done))&&h.ranges||sc(a.sel,f.done),h={changes:[wd(a,b)],generation:f.generation},f.done.push(h);f.done.length>f.undoDepth;)f.done.shift(),f.done[0].ranges||f.done.shift();f.done.push(c);f.generation=++f.maxGeneration;f.lastModTime=f.lastSelTime=g;f.lastOp=f.lastSelOp=d;f.lastOrigin=f.lastSelOrigin=b.origin;p||aa(a,"historyAdded")}function sc(a,b){var c=P(b);c&&
...
(a?h.value:"");h.value="\u21da";h.value=c;d.prevInput=a?"":"\u200b";h.selectionStart=1;h.selectionEnd=c.length;g.selForContextMenu=f.doc.sel}}function c(){d.contextMenuPending=!1;d.wrapper.style.position="relative";h.style.cssText=q;O&&9>W&&g.scrollbars.setScrollTop(g.scroller.scrollTop=p);if(null!=h.selectionStart){(!O||O&&9>W)&&b();var a=0,N=function(){g.selForContextMenu==f.doc.sel&&0==h.selectionStart&&0<h.selectionEnd&&"\u200b"==d.prevInput?Y(f,Fc.selectAll)(f):10>a++?g.detectingSelectAll=setTimeout(N,
500):g.input.reset()};g.detectingSelectAll=setTimeout(N,200)}}var d=this,f=d.cm,g=f.display,h=d.textarea,m=rb(f,a),p=g.scroller.scrollTop;if(m&&!wa){f.options.resetSelectionOnContextMenu&&-1==f.doc.sel.contains(m)&&Y(f,ca)(f.doc,Ba(m),Ca);var q=h.style.cssText;d.wrapper.style.position="absolute";h.style.cssText="position: fixed; width: 30px; height: 30px; top: "+(a.clientY-5)+"px; left: "+(a.clientX-5)+"px; z-index: 1000; background: "+(O?"rgba(255, 255, 255, .05)":"transparent")+"; outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);";
...
f.shift(),d++;else break;for(var h=0,g=0,m=b[0],p=f[0],q=Math.min(m.length,p.length);h<q&&m.charCodeAt(h)==p.charCodeAt(h);)++h;m=P(b);p=P(f);for(q=Math.min(m.length-(1==b.length?h:0),p.length-(1==f.length?h:0));g<q&&m.charCodeAt(m.length-g-1)==p.charCodeAt(p.length-g-1);)++g;b[b.length-1]=m.slice(0,m.length-g);b[0]=b[0].slice(h);d=z(d,h);c=z(c,f.length?P(f).length-g:0);if(1<b.length||b[0]||I(d,c))return sb(a.doc,b,d,c,"+input"),!0},ensurePolled:function(){this.forceCompositionEnd()},reset:function(){this.forceCompositionEnd()},
...
return new Ga(a,this.primIndex)},somethingSelected:function(){for(var a=0;a<this.ranges.length;a++)if(!this.ranges[a].empty())return!0;return!1},contains:function(a,b){b||(b=a);for(var c=0;c<this.ranges.length;c++){var d=this.ranges[c];if(0<=I(b,d.from())&&0>=I(a,d.to()))return c}return-1}};T.prototype={from:function(){return jc(this.anchor,this.head)},to:function(){return ic(this.anchor,this.head)},empty:function(){return this.head.line==this.anchor.line&&this.head.ch==this.anchor.ch}};var hd={left:0,
...
d,new T(g,f[d].to()),Ca)}}}),getTokenAt:function(a,b){return Xe(this,a,b)},getLineTokens:function(a,b){return Xe(this,z(a),b,!0)},getTokenTypeAt:function(a){a=H(this.doc,a);var b=Ze(this,E(this.doc,a.line)),c=0,d=(b.length-1)/2;a=a.ch;var f;if(0==a)f=b[2];else for(;;){var g=c+d>>1;if((g?b[2*g-1]:0)>=a)d=g;else if(b[2*g+1]<a)c=g+1;else{f=b[2*g+2];break}}b=f?f.indexOf("cm-overlay "):-1;return 0>b?f:0==b?null:f.slice(0,b-1)},getModeAt:function(a){var b=this.doc.mode;return b.innerMode?c.innerMode(b,
...
getStateAfter:function(a,b){var c=this.doc;a=Math.max(c.first,Math.min(null==a?c.first+c.size-1:a,c.first+c.size-1));return Ob(this,a+1,b)},cursorCoords:function(a,b){var c;c=this.doc.sel.primary();c=null==a?c.head:"object"==typeof a?H(this.doc,a):a?c.from():c.to();return Ha(this,c,b||"page")},charCoords:function(a,b){return uc(this,H(this.doc,a),b||"page")},coordsChar:function(a,b){a=me(this,a,b||"page");return md(this,a.left,a.top)},lineAtHeight:function(a,b){a=me(this,{top:a,left:0},b||"page").top;
...
wb(c);var pf=c.defaults={},fb=c.optionHandlers={},Jd=c.Init={toString:function(){return"CodeMirror.Init"}};G("value","",function(a,b){a.setValue(b)},!0);G("mode",null,function(a,c){a.doc.modeOption=c;b(a)},!0);G("indentUnit",2,b,!0);G("indentWithTabs",!1);G("smartIndent",!0);G("tabSize",4,function(a){d(a);Fb(a);la(a)},!0);G("lineSeparator",null,function(a,b){if(a.doc.lineSep=b){var c=[],d=a.doc.first;a.doc.iter(function(a){for(var f=0;;){var g=a.text.indexOf(b,f);if(-1==g)break;f=g+b.length;c.push(z(d,
g))}d++});for(var f=c.length-1;0<=f;f--)sb(a.doc,b,c[f],z(c[f].line,c[f].ch+b.length))}});G("specialChars",/[\t\u0000-\u0019\u00ad\u200b-\u200f\u2028\u2029\ufeff]/g,function(a,b,d){a.state.specialChars=new RegExp(b.source+(b.test("\t")?"":"|\t"),"g");d!=c.Init&&a.refresh()});G("specialCharPlaceholder",function(a){var b=D("span","\u2022","cm-invalidchar");b.title="\\u"+a.charCodeAt(0).toString(16);b.setAttribute("aria-label",b.title);return b},function(a){a.refresh()},!0);G("electricChars",!0);G("inputStyle",
zb?"contenteditable":"textarea",function(){throw Error("inputStyle can not (yet) be changed in a running editor");},!0);G("rtlMoveVisually",!jg);G("wholeLineUpdateBefore",!0);G("theme","default",function(a){h(a);m(a)},!0);G("keyMap","default",function(a,b,d){b=Mc(b);(d=d!=c.Init&&Mc(d))&&d.detach&&d.detach(a,b);b.attach&&b.attach(a,d||null)});G("extraKeys",null);G("lineWrapping",!1,function(a){a.options.lineWrapping?(Ib(a.display.wrapper,"CodeMirror-wrap"),a.display.sizer.style.minWidth="",a.display.sizerWidth=
null):(Gb(a.display.wrapper,"CodeMirror-wrap"),w(a));g(a);la(a);Fb(a);setTimeout(function(){B(a)},100)},!0);G("gutters",[],function(a){t(a.options);m(a)},!0);G("fixedGutter",!0,function(a,b){a.display.gutters.style.left=b?A(a.display)+"px":"0";a.refresh()},!0);G("coverGutterNextToScrollbar",!1,function(a){B(a)},!0);G("scrollbarStyle","native",function(a){v(a);B(a);a.display.scrollbars.setScrollTop(a.doc.scrollTop);a.display.scrollbars.setScrollLeft(a.doc.scrollLeft)},!0);G("lineNumbers",!1,function(a){t(a.options);
m(a)},!0);G("firstLineNumber",1,m,!0);G("lineNumberFormatter",function(a){return a},m,!0);G("showCursorWhenSelecting",!1,Kb,!0);G("resetSelectionOnContextMenu",!0);G("lineWiseCopyCut",!0);G("readOnly",!1,function(a,b){"nocursor"==b?(Cb(a),a.display.input.blur(),a.display.disabled=!0):(a.display.disabled=!1,b||a.display.input.reset())});G("disableInput",!1,function(a,b){b||a.display.input.reset()},!0);G("dragDrop",!0,function(a,b,d){!b!=!(d&&d!=c.Init)&&(d=a.display.dragFunctions,b=b?F:Fa,b(a.display.scroller,
"dragstart",d.start),b(a.display.scroller,"dragenter",d.simple),b(a.display.scroller,"dragover",d.simple),b(a.display.scroller,"drop",d.drop))});G("cursorBlinkRate",530);G("cursorScrollMargin",0);G("cursorHeight",1,Kb,!0);G("singleCursorHeightPerLine",!0,Kb,!0);G("workTime",100);G("workDelay",100);G("flattenSpans",!0,d,!0);G("addModeClass",!1,d,!0);G("pollInterval",100);G("undoDepth",200,function(a,b){a.doc.history.undoDepth=b});G("historyEventDelay",1250);G("viewportMargin",10,function(a){a.refresh()},
!0);G("maxHighlightLength",1E4,d,!0);G("moveInputWithCursor",!0,function(a,b){b||a.display.input.resetPosition()});G("tabindex",null,function(a,b){a.display.input.getField().tabIndex=b||""});G("autofocus",null);var of=c.modes={},bc=c.mimeModes={};c.defineMode=function(a,b){c.defaults.mode||"null"==a||(c.defaults.mode=a);2<arguments.length&&(b.dependencies=Array.prototype.slice.call(arguments,2));of[a]=b};c.defineMIME=function(a,b){bc[a]=b};c.resolveMode=function(a){if("string"==typeof a&&bc.hasOwnProperty(a))a=
...
Ba(b))}),replaceRange:function(a,b,c,d){b=H(this,b);c=c?H(this,c):b;sb(this,a,b,c,d)},getRange:function(a,b,c){a=Ya(this,H(this,a),H(this,b));return!1===c?a:a.join(c||this.lineSeparator())},getLine:function(a){return(a=this.getLineHandle(a))&&a.text},getLineHandle:function(a){if(Mb(this,a))return E(this,a)},getLineNumber:function(a){return Q(a)},getLineHandleVisualStart:function(a){"number"==typeof a&&(a=E(this,a));return Da(a)},lineCount:function(){return this.size},firstLine:function(){return this.first},
lastLine:function(){return this.first+this.size-1},clipPos:function(a){return H(this,a)},getCursor:function(a){var b=this.sel.primary();return null==a||"head"==a?b.head:"anchor"==a?b.anchor:"end"==a||"to"==a||!1===a?b.to():b.from()},listSelections:function(){return this.sel.ranges},somethingSelected:function(){return this.sel.somethingSelected()},setCursor:ha(function(a,b,c){a=H(this,"number"==typeof a?z(a,b||0):a);ca(this,Ba(a,null),c)}),setSelection:ha(function(a,b,c){var d=H(this,a);a=H(this,b||
a);ca(this,Ba(d,a),c)}),extendSelection:ha(function(a,b,c){qc(this,H(this,a),b&&H(this,b),c)}),extendSelections:ha(function(a,b){for(var c=[],d=0;d<a.length;d++)c[d]=H(this,a[d]);$d(this,c)}),extendSelectionsBy:ha(function(a,b){$d(this,nc(this.sel.ranges,a),b)}),setSelections:ha(function(a,b,c){if(a.length){for(var d=0,f=[];d<a.length;d++)f[d]=new T(H(this,a[d].anchor),H(this,a[d].head));null==b&&(b=Math.min(a.length-1,this.sel.primIndex));ca(this,ua(f,b),c)}}),addSelection:ha(function(a,b,c){var d=
this.sel.ranges.slice(0);d.push(new T(H(this,a),H(this,b||a)));ca(this,ua(d,d.length-1),c)}),getSelection:function(a){for(var b=this.sel.ranges,c,d=0;d<b.length;d++){var f=Ya(this,b[d].from(),b[d].to());c=c?c.concat(f):f}return!1===a?c:c.join(a||this.lineSeparator())},getSelections:function(a){for(var b=[],c=this.sel.ranges,d=0;d<c.length;d++){var f=Ya(this,c[d].from(),c[d].to());!1!==a&&(f=f.join(a||this.lineSeparator()));b[d]=f}return b},replaceSelection:function(a,b,c){for(var d=[],f=0;f<this.sel.ranges.length;f++)d[f]=
a;this.replaceSelections(d,b,c||"+input")},replaceSelections:ha(function(a,b,c){for(var d=[],f=this.sel,g=0;g<f.ranges.length;g++){var h=f.ranges[g];d[g]={from:h.from(),to:h.to(),text:this.splitLines(a[g]),origin:c}}if(g=b&&"end"!=b){g=[];c=a=z(this.first,0);for(f=0;f<d.length;f++){var m=d[f],h=De(m.from,a,c),p=De(ab(m),a,c);a=m.to;c=p;"around"==b?(m=this.sel.ranges[f],m=0>I(m.head,m.anchor),g[f]=new T(m?p:h,m?h:p)):g[f]=new T(h,h)}g=new Ga(g,this.sel.primIndex)}b=g;for(g=d.length-1;0<=g;g--)lb(this,
...
(b.history=this.history);(this.linked||(this.linked=[])).push({doc:b,sharedHist:a.sharedHist});b.linked=[{doc:this,isParent:!0,sharedHist:a.sharedHist}];a=Qe(this);for(c=0;c<a.length;c++){var d=a[c],f=d.find(),g=b.clipPos(f.from),f=b.clipPos(f.to);I(g,f)&&(g=ub(b,g,f,d.primary,d.primary.type),d.markers.push(g),g.parent=d)}return b},unlinkDoc:function(a){a instanceof c&&(a=a.doc);if(this.linked)for(var b=0;b<this.linked.length;++b)if(this.linked[b].doc==a){this.linked.splice(b,1);a.unlinkDoc(this);
...
var d=c.tagStart;c.tagName=c.tagStart=null;"selfcloseTag"==a||A.autoSelfClosers.hasOwnProperty(b)?u(c,b):(u(c,b),c.context=new p(c,b,d==c.indented));return w}X="error";return v}function B(a,b,c){if("equals"==a)return K;A.allowMissing||(X="error");return v(a,b,c)}function K(a,b,c){if("string"==a)return J;if("word"==a&&A.allowUnquoted)return X="string",v;X="error";return v(a,b,c)}function J(a,b,c){return"string"==a?J:v(a,b,c)}var L=a.indentUnit,C=b.multilineTagIndentFactor||1,R=b.multilineTagIndentPastTag;
...
a.match(/^[^\s]+/,!0);void 0===a.peek()?b.linkTitle=!0:a.match(/^(?:\s+(?:"(?:[^"\\]|\\\\|\\.)+"|'(?:[^'\\]|\\\\|\\.)+'|\((?:[^)\\]|\\\\|\\.)+\)))?/,!0);b.f=b.inline=t;return A.linkHref+" url"}function J(a){kb[a]||(a=(a+"").replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1"),kb[a]=new RegExp("^(?:[^\\\\]|\\\\.)*?("+a+")"));return kb[a]}var L=c.modes.hasOwnProperty("xml"),C=c.getMode(a,L?{name:"xml",htmlMode:!0}:"text/plain");void 0===b.highlightFormatting&&(b.highlightFormatting=!1);void 0===b.maxBlockquoteDepth&&
...
m.pred&&m.pred.annotation.equals(p.annotation)?(v=!0,p.length+=m.pred.length,m.beforePred.next=p,K=m.predPos):(m.beforeStart.next=p,K=m.startPos);for(;p.next;)g.push(new f(K,p)),K+=p.length,p=p.next;m.succ&&m.succ.annotation.equals(p.annotation)?(p.length+=m.succ.length,B=!0,p.next=m.succ.next):p.next=q;g.push(new f(K,p))}else m.pred&&m.succ&&m.pred.annotation.equals(m.succ.annotation)?(B=v=!0,p=new h(m.pred.length+m.succ.length,m.pred.annotation),m.beforePred.next=p,p.next=m.succ.next,g.push(new f(m.startPos-
...
a)};a.prototype.listItem=function(a){vceditor.utils.assert(!1===a||"u"===a||"o"===a||"t"===a||"tc"===a);return this.cloneWithNewAttribute_(d.LIST_TYPE,a)};a.prototype.getIndent=function(){return this.attributes[d.LINE_INDENT]||0};a.prototype.getAlign=function(){return this.attributes[d.LINE_ALIGN]||0};a.prototype.getListItem=function(){return this.attributes[d.LIST_TYPE]||!1};return a}();c.LineFormatting=a})(window);(function(c){var a=function(){function a(b){return b===h.ORDERED?"</ol>":"</ul>"}function d(a,b){return a===b||a===h.TODO&&b===h.TODOCHECKED||a===h.TODOCHECKED&&b===h.TODO}var f=c.utils,g=c.AttributeConstants,h=c.LineFormatting.LIST_TYPE;return function(c,p){for(var s="",u=!0,w=[],t=!1,x=!0,q=!0,r=0,v=c.ops[r],B=!1;v;){f.assert(v.isInsert());var K=v.attributes;if(u){var u=!1,J=0,L=null,C="left";g.LINE_SENTINEL in K&&(J=K[g.LINE_INDENT]||0,L=K[g.LIST_TYPE]||null,C=K[g.LINE_ALIGN]||"left");L&&(J=J||
1);t?(s+="</li>",t=!1):x||(q&&(s+="<br/>"),s+="</div>");x=!1;for(f.assert(0<=J,"Indent must not be negative.");w.length>J||J===w.length&&null!==L&&!d(L,w[w.length-1]);)s+=a(w.pop());for(;w.length<J;)q=L||h.UNORDERED,B=L==h.TODO||L==h.TODOCHECKED||B,s+=q===h.ORDERED?"<ol>":q===h.UNORDERED?"<ul>":'<ul class="vceditor-todo">',w.push(q);q="left"!==C?' style="text-align:'+C+'"':"";if(L){t="";switch(L){case h.TODOCHECKED:t=' class="vceditor-checked"';break;case h.TODO:t=' class="vceditor-unchecked"'}s+=
"<li"+t+q+">";t=!0}else s+="<div"+q+">";q=!0}if(g.LINE_SENTINEL in K)v=c.ops[++r];else if(g.ENTITY_SENTINEL in K){for(L=0;L<v.text.length;L++)J=vceditor.Entity.fromAttributes(K),J=p.exportToElement(J),s+=J.outerHTML;v=c.ops[++r]}else{var J=L="",R;for(R in K){var C=K[R],A,U;R===g.BOLD||R===g.ITALIC||R===g.UNDERLINE||R===g.STRIKE?(f.assert(!0===C),A=U=R):R===g.FONT_SIZE?(A='span style="font-size: '+C,A+="string"!==typeof C||-1===C.indexOf("px",C.length-2)?'px"':'"',U="span"):R===g.FONT?(A='span style="font-family: '+
C+'"',U="span"):R===g.COLOR?(A='span style="color: '+C+'"',U="span"):R===g.BACKGROUND_COLOR?(A='span style="background-color: '+C+'"',U="span"):f.log(!1,"Encountered unknown attribute while rendering html: "+R);A&&(L+="<"+A+">");U&&(J="</"+U+">"+J)}var C=v.text,da=C.indexOf("\n");0<=da?(u=!0,v=da<C.length-1?new vceditor.TextOp("insert",C.substr(da+1),K):c.ops[++r],C=C.substr(0,da)):v=c.ops[++r];C=C.replace(/  +/g,function(a){return Array(a.length+1).join("\u00a0")}).replace(/^ /,"\u00a0").replace(/ $/,
"\u00a0");0<C.length&&(q=!1);s+=L+C.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\u00a0/g,"&nbsp;")+J}}t?s+="</li>":x||(q&&(s+="&nbsp;"),s+="</div>");for(;0<w.length;)s+=a(w.pop());B&&(s='<style>ul.vceditor-todo { list-style: none; margin-left: 0; padding-left: 0; } ul.vceditor-todo > li { padding-left: 1em; text-indent: -1em; } ul.vceditor-todo > li:before { content: "\\2610"; padding-right: 5px; } ul.vceditor-todo > li.vceditor-checked:before { content: "\\2611"; padding-right: 5px; }</style>\n'+
...
function(b){a.applyOperationToCodeMirror(b,this.rtcm)};a.prototype.registerUndo=function(a){this.cm.undo=a};a.prototype.registerRedo=function(a){this.cm.redo=a};a.prototype.invertOperation=function(a){for(var b=0,c=this.rtcm.codeMirror,d,m,x=new g,q=0;q<a.wrapped.ops.length;q++){var r=a.wrapped.ops[q];if(r.isRetain())if(f(r.attributes))x.retain(r.chars),b+=r.chars;else for(d=this.rtcm.getAttributeSpans(b,b+r.chars),m=0;m<d.length;m++){var v={},B;for(B in r.attributes){var K=r.attributes[B],J=d[m].attributes[B];
!1===K?J&&(v[B]=J):K!==J&&(v[B]=J||!1)}x.retain(d[m].length,v);b+=d[m].length}else if(r.isInsert())x["delete"](r.text.length);else if(r.isDelete()){v=c.getRange(c.posFromIndex(b),c.posFromIndex(b+r.chars));d=this.rtcm.getAttributeSpans(b,b+r.chars);for(m=K=0;m<d.length;m++)x.insert(v.substr(K,d[m].length),d[m].attributes),K+=d[m].length;b+=r.chars}}return new h(x,a.meta.invert())};return a}();c.Client=RichTextCodeMirrorAdapter})(window);otAdapter=function(){function c(a,b){b=b.charAt(0).toLowerCase()+b.slice(1);var c=Vceditor.getvcEditor();if(a.operations&&a.revision>a.operations.length){var f=[];f[a.revision-a.operations.length-1]=null;this.operations=f.concat(a.operations)}else this.operations=a.operations?a.operations:[];this.server=new c.Server(a.doc,this.operations);this.trigger=function(a){this.callbacks[a].apply(this,Array.prototype.slice.call(arguments,1))};this.teacherOT=function(a){a=this.doOT(a);"undefined"!=typeof a&&
...
a.readOnly=!1);virtualclass.isPlayMode&&(this.readOnlyMode("enable","notCreateSyncBox"),this.cm.setOption("readOnly","nocursor"));Vceditor.fromCodeMirror({},this.cm,a,b);"Firefox"==virtualclass.system.mybrowser.detection()[0]&&this.removeScrollFromFireFox(this.etype)},disableEditorByOuterLayer:function(){var a=document.querySelector("#virtualclass"+virtualclass.vutil.capitalizeFirstLetter(this.etype)+"Body .CodeMirror.CodeMirror-wrap");null!=a&&(a.style.pointerEvents="none");console.log("Disable editor for ios")},
enableEditorByOuterLayer:function(){var a=document.querySelector("#virtualclass"+virtualclass.vutil.capitalizeFirstLetter(this.etype)+"Body .CodeMirror.CodeMirror-wrap");null!=a&&(a.style.pointerEvents="visible");console.log("Enable editor for ios")},codemirrorWithLayout:function(a){this.UI.container(this.etype);document.getElementById(this.UI.edId);"object"!=typeof this.cm&&(console.log("Code mirror instance is created "),this.cm=CodeMirror(document.getElementById(this.UI.edId),a))},requestData:function(){var a=
