...
this.currentWidth);this.theta=this.theta;var d=Math.cos(this.angle+this.theta)*this.hypotenuse,g=Math.sin(this.angle+this.theta)*this.hypotenuse,c=this.theta,m=Math.sin(c),c=Math.cos(c),d={x:this.x-d,y:this.y-g},g={x:d.x+this.currentWidth*c,y:d.y+this.currentWidth*m},p={x:d.x-this.currentHeight*m,y:d.y+this.currentHeight*c};this.oCoords={tl:d,tr:g,br:{x:g.x-this.currentHeight*m,y:g.y+this.currentHeight*c},bl:p,ml:{x:d.x-this.currentHeight/2*m,y:d.y+this.currentHeight/2*c},mt:{x:d.x+this.currentWidth/
2*c,y:d.y+this.currentWidth/2*m},mr:{x:g.x-this.currentHeight/2*m,y:g.y+this.currentHeight/2*c},mb:{x:p.x+this.currentWidth/2*c,y:p.y+this.currentWidth/2*m},mtr:{x:d.x+this.currentWidth/2*c,y:d.y+this.currentWidth/2*m}};this.setCornerCoords();b.findTargetCorner=function(d){var f=a.main.offset;if(!this.hasControls)return!1;var c=a.utility.actualPointer(d);d=c.x-f.x;var f=c.y-f.y,g;for(g in this.oCoords){if("mtr"===g&&!this.hasRotatingPoint)break;c=a.virtual_box.getImageLines(this.oCoords[g].corner,
