...
c=b.currY;lastmousemovetime=null;if(d.started&&"text"!=a){d.mousemove(b,"up");if(!b.detail.hasOwnProperty("cevent")&&"freeDrawing"!=a){var v=(new Date).getTime();vcan.optimize.calculatePackets(v,"u",g,c)}if(void 0!=f.obj.freeDrawObj&&!0==f.obj.freeDrawObj.freesvg&&(f.obj.freeDrawObj.fdObj.isCurrentlyDrawing&&f.obj.freeDrawObj.finalizeDraw(b),!b.detail.hasOwnProperty("cevent")&&0<m.length)){v=(new Date).getTime();v=vcan.makeStackObj(v,"u",g,c);m.push(v);for(v=0;v<m.length;v++)f.uid++,m[v].uid=f.uid,
...
this.contextTop.closePath();this.isCurrentlyDrawing=!1;var h=this.utility.min(this.freeDrawingXPoints);c=this.utility.min(this.freeDrawingYPoints);var m=this.utility.max(this.freeDrawingXPoints);g=this.utility.max(this.freeDrawingYPoints);var p=[],q,v,w,t=this.freeDrawingXPoints,x=this.freeDrawingYPoints,r=this.mdTime;p.push("M ",t[0]-h," ",x[0]-c," ",r[0]," ");for(var s=1;q=t[s],v=x[s],w=r[s];s++)p.push("L ",q-h," ",v-c," ",w," ");p=p.join("");if("M 0 0 L 0 0 "!==p)return q=this.freeDrawingXPoints[this.freeDrawingXPoints.length-
1],v=this.freeDrawingYPoints[this.freeDrawingYPoints.length-1],w=new a.Path(p,this),w.mp={},w.mp.x=q,w.mp.y=v,w.init(p),w=d.readyObject(w),w.coreObj.type="freeDrawing",w=w.coreObj,w.fill=null,w.stroke=this.freeDrawingColor,w.strokeWidth=this.freeDrawingLineWidth,w.minX=h,w.minY=c,this.utility.objAdd(w),d=a.utility.setVal(w,"x",h+(m-h)/2),d=a.utility.setVal(d,"y",c+(g-c)/2),d.setCoords(),"object"==typeof b&&this.contextTop.restore(),a.renderAll(this.contextTop),d},utility:{max:function(a,b){if(a&&
...
_compress:function(c,a,b){if(null==c)return"";var d,f,g={},h={},m="",p="",q="",v=2,w=3,t=2,x=[],r=0,s=0,u;for(u=0;u<c.length;u+=1)if(m=c[u],Object.prototype.hasOwnProperty.call(g,m)||(g[m]=w++,h[m]=!0),p=q+m,Object.prototype.hasOwnProperty.call(g,p))q=p;else{if(Object.prototype.hasOwnProperty.call(h,q)){if(256>q.charCodeAt(0)){for(d=0;d<t;d++)r<<=1,s==a-1?(s=0,x.push(b(r)),r=0):s++;f=q.charCodeAt(0);for(d=0;8>d;d++)r=r<<1|f&1,s==a-1?(s=0,x.push(b(r)),r=0):s++,f>>=1}else{f=1;for(d=0;d<t;d++)r=r<<1|
f,s==a-1?(s=0,x.push(b(r)),r=0):s++,f=0;f=q.charCodeAt(0);for(d=0;16>d;d++)r=r<<1|f&1,s==a-1?(s=0,x.push(b(r)),r=0):s++,f>>=1}v--;0==v&&(v=Math.pow(2,t),t++);delete h[q]}else for(f=g[q],d=0;d<t;d++)r=r<<1|f&1,s==a-1?(s=0,x.push(b(r)),r=0):s++,f>>=1;v--;0==v&&(v=Math.pow(2,t),t++);g[p]=w++;q=String(m)}if(""!==q){if(Object.prototype.hasOwnProperty.call(h,q)){if(256>q.charCodeAt(0)){for(d=0;d<t;d++)r<<=1,s==a-1?(s=0,x.push(b(r)),r=0):s++;f=q.charCodeAt(0);for(d=0;8>d;d++)r=r<<1|f&1,s==a-1?(s=0,x.push(b(r)),
r=0):s++,f>>=1}else{f=1;for(d=0;d<t;d++)r=r<<1|f,s==a-1?(s=0,x.push(b(r)),r=0):s++,f=0;f=q.charCodeAt(0);for(d=0;16>d;d++)r=r<<1|f&1,s==a-1?(s=0,x.push(b(r)),r=0):s++,f>>=1}v--;0==v&&(v=Math.pow(2,t),t++);delete h[q]}else for(f=g[q],d=0;d<t;d++)r=r<<1|f&1,s==a-1?(s=0,x.push(b(r)),r=0):s++,f>>=1;v--;0==v&&(Math.pow(2,t),t++)}f=2;for(d=0;d<t;d++)r=r<<1|f&1,s==a-1?(s=0,x.push(b(r)),r=0):s++,f>>=1;for(;;)if(r<<=1,s==a-1){x.push(b(r));break}else s++;return x.join("")},decompress:function(c){return null==
c?"":""==c?null:LZString._decompress(c.length,32768,function(a){return c.charCodeAt(a)})},_decompress:function(c,a,b){var d=[],f=4,g=4,h=3,m="",p=[],q,v,w,t,x,r=LZString._f,s=b(0),u=a,A=1;for(q=0;3>q;q+=1)d[q]=q;m=0;w=Math.pow(2,2);for(t=1;t!=w;)v=s&u,u>>=1,0==u&&(u=a,s=b(A++)),m|=(0<v?1:0)*t,t<<=1;switch(m){case 0:m=0;w=Math.pow(2,8);for(t=1;t!=w;)v=s&u,u>>=1,0==u&&(u=a,s=b(A++)),m|=(0<v?1:0)*t,t<<=1;x=r(m);break;case 1:m=0;w=Math.pow(2,16);for(t=1;t!=w;)v=s&u,u>>=1,0==u&&(u=a,s=b(A++)),m|=(0<v?
1:0)*t,t<<=1;x=r(m);break;case 2:return""}q=d[3]=x;for(p.push(x);;){if(A>c)return"";m=0;w=Math.pow(2,h);for(t=1;t!=w;)v=s&u,u>>=1,0==u&&(u=a,s=b(A++)),m|=(0<v?1:0)*t,t<<=1;switch(x=m){case 0:m=0;w=Math.pow(2,8);for(t=1;t!=w;)v=s&u,u>>=1,0==u&&(u=a,s=b(A++)),m|=(0<v?1:0)*t,t<<=1;d[g++]=r(m);x=g-1;f--;break;case 1:m=0;w=Math.pow(2,16);for(t=1;t!=w;)v=s&u,u>>=1,0==u&&(u=a,s=b(A++)),m|=(0<v?1:0)*t,t<<=1;d[g++]=r(m);x=g-1;f--;break;case 2:return p.join("")}0==f&&(f=Math.pow(2,h),h++);if(d[x])m=d[x];else if(x===
...
[]}function g(){clearInterval(virtualclass.clear);if("undefined"!=typeof d&&"undefined"!=typeof f){if(d!=s.video.offsetWidth||f!=s.video.offsetHeight)a=1}else d=s.video.offsetWidth,f=s.video.offsetHeight;1==a?setTimeout(m,2E3):t(s.type)}function h(a){switch(!0){case 300>=a||"undefined"==typeof a:u=300;break;case 3E3>=a:u=a;break;case 5E3>=a:u=3E3;break;default:u=5E3}}function m(){console.log("RESIZE");d=s.video.offsetWidth;f=s.video.offsetHeight;x=Math.round(s.localtempCanvas.height/12);r=Math.round(s.localtempCanvas.width/
12);var t=s.type;s.localtempCanvas.width=s.video.offsetWidth;s.localtempCanvas.height=s.video.offsetHeight;s.localtempCont.drawImage(s.video,0,0,s.video.offsetWidth,s.video.offsetHeight);var w=s.localtempCont.getImageData(0,0,s.localtempCanvas.width,s.localtempCanvas.height),w=s.dc.encodeRGB(w.data),J=Math.round(s.localtempCanvas.width/r),K=Math.round(s.localtempCanvas.height/x),E,M,W,U;U=s.getContainerDimension();"undefined"!=typeof d&&"undefined"!=typeof f?(E=b(d,4),M=b(f,4)):(E=b(s.video.offsetWidth,
4),M=b(s.video.offsetHeight,4));W=b(U.width,4);U=b(U.height,4);t=new Uint8ClampedArray(["ss"==t?104:204,E[0],E[1],M[0],M[1],W[0],W[1],U[0],U[1]]);E=new Uint8ClampedArray(w.length+t.length);E.set(t);E.set(w,t.length);c.Worker&&sworker.postMessage({img:w,resize:1,resA:x,resB:r,dw:J,dh:K,offsetWidth:s.video.offsetWidth,offsetHeight:s.video.offsetHeight},[w.buffer]);ioAdapter.sendBinary(E);h(E.length/128);a=0;clearInterval(virtualclass.clear);virtualclass.clear=setInterval(g,u)}function t(a){s.localtempCanvas.width=
...
a.data.needFullScreen){a=virtualclass.getDataFullScreen(s.type);ioAdapter.sendBinary(a);var b=a.length/128}else null!=a.data.masterSlice&&(ioAdapter.sendBinary(a.data.masterSlice),b=a.data.masterSlice.length/128);h(b);clearInterval(virtualclass.clear);virtualclass.clear=setInterval(g,u)});clearInterval(virtualclass.clear)}var x=Math.round(this.localtempCanvas.height/12),r=Math.round(this.localtempCanvas.width/12),s=this;virtualclass.hasOwnProperty("wholeImage")&&clearInterval(virtualclass.wholeImage);
...
else{var d=new FormData;d.append("record_data",JSON.stringify(a));d.append("user",virtualclass.gObj.uid);d.append("cn",g);d.append("sesseionkey",virtualclass.recorder.sessionKey);virtualclass.recorder.items=[];virtualclass.xhr.send(d,importfilepath,function(b){"done"===b?(virtualclass.pbar.renderProgressBar(a.totalStore,a.totalSent,"progressBar","progressValue"),virtualclass.recorder.rnum++,g++,virtualclass.recorder.xhrsenddata(virtualclass.recorder.rnum)):"ERROR"===b?virtualclass.recorder.alreadyDownload||
...
f.id="errormsessage";f.innerHTML=virtualclass.lang.getString("msgForDownloadStart");document.getElementById("progressContainer").style.display="none";d.appendChild(f);b.appendChild(d);this.alreadyDownload=!0;virtualclass.storage.getAllDataForDownload(["chunkData"],function(b){var f=document.createElement("button");f.id="downloadButton";f.innerHTML=virtualclass.lang.getString("downloadFile");var g=document.createElement("a");g.id="dlink";g.href="";g.download="session.vcp";g.innerHTML=virtualclass.lang.getString("download");
d.appendChild(f);var h=new Blob([b],{type:"application/virtualclass"});f.addEventListener("click",function(){null!=c.webkitURL?g.href=c.webkitURL.createObjectURL(h):(g.href=c.URL.createObjectURL(h),g.onclick=a,document.body.appendChild(g));g.click()})})},sendDataToServer:function(){virtualclass.storage.db.transaction(["chunkData"],"readwrite").objectStore("chunkData").clear();virtualclass.popup.waitBlockAction("none");c.Worker&&(mvDataWorker.postMessage({rdata:virtualclass.recorder.items,makeChunk:!0}),
mvDataWorker.onmessage=function(a){virtualclass.storage.chunkStorage(a.data)})},displayWaitPopupIfNot:function(){!1==this.waitPopup&&(virtualclass.popup.sendBackOtherElems(),document.getElementById("recordingContainer").style.display="none",virtualclass.popup.waitBlockAction("block"),virtualclass.pbar.renderProgressBar(0,0,"downloadProgressBar","downloadProgressValue"),virtualclass.popup.waitBlock(),this.waitPopup=!0)},requestDataFromServer:function(a,b){this.displayWaitPopupIfNot(virtualclass.lang.getString("plswaitwhile"));
...
a.value.hasOwnProperty("recObjs")&&virtualclass.recorder.items.push(JSON.parse(a.value.recObjs));a["continue"]()}}}})(window);(function(c,a){c.user=function(b){return{assignRole:function(a,b,g){roles.hasControls()&&(roles.isEducator()||(virtualclass.vutil.enablePresentatorEditors(g),virtualclass.html.leftAppBar()),virtualclass.attachFunction(),"Whiteboard"==b&&c.virtualclass.wb.attachToolFunction(vcan.cmdWrapperDiv,!0),virtualclass.hasOwnProperty("previrtualclass")?virtualclass.vutil.makeActiveApp("virtualclass"+b,virtualclass.previrtualclass):virtualclass.vutil.makeActiveApp("virtualclass"+b),"Whiteboard"==b&&virtualclass.wb.utility.makeCanvasEnable())},
...
var m=a.createElement("div");m.id=b+c+"Cont";m.className="controleCont";m.appendChild(h);return[m,g]},createAssignControl:function(b,c,g,h){var m=this,p=this.createControllerElement(c,"contrAssign"),q=p[0],v=p[1],p=a.getElementById(c+"ControlContainer");null!=p?0>=p.getElementsByClassName("controleCont").length?p.appendChild(q):p.insertBefore(q,p.firstChild):b.appendChild(q);virtualclass.user.control.changeAttribute(c,v,g,"assign","aRole");"undefined"!=typeof h&&(v.className+=" currTeacher");v.addEventListener("click",
function(){m.control.init.call(m,v)})},createControlDivs:function(a,b,c){var h=this,m=!1,p=localStorage.getItem("virtualclass"+b);if(null!=p&&(m=!0,p=JSON.parse(p),p.hasOwnProperty("currTeacher")))if(virtualclass.gObj[b+"currTeacher"]={},!0==p.currTeacher){var q=virtualclass.user.control.currTeacherAlready=!0;virtualclass.gObj[b+"currTeacher"].ct=!0}else virtualclass.gObj[b+"currTeacher"].ct=!1;var v=roles.isEducator()?!1:!0,w=virtualclass.vutil.userIsOrginalTeacher(b);virtualclass.vutil.isUserTeacher(b);
for(var t=0;t<c.length;t++)if("assign"==c[t]&&w)"undefined"!=typeof q?this.createAssignControl(a,b,v,q):this.createAssignControl(a,b,v);else if("audio"==c[t]){var x=this.createControllerElement(b,"contrAud"),r=x[0],s=x[1];a.appendChild(r);r=m&&p.hasOwnProperty("aud")?p.aud?!0:!1:!0;virtualclass.user.control.changeAttribute(b,s,r,"audio","aud");w&&s.addEventListener("click",function(){h.control.init.call(h,s)})}else if("chat"==c[t]){var x=this.createControllerElement(b,"contrChat"),r=x[0],u=x[1];a.appendChild(r);
w&&u.addEventListener("click",function(){h.control.init.call(h,u)});r=m&&p.hasOwnProperty("chat")?p.chat?!0:!1:!0;virtualclass.user.control.changeAttribute(b,u,r,"chat","chat")}else if(("editorRich"==c[t]||"editorCode"==c[t])&&roles.hasAdmin()){var A=m&&p.hasOwnProperty(c[t])?p[c[t]]?!0:!1:!1,x=this.createControllerElement(b,"contr"+c[t]),r=x[0],x=x[1];r.className+=" controller"+c[t];a.appendChild(r);virtualclass.currApp!=virtualclass.vutil.capitalizeFirstLetter(c[t])&&(r.style.display="none");virtualclass.user.control.changeAttribute(b,
x,A,c[t],c[t]);w&&x.addEventListener("click",h.closureEditor(h,x))}},closureEditor:function(a,b){return function(){a.control.init.call(a,b)}},control:{toggleDisplayWriteModeMsgBox:function(b,c){var g=a.getElementById(b+"writeModeBox"),h=c?virtualclass.lang.getString("writemode"):virtualclass.lang.getString("readonlymode"),m=a.getElementById("virtualclass"+b+"Body");null==g&&null!=m&&(g=a.createElement("div"),g.id=b+"writeModeBox",m.appendChild(g));null!=g&&(g.className="writeModeBox",g.dataset.writeMode=
...
a;d.appendChild(f);var v=this;a=function(){v.confirmInit(this.id,b,c)};f=document.createElement("div");f.id="confirmOk";f.className="confirmButton confirmChild";f.addEventListener("click",a);var w=document.createElement("button");w.id="confirmOkButton";w.className="icon-check";w.innerHTML="OK";f.appendChild(w);d.appendChild(f);f=document.createElement("div");f.id="confirmCancel";f.className="confirmButton confirmChild";f.addEventListener("click",a);a=document.createElement("button");a.id="confirmCancelButton";
a.className="icon-close";a.innerHTML="Cancel";f.appendChild(a);d.appendChild(f)};b.prototype.confirmInit=function(a,b,c){virtualclass.popup.closeElem();a="confirmOk"==a?virtualclass.popup.confirmOk():virtualclass.popup.confirmCancel();b(a,c)};b.prototype.confirmCancel=function(){return!1};b.prototype.confirmOk=function(){return!0};b.prototype.hideAllPopups=function(){for(var a=document.getElementsByClassName("popupWindow"),b=0;b<a.length;b++)a[b].style.display="none"};return b}(window);(function(c){c.converter=function(){function a(a,b){for(var c=a.replace(/[^A-Za-z0-9\+\/]/g,""),h=c.length,m=b?Math.ceil((3*h+1>>2)/b)*b:3*h+1>>2,p=new Uint8Array(m),q,v=0,w=0,t=0;t<h;t++){q=t&3;var x=c.charCodeAt(t),v=v|(64<x&&91>x?x-65:96<x&&123>x?x-71:47<x&&58>x?x+4:43===x?62:47===x?63:0)<<6*(3-q);if(3===q||1===h-t){for(q=0;3>q&&w<m;q++,w++)p[w]=v>>>(16>>>q&24)&255;v=0}}return p}function b(a){return 26>a?a+65:52>a?a+71:62>a?a-4:62===a?43:63===a?47:65}return{base64EncArrInt:function(a){for(var b=
...
else{var g=0;roles.hasControls()&&(g=1);var v={playerVars:{height:"390",width:"640",autohide:0,disablekb:1,enablejsapi:1,modestbranding:1,controls:g,rel:0,fs:0,showinfo:0,start:"undefined"!=typeof d?Math.round(d):0},videoId:b,events:{onReady:this.onPlayerReady}};"undefined"!=typeof d&&(v.start=d);console.log("Player object is CREATED");if("undefined"!=typeof f){var w=this;c.onYouTubeIframeAPIReady=function(){w.player=new YT.Player("player",v)}}else this.player=new YT.Player("player",v);b=a.getElementById(this.UI.id);
...
d=c.to.line,b+=d.text.length-c.to.ch;return b}function w(a){var b=a.display;a=a.doc;b.maxLine=C(a,a.first);b.maxLineLength=v(b.maxLine);b.maxLineChanged=!0;a.iter(function(a){var G=v(a);G>b.maxLineLength&&(b.maxLineLength=G,b.maxLine=a)})}function t(a){var b=da(a.gutters,"CodeMirror-linenumbers");-1==b&&a.lineNumbers?a.gutters=a.gutters.concat(["CodeMirror-linenumbers"]):-1<b&&!a.lineNumbers&&(a.gutters=a.gutters.slice(0),a.gutters.splice(b,1))}function x(a){var b=a.display,c=b.gutters.offsetWidth,
...
a.display.scrollbarFiller);D(b,"mousedown",function(){a.state.focused&&setTimeout(function(){a.display.input.focus()},0)});b.setAttribute("cm-not-content","true")},function(b,c){"horizontal"==c?mb(a,b):Nb(a,b)},a);a.display.scrollbars.addClass&&Ob(a.display.wrapper,a.display.scrollbars.addClass)}function A(a,b){b||(b=x(a));var c=a.display.barWidth,d=a.display.barHeight;L(a,b);for(var n=0;4>n&&c!=a.display.barWidth||d!=a.display.barHeight;n++)c!=a.display.barWidth&&a.options.lineWrapping&&nb(a),L(a,
x(a)),c=a.display.barWidth,d=a.display.barHeight}function L(a,b){var c=a.display,d=c.scrollbars.update(b);c.sizer.style.paddingRight=(c.barWidth=d.right)+"px";c.sizer.style.paddingBottom=(c.barHeight=d.bottom)+"px";d.right&&d.bottom?(c.scrollbarFiller.style.display="block",c.scrollbarFiller.style.height=d.bottom+"px",c.scrollbarFiller.style.width=d.right+"px"):c.scrollbarFiller.style.display="";d.bottom&&a.options.coverGutterNextToScrollbar&&a.options.fixedGutter?(c.gutterFiller.style.display="block",
...
null!=c.top&&(c={top:Math.min(a.doc.height+cd(a.display)-fd(a),c.top)}),b.visible=J(a.display,a.doc,c),b.visible.from>=a.display.viewFrom&&b.visible.to<=a.display.viewTo)break;if(!ya(a,b))break;nb(a);d=x(a);Pb(a);Qb(a,d);A(a,d)}b.signal(a,"update",a);if(a.display.viewFrom!=a.display.reportedViewFrom||a.display.viewTo!=a.display.reportedViewTo)b.signal(a,"viewportChange",a,a.display.viewFrom,a.display.viewTo),a.display.reportedViewFrom=a.display.viewFrom,a.display.reportedViewTo=a.display.viewTo}function Aa(a,
b){var c=new U(a,b);if(ya(a,c)){nb(a);Oa(a,c);var d=x(a);Pb(a);Qb(a,d);A(a,d);c.finish()}}function Qb(a,b){a.display.sizer.style.minHeight=b.docHeight+"px";var c=b.docHeight+a.display.barHeight;a.display.heightForcer.style.top=c+"px";a.display.gutters.style.height=Math.max(c+wa(a),b.clientHeight)+"px"}function nb(a){a=a.display;for(var b=a.lineDiv.offsetTop,c=0;c<a.view.length;c++){var d=a.view[c],n;if(!d.hidden){if(O&&8>T){var f=d.node.offsetTop+d.node.offsetHeight;n=f-b;b=f}else n=d.node.getBoundingClientRect(),
...
z(b.line+1,0))),0<I(b.anchor,n)?(m=b.head,n=qb(N.from(),b.anchor)):(m=b.anchor,n=pb(N.to(),b.head))),N=s.ranges.slice(0),N[r]=new S(H(p,n),m),ba(p,sa(N,r),zd)}function g(b){var c=++x,N=xb(a,b,!0,"rect"==d);if(N)if(0!=I(N,v)){a.curOp.focus=za();f(N);var n=J(m,p);(N.line>=n.to||N.line<n.from)&&setTimeout(X(a,function(){x==c&&g(b)}),150)}else{var R=b.clientY<w.top?-20:b.clientY>w.bottom?20:0;R&&setTimeout(X(a,function(){x==c&&(m.scroller.scrollTop+=R,g(b))}),50)}}function h(a){x=Infinity;ga(a);m.input.focus();
...
t):q=Xb(p,q,c);n?-1==r?(r=u.length,ba(p,sa(u.concat([q]),r),{scroll:!1,origin:"*mouse"})):1<u.length&&u[r].empty()&&"single"==d&&!b.shiftKey?(ba(p,sa(u.slice(0,r).concat(u.slice(r+1)),0)),s=p.sel):ld(p,r,q,zd):(r=0,ba(p,new Ha([q],0),zd),s=p.sel);var v=c,w=m.wrapper.getBoundingClientRect(),x=0,A=X(a,function(a){xe(a)?g(a):h(a)}),aa=X(a,h);D(document,"mousemove",A);D(document,"mouseup",aa)}function wd(a,b,c,d,n){try{var f=b.clientX,g=b.clientY}catch(h){return!1}if(f>=Math.floor(a.display.gutters.getBoundingClientRect().right))return!1;
...
d?b.rest[d-1]:b.line,g;c.pos=0;c.addToken=$f;var h;if(null!=Kd)h=Kd;else{h=oa(a.display.measure,document.createTextNode("A\u062eA"));var m=db(h,0,1).getBoundingClientRect();h=m&&m.left!=m.right?Kd=3>db(h,1,2).getBoundingClientRect().right-m.right:!1}h&&(g=ra(f))&&(c.addToken=ag(c.addToken,g));c.map=[];m=b!=a.display.externalMeasured&&Q(f);a:{h=c;var m=$e(a,f,m),p=f.markedSpans,q=f.text,r=0;if(p)for(var s=q.length,u=0,t=1,v="",w=void 0,x=void 0,A=0,aa=void 0,J=void 0,L=void 0,bb=void 0,K=void 0;;){if(A==
u){for(var aa=J=L=bb=x="",K=null,A=Infinity,z=[],E=0;E<p.length;++E){var V=p[E],M=V.marker;"bookmark"==M.type&&V.from==u&&M.widgetNode?z.push(M):V.from<=u&&(null==V.to||V.to>u||M.collapsed&&V.to==u&&V.from==u)?(null!=V.to&&V.to!=u&&A>V.to&&(A=V.to,J=""),M.className&&(aa+=" "+M.className),M.css&&(x=M.css),M.startStyle&&V.from==u&&(L+=" "+M.startStyle),M.endStyle&&V.to==A&&(J+=" "+M.endStyle),M.title&&!bb&&(bb=M.title),M.collapsed&&(!K||0>Ve(K.marker,M))&&(K=V)):V.from>u&&A>V.from&&(A=V.from)}if(K&&
(K.from||0)==u){bf(h,(null==K.to?s+1:K.to)-u,K.marker,null==K.from);if(null==K.to)break a;K.to==u&&(K=!1)}if(!K&&z.length)for(E=0;E<z.length;++E)bf(h,0,z[E])}if(u>=s)break;for(z=Math.min(s,A);;){if(v){E=u+v.length;K||(V=E>z?v.slice(0,z-u):v,h.addToken(h,V,w?w+aa:aa,L,u+V.length==A?J:"",bb,x));if(E>=z){v=v.slice(z-u);u=z;break}u=E;L=""}v=q.slice(r,r=m[t++]);w=af(m[t++],h.cm.options)}}else for(var t=1;t<m.length;t+=2)h.addToken(h,q.slice(r,r=m[t]),af(m[t+1],h.cm.options))}f.styleClasses&&(f.styleClasses.bgClass&&
...
d||null)});F("extraKeys",null);F("lineWrapping",!1,function(a){a.options.lineWrapping?(Ob(a.display.wrapper,"CodeMirror-wrap"),a.display.sizer.style.minWidth="",a.display.sizerWidth=null):(Mb(a.display.wrapper,"CodeMirror-wrap"),w(a));g(a);ja(a);Lb(a);setTimeout(function(){A(a)},100)},!0);F("gutters",[],function(a){t(a.options);m(a)},!0);F("fixedGutter",!0,function(a,b){a.display.gutters.style.left=b?W(a.display)+"px":"0";a.refresh()},!0);F("coverGutterNextToScrollbar",!1,function(a){A(a)},!0);F("scrollbarStyle",
...
a.header&&(c.push(M),c.push(M+"-"+a.header));a.quote&&(c.push(U),!b.maxBlockquoteDepth||b.maxBlockquoteDepth>=a.quote?c.push(U+"-"+a.quote):c.push(U+"-"+b.maxBlockquoteDepth));!1!==a.list&&((d=(a.listDepth-1)%3)?1===d?c.push(Oa):c.push(Aa):c.push(ya));a.trailingSpaceNewLine?c.push("trailing-space-new-line"):a.trailingSpace&&c.push("trailing-space-"+(a.trailingSpace%2?"a":"b"));return c.length?c.join(" "):null}function v(a,b){if(a.match(uc,!0))return q(b)}function w(a,d){var f=d.text(a,d);if("undefined"!==
...
a.push(this.ops[b].attributes),"retain"===this.ops[b].type?a.push(this.ops[b].chars):"insert"===this.ops[b].type?a.push(this.ops[b].text):"delete"===this.ops[b].type&&a.push(-this.ops[b].chars);0===a.length&&a.push(0);return a};a.fromJSON=function(b){for(var c=new a,d=0,f=b.length;d<f;d++){var v=b[d],w={};"object"===typeof v&&(w=v,d++,v=b[d]);if("number"===typeof v)if(0<v)c.retain(v,w);else c["delete"](-v);else g.assert("string"===typeof v),c.insert(v,w)}return c};a.prototype.apply=function(a,b,c){b=
b||[];c=c||[];if(a.length!==this.baseLength)throw Error("The operation's base length must be equal to the string's length.");for(var d=[],f=0,w,t,x=0,r=this.ops,s=0,u=r.length;s<u;s++){var A=r[s];if(A.isRetain()){if(x+A.chars>a.length)throw Error("Operation can't retain more characters than are left in the string.");d[f++]=a.slice(x,x+A.chars);for(w=0;w<A.chars;w++){var L=b[x+w]||{},J={};for(t in L)J[t]=L[t],g.assert(!1!==J[t]);for(t in A.attributes)!1===A.attributes[t]?delete J[t]:J[t]=A.attributes[t],
g.assert(!1!==J[t]);c.push(J)}x+=A.chars}else if(A.isInsert())for(d[f++]=A.text,w=0;w<A.text.length;w++){L={};for(t in A.attributes)L[t]=A.attributes[t],g.assert(!1!==L[t]);c.push(L)}else x+=A.chars}if(x!==a.length)throw Error("The operation didn't operate on the whole string.");a=d.join("");g.assert(a.length===c.length);return a};a.prototype.invert=function(b){for(var c=0,d=new a,f=this.ops,g=0,w=f.length;g<w;g++){var t=f[g];if(t.isRetain())d.retain(t.chars),c+=t.chars;else if(t.isInsert())d["delete"](t.text.length);
...
var u;if(r.isRetain()&&s.isRetain()){var A=a.transformAttributes(r.attributes,s.attributes);r.chars>s.chars?(u=s.chars,r.chars-=s.chars,s=w[x++]):r.chars===s.chars?(u=s.chars,r=g[t++],s=w[x++]):(u=r.chars,s.chars-=r.chars,r=g[t++]);d.retain(u,A[0]);f.retain(u,A[1])}else if(r.isDelete()&&s.isDelete())r.chars>s.chars?(r.chars-=s.chars,s=w[x++]):r.chars===s.chars?(r=g[t++],s=w[x++]):(s.chars-=r.chars,r=g[t++]);else if(r.isDelete()&&s.isRetain())r.chars>s.chars?(u=s.chars,r.chars-=s.chars,s=w[x++]):r.chars===
s.chars?(u=s.chars,r=g[t++],s=w[x++]):(u=r.chars,s.chars-=r.chars,r=g[t++]),d["delete"](u);else if(r.isRetain()&&s.isDelete())r.chars>s.chars?(u=s.chars,r.chars-=s.chars,s=w[x++]):r.chars===s.chars?(u=r.chars,r=g[t++],s=w[x++]):(u=r.chars,s.chars-=r.chars,r=g[t++]),f["delete"](u);else throw Error("The two operations aren't compatible");}return[d,f]};return a}();c.TextOperation=TextOperation})(window);(function(c){var a=function(a){function c(a,b){this.wrapped=a;this.meta=b}function f(a,b){for(var c in a)a.hasOwnProperty(c)&&(b[c]=a[c])}function g(a,b){return a&&"object"===typeof a&&"function"===typeof a.transform?a.transform(b):a}c.prototype.apply=function(){return this.wrapped.apply.apply(this.wrapped,arguments)};c.prototype.invert=function(){var a=this.meta;return new c(this.wrapped.invert.apply(this.wrapped,arguments),a&&"object"===typeof a&&"function"===typeof a.invert?a.invert.apply(a,arguments):
...
for(b in a)if(a.hasOwnProperty(b)){var c=f.getClientObject(b);a[b].name&&c.setName(a[b].name);(c=a[b].selection)?f.clients[b].updateSelection(f.transformSelection(Selection.fromJSON(c))):f.clients[b].removeSelection()}},reconnect:function(){f.serverReconnect()}})}function g(a){return a[a.length-1]}var h=c.Client,m=c.Cursor,p=c.UndoManager,q=c.TextOperation,v=c.WrappedOperation;a.prototype.invert=function(){return new a(this.cursorAfter,this.cursorBefore)};a.prototype.compose=function(c){return new a(this.cursorBefore,
...
E+'"',U="span"):M===g.COLOR?(W='span style="color: '+E+'"',U="span"):M===g.BACKGROUND_COLOR?(W='span style="background-color: '+E+'"',U="span"):f.log(!1,"Encountered unknown attribute while rendering html: "+M);W&&(K+="<"+W+">");U&&(J="</"+U+">"+J)}var E=u.text,ya=E.indexOf("\n");0<=ya?(v=!0,u=ya<E.length-1?new vceditor.TextOp("insert",E.substr(ya+1),L):c.ops[++s],E=E.substr(0,ya)):u=c.ops[++s];E=E.replace(/  +/g,function(a){return Array(a.length+1).join("\u00a0")}).replace(/^ /,"\u00a0").replace(/ $/,
"\u00a0");0<E.length&&(r=!1);q+=K+E.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\u00a0/g,"&nbsp;")+J}}t?q+="</li>":x||(r&&(q+="&nbsp;"),q+="</div>");for(;0<w.length;)q+=a(w.pop());A&&(q='<style>ul.vceditor-todo { list-style: none; margin-left: 0; padding-left: 0; } ul.vceditor-todo > li { padding-left: 1em; text-indent: -1em; } ul.vceditor-todo > li:before { content: "\\2610"; padding-right: 5px; } ul.vceditor-todo > li.vceditor-checked:before { content: "\\2611"; padding-right: 5px; }</style>\n'+
...
!1===L?J&&(u[A]=J):L!==J&&(u[A]=J||!1)}x.retain(d[m].length,u);b+=d[m].length}else if(s.isInsert())x["delete"](s.text.length);else if(s.isDelete()){u=c.getRange(c.posFromIndex(b),c.posFromIndex(b+s.chars));d=this.rtcm.getAttributeSpans(b,b+s.chars);for(m=L=0;m<d.length;m++)x.insert(u.substr(L,d[m].length),d[m].attributes),L+=d[m].length;b+=s.chars}}return new h(x,a.meta.invert())};return a}();c.Client=RichTextCodeMirrorAdapter})(window);otAdapter=function(){function c(a,b){b=b.charAt(0).toLowerCase()+b.slice(1);var c=Vceditor.getvcEditor();if(a.operations&&a.revision>a.operations.length){var f=[];f[a.revision-a.operations.length-1]=null;this.operations=f.concat(a.operations)}else this.operations=a.operations?a.operations:[];this.server=new c.Server(a.doc,this.operations);this.trigger=function(a){this.callbacks[a].apply(this,Array.prototype.slice.call(arguments,1))};this.teacherOT=function(a){a=this.doOT(a);"undefined"!=typeof a&&
...
"string"!==typeof f&&(f+="px");var h=f.toString().toLowerCase().replace(/[^a-z0-9-_]/g,"-"),g=g+("-"+h);v[d]&&(w[d]||(w[d]={}),w[d][h]||(w[d][h]=!0,h=v[d],f="function"===typeof h?h(f):h+": "+f,this.addStyleWithCSS_((d==q.LINE_INDENT?"pre."+g:"."+g)+" { "+f+" }")))}b=b+" "+g}}return b};a.prototype.markEntity_=function(a){for(var b=c.Entity.fromAttributes(a.annotation.attributes),d=this.codeMirror,f=this,g=[],h=0;h<a.length;h++){var m=d.posFromIndex(a.pos+h),p=d.posFromIndex(a.pos+h+1),q={collapsed:!0,
...
t+x+"]","g"),"");c.push(f)}b.update(b.from,b.to,c)}};a.prototype.onCodeMirrorChange_=function(a,b){if("object"===typeof b.from){for(var c=[];b;)c.push(b),b=b.next;b=c}for(var c=this.convertCoordinateSystemForChanges_(b),d=[],g=0;g<c.length;g++){var h=c[g],p=h.start,q=h.text,t=h.removed,v=h.origin;if(0<t.length){for(var w=this.annotationList_.getAnnotatedSpansForSpan(new m(p,t.length)),x=0,Oa=0;Oa<w.length;Oa++){var Aa=w[Oa];d.push({start:p,end:p+Aa.length,removedAttributes:Aa.annotation.attributes,
...
x.elt("div",null,{"class":"vceditor"});a.parentNode.replaceChild(this.vcEditorWrapper_,a);this.vcEditorWrapper_.appendChild(a);x.on(a,"dragstart",x.stopEvent);this.editor_.vceditor=this;this.options_=f||{};this.getOption("richTextShortcuts",!1)&&(r.keyMap.richtext||this.initializeKeyMap_(),this.codeMirror_.setOption("keyMap","richtext"),this.vcEditorWrapper_.className+=" vceditor-richtext");this.imageInsertionUI=this.getOption("imageInsertionUI",!0);this.getOption("richTextToolbar",!1)&&(this.addToolbar_(),
this.vcEditorWrapper_.className+=" vceditor-richtext vceditor-with-toolbar");this.addPoweredByLogo_();this.codeMirror_&&this.codeMirror_.refresh();this.getOption("userColor",d("JqrwCaZm29-CLg-Pfz2"));this.entityManager_=new w;a=g.revision;c=[];this.codeMirror_?(this.richTextCodeMirror_=new m(this.codeMirror_,this.entityManager_,{cssPrefix:"vceditor-"}),this.editorAdapter_=new h(this.richTextCodeMirror_)):this.editorAdapter_=new q(this.ace_);f.hasOwnProperty("richTextToolbar")?(virtualclass.editorRich.vcAdapter=
...
this.codeMirror_.getWrapperElement().setAttribute("style","");this.codeMirror_.refresh()};b.prototype.insertTextAtCursor=function(a){this.insertText(this.codeMirror_.indexFromPos(this.codeMirror_.getCursor()),a)};b.prototype.insertText=function(a,b){x.assert(!this.ace_,"Not supported for ace yet.");this.assertReady_("insertText");"[object Array]"!==Object.prototype.toString.call(b)&&(b=[b]);for(var d=c.textPiecesToInserts(0===a,b),f=0;f<d.length;f++){var g=d[f].string;this.richTextCodeMirror_.insertText(a,
...
a+".");if(this.zombie_)throw Error("You can't use a Vceditor after calling dispose()!");};b.prototype.makeImageDialog_=function(){this.makeDialog_("img","Insert image url")};b.prototype.makeDialog_=function(a,b){var c=this,d=x.elt("input",null,{"class":"vceditor-dialog-input",id:a,type:"text",placeholder:b,autofocus:"autofocus"}),f=x.elt("a","Submit",{"class":"vceditor-btn",id:"submitbtn"});x.on(f,"click",x.stopEventAnd(function(){var b=document.getElementById("overlay");b.style.visibility="hidden";
var d=document.getElementById(a).value;null!==d&&c.insertEntity(a,{src:d});c.vcEditorWrapper_.removeChild(b)}));var g=x.elt("a","Cancel",{"class":"vceditor-btn"});x.on(g,"click",x.stopEventAnd(function(){var a=document.getElementById("overlay");a.style.visibility="hidden";c.vcEditorWrapper_.removeChild(a)}));f=x.elt("div",[f,g],{"class":"vceditor-btn-group"});d=x.elt("div",[d,f],{"class":"vceditor-dialog-div"});d=x.elt("div",[d],{"class":"vceditor-dialog",id:"overlay"});this.vcEditorWrapper_.appendChild(d)};
