...
virtualclass.wb.attachToolFunction(vcan.cmdWrapperDiv,!0));else if("s"==a){vcan.studentId=wbUser.id;if(!roles.hasControls()){var d=localStorage.getItem("uRole");null!=d&&"e"==d&&(a="e");localStorage.setItem("uRrole",a)}virtualclass.vutil.removeSessionTool()}virtualclass.gObj.hasOwnProperty("audIntDisable")||virtualclass.gObj.hasOwnProperty("vidIntDisable")||(virtualclass.gObj.video.init(),virtualclass.gObj.video.isInitiator=!0);vcan.oneExecuted=!1},removeClassFromElement:function(a,b){if("t_reclaim"!=
