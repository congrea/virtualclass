...
"true"==a.dataset.displaying}}})(window);(function(c){var a,b,d,f,g,h;c.studentScreen=function(){return{ssProcess:function(a,b,d,c){var f=a[0];a=new Uint8ClampedArray(b);var g,h,q,r;switch(f){case 102:case 202:q=virtualclass.vutil.numValidateTwo(a[1],a[2]);h=virtualclass.vutil.numValidateTwo(a[3],a[4]);b=a.subarray(5,a.length);this.initStudentScreen(b,{w:q,h:h},d,c);break;case 103:case 203:b=7;for(q=0;q+7<=a.length;q=r+1)f=virtualclass.vutil.numValidateTwo(a[q+1],a[q+2]),g=virtualclass.vutil.numValidateTwo(a[q+3],a[q+4]),h=parseInt(a[q+
