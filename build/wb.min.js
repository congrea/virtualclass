...
null!=c?a.getElementById("containerWb").insertBefore(b,c):a.getElementById("containerWb").appendChild(b);return b},createDiv:function(b,c,d,k){var m=c;c=vApp.lang.getString(c);var n=a.createElement("a");n.href="#";var p=a.createElement("div");p.id=b;"undefined"!=typeof k&&(p.className=k);k=a.createElement("span");k.className="icon-"+m;n.appendChild(k);n.dataset.title=c;n.className="tooltip";p.appendChild(n);"t_reclaim"==b?(b=a.getElementById(vApp.html.id),d.appendChild(p),b.insertBefore(d,b.firstChild)):
d.appendChild(p)},createCanvas:function(){var b=a.createElement("div");b.id=vcan.canvasWrapperId;vcan.canvasWrapperId=b.id;var c=a.createElement("canvas");c.id="canvas";c.innerHTML="Canvas is missing in your browsers. Please update the latest version of your browser";b.appendChild(c);a.getElementById("containerWb").appendChild(b)},objInit:function(a){"t"==vApp.gObj.uRole&&vApp.wb.utility.makeActiveTool(this.parentNode.id);"t_replay"==this.parentNode.id?(vApp.wb.utility.clearAll(!1),vApp.wb.utility.beforeSend({replayAll:!0})):
vApp.wb.toolInit(this.parentNode.id);"t_replay"!=this.parentNode.id&&"t_clearall"!=this.parentNode.id&&"t_reclaim"!=this.parentNode.id&&"t_assign"!=this.parentNode.id&&(a=(new Date).getTime(),vApp.wb.lt=this.parentNode.id,a={cmd:this.parentNode.id,mt:a},vApp.wb.uid++,a.uid=vApp.wb.uid,vcan.main.replayObjs.push(a),vApp.storage.store(JSON.stringify(vcan.main.replayObjs)),vApp.storage.wholeStore(a),vApp.wb.utility.beforeSend({repObj:[a]}));vApp.wb.prvTool=this.parentNode.id},attachToolFunction:function(b,
c){vApp.wb.createCommand(c);if("undefined"==typeof c){var d=vApp.vutil.chkValueInLocalStorage("orginalTeacherId");vApp.wb.dataInfo=parseInt(wbUser.dataInfo);d&&1==vApp.wb.dataInfo&&!vApp.wb.utility.alreadyExistPacketContainer()&&(vApp.wb.packContainer.createPacketContainer(),vApp.wb.packContainer.createPacketInfoContainer(),vApp.wb.utility.initStoredPacketsNumbers())}for(var d=a.getElementById(b).getElementsByTagName("div"),k=0;k<d.length;k++)d[k].getElementsByTagName("a")[0].addEventListener("click",
vApp.wb.objInit)},toolInit:function(a,b,c,d){"object"==typeof vApp.wb.obj.drawTextObj&&!0==vApp.wb.obj.drawTextObj.wmode&&vcan.main.canvas.getContext("2d");0<vApp.wb.vcan.getStates("children").length?"t_clearall"!=a&&("undefined"!=typeof c&&"t_replay"==a||vApp.wb.utility.deActiveFrmDragDrop(),!0!=c&&"t_replay"!=a&&vApp.wb.vcan.renderAll()):vApp.wb.vcan.main.action="create";vApp.wb.utility.IsObjEmpty(vApp.wb.obj.freeDrawObj&&!1==c)||(vApp.wb.obj.freeDrawObj.freesvg=!1);vApp.wb.vcan.main.currUserCommand=
a+"Init";if("t_activeall"==a)vApp.wb.utility.t_activeallInit();else if("t_replay"==a)"undefined"==typeof c&&vcan.setValInMain("id",0),"undefined"!=typeof d?vApp.wb.t_replayInit(b,d):vApp.wb.t_replayInit(b);else if("t_clearall"==a){if(!confirm(vApp.lang.getString("clearAllWarnMessage")))return;vApp.wb.utility.t_clearallInit();vApp.wb.utility.makeDefaultValue();vApp.storage.clearStorageData();vApp.wb.utility.beforeSend({clearAll:!0})}else"t_assign"==a?(b=localStorage.getItem("toolHeight"),null!=b?vApp.wb.utility.beforeSend({assignRole:!0,
toolHeight:b,socket:vApp.wb.socketOn}):vApp.wb.utility.beforeSend({assignRole:!0,socket:vApp.wb.socketOn})):"t_reclaim"==a&&vApp.wb.utility._reclaimRole();"t_activeall"!=a&&"t_replay"!=a&&"t_clearallInit"!=a&&"t_assign"!=a&&"t_reclaim"!=a&&(vApp.wb.tool=new vApp.wb.tool_obj(a),vApp.wb.utility.attachEventHandlers())},tool_obj:function(a){this.cmd=a;"t_freeDrawing"!=a&&(vApp.wb.obj.freeDrawObj="");"t_text"==a||vApp.vutil.exitTextWrapper()||(vApp.wb.obj.drawTextObj="");"t_freeDrawing"==a?(vApp.wb.obj.freeDrawObj=
