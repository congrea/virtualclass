...
c.msg)});"hidden"==localStorage.getItem(a)&&($("#cb"+a).hide(),$("#tabcb"+a).removeClass("ui-state-active"))})}}function display_error(c){$("<div id = 'dialog' title = 'VmChat Error:'></div>").prependTo("#stickybar");$("#dialog").html(c);$("#dialog").dialog()}function clearAllChatBox(){$(".icon-close").trigger("click")}function disCommonChatInput(){var c=document.getElementById("ta_chrm");null!=c&&(c.disabled=!0)}
