...
a.clientY-vcan.main.offset.y),vcan.optimize.calculatePackets(lastmousemovetime,"m",a.clientX-vcan.main.offset.x,a.clientY-vcan.main.offset.y),lastmousemovetime=(new Date).getTime())},calculatePackets:function(a,b,c,f){a=vcan.makeStackObj(a,b,c,f);console.log(a);vApp.wb.uid++;a.uid=vApp.wb.uid;vcan.main.replayObjs.push(a);vApp.wb.utility.beforeSend({repObj:[a]});vApp.storage.store(JSON.stringify(vcan.main.replayObjs));vApp.storage.wholeStore(a);vApp.wb.utility.updateSentPackets(a)}}})(window);(function(d){d.response={reclaimRole:function(a,b){a!=b&&(vApp.user.control._assign(b,"notsent",a),vApp.user.displayStudentSpeaker(!0),null!=localStorage.getItem("aId")&&localStorage.removeItem("aId"),vApp.user.control.removeAudioFromParticipate(a),"mobTab"==vApp.system.device&&((vApp.system.mybrowser.name=8<=vApp.system.mybrowser.version)&&/(iPad)/g.test(navigator.userAgent)&&vApp.vutil.enableVirtualClass(),vApp.wb.view.removeErrorMsg("errorContainer",!0)))},assignRole:function(a,b,c){if(a!=b||"undefined"!=
