...
"t"==virtualclass.gObj.uRole&&virtualclass.yts.seekChangeInterval()},seekChangeInterval:function(){virtualclass.yts.tsc=setInterval(function(){virtualclass.yts.triggerOnSeekChange()},2E3)}}}})(window,document);var CodeMirror=function(){function d(p,a){if(!(this instanceof d))return new d(p,a);this.options=a=a?ra(a):{};ra(qf,a,!1);x(a);var c=a.value;"string"==typeof c&&(c=new ia(c,a.mode,null,a.lineSeparator));this.doc=c;var xa=new d.inputStyles[a.inputStyle](this),xa=this.display=new b(p,c,xa);xa.wrapper.CodeMirror=this;n(this);m(this);a.lineWrapping&&(this.display.wrapper.className+=" CodeMirror-wrap");a.autofocus&&!Fb&&xa.input.focus();s(this);this.state={keyMaps:[],overlays:[],modeGen:0,overwrite:!1,
delayingBlurEvent:!1,focused:!1,suppressEdits:!1,pasteIncoming:!1,cutIncoming:!1,draggingText:!1,highlight:new Gb,keySeq:null,specialChars:null};var na=this;M&&11>R&&setTimeout(function(){na.display.input.reset(!0)},20);rf(this);Pd||(sf(),Pd=!0);jb(this);this.curOp.forceUpdate=!0;Qd(this,c);a.autofocus&&!Fb||na.hasFocus()?setTimeout(Hb(ad,this),20):Ib(this);for(var f in kb)if(kb.hasOwnProperty(f))kb[f](this,a[f],Rd);L(this);a.finishInit&&a.finishInit(this);for(c=0;c<bd.length;++c)bd[c](this);lb(this);
Y&&a.lineWrapping&&"optimizelegibility"==getComputedStyle(xa.lineDiv).textRendering&&(xa.lineDiv.style.textRendering="auto")}function b(p,a,b){this.input=b;this.scrollbarFiller=B("div",null,"CodeMirror-scrollbar-filler");this.scrollbarFiller.setAttribute("cm-not-content","true");this.gutterFiller=B("div",null,"CodeMirror-gutter-filler");this.gutterFiller.setAttribute("cm-not-content","true");this.lineDiv=B("div",null,"CodeMirror-code");this.selectionDiv=B("div",null,null,"position: relative; z-index: 1");
this.cursorDiv=B("div",null,"CodeMirror-cursors");this.measure=B("div",null,"CodeMirror-measure");this.lineMeasure=B("div",null,"CodeMirror-measure");this.lineSpace=B("div",[this.measure,this.lineMeasure,this.selectionDiv,this.cursorDiv,this.lineDiv],null,"position: relative; outline: none");this.mover=B("div",[B("div",[this.lineSpace],"CodeMirror-lines")],null,"position: relative");this.sizer=B("div",[this.mover],"CodeMirror-sizer");this.sizerWidth=null;this.heightForcer=B("div",null,null,"position: absolute; height: "+
...
this.wheelStartX=this.wheelStartY=null;this.shift=!1;this.activeTouch=this.selForContextMenu=null;b.init(this)}function c(p){p.doc.mode=d.getMode(p.options,p.doc.modeOption);a(p)}function a(p){p.doc.iter(function(p){p.stateAfter&&(p.stateAfter=null);p.styles&&(p.styles=null)});p.doc.frontier=p.doc.first;Jb(p,100);p.state.modeGen++;p.curOp&&ja(p)}function f(p){var a=Ua(p.display),b=p.options.lineWrapping,c=b&&Math.max(5,p.display.scroller.clientWidth/Kb(p.display)-3);return function(d){if(Va(p.doc,
d))return 0;var f=0;if(d.widgets)for(var g=0;g<d.widgets.length;g++)d.widgets[g].height&&(f+=d.widgets[g].height);return b?f+(Math.ceil(d.text.length/c)||1)*a:f+a}}function g(p){var a=p.doc,b=f(p);a.iter(function(p){var a=b(p);a!=p.height&&ya(p,a)})}function m(p){p.display.wrapper.className=p.display.wrapper.className.replace(/\s*cm-s-\S+/g,"")+p.options.theme.replace(/(^|\s)\s*/g," cm-s-");Lb(p)}function h(p){n(p);ja(p);setTimeout(function(){H(p)},20)}function n(p){var a=p.display.gutters,b=p.options.gutters;
Wa(a);for(var c=0;c<b.length;++c){var d=b[c],f=a.appendChild(B("div",null,"CodeMirror-gutter "+d));"CodeMirror-linenumbers"==d&&(p.display.lineGutter=f,f.style.width=(p.display.lineNumWidth||1)+"px")}a.style.display=c?"":"none";r(p)}function r(p){p.display.sizer.style.marginLeft=p.display.gutters.offsetWidth+"px"}function q(p){if(0==p.height)return 0;for(var a=p.text.length,b,c=p;b=Xa(c,!0);)b=b.find(0,!0),c=b.from.line,a+=b.from.ch-b.to.ch;for(c=p;b=Xa(c,!1);)b=b.find(0,!0),a-=c.text.length-b.from.ch,
c=b.to.line,a+=c.text.length-b.to.ch;return a}function t(p){var a=p.display;p=p.doc;a.maxLine=D(p,p.first);a.maxLineLength=q(a.maxLine);a.maxLineChanged=!0;p.iter(function(p){var b=q(p);b>a.maxLineLength&&(a.maxLineLength=b,a.maxLine=p)})}function x(p){var a=ea(p.gutters,"CodeMirror-linenumbers");-1==a&&p.lineNumbers?p.gutters=p.gutters.concat(["CodeMirror-linenumbers"]):-1<a&&!p.lineNumbers&&(p.gutters=p.gutters.slice(0),p.gutters.splice(a,1))}function z(p){var a=p.display,b=a.gutters.offsetWidth,
c=Math.round(p.doc.height+cd(p.display));return{clientHeight:a.scroller.clientHeight,viewHeight:a.wrapper.clientHeight,scrollWidth:a.scroller.scrollWidth,clientWidth:a.scroller.clientWidth,viewWidth:a.wrapper.clientWidth,barLeft:p.options.fixedGutter?b:0,docHeight:c,scrollHeight:c+za(p)+a.barHeight,nativeBarWidth:a.nativeBarWidth,gutterWidth:b}}function v(p,a,b){this.cm=b;var c=this.vert=B("div",[B("div",null,null,"min-width: 1px")],"CodeMirror-vscrollbar"),d=this.horiz=B("div",[B("div",null,null,
"height: 100%; min-height: 1px")],"CodeMirror-hscrollbar");p(c);p(d);F(c,"scroll",function(){c.clientHeight&&a(c.scrollTop,"vertical")});F(d,"scroll",function(){d.clientWidth&&a(d.scrollLeft,"horizontal")});this.checkedOverlay=!1;M&&8>R&&(this.horiz.style.minHeight=this.vert.style.minWidth="18px")}function u(){}function s(p){p.display.scrollbars&&(p.display.scrollbars.clear(),p.display.scrollbars.addClass&&Mb(p.display.wrapper,p.display.scrollbars.addClass));p.display.scrollbars=new d.scrollbarModel[p.options.scrollbarStyle](function(a){p.display.wrapper.insertBefore(a,
p.display.scrollbarFiller);F(a,"mousedown",function(){p.state.focused&&setTimeout(function(){p.display.input.focus()},0)});a.setAttribute("cm-not-content","true")},function(a,b){"horizontal"==b?mb(p,a):Nb(p,a)},p);p.display.scrollbars.addClass&&Ob(p.display.wrapper,p.display.scrollbars.addClass)}function w(p,a){a||(a=z(p));var b=p.display.barWidth,c=p.display.barHeight;G(p,a);for(var d=0;4>d&&b!=p.display.barWidth||c!=p.display.barHeight;d++)b!=p.display.barWidth&&p.options.lineWrapping&&nb(p),G(p,
z(p)),b=p.display.barWidth,c=p.display.barHeight}function G(p,a){var b=p.display,c=b.scrollbars.update(a);b.sizer.style.paddingRight=(b.barWidth=c.right)+"px";b.sizer.style.paddingBottom=(b.barHeight=c.bottom)+"px";c.right&&c.bottom?(b.scrollbarFiller.style.display="block",b.scrollbarFiller.style.height=c.bottom+"px",b.scrollbarFiller.style.width=c.right+"px"):b.scrollbarFiller.style.display="";c.bottom&&p.options.coverGutterNextToScrollbar&&p.options.fixedGutter?(b.gutterFiller.style.display="block",
b.gutterFiller.style.height=c.bottom+"px",b.gutterFiller.style.width=a.gutterWidth+"px"):b.gutterFiller.style.display=""}function C(p,a,b){var c=b&&null!=b.top?Math.max(0,b.top):p.scroller.scrollTop,c=Math.floor(c-p.lineSpace.offsetTop),d=b&&null!=b.bottom?b.bottom:c+p.wrapper.clientHeight,c=Ya(a,c),d=Ya(a,d);if(b&&b.ensure){var f=b.ensure.from.line;b=b.ensure.to.line;f<c?(c=f,d=Ya(a,Aa(D(a,f))+p.wrapper.clientHeight)):Math.min(b,a.lastLine())>=d&&(c=Ya(a,Aa(D(a,b))-p.wrapper.clientHeight),d=b)}return{from:c,
to:Math.max(d,c+1)}}function H(p){var a=p.display,b=a.view;if(a.alignWidgets||a.gutters.firstChild&&p.options.fixedGutter){for(var c=S(a)-a.scroller.scrollLeft+p.doc.scrollLeft,d=a.gutters.offsetWidth,f=c+"px",g=0;g<b.length;g++)if(!b[g].hidden){p.options.fixedGutter&&b[g].gutter&&(b[g].gutter.style.left=f);var h=b[g].alignable;if(h)for(var n=0;n<h.length;n++)h[n].style.left=f}p.options.fixedGutter&&(a.gutters.style.left=c+d+"px")}}function L(p){if(!p.options.lineNumbers)return!1;var a=p.doc,a=E(p.options,
a.first+a.size-1),b=p.display;if(a.length!=b.lineNumChars){var c=b.measure.appendChild(B("div",[B("div",a)],"CodeMirror-linenumber CodeMirror-gutter-elt")),d=c.firstChild.offsetWidth,c=c.offsetWidth-d;b.lineGutter.style.width="";b.lineNumInnerWidth=Math.max(d,b.lineGutter.offsetWidth-c)+1;b.lineNumWidth=b.lineNumInnerWidth+c;b.lineNumChars=b.lineNumInnerWidth?a.length:-1;b.lineGutter.style.width=b.lineNumWidth+"px";r(p);return!0}return!1}function E(p,a){return String(p.lineNumberFormatter(a+p.firstLineNumber))}
function S(p){return p.scroller.getBoundingClientRect().left-p.sizer.getBoundingClientRect().left}function T(p,a,b){var c=p.display;this.viewport=a;this.visible=C(c,p.doc,a);this.editorIsHidden=!c.wrapper.offsetWidth;this.wrapperHeight=c.wrapper.clientHeight;this.wrapperWidth=c.wrapper.clientWidth;this.oldDisplayWidth=Na(p);this.force=b;this.dims=Za(p);this.events=[]}function U(p,a){var b=p.display,c=p.doc;if(a.editorIsHidden)return Oa(p),!1;if(!a.force&&a.visible.from>=b.viewFrom&&a.visible.to<=
b.viewTo&&(null==b.updateLineNumbers||b.updateLineNumbers>=b.viewTo)&&b.renderedView==b.view&&0==Td(p))return!1;L(p)&&(Oa(p),a.dims=Za(p));var d=c.first+c.size,f=Math.max(a.visible.from-p.options.viewportMargin,c.first),g=Math.min(d,a.visible.to+p.options.viewportMargin);b.viewFrom<f&&20>f-b.viewFrom&&(f=Math.max(c.first,b.viewFrom));b.viewTo>g&&20>b.viewTo-g&&(g=Math.min(d,b.viewTo));Pa&&(f=dd(p.doc,f),g=Ud(p.doc,g));c=f!=b.viewFrom||g!=b.viewTo||b.lastWrapHeight!=a.wrapperHeight||b.lastWrapWidth!=
a.wrapperWidth;d=p.display;0==d.view.length||f>=d.viewTo||g<=d.viewFrom?(d.view=rc(p,f,g),d.viewFrom=f):(d.viewFrom>f?d.view=rc(p,f,d.viewFrom).concat(d.view):d.viewFrom<f&&(d.view=d.view.slice($a(p,f))),d.viewFrom=f,d.viewTo<g?d.view=d.view.concat(rc(p,d.viewTo,g)):d.viewTo>g&&(d.view=d.view.slice(0,$a(p,g))));d.viewTo=g;b.viewOffset=Aa(D(p.doc,b.viewFrom));p.display.mover.style.top=b.viewOffset+"px";g=Td(p);if(!c&&0==g&&!a.force&&b.renderedView==b.view&&(null==b.updateLineNumbers||b.updateLineNumbers>=
b.viewTo))return!1;f=Ba();4<g&&(b.lineDiv.style.display="none");ed(p,b.updateLineNumbers,a.dims);4<g&&(b.lineDiv.style.display="");b.renderedView=b.view;f&&Ba()!=f&&f.offsetHeight&&f.focus();Wa(b.cursorDiv);Wa(b.selectionDiv);b.gutters.style.height=b.sizer.style.minHeight=0;c&&(b.lastWrapHeight=a.wrapperHeight,b.lastWrapWidth=a.wrapperWidth,Jb(p,400));b.updateLineNumbers=null;return!0}function Ha(p,a){for(var b=a.viewport,c=!0;;c=!1){if(!c||!p.options.lineWrapping||a.oldDisplayWidth==Na(p))if(b&&
null!=b.top&&(b={top:Math.min(p.doc.height+cd(p.display)-fd(p),b.top)}),a.visible=C(p.display,p.doc,b),a.visible.from>=p.display.viewFrom&&a.visible.to<=p.display.viewTo)break;if(!U(p,a))break;nb(p);c=z(p);Pb(p);Qb(p,c);w(p,c)}a.signal(p,"update",p);if(p.display.viewFrom!=p.display.reportedViewFrom||p.display.viewTo!=p.display.reportedViewTo)a.signal(p,"viewportChange",p,p.display.viewFrom,p.display.viewTo),p.display.reportedViewFrom=p.display.viewFrom,p.display.reportedViewTo=p.display.viewTo}function Rb(p,
a){var b=new T(p,a);if(U(p,b)){nb(p);Ha(p,b);var c=z(p);Pb(p);Qb(p,c);w(p,c);b.finish()}}function Qb(p,a){p.display.sizer.style.minHeight=a.docHeight+"px";var b=a.docHeight+p.display.barHeight;p.display.heightForcer.style.top=b+"px";p.display.gutters.style.height=Math.max(b+za(p),a.clientHeight)+"px"}function nb(p){p=p.display;for(var a=p.lineDiv.offsetTop,b=0;b<p.view.length;b++){var c=p.view[b],d;if(!c.hidden){if(M&&8>R){var f=c.node.offsetTop+c.node.offsetHeight;d=f-a;a=f}else d=c.node.getBoundingClientRect(),
d=d.bottom-d.top;f=c.line.height-d;2>d&&(d=Ua(p));if(.001<f||-.001>f)if(ya(c.line,d),ab(c.line),c.rest)for(d=0;d<c.rest.length;d++)ab(c.rest[d])}}}function ab(p){if(p.widgets)for(var a=0;a<p.widgets.length;++a)p.widgets[a].height=p.widgets[a].node.offsetHeight}function Za(p){for(var a=p.display,b={},c={},d=a.gutters.clientLeft,f=a.gutters.firstChild,g=0;f;f=f.nextSibling,++g)b[p.options.gutters[g]]=f.offsetLeft+f.clientLeft+d,c[p.options.gutters[g]]=f.clientWidth;return{fixedPos:S(a),gutterTotalWidth:a.gutters.offsetWidth,
gutterLeft:b,gutterWidth:c,wrapperWidth:a.wrapper.clientWidth}}function ed(p,a,b){function c(a){var b=a.nextSibling;Y&&sa&&p.display.currentWheelTarget==a?a.style.display="none":a.parentNode.removeChild(a);return b}for(var d=p.display,f=p.options.lineNumbers,g=d.lineDiv,h=g.firstChild,n=d.view,d=d.viewFrom,m=0;m<n.length;m++){var q=n[m];if(!q.hidden)if(q.node&&q.node.parentNode==g){for(;h!=q.node;)h=c(h);h=f&&null!=a&&a<=d&&q.lineNumber;q.changes&&(-1<ea(q.changes,"gutter")&&(h=!1),Sb(p,q,d,b));h&&
(Wa(q.lineNumber),q.lineNumber.appendChild(document.createTextNode(E(p.options,d))));h=q.node.nextSibling}else{var r=gd(p,q,d,b);g.insertBefore(r,h)}d+=q.size}for(;h;)h=c(h)}function Sb(p,a,b,c){for(var d=0;d<a.changes.length;d++){var f=a.changes[d];if("text"==f){var f=a,g=f.text.className,h=sc(p,f);f.text==f.node&&(f.node=h.pre);f.text.parentNode.replaceChild(h.pre,f.text);f.text=h.pre;h.bgClass!=f.bgClass||h.textClass!=f.textClass?(f.bgClass=h.bgClass,f.textClass=h.textClass,Tb(f)):g&&(f.text.className=
g)}else if("gutter"==f)tc(p,a,b,c);else if("class"==f)Tb(a);else if("widget"==f){f=p;g=a;h=c;g.alignable&&(g.alignable=null);for(var n=g.node.firstChild,m=void 0;n;n=m)m=n.nextSibling,"CodeMirror-linewidget"==n.className&&g.node.removeChild(n);Ub(f,g,h)}}a.changes=null}function Ia(p){p.node==p.text&&(p.node=B("div",null,null,"position: relative"),p.text.parentNode&&p.text.parentNode.replaceChild(p.node,p.text),p.node.appendChild(p.text),M&&8>R&&(p.node.style.zIndex=2));return p.node}function sc(p,
a){var b=p.display.externalMeasured;return b&&b.line==a.line?(p.display.externalMeasured=null,a.measure=b.measure,b.built):Vd(p,a)}function Tb(p){var a=p.bgClass?p.bgClass+" "+(p.line.bgClass||""):p.line.bgClass;a&&(a+=" CodeMirror-linebackground");if(p.background)a?p.background.className=a:(p.background.parentNode.removeChild(p.background),p.background=null);else if(a){var b=Ia(p);p.background=b.insertBefore(B("div",null,a),b.firstChild)}p.line.wrapClass?Ia(p).className=p.line.wrapClass:p.node!=
p.text&&(p.node.className="");p.text.className=(p.textClass?p.textClass+" "+(p.line.textClass||""):p.line.textClass)||""}function tc(p,a,b,c){a.gutter&&(a.node.removeChild(a.gutter),a.gutter=null);a.gutterBackground&&(a.node.removeChild(a.gutterBackground),a.gutterBackground=null);if(a.line.gutterClass){var d=Ia(a);a.gutterBackground=B("div",null,"CodeMirror-gutter-background "+a.line.gutterClass,"left: "+(p.options.fixedGutter?c.fixedPos:-c.gutterTotalWidth)+"px; width: "+c.gutterTotalWidth+"px");
d.insertBefore(a.gutterBackground,a.text)}var f=a.line.gutterMarkers;if(p.options.lineNumbers||f){var d=Ia(a),g=a.gutter=B("div",null,"CodeMirror-gutter-wrapper","left: "+(p.options.fixedGutter?c.fixedPos:-c.gutterTotalWidth)+"px");p.display.input.setUneditable(g);d.insertBefore(g,a.text);a.line.gutterClass&&(g.className+=" "+a.line.gutterClass);!p.options.lineNumbers||f&&f["CodeMirror-linenumbers"]||(a.lineNumber=g.appendChild(B("div",E(p.options,b),"CodeMirror-linenumber CodeMirror-gutter-elt",
"left: "+c.gutterLeft["CodeMirror-linenumbers"]+"px; width: "+p.display.lineNumInnerWidth+"px")));if(f)for(a=0;a<p.options.gutters.length;++a)b=p.options.gutters[a],(d=f.hasOwnProperty(b)&&f[b])&&g.appendChild(B("div",[d],"CodeMirror-gutter-elt","left: "+c.gutterLeft[b]+"px; width: "+c.gutterWidth[b]+"px"))}}function gd(p,a,b,c){var d=sc(p,a);a.text=a.node=d.pre;d.bgClass&&(a.bgClass=d.bgClass);d.textClass&&(a.textClass=d.textClass);Tb(a);tc(p,a,b,c);Ub(p,a,c);return a.node}function Ub(p,a,b){Vb(p,
a.line,a,b,!0);if(a.rest)for(var c=0;c<a.rest.length;c++)Vb(p,a.rest[c],a,b,!1)}function Vb(p,a,b,c,d){if(a.widgets){var f=Ia(b),g=0;for(a=a.widgets;g<a.length;++g){var h=a[g],n=B("div",[h.node],"CodeMirror-linewidget");h.handleMouseEvents||n.setAttribute("cm-ignore-events","true");var m=h,q=n,r=c;if(m.noHScroll){(b.alignable||(b.alignable=[])).push(q);var s=r.wrapperWidth;q.style.left=r.fixedPos+"px";m.coverGutter||(s-=r.gutterTotalWidth,q.style.paddingLeft=r.gutterTotalWidth+"px");q.style.width=
s+"px"}m.coverGutter&&(q.style.zIndex=5,q.style.position="relative",m.noHScroll||(q.style.marginLeft=-r.gutterTotalWidth+"px"));p.display.input.setUneditable(n);d&&h.above?f.insertBefore(n,b.gutter||b.text):f.appendChild(n);fa(h,"redraw")}}}function ob(p){return A(p.line,p.ch)}function pb(p,a){return 0>K(p,a)?a:p}function qb(p,a){return 0>K(p,a)?p:a}function uc(p){p.state.focused||(p.display.input.focus(),ad(p))}function Qa(p){return p.options.readOnly||p.doc.cantEdit}function bb(p,a,b,c,d){var f=
p.doc;p.display.shift=!1;c||(c=f.sel);var g=p.state.pasteIncoming||"paste"==d,h=f.splitLines(a),n=null;if(g&&1<c.ranges.length)if(oa&&oa.join("\n")==a){if(0==c.ranges.length%oa.length)for(var n=[],m=0;m<oa.length;m++)n.push(f.splitLines(oa[m]))}else h.length==c.ranges.length&&(n=vc(h,function(p){return[p]}));for(m=c.ranges.length-1;0<=m;m--){var q=c.ranges[m],r=q.from(),s=q.to();q.empty()&&(b&&0<b?r=A(r.line,r.ch-b):p.state.overwrite&&!g&&(s=A(s.line,Math.min(D(f,s.line).text.length,s.ch+N(h).length))));
q=p.curOp.updateInput;r={from:r,to:s,text:n?n[m%n.length]:h,origin:d||(g?"paste":p.state.cutIncoming?"cut":"+input")};rb(p.doc,r);fa(p,"inputRead",p,r)}a&&!g&&Z(p,a);sb(p);p.curOp.updateInput=q;p.curOp.typing=!0;p.state.pasteIncoming=p.state.cutIncoming=!1}function aa(p,a){var b=p.clipboardData&&p.clipboardData.getData("text/plain");if(b)return p.preventDefault(),ka(a,function(){bb(a,b,0,null,"paste")}),!0}function Z(p,a){if(p.options.electricChars&&p.options.smartIndent)for(var b=p.doc.sel,c=b.ranges.length-
1;0<=c;c--){var d=b.ranges[c];if(!(100<d.head.ch||c&&b.ranges[c-1].head.line==d.head.line)){var f=p.getModeAt(d.head),g=!1;if(f.electricChars)for(var h=0;h<f.electricChars.length;h++){if(-1<a.indexOf(f.electricChars.charAt(h))){g=Wb(p,d.head.line,"smart");break}}else f.electricInput&&f.electricInput.test(D(p.doc,d.head.line).text.slice(0,d.head.ch))&&(g=Wb(p,d.head.line,"smart"));g&&fa(p,"electricInput",p,d.head.line)}}}function W(p){for(var a=[],b=[],c=0;c<p.doc.sel.ranges.length;c++){var d=p.doc.sel.ranges[c].head.line,
d={anchor:A(d,0),head:A(d+1,0)};b.push(d);a.push(p.getRange(d.anchor,d.head))}return{text:a,ranges:b}}function Wd(p){p.setAttribute("autocorrect","off");p.setAttribute("autocapitalize","off");p.setAttribute("spellcheck","false")}function hd(p){this.cm=p;this.prevInput="";this.pollingFast=!1;this.polling=new Gb;this.hasSelection=this.inaccurateSelection=!1;this.composing=null}function Xd(){var p=B("textarea",null,null,"position: absolute; padding: 0; width: 1px; height: 1em; outline: none"),a=B("div",
[p],null,"overflow: hidden; position: relative; width: 3px; height: 0px;");Y?p.style.width="1000px":p.setAttribute("wrap","off");tb&&(p.style.border="1px solid black");Wd(p);return a}function id(p){this.cm=p;this.lastAnchorNode=this.lastAnchorOffset=this.lastFocusNode=this.lastFocusOffset=null;this.polling=new Gb;this.gracePeriod=!1}function Yd(p,a){var b=jd(p,a.line);if(!b||b.hidden)return null;var c=D(p.doc,a.line),b=Zd(b,c,a.line),c=ta(c),d="left";c&&(d=wc(c,a.ch)%2?"right":"left");b=$d(b.map,
a.ch,d);b.offset="right"==b.collapse?b.end:b.start;return b}function ub(p,a){a&&(p.bad=!0);return p}function xc(p,a,b){var c;if(a==p.display.lineDiv){c=p.display.lineDiv.childNodes[b];if(!c)return ub(p.clipPos(A(p.display.viewTo-1)),!0);a=null;b=0}else for(c=a;;c=c.parentNode){if(!c||c==p.display.lineDiv)return null;if(c.parentNode&&c.parentNode==p.display.lineDiv)break}for(var d=0;d<p.display.view.length;d++){var f=p.display.view[d];if(f.node==c)return tf(f,a,b)}}function tf(p,a,b){function c(a,
b,O){for(var d=-1;d<(m?m.length:0);d++)for(var ma=0>d?n.map:m[d],f=0;f<ma.length;f+=3){var xa=ma[f+2];if(xa==a||xa==b){b=P(0>d?p.line:p.rest[d]);d=ma[f]+O;if(0>O||xa!=a)d=ma[f+(O?1:0)];return A(b,d)}}}var d=p.text.firstChild,f=!1;if(!a||!kd(d,a))return ub(A(P(p.line),0),!0);if(a==d&&(f=!0,a=d.childNodes[b],b=0,!a))return b=p.rest?N(p.rest):p.line,ub(A(P(b),b.text.length),f);var g=3==a.nodeType?a:null,h=a;g||1!=a.childNodes.length||3!=a.firstChild.nodeType||(g=a.firstChild,b&&(b=g.nodeValue.length));
for(;h.parentNode!=d;)h=h.parentNode;var n=p.measure,m=n.maps;if(a=c(g,h,b))return ub(a,f);d=h.nextSibling;for(g=g?g.nodeValue.length-b:0;d;d=d.nextSibling){if(a=c(d,d.firstChild,0))return ub(A(a.line,a.ch-g),f);g+=d.textContent.length}h=h.previousSibling;for(g=b;h;h=h.previousSibling){if(a=c(h,h.firstChild,-1))return ub(A(a.line,a.ch+g),f);g+=d.textContent.length}}function uf(p,a,b,c,d){function f(p){return function(a){return a.id==p}}function g(a){if(1==a.nodeType){var b=a.getAttribute("cm-text");
if(null!=b)""==b&&(b=a.textContent.replace(/\u200b/g,"")),h+=b;else{var b=a.getAttribute("cm-marker"),O;if(b)a=p.findMarks(A(c,0),A(d+1,0),f(+b)),a.length&&(O=a[0].find())&&(h+=cb(p.doc,O.from,O.to).join(m));else if("false"!=a.getAttribute("contenteditable")){for(O=0;O<a.childNodes.length;O++)g(a.childNodes[O]);/^(pre|div|p)$/i.test(a.nodeName)&&(n=!0)}}}else 3==a.nodeType&&(a=a.nodeValue)&&(n&&(h+=m,n=!1),h+=a)}for(var h="",n=!1,m=p.doc.lineSeparator();;){g(a);if(a==b)break;a=a.nextSibling}return h}
function Ja(p,a){this.ranges=p;this.primIndex=a}function Q(p,a){this.anchor=p;this.head=a}function ua(p,a){var b=p[a];p.sort(function(p,a){return K(p.from(),a.from())});a=ea(p,b);for(b=1;b<p.length;b++){var c=p[b],d=p[b-1];if(0<=K(d.to(),c.from())){var f=qb(d.from(),c.from()),g=pb(d.to(),c.to()),c=d.empty()?c.from()==c.head:d.from()==d.head;b<=a&&--a;p.splice(--b,2,new Q(c?g:f,c?f:g))}}return new Ja(p,a)}function Ca(p,a){return new Ja([new Q(p,a||p)],0)}function J(p,a){if(a.line<p.first)return A(p.first,
0);var b=p.first+p.size-1;if(a.line>b)return A(b,D(p,b).text.length);var b=D(p,a.line).text.length,c=a.ch,b=null==c||c>b?A(a.line,b):0>c?A(a.line,0):a;return b}function Xb(p,a){return a>=p.first&&a<p.first+p.size}function Yb(p,a,b,c){return p.cm&&p.cm.display.shift||p.extend?(p=a.anchor,c&&(a=0>K(b,p),a!=0>K(c,p)?(p=b,b=c):a!=0>K(b,c)&&(b=c)),new Q(p,b)):new Q(c||b,b)}function yc(a,b,c,d){ba(a,new Ja([Yb(a,a.sel.primary(),b,c)],0),d)}function ae(a,b,c){for(var d=[],f=0;f<a.sel.ranges.length;f++)d[f]=
Yb(a,a.sel.ranges[f],b[f],null);b=ua(d,a.sel.primIndex);ba(a,b,c)}function ld(a,b,c,d){var f=a.sel.ranges.slice(0);f[b]=c;ba(a,ua(f,a.sel.primIndex),d)}function vf(a,b){var c={ranges:b.ranges,update:function(b){this.ranges=[];for(var c=0;c<b.length;c++)this.ranges[c]=new Q(J(a,b[c].anchor),J(a,b[c].head))}};X(a,"beforeSelectionChange",a,c);a.cm&&X(a.cm,"beforeSelectionChange",a.cm,c);return c.ranges!=b.ranges?ua(c.ranges,c.ranges.length-1):b}function be(a,b,c){var d=a.history.done,f=N(d);f&&f.ranges?
(d[d.length-1]=b,zc(a,b,c)):ba(a,b,c)}function ba(a,b,c){zc(a,b,c);b=a.sel;var d=a.cm?a.cm.curOp.id:NaN,f=a.history,g=c&&c.origin,h;if(!(h=d==f.lastSelOp)&&(h=g&&f.lastSelOrigin==g)&&!(h=f.lastModTime==f.lastSelTime&&f.lastOrigin==g)){h=N(f.done);var n=g.charAt(0);h="*"==n||"+"==n&&h.ranges.length==b.ranges.length&&h.somethingSelected()==b.somethingSelected()&&new Date-a.history.lastSelTime<=(a.cm?a.cm.options.historyEventDelay:500)}h?f.done[f.done.length-1]=b:Ac(b,f.done);f.lastSelTime=+new Date;
f.lastSelOrigin=g;f.lastSelOp=d;c&&!1!==c.clearRedo&&ce(f.undone)}function zc(a,b,c){if(pa(a,"beforeSelectionChange")||a.cm&&pa(a.cm,"beforeSelectionChange"))b=vf(a,b);var d=c&&c.bias||(0>K(b.primary().head,a.sel.primary().head)?-1:1);de(a,ee(a,b,d,!0));c&&!1===c.scroll||!a.cm||sb(a.cm)}function de(a,b){b.equals(a.sel)||(a.sel=b,a.cm&&(a.cm.curOp.updateInput=a.cm.curOp.selectionChanged=!0,fe(a.cm)),fa(a,"cursorActivity",a))}function ge(a){de(a,ee(a,a.sel,null,!1),Da)}function ee(a,b,c,d){for(var f,
g=0;g<b.ranges.length;g++){var h=b.ranges[g],n=Bc(a,h.anchor,c,d),m=Bc(a,h.head,c,d);if(f||n!=h.anchor||m!=h.head)f||(f=b.ranges.slice(0,g)),f[g]=new Q(n,m)}return f?ua(f,b.primIndex):b}function Bc(a,b,c,d){var f=!1,g=b,h=c||1;a.cantEdit=!1;a:for(;;){var n=D(a,g.line);if(n.markedSpans)for(var m=0;m<n.markedSpans.length;++m){var q=n.markedSpans[m],r=q.marker;if((null==q.from||(r.inclusiveLeft?q.from<=g.ch:q.from<g.ch))&&(null==q.to||(r.inclusiveRight?q.to>=g.ch:q.to>g.ch))){if(d&&(X(r,"beforeCursorEnter"),
r.explicitlyCleared))if(n.markedSpans){--m;continue}else break;if(r.atomic){m=r.find(0>h?-1:1);if(0==K(m,g)&&(m.ch+=h,0>m.ch?m=m.line>a.first?J(a,A(m.line-1)):null:m.ch>n.text.length&&(m=m.line<a.first+a.size-1?A(m.line+1,0):null),!m)){if(f){if(!d)return Bc(a,b,c,!0);a.cantEdit=!0;return A(a.first,0)}f=!0;m=b;h=-h}g=m;continue a}}}return g}}function Pb(a){a.display.input.showSelection(a.display.input.prepareSelection())}function he(a,b){for(var c=a.doc,d={},f=d.cursors=document.createDocumentFragment(),
g=d.selection=document.createDocumentFragment(),h=0;h<c.sel.ranges.length;h++)if(!1!==b||h!=c.sel.primIndex){var n=c.sel.ranges[h],m=n.empty();if(m||a.options.showCursorWhenSelecting){var q=a,r=f,s=Ka(q,n.head,"div",null,null,!q.options.singleCursorHeightPerLine),t=r.appendChild(B("div","\u00a0","CodeMirror-cursor"));t.style.left=s.left+"px";t.style.top=s.top+"px";t.style.height=Math.max(0,s.bottom-s.top)*q.options.cursorHeight+"px";s.other&&(q=r.appendChild(B("div","\u00a0","CodeMirror-cursor CodeMirror-secondarycursor")),
q.style.display="",q.style.left=s.other.left+"px",q.style.top=s.other.top+"px",q.style.height=.85*(s.other.bottom-s.other.top)+"px")}m||wf(a,n,g)}return d}function wf(a,b,c){function d(a,p,b,c){0>p&&(p=0);p=Math.round(p);c=Math.round(c);n.appendChild(B("div",null,"CodeMirror-selected","position: absolute; left: "+a+"px; top: "+p+"px; width: "+(null==b?r-a:b)+"px; height: "+(c-p)+"px"))}function f(b,c,O){var ma=D(h,b),na=ma.text.length,g,n;xf(ta(ma),c||0,null==O?na:O,function(f,h,ca){var m=Cc(a,A(b,
f),"div",ma,"left"),s,qc;f==h?(s=m,ca=qc=m.left):(s=Cc(a,A(b,h-1),"div",ma,"right"),"rtl"==ca&&(ca=m,m=s,s=ca),ca=m.left,qc=s.right);null==c&&0==f&&(ca=q);3<s.top-m.top&&(d(ca,m.top,null,m.bottom),ca=q,m.bottom<s.top&&d(ca,m.bottom,null,s.top));null==O&&h==na&&(qc=r);if(!g||m.top<g.top||m.top==g.top&&m.left<g.left)g=m;if(!n||s.bottom>n.bottom||s.bottom==n.bottom&&s.right>n.right)n=s;ca<q+1&&(ca=q);d(ca,s.top,qc-ca,s.bottom)});return{start:g,end:n}}var g=a.display,h=a.doc,n=document.createDocumentFragment(),
m=ie(a.display),q=m.left,r=Math.max(g.sizerWidth,Na(a)-g.sizer.offsetLeft)-m.right,g=b.from();b=b.to();if(g.line==b.line)f(g.line,g.ch,b.ch);else{var s=D(h,g.line),m=D(h,b.line),m=Ea(s)==Ea(m),g=f(g.line,g.ch,m?s.text.length+1:null).end;b=f(b.line,m?0:null,b.ch).start;m&&(g.top<b.top-2?(d(g.right,g.top,null,g.bottom),d(q,b.top,b.left,b.bottom)):d(g.right,g.top,b.left-g.right,g.bottom));g.bottom<b.top&&d(q,g.bottom,null,b.top)}c.appendChild(n)}function md(a){if(a.state.focused){var b=a.display;clearInterval(b.blinker);
var c=!0;b.cursorDiv.style.visibility="";0<a.options.cursorBlinkRate?b.blinker=setInterval(function(){b.cursorDiv.style.visibility=(c=!c)?"":"hidden"},a.options.cursorBlinkRate):0>a.options.cursorBlinkRate&&(b.cursorDiv.style.visibility="hidden")}}function Jb(a,b){a.doc.mode.startState&&a.doc.frontier<a.display.viewTo&&a.state.highlight.set(b,Hb(yf,a))}function yf(a){var b=a.doc;b.frontier<b.first&&(b.frontier=b.first);if(!(b.frontier>=a.display.viewTo)){var c=+new Date+a.options.workTime,d=vb(b.mode,
Zb(a,b.frontier)),f=[];b.iter(b.frontier,Math.min(b.first+b.size,a.display.viewTo+500),function(g){if(b.frontier>=a.display.viewFrom){var h=g.styles,n=je(a,g,d,!0);g.styles=n.styles;var m=g.styleClasses;(n=n.classes)?g.styleClasses=n:m&&(g.styleClasses=null);m=!h||h.length!=g.styles.length||m!=n&&(!m||!n||m.bgClass!=n.bgClass||m.textClass!=n.textClass);for(n=0;!m&&n<h.length;++n)m=h[n]!=g.styles[n];m&&f.push(b.frontier);g.stateAfter=vb(b.mode,d)}else nd(a,g.text,d),g.stateAfter=0==b.frontier%5?vb(b.mode,
d):null;++b.frontier;if(+new Date>c)return Jb(a,a.options.workDelay),!0});f.length&&ka(a,function(){for(var b=0;b<f.length;b++)La(a,f[b],"text")})}}function zf(a,b,c){for(var d,f,g=a.doc,h=c?-1:b-(a.doc.mode.innerMode?1E3:100);b>h;--b){if(b<=g.first)return g.first;var n=D(g,b-1);if(n.stateAfter&&(!c||b<=g.frontier))return b;n=va(n.text,null,a.options.tabSize);if(null==f||d>n)f=b-1,d=n}return f}function Zb(a,b,c){var d=a.doc,f=a.display;if(!d.mode.startState)return!0;var g=zf(a,b,c),h=g>d.first&&D(d,
g-1).stateAfter,h=h?vb(d.mode,h):Af(d.mode);d.iter(g,b,function(c){nd(a,c.text,h);c.stateAfter=g==b-1||0==g%5||g>=f.viewFrom&&g<f.viewTo?vb(d.mode,h):null;++g});c&&(d.frontier=g);return h}function cd(a){return a.mover.offsetHeight-a.lineSpace.offsetHeight}function ie(a){if(a.cachedPaddingH)return a.cachedPaddingH;var b=qa(a.measure,B("pre","x")),b=window.getComputedStyle?window.getComputedStyle(b):b.currentStyle,b={left:parseInt(b.paddingLeft),right:parseInt(b.paddingRight)};isNaN(b.left)||isNaN(b.right)||
(a.cachedPaddingH=b);return b}function za(a){return Sd-a.display.nativeBarWidth}function Na(a){return a.display.scroller.clientWidth-za(a)-a.display.barWidth}function fd(a){return a.display.scroller.clientHeight-za(a)-a.display.barHeight}function Zd(a,b,c){if(a.line==b)return{map:a.measure.map,cache:a.measure.cache};for(var d=0;d<a.rest.length;d++)if(a.rest[d]==b)return{map:a.measure.maps[d],cache:a.measure.caches[d]};for(d=0;d<a.rest.length;d++)if(P(a.rest[d])>c)return{map:a.measure.maps[d],cache:a.measure.caches[d],
before:!0}}function jd(a,b){if(b>=a.display.viewFrom&&b<a.display.viewTo)return a.display.view[$a(a,b)];var c=a.display.externalMeasured;if(c&&b>=c.lineN&&b<c.lineN+c.size)return c}function Dc(a,b){var c=P(b),d=jd(a,c);d&&!d.text?d=null:d&&d.changes&&(Sb(a,d,c,Za(a)),a.curOp.forceUpdate=!0);if(!d){var f;f=Ea(b);d=P(f);f=a.display.externalMeasured=new ke(a.doc,f,d);f.lineN=d;d=f.built=Vd(a,f);f.text=d.pre;qa(a.display.lineMeasure,d.pre);d=f}c=Zd(d,b,c);return{line:b,view:d,rect:null,map:c.map,cache:c.cache,
before:c.before,hasHeights:!1}}function od(a,b,c,d,f){b.before&&(c=-1);var g=c+(d||"");if(b.cache.hasOwnProperty(g))a=b.cache[g];else{b.rect||(b.rect=b.view.text.getBoundingClientRect());if(!b.hasHeights){var h=b.view,n=b.rect,m=a.options.lineWrapping,q=m&&Na(a);if(!h.measure.heights||m&&h.measure.width!=q){var s=h.measure.heights=[];if(m)for(h.measure.width=q,h=h.text.firstChild.getClientRects(),m=0;m<h.length-1;m++){var q=h[m],r=h[m+1];2<Math.abs(q.bottom-r.bottom)&&s.push((q.bottom+r.top)/2-n.top)}s.push(n.bottom-
n.top)}b.hasHeights=!0}h=d;m=$d(b.map,c,h);d=m.node;n=m.start;q=m.end;c=m.collapse;var t;if(3==d.nodeType){for(s=0;4>s;s++){for(;n&&$b(b.line.text.charAt(m.coverStart+n));)--n;for(;m.coverStart+q<m.coverEnd&&$b(b.line.text.charAt(m.coverStart+q));)++q;if(M&&9>R&&0==n&&q==m.coverEnd-m.coverStart)t=d.parentNode.getBoundingClientRect();else if(M&&a.options.lineWrapping){var v=db(d,n,q).getClientRects();t=v.length?v["right"==h?v.length-1:0]:pd}else t=db(d,n,q).getBoundingClientRect()||pd;if(t.left||t.right||
0==n)break;q=n;n-=1;c="right"}if(M&&11>R){if(v=window.screen&&null!=screen.logicalXDPI&&screen.logicalXDPI!=screen.deviceXDPI)null!=qd?v=qd:(s=qa(a.display.measure,B("span","x")),v=s.getBoundingClientRect(),s=db(s,0,1).getBoundingClientRect(),v=qd=1<Math.abs(v.left-s.left));v&&(v=screen.logicalXDPI/screen.deviceXDPI,s=screen.logicalYDPI/screen.deviceYDPI,t={left:t.left*v,right:t.right*v,top:t.top*s,bottom:t.bottom*s})}}else 0<n&&(c=h="right"),t=a.options.lineWrapping&&1<(v=d.getClientRects()).length?
v["right"==h?v.length-1:0]:d.getBoundingClientRect();!(M&&9>R)||n||t&&(t.left||t.right)||(t=(t=d.parentNode.getClientRects()[0])?{left:t.left,right:t.left+Kb(a.display),top:t.top,bottom:t.bottom}:pd);v=t.top-b.rect.top;d=t.bottom-b.rect.top;n=(v+d)/2;h=b.view.measure.heights;for(s=0;s<h.length-1&&!(n<h[s]);s++);c={left:("right"==c?t.right:t.left)-b.rect.left,right:("left"==c?t.left:t.right)-b.rect.left,top:s?h[s-1]:0,bottom:h[s]};t.left||t.right||(c.bogus=!0);a.options.singleCursorHeightPerLine||
(c.rtop=v,c.rbottom=d);a=c;a.bogus||(b.cache[g]=a)}return{left:a.left,right:a.right,top:f?a.rtop:a.top,bottom:f?a.rbottom:a.bottom}}function $d(a,b,c){for(var d,f,g,h,n=0;n<a.length;n+=3){var m=a[n],q=a[n+1];if(b<m)f=0,g=1,h="left";else if(b<q)f=b-m,g=f+1;else if(n==a.length-3||b==q&&a[n+3]>b)g=q-m,f=g-1,b>=q&&(h="right");if(null!=f){d=a[n+2];m==q&&c==(d.insertLeft?"left":"right")&&(h=c);if("left"==c&&0==f)for(;n&&a[n-2]==a[n-3]&&a[n-1].insertLeft;)d=a[(n-=3)+2],h="left";if("right"==c&&f==q-m)for(;n<
a.length-3&&a[n+3]==a[n+4]&&!a[n+5].insertLeft;)d=a[(n+=3)+2],h="right";break}}return{node:d,start:f,end:g,collapse:h,coverStart:m,coverEnd:q}}function le(a){if(a.measure&&(a.measure.cache={},a.measure.heights=null,a.rest))for(var b=0;b<a.rest.length;b++)a.measure.caches[b]={}}function me(a){a.display.externalMeasure=null;Wa(a.display.lineMeasure);for(var b=0;b<a.display.view.length;b++)le(a.display.view[b])}function Lb(a){me(a);a.display.cachedCharWidth=a.display.cachedTextHeight=a.display.cachedPaddingH=
...
a.left,top:b-a.top}}function Cc(a,b,c,d,f){d||(d=D(a.doc,b.line));var g=d;b=b.ch;d=od(a,Dc(a,d),b,f);return rd(a,g,d,c)}function Ka(a,b,c,d,f,g){function h(b,O){var n=od(a,f,b,O?"right":"left",g);O?n.left=n.right:n.right=n.left;return rd(a,d,n,c)}function n(a,b){var p=m[b],c=p.level%2;a==sd(p)&&b&&p.level<m[b-1].level?(p=m[--b],a=td(p)-(p.level%2?0:1),c=!0):a==td(p)&&b<m.length-1&&p.level<m[b+1].level&&(p=m[++b],a=sd(p)-p.level%2,c=!1);return c&&a==p.to&&a>p.from?h(a-1):h(a,c)}d=d||D(a.doc,b.line);
f||(f=Dc(a,d));var m=ta(d);b=b.ch;if(!m)return h(b);var q=wc(m,b),q=n(b,q);null!=bc&&(q.other=n(b,bc));return q}function oe(a,b){var c=0;b=J(a.doc,b);a.options.lineWrapping||(c=Kb(a.display)*b.ch);var d=D(a.doc,b.line),f=Aa(d)+a.display.lineSpace.offsetTop;return{left:c,right:c,top:f,bottom:f+d.height}}function Ec(a,b,c,d){a=A(a,b);a.xRel=d;c&&(a.outside=!0);return a}function ud(a,b,c){var d=a.doc;c+=a.display.viewOffset;if(0>c)return Ec(d.first,0,!0,-1);var f=Ya(d,c),g=d.first+d.size-1;if(f>g)return Ec(d.first+
d.size-1,D(d,g).text.length,!0,1);0>b&&(b=0);for(d=D(d,f);;)if(f=Bf(a,d,f,b,c),g=(d=Xa(d,!1))&&d.find(0,!0),d&&(f.ch>g.from.ch||f.ch==g.from.ch&&0<f.xRel))f=P(d=g.to.line);else return f}function Bf(a,b,c,d,f){function g(d){d=Ka(a,A(c,d),"line",b,q);n=!0;if(h>d.bottom)return d.left-m;if(h<d.top)return d.left+m;n=!1;return d.left}var h=f-Aa(b),n=!1,m=2*a.display.wrapper.clientWidth,q=Dc(a,b),s=ta(b),r=b.text.length;f=Fc(b);var t=Gc(b),v=g(f),x=n,w=g(t),G=n;if(d>w)return Ec(c,t,G,1);for(;;){if(s?t==
f||t==vd(b,f,1):1>=t-f){s=d<v||d-v<=w-d?f:t;for(d-=s==f?v:w;$b(b.text.charAt(s));)++s;return Ec(c,s,s==f?x:G,-1>d?-1:1<d?1:0)}var u=Math.ceil(r/2),z=f+u;if(s)for(var z=f,Z=0;Z<u;++Z)z=vd(b,z,1);Z=g(z);if(Z>d){t=z;w=Z;if(G=n)w+=1E3;r=u}else f=z,v=Z,x=n,r-=u}}function Ua(a){if(null!=a.cachedTextHeight)return a.cachedTextHeight;if(null==eb){eb=B("pre");for(var b=0;49>b;++b)eb.appendChild(document.createTextNode("x")),eb.appendChild(B("br"));eb.appendChild(document.createTextNode("x"))}qa(a.measure,eb);
b=eb.offsetHeight/50;3<b&&(a.cachedTextHeight=b);Wa(a.measure);return b||1}function Kb(a){if(null!=a.cachedCharWidth)return a.cachedCharWidth;var b=B("span","xxxxxxxxxx"),c=B("pre",[b]);qa(a.measure,c);b=b.getBoundingClientRect();b=(b.right-b.left)/10;2<b&&(a.cachedCharWidth=b);return b||10}function jb(a){a.curOp={cm:a,viewChanged:!1,startHeight:a.doc.height,forceUpdate:!1,updateInput:null,typing:!1,changeObjs:null,cursorActivityHandlers:null,cursorActivityCalled:0,selectionChanged:!1,updateMaxLine:!1,
scrollLeft:null,scrollTop:null,scrollToPos:null,focus:!1,id:++Cf};wb?wb.ops.push(a.curOp):a.curOp.ownsGroup=wb={ops:[a.curOp],delayedCallbacks:[]}}function lb(a){if(a=a.curOp.ownsGroup)try{var b=a.delayedCallbacks,c=0;do{for(;c<b.length;c++)b[c].call(null);for(var d=0;d<a.ops.length;d++){var f=a.ops[d];if(f.cursorActivityHandlers)for(;f.cursorActivityCalled<f.cursorActivityHandlers.length;)f.cursorActivityHandlers[f.cursorActivityCalled++].call(null,f.cm)}}while(c<b.length)}finally{wb=null;for(b=
0;b<a.ops.length;b++)a.ops[b].cm.curOp=null;a=a.ops;for(b=0;b<a.length;b++){var f=a[b],c=f.cm,d=c.display,g=c,h=g.display;!h.scrollbarsClipped&&h.scroller.offsetWidth&&(h.nativeBarWidth=h.scroller.offsetWidth-h.scroller.clientWidth,h.heightForcer.style.height=za(g)+"px",h.sizer.style.marginBottom=-h.nativeBarWidth+"px",h.sizer.style.borderRightWidth=za(g)+"px",h.scrollbarsClipped=!0);f.updateMaxLine&&t(c);f.mustUpdate=f.viewChanged||f.forceUpdate||null!=f.scrollTop||f.scrollToPos&&(f.scrollToPos.from.line<
d.viewFrom||f.scrollToPos.to.line>=d.viewTo)||d.maxLineChanged&&c.options.lineWrapping;f.update=f.mustUpdate&&new T(c,f.mustUpdate&&{top:f.scrollTop,ensure:f.scrollToPos},f.forceUpdate)}for(b=0;b<a.length;b++)f=a[b],f.updatedDisplay=f.mustUpdate&&U(f.cm,f.update);for(b=0;b<a.length;b++)if(f=a[b],c=f.cm,d=c.display,f.updatedDisplay&&nb(c),f.barMeasure=z(c),d.maxLineChanged&&!c.options.lineWrapping&&(g=f,h=d.maxLine.text.length,h=od(c,Dc(c,d.maxLine),h,void 0),g.adjustWidthTo=h.left+3,c.display.sizerWidth=
f.adjustWidthTo,f.barMeasure.scrollWidth=Math.max(d.scroller.clientWidth,d.sizer.offsetLeft+f.adjustWidthTo+za(c)+c.display.barWidth),f.maxScrollLeft=Math.max(0,d.sizer.offsetLeft+f.adjustWidthTo-Na(c))),f.updatedDisplay||f.selectionChanged)f.preparedSelection=d.input.prepareSelection();for(b=0;b<a.length;b++)f=a[b],c=f.cm,null!=f.adjustWidthTo&&(c.display.sizer.style.minWidth=f.adjustWidthTo+"px",f.maxScrollLeft<c.doc.scrollLeft&&mb(c,Math.min(c.display.scroller.scrollLeft,f.maxScrollLeft),!0),c.display.maxLineChanged=
!1),f.preparedSelection&&c.display.input.showSelection(f.preparedSelection),f.updatedDisplay&&Qb(c,f.barMeasure),(f.updatedDisplay||f.startHeight!=c.doc.height)&&w(c,f.barMeasure),f.selectionChanged&&md(c),c.state.focused&&f.updateInput&&c.display.input.reset(f.typing),f.focus&&f.focus==Ba()&&uc(f.cm);for(b=0;b<a.length;b++){f=a[b];c=f.cm;d=c.display;g=c.doc;f.updatedDisplay&&Ha(c,f.update);null==d.wheelStartX||null==f.scrollTop&&null==f.scrollLeft&&!f.scrollToPos||(d.wheelStartX=d.wheelStartY=null);
null==f.scrollTop||d.scroller.scrollTop==f.scrollTop&&!f.forceScroll||(g.scrollTop=Math.max(0,Math.min(d.scroller.scrollHeight-d.scroller.clientHeight,f.scrollTop)),d.scrollbars.setScrollTop(g.scrollTop),d.scroller.scrollTop=g.scrollTop);null==f.scrollLeft||d.scroller.scrollLeft==f.scrollLeft&&!f.forceScroll||(g.scrollLeft=Math.max(0,Math.min(d.scroller.scrollWidth-Na(c),f.scrollLeft)),d.scrollbars.setScrollLeft(g.scrollLeft),d.scroller.scrollLeft=g.scrollLeft,H(c));if(f.scrollToPos){var n=void 0,
h=J(g,f.scrollToPos.from),n=J(g,f.scrollToPos.to),m=f.scrollToPos.margin;null==m&&(m=0);for(var q=0;5>q;q++){var s=!1,r=Ka(c,h),v=n&&n!=h?Ka(c,n):r,v=Hc(c,Math.min(r.left,v.left),Math.min(r.top,v.top)-m,Math.max(r.left,v.left),Math.max(r.bottom,v.bottom)+m),x=c.doc.scrollTop,G=c.doc.scrollLeft;null!=v.scrollTop&&(Nb(c,v.scrollTop),1<Math.abs(c.doc.scrollTop-x)&&(s=!0));null!=v.scrollLeft&&(mb(c,v.scrollLeft),1<Math.abs(c.doc.scrollLeft-G)&&(s=!0));if(!s)break}n=r;f.scrollToPos.isCursor&&c.state.focused&&
(Fa(c,"scrollCursorIntoView")||(m=c.display,q=m.sizer.getBoundingClientRect(),h=null,0>n.top+q.top?h=!0:n.bottom+q.top>(window.innerHeight||document.documentElement.clientHeight)&&(h=!1),null==h||Df||(n=B("div","\u200b",null,"position: absolute; top: "+(n.top-m.viewOffset-c.display.lineSpace.offsetTop)+"px; height: "+(n.bottom-n.top+za(c)+m.barHeight)+"px; left: "+n.left+"px; width: 2px;"),c.display.lineSpace.appendChild(n),n.scrollIntoView(h),c.display.lineSpace.removeChild(n))))}h=f.maybeHiddenMarkers;
n=f.maybeUnhiddenMarkers;if(h)for(m=0;m<h.length;++m)h[m].lines.length||X(h[m],"hide");if(n)for(m=0;m<n.length;++m)n[m].lines.length&&X(n[m],"unhide");d.wrapper.offsetHeight&&(g.scrollTop=c.display.scroller.scrollTop);f.changeObjs&&X(c,"changes",c,f.changeObjs);f.update&&f.update.finish()}}}function ka(a,b){if(a.curOp)return b();jb(a);try{return b()}finally{lb(a)}}function V(a,b){return function(){if(a.curOp)return b.apply(a,arguments);jb(a);try{return b.apply(a,arguments)}finally{lb(a)}}}function da(a){return function(){if(this.curOp)return a.apply(this,
arguments);jb(this);try{return a.apply(this,arguments)}finally{lb(this)}}}function ga(a){return function(){var b=this.cm;if(!b||b.curOp)return a.apply(this,arguments);jb(b);try{return a.apply(this,arguments)}finally{lb(b)}}}function ke(a,b,c){for(var d=this.line=b,f;d=Xa(d,!1);)d=d.find(1,!0).line,(f||(f=[])).push(d);this.size=(this.rest=f)?P(N(this.rest))-c+1:1;this.node=this.text=null;this.hidden=Va(a,b)}function rc(a,b,c){var d=[],f;for(f=b;f<c;)b=new ke(a.doc,D(a.doc,f),f),f+=b.size,d.push(b);
return d}function ja(a,b,c,d){null==b&&(b=a.doc.first);null==c&&(c=a.doc.first+a.doc.size);d||(d=0);var f=a.display;d&&c<f.viewTo&&(null==f.updateLineNumbers||f.updateLineNumbers>b)&&(f.updateLineNumbers=b);a.curOp.viewChanged=!0;if(b>=f.viewTo)Pa&&dd(a.doc,b)<f.viewTo&&Oa(a);else if(c<=f.viewFrom)Pa&&Ud(a.doc,c+d)>f.viewFrom?Oa(a):(f.viewFrom+=d,f.viewTo+=d);else if(b<=f.viewFrom&&c>=f.viewTo)Oa(a);else if(b<=f.viewFrom){var g=Ic(a,c,c+d,1);g?(f.view=f.view.slice(g.index),f.viewFrom=g.lineN,f.viewTo+=
d):Oa(a)}else if(c>=f.viewTo)(g=Ic(a,b,b,-1))?(f.view=f.view.slice(0,g.index),f.viewTo=g.lineN):Oa(a);else{var g=Ic(a,b,b,-1),h=Ic(a,c,c+d,1);g&&h?(f.view=f.view.slice(0,g.index).concat(rc(a,g.lineN,h.lineN)).concat(f.view.slice(h.index)),f.viewTo+=d):Oa(a)}if(a=f.externalMeasured)c<a.lineN?a.lineN+=d:b<a.lineN+a.size&&(f.externalMeasured=null)}function La(a,b,c){a.curOp.viewChanged=!0;var d=a.display,f=a.display.externalMeasured;f&&b>=f.lineN&&b<f.lineN+f.size&&(d.externalMeasured=null);b<d.viewFrom||
b>=d.viewTo||(a=d.view[$a(a,b)],null!=a.node&&(a=a.changes||(a.changes=[]),-1==ea(a,c)&&a.push(c)))}function Oa(a){a.display.viewFrom=a.display.viewTo=a.doc.first;a.display.view=[];a.display.viewOffset=0}function $a(a,b){if(b>=a.display.viewTo)return null;b-=a.display.viewFrom;if(0>b)return null;for(var c=a.display.view,d=0;d<c.length;d++)if(b-=c[d].size,0>b)return d}function Ic(a,b,c,d){var f=$a(a,b),g=a.display.view;if(!Pa||c==a.doc.first+a.doc.size)return{index:f,lineN:c};for(var h=0,n=a.display.viewFrom;h<
f;h++)n+=g[h].size;if(n!=b){if(0<d){if(f==g.length-1)return null;b=n+g[f].size-b;f++}else b=n-b;c+=b}for(;dd(a.doc,c)!=c;){if(f==(0>d?0:g.length-1))return null;c+=d*g[f-(0>d?1:0)].size;f+=d}return{index:f,lineN:c}}function Td(a){a=a.display.view;for(var b=0,c=0;c<a.length;c++){var d=a[c];d.hidden||d.node&&!d.changes||++b}return b}function rf(a){function b(){d.activeTouch&&(f=setTimeout(function(){d.activeTouch=null},1E3),g=d.activeTouch,g.end=+new Date)}function c(a,b){if(null==b.left)return!0;var p=
b.left-a.left,d=b.top-a.top;return 400<p*p+d*d}var d=a.display;F(d.scroller,"mousedown",V(a,pe));M&&11>R?F(d.scroller,"dblclick",V(a,function(b){if(!Fa(a,b)){var c=xb(a,b);!c||wd(a,b,"gutterClick",!0,fa)||Ma(a.display,b)||(ha(b),b=a.findWordAt(c),yc(a.doc,b.anchor,b.head))}})):F(d.scroller,"dblclick",function(b){Fa(a,b)||ha(b)});xd||F(d.scroller,"contextmenu",function(b){qe(a,b)});var f,g={end:0};F(d.scroller,"touchstart",function(a){var b;1!=a.touches.length?b=!1:(b=a.touches[0],b=1>=b.radiusX&&
1>=b.radiusY);b||(clearTimeout(f),b=+new Date,d.activeTouch={start:b,moved:!1,prev:300>=b-g.end?g:null},1==a.touches.length&&(d.activeTouch.left=a.touches[0].pageX,d.activeTouch.top=a.touches[0].pageY))});F(d.scroller,"touchmove",function(){d.activeTouch&&(d.activeTouch.moved=!0)});F(d.scroller,"touchend",function(f){var g=d.activeTouch;if(g&&!Ma(d,f)&&null!=g.left&&!g.moved&&300>new Date-g.start){var h=a.coordsChar(d.activeTouch,"page"),g=!g.prev||c(g,g.prev)?new Q(h,h):!g.prev.prev||c(g,g.prev.prev)?
a.findWordAt(h):new Q(A(h.line,0),J(a.doc,A(h.line+1,0)));a.setSelection(g.anchor,g.head);a.focus();ha(f)}b()});F(d.scroller,"touchcancel",b);F(d.scroller,"scroll",function(){d.scroller.clientHeight&&(Nb(a,d.scroller.scrollTop),mb(a,d.scroller.scrollLeft,!0),X(a,"scroll",a))});F(d.scroller,"mousewheel",function(b){re(a,b)});F(d.scroller,"DOMMouseScroll",function(b){re(a,b)});F(d.wrapper,"scroll",function(){d.wrapper.scrollTop=d.wrapper.scrollLeft=0});d.dragFunctions={simple:function(b){Fa(a,b)||yd(b)},
start:function(b){if(M&&(!a.state.draggingText||100>+new Date-se))yd(b);else if(!Fa(a,b)&&!Ma(a.display,b)&&(b.dataTransfer.setData("Text",a.getSelection()),b.dataTransfer.setDragImage&&!te)){var c=B("img",null,null,"position: fixed; left: 0; top: 0;");c.src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";wa&&(c.width=c.height=1,a.display.wrapper.appendChild(c),c._top=c.offsetTop);b.dataTransfer.setDragImage(c,0,0);wa&&c.parentNode.removeChild(c)}},drop:V(a,Ef)};var h=
d.input.getField();F(h,"keyup",function(b){ue.call(a,b)});F(h,"keydown",V(a,ve));F(h,"keypress",V(a,we));F(h,"focus",Hb(ad,a));F(h,"blur",Hb(Ib,a))}function Ff(a){var b=a.display;if(b.lastWrapHeight!=b.wrapper.clientHeight||b.lastWrapWidth!=b.wrapper.clientWidth)b.cachedCharWidth=b.cachedTextHeight=b.cachedPaddingH=null,b.scrollbarsClipped=!1,a.setSize()}function Ma(a,b){for(var c=b.target||b.srcElement;c!=a.wrapper;c=c.parentNode)if(!c||1==c.nodeType&&"true"==c.getAttribute("cm-ignore-events")||
c.parentNode==a.sizer&&c!=a.mover)return!0}function xb(a,b,c,d){var f=a.display;if(!c&&"true"==(b.target||b.srcElement).getAttribute("cm-not-content"))return null;var g,h;c=f.lineSpace.getBoundingClientRect();try{g=b.clientX-c.left,h=b.clientY-c.top}catch(n){return null}b=ud(a,g,h);var m;d&&1==b.xRel&&(m=D(a.doc,b.line).text).length==b.ch&&(d=va(m,m.length,a.options.tabSize)-m.length,b=A(b.line,Math.max(0,Math.round((g-ie(a.display).left)/Kb(a.display))-d)));return b}function pe(a){var b=this.display;
if(!(b.activeTouch&&b.input.supportsTouch()||Fa(this,a)))if(b.shift=a.shiftKey,Ma(b,a))Y||(b.scroller.draggable=!1,setTimeout(function(){b.scroller.draggable=!0},100));else if(!wd(this,a,"gutterClick",!0,fa)){var c=xb(this,a);window.focus();switch(xe(a)){case 1:c?Gf(this,a,c):(a.target||a.srcElement)==b.scroller&&ha(a);break;case 2:Y&&(this.state.lastMiddleDown=+new Date);c&&yc(this.doc,c);setTimeout(function(){b.input.focus()},20);ha(a);break;case 3:xd?qe(this,a):Hf(this)}}}function Gf(a,b,c){M?
setTimeout(Hb(uc,a),0):a.curOp.focus=Ba();var d=+new Date,f;Jc&&Jc.time>d-400&&0==K(Jc.pos,c)?f="triple":Kc&&Kc.time>d-400&&0==K(Kc.pos,c)?(f="double",Jc={time:d,pos:c}):(f="single",Kc={time:d,pos:c});var d=a.doc.sel,g=sa?b.metaKey:b.ctrlKey,h;a.options.dragDrop&&If&&!Qa(a)&&"single"==f&&-1<(h=d.contains(c))&&(0>K((h=d.ranges[h]).from(),c)||0<c.xRel)&&(0<K(h.to(),c)||0>c.xRel)?Jf(a,b,c,g):Kf(a,b,c,f,g)}function Jf(a,b,c,d){var f=a.display,g=+new Date,h=V(a,function(n){Y&&(f.scroller.draggable=!1);
a.state.draggingText=!1;Ga(document,"mouseup",h);Ga(f.scroller,"drop",h);10>Math.abs(b.clientX-n.clientX)+Math.abs(b.clientY-n.clientY)&&(ha(n),!d&&+new Date-200<g&&yc(a.doc,c),Y||M&&9==R?setTimeout(function(){document.body.focus();f.input.focus()},20):f.input.focus())});Y&&(f.scroller.draggable=!0);a.state.draggingText=h;f.scroller.dragDrop&&f.scroller.dragDrop();F(document,"mouseup",h);F(f.scroller,"drop",h)}function Kf(a,b,c,d,f){function g(b){if(0!=K(x,b))if(x=b,"rect"==d){for(var f=[],O=a.options.tabSize,
h=va(D(q,c.line).text,c.ch,O),n=va(D(q,b.line).text,b.ch,O),na=Math.min(h,n),h=Math.max(h,n),n=Math.min(c.line,b.line),m=Math.min(a.lastLine(),Math.max(c.line,b.line));n<=m;n++){var ca=D(q,n).text,v=ye(ca,na,O);na==h?f.push(new Q(A(n,v),A(n,v))):ca.length>v&&f.push(new Q(A(n,v),A(n,ye(ca,h,O))))}f.length||f.push(new Q(c,c));ba(q,ua(t.ranges.slice(0,r).concat(f),r),{origin:"*mouse",scroll:!1});a.scrollIntoView(b)}else f=s,O=f.anchor,na=b,"single"!=d&&(b="double"==d?a.findWordAt(b):new Q(A(b.line,0),
J(q,A(b.line+1,0))),0<K(b.anchor,O)?(na=b.head,O=qb(f.from(),b.anchor)):(na=b.anchor,O=pb(f.to(),b.head))),f=t.ranges.slice(0),f[r]=new Q(J(q,O),na),ba(q,ua(f,r),zd)}function h(b){var c=++z,f=xb(a,b,!0,"rect"==d);if(f)if(0!=K(f,x)){a.curOp.focus=Ba();g(f);var O=C(m,q);(f.line>=O.to||f.line<O.from)&&setTimeout(V(a,function(){z==c&&h(b)}),150)}else{var ma=b.clientY<G.top?-20:b.clientY>G.bottom?20:0;ma&&setTimeout(V(a,function(){z==c&&(m.scroller.scrollTop+=ma,h(b))}),50)}}function n(a){z=Infinity;ha(a);
m.input.focus();Ga(document,"mousemove",u);Ga(document,"mouseup",Z);q.history.lastSelOrigin=null}var m=a.display,q=a.doc;ha(b);var s,r,t=q.sel,v=t.ranges;f&&!b.shiftKey?(r=q.sel.contains(c),s=-1<r?v[r]:new Q(c,c)):(s=q.sel.primary(),r=q.sel.primIndex);if(b.altKey)d="rect",f||(s=new Q(c,c)),c=xb(a,b,!0,!0),r=-1;else if("double"==d){var w=a.findWordAt(c);s=a.display.shift||q.extend?Yb(q,s,w.anchor,w.head):w}else"triple"==d?(w=new Q(A(c.line,0),J(q,A(c.line+1,0))),s=a.display.shift||q.extend?Yb(q,s,
w.anchor,w.head):w):s=Yb(q,s,c);f?-1==r?(r=v.length,ba(q,ua(v.concat([s]),r),{scroll:!1,origin:"*mouse"})):1<v.length&&v[r].empty()&&"single"==d&&!b.shiftKey?(ba(q,ua(v.slice(0,r).concat(v.slice(r+1)),0)),t=q.sel):ld(q,r,s,zd):(r=0,ba(q,new Ja([s],0),zd),t=q.sel);var x=c,G=m.wrapper.getBoundingClientRect(),z=0,u=V(a,function(a){xe(a)?h(a):n(a)}),Z=V(a,n);F(document,"mousemove",u);F(document,"mouseup",Z)}function wd(a,b,c,d,f){try{var g=b.clientX,h=b.clientY}catch(n){return!1}if(g>=Math.floor(a.display.gutters.getBoundingClientRect().right))return!1;
d&&ha(b);d=a.display;var m=d.lineDiv.getBoundingClientRect();if(h>m.bottom||!pa(a,c))return Ad(b);h-=m.top-d.viewOffset;for(m=0;m<a.options.gutters.length;++m){var q=d.gutters.childNodes[m];if(q&&q.getBoundingClientRect().right>=g)return g=Ya(a.doc,h),f(a,c,a,g,a.options.gutters[m],b),Ad(b)}}function Ef(a){var b=this;if(!Fa(b,a)&&!Ma(b.display,a)){ha(a);M&&(se=+new Date);var c=xb(b,a,!0),d=a.dataTransfer.files;if(c&&!Qa(b))if(d&&d.length&&window.FileReader&&window.File){var f=d.length,g=Array(f),
h=0;a=function(a,p){var d=new FileReader;d.onload=V(b,function(){g[p]=d.result;if(++h==f){c=J(b.doc,c);var a={from:c,to:c,text:b.doc.splitLines(g.join(b.doc.lineSeparator())),origin:"paste"};rb(b.doc,a);be(b.doc,Ca(c,fb(a)))}});d.readAsText(a)};for(var n=0;n<f;++n)a(d[n],n)}else if(b.state.draggingText&&-1<b.doc.sel.contains(c))b.state.draggingText(a),setTimeout(function(){b.display.input.focus()},20);else try{if(g=a.dataTransfer.getData("Text")){if(b.state.draggingText&&(sa?!a.altKey:!a.ctrlKey))var m=
b.listSelections();zc(b.doc,Ca(c,c));if(m)for(n=0;n<m.length;++n)yb(b.doc,"",m[n].anchor,m[n].head,"drag");b.replaceSelection(g,"around","paste");b.display.input.focus()}}catch(q){}}}function Nb(a,b){2>Math.abs(a.doc.scrollTop-b)||(a.doc.scrollTop=b,Ta||Rb(a,{top:b}),a.display.scroller.scrollTop!=b&&(a.display.scroller.scrollTop=b),a.display.scrollbars.setScrollTop(b),Ta&&Rb(a),Jb(a,100))}function mb(a,b,c){(c?b==a.doc.scrollLeft:2>Math.abs(a.doc.scrollLeft-b))||(b=Math.min(b,a.display.scroller.scrollWidth-
a.display.scroller.clientWidth),a.doc.scrollLeft=b,H(a),a.display.scroller.scrollLeft!=b&&(a.display.scroller.scrollLeft=b),a.display.scrollbars.setScrollLeft(b))}function re(a,b){var c=ze(b),d=c.x,c=c.y,f=a.display,g=f.scroller;if(d&&g.scrollWidth>g.clientWidth||c&&g.scrollHeight>g.clientHeight){if(c&&sa&&Y){var h=b.target,n=f.view;a:for(;h!=g;h=h.parentNode)for(var m=0;m<n.length;m++)if(n[m].node==h){a.display.currentWheelTarget=h;break a}}!d||Ta||wa||null==la?(c&&null!=la&&(h=c*la,n=a.doc.scrollTop,
m=n+f.wrapper.clientHeight,0>h?n=Math.max(0,n+h-50):m=Math.min(a.doc.height,m+h+50),Rb(a,{top:n,bottom:m})),20>Lc&&(null==f.wheelStartX?(f.wheelStartX=g.scrollLeft,f.wheelStartY=g.scrollTop,f.wheelDX=d,f.wheelDY=c,setTimeout(function(){if(null!=f.wheelStartX){var a=g.scrollLeft-f.wheelStartX,b=g.scrollTop-f.wheelStartY,a=b&&f.wheelDY&&b/f.wheelDY||a&&f.wheelDX&&a/f.wheelDX;f.wheelStartX=f.wheelStartY=null;a&&(la=(la*Lc+a)/(Lc+1),++Lc)}},200)):(f.wheelDX+=d,f.wheelDY+=c))):(c&&Nb(a,Math.max(0,Math.min(g.scrollTop+
c*la,g.scrollHeight-g.clientHeight))),mb(a,Math.max(0,Math.min(g.scrollLeft+d*la,g.scrollWidth-g.clientWidth))),ha(b),f.wheelStartX=null)}}function Mc(a,b,c){if("string"==typeof b&&(b=Nc[b],!b))return!1;a.display.input.ensurePolled();var d=a.display.shift,f=!1;try{Qa(a)&&(a.state.suppressEdits=!0),c&&(a.display.shift=!1),f=b(a)!=Ae}finally{a.display.shift=d,a.state.suppressEdits=!1}return f}function Lf(a,b,c){for(var d=0;d<a.state.keyMaps.length;d++){var f=cc(b,a.state.keyMaps[d],c,a);if(f)return f}return a.options.extraKeys&&
cc(b,a.options.extraKeys,c,a)||cc(b,a.options.keyMap,c,a)}function Oc(a,b,c,d){var f=a.state.keySeq;if(f){if(Mf(b))return"handled";Nf.set(50,function(){a.state.keySeq==f&&(a.state.keySeq=null,a.display.input.reset())});b=f+" "+b}d=Lf(a,b,d);"multi"==d&&(a.state.keySeq=b);"handled"==d&&fa(a,"keyHandled",a,b,c);if("handled"==d||"multi"==d)ha(c),md(a);return f&&!d&&/\'$/.test(b)?(ha(c),!0):!!d}function Be(a,b){var c=Of(b,!0);return c?b.shiftKey&&!a.state.keySeq?Oc(a,"Shift-"+c,b,function(b){return Mc(a,
b,!0)})||Oc(a,c,b,function(b){if("string"==typeof b?/^go[A-Z]/.test(b):b.motion)return Mc(a,b)}):Oc(a,c,b,function(b){return Mc(a,b)}):!1}function Pf(a,b,c){return Oc(a,"'"+c+"'",b,function(b){return Mc(a,b,!0)})}function ve(a){this.curOp.focus=Ba();if(!Fa(this,a)){M&&11>R&&27==a.keyCode&&(a.returnValue=!1);var b=a.keyCode;this.display.shift=16==b||a.shiftKey;var c=Be(this,a);wa&&(Bd=c?b:null,!c&&88==b&&!Ce&&(sa?a.metaKey:a.ctrlKey)&&this.replaceSelection("",null,"cut"));18!=b||/\bCodeMirror-crosshair\b/.test(this.display.lineDiv.className)||
Qf(this)}}function Qf(a){function b(a){18!=a.keyCode&&a.altKey||(Mb(c,"CodeMirror-crosshair"),Ga(document,"keyup",b),Ga(document,"mouseover",b))}var c=a.display.lineDiv;Ob(c,"CodeMirror-crosshair");F(document,"keyup",b);F(document,"mouseover",b)}function ue(a){16==a.keyCode&&(this.doc.sel.shift=!1);Fa(this,a)}function we(a){if(!(Ma(this.display,a)||Fa(this,a)||a.ctrlKey&&!a.altKey||sa&&a.metaKey)){var b=a.keyCode,c=a.charCode;if(wa&&b==Bd)Bd=null,ha(a);else if(!wa||a.which&&!(10>a.which)||!Be(this,
a))if(b=String.fromCharCode(null==c?b:c),!Pf(this,a,b))this.display.input.onKeyPress(a)}}function Hf(a){a.state.delayingBlurEvent=!0;setTimeout(function(){a.state.delayingBlurEvent&&(a.state.delayingBlurEvent=!1,Ib(a))},100)}function ad(a){a.state.delayingBlurEvent&&(a.state.delayingBlurEvent=!1);"nocursor"!=a.options.readOnly&&(a.state.focused||(X(a,"focus",a),a.state.focused=!0,Ob(a.display.wrapper,"CodeMirror-focused"),a.curOp||a.display.selForContextMenu==a.doc.sel||(a.display.input.reset(),Y&&
setTimeout(function(){a.display.input.reset(!0)},20)),a.display.input.receivedFocus()),md(a))}function Ib(a){a.state.delayingBlurEvent||(a.state.focused&&(X(a,"blur",a),a.state.focused=!1,Mb(a.display.wrapper,"CodeMirror-focused")),clearInterval(a.display.blinker),setTimeout(function(){a.state.focused||(a.display.shift=!1)},150))}function qe(a,b){var c;(c=Ma(a.display,b))||(c=pa(a,"gutterContextMenu")?wd(a,b,"gutterContextMenu",!1,X):!1);if(!c)a.display.input.onContextMenu(b)}function De(a,b){if(0>
K(a,b.from))return a;if(0>=K(a,b.to))return fb(b);var c=a.line+b.text.length-(b.to.line-b.from.line)-1,d=a.ch;a.line==b.to.line&&(d+=fb(b).ch-b.to.ch);return A(c,d)}function Cd(a,b){for(var c=[],d=0;d<a.sel.ranges.length;d++){var f=a.sel.ranges[d];c.push(new Q(De(f.anchor,b),De(f.head,b)))}return ua(c,a.sel.primIndex)}function Ee(a,b,c){return a.line==b.line?A(c.line,a.ch-b.ch+c.ch):A(c.line+(a.line-b.line),a.ch)}function Fe(a,b,c){b={canceled:!1,from:b.from,to:b.to,text:b.text,origin:b.origin,cancel:function(){this.canceled=
!0}};c&&(b.update=function(b,c,d,f){b&&(this.from=J(a,b));c&&(this.to=J(a,c));d&&(this.text=d);void 0!==f&&(this.origin=f)});X(a,"beforeChange",a,b);a.cm&&X(a.cm,"beforeChange",a.cm,b);return b.canceled?null:{from:b.from,to:b.to,text:b.text,origin:b.origin}}function rb(a,b,c){if(a.cm){if(!a.cm.curOp)return V(a.cm,rb)(a,b,c);if(a.cm.state.suppressEdits)return}if(pa(a,"beforeChange")||a.cm&&pa(a.cm,"beforeChange"))if(b=Fe(a,b,!0),!b)return;if(c=Ge&&!c&&Rf(a,b.from,b.to))for(var d=c.length-1;0<=d;--d)He(a,
{from:c[d].from,to:c[d].to,text:d?[""]:b.text});else He(a,b)}function He(a,b){if(1!=b.text.length||""!=b.text[0]||0!=K(b.from,b.to)){var c=Cd(a,b);Ie(a,b,c,a.cm?a.cm.curOp.id:NaN);dc(a,b,c,Dd(a,b));var d=[];gb(a,function(a,c){c||-1!=ea(d,a.history)||(Je(a.history,b),d.push(a.history));dc(a,b,null,Dd(a,b))})}}function Pc(a,b,c){if(!a.cm||!a.cm.state.suppressEdits){for(var d=a.history,f,g=a.sel,h="undo"==b?d.done:d.undone,n="undo"==b?d.undone:d.done,m=0;m<h.length&&(f=h[m],c?!f.ranges||f.equals(a.sel):
f.ranges);m++);if(m!=h.length){for(d.lastOrigin=d.lastSelOrigin=null;;)if(f=h.pop(),f.ranges){Ac(f,n);if(c&&!f.equals(a.sel)){ba(a,f,{clearRedo:!1});return}g=f}else break;c=[];Ac(g,n);n.push({changes:c,generation:d.generation});d.generation=f.generation||++d.maxGeneration;d=pa(a,"beforeChange")||a.cm&&pa(a.cm,"beforeChange");for(m=f.changes.length-1;0<=m;--m){var q=f.changes[m];q.origin=b;if(d&&!Fe(a,q,!1)){h.length=0;break}c.push(Ed(a,q));g=m?Cd(a,q):N(h);dc(a,q,g,Ke(a,q));!m&&a.cm&&a.cm.scrollIntoView({from:q.from,
to:fb(q)});var s=[];gb(a,function(a,b){b||-1!=ea(s,a.history)||(Je(a.history,q),s.push(a.history));dc(a,q,null,Ke(a,q))})}}}}function Le(a,b){if(0!=b&&(a.first+=b,a.sel=new Ja(vc(a.sel.ranges,function(a){return new Q(A(a.anchor.line+b,a.anchor.ch),A(a.head.line+b,a.head.ch))}),a.sel.primIndex),a.cm)){ja(a.cm,a.first,a.first-b,b);for(var c=a.cm.display,d=c.viewFrom;d<c.viewTo;d++)La(a.cm,d,"gutter")}}function dc(a,b,c,d){if(a.cm&&!a.cm.curOp)return V(a.cm,dc)(a,b,c,d);if(b.to.line<a.first)Le(a,b.text.length-
1-(b.to.line-b.from.line));else if(!(b.from.line>a.lastLine())){if(b.from.line<a.first){var f=b.text.length-1-(a.first-b.from.line);Le(a,f);b={from:A(a.first,0),to:A(b.to.line+f,b.to.ch),text:[N(b.text)],origin:b.origin}}f=a.lastLine();b.to.line>f&&(b={from:b.from,to:A(f,D(a,f).text.length),text:[b.text[0]],origin:b.origin});b.removed=cb(a,b.from,b.to);c||(c=Cd(a,b));a.cm?Sf(a.cm,b,d):Fd(a,b,d);zc(a,c,Da)}}function Sf(a,b,c){var d=a.doc,g=a.display,h=b.from,n=b.to,m=!1,s=h.line;a.options.lineWrapping||
(s=P(Ea(D(d,h.line))),d.iter(s,n.line+1,function(a){if(a==g.maxLine)return m=!0}));-1<d.sel.contains(b.from,b.to)&&fe(a);Fd(d,b,c,f(a));a.options.lineWrapping||(d.iter(s,h.line+b.text.length,function(a){var b=q(a);b>g.maxLineLength&&(g.maxLine=a,g.maxLineLength=b,g.maxLineChanged=!0,m=!1)}),m&&(a.curOp.updateMaxLine=!0));d.frontier=Math.min(d.frontier,h.line);Jb(a,400);c=b.text.length-(n.line-h.line)-1;b.full?ja(a):h.line!=n.line||1!=b.text.length||Me(a.doc,b)?ja(a,h.line,n.line+1,c):La(a,h.line,
"text");c=pa(a,"changes");if((d=pa(a,"change"))||c)b={from:h,to:n,text:b.text,removed:b.removed,origin:b.origin},d&&fa(a,"change",a,b),c&&(a.curOp.changeObjs||(a.curOp.changeObjs=[])).push(b);a.display.selForContextMenu=null}function yb(a,b,c,d,f){d||(d=c);if(0>K(d,c)){var g=d;d=c;c=g}"string"==typeof b&&(b=a.splitLines(b));rb(a,{from:c,to:d,text:b,origin:f})}function Hc(a,b,c,d,f){var g=a.display,h=Ua(a.display);0>c&&(c=0);var n=a.curOp&&null!=a.curOp.scrollTop?a.curOp.scrollTop:g.scroller.scrollTop,
m=fd(a),q={};f-c>m&&(f=c+m);var s=a.doc.height+cd(g),r=c<h,h=f>s-h;c<n?q.scrollTop=r?0:c:f>n+m&&(c=Math.min(c,(h?s:f)-m),c!=n&&(q.scrollTop=c));n=a.curOp&&null!=a.curOp.scrollLeft?a.curOp.scrollLeft:g.scroller.scrollLeft;a=Na(a)-(a.options.fixedGutter?g.gutters.offsetWidth:0);(g=d-b>a)&&(d=b+a);10>b?q.scrollLeft=0:b<n?q.scrollLeft=Math.max(0,b-(g?0:10)):d>a+n-3&&(q.scrollLeft=d+(g?0:10)-a);return q}function Qc(a,b,c){null==b&&null==c||Rc(a);null!=b&&(a.curOp.scrollLeft=(null==a.curOp.scrollLeft?a.doc.scrollLeft:
a.curOp.scrollLeft)+b);null!=c&&(a.curOp.scrollTop=(null==a.curOp.scrollTop?a.doc.scrollTop:a.curOp.scrollTop)+c)}function sb(a){Rc(a);var b=a.getCursor(),c=b,d=b;a.options.lineWrapping||(c=b.ch?A(b.line,b.ch-1):b,d=A(b.line,b.ch+1));a.curOp.scrollToPos={from:c,to:d,margin:a.options.cursorScrollMargin,isCursor:!0}}function Rc(a){var b=a.curOp.scrollToPos;if(b){a.curOp.scrollToPos=null;var c=oe(a,b.from),d=oe(a,b.to),b=Hc(a,Math.min(c.left,d.left),Math.min(c.top,d.top)-b.margin,Math.max(c.right,d.right),
Math.max(c.bottom,d.bottom)+b.margin);a.scrollTo(b.scrollLeft,b.scrollTop)}}function Wb(a,b,c,d){var f=a.doc,g;null==c&&(c="add");"smart"==c&&(f.mode.indent?g=Zb(a,b):c="prev");var h=a.options.tabSize,n=D(f,b),m=va(n.text,null,h);n.stateAfter&&(n.stateAfter=null);var q=n.text.match(/^\s*/)[0],s;if(!d&&!/\S/.test(n.text))s=0,c="not";else if("smart"==c&&(s=f.mode.indent(g,n.text.slice(q.length),n.text),s==Ae||150<s)){if(!d)return;c="prev"}"prev"==c?s=b>f.first?va(D(f,b-1).text,null,h):0:"add"==c?s=
m+a.options.indentUnit:"subtract"==c?s=m-a.options.indentUnit:"number"==typeof c&&(s=m+c);s=Math.max(0,s);c="";d=0;if(a.options.indentWithTabs)for(a=Math.floor(s/h);a;--a)d+=h,c+="\t";d<s&&(c+=Ne(s-d));if(c!=q)return yb(f,c,A(b,0),A(b,q.length),"+input"),n.stateAfter=null,!0;for(a=0;a<f.sel.ranges.length;a++)if(h=f.sel.ranges[a],h.head.line==b&&h.head.ch<q.length){d=A(b,q.length);ld(f,a,new Q(d,d));break}}function Sc(a,b,c,d){var f=b,g=b;"number"==typeof b?g=D(a,Math.max(a.first,Math.min(b,a.first+
a.size-1))):f=P(b);if(null==f)return null;d(g,f)&&a.cm&&La(a.cm,f,c);return g}function zb(a,b){for(var c=a.doc.sel.ranges,d=[],f=0;f<c.length;f++){for(var g=b(c[f]);d.length&&0>=K(g.from,N(d).to);){var h=d.pop();if(0>K(h.from,g.from)){g.from=h.from;break}}d.push(g)}ka(a,function(){for(var b=d.length-1;0<=b;b--)yb(a.doc,"",d[b].from,d[b].to,"+delete");sb(a)})}function Gd(a,b,c,d,f){function g(b){var d=(f?vd:Oe)(q,n,c,!0);if(null==d){if(b=!b)b=h+c,b<a.first||b>=a.first+a.size?b=s=!1:(h=b,b=q=D(a,b));
if(b)n=f?(0>c?Gc:Fc)(q):0>c?q.text.length:0;else return s=!1}else n=d;return!0}var h=b.line,n=b.ch,m=c,q=D(a,h),s=!0;if("char"==d)g();else if("column"==d)g(!0);else if("word"==d||"group"==d){var r=null;d="group"==d;b=a.cm&&a.cm.getHelper(b,"wordChars");for(var t=!0;!(0>c)||g(!t);t=!1){var v=q.text.charAt(n)||"\n",v=Tc(v,b)?"w":d&&"\n"==v?"n":!d||/\s/.test(v)?null:"p";!d||t||v||(v="s");if(r&&r!=v){0>c&&(c=1,g());break}v&&(r=v);if(0<c&&!g(!t))break}}m=Bc(a,A(h,n),m,!0);s||(m.hitSide=!0);return m}function Pe(a,
b,c,d){var f=a.doc,g=b.left,h;"page"==d?(d=Math.min(a.display.wrapper.clientHeight,window.innerHeight||document.documentElement.clientHeight),h=b.top+c*(d-(0>c?1.5:.5)*Ua(a.display))):"line"==d&&(h=0<c?b.bottom+3:b.top-3);for(;;){var n=ud(a,g,h);if(!n.outside)break;if(0>c?0>=h:h>=f.height){n.hitSide=!0;break}h+=5*c}return n}function I(a,b,c,f){d.defaults[a]=b;c&&(kb[a]=f?function(a,b,p){p!=Rd&&c(a,b,p)}:c)}function Tf(a){var b=a.split(/-(?!$)/);a=b[b.length-1];for(var c,d,f,g,h=0;h<b.length-1;h++){var n=
b[h];if(/^(cmd|meta|m)$/i.test(n))g=!0;else if(/^a(lt)?$/i.test(n))c=!0;else if(/^(c|ctrl|control)$/i.test(n))d=!0;else if(/^s(hift)$/i.test(n))f=!0;else throw Error("Unrecognized modifier name: "+n);}c&&(a="Alt-"+a);d&&(a="Ctrl-"+a);g&&(a="Cmd-"+a);f&&(a="Shift-"+a);return a}function Uc(a){return"string"==typeof a?Ra[a]:a}function Ab(a,b,c,d,f){if(d&&d.shared)return Uf(a,b,c,d,f);if(a.cm&&!a.cm.curOp)return V(a.cm,Ab)(a,b,c,d,f);var g=new hb(a,f);f=K(b,c);d&&ra(d,g,!1);if(0<f||0==f&&!1!==g.clearWhenEmpty)return g;
g.replacedWith&&(g.collapsed=!0,g.widgetNode=B("span",[g.replacedWith],"CodeMirror-widget"),d.handleMouseEvents||g.widgetNode.setAttribute("cm-ignore-events","true"),d.insertLeft&&(g.widgetNode.insertLeft=!0));if(g.collapsed){if(Qe(a,b.line,b,c,g)||b.line!=c.line&&Qe(a,c.line,b,c,g))throw Error("Inserting collapsed marker partially overlapping an existing one");Pa=!0}g.addToHistory&&Ie(a,{from:b,to:c,origin:"markText"},a.sel,NaN);var h=b.line,n=a.cm,m;a.iter(h,c.line+1,function(a){n&&g.collapsed&&
!n.options.lineWrapping&&Ea(a)==n.display.maxLine&&(m=!0);g.collapsed&&h!=b.line&&ya(a,0);var p=new Vc(g,h==b.line?b.ch:null,h==c.line?c.ch:null);a.markedSpans=a.markedSpans?a.markedSpans.concat([p]):[p];p.marker.attachLine(a);++h});g.collapsed&&a.iter(b.line,c.line+1,function(b){Va(a,b)&&ya(b,0)});g.clearOnEnter&&F(g,"beforeCursorEnter",function(){g.clear()});g.readOnly&&(Ge=!0,(a.history.done.length||a.history.undone.length)&&a.clearHistory());g.collapsed&&(g.id=++Hd,g.atomic=!0);if(n){m&&(n.curOp.updateMaxLine=
!0);if(g.collapsed)ja(n,b.line,c.line+1);else if(g.className||g.title||g.startStyle||g.endStyle||g.css)for(d=b.line;d<=c.line;d++)La(n,d,"text");g.atomic&&ge(n.doc);fa(n,"markerAdded",n,g)}return g}function Uf(a,b,c,d,f){d=ra(d);d.shared=!1;var g=[Ab(a,b,c,d,f)],h=g[0],n=d.widgetNode;gb(a,function(a){n&&(d.widgetNode=n.cloneNode(!0));g.push(Ab(a,J(a,b),J(a,c),d,f));for(var p=0;p<a.linked.length;++p)if(a.linked[p].isParent)return;h=N(g)});return new Wc(g,h)}function Re(a){return a.findMarks(A(a.first,
0),a.clipPos(A(a.lastLine())),function(a){return a.parent})}function Vf(a){for(var b=0;b<a.length;b++){var c=a[b],d=[c.primary.doc];gb(c.primary.doc,function(a){d.push(a)});for(var f=0;f<c.markers.length;f++){var g=c.markers[f];-1==ea(d,g.doc)&&(g.parent=null,c.markers.splice(f--,1))}}}function Vc(a,b,c){this.marker=a;this.from=b;this.to=c}function ec(a,b){if(a)for(var c=0;c<a.length;++c){var d=a[c];if(d.marker==b)return d}}function Dd(a,b){if(b.full)return null;var c=Xb(a,b.from.line)&&D(a,b.from.line).markedSpans,
d=Xb(a,b.to.line)&&D(a,b.to.line).markedSpans;if(!c&&!d)return null;var f=b.from.ch,g=b.to.ch,h=0==K(b.from,b.to);if(c)for(var n=0,m;n<c.length;++n){var q=c[n],s=q.marker;if(null==q.from||(s.inclusiveLeft?q.from<=f:q.from<f)||!(q.from!=f||"bookmark"!=s.type||h&&q.marker.insertLeft)){var r=null==q.to||(s.inclusiveRight?q.to>=f:q.to>f);(m||(m=[])).push(new Vc(s,q.from,r?null:q.to))}}c=m;if(d)for(var n=0,t;n<d.length;++n)if(m=d[n],q=m.marker,null==m.to||(q.inclusiveRight?m.to>=g:m.to>g)||m.from==g&&
"bookmark"==q.type&&(!h||m.marker.insertLeft))s=null==m.from||(q.inclusiveLeft?m.from<=g:m.from<g),(t||(t=[])).push(new Vc(q,s?null:m.from-g,null==m.to?null:m.to-g));d=t;h=1==b.text.length;t=N(b.text).length+(h?f:0);if(c)for(g=0;g<c.length;++g)if(n=c[g],null==n.to)(m=ec(d,n.marker),m)?h&&(n.to=null==m.to?null:m.to+t):n.to=f;if(d)for(g=0;g<d.length;++g)n=d[g],null!=n.to&&(n.to+=t),null==n.from?(m=ec(c,n.marker),m||(n.from=t,h&&(c||(c=[])).push(n))):(n.from+=t,h&&(c||(c=[])).push(n));c&&(c=Se(c));d&&
d!=c&&(d=Se(d));f=[c];if(!h){var h=b.text.length-2,v;if(0<h&&c)for(g=0;g<c.length;++g)null==c[g].to&&(v||(v=[])).push(new Vc(c[g].marker,null,null));for(g=0;g<h;++g)f.push(v);f.push(d)}return f}function Se(a){for(var b=0;b<a.length;++b){var c=a[b];null!=c.from&&c.from==c.to&&!1!==c.marker.clearWhenEmpty&&a.splice(b--,1)}return a.length?a:null}function Ke(a,b){var c;if(c=b["spans_"+a.id]){for(var d=0,f=[];d<b.text.length;++d)f.push(Wf(c[d]));c=f}else c=null;d=Dd(a,b);if(!c)return d;if(!d)return c;
for(f=0;f<c.length;++f){var g=c[f],h=d[f];if(g&&h){var n=0;a:for(;n<h.length;++n){for(var m=h[n],q=0;q<g.length;++q)if(g[q].marker==m.marker)continue a;g.push(m)}}else h&&(c[f]=h)}return c}function Rf(a,b,c){var d=null;a.iter(b.line,c.line+1,function(a){if(a.markedSpans)for(var b=0;b<a.markedSpans.length;++b){var c=a.markedSpans[b].marker;!c.readOnly||d&&-1!=ea(d,c)||(d||(d=[])).push(c)}});if(!d)return null;a=[{from:b,to:c}];for(b=0;b<d.length;++b){c=d[b];for(var f=c.find(0),g=0;g<a.length;++g){var h=
...
b,c,d){var f=new Xc(a,c,d),g=a.cm;g&&f.noHScroll&&(g.display.alignWidgets=!0);Sc(a,b,"widget",function(b){var c=b.widgets||(b.widgets=[]);null==f.insertAt?c.push(f):c.splice(Math.min(c.length-1,Math.max(0,f.insertAt)),0,f);f.line=b;g&&!Va(a,b)&&(c=Aa(b)<a.scrollTop,ya(b,b.height+ac(f)),c&&Qc(g,null,f.height),g.curOp.forceUpdate=!0);return!0});return f}function We(a,b){if(a)for(;;){var c=a.match(/(?:^|\s+)line-(background-)?(\S+)/);if(!c)break;a=a.slice(0,c.index)+a.slice(c.index+c[0].length);var d=
c[1]?"bgClass":"textClass";null==b[d]?b[d]=c[2]:(new RegExp("(?:^|s)"+c[2]+"(?:$|s)")).test(b[d])||(b[d]+=" "+c[2])}return a}function Xe(a,b){if(a.blankLine)return a.blankLine(b);if(a.innerMode){var c=d.innerMode(a,b);if(c.mode.blankLine)return c.mode.blankLine(c.state)}}function Jd(a,b,c,f){for(var g=0;10>g;g++){f&&(f[0]=d.innerMode(a,c).mode);var h=a.token(b,c);if(b.pos>b.start)return h}throw Error("Mode "+a.name+" failed to advance stream.");}function Ye(a,b,c,d){function f(a){return{start:s.start,
end:s.pos,string:s.current(),type:n||null,state:a?vb(g.mode,q):q}}var g=a.doc,h=g.mode,n;b=J(g,b);var m=D(g,b.line),q=Zb(a,b.line,c),s=new Yc(m.text,a.options.tabSize),r;for(d&&(r=[]);(d||s.pos<b.ch)&&!s.eol();)s.start=s.pos,n=Jd(h,s,q),d&&r.push(f(!0));return d?r:f()}function Ze(a,b,c,d,f,g,h){var n=c.flattenSpans;null==n&&(n=a.options.flattenSpans);var m=0,q=null,s=new Yc(b,a.options.tabSize),r,t=a.options.addModeClass&&[null];for(""==b&&We(Xe(c,d),g);!s.eol();){s.pos>a.options.maxHighlightLength?
(n=!1,h&&nd(a,b,d,s.pos),s.pos=b.length,r=null):r=We(Jd(c,s,d,t),g);if(t){var v=t[0].name;v&&(r="m-"+(r?v+" "+r:v))}if(!n||q!=r){for(;m<s.start;)m=Math.min(s.start,m+5E4),f(m,q);q=r}s.start=s.pos}for(;m<s.pos;)a=Math.min(s.pos,m+5E4),f(a,q),m=a}function je(a,b,c,d){var f=[a.state.modeGen],g={};Ze(a,b.text,a.doc.mode,c,function(a,b){f.push(a,b)},g,d);for(c=0;c<a.state.overlays.length;++c){var h=a.state.overlays[c],n=1,m=0;Ze(a,b.text,h.mode,!0,function(a,b){for(var c=n;m<a;){var d=f[n];d>a&&f.splice(n,
1,a,f[n+1],d);n+=2;m=Math.min(a,d)}if(b)if(h.opaque)f.splice(c,n-c,a,"cm-overlay "+b),n=c+2;else for(;c<n;c+=2)d=f[c+1],f[c+1]=(d?d+" ":"")+"cm-overlay "+b},g)}return{styles:f,classes:g.bgClass||g.textClass?g:null}}function $e(a,b,c){if(!b.styles||b.styles[0]!=a.state.modeGen){var d=je(a,b,b.stateAfter=Zb(a,P(b)));b.styles=d.styles;d.classes?b.styleClasses=d.classes:b.styleClasses&&(b.styleClasses=null);c===a.doc.frontier&&a.doc.frontier++}return b.styles}function nd(a,b,c,d){var f=a.doc.mode,g=new Yc(b,
a.options.tabSize);g.start=g.pos=d||0;for(""==b&&Xe(f,c);!g.eol()&&g.pos<=a.options.maxHighlightLength;)Jd(f,g,c),g.start=g.pos}function af(a,b){if(!a||/^\s*$/.test(a))return null;var c=b.addModeClass?Yf:Zf;return c[a]||(c[a]=a.replace(/\S+/g,"cm-$&"))}function Vd(a,b){var c=B("span",null,null,Y?"padding-right: .1px":null),c={pre:B("pre",[c],"CodeMirror-line"),content:c,col:0,pos:0,cm:a,splitSpaces:(M||Y)&&a.getOption("lineWrapping")};b.measure={};for(var d=0;d<=(b.rest?b.rest.length:0);d++){var f=
d?b.rest[d-1]:b.line,g;c.pos=0;c.addToken=$f;var h;if(null!=Kd)h=Kd;else{h=qa(a.display.measure,document.createTextNode("A\u062eA"));var n=db(h,0,1).getBoundingClientRect();h=n&&n.left!=n.right?Kd=3>db(h,1,2).getBoundingClientRect().right-n.right:!1}h&&(g=ta(f))&&(c.addToken=ag(c.addToken,g));c.map=[];n=b!=a.display.externalMeasured&&P(f);a:{h=c;var n=$e(a,f,n),m=f.markedSpans,q=f.text,s=0;if(m)for(var r=q.length,t=0,v=1,w="",x=void 0,G=void 0,z=0,u=void 0,Z=void 0,C=void 0,L=void 0,aa=void 0;;){if(z==
t){for(var u=Z=C=L=G="",aa=null,z=Infinity,H=[],E=0;E<m.length;++E){var A=m[E],W=A.marker;"bookmark"==W.type&&A.from==t&&W.widgetNode?H.push(W):A.from<=t&&(null==A.to||A.to>t||W.collapsed&&A.to==t&&A.from==t)?(null!=A.to&&A.to!=t&&z>A.to&&(z=A.to,Z=""),W.className&&(u+=" "+W.className),W.css&&(G=W.css),W.startStyle&&A.from==t&&(C+=" "+W.startStyle),W.endStyle&&A.to==z&&(Z+=" "+W.endStyle),W.title&&!L&&(L=W.title),W.collapsed&&(!aa||0>Ve(aa.marker,W))&&(aa=A)):A.from>t&&z>A.from&&(z=A.from)}if(aa&&
(aa.from||0)==t){bf(h,(null==aa.to?r+1:aa.to)-t,aa.marker,null==aa.from);if(null==aa.to)break a;aa.to==t&&(aa=!1)}if(!aa&&H.length)for(E=0;E<H.length;++E)bf(h,0,H[E])}if(t>=r)break;for(H=Math.min(r,z);;){if(w){E=t+w.length;aa||(A=E>H?w.slice(0,H-t):w,h.addToken(h,A,x?x+u:u,C,t+A.length==z?Z:"",L,G));if(E>=H){w=w.slice(H-t);t=H;break}t=E;C=""}w=q.slice(s,s=n[v++]);x=af(n[v++],h.cm.options)}}else for(var v=1;v<n.length;v+=2)h.addToken(h,q.slice(s,s=n[v]),af(n[v+1],h.cm.options))}f.styleClasses&&(f.styleClasses.bgClass&&
(c.bgClass=Ld(f.styleClasses.bgClass,c.bgClass||"")),f.styleClasses.textClass&&(c.textClass=Ld(f.styleClasses.textClass,c.textClass||"")));0==c.map.length&&c.map.push(0,0,c.content.appendChild(bg(a.display.measure)));0==d?(b.measure.map=c.map,b.measure.cache={}):((b.measure.maps||(b.measure.maps=[])).push(c.map),(b.measure.caches||(b.measure.caches=[])).push({}))}Y&&/\bcm-tab\b/.test(c.content.lastChild.className)&&(c.content.className="cm-tab-wrap-hack");X(a,"renderLine",a,b.line,c.pre);c.pre.className&&
(c.textClass=Ld(c.pre.className,c.textClass||""));return c}function $f(a,b,c,d,f,g,h){if(b){var n=a.splitSpaces?b.replace(/ {3,}/g,cg):b,m=a.cm.state.specialChars,q=!1;if(m.test(b))for(var s=document.createDocumentFragment(),r=0;;){m.lastIndex=r;var t=m.exec(b),v=t?t.index-r:b.length-r;if(v){var w=document.createTextNode(n.slice(r,r+v));M&&9>R?s.appendChild(B("span",[w])):s.appendChild(w);a.map.push(a.pos,a.pos+v,w);a.col+=v;a.pos+=v}if(!t)break;r+=v+1;"\t"==t[0]?(w=a.cm.options.tabSize,t=w-a.col%
w,w=s.appendChild(B("span",Ne(t),"cm-tab")),w.setAttribute("role","presentation"),w.setAttribute("cm-text","\t"),a.col+=t):("\r"==t[0]||"\n"==t[0]?(w=s.appendChild(B("span","\r"==t[0]?"\u240d":"\u2424","cm-invalidchar")),w.setAttribute("cm-text",t[0])):(w=a.cm.options.specialCharPlaceholder(t[0]),w.setAttribute("cm-text",t[0]),M&&9>R?s.appendChild(B("span",[w])):s.appendChild(w)),a.col+=1);a.map.push(a.pos,a.pos+1,w);a.pos++}else{a.col+=b.length;var s=document.createTextNode(n);a.map.push(a.pos,a.pos+
b.length,s);M&&9>R&&(q=!0);a.pos+=b.length}if(c||d||f||q||h)return b=c||"",d&&(b+=d),f&&(b+=f),d=B("span",[s],b,h),g&&(d.title=g),a.content.appendChild(d);a.content.appendChild(s)}}function cg(a){for(var b=" ",c=0;c<a.length-2;++c)b+=c%2?" ":"\u00a0";return b+" "}function ag(a,b){return function(c,d,f,g,h,n,m){f=f?f+" cm-force-border":"cm-force-border";for(var q=c.pos,s=q+d.length;;){for(var r=0;r<b.length;r++){var t=b[r];if(t.to>q&&t.from<=q)break}if(t.to>=s)return a(c,d,f,g,h,n,m);a(c,d.slice(0,
t.to-q),f,g,null,n,m);g=null;d=d.slice(t.to-q);q=t.to}}}function bf(a,b,c,d){var f=!d&&c.widgetNode;f&&a.map.push(a.pos,a.pos+b,f);!d&&a.cm.display.input.needsContentAttribute&&(f||(f=a.content.appendChild(document.createElement("span"))),f.setAttribute("cm-marker",c.id));f&&(a.cm.display.input.setUneditable(f),a.content.appendChild(f));a.pos+=b}function Me(a,b){return 0==b.from.ch&&0==b.to.ch&&""==N(b.text)&&(!a.cm||a.cm.options.wholeLineUpdateBefore)}function Fd(a,b,c,d){function f(a,c,p){a.text=
c;a.stateAfter&&(a.stateAfter=null);a.styles&&(a.styles=null);null!=a.order&&(a.order=null);Te(a);Ue(a,p);c=d?d(a):1;c!=a.height&&ya(a,c);fa(a,"change",a,b)}function g(a,b){for(var p=a,f=[];p<b;++p)f.push(new fc(m[p],c?c[p]:null,d));return f}var h=b.from,n=b.to,m=b.text,q=D(a,h.line),s=D(a,n.line),r=N(m),t=c?c[m.length-1]:null,v=n.line-h.line;if(b.full)a.insert(0,g(0,m.length)),a.remove(m.length,a.size-m.length);else if(Me(a,b)){var w=g(0,m.length-1);f(s,s.text,t);v&&a.remove(h.line,v);w.length&&
a.insert(h.line,w)}else q==s?1==m.length?f(q,q.text.slice(0,h.ch)+r+q.text.slice(n.ch),t):(w=g(1,m.length-1),w.push(new fc(r+q.text.slice(n.ch),t,d)),f(q,q.text.slice(0,h.ch)+m[0],c?c[0]:null),a.insert(h.line+1,w)):1==m.length?(f(q,q.text.slice(0,h.ch)+m[0]+s.text.slice(n.ch),c?c[0]:null),a.remove(h.line+1,v)):(f(q,q.text.slice(0,h.ch)+m[0],c?c[0]:null),f(s,r+s.text.slice(n.ch),t),w=g(1,m.length-1),1<v&&a.remove(h.line+1,v-1),a.insert(h.line+1,w));fa(a,"change",a,b)}function gc(a){this.lines=a;this.parent=
null;for(var b=0,c=0;b<a.length;++b)a[b].parent=this,c+=a[b].height;this.height=c}function hc(a){this.children=a;for(var b=0,c=0,d=0;d<a.length;++d){var f=a[d],b=b+f.chunkSize(),c=c+f.height;f.parent=this}this.size=b;this.height=c;this.parent=null}function gb(a,b,c){function d(a,p,f){if(a.linked)for(var g=0;g<a.linked.length;++g){var h=a.linked[g];if(h.doc!=p){var n=f&&h.sharedHist;if(!c||n)b(h.doc,n),d(h.doc,a,n)}}}d(a,null,!0)}function Qd(a,b){if(b.cm)throw Error("This document is already in use.");
...
[];a.iter(b,c,function(a){d.push(a.text)});return d}function ya(a,b){var c=b-a.height;if(c)for(var d=a;d;d=d.parent)d.height+=c}function P(a){if(null==a.parent)return null;var b=a.parent;a=ea(b.lines,a);for(var c=b.parent;c;b=c,c=c.parent)for(var d=0;c.children[d]!=b;++d)a+=c.children[d].chunkSize();return a+b.first}function Ya(a,b){var c=a.first;a:do{for(var d=0;d<a.children.length;++d){var f=a.children[d],g=f.height;if(b<g){a=f;continue a}b-=g;c+=f.chunkSize()}return c}while(!a.lines);for(d=0;d<
...
this.lastOp=this.lastSelOp=null;this.generation=this.maxGeneration=a||1}function Ed(a,b){var c={from:ob(b.from),to:fb(b),text:cb(a,b.from,b.to)};cf(a,c,b.from.line,b.to.line+1);gb(a,function(a){cf(a,c,b.from.line,b.to.line+1)},!0);return c}function ce(a){for(;a.length;)if(N(a).ranges)a.pop();else break}function Ie(a,b,c,d){var f=a.history;f.undone.length=0;var g=+new Date,h,n;if(n=f.lastOp==d||f.lastOrigin==b.origin&&b.origin&&("+"==b.origin.charAt(0)&&a.cm&&f.lastModTime>g-a.cm.options.historyEventDelay||
"*"==b.origin.charAt(0)))f.lastOp==d?(ce(f.done),h=N(f.done)):f.done.length&&!N(f.done).ranges?h=N(f.done):1<f.done.length&&!f.done[f.done.length-2].ranges?(f.done.pop(),h=N(f.done)):h=void 0,n=h;if(n){var m=N(h.changes);0==K(b.from,b.to)&&0==K(b.from,m.to)?m.to=fb(b):h.changes.push(Ed(a,b))}else for((h=N(f.done))&&h.ranges||Ac(a.sel,f.done),h={changes:[Ed(a,b)],generation:f.generation},f.done.push(h);f.done.length>f.undoDepth;)f.done.shift(),f.done[0].ranges||f.done.shift();f.done.push(c);f.generation=
...
return c?c.length?c:null:a}function Bb(a,b,c){for(var d=0,f=[];d<a.length;++d){var g=a[d];if(g.ranges)f.push(c?Ja.prototype.deepCopy.call(g):g);else{var g=g.changes,h=[];f.push({changes:h});for(var n=0;n<g.length;++n){var m=g[n],q;h.push({from:m.from,to:m.to,text:m.text});if(b)for(var s in m)(q=s.match(/^spans_(\d+)$/))&&-1<ea(b,Number(q[1]))&&(N(h)[s]=m[s],delete m[s])}}}return f}function df(a,b,c,d){c<a.line?a.line+=d:b<a.line&&(a.line=b,a.ch=0)}function ef(a,b,c,d){for(var f=0;f<a.length;++f){var g=
a[f],h=!0;if(g.ranges){g.copied||(g=a[f]=g.deepCopy(),g.copied=!0);for(var n=0;n<g.ranges.length;n++)df(g.ranges[n].anchor,b,c,d),df(g.ranges[n].head,b,c,d)}else{for(n=0;n<g.changes.length;++n){var m=g.changes[n];if(c<m.from.line)m.from=A(m.from.line+d,m.from.ch),m.to=A(m.to.line+d,m.to.ch);else if(b<=m.to.line){h=!1;break}}h||(a.splice(0,f+1),f=0)}}}function Je(a,b){var c=b.from.line,d=b.to.line,f=b.text.length-(d-c)-1;ef(a.done,c,d,f);ef(a.undone,c,d,f)}function Ad(a){return null!=a.defaultPrevented?
a.defaultPrevented:!1==a.returnValue}function xe(a){var b=a.which;null==b&&(a.button&1?b=1:a.button&2?b=3:a.button&4&&(b=2));sa&&a.ctrlKey&&1==b&&(b=3);return b}function fa(a,b){function c(a){return function(){a.apply(null,f)}}var d=a._handlers&&a._handlers[b];if(d){var f=Array.prototype.slice.call(arguments,2),g;wb?g=wb.delayedCallbacks:ic?g=ic:(g=ic=[],setTimeout(eg,0));for(var h=0;h<d.length;++h)g.push(c(d[h]))}}function eg(){var a=ic;ic=null;for(var b=0;b<a.length;++b)a[b]()}function Fa(a,b,c){"string"==
typeof b&&(b={type:b,preventDefault:function(){this.defaultPrevented=!0}});X(a,c||b.type,a,b);return Ad(b)||b.codemirrorIgnore}function fe(a){var b=a._handlers&&a._handlers.cursorActivity;if(b){a=a.curOp.cursorActivityHandlers||(a.curOp.cursorActivityHandlers=[]);for(var c=0;c<b.length;++c)-1==ea(a,b[c])&&a.push(b[c])}}function pa(a,b){var c=a._handlers&&a._handlers[b];return c&&0<c.length}function Cb(a){a.prototype.on=function(a,b){F(this,a,b)};a.prototype.off=function(a,b){Ga(this,a,b)}}function Gb(){this.id=
null}function ye(a,b,c){for(var d=0,f=0;;){var g=a.indexOf("\t",d);-1==g&&(g=a.length);var h=g-d;if(g==a.length||f+h>=b)return d+Math.min(h,b-f);f+=g-d;f+=c-f%c;d=g+1;if(f>=b)return d}}function Ne(a){for(;$c.length<=a;)$c.push(N($c)+" ");return $c[a]}function N(a){return a[a.length-1]}function ea(a,b){for(var c=0;c<a.length;++c)if(a[c]==b)return c;return-1}function vc(a,b){for(var c=[],d=0;d<a.length;d++)c[d]=b(a[d],d);return c}function jc(){}function ff(a,b){var c;Object.create?c=Object.create(a):
(jc.prototype=a,c=new jc);b&&ra(b,c);return c}function ra(a,b,c){b||(b={});for(var d in a)!a.hasOwnProperty(d)||!1===c&&b.hasOwnProperty(d)||(b[d]=a[d]);return b}function Hb(a){var b=Array.prototype.slice.call(arguments,1);return function(){return a.apply(null,b)}}function Tc(a,b){return b?-1<b.source.indexOf("\\w")&&gf(a)?!0:b.test(a):gf(a)}function hf(a){for(var b in a)if(a.hasOwnProperty(b)&&a[b])return!1;return!0}function $b(a){return 768<=a.charCodeAt(0)&&fg.test(a)}function B(a,b,c,d){a=document.createElement(a);
c&&(a.className=c);d&&(a.style.cssText=d);if("string"==typeof b)a.appendChild(document.createTextNode(b));else if(b)for(c=0;c<b.length;++c)a.appendChild(b[c]);return a}function Wa(a){for(var b=a.childNodes.length;0<b;--b)a.removeChild(a.firstChild);return a}function qa(a,b){return Wa(a).appendChild(b)}function Ba(){for(var a=document.activeElement;a&&a.root&&a.root.activeElement;)a=a.root.activeElement;return a}function kc(a){return new RegExp("(^|\\s)"+a+"(?:$|\\s)\\s*")}function Ld(a,b){for(var c=
a.split(" "),d=0;d<c.length;d++)c[d]&&!kc(c[d]).test(b)&&(b+=" "+c[d]);return b}function jf(a){if(document.body.getElementsByClassName)for(var b=document.body.getElementsByClassName("CodeMirror"),c=0;c<b.length;c++){var d=b[c].CodeMirror;d&&a(d)}}function sf(){var a;F(window,"resize",function(){null==a&&(a=setTimeout(function(){a=null;jf(Ff)},100))});F(window,"blur",function(){jf(Ib)})}function bg(a){if(null==Nd){var b=B("span","\u200b");qa(a,B("span",[b,document.createTextNode("x")]));0!=a.firstChild.offsetHeight&&
(Nd=1>=b.offsetWidth&&2<b.offsetHeight&&!(M&&8>R))}a=Nd?B("span","\u200b"):B("span","\u00a0",null,"display: inline-block; width: 1px; margin-right: -1px");a.setAttribute("cm-text","");return a}function xf(a,b,c,d){if(!a)return d(b,c,"ltr");for(var f=!1,g=0;g<a.length;++g){var h=a[g];if(h.from<c&&h.to>b||b==c&&h.to==b)d(Math.max(h.from,b),Math.min(h.to,c),1==h.level?"rtl":"ltr"),f=!0}f||d(b,c,"ltr")}function sd(a){return a.level%2?a.to:a.from}function td(a){return a.level%2?a.from:a.to}function Fc(a){return(a=
ta(a))?sd(a[0]):0}function Gc(a){var b=ta(a);return b?td(N(b)):a.text.length}function kf(a,b){var c=D(a.doc,b),d=Ea(c);d!=c&&(b=P(d));d=(c=ta(d))?c[0].level%2?Gc(d):Fc(d):0;return A(b,d)}function lf(a,b){var c=kf(a,b.line),d=D(a.doc,c.line),f=ta(d);return f&&0!=f[0].level?c:(d=Math.max(0,d.text.search(/\S/)),A(c.line,b.line==c.line&&b.ch<=d&&b.ch?0:d))}function wc(a,b){bc=null;for(var c=0,d;c<a.length;++c){var f=a[c];if(f.from<b&&f.to>b)return c;if(f.from==b||f.to==b)if(null==d)d=c;else{var g;g=f.level;
var h=a[d].level,n=a[0].level;g=g==n?!0:h==n?!1:g<h;if(g)return f.from!=f.to&&(bc=d),c;f.from!=f.to&&(bc=c);break}}return d}function Od(a,b,c,d){if(!d)return b+c;do b+=c;while(0<b&&$b(a.text.charAt(b)));return b}function vd(a,b,c,d){var f=ta(a);if(!f)return Oe(a,b,c,d);var g=wc(f,b),h=f[g];for(b=Od(a,b,h.level%2?-c:c,d);;){if(b>h.from&&b<h.to)return b;if(b==h.from||b==h.to){if(wc(f,b)==g)return b;h=f[g+c];return 0<c==h.level%2?h.to:h.from}h=f[g+=c];if(!h)return null;b=0<c==h.level%2?Od(a,h.to,-1,
d):Od(a,h.from,1,d)}}function Oe(a,b,c,d){b+=c;if(d)for(;0<b&&$b(a.text.charAt(b));)b+=c;return 0>b||b>a.text.length?null:b}var Ta=/gecko\/\d/i.test(navigator.userAgent),mf=/MSIE \d/.test(navigator.userAgent),nf=/Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent),M=mf||nf,R=M&&(mf?document.documentMode||6:nf[1]),Y=/WebKit\//.test(navigator.userAgent),gg=Y&&/Qt\/\d+\.\d+/.test(navigator.userAgent),hg=/Chrome\//.test(navigator.userAgent),wa=/Opera\//.test(navigator.userAgent),te=/Apple Computer/.test(navigator.vendor),
ig=/Mac OS X 1\d\D([8-9]|\d\d)\D/.test(navigator.userAgent),Df=/PhantomJS/.test(navigator.userAgent),tb=/AppleWebKit/.test(navigator.userAgent)&&/Mobile\/\w+/.test(navigator.userAgent),Fb=tb||/Android|webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(navigator.userAgent),sa=tb||/Mac/.test(navigator.platform),jg=/win/i.test(navigator.platform),ib=wa&&navigator.userAgent.match(/Version\/(\d*\.\d*)/);ib&&(ib=Number(ib[1]));ib&&15<=ib&&(wa=!1,Y=!0);var of=sa&&(gg||wa&&(null==ib||12.11>ib)),xd=Ta||
M&&9<=R,Ge=!1,Pa=!1;v.prototype=ra({update:function(a){var b=a.scrollWidth>a.clientWidth+1,c=a.scrollHeight>a.clientHeight+1,d=a.nativeBarWidth;c?(this.vert.style.display="block",this.vert.style.bottom=b?d+"px":"0",this.vert.firstChild.style.height=Math.max(0,a.scrollHeight-a.clientHeight+(a.viewHeight-(b?d:0)))+"px"):(this.vert.style.display="",this.vert.firstChild.style.height="0");b?(this.horiz.style.display="block",this.horiz.style.right=c?d+"px":"0",this.horiz.style.left=a.barLeft+"px",this.horiz.firstChild.style.width=
a.scrollWidth-a.clientWidth+(a.viewWidth-a.barLeft-(c?d:0))+"px"):(this.horiz.style.display="",this.horiz.firstChild.style.width="0");!this.checkedOverlay&&0<a.clientHeight&&(0==d&&this.overlayHack(),this.checkedOverlay=!0);return{right:c?d:0,bottom:b?d:0}},setScrollLeft:function(a){this.horiz.scrollLeft!=a&&(this.horiz.scrollLeft=a)},setScrollTop:function(a){this.vert.scrollTop!=a&&(this.vert.scrollTop=a)},overlayHack:function(){this.horiz.style.minHeight=this.vert.style.minWidth=sa&&!ig?"12px":
"18px";var a=this,b=function(b){(b.target||b.srcElement)!=a.vert&&(b.target||b.srcElement)!=a.horiz&&V(a.cm,pe)(b)};F(this.vert,"mousedown",b);F(this.horiz,"mousedown",b)},clear:function(){var a=this.horiz.parentNode;a.removeChild(this.horiz);a.removeChild(this.vert)}},v.prototype);u.prototype=ra({update:function(){return{bottom:0,right:0}},setScrollLeft:function(){},setScrollTop:function(){},clear:function(){}},u.prototype);d.scrollbarModel={"native":v,"null":u};T.prototype.signal=function(a,b){pa(a,
...
W(d);oa=f.text;"cut"==a.type?d.setSelections(f.ranges,null,Da):(c.prevInput="",g.value=f.text.join("\n"),Db(g))}else return;"cut"==a.type&&(d.state.cutIncoming=!0)}var c=this,d=this.cm,f=this.wrapper=Xd(),g=this.textarea=f.firstChild;a.wrapper.insertBefore(f,a.wrapper.firstChild);tb&&(g.style.width="0px");F(g,"input",function(){M&&9<=R&&c.hasSelection&&(c.hasSelection=null);c.poll()});F(g,"paste",function(a){if(aa(a,d))return!0;d.state.pasteIncoming=!0;c.fastPoll()});F(g,"cut",b);F(g,"copy",b);F(a.scroller,
"paste",function(b){Ma(a,b)||(d.state.pasteIncoming=!0,c.focus())});F(a.lineSpace,"selectstart",function(b){Ma(a,b)||ha(b)});F(g,"compositionstart",function(){var a=d.getCursor("from");c.composing={start:a,range:d.markText(a,d.getCursor("to"),{className:"CodeMirror-composing"})}});F(g,"compositionend",function(){c.composing&&(c.poll(),c.composing.range.clear(),c.composing=null)})},prepareSelection:function(){var a=this.cm,b=a.display,c=a.doc,d=he(a);if(a.options.moveInputWithCursor){var a=Ka(a,c.sel.primary().head,
...
f=d.doc;d.somethingSelected()?(this.prevInput="",b=f.sel.primary(),c=(b=Ce&&(100<b.to().line-b.from().line||1E3<(c=d.getSelection()).length))?"-":c||d.getSelection(),this.textarea.value=c,d.state.focused&&Db(this.textarea),M&&9<=R&&(this.hasSelection=c)):a||(this.prevInput=this.textarea.value="",M&&9<=R&&(this.hasSelection=null));this.inaccurateSelection=b}},getField:function(){return this.textarea},supportsTouch:function(){return!1},focus:function(){if("nocursor"!=this.cm.options.readOnly&&(!Fb||
...
a)},poll:function(){var a=this.cm,b=this.textarea,c=this.prevInput;if(this.contextMenuPending||!a.state.focused||kg(b)&&!c&&!this.composing||Qa(a)||a.options.disableInput||a.state.keySeq)return!1;var d=b.value;if(d==c&&!a.somethingSelected())return!1;if(M&&9<=R&&this.hasSelection===d||sa&&/[\uf700-\uf7ff]/.test(d))return a.display.input.reset(),!1;if(a.doc.sel==a.display.selForContextMenu){var f=d.charCodeAt(0);8203!=f||c||(c="\u200b");if(8666==f)return this.reset(),this.cm.execCommand("undo")}for(var g=
0,f=Math.min(c.length,d.length);g<f&&c.charCodeAt(g)==d.charCodeAt(g);)++g;var h=this;ka(a,function(){bb(a,d.slice(g),c.length-g,null,h.composing?"*compose":null);1E3<d.length||-1<d.indexOf("\n")?b.value=h.prevInput="":h.prevInput=d;h.composing&&(h.composing.range.clear(),h.composing.range=a.markText(h.composing.start,a.getCursor("to"),{className:"CodeMirror-composing"}))});return!0},ensurePolled:function(){this.pollingFast&&this.poll()&&(this.pollingFast=!1)},onKeyPress:function(){M&&9<=R&&(this.hasSelection=
null);this.fastPoll()},onContextMenu:function(a){function b(){if(null!=h.selectionStart){var a=f.somethingSelected(),c="\u200b"+(a?h.value:"");h.value="\u21da";h.value=c;d.prevInput=a?"":"\u200b";h.selectionStart=1;h.selectionEnd=c.length;g.selForContextMenu=f.doc.sel}}function c(){d.contextMenuPending=!1;d.wrapper.style.position="relative";h.style.cssText=q;M&&9>R&&g.scrollbars.setScrollTop(g.scroller.scrollTop=m);if(null!=h.selectionStart){(!M||M&&9>R)&&b();var a=0,p=function(){g.selForContextMenu==
f.doc.sel&&0==h.selectionStart&&0<h.selectionEnd&&"\u200b"==d.prevInput?V(f,Nc.selectAll)(f):10>a++?g.detectingSelectAll=setTimeout(p,500):g.input.reset()};g.detectingSelectAll=setTimeout(p,200)}}var d=this,f=d.cm,g=f.display,h=d.textarea,n=xb(f,a),m=g.scroller.scrollTop;if(n&&!wa){f.options.resetSelectionOnContextMenu&&-1==f.doc.sel.contains(n)&&V(f,ba)(f.doc,Ca(n),Da);var q=h.style.cssText;d.wrapper.style.position="absolute";h.style.cssText="position: fixed; width: 30px; height: 30px; top: "+(a.clientY-
5)+"px; left: "+(a.clientX-5)+"px; z-index: 1000; background: "+(M?"rgba(255, 255, 255, .05)":"transparent")+"; outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);";if(Y)var s=window.scrollY;g.input.focus();Y&&window.scrollTo(null,s);g.input.reset();f.somethingSelected()||(h.value=d.prevInput=" ");d.contextMenuPending=!0;g.selForContextMenu=f.doc.sel;clearTimeout(g.detectingSelectAll);M&&9<=R&&b();if(xd){yd(a);var t=function(){Ga(window,"mouseup",
t);setTimeout(c,20)};F(window,"mouseup",t)}else setTimeout(c,50)}},setUneditable:jc,needsContentAttribute:!1},hd.prototype);id.prototype=ra({init:function(a){function b(a){if(d.somethingSelected())oa=d.getSelections(),"cut"==a.type&&d.replaceSelection("",null,"cut");else if(d.options.lineWiseCopyCut){var c=W(d);oa=c.text;"cut"==a.type&&d.operation(function(){d.setSelections(c.ranges,0,Da);d.replaceSelection("",null,"cut")})}else return;if(a.clipboardData&&!tb)a.preventDefault(),a.clipboardData.clearData(),
a.clipboardData.setData("text/plain",oa.join("\n"));else{var f=Xd();a=f.firstChild;d.display.lineSpace.insertBefore(f,d.display.lineSpace.firstChild);a.value=oa.join("\n");var p=document.activeElement;Db(a);setTimeout(function(){d.display.lineSpace.removeChild(f);p.focus()},50)}}var c=this,d=c.cm;a=c.div=a.lineDiv;a.contentEditable="true";Wd(a);F(a,"paste",function(a){aa(a,d)});F(a,"compositionstart",function(a){a=a.data;c.composing={sel:d.doc.sel,data:a,startData:a};if(a){var b=d.doc.sel.primary(),
f=d.getLine(b.head.line).indexOf(a,Math.max(0,b.head.ch-a.length));-1<f&&f<=b.head.ch&&(c.composing.sel=Ca(A(b.head.line,f),A(b.head.line,f+a.length)))}});F(a,"compositionupdate",function(a){c.composing.data=a.data});F(a,"compositionend",function(a){var b=c.composing;b&&(a.data==b.startData||/\u200b/.test(a.data)||(b.data=a.data),setTimeout(function(){b.handled||c.applyComposition(b);c.composing==b&&(c.composing=null)},50))});F(a,"touchstart",function(){c.forceCompositionEnd()});F(a,"input",function(){c.composing||
c.pollContent()||ka(c.cm,function(){ja(d)})});F(a,"copy",b);F(a,"cut",b)},prepareSelection:function(){var a=he(this.cm,!1);a.focus=this.cm.state.focused;return a},showSelection:function(a){a&&this.cm.display.view.length&&(a.focus&&this.showPrimarySelection(),this.showMultipleSelections(a))},showPrimarySelection:function(){var a=window.getSelection(),b=this.cm.doc.sel.primary(),c=xc(this.cm,a.anchorNode,a.anchorOffset),d=xc(this.cm,a.focusNode,a.focusOffset);if(!c||c.bad||!d||d.bad||0!=K(qb(c,d),b.from())||
0!=K(pb(c,d),b.to()))if(c=Yd(this.cm,b.from()),d=Yd(this.cm,b.to()),c||d){var f=this.cm.display.view,b=a.rangeCount&&a.getRangeAt(0);c?d||(d=f[f.length-1].measure,d=d.maps?d.maps[d.maps.length-1]:d.map,d={node:d[d.length-1],offset:d[d.length-2]-d[d.length-3]}):c={node:f[0].measure.map[2],offset:0};try{var g=db(c.node,c.offset,d.offset,d.node)}catch(h){}g&&(a.removeAllRanges(),a.addRange(g),b&&null==a.anchorNode?a.addRange(b):Ta&&this.startGracePeriod());this.rememberSelection()}},startGracePeriod:function(){var a=
...
Ca(c,d),Da);if(c.bad||d.bad)b.curOp.selectionChanged=!0})}},pollContent:function(){var a=this.cm,b=a.display,c=a.doc.sel.primary(),d=c.from(),c=c.to();if(d.line<b.viewFrom||c.line>b.viewTo-1)return!1;var f;d.line==b.viewFrom||0==(f=$a(a,d.line))?(d=P(b.view[0].line),f=b.view[0].node):(d=P(b.view[f].line),f=b.view[f-1].node.nextSibling);var g=$a(a,c.line);g==b.view.length-1?(c=b.viewTo-1,b=b.lineDiv.lastChild):(c=P(b.view[g+1].line)-1,b=b.view[g+1].node.previousSibling);b=a.doc.splitLines(uf(a,f,b,
d,c));for(f=cb(a.doc,A(d,0),A(c,D(a.doc,c).text.length));1<b.length&&1<f.length;)if(N(b)==N(f))b.pop(),f.pop(),c--;else if(b[0]==f[0])b.shift(),f.shift(),d++;else break;for(var h=0,g=0,n=b[0],m=f[0],q=Math.min(n.length,m.length);h<q&&n.charCodeAt(h)==m.charCodeAt(h);)++h;n=N(b);m=N(f);for(q=Math.min(n.length-(1==b.length?h:0),m.length-(1==f.length?h:0));g<q&&n.charCodeAt(n.length-g-1)==m.charCodeAt(m.length-g-1);)++g;b[b.length-1]=n.slice(0,n.length-g);b[0]=b[0].slice(h);d=A(d,h);c=A(c,f.length?N(f).length-
g:0);if(1<b.length||b[0]||K(d,c))return yb(a.doc,b,d,c,"+input"),!0},ensurePolled:function(){this.forceCompositionEnd()},reset:function(){this.forceCompositionEnd()},forceCompositionEnd:function(){this.composing&&!this.composing.handled&&(this.applyComposition(this.composing),this.composing.handled=!0,this.div.blur(),this.div.focus())},applyComposition:function(a){a.data&&a.data!=a.startData&&V(this.cm,bb)(this.cm,a.data,0,a.sel)},setUneditable:function(a){a.setAttribute("contenteditable","false")},
onKeyPress:function(a){a.preventDefault();V(this.cm,bb)(this.cm,String.fromCharCode(null==a.charCode?a.keyCode:a.charCode),0)},onContextMenu:jc,resetPosition:jc,needsContentAttribute:!0},id.prototype);d.inputStyles={textarea:hd,contenteditable:id};Ja.prototype={primary:function(){return this.ranges[this.primIndex]},equals:function(a){if(a==this)return!0;if(a.primIndex!=this.primIndex||a.ranges.length!=this.ranges.length)return!1;for(var b=0;b<this.ranges.length;b++){var c=this.ranges[b],d=a.ranges[b];
if(0!=K(c.anchor,d.anchor)||0!=K(c.head,d.head))return!1}return!0},deepCopy:function(){for(var a=[],b=0;b<this.ranges.length;b++)a[b]=new Q(ob(this.ranges[b].anchor),ob(this.ranges[b].head));return new Ja(a,this.primIndex)},somethingSelected:function(){for(var a=0;a<this.ranges.length;a++)if(!this.ranges[a].empty())return!0;return!1},contains:function(a,b){b||(b=a);for(var c=0;c<this.ranges.length;c++){var d=this.ranges[c];if(0<=K(b,d.from())&&0>=K(a,d.to()))return c}return-1}};Q.prototype={from:function(){return qb(this.anchor,
this.head)},to:function(){return pb(this.anchor,this.head)},empty:function(){return this.head.line==this.anchor.line&&this.head.ch==this.anchor.ch}};var pd={left:0,right:0,top:0,bottom:0},eb,wb=null,Cf=0,Kc,Jc,se=0,Lc=0,la=null;M?la=-.53:Ta?la=15:hg?la=-.7:te&&(la=-1/3);var ze=function(a){var b=a.wheelDeltaX,c=a.wheelDeltaY;null==b&&a.detail&&a.axis==a.HORIZONTAL_AXIS&&(b=a.detail);null==c&&a.detail&&a.axis==a.VERTICAL_AXIS?c=a.detail:null==c&&(c=a.wheelDelta);return{x:b,y:c}};d.wheelEventPixels=
function(a){a=ze(a);a.x*=la;a.y*=la;return a};var Nf=new Gb,Bd=null,fb=d.changeEnd=function(a){return a.text?A(a.from.line+a.text.length-1,N(a.text).length+(1==a.text.length?a.from.ch:0)):a.to};d.prototype={constructor:d,focus:function(){window.focus();this.display.input.focus()},setOption:function(a,b){var c=this.options,d=c[a];if(c[a]!=b||"mode"==a)c[a]=b,kb.hasOwnProperty(a)&&V(this,kb[a])(this,b,d)},getOption:function(a){return this.options[a]},getDoc:function(){return this.doc},addKeyMap:function(a,
b){this.state.keyMaps[b?"push":"unshift"](Uc(a))},removeKeyMap:function(a){for(var b=this.state.keyMaps,c=0;c<b.length;++c)if(b[c]==a||b[c].name==a)return b.splice(c,1),!0},addOverlay:da(function(a,b){var c=a.token?a:d.getMode(this.options,a);if(c.startState)throw Error("Overlays may not be stateful.");this.state.overlays.push({mode:c,modeSpec:a,opaque:b&&b.opaque});this.state.modeGen++;ja(this)}),removeOverlay:da(function(a){for(var b=this.state.overlays,c=0;c<b.length;++c){var d=b[c].modeSpec;if(d==
a||"string"==typeof a&&d.name==a){b.splice(c,1);this.state.modeGen++;ja(this);break}}}),indentLine:da(function(a,b,c){"string"!=typeof b&&"number"!=typeof b&&(b=null==b?this.options.smartIndent?"smart":"prev":b?"add":"subtract");Xb(this.doc,a)&&Wb(this,a,b,c)}),indentSelection:da(function(a){for(var b=this.doc.sel.ranges,c=-1,d=0;d<b.length;d++){var f=b[d];if(f.empty())f.head.line>c&&(Wb(this,f.head.line,a,!0),c=f.head.line,d==this.doc.sel.primIndex&&sb(this));else{for(var g=f.from(),f=f.to(),h=Math.max(c,
g.line),c=Math.min(this.lastLine(),f.line-(f.ch?0:1))+1,f=h;f<c;++f)Wb(this,f,a);f=this.doc.sel.ranges;0==g.ch&&b.length==f.length&&0<f[d].from().ch&&ld(this.doc,d,new Q(g,f[d].to()),Da)}}}),getTokenAt:function(a,b){return Ye(this,a,b)},getLineTokens:function(a,b){return Ye(this,A(a),b,!0)},getTokenTypeAt:function(a){a=J(this.doc,a);var b=$e(this,D(this.doc,a.line)),c=0,d=(b.length-1)/2;a=a.ch;var f;if(0==a)f=b[2];else for(;;){var g=c+d>>1;if((g?b[2*g-1]:0)>=a)d=g;else if(b[2*g+1]<a)c=g+1;else{f=
...
c.push(d[f.helperType]):d[f.name]&&c.push(d[f.name]);for(g=0;g<d._global.length;g++)h=d._global[g],h.pred(f,this)&&-1==ea(c,h.val)&&c.push(h.val);return c},getStateAfter:function(a,b){var c=this.doc;a=Math.max(c.first,Math.min(null==a?c.first+c.size-1:a,c.first+c.size-1));return Zb(this,a+1,b)},cursorCoords:function(a,b){var c;c=this.doc.sel.primary();c=null==a?c.head:"object"==typeof a?J(this.doc,a):a?c.from():c.to();return Ka(this,c,b||"page")},charCoords:function(a,b){return Cc(this,J(this.doc,
a),b||"page")},coordsChar:function(a,b){a=ne(this,a,b||"page");return ud(this,a.left,a.top)},lineAtHeight:function(a,b){a=ne(this,{top:a,left:0},b||"page").top;return Ya(this.doc,a+this.display.viewOffset)},heightAtLine:function(a,b){var c=!1,d;"number"==typeof a?(d=this.doc.first+this.doc.size-1,a<this.doc.first?a=this.doc.first:a>d&&(a=d,c=!0),d=D(this.doc,a)):d=a;return rd(this,d,{top:0,left:0},b||"page").top+(c?this.doc.height-Aa(d):0)},defaultTextHeight:function(){return Ua(this.display)},defaultCharWidth:function(){return Kb(this.display)},
setGutterMarker:da(function(a,b,c){return Sc(this.doc,a,"gutter",function(a){var d=a.gutterMarkers||(a.gutterMarkers={});d[b]=c;!c&&hf(d)&&(a.gutterMarkers=null);return!0})}),clearGutter:da(function(a){var b=this,c=b.doc,d=c.first;c.iter(function(c){c.gutterMarkers&&c.gutterMarkers[a]&&(c.gutterMarkers[a]=null,La(b,d,"gutter"),hf(c.gutterMarkers)&&(c.gutterMarkers=null));++d})}),lineInfo:function(a){if("number"==typeof a){if(!Xb(this.doc,a))return null;var b=a;a=D(this.doc,a);if(!a)return null}else if(b=
P(a),null==b)return null;return{line:b,handle:a,text:a.text,gutterMarkers:a.gutterMarkers,textClass:a.textClass,bgClass:a.bgClass,wrapClass:a.wrapClass,widgets:a.widgets}},getViewport:function(){return{from:this.display.viewFrom,to:this.display.viewTo}},addWidget:function(a,b,c,d,f){var g=this.display;a=Ka(this,J(this.doc,a));var h=a.bottom,n=a.left;b.style.position="absolute";b.setAttribute("cm-ignore-events","true");this.display.input.setUneditable(b);g.sizer.appendChild(b);if("over"==d)h=a.top;
else if("above"==d||"near"==d){var m=Math.max(g.wrapper.clientHeight,this.doc.height),q=Math.max(g.sizer.clientWidth,g.lineSpace.clientWidth);("above"==d||a.bottom+b.offsetHeight>m)&&a.top>b.offsetHeight?h=a.top-b.offsetHeight:a.bottom+b.offsetHeight<=m&&(h=a.bottom);n+b.offsetWidth>q&&(n=q-b.offsetWidth)}b.style.top=h+"px";b.style.left=b.style.right="";"right"==f?(n=g.sizer.clientWidth-b.offsetWidth,b.style.right="0px"):("left"==f?n=0:"middle"==f&&(n=(g.sizer.clientWidth-b.offsetWidth)/2),b.style.left=
n+"px");c&&(a=Hc(this,n,h,n+b.offsetWidth,h+b.offsetHeight),null!=a.scrollTop&&Nb(this,a.scrollTop),null!=a.scrollLeft&&mb(this,a.scrollLeft))},triggerOnKeyDown:da(ve),triggerOnKeyPress:da(we),triggerOnKeyUp:ue,execCommand:function(a){if(Nc.hasOwnProperty(a))return Nc[a].call(null,this)},triggerElectric:da(function(a){Z(this,a)}),findPosH:function(a,b,c,d){var f=1;0>b&&(f=-1,b=-b);var g=0;for(a=J(this.doc,a);g<b&&(a=Gd(this.doc,a,f,c,d),!a.hitSide);++g);return a},moveH:da(function(a,b){var c=this;
c.extendSelectionsBy(function(d){return c.display.shift||c.doc.extend||d.empty()?Gd(c.doc,d.head,a,b,c.options.rtlMoveVisually):0>a?d.from():d.to()},lc)}),deleteH:da(function(a,b){var c=this.doc;this.doc.sel.somethingSelected()?c.replaceSelection("",null,"+delete"):zb(this,function(d){var f=Gd(c,d.head,a,b,!1);return 0>a?{from:f,to:d.head}:{from:d.head,to:f}})}),findPosV:function(a,b,c,d){var f=1;0>b&&(f=-1,b=-b);var g=0;for(a=J(this.doc,a);g<b&&(a=Ka(this,a,"div"),null==d?d=a.left:a.left=d,a=Pe(this,
a,f,c),!a.hitSide);++g);return a},moveV:da(function(a,b){var c=this,d=this.doc,f=[],g=!c.display.shift&&!d.extend&&d.sel.somethingSelected();d.extendSelectionsBy(function(h){if(g)return 0>a?h.from():h.to();var n=Ka(c,h.head,"div");null!=h.goalColumn&&(n.left=h.goalColumn);f.push(n.left);var m=Pe(c,n,a,b);"page"==b&&h==d.sel.primary()&&Qc(c,null,Cc(c,m,"div").top-n.top);return m},lc);if(f.length)for(var h=0;h<d.sel.ranges.length;h++)d.sel.ranges[h].goalColumn=f[h]}),findWordAt:function(a){var b=D(this.doc,
a.line).text,c=a.ch,d=a.ch;if(b){var f=this.getHelper(a,"wordChars");(0>a.xRel||d==b.length)&&c?--c:++d;for(var g=b.charAt(c),g=Tc(g,f)?function(a){return Tc(a,f)}:/\s/.test(g)?function(a){return/\s/.test(a)}:function(a){return!/\s/.test(a)&&!Tc(a)};0<c&&g(b.charAt(c-1));)--c;for(;d<b.length&&g(b.charAt(d));)++d}return new Q(A(a.line,c),A(a.line,d))},toggleOverwrite:function(a){if(null==a||a!=this.state.overwrite)(this.state.overwrite=!this.state.overwrite)?Ob(this.display.cursorDiv,"CodeMirror-overwrite"):
Mb(this.display.cursorDiv,"CodeMirror-overwrite"),X(this,"overwriteToggle",this,this.state.overwrite)},hasFocus:function(){return this.display.input.getField()==Ba()},scrollTo:da(function(a,b){null==a&&null==b||Rc(this);null!=a&&(this.curOp.scrollLeft=a);null!=b&&(this.curOp.scrollTop=b)}),getScrollInfo:function(){var a=this.display.scroller;return{left:a.scrollLeft,top:a.scrollTop,height:a.scrollHeight-za(this)-this.display.barHeight,width:a.scrollWidth-za(this)-this.display.barWidth,clientHeight:fd(this),
clientWidth:Na(this)}},scrollIntoView:da(function(a,b){null==a?(a={from:this.doc.sel.primary().head,to:null},null==b&&(b=this.options.cursorScrollMargin)):"number"==typeof a?a={from:A(a,0),to:null}:null==a.from&&(a={from:a,to:null});a.to||(a.to=a.from);a.margin=b||0;if(null!=a.from.line)Rc(this),this.curOp.scrollToPos=a;else{var c=Hc(this,Math.min(a.from.left,a.to.left),Math.min(a.from.top,a.to.top)-a.margin,Math.max(a.from.right,a.to.right),Math.max(a.from.bottom,a.to.bottom)+a.margin);this.scrollTo(c.scrollLeft,
c.scrollTop)}}),setSize:da(function(a,b){function c(a){return"number"==typeof a||/^\d+$/.test(String(a))?a+"px":a}var d=this;null!=a&&(d.display.wrapper.style.width=c(a));null!=b&&(d.display.wrapper.style.height=c(b));d.options.lineWrapping&&me(this);var f=d.display.viewFrom;d.doc.iter(f,d.display.viewTo,function(a){if(a.widgets)for(var b=0;b<a.widgets.length;b++)if(a.widgets[b].noHScroll){La(d,f,"widget");break}++f});d.curOp.forceUpdate=!0;X(d,"refresh",this)}),operation:function(a){return ka(this,
a)},refresh:da(function(){var a=this.display.cachedTextHeight;ja(this);this.curOp.forceUpdate=!0;Lb(this);this.scrollTo(this.doc.scrollLeft,this.doc.scrollTop);r(this);(null==a||.5<Math.abs(a-Ua(this.display)))&&g(this);X(this,"refresh",this)}),swapDoc:da(function(a){var b=this.doc;b.cm=null;Qd(this,a);Lb(this);this.display.input.reset();this.scrollTo(a.scrollLeft,a.scrollTop);this.curOp.forceScroll=!0;fa(this,"swapDoc",this,b);return b}),getInputField:function(){return this.display.input.getField()},
getWrapperElement:function(){return this.display.wrapper},getScrollerElement:function(){return this.display.scroller},getGutterElement:function(){return this.display.gutters}};Cb(d);var qf=d.defaults={},kb=d.optionHandlers={},Rd=d.Init={toString:function(){return"CodeMirror.Init"}};I("value","",function(a,b){a.setValue(b)},!0);I("mode",null,function(a,b){a.doc.modeOption=b;c(a)},!0);I("indentUnit",2,c,!0);I("indentWithTabs",!1);I("smartIndent",!0);I("tabSize",4,function(b){a(b);Lb(b);ja(b)},!0);I("lineSeparator",
null,function(a,b){if(a.doc.lineSep=b){var c=[],d=a.doc.first;a.doc.iter(function(a){for(var f=0;;){var p=a.text.indexOf(b,f);if(-1==p)break;f=p+b.length;c.push(A(d,p))}d++});for(var f=c.length-1;0<=f;f--)yb(a.doc,b,c[f],A(c[f].line,c[f].ch+b.length))}});I("specialChars",/[\t\u0000-\u0019\u00ad\u200b-\u200f\u2028\u2029\ufeff]/g,function(a,b,c){a.state.specialChars=new RegExp(b.source+(b.test("\t")?"":"|\t"),"g");c!=d.Init&&a.refresh()});I("specialCharPlaceholder",function(a){var b=B("span","\u2022",
"cm-invalidchar");b.title="\\u"+a.charCodeAt(0).toString(16);b.setAttribute("aria-label",b.title);return b},function(a){a.refresh()},!0);I("electricChars",!0);I("inputStyle",Fb?"contenteditable":"textarea",function(){throw Error("inputStyle can not (yet) be changed in a running editor");},!0);I("rtlMoveVisually",!jg);I("wholeLineUpdateBefore",!0);I("theme","default",function(a){m(a);h(a)},!0);I("keyMap","default",function(a,b,c){b=Uc(b);(c=c!=d.Init&&Uc(c))&&c.detach&&c.detach(a,b);b.attach&&b.attach(a,
c||null)});I("extraKeys",null);I("lineWrapping",!1,function(a){a.options.lineWrapping?(Ob(a.display.wrapper,"CodeMirror-wrap"),a.display.sizer.style.minWidth="",a.display.sizerWidth=null):(Mb(a.display.wrapper,"CodeMirror-wrap"),t(a));g(a);ja(a);Lb(a);setTimeout(function(){w(a)},100)},!0);I("gutters",[],function(a){x(a.options);h(a)},!0);I("fixedGutter",!0,function(a,b){a.display.gutters.style.left=b?S(a.display)+"px":"0";a.refresh()},!0);I("coverGutterNextToScrollbar",!1,function(a){w(a)},!0);I("scrollbarStyle",
"native",function(a){s(a);w(a);a.display.scrollbars.setScrollTop(a.doc.scrollTop);a.display.scrollbars.setScrollLeft(a.doc.scrollLeft)},!0);I("lineNumbers",!1,function(a){x(a.options);h(a)},!0);I("firstLineNumber",1,h,!0);I("lineNumberFormatter",function(a){return a},h,!0);I("showCursorWhenSelecting",!1,Pb,!0);I("resetSelectionOnContextMenu",!0);I("lineWiseCopyCut",!0);I("readOnly",!1,function(a,b){"nocursor"==b?(Ib(a),a.display.input.blur(),a.display.disabled=!0):(a.display.disabled=!1,b||a.display.input.reset())});
I("disableInput",!1,function(a,b){b||a.display.input.reset()},!0);I("dragDrop",!0,function(a,b,c){!b!=!(c&&c!=d.Init)&&(c=a.display.dragFunctions,b=b?F:Ga,b(a.display.scroller,"dragstart",c.start),b(a.display.scroller,"dragenter",c.simple),b(a.display.scroller,"dragover",c.simple),b(a.display.scroller,"drop",c.drop))});I("cursorBlinkRate",530);I("cursorScrollMargin",0);I("cursorHeight",1,Pb,!0);I("singleCursorHeightPerLine",!0,Pb,!0);I("workTime",100);I("workDelay",100);I("flattenSpans",!0,a,!0);
I("addModeClass",!1,a,!0);I("pollInterval",100);I("undoDepth",200,function(a,b){a.doc.history.undoDepth=b});I("historyEventDelay",1250);I("viewportMargin",10,function(a){a.refresh()},!0);I("maxHighlightLength",1E4,a,!0);I("moveInputWithCursor",!0,function(a,b){b||a.display.input.resetPosition()});I("tabindex",null,function(a,b){a.display.input.getField().tabIndex=b||""});I("autofocus",null);var pf=d.modes={},nc=d.mimeModes={};d.defineMode=function(a,b){d.defaults.mode||"null"==a||(d.defaults.mode=
a);2<arguments.length&&(b.dependencies=Array.prototype.slice.call(arguments,2));pf[a]=b};d.defineMIME=function(a,b){nc[a]=b};d.resolveMode=function(a){if("string"==typeof a&&nc.hasOwnProperty(a))a=nc[a];else if(a&&"string"==typeof a.name&&nc.hasOwnProperty(a.name)){var b=nc[a.name];"string"==typeof b&&(b={name:b});a=ff(b,a);a.name=b.name}else if("string"==typeof a&&/^[\w\-]+\/[\w\-]+\+xml$/.test(a))return d.resolveMode("application/xml");return"string"==typeof a?{name:a}:a||{name:"null"}};d.getMode=
function(a,b){b=d.resolveMode(b);var c=pf[b.name];if(!c)return d.getMode(a,"text/plain");c=c(a,b);if(oc.hasOwnProperty(b.name)){var f=oc[b.name],g;for(g in f)f.hasOwnProperty(g)&&(c.hasOwnProperty(g)&&(c["_"+g]=c[g]),c[g]=f[g])}c.name=b.name;b.helperType&&(c.helperType=b.helperType);if(b.modeProps)for(g in b.modeProps)c[g]=b.modeProps[g];return c};d.defineMode("null",function(){return{token:function(a){a.skipToEnd()}}});d.defineMIME("text/plain","null");var oc=d.modeExtensions={};d.extendMode=function(a,
b){var c=oc.hasOwnProperty(a)?oc[a]:oc[a]={};ra(b,c)};d.defineExtension=function(a,b){d.prototype[a]=b};d.defineDocExtension=function(a,b){ia.prototype[a]=b};d.defineOption=I;var bd=[];d.defineInitHook=function(a){bd.push(a)};var Eb=d.helpers={};d.registerHelper=function(a,b,c){Eb.hasOwnProperty(a)||(Eb[a]=d[a]={_global:[]});Eb[a][b]=c};d.registerGlobalHelper=function(a,b,c,f){d.registerHelper(a,b,f);Eb[a]._global.push({pred:c,val:f})};var vb=d.copyState=function(a,b){if(!0===b)return b;if(a.copyState)return a.copyState(b);
var c={},d;for(d in b){var f=b[d];f instanceof Array&&(f=f.concat([]));c[d]=f}return c},Af=d.startState=function(a,b,c){return a.startState?a.startState(b,c):!0};d.innerMode=function(a,b){for(;a.innerMode;){var c=a.innerMode(b);if(!c||c.mode==a)break;b=c.state;a=c.mode}return c||{mode:a,state:b}};var Nc=d.commands={selectAll:function(a){a.setSelection(A(a.firstLine(),0),A(a.lastLine()),Da)},singleSelection:function(a){a.setSelection(a.getCursor("anchor"),a.getCursor("head"),Da)},killLine:function(a){zb(a,
function(b){if(b.empty()){var c=D(a.doc,b.head.line).text.length;return b.head.ch==c&&b.head.line<a.lastLine()?{from:b.head,to:A(b.head.line+1,0)}:{from:b.head,to:A(b.head.line,c)}}return{from:b.from(),to:b.to()}})},deleteLine:function(a){zb(a,function(b){return{from:A(b.from().line,0),to:J(a.doc,A(b.to().line+1,0))}})},delLineLeft:function(a){zb(a,function(a){return{from:A(a.from().line,0),to:a.from()}})},delWrappedLineLeft:function(a){zb(a,function(b){var c=a.charCoords(b.head,"div").top+5;return{from:a.coordsChar({left:0,
top:c},"div"),to:b.from()}})},delWrappedLineRight:function(a){zb(a,function(b){var c=a.charCoords(b.head,"div").top+5,c=a.coordsChar({left:a.display.lineDiv.offsetWidth+100,top:c},"div");return{from:b.from(),to:c}})},undo:function(a){a.undo()},redo:function(a){a.redo()},undoSelection:function(a){a.undoSelection()},redoSelection:function(a){a.redoSelection()},goDocStart:function(a){a.extendSelection(A(a.firstLine(),0))},goDocEnd:function(a){a.extendSelection(A(a.lastLine()))},goLineStart:function(a){a.extendSelectionsBy(function(b){return kf(a,
...
"Ctrl-Right":"goGroupRight","Alt-Left":"goLineStart","Alt-Right":"goLineEnd","Ctrl-Backspace":"delGroupBefore","Ctrl-Delete":"delGroupAfter","Ctrl-S":"save","Ctrl-F":"find","Ctrl-G":"findNext","Shift-Ctrl-G":"findPrev","Shift-Ctrl-F":"replace","Shift-Ctrl-R":"replaceAll","Ctrl-[":"indentLess","Ctrl-]":"indentMore","Ctrl-U":"undoSelection","Shift-Ctrl-U":"redoSelection","Alt-U":"redoSelection",fallthrough:"basic"};Ra.emacsy={"Ctrl-F":"goCharRight","Ctrl-B":"goCharLeft","Ctrl-P":"goLineUp","Ctrl-N":"goLineDown",
"Alt-F":"goWordRight","Alt-B":"goWordLeft","Ctrl-A":"goLineStart","Ctrl-E":"goLineEnd","Ctrl-V":"goPageDown","Shift-Ctrl-V":"goPageUp","Ctrl-D":"delCharAfter","Ctrl-H":"delCharBefore","Alt-D":"delWordAfter","Alt-Backspace":"delWordBefore","Ctrl-K":"killLine","Ctrl-T":"transposeChars"};Ra.macDefault={"Cmd-A":"selectAll","Cmd-D":"deleteLine","Cmd-Z":"undo","Shift-Cmd-Z":"redo","Cmd-Y":"redo","Cmd-Home":"goDocStart","Cmd-Up":"goDocStart","Cmd-End":"goDocEnd","Cmd-Down":"goDocEnd","Alt-Left":"goGroupLeft",
...
fallthrough:["basic","emacsy"]};Ra["default"]=sa?Ra.macDefault:Ra.pcDefault;d.normalizeKeyMap=function(a){var b={},c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];if(!/^(name|fallthrough|(de|at)tach)$/.test(c)){if("..."!=d)for(var f=vc(c.split(" "),Tf),g=0;g<f.length;g++){var h,n;g==f.length-1?(n=f.join(" "),h=d):(n=f.slice(0,g+1).join(" "),h="...");var m=b[n];if(!m)b[n]=h;else if(m!=h)throw Error("Inconsistent bindings for "+n);}delete a[c]}}for(var q in b)a[q]=b[q];return a};var cc=d.lookupKey=
function(a,b,c,d){b=Uc(b);var f=b.call?b.call(a,d):b[a];if(!1===f)return"nothing";if("..."===f)return"multi";if(null!=f&&c(f))return"handled";if(b.fallthrough){if("[object Array]"!=Object.prototype.toString.call(b.fallthrough))return cc(a,b.fallthrough,c,d);for(f=0;f<b.fallthrough.length;f++){var g=cc(a,b.fallthrough[f],c,d);if(g)return g}}},Mf=d.isModifierKey=function(a){a="string"==typeof a?a:Sa[a.keyCode];return"Ctrl"==a||"Alt"==a||"Shift"==a||"Mod"==a},Of=d.keyName=function(a,b){if(wa&&34==a.keyCode&&
a["char"])return!1;var c=Sa[a.keyCode],d=c;if(null==d||a.altGraphKey)return!1;a.altKey&&"Alt"!=c&&(d="Alt-"+d);(of?a.metaKey:a.ctrlKey)&&"Ctrl"!=c&&(d="Ctrl-"+d);(of?a.ctrlKey:a.metaKey)&&"Cmd"!=c&&(d="Cmd-"+d);!b&&a.shiftKey&&"Shift"!=c&&(d="Shift-"+d);return d};d.fromTextArea=function(a,b){function c(){a.value=q.getValue()}b=b?ra(b):{};b.value=a.value;!b.tabindex&&a.tabIndex&&(b.tabindex=a.tabIndex);!b.placeholder&&a.placeholder&&(b.placeholder=a.placeholder);if(null==b.autofocus){var f=Ba();b.autofocus=
f==a||null!=a.getAttribute("autofocus")&&f==document.body}if(a.form&&(F(a.form,"submit",c),!b.leaveSubmitMethodAlone)){var g=a.form,h=g.submit;try{var n=g.submit=function(){c();g.submit=h;g.submit();g.submit=n}}catch(m){}}b.finishInit=function(b){b.save=c;b.getTextArea=function(){return a};b.toTextArea=function(){b.toTextArea=isNaN;c();a.parentNode.removeChild(b.getWrapperElement());a.style.display="";a.form&&(Ga(a.form,"submit",c),"function"==typeof a.form.submit&&(a.form.submit=h))}};a.style.display=
"none";var q=d(function(b){a.parentNode.insertBefore(b,a.nextSibling)},b);return q};var Yc=d.StringStream=function(a,b){this.pos=this.start=0;this.string=a;this.tabSize=b||8;this.lineStart=this.lastColumnPos=this.lastColumnValue=0};Yc.prototype={eol:function(){return this.pos>=this.string.length},sol:function(){return this.pos==this.lineStart},peek:function(){return this.string.charAt(this.pos)||void 0},next:function(){if(this.pos<this.string.length)return this.string.charAt(this.pos++)},eat:function(a){var b=
this.string.charAt(this.pos);if("string"==typeof a?b==a:b&&(a.test?a.test(b):a(b)))return++this.pos,b},eatWhile:function(a){for(var b=this.pos;this.eat(a););return this.pos>b},eatSpace:function(){for(var a=this.pos;/[\s\u00a0]/.test(this.string.charAt(this.pos));)++this.pos;return this.pos>a},skipToEnd:function(){this.pos=this.string.length},skipTo:function(a){a=this.string.indexOf(a,this.pos);if(-1<a)return this.pos=a,!0},backUp:function(a){this.pos-=a},column:function(){this.lastColumnPos<this.start&&
(this.lastColumnValue=va(this.string,this.start,this.tabSize,this.lastColumnPos,this.lastColumnValue),this.lastColumnPos=this.start);return this.lastColumnValue-(this.lineStart?va(this.string,this.lineStart,this.tabSize):0)},indentation:function(){return va(this.string,null,this.tabSize)-(this.lineStart?va(this.string,this.lineStart,this.tabSize):0)},match:function(a,b,c){if("string"==typeof a){var d=function(a){return c?a.toLowerCase():a},f=this.string.substr(this.pos,a.length);if(d(f)==d(a))return!1!==
b&&(this.pos+=a.length),!0}else{if((a=this.string.slice(this.pos).match(a))&&0<a.index)return null;a&&!1!==b&&(this.pos+=a[0].length);return a}},current:function(){return this.string.slice(this.start,this.pos)},hideFirstChars:function(a,b){this.lineStart+=a;try{return b()}finally{this.lineStart-=a}}};var Hd=0,hb=d.TextMarker=function(a,b){this.lines=[];this.type=b;this.doc=a;this.id=++Hd};Cb(hb);hb.prototype.clear=function(){if(!this.explicitlyCleared){var a=this.doc.cm,b=a&&!a.curOp;b&&jb(a);if(pa(this,
"clear")){var c=this.find();c&&fa(this,"clear",c.from,c.to)}for(var d=c=null,f=0;f<this.lines.length;++f){var g=this.lines[f],h=ec(g.markedSpans,this);a&&!this.collapsed?La(a,P(g),"text"):a&&(null!=h.to&&(d=P(g)),null!=h.from&&(c=P(g)));for(var n=g,m=g.markedSpans,s=h,t=void 0,r=0;r<m.length;++r)m[r]!=s&&(t||(t=[])).push(m[r]);n.markedSpans=t;null==h.from&&this.collapsed&&!Va(this.doc,g)&&a&&ya(g,Ua(a.display))}if(a&&this.collapsed&&!a.options.lineWrapping)for(f=0;f<this.lines.length;++f)g=Ea(this.lines[f]),
h=q(g),h>a.display.maxLineLength&&(a.display.maxLine=g,a.display.maxLineLength=h,a.display.maxLineChanged=!0);null!=c&&a&&this.collapsed&&ja(a,c,d+1);this.lines.length=0;this.explicitlyCleared=!0;this.atomic&&this.doc.cantEdit&&(this.doc.cantEdit=!1,a&&ge(a.doc));a&&fa(a,"markerCleared",a,this);b&&lb(a);this.parent&&this.parent.clear()}};hb.prototype.find=function(a,b){null==a&&"bookmark"==this.type&&(a=1);for(var c,d,f=0;f<this.lines.length;++f){var g=this.lines[f],h=ec(g.markedSpans,this);if(null!=
h.from&&(c=A(b?g:P(g),h.from),-1==a))return c;if(null!=h.to&&(d=A(b?g:P(g),h.to),1==a))return d}return c&&{from:c,to:d}};hb.prototype.changed=function(){var a=this.find(-1,!0),b=this,c=this.doc.cm;a&&c&&ka(c,function(){var d=a.line,f=P(a.line);if(f=jd(c,f))le(f),c.curOp.selectionChanged=c.curOp.forceUpdate=!0;c.curOp.updateMaxLine=!0;Va(b.doc,d)||null==b.height||(f=b.height,b.height=null,(f=ac(b)-f)&&ya(d,d.height+f))})};hb.prototype.attachLine=function(a){if(!this.lines.length&&this.doc.cm){var b=
this.doc.cm.curOp;b.maybeHiddenMarkers&&-1!=ea(b.maybeHiddenMarkers,this)||(b.maybeUnhiddenMarkers||(b.maybeUnhiddenMarkers=[])).push(this)}this.lines.push(a)};hb.prototype.detachLine=function(a){this.lines.splice(ea(this.lines,a),1);!this.lines.length&&this.doc.cm&&(a=this.doc.cm.curOp,(a.maybeHiddenMarkers||(a.maybeHiddenMarkers=[])).push(this))};var Hd=0,Wc=d.SharedTextMarker=function(a,b){this.markers=a;this.primary=b;for(var c=0;c<a.length;++c)a[c].parent=this};Cb(Wc);Wc.prototype.clear=function(){if(!this.explicitlyCleared){this.explicitlyCleared=
!0;for(var a=0;a<this.markers.length;++a)this.markers[a].clear();fa(this,"clear")}};Wc.prototype.find=function(a,b){return this.primary.find(a,b)};var Xc=d.LineWidget=function(a,b,c){if(c)for(var d in c)c.hasOwnProperty(d)&&(this[d]=c[d]);this.doc=a;this.node=b};Cb(Xc);Xc.prototype.clear=function(){var a=this.doc.cm,b=this.line.widgets,c=this.line,d=P(c);if(null!=d&&b){for(var f=0;f<b.length;++f)b[f]==this&&b.splice(f--,1);b.length||(c.widgets=null);var g=ac(this);ya(c,Math.max(0,c.height-g));a&&
ka(a,function(){var b=-g;Aa(c)<(a.curOp&&a.curOp.scrollTop||a.doc.scrollTop)&&Qc(a,null,b);La(a,d,"widget")})}};Xc.prototype.changed=function(){var a=this.height,b=this.doc.cm,c=this.line;this.height=null;var d=ac(this)-a;d&&(ya(c,c.height+d),b&&ka(b,function(){b.curOp.forceUpdate=!0;Aa(c)<(b.curOp&&b.curOp.scrollTop||b.doc.scrollTop)&&Qc(b,null,d)}))};var fc=d.Line=function(a,b,c){this.text=a;Ue(this,b);this.height=c?c(this):1};Cb(fc);fc.prototype.lineNo=function(){return P(this)};var Zf={},Yf={};
gc.prototype={chunkSize:function(){return this.lines.length},removeInner:function(a,b){for(var c=a,d=a+b;c<d;++c){var f=this.lines[c];this.height-=f.height;var g=f;g.parent=null;Te(g);fa(f,"delete")}this.lines.splice(a,b)},collapse:function(a){a.push.apply(a,this.lines)},insertInner:function(a,b,c){this.height+=c;this.lines=this.lines.slice(0,a).concat(b).concat(this.lines.slice(a));for(a=0;a<b.length;++a)b[a].parent=this},iterN:function(a,b,c){for(b=a+b;a<b;++a)if(c(this.lines[a]))return!0}};hc.prototype=
{chunkSize:function(){return this.size},removeInner:function(a,b){this.size-=b;for(var c=0;c<this.children.length;++c){var d=this.children[c],f=d.chunkSize();if(a<f){var g=Math.min(b,f-a),h=d.height;d.removeInner(a,g);this.height-=h-d.height;f==g&&(this.children.splice(c--,1),d.parent=null);if(0==(b-=g))break;a=0}else a-=f}25>this.size-b&&(1<this.children.length||!(this.children[0]instanceof gc))&&(c=[],this.collapse(c),this.children=[new gc(c)],this.children[0].parent=this)},collapse:function(a){for(var b=
0;b<this.children.length;++b)this.children[b].collapse(a)},insertInner:function(a,b,c){this.size+=b.length;this.height+=c;for(var d=0;d<this.children.length;++d){var f=this.children[d],g=f.chunkSize();if(a<=g){f.insertInner(a,b,c);if(f.lines&&50<f.lines.length){for(;50<f.lines.length;)a=f.lines.splice(f.lines.length-25,25),a=new gc(a),f.height-=a.height,this.children.splice(d+1,0,a),a.parent=this;this.maybeSpill()}break}a-=g}},maybeSpill:function(){if(!(10>=this.children.length)){var a=this;do{var b=
a.children.splice(a.children.length-5,5),b=new hc(b);if(a.parent){a.size-=b.size;a.height-=b.height;var c=ea(a.parent.children,a);a.parent.children.splice(c+1,0,b)}else c=new hc(a.children),c.parent=a,a.children=[c,b],a=c;b.parent=a.parent}while(10<a.children.length);a.parent.maybeSpill()}},iterN:function(a,b,c){for(var d=0;d<this.children.length;++d){var f=this.children[d],g=f.chunkSize();if(a<g){g=Math.min(b,g-a);if(f.iterN(a,g,c))return!0;if(0==(b-=g))break;a=0}else a-=g}}};var lg=0,ia=d.Doc=function(a,
b,c,d){if(!(this instanceof ia))return new ia(a,b,c,d);null==c&&(c=0);hc.call(this,[new gc([new fc("",null)])]);this.first=c;this.scrollTop=this.scrollLeft=0;this.cantEdit=!1;this.cleanGeneration=1;this.frontier=c;c=A(c,0);this.sel=Ca(c);this.history=new Zc(null);this.id=++lg;this.modeOption=b;this.lineSep=d;"string"==typeof a&&(a=this.splitLines(a));Fd(this,{from:c,to:c,text:a});ba(this,Ca(c),Da)};ia.prototype=ff(hc.prototype,{constructor:ia,iter:function(a,b,c){c?this.iterN(a-this.first,b-a,c):
...
Ca(b))}),replaceRange:function(a,b,c,d){b=J(this,b);c=c?J(this,c):b;yb(this,a,b,c,d)},getRange:function(a,b,c){a=cb(this,J(this,a),J(this,b));return!1===c?a:a.join(c||this.lineSeparator())},getLine:function(a){return(a=this.getLineHandle(a))&&a.text},getLineHandle:function(a){if(Xb(this,a))return D(this,a)},getLineNumber:function(a){return P(a)},getLineHandleVisualStart:function(a){"number"==typeof a&&(a=D(this,a));return Ea(a)},lineCount:function(){return this.size},firstLine:function(){return this.first},
lastLine:function(){return this.first+this.size-1},clipPos:function(a){return J(this,a)},getCursor:function(a){var b=this.sel.primary();return null==a||"head"==a?b.head:"anchor"==a?b.anchor:"end"==a||"to"==a||!1===a?b.to():b.from()},listSelections:function(){return this.sel.ranges},somethingSelected:function(){return this.sel.somethingSelected()},setCursor:ga(function(a,b,c){a=J(this,"number"==typeof a?A(a,b||0):a);ba(this,Ca(a,null),c)}),setSelection:ga(function(a,b,c){var d=J(this,a);a=J(this,b||
a);ba(this,Ca(d,a),c)}),extendSelection:ga(function(a,b,c){yc(this,J(this,a),b&&J(this,b),c)}),extendSelections:ga(function(a,b){for(var c=[],d=0;d<a.length;d++)c[d]=J(this,a[d]);ae(this,c)}),extendSelectionsBy:ga(function(a,b){ae(this,vc(this.sel.ranges,a),b)}),setSelections:ga(function(a,b,c){if(a.length){for(var d=0,f=[];d<a.length;d++)f[d]=new Q(J(this,a[d].anchor),J(this,a[d].head));null==b&&(b=Math.min(a.length-1,this.sel.primIndex));ba(this,ua(f,b),c)}}),addSelection:ga(function(a,b,c){var d=
this.sel.ranges.slice(0);d.push(new Q(J(this,a),J(this,b||a)));ba(this,ua(d,d.length-1),c)}),getSelection:function(a){for(var b=this.sel.ranges,c,d=0;d<b.length;d++){var f=cb(this,b[d].from(),b[d].to());c=c?c.concat(f):f}return!1===a?c:c.join(a||this.lineSeparator())},getSelections:function(a){for(var b=[],c=this.sel.ranges,d=0;d<c.length;d++){var f=cb(this,c[d].from(),c[d].to());!1!==a&&(f=f.join(a||this.lineSeparator()));b[d]=f}return b},replaceSelection:function(a,b,c){for(var d=[],f=0;f<this.sel.ranges.length;f++)d[f]=
a;this.replaceSelections(d,b,c||"+input")},replaceSelections:ga(function(a,b,c){for(var d=[],f=this.sel,g=0;g<f.ranges.length;g++){var h=f.ranges[g];d[g]={from:h.from(),to:h.to(),text:this.splitLines(a[g]),origin:c}}if(g=b&&"end"!=b){g=[];c=a=A(this.first,0);for(f=0;f<d.length;f++){var n=d[f],h=Ee(n.from,a,c),m=Ee(fb(n),a,c);a=n.to;c=m;"around"==b?(n=this.sel.ranges[f],n=0>K(n.head,n.anchor),g[f]=new Q(n?m:h,n?h:m)):g[f]=new Q(h,h)}g=new Ja(g,this.sel.primIndex)}b=g;for(g=d.length-1;0<=g;g--)rb(this,
d[g]);b?be(this,b):this.cm&&sb(this.cm)}),undo:ga(function(){Pc(this,"undo")}),redo:ga(function(){Pc(this,"redo")}),undoSelection:ga(function(){Pc(this,"undo",!0)}),redoSelection:ga(function(){Pc(this,"redo",!0)}),setExtending:function(a){this.extend=a},getExtending:function(){return this.extend},historySize:function(){for(var a=this.history,b=0,c=0,d=0;d<a.done.length;d++)a.done[d].ranges||++b;for(d=0;d<a.undone.length;d++)a.undone[d].ranges||++c;return{undo:b,redo:c}},clearHistory:function(){this.history=
...
null,!0);b.undone=Bb(a.undone.slice(0),null,!0)},addLineClass:ga(function(a,b,c){return Sc(this,a,"gutter"==b?"gutter":"class",function(a){var d="text"==b?"textClass":"background"==b?"bgClass":"gutter"==b?"gutterClass":"wrapClass";if(a[d]){if(kc(c).test(a[d]))return!1;a[d]+=" "+c}else a[d]=c;return!0})}),removeLineClass:ga(function(a,b,c){return Sc(this,a,"gutter"==b?"gutter":"class",function(a){var d="text"==b?"textClass":"background"==b?"bgClass":"gutter"==b?"gutterClass":"wrapClass",f=a[d];if(f)if(null==
c)a[d]=null;else{var g=f.match(kc(c));if(!g)return!1;var h=g.index+g[0].length;a[d]=f.slice(0,g.index)+(g.index&&h!=f.length?" ":"")+f.slice(h)||null}else return!1;return!0})}),addLineWidget:ga(function(a,b,c){return Xf(this,a,b,c)}),removeLineWidget:function(a){a.clear()},markText:function(a,b,c){return Ab(this,J(this,a),J(this,b),c,"range")},setBookmark:function(a,b){var c={replacedWith:b&&(null==b.nodeType?b.widget:b),insertLeft:b&&b.insertLeft,clearWhenEmpty:!1,shared:b&&b.shared,handleMouseEvents:b&&
b.handleMouseEvents};a=J(this,a);return Ab(this,a,a,c,"bookmark")},findMarksAt:function(a){a=J(this,a);var b=[],c=D(this,a.line).markedSpans;if(c)for(var d=0;d<c.length;++d){var f=c[d];(null==f.from||f.from<=a.ch)&&(null==f.to||f.to>=a.ch)&&b.push(f.marker.parent||f.marker)}return b},findMarks:function(a,b,c){a=J(this,a);b=J(this,b);var d=[],f=a.line;this.iter(a.line,b.line+1,function(g){if(g=g.markedSpans)for(var h=0;h<g.length;h++){var n=g[h];f==a.line&&a.ch>n.to||null==n.from&&f!=a.line||f==b.line&&
n.from>b.ch||c&&!c(n.marker)||d.push(n.marker.parent||n.marker)}++f});return d},getAllMarks:function(){var a=[];this.iter(function(b){if(b=b.markedSpans)for(var c=0;c<b.length;++c)null!=b[c].from&&a.push(b[c].marker)});return a},posFromIndex:function(a){var b,c=this.first;this.iter(function(d){d=d.text.length+1;if(d>a)return b=a,!0;a-=d;++c});return J(this,A(c,b))},indexFromPos:function(a){a=J(this,a);var b=a.ch;if(a.line<this.first||0>a.ch)return 0;this.iter(this.first,a.line,function(a){b+=a.text.length+
...
(b.history=this.history);(this.linked||(this.linked=[])).push({doc:b,sharedHist:a.sharedHist});b.linked=[{doc:this,isParent:!0,sharedHist:a.sharedHist}];a=Re(this);for(c=0;c<a.length;c++){var d=a[c],f=d.find(),g=b.clipPos(f.from),f=b.clipPos(f.to);K(g,f)&&(g=Ab(b,g,f,d.primary,d.primary.type),d.markers.push(g),g.parent=d)}return b},unlinkDoc:function(a){a instanceof d&&(a=a.doc);if(this.linked)for(var b=0;b<this.linked.length;++b)if(this.linked[b].doc==a){this.linked.splice(b,1);a.unlinkDoc(this);
Vf(Re(this));break}if(a.history==this.history){var c=[a.id];gb(a,function(a){c.push(a.id)},!0);a.history=new Zc(null);a.history.done=Bb(this.history.done,c);a.history.undone=Bb(this.history.undone,c)}},iterLinkedDocs:function(a){gb(this,a)},getMode:function(){return this.mode},getEditor:function(){return this.cm},splitLines:function(a){return this.lineSep?a.split(this.lineSep):mg(a)},lineSeparator:function(){return this.lineSep||"\n"}});ia.prototype.eachLine=ia.prototype.iter;var ng="iter insert remove copy getEditor constructor".split(" "),
pc;for(pc in ia.prototype)ia.prototype.hasOwnProperty(pc)&&0>ea(ng,pc)&&(d.prototype[pc]=function(a){return function(){return a.apply(this.doc,arguments)}}(ia.prototype[pc]));Cb(ia);var ha=d.e_preventDefault=function(a){a.preventDefault?a.preventDefault():a.returnValue=!1},og=d.e_stopPropagation=function(a){a.stopPropagation?a.stopPropagation():a.cancelBubble=!0},yd=d.e_stop=function(a){ha(a);og(a)},F=d.on=function(a,b,c){a.addEventListener?a.addEventListener(b,c,!1):a.attachEvent?a.attachEvent("on"+
b,c):(a=a._handlers||(a._handlers={}),(a[b]||(a[b]=[])).push(c))},Ga=d.off=function(a,b,c){if(a.removeEventListener)a.removeEventListener(b,c,!1);else if(a.detachEvent)a.detachEvent("on"+b,c);else if(a=a._handlers&&a._handlers[b])for(b=0;b<a.length;++b)if(a[b]==c){a.splice(b,1);break}},X=d.signal=function(a,b){var c=a._handlers&&a._handlers[b];if(c)for(var d=Array.prototype.slice.call(arguments,2),f=0;f<c.length;++f)c[f].apply(null,d)},ic=null,Sd=30,Ae=d.Pass={toString:function(){return"CodeMirror.Pass"}},
Da={scroll:!1},zd={origin:"*mouse"},lc={origin:"+move"};Gb.prototype.set=function(a,b){clearTimeout(this.id);this.id=setTimeout(b,a)};var va=d.countColumn=function(a,b,c,d,f){null==b&&(b=a.search(/[^\s\u00a0]/),-1==b&&(b=a.length));d=d||0;for(f=f||0;;){var g=a.indexOf("\t",d);if(0>g||g>=b)return f+(b-d);f+=g-d;f+=c-f%c;d=g+1}},$c=[""],Db=function(a){a.select()};tb?Db=function(a){a.selectionStart=0;a.selectionEnd=a.value.length}:M&&(Db=function(a){try{a.select()}catch(b){}});var pg=/[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/,
gf=d.isWordChar=function(a){return/\w/.test(a)||"\u0080"<a&&(a.toUpperCase()!=a.toLowerCase()||pg.test(a))},fg=/[\u0300-\u036f\u0483-\u0489\u0591-\u05bd\u05bf\u05c1\u05c2\u05c4\u05c5\u05c7\u0610-\u061a\u064b-\u065e\u0670\u06d6-\u06dc\u06de-\u06e4\u06e7\u06e8\u06ea-\u06ed\u0711\u0730-\u074a\u07a6-\u07b0\u07eb-\u07f3\u0816-\u0819\u081b-\u0823\u0825-\u0827\u0829-\u082d\u0900-\u0902\u093c\u0941-\u0948\u094d\u0951-\u0955\u0962\u0963\u0981\u09bc\u09be\u09c1-\u09c4\u09cd\u09d7\u09e2\u09e3\u0a01\u0a02\u0a3c\u0a41\u0a42\u0a47\u0a48\u0a4b-\u0a4d\u0a51\u0a70\u0a71\u0a75\u0a81\u0a82\u0abc\u0ac1-\u0ac5\u0ac7\u0ac8\u0acd\u0ae2\u0ae3\u0b01\u0b3c\u0b3e\u0b3f\u0b41-\u0b44\u0b4d\u0b56\u0b57\u0b62\u0b63\u0b82\u0bbe\u0bc0\u0bcd\u0bd7\u0c3e-\u0c40\u0c46-\u0c48\u0c4a-\u0c4d\u0c55\u0c56\u0c62\u0c63\u0cbc\u0cbf\u0cc2\u0cc6\u0ccc\u0ccd\u0cd5\u0cd6\u0ce2\u0ce3\u0d3e\u0d41-\u0d44\u0d4d\u0d57\u0d62\u0d63\u0dca\u0dcf\u0dd2-\u0dd4\u0dd6\u0ddf\u0e31\u0e34-\u0e3a\u0e47-\u0e4e\u0eb1\u0eb4-\u0eb9\u0ebb\u0ebc\u0ec8-\u0ecd\u0f18\u0f19\u0f35\u0f37\u0f39\u0f71-\u0f7e\u0f80-\u0f84\u0f86\u0f87\u0f90-\u0f97\u0f99-\u0fbc\u0fc6\u102d-\u1030\u1032-\u1037\u1039\u103a\u103d\u103e\u1058\u1059\u105e-\u1060\u1071-\u1074\u1082\u1085\u1086\u108d\u109d\u135f\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17b7-\u17bd\u17c6\u17c9-\u17d3\u17dd\u180b-\u180d\u18a9\u1920-\u1922\u1927\u1928\u1932\u1939-\u193b\u1a17\u1a18\u1a56\u1a58-\u1a5e\u1a60\u1a62\u1a65-\u1a6c\u1a73-\u1a7c\u1a7f\u1b00-\u1b03\u1b34\u1b36-\u1b3a\u1b3c\u1b42\u1b6b-\u1b73\u1b80\u1b81\u1ba2-\u1ba5\u1ba8\u1ba9\u1c2c-\u1c33\u1c36\u1c37\u1cd0-\u1cd2\u1cd4-\u1ce0\u1ce2-\u1ce8\u1ced\u1dc0-\u1de6\u1dfd-\u1dff\u200c\u200d\u20d0-\u20f0\u2cef-\u2cf1\u2de0-\u2dff\u302a-\u302f\u3099\u309a\ua66f-\ua672\ua67c\ua67d\ua6f0\ua6f1\ua802\ua806\ua80b\ua825\ua826\ua8c4\ua8e0-\ua8f1\ua926-\ua92d\ua947-\ua951\ua980-\ua982\ua9b3\ua9b6-\ua9b9\ua9bc\uaa29-\uaa2e\uaa31\uaa32\uaa35\uaa36\uaa43\uaa4c\uaab0\uaab2-\uaab4\uaab7\uaab8\uaabe\uaabf\uaac1\uabe5\uabe8\uabed\udc00-\udfff\ufb1e\ufe00-\ufe0f\ufe20-\ufe26\uff9e\uff9f]/,
...
f.eatSpace(),r(g);if("["===f.peek())return a(f,g,u);if(f.match(gd,!0))return g.hr=!0,Qb;if((!g.prevLineHasContent||m)&&(f.match(Ub,!1)||f.match(Vb,!1)))return n=null,f.match(Ub,!0)?n="ul":(f.match(Vb,!0),n="ol"),g.indentation+=4,g.list=!0,g.listDepth++,c.taskLists&&f.match(ob,!1)&&(g.taskList=!0),g.f=g.inline,c.highlightFormatting&&(g.formatting=["list","list-"+n]),r(g);if(c.fencedCodeBlocks&&f.match(/^```[ \t]*([\w+#]*)/,!0))return n=RegExp.$1,d.findModeByName&&(m=d.findModeByName(n))&&(n=m.mime||
m.mimes[0]),n=d.getMode(b,n),g.localMode="null"==n.name?null:n,g.localMode&&(g.localState=g.localMode.startState()),g.f=g.block=h,c.highlightFormatting&&(g.formatting="code-block"),g.code=!0,r(g)}else return g.header="="==s[0].charAt(0)?1:2,c.highlightFormatting&&(g.formatting="header"),g.f=g.inline,r(g);return a(f,g,g.inline)}function m(a,b){var c=H.token(a,b.htmlState);if(C&&null===b.htmlState.tagStart&&!b.htmlState.context||b.md_inside&&-1<a.current().indexOf(">"))b.f=t,b.block=g,b.htmlState=null;
return c}function h(a,b){if(a.sol()&&a.match("```",!1))return b.localMode=b.localState=null,b.f=b.block=n,null;if(b.localMode)return b.localMode.token(a,b.localState);a.skipToEnd();return S}function n(a,b){a.match("```");b.block=g;b.f=t;c.highlightFormatting&&(b.formatting="code-block");b.code=!0;var d=r(b);b.code=!1;return d}function r(a){var b=[];if(a.formatting){b.push(ab);"string"===typeof a.formatting&&(a.formatting=[a.formatting]);for(var d=0;d<a.formatting.length;d++)b.push(ab+"-"+a.formatting[d]),
"header"===a.formatting[d]&&b.push(ab+"-"+a.formatting[d]+"-"+a.header),"quote"===a.formatting[d]&&(!c.maxBlockquoteDepth||c.maxBlockquoteDepth>=a.quote?b.push(ab+"-"+a.formatting[d]+"-"+a.quote):b.push("error"))}if(a.taskOpen)return b.push("meta"),b.length?b.join(" "):null;if(a.taskClosed)return b.push("property"),b.length?b.join(" "):null;if(a.linkHref)return b.push(Ia),b.length?b.join(" "):null;a.strong&&b.push(Tb);a.em&&b.push(sc);a.strikethrough&&b.push(tc);a.linkText&&b.push(Sb);a.code&&b.push(S);
a.header&&(b.push(E),b.push(E+"-"+a.header));a.quote&&(b.push(T),!c.maxBlockquoteDepth||c.maxBlockquoteDepth>=a.quote?b.push(T+"-"+a.quote):b.push(T+"-"+c.maxBlockquoteDepth));!1!==a.list&&((d=(a.listDepth-1)%3)?1===d?b.push(Ha):b.push(Rb):b.push(U));a.trailingSpaceNewLine?b.push("trailing-space-new-line"):a.trailingSpace&&b.push("trailing-space-"+(a.trailingSpace%2?"a":"b"));return b.length?b.join(" "):null}function q(a,b){if(a.match(uc,!0))return r(b)}function t(a,b){var f=b.text(a,b);if("undefined"!==
typeof f)return f;if(b.list)return b.list=null,r(b);if(b.taskList)return"x"!==a.match(ob,!0)[1]?b.taskOpen=!0:b.taskClosed=!0,c.highlightFormatting&&(b.formatting="task"),b.taskList=!1,r(b);b.taskOpen=!1;b.taskClosed=!1;if(b.header&&a.match(/^#+$/,!0))return c.highlightFormatting&&(b.formatting="header"),r(b);var f=a.sol(),g=a.next();if("\\"===g&&(a.next(),c.highlightFormatting))return(f=r(b))?f+" formatting-escape":"formatting-escape";if(b.linkTitle){b.linkTitle=!1;var h=g;"("===g&&(h=")");h=(h+
"").replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1");if(a.match(new RegExp("^\\s*(?:[^"+h+"\\\\]+|\\\\\\\\|\\\\.)"+h),!0))return Ia}if("`"===g){f=b.formatting;c.highlightFormatting&&(b.formatting="code");g=r(b);h=a.pos;a.eatWhile("`");h=1+a.pos-h;if(b.code){if(h===L)return b.code=!1,g;b.formatting=f}else L=h,b.code=!0;return r(b)}if(b.code)return r(b);if("!"===g&&a.match(/\[[^\]]*\] ?(?:\(|\[)/,!1))return a.match(/\[[^\]]*\]/),b.inline=b.f=z,nb;if("["===g&&a.match(/.*\](\(.*\)| ?\[.*\])/,!1))return b.linkText=
!0,c.highlightFormatting&&(b.formatting="link"),r(b);if("]"===g&&b.linkText&&a.match(/\(.*\)| ?\[.*\]/,!1))return c.highlightFormatting&&(b.formatting="link"),f=r(b),b.linkText=!1,b.inline=b.f=z,f;if("<"===g&&a.match(/^(https?|ftps?):\/\/(?:[^\\>]|\\.)+>/,!1))return b.f=b.inline=x,c.highlightFormatting&&(b.formatting="link"),f=r(b),(f?f+" ":"")+Za;if("<"===g&&a.match(/^[^> \\]+@(?:[^\\>]|\\.)+>/,!1))return b.f=b.inline=x,c.highlightFormatting&&(b.formatting="link"),f=(f=r(b))?f+" ":"",f+ed;if("<"===
g&&a.match(/^\w/,!1))return-1!=a.string.indexOf(">")&&(f=a.string.substring(1,a.string.indexOf(">")),/markdown\s*=\s*('|"){0,1}1('|"){0,1}/.test(f)&&(b.md_inside=!0)),a.backUp(1),b.htmlState=d.startState(H),f=m,b.f=b.block=f,f(a,b);if("<"===g&&a.match(/^\/\w*?>/))return b.md_inside=!1,"tag";h=!1;if(!c.underscoresBreakWords&&"_"===g&&"_"!==a.peek()&&a.match(/(\w)/,!1)){var n=a.pos-2;0<=n&&(n=a.string.charAt(n),"_"!==n&&n.match(/(\w)/,!1)&&(h=!0))}if("*"===g||"_"===g&&!h){if(!f||" "!==a.peek()){if(b.strong===
g&&a.eat(g))return c.highlightFormatting&&(b.formatting="strong"),g=r(b),b.strong=!1,g;if(!b.strong&&a.eat(g))return b.strong=g,c.highlightFormatting&&(b.formatting="strong"),r(b);if(b.em===g)return c.highlightFormatting&&(b.formatting="em"),g=r(b),b.em=!1,g;if(!b.em)return b.em=g,c.highlightFormatting&&(b.formatting="em"),r(b)}}else if(" "===g&&(a.eat("*")||a.eat("_"))){if(" "===a.peek())return r(b);a.backUp(1)}if(c.strikethrough)if("~"===g&&a.eatWhile(g)){if(b.strikethrough)return c.highlightFormatting&&
(b.formatting="strikethrough"),g=r(b),b.strikethrough=!1,g;if(a.match(/^[^\s]/,!1))return b.strikethrough=!0,c.highlightFormatting&&(b.formatting="strikethrough"),r(b)}else if(" "===g&&a.match(/^~~/,!0)){if(" "===a.peek())return r(b);a.backUp(2)}" "===g&&(a.match(/ +$/,!1)?b.trailingSpace++:b.trailingSpace&&(b.trailingSpaceNewLine=!0));return r(b)}function x(a,b){if(">"===a.next()){b.f=b.inline=t;c.highlightFormatting&&(b.formatting="link");var d=r(b);return(d?d+" ":"")+Za}a.match(/^[^>]+/,!0);return Za}
function z(a,b){if(a.eatSpace())return null;var d=a.next();return"("===d||"["===d?(b.f=b.inline=v("("===d?")":"]"),c.highlightFormatting&&(b.formatting="link-string"),b.linkHref=!0,r(b)):"error"}function v(a){return function(b,d){if(b.next()===a){d.f=d.inline=t;c.highlightFormatting&&(d.formatting="link-string");var f=r(d);d.linkHref=!1;return f}b.match(G(a),!0)&&b.backUp(1);d.linkHref=!0;return r(d)}}function u(b,d){return b.match(/^[^\]]*\]:/,!1)?(d.f=s,b.next(),c.highlightFormatting&&(d.formatting=
"link"),d.linkText=!0,r(d)):a(b,d,t)}function s(a,b){if(a.match(/^\]:/,!0)){b.f=b.inline=w;c.highlightFormatting&&(b.formatting="link");var d=r(b);b.linkText=!1;return d}a.match(/^[^\]]+/,!0);return Sb}function w(a,b){if(a.eatSpace())return null;a.match(/^[^\s]+/,!0);void 0===a.peek()?b.linkTitle=!0:a.match(/^(?:\s+(?:"(?:[^"\\]|\\\\|\\.)+"|'(?:[^'\\]|\\\\|\\.)+'|\((?:[^)\\]|\\\\|\\.)+\)))?/,!0);b.f=b.inline=t;return Ia}function G(a){Qa[a]||(a=(a+"").replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1"),Qa[a]=
new RegExp("^(?:[^\\\\]|\\\\.)*?("+a+")"));return Qa[a]}var C=d.modes.hasOwnProperty("xml"),H=d.getMode(b,C?{name:"xml",htmlMode:!0}:"text/plain");void 0===c.highlightFormatting&&(c.highlightFormatting=!1);void 0===c.maxBlockquoteDepth&&(c.maxBlockquoteDepth=0);void 0===c.underscoresBreakWords&&(c.underscoresBreakWords=!0);void 0===c.fencedCodeBlocks&&(c.fencedCodeBlocks=!1);void 0===c.taskLists&&(c.taskLists=!1);void 0===c.strikethrough&&(c.strikethrough=!1);var L=0,E="header",S="comment",T="quote",
U="variable-2",Ha="variable-3",Rb="keyword",Qb="hr",nb="tag",ab="formatting",Za="link",ed="link",Sb="link",Ia="string",sc="em",Tb="strong",tc="strikethrough",gd=/^([*\-_])(?:\s*\1){2,}\s*$/,Ub=/^[*\-+]\s+/,Vb=/^[0-9]+([.)])\s+/,ob=/^\[(x| )\](?=\s)/,pb=/^(#+)(?: |$)/,qb=/^ *(?:\={1,}|-{1,})\s*$/,uc=/^[^#!\[\]*_\\<>` "'(~]+/,Qa=[],bb={startState:function(){return{f:g,prevLineHasContent:!1,thisLineHasContent:!1,block:g,htmlState:null,indentation:0,inline:t,text:q,formatting:!1,linkText:!1,linkHref:!1,
linkTitle:!1,em:!1,strong:!1,header:0,hr:!1,taskList:!1,list:!1,listDepth:0,quote:0,trailingSpace:0,trailingSpaceNewLine:!1,strikethrough:!1}},copyState:function(a){return{f:a.f,prevLineHasContent:a.prevLineHasContent,thisLineHasContent:a.thisLineHasContent,block:a.block,htmlState:a.htmlState&&d.copyState(H,a.htmlState),indentation:a.indentation,localMode:a.localMode,localState:a.localMode?d.copyState(a.localMode,a.localState):null,inline:a.inline,text:a.text,formatting:!1,linkTitle:a.linkTitle,em:a.em,
...
"editorRich":"editorCode";b={eddata:"virtualclass-editor-operation",data:JSON.stringify({revision:b,operation:c,cursor:a}),et:g};io.send(b);console.log("send operation")};d.prototype.sendSelection=function(b){io.send({eddata:"selection",data:JSON.stringify(b)})};d.prototype.sendCursor=function(b){io.send({eddata:"virtualclass-editor-cursor",data:JSON.stringify(b)})};d.prototype.registerCallbacks=function(b){this.callbacks=b};return d}();var Vceditor=function(){var d=d||{};d.utils={};d.utils.makeEventEmitter=function(a,b){a.prototype.allowedEvents_=b;a.prototype.on=function(a,b,c){this.validateEventType_(a);this.eventListeners_=this.eventListeners_||{};this.eventListeners_[a]=this.eventListeners_[a]||[];this.eventListeners_[a].push({callback:b,context:c})};a.prototype.off=function(a,b){this.validateEventType_(a);this.eventListeners_=this.eventListeners_||{};for(var c=this.eventListeners_[a]||[],d=0;d<c.length;d++)if(c[d].callback===
b){c.splice(d,1);break}};a.prototype.trigger=function(a){this.eventListeners_=this.eventListeners_||{};for(var b=this.eventListeners_[a]||[],c=0;c<b.length;c++)b[c].callback.apply(b[c].context,Array.prototype.slice.call(arguments,1))};a.prototype.validateEventType_=function(a){if(this.allowedEvents_){for(var b=!1,c=0;c<this.allowedEvents_.length;c++)if(this.allowedEvents_[c]===a){b=!0;break}if(!b)throw Error('Unknown event "'+a+'"');}}};d.utils.elt=function(a,b,c){a=document.createElement(a);if("string"===
typeof b)d.utils.setTextContent(a,b);else if(b)for(var m=0;m<b.length;++m)a.appendChild(b[m]);for(var h in c||{})a.setAttribute(h,c[h]);return a};d.utils.setTextContent=function(a,b){a.innerHTML="";a.appendChild(document.createTextNode(b))};d.utils.on=function(a,b,c,d){a.addEventListener?a.addEventListener(b,c,d||!1):a.attachEvent&&a.attachEvent("on"+b,c)};d.utils.off=function(a,b,c,d){a.removeEventListener?a.removeEventListener(b,c,d||!1):a.detachEvent&&a.detachEvent("on"+b,c)};d.utils.preventDefault=
function(a){a.preventDefault?a.preventDefault():a.returnValue=!1};d.utils.stopPropagation=function(a){a.stopPropagation?a.stopPropagation():a.cancelBubble=!0};d.utils.stopEvent=function(a){d.utils.preventDefault(a);d.utils.stopPropagation(a)};d.utils.stopEventAnd=function(a){return function(b){a(b);d.utils.stopEvent(b);return!1}};d.utils.trim=function(a){return a.replace(/^\s+/g,"").replace(/\s+$/g,"")};d.utils.stringEndsWith=function(a,b){for(var c="string"==typeof b?[b]:b,d=0;d<c.length;d++)if(b=
c[d],-1!==a.indexOf(b,a.length-b.length))return!0;return!1};d.utils.assert=function(a,b){if(!a)throw Error(b||"assertion error");};d.utils.log=function(){if("undefined"!==typeof console&&"undefined"!==typeof console.log){for(var a=["Vceditor:"],b=0;b<arguments.length;b++)a.push(arguments[b]);console.log.apply(console,a)}};d=d||{};d.Span=function(){function a(a,b){this.pos=a;this.length=b}a.prototype.end=function(){return this.pos+this.length};return a}();d=d||{};d.TextOp=function(){function a(a,c,
d){this.type=a;this.attributes=this.text=this.chars=null;"insert"===a?(this.text=c,b.assert("string"===typeof this.text),this.attributes=d||{},b.assert("object"===typeof this.attributes)):"delete"===a?(this.chars=c,b.assert("number"===typeof this.chars)):"retain"===a&&(this.chars=c,b.assert("number"===typeof this.chars),this.attributes=d||{},b.assert("object"===typeof this.attributes))}var b=d.utils;a.prototype.isInsert=function(){return"insert"===this.type};a.prototype.isDelete=function(){return"delete"===
this.type};a.prototype.isRetain=function(){return"retain"===this.type};a.prototype.equals=function(a){return this.type===a.type&&this.text===a.text&&this.chars===a.chars&&this.attributesEqual(a.attributes)};a.prototype.attributesEqual=function(a){for(var b in this.attributes)if(this.attributes[b]!==a[b])return!1;for(b in a)if(this.attributes[b]!==a[b])return!1;return!0};a.prototype.hasEmptyAttributes=function(){var a=!0,b;for(b in this.attributes){a=!1;break}return a};return a}();d=d||{};d.TextOperation=
function(){function a(){if(!this||this.constructor!==a)return new a;this.ops=[];this.targetLength=this.baseLength=0}function b(a){a=a.ops;switch(a.length){case 1:return a[0];case 2:return a[0].isRetain()?a[1]:a[1].isRetain()?a[0]:null;case 3:if(a[0].isRetain()&&a[2].isRetain())return a[1]}return null}function c(a){return a.ops[0].isRetain()?a.ops[0].chars:0}var m=d.TextOp,h=d.utils;a.prototype.equals=function(a){if(this.baseLength!==a.baseLength||this.targetLength!==a.targetLength||this.ops.length!==
a.ops.length)return!1;for(var b=0;b<this.ops.length;b++)if(!this.ops[b].equals(a.ops[b]))return!1;return!0};a.prototype.retain=function(a,b){if("number"!==typeof a||0>a)throw Error("retain expects a positive integer.");if(0===a)return this;this.baseLength+=a;this.targetLength+=a;b=b||{};var c=0<this.ops.length?this.ops[this.ops.length-1]:null;c&&c.isRetain()&&c.attributesEqual(b)?c.chars+=a:this.ops.push(new m("retain",a,b));return this};a.prototype.insert=function(a,b){if("string"!==typeof a)throw Error("insert expects a string");
if(""===a)return this;b=b||{};this.targetLength+=a.length;var c=0<this.ops.length?this.ops[this.ops.length-1]:null,d=1<this.ops.length?this.ops[this.ops.length-2]:null;c&&c.isInsert()&&c.attributesEqual(b)?c.text+=a:c&&c.isDelete()?d&&d.isInsert()&&d.attributesEqual(b)?d.text+=a:(this.ops[this.ops.length-1]=new m("insert",a,b),this.ops.push(c)):this.ops.push(new m("insert",a,b));return this};a.prototype["delete"]=function(a){"string"===typeof a&&(a=a.length);if("number"!==typeof a||0>a)throw Error("delete expects a positive integer or a string");
if(0===a)return this;this.baseLength+=a;var b=0<this.ops.length?this.ops[this.ops.length-1]:null;b&&b.isDelete()?b.chars+=a:this.ops.push(new m("delete",a));return this};a.prototype.isNoop=function(){return 0===this.ops.length||1===this.ops.length&&this.ops[0].isRetain()&&this.ops[0].hasEmptyAttributes()};a.prototype.clone=function(){for(var b=new a,c=0;c<this.ops.length;c++)if(this.ops[c].isRetain())b.retain(this.ops[c].chars,this.ops[c].attributes);else if(this.ops[c].isInsert())b.insert(this.ops[c].text,
this.ops[c].attributes);else b["delete"](this.ops[c].chars);return b};a.prototype.toString=function(){return(Array.prototype.map||function(a){for(var b=[],c=0,d=this.length;c<d;c++)b[c]=a(this[c]);return b}).call(this.ops,function(a){return a.isRetain()?"retain "+a.chars:a.isInsert()?"insert '"+a.text+"'":"delete "+a.chars}).join(", ")};a.prototype.toJSON=function(){for(var a=[],b=0;b<this.ops.length;b++)this.ops[b].hasEmptyAttributes()||a.push(this.ops[b].attributes),"retain"===this.ops[b].type?
a.push(this.ops[b].chars):"insert"===this.ops[b].type?a.push(this.ops[b].text):"delete"===this.ops[b].type&&a.push(-this.ops[b].chars);0===a.length&&a.push(0);return a};a.fromJSON=function(b){for(var c=new a,d=0,f=b.length;d<f;d++){var g=b[d],m={};"object"===typeof g&&(m=g,d++,g=b[d]);if("number"===typeof g)if(0<g)c.retain(g,m);else c["delete"](-g);else h.assert("string"===typeof g),c.insert(g,m)}return c};a.prototype.apply=function(a,b,c){b=b||[];c=c||[];if(a.length!==this.baseLength)throw Error("The operation's base length must be equal to the string's length.");
for(var d=[],f=0,g,m,u=0,s=this.ops,w=0,G=s.length;w<G;w++){var C=s[w];if(C.isRetain()){if(u+C.chars>a.length)throw Error("Operation can't retain more characters than are left in the string.");d[f++]=a.slice(u,u+C.chars);for(g=0;g<C.chars;g++){var H=b[u+g]||{},L={};for(m in H)L[m]=H[m],h.assert(!1!==L[m]);for(m in C.attributes)!1===C.attributes[m]?delete L[m]:L[m]=C.attributes[m],h.assert(!1!==L[m]);c.push(L)}u+=C.chars}else if(C.isInsert())for(d[f++]=C.text,g=0;g<C.text.length;g++){H={};for(m in C.attributes)H[m]=
C.attributes[m],h.assert(!1!==H[m]);c.push(H)}else u+=C.chars}if(u!==a.length)throw Error("The operation didn't operate on the whole string.");a=d.join("");h.assert(a.length===c.length);return a};a.prototype.invert=function(b){for(var c=0,d=new a,f=this.ops,g=0,h=f.length;g<h;g++){var m=f[g];if(m.isRetain())d.retain(m.chars),c+=m.chars;else if(m.isInsert())d["delete"](m.text.length);else d.insert(b.slice(c,c+m.chars)),c+=m.chars}return d};a.prototype.compose=function(b){function c(a,b,d){var f={},
g;for(g in a)f[g]=a[g];for(g in b)d&&!1===b[g]?delete f[g]:f[g]=b[g];return f}if(this.targetLength!==b.baseLength)throw Error("The base length of the second operation has to be the target length of the first operation");var d=new a,f=this.clone().ops;b=b.clone().ops;for(var g=0,h=0,m=f[g++],u=b[h++],s;"undefined"!==typeof m||"undefined"!==typeof u;)if(m&&m.isDelete())d["delete"](m.chars),m=f[g++];else if(u&&u.isInsert())d.insert(u.text,u.attributes),u=b[h++];else{if("undefined"===typeof m)throw Error("Cannot compose operations: first operation is too short.");
if("undefined"===typeof u)throw Error("Cannot compose operations: first operation is too long.");if(m.isRetain()&&u.isRetain())s=c(m.attributes,u.attributes),m.chars>u.chars?(d.retain(u.chars,s),m.chars-=u.chars,u=b[h++]):m.chars===u.chars?(d.retain(m.chars,s),m=f[g++],u=b[h++]):(d.retain(m.chars,s),u.chars-=m.chars,m=f[g++]);else if(m.isInsert()&&u.isDelete())m.text.length>u.chars?(m.text=m.text.slice(u.chars),u=b[h++]):m.text.length===u.chars?(m=f[g++],u=b[h++]):(u.chars-=m.text.length,m=f[g++]);
else if(m.isInsert()&&u.isRetain())s=c(m.attributes,u.attributes,!0),m.text.length>u.chars?(d.insert(m.text.slice(0,u.chars),s),m.text=m.text.slice(u.chars),u=b[h++]):m.text.length===u.chars?(d.insert(m.text,s),m=f[g++],u=b[h++]):(d.insert(m.text,s),u.chars-=m.text.length,m=f[g++]);else if(m.isRetain()&&u.isDelete())m.chars>u.chars?(d["delete"](u.chars),m.chars-=u.chars,u=b[h++]):m.chars===u.chars?(d["delete"](u.chars),m=f[g++],u=b[h++]):(d["delete"](m.chars),u.chars-=m.chars,m=f[g++]);else throw Error("This shouldn't happen: op1: "+
JSON.stringify(m)+", op2: "+JSON.stringify(u));}return d};a.prototype.shouldBeComposedWith=function(a){if(this.isNoop()||a.isNoop())return!0;var d=c(this),h=c(a),m=b(this);a=b(a);return m&&a?m.isInsert()&&a.isInsert()?d+m.text.length===h:m.isDelete()&&a.isDelete()?h+a.chars===d||d===h:!1:!1};a.prototype.shouldBeComposedWithInverted=function(a){if(this.isNoop()||a.isNoop())return!0;var d=c(this),h=c(a),m=b(this);a=b(a);return m&&a?m.isInsert()&&a.isInsert()?d+m.text.length===h||d===h:m.isDelete()&&
a.isDelete()?h+a.chars===d:!1:!1};a.transformAttributes=function(a,b){var c={},d={},f,g={};for(f in a)g[f]=!0;for(f in b)g[f]=!0;for(f in g){var g=a[f],m=b[f];h.assert(null!=g||null!=m);null==g?d[f]=m:null==m?c[f]=g:g!==m&&(c[f]=g)}return[c,d]};a.transform=function(b,c){if(b.baseLength!==c.baseLength)throw Error("Both operations have to have the same base length");for(var d=new a,f=new a,g=b.clone().ops,h=c.clone().ops,m=0,u=0,s=g[m++],w=h[u++];"undefined"!==typeof s||"undefined"!==typeof w;)if(s&&
s.isInsert())d.insert(s.text,s.attributes),f.retain(s.text.length),s=g[m++];else if(w&&w.isInsert())d.retain(w.text.length),f.insert(w.text,w.attributes),w=h[u++];else{if("undefined"===typeof s)throw Error("Cannot transform operations: first operation is too short.");if("undefined"===typeof w)throw Error("Cannot transform operations: first operation is too long.");var G;if(s.isRetain()&&w.isRetain()){var C=a.transformAttributes(s.attributes,w.attributes);s.chars>w.chars?(G=w.chars,s.chars-=w.chars,
w=h[u++]):s.chars===w.chars?(G=w.chars,s=g[m++],w=h[u++]):(G=s.chars,w.chars-=s.chars,s=g[m++]);d.retain(G,C[0]);f.retain(G,C[1])}else if(s.isDelete()&&w.isDelete())s.chars>w.chars?(s.chars-=w.chars,w=h[u++]):s.chars===w.chars?(s=g[m++],w=h[u++]):(w.chars-=s.chars,s=g[m++]);else if(s.isDelete()&&w.isRetain())s.chars>w.chars?(G=w.chars,s.chars-=w.chars,w=h[u++]):s.chars===w.chars?(G=w.chars,s=g[m++],w=h[u++]):(G=s.chars,w.chars-=s.chars,s=g[m++]),d["delete"](G);else if(s.isRetain()&&w.isDelete())s.chars>
w.chars?(G=w.chars,s.chars-=w.chars,w=h[u++]):s.chars===w.chars?(G=s.chars,s=g[m++],w=h[u++]):(G=s.chars,w.chars-=s.chars,s=g[m++]),f["delete"](G);else throw Error("The two operations aren't compatible");}return[d,f]};return a}();"object"===typeof module&&(module.exports=d.TextOperation);d=d||{};d.AnnotationList=function(){function a(a,b){if(!a)throw Error("AnnotationList assertion failed"+(b?": "+b:""));}function b(a,c){this.pos=a;this.length=c.length;this.annotation=c.annotation;this.attachedObject_=
c.attachedObject}function c(a,b){this.pos=a;this.length=b.length;this.annotation=b.annotation;this.node_=b}function m(a){this.head_=new h(0,r);this.changeHandler_=a}function h(a,b){this.length=a;this.annotation=b;this.next=this.attachedObject=null}var n=d.Span;b.prototype.getAttachedObject=function(){return this.attachedObject_};c.prototype.attachObject=function(a){this.node_.attachedObject=a};var r={equals:function(){return!1}};m.prototype.insertAnnotatedSpan=function(b,c){this.wrapOperation_(new n(b.pos,
0),function(d,f){a(!f||null===f.next);var g=new h(b.length,c);if(f){a(b.pos>d&&b.pos<d+f.length);var m=new h(0,r);m.next=new h(b.pos-d,f.annotation);m.next.next=g;g.next=new h(d+f.length-b.pos,f.annotation);return m.next}return g})};m.prototype.removeSpan=function(b){0!==b.length&&this.wrapOperation_(b,function(c,d){a(null!==d);var f=new h(0,r),g=f;b.pos>c&&(g.next=new h(b.pos-c,d.annotation),g=g.next);for(;b.end()>c+d.length;)c+=d.length,d=d.next;var m=c+d.length-b.end();0<m&&(g.next=new h(m,d.annotation));
return f.next})};m.prototype.updateSpan=function(b,c){0!==b.length&&this.wrapOperation_(b,function(d,f){a(null!==f);var g=new h(0,r),m=g,n=d,w=b.pos-n;a(w<f.length);0<w&&(m.next=new h(w,f.annotation),m=m.next,n+=m.length);for(;null!==f&&b.end()>=d+f.length;)n=d+f.length-n,m.next=new h(n,c(f.annotation,n)),m=m.next,d+=f.length,f=f.next,n=d;w=b.end()-n;0<w&&(a(w<f.length),m.next=new h(w,c(f.annotation,w)),m=m.next,n+=m.length,m.next=new h(d+f.length-n,f.annotation));return g.next})};m.prototype.wrapOperation_=
function(a,d){if(0>a.pos)throw Error("Span start cannot be negative.");var m=[],n=[],r=this.getAffectedNodes_(a),u;null!==r.start?(u=r.end.next,r.end.next=null):u=r.succ;var s=d(r.startPos,r.start),w=!1,G=!1;if(s){this.mergeNodesWithSameAnnotations_(s);var C;r.pred&&r.pred.annotation.equals(s.annotation)?(w=!0,s.length+=r.pred.length,r.beforePred.next=s,C=r.predPos):(r.beforeStart.next=s,C=r.startPos);for(;s.next;)n.push(new c(C,s)),C+=s.length,s=s.next;r.succ&&r.succ.annotation.equals(s.annotation)?
(s.length+=r.succ.length,G=!0,s.next=r.succ.next):s.next=u;n.push(new c(C,s))}else r.pred&&r.succ&&r.pred.annotation.equals(r.succ.annotation)?(G=w=!0,s=new h(r.pred.length+r.succ.length,r.pred.annotation),r.beforePred.next=s,s.next=r.succ.next,n.push(new c(r.startPos-r.pred.length,s))):r.beforeStart.next=u;w&&m.push(new b(r.predPos,r.pred));u=r.startPos;for(s=r.start;null!==s;)m.push(new b(u,s)),u+=s.length,s=s.next;G&&m.push(new b(u,r.succ));this.changeHandler_(m,n)};m.prototype.getAffectedNodes_=
function(a){for(var b={},c=null,d=this.head_,f=d.next,g=0;null!==f&&a.pos>=g+f.length;)g+=f.length,c=d,d=f,f=f.next;if(null===f&&(0!==a.length||a.pos!==g))throw Error("Span start exceeds the bounds of the AnnotationList.");b.startPos=g;b.start=0===a.length&&a.pos===g?null:f;b.beforeStart=d;g===a.pos&&0<g?(b.pred=d,b.predPos=g-d.length,b.beforePred=c):b.pred=null;for(;null!==f&&a.end()>g;)g+=f.length,d=f,f=f.next;if(a.end()>g)throw Error("Span end exceeds the bounds of the AnnotationList.");0===a.length&&
a.end()===g?b.end=null:b.end=d;b.succ=g===a.end()?f:null;return b};m.prototype.mergeNodesWithSameAnnotations_=function(a){if(a)for(var b=null;a;)b&&b.annotation.equals(a.annotation)?(b.length+=a.length,b.next=a.next):b=a,a=a.next};m.prototype.forEach=function(a){for(var b=this.head_.next;null!==b;)a(b.length,b.annotation,b.attachedObject),b=b.next};m.prototype.getAnnotatedSpansForPos=function(a){for(var c=0,d=this.head_.next,g=null;null!==d&&c+d.length<=a;)c+=d.length,g=d,d=d.next;if(null===d&&c!==
a)throw Error("pos exceeds the bounds of the AnnotationList");var h=[];c===a&&g&&h.push(new b(c-g.length,g));d&&h.push(new b(c,d));return h};m.prototype.getAnnotatedSpansForSpan=function(a){if(0===a.length)return[];for(var b=[],c=this.getAffectedNodes_(a),d=c.startPos,c=c.start;null!==c&&d<a.end();){var f=Math.max(d,a.pos),g=Math.min(d+c.length,a.end()),f=new n(f,g-f);f.annotation=c.annotation;b.push(f);d+=c.length;c=c.next}return b};m.prototype.count=function(){for(var b=0,c=this.head_.next,d=null;null!==
c;)d&&a(!d.annotation.equals(c.annotation)),d=c,c=c.next,b++;return b};h.prototype.clone=function(){var a=new h(this.spanLength,this.annotation);a.next=this.next;return a};return m}();d=d||{};d.Cursor=function(){function a(a,b){this.position=a;this.selectionEnd=b}a.fromJSON=function(b){return new a(b.position,b.selectionEnd)};a.prototype.equals=function(a){return this.position===a.position&&this.selectionEnd===a.selectionEnd};a.prototype.compose=function(a){return a};a.prototype.transform=function(b){function c(a){for(var d=
a,g=b.ops,m=0,t=b.ops.length;m<t&&!(g[m].isRetain()?a-=g[m].chars:g[m].isInsert()?d+=g[m].text.length:(d-=Math.min(a,g[m].chars),a-=g[m].chars),0>a);m++);return d}var d=c(this.position);return this.position===this.selectionEnd?new a(d,d):new a(d,c(this.selectionEnd))};return a}();d=d=d||{};d.RichTextToolbar=function(a){function b(a){this.imageInsertionUI=a;this.element_=this.makeElement_()}var c=d.utils;c.makeEventEmitter(b,"bold italic underline strike font font-size color left center right unordered-list ordered-list todo-list indent-increase indent-decrease undo redo insert-image".split(" "));
b.prototype.element=function(){return this.element_};b.prototype.makeButton_=function(a,b){var d=this,f=c.elt("a",[c.elt("span","",{"class":"vceditor-tb-"+(b||a)})],{"class":"vceditor-btn"});c.on(f,"click",c.stopEventAnd(function(){d.trigger(a)}));return f};b.prototype.makeElement_=function(){var a=this.makeFontDropdown_(),b=this.makeFontSizeDropdown_(),d=this.makeColorDropdown_(),a=[c.elt("div",[a],{"class":"vceditor-btn-group"}),c.elt("div",[b],{"class":"vceditor-btn-group"}),c.elt("div",[d],{"class":"vceditor-btn-group"}),
c.elt("div",[this.makeButton_("bold"),this.makeButton_("italic"),this.makeButton_("underline"),this.makeButton_("strike","strikethrough")],{"class":"vceditor-btn-group"}),c.elt("div",[this.makeButton_("unordered-list","list-2"),this.makeButton_("ordered-list","numbered-list"),this.makeButton_("todo-list","list")],{"class":"vceditor-btn-group"}),c.elt("div",[this.makeButton_("indent-decrease"),this.makeButton_("indent-increase")],{"class":"vceditor-btn-group"}),c.elt("div",[this.makeButton_("left",
"paragraph-left"),this.makeButton_("center","paragraph-center"),this.makeButton_("right","paragraph-right")],{"class":"vceditor-btn-group"}),c.elt("div",[this.makeButton_("undo"),this.makeButton_("redo")],{"class":"vceditor-btn-group"})];this.imageInsertionUI&&a.push(c.elt("div",[this.makeButton_("insert-image")],{"class":"vceditor-btn-group"}));a=c.elt("div",a,{"class":"vceditor-toolbar-wrapper"});b=c.elt("div",null,{"class":"vceditor-toolbar"});b.appendChild(a);return b};b.prototype.makeFontDropdown_=
function(){for(var a="Arial;Comic Sans MS;Courier New;Impact;Times New Roman;Verdana".split(";"),b=[],d=0;d<a.length;d++){var f=c.elt("span",a[d]);f.setAttribute("style","font-family:"+a[d]);b.push({content:f,value:a[d]})}return this.makeDropdown_("Font","font",b)};b.prototype.makeFontSizeDropdown_=function(){for(var a=[9,10,12,14,18,24,32,42],b=[],d=0;d<a.length;d++){var f=c.elt("span",a[d].toString());f.setAttribute("style","font-size:"+a[d]+"px; line-height:"+(a[d]-6)+"px;");b.push({content:f,
value:a[d]})}return this.makeDropdown_("Size","font-size",b,"px")};b.prototype.makeColorDropdown_=function(){for(var a="black red green blue yellow cyan magenta grey".split(" "),b=[],d=0;d<a.length;d++){var f=c.elt("div");f.className="vceditor-color-dropdown-item";f.setAttribute("style","background-color:"+a[d]);b.push({content:f,value:a[d]})}return this.makeDropdown_("Color","color",b)};b.prototype.makeDropdown_=function(a,b,d,f){function q(){v&&(z.style.display="",c.off(document,"click",q,!0),v=
!1);u=!0;setTimeout(function(){u=!1},0)}function t(a,d){"object"!==typeof a&&(a=document.createTextNode(String(a)));var m=c.elt("a",[a]);c.on(m,"click",c.stopEventAnd(function(){q();x.trigger(b,d+f)}));z.appendChild(m)}f=f||"";var x=this;a=c.elt("a",a+" \u25be",{"class":"vceditor-btn vceditor-dropdown"});var z=c.elt("ul",[],{"class":"vceditor-dropdown-menu"});a.appendChild(z);for(var v=!1,u=!1,s=0;s<d.length;s++)t(d[s].content,d[s].value);c.on(a,"click",c.stopEventAnd(function(){u||v||(z.style.display=
"block",c.on(document,"click",q,!0),v=!0)}));return a};return b}();d=d||{};d.WrappedOperation=function(a){function b(a,c){this.wrapped=a;this.meta=c}function c(a,b){for(var d in a)a.hasOwnProperty(d)&&(b[d]=a[d])}function d(a,b){return a&&"object"===typeof a&&"function"===typeof a.transform?a.transform(b):a}b.prototype.apply=function(){return this.wrapped.apply.apply(this.wrapped,arguments)};b.prototype.invert=function(){var a=this.meta;return new b(this.wrapped.invert.apply(this.wrapped,arguments),
a&&"object"===typeof a&&"function"===typeof a.invert?a.invert.apply(a,arguments):a)};b.prototype.compose=function(a){var d=this.wrapped.compose(a.wrapped),m;m=this.meta;a=a.meta;if(m&&"object"===typeof m)if("function"===typeof m.compose)m=m.compose(a);else{var q={};c(m,q);c(a,q);m=q}else m=a;return new b(d,m)};b.transform=function(a,c){var g=a.wrapped.constructor.transform,g=g(a.wrapped,c.wrapped);return[new b(g[0],d(a.meta,c.wrapped)),new b(g[1],d(c.meta,a.wrapped))]};return b}();d=d||{};d.UndoManager=
function(){function a(a){this.maxItems=a||50;this.state=c;this.dontCompose=!1;this.undoStack=[];this.redoStack=[]}function b(a,c){for(var d=[],f=c.constructor,g=a.length-1;0<=g;g--){var t=f.transform(a[g],c);"function"===typeof t[0].isNoop&&t[0].isNoop()||d.push(t[0]);c=t[1]}return d.reverse()}var c="normal";a.prototype.add=function(a,b){if("undoing"===this.state)this.redoStack.push(a),this.dontCompose=!0;else if("redoing"===this.state)this.undoStack.push(a),this.dontCompose=!0;else{var c=this.undoStack;
!this.dontCompose&&b&&0<c.length?c.push(a.compose(c.pop())):(c.push(a),c.length>this.maxItems&&c.shift());this.dontCompose=!1;this.redoStack=[]}};a.prototype.transform=function(a){this.undoStack=b(this.undoStack,a);this.redoStack=b(this.redoStack,a)};a.prototype.performUndo=function(a){this.state="undoing";if(0===this.undoStack.length)throw Error("undo not possible");a(this.undoStack.pop());this.state=c};a.prototype.performRedo=function(a){this.state="redoing";if(0===this.redoStack.length)throw Error("redo not possible");
a(this.redoStack.pop());this.state=c};a.prototype.canUndo=function(){return 0!==this.undoStack.length};a.prototype.canRedo=function(){return 0!==this.redoStack.length};a.prototype.isUndoing=function(){return"undoing"===this.state};a.prototype.isRedoing=function(){return"redoing"===this.state};return a}();d=d||{};d.Client=function(){function a(a){this.revision=a;this.state=h}function b(){}function c(a){this.outstanding=a}function d(a,b){this.outstanding=a;this.buffer=b}a.prototype.setState=function(a){this.state=
a};a.prototype.applyClient=function(a){this.setState(this.state.applyClient(this,a))};a.prototype.applyServer=function(a){this.revision++;this.setState(this.state.applyServer(this,a))};a.prototype.serverAck=function(){this.revision++;this.setState(this.state.serverAck(this))};a.prototype.serverRetry=function(){this.setState(this.state.serverRetry(this))};a.prototype.transformCursor=function(a){return this.state.transformCursor(a)};a.prototype.sendOperation=function(a){throw Error("sendOperation must be defined in child class");
};a.prototype.applyOperation=function(a){throw Error("applyOperation must be defined in child class");};a.Synchronized=b;b.prototype.applyClient=function(a,b){a.sendOperation(a.revision,b);return new c(b)};b.prototype.applyServer=function(a,b){a.applyOperation(b);return this};b.prototype.transformCursor=function(a){return a};b.prototype.serverAck=function(a){throw Error("There is no pending operation.");};b.prototype.serverRetry=function(a){throw Error("There is no pending operation.");};var h=new b;
a.AwaitingConfirm=c;c.prototype.applyClient=function(a,b){return new d(this.outstanding,b)};c.prototype.applyServer=function(a,b){var d=b.constructor.transform(this.outstanding,b);a.applyOperation(d[1]);return new c(d[0])};c.prototype.serverAck=function(a){return h};c.prototype.serverRetry=function(a){a.sendOperation(this.outstanding);return this};c.prototype.transformCursor=function(a){return a.transform(this.outstanding)};a.AwaitingWithBuffer=d;d.prototype.applyClient=function(a,b){var c=this.buffer.compose(b);
return new d(this.outstanding,c)};d.prototype.applyServer=function(a,b){var c=b.constructor.transform,f=c(this.outstanding,b),c=c(this.buffer,f[1]);a.applyOperation(c[1]);return new d(f[0],c[0])};d.prototype.serverRetry=function(a){var b=this.outstanding.compose(this.buffer);a.sendOperation(b);return new c(b)};d.prototype.serverAck=function(a){a.sendOperation(a.revision,this.buffer);return new c(this.buffer)};d.prototype.transformCursor=function(a){return a.transform(this.outstanding).transform(this.buffer)};
return a}();d=d||{};d.EditorClient=function(){function a(a,b){this.cursorBefore=a;this.cursorAfter=b}function b(a,c){this.id=a;this.editorAdapter=c;this.li=document.createElement("li")}function c(a,b,d,f){h.call(this,a);this.serverAdapter=d;this.editorAdapter=f;this.undoManager=new r;this.clients={};var g=this;this.editorAdapter.registerCallbacks({change:function(a,b){g.onChange(a,b)},cursorActivity:function(){g.onCursorActivity()},blur:function(){g.onBlur()},focus:function(){g.onFocus()}});this.editorAdapter.registerUndo(function(){g.undo()});
this.editorAdapter.registerRedo(function(){g.redo()});this.serverAdapter.registerCallbacks({client_left:function(a){g.onClientLeft(a)},set_name:function(a,b){g.getClientObject(a).setName(b)},ack:function(){g.serverAck()},operation:function(a){g.applyServer(q.fromJSON(a))},cursor:function(a,b){b?g.getClientObject(a).updateCursor(g.transformCursor(n.fromJSON(b))):g.getClientObject(a).removeCursor()},clients:function(a){for(var b in g.clients)if(g.clients.hasOwnProperty(b)&&!a.hasOwnProperty(b))g.onClientLeft(b);
for(b in a)if(a.hasOwnProperty(b)){var c=g.getClientObject(b);a[b].name&&c.setName(a[b].name);(c=a[b].selection)?g.clients[b].updateSelection(g.transformSelection(Selection.fromJSON(c))):g.clients[b].removeSelection()}},reconnect:function(){g.serverReconnect()}})}function m(a){return a[a.length-1]}var h=d.Client,n=d.Cursor,r=d.UndoManager,q=d.TextOperation,t=d.WrappedOperation;a.prototype.invert=function(){return new a(this.cursorAfter,this.cursorBefore)};a.prototype.compose=function(b){return new a(this.cursorBefore,
b.cursorAfter)};a.prototype.transform=function(b){return new a(this.cursorBefore?this.cursorBefore.transform(b):null,this.cursorAfter?this.cursorAfter.transform(b):null)};b.prototype.setColor=function(a){this.color=a};b.prototype.updateCursor=function(a){this.color="#86BA7D";this.removeCursor();this.cursor=a;this.mark=this.editorAdapter.setOtherCursor(a,this.color,this.id)};b.prototype.removeCursor=function(){this.mark&&this.mark.clear()};(function(a,b){function c(){}c.prototype=b.prototype;a.prototype=
new c;a.prototype.constructor=a})(c,h);c.prototype.getClientObject=function(a){var c=this.clients[a];return c?c:this.clients[a]=new b(a,this.editorAdapter)};c.prototype.applyUnredo=function(a){this.undoManager.add(this.editorAdapter.invertOperation(a));this.editorAdapter.applyOperation(a.wrapped);(this.cursor=a.meta.cursorAfter)&&this.editorAdapter.setCursor(this.cursor);this.applyClient(a.wrapped)};c.prototype.undo=function(){var a=this;this.undoManager.canUndo()&&this.undoManager.performUndo(function(b){a.applyUnredo(b)})};
