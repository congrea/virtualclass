...
(this.uiFooterbarUserlistIcon=d('<div id="usertab_icon"></div>')).appendTo(uiFooterbarUserlistContent);uiFooterbarUserlistText=(this.uiFooterbarUserlistText=d('<div id="usertab_text" class="tooltip close " data-title="'+vApp.lang.getString("maxUserList")+'"></div>')).appendTo(uiFooterbarUserlistContent).text("Private Chat").click(function(){vApp.gObj.video.dispAllVideo("chat_div");0<Object.keys(io.uniquesids).length&&(d(this).hasClass("close")?(d(this).addClass("open"),d(this).removeClass("close"),
d("#usertab_toogle_icon").addClass("icon-arrow-down"),d("#usertab_toogle_icon").removeClass("close icon-arrow-up"),d(this).attr("data-title",vApp.lang.getString("miniUserList"))):(d(this).addClass("close"),d(this).removeClass("open"),d("#usertab_toogle_icon").addClass("icon-arrow-up"),d("#usertab_toogle_icon").removeClass("icon-arrow-down"),d(this).attr("data-title",vApp.lang.getString("maxUserList"))),d("#chat_div").memberlist("option","boxManager").toggleBox())});uiFooterbartabCont=(this.uiFooterbartabCont=
d("<div></div>")).attr("id","tabs").addClass("tabs-bottom").appendTo(a);uiFooterbartabs=(this.uiFooterbartabs=d('<ul class="tabs"></ul>')).appendTo(uiFooterbartabCont);this._setWidth(this.options.width);this.init(this)},destroy:function(){this.element.remove();this._destroy()},_setWidth:function(a){this.uiFooterbar.width(a+"px")}})})(jQuery);
