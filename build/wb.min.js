...
u.appendChild(s);b.appendChild(u);w.addEventListener("click",function(){h.control.init.call(h,w)});r=k&&m.hasOwnProperty("ch")?m.ch?!0:!1:!0;vApp.user.control.changeAttribute(d,w,r,"chat","ch")}},control:{changeAttribute:function(a,b,d,h,k){d?(b.parentNode.setAttribute("data-title",vApp.lang.getString(h+"Disable")),b.setAttribute("data-"+h+"-disable","false"),b.className="icon-"+h+"Img enable",vApp.user.control.updateUser(a,k,!0)):("assign"==h&&b.parentNode.classList.remove("tooltip"),b.parentNode.setAttribute("data-title",
vApp.lang.getString(h+"Enable")),b.setAttribute("data-"+h+"-disable","true"),b.className="icon-"+h+"Img block",vApp.user.control.updateUser(a,k,!1))},init:function(a){var b=a.id,d=b.indexOf("contr"),d=b.substring(0,d),b=b.split("contr")[1],h=b.indexOf("Img"),b=b.substring(0,h);"Assign"==b?(b="true"==a.getAttribute("data-assign-disable")?!0:!1,b||(this.control.changeAttribute(d,a,b,"assign","aRole"),vApp.user.control._assign(d),vApp.user.control.changeAttrToAssign("block"))):"Chat"==b?("true"==a.getAttribute("data-chat-disable")?
(a.className="contrChatBlock",b="enable",this.control.changeAttribute(d,a,!0,"chat","ch")):(b="block",this.control.changeAttribute(d,a,!1,"chat","ch")),this.control._chat(d,b)):"Aud"==b&&("true"==a.getAttribute("data-audio-disable")?(b="enable",this.control.changeAttribute(d,a,!0,"audio","aud")):(b="block",this.control.changeAttribute(d,a,!1,"audio","aud")),this.control._audio(d,b))},_assign:function(b,d){vApp.wb.utility.assignRole();vApp.vutil.removeAppPanel();if(!vApp.vutil.chkValueInLocalStorage("orginalTeacherId")){var g=
a.getElementById("vcanvas");g.className=g.className.replace(/\bteacher\b/," ");g.className="student"}localStorage.setItem("canvasDrwMsg",!0);g=a.getElementById("vAppScreenShareLocalVideo");null!=g&&"VIDEO"==g.tagName&&vApp.vutil.videoTeacher2Student("ScreenShare",!0);var h;"ScreenShare"==vApp.currApp&&(h="ss");"Whiteboard"!=vApp.currApp&&(vApp[h].hasOwnProperty("currentStream")&&vApp[h].currentStream.stop(),vApp[h]="");"undefined"==typeof d&&vApp.wb.utility.beforeSend({assignRole:!0,toUser:b});null==
localStorage.getItem("orginalTeacherId")&&(h=a.getElementById("chat_div").getElementsByClassName("controls")[0],h.parentNode.removeChild(h))},_chat:function(a,b){"enable"==b?vApp.wb.utility.beforeSend({enc:!0,toUser:a}):(vApp.user.control.updateUser(a,"ch",!1),vApp.wb.utility.beforeSend({dic:!0,toUser:a}))},_audio:function(a,b){"enable"==b?vApp.wb.utility.beforeSend({ena:!0,toUser:a}):vApp.wb.utility.beforeSend({dia:!0,toUser:a})},audioWidgetEnable:function(){localStorage.setItem("audEnable","true");
var b=a.getElementById("audioWidget");b.className="active";b.style.opacity="1";b.style.pointerEvents="visible"},audioWidgetDisable:function(){localStorage.setItem("audEnable","false");var b=a.getElementById("audioWidget");b.style.opacity="0.5";b.style.pointerEvents="none";b.className="deactive";b=a.getElementById("speakerPressing");vApp.gObj.video.audio.studentNotSpeak(b);vApp.gObj.video.audio.clickOnceSpeaker("speakerPressOnce","alwaysDisable")},allChatDisable:function(){localStorage.setItem("chatEnable",
"false");this.disableCommonChat();this.disbaleAllChatBox();this.disableOnLineUser()},disableCommonChat:function(){var b=a.getElementById("chatrm");null!=b&&this.makeElemDisable(b)},disbaleAllChatBox:function(){for(var b=a.getElementById("stickybar").getElementsByClassName("ui-chatbox"),d=0;d<b.length;d++)this.makeElemDisable(b[d])},disableOnLineUser:function(){for(var b=a.getElementsByClassName("ui-memblist-usr"),d=0;d<b.length;d++)b[d].style.pointerEvents="none"},makeElemDisable:function(a){vApp.vutil.elemHasAnyClass(a.id)?
...
"visible"},makeElemEnable:function(a){vApp.vutil.elemHasAnyClass(a.id)?(a.classList.remove("disable"),a.classList.add("enable")):a.className="enable";a=a.getElementsByClassName("ui-chatbox-input-box")[0];null!=a&&(a.disabled=!1)},updateUser:function(a,b,d){var h=localStorage.getItem("vApp"+a),k={};null==h?k.id=a:k=JSON.parse(h);k[b]=d;localStorage["vApp"+k.id]=JSON.stringify(k);return k},audioSign:function(b,f){if("create"==f){if(null==a.getElementById(b.id+"AudEnableSign")){var g=a.createElement("div");
g.id=b.id+"AudEnableSign";var h=a.createElement("img");imgName="audioenable";h.id=b.id+imgName+"Img";h.src=d.whiteboardPath+"images/"+imgName+".png";var k=a.createElement("a");k.id=b.id+imgName+"Anch";k.className="audEnableSign tooltip controleCont";k.setAttribute("data-title","student audio enable");k.appendChild(h);g.appendChild(k);a.getElementById(b.id+"ControlContainer").appendChild(g)}}else g=a.getElementById(b.id+"AudEnableSign"),g.parentNode.removeChild(g)},shouldApply:function(a){var b=localStorage.getItem("vApp"+
a);null!=b&&(b=JSON.parse(b),console.log("uid "+a+" "+b.ad),b.ad&&vApp.user.control.audioSign({id:a},"create"))},changeAttrToAssign:function(b){for(var d=a.getElementsByClassName("assignImg"),g=0;g<d.length;g++)"enable"==b?(d[g].classList.remove("block"),d[g].classList.add("enable"),d[g].parentNode.classList.add("tooltip"),d[g].parentNode.setAttribute("data-title",vApp.lang.getString("assignDisable")),d[g].setAttribute("data-assign-disable","false")):(d[g].classList.remove("enable"),d[g].classList.add("block"),
...
null!=a&&vApp.user.control.makeElemDisable(a)))});uiFooterbarUserlisttab=(this.uiFooterbarUserlisttab=d("<div></div>")).addClass("vmchat_bar_button").prop("id","user_list").appendTo(a);uiFooterbarUserlistContent=(this.uiFooterbarUserlistContent=d('<div class="inner_bt"></div>')).appendTo(uiFooterbarUserlisttab);uiFooterbarUserlistIcon=(this.uiFooterbarUserlistIcon=d('<div id="usertab_icon"></div>')).appendTo(uiFooterbarUserlistContent);uiFooterbarUserlistText=(this.uiFooterbarUserlistText=d('<div id="usertab_text" class="tooltip close " data-title="'+
vApp.lang.getString("maxUserList")+'"></div>')).appendTo(uiFooterbarUserlistContent).text("Private Chat").click(function(){vApp.gObj.video.dispAllVideo("chat_div");0<Object.keys(io.uniquesids).length&&(d(this).hasClass("close")?(d(this).addClass("open"),d(this).removeClass("close"),d("#usertab_toogle_icon").addClass("icon-arrow-down"),d("#usertab_toogle_icon").removeClass("close icon-arrow-up"),d(this).attr("data-title",vApp.lang.getString("miniUserList"))):(d(this).addClass("close"),d(this).removeClass("open"),
d("#usertab_toogle_icon").addClass("icon-arrow-up"),d("#usertab_toogle_icon").removeClass("icon-arrow-down"),d(this).attr("data-title",vApp.lang.getString("maxUserList"))),d("#chat_div").memberlist("option","boxManager").toggleBox())});uiFooterbartabCont=(this.uiFooterbartabCont=d("<div></div>")).attr("id","tabs").addClass("tabs-bottom").appendTo(a);uiFooterbartabs=(this.uiFooterbartabs=d('<ul class="tabs"></ul>')).appendTo(uiFooterbartabCont);this._setWidth(this.options.width);this.init(this)},destroy:function(){this.element.remove();
this._destroy()},_setWidth:function(a){this.uiFooterbar.width(a+"px")}})})(jQuery);(function(d){d.fn.clickToggle=function(a,b){var c=[a,b];this.data("toggleclicked",0);this.click(function(){var a=d(this).data(),b=a.toggleclicked;d.proxy(c[b],this)();a.toggleclicked=(b+1)%2});return this}})(jQuery);(function(d){d.widget("ui.memberlist",{options:{id:null,title:null,user:null,hidden:!1,offset:0,width:230,userSent:function(a){this.boxManager.addUsr(a.name)},boxClosed:function(a){},boxManager:{init:function(a){this.elem=a},addUsr:function(a){var b=this.elem.uiChatboxLog,c=document.createElement("div");b.append(c);if(a){b=document.createElement("a");b.href="#"+a.userid;b.classList.add("tooltip");b.setAttribute("data-title","Click to chat");var f=document.createElement("img");f.src=a.img;b.appendChild(f);
