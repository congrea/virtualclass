...
args:d}),"*");default:console.log("There is no event is occured")}},toProtocolRelativeUrl:function(){var a=virtualclass.sharePt.urlValue;return 0<=a.indexOf("http")?a.replace(/http:\/\/|https:\/\//,"//"):"//"+a},initNewPpt:function(){virtualclass.sharePt.autoSlideTime=0;virtualclass.sharePt.autoSlideFlag=0;virtualclass.sharePt.localStoragFlag=0;virtualclass.sharePt.startFromFlag=0;virtualclass.sharePt.eventsObj=[];virtualclass.sharePt.state={indexh:0,indexv:0,indexf:0};virtualclass.sharePt.stateLocalStorage=
{};localStorage.removeItem("autoSlideTime");localStorage.removeItem("autoSlideFlag");null==document.getElementById("iframecontainer")&&(console.log("call of iframe creater from onclick event handler"),virtualclass.sharePt.UI.createIframe());var a=document.getElementById(virtualclass.sharePt.UI.id);a.classList.contains("pptSharing")||a.classList.add("pptSharing");virtualclass.sharePt.urlValue=document.getElementById("presentationurl").value;virtualclass.sharePt.urlValue=virtualclass.sharePt.toProtocolRelativeUrl();
virtualclass.sharePt.isUrlip(virtualclass.sharePt.urlValue)?virtualclass.sharePt.setPptUrl(virtualclass.sharePt.urlValue):0<virtualclass.sharePt.urlValue.search("<iframe")?(a=virtualclass.sharePt.extractUrl(virtualclass.sharePt.urlValue),virtualclass.sharePt.setPptUrl(a)):virtualclass.sharePt.validURLWithDomain(virtualclass.sharePt.urlValue)?(a=virtualclass.sharePt.cleanupUrl(virtualclass.sharePt.urlValue),virtualclass.sharePt.setPptUrl(virtualclass.sharePt.completeUrl(a))):(console.log("Invalid Url"),
alert("Invalid URL"));virtualclass.system.setAppDimension()},cleanupUrl:function(a){var b=a.search("#");0<b&&(a=a.slice(0,b));return a},setPptUrl:function(a){console.log("test+set ppt url function");document.getElementById("iframecontainer").style.display="block";var b=document.getElementById("pptiframe");console.log("completeurl"+a);virtualclass.sharePt.pptUrl=a+"?postMessage=true&postMessageEvents=true";b.setAttribute("src",virtualclass.sharePt.pptUrl);ioAdapter.mustSend({pptMsg:"displayframe",
