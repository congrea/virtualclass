...
d.getString;this.lang.message=d.message;this.vutil=d.vutil;this.media=d.media;this.system=d.system;this.recorder=d.recorder;this.clear="";this.currApp=b;this.dirtyCorner=d.dirtyCorner;this.html.init(this);this.adapter=d.adapter;this.makeAppReady(b,"byclick");this.system.check();this.vutil.isSystemCompatible();this.storage=d.storage;vApp.system.indexeddb&&this.storage.init();vApp.wb.utility.displayCanvas();b==this.apps[1]&&this.system.setAppDimension();vApp.user.assignRole(vApp.gObj.uRole,b);"t"==
vApp.gObj.uRole&&vcan.utility.canvasCalcOffset(vcan.main.canid);this.gObj.video=new d.vApp.media;this.initSocketConn();vApp.chat=new Chat;vApp.chat.init();vApp.vutil.initOnBeforeUnload(vApp.system.mybrowser.name)},initSocketConn:function(){if(this.system.webSocket){var a=d.wbUser;vApp.uInfo={userid:a.id,sid:a.sid,rid:a.path,authuser:a.auth_user,authpass:a.auth_pass,userobj:{userid:a.id,name:a.name,lname:a.lname,img:a.imageurl,role:a.role},room:a.room};io.init(vApp.uInfo);d.userdata=vApp.uInfo}},html:{id:"vAppCont",
optionsClass:"appOptions",init:function(a){this.vapp=a},leftAppBar:function(){var a=document.getElementById(this.id),b=this.createElement("div","vAppOptionsCont");a.insertBefore(b,a.firstChild);this.createDiv(vApp.wbConfig.id+"Tool","whiteboard",b,vApp.wbConfig.classes);this.createDiv(vApp.ssConfig.id+"Tool","screenshare",b,vApp.ssConfig.classes);vApp.gObj.hasOwnProperty("errNotScreenShare")&&vApp.view.disableSSUI();"t"==vApp.gObj.uRole&&this.createDiv(vApp.appSessionEnd+"Tool","sessionend",
b,"appOptions");vApp.gObj.hasOwnProperty("errAppBar")&&vApp.view.disableLeftAppBar()},createDiv:function(a,b,c,f,g){var d=document.createElement("a");d.href="#";var h=document.createElement("div");h.id=a;"undefined "!=typeof f&&(h.className=f);a=document.createElement("span");a.className="icon-"+b;d.appendChild(a);d.dataset.title=vApp.lang.getString(b);d.className="tooltip";h.appendChild(d);"undefined"!=typeof g?(g=document.getElementById("vAppScreenShareTool"),c.replaceChild(h,g)):c.appendChild(h)},
createElement:function(a,b,c){a=document.createElement(a);"undefined"!=typeof b&&(a.id=b);if("undefined"!=typeof c&&1<c.length)for(b=0;b<c.length;b++)a.className+=c[b]+" ";return a}},makeAppReady:function(a,b){if(a==this.apps[0]){"object"==typeof this.ss&&(this.ss.prevStream=!1);"undefined"!=typeof this.previous&&("undefined"!=typeof b&&"byclick"==b&&vApp.virutalclass.vutil.beforeSend({dispWhiteboard:!0}),document.getElementById(vApp.previous).style.display="none");var c=document.getElementById(this.wbConfig.id);
null!=c&&(c.style.display="block");"object"!=typeof this.wb&&(this.wb=new d.whiteboard(this.wbConfig),this.wb.utility=new d.utility,this.view=d.view,this.wb.packContainer=new d.packContainer,this.wb.draw_object=d.draw_object,this.wb.makeobj=d.makeobj,this.wb.readyFreeHandObj=d.readyFreeHandObj,this.wb._replay=_replay,this.wb.readyTextObj=d.readyTextObj,this.wb.bridge=d.bridge,this.wb.response=d.response,this.wb.utility.initUpdateInfo(""));"undefined"!=typeof this.prevScreen&&this.prevScreen.hasOwnProperty("currentStream")&&
this.prevScreen.unShareScreen();vApp.hasOwnProperty("prevApp")&&"t"==vApp.gObj.uRole&&vApp.vutil.makeActiveApp("vApp"+a,vApp.prevApp);null!=document.getElementById("canvas")&&(vcan.utility.canvasCalcOffset(vcan.main.canid),vApp.wb.utility.makeCanvasEnable());"vAppScreenShare"==this.previous&&"t"==vApp.gObj.uRole&&(vApp.vutil.dimensionMatch("vAppWhiteboard","vAppScreenShare")||vApp.wb.utility.lockVapp());this.prevApp=this.previous=this.wbConfig.id}else a==this.apps[1]&&("object"!=typeof this.ss&&(this.ss=
new d.screenShare(vApp.ssConfig)),this.ss.init({type:"ss",app:a}))},attachFunction:function(){for(var a=document.getElementsByClassName("appOptions"),b=0;b<a.length;b++){var c=a[b].getElementsByTagName("a")[0],f=this;clickedAnchor=c;c.onclick=function(){f.initlizer(this)}}},initlizer:function(a){a=a.parentNode.id.split("vApp")[1];if("SessionEndTool"==a){if(!confirm(vApp.lang.getString("startnewsession")))return;a=a.substring(0,a.indexOf("Tool"));vApp.vutil.makeActiveApp("vApp"+a,vApp.previous);vApp.storage.config.endSession();
vApp.virutalclass.vutil.beforeSend({sEnd:!0});vApp.hasOwnProperty("prevScreen")&&vApp.prevScreen.hasOwnProperty("currentStream")&&vApp.prevScreen.unShareScreen();vApp.prevApp="vApp"+a}else this.currApp=a=a.substring(0,a.indexOf("Tool")),this.PrvAndCurrIsWss(this.previous,a)?alert("Already the whole screen is being shared."):this.makeAppReady(a,"byclick");"ScreenShare"!=a&&vApp.vutil.removeClass("audioWidget","fixed")},PrvAndCurrIsWss:function(a,b){return"vAppWholeScreenShare"==a&&b==this.apps[2]?!0:!1},prvCurrUsersSame:function(){var a=
localStorage.getItem("prvUser");if(null==a)vApp.setPrvUser();else if(a=JSON.parse(a),a.id!=wbUser.id||a.room!=wbUser.room)vApp.gObj.sessionClear=!0,vApp.setPrvUser(),"t"==this.gObj.uRole&&localStorage.setItem("teacherId",wbUser.id)},setPrvUser:function(){localStorage.clear();localStorage.setItem("prvUser",JSON.stringify({id:wbUser.id,room:wbUser.room}))}}}})(window);(function(d,a){var b={cmdWrapperDiv:"commandToolsWrapper",create:function(a){if("#"==a.charAt(0)){var f=a.substring(1,a.length);b.utility.canvasCalcOffset(f);return new b.main(a)}alert("there is a problem with canvas id")},main:function(c){b.main.children=[];b.main.id=0;b.main.uid=0;b.main.canvas=a.querySelector(c);b.main.canid=c.substring(1,c.length);b.main.currentTransform="";b.main.replayObjs=[];b.main.dragMode=!1;b.main.scaleMode=!1;b.main.usrCurrAction="";b.main.currObj="";b.main.textObj=!1;
...
function(){"Whiteboard"==vApp.currApp&&vApp.wb.utility.lockVapp()});d.addEventListener("click",function(){vApp.view.disappearBox("WebRtc");vApp.view.disappearBox("Canvas");vApp.view.disappearBox("drawArea")});vApp.vutil.chkValueInLocalStorage("reclaim");this.stHasTeacher=vApp.vutil.chkValueInLocalStorage("teacherId");if(vApp.vutil.chkValueInLocalStorage("reclaim")){var a=vApp.wb.createCommandWrapper();vApp.wb.utility.createReclaimButton(a);vApp.gObj.uRole="s"}this.stHasTeacher&&(vApp.gObj.uRole=
...
vApp.virutalclass.vutil.beforeSend({replayAll:!0})):vApp.wb.toolInit(this.parentNode.id);"t_replay"!=this.parentNode.id&&"t_clearall"!=this.parentNode.id&&"t_reclaim"!=this.parentNode.id&&"t_assign"!=this.parentNode.id&&(a=(new Date).getTime(),vApp.wb.lt=this.parentNode.id,a={cmd:this.parentNode.id,mt:a},vApp.wb.uid++,a.uid=vApp.wb.uid,vcan.main.replayObjs.push(a),vApp.storage.store(JSON.stringify(vcan.main.replayObjs)),vApp.storage.wholeStore(a),vApp.virutalclass.vutil.beforeSend({repObj:[a]}));"t_clearall"!=this.parentNode.id&&
...
vApp.wb.prvTool=a;vApp.virutalclass.vutil.beforeSend({clearAll:!0})}else"t_assign"==a?(b=localStorage.getItem("toolHeight"),null!=b?vApp.virutalclass.vutil.beforeSend({assignRole:!0,toolHeight:b,socket:vApp.wb.socketOn}):vApp.virutalclass.vutil.beforeSend({assignRole:!0,socket:vApp.wb.socketOn})):"t_reclaim"==a&&vApp.wb.utility._reclaimRole();"t_activeall"!=a&&"t_replay"!=a&&"t_clearallInit"!=a&&"t_assign"!=a&&"t_reclaim"!=a&&(vApp.wb.tool=new vApp.wb.tool_obj(a),vApp.wb.utility.attachEventHandlers())},tool_obj:function(a){this.cmd=
...
vApp.wb.user.connected=!1;localStorage.removeItem("otherRole");"undefined"!=typeof cthis&&(tempIsInitiaor=!0,cthis.isStarted&&cthis.handleRemoteHangup())},sendRequest:function(a,b){vApp.virutalclass.vutil.beforeSend({reclaimRole:!0})},updateSentInformation:function(a,b){if(vApp.vutil.chkValueInLocalStorage("orginalTeacherId")){var c=JSON.parse(a),c="undefined"!=typeof b?c:c.repObj[0],f="",g;for(g in c)f+=g+" : "+c[g]+" <br />";null!=document.getElementById("sentMsgInfo")&&(document.getElementById("sentMsgInfo").innerHTML=
f)}},audioSend:function(a,b){if(vApp.gObj.audMouseDown&&1==io.sock.readyState){var c;c=vApp.gObj.uid.toString();for(var f=c.length;8>f;f++)c="0"+c;c=c.match(/[\S]{1,2}/g)||[];c=new Int8Array([101,c[0],c[1],c[2],c[3]]);f=new Int8Array(a.length+c.length);f.set(c);f.set(a,c.length);io.sendBinary(f);vApp.gObj.video.audio.setAudioStatus(b)}else vApp.gObj.video.audio.setAudioStatus("stop")},beforeSend:function(a){if(a.hasOwnProperty("createArrow")){var b=JSON.stringify(a);vApp.wb.vcan.optimize.sendPacketWithOptimization(b,
...
(a.style.margin="0",a.style.padding="0"),a=a.parentNode;"vcanvas"!=a.id&&(a.style.margin="0",a.style.padding="0")},lockVapp:function(){if(d.earlierWidth!=d.innerWidth&&(vApp.wb.canvasDisable=!0,vApp.wb.utility.makeCanvasDisable(),vApp.wb.utility.toolWrapperDisable(),vApp.vutil.disableAppsBar(),null==document.getElementById("divForReloadMsg"))){var a=null!=localStorage.getItem("teacherId")?"msgForReload":"msgStudentForReload";d.vApp.view.displayMsgBox("divForReloadMsg",a);d.earlierWidth=d.innerWidth}},
...
removeClassFromElement:function(a,b){if("t_reclaim"!=a){a=document.getElementById(a).className;for(var c=a.split(" "),f=[],g=0;g<c.length;g++)c[g]!=b&&f.push(c[g]);return 1<f.length?f.join(" "):f[0]}},makeActiveTool:function(a){a=document.getElementById(a);var b;vApp.wb.hasOwnProperty("prvTool")&&"t_reclaim"!=vApp.wb.prvTool?(b=vApp.wb.utility.removeClassFromElement(vApp.wb.prvTool,"active"),document.getElementById(vApp.wb.prvTool).className=b):b=a.className;a.className=b+" active";localStorage.activeTool=
a.id},makeDeActiveTool:function(){vApp.wb.tool="";document.getElementById("commandToolsWrapper");var a=document.getElementsByClassName("tool active");0<a.length&&a[0].classList.remove("active")},createAudioTransmitIcon:function(a){var b=document.cteateElement("div");b.id="audioTransmit"+uuserId;b.className="audioTransmit";document.getElementById(a+"ControlContainer")},_reclaimRole:function(){vApp.wb.utility.reclaimRole();vApp.wb.utility.sendRequest("reclaimRole",!0);vApp.user.control.changeAttrToAssign("enable")},
...
screenshare:"Screen Share",sessionend:"Session End",audioTest:"Kindly speak some words for audio testing\nYour voice will be recorderd for 5 seconds after press OK.",chatEnable:"Chat is on",chatDisable:"Chat Disabled",assignEnable:"Transfer Controls",assignDisable:"Reclaim Role",audioEnable:"Audio Enabled",audioDisable:"Audio Disabled",audioOn:"Audio on",minCommonChat:"Hide Common Chat",maxCommonChat:"Show Common Chat",miniuserbox:"Hide User Box",maxuserbox:"Show User Box",miniUserList:"Show User List",
maxUserList:"Hide User List",startnewsession:"Do you want start a new session with ending current session?",DevicesNotFoundError:"You may not have Webcam(camera/microphone).",PermissionDeniedError:"You denied to access your Webcam.",PERMISSION_DENIED:"You denied to access your Webcam(camera/microphone).",notSupportBrowser:"Firefox {vApp1} does not support Screen sharing.",disableSpeaker:"Disable Audio",enableSpeaker:"Enable Audio",notSupportChrome:"Your browser {vapp1} {vapp2} needs to updated, We support Chrome 40",
errcanvas:"canvas",errwebSocket:"Web Socket",errgetusermedia:"getUserMedia",errindexeddb:"indexedDb",errwebworker:"Web worker",errwebaudio:"Web audio",errtypedarray:"Typed array",errscreenshare:"Screen share",operaBrowserIssue:"Your browser {vapp1} {vapp2} is partially supported. You will not be able to share your screen with Learners, We fully support chrome and Firefox",commonBrowserIssue:"Your browser {vapp1} {vapp2} is not supported, We support Chrome and Firefox.",chFireBrowsersIssue:"Your browser {vapp1} {vapp2}  needs to updated, We support Chrome 40 and Firefox 35.",
studentSafariBrowserIssue:"Your browser {vapp1} {vapp2} does not able to share your Cam with other users, We fully support Chrome  and Firefox.",ieBrowserIssue:"Your browser Internet Explorer is not supported, We fully support Chrome  and Firefox.",ios7support:"We support only iOS 8 (Apple's operating system version 8) or higher.",supportDesktop:"For teacher we support desktop computer only not any tablet and mobile phone.",notSupportIphone:"We support iPad, Tablet or Desktop coputer, not any Mobile phone",
InternalError:"It seems that you try to connect a single web cam from two different browsers on a single computer.<br /> This is not compaitible with different Operating System eg:- Windows, CentOS. ",SourceUnavailableError:"It seems that you try to connect a single web cam from two different browsers on a single computer.<br /> This is not supported for operating system like : Windows, CentOS.",teacherSafariBrowserIssue:"Your browser Safari is not supporting for teacher, We fully support Chrome  and Firefox.",
safariBrowserIssue:"Your browser Safari {vapp1} is not supported, We fully support Chrome  and Firefox"}})(window);(function(d){d.getString=function(a,b){var c=d.vApp.lang.message[a];if("undefined"!=typeof b&&0<b.length)for(var f=0;f<b.length;f++)c=c.replace(new RegExp("{vapp"+(f+1)+"}"),b[f]);return c}})(window);(function(d){var a={init:function(){this.msgBoxClass="msgBox";this.window={};this.virtualWindow={};return this},displayMessage:function(a,c,f,g,d){a="undefined"==typeof d?this.createMsgBox(a,c,f):this.createMsgBox(a,c,f,d);c=document.getElementById("vcanvas");"undefined"!=typeof g?document.getElementById(g).appendChild(a):c.insertBefore(a,c.childNodes[0])},createErrorMsg:function(a,c,f){var g=document.getElementById(c);null==g?(g=document.createElement("div"),g.id=c,g.innerHTML=a):g.innerHTML=a+"<br /> "+
g.innerHTML;a=document.getElementById(f);a.parentNode.insertBefore(g,a);return g.id},removeErrorMsg:function(a,c){var f=document.getElementById(a);if("undefined"!=typeof c){var g=f.innerHTML.split(/<br>|<br\\>/);if(1<g.length){g.shift();f.innerHTML=g.join();return}}f.parentNode.removeChild(f)},removeErrorContainer:function(a){a=document.getElementById(a);a.parentNode.removeChild(a)},customCreateElement:function(a,c,f){a=document.createElement(a);"undefined"!=typeof c&&(a.id=c);"undefined"!=typeof f&&
(a.className=f);return a},createMsgBox:function(a,c,f,g){var d=this.customCreateElement("div",c,f);"undefined"==typeof g&&(f=this.customCreateElement("div",c+"img",f+"img"),d.appendChild(f));c=this.customCreateElement("p",c+"Para");c.innerHTML=a;d.appendChild(c);return d},disappearBox:function(a){a=document.getElementsByClassName(this.msgBoxClass+a);null!=a[0]&&a[0].parentNode.removeChild(a[0])},multiMediaMsg:function(a){if("Firefox"==vApp.system.mybrowser.name){var c=vApp.lang.getString("wbrtcMsgFireFox");
this.displayMessage(c,"fireFoxWebrtcCont",this.msgBoxClass+a)}else"Chrome"==vApp.system.mybrowser.name&&(c=vApp.lang.getString("wbrtcMsgChrome"),this.displayMessage(c,"chormeWebrtcCont",this.msgBoxClass+a))},canvasDrawMsg:function(a){document.getElementById("vcanvas").className="canvasMsgBoxParent";if("Firefox"==vApp.system.mybrowser.name){var c=vApp.lang.getString("canvasDrawMsg");this.displayMessage(c,"canvasDrawMsgContFirefox",this.msgBoxClass+a,"containerWb")}else"Chrome"==vApp.system.mybrowser.name&&
(c=vApp.lang.getString("canvasDrawMsg"),this.displayMessage(c,"canvasDrawMsgContChrome",this.msgBoxClass+a,"containerWb"))},drawLabel:function(a){var c=vApp.lang.getString("drawArea");this.displayMessage(c,"canvasDrawArea",this.msgBoxClass+a,"containerWb",!1)},displayMsgBox:function(a,c){var f=this.customCreateElement("div",a),g=this.customCreateElement("p",a+"Para");g.innerHTML=vApp.lang.getString(c);f.appendChild(g);g=this.customCreateElement("a",a+"Anchor");g.href=d.location;g.innerHTML=vApp.lang.getString("reload");
g.onclick=function(){d.location.reload()};f.appendChild(g);g=document.getElementById("vAppCont");g.insertBefore(f,g.firstChild)},displayServerError:function(a,c){var f=this.customCreateElement("div",a);f.innerHTML=c;var g=document.getElementById("vcanvas");g.parentNode.insertBefore(f,g)},removeElement:function(a){a=document.getElementById(a);null!=a&&a.parentNode.removeChild(a)},disableSSUI:function(){var a=document.getElementById("vAppScreenShareTool");null!=a&&(a.style.opacity="0.5",a.style.pointerEvents=
"none")},disableLeftAppBar:function(){var a=document.getElementById("vAppOptionsCont");null!=a&&(a.style.opacity="0.5",a.style.pointerEvents="none")}},a=a.init();count=0;a.window.resizeFinished=function(){var a=0;return function(c,f){clearTimeout(a);a=setTimeout(c,f)}}();a.window.resize=function(){var a=vApp.system.measureResoultion({width:d.innerWidth,height:d.innerHeight});vApp.vutil.setContainerWidth(a);vcan.renderAll()};a.virtualWindow.manupulation=function(a){var c=a.message.virtualWindow;if(c.hasOwnProperty("removeVirtualWindow"))a.fromUser.userid!=
wbUser.id&&vApp.wb.utility.removeVirtualWindow("virtualWindow");else if(c.hasOwnProperty("createVirtualWindow"))c.hasOwnProperty("toolHeight")&&localStorage.setItem("toolHeight",c.toolHeight),a.fromUser.userid!=wbUser.id&&vApp.wb.utility.createVirtualWindow(c.createVirtualWindow);else if(c.hasOwnProperty("shareBrowserWidth")){c.hasOwnProperty("toolHeight")&&localStorage.setItem("toolHeight",c.toolHeight);if(null!=localStorage.getItem("teacherId")){var f=vApp.wb.utility.getWideValueAppliedByCss("commandToolsWrapper");
localStorage.setItem("toolHeight",f)}a.fromUser.userid!=wbUser.id?(null!=localStorage.getItem("teacherId")&&vApp.wb.utility.makeCanvasEnable(),otherBrowser=c.browserRes):myBrowser=vApp.system.measureResoultion({width:d.outerWidth,height:d.innerHeight});"object"==typeof myBrowser&&"object"==typeof otherBrowser&&(myBrowser.width>otherBrowser.width?vApp.wb.gObj.virtualWindow||(vApp.wb.utility.createVirtualWindow(otherBrowser),vApp.wb.gObj.virtualWindow=!0):myBrowser.width<otherBrowser.width&&!vApp.wb.gObj.virtualWindow&&
(a=document.getElementById("vcanvas"),a=vApp.wb.utility.getElementRightOffSet(a),null!=localStorage.getItem("teacherId")?vApp.virutalclass.vutil.beforeSend({virtualWindow:{createVirtualWindow:myBrowser-a,toolHeight:f}}):vApp.virutalclass.vutil.beforeSend({virtualWindow:{createVirtualWindow:myBrowser-a}})))}};d.view=a})(window);(function(d){var a={init:function(){this.wbRtc={};this.wbRtc.className="webrtcCont";this.mybrowser={};return this},isCanvasSupport:function(a,c,f){return"MSIE"==c?9!=f?!1:!0:d.CanvasRenderingContext2D?!0:!1},isWebSocketSupport:function(a,c,f){return"undefined"==typeof d.WebSocket||"function"!=typeof d.WebSocket&&"object"!=typeof d.WebSocket||!d.WebSocket.hasOwnProperty("OPEN")?!1:!0},isLocalStorageSupport:function(){return void 0!==Storage?!0:!1},isGetUserMediaSupport:function(a,c){navigator.getUserMedia=
navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia;return navigator.getUserMedia?!0:!1},isIndexedDbSupport:function(){return d.indexedDB||d.webkitIndexedDB||d.mozIndexedDB||d.msIndexedDB?!0:!1},isWorkerSupport:function(){return d.Worker?!0:!1},isAudioApiSupport:function(){return d.AudioContext||d.webkitAudioContext?!0:!1},isTypedArraySupport:function(){return"ArrayBuffer"in d?!0:!1},isScreenShareSupport:function(a,c){return"Firefox"==a?34<=c?
!0:!1:"Chrome"==a?39<=c?!0:!1:!1},setValue:function(a,c){this[a]=c},checkBrowserFunctions:function(a,c){this.setValue("canvas",this.isCanvasSupport());this.setValue("webSocket",this.isWebSocketSupport());this.setValue("getusermedia",this.isGetUserMediaSupport());this.setValue("indexeddb",this.isIndexedDbSupport());this.setValue("webworker",this.isWorkerSupport());this.setValue("webaudio",this.isAudioApiSupport());this.setValue("typedarray",this.isTypedArraySupport());this.setValue("screenshare",this.isScreenShareSupport(a,
c));this.setValue("localstorage",this.isLocalStorageSupport())},measureResoultion:function(a){var c=document.getElementById("vAppCont"),c=vcan.utility.getElementOffset(c),f=c.x;return{width:1024>a.width?1024-f:a.width-f,height:a.height-c.y}},setAppDimension:function(){var b=this.measureResoultion({width:d.innerWidth,height:d.innerHeight});vApp.vutil.setContainerWidth(b);"Whiteboard"==vApp.currApp&&a.setCanvasDimension(b)},setCanvasDimension:function(a){if("undefined"!=typeof vcan.main.canvas){var c=
vcan.main.canvas;ctx=vcan.main.canvas.getContext("2d");c.width=a.width;c.height=a.height-("t"==vApp.gObj.uRole?65:10);console.log("canvas width "+c.width);a=vcan.utility.getElementOffset(document.getElementById("canvas"));vcan.main.offset.x=a.x}},getResoultion:function(a){var c={};1280>a?(c.width=1024,c.height=768):1280<=a&&1366>a?(c.width=1280,c.height=1024):1366<=a&&1920>a?(c.width=1366,c.height=768):1920<=a&&(c.width=1920,c.height=1080);return c},reportBrowser:function(a){a=this.getErrors(a);1<
a.length?vApp.error.push(a.join(",")+" are disabled in your browser."):1==a.length&&vApp.error.push(a+" is disabled in your browser.")},getErrors:function(a){var c=[],f="canvas webSocket getusermedia webaudio indexeddb localstorage typedarray".split(" ");"t"==a&&f.push("webworker","screenshare");for(a=0;a<f.length;a++)this[f[a]]||("screenshare"==f[a]&&(vApp.gObj.errNotScreenShare=!0),c.push(vApp.lang.getString("err"+f[a])));return c},isiOSDevice:function(){return parseFloat((""+(/CPU.*OS ([0-9_]{1,5})|(CPU like).*AppleWebKit.*Mobile/i.exec(navigator.userAgent)||
[0,""])[1]).replace("undefined","3_2").replace("_",".").replace("_",""))||!1},isAndroid:function(){return-1<navigator.userAgent.toLowerCase().indexOf("android")},check:function(){var a=this.isiOSDevice();this.device="desktop";if(a){var c="iOS";this.device="mobTab"}else var f=this.isAndroid(),a=this.mybrowser.detection(),c=a[0],a=parseFloat(a[1]);this.mybrowser.name=c;this.mybrowser.version=a;this.checkBrowserFunctions(c,a);"undefined"!=typeof f&&f?(this.device="mobTab","t"==vApp.gObj.uRole?(vApp.vutil.initDisableVirtualClass(),
vApp.error.push("We support only desktop computer not  any tablet and mobile for teacher.")):f&&("Chrome"==c?40<=a?vApp.vutil.initDisableAudVid():(vApp.error.push(c+" "+a+"  is not supported, we support chrome  versoin 40 or newer on Android"),vApp.vutil.initDisableVirtualClass()):(vApp.error.push(c+"  is not supported, we support Chrome 40 or newer on andorid"),vApp.vutil.initDisableVirtualClass()))):"Chrome"==c&&40<=a||"Firefox"==c&&35<=a||"s"==vApp.gObj.uRole&&c=="OPR">a>=26?this.reportBrowser(vApp.gObj.uRole):
"Chrome"==c&&40>a||"Firefox"==c&&35>a||"s"==vApp.gObj.uRole&&"OPR"==c&&26>a?(this.reportBrowser(vApp.gObj.uRole),vApp.error.push(vApp.lang.getString("chFireBrowsersIssue",[c,a]))):"OPR"==c&&26<=a?(this.reportBrowser(vApp.gObj.uRole),"t"==vApp.gObj.uRole&&vApp.error.push(vApp.lang.getString("operaBrowserIssue",[c,a]))):"Safari"==c?8<=a?"t"==vApp.gObj.uRole?(vApp.vutil.initDisableVirtualClass(),vApp.error.push(vApp.lang.getString("teacherSafariBrowserIssue",[c,a]))):(vApp.vutil.initDisableAudVid(),
vApp.error.push(vApp.lang.getString("studentSafariBrowserIssue",[c,a])),vApp.user.control.audioWidgetDisable()):(vApp.vutil.initDisableVirtualClass(),vApp.error.push(vApp.lang.getString("safariBrowserIssue",[c,a]))):"iOS"==c?/(iPad)/g.test(navigator.userAgent)?"s"==vApp.gObj.uRole?8<=a?(vApp.vutil.initDisableAudVid(),vApp.gObj.iosIpadbAudTrue=!1,c=document.createElement("div"),c.innerHTML="Tap here for enable the audio",c.id="iosAudioTrigger",c.addEventListener("click",function(){vApp.vutil.firstiOSaudioCall();
this.parentNode.removeChild(this)}),f=document.getElementById("audioWidget"),f.parentNode.insertBefore(c,f.nextSibling)):(vApp.vutil.initDisableVirtualClass(),vApp.error.push(vApp.lang.getString("ios7support"))):(vApp.vutil.initDisableVirtualClass(),vApp.error.push(vApp.lang.getString("supportDesktop"))):(vApp.vutil.initDisableVirtualClass(),vApp.error.push(vApp.lang.getString("notSupportIphone"))):(this.mybrowser.detectIE()?(vApp.gObj.errIE=!0,vApp.error.push(vApp.lang.getString("ieBrowserIssue"))):
vApp.error.push(vApp.lang.getString("commonBrowserIssue",[c,a])),vApp.vutil.initDisableVirtualClass())}},a=a.init();d.addEventListener("resize",function(){d.earlierWidth!=d.innerWidth&&a.setAppDimension()});d.addEventListener("resize",function(){d.earlierWidth!=d.innerWidth&&vApp.view.window.resize()});a.mybrowser.detectIE=function(){var a=d.navigator.userAgent,c=a.indexOf("MSIE ");if(0<c)return parseInt(a.substring(c+5,a.indexOf(".",c)),10);if(0<a.indexOf("Trident/"))return c=a.indexOf("rv:"),
parseInt(a.substring(c+3,a.indexOf(".",c)),10);c=a.indexOf("Edge/");return 0<c?parseInt(a.substring(c+5,a.indexOf(".",c)),10):!1};a.mybrowser.detection=function(){var a=navigator.userAgent,c,f=a.match(/(opera|opr|OPR(?=\/))\/?\s*([\d\.]+)/i)||[];if(0>=f.length&&(f=a.match(/(chrome|safari|firefox|trident(?=\/))\/?\s*([\d\.]+)/i)||[],"Safari"==f[1])){var g=a.match(/(version(?=\/))\/?\s*([\d\.]+)/i)||[];f[2]=g[2]}if(/trident/i.test(f[1]))return c=/\brv[ :]+(\d+(\.\d+)?)/g.exec(a)||[],"IE "+(c[1]||"");
f=f[2]?[f[1],f[2]]:[navigator.appName,navigator.appVersion,"-?"];null!=(c=a.match(/version\/([\.\d]+)/i))&&(f[2]=c[1]);return f};d.system=a})(window);(function(d){d.packContainer=function(){return{createPacketContDiv:function(a,b){var c=document.createElement("div");"undefined"!=typeof a&&(c.id=a);"undefined"!=typeof b&&(c.clasName=b);return c},togglePacketCont:function(a){for(var b=this.className.split(" "),c=0;c<b.length;c++)if("display"==b[c]){this.className="hide";this.innerHTML="+";a._togglePacketCont(b[c]);break}else if("hide"==b[c]){this.className="display";this.innerHTML="-";a._togglePacketCont(b[c]);break}},_togglePacketCont:function(a){a=
...
f=1,g=b.length;f<g;f++){var d=a.measureText(b[f]).width;d>c&&(c=d)}return c},getTextHeight:function(a,b,c){return c.fontSize*b.length*c.lineHeight},removeTextNode:function(){for(var a=document.getElementsByClassName("textBoxContainer"),b=0;b<a.length;b++)a[b].parentNode.removeChild(a[b])}}}})(window);(function(d){var a=d.vcan;a.main.freeHandDrawing=function(b){return{type:"freeDrawing",init:function(){this.contextTop={};this.isCurrentlyDrawing=!1;this.freeDrawingXPoints=[];this.freeDrawingYPoints=[];this.mdTime=[];this.freeDrawingColor=void 0==b.borderColor?"#000000":b.borderColor;this.freeDrawingLineWidth=void 0!=b.lineWidth?b.lineWidth:"3";return this},fhdStart:function(a,b,g){g=(new Date).getTime();this.contextTop=a;this.isCurrentlyDrawing=!0;this.freeDrawingXPoints.push(b.x);this.freeDrawingYPoints.push(b.y);
this.contextTop.beginPath();this.contextTop.save();this.contextTop.moveTo(b.x,b.y);this.mdTime.push(g);this.contextTop.strokeStyle=this.freeDrawingColor;this.contextTop.lineWidth=this.freeDrawingLineWidth;this.contextTop.lineCap=this.contextTop.lineJoin="round"},fhRendering:function(a,b){var g=(new Date).getTime();this.freeDrawingXPoints.push(a.x);this.freeDrawingYPoints.push(a.y);this.contextTop.lineTo(a.x,a.y);this.contextTop.stroke();this.mdTime.push(g)},finalizeDrawingPath:function(c,f,g){(new Date).getTime();
this.contextTop.closePath();this.isCurrentlyDrawing=!1;var d=this.utility.min(this.freeDrawingXPoints);f=this.utility.min(this.freeDrawingYPoints);var h=this.utility.max(this.freeDrawingXPoints);g=this.utility.max(this.freeDrawingYPoints);var m=[],n,p,q,r=this.freeDrawingXPoints,u=this.freeDrawingYPoints,s=this.mdTime;m.push("M ",r[0]-d," ",u[0]-f," ",s[0]," ");for(var v=1;n=r[v],p=u[v],q=s[v];v++)m.push("L ",n-d," ",p-f," ",q," ");m=m.join("");if("M 0 0 L 0 0 "!==m)return n=this.freeDrawingXPoints[this.freeDrawingXPoints.length-
1],p=this.freeDrawingYPoints[this.freeDrawingYPoints.length-1],q=new a.Path(m,this),q.mp={},q.mp.x=n,q.mp.y=p,q.init(m),q=c.readyObject(q),q.coreObj.type="freeDrawing",q=q.coreObj,q.fill=null,q.stroke=this.freeDrawingColor,q.strokeWidth=this.freeDrawingLineWidth,q.minX=d,q.minY=f,this.utility.objAdd(q),c=a.utility.setVal(q,"x",d+(h-d)/2),c=a.utility.setVal(c,"y",f+(g-f)/2),c.setCoords(),"object"==typeof b&&this.contextTop.restore(),a.renderAll(this.contextTop),c},utility:{max:function(a,b){if(a&&
0!==a.length){var g=a.length-1,d=b?a[g][b]:a[g];if(b)for(;g--;)a[g][b]>=d&&(d=a[g][b]);else for(;g--;)a[g]>=d&&(d=a[g]);return d}},min:function(a,b){if(a&&0!==a.length){var d=a.length-1,k=b?a[d][b]:a[d];if(b)for(;d--;)a[d][b]<k&&(k=a[d][b]);else for(;d--;)a[d]<k&&(k=a[d]);return k}},objAdd:function(b){a.main.children.push(b);return this}}}}})(window);(function(d){var a=d.vcan;a.Path=function(b,c){return{objectType:"path",init:function(a,b){b=b||{};this.commandLengths={m:2,l:2,h:1,v:1,c:6,s:4,q:4,t:2,a:7};if(!a)throw Error("`path` argument is required");if(this.path=a.match&&a.match(/[a-zA-Z][^a-zA-Z]*/g))return this.initializeFromArray(b),this},initializeFromArray:function(a){var b="width"in a,c="height"in a;this.path=this._parsePath();b&&c||(this.utility.extend(this,this._parseDimensions()),b&&(this.width=a.width),c&&(this.height=a.height))},
...
f.setZindex(),f.downObj=!0,f.setupCurrentTransform(b),a.utility.setActiveObject(f),a.main.currObj=f):a.deactivateAll();void 0!=f&&a.renderAll();b.detail.hasOwnProperty("cevent")||(f=(new Date).getTime(),f=a.makeStackObj(f,"d",b.clientX-a.main.offset.x,b.clientY-a.main.offset.y),vApp.wb.uid++,console.log("uid "+vApp.wb.uid),f.uid=vApp.wb.uid,a.main.replayObjs.push(f),vApp.virutalclass.vutil.beforeSend({repObj:[f]}),vApp.wb.utility.updateSentPackets(f))}}else"create"==a.main.action&&(b.detail.hasOwnProperty("cevent")&&
...
(new Date).getTime();a={type:"text",text:k,x:b.measure.x+m,y:b.measure.y+f,fontSize:20,fontWidth:a.measureText(k).width,mp:{x:b.measure.x,y:b.measure.y}};!1==vApp.wb.obj.drawTextObj.muser&&(k={mt:h,ac:"d",x:this.startPosX,y:this.startPosY,mtext:a.text},vApp.wb.uid++,k.uid=vApp.wb.uid,c.main.replayObjs.push(k),vApp.storage.store(JSON.stringify(c.main.replayObjs)),vApp.storage.wholeStore(k),vApp.virutalclass.vutil.beforeSend({repObj:[k]}),vApp.wb.utility.updateSentPackets(k));a=vApp.wb.canvas.readyObject(a);
vApp.wb.canvas.addObject(a);c.main.children[c.main.children.length-1].mt=h;d.parentNode.removeChild(b);c.renderAll();0<vApp.wb.sentPackets&&null!=document.getElementById(vApp.wb.sentPackDiv)&&(document.getElementById(vApp.wb.sentPackDiv).innerHTML=vApp.wb.sentPackets);vApp.wb.utility.toolWrapperEnable(!0)}}}})(window);(function(d){d.keyBoard={prvTool:"",skey:!1,triggerActiveAll:function(a){a.shiftKey&&(console.log("what happend mere bhai"),vApp.wb.keyBoard.skey=!0,vApp.wb.keyBoard.prvTool=vApp.wb.tool.cmd,vApp.wb.toolInit("t_activeall"),a={cmd:"t_activeall",mt:(new Date).getTime()},vcan.main.replayObjs.push(a),vApp.virutalclass.vutil.beforeSend({repObj:[a]}),vApp.wb.vcan.main.action="move")},triggerdeActiveAll:function(a){vApp.wb.keyBoard.skey&&(console.log("what happend mere bhai ddd"),a=(new Date).getTime(),vApp.wb.utility.deActiveFrmDragDrop(),
vApp.wb.toolInit(vApp.wb.keyBoard.prvTool),a={cmd:vApp.wb.keyBoard.prvTool,mt:a},vcan.main.replayObjs.push(a),vApp.virutalclass.vutil.beforeSend({repObj:[a]}))}}})(window);(function(d){d.adapter=function(){return{RTCPeerConnection:null,webrtcDetectedBrowser:null,init:function(a){vApp.system.getusermedia&&(a.mozGetUserMedia?(d.webrtcDetectedBrowser="firefox",this.RTCPeerConnection=mozRTCPeerConnection,this.RTCSessionDescription=mozRTCSessionDescription,this.RTCIceCandidate=mozRTCIceCandidate,a.getUserMedia=a.mozGetUserMedia,this.attachMediaStream=function(a,c){this.videoAdd=!0;var f=d.URL||d.webkitURL;a.src=f?f.createObjectURL(c):c;a.play()},reattachMediaStream=function(a,
c){console.log("Reattaching media stream");a.mozSrcObject=c.mozSrcObject;a.play()},MediaStream.prototype.getVideoTracks=function(){return[]},MediaStream.prototype.getAudioTracks=function(){return[]}):a.webkitGetUserMedia?(console.log("This appears to be Chrome"),d.webrtcDetectedBrowser="chrome",this.RTCPeerConnection=webkitRTCPeerConnection,this.RTCSessionDescription=RTCSessionDescription,this.RTCIceCandidate=RTCIceCandidate,a.getUserMedia=a.webkitGetUserMedia,this.attachMediaStream=function(a,c){var f=
d.URL||d.webkitURL;a.src=f?f.createObjectURL(c):c;a.play();this.videoAdd=!0},reattachMediaStream=function(a,c){a.src=c.src},webkitMediaStream.prototype.getVideoTracks||(webkitMediaStream.prototype.getVideoTracks=function(){return this.videoTracks},webkitMediaStream.prototype.getAudioTracks=function(){return this.audioTracks}),webkitRTCPeerConnection.prototype.getLocalStreams||(webkitRTCPeerConnection.prototype.getLocalStreams=function(){return this.localStreams},webkitRTCPeerConnection.prototype.getRemoteStreams=
function(){return this.remoteStreams})):console.log("Browser does not appear to be WebRTC-capable"));return a}}}})(window);function Resampler(d,a,b,c,f){this.fromSampleRate=d;this.toSampleRate=a;this.channels=b|0;this.outputBufferSize=c;this.noReturn=!!f;this.initialize()}
...
Resampler.prototype.initializeBuffers=function(){try{this.outputBuffer=new Float32Array(this.outputBufferSize),this.lastOutput=new Float32Array(this.channels)}catch(d){this.outputBuffer=[],this.lastOutput=[]}};(function(d){repMode=!1;var a=d.io,b=0,c=0,f=0,g=0,k=65535,h=0;d.media=function(){return{isChannelReady:"",isInitiator:!1,isStarted:"",localStream:"",pc:[],cn:0,ba:!1,bb:!1,bc:!1,bNotRender:!1,remoteStream:"",turnReady:"",oneExecuted:!1,videoControlId:"videoContainer",videoContainerId:"videos",util:{imageReplaceWithVideo:function(a,b){var c=document.getElementById("ml"+a);vApp.vutil.elemHasAnyClass("ml"+a)&&c.classList.remove("userImg");var c=c.getElementsByTagName("a")[0],f=c.getElementsByTagName("img")[0];
c.replaceChild(b,f)}},audio:{audioStreamArr:[],tempAudioStreamArr:[],recordingLength:0,bufferSize:0,encMode:"alaw",recordAudio:!1,resampler:new Resampler(44100,8E3,1,4096),rec:"",otherSound:!1,audioNodes:[],sdElem:"silenceDetect",Html5Audio:{audioContext:new (d.AudioContext||d.webkitAudioContext)},init:function(){null!=localStorage.getItem("orginalTeacherId")&&(vApp.gObj.audMouseDown=!0);this.graph={height:56,width:4,average:0,display:function(){var a=cthis.video;"t"==vApp.gObj.uRole&&this._display(a.tempVidCont,
...
slienceDetection:function(a,d){var p=0,q=0,r=0;for(i=0;i<d.length;i++)r=Math.abs(d[i]),p<r&&(p=r),q+=r;g=q/d.length;r=Math.abs(g^2-f^2);f=g;5>r&&(k=p);k>p&&(k=p);h<p&&(h=p);50*k<h&&(k*=5);h/50>k&&(h=p);q=h/k;switch(!0){case 8<q:r=2.5;break;case 5<q:r=2;break;case 3<q:r=1.2;break;default:r=1}2<=q&&p>=k*r?(0==b&&0!=c&&(vApp.wb.utility.audioSend(c),c=0),vApp.wb.utility.audioSend(a,"sending"),b=9):0<b?(vApp.wb.utility.audioSend(a,"sending"),b--):2>q?vApp.wb.utility.audioSend(a,"sending"):(this.setAudioStatus("notSending"),
10<q&&(h*=.8),c=a);return a},setAudioStatus:function(a){if("undefined"==typeof b)var b=document.getElementById("audioWidget").getElementsByClassName(this.sdElem)[0];b.setAttribute("data-silence-detect",a)},makeIconNotDraggable:function(a,b){var c=document.getElementById(a,b).getContext("2d"),f=new Image;f.onload=function(){c.drawImage(f,0,0)};f.src=d.whiteboardPath+"images/"+b},attachFunctionsToAudioWidget:function(){for(var a=document.getElementById("audioWidget").getElementsByClassName("audioTool"),
b=0;b<a.length;b++)"speakerPressOnce"!=a[b].id&&"speakerPressing"==a[b].id&&this.attachSpeakToStudent(a[b].id),"speakerPressing"!=a[b].id&&a[b].addEventListener("click",this.audioToolInit)},audioToolInit:function(){var a=vApp.gObj.video.audio;"speakerPressOnce"==this.id?a.clickOnceSpeaker(this.id):"audioTest"==this.id?confirm(vApp.lang.getString("audioTest"))&&a.testInit(this.id):"silenceDetect"==this.id&&(this.getElementsByTagName("a"),a.sd?(a.sd=!1,this.className+=" sdDisable"):(a.sd=!0,this.className+=
" sdEnable"))},attachSpeakToStudent:function(a){var b=this,c=document.getElementById(a),f=!1;c.addEventListener("mousedown",function(){if(!vApp.gObj.audMouseDown){b.studentSpeak(c);f=!0;var a=document.getElementById("speakerPressonceLabel");null!=a&&vApp.vutil.elemHasAnyClass("speakerPressonceLabel")&&a.classList.contains("silenceDetect")&&(a.removeAttribute("data-silence-detect"),a.classList.remove("silenceDetect"),0>=a.classList.length&&a.removeAttribute("class"),a=a.getElementsByTagName("i")[0],
null!=a&&(a.setAttribute("data-silence-detect","stop"),a.className+=" silenceDetect"))}});c.addEventListener("mouseup",function(){if(f){b.studentNotSpeak(c);f=!1;var a=document.getElementById("speakerPressonceLabel"),d=a.getElementsByTagName("i")[0];"undefined"!=typeof d.classList&&d.classList.contains("silenceDetect")&&(d.classList.remove("silenceDetect"),0>=d.classList.length&&d.removeAttribute("class"),a.removeAttribute("data-silence-detect"));null!==a&&(a.setAttribute("data-silence-detect","stop"),
a.className=d.className+" silenceDetect")}})},attachAudioPressOnce:function(){var a=document.getElementById("speakerPressOnce");a.setAttribute("data-audio-playing","false");var b=this;a.addEventListener("click",function(){b.clickOnceSpeaker.call(b,a.id)})},clickOnceSpeaker:function(a,b){var c=document.getElementById(a),f=document.getElementById("speakerPressing"),d=c.getElementsByClassName("tooltip")[0];"false"==c.getAttribute("data-audio-playing")&&"undefined"==typeof b?(this.studentSpeak(f),c.setAttribute("data-audio-playing",
"true"),d.setAttribute("data-title",vApp.lang.getString("disableSpeaker")),c.className="audioTool active"):(this.studentNotSpeak(f),c.setAttribute("data-audio-playing","false"),d.setAttribute("data-title",vApp.lang.getString("enableSpeaker")),c.className="audioTool deactive")},studentSpeak:function(a){"undefined"!=typeof a&&(document.getElementById(a.id+"Button"),a.classList.remove("deactive"),a.classList.add("active"));vApp.gObj.audMouseDown=!0;vApp.virutalclass.vutil.beforeSend({sad:!0})},studentNotSpeak:function(a){vApp.gObj.hasOwnProperty("audMouseDown")&&
vApp.gObj.audMouseDown&&("undefined"!=typeof a&&(document.getElementById(a.id+"Button"),a.classList.remove("active"),a.classList.add("deactive")),a=document.getElementById("speakerPressOnce"),a.setAttribute("data-audio-playing","false"),a.className="audioTool deactive",vApp.gObj.audMouseDown=!1,vApp.gObj.video.audio.setAudioStatus("stop"),vApp.virutalclass.vutil.beforeSend({sad:!1}))},ab2str:function(a){return String.fromCharCode.apply(null,new Int8Array(a))},str2ab:function(a){for(var b=new ArrayBuffer(a.length),
...
b)}},audioInLocalStorage:function(a){return G711.encode(a,{alaw:"alaw"==this.encMode?!0:!1})},testInit:function(a){var b=document.getElementById(a);b.classList.add("audioIsTesting");this.studentNotSpeak();vApp.gObj.audioForTest=[];this.storeAudio=!0;var c=this;c.otherSound=!0;c.hasOwnProperty("testAudio")&&clearTimeout(c.testAudio);c.testAudio=setTimeout(function(){c.playRecordedAudio(vApp.gObj.audioForTest,vApp.gObj.uid,!0)},5E3);setTimeout(function(){b.classList.remove("audioIsTesting");c.otherSound=
!1},11E3)},audioForTesting:function(a){a=G711.encode(a,{alaw:"alaw"==this.encMode?!0:!1});vApp.gObj.audioForTest.push(a);vApp.gObj[vApp.gObj.uid]=!1},playRecordedAudio:function(a,b,c){var f;this.myaudioNodes=[];for(var d=0,g=0;g<a.length;g++)f=a[g],f=G711.decode(f,{alaw:"alaw"==this.encMode?!0:!1,floating_point:!0,Eight:!0}),this.myaudioNodes.push(new Float32Array(f)),d+=f.length;f=this.mergeBuffers(this.myaudioNodes,d);"undefined"!=typeof c?vApp.gObj.video.audio.play(f,b,c):vApp.gObj.video.audio.play(f,
b)},play:function(a,b,c){var f=JSON.parse(localStorage.getItem("vApp"+b));"undefined"==typeof receivedResampler&&(receivedResampler=new Resampler(8E3,44100,1,16384));var d=receivedResampler.resampler(a);a=this.Html5Audio.audioContext.createBuffer(1,d.length,44100);a.getChannelData(0).set(d);d=this.Html5Audio.audioContext.createBufferSource();d.buffer=a;a=this.Html5Audio.audioContext.createGain();a.gain.value=.9;d.connect(a);a.connect(this.Html5Audio.audioContext.destination);null!=f&&f.ad&&f.aud&&
(vApp.user.control.iconAttrManupulate(b,"icon-audioEnaGreen"),document.getElementById(f.id+"contrAudAnch").setAttribute("data-title",vApp.lang.getString("audioOn")));d.onended=function(){f=JSON.parse(localStorage.getItem("vApp"+b));"undefined"==typeof c&&(clearTimeout(vApp.gObj[b].out),vApp.gObj[b].isplaying=!1,0<vApp.gObj.video.audio.audioToBePlay[b].length?vApp.gObj.video.audio.getChunks(b):f.ad&&f.aud&&vApp.user.control.iconAttrManupulate(b,"icon-audioEnaOrange"))};d.start(0);vApp.gObj[b].isplaying=
!0;"undefined"==typeof c&&(vApp.gObj[b].out=setTimeout(function(){vApp.gObj[b].isplaying=!1;0<vApp.gObj.video.audio.audioToBePlay[b].length&&vApp.gObj.video.audio.getChunks(b)},1E3*d.buffer.duration+10))},calcAverage:function(){var a=new Uint8Array(analyser.frequencyBinCount);analyser.getByteFrequencyData(a);for(var b=0,c=a.length,f=0;f<c;f++)b+=a[f];this.graph.average=b/c},audioInGraph:function(){var a=cthis.video;if("t"==vApp.gObj.uRole){var b=this.graph.height-this.graph.height*this.graph.average/
100;a.tempVidCont.beginPath();a.tempVidCont.moveTo(a.tempVid.width-this.graph.width,this.graph.height);a.tempVidCont.lineTo(a.tempVid.width-this.graph.width,b);a.tempVidCont.lineWidth=this.graph.width;a.tempVidCont.strokeStyle="rgba(247, 25, 77, 1)";a.tempVidCont.closePath();a.tempVidCont.stroke()}},queue:function(a,b){this.hasOwnProperty("audioToBePlay")||(this.audioToBePlay={});this.audioToBePlay.hasOwnProperty(b)||(this.audioToBePlay[b]=[]);this.audioToBePlay[b].push(a)},getChunks:function(a,b){8<
this.audioToBePlay[a].length?(this.audioToBePlay[a].length=0,vApp.gObj[a].isplaying=!1):0<this.audioToBePlay[a].length?(this.playRecordedAudio(this.audioToBePlay[a],a),this.audioToBePlay[a].length=0):vApp.gObj[a].isplaying=!1},replayInit:function(){vApp.storage.getAllObjs(["audioData"],function(){vApp.gObj.video.audio.replay(0,0)})},replay:function(a,b){repMode=!0;var c,f,d;0<this.audioNodes.length&&(c=this.mergeBuffers(this.audioNodes),f=this.Html5Audio.audioContext.currentTime+a,d=this.Html5Audio.audioContext.createBuffer(1,
...
document.createElement("div");b.className="videoWrapper";var c=document.createElement("div");c.className="videoSubWrapper";c.id="user"+a.id;b.appendChild(c);vidId=a.id;var f=document.createElement("canvas");f.id="video"+vidId;f.className="userVideos";f.width=this.width;f.height=this.height;c.appendChild(f);vApp.gObj.video.util.imageReplaceWithVideo(a.id,b)},updateHightInSideBar:function(a){var b=document.getElementById("widgetRightSide").offsetHeight;document.getElementById("chatContainer").style.height=
b-a+"px"},send:function(){function b(){function h(){try{f.tempVidCont.drawImage(f.myVideo,0,0,f.width,f.height)}catch(a){if("NS_ERROR_NOT_AVAILABLE"==a.name)setTimeout(h,100);else throw a;}}if("t"==vApp.gObj.uRole){if("undefined"==typeof k){var k=document.getElementById("graphCanvas");null!=k&&(cthis.audio.graph.cvCont=k.getContext("2d"))}null!=k&&cthis.audio.graph.cvCont.clearRect(0,0,k.width,k.height)}f.tempVidCont.clearRect(0,0,f.tempVid.width,f.tempVid.height);d.navigator.userAgent.match("Firefox")?
h():f.tempVidCont.drawImage(f.myVideo,0,0,f.width,f.height);"t"==vApp.gObj.uRole&&cthis.audio.graph.display();k={name:vApp.gObj.uName,id:vApp.gObj.uid};"t"==vApp.gObj.uRole&&(k.role=vApp.gObj.uRole);vApp.virutalclass.vutil.beforeSend({videoByImage:k});var k=f.tempVidCont.getImageData(0,0,f.tempVid.width,f.tempVid.height),k=vApp.dirtyCorner.encodeRGB(k.data),s=c(vApp.gObj.uid,8),s=new Uint8ClampedArray([11,s[0],s[1],s[2],s[3]]),v=new Uint8ClampedArray(k.length+s.length);v.set(s);v.set(k,s.length);a.sendBinary(v);
clearInterval(vApp.gObj.video.smallVid);k=2E3+2500*vApp.gObj.totalUser.length;g!=vApp.gObj.totalUser?(g=vApp.gObj.totalUser.length,s=vApp.gObj.totalUser.indexOf(vApp.gObj.uId),vApp.gObj.video.smallVid=setInterval(b,k+k/g*s)):vApp.gObj.video.smallVid=setInterval(b,k)}function c(a,b){for(var f=a.toString(),d=f.length;d<b;d++)f="0"+f;return f.match(/[\S]{1,2}/g)||[]}vApp.gObj.video.hasOwnProperty("smallVid")&&clearInterval(vApp.gObj.video.smallVid);var f=this;randomTime=Math.floor(10001*Math.random())+
5E3;var g=-1;vApp.gObj.video.smallVid=setInterval(b,300)},startToStream:function(){cthis.video.calcDimension();cthis.video.send()},playWithoutSlice:function(a,b){this.remoteVid=document.getElementById("video"+a);this.remoteVidCont=this.remoteVid.getContext("2d");var c=vApp.dirtyCorner.decodeRGB(b,this.remoteVidCont,this.remoteVid);this.remoteVidCont.putImageData(c,0,0)},justForDemo:function(){var a=0,b=document.getElementById("allVideosCont");b.style.maxHeight="250px";setInterval(function(){if(20>=
++a){b=document.getElementById("allVideosCont");var c=document.createElement("div");c.className="videoWrapper";var f=document.createElement("div");f.className="videoSubWrapper";f.setAttribute("data-uname","suman"+a);c.appendChild(f);var d=document.createElement("video");d.className="userVideo";d.src="http://html5demos.com/assets/dizzy.mp4";f.appendChild(d);b.appendChild(c);250<=b.offsetHeight&&"undefined"!=b.style.overflowY&&"scroll"!=b.style.overflowY&&(b.style.overflowY="scroll",document.getElementById(vApp.gObj.chat.mainChatBoxId).style.borderTop=
...
vApp.system.wbRtc.peerCon&&"undefined"==typeof localStorage.wbrtcMsg&&(vApp.view.multiMediaMsg("WebRtc"),localStorage.wbrtcMsg=!0)},handleUserMedia:function(a){var b=document.getElementById("audioWidget");vApp.vutil.elemHasAnyClass("audioWidget")&&b.classList.contains("deactive")&&vApp.user.control.audioWidgetEnable();cthis.video.tempStream=a;cthis.audio.init();a=document.getElementById("ml"+vApp.gObj.uid);null!=a&&null!=a.getElementsByTagName("video")&&cthis._handleUserMedia(vApp.gObj.uid)},addUserRole:function(a,
b){var c=document.getElementById("ml"+a);c.setAttribute("data-role",b);c.classList.add("s"==b?"student":"teacher")},_handleUserMedia:function(a){document.getElementById(a);var b=cthis.video.tempStream;"undefined"!=typeof b&&(a=cthis.video.createVideoElement(),vApp.gObj.video.util.imageReplaceWithVideo(vApp.gObj.uid,a),cthis.video.insertTempVideo(a),cthis.video.tempVideoInit(),cthis.video.myVideo=document.getElementById("video"+vApp.gObj.uid),vApp.adpt.attachMediaStream(cthis.video.myVideo,b),cthis.video.myVideo.muted=
!0,b.ontimeupdate=function(){console.log("raja"+b.currentTime)},vApp.jId==vApp.gObj.uid&&(cthis.stream=cthis.video.tempStream,cthis.audio.manuPulateStream(),cthis.audio.graph.canvasForVideo()),cthis.video.myVideo.onloadedmetadata=function(){cthis.video.startToStream()});userMedia=!0},updateVidContHeight:function(){var a=document.getElementById("vAppCont"),a=vcan.utility.getElementOffset(a),a=d.innerHeight-(a.y+75);document.getElementById("chat_div").style.maxHeight=a+"px"},close:function(){vApp.gObj.video.hasOwnProperty("smallVid")&&
clearInterval(vApp.gObj.video.smallVid)},dispAllVideo:function(a){setTimeout(function(){var b=document.getElementById(a);if(null!=b)for(var b=b.getElementsByTagName("video"),c=0;c<b.length;c++)b[c].play()},1040)},existVideoContainer:function(a){for(var b=document.getElementsByClassName("userVideos"),c=0;c<b.length;c++)if(b[c].id=="video"+a.id)return!0;return!1},handleUserMediaError:function(a){a="object"==typeof a?vApp.lang.getString(a.name):vApp.lang.getString(a);vApp.view.createErrorMsg(a,"errorContainer",
"chatWidget");vApp.user.control.audioWidgetDisable();vApp.view.disappearBox("WebRtc");console.log("navigator.getUserMedia error: ",a)}}}})(window);(function(d){var a={requestPackets:function(a){1<a.length&&(vApp.wb.gObj.myArr=a);vApp.wb.sentReq=!0;return[vApp.wb.gObj.rcvdPackId,a[0].uid]},makeQueue:function(a){vApp.wb.gObj.rcvdPackId!=vApp.wb.gObj.displayedObjId&&(vApp.wb.gObj.packQueue=vApp.wb.gObj.packQueue.concat(a.message.repObj))},sendPackets:function(a,c){if(0==a.message.getMsPckt[0])var f=-1;else for(f=0;f<vApp.wb.gObj.myrepObj.length&&a.message.getMsPckt[0]!=vApp.wb.gObj.myrepObj[f].uid;f++);for(f+=1;f<a.message.getMsPckt[1];f++)c.push(vApp.wb.gObj.myrepObj[f]);
...
[]);return a},containsIfQueuePacks:function(a,c,f,d){a!=c&&f+1!=d[0].uid&&0<vApp.wb.gObj.packQueue.length&&d[d.length-1].uid==vApp.wb.gObj.packQueue[0].uid&&(vApp.wb.gObj.packQueue=d.concat(vApp.wb.gObj.packQueue))},sortingReplyObjs:function(){vApp.wb.gObj.replayObjs=vApp.wb.gObj.replayObjs.sort(function(a,c){return a.uid-c.uid})}};d.bridge=a})(window);(function(d){vcan.optimize={sendPacketWithOptimization:function(a,b,c){"undefined"==typeof this.lastarrowtime&&(this.lastarrowtime=(new Date).getTime(),vApp.wb.sentPackets+=a.length,1==b&&vApp.virutalclass.vutil.beforeSend(JSON.parse(a)),vApp.wb.utility.updateSentInformation(a,!0));this.presentarrowtime=(new Date).getTime();this.presentarrowtime-this.lastarrowtime>=c&&(vApp.wb.sentPackets+=a.length,1==b&&io.send(JSON.parse(a)),vApp.wb.utility.updateSentInformation(a,!0),this.lastarrowtime=(new Date).getTime())},
...
a.clientY-vcan.main.offset.y),vcan.optimize.calculatePackets(lastmousemovetime,"m",a.clientX-vcan.main.offset.x,a.clientY-vcan.main.offset.y),lastmousemovetime=(new Date).getTime())},calculatePackets:function(a,b,c,f){a=vcan.makeStackObj(a,b,c,f);console.log(a);vApp.wb.uid++;a.uid=vApp.wb.uid;vcan.main.replayObjs.push(a);vApp.virutalclass.vutil.beforeSend({repObj:[a]});vApp.storage.store(JSON.stringify(vcan.main.replayObjs));vApp.storage.wholeStore(a);vApp.wb.utility.updateSentPackets(a)}}})(window);(function(d){d.response={reclaimRole:function(a,b){a!=b&&(vApp.user.control._assign(b,"notsent",a),vApp.user.displayStudentSpeaker(!0),null!=localStorage.getItem("aId")&&localStorage.removeItem("aId"),vApp.user.control.removeAudioFromParticipate(a),"mobTab"==vApp.system.device&&((vApp.system.mybrowser.name=8<=vApp.system.mybrowser.version)&&/(iPad)/g.test(navigator.userAgent)&&vApp.vutil.enableVirtualClass(),vApp.view.removeErrorMsg("errorContainer",!0)))},assignRole:function(a,b,c){if(a!=b||"undefined"!=
typeof c)if(vApp.wb.utility.assignRole(b),vApp.wb.utility.uniqueArrOfObjsToTeacher(),null==localStorage.getItem("orginalTeacherId")){vApp.vutil.removeSessionTool();b=document.getElementById("ml"+a);c=["assign"];var f=document.getElementById(a+"ControlContainer");null!=f?vApp.user.createAssignControl(f,a,!0):(c=vApp.user.createControl(a,c),b.appendChild(c));localStorage.setItem("aId",a)}else a=document.getElementById("chat_div").getElementsByClassName("currTeacher")[0],null!=a&&vApp.user.control.removeCurrTeacherFromControl(a.id),
vApp.user.control.changeAttrToAssign("enable");vApp.vutil.attachClickOutSideCanvas();"mobTab"==vApp.system.device&&(vApp.vutil.disableVirtualClass(),vApp.view.createErrorMsg(vApp.lang.getString("supportDesktop"),"errorContainer","chatWidget"))},checkUser:function(a,b,c){"undefined"!=typeof vcan.teacher||c||vApp.wb.utility.makeCanvasDisable();vApp.wb.utility.initDefaultInfo(a,wbUser.role);vApp.wb.utility.makeUserAvailable(a.message.checkUser.e.clientLen)},clearAll:function(a,b,c,f){a!=b&&(vApp.wb.tool=
new vApp.wb.tool_obj("t_clearall"),vApp.wb.utility.t_clearallInit(),vApp.wb.utility.makeDefaultValue(),vApp.storage.clearStorageData());f&&vApp.wb.utility.updateRcvdInformation(c)},replayAll:function(){d.vApp.wb.vcan.main.replayObjs=vApp.wb.gObj.replayObjs;vApp.wb.utility.clearAll(!1);vApp.wb.toolInit("t_replay","fromFile")},createArrow:function(a,b){var c=vApp.wb.arrImg,f={};f.mp={x:a.x,y:a.y};vApp.wb.utility.drawArrowImg(c,f);b&&vApp.wb.utility.updateRcvdInformation(a)},replayObj:function(a){d.vApp.wb.vcan.main.replayObjs=
...
d.innerHeight+"px"},isSystemCompatible:function(){if(0<vApp.error.length){var a=1<vApp.error.length?vApp.error.join("<br />"):vApp.error[0];vApp.view.createErrorMsg(a,"errorContainer","chatWidget");vApp.gObj.hasOwnProperty("errIE")&&vApp.vutil.disableVirtualClass();vApp.gObj.hasOwnProperty("audIntDisable")&&vApp.user.control.audioWidgetDisable();vApp.gObj.hasOwnProperty("errNotDesktop")&&(vApp.user.control.audioWidgetDisable(),vApp.vutil.disableVirtualClass())}else(vApp.gObj.hasOwnProperty("audIntDisable")||
vApp.gObj.hasOwnProperty("vidIntDisable"))&&vApp.user.control.audioWidgetDisable()},chkValueInLocalStorage:function(a){return null===localStorage.getItem(a)?!1:localStorage[a]},setContainerWidth:function(a){var b="vAppWhiteboard";"undefined"!=typeof vApp.previous&&(b=vApp.previous);var c=document.getElementById(b);if("ScreenShare"==vApp.currApp){var f=document.getElementById("vAppOptionsCont");if(null!=f){var d=vcan.utility.getElementOffset(f);leftSideBarWidth=f.offsetWidth+d.x}else leftSideBarWidth=
0}else leftSideBarWidth=0;a.width-=5+leftSideBarWidth+0;c.style.width=a.width+"px";"vAppWhiteboard"!=b&&(f=document.getElementById(b+"Local"),a.width-=10,c.style.width=a.width,f.style.width=a.width+"px",vApp.vutil.setScreenInnerTagsWidth(b))},setScreenInnerTagsWidth:function(a){document.getElementById(a);document.getElementById(a+"Local");document.getElementById(a+"LocalVideo")},makeActiveApp:function(a,b){if("undefined"!=typeof b){b+="Tool";var c=vApp.wb.utility.removeClassFromElement(b,"active");
document.getElementById(b).className=c}document.getElementById(a+"Tool").className+=" active"},initInstallChromeExt:function(a){"EXTENSION_UNAVAILABLE"==a.name&&(console.log("ask for inline installation"),chrome.webstore.install("https://chrome.google.com/webstore/detail/ijhofagnokdeoghaohcekchijfeffbjl",function(a){d.location.reload()},function(a){alert(a)}))},removeAppPanel:function(){var a=document.getElementById("vAppOptionsCont");null!=a&&a.parentNode.removeChild(a)},removeTempVideo:function(a){a=
document.getElementById(a);a.parentNode.removeChild(a)},createLocalTempVideo:function(a,b){if("string"==typeof a||"String"==typeof a)a=document.getElementById(a);var c=vApp.vutil.createDOM("div",b),f=vApp.vutil.createDOM("canvas",b+"Video");c.appendChild(f);a.appendChild(c)},initLocCanvasCont:function(a){var b="ScreenShare"==vApp.currApp?"ss":"wss";vApp[b].localtempCanvas=document.getElementById(a);vApp[b].localtempCont=vApp[b].localtempCanvas.getContext("2d")},videoTeacher2Student:function(a,b){var c=
a,f=document.getElementById("vApp"+a+"LocalVideo");if(null!=f&&"VIDEO"==f.tagName){var d=document.createElement("canvas");d.id=f.id;d.width=f.offsetWidth;d.height=f.offsetHeight;f.parentNode.replaceChild(d,f);"ScreenShare"==c&&(c="ss");"undefined"!=typeof b||"undefined"==typeof c||"ss"!=c&&"wss"!=c||(vApp[c].localCanvas=d,vApp[c].localCont=vApp[c].localCanvas.getContext("2d"),f=vApp[c].localtempCont.getImageData(0,0,vApp[c].localtempCanvas.width,vApp[c].localtempCanvas.height),vApp[c].localCont.putImageData(f,
0,0));vApp.vutil.removeTempVideo("vApp"+a+"LocalTemp")}},clickOutSideCanvas:function(){this.exitTextWrapper()&&vApp.wb.obj.drawTextObj.textUtility(vApp.wb.gObj.spx,vApp.wb.gObj.spy)},exitTextWrapper:function(){return 0<document.getElementsByClassName("textBoxContainer").length?!0:!1},attachClickOutSideCanvas:function(){function a(a){a=document.getElementById(a);null!=a&&(a.onclick=function(){vApp.vutil.clickOutSideCanvas()})}a("commandToolsWrapper");a("vAppOptionsCont");a("audioWidget");a("chatWidget")},
dimensionMatch:function(a,b){var c=document.getElementById(a).offsetWidth,f=document.getElementById("vAppOptionsCont").offsetWidth;return document.getElementById(b).offsetWidth+f==c?!0:!1},disableAppsBar:function(){var a=document.getElementById("vAppOptionsCont");null!=a&&(a.style.pointerEvents="none")},isMiniFileIncluded:function(a){a=new RegExp(a+".js?=*([0-9]*)");for(var b=document.getElementsByTagName("script"),c=0;c<b.length;c++)if(a.test(b[c].src))return!0;return!1},clearAllChat:function(){localStorage.removeItem(vApp.gObj.uid);
sessionStorage.clear("chatroom");vApp.chat.idList.length=0;clearAllChatBox();var a=document.getElementById("chatWidget").getElementsByClassName("ui-chatbox-msg");if(0<a.length)for(;null!=a[0];)a[0].parentNode.removeChild(a[0])},isObjectEmpty:function(a){for(var b in a)if(a.hasOwnProperty(b))return!1;return!0},removeSessionTool:function(){if(null==localStorage.getItem("orginalTeacherId")){var a=document.getElementById("vAppSessionEndTool");null!=a&&a.parentNode.removeChild(a)}},toggleRoleClass:function(a){if(null!=
localStorage.getItem("teacherId")&&null==localStorage.getItem("orginalTeacherId")||a)document.getElementById("vAppCont").classList.toggle("teacher"),document.getElementById("vAppCont").classList.toggle("student")},addClass:function(a,b){var c=document.getElementById(a);vApp.vutil.elemHasAnyClass(a)?c.classList.add(b):c.className=b},removeClass:function(a,b){var c=document.getElementById(a);vApp.vutil.elemHasAnyClass(a)&&c.classList.contains(b)&&c.classList.remove(b)},breakIntoBytes:function(a,b){for(var c=
a.toString(),f=c.length;f<b;f++)c="0"+c;return c.match(/[\S]{1,2}/g)||[]},numValidateFour:function(a,b,c,f){a=this.preNumValidateTwo(a);b=this.preNumValidateTwo(b);c=this.preNumValidateTwo(c);f=this.preNumValidateTwo(f);return parseInt(a+b+c+f)},numValidateTwo:function(a,b){a=this.preNumValidateTwo(a);b=this.preNumValidateTwo(b);return parseInt(a+b)},preNumValidateTwo:function(a){a=a.toString();if(1==a.length)return"0"+a;if(2==a.length)return a},elemHasAnyClass:function(a){a=document.getElementById(a);
return null!=a?"undefined"!=typeof a.classList?!0:!1:!1},userIsOrginalTeacher:function(a){return null!=localStorage.getItem("orginalTeacherId")?!0:!1},isUserTeacher:function(a){return null!=localStorage.getItem("teacherId")?!0:!1},initDisableAudVid:function(){vApp.gObj.audIntDisable=!0;vApp.gObj.vidIntDisable=!0},initDisableVirtualClass:function(){this.initDisableAudVid();vApp.gObj.errNotDesktop=!0;vApp.gObj.errNotScreenShare=!0;vApp.gObj.errAppBar=!0},disableVirtualClass:function(){var a=document.getElementById("vAppCont");
a.style.opacity=.6;a.style.pointerEvents="none"},enableVirtualClass:function(){var a=document.getElementById("vAppCont");a.style.opacity=1;a.style.pointerEvents="visible"},firstiOSaudioCall:function(){vApp.gObj.hasOwnProperty("audioPlayMessage")&&(vApp.gObj.iosIpadbAudTrue=!0,vApp.gObj.video.audio.receivedAudioProcess(vApp.gObj.audioPlayMessage))},beforeLoad:function(){if("undefined"!=typeof vApp.storage.wholeStoreData){var a=JSON.parse(vApp.storage.wholeStoreData);a.beforeRefresh=!0;vApp.storage.wholeStore(a,
"put")}localStorage.removeItem("otherRole");vApp.wb.utility.userIds=[];vApp.gObj.hasOwnProperty("audIntDisable")||vApp.gObj.video.audio.studentNotSpeak();vApp.vutil.clickOutSideCanvas();localStorage.setItem(wbUser.sid,JSON.stringify(vApp.chat.vmstorage));io.disconnect()},initOnBeforeUnload:function(a){"iOS"==a?document.body.onunload=function(){vApp.vutil.beforeLoad()}:d.onbeforeunload=function(){vApp.vutil.beforeLoad()}}}})(window);(function(d){d.studentScreen=function(){return{ssProcess:function(a,b,c,f){if(102==a[0]||202==a[0]){a=new Uint8ClampedArray(b);var d=vApp.vutil.numValidateTwo(a[1],a[2]),k=vApp.vutil.numValidateTwo(a[3],a[4]);b=a.subarray(5,a.length);this.initStudentScreen(b,{w:d,h:k},c,f)}else if(103==a[0]||203==a[0])for(a=new Uint8ClampedArray(b),b=7,d=0;d+7<=a.length;d=n+1){var h=vApp.vutil.numValidateTwo(a[d+1],a[d+2]),m=vApp.vutil.numValidateTwo(a[d+3],a[d+4]),k=parseInt(a[d+5]),d=parseInt(a[d+6]),n=b+k*d-1;
...
b):(b.hasOwnProperty("w")&&(vApp[app].localCanvas.width=b.w,vApp[app].localCanvas.height=b.h),vApp[app].drawImages(a))}vApp.previous=vApp[app].id}}};d.screenShare=function(a){vApp.getSceenFirefox=function(){var a=parseInt(d.navigator.userAgent.match(/Firefox\/(.*)/)[1],10);33<=a?(constraints={video:{mozMediaSource:"window",mediaSource:"window"}},vApp.adpt=new vApp.adapter,navigator2=vApp.adpt.init(navigator),navigator2.getUserMedia(constraints,function(a,b){vApp.ss._init();vApp.ss.initializeRecorder.call(vApp.ss,
a);if("undefined"==typeof b)var g=a.currentTime,k=d.setInterval(function(){a||d.clearInterval(k);if(a.currentTime==g&&(d.clearInterval(k),a.onended))a.onended();g=a.currentTime},500)},function(a){"string"==typeof a?"PERMISSION_DENIED"===a&&d.open("https://addons.mozilla.org/en-US/firefox/addon/ff_screenshare/").focus():"object"==typeof a&&"PermissionDeniedError"===a.name&&d.open("https://addons.mozilla.org/en-US/firefox/addon/ff_screenshare/").focus()})):alert(vApp.lang.getString("notSupportBrowser",
[a]))};return{prevStream:!1,init:function(a){this.type=a.type;this.ssByClick=!0;this.manualStop=!1;"t"!=vApp.gObj.uRole||vApp.recorder.recImgPlay?this._init():this.readyTostart(a.app)},_init:function(){vApp.previous!=a.id&&(document.getElementById(vApp.previous).style.display="none",vApp.previous=a.id);var b=document.getElementById(a.id);null!=b&&(b.style.display="block");if(!this.hasOwnProperty("id")){this.dc=vApp.dirtyCorner;this.postFix="Cont";this.id=a.hasOwnProperty("id")?a.id:"vAppScreenShare";
this.className="vmApp";this.label="Local";this.local=this.id+this.label;this.localTemp=this.id+this.label+"Temp";this.classes=a.hasOwnProperty("class")?a.classes:"";this.initPrevImage();b=document.getElementById(this.id);null!=b&&b.parentNode.removeChild(b);var b=this.html.UI.call(this,vApp.gObj.uRole),c=document.getElementById(vApp.rWidgetConfig.id);document.getElementById(vApp.html.id).insertBefore(b,c);"t"!=vApp.gObj.uRole||vApp.recorder.recImgPlay||vApp.vutil.initLocCanvasCont(this.localTemp+
...
"";this.localtempCont.clearRect(0,0,this.localtempCanvas.width,this.localtempCanvas.height);clearInterval(vApp.clear);this.initPrevImage();this.hasOwnProperty("currentStream")&&this.currentStream.stop();vApp.virutalclass.vutil.beforeSend({unshareScreen:!0,st:this.type})},removeStream:function(){vApp.vutil.removeClass("audioWidget","fixed");this.localCont.clearRect(0,0,this.localCanvas.width,this.localCanvas.height)},initializeRecorder:function(a){vApp.vutil.addClass("audioWidget","fixed");changeonresize=
1;resizecalled=0;this.prevStream&&(this.ssByClick=!1);"undefined"!=typeof vApp.prevScreen&&vApp.prevScreen.hasOwnProperty("currentStream")&&vApp.prevScreen.unShareScreen();this.video=document.getElementById(this.local+"Video");if("VIDEO"!=this.video.tagName){var c=this.video,f=document.createElement("video");f.id=c.id;this.video.parentNode.replaceChild(f,this.video);this.video=document.getElementById(this.local+"Video");this.video.autoplay=!0;vApp.vutil.createLocalTempVideo("vAppScreenShare",this.local+
"Temp");vApp.vutil.initLocCanvasCont(this.local+"TempVideo")}this.currentStream=a;var g=this;console.log("video changed");vApp.adpt.attachMediaStream(this.video,a);this.prevStream=!0;this.currentStream.onended=function(a){g.ssByClick?(g.video.src="",g.localtempCont.clearRect(0,0,g.localtempCanvas.width,g.localtempCanvas.height),clearInterval(vApp.clear),g.initPrevImage(),vApp.virutalclass.vutil.beforeSend({unshareScreen:!0,st:g.type}),g.prevStream=!1,g.prevScreen="",vApp.prevScreen=""):g.ssByClick=!0};a=
{};a.width=d.innerWidth;a.height=d.innerHeight-140;var c=document.getElementById(this.local),k=this.html.getDimension(a);c.style.width=Math.round(k.width)+"px";c.style.height=Math.round(k.height)+"px";g=this;this.video.onloadedmetadata=function(){g.width=k.width;g.height=k.height;g.localtempCanvas.width=g.video.offsetWidth;g.localtempCanvas.height=g.video.offsetHeight;vApp.prevScreen=g;var a=vApp.system.measureResoultion({width:d.innerWidth,height:d.innerHeight});g.sharing();vApp.vutil.setContainerWidth(a);
"t"==vApp.gObj.uRole&&vApp.vutil.makeActiveApp(g.id,vApp.prevApp);vApp.prevApp=g.id}},sharing:function(){function a(b,c){for(var f=b.toString(),d=f.length;d<c;d++)f="0"+f;return f.match(/[\S]{1,2}/g)||[]}function c(){clearInterval(vApp.clear);if("undefined"!=typeof prvVWidth&&"undefined"!=typeof prvVHeight){if(prvVWidth!=n.video.offsetWidth||prvVHeight!=n.video.offsetHeight)changeonresize=1}else prvVWidth=n.video.offsetWidth,prvVHeight=n.video.offsetHeight;1==changeonresize?setTimeout(g,2E3):k(n.type)}
function f(a){p=400>=a||"undefined"==typeof a?400:1E4<=a?a/2:a;4*q<p&&(p=4*q);400<p&&console.trace();q=p}function g(){console.log("RESIZE");prvVWidth=n.video.offsetWidth;prvVHeight=n.video.offsetHeight;h=Math.round(n.localtempCanvas.height/12);m=Math.round(n.localtempCanvas.width/12);var g=n.type;n.localtempCanvas.width=n.video.offsetWidth;n.localtempCanvas.height=n.video.offsetHeight;n.localtempCont.drawImage(n.video,0,0,n.video.offsetWidth,n.video.offsetHeight);var k=n.localtempCont.getImageData(0,
0,n.localtempCanvas.width,n.localtempCanvas.height),k=n.dc.encodeRGB(k.data),q=Math.round(n.localtempCanvas.width/m),v=Math.round(n.localtempCanvas.height/h),w=n.getContainerDimension();if("undefined"!=typeof prvVWidth&&"undefined"!=typeof prvVHeight)var x=a(prvVWidth,4),z=a(prvVHeight,4),A=a(w.width,4);else x=a(n.video.offsetWidth,4),z=a(n.video.offsetHeight,4),A=a(w.width,4);w=a(w.height,4);g=new Uint8ClampedArray(["ss"==g?104:204,x[0],x[1],z[0],z[1],A[0],A[1],w[0],w[1]]);x=new Uint8ClampedArray(k.length+
g.length);x.set(g);x.set(k,g.length);d.Worker&&sworker.postMessage({img:k,resize:1,resA:h,resB:m,dw:q,dh:v,offsetWidth:n.video.offsetWidth,offsetHeight:n.video.offsetHeight},[k.buffer]);io.sendBinary(x);f(x.length/128);changeonresize=0;clearInterval(vApp.clear);vApp.clear=setInterval(c,p)}function k(a){n.localtempCanvas.width=n.video.offsetWidth;n.localtempCanvas.height=n.video.offsetHeight;n.localtempCont.drawImage(n.video,0,0,n.video.offsetWidth,n.video.offsetHeight);a=Math.round(n.localtempCanvas.width/
m);var b=Math.round(n.localtempCanvas.height/h),g=n.localtempCont.getImageData(0,0,n.video.offsetWidth,n.video.offsetHeight);d.Worker&&(sworker.postMessage({img:g.data,resA:h,resB:m,dw:a,dh:b,offsetWidth:n.video.offsetWidth,offsetHeight:n.video.offsetHeight,type:n.type},[g.data.buffer]),sworker.onmessage=function(a){if(1==a.data.needFullScreen){a=vApp.getDataFullScreen(n.type);io.sendBinary(a);var b=a.length/128}else null!=a.data.masterSlice&&(io.sendBinary(a.data.masterSlice),b=a.data.masterSlice.length/
128);f(b)});clearInterval(vApp.clear);vApp.clear=setInterval(c,p)}var h=Math.round(this.localtempCanvas.height/12),m=Math.round(this.localtempCanvas.width/12),n=this;randomTime=Math.floor(10001*Math.random())+5E3;vApp.hasOwnProperty("wholeImage")&&clearInterval(vApp.wholeImage);vApp.hasOwnProperty("clear")&&clearInterval(vApp.clear);var p=1E3,q=1E3;vApp.getDataFullScreen=function(c){n.localtempCanvas.width=n.video.offsetWidth;n.localtempCanvas.height=n.video.offsetHeight;n.localtempCont.drawImage(n.video,
0,0,n.video.offsetWidth,n.video.offsetHeight);var f=n.localtempCont.getImageData(0,0,n.localtempCanvas.width,n.localtempCanvas.height),f=n.dc.encodeRGB(f.data),d=a(n.localtempCanvas.height,4),g=a(n.localtempCanvas.width,4);c=new Uint8ClampedArray(["ss"==c?102:202,g[0],g[1],d[0],d[1]]);d=new Uint8ClampedArray(f.length+c.length);d.set(c);d.set(f,c.length);return d};clearInterval(vApp.clear);vApp.clear=setInterval(c,p)},getContainerDimension:function(){var a=document.getElementById(this.id+"Local");
return{width:a.offsetWidth,height:a.offsetHeight}},drawImages:function(a,c){if("undefined"!=typeof c){var f=this.dc.decodeRGBSlice(a,this.localCont,c);this.localCont.putImageData(f,c.x,c.y)}else f=this.dc.decodeRGB(a,this.localCont,this.localCanvas),this.localCont.putImageData(f,0,0)},drawSingleImage:function(a){a=this.dc.decodeRGB(a,this.localCont,this.localCanvas);this.localCont.putImageData(a,0,0)},dimensionStudentScreen:function(a,c){this.localCanvas=document.getElementById(vApp[app].local+"Video");
this.localCont=vApp[app].localCanvas.getContext("2d");this.localCanvas.width=a;this.localCanvas.height=c;console.log("normal width "+this.localCanvas.width)},dimensionStudentScreenResize:function(a,c){this.hasOwnProperty("vac")||(this.vac=!0,this.localCanvas=document.getElementById(vApp[app].local+"Video"),this.localCont=vApp[app].localCanvas.getContext("2d"));a.hasOwnProperty("d")&&(this.localCont.clearRect(0,0,this.localCanvas.width,this.localCanvas.height),this.localCanvas.width=a.d.w,this.localCanvas.height=
a.d.h);if(a.hasOwnProperty("vc")){var f=document.getElementById(vApp[app].local);f.style.width=a.vc.w+"px";f.style.height=a.vc.h+"px"}"vAppWhiteboard"!=vApp.previous&&vApp.vutil.setScreenInnerTagsWidth(vApp.previous)},html:{UI:function(a){var c=vApp.vutil.createDOM("div",this.id,[this.className]),f=vApp.vutil.createDOM("div",this.local,[this.label]);if("t"==a){if(vApp.recorder.recImgPlay)var d=vApp.vutil.createDOM("canvas",this.local+"Video");else d=vApp.vutil.createDOM("video",this.local+"Video"),
d.setAttribute("autoplay",!0);f.style.cssText+=";position:relative"}else d=vApp.vutil.createDOM("canvas",this.local+"Video");f.appendChild(d);c.appendChild(f);"t"!=a||vApp.recorder.recImgPlay||vApp.vutil.createLocalTempVideo(c,this.localTemp);return c},getDimension:function(a,c){return{height:a.height,width:a.width}}},initPrevImage:function(){sworker.postMessage({initPrevImg:!0})}}}})(window);(function(d){d.recorder={items:[],recImgPlay:!1,init:function(a){function b(){f.objs=vApp.recorder.items;f.objNo=0;f.repMode=a;f.callBkfunc="";vApp.ss="";vApp.wss="";var b=document.getElementById("vApp"+vApp.apps[1]);null!=b&&b.parentNode.removeChild(b);setTimeout(function(){vApp.recorder.renderObj()},f.objs[0].mt-vApp.wb.pageEnteredTime)}var c=vApp.wb.vcan;"undefined"!=typeof myfunc?this.objs=c.getStates("replayObjs"):vApp.storage.getAllObjs(["allData"],b);var f=this;setTimeout(function(){"undefined"!=
...
b=b.hasOwnProperty("mtext")?{detail:{cevent:{x:b.x,y:b.y,mtext:b.mtext}}}:{detail:{cevent:{x:b.x,y:b.y}}};this.objs[this.objNo].hasOwnProperty("uid")&&(vApp.wb.gObj.displayedObjId=this.objs[this.objNo].uid,a=new CustomEvent(a,b),vcan.main.canvas.dispatchEvent(a))}if("object"==typeof this.objs[this.objNo+1]){"undefined"!=typeof this.repMode&&"fromBrowser"==this.repMode?vApp.wb.replayTime=0:this.objs[this.objNo].hasOwnProperty("beforeRefresh")?vApp.wb.replayTime=this.objs[this.objNo+1].mt-this.objs[this.objNo+
...
JSON.parse(a.value.repObjs);vApp.wb.utility.replayFromLocalStroage(b)}else a.value.hasOwnProperty("audiostream")?(b=JSON.parse(a.value.audiostream),vApp.gObj.video.audio.assignFromLocal(b)):a.value.hasOwnProperty("recObjs")&&vApp.recorder.items.push(JSON.parse(a.value.recObjs));a["continue"]()}}}})(window);(function(d,a){d.user=function(b){return{assignRole:function(b,f){"t"==b&&(vApp.html.leftAppBar(),vApp.attachFunction(),a.getElementById("vAppOptionsCont"),d.vApp.wb.attachToolFunction(vcan.cmdWrapperDiv,!0),"Whiteboard"==f&&"t"==vApp.gObj.uRole&&(vApp.hasOwnProperty("prevApp")?vApp.vutil.makeActiveApp("vApp"+f,vApp.prevApp):vApp.vutil.makeActiveApp("vApp"+f),vApp.wb.utility.makeCanvasEnable()))},teacherIsAlreadyExist:function(){for(var b=a.getElementById("chat_div").getElementsByClassName("ui-memblist-usr"),
...
(vApp[h].hasOwnProperty("currentStream")&&vApp[h].currentStream.stop(),vApp[h]="");"undefined"==typeof d&&vApp.virutalclass.vutil.beforeSend({assignRole:!0,toUser:b});null==localStorage.getItem("orginalTeacherId")&&("undefined"==typeof g&&(g=b),b=a.getElementById(g+"ControlContainer").getElementsByClassName("controleCont")[0],b.removeChild(b.firstChild))},_chat:function(a,b){"enable"==b?vApp.virutalclass.vutil.beforeSend({enc:!0,toUser:a}):(vApp.user.control.updateUser(a,"ch",!1),vApp.virutalclass.vutil.beforeSend({dic:!0,
toUser:a}))},_audio:function(a,b){"enable"==b?vApp.virutalclass.vutil.beforeSend({ena:!0,toUser:a}):vApp.virutalclass.vutil.beforeSend({dia:!0,toUser:a})},audioWidgetEnable:function(){localStorage.setItem("audEnable","true");var b=a.getElementById("audioWidget");b.className="active";b.style.opacity="1";b.style.pointerEvents="visible"},audioWidgetDisable:function(){localStorage.setItem("audEnable","false");var b=a.getElementById("audioWidget");b.style.opacity="0.5";b.style.pointerEvents="none";b.className="deactive";
b=a.getElementById("speakerPressing");vApp.gObj.hasOwnProperty("video")&&(vApp.gObj.video.audio.studentNotSpeak(b),vApp.gObj.video.audio.clickOnceSpeaker("speakerPressOnce","alwaysDisable"))},allChatDisable:function(){localStorage.setItem("chatEnable","false");this.disableCommonChat();this.disbaleAllChatBox();this.disableOnLineUser()},disableCommonChat:function(){var b=a.getElementById("chatrm");null!=b&&this.makeElemDisable(b)},disbaleAllChatBox:function(){for(var b=a.getElementById("stickybar").getElementsByClassName("ui-chatbox"),
...
if(c.userid==io.cfg.userid&&"undefined"!=typeof a&&"removed"!=a){var d=document.getElementById("video"+c.userid);vApp.gObj.hasOwnProperty("audIntDisable")||vApp.gObj.hasOwnProperty("vidIntDisable")||null!=d||vApp.gObj.video._handleUserMedia(c.userid)}vApp.gObj.video.addUserRole(c.userid,c.role)})):$("div#memlist").length&&$("div#memlist").remove()}
