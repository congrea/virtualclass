...
f,d=0;d<b.length;d++)if(f=b[d].getAttribute("data-role"),"t"==f)return!0;return!1},createControl:function(b,f){var d=a.createElement("div");d.id=b+"ControlContainer";d.className="controls";this.createControlDivs(d,b,f);return d},createAssignControl:function(b,f,d,k){var h=this,m=a.createElement("span");m.id=f+"contrAssignImg";m.innerHTML="&nbsp;";var n=a.createElement("a");n.id=f+"contrAssignAnch";n.className="tooltip";n.appendChild(m);var p=a.createElement("div");p.id=f+"contrAssignCont";p.className=
"controleCont";p.appendChild(n);n=a.getElementById(f+"ControlContainer");null!=n?0>=n.getElementsByClassName("controleCont").length?n.appendChild(p):n.insertBefore(p,n.firstChild):b.appendChild(p);vApp.user.control.changeAttribute(f,m,d,"assign","aRole");"undefined"!=typeof k&&(m.className+=" currTeacher");m.addEventListener("click",function(){h.control.init.call(h,m)})},createControlDivs:function(b,f,d){var k=this,h=!1,m=localStorage.getItem("vApp"+f);if(null!=m&&(h=!0,m=JSON.parse(m),m.hasOwnProperty("currTeacher")&&
m.currTeacher))var n=!0;var p=localStorage.getItem("reclaim"),p=null!=p&&p?!1:!0,q=vApp.vutil.userIsOrginalTeacher(f);vApp.vutil.isUserTeacher(f);for(var r=0;r<d.length;r++)if("assign"==d[r]&&q)"undefined"!=typeof n?this.createAssignControl(b,f,p,n):this.createAssignControl(b,f,p);else if("audio"==d[r]){var u=a.createElement("span");imgName="contrAud";u.id=f+imgName+"Img";u.innerHTML="&nbsp;";var s=a.createElement("a");s.id=f+imgName+"Anch";s.className="tooltip";s.appendChild(u);var v=a.createElement("div");
v.id=f+imgName+"Cont";v.className="controleCont";v.appendChild(s);b.appendChild(v);v=h&&m.hasOwnProperty("aud")?m.aud?!0:!1:!0;vApp.user.control.changeAttribute(f,u,v,"audio","aud");q&&u.addEventListener("click",function(){k.control.init.call(k,u)})}else if("chat"==d[r]){var w=a.createElement("span");imgName="contrChat";w.id=f+imgName+"Img";w.innerHTML="&nbsp;";s=a.createElement("a");s.id=f+imgName+"Anch";s.className="tooltip";s.appendChild(w);v=a.createElement("div");v.id=f+imgName+"Cont";v.className=
"controleCont";v.appendChild(s);b.appendChild(v);q&&w.addEventListener("click",function(){k.control.init.call(k,w)});v=h&&m.hasOwnProperty("ch")?m.ch?!0:!1:!0;vApp.user.control.changeAttribute(f,w,v,"chat","ch")}},control:{addCurrTeacherToControl:function(b){var f=a.getElementById(b);null!=f&&(vApp.vutil.elemHasAnyClass(b)?f.classList.add("currTeacher"):f.className="currTeacher")},removeCurrTeacherFromControl:function(b){var f=a.getElementById(b);vApp.vutil.elemHasAnyClass(b)&&(f.classList.remove("currTeacher"),
f=b.indexOf("contr"),b=b.substring(0,f),vApp.user.control.updateUser(b,"currTeacher",!1))},disable:function(b,f,d,k){d=a.getElementById(b+"contr"+d+"Img");vApp.user.control._disable(d,f,b,k)},_disable:function(a,b,d,k){a.parentNode.setAttribute("data-title",vApp.lang.getString(b+"Enable"));a.setAttribute("data-"+b+"-disable","true");a.className="audio"==b?"icon-"+b+"DisImg block "+b+"DisImg":"icon-"+b+"Img block "+b+"Img";"assign"==b&&(a.parentNode.classList.remove("tooltip"),this.addCurrTeacherToControl(a.id),
vApp.user.control.updateUser(d,"currTeacher",!0));vApp.user.control.updateUser(d,k,!1)},enable:function(b,f,d,k){d=a.getElementById(b+"contr"+d+"Img");vApp.user.control._enable(d,f,b,k)},_enable:function(a,b,d,k){a.parentNode.setAttribute("data-title",vApp.lang.getString(b+"Disable"));a.setAttribute("data-"+b+"-disable","false");a.className="icon-"+b+"Img enable "+b+"Img";vApp.user.control.updateUser(d,k,!0)},changeAttribute:function(a,b,d,k,h){d?vApp.user.control._enable(b,k,a,h):vApp.user.control._disable(b,
k,a,h)},init:function(a){var b=a.id,d=b.indexOf("contr"),d=b.substring(0,d),b=b.split("contr")[1],k=b.indexOf("Img"),b=b.substring(0,k);"Assign"==b?(b="true"==a.getAttribute("data-assign-disable")?!0:!1,b||(this.control.changeAttribute(d,a,b,"assign","aRole"),vApp.user.control._assign(d),vApp.user.control.changeAttrToAssign("block"))):"Chat"==b?("true"==a.getAttribute("data-chat-disable")?(a.className="contrChatBlock",b="enable",this.control.changeAttribute(d,a,!0,"chat","ch")):(b="block",this.control.changeAttribute(d,
a,!1,"chat","ch")),this.control._chat(d,b)):"Aud"==b&&("true"==a.getAttribute("data-audio-disable")?(b="enable",this.control.changeAttribute(d,a,!0,"audio","aud")):(b="block",this.control.changeAttribute(d,a,!1,"audio","aud")),this.control._audio(d,b))},_assign:function(b,d,g){vApp.wb.utility.assignRole();vApp.vutil.removeAppPanel();if(!vApp.vutil.chkValueInLocalStorage("orginalTeacherId")){var k=a.getElementById("vcanvas");k.className=k.className.replace(/\bteacher\b/," ");k.className="student"}localStorage.setItem("canvasDrwMsg",
!0);k=a.getElementById("vAppScreenShareLocalVideo");null!=k&&"VIDEO"==k.tagName&&vApp.vutil.videoTeacher2Student("ScreenShare",!0);var h;"ScreenShare"==vApp.currApp&&(h="ss");"Whiteboard"!=vApp.currApp&&(vApp[h].hasOwnProperty("currentStream")&&vApp[h].currentStream.stop(),vApp[h]="");"undefined"==typeof d&&vApp.wb.utility.beforeSend({assignRole:!0,toUser:b});null==localStorage.getItem("orginalTeacherId")&&("undefined"==typeof g&&(g=b),b=a.getElementById(g+"ControlContainer").getElementsByClassName("controleCont")[0],
b.removeChild(b.firstChild))},_chat:function(a,b){"enable"==b?vApp.wb.utility.beforeSend({enc:!0,toUser:a}):(vApp.user.control.updateUser(a,"ch",!1),vApp.wb.utility.beforeSend({dic:!0,toUser:a}))},_audio:function(a,b){"enable"==b?vApp.wb.utility.beforeSend({ena:!0,toUser:a}):vApp.wb.utility.beforeSend({dia:!0,toUser:a})},audioWidgetEnable:function(){localStorage.setItem("audEnable","true");var b=a.getElementById("audioWidget");b.className="active";b.style.opacity="1";b.style.pointerEvents="visible"},
audioWidgetDisable:function(){localStorage.setItem("audEnable","false");var b=a.getElementById("audioWidget");b.style.opacity="0.5";b.style.pointerEvents="none";b.className="deactive";b=a.getElementById("speakerPressing");vApp.gObj.video.audio.studentNotSpeak(b);vApp.gObj.video.audio.clickOnceSpeaker("speakerPressOnce","alwaysDisable")},allChatDisable:function(){localStorage.setItem("chatEnable","false");this.disableCommonChat();this.disbaleAllChatBox();this.disableOnLineUser()},disableCommonChat:function(){var b=
