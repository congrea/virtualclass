...
screenshare:"Screen Share",sessionend:"Session End",audioTest:"Kindly speak some words for audio testing",chatEnable:"Chat is on",chatDisable:"Chat Disabled",assignEnable:"Transfer Controls",assignDisable:"Reclaim Role",audioEnable:"Audio Enabled",audioDisable:"Audio Disabled",audioOn:"Audio on",minCommonChat:"Hide Common Chat",maxCommonChat:"Show Common Chat",miniuserbox:"Hide User Box",maxuserbox:"Show User Box",miniUserList:"Show User List",maxUserList:"Hide User List",startnewsession:"Do you want start a new session with ending current session?",
DevicesNotFoundError:"You may not have Webcam(camera/microphone).",PermissionDeniedError:"You denied to access your Webcam.",PERMISSION_DENIED:"You denied to access your Webcam(camera/microphone).",notSupportBrowser:"Firefox {vApp1} does not support Screen sharing.",disableSpeaker:"Disable Audio",enableSpeaker:"Enable Audio",notSupportChrome:"Your browser {vapp1} {vapp2} needs to updated, We support Chrome 40",errcanvas:"canvas",errwebSocket:"Web Socket",errgetusermedia:"getUserMedia",errindexeddb:"indexedDb",
errwebworker:"Web worker",errwebaudio:"Web audio",errtypedarray:"Typed array",errscreenshare:"Screen share",operaBrowserIssue:"Your browser {vapp1} {vapp2} is partially supported. You will not be able to share your screen with Learners, We fully support chrome and Firefox",commonBrowserIssue:"Your browser {vapp1} {vapp2} is not supported, We support Chrome and Firefox.",chFireBrowsersIssue:"Your browser {vapp1} {vapp2}  needs to updated, We support Chrome 40 and Firefox 35.",studentSafariBrowserIssue:"Your browser {vApp1} does not able to share your Cam with other users, We fully support Chrome  and Firefox.",
ieBrowserIssue:"Your browser Internet Explorer is not supported, We fully support Chrome  and Firefox.",ios7support:"We support only iOS 7 (Apple operating system 7) or higher.",supportDesktop:"For teacher we support desktop computer only not any tablet and mobile phone.",notSupportIphone:"We support iPad, Tablet or Desktop coputer, not any Mobile phone"}})(window);(function(d){d.getString=function(a,b){var c=d.vApp.lang.message[a];if("undefined"!=typeof b&&0<b.length)for(var f=0;f<b.length;f++)c=c.replace(new RegExp("{vapp"+(f+1)+"}"),b[f]);return c}})(window);(function(d){var a={init:function(){this.msgBoxClass="msgBox";this.window={};this.virtualWindow={};return this},displayMessage:function(a,c,f,g,d){a="undefined"==typeof d?this.createMsgBox(a,c,f):this.createMsgBox(a,c,f,d);c=document.getElementById("vcanvas");"undefined"!=typeof g?document.getElementById(g).appendChild(a):c.insertBefore(a,c.childNodes[0])},createErrorContainerToBeDeleted:function(){var a=document.getElementById("errorContainer");if(null==a){a=document.createElement("div");a.id="errorContainer";
