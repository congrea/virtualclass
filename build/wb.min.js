...
typeof virtualclass.wb)if(virtualclass.wb.tool.hasOwnProperty("started")&&!0==virtualclass.wb.tool.started||"move"==virtualclass.wb.vcan.main.action){var d=virtualclass.wb.vcan.main.replayObjs[virtualclass.wb.vcan.main.replayObjs.length-1];d.ac="u";d=d.hasOwnProperty("mtext")?{detail:{cevent:{x:d.x,y:d.y,mtext:d.mtext}}}:{detail:{cevent:{x:d.x,y:d.y}}};d.detail.broadCast=!0;d=new CustomEvent("mouseup",d);vcan.main.canvas.dispatchEvent(d)}else"t_text"==virtualclass.wb.tool.cmd&&virtualclass.wb.obj.drawTextObj.finalizeTextIfAny();
virtualclass.user.control._assign(b,"notsent",a);virtualclass.user.displayStudentSpeaker(!0);null!=localStorage.getItem("aId")&&localStorage.removeItem("aId");virtualclass.user.control.removeAudioFromParticipate(a);"mobTab"==virtualclass.system.device&&((virtualclass.system.mybrowser.name=8<=virtualclass.system.mybrowser.version)&&/(iPad)/g.test(navigator.userAgent)&&virtualclass.vutil.enableVirtualClass(),virtualclass.view.removeErrorMsg("errorContainer",!0))}},createReclaimButtonIfNeed:function(){if(roles.isEducator()){var a=
