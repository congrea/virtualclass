...
DevicesNotFoundError:"You may not have Webcam(camera/microphone).",PermissionDeniedError:"You denied to access your Webcam.",PERMISSION_DENIED:"You denied to access your Webcam(camera/microphone).",notSupportBrowser:"Not supported screen sharing for this version of browser",disableSpeaker:"Disable Audio",enableSpeaker:"Enable Audio",notSupportChrome:"Your browser {Browser Version} needs to updated, We support Chrome 40",errcanvas:"canvas",errwebSocket:"Web Socket",errgetusermedia:"getUserMedia",errindexeddb:"indexedDb",
errwebworker:"Web worker",errwebaudio:"Web audio",errtypedarray:"Typed array",errscreenshare:"Screen share",operaBrowserIssue:"is Partially Supported, you will not be able to share your screen with Learners, We Fully Support Chrome and Firefox",commonBrowserIssue:"is not supported, We support Chrome and Firefox.",chFireBrowsersIssue:" needs to updated, We support Chrome 40 and Firefox 35.",studentSafariBrowserIssue:"does not able to share your Cam with other Users, We Fully Support Chrome  and Firefox.",
ieBrowserIssue:"Internet Explorer is not supported, We Fully Support Chrome  and Firefox."}})(window);(function(d){d.getString=function(a){return d.vApp.lang.message[a]}})(window);(function(d){var a={init:function(){this.msgBoxClass="msgBox";this.window={};this.virtualWindow={};return this},displayMessage:function(a,c,f,g,d){a="undefined"==typeof d?this.createMsgBox(a,c,f):this.createMsgBox(a,c,f,d);c=document.getElementById("vcanvas");"undefined"!=typeof g?document.getElementById(g).appendChild(a):c.insertBefore(a,c.childNodes[0])},createErrorContainerToBeDeleted:function(){var a=document.getElementById("errorContainer");if(null==a){a=document.createElement("div");a.id="errorContainer";
...
a);return g.id},removeErrorContainer:function(a){a=document.getElementById(a);a.parentNode.removeChild(a)},customCreateElement:function(a,c,f){a=document.createElement(a);"undefined"!=typeof c&&(a.id=c);"undefined"!=typeof f&&(a.className=f);return a},createMsgBox:function(a,c,f,g){var d=this.customCreateElement("div",c,f);"undefined"==typeof g&&(f=this.customCreateElement("div",c+"img",f+"img"),d.appendChild(f));c=this.customCreateElement("p",c+"Para");c.innerHTML=a;d.appendChild(c);return d},disappearBox:function(a){a=
document.getElementsByClassName(this.msgBoxClass+a);null!=a[0]&&a[0].parentNode.removeChild(a[0])},multiMediaMsg:function(a){if("Firefox"==vApp.system.mybrowser.name){var c=vApp.lang.getString("wbrtcMsgFireFox");this.displayMessage(c,"fireFoxWebrtcCont",this.msgBoxClass+a)}else"Chrome"==vApp.system.mybrowser.name&&(c=vApp.lang.getString("wbrtcMsgChrome"),this.displayMessage(c,"chormeWebrtcCont",this.msgBoxClass+a))},canvasDrawMsg:function(a){document.getElementById("vcanvas").className="canvasMsgBoxParent";
if("Firefox"==vApp.system.mybrowser.name){var c=vApp.lang.getString("canvasDrawMsg");this.displayMessage(c,"canvasDrawMsgContFirefox",this.msgBoxClass+a,"containerWb")}else"Chrome"==vApp.system.mybrowser.name&&(c=vApp.lang.getString("canvasDrawMsg"),this.displayMessage(c,"canvasDrawMsgContChrome",this.msgBoxClass+a,"containerWb"))},drawLabel:function(a){var c=vApp.lang.getString("drawArea");this.displayMessage(c,"canvasDrawArea",this.msgBoxClass+a,"containerWb",!1)},displayMsgBox:function(a,c){var f=
this.customCreateElement("div",a),g=this.customCreateElement("p",a+"Para");g.innerHTML=vApp.lang.getString(c);f.appendChild(g);g=this.customCreateElement("a",a+"Anchor");g.href=d.location;g.innerHTML=vApp.lang.getString("reload");g.onclick=function(){d.location.reload()};f.appendChild(g);g=document.getElementById("vAppCont");g.insertBefore(f,g.firstChild)},displayServerError:function(a,c){var f=this.customCreateElement("div",a);f.innerHTML=c;var g=document.getElementById("vcanvas");g.parentNode.insertBefore(f,
g)},removeElement:function(a){a=document.getElementById(a);null!=a&&a.parentNode.removeChild(a)},disableSSUI:function(){var a=document.getElementById("vAppScreenShareTool");null!=a&&(a.style.opacity="0.5",a.style.pointerEvents="none")},disableLeftAppBar:function(){var a=document.getElementById("vAppOptionsCont");null!=a&&(a.style.opacity="0.5",a.style.pointerEvents="none")}},a=a.init();count=0;a.window.resizeFinished=function(){var a=0;return function(c,f){clearTimeout(a);a=setTimeout(c,f)}}();a.window.resize=
function(){var a=vApp.system.measureResoultion({width:d.innerWidth,height:d.innerHeight});vApp.vutil.setContainerWidth(a);vcan.renderAll()};a.virtualWindow.manupulation=function(a){var c=a.message.virtualWindow;if(c.hasOwnProperty("removeVirtualWindow"))a.fromUser.userid!=wbUser.id&&vApp.wb.utility.removeVirtualWindow("virtualWindow");else if(c.hasOwnProperty("createVirtualWindow"))c.hasOwnProperty("toolHeight")&&localStorage.setItem("toolHeight",c.toolHeight),a.fromUser.userid!=wbUser.id&&vApp.wb.utility.createVirtualWindow(c.createVirtualWindow);
else if(c.hasOwnProperty("shareBrowserWidth")){c.hasOwnProperty("toolHeight")&&localStorage.setItem("toolHeight",c.toolHeight);if(null!=localStorage.getItem("teacherId")){var f=vApp.wb.utility.getWideValueAppliedByCss("commandToolsWrapper");localStorage.setItem("toolHeight",f)}a.fromUser.userid!=wbUser.id?(null!=localStorage.getItem("teacherId")&&vApp.wb.utility.makeCanvasEnable(),otherBrowser=c.browserRes):myBrowser=vApp.system.measureResoultion({width:d.outerWidth,height:d.innerHeight});"object"==
typeof myBrowser&&"object"==typeof otherBrowser&&(myBrowser.width>otherBrowser.width?vApp.wb.gObj.virtualWindow||(vApp.wb.utility.createVirtualWindow(otherBrowser),vApp.wb.gObj.virtualWindow=!0):myBrowser.width<otherBrowser.width&&!vApp.wb.gObj.virtualWindow&&(a=document.getElementById("vcanvas"),a=vApp.wb.utility.getElementRightOffSet(a),null!=localStorage.getItem("teacherId")?vApp.wb.utility.beforeSend({virtualWindow:{createVirtualWindow:myBrowser-a,toolHeight:f}}):vApp.wb.utility.beforeSend({virtualWindow:{createVirtualWindow:myBrowser-
a}})))}};d.view=a})(window);(function(d){var a={init:function(){this.wbRtc={};this.wbRtc.className="webrtcCont";this.mybrowser={};return this},isCanvasSupport:function(a,c,f){return"MSIE"==c?9!=f?!1:!0:d.CanvasRenderingContext2D?!0:!1},isWebSocketSupport:function(a,c,f){return"undefined"==typeof d.WebSocket||"function"!=typeof d.WebSocket&&"object"!=typeof d.WebSocket||!d.WebSocket.hasOwnProperty("OPEN")?!1:!0},isLocalStorageSupport:function(){return void 0!==Storage?!0:!1},isGetUserMediaSupport:function(a,c){navigator.getUserMedia=
...
[0,""])[1]).replace("undefined","3_2").replace("_",".").replace("_",""))||!1},isAndroid:function(){return-1<navigator.userAgent.toLowerCase().indexOf("android")},check:function(){var a=this.isiOSDevice();if(a)var c="safariMobile",f=a;else{var g=this.isAndroid(),f=this.mybrowser.detection(),c=f[0],f=parseFloat(f[1]);this.mybrowser.name=c;this.mybrowser.version=f}this.checkBrowserFunctions(c,f);"undefined"!=typeof g&&g||a?"t"==vApp.gObj.uRole?(vApp.vutil.initDisableVirtualClass(),vApp.error.push("We support only desktop computer not  any tablet and mobile for teacher.")):
g&&("Chrome"==c?40<=f?vApp.vutil.initDisableAudVid():vApp.error.push(c+" "+f+"  is not supported, we support chrome  versoin 40 or newer on Android"):vApp.error.push(c+"  is not supported, we support Chrome 40 or newer on andorid")):"Chrome"==c&&40<=f||"Firefox"==c&&35<=f||"s"==vApp.gObj.uRole&&c=="OPR">f>=26?this.reportBrowser(vApp.gObj.uRole):"Chrome"==c&&40>f||"Firefox"==c&&35>f||"s"==vApp.gObj.uRole&&"OPR"==c&&26>f?(this.reportBrowser(vApp.gObj.uRole),vApp.error.push(c+" "+f+vApp.lang.getString("chFireBrowsersIssue"))):
"t"==vApp.gObj.uRole&&"OPR"==c&&26<=f?(this.reportBrowser(vApp.gObj.uRole),vApp.error.push(c+" "+f+" "+vApp.lang.getString("operaBrowserIssue"))):"s"==vApp.gObj.uRole&&"Safari"==c&&8<=f?(vApp.vutil.initDisableAudVid(),this.reportBrowser(vApp.gObj.uRole),vApp.error.push(c+" "+vApp.lang.getString("studentSafariBrowserIssue")),vApp.user.control.audioWidgetDisable()):"s"==vApp.gObj.uRole&&"safariMobile"==c&&7<=f?vApp.vutil.initDisableAudVid():this.mybrowser.detectIE()?(vApp.gObj.errIE=!0,vApp.error.push(vApp.lang.getString("ieBrowserIssue")),
vApp.vutil.initDisableVirtualClass()):vApp.error.push(c+" "+f+" "+vApp.lang.getString("commonBrowserIssue"))}},a=a.init();d.addEventListener("resize",function(){d.earlierWidth!=d.innerWidth&&a.setAppDimension()});d.addEventListener("resize",function(){d.earlierWidth!=d.innerWidth&&vApp.wb.view.window.resize()});a.mybrowser.detectIE=function(){var a=d.navigator.userAgent,c=a.indexOf("MSIE ");if(0<c)return parseInt(a.substring(c+5,a.indexOf(".",c)),10);if(0<a.indexOf("Trident/"))return c=a.indexOf("rv:"),
...
d.innerHeight+"px"},isSystemCompatible:function(){if(0<vApp.error.length){var a=1<vApp.error.length?vApp.error.join("<br />"):vApp.error[0];vApp.wb.view.createErrorMsg(a,"errorContainer","chatWidget");vApp.gObj.hasOwnProperty("errIE")&&vApp.vutil.disableVirtualClass();vApp.gObj.hasOwnProperty("audIntDisable")&&vApp.user.control.audioWidgetDisable();vApp.gObj.hasOwnProperty("errNotDesktop")&&(vApp.user.control.audioWidgetDisable(),vApp.vutil.disableVirtualClass())}},chkValueInLocalStorage:function(a){return null===
localStorage.getItem(a)?!1:localStorage[a]},setContainerWidth:function(a){var b="vAppWhiteboard";"undefined"!=typeof vApp.previous&&(b=vApp.previous);var c=document.getElementById(b);if("ScreenShare"==vApp.currApp){var f=document.getElementById("vAppOptionsCont");if(null!=f){var d=vcan.utility.getElementOffset(f);leftSideBarWidth=f.offsetWidth+d.x}else leftSideBarWidth=0}else leftSideBarWidth=0;a.width-=5+leftSideBarWidth+0;c.style.width=a.width+"px";"vAppWhiteboard"!=b&&(f=document.getElementById(b+
"Local"),a.width-=10,c.style.width=a.width,f.style.width=a.width+"px",vApp.vutil.setScreenInnerTagsWidth(b))},setScreenInnerTagsWidth:function(a){document.getElementById(a);document.getElementById(a+"Local");document.getElementById(a+"LocalVideo")},makeActiveApp:function(a,b){if("undefined"!=typeof b){b+="Tool";var c=vApp.wb.utility.removeClassFromElement(b,"active");document.getElementById(b).className=c}document.getElementById(a+"Tool").className+=" active"},initInstallChromeExt:function(a){"EXTENSION_UNAVAILABLE"==
a.name&&(console.log("ask for inline installation"),chrome.webstore.install("https://chrome.google.com/webstore/detail/ijhofagnokdeoghaohcekchijfeffbjl",function(a){d.location.reload()},function(a){alert(a)}))},removeAppPanel:function(){var a=document.getElementById("vAppOptionsCont");null!=a&&a.parentNode.removeChild(a)},removeTempVideo:function(a){a=document.getElementById(a);a.parentNode.removeChild(a)},createLocalTempVideo:function(a,b){if("string"==typeof a||"String"==typeof a)a=document.getElementById(a);
var c=vApp.vutil.createDOM("div",b),f=vApp.vutil.createDOM("canvas",b+"Video");c.appendChild(f);a.appendChild(c)},initLocCanvasCont:function(a){var b="ScreenShare"==vApp.currApp?"ss":"wss";vApp[b].localtempCanvas=document.getElementById(a);vApp[b].localtempCont=vApp[b].localtempCanvas.getContext("2d")},videoTeacher2Student:function(a,b){var c=a,f=document.getElementById("vApp"+a+"LocalVideo");if(null!=f&&"VIDEO"==f.tagName){var d=document.createElement("canvas");d.id=f.id;d.width=f.offsetWidth;d.height=
f.offsetHeight;f.parentNode.replaceChild(d,f);"ScreenShare"==c&&(c="ss");"undefined"!=typeof b||"undefined"==typeof c||"ss"!=c&&"wss"!=c||(vApp[c].localCanvas=d,vApp[c].localCont=vApp[c].localCanvas.getContext("2d"),f=vApp[c].localtempCont.getImageData(0,0,vApp[c].localtempCanvas.width,vApp[c].localtempCanvas.height),vApp[c].localCont.putImageData(f,0,0));vApp.vutil.removeTempVideo("vApp"+a+"LocalTemp")}},clickOutSideCanvas:function(){this.exitTextWrapper()&&vApp.wb.obj.drawTextObj.textUtility(vApp.wb.gObj.spx,
vApp.wb.gObj.spy)},exitTextWrapper:function(){return 0<document.getElementsByClassName("textBoxContainer").length?!0:!1},attachClickOutSideCanvas:function(){function a(a){a=document.getElementById(a);null!=a&&(a.onclick=function(){vApp.vutil.clickOutSideCanvas()})}a("commandToolsWrapper");a("vAppOptionsCont");a("audioWidget");a("chatWidget")},dimensionMatch:function(a,b){var c=document.getElementById(a).offsetWidth,f=document.getElementById("vAppOptionsCont").offsetWidth;return document.getElementById(b).offsetWidth+
f==c?!0:!1},disableAppsBar:function(){var a=document.getElementById("vAppOptionsCont");null!=a&&(a.style.pointerEvents="none")},isMiniFileIncluded:function(a){a=new RegExp(a+".js?=*([0-9]*)");for(var b=document.getElementsByTagName("script"),c=0;c<b.length;c++)if(a.test(b[c].src))return!0;return!1},clearAllChat:function(){localStorage.removeItem(vApp.gObj.uid);sessionStorage.clear("chatroom");vApp.chat.idList.length=0;clearAllChatBox();var a=document.getElementById("chatWidget").getElementsByClassName("ui-chatbox-msg");
if(0<a.length)for(;null!=a[0];)a[0].parentNode.removeChild(a[0])},isObjectEmpty:function(a){for(var b in a)if(a.hasOwnProperty(b))return!1;return!0},removeSessionTool:function(){if(null==localStorage.getItem("orginalTeacherId")){var a=document.getElementById("vAppSessionEndTool");null!=a&&a.parentNode.removeChild(a)}},toggleRoleClass:function(a){if(null!=localStorage.getItem("teacherId")&&null==localStorage.getItem("orginalTeacherId")||a)document.getElementById("vAppCont").classList.toggle("teacher"),
document.getElementById("vAppCont").classList.toggle("student")},addClass:function(a,b){var c=document.getElementById(a);vApp.vutil.elemHasAnyClass(a)?c.classList.add(b):c.className=b},removeClass:function(a,b){var c=document.getElementById(a);vApp.vutil.elemHasAnyClass(a)&&c.classList.contains(b)&&c.classList.remove(b)},breakIntoBytes:function(a,b){for(var c=a.toString(),f=c.length;f<b;f++)c="0"+c;return c.match(/[\S]{1,2}/g)||[]},numValidateFour:function(a,b,c,f){a=this.preNumValidateTwo(a);b=this.preNumValidateTwo(b);
c=this.preNumValidateTwo(c);f=this.preNumValidateTwo(f);return parseInt(a+b+c+f)},numValidateTwo:function(a,b){a=this.preNumValidateTwo(a);b=this.preNumValidateTwo(b);return parseInt(a+b)},preNumValidateTwo:function(a){a=a.toString();if(1==a.length)return"0"+a;if(2==a.length)return a},elemHasAnyClass:function(a){a=document.getElementById(a);return null!=a?"undefined"!=typeof a.classList?!0:!1:!1},userIsOrginalTeacher:function(a){return null!=localStorage.getItem("orginalTeacherId")?!0:!1},isUserTeacher:function(a){return null!=
localStorage.getItem("teacherId")?!0:!1},initDisableAudVid:function(){vApp.gObj.audIntDisable=!0;vApp.gObj.vidIntDisable=!0},initDisableVirtualClass:function(){this.initDisableAudVid();vApp.gObj.errNotDesktop=!0;vApp.gObj.errNotScreenShare=!0;vApp.gObj.errAppBar=!0},disableVirtualClass:function(){var a=document.getElementById("vAppCont");a.style.opacity=.6;a.style.pointerEvents="none"}};d.onbeforeunload=function(){if("undefined"!=typeof vApp.storage.wholeStoreData){var a=JSON.parse(vApp.storage.wholeStoreData);
...
return{prevStream:!1,init:function(a){this.type=a.type;this.ssByClick=!0;this.manualStop=!1;"t"!=vApp.gObj.uRole||vApp.recorder.recImgPlay?this._init():this.readyTostart(a.app)},_init:function(){vApp.previous!=a.id&&(document.getElementById(vApp.previous).style.display="none",vApp.previous=a.id);var b=document.getElementById(a.id);null!=b&&(b.style.display="block");if(!this.hasOwnProperty("id")){this.dc=vApp.dirtyCorner;this.postFix="Cont";this.id=a.hasOwnProperty("id")?a.id:"vAppScreenShare";this.className=
"vmApp";this.label="Local";this.local=this.id+this.label;this.localTemp=this.id+this.label+"Temp";this.classes=a.hasOwnProperty("class")?a.classes:"";this.initPrevImage();b=document.getElementById(this.id);null!=b&&b.parentNode.removeChild(b);var b=this.html.UI.call(this,vApp.gObj.uRole),c=document.getElementById(vApp.rWidgetConfig.id);document.getElementById(vApp.html.id).insertBefore(b,c);"t"!=vApp.gObj.uRole||vApp.recorder.recImgPlay||vApp.vutil.initLocCanvasCont(this.localTemp+"Video")}},readyTostart:function(a){a==
vApp.apps[1]&&this.getScreen()},onError:function(a){console.log("Error "+a)},getScreen:function(a){"Chrome"==vApp.system.mybrowser.name?vApp.gObj.hasOwnProperty("ext")&&vApp.gObj.ext?d.postMessage({type:"getScreen",id:1},"*"):chrome.webstore.install("https://chrome.google.com/webstore/detail/ijhofagnokdeoghaohcekchijfeffbjl",function(){d.location.reload()}):"Firefox"==vApp.system.mybrowser.name&&vApp.getSceenFirefox()},unShareScreen:function(){this.video.src="";this.localtempCont.clearRect(0,0,this.localtempCanvas.width,
this.localtempCanvas.height);clearInterval(vApp.clear);this.initPrevImage();this.hasOwnProperty("currentStream")&&this.currentStream.stop();vApp.wb.utility.beforeSend({unshareScreen:!0,st:this.type})},removeStream:function(){vApp.vutil.removeClass("audioWidget","fixed");this.localCont.clearRect(0,0,this.localCanvas.width,this.localCanvas.height)},initializeRecorder:function(a){vApp.vutil.addClass("audioWidget","fixed");changeonresize=1;resizecalled=0;this.prevStream&&(this.ssByClick=!1);"undefined"!=
typeof vApp.prevScreen&&vApp.prevScreen.hasOwnProperty("currentStream")&&vApp.prevScreen.unShareScreen();this.video=document.getElementById(this.local+"Video");if("VIDEO"!=this.video.tagName){var c=this.video,f=document.createElement("video");f.id=c.id;this.video.parentNode.replaceChild(f,this.video);this.video=document.getElementById(this.local+"Video");this.video.autoplay=!0;vApp.vutil.createLocalTempVideo("vAppScreenShare",this.local+"Temp");vApp.vutil.initLocCanvasCont(this.local+"TempVideo")}this.currentStream=
a;var g=this;console.log("video changed");vApp.adpt.attachMediaStream(this.video,a);this.prevStream=!0;this.currentStream.onended=function(a){g.ssByClick?(g.video.src="",g.localtempCont.clearRect(0,0,g.localtempCanvas.width,g.localtempCanvas.height),clearInterval(vApp.clear),g.initPrevImage(),vApp.wb.utility.beforeSend({unshareScreen:!0,st:g.type}),g.prevStream=!1,g.prevScreen="",vApp.prevScreen=""):g.ssByClick=!0};a={};a.width=d.innerWidth;a.height=d.innerHeight-140;var c=document.getElementById(this.local),
k=this.html.getDimension(a);c.style.width=Math.round(k.width)+"px";c.style.height=Math.round(k.height)+"px";g=this;this.video.onloadedmetadata=function(){g.width=k.width;g.height=k.height;g.localtempCanvas.width=g.video.offsetWidth;g.localtempCanvas.height=g.video.offsetHeight;vApp.prevScreen=g;var a=vApp.system.measureResoultion({width:d.innerWidth,height:d.innerHeight});g.sharing();vApp.vutil.setContainerWidth(a);"t"==vApp.gObj.uRole&&vApp.vutil.makeActiveApp(g.id,vApp.prevApp);vApp.prevApp=g.id}},
sharing:function(){function a(b,c){for(var f=b.toString(),d=f.length;d<c;d++)f="0"+f;return f.match(/[\S]{1,2}/g)||[]}function c(){clearInterval(vApp.clear);if("undefined"!=typeof prvVWidth&&"undefined"!=typeof prvVHeight){if(prvVWidth!=n.video.offsetWidth||prvVHeight!=n.video.offsetHeight)changeonresize=1}else prvVWidth=n.video.offsetWidth,prvVHeight=n.video.offsetHeight;1==changeonresize?setTimeout(g,2E3):k(n.type)}function f(a){p=400>=a||"undefined"==typeof a?400:1E4<=a?a/2:a;4*q<p&&(p=4*q);400<
p&&console.trace();q=p}function g(){console.log("RESIZE");prvVWidth=n.video.offsetWidth;prvVHeight=n.video.offsetHeight;h=Math.round(n.localtempCanvas.height/12);m=Math.round(n.localtempCanvas.width/12);var g=n.type;n.localtempCanvas.width=n.video.offsetWidth;n.localtempCanvas.height=n.video.offsetHeight;n.localtempCont.drawImage(n.video,0,0,n.video.offsetWidth,n.video.offsetHeight);var k=n.localtempCont.getImageData(0,0,n.localtempCanvas.width,n.localtempCanvas.height),k=n.dc.encodeRGB(k.data),q=
Math.round(n.localtempCanvas.width/m),v=Math.round(n.localtempCanvas.height/h),w=n.getContainerDimension();if("undefined"!=typeof prvVWidth&&"undefined"!=typeof prvVHeight)var x=a(prvVWidth,4),z=a(prvVHeight,4),A=a(w.width,4);else x=a(n.video.offsetWidth,4),z=a(n.video.offsetHeight,4),A=a(w.width,4);w=a(w.height,4);g=new Uint8ClampedArray(["ss"==g?104:204,x[0],x[1],z[0],z[1],A[0],A[1],w[0],w[1]]);x=new Uint8ClampedArray(k.length+g.length);x.set(g);x.set(k,g.length);d.Worker&&sworker.postMessage({img:k,
resize:1,resA:h,resB:m,dw:q,dh:v,offsetWidth:n.video.offsetWidth,offsetHeight:n.video.offsetHeight},[k.buffer]);io.sendBinary(x);f(x.length/128);changeonresize=0;clearInterval(vApp.clear);vApp.clear=setInterval(c,p)}function k(a){n.localtempCanvas.width=n.video.offsetWidth;n.localtempCanvas.height=n.video.offsetHeight;n.localtempCont.drawImage(n.video,0,0,n.video.offsetWidth,n.video.offsetHeight);a=Math.round(n.localtempCanvas.width/m);var b=Math.round(n.localtempCanvas.height/h),g=n.localtempCont.getImageData(0,
0,n.video.offsetWidth,n.video.offsetHeight);d.Worker&&(sworker.postMessage({img:g.data,resA:h,resB:m,dw:a,dh:b,offsetWidth:n.video.offsetWidth,offsetHeight:n.video.offsetHeight,type:n.type},[g.data.buffer]),sworker.onmessage=function(a){if(1==a.data.needFullScreen){a=vApp.getDataFullScreen(n.type);io.sendBinary(a);var b=a.length/128}else null!=a.data.masterSlice&&(io.sendBinary(a.data.masterSlice),b=a.data.masterSlice.length/128);f(b)});clearInterval(vApp.clear);vApp.clear=setInterval(c,p)}var h=
Math.round(this.localtempCanvas.height/12),m=Math.round(this.localtempCanvas.width/12),n=this;randomTime=Math.floor(10001*Math.random())+5E3;vApp.hasOwnProperty("wholeImage")&&clearInterval(vApp.wholeImage);vApp.hasOwnProperty("clear")&&clearInterval(vApp.clear);var p=1E3,q=1E3;vApp.getDataFullScreen=function(c){n.localtempCanvas.width=n.video.offsetWidth;n.localtempCanvas.height=n.video.offsetHeight;n.localtempCont.drawImage(n.video,0,0,n.video.offsetWidth,n.video.offsetHeight);var f=n.localtempCont.getImageData(0,
0,n.localtempCanvas.width,n.localtempCanvas.height),f=n.dc.encodeRGB(f.data),d=a(n.localtempCanvas.height,4),g=a(n.localtempCanvas.width,4);c=new Uint8ClampedArray(["ss"==c?102:202,g[0],g[1],d[0],d[1]]);d=new Uint8ClampedArray(f.length+c.length);d.set(c);d.set(f,c.length);return d};clearInterval(vApp.clear);vApp.clear=setInterval(c,p)},getContainerDimension:function(){var a=document.getElementById(this.id+"Local");return{width:a.offsetWidth,height:a.offsetHeight}},drawImages:function(a,c){if("undefined"!=
typeof c){var f=this.dc.decodeRGBSlice(a,this.localCont,c);this.localCont.putImageData(f,c.x,c.y)}else f=this.dc.decodeRGB(a,this.localCont,this.localCanvas),this.localCont.putImageData(f,0,0)},drawSingleImage:function(a){a=this.dc.decodeRGB(a,this.localCont,this.localCanvas);this.localCont.putImageData(a,0,0)},dimensionStudentScreen:function(a,c){this.localCanvas=document.getElementById(vApp[app].local+"Video");this.localCont=vApp[app].localCanvas.getContext("2d");this.localCanvas.width=a;this.localCanvas.height=
c;console.log("normal width "+this.localCanvas.width)},dimensionStudentScreenResize:function(a,c){this.hasOwnProperty("vac")||(this.vac=!0,this.localCanvas=document.getElementById(vApp[app].local+"Video"),this.localCont=vApp[app].localCanvas.getContext("2d"));a.hasOwnProperty("d")&&(this.localCont.clearRect(0,0,this.localCanvas.width,this.localCanvas.height),this.localCanvas.width=a.d.w,this.localCanvas.height=a.d.h);if(a.hasOwnProperty("vc")){var f=document.getElementById(vApp[app].local);f.style.width=
a.vc.w+"px";f.style.height=a.vc.h+"px"}"vAppWhiteboard"!=vApp.previous&&vApp.vutil.setScreenInnerTagsWidth(vApp.previous)},html:{UI:function(a){var c=vApp.vutil.createDOM("div",this.id,[this.className]),f=vApp.vutil.createDOM("div",this.local,[this.label]);if("t"==a){if(vApp.recorder.recImgPlay)var d=vApp.vutil.createDOM("canvas",this.local+"Video");else d=vApp.vutil.createDOM("video",this.local+"Video"),d.setAttribute("autoplay",!0);f.style.cssText+=";position:relative"}else d=vApp.vutil.createDOM("canvas",
this.local+"Video");f.appendChild(d);c.appendChild(f);"t"!=a||vApp.recorder.recImgPlay||vApp.vutil.createLocalTempVideo(c,this.localTemp);return c},getDimension:function(a,c){return{height:a.height,width:a.width}}},initPrevImage:function(){sworker.postMessage({initPrevImg:!0})}}}})(window);(function(d){d.recorder={items:[],recImgPlay:!1,init:function(a){function b(){f.objs=vApp.recorder.items;f.objNo=0;f.repMode=a;f.callBkfunc="";vApp.ss="";vApp.wss="";var b=document.getElementById("vApp"+vApp.apps[1]);null!=b&&b.parentNode.removeChild(b);setTimeout(function(){vApp.recorder.renderObj()},f.objs[0].mt-vApp.wb.pageEnteredTime)}var c=vApp.wb.vcan;"undefined"!=typeof myfunc?this.objs=c.getStates("replayObjs"):vApp.storage.getAllObjs(["allData"],b);var f=this;setTimeout(function(){"undefined"!=
