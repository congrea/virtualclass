...
"Chrome"==c&&40>a||"Firefox"==c&&35>a||"s"==vApp.gObj.uRole&&"OPR"==c&&26>a?(this.reportBrowser(vApp.gObj.uRole),vApp.error.push(vApp.lang.getString("chFireBrowsersIssue",[c,a]))):"t"==vApp.gObj.uRole&&"OPR"==c&&26<=a?(this.reportBrowser(vApp.gObj.uRole),vApp.error.push(vApp.lang.getString("operaBrowserIssue",[c,a]))):"Safari"==c?8<=a?"t"==vApp.gObj.uRole?(vApp.vutil.initDisableVirtualClass(),vApp.error.push(vApp.lang.getString("teacherSafariBrowserIssue",[c,a]))):(vApp.vutil.initDisableAudVid(),
