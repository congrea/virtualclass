...
d,g=0;g<b.length;g++)if(d=b[g].getAttribute("data-role"),"t"==d)return!0;return!1},createControl:function(b,d){var g=a.createElement("div");g.id=b+"ControlContainer";g.className="controls";this.createControlDivs(g,b,d);return g},createControlDivs:function(b,d,g){var k=this,h=!1,m=localStorage.getItem("vApp"+d);null!=m&&(h=!0,m=JSON.parse(m));for(var n=localStorage.getItem("reclaim"),n=null!=n&&n?!1:!0,p=0;p<g.length;p++)if("assign"==g[p]){var q=a.createElement("span"),r="contrAssign";q.id=d+r+"Img";
...
u=a.createElement("div");u.id=d+r+"Cont";u.className="controleCont";u.appendChild(s);b.appendChild(u);r=h&&m.hasOwnProperty("aud")?m.aud?!0:!1:!0;vApp.user.control.changeAttribute(d,v,r,"audio","aud");v.addEventListener("click",function(){k.control.init.call(k,v)})}else if("chat"==g[p]){var w=a.createElement("span"),r="contrChat";w.id=d+r+"Img";w.innerHTML="&nbsp;";s=a.createElement("a");s.id=d+r+"Anch";s.className="tooltip";s.appendChild(w);u=a.createElement("div");u.id=d+r+"Cont";u.className="controleCont";
u.appendChild(s);b.appendChild(u);w.addEventListener("click",function(){k.control.init.call(k,w)});r=h&&m.hasOwnProperty("ch")?m.ch?!0:!1:!0;vApp.user.control.changeAttribute(d,w,r,"chat","ch")}},control:{changeAttribute:function(a,b,d,k,h){d?(b.parentNode.setAttribute("data-title",vApp.lang.getString(k+"Disable")),b.setAttribute("data-"+k+"-disable","false"),b.className="icon-"+k+"Img enable",vApp.user.control.updateUser(a,h,!0)):("assign"==k&&b.parentNode.classList.remove("tooltip"),b.parentNode.setAttribute("data-title",
vApp.lang.getString(k+"Enable")),b.setAttribute("data-"+k+"-disable","true"),b.className="audio"==k?"icon-"+k+"DisImg block":"icon-"+k+"Img block",vApp.user.control.updateUser(a,h,!1))},init:function(a){var b=a.id,d=b.indexOf("contr"),d=b.substring(0,d),b=b.split("contr")[1],k=b.indexOf("Img"),b=b.substring(0,k);"Assign"==b?(b="true"==a.getAttribute("data-assign-disable")?!0:!1,b||(this.control.changeAttribute(d,a,b,"assign","aRole"),vApp.user.control._assign(d),vApp.user.control.changeAttrToAssign("block"))):
...
if(!vApp.vutil.chkValueInLocalStorage("orginalTeacherId")){var g=a.getElementById("vcanvas");g.className=g.className.replace(/\bteacher\b/," ");g.className="student"}localStorage.setItem("canvasDrwMsg",!0);g=a.getElementById("vAppScreenShareLocalVideo");null!=g&&"VIDEO"==g.tagName&&vApp.vutil.videoTeacher2Student("ScreenShare",!0);var k;"ScreenShare"==vApp.currApp&&(k="ss");"Whiteboard"!=vApp.currApp&&(vApp[k].hasOwnProperty("currentStream")&&vApp[k].currentStream.stop(),vApp[k]="");"undefined"==
typeof d&&vApp.wb.utility.beforeSend({assignRole:!0,toUser:b});null==localStorage.getItem("orginalTeacherId")&&(k=a.getElementById("chat_div").getElementsByClassName("controls")[0],k.parentNode.removeChild(k))},_chat:function(a,b){"enable"==b?vApp.wb.utility.beforeSend({enc:!0,toUser:a}):(vApp.user.control.updateUser(a,"ch",!1),vApp.wb.utility.beforeSend({dic:!0,toUser:a}))},_audio:function(a,b){"enable"==b?vApp.wb.utility.beforeSend({ena:!0,toUser:a}):vApp.wb.utility.beforeSend({dia:!0,toUser:a})},
