...
a)return console.log("joniId "+a),!0;return!1},isEducatorAlreadyExist:function(a){if(virtualclass.hasOwnProperty("connectedUsers"))for(var b=0;b<virtualclass.connectedUsers.length;b++)if("e"==virtualclass.connectedUsers[b].role&&virtualclass.connectedUsers[b].userid!=a)return console.log("joniId "+a),!0;return!1},isOrginalTeacherExist:function(a){if(virtualclass.hasOwnProperty("connectedUsers"))for(var b=0;b<virtualclass.connectedUsers.length;b++)if("t"==virtualclass.connectedUsers[b].role&&virtualclass.connectedUsers[b].userid!=
a)return console.log("joniId "+a),!0;return!1},getMySetTime:function(a){for(var b=0;b<a.length;b++)if(a[b].userid==virtualclass.gObj.uid)return 180*(b+1)+2E3;return 2300},createBecomeTeacherWidget:function(){if(null==document.getElementById("beTeacher")){var a=document.createElement("div");a.id="beTeacher";var b=document.createElement("a");b.id=a.id+"Anchor";b.innerHTML=virtualclass.lang.getString("becomeTeacher");a.appendChild(b);b=document.getElementById("virtualclassCont");b.insertBefore(a,b.firstChild);
a.addEventListener("click",virtualclass.vutil.initTeacherRole);a.style.pointerEvents="none";a.style.opacity="0.5";setTimeout(function(){a.style.pointerEvents="visible";a.style.opacity="1"},15E3)}},removeBecomeTeacherWidget:function(){var a=document.getElementById("beTeacher");null!=a&&a.parentNode.removeChild(a)},initTeacherRole:function(){ioAdapter.send({cf:"bt"});virtualclass.vutil.removeBecomeTeacherWidget();setTimeout(function(){virtualclass.vutil.isOrginalTeacherExist(virtualclass.jId)?console.log("Already connected teacher"):
(virtualclass.vutil.overrideRoles("t"),localStorage.setItem("beTeacher",!0),console.log("connected teacher"));c.location.reload()},virtualclass.gObj.mySetTime)},overrideRoles:function(a){virtualclass.uInfo.userobj.role=a;virtualclass.gObj.uRole=virtualclass.uInfo.userobj.role;wbUser.role=virtualclass.uInfo.userobj.role;var b=document.getElementById("virtualclassCont");virtualclass.vutil.overrideRolesFromElem(b,a)},overrideRolesFromElem:function(a,b){"s"==b?(a.classList.remove("teacher"),a.classList.remove("orginalTeacher"),
a.classList.remove("presenter"),a.classList.remove("educator"),virtualclassCont.classList.add("student")):"p"==b?(a.classList.remove("teacher"),a.classList.remove("orginalTeacher"),a.classList.remove("educator"),virtualclassCont.classList.add("student"),virtualclassCont.classList.add("presenter")):"e"==b?(a.classList.add("teacher"),a.classList.remove("student"),a.classList.remove("presenter"),a.classList.add("educator"),a.classList.add("orginalTeacher")):"t"==b&&(a.classList.remove("student"),a.classList.remove("educator"),
a.classList.remove("presenter"),a.classList.add("teacher"),a.classList.add("orginalTeacher"),console.log("add Teacher"))}}})(window);(function(c){var a,b,d,f,g,h;c.studentScreen=function(){return{ssProcess:function(a,b,d,c){var f=a[0];a=new Uint8ClampedArray(b);var g,h,q,s;switch(f){case 102:case 202:q=virtualclass.vutil.numValidateTwo(a[1],a[2]);h=virtualclass.vutil.numValidateTwo(a[3],a[4]);b=a.subarray(5,a.length);this.initStudentScreen(b,{w:q,h:h},d,c);break;case 103:case 203:b=7;for(q=0;q+7<=a.length;q=s+1)f=virtualclass.vutil.numValidateTwo(a[q+1],a[q+2]),g=virtualclass.vutil.numValidateTwo(a[q+3],a[q+4]),h=parseInt(a[q+
...
room:wbUser.room});c.add({myconfig:a,timeStamp:(new Date).getTime()})}else console.log("The Datbase is not created for Applicatoin.")},endSession:function(a){var c=localStorage.getItem("nEd");localStorage.clear();virtualclass.recorder.items=[];virtualclass.recorder.totalSent=0;virtualclass.gObj.tempReplayObjs.length=0;virtualclass.gObj.hasOwnProperty("downloadProgress")&&delete virtualclass.gObj.downloadProgress;a||("object"==typeof virtualclass.wb&&(virtualclass.wb.utility.t_clearallInit(),virtualclass.wb.utility.makeDefaultValue(),
...
b){for(var c=a.doc.sel.ranges,d=[],n=0;n<c.length;n++){for(var f=b(c[n]);d.length&&0>=J(f.from,P(d).to);){var g=d.pop();if(0>J(g.from,f.from)){f.from=g.from;break}}d.push(f)}ma(a,function(){for(var b=d.length-1;0<=b;b--)sb(a.doc,"",d[b].from,d[b].to,"+delete");mb(a)})}function yd(a,b,c,d,f){function g(b){var d=(f?nd:Ne)(q,m,c,!0);if(null==d){if(b=!b)b=h+c,b<a.first||b>=a.first+a.size?b=r=!1:(h=b,b=q=E(a,b));if(b)m=f?(0>c?yc:xc)(q):0>c?q.text.length:0;else return r=!1}else m=d;return!0}var h=b.line,
m=b.ch,p=c,q=E(a,h),r=!0;if("char"==d)g();else if("column"==d)g(!0);else if("word"==d||"group"==d){var s=null;d="group"==d;b=a.cm&&a.cm.getHelper(b,"wordChars");for(var v=!0;!(0>c)||g(!v);v=!1){var u=q.text.charAt(m)||"\n",u=Lc(u,b)?"w":d&&"\n"==u?"n":!d||/\s/.test(u)?null:"p";!d||v||u||(u="s");if(s&&s!=u){0>c&&(c=1,g());break}u&&(s=u);if(0<c&&!g(!v))break}}p=tc(a,z(h,m),p,!0);r||(p.hitSide=!0);return p}function Oe(a,b,c,d){var f=a.doc,g=b.left,h;"page"==d?(d=Math.min(a.display.wrapper.clientHeight,
...
a,c)})}},createEditorClient:function(a,b){roles.hasAdmin()&&(this.cm.setOption("readOnly",!1),this.createAllEditorController(),a.readOnly=!1);virtualclass.isPlayMode&&(this.readOnlyMode("enable","notCreateSyncBox"),this.cm.setOption("readOnly","nocursor"));Vceditor.fromCodeMirror({},this.cm,a,b);console.log("Creating Rich Text Layout")},codemirrorWithLayout:function(a){this.UI.container(this.etype);document.getElementById(this.UI.edId);"object"!=typeof this.cm&&(console.log("Code mirror instance is created "),
this.cm=CodeMirror(document.getElementById(this.UI.edId),a))},requestData:function(){var a=virtualclass.vutil.whoIsTeacher();this.readOnlyMode("enable");ioAdapter.mustSendUser({eddata:"requestForEditorData",et:this.etype,cf:"eddata"},a)},readOnlyMode:function(a,b){"object"==typeof this.cm&&("enable"==a?this.readonly||(this.cm.setOption("readOnly","nocursor"),"undefined"==typeof b&&this.UI.createSynchMessageBox(),this.readonly="nocursor"):this.readonly&&!virtualclass.isPlayMode&&(this.cm.setOption("readOnly",
