...
vApp.lang.getString(h+"Enable")),b.setAttribute("data-"+h+"-disable","true"),b.className="audio"==h?"icon-"+h+"DisImg block":"icon-"+h+"Img block",vApp.user.control.updateUser(a,k,!1))},init:function(a){var b=a.id,d=b.indexOf("contr"),d=b.substring(0,d),b=b.split("contr")[1],h=b.indexOf("Img"),b=b.substring(0,h);"Assign"==b?(b="true"==a.getAttribute("data-assign-disable")?!0:!1,b||(this.control.changeAttribute(d,a,b,"assign","aRole"),vApp.user.control._assign(d),vApp.user.control.changeAttrToAssign("block"))):
