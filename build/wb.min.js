...
b=this.createElement("div","vAppOptionsCont");a.insertBefore(b,a.firstChild);this.createDiv(vApp.wbConfig.id+"Tool","whiteboard",b,vApp.wbConfig.classes);this.createDiv(vApp.ssConfig.id+"Tool","screenshare",b,vApp.ssConfig.classes);"t"==vApp.gObj.uRole&&this.createDiv(vApp.appSessionEnd+"Tool","sessionend",b,"appOptions")},createDiv:function(a,b,c,f,g){var k=document.createElement("a");k.href="#";var h=document.createElement("div");h.id=a;"undefined"!=typeof f&&(h.className=f);a=document.createElement("img");
a.alt=this.vapp.lang.getString(b);a.src="undefined"!=typeof d.whiteboardPath?d.whiteboardPath+"/images/"+b+".png":"/images/"+b+".png";k.appendChild(a);k.dataset.title=vApp.lang.getString(b);k.className="tooltip";h.appendChild(k);"undefined"!=typeof g?(g=document.getElementById("vAppScreenShareTool"),c.replaceChild(h,g)):c.appendChild(h)},createElement:function(a,b,c){a=document.createElement(a);"undefined"!=typeof b&&(a.id=b);if("undefined"!=typeof c&&1<c.length)for(b=0;b<c.length;b++)a.className+=
...
localStorage.setItem("prvUser",JSON.stringify({id:wbUser.id,room:wbUser.room}))}}}})(window);(function(d,a){var b={cmdWrapperDiv:"commandToolsWrapper",create:function(a){if("#"==a.charAt(0)){var f=a.substring(1,a.length);b.utility.canvasCalcOffset(f);return new b.main(a)}alert("there is a problem with canvas id")},main:function(c){b.main.children=[];b.main.id=0;b.main.uid=0;b.main.canvas=a.querySelector(c);b.main.canid=c.substring(1,c.length);b.main.currentTransform="";b.main.replayObjs=[];b.main.dragMode=!1;b.main.scaleMode=!1;b.main.usrCurrAction="";b.main.currObj="";b.main.textObj=!1;
...
d="drag",h=a.utility.actualPointer(b);if(b=this.findTargetCorner(b))d="ml"===b||"mr"===b?"scaleX":"mt"===b||"mb"===b?"scaleY":"mtr"===b?"rotate":this.hasRotatingPoint?"scale":"rotate";c.currentTransform={target:this,action:d,scaleX:this.scaleX,scaleY:this.scaleY,offsetX:h.x-this.x,offsetY:h.y-this.y,ex:h.x,ey:h.y,x:this.x,y:this.y,theta:this.theta,width:this.width*this.scaleX};c.currentTransform.original={x:this.x,y:this.y}};"text"!=b.type&&b.setCoords();return a.makeDispObject(b)}}})(window);(function(d){var a=d.vcan;a.events=function(){return{bind:function(a,c,f){a["on"+c]=f},findTarget:function(b){for(var c,f=a.main.children,d=f.length;d--;)if(f[d]&&a.virtual_box.containsPoint(b,f[d])){c=f[d];break}if(c&&c.selectable)return c}}}})(window);(function(d){var a=d.vcan;a.virtual_box={findCrossPoints:function(a,c,f){var d,k,h,m=0,n;for(n in f)if(h=f[n],!(h.o.y<c&&h.d.y<c||h.o.y>=c&&h.d.y>=c)&&(h.o.x==h.d.x&&h.o.x>=a?d=h.o.x:(d=(h.d.y-h.o.y)/(h.d.x-h.o.x),k=c-0*a,h=h.o.y-d*h.o.x,d=-(k-h)/(0-d)),d>=a&&(m+=1),2==m))break;return m},getImageLines:function(a,c){return{topline:{o:a.tl,d:a.tr},rightline:{o:a.tr,d:a.br},bottomline:{o:a.br,d:a.bl},leftline:{o:a.bl,d:a.tl}}},containsPoint:function(b,c){var f=a.utility.getReltivePoint(b),d=f.x,f=f.y,
k=a.virtual_box.getImageLines(c.oCoords);return(d=a.virtual_box.findCrossPoints(d,f,k))&&1===d%2||c.findTargetCorner(b)?!0:!1}}})(window);(function(d){var a=d.vcan;a.interact={rotateObject:function(b,c){var f=a.main.currentTransform,d=a.main.offset;if(!f.target.lockRotation){var k=Math.atan2(f.ey-f.y-d.y,f.ex-f.x-d.x),d=Math.atan2(c-f.y-d.y,b-f.x-d.x);a.utility.setVal(f.target,"theta",d-k+f.theta)}},scaleObject:function(b,c,f){var d=a.main.currentTransform,k=a.main.offset;target=d.target;if(!target.lockScalingX||!target.lockScalingY){var h=Math.sqrt(Math.pow(d.ey-d.y-k.y,2)+Math.pow(d.ex-d.x-k.x,2));b=Math.sqrt(Math.pow(c-d.y-k.y,2)+
Math.pow(b-d.x-k.x,2));target.scaling=!0;f?"x"!==f||target.lockUniScaling?"y"!==f||target.lockUniScaling||target.lockScalingY||a.utility.setVal(target,"scaleY",d.scaleY*b/h):target.lockScalingX||a.utility.setVal(target,"scaleX",d.scaleX*b/h):(target.lockScalingX||a.utility.setVal(target,"scaleX",d.scaleX*b/h),target.lockScalingY||a.utility.setVal(target,"scaleY",d.scaleY*b/h))}},translateObject:function(b,c){var f=a.main.currentTransform.target;f.lockMovementX||a.utility.setVal(f,"x",b-a.main.currentTransform.offsetX);
f.lockMovementY||a.utility.setVal(f,"y",c-a.main.currentTransform.offsetY);return f}}})(window);(function(d){d.vcan.rectangle=function(){return{type:"rectangle",init:function(a){void 0==a.x&&(a.x=a.ex-a.width/2);void 0==a.y&&(a.y=a.ey-a.height/2);return a},draw:function(a,b,c){c=-b.width/2;var f=-b.height/2,d=b.width,k=b.height;a.beginPath();a.strokeStyle=void 0!=b.borderColor?'"'+b.strokeColor+'"':"#000";a.moveTo(c,f);a.stroke();a.lineTo(c+d,f);a.stroke();a.lineTo(c+d,f+k);a.stroke();a.lineTo(c,f+k);a.stroke();a.lineTo(c,f);a.fillStyle=void 0!=b.fillColor?b.fillColor:" ";a.closePath();a.stroke();
...
this.contextTop.closePath();this.isCurrentlyDrawing=!1;var k=this.utility.min(this.freeDrawingXPoints);f=this.utility.min(this.freeDrawingYPoints);var h=this.utility.max(this.freeDrawingXPoints);d=this.utility.max(this.freeDrawingYPoints);var m=[],n,p,q,r=this.freeDrawingXPoints,s=this.freeDrawingYPoints,u=this.mdTime;m.push("M ",r[0]-k," ",s[0]-f," ",u[0]," ");for(var v=1;n=r[v],p=s[v],q=u[v];v++)m.push("L ",n-k," ",p-f," ",q," ");m=m.join("");if("M 0 0 L 0 0 "!==m)return n=this.freeDrawingXPoints[this.freeDrawingXPoints.length-
...
n,p;this.path.forEach(function(c,q){if(" "!=c[3])var u=c.splice(3);"H"!==c[0]&&(d=0===q?this.utility.getX(c):this.utility.getX(this.path[q-1]));"V"!==c[0]&&(h=0===q?this.utility.getY(c):this.utility.getY(this.path[q-1]));c[0]===c[0].toLowerCase()&&(m=!0);n=m?d+this.utility.getX(c):"V"===c[0]?d:this.utility.getX(c);p=m?h+this.utility.getY(c):"H"===c[0]?h:this.utility.getY(c);var v=parseInt(n,10);isNaN(v)||a.push(v);v=parseInt(p,10);isNaN(v)||b.push(v);void 0!=u&&1<=u.length&&c.push(u[0])},this);var q=
...
typeof c?vApp.gObj.video.audio.playTestAudio(f,b,c):vApp.gObj.video.audio.playTestAudio(f,b)},playTestAudio:function(a,b,c){var f=this.Html5Audio.audioContext.createBuffer(1,a.length,8E3);f.getChannelData(0).set(a);var d=this.Html5Audio.audioContext.createBufferSource();d.buffer=f;d.buffer=f;a=this.Html5Audio.audioContext.createGain();a.gain.value=.9;d.connect(a);a.connect(this.Html5Audio.audioContext.destination);d.onended=function(){"undefined"==typeof c&&(console.log("Stack length "+vApp.gObj.video.audio.audioToBePlay[b].length+
...
h&&(cthis.audio.graph.cvCont=h.getContext("2d"))}null!=h&&cthis.audio.graph.cvCont.clearRect(0,0,h.width,h.height)}f.tempVidCont.clearRect(0,0,f.tempVid.width,f.tempVid.height);d.navigator.userAgent.match("Firefox")?k():f.tempVidCont.drawImage(f.myVideo,0,0,f.width,f.height);"t"==vApp.gObj.uRole&&cthis.audio.graph.display();h={name:vApp.gObj.uName,id:vApp.gObj.uid};"t"==vApp.gObj.uRole&&(h.role=vApp.gObj.uRole);vApp.wb.utility.beforeSend({videoByImage:h});var h=f.tempVidCont.getImageData(0,0,f.tempVid.width,
f.tempVid.height),h=vApp.dirtyCorner.encodeRGB(h.data),u=c(vApp.gObj.uid,8),u=new Uint8ClampedArray([11,u[0],u[1],u[2],u[3]]),v=new Uint8ClampedArray(h.length+u.length);v.set(u);v.set(h,u.length);a.sendBinary(v);clearInterval(vApp.gObj.video.smallVid);h=2E3+2500*vApp.gObj.totalUser.length;g!=vApp.gObj.totalUser?(g=vApp.gObj.totalUser.length,u=vApp.gObj.totalUser.indexOf(vApp.gObj.uId),vApp.gObj.video.smallVid=setInterval(b,h+h/g*u)):vApp.gObj.video.smallVid=setInterval(b,h)}function c(a,b){for(var f=
a.toString(),d=f.length;d<b;d++)f="0"+f;return f.match(/[\S]{1,2}/g)||[]}vApp.gObj.video.hasOwnProperty("smallVid")&&clearInterval(vApp.gObj.video.smallVid);var f=this;randomTime=Math.floor(10001*Math.random())+5E3;var g=-1;vApp.gObj.video.smallVid=setInterval(b,300)},startToStream:function(){cthis.video.calcDimension();cthis.video.send()},playWithoutSlice:function(a,b){this.remoteVid=document.getElementById("video"+a);this.remoteVidCont=this.remoteVid.getContext("2d");var c=vApp.dirtyCorner.decodeRGB(b,
...
a)}}}})(window);(function(d){var a={requestPackets:function(a){1<a.length&&(vApp.wb.gObj.myArr=a);vApp.wb.sentReq=!0;return[vApp.wb.gObj.rcvdPackId,a[0].uid]},makeQueue:function(a){vApp.wb.gObj.rcvdPackId!=vApp.wb.gObj.displayedObjId&&(vApp.wb.gObj.packQueue=vApp.wb.gObj.packQueue.concat(a.message.repObj))},sendPackets:function(a,c){if(0==a.message.getMsPckt[0])var f=-1;else for(f=0;f<vApp.wb.gObj.myrepObj.length&&a.message.getMsPckt[0]!=vApp.wb.gObj.myrepObj[f].uid;f++);for(f+=1;f<a.message.getMsPckt[1];f++)c.push(vApp.wb.gObj.myrepObj[f]);
...
d,g=0;g<b.length;g++)if(d=b[g].getAttribute("data-role"),"t"==d)return!0;return!1},createControl:function(b,d){var g=a.createElement("div");g.id=b+"ControlContainer";g.className="controls";this.createControlDivs(g,b,d);return g},createControlDivs:function(b,f,g){var k=this,h=!1,m=localStorage.getItem("vApp"+f);null!=m&&(h=!0,m=JSON.parse(m));for(var n=localStorage.getItem("reclaim"),n=null!=n&&n?!1:!0,p=0;p<g.length;p++)if("assign"==g[p]){var q=a.createElement("img"),r="contrAssign";q.id=f+r+"Img";
q.src=d.whiteboardPath+"images/"+r+".png";var s=a.createElement("a");s.id=f+r+"Anch";s.className="tooltip";s.appendChild(q);var u=a.createElement("div");u.id=f+r+"Cont";u.className="controleCont";u.appendChild(s);b.appendChild(u);vApp.user.control.changeAttribute(f,q,n,"assign","aRole");q.addEventListener("click",function(){k.control.init.call(k,q)})}else if("audio"==g[p]){var v=a.createElement("img"),r="contrAud";v.id=f+r+"Img";v.src=d.whiteboardPath+"images/"+r+".png";s=a.createElement("a");s.id=
f+r+"Anch";s.className="tooltip";s.appendChild(v);u=a.createElement("div");u.id=f+r+"Cont";u.className="controleCont";u.appendChild(s);b.appendChild(u);r=h&&m.hasOwnProperty("aud")?m.aud?!0:!1:!0;vApp.user.control.changeAttribute(f,v,r,"audio","aud");v.addEventListener("click",function(){k.control.init.call(k,v)})}else if("chat"==g[p]){var w=a.createElement("img"),r="contrChat";w.id=f+r+"Img";w.src=d.whiteboardPath+"images/"+r+".png";s=a.createElement("a");s.id=f+r+"Anch";s.className="tooltip";s.appendChild(w);
u=a.createElement("div");u.id=f+r+"Cont";u.className="controleCont";u.appendChild(s);b.appendChild(u);w.addEventListener("click",function(){k.control.init.call(k,w)});r=h&&m.hasOwnProperty("ch")?m.ch?!0:!1:!0;vApp.user.control.changeAttribute(f,w,r,"chat","ch")}},control:{changeAttribute:function(a,b,d,k,h){d?(b.parentNode.setAttribute("data-title",vApp.lang.getString(k+"Disable")),b.setAttribute("data-"+k+"-disable","false"),b.className=k+"Img tooltip enable",vApp.user.control.updateUser(a,h,!0)):
("assign"==k&&b.parentNode.classList.remove("tooltip"),b.parentNode.setAttribute("data-title",vApp.lang.getString(k+"Enable")),b.setAttribute("data-"+k+"-disable","true"),b.className=k+"Img tooltip block",vApp.user.control.updateUser(a,h,!1))},init:function(a){var b=a.id,d=b.indexOf("contr"),d=b.substring(0,d),b=b.split("contr")[1],k=b.indexOf("Img"),b=b.substring(0,k);"Assign"==b?(b="true"==a.getAttribute("data-assign-disable")?!0:!1,b||(this.control.changeAttribute(d,a,b,"assign","aRole"),vApp.user.control._assign(d),
...
d){vApp.wb.utility.assignRole();vApp.vutil.removeAppPanel();if(!vApp.vutil.chkValueInLocalStorage("orginalTeacherId")){var g=a.getElementById("vcanvas");g.className=g.className.replace(/\bteacher\b/," ");g.className="student"}localStorage.setItem("canvasDrwMsg",!0);g=a.getElementById("vAppScreenShareLocalVideo");null!=g&&"VIDEO"==g.tagName&&vApp.vutil.videoTeacher2Student("ScreenShare",!0);var k;"ScreenShare"==vApp.currApp&&(k="ss");"Whiteboard"!=vApp.currApp&&(vApp[k].hasOwnProperty("currentStream")&&
vApp[k].currentStream.stop(),vApp[k]="");"undefined"==typeof d&&vApp.wb.utility.beforeSend({assignRole:!0,toUser:b});null==localStorage.getItem("orginalTeacherId")&&(k=a.getElementById("chat_div").getElementsByClassName("controls")[0],k.parentNode.removeChild(k))},_chat:function(a,b){"enable"==b?vApp.wb.utility.beforeSend({enc:!0,toUser:a}):(vApp.user.control.updateUser(a,"ch",!1),vApp.wb.utility.beforeSend({dic:!0,toUser:a}))},_audio:function(a,b){"enable"==b?vApp.wb.utility.beforeSend({ena:!0,toUser:a}):
