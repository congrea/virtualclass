...
virtualclass.yts.init(d,d.startFrom):null==document.querySelector("iframe#player")&&virtualclass.yts.init();this.previous=virtualclass.ytsConfig.id},EditorRich:function(a){this.appInitiator.editor.call(virtualclass,a)},EditorCode:function(a){this.appInitiator.editor.call(virtualclass,a)},editor:function(a){this.user.control.toggleDisplayEditorController(a.substring(a.indexOf("virtualclass"),a.length),"block");var b=[];a==this.apps[3]?(virtualclass.editorRich.init(0,b,"",""),this.previous=virtualclass.edConfig.id):
