...
12);var t=r.type;r.localtempCanvas.width=r.video.offsetWidth;r.localtempCanvas.height=r.video.offsetHeight;r.localtempCont.drawImage(r.video,0,0,r.video.offsetWidth,r.video.offsetHeight);var w=r.localtempCont.getImageData(0,0,r.localtempCanvas.width,r.localtempCanvas.height),w=r.dc.encodeRGB(w.data),K=Math.round(r.localtempCanvas.width/q),M=Math.round(r.localtempCanvas.height/x),C,R,A,U;U=r.getContainerDimension();"undefined"!=typeof d&&"undefined"!=typeof f?(C=b(d,4),R=b(f,4)):(C=b(r.video.offsetWidth,
