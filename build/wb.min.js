...
"currTeacher")},removeCurrTeacherFromControl:function(b){var f=a.getElementById(b);vApp.vutil.elemHasAnyClass(b)&&(f.classList.remove("currTeacher"),f=b.indexOf("contr"),b=b.substring(0,f),vApp.user.control.updateUser(b,"currTeacher",!1))},disable:function(b,f,d,k){d=a.getElementById(b+"contr"+d+"Img");vApp.user.control._disable(d,f,b,k)},_disable:function(a,b,d,k){a.parentNode.setAttribute("data-title",vApp.lang.getString(b+"Disable"));a.setAttribute("data-"+b+"-disable","true");a.className="audio"==
...
"currTeacher",!0));vApp.user.control.updateUser(d,k,!1)},enable:function(b,f,d,k){d=a.getElementById(b+"contr"+d+"Img");vApp.user.control._enable(d,f,b,k)},_enable:function(a,b,d,k){a.parentNode.setAttribute("data-title",vApp.lang.getString(b+"Enable"));"audio"==b&&a.parentNode.setAttribute("data-title",vApp.lang.getString(b+"Disable"));a.setAttribute("data-"+b+"-disable","false");a.className="icon-"+b+"Img enable "+b+"Img";vApp.user.control.updateUser(d,k,!0)},changeAttribute:function(a,b,d,k,h){d?
vApp.user.control._enable(b,k,a,h):vApp.user.control._disable(b,k,a,h)},init:function(a){var b=a.id,d=b.indexOf("contr"),d=b.substring(0,d),b=b.split("contr")[1],k=b.indexOf("Img"),b=b.substring(0,k);"Assign"==b?(vApp.gObj.controlAssign=!0,vApp.gObj.controlAssignId=d,b="true"==a.getAttribute("data-assign-disable")?!0:!1,b||(this.control.changeAttribute(d,a,b,"assign","aRole"),vApp.user.control._assign(d),vApp.user.control.changeAttrToAssign("block"))):"Chat"==b?("true"==a.getAttribute("data-chat-disable")?
(a.className="contrChatBlock",b="enable",this.control.changeAttribute(d,a,!0,"chat","ch")):(b="block",this.control.changeAttribute(d,a,!1,"chat","ch")),this.control._chat(d,b)):"Aud"==b&&("true"==a.getAttribute("data-audio-disable")?(b="enable",this.control.changeAttribute(d,a,!0,"audio","aud")):(b="block",this.control.changeAttribute(d,a,!1,"audio","aud")),this.control._audio(d,b))},_assign:function(b,d,g){vApp.wb.utility.assignRole();vApp.vutil.removeAppPanel();if(!vApp.vutil.chkValueInLocalStorage("orginalTeacherId")){var k=
a.getElementById("vcanvas");k.className=k.className.replace(/\bteacher\b/," ");k.className="student"}localStorage.setItem("canvasDrwMsg",!0);k=a.getElementById("vAppScreenShareLocalVideo");null!=k&&"VIDEO"==k.tagName&&vApp.vutil.videoTeacher2Student("ScreenShare",!0);var h;"ScreenShare"==vApp.currApp&&(h="ss");"Whiteboard"!=vApp.currApp&&(vApp[h].hasOwnProperty("currentStream")&&vApp[h].currentStream.stop(),vApp[h]="");"undefined"==typeof d&&vApp.wb.utility.beforeSend({assignRole:!0,toUser:b});null==
