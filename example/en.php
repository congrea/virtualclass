<?php
    ...
    $string['downloadsession'] = 'Please wait while the recording is downloaded.';
    $string['askplaymsg'] = '<span id="askplaymsg"> "Downloading in process, click Play to begin </span>"';
    ...
    $string['audioEnable'] = 'Unmute';
    $string['audioDisable'] = 'Mute';
