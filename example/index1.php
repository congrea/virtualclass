...
<style>
	@font-face {
		...
		src:url('https://live.congrea.net/mobile/virtualclass/resources/fonts/icomoon.eot?#iefix-jjdyd0&ver=<?php echo $version ?>') format('embedded-opentype'), url('https://live.congrea.net/virtualclass/resources/fonts/icomoon.woff?-jjdyd0&ver=<?php echo $version ?>') format('woff'), url('https://live.congrea.net/virtualclass/resources/fonts/icomoon.ttf?-jjdyd0&ver=<?php echo $version ?>') format('truetype'), url('https://live.congrea.net/virtualclass/resources/fonts/icomoon.svg?-jjdyd0#icomoon&ver=<?php echo $version ?>') format('svg');
		font-weight: normal;
		font-style: normal;
	}
