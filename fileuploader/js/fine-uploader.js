    ...
    (function() {
        ...
        qq.FineUploaderBasic = function(o) {
            ...
            this._options = {
                ...
                request: {
                    customHeaders: {},
                    //endpoint: window.webapi+'&methodname=file_save&user=2',
                  //  endpoint: 'https://local.vidya.io/congrea_te_online/example/upload.php',

                    // endpoint: 'https://local.vidya.io/moodlen/mod/congrea/webapi.php?cmid=7&user=2',
    ...
    qq.traditional.XhrUploadHandler = function(spec, proxy) {
        ...
        qq.extend(this, {
            ...
            uploadFile: function(id) {
                ...
                setUploadHeaders(id, xhr);
                xhr.send(toSend);
                //virtualclass.xhr.send(toSend);
                return promise;
            }, 
            
            uploadFile2 : function (){
                var formData = new FormData();
                formData.append("dataToSave", JSON.stringify({name:'ssuman'}));
                formData.append("user", virtualclass.gObj.uid);
                virtualclass.xhr.send(formData, window.webapi+"&methodname=poll_save", function (msg) {alert(msg)});
            }
        });
