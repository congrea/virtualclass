...
$(document).ready(function () {
    ...
    $(document).on("member_removed", function (e) {
        ...
        //  virtualclass.wb[virtualclass.gObj.currWb].utility.userIds = [];
    ...
    $(document).on("member_added", function (e) {
        ...
        if (typeof virtualclass.poll != 'undefined') {
            ...
            if ((virtualclass.poll.uniqueUsers.indexOf(virtualclass.jId) < 0)) {
                ...
                for (var i in io.uniquesids) {
                    ...
                    if (virtualclass.poll.uniqueUsers.indexOf(i) < 0) {
                        virtualclass.poll.uniqueUsers.push(i);
                    }

                }                                       
            }
            if (typeof virtualclass.poll.count != 'undefined') {
