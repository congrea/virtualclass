const api = {
  ...
  UpdateDocumentStatus: 'https://api.congrea.net/t/UpdateDocumentStatus',
  GetDocumentURLs: 'https://api.congrea.net/t/GetDocumentURLs',
  UpdateRoomMetaData: 'https://api.congrea.net/t/UpdateRoomMetaData',
