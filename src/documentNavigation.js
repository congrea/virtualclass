...
(function (window, document) {
    ...
    pageIndexNav.prototype.init = function () {
        ...
        this.n = this.countShownPage(this.width);
    ...
    pageIndexNav.prototype.createIndex = function () {
        ...
        for (var i = 0; i < virtualclass.dts.order.length; i++) {
            // if(typeof virtualclass.dts.notes[virtualclass.dts.order[i]] != 'object'){
    ...
    pageIndexNav.prototype.rearrangeIndex = function (order) {
        ...
        if (container) {
            ...
            if(tmpdiv){
            var old = []
            // incase of rearrange save the old class
            if (this.oldOrder) {
...
//        if(virtualclass.dts.notes[order] && virtualclass.dts.notes[order].status == 1){
//           sn.setAttribute("status",1)
//        }else{
//           sn.setAttribute("status",0)
//        }
...
//        }
    ...
    pageIndexNav.prototype.UI = {
        ...
        wbIndexdisplay: function (navType) {
            if (id > this.n) {
                var shw = document.querySelector(".noteIndex.shw");
                shw.className = "noteIndex hid left";
            }
        ...
        navigatorMode: function () {
            ...
            var firstElement = virtualclass.dts.order[0];
