(function (window) {
    ...
    var message = {
        ...
        'mybsharedoc' : 'There might be share the Docs',
        'status' : 'status',
        'delete' : 'delete',
        'EnAll' : 'Enable All',
        ...
        'Creator' : 'Creator',
        'pollmybpublish' : 'Poll may be published',
        'NAME' : 'NAME',
        ...
        'canvasmissing' : 'Canvas is missing in your browsers. Please update the latest version of your browser',
        'youtubewllbshrshortly' : 'YouTube video will be shared shortly.',
        'ShareYouTubeVideo' : 'Share YouTube Video',
        'Prev' : 'Prev',
        'Next' : 'Next',
