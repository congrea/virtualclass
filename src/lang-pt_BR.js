(function (window) {
  ...
  const message = {
    ...
    askplayMessage: '<span id="askplaymsg"> Devemos começar a sessão?</span><br /><span id="remaingmsg">Os dados restantes serão baixados em paralelo.</span>',
    ...
    cancel: 'Cancelar',
    canvasDrawMsg: 'Você pode clicar em qualquer ferramenta de desenho' + 'clique e segure o botão esquerdo do mouse para desenhar',
    ...
    chFireBrowsersIssue: 'Seu browser {virtualclass1} {virtualclass2} precisa atualizar, Congrea suporta Chrome 40+ e Firefox 35+.',
    ...
    commonBrowserIssue: 'Seu browser {virtualclass1} {virtualclass2} não é suportado, Use a última versão do Chrome ou Firefox.',
    ...
    InternalError: 'Por favor, certifique-se que a mesma webcam não está sendo usada <br /> em múltiplos browsers ou múltiplas aplicações. ',
    ...
    Line: 'Linha',
    lowBandWidthSpeed: 'Sua banda larga é muito baixa, nós vamos parar o vídeo. Você ainda poderá ouvir o áudio e ver a tela.',
    ...
    media: 'Mídia',
    mediumBandWidthSpeed: 'Sua banda larga é limitada, nós vamos reduzir a qualidade do vídeo de acordo com a banda larga disponível.',
    ...
    NotReadableError: 'Favor certifique-se que a mesma webcam não está sendo usada <br /> em múltiplos browsers ou múltiplas aplicações.',
    notsupportbrowser: '{virtualclass1} não é completamente compatível. Para a melhor experiência, use o Google Chrome.',
    ...
    noPollNoAdmin: 'Não há nenhuma questão disponível para a enquete de site. Só o admin pode criar enquete a nível de site.',
    ...
    operaBrowserIssue: 'Seu browser {virtualclass1} {virtualclass2} é parcialmente suportado. Você não poderá compartilhar sua tela. Congrea suporta completamente Chrome e Firefox',
    Options: 'Opções',
    ...
    reclaim: 'Retomar',
    Rectangle: 'Retângulo',
    rejected: 'Outra aplicação no seu computador pode estar usando sua Webcam. Favor fechar todas as outras aplicações',
    ...
    reply: 'Responder',
    safariBrowserIssue: 'Seu browser Safari {virtualclass1} não é suportado. Nós suportamos completamente o Chrome e o Firefox',
    Save: 'Salvar',
    savesession: 'Deseja salvar a sessão atual?',
    savesessionTechSupport: "Deseja salvar a sessão atual? <br /> Uma vez baixada a sessão, atualizações não serão disponíveis ao baixar novamente a mesma sessão.",
    ...
    SourceUnavailableError: 'Favor certifique-se que a mesma Webcam não está sendo usada em múltiplos browsers ou múltiplas aplicações.',
    // 'SourceUnavailableError' : 'Outra aplicação no seu computador pode estar usando a Webcam. Favor fechar tais aplicações.',
    ...
    studentSafariBrowserIssue: 'Seu browser {virtualclass1} {virtualclass2} não pode compartilhar sua Webcam com outros usuários. Congrea suporta completamente Chrome e Firefox.',
    supportDesktop: 'Sala Virtual não suporta tablets nem smartphones. Para apresentar, favor usar um computador.',
    supportDesktopOnly: 'Desculpe, o modo de apresentador só suporta computadores. Tablets e smartphones não são suportados.',
    teacherSafariBrowserIssue: 'Safari não suporta a funcionalidade de apresentador. Favor trocar para Chrome ou Firefox.',
    ...
    wbrtcMsgChrome: 'Você pode clicar no botão de negação para não compartilhar seu microfone e câmera com o Congrea.' + 'ou clicar no botão de permitir para compartilhá-los.',
    wbrtcMsgFireFox: 'Você pode clicar em "Compartilhar Dispositivos Selecionados"' + ' para compartilhar seu microfone e câmera com outros usuários',
    ...
    /* For Chrome */
    PermissionDeniedErrorExt: '<div class="errorMsg"> Acesso à câmera foi bloqueado. Para providenciar acesso à Webcam, favor seguir os procedimentos abaixo <br />'
    ...
    + ' <figure class="chrome" > <img src="https://www.congrea.com/wp-content/uploads/2016/10/ff-vídeo.png" > <figcaption>Chrome</figcaption> </figure></div>',

    SecurityErrorExt: '<div class="errorMsg"> Acesso à câmera foi bloqueado. Para providenciar acesso à Webcam, favor seguir os procedimentos abaixo <br />'
    + 'Vá para o ícone de câmera no topo direito da tela <br /> '
    + 'Clique na opção "Sempre permitir..." e selecione a opção de câmera <br />  '
    + 'Clique em finalizado e recarregue a tela  </div> <div class="screenImages">'
    + ' <figure class="chrome" > <img src="https://www.congrea.com/wp-content/uploads/2016/10/ff-vídeo.png" > <figcaption>Chrome</figcaption> </figure></div>',

    nopermissionExt: '<div class="errorMsg"> Acesso à câmera foi bloqueado. Para providenciar acesso à Webcam, favor seguir os procedimentos abaixo <br />'
    + 'Vá para o ícone de câmera no topo direito da tela <br /> '
    + 'Clique na opção "Sempre permitir..." e selecione a opção de câmera <br />  '
    + 'Clique em finalizado e recarregue a tela  </div> <div class="screenImages">'
    + ' <figure class="chrome" > <img src="https://www.congrea.com/wp-content/uploads/2016/10/ff-vídeo.png" > <figcaption>Chrome</figcaption> </figure></div>',
    ...
    + "Você pode baixá-lo <a href='https://chrome.google.com/webstore/detail/desktop-selector/ijhofagnokdeoghaohcekchijfeffbjl' target='_blank'>AQUI.</a>",


    /* For Firefox */
    PermissionDeniedErrorExtFF: '<div class="errorMsg"> Acesso à câmera foi bloqueado. Para providenciar acesso à Webcam, favor seguir os procedimentos abaixo <br />'
    ...
    SecurityErrorExtFF: '<div class="errorMsg"> Acesso à câmera foi bloqueado. Para providenciar acesso à Webcam, favor seguir os procedimentos abaixo <br />'
    + 'Vá para o ícone de câmera no topo esquerdo da tela <br /> '
    + 'Clique na opção "Compartilhar Dispositivo Selecionado"'
    + '<div class="screenImages">'
    + '<figure class="firefox" > <img src="https://www.congrea.com/wp-content/uploads/2016/10/ff-screnshare.png" > <figcaption>Chrome</figcaption> </figure></div>',

    nopermissionExtFF: '<div class="errorMsg"> Acesso à câmera foi bloqueado. Para providenciar acesso à Webcam, favor seguir os procedimentos abaixo <br />'
    + 'Vá para o ícone de câmera no topo esquerdo da tela <br /> '
    + 'Clique na opção "Compartilhar Dispositivo Selecionado"'
    + '<div class="screenImages">'
    + '<figure class="firefox" > <img src="https://www.congrea.com/wp-content/uploads/2016/10/ff-screnshare.png" > <figcaption>Chrome</figcaption> </figure></div>',
