...
this.JST['dest_temp/templates/appSettingDetail.hbs'] = Handlebars.template({
  1(container, depth0, helpers, partials, data) {
    const alias1 = depth0 != null ? depth0 : (container.nullContext || {}); const alias2 = helpers.helperMissing; const
      alias3 = container.escapeExpression;

    return ` <div class="bulkUserActions app-setting-rbs"><div class="setting-heading"><label class="bulk">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'bulkUserActions', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Audio', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Video', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Chat', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'GroupChat', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'RaiseHand', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'UserList', { name: 'getString', hash: {}, data }))
  ...
  3(container, depth0, helpers, partials, data) {
    return ` <div class="uiMuteAll"><a id="contrAudioAll"><span class="cgIcon"id="contrAudioAllImg" data-action="disable" class="icon-all-audio-disable cgIcon" data-title="${
      container.escapeExpression((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'muteAll', { name: 'getString', hash: {}, data }))
    }"></span></a></div> `;
  },
  compiler: [7, '>= 4.0.0'],
  main(container, depth0, helpers, partials, data) {
    let stack1; const alias1 = depth0 != null ? depth0 : (container.nullContext || {}); const alias2 = helpers.helperMissing; const
      alias3 = container.escapeExpression;

    return `<div id="appSettingDetail"> ${
      (stack1 = helpers.if.call(alias1, (depth0 != null ? depth0.hasControl : depth0), {
        name: 'if', hash: {}, fn: container.program(1, data, 0), inverse: container.noop, data,
      })) != null ? stack1 : ''
    } <div id="settingGeneral" class="app-settings-rbs"><div class="setting-heading"><label>${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'general', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'appPrerequites', { name: 'getString', hash: {}, data }))
    } <span class="pre-check-btn" id="precheckBtn"><div id="settingPrecheck"><div class="prechk" data-title="${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'precheck', { name: 'getString', hash: {}, data }))
    }" id="precheckTest"><span class="precheck cgIcon" id="precheckSetting">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'precheckStart', { name: 'getString', hash: {}, data }))
    }</span></div></div></span></li></ul></div><div id="settingAudioVideo" style="display:none;"> ${
      (stack1 = helpers.if.call(alias1, (depth0 != null ? depth0.hasControl : depth0), {
        name: 'if', hash: {}, fn: container.program(3, data, 0), inverse: container.noop, data,
      })) != null ? stack1 : ''
...
this.JST['dest_temp/templates/appTools.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="virtualclassAppOptionsCont" style="z-index: 100;"><div id="virtualclassOptionsCont" style="z-index: 100;"><div class="appOptions" id="virtualclassWhiteboardTool"><a class="congtooltip" data-doc="_doc0_0" data-title="${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Whiteboard', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'DocumentSharing', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'ScreenShare', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'ShareVideo', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'poll', { name: 'getString', hash: {}, data }))
    }" href="#"><span class="icon-poll cgIcon"></span></a></div><div class="appOptions" id="virtualclassQuizTool"><a class="congtooltip" data-title="${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Quiz', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'TextEditor', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'CodeEditor', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'SharePresentation', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'SessionEnd', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/audioWidget.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="audioWidget"><ul class="nav navbar-nav" id="mainAudioPanel"><li id="speakerPressOnce" class="${
      alias4(((helper = (helper = helpers.classes || (depth0 != null ? depth0.classes : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'classes', hash: {}, data }) : helper)))
    }" data-audio-playing=${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dap', { name: 'getString', hash: {}, data }))
    }><a id="speakerPressonce" class="congtooltip" data-title="${
      alias4(((helper = (helper = helpers.audio_tooltip || (depth0 != null ? depth0.audio_tooltip : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'audio_tooltip', hash: {}, data }) : helper)))
    }" data-meeting="${
      alias4(((helper = (helper = helpers.meetingMode || (depth0 != null ? depth0.meetingMode : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'meetingMode', hash: {}, data }) : helper)))
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'videooff', { name: 'getString', hash: {}, data }))
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'setting', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/chat/chatbox.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<li id="tabcb${
      alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'id', hash: {}, data }) : helper)))
    }" class="ui-state-default ui-corner-bottom ui-tabs-active ui-state-active" aria-controls="tabcb${
      alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'id', hash: {}, data }) : helper)))
    }"><a href="#tabcb${
      alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'id', hash: {}, data }) : helper)))
    }" class="ui-tabs-anchor">${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'adminusr', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/chat/chatuser.hbs'] = Handlebars.template({
  1(container, depth0, helpers, partials, data) {
    let stack1; const alias1 = container.lambda; const
  ...
  5(container, depth0, helpers, partials, data) {
    let stack1; const alias1 = container.lambda; const alias2 = container.escapeExpression; const
    ...
    return ` <div id="${
      ...
      (stack1 = helpers.if.call(alias3, ((stack1 = (depth0 != null ? depth0.peer : depth0)) != null ? stack1.isTeacher : stack1), {
        name: 'if', hash: {}, fn: container.program(6, data, 0), inverse: container.noop, data,
      })) != null ? stack1 : ''
      ...
      alias2((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(alias3, 'audioEnable', { name: 'getString', hash: {}, data }))
    }" id="${
      alias2(alias1(((stack1 = (depth0 != null ? depth0.peer : depth0)) != null ? stack1.userid : stack1), depth0))
      ...
      (stack1 = helpers.if.call(alias3, ((stack1 = (depth0 != null ? depth0.peer : depth0)) != null ? stack1.isTeacher : stack1), {
        name: 'if', hash: {}, fn: container.program(8, data, 0), inverse: container.noop, data,
      })) != null ? stack1 : ''
    } </div> `;
  },
  6(container, depth0, helpers, partials, data) {
    let stack1; const alias1 = container.lambda; const alias2 = container.escapeExpression; const alias3 = depth0 != null ? depth0 : (container.nullContext || {}); const
    ...
    return ` <div id="${
      ...
      alias2((helpers.getString || (depth0 && depth0.getString) || alias4).call(alias3, 'transferControls', { name: 'getString', hash: {}, data }))
    }"><span id="${
      alias2(alias1(((stack1 = (depth0 != null ? depth0.peer : depth0)) != null ? stack1.userid : stack1), depth0))
      ...
      alias2((helpers.getString || (depth0 && depth0.getString) || alias4).call(alias3, 'disabled', { name: 'getString', hash: {}, data }))
      ...
      alias2((helpers.getString || (depth0 && depth0.getString) || alias4).call(alias3, 'requestScreenShare', { name: 'getString', hash: {}, data }))
    }" id="${
      alias2(alias1(((stack1 = (depth0 != null ? depth0.peer : depth0)) != null ? stack1.userid : stack1), depth0))
  ...
  8(container, depth0, helpers, partials, data) {
    ...
    return ` <div class="controleCont userChat chatControl${
      ...
      alias2((helpers.getString || (depth0 && depth0.getString) || alias4).call(alias3, 'chatEnable', { name: 'getString', hash: {}, data }))
    }" id="${
      alias2(alias1(((stack1 = (depth0 != null ? depth0.peer : depth0)) != null ? stack1.userid : stack1), depth0))
      ...
      alias2((helpers.getString || (depth0 && depth0.getString) || alias4).call(alias3, 'writemode', { name: 'getString', hash: {}, data }))
    }" id="${
      alias2(alias1(((stack1 = (depth0 != null ? depth0.peer : depth0)) != null ? stack1.userid : stack1), depth0))
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div class="userImg ui-memblist-usr online media ${
      ...
      (stack1 = helpers.if.call(alias3, ((stack1 = ((stack1 = (depth0 != null ? depth0.peer : depth0)) != null ? stack1.chatIconColors : stack1)) != null ? stack1.savedImg : stack1), {
        name: 'if', hash: {}, fn: container.program(1, data, 0), inverse: container.program(3, data, 0), data,
      })) != null ? stack1 : ''
      ...
      (stack1 = helpers.if.call(alias3, ((stack1 = (depth0 != null ? depth0.peer : depth0)) != null ? stack1.notSelf : stack1), {
        name: 'if', hash: {}, fn: container.program(5, data, 0), inverse: container.noop, data,
      })) != null ? stack1 : ''
    } </div>`;
  },
  useData: true,
...
this.JST['dest_temp/templates/chat/stickycont.hbs'] = Handlebars.template({
  ...
  7(container, depth0, helpers, partials, data) {
    return ` <li class="handRaise enable congtooltip " id="congHr" data-title ="${
      container.escapeExpression((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'RaiseHandStdEnabled', { name: 'getString', hash: {}, data }))
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<ul class="chatBarTab nav navbar-nav"> ${
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'commonChat', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Chatroom', { name: 'getString', hash: {}, data }))
    }</span></a></li> ${
      (stack1 = helpers.if.call(alias1, (depth0 != null ? depth0.control : depth0), {
        name: 'if', hash: {}, fn: container.program(5, data, 0), inverse: container.program(7, data, 0), data,
      })) != null ? stack1 : ''
...
this.JST['dest_temp/templates/dashboard.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    return `<div id="congdashboard" class="modal in" role="dialog"><div class="modal-dialog"><div class="modal-content dashboardContainer"><div class="modal-header"><button type="submit" class="close btn btn-default">${
      container.escapeExpression((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'Finish', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/dashboardNav.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="dashboardnav" class="navigation congtooltip" data-title="${
      alias4(((helper = (helper = helpers.app || (depth0 != null ? depth0.app : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'app', hash: {}, data }) : helper)))
...
this.JST['dest_temp/templates/documentSharing/dashboard.hbs'] = Handlebars.template({
  ...
  compiler: [7, '>= 4.0.0'],
  main(container, depth0, helpers, partials, data) {
    let stack1; let helper; const alias1 = depth0 != null ? depth0 : (container.nullContext || {}); const alias2 = helpers.helperMissing; const
      alias3 = container.escapeExpression;

    return ` <div class='dbContainer' data-app="${
      alias3(((helper = (helper = helpers.app || (depth0 != null ? depth0.app : depth0)) != null ? helper : alias2), (typeof helper === 'function' ? helper.call(alias1, { name: 'app', hash: {}, data }) : helper)))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Udocument', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/documentSharing/docsMain.hbs'] = Handlebars.template({
  ...
  3(container, depth0, helpers, partials, data) {
    return ` <p id="docMsgStudent">${
      container.escapeExpression((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'mybsharedoc', { name: 'getString', hash: {}, data }))
    }</p> `;
  },
  compiler: [7, '>= 4.0.0'],
  main(container, depth0, helpers, partials, data) {
...
this.JST['dest_temp/templates/documentSharing/docsNav.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return ` <div class="link${
      alias4(((helper = (helper = helpers.type || (depth0 != null ? depth0.type : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'type', hash: {}, data }) : helper)))
    } links list-group-item" id="link${
      alias4(((helper = (helper = helpers.type || (depth0 != null ? depth0.type : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'type', hash: {}, data }) : helper)))
    }${alias4(((helper = (helper = helpers.rid || (depth0 != null ? depth0.rid : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'rid', hash: {}, data }) : helper)))
    }" data-screen="${
      alias4(((helper = (helper = helpers.type || (depth0 != null ? depth0.type : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'type', hash: {}, data }) : helper)))
    }${alias4(((helper = (helper = helpers.rid || (depth0 != null ? depth0.rid : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'rid', hash: {}, data }) : helper)))
    } " data-rid="${
      ...
      alias4(((helper = (helper = helpers.status || (depth0 != null ? depth0.status : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'status', hash: {}, data }) : helper)))
    }"><a class="statusanch">${
      alias4(((helper = (helper = helpers.status || (depth0 != null ? depth0.status : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'status', hash: {}, data }) : helper)))
    }</a></div><div class="controls delete"><a class="deleteanch"></a></div></div><div class="mainpreview tooltip2" id="mainpdocs${
      alias4(((helper = (helper = helpers.rid || (depth0 != null ? depth0.rid : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'rid', hash: {}, data }) : helper)))
    }" title="${
      alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'title', hash: {}, data }) : helper)))
    }" data-screen="${
      alias4(((helper = (helper = helpers.type || (depth0 != null ? depth0.type : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'type', hash: {}, data }) : helper)))
    }${alias4(((helper = (helper = helpers.rid || (depth0 != null ? depth0.rid : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'rid', hash: {}, data }) : helper)))
    }" data-rid="${
...
this.JST['dest_temp/templates/documentSharing/notesMain.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}), (depth0 != null ? depth0.notes : depth0), {
      name: 'each', hash: {}, fn: container.program(1, data, 0), inverse: container.noop, data,
    })) != null ? stack1 : '');
  },
  useData: true,
});
...
this.JST['dest_temp/templates/documentSharing/notesNav.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return ` <div class="linknotes links col-sm-2" id="link${
      ...
      alias4(((helper = (helper = helpers.content_path || (depth0 != null ? depth0.content_path : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'content_path', hash: {}, data }) : helper)))
    }"></div><div id="controlCont${
      alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'id', hash: {}, data }) : helper)))
    }" class="controlCont"><div class="controls status" data-status="${
      alias4(((helper = (helper = helpers.status || (depth0 != null ? depth0.status : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'status', hash: {}, data }) : helper)))
    }" title="${
      alias4(((helper = (helper = helpers.titleAction || (depth0 != null ? depth0.titleAction : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'titleAction', hash: {}, data }) : helper)))
    }"><a class="statusanch">${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'status', { name: 'getString', hash: {}, data }))
    }${alias4(((helper = (helper = helpers.status || (depth0 != null ? depth0.status : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'status', hash: {}, data }) : helper)))
    }</a></div><div class="controls delete" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'delete', { name: 'getString', hash: {}, data }))
    }"><a class="deleteanch">${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'delete', { name: 'getString', hash: {}, data }))
    }</a></div></div></div>`;
  },
...
this.JST['dest_temp/templates/documentSharing/screen.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return ` <div id="screen-docs" data-doc="${
      alias4(((helper = (helper = helpers.cd || (depth0 != null ? depth0.cd : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cd', hash: {}, data }) : helper)))
    }" class="screen page_wrapper current"> ${
      alias4(((helper = (helper = helpers.debug || (depth0 != null ? depth0.debug : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'debug', hash: {}, data }) : helper)))
    } <div class="pageContainer"><div id="notesContainer" class="notes"> ${
      (stack1 = container.invokePartial(partials.docNotesMain, depth0, {
        name: 'docNotesMain', data, helpers, partials, decorators: container.decorators,
      })) != null ? stack1 : ''
    } </div> ${
      (stack1 = helpers.if.call(alias1, (depth0 != null ? depth0.hasControls : depth0), {
        name: 'if', hash: {}, fn: container.program(1, data, 0), inverse: container.noop, data,
...
this.JST['dest_temp/templates/editor/edenableall.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="all${
      alias4(((helper = (helper = helpers.type1 || (depth0 != null ? depth0.type1 : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'type1', hash: {}, data }) : helper)))
    }Container" class="editorController congtooltip" data-title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'oncollaboration', { name: 'getString', hash: {}, data }))
    }"><a id="all${
      alias4(((helper = (helper = helpers.type1 || (depth0 != null ? depth0.type1 : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'type1', hash: {}, data }) : helper)))
    }ContainerAnch" href="#" data-action="enable"><span class="cgText"> ${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'collaborate', { name: 'getString', hash: {}, data }))
    }</span></a></div>`;
  },
  useData: true,
});
...
this.JST['dest_temp/templates/editor/editorrich.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="virtualclass${
      ...
      alias4(((helper = (helper = helpers.class || (depth0 != null ? depth0.class : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'class', hash: {}, data }) : helper)))
    }"><div id="virtualclass${
      alias4(((helper = (helper = helpers.type || (depth0 != null ? depth0.type : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'type', hash: {}, data }) : helper)))
    }Body"></div></div>`;
  },
...
this.JST['dest_temp/templates/editor/messagebox.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    return `<div id="synchMessageBox" width="340px" height="15px"><p id="readOnlyMsg">${
      container.escapeExpression((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'pleasewaitWhSynNewCont', { name: 'getString', hash: {}, data }))
    }</p></div>`;
  },
  useData: true,
});
...
this.JST['dest_temp/templates/leftBar.hbs'] = Handlebars.template({
  1(container, depth0, helpers, partials, data) {
    ...
    return ` ${
      (stack1 = helpers.if.call(depth0 != null ? depth0 : (container.nullContext || {}), (depth0 != null ? depth0.meetingMode : depth0), {
        name: 'if', hash: {}, fn: container.program(2, data, 0), inverse: container.program(4, data, 0), data,
      })) != null ? stack1 : ''
    } `;
  },
  2(container, depth0, helpers, partials, data) {
    ...
    return ` ${
      (stack1 = container.invokePartial(partials.appToolsMeeting, depth0, {
        name: 'appToolsMeeting', data, helpers, partials, decorators: container.decorators,
      })) != null ? stack1 : ''
    } `;
  },
  4(container, depth0, helpers, partials, data) {
    ...
    return ` ${
      (stack1 = container.invokePartial(partials.appTools, depth0, {
        name: 'appTools', data, helpers, partials, decorators: container.decorators,
      })) != null ? stack1 : ''
    } `;
  },
  6(container, depth0, helpers, partials, data) {
  ...
  compiler: [7, '>= 4.0.0'],
  main(container, depth0, helpers, partials, data) {
    let stack1; let helper; const
      alias1 = depth0 != null ? depth0 : (container.nullContext || {});

    return `<div id="virtualclassAppLeftPanel" class="leftbar hideZoom" data-surname="${
      container.escapeExpression(((helper = (helper = helpers.meetingMode || (depth0 != null ? depth0.meetingMode : depth0)) != null ? helper : helpers.helperMissing), (typeof helper === 'function' ? helper.call(alias1, { name: 'meetingMode', hash: {}, data }) : helper)))
    }"> ${
      (stack1 = helpers.if.call(alias1, (depth0 != null ? depth0.hasControls : depth0), {
        name: 'if', hash: {}, fn: container.program(1, data, 0), inverse: container.noop, data,
      })) != null ? stack1 : ''
...
this.JST['dest_temp/templates/main.hbs'] = Handlebars.template({
  1(container, depth0, helpers, partials, data) {
    ...
    return ` ${
      (stack1 = container.invokePartial(partials.recordingControl, depth0, {
        name: 'recordingControl', data, helpers, partials, decorators: container.decorators,
      })) != null ? stack1 : ''
    } `;
  },
  compiler: [7, '>= 4.0.0'],
  main(container, depth0, helpers, partials, data) {
    ...
    return `${(stack1 = container.invokePartial(partials.precheck, depth0, {
      name: 'precheck', data, helpers, partials, decorators: container.decorators,
    })) != null ? stack1 : ''
    } ${
      (stack1 = container.invokePartial(partials.joinclass, depth0, {
        name: 'joinclass', data, helpers, partials, decorators: container.decorators,
      })) != null ? stack1 : ''
      ...
      (stack1 = container.invokePartial(partials.rightBar, depth0, {
        name: 'rightBar', data, helpers, partials, decorators: container.decorators,
      })) != null ? stack1 : ''
    } ${
      (stack1 = container.invokePartial(partials.leftBar, depth0, {
        name: 'leftBar', data, helpers, partials, decorators: container.decorators,
      })) != null ? stack1 : ''
    } ${
      (stack1 = container.invokePartial(partials.popupCont, depth0, {
        name: 'popupCont', data, helpers, partials, decorators: container.decorators,
      })) != null ? stack1 : ''
    } ${
      (stack1 = container.invokePartial(partials.dashboardCont, depth0, {
        name: 'dashboardCont', data, helpers, partials, decorators: container.decorators,
      })) != null ? stack1 : ''
    } </div>`;
  },
  usePartial: true,
...
this.JST['dest_temp/templates/navigation/docIndex.hbs'] = Handlebars.template({
  compiler: [7, '>= 4.0.0'],
  main(container, depth0, helpers, partials, data) {
    let helper; const alias1 = depth0 != null ? depth0 : (container.nullContext || {}); const alias2 = helpers.helperMissing; const alias3 = 'function'; const
      alias4 = container.escapeExpression;
    ...
    return `<span id="index${
      alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'id', hash: {}, data }) : helper)))
    }" class="noteIndex shw active" data-set="${
      alias4(((helper = (helper = helpers.page || (depth0 != null ? depth0.page : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'page', hash: {}, data }) : helper)))
    }">${
      alias4(((helper = (helper = helpers.page || (depth0 != null ? depth0.page : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'page', hash: {}, data }) : helper)))
    }</span>`;
  },
...
this.JST['dest_temp/templates/navigation/navMain.hbs'] = Handlebars.template({
  1(container, depth0, helpers, partials, data) {
    let helper; const alias1 = depth0 != null ? depth0 : (container.nullContext || {}); const alias2 = helpers.helperMissing; const alias3 = 'function'; const
      alias4 = container.escapeExpression;
    ...
    return ` <span id="leftNavPage" class="pageNav"></span><span class="navArrow"></span><span class="pageHead">Page</span><div id="ancCont" class="noCont"><div id="pageAnc"><span id="currIndex">${
      alias4(((helper = (helper = helpers.currIndex || (depth0 != null ? depth0.currIndex : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'currIndex', hash: {}, data }) : helper)))
    }</span><span id="totalPages"> of ${
      alias4(((helper = (helper = helpers.totalPages || (depth0 != null ? depth0.totalPages : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'totalPages', hash: {}, data }) : helper)))
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return ((stack1 = helpers.if.call(depth0 != null ? depth0 : (container.nullContext || {}), (depth0 != null ? depth0.control : depth0), {
      name: 'if', hash: {}, fn: container.program(1, data, 0), inverse: container.program(3, data, 0), data,
    })) != null ? stack1 : '');
  },
  useData: true,
...
this.JST['dest_temp/templates/navigation/wbIndex.hbs'] = Handlebars.template({
  compiler: [7, '>= 4.0.0'],
  main(container, depth0, helpers, partials, data) {
    let helper; const alias1 = depth0 != null ? depth0 : (container.nullContext || {}); const alias2 = helpers.helperMissing; const alias3 = 'function'; const
      alias4 = container.escapeExpression;
    ...
    return `<span id="index${
      alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'id', hash: {}, data }) : helper)))
    }" class="noteIndex shw active" value="${
      alias4(((helper = (helper = helpers.wid || (depth0 != null ? depth0.wid : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'wid', hash: {}, data }) : helper)))
    }">${
      alias4(((helper = (helper = helpers.order || (depth0 != null ? depth0.order : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'order', hash: {}, data }) : helper)))
    }</span>`;
  },
  useData: true,
});
...
this.JST['dest_temp/templates/poll/edit-modal.hbs'] = Handlebars.template({
  1(container, depth0, helpers, partials, data) {
    ...
    return ` <div class="inputWrapper clearfix"><textarea rows="1" id="option${
      alias1(((helper = (helper = helpers.key || (data && data.key)) != null ? helper : helpers.helperMissing), (typeof helper === 'function' ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}), { name: 'key', hash: {}, data }) : helper)))
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="editPollModal" class="modal in" tab-index="-1" area-hidden="true" style="display: block; padding-right: 0px;"><div class="modal-dialog"><div class="modal-content" id="pollModalBody"><div id="contHead" class="modal-header"><button type="button" class="close" id="modalClose" data-dismiss="modal">×</button><div id="editTx" class="row modalHeaderTx panel-body">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'PEdit', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Question', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Options', { name: 'getString', hash: {}, data }))
    }</label> ${
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Addoption', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Reset', { name: 'getString', hash: {}, data }))
    }<i class="icon-reset"></i></button><button id="etSave" class="btn btn-default controls">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Save', { name: 'getString', hash: {}, data }))
    }<i class="icon-save"></i></button><button id="saveNdPublish" class="btn btn-default controls">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Publish', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/poll/modal.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="editPollModal" class="modal in" tab-index="-1" area-hidden="true" style="display: block;"><div class="modal-dialog"><div class="modal-content" id="pollModalBody"><div id="contHead" class="modal-header"><button type="button" class="close" id="modalClose" data-dismiss="modal">×</button><div id="editTx" class="row modalHeaderTx panel-body">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'createnewpoll', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/poll/pollmain.hbs'] = Handlebars.template({
  1(container, depth0, helpers, partials, data) {
    ...
    return ` <li role="presentation" id="coursePollTab" class="navListTab active" data-toggle="popover" data-trigger="hover" data-content="${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'coursePoll', { name: 'getString', hash: {}, data }))
    }"><a href="#">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Cpoll', { name: 'getString', hash: {}, data }))
    }</a></li><li role="presentation" id="sitePollTab" class="navListTab" data-toggle="popover" data-trigger="hover" data-content="${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'sitePoll', { name: 'getString', hash: {}, data }))
    }"><a href="# ">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Spoll', { name: 'getString', hash: {}, data }))
    }</a></li> `;
  },
  3(container, depth0, helpers, partials, data) {
    const alias1 = depth0 != null ? depth0 : (container.nullContext || {}); const alias2 = helpers.helperMissing; const
    ...
    return ` <li role="presentation" id="pollResult" class="navListTab" data-toggle="popover" data-trigger="hover" data-content="${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'pollresult', { name: 'getString', hash: {}, data }))
    }"><a href="# ">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Presult', { name: 'getString', hash: {}, data }))
  ...
  5(container, depth0, helpers, partials, data) {
    ...
    return ` <div id="mszBoxPoll" class="row" style="display:none"></div><div id="createPollCont" class="createBtnCont"><button id="newPollBtnsite" class="btn btn-default site" data-toogle="modal" data-target="#editPollModal" style="display: none;"><i class="icon-create-new"></i>${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'addnew', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Controls', { name: 'getString', hash: {}, data }))
    }<i class="icon-setting"></i></th><th class="qnTextHeader col-sm-8">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'PQuestions', { name: 'getString', hash: {}, data }))
    }<i class="icon-help"></i></th><th class="creatorHeader col-sm-2">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Creator', { name: 'getString', hash: {}, data }))
  ...
  7(container, depth0, helpers, partials, data) {
    return ` <div id="mszBoxPoll" class="row"><div id="stdPollMszLayout">${
      container.escapeExpression((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'pollmybpublish', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/poll/pollresultlist.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<table id="listViewTable" class="table table-bordered"><thead><tr><th>${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'NAME', { name: 'getString', hash: {}, data }))
    }</th><th>${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'optselectd', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/poll/pollStd.hbs'] = Handlebars.template({
  1(container, depth0, helpers, partials, data) {
    ...
    return ` <div><input class="opt" name="option" value="${
      alias4(((helper = (helper = helpers.key || (data && data.key)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'key', hash: {}, data }) : helper)))
    }" type="radio" id="${
      alias4(((helper = (helper = helpers.key || (data && data.key)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'key', hash: {}, data }) : helper)))
    }"><span>${
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="stdPollContainer" class="container"><div id="stdContHead" class="panel"><div class="stdHeader"><label id="pollHead">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'pollHead', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/poll/preview-modal.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="editPollModal" class="modal in" tab-index="-1" area-hidden="true" style="display: block;"><div class="modal-dialog"><div class="modal-content" id="pollModalBody"><div id="contHead" class="modal-header"><button type="button" class="close" id="modalClose" data-dismiss="modal">×</button><div id="publishTx" class="row modalHeaderTx panel-body">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'ppoll', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Back', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/poll/qn.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<tr id="contQn${
      ...
      alias2((helpers.getString || (depth0 && depth0.getString) || alias4).call(alias3, 'edit', { name: 'getString', hash: {}, data }))
      ...
      alias2((helpers.getString || (depth0 && depth0.getString) || alias4).call(alias3, 'delete', { name: 'getString', hash: {}, data }))
      ...
      alias2((helpers.getString || (depth0 && depth0.getString) || alias4).call(alias3, 'Publish', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/poll/result-modal.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="editPollModal" class="modal in" tab-index="-1" area-hidden="true" style="display: block;"><div class="modal-dialog"><div class="modal-content" id="pollModalBody"><div id="contHead" class="modal-header"><button type="button" class="close" id="modalClose">×</button><div id="resultTx" class="row modalHeaderTx panel-body">${
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Rtime', { name: 'getString', hash: {}, data }))
    }</label><div id="timerCont"></div></div><div id="votesWrapper" class="col-md-6"><label id="congreaPollVoters">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'VotedSoFar', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'watstdrespo', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/poll/setting-modal.hbs'] = Handlebars.template({
  1(container, depth0, helpers, partials, data) {
    const alias1 = container.lambda; const
      alias2 = container.escapeExpression;
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div class="modal-dialog" id="yui_3_17_2_1_1496125638736_94"><div class="modal-content" id="pollModalBody"><div id="contHead" class="modal-header"><button type="button" class="close" id="modalClose" data-dismiss="modal">×</button><div id="settingTx" class="row modalHeaderTx panel-body">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'PSetting', { name: 'getString', hash: {}, data }))
    }</div></div><div id="contBody" class="modal-body"><div id="settingCont"><label class="pollLabel panel">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'ModeclosingPoll', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'ByInstructor', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'ByTimer', { name: 'getString', hash: {}, data }))
    }</span></label></span></label><div id="enTimer" class="panel"><label id="timerTx" class="pollLabel">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'SetTimer', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'minute', { name: 'getString', hash: {}, data }))
    }</option><option id="op2" value="second">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'second', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Showresulttostudents', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'cancel', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/poll/stdResult.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="resultLayout"><div id="resultLayoutHead" class="stdrslt container"><div id="timerWrapper"><label id="timerLabel">${
      alias1((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'Rtime', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/popupCont.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="popupContainer"><div id="about-modal" class="rv-vanilla-modal"><div id="recordingContainer" class="popupWindow"><div class="rv-vanilla-modal-header group" id="recordingHeaderContainer"><h2 class="rv-vanilla-modal-title cgText" id="recordingHeader"> ${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'uploadsession', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'totalprogress', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'indvprogress', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'uploadedsession', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'downloadsession', { name: 'getString', hash: {}, data }))
    }</div><div id="downloadPrgressLabel" class="cgText"> ${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'overallprogress', { name: 'getString', hash: {}, data }))
    } </div></div><div id="askPlay"><div id="askplayMessage"></div><button id="playButton" class="icon-play cgText">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'play', { name: 'getString', hash: {}, data }))
    }</button></div></div></div>  <div id="replayContainer" class="popupWindow"><p id="replayMessage">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'replay_message', { name: 'getString', hash: {}, data }))
    }</p><div id="replayClose" class="close icon-close"></div><button id="replayButton" class="icon-repeat cgText">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'replay', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'sessionexpired', { name: 'getString', hash: {}, data }))
    }</h3></div><span id="sessionEndClose" class="icon-close"></span><span id="sessionEndMsg"> ${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'sessionendmsg', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'validateurlmsg', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'waitmsgconnect', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'JoinClassMsg', { name: 'getString', hash: {}, data }))
    } </span><br/></div></div></div>`;
  },
  useData: true,
});
...
this.JST['dest_temp/templates/ppt/dashboard.hbs'] = Handlebars.template({
  compiler: [7, '>= 4.0.0'],
  main(container, depth0, helpers, partials, data) {
    let helper; const alias1 = depth0 != null ? depth0 : (container.nullContext || {}); const alias2 = helpers.helperMissing; const
      alias3 = container.escapeExpression;
    ...
    return `<div class='dbContainer' data-app="${
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'EHTMLPresentUrl', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/ppt/linkPpt.hbs'] = Handlebars.template({
  1(container, depth0, helpers, partials, data) {
    ...
    return ` <div class="controls status" data-status="${
      ...
      alias1((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'disable', { name: 'getString', hash: {}, data }))
  ...
  3(container, depth0, helpers, partials, data) {
    ...
    return ` <div class="controls status" data-status="${
      ...
      alias1((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'enable', { name: 'getString', hash: {}, data }))
    }"><a class="statusanch"></a></div> `;
  },
  compiler: [7, '>= 4.0.0'],
  main(container, depth0, helpers, partials, data) {
    let stack1; let helper; const alias1 = depth0 != null ? depth0 : (container.nullContext || {}); const alias2 = helpers.helperMissing; const alias3 = 'function'; const alias4 = container.escapeExpression; const
      alias5 = container.lambda;

    return `<div class="${
      alias4(((helper = (helper = helpers.className || (depth0 != null ? depth0.className : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'className', hash: {}, data }) : helper)))
    } row" id="link${
      alias4(((helper = (helper = helpers.type || (depth0 != null ? depth0.type : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'type', hash: {}, data }) : helper)))
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Play', { name: 'getString', hash: {}, data }))
    }"></div> ${
...
this.JST['dest_temp/templates/ppt/mszdisplay.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    return `<p id="pptMessageLayout">${
      container.escapeExpression((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'preWllBshortly', { name: 'getString', hash: {}, data }))
    }</p>`;
  },
  useData: true,
});
...
this.JST['dest_temp/templates/precheck.hbs'] = Handlebars.template({
  compiler: [7, '>= 4.0.0'],
  main(container, depth0, helpers, partials, data) {
    let helper; const alias1 = depth0 != null ? depth0 : (container.nullContext || {}); const alias2 = helpers.helperMissing; const alias3 = container.escapeExpression; const
      alias4 = 'function';
    ...
    return `<div id="virtualclassPreCheck" class="bootstrap"><div id="preCheckcontainer"><div class="container "><div class="modal in" id="myModal" role="dialog"><div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-body"><div id="precheckSkip" class="button clearfix"><span class="skip"></span></div><div id="preCheckProgress"><ul class="progressbar" id="congProgressbar"><li class="screen1 browser active"></li><li class="screen2 bandwidth"></li><li class="screen5 speaker"></li><li class="screen4 mic"></li><li class="screen3 webcam"></li></ul></div><div id="vcBrowserCheck" class="precheck browser"><div class="testName"> ${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'testingbrowser', { name: 'getString', hash: {}, data }))
    } </div><div class="result"></div><div id="browserButtons" class="button clearfix"><button type="button" class="next btn btn-default">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Next', { name: 'getString', hash: {}, data }))
    }</button></div></div><div id="vcBandWidthCheck" class="precheck bandwidth"><div class="testName"> ${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'testinginternetspeed', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Prev', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'testingspeaker', { name: 'getString', hash: {}, data }))
    } </div><audio id="vcSpeakerCheckAudio"><source src="${
      alias3(((helper = (helper = helpers.whiteboardPath || (depth0 != null ? depth0.whiteboardPath : depth0)) != null ? helper : alias2), (typeof helper === alias4 ? helper.call(alias1, { name: 'whiteboardPath', hash: {}, data }) : helper)))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'testingmichrophone', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'testingwebcam', { name: 'getString', hash: {}, data }))
      ...
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'JoinSession', { name: 'getString', hash: {}, data }))
    }</button></div></div></div></div></div></div></div></div></div>`;
  },
  useData: true,
});

this.JST['dest_temp/templates/recordingButton.hbs'] = Handlebars.template({
  1(container, depth0, helpers, partials, data) {
  ...
  3(container, depth0, helpers, partials, data) {
    ...
    return ((stack1 = helpers.if.call(depth0 != null ? depth0 : (container.nullContext || {}), (depth0 != null ? depth0.eleven : depth0), {
      name: 'if', hash: {}, fn: container.program(4, data, 0), inverse: container.program(6, data, 0), data,
    })) != null ? stack1 : '');
  },
  4(container, depth0, helpers, partials, data) {
  ...
  6(container, depth0, helpers, partials, data) {
    ...
    return ((stack1 = helpers.if.call(depth0 != null ? depth0 : (container.nullContext || {}), (depth0 != null ? depth0.twenty : depth0), {
      name: 'if', hash: {}, fn: container.program(7, data, 0), inverse: container.program(9, data, 0), data,
    })) != null ? stack1 : '');
  },
  7(container, depth0, helpers, partials, data) {
  ...
  9(container, depth0, helpers, partials, data) {
    ...
    return ((stack1 = helpers.if.call(depth0 != null ? depth0 : (container.nullContext || {}), (depth0 != null ? depth0.twentyone : depth0), {
      name: 'if', hash: {}, fn: container.program(10, data, 0), inverse: container.noop, data,
    })) != null ? stack1 : '');
  },
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return ((stack1 = helpers.if.call(depth0 != null ? depth0 : (container.nullContext || {}), (depth0 != null ? depth0.ten : depth0), {
      name: 'if', hash: {}, fn: container.program(1, data, 0), inverse: container.program(3, data, 0), data,
    })) != null ? stack1 : '');
  },
  useData: true,
...
this.JST['dest_temp/templates/recordingControl.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    return `<div class="playControllerMainCont"><div id="playControllerCont"><div id="playController"><div id="playProgress"><div id="playProgressBar" class="progressBar" style="width: 0%;"><div id="playCircle" class="circle"></div></div><div id="downloadProgress"><div id="downloadProgressBar" class="progressBar"></div><div id="downloadProgressValue" class="progressValue"></div></div><div id="timeInHover">0</div></div><div id="recPauseCont" class="recButton recordingPlay"><button id="recPause" class="icon-pause congtooltip" data-title="${
      container.escapeExpression((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'Pause', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/rightBar.hbs'] = Handlebars.template({
  compiler: [7, '>= 4.0.0'],
  main(container, depth0, helpers, partials, data) {
    let stack1; const alias1 = depth0 != null ? depth0 : (container.nullContext || {}); const
      alias2 = helpers.helperMissing;

    return `<div id="virtualclassAppRightPanel" class="rightbar bootstrap chat_enabled"> ${
      (stack1 = container.invokePartial((helpers.getVideoType || (depth0 && depth0.getVideoType) || alias2).call(alias1, { name: 'getVideoType', hash: {}, data }), depth0, {
        data, helpers, partials, decorators: container.decorators,
      })) != null ? stack1 : ''
    }  ${
      (stack1 = container.invokePartial(partials.audioWidget, depth0, {
        name: 'audioWidget', data, helpers, partials, decorators: container.decorators,
      })) != null ? stack1 : ''
    }  <div id="rightSubContainer" class=""> ${
      (stack1 = container.invokePartial(partials.appSettingDetail, depth0, {
        name: 'appSettingDetail', data, helpers, partials, decorators: container.decorators,
      })) != null ? stack1 : ''
      ...
      container.escapeExpression((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Searchuser', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/ssmainDiv.hbs'] = Handlebars.template({
  ...
  4(container, depth0, helpers, partials, data) {
    ...
    return ` <div id="virtualclassScreenShareLocal" class="Local " style="position: relative; width: 1536px; height: 677px;"><video id="virtualclassScreenShareLocalVideo" autoplay="true" src=" "></video></div><div id="virtualclassScreenShareLocalSmall" class="Local "><video id="virtualclassScreenShareLocalVideosmall" autoplay="true" src=" "></video><h3 id="screenShrMsg" class="alert alert-info">${
      container.escapeExpression((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(alias1, 'screensharemsg', { name: 'getString', hash: {}, data }))
    }</h3> ${
  ...
  5(container, depth0, helpers, partials, data) {
    ...
    return ` <div id="stopScreenShare" class="ss" data-title="${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'ssStop', { name: 'getString', hash: {}, data }))
    }"><button type="button"> ${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'ssBtn', { name: 'getString', hash: {}, data }))
    }</button></div> `;
  },
  7(container, depth0, helpers, partials, data) {
    let stack1;
  ...
  8(container, depth0, helpers, partials, data) {
    return ` <div id="screenController"><div class="share selfView"><button type="button">${
      container.escapeExpression((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'sharetoall', { name: 'getString', hash: {}, data }))
    }</button></div></div> `;
  },
  10(container, depth0, helpers, partials, data) {
    let stack1;
    ...
    return ` ${
      (stack1 = helpers.unless.call(depth0 != null ? depth0 : (container.nullContext || {}), (depth0 != null ? depth0.recImg : depth0), {
        name: 'unless', hash: {}, fn: container.program(11, data, 0), inverse: container.noop, data,
      })) != null ? stack1 : ''
    } `;
  },
  11(container, depth0, helpers, partials, data) {
  ...
  13(container, depth0, helpers, partials, data) {
    let stack1;
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="virtualclassScreenShare" class="virtualclass "> ${
      (stack1 = helpers.if.call(alias1, (depth0 != null ? depth0.control : depth0), {
        name: 'if', hash: {}, fn: container.program(1, data, 0), inverse: container.program(7, data, 0), data,
      })) != null ? stack1 : ''
    } ${
      (stack1 = helpers.if.call(alias1, (depth0 != null ? depth0.control : depth0), {
        name: 'if', hash: {}, fn: container.program(10, data, 0), inverse: container.program(13, data, 0), data,
      })) != null ? stack1 : ''
    } </div>`;
  },
  useData: true,
...
this.JST['dest_temp/templates/videoupload/linkvideo.hbs'] = Handlebars.template({
  1(container, depth0, helpers, partials, data) {
    ...
    return ` <div class="controls status" data-status="${
      ...
      alias2((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'disable', { name: 'getString', hash: {}, data }))
  ...
  3(container, depth0, helpers, partials, data) {
    ...
    return ` <div class="controls status" data-status="${
      ...
      alias2((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'enable', { name: 'getString', hash: {}, data }))
    }"><a class="statusanch">status"${
      alias2(alias1(((stack1 = (depth0 != null ? depth0.dataset : depth0)) != null ? stack1.status : stack1), depth0))
    }"</a></div> `;
  },
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div class="${
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'edittitle', { name: 'getString', hash: {}, data }))
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'clicktoplay', { name: 'getString', hash: {}, data }))
    }" data-rid="${
      alias4(alias5(((stack1 = (depth0 != null ? depth0.dataset : depth0)) != null ? stack1.rid : stack1), depth0))
    }">${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'clicktoplay', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/videoupload/popup.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="videoPopup" data-app="Video" class="dbContainer"><div id="uploadMsz" class="qq-gallery" style="display:none"></div><div id="congreavideoContBody"></div><div id="listvideo"></div><div id="congreaShareVideoUrlCont"><div id="uploadBtnCont"><button type="button" id="uploadVideo" class="btn btn-default"><span class=" glyphicon glyphicon-upload videoupload-icon" title="${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'uploadvideo', { name: 'getString', hash: {}, data }))
    }"></span><span class="videobtntxt">${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'uploadvideo', { name: 'getString', hash: {}, data }))
    }</span></button></div><div id="videoUrlContainer"><input id="videourl" placeholder="${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'enteryouryoutubeurl', { name: 'getString', hash: {}, data }))
...
this.JST['dest_temp/templates/videoupload/videoupload.hbs'] = Handlebars.template({
  ...
  3(container, depth0, helpers, partials, data) {
    return ` <p id="messageLayoutVideo">${
      container.escapeExpression((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'Vwllbshrshortly', { name: 'getString', hash: {}, data }))
    }</p> `;
  },
  compiler: [7, '>= 4.0.0'],
  main(container, depth0, helpers, partials, data) {
...
this.JST['dest_temp/templates/whiteboard/main.hbs'] = Handlebars.template({
  1(container, depth0, helpers, partials, data) {
    ...
    return ` ${
      (stack1 = container.invokePartial(partials.whiteboardToolbar, depth0, {
        name: 'whiteboardToolbar', data, helpers, partials, decorators: container.decorators,
      })) != null ? stack1 : ''
    } `;
  },
  compiler: [7, '>= 4.0.0'],
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="vcanvas${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'canvasmissing', { name: 'getString', hash: {}, data }))
    } </canvas></div></div></div>`;
  },
  usePartial: true,
  useData: true,
...
this.JST['dest_temp/templates/whiteboard/toolbar.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div id="commandToolsWrapper${
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Freehand', { name: 'getString', hash: {}, data }))
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Shapes', { name: 'getString', hash: {}, data }))
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Rectangle', { name: 'getString', hash: {}, data }))
    }" class="congtooltip"><span class="icon-rectangle cgIcon"></span></a></div><div id="t_line${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" class="tool" data-tool="line"><a href="#" data-title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Line', { name: 'getString', hash: {}, data }))
    }" class="congtooltip"><span class="icon-line cgIcon"></span></a></div><div id="t_oval${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" class="tool" data-tool="oval"><a href="#" data-title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Oval', { name: 'getString', hash: {}, data }))
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Triangle', { name: 'getString', hash: {}, data }))
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'Text', { name: 'getString', hash: {}, data }))
    }" class="congtooltip"><span class="icon-text cgIcon"></span></a></div><div id="t_strk${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" class="tool" data-tool="stroke"><a href="#" data-title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'strk', { name: 'getString', hash: {}, data }))
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'font', { name: 'getString', hash: {}, data }))
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'colorSelector', { name: 'getString', hash: {}, data }))
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'black', { name: 'getString', hash: {}, data }))
    }" data-color="#000000" bgcolor="#000000"></td><td id="cell-2${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-gray-4', { name: 'getString', hash: {}, data }))
    }" data-color="#434343" bgcolor="#434343"></td><td id="cell-3${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-gray-3', { name: 'getString', hash: {}, data }))
    }" data-color="#666666" bgcolor="#666666"></td><td id="cell-4${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-gray-2', { name: 'getString', hash: {}, data }))
    }" data-color="#999999" bgcolor="#999999"></td><td id="cell-5${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-gray-1', { name: 'getString', hash: {}, data }))
    }" data-color="#b7b7b7" bgcolor="#b7b7b7"></td><td id="cell-6${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'gray', { name: 'getString', hash: {}, data }))
    }" data-color="#cccccc" bgcolor="#cccccc"></td><td id="cell-7${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-gray-1', { name: 'getString', hash: {}, data }))
    }" data-color="#d9d9d9" bgcolor="#d9d9d9"></td><td id="cell-8${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-gray-2', { name: 'getString', hash: {}, data }))
    }" data-color="#efefef" bgcolor="#efefef"></td><td id="cell-9${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-gray-3', { name: 'getString', hash: {}, data }))
    }" data-color="#f3f3f3" bgcolor="#f3f3f3"></td><td id="cell-10${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'white', { name: 'getString', hash: {}, data }))
    }" data-color="#ffffff" bgcolor="#ffffff"></td></tr><tr style="height:5px"></tr><tr><td id="cell-11${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'red-berry', { name: 'getString', hash: {}, data }))
    }" data-color="#980000" bgcolor="#980000"></td><td id="cell-12${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'red', { name: 'getString', hash: {}, data }))
    }" data-color="#ff0000" bgcolor="#ff0000"></td><td id="cell-13${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'yellow', { name: 'getString', hash: {}, data }))
    }" data-color="#FF9900" bgcolor="#FF9900"></td><td id="cell-14${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'orange', { name: 'getString', hash: {}, data }))
    }" data-color="#ffff00" bgcolor="#ffff00"></td><td id="cell-15${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'green', { name: 'getString', hash: {}, data }))
    }" data-color="#00ff00" bgcolor="#00ff00"></td><td id="cell-16${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'cyan', { name: 'getString', hash: {}, data }))
    }" data-color="#00ffff" bgcolor="#00ffff"></td><td id="cell-17${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'cornflower-blue', { name: 'getString', hash: {}, data }))
    }" data-color="#4a86e8" bgcolor="#4a86e8"></td><td id="cell-18${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'blue', { name: 'getString', hash: {}, data }))
    }" data-color="#0000ff" bgcolor="#0000ff"></td><td id="cell-19${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'purple', { name: 'getString', hash: {}, data }))
    }" data-color="#9900ff" bgcolor="#9900ff"></td><td id="cell-20${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'magenta', { name: 'getString', hash: {}, data }))
    }" data-color="#ff00ff" bgcolor="#ff00ff"></td></tr><tr style="height:5px"></tr><tr><td id="cell-21${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-red-berry-3', { name: 'getString', hash: {}, data }))
    }"data-color="#e6b8af" bgcolor="#e6b8af"></td><td id="cell-22${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-red-3', { name: 'getString', hash: {}, data }))
    }" data-color="#f4cccc" bgcolor="#f4cccc"></td><td id="cell-23${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-orange-3', { name: 'getString', hash: {}, data }))
    }" data-color="#fce5cd" bgcolor="#fce5cd"></td><td id="cell-24${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-yellow-3', { name: 'getString', hash: {}, data }))
    }" data-color="#fff2cc" bgcolor="#fff2cc"></td><td id="cell-25${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-green-3', { name: 'getString', hash: {}, data }))
    }" data-color="#d9ead3" bgcolor="#d9ead3"></td><td id="cell-26${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-cyan-3', { name: 'getString', hash: {}, data }))
    }" data-color="#d0e0e3" bgcolor="#d0e0e3"></td><td id="cell-27${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-cornflower-blue-3', { name: 'getString', hash: {}, data }))
    }" data-color="#c9daf8" bgcolor="#c9daf8"></td><td id="cell-28${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-blue-3', { name: 'getString', hash: {}, data }))
    }" data-color="#cfe2f3" bgcolor="#cfe2f3"></td><td id="cell-29${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-purple-3', { name: 'getString', hash: {}, data }))
    }" data-color="#d9d2e9" bgcolor="#d9d2e9"></td><td id="cell-30${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-magenta-3', { name: 'getString', hash: {}, data }))
    }" data-color="#ead1dc" bgcolor="#ead1dc"></td></tr><tr><td id="cell-31${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-red-berry-2', { name: 'getString', hash: {}, data }))
    }" data-color="#dd7e6b" bgcolor="#dd7e6b"></td><td id="cell-32${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-red-2', { name: 'getString', hash: {}, data }))
    }" data-color="#ea9999" bgcolor="#ea9999"></td><td id="cell-33${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-orange-2', { name: 'getString', hash: {}, data }))
    }" data-color="#f9cb9c" bgcolor="#f9cb9c"></td><td id="cell-34${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-yellow-2', { name: 'getString', hash: {}, data }))
    }" data-color="#ffe599" bgcolor="#ffe599"></td><td id="cell-35${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-green-2', { name: 'getString', hash: {}, data }))
    }" data-color="#b6d7a8" bgcolor="#b6d7a8"></td><td id="cell-36${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-cyan-2', { name: 'getString', hash: {}, data }))
    }" data-color="#a2c4c9" bgcolor="#a2c4c9"></td><td id="cell-37${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-cornflower-blue-2', { name: 'getString', hash: {}, data }))
    }" data-color="#a4c2f4" bgcolor="#a4c2f4"></td><td id="cell-38${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-blue-2', { name: 'getString', hash: {}, data }))
    }" data-color="#9fc5e8" bgcolor="#9fc5e8"></td><td id="cell-39${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-purple-2', { name: 'getString', hash: {}, data }))
    }" data-color="#a0a7d6" bgcolor="#a0a7d6"></td><td id="cell-40${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-magenta-2', { name: 'getString', hash: {}, data }))
    }" data-color="#d5a6bd" bgcolor="#d5a6bd"></td></tr><tr><td id="cell-41${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-red-berry-1', { name: 'getString', hash: {}, data }))
    }" data-color="#cc4125" bgcolor="#cc4125"></td><td id="cell-42${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-red-1', { name: 'getString', hash: {}, data }))
    }" data-color="#e06666" bgcolor="#e06666"></td><td id="cell-43${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-orange-1', { name: 'getString', hash: {}, data }))
    }" data-color="#f6b26b" bgcolor="#f6b26b"></td><td id="cell-44${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-yellow-1', { name: 'getString', hash: {}, data }))
    }" data-color="#ffd966" bgcolor="#ffd966"></td><td id="cell-45${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-green-1', { name: 'getString', hash: {}, data }))
    }" data-color="#93c47d" bgcolor="#93c47d"></td><td id="cell-46${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-cyan-1', { name: 'getString', hash: {}, data }))
    }" data-color="#76a5af" bgcolor="#76a5af"></td><td id="cell-47${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-cornflower-blue-1', { name: 'getString', hash: {}, data }))
    }" data-color="#6d9eeb" bgcolor="#6d9eeb"></td><td id="cell-48${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-blue-1', { name: 'getString', hash: {}, data }))
    }" data-color="#6fa8dc" bgcolor="#6fa8dc"></td><td id="cell-49${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-purple-1', { name: 'getString', hash: {}, data }))
    }" data-color="#8e7cc3" bgcolor="#8e7cc3"></td><td id="cell-50${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'light-magenta-1', { name: 'getString', hash: {}, data }))
    }" data-color="#c27ba0" bgcolor="#c27ba0"></td></tr><tr><td id="cell-51${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-red-berry-1', { name: 'getString', hash: {}, data }))
    }" data-color="#a61c00" bgcolor="#a61c00"></td><td id="cell-52${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-red-1', { name: 'getString', hash: {}, data }))
    }" data-color="#cc0000" bgcolor="#cc0000"></td><td id="cell-53${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-orange-1', { name: 'getString', hash: {}, data }))
    }" data-color="#e69138" bgcolor="#e69138"></td><td id="cell-54${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-yellow-1', { name: 'getString', hash: {}, data }))
    }" data-color="#f1c232" bgcolor="#f1c232"></td><td id="cell-55${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-green-1', { name: 'getString', hash: {}, data }))
    }" data-color="#6aa84f" bgcolor="#6aa84f"></td><td id="cell-56${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-cyan-1', { name: 'getString', hash: {}, data }))
    }" data-color="#45818e" bgcolor="#45818e"></td><td id="cell-57${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-cornflower-blue-1', { name: 'getString', hash: {}, data }))
    }" data-color="#3c78d8" bgcolor="#3c78d8"></td><td id="cell-58${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-blue-1', { name: 'getString', hash: {}, data }))
    }" data-color="#3d85c6" bgcolor="#3d85c6"></td><td id="cell-59${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-purple-1', { name: 'getString', hash: {}, data }))
    }" data-color="#674ea7" bgcolor="#674ea7"></td><td id="cell-60${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-magenta-1', { name: 'getString', hash: {}, data }))
    }" data-color="#a64d79" bgcolor="#a64d79"></td></tr><tr><td id="cell-61${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-red-berry-2', { name: 'getString', hash: {}, data }))
    }" data-color="#85200c" bgcolor="#85200c"></td><td id="cell-62${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-red-2', { name: 'getString', hash: {}, data }))
    }" data-color="#990000" bgcolor="#990000"></td><td id="cell-63${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-orange-2', { name: 'getString', hash: {}, data }))
    }" data-color="#b45f06" bgcolor="#b45f06"></td><td id="cell-64${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-yellow-2', { name: 'getString', hash: {}, data }))
    }" data-color="#bf9000" bgcolor="#bf9000"></td><td id="cell-65${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-green-2', { name: 'getString', hash: {}, data }))
    }" data-color="#38761d" bgcolor="#38761d"></td><td id="cell-66${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-cyan-2', { name: 'getString', hash: {}, data }))
    }" data-color="#134f5c" bgcolor="#134f5c"></td><td id="cell-67${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-cornflower-blue-2', { name: 'getString', hash: {}, data }))
    }" data-color="#1155cc" bgcolor="#1155cc"></td><td id="cell-68${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-blue-2', { name: 'getString', hash: {}, data }))
    }" data-color="#0b5394" bgcolor="#0b5394"></td><td id="cell-69${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-purple-2', { name: 'getString', hash: {}, data }))
    }" data-color="#351c75" bgcolor="#351c75"></td><td id="cell-70${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-magenta-2', { name: 'getString', hash: {}, data }))
    }" data-color="#741b47" bgcolor="#741b47"></td></tr><tr><td id="cell-71${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-red-berry-3', { name: 'getString', hash: {}, data }))
    }" data-color="#5b0f00" bgcolor="#5b0f00"></td><td id="cell-72${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-red-3', { name: 'getString', hash: {}, data }))
    }" data-color="#660000" bgcolor="#660000"></td><td id="cell-73${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-orange-3', { name: 'getString', hash: {}, data }))
    }" data-color="#783f04" bgcolor="#783f04"></td><td id="cell-74${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-yellow-3', { name: 'getString', hash: {}, data }))
    }" data-color="#7f6000" bgcolor="#7f6000"></td><td id="cell-75${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-green-3', { name: 'getString', hash: {}, data }))
    }" data-color="#274e13" bgcolor="#274e13"></td><td id="cell-76${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-cyan-3', { name: 'getString', hash: {}, data }))
    }" data-color="#0c343d" bgcolor="#0c343d"></td><td id="cell-77${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-cornflower-blue-3', { name: 'getString', hash: {}, data }))
    }" data-color="#1c4587" bgcolor="#1c4587"></td><td id="cell-78${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-blue-3', { name: 'getString', hash: {}, data }))
    }" data-color="#073763" bgcolor="#073763"></td><td id="cell-79${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-purple-3', { name: 'getString', hash: {}, data }))
    }" data-color="#20124d" bgcolor="#20124d"></td><td id="cell-80${
      alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'cn', hash: {}, data }) : helper)))
    }" title="${
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'dark-magenta-3', { name: 'getString', hash: {}, data }))
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'ActiveAll', { name: 'getString', hash: {}, data }))
      ...
      alias4((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'ClearAll', { name: 'getString', hash: {}, data }))
  ...
  1(container, depth0, helpers, partials, data) {
    ...
    return ` ${
      (stack1 = container.invokePartial(partials.ytscontrol, depth0, {
        name: 'ytscontrol', data, helpers, partials, decorators: container.decorators,
      })) != null ? stack1 : ''
    } `;
  },
  3(container, depth0, helpers, partials, data) {
    return ` <p id="messageLayout">${
      container.escapeExpression((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'youtubewllbshrshortly', { name: 'getString', hash: {}, data }))
    }</p> `;
  },
  compiler: [7, '>= 4.0.0'],
  main(container, depth0, helpers, partials, data) {
...
this.JST['dest_temp/templates/youtube/ytscontrol.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    return `<div id="youtubeUrlContainer"><input id="youtubeurl" placeholder="Enter YouTube Video URL."><button id="submitURL">${
      container.escapeExpression((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), 'ShareYouTubeVideo', { name: 'getString', hash: {}, data }))
    }</button></div>`;
  },
  useData: true,
});
...
this.JST['dest_temp/templates/zoomControl.hbs'] = Handlebars.template({
  ...
  main(container, depth0, helpers, partials, data) {
    ...
    return `<div class="zoomControler"><div class="zoomIn"><span class="congtooltip zoomctrtool" data-title="${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'zoomIn', { name: 'getString', hash: {}, data }))
    }"><i class="icon-zoonIn"></i></span></div><div class="fitScreen"><span class="congtooltip zoomctrtool" data-title="${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'fitToScreen', { name: 'getString', hash: {}, data }))
    }"><i class="icon-fitScreen"></i></span></div><div class="zoomOut"><span class="congtooltip zoomctrtool" data-title="${
      alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, 'zoomOut', { name: 'getString', hash: {}, data }))
