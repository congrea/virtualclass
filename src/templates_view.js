...
this["JST"]["dest_temp/templates/appSettingMedia.hbs"] = Handlebars.template({
    "compiler": [7, ">= 4.0.0"], "main": function (container, depth0, helpers, partials, data) {
        var alias1 = depth0 != null ? depth0 : (container.nullContext || {}), alias2 = helpers.helperMissing,
            alias3 = container.escapeExpression;

        return "<div id=\"webRtcIoContainer\" class=\"rtcIo\"><div class=\"setting-heading\"><label>"
            + alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, "media", {
                "name": "getString",
                "hash": {},
                "data": data
            }))
            + "</label></div><ul class=\"list-group\"><li class=\"lists-cont d-flex justify-content-between align-items-center ainput\"> "
            + alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, "audioInput", {
                "name": "getString",
                "hash": {},
                "data": data
            }))
            + " <div class=\"audio-options\"><select id=\"audioSource\"></select><span class=\"hide\">"
            + alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, "noain", {
                "name": "getString",
                "hash": {},
                "data": data
            }))
            + "</span></div></li><li class=\"lists-cont d-flex justify-content-between align-items-center aoutput\"> "
            + alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, "audioOutput", {
                "name": "getString",
                "hash": {},
                "data": data
            }))
            + " <div class=\"audio-options\"><select id=\"audioOutput\"></select><span class=\"hide\">"
            + alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, "noaout", {
                "name": "getString",
                "hash": {},
                "data": data
            }))
            + "</span></div></li><li class=\"lists-cont clearfix justify-content-between align-items-center vinput\"> "
            + alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, "videoInput", {
                "name": "getString",
                "hash": {},
                "data": data
            }))
            + " <div class=\"audio-options\"><select id=\"videoSource\"></select><span class=\"hide\">"
            + alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, "novideo", {
                "name": "getString",
                "hash": {},
                "data": data
            }))
...
this["JST"]["dest_temp/templates/zoomControl.hbs"] = Handlebars.template({
    "compiler": [7, ">= 4.0.0"], "main": function (container, depth0, helpers, partials, data) {
        ...
        return "<div class=\"zoomControler\"><div class=\"zoomIn\"><span class=\"congtooltip\" data-title=\""
            ...
            + alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1, "reloadDoc", {
                "name": "getString",
                "hash": {},
                "data": data
            }))
