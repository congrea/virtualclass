...
this["JST"]["templates/appSettingDetail.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    return "  <div class=\"bulkUserActions\"> \n  <label class=\"bulk\">Bulk User Actions</label>\n    <ul class=\"list-group\">\n\n      <li class=\"list-group-item d-flex justify-content-between align-items-center\" id =\"contrAudioAll\"><span id=\"usersMuteSwitch\"></span>\n        Mute all Audio\n\n        <label class=\"switch\">\n          <input type=\"checkbox\" >\n          <span class=\"slider round icon-all-audio-enable congtooltip\" id =\"contrAudioAllImg\" ></span>\n        </label>\n\n      </li>\n\n      <li class=\"list-group-item d-flex justify-content-between align-items-center\" id =\"contrVideoAll\">\n        <span id=\"usersVideoSwitch\"></span>\n        Disable all Videos\n        <label class=\"switch\">\n          <input type=\"checkbox\">\n          <span class=\"slider round icon-all-video-enable congtooltip\" id =\"contrVideoAllImg\" ></span>\n        </label>\n      </li>\n   </ul>\n    </div> \n    \n";
  ...
  return "<div id=\"appSettingDetail\">\n"
    ...
    + " <div id=\"settingGeneral\">\n      <label>General</label>\n        <ul class=\"list-group\">\n            <li class=\"list-group-item d-flex justify-content-between align-items-center\"><span id=\"validate-precheck\"></span>\n            Validate App Prerequites\n            <span class=\"pre-check-btn\"><div id=\"settingPrecheck\">\n              <div class=\"prechk\" data-title=\"Precheck\" id=\"precheckTest\">\n                <span class=\"precheck cgIcon\"  id=\"precheckSetting\" >Start</span>\n              </div>\n        </div></span>\n            </li>\n        </ul>\n    \n  </div>  \n    \n  <div id=\"settingAudioVideo\" style=\"display:none;\">\n"
...
this["JST"]["templates/chat/chatuser.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "           <div id=\""
    ...
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.peer : depth0)) != null ? stack1.userid : stack1), depth0))
    + "contrstdscreenCont\">\n            <a class=\"congtooltip\"  data-title=\"Request ScreenShare\" id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.peer : depth0)) != null ? stack1.userid : stack1), depth0))
